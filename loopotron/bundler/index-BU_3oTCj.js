import { defineComponent as m, inject as u, resolveComponent as y, openBlock as f, createBlock as L, unref as v, withCtx as b, createElementVNode as p, markRaw as I } from "vue";
import "tiny-emitter";
import { F as x, n as s, S as A, o as g, p as $, q as h, L as w, b as S, d as _ } from "./main-DXAY4SCF.js";
...
class M extends x {
  ...
  _parseConfig(e) {
    ...
    const r = [1, 2, 3, 4, 5, 6];
    !e.multilineItems?.maxLines || !r.includes(e.multilineItems?.maxLines) ? s(this.$vApp.$pinia).maxLines = 3 : s(this.$vApp.$pinia).maxLines = e.multilineItems.maxLines, this.handlePanelWidths(["legend"]), this.handlePanelTeleports(["legend"]);
  ...
  getLayerItem(e) {
    ...
    return typeof e == "string" ? (r = e, t = e) : (r = e.id, t = e.uid), this.getLegend().some((n) => (i = this.searchTreeFirst(
      n,
      (o) => o instanceof g && (o.layerId === r || o.uid === t)
    ), i !== void 0)), i;
  }
  /**
  ...
  _treeWalker(e, t, r) {
    const l = ((o) => {
      ...
      for (; a.length > 0; ) {
        ...
        if (d && d.uid === o)
          return d;
        d && a.push(...d.sublayers);
      }
    })(t.uid), n = {};
    return t.isLayerRoot && !t.isLogicalLayer ? (n.layer = l, n.name = l.name, n.children = t.children.map((o) => this._treeWalker(e, o, r))) : !t.isLayerRoot && !t.isLogicalLayer ? (n.name = t.name, n.children = t.children.map((o) => this._treeWalker(e, o, r))) : t.isLogicalLayer && (n.layer = l, n.name = l.name, n.layerId = l.id, n.sublayerIndex = e.isSublayer ? e.layerIdx : void 0), { ...n, ...r };
  }
}
const T = /* @__PURE__ */ m({
  __name: "nav-button",
  setup(c) {
    const { t: e } = E(), t = u("iApi"), r = () => {
...
class Te extends M {
  added() {
    this.$iApi.component("legend-nav-button", T), this.$iApi.panel.register(
      {
        legend: {
          screens: {
            "legend-screen": () => I(import("./screen-Bccw7CLf.js"))
          },
          style: {
            width: "350px"
          },
    ...
    this.removed = () => {
      e(), this.$iApi.fixture.exists("appbar") && S(this.$vApp.$pinia).removeButton("legend"), this.$iApi.fixture.exists("mapnav") && _(this.$vApp.$pinia).removeItem("legend"), s().$reset(), this.$iApi.panel.remove("legend");
    };
  }
}
export {
