import { defineComponent as Q, ref as V, onMounted as ce, resolveDirective as q, openBlock as l, createElementBlock as o, withModifiers as k, withDirectives as x, createElementVNode as a, unref as t, withKeys as se, normalizeClass as C, inject as ge, computed as U, toRaw as M, resolveComponent as me, createVNode as Le, withCtx as re, createTextVNode as B, toDisplayString as w, Fragment as le, renderList as ne, normalizeStyle as pe, createCommentVNode as v, watch as ke, createStaticVNode as de, createBlock as Z, resolveDynamicComponent as xe } from "vue";
import { p as we, o as u, W as Ce, a as ye, Z as b, G as K, _ as oe, M as Me, n as Se, a0 as f, a1 as G, S as Te, a2 as O, a3 as ee } from "./main-DXAY4SCF.js";
import "pinia";
...
const Ee = ["type", "aria-label", "checked", "disabled", "content"], te = /* @__PURE__ */ Q({
  ...
  setup(e) {
    const { t: y } = ae(), s = e, m = V(s.legendItem.visibility);
    ce(() => {
      s.legendItem.checkVisibilityRules(), m.value = s.legendItem.visibility === s.checked;
    });
    const I = (i) => !i.symbologyStack.some((r) => r.visibility), $ = () => {
      if (s.value instanceof we)
        s.legendItem.toggleVisibility();
      else if (s.legendItem instanceof u) {
        if (I(s.legendItem) ? (s.legendItem.setSymbologyVisibility(void 0, !1), s.legendItem.setSymbologyVisibility(s.value.uid, !0), s.legendItem.toggleVisibility(!0)) : s.legendItem.setSymbologyVisibility(s.value.uid, !s.value.lastVisbility), I(s.legendItem) && s.legendItem.toggleVisibility(!1), s.legendItem.layer?.supportsFeatures) {
  ...
  setup(e) {
    const { t: y } = ae(), s = ge("iApi"), m = V(), I = V(!1), $ = ye(), i = V($.mobileView), r = e, T = () => {
      r.legendItem.layerControlAvailable(b.Symbology) && r.legendItem.toggleSymbology();
    }, P = () => {
      r.legendItem.layerControlAvailable(b.Datatable) && A("grid") && s.event.emit(K.GRID_TOGGLE, r.legendItem.layer);
    }, N = () => {
      r.legendItem.layerControlAvailable(b.Settings) && A("settings") && s.event.emit(K.SETTINGS_TOGGLE, r.legendItem.layer);
    }, Y = () => {
      if (r.legendItem.layerControlAvailable(b.Metadata) && A("metadata")) {
      ...
      r.legendItem.layerControlAvailable(b.BoundaryZoom) && r.legendItem?.layer?.zoomToLayerBoundary();
    }, F = () => {
      r.legendItem.layerControlAvailable(b.Remove) && s.geo.map.removeLayer(r.legendItem.layerUid);
    }, D = () => {
      j.value && (M(r.legendItem.layer).reload(), m.value.open = !1);
    }, j = U(() => r.legendItem.layerControlAvailable(b.Reload) && r.legendItem instanceof u && M(r.legendItem.layer)?.canReload), J = (z) => {
      I.value = !0, setTimeout(() => {
        I.value && (i.value || z._tippy?.show());
      }, 300);
    }, A = (z) => {
      try {
    ...
    return (z, c) => {
      const L = me("dropdown-menu"), R = q("tippy");
      return l(), o("div", {
        onClick: c[2] || (c[2] = k(() => {
        }, ["stop"])),
        ...
        Le(L, {
          ...
          default: re(() => [
            ...
            x((l(), o("a", {
              ...
              onMouseover: c[0] || (c[0] = k((E) => J(E.currentTarget), ["stop"])),
              onMouseout: c[1] || (c[1] = (E) => (
                //@ts-ignore
                (i.value || E.currentTarget?._tippy?.hide(), I.value = !1)
              )),
              onClick: D,
              role: "button",
...
}), Pe = /* @__PURE__ */ oe(Re, [["__scopeId", "data-v-9590866e"]]), De = { key: 0 }, je = {
  key: 0,
  ...
  setup(e) {
    ...
    return ce(() => {
    ...
    }), (m, I) => e.visible ? (l(), o("div", Ke, I[0] || (I[0] = [
      a("svg", {
      ...
      s.value.length > 1 ? (l(), o("div", je, [
        (l(!0), o(le, null, ne(s.value.slice(0, 3).reverse(), ($, i) => (l(), o("div", {
          class: C(["absolute", [i == 0 ? "symbol-0" : i == 1 ? "left-3 symbol-1" : "left-6 symbol-2"]]),
          style: pe({ "z-index": 3 - i }),
          key: i
        }, [
          s.value[i].svgcode ? (l(), o("span", {
            key: 0,
            class: "symbologyIcon w-28 h-28",
            innerHTML: s.value[i].svgcode
          }, null, 8, Oe)) : s.value[i].imgUrl ? (l(), o("img", {
            key: 1,
            class: "symbologyIcon w-28 h-28",
            src: s.value[i].imgUrl
          }, null, 8, qe)) : v("", !0)
        ], 6))), 128))
      ])) : s.value.length > 0 ? (l(), o("div", Ne, [
        s.value[0].svgcode ? (l(), o("span", {
          key: 0,
          innerHTML: s.value[0].svgcode
        }, null, 8, Fe)) : s.value[0].imgUrl ? (l(), o("img", {
          key: 1,
...
}), Ye = /* @__PURE__ */ oe(Qe, [["__scopeId", "data-v-34dfeccd"]]), Je = { class: "relative" }, Xe = ["content"], _e = {
  key: 0,
  ...
  width: "24px",
  height: "24px"
}, lt = ["disabled", "content", "aria-label"], nt = ["src"], ot = { class: "h-auto break-words text-ellipsis" }, at = {
  key: 4,
  ...
  setup(e) {
    const y = Me(), s = ye(), { t: m } = ae(), I = ge("iApi"), $ = V(), i = e, r = Se(), T = r.multilineItems, P = (i.legendItem instanceof u && i.legendItem.maxLines) ?? r.maxLines, N = V(s.mobileView), Y = U(() => y.layerConfigs), H = V([]), F = V(!1), D = V(!1), j = U(() => i.legendItem instanceof u ? M(i.legendItem.layer)?.layerType : ""), J = U(() => i.legendItem instanceof u && M(i.legendItem.layer)?.canModifyLayer), A = U(() => {
      if (i.legendItem instanceof u) {
        const d = M(i.legendItem.layer);
        return d ? d.canReload : !0;
      } else
        return !1;
    }), z = U(() => I.animate), c = U(() => i.legendItem.children.length > 0 || // TODO: Determine why Vue reactivity isn't picking updates to the children property of the parent.
    ...
    i.legendItem instanceof u && M(i.legendItem.layer)?.sublayers.length > 0), L = (d) => d === G.Expand || d === G.Visibility ? i.legendItem.controlAvailable(d) : i.legendItem.layerControlAvailable(d), R = (d) => Ve(d), E = () => {
      i.legendItem.children.length === 0 || !L(G.Expand) || (i.legendItem.toggleExpanded(), I.updateAlert(m(`legend.alert.group${i.legendItem.expanded ? "Expanded" : "Collapsed"}`)));
    }, X = () => {
      if (L(b.Symbology)) {
        const d = i.legendItem.toggleSymbology();
        I.updateAlert(m(`legend.alert.symbology${d ? "Expanded" : "Collapsed"}`));
      }
    }, ue = () => {
      L(b.Datatable) && W() && I.event.emit(K.GRID_TOGGLE, i.legendItem.layer);
    }, ve = (d) => {
      ...
      i.legendItem.reload(), setTimeout(() => {
        ...
        if (d.layer)
          ...
          const h = I.geo.layer.getLayer(d.parentLayerId);
          h && (M(h).reload(), n = !1);
        }
        if (n) {
          const h = d.isSublayer ? d.parentLayerId : d.layerId, p = Y.value.find((S) => S.id === h);
          p !== void 0 && Ie(p);
        }
      ...
      try {
        const n = I.geo.layer.getLayer(d.id);
        if (n) {
          ...
          const h = I.geo.layer.createLayer(d);
      ...
      if (d.type === f.Error) {
        ...
        const h = setInterval(() => {
          const p = d.layer;
          (p && (p.layerExists || p.initiationState === ee.NEW || p.initiationState === ee.TERMINATING || p.initiationState === ee.TERMINATED) || n > 1200) && (clearInterval(h), p && I.geo.map.removeLayer(p), y.removeLayerConfig(d.layerId), I.fixture.get("legend")?.removeLayerItem(d.layerId)), n++;
        }, 250);
      } else {
        i.legendItem.error();
        const h = setInterval(() => {
          const p = d.parentLayerId || d.layerId, S = I.geo.layer.getLayer(p);
    ...
    return i.legendItem instanceof u && (ie(), ke(
      ...
      const h = me("item", !0), p = q("tippy"), S = q("truncate"), _ = q("focus-item");
      return e.legendItem.hidden ? v("", !0) : (l(), o("div", {
        ...
        a("div", Je, [
          x((l(), o("div", {
            class: C(["flex items-center hover:bg-gray-200 default-focus-style !p-5", [
              ...
              c.value && L(t(G).Expand) || !c.value && e.legendItem instanceof t(u) && L(t(b).Datatable) && W() && e.legendItem.type === t(f).Item ? "cursor-pointer" : "cursor-default",
              t(T) ? "multilined" : "singlelined"
            ]]),
            onMouseover: n[9] || (n[9] = k((g) => he(g.currentTarget), ["stop"])),
            onMouseout: n[10] || (n[10] = (g) => (
              //@ts-ignore
              (N.value || g.currentTarget?._tippy?.hide(), D.value = !1)
            )),
            onClick: n[11] || (n[11] = () => {
              !c.value && e.legendItem instanceof t(u) && L(t(b).Datatable) && W() && e.legendItem.type === t(f).Item ? ue() : c.value && E();
            }),
            content: c.value && L(t(G).Expand) ? t(m)(e.legendItem.expanded ? "legend.group.collapse" : "legend.group.expand") : e.legendItem instanceof t(u) && e.legendItem.type === t(f).Item && L(t(b).Datatable) && W() ? t(m)("legend.layer.data") : "",
            "truncate-trigger": ""
          }, [
            e.legendItem.type !== t(f).Item ? (l(), o("div", _e, [
              e.legendItem.type === t(f).Placeholder ? (l(), o("svg", et, n[12] || (n[12] = [
                de('<path d="M0 0h24v24H0V0z" fill="none" data-v-b1261e08></path><path d="M0 0h24v24H0V0z" fill="none" data-v-b1261e08></path><circle cx="15.5" cy="9.5" r="1.5" data-v-b1261e08></circle><circle cx="8.5" cy="9.5" r="1.5" data-v-b1261e08></circle><circle cx="15.5" cy="9.5" r="1.5" data-v-b1261e08></circle><circle cx="8.5" cy="9.5" r="1.5" data-v-b1261e08></circle><path d="M11.99 2C6.47 2 2 6.48 2 12s4.47 10 9.99 10C17.52 22 22 17.52 22 12S17.52 2 11.99 2zM12 20c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8zm0-2.5c2.33 0 4.32-1.45 5.12-3.5h-1.67c-.69 1.19-1.97 2-3.45 2s-2.75-.81-3.45-2H6.88c.8 2.05 2.79 3.5 5.12 3.5z" data-v-b1261e08></path>', 7)
              ]))) : (l(), o("svg", tt, n[13] || (n[13] = [
                de('<path d="M0 0h24v24H0V0z" fill="none" data-v-b1261e08></path><path d="M0 0h24v24H0V0z" fill="none" data-v-b1261e08></path><circle cx="15.5" cy="9.5" r="1.5" data-v-b1261e08></circle><circle cx="8.5" cy="9.5" r="1.5" data-v-b1261e08></circle><circle cx="15.5" cy="9.5" r="1.5" data-v-b1261e08></circle><circle cx="8.5" cy="9.5" r="1.5" data-v-b1261e08></circle><path d="M 20,12C 20,7.6 16.4,4 12,4C 7.6,4 4,7.6 4,12C 4,16.4 7.6,20 12,20C 16.4,20 20,16.4 20,12 Z M 22,12C 22,17.5 17.5,22 12,22C 6.5,22 2,17.5 2,12C 2,6.5 6.5,2.00001 12,2.00001C 17.5,2.00001 22,6.5 22,12 Z M 15.5,8C 16.3,8 17,8.7 17,9.5C 17,10.3 16.3,11 15.5,11C 14.7,11 14,10.3 14,9.5C 14,8.7 14.7,8 15.5,8 Z M 10,9.5C 10,10.3 9.3,11 8.5,11C 7.7,11 7,10.3 7,9.5C 7,8.7 7.7,8 8.5,8C 9.3,8 10,8.7 10,9.5 Z M 12,14C 13.7524,14 15.2943,14.7212 16.1871,15.8129L 14.7697,17.2302C 14.3175,16.5078 13.2477,16 12,16C 10.7523,16 9.68254,16.5078 9.23024,17.2302L 7.81291,15.8129C 8.7057,14.7212 10.2476,14 12,14 Z" data-v-b1261e08></path>', 7)
              ])))
            ])) : v("", !0),
            e.legendItem.type === t(f).Item && e.legendItem instanceof t(u) && e.legendItem.layer.legend.length > 0 ? (l(), o("div", {
              key: 1,
            ...
            e.legendItem instanceof t(u) && t(T) ? x((l(), o("div", {
              key: 3,
              class: C(["flex-1 pointer-events-none m-5", `line-clamp-${t(P)}`])
            }, [
              a("span", ot, w(e.legendItem.name ?? (e.legendItem?.layer?.name ? e.legendItem.layer?.name : e.legendItem.layerId)), 1)
            ], 2)), [
              [S, {
                externalTrigger: !0,
                noTruncateClass: !0
              }]
            ]) : e.legendItem instanceof t(u) ? x((l(), o("div", at, [
              ...
              [S, { externalTrigger: !0 }]
            ]) : e.legendItem instanceof t(Te) ? (l(), o("div", it, [
              e.legendItem.infoType === t(O).Title && e.legendItem.content ? (l(), o("h3", st, w(e.legendItem.content), 1)) : e.legendItem.infoType === t(O).Title ? (l(), o("h3", rt, w(e.legendItem.name), 1)) : e.legendItem.infoType === t(O).Text ? (l(), o("p", dt, w(e.legendItem.content), 1)) : e.legendItem.infoType === t(O).Image ? (l(), o("img", {
                key: 3,
                src: e.legendItem.content,
                alt: "InfoType image not found :("
              }, null, 8, ct)) : e.legendItem.infoType === t(O).Markdown ? (l(), o("div", {
                key: 4,
                class: "ramp-markdown",
                innerHTML: R(e.legendItem.content)
              }, null, 8, gt)) : (l(), Z(xe(`${e.legendItem.uid}-info-section`), { key: 5 }))
            ])) : v("", !0),
            e.legendItem.type === t(f).Error && A.value ? (l(), o("div", mt, [
              x((l(), o("button", {
                type: "button",
            ...
            e.legendItem.type !== t(f).Item && e.legendItem instanceof t(u) ? (l(), o("div", ut, [
              x((l(), o("button", {
                type: "button",
                class: "text-gray-500 hover:text-black",
            ...
            e.legendItem.type === t(f).Item && e.legendItem instanceof t(u) && e.legendItem.layerOffscale ? x((l(), o("div", {
              key: 9,
            ...
            e.legendItem.type === t(f).Item && e.legendItem instanceof t(u) && !e.legendItem.layer?.mapLayer ? x((l(), o("div", {
              key: 10,
              class: "relative p-4 cursor-default",
            ...
            e.legendItem.type === t(f).Item && e.legendItem instanceof t(u) && e.legendItem.layerOffscale ? (l(), o("div", pt, [
              x((l(), o("button", {
                type: "button",
                class: "p-4",
          ...
          e.legendItem.type === t(f).Placeholder || e.legendItem instanceof t(u) && e.legendItem.layerRedrawing && e.legendItem.visibility ? (l(), o("div", xt, n[21] || (n[21] = [
            a("div", { class: "progress-line" }, null, -1)
          ]))) : v("", !0)
        ]),
        e.legendItem instanceof t(u) && e.legendItem.symbologyExpanded ? x((l(), o("div", wt, [
          H.value.length > 0 ? (l(), o("div", Ct, [
            e.legendItem instanceof t(u) && e.legendItem.description ? (l(), o("p", Mt, w(e.legendItem.description), 1)) : v("", !0),
            (l(!0), o(le, null, ne(H.value, (g) => (l(), o("div", {
              class: "m-5",
              key: g.uid
            }, [
              g.imgUrl && e.legendItem.symbologyRenderStyle === "images" || !g.imgUrl && j.value === "ogc-wms" ? (l(), o("div", St, [
                g.imgUrl ? (l(), o("div", Tt, [
                  a("img", {
                    class: "max-w-full",
                    src: g.imgUrl
                ...
                g.label ? x((l(), o("div", Et, [
                  a("span", null, w(g.label), 1),
                ...
                J.value && e.legendItem.layer.supportsFeatures && (!g.imgUrl && H.value.length > 1 || g.imgUrl && g.definitionClause) ? (l(), Z(te, {
                  key: 2,
                  value: g,
                  legendItem: e.legendItem,
                  checked: g.visibility,
          ...
          F.value ? v("", !0) : (l(), o("div", Ut, [
            x((l(), o("div", Rt, [
              z.value ? (l(), o("div", Pt)) : v("", !0),
              x((l(), o("div", Dt, [
                a("span", null, w(t(m)("legend.symbology.loading")), 1)
              ])), [
                [S]
              ])
            ])), [
        ...
        e.legendItem.expanded ? (l(), o("div", jt, [
          (l(!0), o(le, null, ne(e.legendItem.children, (g) => (l(), Z(h, {
            legendItem: g,
            key: g.uid
...
}), jl = /* @__PURE__ */ oe(Ot, [["__scopeId", "data-v-b1261e08"]]);
export {
  jl as default
};
