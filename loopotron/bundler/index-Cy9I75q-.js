...
import "tiny-emitter";
import { F as i, b as s, r as m } from "./main-DXAY4SCF.js";
    ...
    this.$iApi.panel.register(
      {
        metadata: {
          screens: {
            "metadata-screen-content": () => o(import("./screen-CALM7_yK.js"))
          },
          style: {
            width: "350px"
          },
      ...
      this.$iApi.fixture.exists("appbar") && s(this.$vApp.$pinia).removeButton("metadata"), m(this.$vApp.$pinia).$reset(), this.$iApi.panel.remove("metadata");
    };
  }
}
export {
