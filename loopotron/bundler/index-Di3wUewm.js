import "tiny-emitter";
import { F as h, i as n, b as u } from "./main-DXAY4SCF.js";
...
class x extends h {
  ...
  _parseConfig(e) {
    ...
    e && e.mergeGrids && e.mergeGrids.forEach((t) => {
      const l = [], { gridId: o, layers: s, fieldMap: m, options: c } = t;
      s.forEach((r) => {
        r.sublayers ? r.sublayers?.forEach((a) => {
          l.push(`${r.layerId}-${a}`), delete i[`${r.layerId}-${a}`];
    ...
    this.$iApi.panel.register(
      {
        grid: {
          screens: {
            "grid-screen": () => b(import("./screen-MMpavef3.js"))
          },
          style: {
            width: "450px"
          },
