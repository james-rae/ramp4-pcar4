...
import { _ as H, d as L, k as X, F as ee, G as te } from "./main-C8lGmFA5.js";
...
const G = /* @__PURE__ */ H(ne, [["render", ae]]), se = /* @__PURE__ */ T({
  ...
  setup(h) {
    ...
    const p = [
      {
        type: "point",
        icon: g(_(() => import("./point-icon-DrkLYWMZ.js")))
      },
      {
        type: "polyline",
        icon: g(_(() => import("./polyline-icon-DpgKjl6y.js")))
      },
      {
        type: "polygon",
        icon: g(_(() => import("./polygon-icon-IoWyGcxU.js")))
      },
      {
        type: "circle",
        icon: g(_(() => import("./circle-icon-yVE3l1u3.js")))
      },
      {
        type: "rectangle",
        icon: g(_(() => import("./rectangle-icon-DgqB6TZ8.js")))
      }
    ], a = A(() => {
      const s = p.filter((u) => e.supportedTypes.some((x) => x.type === u.type));
      return s.push({
        type: "edit",
        icon: g(_(() => import("./edit-icon-COMo--5Z.js")))
      }), s;
    }), n = (s) => {
