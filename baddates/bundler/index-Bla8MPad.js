...
import { _ as H, d as L, F as X, G as ee } from "./main-DnrcoMvP.js";
...
const G = /* @__PURE__ */ H(ne, [["render", ae]]), se = /* @__PURE__ */ T({
  ...
  setup(h) {
    ...
    const p = [
      {
        type: "point",
        icon: g(_(() => import("./point-icon-CKj8NqhN.js")))
      },
      {
        type: "polyline",
        icon: g(_(() => import("./polyline-icon-Dmybpgug.js")))
      },
      {
        type: "polygon",
        icon: g(_(() => import("./polygon-icon-B6F7vmNh.js")))
      },
      {
        type: "circle",
        icon: g(_(() => import("./circle-icon-D6bFvADe.js")))
      },
      {
        type: "rectangle",
        icon: g(_(() => import("./rectangle-icon-DA2it6wr.js")))
      }
    ], a = A(() => {
      const s = p.filter((u) => e.supportedTypes.some((x) => x.type === u.type));
      return s.push({
        type: "edit",
        icon: g(_(() => import("./edit-icon-CNZSH5UP.js")))
      }), s;
    }), n = (s) => {
