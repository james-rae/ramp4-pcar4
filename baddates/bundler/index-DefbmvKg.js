...
import "tiny-emitter";
import { G as le, L as Te, F as xe } from "./main-DnrcoMvP.js";
...
class ft extends Me {
  async init() {
    Object.entries(Le).forEach((b) => this.$iApi.$i18n.mergeLocaleMessage(...b)), this._parseConfig(this.config), Z(this.$vApp.$pinia).supportedTypes.forEach((b) => {
      const o = `${b.type}-icon`;
      this.$iApi.component(o, Ae(Se(/* @__PURE__ */ Object.assign({ "./icons/circle-icon.vue": () => import("./circle-icon-D6bFvADe.js"), "./icons/edit-icon.vue": () => import("./edit-icon-CNZSH5UP.js"), "./icons/point-icon.vue": () => import("./point-icon-CKj8NqhN.js"), "./icons/polygon-icon.vue": () => import("./polygon-icon-B6F7vmNh.js"), "./icons/polyline-icon.vue": () => import("./polyline-icon-Dmybpgug.js"), "./icons/rectangle-icon.vue": () => import("./rectangle-icon-DA2it6wr.js") }), `./icons/${b.type}-icon.vue`, 3)));
    });
