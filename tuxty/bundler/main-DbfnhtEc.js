import { TinyEmitter as hs } from "tiny-emitter";
import { defineStore as W, storeToRefs as fs, createPinia as ms } from "pinia";
import { ref as f, computed as G, markRaw as ne, defineComponent as D, inject as _e, reactive as $e, watch as Pt, onBeforeUnmount as bt, resolveDirective as U, withDirectives as V, createElementBlock as w, openBlock as v, withKeys as ys, withModifiers as si, onMounted as at, normalizeStyle as Ni, normalizeClass as ue, createVNode as me, Transition as Fi, withCtx as pe, createBlock as ee, resolveDynamicComponent as gs, mergeProps as vs, useCssVars as bs, TransitionGroup as Di, Fragment as st, renderList as At, unref as I, nextTick as Tt, renderSlot as Be, createElementVNode as g, vShow as As, resolveComponent as ae, createTextVNode as ft, toDisplayString as B, createCommentVNode as j, onUpdated as ws, Teleport as Es, getCurrentInstance as xs, useTemplateRef as vi, createApp as Gi, toRaw as Pe, h as Ss, render as jt, defineAsyncComponent as Is } from "vue";
import Nt from "@arcgis/core/Color";
import Et from "@arcgis/core/config";
import { watch as Re } from "@arcgis/core/core/reactiveUtils";
import _s from "@arcgis/core/Graphic";
import bi from "@arcgis/core/geometry/Extent";
import Ts from "@arcgis/core/geometry/Multipoint";
import Ls from "@arcgis/core/geometry/Point";
import ri from "@arcgis/core/geometry/Polygon";
import Ui from "@arcgis/core/geometry/Polyline";
import Rs from "@arcgis/core/geometry/SpatialReference";
import { fromJSON as $s } from "@arcgis/core/geometry/support/jsonUtils";
import Qe from "@arcgis/core/request";
import Cs from "@arcgis/core/symbols/PictureMarkerSymbol";
import Os from "@arcgis/core/symbols/SimpleFillSymbol";
import ks from "@arcgis/core/symbols/SimpleLineSymbol";
import Zt from "@arcgis/core/symbols/SimpleMarkerSymbol";
import { fromJSON as ai } from "@arcgis/core/symbols/support/jsonUtils";
import "@arcgis/map-components/components/arcgis-sketch";
import "@arcgis/map-components/components/arcgis-swipe";
import Vi from "deepmerge";
import { applyConverter as Ms } from "@terraformer/spatial";
import ge from "proj4";
import { debounce as Ft, throttle as ut } from "throttle-debounce";
import { createI18n as Ps, useI18n as se } from "vue-i18n";
import ke from "screenfull";
import { cloneDeep as Ai } from "lodash-es";
import Ns, { setDefaultProps as Fs, useTippy as Ds } from "vue-tippy";
import Gs from "linkify-html";
import { createPopper as Us, detectOverflow as Vs } from "@popperjs/core";
import Lt from "redaxios";
import Ie from "await-to-js";
import { geojsonToArcGIS as zs } from "@terraformer/arcgis";
import { dsv as wi, csv2geojson as Bs } from "csv2geojson";
import ct from "svg.js";
import zi from "animejs";
import "tippy.js/animations/scale.css";
var Ue = /* @__PURE__ */ ((r) => (r.BLOB = "blob", r.DATE = "date", r.DOUBLE = "double", r.GEOMETRY = "geometry", r.GLOBAL_ID = "global-id", r.GUID = "guid", r.INTEGER = "integer", r.LONG = "long", r.OID = "oid", r.RASTER = "raster", r.SINGLE = "single", r.SMALL_INTEGER = "small-integer", r.STRING = "string", r.XML = "xml", r))(Ue || {}), Ge = /* @__PURE__ */ ((r) => (r.CIRCLE = "circle", r.CROSS = "cross", r.DIAMOND = "diamond", r.ICON = "icon", r.PATH = "path", r.SQUARE = "square", r.TRIANGLE = "triangle", r.X = "x", r))(Ge || {}), be = /* @__PURE__ */ ((r) => (r.DASH = "dash", r.DASHDOT = "dash-dot", r.DASHDOTDOT = "short-dash-dot-dot", r.DOT = "dot", r.LONGDASH = "long-dash", r.LONGDASHDOT = "long-dash-dot", r.LONGDASHDOTDOT = "long-dash-dot-dot", r.NONE = "none", r.NULL = "none", r.SHORTDASH = "short-dash", r.SHORTDASHDOT = "short-dash-dot", r.SHORTDASHDOTDOT = "short-dash-dot-dot", r.SHORTDOT = "short-dot", r.SOLID = "solid", r))(be || {}), Bi = /* @__PURE__ */ ((r) => (r.BEVEL = "bevel", r.MITER = "miter", r.ROUND = "round", r))(Bi || {}), qi = /* @__PURE__ */ ((r) => (r.ROUND = "round", r.BUTT = "butt", r.SQUARE = "square", r))(qi || {}), ji = /* @__PURE__ */ ((r) => (r.BDIAG = "backward-diagonal", r.CROSS = "cross", r.DIAG_CROSS = "diagonal-cross", r.FDIAG = "forward-diagonal", r.HORIZONTAL = "horizontal", r.NONE = "none", r.NULL = "none", r.SOLID = "solid", r.VERTICAL = "vertical", r))(ji || {}), $ = /* @__PURE__ */ ((r) => (r.POINT = "Point", r.MULTIPOINT = "MultiPoint", r.LINESTRING = "LineString", r.MULTILINESTRING = "MultiLineString", r.POLYGON = "Polygon", r.MULTIPOLYGON = "MultiPolygon", r.LINEARRING = "LinearRing", r.EXTENT = "Extent", r.NONE = "None", r.UNKNOWN = "Unknown", r))($ || {}), zt = /* @__PURE__ */ ((r) => (r.Simple = "simple", r.Unique = "uniqueValue", r.ClassBreaks = "classBreaks", r.Unknown = "unknown", r))(zt || {}), S = /* @__PURE__ */ ((r) => (r.FEATURE = "esri-feature", r.MAPIMAGE = "esri-map-image", r.TILE = "esri-tile", r.VECTORTILE = "esri-vector-tile", r.IMAGERY = "esri-imagery", r.IMAGERYTILE = "esri-imagery-tile", r.GRAPHIC = "esri-graphic", r.WMS = "ogc-wms", r.WFS = "ogc-wfs", r.GEOJSON = "file-geojson", r.GEOJSONZIPPED = "file-zip-geojson", r.CSV = "file-csv", r.SHAPEFILE = "file-shape", r.FLATGEOBUF = "file-fgb", r.FLATGEOBUFZIPPED = "file-zip-fgb", r.OSM = "osm-tile", r.DATACSV = "data-csv", r.DATAJSON = "data-json", r.DATATABLE = "data-esri-table", r.UNKNOWN = "unknown", r.SUBLAYER = "sublayer", r))(S || {}), ye = /* @__PURE__ */ ((r) => (r.FEATURE = "feature", r.GRAPHIC = "graphic", r.IMAGERY = "imagery", r.IMAGERYTILE = "imagery-tile", r.MAPIMAGE = "map-image", r.NOLAYER = "no-layer", r.OSM = "osm-tile", r.TILE = "tile", r.UNKNOWN = "unknown", r.VECTORTILE = "vector-tile", r.WMS = "wms", r))(ye || {}), le = /* @__PURE__ */ ((r) => (r.ESRI_FEATURE = "esriFeature", r.ESRI_RASTER = "esriRaster", r.ESRI_TILE = "esriTile", r.OSM_TILE = "osmTile", r.OGC_RASTER = "ogcRaster", r.UNKNOWN = "unknown", r))(le || {}), K = /* @__PURE__ */ ((r) => (r.POINT = "Point", r.MULTIPOINT = "MultiPoint", r.LINESTRING = "LineString", r.MULTILINESTRING = "MultiLineString", r.POLYGON = "Polygon", r.MULTIPOLYGON = "MultiPolygon", r))(K || {}), oe = /* @__PURE__ */ ((r) => (r.GEOMETRIC = "geometric", r.SYMBOLIC = "symbolic", r.HYBRID = "hybrid", r.NONE = "none", r))(oe || {}), H = /* @__PURE__ */ ((r) => (r.NEW = "new", r.INITIATING = "initiating", r.INITIATED = "initiated", r.TERMINATING = "terminating", r.TERMINATED = "terminated", r))(H || {}), Z = /* @__PURE__ */ ((r) => (r.NEW = "new", r.LOADING = "loading", r.LOADED = "loaded", r.ERROR = "error", r))(Z || {}), fe = /* @__PURE__ */ ((r) => (r.NOT_LOADED = "not-loaded", r.NOT_VISUAL = "not-visual", r.REFRESH = "refresh", r.UP_TO_DATE = "up-to-date", r))(fe || {}), mt = /* @__PURE__ */ ((r) => (r.ESRI = "esri", r.TEXT = "text", r.IMAGE = "image", r.HTML = "html", r.XML = "xml", r.JSON = "json", r.UNKNOWN = "unknown", r))(mt || {}), ce = /* @__PURE__ */ ((r) => (r.SYMBOL = "symbol", r.GRID = "grid", r.EXTENT = "extent", r.INITIAL = "initial", r.API = "api", r.MIL_FLICKER_ERASER = "mileraser", r.PERMANENT = "permanent", r))(ce || {}), Q = /* @__PURE__ */ ((r) => (r.BoundaryZoom = "boundaryZoom", r.Datatable = "datatable", r.Identify = "identify", r.Metadata = "metadata", r.Opacity = "opacity", r.Refresh = "refresh", r.Reload = "reload", r.Remove = "remove", r.Settings = "settings", r.Symbology = "symbology", r.Visibility = "visibility", r))(Q || {});
class Ce {
  attributes;
  geometry;
  style;
  id;
  constructor(e, t, i) {
    this.geometry = e, t ? this.id = t : this.id = it.sharedUtils.generateUUID(), i ? this.attributes = i : this.attributes = {};
  }
  _hover;
...
class R {
  ...
  static fromConfig(e) {
    if (e.wkt)
      return new R(e.wkt);
    if (e.wkid)
      return new R(e.wkid, e.latestWkid);
   ...
   */
  static parseSR(e) {
    return e ? e instanceof R ? e.clone() : typeof e == "string" && e.startsWith("EPSG:") ? new R(parseInt(e.substring(5).trim())) : new R(e) : R.latLongSR();
  }
  static fromESRI(e) {
    if (e.wkt)
      return new R(e.wkt);
    {
      const t = e.toJSON().latestWkid, i = new R(e.wkid);
      return t && (i.latestWkid = t), i;
    }
  }
  toESRI() {
    return new Rs(this.lean());
  }
  static fromGeoJSON(e) {
    const t = R.parseGeoJsonCrs(e);
    return t.substring(0, 5) === "EPSG:" ? new R(parseInt(t.slice(5))) : new R(t);
  }
  /**
...
class ot {
  ...
  id;
  constructor(e, t) {
    this.id = e ? e.toString() : "", this.sr = R.parseSR(t);
  }
  /**
...
class te extends ot {
  ...
  static fromESRI(e, t) {
    return new te(t, [e.x, e.y], R.fromESRI(e.spatialReference), !0);
  }
  toESRI() {
    return new Ls({
      x: this.x,
  ...
  static fromGeoJSON(e, t) {
    return new te(t, e.coordinates, R.fromGeoJSON(e.crs), !0);
  }
  toGeoJSON() {
...
class we extends ot {
  ...
  rawArray;
  constructor(e, t, i, s) {
    super(e, t.sr || i), s ? this.rawArray = we.arrayDeepCopy(t) : t instanceof we ? this.rawArray = t.toArray() : this.rawArray = we.parsePointSet(t);
  }
   ...
   */
  toArray() {
    return we.arrayDeepCopy(this.rawArray);
  }
...
class Xe extends we {
  ...
  static fromESRI(e, t) {
    return new Xe(t, e.paths[0], R.fromESRI(e.spatialReference), !0);
  }
  toESRI() {
    return new Ui({
      paths: [this.toArray()],
  ...
  static fromGeoJSON(e, t) {
    return new Xe(t, e.coordinates, R.fromGeoJSON(e.crs), !0);
  }
  toGeoJSON() {
...
class Le extends ot {
  ...
  constructor(e, t, i, s) {
    if (super(e, t.sr || i), s)
      this.rawArray = Le.arrayDeepCopy(t);
      ...
      this.rawArray = t.map((a) => we.parsePointSet(a));
    } else
  ...
  getAt(e) {
    return new Xe(this.childIdGenerator(e), this.rawArray[e], this.sr, !0);
  }
  ...
  updateAt(e, t) {
    this.rawArray[t] = we.parsePointSet(e);
  }
   ...
   */
  toArray() {
    return Le.arrayDeepCopy(this.rawArray);
  }
  static arrayDeepCopy(e) {
    return e.map((t) => t.map((i) => i.slice()));
  }
  static fromESRI(e, t) {
    return new Le(t, e.paths, R.fromESRI(e.spatialReference), !0);
  }
  toESRI() {
    return new Ui({
      paths: this.toArray(),
...
class tt extends we {
  constructor(e, t, i, s) {
    if (super(e, t, i, s), tt.closeRing(this.rawArray), this.length < 4)
  ...
  static fromESRI(e, t) {
    return new tt(t, e.rings[0], R.fromESRI(e.spatialReference), !0);
  }
  toESRI() {
    return new ri({
      rings: [this.toArray()],
  ...
  static fromGeoJSON(e, t) {
    return new tt(t, e.coordinates, R.fromGeoJSON(e.crs), !0);
  }
  toGeoJSON() {
...
class he extends ot {
  ...
  get ringArray() {
    return this.rawArray.map((e, t) => new tt(this.childIdGenerator(t), e, this.sr, !0));
  }
  ...
  static parsePolygon(e) {
    ...
    if (e instanceof Le)
      ...
      t = e.map((i) => we.parsePointSet(i));
    } else
      throw new Error("invalid input format for parsePolygon");
    return t.forEach((i) => tt.closeRing(i)), t;
  }
  static arrayDeepCopy(e) {
    return e.map((t) => t.map((i) => i.slice()));
  }
  static fromESRI(e, t) {
    return new he(t, e.rings, R.fromESRI(e.spatialReference), !0);
  }
  toESRI() {
    return new ri({
      rings: this.toArray(),
  ...
  static fromGeoJSON(e, t) {
    return new he(t, e.coordinates, R.fromGeoJSON(e.crs), !0);
  }
  toGeoJSON() {
    return this.geoJsonFactory(K.POLYGON, this.toArray());
  }
...
class Ve extends ot {
  rawArray;
  constructor(e, t, i, s) {
    super(e, t.sr || i), s ? this.rawArray = Ve.arrayDeepCopy(t) : this.rawArray = Ve.parseMultiPolygon(t);
  }
  addPolygon(e) {
  ...
  static parseMultiPolygon(e) {
    ...
    if (e instanceof he)
      return [e.toArray()];
    if (e instanceof Le || e instanceof we)
  ...
  static fromESRI(e, t) {
    return new Ve(t, [e.rings], R.fromESRI(e.spatialReference), !0);
  }
  toESRI() {
    const e = [];
...
class X extends ot {
  ...
  expand(e) {
    return X.fromESRI(this.toESRI().expand(e), `${this.id}-expanded`);
  }
  clone() {
    return new X(this.id, this.rawMin, this.rawMax, this.sr);
  }
  /**
  ...
  static fromConfig(e, t) {
    return new X(
      ...
      [t.xmin, t.ymin],
      [t.xmax, t.ymax],
      R.fromConfig(t.spatialReference)
    );
  }
  isEqual(e) {
  ...
  static fromArcServer(e, t) {
    return X.fromESRI(bi.fromJSON(e), t);
  }
  ...
  static fromGeoJSON(e, t) {
    ...
    }), new X(t, i, s, R.fromGeoJSON(e.crs));
  }
  toGeoJSON() {
...
class je {
  ...
  get hex() {
    const e = this.rgba;
    return e[3] = e[3] * 255, `#${e.map((t) => je.intToHex(t)).join("")}`;
  }
  get r() {
    return this.c[0];
  }
...
class Ke extends ze {
  ...
  _angle;
  constructor(e) {
    if (e = e || { style: Ge.CIRCLE }, super(), this._style = e.style || Ge.CIRCLE, e.style === Ge.ICON) {
      const t = e;
      this._icon = t.icon || "", this._height = ze.convToPoints(t.height) || 16.5, this._width = ze.convToPoints(t.width) || 16.5, this._size = 0, this._colour = new je(), this._outline = new Fe(), this._path = "";
    } else {
      const t = e;
      this._size = ze.convToPoints(t.size) || 12, this._colour = new je(t.colour ?? "#ffffff40"), this._outline = new Fe(t.outline), this._path = this._style === Ge.PATH && t.path || "", this._height = 0, this._width = 0, this._icon = "";
    }
    this._xOffset = ze.convToPoints(e.xOffset) || 0, this._yOffset = ze.convToPoints(e.yOffset) || 0, this._angle = e.angle || 0;
  }
  ...
  propGrouse(e) {
    this._style === Ge.ICON !== e && console.warn(`Accessed a point style property that is invalid for the style type ${this._style}`);
  }
  toOptions() {
    const e = {
  ...
  toESRI() {
    let e;
    return this.styleType === Ge.ICON ? Ke.isImageUrl(this.icon) ? (e = new Cs(), e.url = this.icon, e.width = this.width, e.height = this.height, e.xoffset = this.xOffset, e.yoffset = this.yOffset, e.angle = this.angle) : (e = new Zt(), e.color = new Nt(this.colour.rgba), e.size = this.width, e.xoffset = this.xOffset, e.yoffset = this.yOffset, e.angle = this.angle) : (e = new Zt(), e.color = new Nt(this.colour.rgba), e.size = this.size, e.xoffset = this.xOffset, e.yoffset = this.yOffset, e.angle = this.angle, e.path = this.path, e.style = this.styleType, e.outline = this.outline.toESRI()), e;
  }
  static fromESRI(e) {
    const t = {
      xOffset: e.xoffset,
    ...
    if (e.type === "simple-marker") {
      const i = t;
      i.style = e.style, i.colour = e.color.toRgba(), i.size = e.size, i.path = e.path, i.outline = Fe.fromESRI(e.outline).toOptions();
    } else {
      const i = t;
      i.style = Ge.ICON, i.width = e.width, i.height = e.height, i.icon = e.url;
    }
    return new Ke(t);
  }
  static fromArcServer(e) {
    return Ke.fromESRI(ai(e));
  }
  /**
...
class Fe extends ze {
  ...
  _colour;
  constructor(e) {
    e = e || {}, super(), this._style = e.style || be.SOLID;
    const t = ze.convToPoints(e.width);
    this._width = typeof t > "u" || t < 0 ? 0.75 : t, this._colour = new je(e.colour), this._miter = e.miter ?? 2, this._cap = e.cap || qi.ROUND, this._join = e.join || Bi.ROUND;
  }
...
class St extends ze {
  ...
  _fillStyle;
  constructor(e) {
    super(), e = e || {}, e.fill || (e.fill = {}), this._fillColour = new je(e.fill.colour), this._fillStyle = e.fill.style || ji.SOLID, this._outlineStyle = new Fe(e.outline);
  }
  /** Returns the specified colour */
  get fillColour() {
  ...
  toESRI() {
    const e = this.outline.toESRI(), t = new Nt(this.fillColour.rgba), i = new Os();
  ...
  static fromESRI(e) {
    const t = {
      ...
      outline: Fe.fromESRI(e.outline).toOptions()
    };
    return new St(t);
  }
  static fromArcServer(e) {
    return St.fromESRI(ai(e));
  }
}
class qs {
  ...
  geomEsriToRamp(e, t) {
    switch (e.type) {
      ...
      case "polyline": {
        const i = e;
        return i.paths.length === 1 ? Xe.fromESRI(i, t) : Le.fromESRI(i, t);
      }
      case "polygon":
        return he.fromESRI(e, t);
      case "extent":
        return X.fromESRI(e, t);
      case "multipoint":
        return yt.fromESRI(e, t);
      default:
  ...
  geomGeoJsonToRamp(e, t) {
    switch (e.type) {
      ...
      case K.LINESTRING:
        return Xe.fromGeoJSON(e, t);
      case K.POLYGON:
        return he.fromGeoJSON(e, t);
      case K.MULTIPOINT:
        return yt.fromGeoJSON(e, t);
      case K.MULTILINESTRING:
        return Le.fromGeoJSON(e, t);
      case K.MULTIPOLYGON:
  ...
  graphicGeoJsonToRamp(e, t) {
    ...
    return Object.keys(e.properties.forEach((o) => s[o] = e.properties[o])), new Ce(i, "", s);
  }
  /**
  ...
  graphicRampToEsri(e) {
    ...
    return t.geometry = this.geomRampToEsri(e.geometry), Object.keys(e.attributes).forEach((i) => t.attributes[i] = e.attributes[i]), e.style && (t.symbol = this.styleRampToEsri(e.style)), new _s(t);
  }
  styleRampToEsri(e) {
    return e.toESRI();
  }
  styleEsriToRamp(e) {
    switch (e.type) {
      case "picture-marker":
      case "simple-marker":
        return Ke.fromESRI(e);
      case "simple-line":
        return Fe.fromESRI(e);
      case "simple-fill":
        return St.fromESRI(e);
      default:
        return console.error(`Unsupported ESRI symbol type encountered: ${e.type}`), new Ke();
    }
  }
...
class Wi {
   ...
   */
  isActive() {
    return this.sqlActiveFilters([ce.PERMANENT]).length > 0;
  }
  /**
   ...
   */
  setSql(e, t) {
    e === ce.PERMANENT ? console.error("Attempted to overwrite a permanent filter. Not allowed.") : (this.sql[e] = t, this.clearCacheSet(e));
  }
  /**
   ...
   */
  setExtent(e) {
    e.isEqual(this.extent) || (this.extent = e, this.clearCacheSet(ce.EXTENT));
  }
  /**
   ...
   */
  getCacheKey(e, t) {
    return `_cache$${e.sort().join("$")}${t ? "$" + ce.EXTENT : ""}$`;
  }
  /**
   ...
   */
  clearAll() {
    this.sql = { [ce.PERMANENT]: this.sql[ce.PERMANENT] }, this.extent = void 0, this.clearAllCaches();
  }
}
class It {
  id;
  ...
  static fromConfig(e) {
    return new It(
      e.id,
      X.fromConfig(`${e.id}-extent-default`, e.default),
      e.full !== void 0 ? X.fromConfig(`${e.id}-extent-full`, e.full) : void 0,
      e.maximum !== void 0 ? X.fromConfig(`${e.id}-extent-maximum`, e.maximum) : void 0
    );
  }
  clone() {
    return new It(this.id, this._defaultExtent, this._fullExtent, this._maximumExtent);
  }
}
class ie {
  realPromise;
...
class Gt {
   ...
   */
  updateQuery(e) {
    const t = Vi.all([{}, this.queryMap, e]);
...
class Ws {
  espgWorker;
  constructor() {
    this.espgWorker = this.defaultEpsgLookup, ge.defs(
      "EPSG:3978",
      "+proj=lcc +lat_1=49 +lat_2=77 +lat_0=49 +lon_0=-95 +x_0=0 +y_0=0 +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +units=m +no_defs"
    ), ge.defs(
      "EPSG:3979",
      "+proj=lcc +lat_1=49 +lat_2=77 +lat_0=49 +lon_0=-95 +x_0=0 +y_0=0 +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +units=m +no_defs"
    ), ge.defs("EPSG:54004", "+proj=merc +lon_0=0 +k=1 +x_0=0 +y_0=0 +ellps=WGS84 +datum=WGS84 +units=m +no_defs"), ge.defs("EPSG:102100", ge.defs("EPSG:3857")), ge.defs(
      "EPSG:102187",
    ...
    for (; e <= 60; ) {
      const t = e < 10 ? `0${e}` : e;
      ge.defs(`EPSG:326${t}`, `+proj=utm +zone=${e} +ellps=WGS84 +datum=WGS84 +units=m +no_defs`), e++;
    }
  }
  /**
   ...
   */
  addProjection(e, t) {
    e = typeof e == "number" ? `EPSG:${e}` : e, ge.defs(e, t);
  }
  ...
  async checkProj(e) {
    ...
    const a = async (n) => {
      try {
        ...
        return c === null || c === "" ? !1 : (ge.defs(n, c), !0);
      } catch {
        return !1;
      }
    };
  ...
  async projectGeoJson(e, t, i) {
    let s, a;
    if (t ? s = this.normalizeProj(t) : s = R.parseGeoJsonCrs(e.crs), i ? a = this.normalizeProj(i) : a = Hs, a === s)
      return e;
    await this.checkProjBomber([s, a]);
    const o = ge(s, a).forward;
    return Ms(e, o);
  }
  /**
  ...
  async projectGeometry(e, t) {
    ...
    const i = t.toGeoJSON(), s = await this.projectGeoJson(i, this.normalizeProj(t.sr), this.normalizeProj(e)), a = it.geom.geomGeoJsonToRamp(s, t.id);
    return a.sr = R.parseSR(e), a;
  }
  /**
  ...
  async projectExtent(e, t) {
    const i = (y, A, b) => {
      if (b === 0)
        return [y, A];
      const P = [(y[0] + A[0]) / 2, (y[1] + A[1]) / 2];
      if (b === 1)
        return [y, P, A];
      if (b > 1) {
        const q = i(y, P, b - 1), L = i(P, A, b - 1);
        return q.concat(L.slice(1));
      }
      return [[]];
    }, s = t.toPolygonArray().pop() || [];
    let a = [];
    [0, 1, 2, 3].map((y) => i(s[y], s[y + 1], 3).slice(1)).forEach((y) => a = a.concat(y));
    const o = new he("warpy", [a], t.sr, !0), l = await this.projectGeometry(e, o), n = l.toArray().pop() || [], c = n.map((y) => y[0]), u = n.map((y) => y[1]), p = Math.min.apply(null, c), d = Math.max.apply(null, c), m = Math.min.apply(null, u), h = Math.max.apply(null, u);
    return X.fromParams(t.id + "_projected", p, m, d, h, l.sr);
  }
}
class Ys {
  // useful functions
  ...
  sharedUtils;
  constructor() {
    this.proj = new Ws(), this.geom = new qs(), this.sharedUtils = new js();
  }
  defaultTileSchemas() {
...
const Ut = W("appbar", () => {
  ...
  const r = f([]), e = f([]), t = f([]);
  function i(p) {
    return Ht(r.value, (d) => d?.uid === p);
  }
  function s(p) {
    return Ht(r.value, (d) => d?.id === p);
  }
  function a(p) {
    return Ht(
      r.value,
  ...
  function n(p, d) {
    ...
    const m = t.value.findIndex((h) => h === p.id);
    m !== -1 && m !== d && (t.value.splice(m, 1), t.value.splice(d, 0, p.id), t.value = [...t.value]);
  }
  function c(p) {
    const d = r.value.filter((m) => m.id !== p.id || m.uid !== p.uid);
    if (r.value = d, p.mapLayer) {
      const m = t.value.filter((h) => h !== p.id);
      t.value = m;
    }
  }
  function u(p) {
    const d = e.value.filter((m) => m.id !== p);
    e.value = d;
  }
  return {
    /**
  ...
  function n(c, u) {
    ...
    if (d.length) {
      const m = d[0];
      u.forEach((h) => {
        const y = d.includes(h) ? h : m;
        i.value[h] = p[y], s.value[h] = y;
      });
    } else
...
class Qs extends re {
  ...
  _funCounter;
  constructor(e) {
    super(e), this._eventBus = new hs(), this._eventRegister = [], this._funCounter = 1, this._nameRegister = Object.values(x).filter((t) => typeof t == "string" && t.indexOf("/") > -1);
  }
  /**
   ...
   */
  addDefaultEvents(e) {
    return (!Array.isArray(e) || e.length === 0) && (e = Object.values(Qt)), e.map((t) => this.defaultHandlerFactory(t));
  }
  /**
  ...
  defaultHandlerFactory(e) {
    ...
    switch (e) {
      ...
      case "ramp_layer_remove_checks_grid":
        t = (i) => {
          if (this.$iApi.fixture.get("grid")) {
            const s = Xt(this.$vApp.$pinia), a = s.getGridId(i.id);
            if (a === void 0) return;
      ...
      case "ramp_map_basemap_updates_map_attribs":
        t = () => {
          this.$iApi.geo.map.caption.updateAttribution(
            Ae(this.$vApp.$pinia).activeBasemapConfig?.attribution
          );
        }, this.$iApi.event.on("map/basemapchanged", t, e);
        break;
      ...
      case "ramp_map_created_initializes_fixtures":
        t = () => {
          const i = xe(this.$vApp.$pinia).items;
      ...
      case "ramp_map_resize_updates_scalebar":
        this.$iApi.event.on(
          "map/resized",
          Ft(100, () => this.$iApi.geo.map.caption.updateScale()),
          e
        );
        break;
      case "ramp_map_scale_updates_scalebar":
        this.$iApi.event.on(
          "map/scalechanged",
          Ft(300, () => this.$iApi.geo.map.caption.updateScale()),
          e
        );
        break;
      case "ramp_panel_close_updates_appbar":
        t = (i) => {
          const s = Ut(this.$vApp.$pinia);
...
function sr() {
  let r = document.documentElement.getAttribute("lang") || Wt;
  return tr.includes(r) || (r = Wt), Ps({
    legacy: !1,
    locale: r,
    fallbackLocale: Wt,
    globalInjection: !0,
...
const Vt = W("maptip", () => {
  ...
  __name: "esri-map",
  setup(r) {
    const e = Vt(), t = _e("iApi"), i = G(() => e.maptipPoint), s = G(() => e.maptipInstance), a = G(() => e.content), o = $e([]), l = f(!1);
    o.push(
      Pt(i, () => {
        if (i.value) {
          const c = t.geo.map.getPixelWidth() / 2, u = 0, p = t.geo.map.mapPointToScreenPoint(i.value), d = p.screenX - c, m = u - p.screenY;
          s.value.setProps({
            // Offset more for touch devices so tooltip is visible above finger
            offset: l.value ? [d, m + 25] : [d, m]
  ...
  constructor(e) {
    this.resizeObserver = new ResizeObserver((t) => {
      t.length && window.requestAnimationFrame(() => {
        t.forEach((i) => {
          const s = i.target.dataset.breakpoints, a = s ? JSON.parse(s) : e ?? ar;
...
const or = ["data-cy"], Zi = /* @__PURE__ */ D({
  ...
  setup(r) {
    ...
    return (n, c) => {
      const u = U("focus-container");
      return v(), w("div", {
        class: ue(["shadow-tm bg-white h-full xs:mr-0 sm:mr-12 last:mr-0 pointer-events-auto min-w-0 shrink-0", r.panel.expanded ? "flex-grow max-w-full" : ""]),
        style: Ni(r.panel.style),
        "data-cy": r.panel.id,
        ref_key: "componentEl",
        ref: e
      }, [
        me(Fi, {
          ...
          default: pe(() => [
            V((v(), ee(gs(r.panel.route.screen), vs({ class: "h-full" }, r.panel.route.props, { panel: r.panel }), null, 16, ["panel"])), [
              [u]
            ])
          ]),
          _: 1
  ...
  const r = f(void 0), e = f(void 0), t = f(0), i = f(0), s = f(!1), a = f(!0), o = f({}), l = f({}), n = f([]), c = f([]), u = f([]), p = f(1), d = G(() => i.value);
  function m(E) {
  ...
  function h(E) {
    const O = [];
    return E.forEach((Y) => {
      Y in l.value && O.push(l.value[Y].getPromise());
    }), O;
  }
  function y(E) {
    _(E), k(), e.value = void 0;
  }
  function A(E) {
    T(E), k();
  }
  ...
  function k() {
    let E = t.value;
    const O = [], Y = 350, ve = 12, Oe = 600;
    for (let Ee = n.value.length - 1; Ee >= 0; Ee--) {
      const We = n.value[Ee];
      let Te = We.width || Y;
      if (s.value ? Te = E : Te += ve, We.id === "grid" && (Te = Math.max(Math.min(Te, E), Oe)), (E >= Te && !s.value || O.length === 0) && (E -= Te, O.unshift(We)), We.id === "grid" && E < Oe)
        break;
    }
    if (r.value && //@ts-expect-error TODO: explain why this is needed or remove
    !O.includes(r.value) && !s.value) {
      let Ee;
      for (let De = 0; De < O.length - 1 && E < (r.value.width || Y) + ve; De++)
        Ee = O.shift(), E += Ee.width || Y;
      E >= (r.value.width || Y) ? O.unshift(r.value) : e.value || (Ee = O.shift(), O.unshift(r.value));
      const We = n.value.indexOf(r.value), Te = n.value.indexOf(Ee), wt = n.value.slice();
      Te > -1 && (wt.splice(We, 1), wt.splice(Te, 0, r.value)), n.value = wt;
    }
    i.value = E, u.value = O;
  }
  function F(E) {
  ...
  function T(E) {
    if (E.teleport) {
      const O = c.value.indexOf(E);
      O !== -1 && (c.value = [...c.value.slice(0, O), ...c.value.slice(O + 1)]);
    } else {
      const O = n.value.indexOf(E);
      O !== -1 && (n.value = [...n.value.slice(0, O), ...n.value.slice(O + 1)]);
    }
  }
  function C(E, O) {
    const Y = n.value.indexOf(E), ve = O === "right" ? 1 : -1;
    u.value.includes(n.value[Y + ve]) && ([n.value[Y], n.value[Y + ve]] = [
      n.value[Y + ve],
      n.value[Y]
    ]);
  }
  function z(E) {
    ...
    O !== -1 && (u.value = [...u.value.slice(0, O), ...u.value.slice(O + 1)]), r.value && r.value.id == E.id && (r.value = void 0);
  }
  function J(E) {
    l.value = {
      ...l.value,
  ...
  setup(r) {
    ...
    const e = rt(), t = _e("iApi"), i = f(), s = G(() => e.opacity), a = G(() => e.mobileView);
    at(() => {
    ...
    const o = (u) => (
      ...
      const [d, m] = [u.children[0].getBoundingClientRect(), u.parentElement.getBoundingClientRect()];
      u.style.width = `${d.width}px`, u.style.height = `${d.height}px`, u.style.left = `${d.left - m.left}px`, u.style.position = "absolute", c(u, p, [
        [0, -6],
        [1, 0]
      ]);
    }, c = (u, p, d) => {
    ...
    return (u, p) => (v(), ee(Di, {
      ...
      default: pe(() => [
        (v(!0), w(st, null, At(o(I(t).screenSize), (d) => (v(), ee(Zi, {
          key: `${d.id}`,
          panel: d
        }, null, 8, ["panel"]))), 128))
      ]),
  ...
  for (const [i, s] of e)
    t[i] = s;
  return t;
}, lr = /* @__PURE__ */ He(nr, [["__scopeId", "data-v-717e4bd7"]]), cr = ["content", "aria-label"], oi = /* @__PURE__ */ D({
  ...
  setup(r) {
    const e = f(!1), t = f(null), i = $e([]), s = f(), a = f(), o = f(), l = r;
    i.push(
      Pt(e, () => {
        t.value.update();
      })
    ...
    return at(() => {
      window.addEventListener(
        ...
        (!s.value || !s.value.contains(p.target)) && (e.value = !1);
      }), o.value.addEventListener("focus", c), o.value.addEventListener("blur", u), o.value.addEventListener("mouseover", c), o.value.addEventListener("mouseleave", u), Tt(() => {
        const p = {
          name: "overflowScroll",
          enabled: !0,
          phase: "main",
          fn({ state: d }) {
            const { bottom: m } = Vs(d);
            m > 0 ? (d.styles.popper.overflowY = m > 100 ? "auto" : void 0, d.styles.popper.overflowX = "hidden", d.styles.popper.height = `${d.rects.popper.height - m - 8}px`) : d.styles.popper.height = "auto";
          }
        };
        o.value && a.value && (t.value = Us(o.value, a.value, {
      ...
      return v(), w("div", {
        ...
        V(g("div", {
          ...
          class: ue(["rv-dropdown shadow-md border border-gray:200 py-8 bg-white rounded z-10", { "text-center": r.centered }]),
          ref_key: "dropdown",
          ref: a
        }, [
          Be(p.$slots, "default", {
  ...
  let r = 0;
  const e = f([]), t = f({}), i = G(() => e.value.length >= 99 ? 99 : e.value.length);
  function s(u) {
  ...
  function a(u) {
    if (e.value.includes(u)) {
      ...
      u instanceof Xi && c(u), p > -1 && e.value.splice(p, 1);
    }
  }
  function o(u) {
    t.value[u.id] = u;
...
}), ur = { class: "h-full flex flex-col" }, pr = { class: "w-full flex mb-6" }, dr = ["content", "aria-label"], hr = /* @__PURE__ */ D({
  __name: "screen",
  props: {
    panel: {
      type: Object,
  ...
  setup(r) {
    const e = qe(), { t } = se(), i = G(() => e.notificationNumber), s = () => e.clearAll();
    return (a, o) => {
      const l = ae("panel-screen"), n = U("tippy");
      return v(), ee(l, { panel: r.panel }, {
        header: pe(() => [
          ft(B(I(t)("notifications.title")), 1)
        ]),
        content: pe(() => [
          g("div", ur, [
            g("div", pr, [
              V((v(), w("button", {
                ...
                g("svg", {
                  ...
                  g("path", { d: "M13 17h-9a4 4 0 0 0 2 -3v-3a7 7 0 0 1 4 -6a2 2 0 1 1 4 0a7 7 0 0 1 4 6v2" }),
                  g("path", { d: "M9 17v1a3 3 0 0 0 4.194 2.753" }),
                  g("path", { d: "M22 22l-5 -5" }),
                  g("path", { d: "M17 22l5 -5" })
                ], -1)
              ]), 10, dr)), [
                [n, {
...
var Se = /* @__PURE__ */ ((r) => (r.ERROR = "error", r.INFO = "info", r.WARNING = "warning", r))(Se || {});
class fr extends re {
  notificationStore;
  /**
  ...
  constructor(e) {
    super(e), this.$iApi.panel.register({
      ...
      config: {
        screens: {
          "notifications-screen": ne(hr)
        },
        alertName: "notifications.title"
      }
    }), this.notificationStore = qe(this.$vApp.$pinia);
  }
  /**
  ...
  addGroup(e, t, i) {
    ...
    const s = new Xi(this.$iApi, e, t, i);
...
class Xi extends re {
  notificationStore = qe(this.$vApp.$pinia);
  id;
  message;
  type;
  messageList = [];
...
const mr = ["content"], yr = { class: "flex items-center text-left" }, gr = { class: "select-text cursor-text" }, vr = ["content", "aria-label"], br = {
  key: 0,
  class: "text-left"
}, Ar = /* @__PURE__ */ D({
  ...
  setup(r, { emit: e }) {
    ...
    return (n, c) => {
      const u = U("tippy");
      return V((v(), w("li", {
        class: ue(["flex-col default-focus-style p-4", r.notification.messageList ? "cursor-pointer" : ""]),
        content: I(t)(a.value ? "notifications.controls.collapse" : "notifications.controls.expand"),
        onClick: c[1] || (c[1] = (p) => a.value = !a.value)
      }, [
        g("div", yr, [
          g("span", null, [
            ft(B(o[r.notification.type]) + " ", 1),
            g("span", gr, B(r.notification.message), 1)
          ]),
          c[4] || (c[4] = g("span", { class: "flex-grow" }, null, -1)),
          r.notification.messageList ? (v(), w("div", {
            key: 0,
            class: ue(["dropdown-icon p-4 pointer-events-none", { "transform -rotate-180": a.value }])
          }, c[2] || (c[2] = [
            g("svg", {
              xmlns: "http://www.w3.org/2000/svg",
              height: "24",
              ...
              g("path", { d: "M7.41 8.59L12 13.17l4.59-4.58L18 10l-6 6-6-6 1.41-1.41z" })
            ], -1)
          ]), 2)) : j("", !0),
          V((v(), w("button", {
            type: "button",
            onClick: c[0] || (c[0] = si(() => i("remove"), ["stop"])),
  ...
  setup(r) {
    const e = qe(), { t } = se(), i = f(), s = f({}), a = () => {
      ...
      p && Tt(() => {
        ...
        if (d) {
          const m = new CustomEvent("switchFocusItem", { detail: { focusItem: d }, bubbles: !0 });
          d.dispatchEvent(m);
        }
      });
    };
    ...
    const n = G(() => e.notificationStack);
    return (c, u) => {
      const p = U("focus-item"), d = U("focus-list"), m = U("tippy");
      return v(), w("div", null, [
        n.value.length > 0 ? V((v(), w("ul", {
          key: 0,
          ...
          (v(!0), w(st, null, At(n.value, (h, y) => (v(), w(st, {
            key: h.id
          }, [
            y > 0 ? (v(), w("div", Er)) : j("", !0),
            V(me(Ar, {
          ...
          [d],
          [m, { trigger: "manual", placement: "top-start", touch: !1 }]
        ]) : (v(), w("div", xr, [
          u[0] || (u[0] = g("span", { class: "flex-grow" }, null, -1)),
          u[1] || (u[1] = g("svg", {
            xmlns: "http://www.w3.org/2000/svg",
            viewBox: "0 0 24 24",
            ...
            g("path", { d: "M18 7l-1.41-1.41-6.34 6.34 1.41 1.41L18 7zm4.24-1.41L11.66 16.17 7.48 12l-1.41 1.41L11.66 19l12-12-1.42-1.41zM.41 13.41L6 19l1.41-1.41L1.83 12 .41 13.41z" })
          ], -1)),
          g("span", null, B(I(t)("notifications.empty")), 1),
          u[2] || (u[2] = g("span", { style: { "flex-grow": "6" } }, null, -1))
        ]))
      ]);
    };
  }
}), Sr = { class: "flex items-center hover:text-white" }, Ir = ["aria-label"], _r = {
  key: 0,
  class: "number rounded-full w-18 text-white"
}, Tr = { class: "notification-dropdown pointer-events-auto bg-white rounded text-center text-black w-500 h-256 flex flex-col p-0" }, Lr = { class: "pb-8 border-b border-gray-600" }, Rr = { class: "absolute flex right-3 top-3" }, $r = ["content", "aria-label"], Cr = /* @__PURE__ */ D({
  __name: "caption-button",
  setup(r) {
    const e = qe(), { t } = se(), i = G(() => e.notificationNumber), s = () => e.clearAll();
    return (a, o) => {
      const l = ae("close"), n = U("tippy");
      return v(), ee(oi, {
        position: "top-start",
        ...
        header: pe(() => [
          g("div", Sr, [
            (v(), w("svg", {
              ...
              g("path", { d: "M12 22c1.1 0 2-.9 2-2h-4c0 1.1.89 2 2 2zm6-6v-5c0-3.07-1.64-5.64-4.5-6.32V4c0-.83-.67-1.5-1.5-1.5s-1.5.67-1.5 1.5v.68C7.63 5.36 6 7.92 6 11v5l-2 2v1h16v-1l-2-2z" }, null, -1)
            ]), 8, Ir)),
            i.value && i.value > 0 ? (v(), w("span", _r, B(i.value), 1)) : j("", !0)
          ])
        ]),
        default: pe((c) => [
          g("div", Tr, [
            g("div", null, [
              g("h4", Lr, B(I(t)("notifications.title")), 1),
              g("div", Rr, [
                V((v(), w("button", {
                  type: "button",
                  onClick: s,
            ...
            me(Qi, { class: "overflow-y-auto h-230" })
          ])
        ]),
        _: 1
      }, 8, ["tooltip"]);
...
}), Or = /* @__PURE__ */ He(Cr, [["__scopeId", "data-v-3623a7d2"]]), kr = { class: "flex hover:text-white" }, Mr = ["aria-label"], Pr = { class: "about-ramp-dropdown pointer-events-auto bg-white rounded w-256 h-50" }, Nr = ["aria-label", "content"], Fr = { class: "pb-8 pt-1 border-b border-gray-600 mb-10" }, Dr = { class: "absolute right-5 top-5" }, Gr = { class: "select-text" }, Ur = { class: "font-bold cursor-text" }, Vr = { class: "text-sm cursor-text" }, zr = { class: "font-bold cursor-text" }, Br = { class: "ml-5 cursor-text" }, qr = /* @__PURE__ */ D({
  ...
  setup(r) {
    const { t: e } = se(), t = _e("iApi"), i = () => {
      t.reload();
    }, s = G(() => `${xt.major}.${xt.minor}.${xt.patch}`), a = G(() => xt.hash.slice(0, 9)), o = G(() => {
      const l = new Date(xt.timestamp);
      if (isNaN(l.getTime()))
    ...
    return (l, n) => {
      const c = ae("close"), u = ae("dropdown-menu"), p = U("tippy"), d = U("focus-item");
      return V((v(), ee(u, {
            ...
            g("div", null, [
              V((v(), w("button", {
                ...
                g("svg", {
                  ...
                  g("path", { d: "M17.65 6.35C16.2 4.9 14.21 4 12 4c-4.42 0-7.99 3.58-7.99 8s3.57 8 7.99 8c3.73 0 6.84-2.55 7.73-6h-2.08c-.82 2.33-3.04 4-5.65 4-3.31 0-6-2.69-6-6s2.69-6 6-6c1.66 0 3.14.69 4.22 1.78L13 11h7V4l-2.35 2.35z" })
                ], -1)
              ]), 8, Nr)), [
                [p, {
              ...
              g("div", Gr, [
                g("div", null, [
                  g("span", Ur, B(s.value), 1),
                  g("span", Vr, " [" + B(a.value) + "] ", 1)
                ]),
                g("div", null, [
                  g("span", zr, B(o.value[0]), 1),
                  g("span", Br, B(o.value[1]), 1)
                ]),
                n[2] || (n[2] = g("div", { class: "mt-5" }, [
                  g("a", {
...
}), jr = /* @__PURE__ */ He(qr, [["__scopeId", "data-v-e0d1ce9f"]]), Hr = "S", Wr = "__HELP__", es = W("keyboardnav", () => {
  const r = f(), e = f({}), t = f(!1), i = f([]), s = f(), a = f("idle"), o = ["H", "?"];
  function l() {
    const _ = "ABCDEFGHIJKLMNOPQRSTUVWXYZ";
    for (const T of _)
      if (!e.value[T] && !o.includes(T)) return T;
  }
  function n(_, T) {
    let C = _.toUpperCase();
    if (o.includes(C) || e.value[C]) {
      const z = l();
      z ? C = z : console.error("No available keyboard namespace letters");
    }
    if (!T.handler)
      for (const z of T.keys)
        z.handler || console.error(
          `Keyboardnav registration for ${C} requires handlers for all keys or a parent handler`
        );
    return e.value[C] = T, C;
  }
  function c(_) {
    t.value !== _ && (t.value = _);
  }
  ...
  function p(_, T, C) {
    if (_) {
      if (_ === "clear") {
        y({ event: T, suppressHandler: !0 });
        return;
      }
      if (_ === "reset") {
        const z = C ?? F.activeNamespace ?? F.keyChain[1];
        if (!z) {
          y({ suppressHandler: !0 });
          return;
        }
        A([Hr, z]), q(void 0), L("awaitAction"), F.activeNamespace = z;
      }
    }
  }
  function d(_, T, C) {
    r.value = _, !C?.suppressHandler && e.value[_]?.activeHandler?.(F, T);
  }
  function m(_, T) {
    r.value && !T?.suppressHandler && e.value[r.value]?.deactiveHandler?.(F, _), r.value = void 0;
  }
  function h(_, T) {
    const C = r.value;
    if (!C) return;
    ...
    if (!z) return;
    if (z.handler) {
      const O = z.handler(F, T, _);
      return p(O, T, C), { namespace: C, key: _, chainAction: O ?? void 0 };
    }
    const J = z.keys.find((O) => O.key === _);
    if (!J)
      return;
    const E = J.handler?.(F, T);
    return p(E, T, C), { namespace: C, key: J.key, chainAction: E ?? void 0 };
  }
  function y(_) {
    m(_?.event, { suppressHandler: _?.suppressHandler }), _?.preserveChain || (i.value = []), _?.preserveLastAction || (s.value = void 0), a.value = "idle";
  }
  function A(_) {
    i.value = [..._];
  }
  ...
  function N(_) {
    m(_?.event, { suppressHandler: !0 }), a.value = "complete";
  }
  const k = {
    activeNamespace: r,
    namespaces: e,
  ...
  return k;
}), Yr = { class: "map-caption absolute bottom-0 h-29 sm:h-38 flex justify-end pointer-events-auto cursor-default select-none text-gray-200 bg-black-75 left-0 right-0 py-2 sm:py-6" }, Jr = {
  key: 0,
  class: "relative top-2 sm:top-1 ml-4 sm:ml-0 shrink-0"
}, Kr = ["href", "aria-label"], Zr = ["src", "alt"], Xr = {
  key: 1,
  class: "relative ml-10 top-2 text-sm sm:text-base font-mono flex items-center gap-2",
  "aria-live": "polite"
}, Qr = { class: "chain-content" }, ea = { class: "chain-keys" }, ta = {
  key: 0,
  class: "chain-cursor"
}, ia = {
  key: 1,
...
}, aa = { class: "flex min-w-fit justify-end" }, oa = {
  key: 0,
  class: "pl-8 px-14 sm:block display-none relative top-2"
}, na = ["aria-pressed", "aria-label", "content"], la = { class: "relative top-1 text-sm sm:text-base" }, ca = { class: "text-gray-200 hover:text-white text-sm sm:text-base pb-5" }, ua = ["onClick"], pa = {
  key: 0,
  class: "sr-only"
}, da = /* @__PURE__ */ D({
  __name: "map-caption",
  setup(r) {
    const e = Ze(), t = es(), i = Ae(), { t: s } = se(), a = _e("iApi"), o = G(() => e.scale), l = G(() => e.attribution), n = G(() => e.coords), c = G(() => e.langtoggle), u = G(() => i.config.map), { keyChain: p, lastAction: d, chainState: m, namespaces: h, activeNamespace: y } = fs(t), A = G(() => {
      if (!p.value.length) return;
      const F = p.value.join(" "), _ = m.value === "awaitNamespace" || m.value === "awaitAction";
      let T;
      const C = d.value;
      if (C)
        if (C.namespace === Wr)
          T = s("keyboardnav.chain.help");
        else {
          const J = `keyboardnav.key.${C.namespace}.${C.key}`, E = s(J);
          E !== J && (T = E);
        }
      let z;
      if (m.value === "awaitNamespace") {
        const J = `H - ${s("keyboardnav.chain.help")}`, E = Object.keys(h.value).map((Y) => {
          const ve = `keyboardnav.ns.${Y}`, Oe = s(ve);
          return `${Y} - ${Oe === ve ? Y : Oe}`;
        });
        z = `[${[J, ...E].join(", ")}]`;
      } else if (m.value === "awaitAction") {
        const J = y.value ?? p.value[1], E = J ? h.value[J] : void 0;
        E && E.keys?.length && (z = `[${E.keys.map((Y) => {
          const ve = `keyboardnav.key.${J}.${Y.key}`, Oe = s(ve), Ee = Oe === ve ? Y.key : Oe;
          return `${Y.key} - ${Ee}`;
        }).join(", ")}]`);
      }
      return {
    ...
    P.push(
      ...
      Tt(() => {
        a.$i18n.locale.value && b.value.length == 0 && (b.value = a.$i18n.availableLocales);
      });
    });
    const q = () => l.value?.logo?.link && l.value?.logo?.value && !l.value?.logo?.disabled, L = (F) => {
      a.$i18n.locale.value != F && a.setLanguage(F);
    }, N = () => {
      e.toggleScale(), a.geo.map.caption.updateScale();
    }, k = (F = !1) => s(F ? "map.toggleScaleToMetric" : "map.toggleScaleToImperial");
    return (F, _) => {
      const T = ae("dropdown-menu"), C = U("truncate"), z = U("tippy");
      return v(), w("div", Yr, [
        me(jr, {
          class: "sm:block display-none ml-8 mr-4",
          position: "top-end"
        }),
        me(Or, { class: "sm:block display-none" }),
        q() ? (v(), w("span", Jr, [
          g("a", {
        ...
        A.value ? (v(), w("span", Xr, [
          g("span", Qr, [
            _[0] || (_[0] = g("span", { class: "chain-colon" }, ":", -1)),
            g("span", ea, B(A.value.keys), 1),
            A.value.cursor ? (v(), w("span", ta, "_")) : j("", !0),
            A.value.options ? (v(), w("span", ia, B(A.value.options), 1)) : j("", !0)
          ]),
          A.value.description ? (v(), w("span", sa, "- " + B(A.value.description) + "...", 1)) : j("", !0)
        ])) : l.value?.text.disabled ? j("", !0) : V((v(), w("span", ra, [
          ft(B(l.value?.text.value), 1)
        ])), [
          [C, {
            options: {
              placement: "top",
        ...
        _[1] || (_[1] = g("span", { class: "flex-grow w-15" }, null, -1)),
        g("div", aa, [
          n.value?.disabled ? j("", !0) : V((v(), w("div", oa, [
            ft(B(n.value?.formattedString), 1)
          ])), [
            [C, {
              options: {
                hideOnClick: !1,
          ...
          o.value?.disabled ? j("", !0) : V((v(), w("button", {
            key: 1,
            type: "button",
            ...
            "aria-label": `
                    ${o.value?.label} - ${k(o.value?.isImperialScale)}
                `,
            content: k(o.value?.isImperialScale)
          }, [
            g("span", {
              class: "border-solid border-2 border-white border-t-0 h-5 mr-4 inline-block",
              style: Ni({ width: o.value?.width })
            }, null, 4),
            g("span", la, B(o.value?.label), 1)
          ], 8, na)), [
            [z, {
              delay: [300, 0],
              placement: "top",
          ...
          c.value?.disabled ? j("", !0) : (v(), ee(T, {
            ...
            header: pe(() => [
              g("span", ca, B(I(s)("map.language.short")), 1)
            ]),
            default: pe(() => [
              (v(!0), w(st, null, At(b.value, (J, E) => (v(), w("a", {
                key: `${J}-${E}`,
                class: ue(["flex-auto items-center text-sm sm:text-base cursor-pointer", { "font-bold": J === I(a).$i18n.locale.value }]),
                href: "javascript:;",
                onClick: (O) => L(J)
              }, [
                ft(B(I(s)("map.language." + J)) + " ", 1),
                J === I(a).$i18n.locale.value ? (v(), w("span", pa, B(I(s)("map.language.curr")), 1)) : j("", !0)
              ], 10, ua))), 128))
            ]),
            _: 1
          }, 8, ["tooltip", "ariaLabel"]))
    ...
    return (a, o) => {
      ...
      return V((v(), w("button", {
        ...
        o[1] || (o[1] = g("svg", {
          ...
          g("path", { d: "M12 22c1.1 0 2-.9 2-2h-4c0 1.1.89 2 2 2zm6-6v-5c0-3.07-1.64-5.64-4.5-6.32V4c0-.83-.67-1.5-1.5-1.5s-1.5.67-1.5 1.5v.68C7.63 5.36 6 7.92 6 11v5l-2 2v1h16v-1l-2-2z" })
        ], -1)),
        s.value && s.value > 0 ? (v(), w("span", fa, B(s.value), 1)) : j("", !0)
      ], 8, ha)), [
        [l]
      ]);
    };
  }
}), ya = /* @__PURE__ */ He(ma, [["__scopeId", "data-v-a451db5c"]]), ga = { class: "flex items-center mb-20" }, va = { class: "text-xl" }, ba = /* @__PURE__ */ D({
  __name: "keyboard-instructions",
  setup(r) {
    const e = _e("iApi"), { t } = se(), i = f(!1), s = f(["app", "lists", "map", "keyboardNav"]), a = f([]), o = f(null), l = f(null);
    at(() => {
      a.value.push(
    ...
    return (c, u) => {
      ...
      return i.value ? (v(), w("div", {
        ...
        g("div", {
          ...
          g("div", ga, [
            g("h2", va, B(I(t)("keyboardInstructions.title")), 1),
            me(p, {
              class: "ml-auto",
              onClick: u[0] || (u[0] = (d) => i.value = !1)
            })
          ]),
          (v(!0), w(st, null, At(s.value, (d) => (v(), w("p", {
            class: "whitespace-pre-line pb-10",
            key: d
          }, B(I(t)(`keyboardInstructions.${d}`)), 1))), 128)),
          g("button", {
            type: "button",
            ...
            ref_key: "lastEl",
            ref: l
          }, B(I(t)("keyboardInstructions.OK")), 513)
        ], 512)
      ], 32)) : j("", !0);
    };
  }
}), pt = W("instance", () => ({ started: f(!1) })), Aa = { class: "h-full relative" }, wa = { class: "inner-shell absolute top-0 left-0 h-full w-full pointer-events-none" }, Ea = { class: "absolute top-8 w-full flex justify-center" }, xa = {
  key: 1,
  class: "w-full h-full"
}, Sa = /* @__PURE__ */ D({
  __name: "shell",
  setup(r) {
    const e = _e("iApi"), t = pt(), i = xe(), s = rt(), { t: a } = se(), o = G(() => i.items.appbar), l = () => {
      e.event.emit("openKeyboardInstructions");
    }, n = () => s.teleported;
    return (c, u) => (v(), w("div", Aa, [
      g("div", wa, [
        u[0] || (u[0] = g("div", { class: "sr-only screen-reader-alert" }, null, -1)),
        g("div", Ea, [
          g("button", {
            type: "button",
            class: "bg-white hidden-until-focus z-50 shadow-md px-10",
            onClick: l
          }, B(I(a)("keyboardInstructions.open")), 1)
        ]),
        me(ba, { class: "keyboard-instructions-modal" }),
        me(lr, { class: "panel-stack sm:flex absolute inset-0 overflow-hidden sm:p-12 z-10 sm:pl-80 xs:pl-40 sm:pb-48 xs:pb-28 xs:pr-0 sm:pr-40" }),
        o.value ? j("", !0) : (v(), ee(ya, { key: 0 })),
        me(da, { class: "z-30" })
      ]),
      I(t).started ? (v(), ee(rr, { key: 0 })) : (v(), w("div", xa, u[1] || (u[1] = [
        g("div", { class: "spinner relative inset-x-1/2 inset-y-9/20" }, null, -1)
      ]))),
      (v(!0), w(st, null, At(n(), (p) => (v(), ee(Es, {
...
}), Ia = /* @__PURE__ */ He(Sa, [["__scopeId", "data-v-3d441124"]]), _a = D({
  name: "App",
  components: { Shell: Ia },
  setup() {
    const r = xs();
    at(() => {
      new Ki().observe(r?.proxy?.$refs["app-size"]), Fs({
        aria: {
          content: "labelledby"
        },
        theme: "ramp4",
...
const $a = /* @__PURE__ */ He(_a, [["render", Ra]]), Me = "focus-list", Ye = "focus-item", Ca = "focus-icon", Oa = "focus-container", gt = `[${Me}],[${Oa}]`, Rt = "truncate-text", $t = "show-truncate", ht = "focused", ei = `button,input,select,a,textarea,[contenteditable],[${Me}],[${Ca}],[tabindex]`, ka = {
  mounted(r, e) {
    +r.getAttribute("tabindex") <= 0 && r.setAttribute("tabindex", "0"), r.toggleAttribute(Me, !0), new Ma(r, e.value);
  },
  updated(r) {
    ts(r);
  }
...
function ts(r) {
  r.querySelectorAll(ei).forEach((t) => {
    if (t.closest(gt) === r || t.closest(gt) === t && t.parentElement.closest(gt) === r)
      if (t.closest(`[${Me}],.${ht}`).classList.contains(ht))
...
class Ma {
  ...
  setTabIndex(e, t = this.element) {
    t.querySelectorAll(ei).forEach((s) => {
      (e === -1 || s.closest(gt) === this.element || s.closest(gt) === s && s.parentElement.closest(gt) === this.element || s.closest(`[${Me}],.${ht}`).classList.contains(ht)) && s.setAttribute("tabindex", e.toString());
    });
  }
  /**
   ...
   */
  defocusItem(e) {
    e.classList.remove(ht), this.setTabIndex(-1, e), e._tippy && e._tippy.hide(), e.getAttribute(Ye) === $t && e.querySelector(`[${Rt}]`)?._tippy?.hide();
  }
  /**
   ...
   */
  focusItem(e) {
    e.classList.add(ht), this.setAriaActiveDescendant(e), this.setTabIndex(0, e), e.scrollIntoView({ block: "nearest" }), e._tippy && !this.isTapped && e._tippy.show(), e.getAttribute(Ye) === $t && e.querySelector(`[${Rt}]`)?._tippy?.show(), this.isTapped = !1;
  }
  /**
  ...
  onKeydown(e) {
    const t = this, i = Array.prototype.filter.call(
      this.element.querySelectorAll(`[${Ye}]`),
      (s) => s.closest(`[${Me}]`) === t.element && !!s.offsetParent
    );
    if (i.length !== 0)
      switch (e.key) {
        case "Up":
        ...
        case " ":
          ...
          break;
        case "Tab":
          const s = this.highlightedItem.querySelectorAll(ei).length === 0, a = this.element.isEqualNode(e.target);
  ...
  onClick(e) {
    ...
    let t = e.target;
    if (!t.hasAttribute(Me))
      for (; t.parentElement.closest(`[${Me}]`) !== this.element; )
        t = t.parentElement.closest(`[${Me}]`);
    this.highlightedItem = t.closest(`[${Ye}]`) || t.closest(`[${Me}]`) || this.highlightedItem, t.hasAttribute(`${Ye}`) && this.element.focus(), this.highlightedItem !== this.element ? this.focusItem(this.highlightedItem) : this.element.removeAttribute("aria-activedescendant");
  }
  /**
  ...
  onFocus() {
    if (this.highlightedItem === this.element) {
      const e = this.element.querySelectorAll(`[${Ye}]`);
      if (e.length === 1) {
        this.defocusItem(this.highlightedItem), this.highlightedItem = e[0], this.focusItem(e[0]);
        return;
      }
    }
    this.highlightedItem && !this.isClicked && (this.highlightedItem._tippy && this.highlightedItem._tippy.show(), this.highlightedItem.getAttribute(Ye) === $t && this.highlightedItem.querySelector(`[${Rt}]`)?._tippy?.show()), this.isClicked = !1, this.element.hasAttribute("aria-activedescendant") || this.highlightedItem === this.element ? this.highlightedItem !== this.element && this.focusItem(this.highlightedItem) : this.setAriaActiveDescendant(this.highlightedItem), ts(this.element), this.highlightedItem && this.highlightedItem !== this.element && this.highlightedItem.setAttribute("tabindex", "-1");
  }
  /**
   ...
   */
  onBlur() {
    this.highlightedItem && (this.highlightedItem._tippy && this.highlightedItem._tippy.hide(), this.highlightedItem.getAttribute(Ye) === $t && this.highlightedItem.querySelector(`[${Rt}]`)?._tippy?.hide());
  }
  /**
...
const Ei = "focus-item", Pa = {
  beforeMount(r, e) {
    r.hasAttribute("id") || r.setAttribute("id", Na()), e.value ? r.setAttribute(Ei, e.value) : r.toggleAttribute(Ei, !0);
  }
};
function Na() {
  let r;
...
const ni = "focus-container", is = "focus-list", Fa = "focus-icon", Yt = `[${is}],[${ni}]`, xi = `button,input,select,a,textarea,[contenteditable],.ag-tab-guard,[${is}],[${ni}],[${Fa}],[tabindex]`;
let Jt = [];
const Da = {
  mounted(r) {
    [...document.querySelectorAll(".inner-shell")].some((t) => t.contains(r)) && Jt.push(new Ga(r));
  },
  beforeUnmount(r) {
    Jt = Jt.filter((e) => e.element === r ? (e.removeEventListeners(), !1) : !0);
  }
};
class Ga {
  element;
   ...
   */
  constructor(e) {
    this.element = e, this.element.toggleAttribute(ni, !0), this.element.tabIndex = 0, setTimeout(() => this.disableTabbing(), 600);
    const t = this;
  ...
  disableTabbing() {
    if (this.element.contains(document.activeElement))
      return;
    Array.prototype.filter.call(this.element.querySelectorAll(xi), () => !0).forEach((t) => {
      t.tabIndex = -1;
    });
  }
  /**
  ...
  enableTabbing() {
    let e;
    return Array.prototype.map.call(this.element.querySelectorAll(xi), (t) => {
      (t.closest(Yt) === this.element || t.closest(Yt) === t && t.parentElement.closest(Yt) === this.element) && t.offsetParent && (t.tabIndex = 0, e === void 0 && (e = t));
    }), e;
  }
}
const Ua = "truncate-text", Va = "truncate-trigger", za = {
  beforeMount(r, e) {
    !r.classList.contains("truncate") && !e.value?.noTruncateClass && r.classList.add("truncate"), r.toggleAttribute(Ua, !0);
  },
  mounted(r, e) {
    let t;
    e.value && e.value.externalTrigger && (t = r.closest(`[${Va}]`)), Ds(r, {
      content: Si(r.textContent),
      onShow: Ba,
      allowHTML: !0,
      placement: "bottom-start",
      maxWidth: 320,
  ...
  updated(r, e) {
    r._tippy && (r._tippy.setContent(Si(r.textContent)), e.value && e.value.options && r._tippy.setProps(e.value.options));
  },
  unmounted(r) {
...
function ja(r, e) {
  const t = r;
  return ["Tab", "Escape"].includes(t.key) && !!e?.matches(":focus") && !e?.hasAttribute("aria-activedescendant");
}
const Ha = ["content"], Wa = {
  key: 0,
...
}, Qa = "[focus-list], [focus-container]", eo = /* @__PURE__ */ D({
  __name: "panel-screen",
  props: {
  ...
  setup(r, { expose: e }) {
    const { t } = se(), i = rt(), s = Ut(), a = _e("iApi"), o = vi("el"), l = vi("contentEl"), n = f(), c = f(), u = f();
    e({ el: o });
    const p = r, d = G(() => a.fixture.get("appbar") ? s.temporary : []), m = G(() => i.mobileView), h = G(() => i.reorderable), y = (T) => T.scrollHeight > T.clientHeight, A = (T) => T.querySelector(Qa), b = () => {
      if (!l.value)
        return "-1";
      const T = !!A(l.value);
      return y(l.value) && !T ? "0" : "-1";
    }, P = () => {
      if (!l.value)
        return;
      const T = b();
      l.value.getAttribute("tabindex") !== T && l.value.setAttribute("tabindex", T);
    }, q = (T) => {
      if (T.target !== l.value || !l.value)
        return;
      const C = A(l.value);
      if (!C)
        return;
      const z = T.relatedTarget;
      z && l.value.contains(z) || C.focus();
    }, L = () => {
      o.value?._tippy?.hide();
    }, N = (T) => {
      ja(T, o.value) && o.value?._tippy?.show();
    }, k = () => !m.value && !p.panel.teleport, F = (T) => {
      p.panel.move(T), T === "left" && Tt(() => {
        (o.value?.querySelector(".move-left")).focus();
      });
    }, _ = G(() => p.screenId ? p.panel.screens[p.screenId][a.$i18n.locale.value ?? "en"] : null);
    return at(() => {
      o.value?.addEventListener("blur", L), o.value?.addEventListener("keyup", N), l.value && (l.value.addEventListener("focus", q), n.value = new ResizeObserver(P), n.value.observe(l.value), c.value = new MutationObserver(P), c.value.observe(l.value, {
        childList: !0,
        subtree: !0,
        attributes: !0,
        attributeFilter: ["focus-list", "focus-container"]
      }), u.value = new MutationObserver(P), u.value.observe(l.value, {
        attributes: !0,
        attributeFilter: ["tabindex"]
      }), P());
    }), bt(() => {
      o.value?.removeEventListener("blur", L), o.value?.removeEventListener("keyup", N), l.value?.removeEventListener("focus", q), n.value?.disconnect(), c.value?.disconnect(), u.value?.disconnect();
    }), (T, C) => {
      const z = ae("back"), J = ae("panel-options-menu"), E = ae("left"), O = ae("right"), Y = ae("pin"), ve = ae("expand"), Oe = ae("minimize"), Ee = ae("close"), We = U("truncate"), Te = U("focus-item"), wt = U("tippy");
      return V((v(), w("div", {
        ...
        r.header ? (v(), w("header", Wa, [
          me(z, {
            class: ue(r.panel.teleport ? "display-none" : "block sm:display-none"),
            onClick: C[0] || (C[0] = (De) => r.panel.close())
          }, null, 8, ["class"]),
          V((v(), w("h2", Ya, [
            T.$slots.header ? Be(T.$slots, "header", { key: 0 }) : (v(), w("div", Ja, B(I(t)(r.panel.alertName)), 1))
          ])), [
            [We]
          ]),
          T.$slots.controls ? (v(), ee(J, { key: 0 }, {
            default: pe(() => [
              Be(T.$slots, "controls")
            ]),
            _: 3
          ...
          g("div", {
            class: ue(r.panel.teleport ? "flex" : "display-none sm:flex")
          }, [
            r.panel.teleport ? j("", !0) : (v(), w("div", Ka, [
              h.value ? (v(), ee(E, {
                key: 0,
                onClick: C[1] || (C[1] = (De) => F("left")),
                active: !r.panel.isLeftMostPanel
              }, null, 8, ["active"])) : j("", !0),
              h.value ? (v(), ee(O, {
                key: 1,
                onClick: C[2] || (C[2] = (De) => F("right")),
                active: !r.panel.isRightMostPanel
              }, null, 8, ["active"])) : j("", !0),
              me(Y, {
                onClick: C[3] || (C[3] = (De) => r.panel.pin()),
                active: r.panel.isPinned
              }, null, 8, ["active"]),
              r.panel.controls && r.panel.controls.expand ? (v(), ee(ve, {
                key: 2,
                onClick: C[4] || (C[4] = (De) => r.panel.expand()),
                active: r.panel.expanded
              }, null, 8, ["active"])) : j("", !0)
            ])),
            r.panel.button && d.value?.includes(r.panel.id) ? (v(), ee(Oe, {
              key: 1,
              onClick: C[5] || (C[5] = (De) => r.panel.minimize())
            })) : j("", !0),
            me(Ee, {
              onClick: C[6] || (C[6] = (De) => r.panel.close())
            })
          ], 2)
        ])) : j("", !0),
        r.content ? (v(), w("div", {
          ...
          T.$slots.content ? Be(T.$slots, "content", { key: 0 }) : _.value ? (v(), w("div", {
            key: 1,
            innerHTML: _.value.innerHTML
          }, null, 8, Za)) : j("", !0)
        ], 512)) : j("", !0),
        r.footer ? V((v(), w("div", Xa, [
          Be(T.$slots, "footer")
        ])), [
          [Te]
        ]) : j("", !0)
...
}), to = { class: "relative" }, io = ["content", "aria-label"], so = ["transform"], ro = /* @__PURE__ */ D({
  __name: "pin",
  props: {
    active: Boolean
  },
  setup(r) {
    ...
    return (t, i) => {
      ...
      return v(), w("div", to, [
        V((v(), w("button", {
          type: "button",
          class: ue(["text-gray-500 hover:text-black focus:text-black p-8", { "text-gray-700": r.active }]),
          ...
          (v(), w("svg", {
            ...
            g("path", { d: "M298.028 214.267L285.793 96H328c13.255 0 24-10.745 24-24V24c0-13.255-10.745-24-24-24H56C42.745 0 32 10.745 32 24v48c0 13.255 10.745 24 24 24h42.207L85.972 214.267C37.465 236.82 0 277.261 0 328c0 13.255 10.745 24 24 24h136v104.007c0 1.242.289 2.467.845 3.578l24 48c2.941 5.882 11.364 5.893 14.311 0l24-48a8.008 8.008 0 0 0 .845-3.578V352h136c13.255 0 24-10.745 24-24-.001-51.183-37.983-91.42-85.973-113.733z" }, null, -1)
          ]), 8, so))
        ], 10, io)), [
...
}), ao = { class: "relative" }, oo = ["content", "aria-label"], no = /* @__PURE__ */ D({
  __name: "close",
  props: {
    active: Boolean
  },
...
}), lo = { class: "relative" }, co = ["content", "aria-label"], uo = /* @__PURE__ */ D({
  __name: "back",
  props: {
    active: Boolean
  },
...
}), po = { class: "w-32 h-32" }, ho = ["content", "aria-label"], fo = {
  key: 0,
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 24 24",
      ...
      return v(), w("div", po, [
        V((v(), w("button", {
          ...
          r.active ? (v(), w("svg", mo, i[1] || (i[1] = [
            ...
            g("path", { d: "M8 19h3v3h2v-3h3l-4-4-4 4zm8-15h-3V1h-2v3H8l4 4 4-4zM4 9v2h16V9H4z" }, null, -1),
            g("path", { d: "M4 12h16v2H4z" }, null, -1)
          ]))) : (v(), w("svg", fo, i[0] || (i[0] = [
            g("path", {
              d: "M0 0h24v24H0z",
              fill: "none"
            ...
            g("path", { d: "M4 20h16v2H4zM4 2h16v2H4zm9 7h3l-4-4-4 4h3v6H8l4 4 4-4h-3z" }, null, -1)
          ])))
        ], 8, ho)), [
          [s, {
            placement: "bottom",
...
}), go = { class: "relative" }, vo = ["content", "aria-label"], bo = /* @__PURE__ */ D({
  __name: "minimize",
  props: {
    active: Boolean
  },
  setup(r) {
    ...
    return (t, i) => {
      ...
      return v(), w("div", go, [
        V((v(), w("button", {
          type: "button",
          class: ue(["text-gray-500 hover:text-black focus:text-black p-6", { "text-gray-700": r.active }]),
...
}), Ao = { class: "relative" }, wo = ["content", "aria-label"], Eo = /* @__PURE__ */ D({
  __name: "right",
  props: {
    active: Boolean
  },
      ...
      return v(), w("div", Ao, [
        V((v(), w("button", {
          ...
          g("svg", {
            ...
            g("path", { d: "M 8.59 16.34 L 13.17 11.75 L 8.59 7.16 L 10 5.75 L 16 11.75 L 10 17.75 Z" })
          ], -1)
        ]), 10, wo)), [
          [s, {
            placement: "bottom",
...
}), xo = { class: "relative" }, So = ["content", "aria-label"], Io = /* @__PURE__ */ D({
  __name: "left",
  props: {
    active: Boolean
  },
      ...
      return v(), w("div", xo, [
        V((v(), w("button", {
          ...
          g("svg", {
            ...
            g("path", { d: "M 15.41 16.09 L 10.83 11.5 L 15.41 6.91 L 14 5.5 L 8 11.5 L 14 17.5 Z" })
          ], -1)
        ]), 10, So)), [
          [s, {
            placement: "bottom",
      ...
      header: pe(() => i[0] || (i[0] = [
        g("div", { class: "p-6" }, [
          g("svg", {
            ...
            g("path", { d: "M12 8c1.1 0 2-.9 2-2s-.9-2-2-2-2 .9-2 2 .9 2 2 2zm0 2c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2zm0 6c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2z" })
          ])
        ], -1)
      ])),
      default: pe(() => [
...
}), To = /* @__PURE__ */ He(_o, [["__scopeId", "data-v-51e22a4a"]]), Lo = {
  key: 0,
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 24 24",
  ...
  setup(r) {
    ...
    return (s, a) => {
      ...
      return v(), ee(o, {
        ...
        default: pe(() => [
          I(t).isFullscreen ? (v(), w("svg", Lo, a[0] || (a[0] = [
            g("path", {
              d: "M0 0h24v24H0z",
              fill: "none"
            }, null, -1),
            g("path", { d: "M5 16h3v3h2v-5H5v2zm3-8H5v2h5V5H8v3zm6 11h2v-3h3v-2h-5v5zm2-11V5h-2v5h5V8h-3z" }, null, -1)
          ]))) : (v(), w("svg", Ro, a[1] || (a[1] = [
            g("path", {
              d: "M0 0h24v24H0z",
              fill: "none"
            }, null, -1),
            g("path", { d: "M7 14H5v5h5v-2H7v-3zm-2-4h2V7h3V5H5v5zm12 7h-3v2h5v-5h-2v3zM14 5v2h3v3h2V5h-5z" }, null, -1)
          ])))
        ]),
        _: 1
      }, 8, ["tooltip"]);
    ...
    const s = async () => {
      if (i.length)
        ...
        const l = await o({
          ...
          n.code === GeolocationPositionError.PERMISSION_DENIED ? t.notify.show(Se.ERROR, e("mapnav.geolocator.error.permission")) : t.notify.show(Se.ERROR, e("mapnav.geolocator.error.internal"));
        });
        l && (i = [l.coords.longitude, l.coords.latitude], a(i));
      }
    }, a = (l) => {
      const n = new te("geolocation", l, R.latLongSR(), !0);
      ...
      return v(), ee(c, {
        ...
        default: pe(() => n[0] || (n[0] = [
          g("svg", {
            ...
            g("path", { d: "M12 8c-2.21 0-4 1.79-4 4s1.79 4 4 4 4-1.79 4-4-1.79-4-4-4zm8.94 3c-.46-4.17-3.77-7.48-7.94-7.94V1h-2v2.06C6.83 3.52 3.52 6.83 3.06 11H1v2h2.06c.46 4.17 3.77 7.48 7.94 7.94V23h2v-2.06c4.17-.46 7.48-3.77 7.94-7.94H23v-2h-2.06zM12 19c-3.87 0-7-3.13-7-7s3.13-7 7-7 7 3.13 7 7-3.13 7-7 7z" })
          ], -1)
        ])),
        _: 1
      }, 8, ["tooltip"]);
      ...
      return v(), ee(o, {
        ...
        default: pe(() => a[0] || (a[0] = [
          g("svg", {
            ...
            g("path", { d: "M10 20v-6h4v6h5v-8h3L12 3 2 12h3v8z" }),
            g("path", {
              d: "M0 0h24v24H0z",
              fill: "none"
            })
  ...
  tabindex: "-1"
}, Mo = ["content", "aria-label"], Po = /* @__PURE__ */ D({
  __name: "button",
  props: {
    onClickFunction: {
      type: Function,
  ...
  setup(r) {
    return (e, t) => {
      const i = U("focus-item"), s = U("tippy");
      return v(), w("div", ko, [
        V((v(), w("button", {
          type: "button",
          class: ue(["w-full h-full default-focus-style", [
  ...
  class: "relative",
  tabindex: "-1"
}, Fo = ["aria-label", "content"], Do = /* @__PURE__ */ D({
  __name: "button",
  props: {
    onClickFunction: {
      type: Function,
  ...
  setup(r) {
    const e = _e("iApi"), t = r, i = () => e.event.emit(x.APPBAR_BUTTON_CLICK, t.buttonId);
    return (s, a) => {
      const o = U("focus-item"), l = U("tippy");
      return v(), w("div", No, [
        V((v(), w("button", {
          type: "button",
...
}), Go = /* @__PURE__ */ He(Do, [["__scopeId", "data-v-1cb84ae1"]]), Uo = W("areas-of-interest", () => ({ areas: f([]) })), Vo = W("export", () => {
  const r = f({
    title: !0,
    map: !0,
    mapElements: !0,
...
class jo {
  ...
  fsaToProvince(e) {
    ...
    return s === "X" ? i === "X0A" || i === "X0B" || i === "X0C" ? t = 62 : t = 61 : t = Bo[s], this.codeToProvince(t);
  }
}
function Ho(r) {
  return new jo(r);
  ...
  constructor(e, t) {
    Lt.get(t).then((i) => {
      i.data.definitions.forEach((s) => {
        Ct[e][s.code] = s.term.split(`${s.code}-`)[1];
      }), Object.keys(Ct[e]).forEach((s) => {
        this.allTypes[s] = Ct[e][s], this.validTypes[s] = Ct[e][s];
      }), this.typesFetched = !0;
    });
  }
...
async function Jo(r, e) {
  ...
  return s.test(e) && !r.disabledSearchTypes.includes("LAT/LNG") ? (i = e.slice(0, -1), t = new Ot(r, i), await Qo(t)) : o.test(e) && !r.disabledSearchTypes.includes("FSA") ? (i = e.substring(0, 3).toUpperCase(), t = new Ot(r, i), await en(t)) : a.test(e) && !r.disabledSearchTypes.includes("NTS") ? (i = e.substring(0, 6).toUpperCase(), t = new Ot(r, i), await tn(t)) : (i = encodeURIComponent(e.trim()), t = new Ot(r, i), await sn(t)), r.customSources.length && await Ko(t, r.customSources), t;
}
const li = async (r) => {
  const [e, t] = await Ie(Lt.get(r));
...
}, ss = (r, e) => e.filter((t) => r.types.validTypes[t.concise.code]).map((t) => ({
  name: t.name,
  flav: "nme",
  bbox: t.bbox,
  ...
  const [e, t] = await Ie(li(ci(r, !0)));
  return e ? (console.error("Geolocation service failed"), r.failedServs.push("geolocation"), []) : t;
}, Zo = async (r) => {
  const [e, t] = await Ie(li(ci(r, !1)));
  let i;
  e ? (console.error("GeoName service targeting Name failed"), r.failedServs.push("geoname"), i = []) : i = t.items, r.addResult(ss(r.config, i));
}, Xo = async (r, e, t) => {
  const [i, s] = await Ie(li(ci(r, !1, e, t)));
  let a;
  i ? (console.error("GeoName service targeting Lat Lon failed"), r.failedServs.push("geoname"), a = []) : a = s.items, r.addResult(ss(r.config, a));
}, Qo = async (r) => {
  ...
  await Xo(r, t, i), r.addResult(s);
}, en = async (r) => {
  const e = r.config, t = await ui(r);
  if (t.length) {
  ...
  const e = r.config;
  if (await Zo(r), e.categories.length === 0 || e.categories.includes("ADDR")) {
    const t = await ui(r), i = e.sortOrder.indexOf("ADDR"), s = i >= 0 ? i : e.sortOrder.length, a = t.filter((o) => o.type?.includes("Street")).map((o) => {
...
}, rn = "~FSA~", Ii = "https://geogratis.gc.ca/services/geolocation/@{language}/locate", _i = "https://geogratis.gc.ca/services/geoname/@{language}/geonames.json", Ti = "https://geogratis.gc.ca/services/geoname/@{language}/codes/province.json", Li = "https://geogratis.gc.ca/services/geoname/@{language}/codes/concise.json";
class Ri {
  config;
  constructor(e, t) {
    let i, s, a, o;
    const l = t?.serviceUrls;
    l ? (i = l.geoLocation ? l.geoLocation : Ii, s = l.geoNames ? l.geoNames : _i, a = l.geoProvince ? l.geoProvince : Ti, o = l.geoTypes ? l.geoTypes : Li) : (i = Ii, s = _i, a = Ti, o = Li), i = i.replace("@{language}", e), s = s.replace("@{language}", e), a = a.replace("@{language}", e), o = o.replace("@{language}", e);
    let n = "";
    const c = t?.fsaBoundaries;
    if (c && c.serviceUrl) {
      const b = c.keyField || "CFSAUID";
      n = `${c.serviceUrl}/query/?where=${b}%3D'${rn}'&outFields=${b}&returnGeometry=true&f=json`;
    }
    const u = t?.settings;
    let p, d, m, h, y, A;
    u ? (p = u.categories ? u.categories : [], d = u.sortOrder ? u.sortOrder : [], m = u.disabledSearchTypes ? u.disabledSearchTypes : [], h = u.maxResults > 0 ? u.maxResults : 100, y = !!u.officialOnly) : (p = [], d = [], m = [], h = 100, y = !1), A = t?.customSources ?? [], A = A.map((b) => ({
      ...b,
      onSearch: async (P) => {
        const q = b.data ?? [], N = rs().cleanVal(P).replace("*", "");
        return q.filter((k) => k.name.toLowerCase().includes(N)).map((k) => ({
          name: k.name,
          type: b.catName,
          bbox: k.bbox,
          flav: "nme",
          location: {
            province: this.config.provinces.abbrToProvince(k.prov),
            city: k.city
          },
          order: d.indexOf(b.code) >= 0 ? d.indexOf(b.code) : d.length
        }));
      }
    })), this.config = {
      language: e,
...
const rs = W("geosearch", () => {
  const r = f(new Ri("en", void 0)), e = f({
    type: "",
    province: "",
    extent: void 0
  }), t = f(!1), i = f(""), s = f(""), a = f(""), o = f([]), l = f([]), n = f(!1), c = f([]), u = G(
    () => r.value.fetchProvinces().then((L) => (L.sort((N, k) => N.name.localeCompare(k.name, void 0, { sensitivity: "case" })), L))
  ), p = G(
    () => new Promise((L) => {
      r.value.fetchTypes().then((N) => {
        N.sort(
          (k, F) => k.name.localeCompare(F.name, void 0, { sensitivity: "case" })
        ), L(N);
      });
    })
  );
  ...
  function m(L) {
    return L.normalize("NFD").replace(/[\u0300-\u036f]/g, "").toLowerCase();
  }
  function h(L) {
    n.value = !0;
    ...
    else if (N && N !== a.value || L) {
      const k = setInterval(() => {
        r.value.config.provinces.listFetched && r.value.config.types.typesFetched && (clearInterval(k), r.value.query(`${N}*`).then((F) => {
          c.value = F.failedServs, a.value = N, l.value = F.results;
          const _ = $i(
            t.value,
            //@ts-expect-error TODO: explain why this is needed or remove
            e.value,
  ...
  function y(L) {
    e.value.province = typeof L.province > "u" ? "" : L.province, h(L.forceReRun);
  }
  function A(L) {
    e.value.type = typeof L.type > "u" ? "" : L.type, h(L.forceReRun);
  }
  function b(L) {
    a.value = i.value.replace(/["!*$+?^{}()|[\]\\]/g, "").trim(), i.value = L, h();
  }
  function P(L) {
    const N = {
    ...
    L = m(L), s.value = Array.from(L).map((k) => Object.keys(N).includes(k) ? "[" + k + N[k] + "]" : k.replace(/["$!*+?^{}()|[\]\\]/g, "").replace(/[.\\]/g, "\\$&").trim()).join("");
  }
  function q(L) {
...
}), an = W("help", () => ({ location: f("./help/") }));
var as = /* @__PURE__ */ ((r) => (r.Visibility = "visibilityButton", r.Expand = "expandButton", r))(as || {}), ti = /* @__PURE__ */ ((r) => (r.Item = "item", r.Placeholder = "placeholder", r.Error = "error", r))(ti || {});
class os extends re {
  _uid;
  _name;
  _type;
   ...
   */
  constructor(e, t, i) {
    super(e), this._uid = it.sharedUtils.generateUUID(), this._name = t.name, this._type = t.type ?? "placeholder", this._parent = i, this._children = [], this._loadPromise = new ie(), this._hidden = t.hidden ?? !1, this._expanded = t.expanded ?? !0, this._visibility = !0, this._exclusive = t.exclusive ?? !1, this._controls = t.controls?.slice() ?? [
      "visibilityButton",
      "expandButton"
      /* Expand */
  ...
  toggleVisibility(e, t = !0) {
    if (this.visibility !== e) {
      if (this._visibility = e ?? !this.visibility, !this.exclusive)
        ...
        if (this._lastVisible && (!(this._lastVisible instanceof Je) || this._lastVisible.layerControlAvailable(Q.Visibility)))
          this._lastVisible.toggleVisibility(!0);
        else {
          const i = this.children.find(
            (s) => !(s instanceof Je) || s.layerControlAvailable(Q.Visibility)
          );
   ...
   */
  checkVisibility(e) {
    this instanceof Je && !this.layerControlAvailable(Q.Visibility) || (this.exclusive ? e.visibility ? (this.children.forEach((t) => {
      t.uid !== e.uid && t.toggleVisibility(!1, !1);
    }), this._lastVisible = e, this._visibility = !0, this instanceof Je && this.layer && this.layer.layerExists && (this.layer.visibility = !0)) : (this._visibility = !1, this instanceof Je && this.layer && this.layer.layerExists && (this.layer.visibility = !1), this._lastVisible = e) : this.children.some((t) => t.visibility) ? (this._visibility = !0, this._visibleChildren = this.children.filter((t) => t.visibility), this instanceof Je && this.layer && this.layer.layerExists && (this.layer.visibility = !0)) : (this._visibility = !1, this._visibleChildren = [], this instanceof Je && this.layer && this.layer.layerExists && (this.layer.visibility = !1)), this.parent && this.parent.checkVisibility(this));
  }
  /**
...
class Je extends os {
  ...
  clickSymbology(e, t) {
    if (!this.symbolsVisible() && t !== !1 ? (this.setSymbologyVisibility(void 0, !1), this.setSymbologyVisibility(e, !0), this.toggleVisibility(!0)) : this.setSymbologyVisibility(e, t), this.symbolsVisible() || this.toggleVisibility(!1), this.layer?.supportsFeatures) {
      ...
      let s = "";
      i.length === 0 ? s = "1=2" : i.length < this.symbologyStack.length && (s = i.join(" OR ")), this.layer.setSqlFilter(ce.SYMBOL, s);
    }
  }
  /**
  ...
  load(e) {
    const t = e instanceof di ? e : this.$iApi.geo.layer.getLayer(this._layerId ?? this._layerUid);
    t && (this.layer = t, this._layerRedrawing = t.mapLayer && t.drawState !== fe.UP_TO_DATE, t.loadPromise().then(() => {
      this._layerInitVis = typeof this._layerInitVis < "u" ? this._visibility : t.visibility, super.load(), this.toggleVisibility(this._layerInitVis, !0, !0), t.visibility || this.setSymbologyVisibility(void 0, !1), this.handlers.push(
        this.$iApi.event.on(
          ...
          (i) => {
            i.layer.uid === this.layer.uid && this._type === ti.Item && this.toggleVisibility(i.visibility, !0, !0);
          }
        )
      ), this.handlers.push(
        this.$iApi.event.on(
          ...
          (i) => {
            this.layer.uid === i.layer.uid && (i.layer.drawState === fe.REFRESH ? this.layerRedrawing = !0 : setTimeout(() => {
              this.layerRedrawing = i.layer.drawState === fe.REFRESH;
            }, 500));
          }
        )
...
var on = /* @__PURE__ */ ((r) => (r.Title = "title", r.Text = "text", r.Image = "image", r.Markdown = "markdown", r.Template = "template", r))(on || {});
class Ci extends os {
  _infoType;
  ...
  constructor(e, t, i) {
    ...
    }), (t.infoType || t.content) && (this._controls = t.controls?.slice() ?? [as.Expand]), super.load();
  }
...
const nn = W("legend", () => {
  ...
  function a(n) {
    if (n.parent === void 0)
      ...
      if (!(n.item instanceof Ci) && !(n.item instanceof Je)) {
  ...
  function o(n) {
    const c = (u) => (u = u.filter((p) => (p === n && !p.children.length && p.onRemoved(), p !== n)), u.forEach((p) => {
      ...
      (p) => !(p instanceof Ci && !p.children.length && p.content === "")
    ), u);
    e.value = c(e.value);
  }
  function l(n) {
...
var de = /* @__PURE__ */ ((r) => (r[r.UPLOAD = 0] = "UPLOAD", r[r.FORMAT = 1] = "FORMAT", r[r.CONFIGURE = 2] = "CONFIGURE", r))(de || {});
const hn = W("wizard", () => {
  const r = {
    id: "Placeholder",
    layerType: S.UNKNOWN,
  ...
  function n(c) {
    switch (l.value) {
      case de.UPLOAD:
        c === de.UPLOAD ? t.value = "" : c === de.FORMAT && (l.value = de.FORMAT);
        break;
      case de.FORMAT:
        c === de.UPLOAD ? (a.value && (t.value = "", a.value = null), i.value = "", l.value = de.UPLOAD) : c === de.CONFIGURE && (l.value = de.CONFIGURE);
        break;
      case de.CONFIGURE:
        c === de.UPLOAD ? (t.value = "", i.value = "", a.value = null, s.value = !0, o.value = {
          config: r,
          configOptions: []
        }, l.value = de.UPLOAD) : c === de.FORMAT && (o.value = {
          config: r,
          configOptions: []
        }, s.value = !0, l.value = de.FORMAT);
        break;
    }
  }
  return {
...
class fn {
  ...
  constructor(e, t, i) {
    ...
    const s = mn(e, this);
    this.$vApp = s.app, this.$element = s.element, this.$i18n = s.i18n, this.$rootEl = s.app.$root?.$el, this.fixture = new pl(this), this.panel = new dl(this), this.geo = new cl(this), this.dev = new vl(this), this.ui = {
      ...
      escapeHtml: () => "",
      isPlainText: () => !0
    }, this.notify = new fr(this), this._isFullscreen = ke.isEnabled && !!this.$vApp.$root && ke.isFullscreen && ke.element === this.$vApp.$root.$el, ke.isEnabled && ke.onchange(() => {
      this._isFullscreen = ke.isEnabled && !!this.$vApp.$root && ke.isFullscreen && ke.element === this.$vApp.$root.$el;
   ...
   */
  initialize(e, t, i) {
    const s = Ae(this.$vApp.$pinia), a = rt(this.$vApp.$pinia), o = Vt(this.$vApp.$pinia);
    if (t?.configs !== void 0) {
      ...
      const u = setInterval(() => {
        ...
        h && (clearInterval(u), this.geo.map.createMap(c.map, h).then(() => {
          if (h._tippy.hide(0), o.setMaptipInstance(h._tippy), c.layers && c.layers.length > 0) {
            let y = 0;
            c.layers.forEach((A) => {
              const b = this.geo.layer.createLayer(A);
      ...
      }, d = c.system?.zoomIcon || "globe", m = p[d] || d;
      this.ui.getZoomIcon = () => m, this.ui.formatNumber = (h) => this.ui.suppressNumberLocalization ? h.toString() : this.$i18n.n(h, "number"), this.ui.escapeHtml = (h) => {
        const y = {
          "<": "&lt;",
          ">": "&gt;",
          '"': "&quot;",
   ...
   */
  reloadWorker(e, t) {
    const i = pt(this.$vApp.$pinia), s = qe(this.$vApp.$pinia), a = Ae(this.$vApp.$pinia), o = xe(this.$vApp.$pinia), l = Ne(this.$vApp.$pinia), n = Xt(this.$vApp.$pinia), c = !!e;
  ...
  useStore(e) {
    if (!([
      ...
      switch (e) {
        ...
        case "details":
          return Ji(this.$vApp.$pinia);
        case "export":
          return Vo(this.$vApp.$pinia);
        case "extentguard":
          return zo(this.$vApp.$pinia);
        case "geosearch":
          return rs(this.$vApp.$pinia);
        case "grid":
          return Xt(this.$vApp.$pinia);
        case "help":
          return an(this.$vApp.$pinia);
        case "keyboardnav":
          return es(this.$vApp.$pinia);
        case "legend":
        ...
        case "northarrow":
          return un(this.$vApp.$pinia);
        case "overviewmap":
          return pn(this.$vApp.$pinia);
        case "scrollguard":
          return dn(this.$vApp.$pinia);
        case "wizard":
          return hn(this.$vApp.$pinia);
        // core stores
        case "config":
          return Ae(this.$vApp.$pinia);
        case "fixture":
          return xe(this.$vApp.$pinia);
        case "instance":
          return pt(this.$vApp.$pinia);
        case "layer":
          return Ne(this.$vApp.$pinia);
        case "map-caption":
          return Ze(this.$vApp.$pinia);
        case "maptip":
          return Vt(this.$vApp.$pinia);
        case "notification":
          return qe(this.$vApp.$pinia);
        case "panel":
  ...
  setLanguage(e) {
    if (this.$i18n.locale.value === e)
      return;
    const t = Ae(this.$vApp.$pinia), i = qe(this.$vApp.$pinia), s = t.registeredLangs;
   ...
   */
  toggleFullscreen() {
    ke.isEnabled && ke.toggle(this.$element._container || void 0);
  }
  /**
   ...
   */
  get started() {
    return pt(this.$vApp.$pinia).started;
  }
  /**
...
function mn(r, e) {
  ...
  t.use(({ store: o }) => {
    const l = Ai(o.$state);
    o.$reset = () => o.$patch(Ai(l));
  });
  const i = sr(), s = Gi($a).use(i).use(Ns, {
    directive: "tippy",
    // => v-tippy
    component: "tippy"
    // => <tippy/>
  }).use(t);
  s.directive("focus-container", Da), s.directive("focus-list", ka), s.directive("focus-item", Pa), s.directive("truncate", za), s.component("panel-screen", eo), s.component("pin", ro), s.component("close", no), s.component("back", uo), s.component("expand", yo), s.component("panel-options-menu", To), s.component("dropdown-menu", oi), s.component("minimize", bo), s.component("right", Eo), s.component("left", Io), s.component("fullscreen-nav-button", $o), s.component("geolocator-nav-button", Co), s.component("home-nav-button", Oo), s.component("mapnav-button", Po), s.component("appbar-button", Go), s.component("transition", Fi), s.component("transition-group", Di), s.config.globalProperties.$iApi = e, s.config.globalProperties.$pinia = t, s.config.idPrefix = `ramp-${r.id || it.sharedUtils.generateUUID()}`, s.provide("iApi", e);
  const a = s.mount(r);
...
class pi {
  ...
  static async create(e) {
    const t = new pi(e), i = e.layers.map((o) => {
      const l = {
        url: o.url,
        opacity: o.opacity
      };
      if (o.layerType === S.TILE)
        return M.TileLayer(l);
      if (o.layerType === S.VECTORTILE)
        return M.VectorTileLayer(l);
      if (o.layerType === S.MAPIMAGE)
        return M.MapImageLayer(l);
      if (o.layerType === S.OSM)
        return M.OpenStreetMapLayer(l);
    ...
    return t.esriBasemap = await M.Basemap({
      baseLayers: a,
      title: e.name || "",
      id: e.id
    }), t;
...
class yn extends re {
  ...
  async createMap(e, t) {
    ...
    }, s = e.basemaps.map((n) => pi.create(n)), o = (await Promise.all(s)).filter((n) => (n.createErr && i(n), n.esriBasemap.baseLayers.length > 0));
    o.forEach((n) => {
    ...
    const l = {};
    this.esriMap = ne(await M.Map(l)), this.pointZoomScale = e.pointZoomScale && e.pointZoomScale > 0 ? e.pointZoomScale : 5e4, this._targetDiv = t, this.createMapView(e.initialBasemapId);
  }
  /**
  ...
  async applyBasemap(e) {
    ...
    t.esriBasemap.id !== i && (this.esriMap.basemap = Pe(t.esriBasemap));
  }
  /**
   ...
   */
  getExtent() {
    return this.esriView ? X.fromESRI(this.esriView.extent) : (this.noMapErr(), X.fromParams("i_am_error", 0, 1, 0, 1));
  }
  /**
   ...
   */
  getExtentSet() {
    return this._rampExtentSet ? this._rampExtentSet : (this.noMapErr(), It.fromConfig({
   ...
   */
  getSR() {
    return this._rampSR ? this._rampSR.clone() : (this.noMapErr(), R.latLongSR());
  }
  /**
...
class gn extends re {
   ...
   */
  constructor(e) {
    super(e), this.maptipStore = Vt(this.$vApp.$pinia);
  }
...
class vn extends re {
    ...
    if (e ? (e.logo ? e.logo.disabled ? s.logo.disabled = !0 : (s.logo.altText = e.logo.altText || i.altText, s.logo.link = e.logo.link || i.link, s.logo.value = e.logo.value || i.value) : (s.logo.altText = i.altText, s.logo.link = i.link, s.logo.value = i.value), e.text ? e.text.disabled ? s.text.disabled = !0 : s.text.value = e.text.value || t.value : s.text.value = t.value, Ze(this.$vApp.$pinia).setAttribution(s)) : (s.logo.altText = i.altText, s.logo.link = i.link, s.logo.value = i.value, s.text.value = t.value), !e || e.text?.disabled || !e.text) {
      ...
      if (n) {
        const c = n.baseLayers.map((u) => new Promise((p) => {
          let d = 0;
          const m = o / l, h = setInterval(function() {
            u.loaded && !u.loadError ? (clearInterval(h), p(u)) : d > m && (clearInterval(h), p(null)), d++;
          }, l);
        })).toArray();
        Promise.all(c).then((u) => {
          a = u.filter((d) => d?.copyright).map((d) => d.copyright).join(" | "), s.text.value = a || s.text.value || t.value, Ze(this.$vApp.$pinia).setAttribution(s);
        });
      }
    }
  }
   ...
   */
  updateScale() {
    const e = Ze(this.$vApp.$pinia), t = e.scale;
    if (t?.disabled)
      return;
...
class bn extends yn {
   ...
   */
  constructor(e) {
    super(e, "main"), this.maptip = new gn(e), this.caption = new vn(e), this.mapMouseThrottle = 0;
  }
  async createMap(e, t) {
   ...
   */
  async createMapView(e) {
    const i = Ae(this.$vApp.$pinia).config.map;
    if (!i)
    ...
    this._rampExtentSet = It.fromConfig(o), this._rampSR = this._rampExtentSet.sr.clone();
    ...
    this.esriView = ne(
      ...
      n.preventDefault();
    }) : console.error("ESRI Map View is missing its container"), Re(
  ...
  async applyBasemap(e) {
    ...
    this.esriMap.basemap = Pe(t.esriBasemap);
    const i = Ae(this.$vApp.$pinia);
  ...
  async setBasemap(e) {
    ...
    const t = Ae(this.$vApp.$pinia), i = await this.findBasemap(e), a = t.activeBasemapConfig.tileSchemaId !== i.tileSchemaId;
    if (a) {
      ...
      const o = await M.ColorBackground({
        color: new je(i.backgroundColour).toESRI()
      });
  ...
  addLayer(e, t = void 0) {
    return new Promise((i, s) => {
      if (this.esriMap || (this.noMapErr(), s()), e.initiationState !== H.INITIATING && e.initiationState !== H.INITIATED && e.layerState !== Z.ERROR && e.initiate(), e.mapLayer && t === void 0) {
        ...
        if (e.isCosmetic)
          ...
          for (let d = c.length - 1; d >= 0 && p; d--) {
            const m = u.find((h) => h.id === c[d]);
            m && !m.isCosmetic && (t = d + 1, p = !1);
          }
          p && (t = 0);
        }
      }
      Ne(this.$vApp.$pinia).addLayer(e, t), this.$iApi.event.emit(x.LAYER_REGISTERED, e);
      const o = Date.now();
      let l = 0;
      const n = setInterval(() => {
        l += 250, l >= e.expectedTime.fail || e.layerState === Z.ERROR ? (clearInterval(n), e.lastCancel < o && console.error(`Failed to add layer: ${e.id}.`), s()) : e.initiationState === H.INITIATED && (e.esriLayer || !e.mapLayer) && (clearInterval(n), e.mapLayer ? this.insertToEsriMap(e) : e.onLoad(), i());
      }, 250);
    });
  }
  /**
  ...
  reorder(e, t, i = !1) {
    ...
    if (o === t)
      return;
    if (Ne(this.$vApp.$pinia).reorderLayer(e, t), e.esriLayer && this.esriMap.layers.indexOf(e.esriLayer) > -1) {
      let n = 0;
      if (t > 0) {
  ...
  removeLayer(e) {
    ...
    let t;
    if (e instanceof di ? t = e : t = this.$iApi.geo.layer.getLayer(e), !t)
    ...
    const i = Ne(this.$vApp.$pinia);
    i.removeLayer(t), i.removeLayerConfig(t.id), t.removeEsriLayer(), t.initiationState === H.INITIATED && t.terminate(), t.isRemoved = !0, this.$iApi.event.emit(x.LAYER_REMOVE, t);
  }
  /**
  ...
  createMouseMoveHandler() {
    ...
    return ut(this.mapMouseThrottle, (e) => {
...
const An = { geometryType: "point", renderer: { type: "simple", symbol: { type: "esriSMS", style: "esriSMSCircle", color: [67, 100, 255, 200], size: 7, outline: { color: [0, 0, 0, 255], width: 1 } } } }, wn = { geometryType: "polyline", renderer: { type: "simple", symbol: { type: "esriSLS", style: "esriSLSSolid", color: [90, 90, 90, 200], width: 2 } } }, En = { geometryType: "polygon", renderer: { type: "simple", symbol: { type: "esriSFS", style: "esriSFSSolid", color: [76, 76, 125, 200], outline: { type: "esriSLS", style: "esriSLSSolid", color: [110, 110, 110, 255], width: 1 } } } }, xn = { geometryType: "polygon", renderer: { type: "simple", symbol: { type: "esriSFS", style: "esriSFSSolid", color: [255, 0, 0, 64], outline: { type: "esriSLS", style: "esriSLSSolid", color: [240, 128, 128, 255], width: 1 } } } }, Sn = {
  circlePoint: An,
  solidLine: wn,
  outlinedPoly: En,
  boundingBoxPoly: xn
...
class $n extends re {
  ...
  extractCsvFields(e, t = ",") {
    return wi.dsvFormat(t).parseRows(e)[0].map((s) => ({ name: s, type: Ue.STRING }));
  }
  /**
  ...
  filterCsvLatLonFields(e, t = ",") {
    const i = wi.dsvFormat(t).parseRows(e), s = i[0], a = {
  ...
  async geoJsonToEsriJson(e, t) {
    ...
    _n(e);
    const l = e.features[0].geometry.type, n = In[l], c = JSON.parse(
      // @ts-expect-error TODO: explain why this is needed or remove
      JSON.stringify(Sn[n])
    );
    if (t) {
      ...
      t.layerId ? a = t.layerId : a = this.$iApi.geo.shared.generateUUID(), t.colour && (c.renderer.symbol.color = new je(t.colour).toArcServer());
    } else
      throw new Error("geoJsonToEsriJson - missing opts arguement");
    s || (s = R.parseGeoJsonCrs(e.crs)), o.renderer = await M.RendererFromJson(c.renderer), o.fields = (o.fields || []).concat(
      t.fieldMetadata?.exclusiveFields ? this.extractGeoJsonFields(e).filter(
        (y) => t.fieldMetadata?.fieldInfo?.find((A) => A.name === y.name)
    ...
    const p = R.parseSR(i).toESRI();
    await this.$iApi.geo.proj.projectGeoJson(e, s, u);
    const d = zs(e, { sr: 8888 });
    o.geometryType = this.$iApi.geo.geom.geoJsonGeomTypeToEsriGeomType(l);
    const m = o.fields.map((y) => y.name);
    for (let y = 0; y < d.length; y++) {
      const A = d[y];
      A.geometry.spatialReference = p, A.geometry.type = o.geometryType, Object.keys(A.attributes).forEach((b) => {
        m.includes(b) ? (Array.isArray(A.attributes[b]) || typeof A.attributes[b] == "object") && A.attributes[b] != null && (A.attributes[b] = JSON.stringify(A.attributes[b])) : delete A.attributes[b];
      });
    }
    return (t.fieldMetadata?.fieldInfo && t.fieldMetadata?.fieldInfo.length > 0 ? t.fieldMetadata.fieldInfo.filter((y) => y.trim && m.includes(y.name)).map((y) => y.name) : []).forEach((y) => {
      for (let A = 0; A < d.length; A++) {
        const b = d[A].attributes;
    ...
    return import("flatgeobuf").then(({ geojson: s }) => new Promise((a) => {
      ...
      const u = setInterval(() => {
        if (n && o) {
          clearInterval(u);
          let p;
          l && (l.code && l.code !== 4326 && l.org === "EPSG" ? p = new R(l.code) : l.wkt ? p = new R(l.wkt) : console.error("Encountered FlatGeobuf with non-EPSG org: ", l)), p && (n.crs = p.toGeoJSON()), a(n);
        } else
   ...
   */
  inferType(e) {
    return typeof e == "number" ? Ue.DOUBLE : Ue.STRING;
  }
  /**
...
class On extends re {
  ...
  async loadWfsData(e, t = -1, i = 0, s = 1e3, a = {
    ...
    const u = new Gt(e).updateQuery(n), [p, d] = await Ie(Lt.get(u, { signal: l }));
    if (!d)
      return console.error(`WFS data failed to load for ${e}`, p), Promise.reject(p);
    const m = d.data;
    if (t === -1) {
      if (typeof m.numberMatched != "number")
        throw new Error("WFS hits missing numberMatched");
      return t = d.data.numberMatched, this.loadWfsData(e, t, i, s, a, o, l);
    }
    if (a.features = a.features.concat(m.features), m.features.length < t - i) {
      const h = Math.min(s, t - i - m.features.length);
      ...
      return o && a.features.length > 0 && a.features[0].geometry.type === K.POINT && a.features.forEach((h) => {
        const y = h.geometry.coordinates;
        h.properties.rvInternalCoordX = y[0], h.properties.rvInternalCoordY = y[1];
      }), a;
  }
  /**
  ...
  async parseCapabilities(e) {
    const t = async () => {
      let d = e;
      if (e.indexOf("?") === -1)
        d += "?service=WMS&request=GetCapabilities";
      else {
        const h = new Gt(e.toUpperCase());
        "SERVICE" in h.queryMap || (d += "&service=WMS"), "REQUEST" in h.queryMap || (d += "&request=GetCapabilities");
      }
      return (await Qe(d, {
        responseType: "xml"
      })).data;
      ...
      t().then((m) => d(m)).catch(() => {
        console.error("Get capabilities failed; trying the second time;"), d(t());
      });
    }), s = (d) => {
      let m = d.Layer;
      return m ? (Array.isArray(m) || (m = [m]), m.map((h) => {
        const y = h.Name, A = h.Title;
        let b = h.Style;
        const P = [], q = {};
        return b && (Array.isArray(b) || (b = [b]), b.forEach((L) => {
          const N = L.Name;
          if (P.push(N), L.LegendURL) {
            const F = L.LegendURL.OnlineResource["@_xlink:href"];
            q[N] = F.replaceAll("&amp;", "&");
          }
        })), {
          ...
          name: y?.toString() ?? null,
          title: A,
          queryable: h["@_queryable"] === "1",
          layers: s(h),
          allStyles: P,
          styleToURL: q,
          currentStyle: P[0]
    ...
    }, { XMLParser: o } = await import("fast-xml-parser"), l = await i;
    if (!l)
      return [];
...
class kn extends re {
  ...
  ogc;
  constructor(e) {
    super(e), this.files = new $n(e), this.ogc = new On(e);
  }
  /**
   ...
   */
  getLayer(e) {
    return Ne(this.$vApp.$pinia).getLayerByAny(e);
  }
  /**
   ...
   */
  getSublayer(e, t) {
    const i = Ne(this.$vApp.$pinia).getLayerById(e);
   ...
   */
  layerOrderIds() {
    return Ne(this.$vApp.$pinia).mapOrder.slice(0) || [];
  }
  /**
   ...
   */
  allLayers() {
    return Ne(this.$vApp.$pinia).layers || [];
  }
  /**
  ...
  allActiveLayers() {
    return this.allLayers().filter(
      (e) => e.layerState !== Z.ERROR && e.initiationState === H.INITIATED
    );
  }
  /**
   ...
   */
  allLayersOnMap(e = !0) {
    const t = this.allLayers().filter((i) => i.mapLayer && i.initiationState === H.INITIATED);
    if (e) {
  ...
  getLayerControls(e) {
    ...
    return t.supportsFeatures || s.push(Q.Datatable), t.extent === void 0 && s.push(Q.BoundaryZoom), (t.config?.metadata || (t.isSublayer ? t.parentLayer?.config?.metadata : {}) || {}).url || s.push(Q.Metadata), !t.mapLayer && !t.config.controls?.includes(Q.Settings) && s.push(Q.Settings), s.forEach((o) => {
  ...
  async loadLayerMetadata(e) {
    ...
    const [t, i] = await Ie(Qe(e, { query: { f: "json" } }));
    if (!i)
...
class di extends re {
   ...
   */
  getGraphic(e, t) {
    return Promise.resolve(new Ce(new et()));
  }
  /**
...
class ns extends di {
  ...
  constructor(e, t) {
    super(e, t), this.name = e.name || "", this.geomType = $.NONE, this.dataFormat = le.UNKNOWN, this.layerType = S.UNKNOWN, this.layerFormat = ye.UNKNOWN;
    ...
    this.expectedTime.draw = e.expectedDrawTime ?? i.draw, this.expectedTime.load = e.expectedLoadTime ?? i.load, this.expectedTime.fail = e.maxLoadTime || i.fail, this.lastCancel = 0, this.timers = {
      draw: void 0,
      load: void 0
    }, this.origRampConfig = e, this.id = e.id || "", this.uid = this.$iApi.geo.shared.generateUUID(), this.isCosmetic = !1, this.isSystem = e.system || !1, this.isRemoved = !1, this.isSublayer = !1, this.supportsIdentify = !1, this.mapLayer = !0, this.identifyMode = oe.NONE, this.supportsFeatures = !1, this.maptips = !1, this.supportsSublayers = !1, this.isFile = !1, this.layerState = Z.NEW, this.initiationState = H.NEW, this.drawState = fe.NOT_LOADED, this.loadDefProm = new ie(), this.url = this.origRampConfig.url, this.canReload = !!(this.url || this.origRampConfig.caching), this.loadPromDone = !1, this.nameArcadeFormula = "", this.maptipArcadeFormula = "", this.layerTree = new Dt(0, this.uid, this.name, !0);
  }
  updateInitiationState(e) {
  ...
  updateDrawState(e) {
    this.drawState = e, e === fe.REFRESH ? this.startTimer(
      "draw"
      /* DRAW */
    ) : e === fe.UP_TO_DATE && this.stopTimer(
      "draw"
      /* DRAW */
  ...
  async initiate() {
    this.updateInitiationState(H.INITIATING), this.startTimer(
      "load"
      /* LOAD */
    );
    const e = (a) => {
    ...
    }, this.expectedTime.fail), [s] = await Ie(this.onInitiate());
    clearTimeout(i), t > this.lastCancel && (this.drawState !== fe.UP_TO_DATE && this.startTimer(
      "draw"
      /* DRAW */
    ), s ? e(`Init error on layer id: ${this.id} . ${s.message}`) : this.updateInitiationState(H.INITIATED));
  }
  async onInitiate() {
    if (this.isSublayer)
  ...
  async terminate() {
    this.updateInitiationState(H.TERMINATING), await Promise.all(this.sublayers.map((e) => e.terminate())), this.loadDefProm = new ie(), this.loadPromDone = !1, this.updateLayerState(Z.NEW), this.updateDrawState(fe.NOT_LOADED), this.updateInitiationState(H.TERMINATED);
  }
  // ----------- LAYER LOAD -----------
  ...
  onError(e = !0) {
    this.layerState !== Z.ERROR && (this.initiationState === H.INITIATING && this.updateInitiationState(H.NEW), this.loadPromDone && (this.loadDefProm = new ie()), this.loadDefProm.rejectMe(), this.loadPromDone = !0, this.sublayers.forEach((t) => t.onError(e)), e && this.$iApi.notify.show(
      Se.ERROR,
      this.$iApi.$i18n.t("layer.error", {
        id: this.id
      })
   ...
   */
  getGraphic(e, t) {
    return this.stubError(), Promise.resolve(new Ce(new et()));
  }
  getIcon(e) {
    return this.stubError(), Promise.resolve("");
  }
...
class nt extends ns {
  ...
  // ----------- LAYER CONSTRUCTION AND INITIALIZAION -----------
  constructor(e, t) {
    super(e, t), this._scaleSet = new Hi(), this._mouseTolerance = e.mouseTolerance != null ? e.mouseTolerance : 5, this._touchTolerance = e.touchTolerance != null ? e.touchTolerance : 15, this._drawOrder = [], this._serverVisibility = void 0, this.isCosmetic = e.cosmetic || !1, this.extent = e.extent ? X.fromConfig(`${this.id}_extent`, e.extent) : void 0, this.viewDefProm = new ie(), this.esriWatches = [];
  }
  noLayerErr() {
    console.error(
    ...
    this.esriWatches.push(
      ...
      this.esriView = ne(e.layerView), this.esriWatches.push(
        Re(
          ...
          (t) => {
            this.updateDrawState(t ? fe.REFRESH : fe.UP_TO_DATE);
          }
        )
   ...
   */
  getSR() {
    return this.esriLayer ? R.fromESRI(this.esriLayer.spatialReference) : (this.noLayerErr(), R.latLongSR());
  }
}
class hi extends nt {
  attribs;
  ...
  filter;
  constructor(e, t) {
    super(e, t), this.supportsIdentify = !0, this.geomType = $.UNKNOWN, this.serviceUrl = "", this.fieldList = "", this.canModifyLayer = !0, this.filter = new Wi(e.permanentFilteredQuery || "", e.initialFilteredQuery || ""), e.state?.hovertips !== void 0 && console.warn("hovertips layer configuration property is deprecated. Please adjust to use maptips instead"), this.maptips = e.state?.maptips ?? e.state?.hovertips ?? !0, this.attribs = new cs();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
  ...
  async loadLayerMetadata(e = {}) {
    ...
    if (!(t < this.lastCancel))
      if (this.geomType = i.geometryType, this.attribs.quickCache = new ps(this.geomType), this.scaleSet.minScale = i.minScale, this.scaleSet.maxScale = i.maxScale, this.dataFormat = i.dataFormat, this.extent = this.extent ?? i.extent, this._serverVisibility = i.defaultVisibility, this.origRampConfig.name || (this.name = i.name ?? this.id), this.dataFormat === le.ESRI_FEATURE) {
        ...
        const a = {
          ...
          permanentFilter: this.getSqlFilter(ce.PERMANENT)
        };
        this.attribs.attLoader = new us(this.$iApi, a);
      } else
  ...
  async getGraphic(e, t) {
    ...
    if (t.getGeom) {
      ...
      if (u)
        s = u;
      else if (this.layerType === S.FEATURE && !(this.attribs.quickCache.isPoint && t.forZoom)) {
        const p = await this.getLocalGeometry(e);
        p ? (this.attribs.quickCache.isPoint || this.attribs.quickCache.setGeom(e, p, n), s = p) : l = !0;
      } else
        l = !0;
    }
    if (o || l) {
    ...
    const c = new Ce(s, "", t.getAttribs ? i : void 0);
    if (t.getStyle) {
      const u = Pe(this.renderer.getGraphicSymbol(i));
      c.style = this.$iApi.geo.geom.styleEsriToRamp(u);
    }
    return c;
  }
  async zoomToFeature(e) {
    const t = await this.getGraphic(e, { getGeom: !0, forZoom: !0 });
  ...
  setSqlFilter(e, t) {
    ...
    if (t !== i)
      if (this.filter.setSql(e, t), this.$iApi.event.emit(x.FILTER_CHANGE, {
        uid: this.uid,
        filterKey: e
      }), this.layerFormat === ye.MAPIMAGE)
        this.applySqlFilter();
      else {
...
class Mn extends nt {
  constructor(e, t) {
    super(e, t), this.dataFormat = le.ESRI_FEATURE, this.layerFormat = ye.GRAPHIC, this.maptips = !1;
  }
  _graphics = [];
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
  ...
  async addGraphic(e) {
    ...
    const i = t.filter((n) => this._graphics.findIndex((u) => u.id === n.id) === -1 ? (this._graphics.push(n), !0) : (console.error(`Attempting to add graphic with id '${n.id}' that has already been added.`), !1)), s = this.$iApi.geo.map.getSR(), a = i.map((n) => this.$iApi.geo.proj.projectGeometry(s, n.geometry)), o = await Promise.all(a), l = i.map((n, c) => {
      const u = new Ce(o[c], n.id, n.attributes);
...
class Pn extends Mn {
  ...
  async onInitiate() {
    this.esriLayer = ne(await M.GraphicsLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
  ...
  onLoadActions() {
    const e = super.onLoadActions();
    return this.layerTree.name = this.name, this.updateDrawState(fe.UP_TO_DATE), e;
  }
  // ----------- LAYER ACTIONS -----------
}
class lt extends hi {
  ...
  sourceGeoJson;
  constructor(e, t) {
    super(e, t), this.supportsIdentify = !0, this.isFile = !0, this.dataFormat = le.ESRI_FEATURE, this.layerFormat = ye.FEATURE, this.layerIdx = 0, e.identifyMode && e.identifyMode !== oe.NONE ? this.identifyMode = e.identifyMode : this.identifyMode = oe.HYBRID;
  }
  async reload() {
  ...
  runIdentify(e) {
    ...
    return e.hitTest && (this.identifyMode === oe.HYBRID || this.identifyMode === oe.SYMBOLIC) && (s = a.then(async () => {
      ...
      o.forEach((n) => {
        i.items.push(_t.makeRawItem(mt.ESRI, n.attributes));
      }), l.forEach((n) => {
        i.items.push(_t.makeOidItem(n, this));
  ...
  extractLayerMetadata() {
    ...
    this.supportsFeatures = !0, this.geomType = this.$iApi.geo.geom.clientGeomTypeToRampGeomType(e.geometryType), this.scaleSet.minScale = e.minScale || 0, this.scaleSet.maxScale = e.maxScale || 0, this.extent = this.extent ?? X.fromESRI(e.fullExtent, this.id + "_extent");
  ...
  async getGraphic(e, t) {
    ...
    if (t.getStyle) {
      const s = Pe(this.renderer.getGraphicSymbol(i.attributes));
...
class zn extends hi {
  constructor(e, t) {
    super(e, t), this.dataFormat = le.ESRI_FEATURE, this.supportsIdentify = !0, this.layerType = S.FEATURE, this.layerFormat = ye.FEATURE, e.identifyMode && e.identifyMode !== oe.NONE ? this.identifyMode = e.identifyMode : this.identifyMode = oe.HYBRID;
  }
  async onInitiate() {
    ne(this.esriLayer = await M.FeatureLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
  ...
  onLoadActions() {
    ...
    const o = async () => {
      ...
      if (this.esriLayer && this.origRampConfig.customRenderer?.type) {
        const c = await M.RendererFromJson(this.origRampConfig.customRenderer);
    ...
    }, l = this.$iApi.geo.layer.loadFeatureCount(this.serviceUrl, this.getSqlFilter(ce.PERMANENT)).then((n) => {
  ...
  runIdentify(e) {
    ...
    return e.hitTest && (this.identifyMode === oe.HYBRID || this.identifyMode === oe.SYMBOLIC) && (s = a.then(async () => {
      ...
      o.forEach((l) => {
        i.items.push(_t.makeOidItem(l, this));
      }), i.loaded = !0, t.resolveMe();
    }).catch(() => {
      i.errored = !0, t.resolveMe();
    }), [i];
  ...
  async getGraphicExtent(e) {
    ...
    if (!this.layerExists)
      ...
      const i = this.attribs.quickCache.getExtent(e);
      if (i)
        t = i;
      else {
        const [s, a] = await Ie(
        ...
        !s && a.extent && (t = X.fromESRI(a.extent), this.attribs.quickCache.setExtent(e, t));
      }
    }
    return t;
  }
  async getLocalGeometry(e) {
    await this.viewPromise(), this.esriView.updating && await new Promise((s) => {
      const a = Re(
    ...
    const i = await this.esriView.queryFeatures(t);
    if (i.features.length) {
      const s = i.features[0];
      return this.$iApi.geo.geom.geomEsriToRamp(s.geometry);
    } else
      return;
  }
  async zoomToFeature(e) {
    let t;
    return this.geomType !== $.POINT && (t = this.attribs.quickCache.getAnyScaleGeom(e), t || (t = await this.getLocalGeometry(e), t ? this.geomType !== $.MULTIPOINT && this.attribs.quickCache.setGeom(e, t, this.$iApi.geo.map.getScale()) : t = await this.getGraphicExtent(e))), t && !t.invalid() ? (await this.$iApi.geo.map.zoomMapTo(t), !0) : await super.zoomToFeature(e);
  }
}
class Bn extends nt {
  ...
  origState;
  constructor(e, t) {
    super(e, t), this.supportsIdentify = !0, this.supportsSublayers = !0, this.layerType = S.MAPIMAGE, this.layerFormat = ye.MAPIMAGE, this.isDynamic = !1, this.maptips = !1, this.layerTree.layerIdx = -1, this.identifyMode = oe.GEOMETRIC;
  }
  /**
  ...
  set visibility(e) {
    ...
    if (e || kt(this, "1=2"), this.actualViz = e, e && !this.esriLayer.visible)
      this.esriLayer.visible = !0;
    else if (!e && this.esriLayer.visible) {
      let t = "";
      const i = setTimeout(() => {
        this.$iApi.event.off(t), this.actualViz || (this.esriLayer.visible = !1, kt(this, ""));
      }, 1600);
      t = this.$iApi.event.on(
        x.LAYER_DRAWSTATECHANGE,
        (s) => {
          s.layer.id === this.id && s.state === fe.UP_TO_DATE && (clearTimeout(i), this.$iApi.event.off(t), this.actualViz || (this.esriLayer.visible = !1, kt(this, "")));
        }
      );
    }
    e && kt(this, "");
  ...
  async onInitiate() {
    this.esriLayer = ne(await M.MapImageLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
  ...
  onLoadActions() {
    ...
    this.isDynamic = this.esriLayer.capabilities.exportMap.supportsDynamicLayers, this.extent = this.extent ?? X.fromESRI(this.esriLayer.fullExtent, this.id + "_extent");
    const i = (n) => {
    ...
    const a = [], o = (n, c) => {
      ...
      if (n.sublayers && n.sublayers.length > 0) {
        const d = (p ? p.name : "") || n.title || "", m = new Dt(u, "", d, !1);
        c.findChildByIdx(u) || c.children.push(m), n.sublayers.reverse().forEach((h) => {
          o(h, m);
        });
      } else {
        this._sublayers[u] || (this._sublayers[u] = new qn(
          {
        ...
        if (d.isRemoved)
          return;
        if (d.name = p?.name || n.title || "", a.push(d), !c.children.map((m) => m.layerIdx).includes(u)) {
          const m = new Dt(u, d.uid, d.name, !1);
          c.children.push(m);
        }
        d.esriWatches.push(
          Re(
    ...
    const l = a.map(async (n) => {
      ...
      if (n.esriSubLayer && u?.customRenderer?.type) {
        const m = await M.RendererFromJson(u.customRenderer);
        n.esriSubLayer.renderer = m, p.customRenderer = m;
      }
      ...
      if (d ? (n.visibility = n.isRemoved ? !1 : d.state?.visibility ?? (this.origState.visibility ? n._serverVisibility ?? this.origState.visibility : this.origState.visibility ?? n._serverVisibility) ?? !0, n.opacity = d.state?.opacity ?? this.origState.opacity ?? 1, this.$iApi.geo.attributes.applyFieldMetadata(n, d.fieldMetadata), n.canModifyLayer || this.$iApi.notify.show(
        ...
        const m = await this.$iApi.geo.layer.loadFeatureCount(
          n.serviceUrl,
          n.getSqlFilter(ce.PERMANENT)
        );
        t > this.lastCancel && (n.featureCount = m);
      }
    });
  ...
  runIdentify(e) {
    ...
    return e.geometry.type === $.POINT && (i = this.$iApi.geo.query.makeClickBuffer(e.geometry, e.tolerance)), t.map((s) => {
      ...
      return s.geomType !== $.POLYGON && i ? o.filterGeometry = i : o.filterGeometry = e.geometry, o.filterSql = s.getCombinedSqlFilter(), o.sourceSR = s.sourceSR, s.queryOIDs(o).then((n) => {
        n.forEach((c) => {
          l.items.push(_t.makeOidItem(c, s));
...
const kt = (r, e) => {
  r.sublayers.forEach((t) => {
    t.layerExists && t.canModifyLayer && t.setSqlFilter(ce.MIL_FLICKER_ERASER, e);
  });
};
class qn extends hi {
  constructor(e, t, i) {
    if (super(e, t), this.layerType = S.SUBLAYER, this.layerFormat = ye.MAPIMAGE, this.isSublayer = !0, this.layerIdx = e.index, this.parentLayer = i, this.isSystem = i.isSystem, this.dataFormat = le.ESRI_FEATURE, this.supportsFeatures = !0, this.maptips = !1, this.url = this.parentLayer?.url, this.canReload = !!(this.url || this.origRampConfig.caching), !i.esriLayer)
  ...
  getSR() {
    if (this.parentLayer?.esriLayer) {
      ...
      return e ? R.fromESRI(e) : R.latLongSR();
    } else
      return this.noLayerErr(), R.latLongSR();
  }
  /**
  ...
  async zoomToFeature(e) {
    if (this.supportsFeatures) {
      const t = this.attribs.quickCache.getAnyScaleGeom(e);
...
class jn extends nt {
  constructor(e, t) {
    super(e, t), this.supportsIdentify = !1, this.layerType = S.OSM, this.layerFormat = ye.OSM, this.dataFormat = le.OSM_TILE, this.supportsFeatures = !1;
  }
  async onInitiate() {
    this.esriLayer = ne(await M.OpenStreetMapLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
...
class Hn extends nt {
  constructor(e, t) {
    super(e, t), this.supportsIdentify = !1, this.layerType = S.IMAGERY, this.layerFormat = ye.IMAGERY, this.dataFormat = le.ESRI_RASTER;
  }
  async onInitiate() {
    this.esriLayer = ne(await M.ImageryLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
...
class fi extends nt {
  ...
  async checkProj() {
    ...
    if (this.layerState === Z.LOADED && !i)
      s(), this.onError(), this.updateDrawState(fe.NOT_LOADED);
...
class Wn extends fi {
  constructor(e, t) {
    super(e, t), this.layerType = S.IMAGERYTILE, this.layerFormat = ye.IMAGERYTILE, this.schemaLocked = !1;
  }
  async onInitiate() {
    this.esriLayer = ne(await M.ImageryTileLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
...
class Yn extends fi {
  constructor(e, t) {
    super(e, t), this.layerType = S.TILE, this.layerFormat = ye.TILE;
  }
  async onInitiate() {
    this.esriLayer = ne(await M.TileLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
...
class Jn extends fi {
  constructor(e, t) {
    super(e, t), this.layerType = S.VECTORTILE, this.layerFormat = ye.VECTORTILE;
  }
  async onInitiate() {
    this.esriLayer = ne(await M.VectorTileLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
...
class Kn extends nt {
  ...
  mimeType;
  constructor(e, t) {
    super(e, t), this.supportsIdentify = !0, this.layerType = S.WMS, this.layerFormat = ye.WMS, this.mimeType = e.featureInfoMimeType || "", this.sublayerNames = [], this.dataFormat = le.OGC_RASTER, this.identifyMode = oe.GEOMETRIC;
  }
  async onInitiate() {
    this.esriLayer = ne(await M.WMSLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
  ...
  runIdentify(e) {
    ...
    return this.getFeatureInfo(this.sublayerNames, e.geometry, this.mimeType).then((s) => {
      if (s) {
        let a = !0, o;
        typeof s != "string" ? o = mt.JSON : s.indexOf("Search returned no results") === -1 && s !== "" ? o = mt.TEXT : (a = !1, o = mt.UNKNOWN), a && i.items.push(_t.makeRawItem(o, s));
      }
      i.loaded = !0, t.resolveMe();
    }).catch(() => {
      i.errored = !0, t.resolveMe();
  ...
  getFeatureInfo(e, t, i) {
    ...
    let o, l;
    const n = s.getExtent(), c = a.spatialReferences, u = e.join(","), p = s.esriView.toScreen(t.toESRI()), d = Math.floor(p.x), m = Math.floor(p.y), y = {
    ...
    }, this.$iApi.geo.layer.ogc.reversedAxisWKIDs().indexOf(o) > -1 && (l.BBOX = `${n.ymin},${n.xmin},${n.ymax},${n.xmax}`)) : l = { SRS: "EPSG:" + o, X: d, Y: m }, Object.prototype.hasOwnProperty.call(l, "BBOX") || (l.BBOX = `${n.xmin},${n.ymin},${n.xmax},${n.ymax}`);
    const b = {
      SERVICE: "WMS",
      ...
      LAYERS: u,
      INFO_FORMAT: i
    }, P = a.customLayerParameters;
    return P && Object.keys(P).forEach((q) => {
      q.toLowerCase() !== "styles" && (b[q] = P[q]);
    }), Object.keys(b).forEach((q) => l[q] = b[q]), Qe(a.url.split("?")[0], {
      query: l,
      responseType: y
    });
  }
...
class Zn extends lt {
  ...
  async onInitiate() {
    const e = Date.now(), t = new Gt(this.config.url), { offset: i, limit: s } = t.queryMap, a = await this.$iApi.geo.layer.ogc.loadWfsData(
      this.config.url,
      -1,
      parseInt(i) || 0,
      parseInt(s) || 1e3,
...
class ls extends ns {
  ...
  // ----------- LAYER CONSTRUCTION AND INITIALIZAION -----------
  constructor(e, t) {
    super(e, t), this.dataFormat = le.ESRI_FEATURE, this.layerFormat = ye.NOLAYER, this.drawState = fe.NOT_VISUAL, this.attribs = new cs(), this.supportsFeatures = !0, this.mapLayer = !1, this.isFile = !1, this._visibility = e.state?.visibility ?? !0, this.expectedTime.draw = 0;
  }
  async onInitiate() {
    if (this.sourceJson) {
      ...
      this.fields = t.map((c, u) => {
        ...
        const m = this.$iApi.geo.layer.files.inferType(i[u]);
        return {
          name: d,
          alias: p,
          type: m,
          length: m === Ue.STRING ? 256 : void 0
        };
      }), this.oidField = "rampOID", this.fields.push({ name: this.oidField, type: Ue.OID }), e.fields.push(this.oidField), e.data.forEach((c, u) => c.push(u + 1)), this.$iApi.geo.attributes.applyFieldMetadata(this, this.origRampConfig.fieldMetadata), this.fieldList = "*";
      const a = {
        batchSize: -1,
      ...
      this.attribs.attLoader = new sl(this.$iApi, a), await this.attribs.attLoader.getAttribs(), this.featureCount = e.data.length;
...
class Qn extends ls {
  ...
  serviceUrl;
  constructor(e, t) {
    super(e, t), this.layerType = S.DATATABLE, this.serviceUrl = e.url, this.filter = new Wi(e.permanentFilteredQuery || "", e.initialFilteredQuery || "");
  }
  async onInitiate() {
  }
  onLoadActions() {
    const e = super.onLoadActions(), t = Date.now(), s = this.$iApi.geo.shared.parseUrlIndex(this.serviceUrl).index || 0, a = this.$iApi.geo.layer.loadLayerMetadata(this.serviceUrl).then((l) => {
      ...
      this.attribs.attLoader = new us(this.$iApi, n), this.attribs.quickCache = new ps(this.geomType);
    }), o = this.$iApi.geo.layer.loadFeatureCount(this.serviceUrl, this.getSqlFilter(ce.PERMANENT)).then((l) => {
...
class tl extends re {
  ...
  async loadGraphicsAttributes(e, t) {
    ...
    const s = {
      features: e.sourceGraphics.map((a) => Pe(a).attributes).toArray(),
      oidIndex: {}
    };
  ...
  async loadSingleFeature(e) {
    ...
    if (a.length > 0) {
      ...
      if (e.includeGeometry) {
        ...
        const n = $s(l.geometry);
        o = this.$iApi.geo.geom.geomEsriToRamp(n);
      } else
        o = new et();
      return new Ce(o, "", l.attributes);
    }
...
class mi extends re {
  ...
  constructor(e, t) {
    super(e), this.aac = new Oi(), this.details = t;
  }
  /**
  ...
  getAttribs() {
    return this.loadPromise || (this.aac = new Oi(), this.loadPromise = this.loadPromiseGenerator()), this.loadPromise;
  }
  abortAttribLoad() {
...
class ps {
  ...
  getAnyScaleGeom(e) {
    if (this.isPoint)
      return this.getGeom(e);
    {
      let t;
      return Object.values(this.geoms).some((i) => {
        const s = i[e];
        return s && (t = s), s;
      }), t;
    }
...
class yi {
  ...
  constructor(e, t, i = !1) {
    this.innerRenderer = e, this.symbolUnits = [], this.falseRenderer = i, this.type = zt.Unknown;
  }
...
class qt {
  ...
  parent;
  constructor(e) {
    this.parent = e, this.symbol = new Zt();
  }
  match(e) {
    return !!e;
  }
...
class al extends yi {
  ...
  keyFields;
  constructor(e, t, i = !1) {
    super(e, t, i), this.type = zt.Unique, this.delim = e.fieldDelimiter || ", ";
...
class ol extends yi {
  ...
  constructor(e, t, i = !1) {
    if (super(e, t, i), this.valField = this.cleanFieldName(e.field, t), e.classBreakInfos.forEach((s, a) => {
      const o = a === 0, l = new Mi(this, s.minValue, s.maxValue, o);
...
class nl extends re {
  ...
  async generateWMSSymbology(e) {
    const t = ct(document.createElement("div")).size(this.CONTAINER_SIZE, this.CONTAINER_SIZE).viewbox(0, 0, 0, 0), i = {
      svgcode: "",
      imgHeight: "",
      imgWidth: ""
    };
  ...
  async renderSymbologyImage(e, t = null) {
    t === null && (t = ct(document.createElement("div")).size(this.CONTAINER_SIZE, this.CONTAINER_SIZE).viewbox(0, 0, 0, 0));
  ...
  async renderSymbologyIcon(e, t = null) {
    if (t === null) {
      ...
      a.setAttribute("style", "opacity:0;position:fixed;left:100%;top:100%;overflow:hidden"), document.body.appendChild(a), t = ct(a).size(this.CONTAINER_SIZE, this.CONTAINER_SIZE).viewbox(0, 0, this.CONTAINER_SIZE, this.CONTAINER_SIZE);
    }
   ...
   */
  generateLetterSvg(e, t, i = "#000") {
    e.rect(this.CONTENT_IMAGE_SIZE, this.CONTENT_IMAGE_SIZE).center(this.CONTAINER_CENTER, this.CONTAINER_CENTER).fill(i);
    const s = t[0].toUpperCase();
    e.text(s).size(23).fill("#fff").attr({
      "font-weight": "bold",
      "font-family": "Roboto"
    }).center(this.CONTAINER_CENTER, this.CONTAINER_CENTER).tspan(s).addClass("grid-icons").attr({
  ...
  generatePlaceholderSymbology(e, t = "#000") {
    const i = ct(document.createElement("div")).size(this.CONTAINER_SIZE, this.CONTAINER_SIZE).viewbox(0, 0, this.CONTAINER_SIZE, this.CONTAINER_SIZE);
    return this.generateLetterSvg(i, e, t), {
      name: e,
      svgcode: i.svg()
    };
  }
  async generateBlankSymbology() {
    return ct(document.createElement("div")).size(this.CONTAINER_SIZE, this.CONTAINER_SIZE).svg();
  }
  /**
  ...
  async symbolToSvg(e) {
    ...
    const a = ct(s).size(this.CONTAINER_SIZE, this.CONTAINER_SIZE).viewbox(0, 0, this.CONTAINER_SIZE, this.CONTAINER_SIZE), o = {
      // @ts-expect-error TODO: explain why this is needed or remove
      path({ size: h, path: y }) {
      ...
      [be.DOT]: "1.333,4",
      // esriSLSDot
      [be.DASHDOT]: "5.333,4,1.333,4",
      // esriSLSDashDot
      [be.LONGDASH]: "10.666,4",
      // esriSLSLongDash
      [be.LONGDASHDOT]: "10.666,4,1.333,4",
      // esriSLSLongDashDot
      [be.LONGDASHDOTDOT]: "10.666,4,1.333,4,1.333,4",
      // esriSLSLongDashDotDot
      [be.SHORTDOT]: "1.333,1.333",
      // esriSLSShortDot
      [be.SHORTDASH]: "5.333,1.333",
      // esriSLSShortDash
      [be.SHORTDASHDOT]: "5.333,1.333,1.333,1.333",
      // esriSLSShortDashDot
      [be.SHORTDASHDOTDOT]: "5.333,1.333,1.333,1.333,1.333,1.333"
      ...
      "simple-line"() {
        const h = m(e.color), y = d({
          ...
          // @ts-expect-error TODO: explain why this is needed or remove
          dasharray: l[e.style]
        }), A = t.CONTENT_PADDING, b = t.CONTAINER_SIZE - t.CONTENT_PADDING;
        a.line(A, A, b, b).stroke(y);
      },
      ...
      "simple-fill"() {
        ...
        a.rect(t.CONTENT_SIZE, t.CONTENT_SIZE).center(t.CONTAINER_CENTER, t.CONTAINER_CENTER).fill(A).stroke(P);
      },
      text() {
        t.generateLetterSvg(a, "A", "#2e8b57");
      },
      "picture-fill"() {
        const h = e.imageData ? `data:${e.contentType};base64,${e.imageData}` : e.url, y = e.width * e.xscale, A = e.height * e.yscale;
        e.outline = e.outline || c;
        const b = m(e.outline.color), P = d({
          color: b.colour,
          opacity: b.opacity,
        ...
        return t.$iApi.geo.shared.convertImagetoDataURL(h).then((L) => {
          const N = a.pattern(
            y,
            A,
            (k) => (
          ...
          a.rect(t.CONTENT_SIZE, t.CONTENT_SIZE).center(t.CONTAINER_CENTER, t.CONTAINER_CENTER).fill(N).stroke(P);
        });
      },
      "picture-marker"() {
  ...
  async getMapServerLegend(e) {
    ...
    const t = {
      query: { f: "json" }
    }, i = { layers: [] }, [s, a] = await Ie(Qe(`${e}/legend`, t));
  ...
  async mapServerLegendToRenderer(e, t) {
    ...
    if (typeof i < "u") {
      ...
      const a = await M.RendererFromJson(s);
...
class ll extends re {
  ...
  async arcGisServerQueryIds(e) {
    ...
    const i = await M.QueryByIds(e.url, t);
  ...
  async geoJsonQuery(e) {
    ...
    return (await e.layer.esriLayer.queryFeatures(t)).features.map((s, a) => {
      let o;
      return t.returnGeometry ? o = this.$iApi.geo.geom.geomEsriToRamp(s.geometry, `queryResult${a}`) : o = new et(), new Ce(o, "", s.attributes);
    });
  }
  /**
...
class cl extends re {
   ...
   */
  constructor(e) {
    super(e), this.geom = it.geom, this.proj = it.proj, this.shared = it.sharedUtils, this.map = new bn(e), this.layer = new kn(e), this.attributes = new tl(e), this.query = new ll(e), this.symbology = new nl(e), Array.isArray(Et.request.interceptors) || (Et.request.interceptors = []), Et.request.interceptors.push({
      before: (t) => {
   ...
   */
  set proxy(e) {
    Et.request.proxyUrl = e;
  }
  /**
   * Read the current proxy setting, returns url string, empty string if no proxy
   */
  get proxy() {
    return Et.request.proxyUrl || "";
  }
}
const ul = /* @__PURE__ */ Object.assign({ "../fixtures/appbar/index.ts": () => import("./index-BGbTNQPy.js"), "../fixtures/areas-of-interest/index.ts": () => import("./index-Bwyp1p18.js"), "../fixtures/basemap/index.ts": () => import("./index-CRdeIUyM.js"), "../fixtures/crosshairs/index.ts": () => import("./index-DHfiSCSI.js"), "../fixtures/details/index.ts": () => import("./index-ESSS2EQS.js"), "../fixtures/draw/index.ts": () => import("./index-8BIg8Ivp.js"), "../fixtures/export-footnote/index.ts": () => import("./index-CN6-ZGbH.js"), "../fixtures/export-legend/index.ts": () => import("./index-D8-r0_Rw.js"), "../fixtures/export-map/index.ts": () => import("./index-YTOqxMK9.js"), "../fixtures/export-northarrow/index.ts": () => import("./index-Cqir-Ezz.js"), "../fixtures/export-scalebar/index.ts": () => import("./index-OKx6NDNp.js"), "../fixtures/export-timestamp/index.ts": () => import("./index-DTn5LmTz.js"), "../fixtures/export-title/index.ts": () => import("./index-D8ThSGxX.js"), "../fixtures/export/index.ts": () => import("./index-Co_au8mI.js"), "../fixtures/extentguard/index.ts": () => import("./index-BoVSS2kE.js"), "../fixtures/gazebo/index.ts": () => import("./index-BnDHUi62.js"), "../fixtures/geosearch/index.ts": () => import("./index-BhStNDNO.js"), "../fixtures/grid/index.ts": () => import("./index--vGtLfe4.js"), "../fixtures/help/index.ts": () => import("./index-Dd8MJuRJ.js"), "../fixtures/hilight/index.ts": () => import("./index-CAsgBr8z.js"), "../fixtures/keyboardnav/index.ts": () => import("./index-CZxzj0An.js"), "../fixtures/layer-reorder/index.ts": () => import("./index-DTGgC3JY.js"), "../fixtures/legend/index.ts": () => import("./index-D72cTnNJ.js"), "../fixtures/mapnav/index.ts": () => import("./index-Ds9c83ks.js"), "../fixtures/metadata/index.ts": () => import("./index-CW0pTsSX.js"), "../fixtures/northarrow/index.ts": () => import("./index-rcqwGTgD.js"), "../fixtures/overviewmap/index.ts": () => import("./index-Blf9q5Kg.js"), "../fixtures/panguard/index.ts": () => import("./index-DCI-Fe2m.js"), "../fixtures/scrollguard/index.ts": () => import("./index-CAmG5aix.js"), "../fixtures/settings/index.ts": () => import("./index-ZXPq21Ip.js"), "../fixtures/snowman/index.ts": () => import("./index-u1W93mE8.js"), "../fixtures/swipe/index.ts": () => import("./index-CNQHjbUf.js"), "../fixtures/wizard/index.ts": () => import("./index-BoNOIUaE.js") });
class pl extends re {
  /**
   ...
   */
  exists(e) {
    return e in xe(this.$vApp.$pinia).items;
  }
  /**
  ...
  async add(e, t) {
    let i;
    if (e in xe(this.$vApp.$pinia).items)
      return this.get(e);
    if (t) {
      if (typeof t != "function")
        throw new Error("malformed fixture constructor");
      i = gi.updateBaseToInstance(new t(), e, this.$iApi);
    } else {
      const s = (await ul[`../fixtures/${e}/index.ts`]()).default;
      i = new s(e, this.$iApi);
    }
    return xe(this.$vApp.$pinia).addFixture(i), this.$iApi.event.emit(x.FIXTURE_ADDED, i), this.$iApi.geo.map.created && i.initialized?.(), i;
  }
  /**
  ...
  remove(e) {
    ...
    return xe(this.$vApp.$pinia).removeFixture(t), this.$iApi.event.emit(x.FIXTURE_REMOVED, t), t;
  }
  ...
  get(e) {
    ...
    const i = t.map((s) => {
      const a = xe(this.$vApp.$pinia).items[s];
      if (a)
        return a;
    });
   ...
   */
  isLoaded(e) {
    const t = xe(this.$vApp.$pinia), i = Array.isArray(e) ? e : [e];
    i.forEach((a) => {
...
class gi extends re {
  ...
  mount(e, { props: t, children: i, element: s, app: a } = {}) {
    let o = s, l = Ss(e, t, i);
    return a && a._context && (l.appContext = a._context), o ? jt(l, o) : (o = document.createElement("div"), jt(l, o)), { vNode: l, destroy: () => {
      o && jt(null, o), o = null, l = null;
    }, el: o };
  }
  /**
   ...
   */
  get config() {
    return Ae(this.$vApp.$pinia).config.fixtures[this.id];
  }
  /**
  ...
  handlePanelTeleports(e) {
    if (this.config?.panelTeleport) {
      const t = rt(this.$vApp.$pinia), i = !!this.config.panelTeleport.target;
      e.forEach((s) => {
...
class dl extends re {
  ...
  register(e, t) {
    ...
    const s = Object.entries(i).reduce((a, [o, l]) => (a.push(new Mt(this.$iApi, o, l)), a), []);
  ...
  open(e) {
    let t, i, s;
    if (typeof e == "string" || e instanceof Mt ? t = this.get(e) : (t = this.get(e.id), { screen: i, props: s } = e), !t)
      return t;
  ...
  toggle(e, t) {
    let i;
    return typeof e == "string" || e instanceof Mt ? i = this.get(e) : i = this.get(e.id), i && (t = typeof t < "u" ? t : !i.isVisible, t !== i.isVisible ? t ? this.open(e) : this.close(i) : i);
  }
  /**
  ...
  toggleMinimize(e, t) {
    let i;
    return typeof e == "string" || e instanceof Mt ? i = this.get(e) : i = this.get(e.id), i && (t = typeof t < "u" ? t : !i.isVisible, t !== i.isVisible ? t ? this.open(i) : this.minimize(i) : i);
  }
  /**
...
function ml(r, e) {
  ...
  return v(), ee(t, {
    ...
    content: pe(() => e[0] || (e[0] = [
      g("div", { class: "loader" }, null, -1)
    ])),
    _: 1
  });
}
const yl = /* @__PURE__ */ He(fl, [["render", ml], ["__scopeId", "data-v-a3c61802"]]), gl = /* @__PURE__ */ Object.assign({ "../fixtures/areas-of-interest/screen.vue": () => import("./screen-DEsiBeOF.js"), "../fixtures/basemap/screen.vue": () => import("./screen-DVjUrnN1.js"), "../fixtures/export/screen.vue": () => import("./screen-CPLFaJJ1.js"), "../fixtures/geosearch/screen.vue": () => import("./screen-CHvYE51L.js"), "../fixtures/grid/screen.vue": () => import("./screen-wOsJwiUD.js"), "../fixtures/help/screen.vue": () => import("./screen-BzKMQYWo.js"), "../fixtures/layer-reorder/screen.vue": () => import("./screen-Orq-y8ie.js"), "../fixtures/legend/screen.vue": () => import("./screen-DL-P0erY.js"), "../fixtures/metadata/screen.vue": () => import("./screen-Bfibr9Rc.js"), "../fixtures/settings/screen.vue": () => import("./screen-CI7_rIuW.js"), "../fixtures/wizard/screen.vue": () => import("./screen-DDtnOv89.js") });
class Mt extends re {
  /**
   * ID of this panel.
   *
  ...
  registerScreen(e) {
    ...
    if (Ks(t) || Js(t))
      ...
      let s;
      typeof t == "string" ? s = gl[`../fixtures/${t}`]() : s = t();
      const a = new Promise((o, l) => {
        s.then((n) => {
          this.loadedScreens.push(e), o(Zs(n) ? n.default : n);
        }), s.catch((n) => l(n));
      });
      i = Is({
...
function Al(r) {
  ...
  return El(r.services, e), wl(r.map, e), xl(r.ui, e), r.plugins && Sl(r.plugins, e), e;
}
function wl(r, e) {
  if (r.layers && r.layers.forEach((t) => {
    e.layers.unshift(ds(t));
...
function ii(r) {
  ...
  return r.controls && r.controls.length > 0 && (e.controls = vt(r.controls, t), r.controls.includes("visibility") && e.controls.push("visibilityButton"), (r.controls.length !== 1 || r.controls[0] !== "visibility") && console.warn(
    "Legend entry groups currently support only the visibility control. All other controls are currently not supported."
  ), e.controls.push("expandButton")), r.disabledControls && r.disabledControls.length > 0 && (e.disabledControls = vt(r.disabledControls, t), r.disabledControls.includes("visibility") && e.disabledControls.push("visibilityButton"), (r.disabledControls.length !== 1 || r.disabledControls[0] !== "visibility") && console.warn(
    "Legend entry groups currently support only the visibility control. All other controls are currently not supported."
  )), r.children.forEach((i) => {
    if (i.layerId)
      e.children.push(Pi(i));
    else if (i.infoType)
      ...
      typeof i.collapse < "u" && console.warn(
        ...
        a.layerId ? s.children.push(Pi(a)) : s.children.push(ii(a));
      }), e.children.push(s);
    } else
      e.children.push(ii(i));
  }), e;
}
function Pi(r) {
  const e = r, t = [
  ...
  return r.controls && r.controls.length > 0 && (e.layerControls = vt(r.controls, t), e.layerControls.push("symbology")), r.disabledControls && r.disabledControls.length > 0 && (e.disabledLayerControls = vt(r.disabledControls, t)), r.controlledIds && (console.warn(
...
function Kt(r) {
  ...
  return r.controls && r.controls.length > 0 && (e.controls = vt(r.controls, t), e.controls.push("symbology")), r.disabledControls && r.disabledControls.length > 0 && (e.disabledControls = vt(r.disabledControls, t)), r.state && (e.state = {
  ...
  )), typeof r.stateOnly < "u" && (e.cosmetic = r.stateOnly), r.initialFilteredQuery && (e.initialFilteredQuery = r.initialFilteredQuery), Il(r, e), typeof r.toggleSymbology < "u" && console.warn(`toggleSymbology property provided in layer ${r.id} cannot be mapped and will be skipped.`), r.table && (e.fixtures = {
    grid: {}
  }, r.table.title && (e.fixtures.grid.title = r.table.title), r.table.description && console.warn(
...
var dt = { major: "4", minor: "19", patch: "0-beta", timestamp: "Thu Mar 12 14:10:16 2026 -0400", hash: "afe8e65a57bdca743d6309db28fbf5570d8efeb7" };
console.info(
  `RAMP v${dt.major}.${dt.minor}.${dt.patch} [${dt.hash.slice(0, 9)}] (Built on ${new Date(
...
const hc = (r, e, t) => new fn(r, e, t), it = new Ys();
export {
  Ue as $,
  jr as A,
  yn as B,
