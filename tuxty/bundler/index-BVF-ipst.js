...
import { _ as H, d as L, F as X, G as ee } from "./main-CKy89sJU.js";
...
const G = /* @__PURE__ */ H(ne, [["render", ae]]), se = /* @__PURE__ */ T({
  ...
  setup(h) {
    ...
    const p = [
      {
        type: "point",
        icon: g(_(() => import("./point-icon-D9MhQpXm.js")))
      },
      {
        type: "polyline",
        icon: g(_(() => import("./polyline-icon-BEhJkpLq.js")))
      },
      {
        type: "polygon",
        icon: g(_(() => import("./polygon-icon-BYsjzXmI.js")))
      },
      {
        type: "circle",
        icon: g(_(() => import("./circle-icon-cM0h7Yw2.js")))
      },
      {
        type: "rectangle",
        icon: g(_(() => import("./rectangle-icon-FqJAdwEZ.js")))
      }
    ], a = A(() => {
      const s = p.filter((u) => e.supportedTypes.some((x) => x.type === u.type));
      return s.push({
        type: "edit",
        icon: g(_(() => import("./edit-icon-ctZTH-Qb.js")))
      }), s;
    }), n = (s) => {
