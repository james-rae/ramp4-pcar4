...
import "tiny-emitter";
import { G as le, L as Te, F as xe } from "./main-DbfnhtEc.js";
...
class ft extends Me {
  async init() {
    Object.entries(Le).forEach((b) => this.$iApi.$i18n.mergeLocaleMessage(...b)), this._parseConfig(this.config), Z(this.$vApp.$pinia).supportedTypes.forEach((b) => {
      const o = `${b.type}-icon`;
      this.$iApi.component(o, Ae(Se(/* @__PURE__ */ Object.assign({ "./icons/circle-icon.vue": () => import("./circle-icon-BawCzL7X.js"), "./icons/edit-icon.vue": () => import("./edit-icon-fXC6Sms6.js"), "./icons/point-icon.vue": () => import("./point-icon-CeusRKlK.js"), "./icons/polygon-icon.vue": () => import("./polygon-icon-aBTBamp7.js"), "./icons/polyline-icon.vue": () => import("./polyline-icon-Cvo7rJ0D.js"), "./icons/rectangle-icon.vue": () => import("./rectangle-icon-Bp29ryff.js") }), `./icons/${b.type}-icon.vue`, 3)));
    });
