...
import { ref as f, computed as G, markRaw as ne, defineComponent as D, inject as Ie, reactive as Re, watch as kt, onBeforeUnmount as vt, resolveDirective as U, withDirectives as V, createElementBlock as w, openBlock as b, withKeys as ys, withModifiers as ii, onMounted as st, normalizeStyle as Ni, normalizeClass as ue, createVNode as me, Transition as Fi, withCtx as pe, createBlock as ee, resolveDynamicComponent as gs, mergeProps as vs, useCssVars as bs, TransitionGroup as Di, Fragment as tt, renderList as bt, unref as I, nextTick as It, renderSlot as Ve, createElementVNode as g, vShow as As, resolveComponent as ae, createTextVNode as ht, toDisplayString as z, createCommentVNode as B, onUpdated as ws, Teleport as Es, getCurrentInstance as xs, useTemplateRef as vi, createApp as Gi, toRaw as ke, h as Ss, render as qt, defineAsyncComponent as Is } from "vue";
import Mt from "@arcgis/core/Color";
import At from "@arcgis/core/config";
import { watch as Le } from "@arcgis/core/core/reactiveUtils.js";
import bi from "@arcgis/core/geometry/Extent";
import _s from "@arcgis/core/geometry/Multipoint";
import Ts from "@arcgis/core/geometry/Point";
import si from "@arcgis/core/geometry/Polygon";
import Ui from "@arcgis/core/geometry/Polyline";
import Ls from "@arcgis/core/geometry/SpatialReference";
import { fromJSON as Rs } from "@arcgis/core/geometry/support/jsonUtils";
...
import Kt from "@arcgis/core/symbols/SimpleMarkerSymbol";
import { fromJSON as ri } from "@arcgis/core/symbols/support/jsonUtils";
import "@arcgis/map-components/components/arcgis-swipe";
import Vi from "deepmerge";
import { applyConverter as Ms } from "@terraformer/spatial";
import ge from "proj4";
import { debounce as Pt, throttle as ct } from "throttle-debounce";
...
var De = /* @__PURE__ */ ((r) => (r.BLOB = "blob", r.DATE = "date", r.DOUBLE = "double", r.GEOMETRY = "geometry", r.GLOBAL_ID = "global-id", r.GUID = "guid", r.INTEGER = "integer", r.LONG = "long", r.OID = "oid", r.RASTER = "raster", r.SINGLE = "single", r.SMALL_INTEGER = "small-integer", r.STRING = "string", r.XML = "xml", r))(De || {}), Fe = /* @__PURE__ */ ((r) => (r.CIRCLE = "circle", r.CROSS = "cross", r.DIAMOND = "diamond", r.ICON = "icon", r.PATH = "path", r.SQUARE = "square", r.TRIANGLE = "triangle", r.X = "x", r))(Fe || {}), ve = /* @__PURE__ */ ((r) => (r.DASH = "dash", r.DASHDOT = "dash-dot", r.DASHDOTDOT = "short-dash-dot-dot", r.DOT = "dot", r.LONGDASH = "long-dash", r.LONGDASHDOT = "long-dash-dot", r.LONGDASHDOTDOT = "long-dash-dot-dot", r.NONE = "none", r.NULL = "none", r.SHORTDASH = "short-dash", r.SHORTDASHDOT = "short-dash-dot", r.SHORTDASHDOTDOT = "short-dash-dot-dot", r.SHORTDOT = "short-dot", r.SOLID = "solid", r))(ve || {}), Bi = /* @__PURE__ */ ((r) => (r.BEVEL = "bevel", r.MITER = "miter", r.ROUND = "round", r))(Bi || {}), qi = /* @__PURE__ */ ((r) => (r.ROUND = "round", r.BUTT = "butt", r.SQUARE = "square", r))(qi || {}), ji = /* @__PURE__ */ ((r) => (r.BDIAG = "backward-diagonal", r.CROSS = "cross", r.DIAG_CROSS = "diagonal-cross", r.FDIAG = "forward-diagonal", r.HORIZONTAL = "horizontal", r.NONE = "none", r.NULL = "none", r.SOLID = "solid", r.VERTICAL = "vertical", r))(ji || {}), $ = /* @__PURE__ */ ((r) => (r.POINT = "Point", r.MULTIPOINT = "MultiPoint", r.LINESTRING = "LineString", r.MULTILINESTRING = "MultiLineString", r.POLYGON = "Polygon", r.MULTIPOLYGON = "MultiPolygon", r.LINEARRING = "LinearRing", r.EXTENT = "Extent", r.NONE = "None", r.UNKNOWN = "Unknown", r))($ || {}), Ut = /* @__PURE__ */ ((r) => (r.Simple = "simple", r.Unique = "uniqueValue", r.ClassBreaks = "classBreaks", r.Unknown = "unknown", r))(Ut || {}), S = /* @__PURE__ */ ((r) => (r.FEATURE = "esri-feature", r.MAPIMAGE = "esri-map-image", r.TILE = "esri-tile", r.VECTORTILE = "esri-vector-tile", r.IMAGERY = "esri-imagery", r.IMAGERYTILE = "esri-imagery-tile", r.GRAPHIC = "esri-graphic", r.WMS = "ogc-wms", r.WFS = "ogc-wfs", r.GEOJSON = "file-geojson", r.GEOJSONZIPPED = "file-zip-geojson", r.CSV = "file-csv", r.SHAPEFILE = "file-shape", r.FLATGEOBUF = "file-fgb", r.FLATGEOBUFZIPPED = "file-zip-fgb", r.OSM = "osm-tile", r.DATACSV = "data-csv", r.DATAJSON = "data-json", r.DATATABLE = "data-esri-table", r.UNKNOWN = "unknown", r.SUBLAYER = "sublayer", r))(S || {}), ye = /* @__PURE__ */ ((r) => (r.FEATURE = "feature", r.GRAPHIC = "graphic", r.IMAGERY = "imagery", r.IMAGERYTILE = "imagery-tile", r.MAPIMAGE = "map-image", r.NOLAYER = "no-layer", r.OSM = "osm-tile", r.TILE = "tile", r.UNKNOWN = "unknown", r.VECTORTILE = "vector-tile", r.WMS = "wms", r))(ye || {}), le = /* @__PURE__ */ ((r) => (r.ESRI_FEATURE = "esriFeature", r.ESRI_RASTER = "esriRaster", r.ESRI_TILE = "esriTile", r.OSM_TILE = "osmTile", r.OGC_RASTER = "ogcRaster", r.UNKNOWN = "unknown", r))(le || {}), J = /* @__PURE__ */ ((r) => (r.POINT = "Point", r.MULTIPOINT = "MultiPoint", r.LINESTRING = "LineString", r.MULTILINESTRING = "MultiLineString", r.POLYGON = "Polygon", r.MULTIPOLYGON = "MultiPolygon", r))(J || {}), oe = /* @__PURE__ */ ((r) => (r.GEOMETRIC = "geometric", r.SYMBOLIC = "symbolic", r.HYBRID = "hybrid", r.NONE = "none", r))(oe || {}), H = /* @__PURE__ */ ((r) => (r.NEW = "new", r.INITIATING = "initiating", r.INITIATED = "initiated", r.TERMINATING = "terminating", r.TERMINATED = "terminated", r))(H || {}), K = /* @__PURE__ */ ((r) => (r.NEW = "new", r.LOADING = "loading", r.LOADED = "loaded", r.ERROR = "error", r))(K || {}), fe = /* @__PURE__ */ ((r) => (r.NOT_LOADED = "not-loaded", r.NOT_VISUAL = "not-visual", r.REFRESH = "refresh", r.UP_TO_DATE = "up-to-date", r))(fe || {}), ft = /* @__PURE__ */ ((r) => (r.ESRI = "esri", r.TEXT = "text", r.IMAGE = "image", r.HTML = "html", r.XML = "xml", r.JSON = "json", r.UNKNOWN = "unknown", r))(ft || {}), ce = /* @__PURE__ */ ((r) => (r.SYMBOL = "symbol", r.GRID = "grid", r.EXTENT = "extent", r.INITIAL = "initial", r.API = "api", r.MIL_FLICKER_ERASER = "mileraser", r.PERMANENT = "permanent", r))(ce || {}), Q = /* @__PURE__ */ ((r) => (r.BoundaryZoom = "boundaryZoom", r.Datatable = "datatable", r.Identify = "identify", r.Metadata = "metadata", r.Opacity = "opacity", r.Refresh = "refresh", r.Reload = "reload", r.Remove = "remove", r.Settings = "settings", r.Symbology = "symbology", r.Visibility = "visibility", r))(Q || {});
class $e {
  attributes;
  geometry;
  style;
...
class te extends rt {
  ...
  toGeoJSON() {
    return this.geoJsonFactory(J.POINT, this.toArray());
  }
}
class Ae extends rt {
...
class mt extends Ae {
  ...
  toGeoJSON() {
    return this.geoJsonFactory(J.MULTIPOINT, this.toArray());
  }
}
class Ke extends Ae {
  constructor(e, t, i, s) {
  ...
  toGeoJSON() {
    return this.geoJsonFactory(J.LINESTRING, this.toArray());
  }
}
class Te extends rt {
  rawArray;
  constructor(e, t, i, s) {
    if (super(e, t.sr || i), s)
      this.rawArray = Te.arrayDeepCopy(t);
  ...
  static fromESRI(e, t) {
    return new Te(t, e.paths, T.fromESRI(e.spatialReference), !0);
  }
  toESRI() {
    return new Ui({
      paths: this.toArray(),
  ...
  toGeoJSON() {
    return this.geoJsonFactory(J.MULTILINESTRING, this.toArray());
  }
}
class Qe extends Ae {
  constructor(e, t, i, s) {
    if (super(e, t, i, s), Qe.closeRing(this.rawArray), this.length < 4)
  ...
  static fromESRI(e, t) {
    return new Qe(t, e.rings[0], T.fromESRI(e.spatialReference), !0);
  }
  toESRI() {
    return new si({
      rings: [this.toArray()],
  ...
  static fromGeoJSON(e, t) {
    return new Qe(t, e.coordinates, T.fromGeoJSON(e.crs), !0);
  }
  toGeoJSON() {
    return this.geoJsonFactory(J.POLYGON, [this.toArray()]);
  }
}
class he extends rt {
  rawArray;
  ...
  get ringArray() {
    return this.rawArray.map((e, t) => new Qe(this.childIdGenerator(t), e, this.sr, !0));
  }
  ...
  static parsePolygon(e) {
    ...
    return t.forEach((i) => Qe.closeRing(i)), t;
  }
  static arrayDeepCopy(e) {
    return e.map((t) => t.map((i) => i.slice()));
  }
...
class Ge extends rt {
  ...
  static parseMultiPolygon(e) {
    ...
    if (e instanceof he)
      return [e.toArray()];
    if (e instanceof Te || e instanceof Ae)
  ...
  toGeoJSON() {
    return this.geoJsonFactory(J.MULTIPOLYGON, this.toArray());
  }
}
class Z extends rt {
  ...
  expand(e) {
    return Z.fromESRI(this.toESRI().expand(e), `${this.id}-expanded`);
  }
  clone() {
    return new Z(this.id, this.rawMin, this.rawMax, this.sr);
  }
  /**
  ...
  static fromArcServer(e, t) {
    return Z.fromESRI(bi.fromJSON(e), t);
  }
  ...
  static fromGeoJSON(e, t) {
    ...
    }), new Z(t, i, s, T.fromGeoJSON(e.crs));
  }
  toGeoJSON() {
    return this.geoJsonFactory(J.POLYGON, this.toPolygonArray());
  }
}
class Be {
  c;
...
class Ye extends Ue {
  ...
  toESRI() {
    let e;
    return this.styleType === Fe.ICON ? Ye.isImageUrl(this.icon) ? (e = new Cs(), e.url = this.icon, e.width = this.width, e.height = this.height, e.xoffset = this.xOffset, e.yoffset = this.yOffset, e.angle = this.angle) : (e = new Kt(), e.color = new Mt(this.colour.rgba), e.size = this.width, e.xoffset = this.xOffset, e.yoffset = this.yOffset, e.angle = this.angle) : (e = new Kt(), e.color = new Mt(this.colour.rgba), e.size = this.size, e.xoffset = this.xOffset, e.yoffset = this.yOffset, e.angle = this.angle, e.path = this.path, e.style = this.styleType, e.outline = this.outline.toESRI()), e;
  }
  static fromESRI(e) {
    const t = {
      xOffset: e.xoffset,
...
class Pe extends Ue {
  ...
  constructor(e) {
    ...
    this._width = typeof t > "u" || t < 0 ? 0.75 : t, this._colour = new Be(e.colour), this._miter = e.miter ?? 2, this._cap = e.cap || qi.ROUND, this._join = e.join || Bi.ROUND;
  }
...
class Et extends Ue {
  ...
  _fillStyle;
  constructor(e) {
    super(), e = e || {}, e.fill || (e.fill = {}), this._fillColour = new Be(e.fill.colour), this._fillStyle = e.fill.style || ji.SOLID, this._outlineStyle = new Pe(e.outline);
  }
  /** Returns the specified colour */
  get fillColour() {
  ...
  toESRI() {
    const e = this.outline.toESRI(), t = new Mt(this.fillColour.rgba), i = new Os();
...
class qs {
  ...
  geomEsriToRamp(e, t) {
    switch (e.type) {
      ...
      case "polyline": {
        const i = e;
        return i.paths.length === 1 ? Ke.fromESRI(i, t) : Te.fromESRI(i, t);
      }
      case "polygon":
        return he.fromESRI(e, t);
      case "extent":
        return Z.fromESRI(e, t);
      case "multipoint":
  ...
  graphicRampToEsri(e) {
    ...
    return t.geometry = this.geomRampToEsri(e.geometry), Object.keys(e.attributes).forEach((i) => t.attributes[i] = e.attributes[i]), e.style && (t.symbol = this.styleRampToEsri(e.style)), new $s(t);
  }
  styleRampToEsri(e) {
    return e.toESRI();
  }
...
class xt {
  ...
  static fromConfig(e) {
    return new xt(
      e.id,
      Z.fromConfig(`${e.id}-extent-default`, e.default),
      e.full !== void 0 ? Z.fromConfig(`${e.id}-extent-full`, e.full) : void 0,
      e.maximum !== void 0 ? Z.fromConfig(`${e.id}-extent-maximum`, e.maximum) : void 0
    );
  }
  clone() {
...
class Ws {
  ...
  async projectGeoJson(e, t, i) {
    let s, a;
    if (t ? s = this.normalizeProj(t) : s = T.parseGeoJsonCrs(e.crs), i ? a = this.normalizeProj(i) : a = Hs, a === s)
      return e;
  ...
  async projectExtent(e, t) {
    const i = (y, A, v) => {
      if (v === 0)
        return [y, A];
      const C = [(y[0] + A[0]) / 2, (y[1] + A[1]) / 2];
      if (v === 1)
        return [y, C, A];
      if (v > 1) {
        const q = i(y, C, v - 1), L = i(C, A, v - 1);
    ...
    return Z.fromParams(t.id + "_projected", p, m, d, h, l.sr);
  }
}
class Ys {
  // useful functions
...
const Dt = W("appbar", () => {
  ...
  const r = f([]), e = f([]), t = f([]);
  function i(p) {
    return jt(r.value, (d) => d?.uid === p);
  }
  function s(p) {
    return jt(r.value, (d) => d?.id === p);
  }
  function a(p) {
    return jt(
      r.value,
...
class Qs extends re {
   ...
   */
  addDefaultEvents(e) {
    return (!Array.isArray(e) || e.length === 0) && (e = Object.values(Xt)), e.map((t) => this.defaultHandlerFactory(t));
  }
  /**
  ...
  defaultHandlerFactory(e) {
    ...
    switch (e) {
      ...
      case "ramp_layer_remove_checks_grid":
        t = (i) => {
          if (this.$iApi.fixture.get("grid")) {
            const s = Zt(this.$vApp.$pinia), a = s.getGridId(i.id);
            if (a === void 0) return;
      ...
      case "ramp_map_resize_updates_scalebar":
        this.$iApi.event.on(
          "map/resized",
          Pt(100, () => this.$iApi.geo.map.caption.updateScale()),
          e
        );
        break;
      case "ramp_map_scale_updates_scalebar":
        this.$iApi.event.on(
          "map/scalechanged",
          Pt(300, () => this.$iApi.geo.map.caption.updateScale()),
          e
        );
        break;
      case "ramp_panel_close_updates_appbar":
        t = (i) => {
          const s = Dt(this.$vApp.$pinia);
...
function sr() {
  let r = document.documentElement.getAttribute("lang") || Ht;
  return tr.includes(r) || (r = Ht), Ps({
    legacy: !1,
...
const Gt = W("maptip", () => {
  ...
  __name: "esri-map",
  setup(r) {
    const e = Gt(), t = Ie("iApi"), i = G(() => e.maptipPoint), s = G(() => e.maptipInstance), a = G(() => e.content), o = Re([]), l = f(!1);
    o.push(
      kt(i, () => {
        if (i.value) {
...
const or = ["data-cy"], Zi = /* @__PURE__ */ D({
    ...
    return (n, c) => {
      ...
      return b(), w("div", {
        ...
        me(Fi, {
          ...
          default: pe(() => [
            V((b(), ee(gs(r.panel.route.screen), vs({ class: "h-full" }, r.panel.route.props, { panel: r.panel }), null, 16, ["panel"])), [
              [u]
            ])
          ]),
          _: 1
  ...
  function h(E) {
    const R = [];
    return E.forEach((X) => {
      X in l.value && R.push(l.value[X].getPromise());
    }), R;
  }
  function y(E) {
  ...
  function O() {
    let E = t.value;
    const R = [], X = 350, we = 12, je = 600;
    for (let _e = n.value.length - 1; _e >= 0; _e--) {
      const nt = n.value[_e];
      let Ne = nt.width || X;
      if (s.value ? Ne = E : Ne += we, nt.id === "grid" && (Ne = Math.max(Math.min(Ne, E), je)), (E >= Ne && !s.value || R.length === 0) && (E -= Ne, R.unshift(nt)), nt.id === "grid" && E < je)
        break;
    }
    if (r.value && //@ts-expect-error TODO: explain why this is needed or remove
    !R.includes(r.value) && !s.value) {
      let _e;
      for (let gi = 0; gi < R.length - 1 && E < (r.value.width || X) + we; gi++)
        _e = R.shift(), E += _e.width || X;
      E >= (r.value.width || X) ? R.unshift(r.value) : e.value || (_e = R.shift(), R.unshift(r.value));
      const nt = n.value.indexOf(r.value), Ne = n.value.indexOf(_e), Bt = n.value.slice();
      Ne > -1 && (Bt.splice(nt, 1), Bt.splice(Ne, 0, r.value)), n.value = Bt;
    }
    i.value = E, u.value = R;
  }
  function P(E) {
  ...
  function N(E) {
    if (E.teleport) {
      ...
      const R = n.value.indexOf(E);
      R !== -1 && (n.value = [...n.value.slice(0, R), ...n.value.slice(R + 1)]);
    }
  }
  function F(E, R) {
    const X = n.value.indexOf(E), we = R === "right" ? 1 : -1;
    u.value.includes(n.value[X + we]) && ([n.value[X], n.value[X + we]] = [
      n.value[X + we],
      n.value[X]
    ]);
  }
  function j(E) {
    ...
    R !== -1 && (u.value = [...u.value.slice(0, R), ...u.value.slice(R + 1)]), r.value && r.value.id == E.id && (r.value = void 0);
  }
  function Y(E) {
    l.value = {
      ...l.value,
  ...
  setup(r) {
    ...
    const e = it(), t = Ie("iApi"), i = f(), s = G(() => e.opacity), a = G(() => e.mobileView);
    st(() => {
    ...
    return (u, p) => (b(), ee(Di, {
      ...
      default: pe(() => [
        (b(!0), w(tt, null, bt(o(I(t).screenSize), (d) => (b(), ee(Zi, {
          key: `${d.id}`,
          panel: d
        }, null, 8, ["panel"]))), 128))
      ]),
  ...
  for (const [i, s] of e)
    t[i] = s;
  return t;
}, lr = /* @__PURE__ */ qe(nr, [["__scopeId", "data-v-717e4bd7"]]), cr = ["content", "aria-label"], ai = /* @__PURE__ */ D({
  ...
  setup(r) {
    const e = f(!1), t = f(null), i = Re([]), s = f(), a = f(), o = f(), l = r;
    i.push(
      kt(e, () => {
        t.value.update();
      })
  ...
  setup(r) {
    const e = ze(), { t } = se(), i = G(() => e.notificationNumber), s = () => e.clearAll();
    return (a, o) => {
...
const mr = ["content"], yr = { class: "flex items-center text-left" }, gr = { class: "select-text cursor-text" }, vr = ["content", "aria-label"], br = {
      ...
      return V((b(), w("li", {
        ...
        g("div", yr, [
          g("span", null, [
            ...
            g("span", gr, z(r.notification.message), 1)
          ]),
          ...
          V((b(), w("button", {
            type: "button",
            onClick: c[0] || (c[0] = ii(() => i("remove"), ["stop"])),
        ...
        r.notification.messageList && a.value ? (b(), w("div", br, [
    ...
    return (c, u) => {
      ...
      return b(), w("div", null, [
        n.value.length > 0 ? V((b(), w("ul", {
          ...
          (b(!0), w(tt, null, bt(n.value, (h, y) => (b(), w(tt, {
            key: h.id
          }, [
            y > 0 ? (b(), w("div", Er)) : B("", !0),
            V(me(Ar, {
          ...
          g("span", null, z(I(t)("notifications.empty")), 1),
      ...
      return b(), ee(ai, {
        ...
        header: pe(() => [
          g("div", Sr, [
            ...
            i.value && i.value > 0 ? (b(), w("span", _r, z(i.value), 1)) : B("", !0)
          ])
        ]),
        default: pe((c) => [
          g("div", Tr, [
            g("div", null, [
              g("h4", Lr, z(I(t)("notifications.title")), 1),
              g("div", Rr, [
                V((b(), w("button", {
                  type: "button",
                  onClick: s,
  ...
  setup(r) {
    const { t: e } = se(), t = Ie("iApi"), i = () => {
      t.reload();
    }, s = G(() => `${wt.major}.${wt.minor}.${wt.patch}`), a = G(() => wt.hash.slice(0, 9)), o = G(() => {
        ...
        default: pe((m) => [
          g("div", Pr, [
            g("div", null, [
              ...
              g("div", Gr, [
                g("div", null, [
                  g("span", Ur, z(s.value), 1),
                  g("span", Vr, " [" + z(a.value) + "] ", 1)
                ]),
                g("div", null, [
                  g("span", zr, z(o.value[0]), 1),
                  g("span", Br, z(o.value[1]), 1)
                ]),
...
}), jr = /* @__PURE__ */ qe(qr, [["__scopeId", "data-v-e0d1ce9f"]]), Hr = "S", Wr = "__HELP__", es = W("keyboardnav", () => {
  const r = f(), e = f({}), t = f(!1), i = f([]), s = f(), a = f("idle"), o = ["H", "?"];
  function l() {
    const _ = "ABCDEFGHIJKLMNOPQRSTUVWXYZ";
    for (const N of _)
      if (!e.value[N] && !o.includes(N)) return N;
  }
  function n(_, N) {
    let F = _.toUpperCase();
    if (o.includes(F) || e.value[F]) {
      const j = l();
      j ? F = j : console.error("No available keyboard namespace letters");
    }
    if (!N.handler)
      for (const j of N.keys)
        j.handler || console.error(
          `Keyboardnav registration for ${F} requires handlers for all keys or a parent handler`
        );
    return e.value[F] = N, F;
  }
  function c(_) {
    t.value !== _ && (t.value = _);
  }
  ...
  function p(_, N, F) {
    if (_) {
      if (_ === "clear") {
        y({ event: N, suppressHandler: !0 });
        return;
      }
      if (_ === "reset") {
        const j = F ?? P.activeNamespace ?? P.keyChain[1];
        if (!j) {
          y({ suppressHandler: !0 });
          return;
        }
        A([Hr, j]), q(void 0), L("awaitAction"), P.activeNamespace = j;
      }
    }
  }
  function d(_, N, F) {
    r.value = _, !F?.suppressHandler && e.value[_]?.activeHandler?.(P, N);
  }
  function m(_, N) {
    r.value && !N?.suppressHandler && e.value[r.value]?.deactiveHandler?.(P, _), r.value = void 0;
  }
  function h(_, N) {
    const F = r.value;
    if (!F) return;
    ...
    if (!j) return;
    if (j.handler) {
      const R = j.handler(P, N, _);
      return p(R, N, F), { namespace: F, key: _, chainAction: R ?? void 0 };
    }
    const Y = j.keys.find((R) => R.key === _);
    if (!Y)
      return;
    const E = Y.handler?.(P, N);
    return p(E, N, F), { namespace: F, key: Y.key, chainAction: E ?? void 0 };
  }
  function y(_) {
  ...
  __name: "map-caption",
  setup(r) {
    const e = Je(), t = es(), i = be(), { t: s } = se(), a = Ie("iApi"), o = G(() => e.scale), l = G(() => e.attribution), n = G(() => e.coords), c = G(() => e.langtoggle), u = G(() => i.config.map), { keyChain: p, lastAction: d, chainState: m, namespaces: h, activeNamespace: y } = fs(t), A = G(() => {
      if (!p.value.length) return;
      const P = p.value.join(" "), _ = m.value === "awaitNamespace" || m.value === "awaitAction";
      let N;
      const F = d.value;
      if (F)
        if (F.namespace === Wr)
          N = s("keyboardnav.chain.help");
        else {
          const Y = `keyboardnav.key.${F.namespace}.${F.key}`, E = s(Y);
          E !== Y && (N = E);
        }
      let j;
      if (m.value === "awaitNamespace") {
        const Y = `H - ${s("keyboardnav.chain.help")}`, E = Object.keys(h.value).map((X) => {
          const we = `keyboardnav.ns.${X}`, je = s(we);
          return `${X} - ${je === we ? X : je}`;
        });
        j = `[${[Y, ...E].join(", ")}]`;
      } else if (m.value === "awaitAction") {
        const Y = y.value ?? p.value[1], E = Y ? h.value[Y] : void 0;
        E && E.keys?.length && (j = `[${E.keys.map((X) => {
          const we = `keyboardnav.key.${Y}.${X.key}`, je = s(we), _e = je === we ? X.key : je;
          return `${X.key} - ${_e}`;
        }).join(", ")}]`);
      }
      return {
    ...
    C.push(
      kt(u, (P) => {
        P && a.geo.map.caption.createCaption(u.value?.caption);
      })
    ), vt(() => {
      C.forEach((P) => P());
    }), ws(() => {
    ...
    const q = () => l.value?.logo?.link && l.value?.logo?.value && !l.value?.logo?.disabled, L = (P) => {
      a.$i18n.locale.value != P && a.setLanguage(P);
    }, M = () => {
      e.toggleScale(), a.geo.map.caption.updateScale();
    }, O = (P = !1) => s(P ? "map.toggleScaleToMetric" : "map.toggleScaleToImperial");
    return (P, _) => {
      const N = ae("dropdown-menu"), F = U("truncate"), j = U("tippy");
      return b(), w("div", Yr, [
        me(jr, {
        ...
        A.value ? (b(), w("span", Xr, [
          g("span", Qr, [
            ...
            g("span", ea, z(A.value.keys), 1),
            A.value.cursor ? (b(), w("span", ta, "_")) : B("", !0),
            A.value.options ? (b(), w("span", ia, z(A.value.options), 1)) : B("", !0)
          ]),
          A.value.description ? (b(), w("span", sa, "- " + z(A.value.description) + "...", 1)) : B("", !0)
        ])) : l.value?.text.disabled ? B("", !0) : V((b(), w("span", ra, [
        ...
        g("div", aa, [
          n.value?.disabled ? B("", !0) : V((b(), w("div", oa, [
          ...
          o.value?.disabled ? B("", !0) : V((b(), w("button", {
            key: 1,
            type: "button",
          ...
          c.value?.disabled ? B("", !0) : (b(), ee(N, {
            ...
            header: pe(() => [
              g("span", ca, z(I(s)("map.language.short")), 1)
            ]),
            default: pe(() => [
              (b(!0), w(tt, null, bt(v.value, (Y, E) => (b(), w("a", {
                key: `${Y}-${E}`,
                class: ue(["flex-auto items-center text-sm sm:text-base cursor-pointer", { "font-bold": Y === I(a).$i18n.locale.value }]),
                href: "javascript:;",
                onClick: (R) => L(Y)
              }, [
                ht(z(I(s)("map.language." + Y)) + " ", 1),
                Y === I(a).$i18n.locale.value ? (b(), w("span", pa, z(I(s)("map.language.curr")), 1)) : B("", !0)
              ], 10, ua))), 128))
            ]),
            _: 1
          }, 8, ["tooltip", "ariaLabel"]))
  ...
  setup(r) {
    const e = ze(), t = Ie("iApi"), { t: i } = se(), s = G(() => e.notificationNumber);
    return (a, o) => {
      const l = U("tippy");
      return V((b(), w("button", {
        type: "button",
        ...
        s.value && s.value > 0 ? (b(), w("span", fa, z(s.value), 1)) : B("", !0)
      ], 8, ha)), [
        [l]
      ]);
    };
  }
}), ya = /* @__PURE__ */ qe(ma, [["__scopeId", "data-v-a451db5c"]]), ga = { class: "flex items-center mb-20" }, va = { class: "text-xl" }, ba = /* @__PURE__ */ D({
  __name: "keyboard-instructions",
  setup(r) {
    const e = Ie("iApi"), { t } = se(), i = f(!1), s = f(["app", "lists", "map", "keyboardNav"]), a = f([]), o = f(null), l = f(null);
    st(() => {
      a.value.push(
    ...
    return (c, u) => {
      ...
      return i.value ? (b(), w("div", {
        ...
        g("div", {
          ...
          g("div", ga, [
            g("h2", va, z(I(t)("keyboardInstructions.title")), 1),
            me(p, {
              class: "ml-auto",
...
}), ut = W("instance", () => ({ started: f(!1) })), Aa = { class: "h-full relative" }, wa = { class: "inner-shell absolute top-0 left-0 h-full w-full pointer-events-none" }, Ea = { class: "absolute top-8 w-full flex justify-center" }, xa = {
  key: 1,
  class: "w-full h-full"
}, Sa = /* @__PURE__ */ D({
  __name: "shell",
  setup(r) {
    const e = Ie("iApi"), t = ut(), i = Ee(), s = it(), { t: a } = se(), o = G(() => i.items.appbar), l = () => {
      e.event.emit("openKeyboardInstructions");
    }, n = () => s.teleported;
    return (c, u) => (b(), w("div", Aa, [
      g("div", wa, [
        ...
        o.value ? B("", !0) : (b(), ee(ya, { key: 0 })),
        me(da, { class: "z-30" })
      ]),
      I(t).started ? (b(), ee(rr, { key: 0 })) : (b(), w("div", xa, u[1] || (u[1] = [
        g("div", { class: "spinner relative inset-x-1/2 inset-y-9/20" }, null, -1)
      ]))),
      (b(!0), w(tt, null, bt(n(), (p) => (b(), ee(Es, {
...
}), Ia = /* @__PURE__ */ qe(Sa, [["__scopeId", "data-v-3d441124"]]), _a = D({
  name: "App",
  components: { Shell: Ia },
  setup() {
    const r = xs();
...
const $a = /* @__PURE__ */ qe(_a, [["render", Ra]]), Oe = "focus-list", He = "focus-item", Ca = "focus-icon", Oa = "focus-container", yt = `[${Oe}],[${Oa}]`, Tt = "truncate-text", Lt = "show-truncate", dt = "focused", Qt = `button,input,select,a,textarea,[contenteditable],[${Oe}],[${Ca}],[tabIndex]`, ka = {
  mounted(r, e) {
    +r.getAttribute("tabindex") <= 0 && r.setAttribute("tabindex", "0"), r.toggleAttribute(Oe, !0), new Ma(r, e.value);
  },
  updated(r) {
    ts(r);
  }
...
function ts(r) {
  r.querySelectorAll(Qt).forEach((t) => {
...
class Ma {
  ...
  setTabIndex(e, t = this.element) {
    t.querySelectorAll(Qt).forEach((s) => {
    ...
    if (i.length !== 0)
      switch (e.key) {
        ...
        case " ":
          ...
          break;
        case "Tab":
          const s = this.highlightedItem.querySelectorAll(Qt).length === 0, a = this.element.isEqualNode(e.target);
  ...
  onFocus() {
    ...
    this.highlightedItem && !this.isClicked && (this.highlightedItem._tippy && this.highlightedItem._tippy.show(), this.highlightedItem.getAttribute(He) === Lt && this.highlightedItem.querySelector(`[${Tt}]`)?._tippy?.show()), this.isClicked = !1, this.element.hasAttribute("aria-activedescendant") || this.highlightedItem === this.element ? this.highlightedItem !== this.element && this.focusItem(this.highlightedItem) : this.setAriaActiveDescendant(this.highlightedItem), ts(this.element), this.highlightedItem && this.highlightedItem !== this.element && this.highlightedItem.setAttribute("tabindex", "-1");
  }
  /**
...
const oi = "focus-container", is = "focus-list", Fa = "focus-icon", Wt = `[${is}],[${oi}]`, xi = `button,input,select,a,textarea,[contenteditable],.ag-tab-guard,[${is}],[${oi}],[${Fa}],[tabIndex]`;
let Yt = [];
const Da = {
  mounted(r) {
    [...document.querySelectorAll(".inner-shell")].some((t) => t.contains(r)) && Yt.push(new Ga(r));
  },
  beforeUnmount(r) {
    Yt = Yt.filter((e) => e.element === r ? (e.removeEventListeners(), !1) : !0);
  }
};
class Ga {
  element;
   ...
   */
  constructor(e) {
    this.element = e, this.element.toggleAttribute(oi, !0), this.element.tabIndex = 0, setTimeout(() => this.disableTabbing(), 600);
    const t = this;
  ...
  enableTabbing() {
    ...
    return Array.prototype.map.call(this.element.querySelectorAll(xi), (t) => {
      (t.closest(Wt) === this.element || t.closest(Wt) === t && t.parentElement.closest(Wt) === this.element) && t.offsetParent && (t.tabIndex = 0, e === void 0 && (e = t));
    }), e;
  }
}
...
const ja = ["content"], Ha = {
  ...
  setup(r, { expose: e }) {
    const { t } = se(), i = it(), s = Dt(), a = Ie("iApi"), o = vi("el"), l = vi("contentEl"), n = f();
    e({ el: o });
    const c = r, u = G(() => a.fixture.get("appbar") ? s.temporary : []), p = G(() => i.mobileView), d = G(() => i.reorderable), m = (v) => v.scrollHeight > v.clientHeight, h = () => !p.value && !c.panel.teleport, y = (v) => {
      c.panel.move(v), v === "left" && It(() => {
        (o.value?.querySelector(".move-left")).focus();
      });
    }, A = G(() => c.screenId ? c.panel.screens[c.screenId][a.$i18n.locale.value ?? "en"] : null);
    return st(() => {
      o.value?.addEventListener("blur", () => {
        ...
        m(l.value) ? l.value?.setAttribute("tabIndex", "0") : l.value?.removeAttribute("tabIndex");
      ...
      const q = ae("back"), L = ae("panel-options-menu"), M = ae("left"), O = ae("right"), P = ae("pin"), _ = ae("expand"), N = ae("minimize"), F = ae("close"), j = U("truncate"), Y = U("focus-item"), E = U("tippy");
      return V((b(), w("div", {
        ...
        r.header ? (b(), w("header", Ha, [
          me(q, {
            class: ue(r.panel.teleport ? "display-none" : "block sm:display-none"),
            onClick: C[0] || (C[0] = (R) => r.panel.close())
          }, null, 8, ["class"]),
          V((b(), w("h2", Wa, [
            v.$slots.header ? Ve(v.$slots, "header", { key: 0 }) : (b(), w("div", Ya, z(I(t)(r.panel.alertName)), 1))
          ])), [
            [j]
          ]),
          v.$slots.controls ? (b(), ee(L, { key: 0 }, {
            default: pe(() => [
              Ve(v.$slots, "controls")
            ]),
            _: 3
          ...
          g("div", {
            ...
            r.panel.teleport ? B("", !0) : (b(), w("div", Ja, [
              d.value ? (b(), ee(M, {
                key: 0,
                onClick: C[1] || (C[1] = (R) => y("left")),
                active: !r.panel.isLeftMostPanel
              }, null, 8, ["active"])) : B("", !0),
              d.value ? (b(), ee(O, {
                key: 1,
                onClick: C[2] || (C[2] = (R) => y("right")),
                active: !r.panel.isRightMostPanel
              }, null, 8, ["active"])) : B("", !0),
              me(P, {
                onClick: C[3] || (C[3] = (R) => r.panel.pin()),
                active: r.panel.isPinned
              }, null, 8, ["active"]),
              r.panel.controls && r.panel.controls.expand ? (b(), ee(_, {
                key: 2,
                onClick: C[4] || (C[4] = (R) => r.panel.expand()),
                active: r.panel.expanded
              }, null, 8, ["active"])) : B("", !0)
            ])),
            r.panel.button && u.value?.includes(r.panel.id) ? (b(), ee(N, {
              key: 1,
              onClick: C[5] || (C[5] = (R) => r.panel.minimize())
            })) : B("", !0),
            me(F, {
              onClick: C[6] || (C[6] = (R) => r.panel.close())
            })
          ], 2)
        ])) : B("", !0),
        r.content ? (b(), w("div", {
...
}), Qa = { class: "relative" }, eo = ["content", "aria-label"], to = ["transform"], io = /* @__PURE__ */ D({
  __name: "pin",
  props: {
    active: Boolean
  },
...
}), so = { class: "relative" }, ro = ["content", "aria-label"], ao = /* @__PURE__ */ D({
  __name: "close",
  props: {
    active: Boolean
  },
...
}), oo = { class: "relative" }, no = ["content", "aria-label"], lo = /* @__PURE__ */ D({
  __name: "back",
  props: {
    active: Boolean
  },
...
}), co = { class: "w-32 h-32" }, uo = ["content", "aria-label"], po = {
  key: 0,
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 24 24",
...
}), mo = { class: "relative" }, yo = ["content", "aria-label"], go = /* @__PURE__ */ D({
  __name: "minimize",
  props: {
    active: Boolean
  },
...
}), vo = { class: "relative" }, bo = ["content", "aria-label"], Ao = /* @__PURE__ */ D({
  __name: "right",
  props: {
    active: Boolean
  },
...
}), wo = { class: "relative" }, Eo = ["content", "aria-label"], xo = /* @__PURE__ */ D({
  __name: "left",
  props: {
    active: Boolean
  },
...
}), Io = /* @__PURE__ */ qe(So, [["__scopeId", "data-v-51e22a4a"]]), _o = {
  key: 0,
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 24 24",
  ...
  setup(r) {
    ...
    return (s, a) => {
      ...
      return b(), ee(o, {
        ...
        default: pe(() => [
          I(t).isFullscreen ? (b(), w("svg", _o, a[0] || (a[0] = [
            g("path", {
              d: "M0 0h24v24H0z",
              fill: "none"
            }, null, -1),
  ...
  tabindex: "-1"
}, Oo = ["content", "aria-label"], ko = /* @__PURE__ */ D({
  __name: "button",
  props: {
    onClickFunction: {
      type: Function,
  ...
  class: "relative",
  tabindex: "-1"
}, Po = ["aria-label", "content"], No = /* @__PURE__ */ D({
  __name: "button",
  props: {
    onClickFunction: {
      type: Function,
  ...
  setup(r) {
    const e = Ie("iApi"), t = r, i = () => e.event.emit(x.APPBAR_BUTTON_CLICK, t.buttonId);
    return (s, a) => {
...
}), Fo = /* @__PURE__ */ qe(No, [["__scopeId", "data-v-1cb84ae1"]]), Do = W("areas-of-interest", () => ({ areas: f([]) })), Go = W("export", () => {
  const r = f({
    title: !0,
    map: !0,
    mapElements: !0,
...
class Bo {
  ...
  fsaToProvince(e) {
    ...
    return s === "X" ? i === "X0A" || i === "X0B" || i === "X0C" ? t = 62 : t = 61 : t = Vo[s], this.codeToProvince(t);
  }
}
function qo(r) {
  return new Bo(r);
...
async function Wo(r, e) {
  ...
  return s.test(e) && !r.disabledSearchTypes.includes("LAT/LNG") ? (i = e.slice(0, -1), t = new $t(r, i), await Zo(t)) : o.test(e) && !r.disabledSearchTypes.includes("FSA") ? (i = e.substring(0, 3).toUpperCase(), t = new $t(r, i), await Xo(t)) : a.test(e) && !r.disabledSearchTypes.includes("NTS") ? (i = e.substring(0, 6).toUpperCase(), t = new $t(r, i), await Qo(t)) : (i = encodeURIComponent(e.trim()), t = new $t(r, i), await en(t)), r.customSources.length && await Yo(t, r.customSources), t;
}
const ni = async (r) => {
  const [e, t] = await Se(_t.get(r));
  ...
  await Ko(r, t, i), r.addResult(s);
}, Xo = async (r) => {
  const e = r.config, t = await ci(r);
  if (t.length) {
  ...
  const e = r.config;
  if (await Jo(r), e.categories.length === 0 || e.categories.includes("ADDR")) {
    const t = await ci(r), i = e.sortOrder.indexOf("ADDR"), s = i >= 0 ? i : e.sortOrder.length, a = t.filter((o) => o.type?.includes("Street")).map((o) => {
...
}, tn = "~FSA~", Ii = "https://geogratis.gc.ca/services/geolocation/@{language}/locate", _i = "https://geogratis.gc.ca/services/geoname/@{language}/geonames.json", Ti = "https://geogratis.gc.ca/services/geoname/@{language}/codes/province.json", Li = "https://geogratis.gc.ca/services/geoname/@{language}/codes/concise.json";
class Ri {
  config;
  constructor(e, t) {
    let i, s, a, o;
    ...
    if (c && c.serviceUrl) {
      ...
      n = `${c.serviceUrl}/query/?where=${v}%3D'${tn}'&outFields=${v}&returnGeometry=true&f=json`;
    }
    const u = t?.settings;
    let p, d, m, h, y, A;
    u ? (p = u.categories ? u.categories : [], d = u.sortOrder ? u.sortOrder : [], m = u.disabledSearchTypes ? u.disabledSearchTypes : [], h = u.maxResults > 0 ? u.maxResults : 100, y = !!u.officialOnly) : (p = [], d = [], m = [], h = 100, y = !1), A = t?.customSources ?? [], A = A.map((v) => ({
      ...v,
      onSearch: async (C) => {
        const q = v.data ?? [], M = rs().cleanVal(C).replace("*", "");
        return q.filter((O) => O.name.toLowerCase().includes(M)).map((O) => ({
          name: O.name,
          type: v.catName,
          bbox: O.bbox,
          flav: "nme",
   ...
   */
  async query(e) {
    const t = await Wo(this.config, e.toUpperCase()), i = this.config.sortOrder.length, s = t.results.filter((n) => n.order < i), a = t.results.filter((n) => n.order >= i);
...
const rs = W("geosearch", () => {
  const r = f(new Ri("en", void 0)), e = f({
    ...
    () => r.value.fetchProvinces().then((L) => (L.sort((M, O) => M.name.localeCompare(O.name, void 0, { sensitivity: "case" })), L))
  ), p = G(
    () => new Promise((L) => {
      r.value.fetchTypes().then((M) => {
        M.sort(
          (O, P) => O.name.localeCompare(P.name, void 0, { sensitivity: "case" })
        ), L(M);
      });
    })
  );
  ...
  function h(L) {
    n.value = !0;
    const M = i.value.replace(/["!*$+?^{}()|[\]\\]/g, "").trim();
    if (!M)
      o.value = [], l.value = [], n.value = !1;
    else if (M && M !== a.value || L) {
      const O = setInterval(() => {
        r.value.config.provinces.listFetched && r.value.config.types.typesFetched && (clearInterval(O), r.value.query(`${M}*`).then((P) => {
          c.value = P.failedServs, a.value = M, l.value = P.results;
          const _ = $i(
            t.value,
            //@ts-expect-error TODO: explain why this is needed or remove
            e.value,
  ...
  function C(L) {
    ...
    L = m(L), s.value = Array.from(L).map((O) => Object.keys(M).includes(O) ? "[" + O + M[O] + "]" : O.replace(/["$!*+?^{}()|[\]\\]/g, "").replace(/[.\\]/g, "\\$&").trim()).join("");
  }
  function q(L) {
...
}), sn = W("help", () => ({ location: f("./help/") }));
var as = /* @__PURE__ */ ((r) => (r.Visibility = "visibilityButton", r.Expand = "expandButton", r))(as || {}), ei = /* @__PURE__ */ ((r) => (r.Item = "item", r.Placeholder = "placeholder", r.Error = "error", r))(ei || {});
class os extends re {
  _uid;
  _name;
  _type;
  ...
  toggleVisibility(e, t = !0) {
    if (this.visibility !== e) {
      if (this._visibility = e ?? !this.visibility, !this.exclusive)
        ...
        if (this._lastVisible && (!(this._lastVisible instanceof We) || this._lastVisible.layerControlAvailable(Q.Visibility)))
          this._lastVisible.toggleVisibility(!0);
        else {
          const i = this.children.find(
            (s) => !(s instanceof We) || s.layerControlAvailable(Q.Visibility)
          );
   ...
   */
  checkVisibility(e) {
    this instanceof We && !this.layerControlAvailable(Q.Visibility) || (this.exclusive ? e.visibility ? (this.children.forEach((t) => {
...
class We extends os {
  ...
  load(e) {
    const t = e instanceof pi ? e : this.$iApi.geo.layer.getLayer(this._layerId ?? this._layerUid);
    t && (this.layer = t, this._layerRedrawing = t.mapLayer && t.drawState !== fe.UP_TO_DATE, t.loadPromise().then(() => {
      this._layerInitVis = typeof this._layerInitVis < "u" ? this._visibility : t.visibility, super.load(), this.toggleVisibility(this._layerInitVis, !0, !0), t.visibility || this.setSymbologyVisibility(void 0, !1), this.handlers.push(
        this.$iApi.event.on(
          ...
          (i) => {
            i.layer.uid === this.layer.uid && this._type === ei.Item && this.toggleVisibility(i.visibility, !0, !0);
          }
        )
      ), this.handlers.push(
        this.$iApi.event.on(
...
var rn = /* @__PURE__ */ ((r) => (r.Title = "title", r.Text = "text", r.Image = "image", r.Markdown = "markdown", r.Template = "template", r))(rn || {});
class Ci extends os {
  _infoType;
...
const an = W("legend", () => {
  ...
  function a(n) {
    if (n.parent === void 0)
      ...
      if (!(n.item instanceof Ci) && !(n.item instanceof We)) {
...
class dn {
  ...
  constructor(e, t, i) {
    ...
    const s = hn(e, this);
    this.$vApp = s.app, this.$element = s.element, this.$i18n = s.i18n, this.$rootEl = s.app.$root?.$el, this.fixture = new cl(this), this.panel = new ul(this), this.geo = new nl(this), this.dev = new yl(this), this.ui = {
      ...
      escapeHtml: () => "",
      isPlainText: () => !0
    }, this.notify = new fr(this), this._isFullscreen = Ce.isEnabled && !!this.$vApp.$root && Ce.isFullscreen && Ce.element === this.$vApp.$root.$el, Ce.isEnabled && Ce.onchange(() => {
   ...
   */
  initialize(e, t, i) {
    const s = be(this.$vApp.$pinia), a = it(this.$vApp.$pinia), o = Gt(this.$vApp.$pinia);
    if (t?.configs !== void 0) {
   ...
   */
  reloadWorker(e, t) {
    const i = ut(this.$vApp.$pinia), s = ze(this.$vApp.$pinia), a = be(this.$vApp.$pinia), o = Ee(this.$vApp.$pinia), l = Me(this.$vApp.$pinia), n = Zt(this.$vApp.$pinia), c = !!e;
  ...
  useStore(e) {
    if (!([
      ...
      switch (e) {
        ...
        case "export":
          return Go(this.$vApp.$pinia);
        case "extentguard":
          return Uo(this.$vApp.$pinia);
        case "geosearch":
          return rs(this.$vApp.$pinia);
        case "grid":
          return Zt(this.$vApp.$pinia);
        case "help":
...
function hn(r, e) {
  ...
  s.directive("focus-container", Da), s.directive("focus-list", ka), s.directive("focus-item", Pa), s.directive("truncate", za), s.component("panel-screen", Xa), s.component("pin", io), s.component("close", ao), s.component("back", lo), s.component("expand", fo), s.component("panel-options-menu", Io), s.component("dropdown-menu", ai), s.component("minimize", go), s.component("right", Ao), s.component("left", xo), s.component("fullscreen-nav-button", Lo), s.component("geolocator-nav-button", Ro), s.component("home-nav-button", $o), s.component("mapnav-button", ko), s.component("appbar-button", Fo), s.component("transition", Fi), s.component("transition-group", Di), s.config.globalProperties.$iApi = e, s.config.globalProperties.$pinia = t, s.config.idPrefix = `ramp-${r.id || et.sharedUtils.generateUUID()}`, s.provide("iApi", e);
  const a = s.mount(r);
...
class ui {
  ...
  static async create(e) {
    const t = new ui(e), i = e.layers.map((o) => {
      const l = {
        url: o.url,
        opacity: o.opacity
      };
...
class fn extends re {
  ...
  async createMap(e, t) {
    ...
    }, s = e.basemaps.map((n) => ui.create(n)), o = (await Promise.all(s)).filter((n) => (n.createErr && i(n), n.esriBasemap.baseLayers.length > 0));
    o.forEach((n) => {
   ...
   */
  getExtent() {
    return this.esriView ? Z.fromESRI(this.esriView.extent) : (this.noMapErr(), Z.fromParams("i_am_error", 0, 1, 0, 1));
  }
  /**
...
class mn extends re {
   ...
   */
  constructor(e) {
    super(e), this.maptipStore = Gt(this.$vApp.$pinia);
  }
...
class gn extends fn {
   ...
   */
  constructor(e) {
    super(e, "main"), this.maptip = new mn(e), this.caption = new yn(e), this.mapMouseThrottle = 0;
  }
  async createMap(e, t) {
  ...
  async createMapView(e) {
    ...
    this.esriView = ne(
      ...
      n.preventDefault();
    }) : console.error("ESRI Map View is missing its container"), Le(
  ...
  addLayer(e, t = void 0) {
    return new Promise((i, s) => {
      if (this.esriMap || (this.noMapErr(), s()), e.initiationState !== H.INITIATING && e.initiationState !== H.INITIATED && e.layerState !== K.ERROR && e.initiate(), e.mapLayer && t === void 0) {
      ...
      let l = 0;
      const n = setInterval(() => {
        l += 250, l >= e.expectedTime.fail || e.layerState === K.ERROR ? (clearInterval(n), e.lastCancel < o && console.error(`Failed to add layer: ${e.id}.`), s()) : e.initiationState === H.INITIATED && (e.esriLayer || !e.mapLayer) && (clearInterval(n), e.mapLayer ? this.insertToEsriMap(e) : e.onLoad(), i());
      }, 250);
    });
  }
  /**
  ...
  removeLayer(e) {
    ...
    let t;
    if (e instanceof pi ? t = e : t = this.$iApi.geo.layer.getLayer(e), !t)
...
const vn = { geometryType: "point", renderer: { type: "simple", symbol: { type: "esriSMS", style: "esriSMSCircle", color: [67, 100, 255, 200], size: 7, outline: { color: [0, 0, 0, 255], width: 1 } } } }, bn = { geometryType: "polyline", renderer: { type: "simple", symbol: { type: "esriSLS", style: "esriSLSSolid", color: [90, 90, 90, 200], width: 2 } } }, An = { geometryType: "polygon", renderer: { type: "simple", symbol: { type: "esriSFS", style: "esriSFSSolid", color: [76, 76, 125, 200], outline: { type: "esriSLS", style: "esriSLSSolid", color: [110, 110, 110, 255], width: 1 } } } }, wn = { geometryType: "polygon", renderer: { type: "simple", symbol: { type: "esriSFS", style: "esriSFSSolid", color: [255, 0, 0, 64], outline: { type: "esriSLS", style: "esriSLSSolid", color: [240, 128, 128, 255], width: 1 } } } }, En = {
  circlePoint: vn,
  solidLine: bn,
  outlinedPoly: An,
  boundingBoxPoly: wn
...
class Ln extends re {
  ...
  extractCsvFields(e, t = ",") {
    return wi.dsvFormat(t).parseRows(e)[0].map((s) => ({ name: s, type: De.STRING }));
  }
  /**
  ...
  async geoJsonToEsriJson(e, t) {
    ...
    Sn(e);
    const l = e.features[0].geometry.type, n = xn[l], c = JSON.parse(
      // @ts-expect-error TODO: explain why this is needed or remove
      JSON.stringify(En[n])
    );
    if (t) {
    ...
    for (let y = 0; y < d.length; y++) {
      ...
      A.geometry.spatialReference = p, A.geometry.type = o.geometryType, Object.keys(A.attributes).forEach((v) => {
        m.includes(v) ? (Array.isArray(A.attributes[v]) || typeof A.attributes[v] == "object") && A.attributes[v] != null && (A.attributes[v] = JSON.stringify(A.attributes[v])) : delete A.attributes[v];
      });
    }
...
class $n extends re {
  ...
  async loadWfsData(e, t = -1, i = 0, s = 1e3, a = {
    ...
    const u = new Ft(e).updateQuery(n), [p, d] = await Se(_t.get(u, { signal: l }));
    if (!d)
    ...
    if (a.features = a.features.concat(m.features), m.features.length < t - i) {
      ...
      return o && a.features.length > 0 && a.features[0].geometry.type === J.POINT && a.features.forEach((h) => {
  ...
  async parseCapabilities(e) {
    const t = async () => {
      ...
      return m ? (Array.isArray(m) || (m = [m]), m.map((h) => {
        ...
        let v = h.Style;
        const C = [], q = {};
        return v && (Array.isArray(v) || (v = [v]), v.forEach((L) => {
          const M = L.Name;
          if (C.push(M), L.LegendURL) {
            const P = L.LegendURL.OnlineResource["@_xlink:href"];
            q[M] = P.replaceAll("&amp;", "&");
          }
        })), {
...
class Cn extends re {
  ...
  ogc;
  constructor(e) {
    super(e), this.files = new Ln(e), this.ogc = new $n(e);
  }
  /**
  ...
  allActiveLayers() {
    return this.allLayers().filter(
      (e) => e.layerState !== K.ERROR && e.initiationState === H.INITIATED
    );
  }
  /**
  ...
  async loadLayerMetadata(e) {
    ...
    const [t, i] = await Se(Ze(e, { query: { f: "json" } }));
    if (!i)
    ...
    if (a.name = s.name || "", a.currentVersion = s.currentVersion || -1, a.minScale = s.effectiveMinScale || s.minScale || 0, a.maxScale = s.effectiveMaxScale || s.maxScale || 0, a.extent = s.extent ? Z.fromArcServer(s.extent, "layer_extent") : void 0, a.defaultVisibility = s.defaultVisibility ?? !0, a.canModifyLayer = s.canModifyLayer ?? !0, s.type === "Feature Layer" || s.type === "Table") {
...
class pi extends re {
   ...
   */
  getLayerTree() {
    return new Nt(0, "Fake tree", "getLayerTree() was not implemented in layer");
  }
  /**
   ...
   */
  getGraphic(e, t) {
    return Promise.resolve(new $e(new Xe()));
  }
  /**
...
class ns extends pi {
  ...
  constructor(e, t) {
    ...
    this.expectedTime.draw = e.expectedDrawTime ?? i.draw, this.expectedTime.load = e.expectedLoadTime ?? i.load, this.expectedTime.fail = e.maxLoadTime || i.fail, this.lastCancel = 0, this.timers = {
      draw: void 0,
      load: void 0
    }, this.origRampConfig = e, this.id = e.id || "", this.uid = this.$iApi.geo.shared.generateUUID(), this.isCosmetic = !1, this.isSystem = e.system || !1, this.isRemoved = !1, this.isSublayer = !1, this.supportsIdentify = !1, this.mapLayer = !0, this.identifyMode = oe.NONE, this.supportsFeatures = !1, this.maptips = !1, this.supportsSublayers = !1, this.isFile = !1, this.layerState = K.NEW, this.initiationState = H.NEW, this.drawState = fe.NOT_LOADED, this.loadDefProm = new ie(), this.url = this.origRampConfig.url, this.canReload = !!(this.url || this.origRampConfig.caching), this.loadPromDone = !1, this.nameArcadeFormula = "", this.maptipArcadeFormula = "", this.layerTree = new Nt(0, this.uid, this.name, !0);
  }
  updateInitiationState(e) {
  ...
  async terminate() {
    this.updateInitiationState(H.TERMINATING), await Promise.all(this.sublayers.map((e) => e.terminate())), this.loadDefProm = new ie(), this.loadPromDone = !1, this.updateLayerState(K.NEW), this.updateDrawState(fe.NOT_LOADED), this.updateInitiationState(H.TERMINATED);
  }
  // ----------- LAYER LOAD -----------
    ...
    try {
      ...
      Promise.all(s).then(() => {
        clearTimeout(i), t ? this.visibility = !1 : (this.stopTimer(
          "load"
          /* LOAD */
        ), e > this.lastCancel && (this.loadPromDone && (this.loadDefProm = new ie()), this.loadDefProm.resolveMe(), this.loadPromDone = !0, this.sublayers.forEach((a) => a.onLoad()), this.updateLayerState(K.LOADED)));
      }).catch(() => {
  ...
  onError(e = !0) {
    this.layerState !== K.ERROR && (this.initiationState === H.INITIATING && this.updateInitiationState(H.NEW), this.loadPromDone && (this.loadDefProm = new ie()), this.loadDefProm.rejectMe(), this.loadPromDone = !0, this.sublayers.forEach((t) => t.onError(e)), e && this.$iApi.notify.show(
      xe.ERROR,
      this.$iApi.$i18n.t("layer.error", {
        id: this.id
      })
   ...
   */
  getGraphic(e, t) {
    return this.stubError(), Promise.resolve(new $e(new Xe()));
  }
  getIcon(e) {
    return this.stubError(), Promise.resolve("");
  }
...
class at extends ns {
  ...
  // ----------- LAYER CONSTRUCTION AND INITIALIZAION -----------
  constructor(e, t) {
    super(e, t), this._scaleSet = new Hi(), this._mouseTolerance = e.mouseTolerance != null ? e.mouseTolerance : 5, this._touchTolerance = e.touchTolerance != null ? e.touchTolerance : 15, this._drawOrder = [], this._serverVisibility = void 0, this.isCosmetic = e.cosmetic || !1, this.extent = e.extent ? Z.fromConfig(`${this.id}_extent`, e.extent) : void 0, this.viewDefProm = new ie(), this.esriWatches = [];
  }
  noLayerErr() {
    console.error(
...
class ot extends di {
  ...
  extractLayerMetadata() {
    ...
    this.supportsFeatures = !0, this.geomType = this.$iApi.geo.geom.clientGeomTypeToRampGeomType(e.geometryType), this.scaleSet.minScale = e.minScale || 0, this.scaleSet.maxScale = e.maxScale || 0, this.extent = this.extent ?? Z.fromESRI(e.fullExtent, this.id + "_extent");
  ...
  async getGraphicExtent(e) {
    ...
    if (!this.layerExists)
      ...
      if (i)
        ...
        s || (t = Z.fromESRI(a.extent), this.attribs.quickCache.setExtent(e, t));
      }
    }
    return t;
  }
...
class Vn extends at {
  ...
  set visibility(e) {
    ...
    if (e || Ct(this, "1=2"), this.actualViz = e, e && !this.esriLayer.visible)
      this.esriLayer.visible = !0;
    else if (!e && this.esriLayer.visible) {
      let t = "";
      const i = setTimeout(() => {
        this.$iApi.event.off(t), this.actualViz || (this.esriLayer.visible = !1, Ct(this, ""));
      }, 1600);
      t = this.$iApi.event.on(
        x.LAYER_DRAWSTATECHANGE,
        (s) => {
          s.layer.id === this.id && s.state === fe.UP_TO_DATE && (clearTimeout(i), this.$iApi.event.off(t), this.actualViz || (this.esriLayer.visible = !1, Ct(this, "")));
        }
      );
    }
    e && Ct(this, "");
  ...
  onLoadActions() {
    ...
    this.isDynamic = this.esriLayer.capabilities.exportMap.supportsDynamicLayers, this.extent = this.extent ?? Z.fromESRI(this.esriLayer.fullExtent, this.id + "_extent");
    const i = (n) => {
    ...
    const a = [], o = (n, c) => {
      ...
      if (n.sublayers && n.sublayers.length > 0) {
        const d = (p ? p.name : "") || n.title || "", m = new Nt(u, "", d, !1);
        c.findChildByIdx(u) || c.children.push(m), n.sublayers.reverse().forEach((h) => {
          o(h, m);
        });
      } else {
        this._sublayers[u] || (this._sublayers[u] = new zn(
          {
        ...
        if (d.name = p?.name || n.title || "", a.push(d), !c.children.map((m) => m.layerIdx).includes(u)) {
          const m = new Nt(u, d.uid, d.name, !1);
          c.children.push(m);
        }
        d.esriWatches.push(
          Le(
    ...
    const l = a.map(async (n) => {
      ...
      if (n.esriSubLayer && u?.customRenderer?.type) {
        const m = await k.RendererFromJson(u.customRenderer);
...
class hi extends at {
  ...
  async checkProj() {
    ...
    if (this.layerState === K.LOADED && !i)
      s(), this.onError(), this.updateDrawState(fe.NOT_LOADED);
    else if (this.layerState === K.ERROR && i)
      this.reload();
    else if (this.layerState !== K.ERROR && !i)
...
class Yn extends at {
  ...
  getFeatureInfo(e, t, i) {
    ...
    return C && Object.keys(C).forEach((q) => {
      q.toLowerCase() !== "styles" && (v[q] = C[q]);
    }), Object.keys(v).forEach((q) => l[q] = v[q]), Ze(a.url.split("?")[0], {
      query: l,
      responseType: y
    });
  }
...
class Jn extends ot {
  ...
  async onInitiate() {
    const e = Date.now(), t = new Ft(this.config.url), { offset: i, limit: s } = t.queryMap, a = await this.$iApi.geo.layer.ogc.loadWfsData(
      this.config.url,
      -1,
      parseInt(i) || 0,
      parseInt(s) || 1e3,
...
class ls extends ns {
  ...
  async onInitiate() {
    if (this.sourceJson) {
      ...
      this.attribs.attLoader = new tl(this.$iApi, a), await this.attribs.attLoader.getAttribs(), this.featureCount = e.data.length;
  ...
  async reload() {
    this.$iApi.event.emit(x.LAYER_RELOAD_START, this), await this.terminate(), await this.initiate(), this.layerState !== K.ERROR && this.onLoad(), setTimeout(() => {
...
class mi {
  ...
  constructor(e, t, i = !1) {
    this.innerRenderer = e, this.symbolUnits = [], this.falseRenderer = i, this.type = Ut.Unknown;
  }
...
class zt {
  ...
  parent;
  constructor(e) {
    this.parent = e, this.symbol = new Kt();
  }
  match(e) {
    return !!e;
  }
...
class sl extends mi {
  ...
  keyFields;
  constructor(e, t, i = !1) {
    super(e, t, i), this.type = Ut.Unique, this.delim = e.fieldDelimiter || ", ";
...
class al extends re {
  ...
  async symbolToSvg(e) {
    ...
    const a = lt(s).size(this.CONTAINER_SIZE, this.CONTAINER_SIZE).viewbox(0, 0, this.CONTAINER_SIZE, this.CONTAINER_SIZE), o = {
      ...
      none: () => "transparent",
      // esriSFSNull
      horizontal: (h, y) => a.pattern(5, 5, (v) => v.line(0, 5 / 2, 5, 5 / 2)).stroke(y),
      vertical: (h, y) => a.pattern(5, 5, (v) => v.line(5 / 2, 0, 5 / 2, 5)).stroke(y),
      "forward-diagonal": (h, y) => a.pattern(5, 5, (v) => {
        v.line(0, 0, 5, 5).stroke(y), v.line(0, 0, 5, 5).move(0, 5).stroke(y), v.line(0, 0, 5, 5).move(5, 0).stroke(y);
      }),
      "backward-diagonal": (h, y) => a.pattern(5, 5, (v) => {
        v.line(5, 0, 0, 5).stroke(y), v.line(5, 0, 0, 5).move(5 / 2, 5 / 2).stroke(y), v.line(5, 0, 0, 5).move(-5 / 2, -5 / 2).stroke(y);
      }),
      cross: (h, y) => a.pattern(5, 5, (v) => {
        v.line(5 / 2, 0, 5 / 2, 5).stroke(y), v.line(0, 5 / 2, 5, 5 / 2).stroke(y);
      }),
      "diagonal-cross": (h, y) => a.pattern(7, 7, (v) => {
      ...
      "picture-fill"() {
        ...
        return t.$iApi.geo.shared.convertImagetoDataURL(h).then((L) => {
          ...
          a.rect(t.CONTENT_SIZE, t.CONTENT_SIZE).center(t.CONTAINER_CENTER, t.CONTAINER_CENTER).fill(M).stroke(C);
        });
      },
      "picture-marker"() {
        const h = e.source, y = h && h.imageData ? `data:${h.contentType};base64,${h.imageData}` : e.url;
        return t.$iApi.geo.shared.convertImagetoDataURL(y).then((v) => t.svgDrawImage(a, v)).then(({ image: v }) => {
  ...
  async getMapServerLegend(e) {
    ...
    const t = {
      query: { f: "json" }
    }, i = { layers: [] }, [s, a] = await Se(Ze(`${e}/legend`, t));
...
class ol extends re {
  ...
  async geoJsonQuery(e) {
    ...
    return (await e.layer.esriLayer.queryFeatures(t)).features.map((s, a) => {
      let o;
      return t.returnGeometry ? o = this.$iApi.geo.geom.geomEsriToRamp(s.geometry, `queryResult${a}`) : o = new Xe(), new $e(o, "", s.attributes);
    });
  }
  /**
...
class nl extends re {
   ...
   */
  constructor(e) {
    super(e), this.geom = et.geom, this.proj = et.proj, this.shared = et.sharedUtils, this.map = new gn(e), this.layer = new Cn(e), this.attributes = new Qn(e), this.query = new ol(e), this.symbology = new al(e), Array.isArray(At.request.interceptors) || (At.request.interceptors = []), At.request.interceptors.push({
      before: (t) => {
...
const ll = /* @__PURE__ */ Object.assign({ "../fixtures/appbar/index.ts": () => import("./index-bxgbybOe.js"), "../fixtures/areas-of-interest/index.ts": () => import("./index-D8LuIhnR.js"), "../fixtures/basemap/index.ts": () => import("./index-BwdMuv7M.js"), "../fixtures/crosshairs/index.ts": () => import("./index-B2rhY5MS.js"), "../fixtures/details/index.ts": () => import("./index-6zIroE5D.js"), "../fixtures/draw/index.ts": () => import("./index-CRqo9TmT.js"), "../fixtures/export-footnote/index.ts": () => import("./index-CbjUT4Sc.js"), "../fixtures/export-legend/index.ts": () => import("./index-BEmCsOyD.js"), "../fixtures/export-map/index.ts": () => import("./index-dsyWSfJV.js"), "../fixtures/export-northarrow/index.ts": () => import("./index-Cr0YMoUV.js"), "../fixtures/export-scalebar/index.ts": () => import("./index-CRMdskaI.js"), "../fixtures/export-timestamp/index.ts": () => import("./index-Cwnznpg8.js"), "../fixtures/export-title/index.ts": () => import("./index-B-rcF1nh.js"), "../fixtures/export/index.ts": () => import("./index-BWvGpax9.js"), "../fixtures/extentguard/index.ts": () => import("./index-DWgtKZdl.js"), "../fixtures/gazebo/index.ts": () => import("./index-DbmtmtV7.js"), "../fixtures/geosearch/index.ts": () => import("./index-BGzsvSyH.js"), "../fixtures/grid/index.ts": () => import("./index-BwcNsN3I.js"), "../fixtures/help/index.ts": () => import("./index-hzu_P5U3.js"), "../fixtures/hilight/index.ts": () => import("./index-CqARN_Ja.js"), "../fixtures/keyboardnav/index.ts": () => import("./index-DwoKEnHN.js"), "../fixtures/layer-reorder/index.ts": () => import("./index-C6l-YAGM.js"), "../fixtures/legend/index.ts": () => import("./index-B6GYP3yq.js"), "../fixtures/mapnav/index.ts": () => import("./index-BVF-ipst.js"), "../fixtures/metadata/index.ts": () => import("./index-Drn43YU5.js"), "../fixtures/northarrow/index.ts": () => import("./index-C4JCbPTv.js"), "../fixtures/overviewmap/index.ts": () => import("./index-RByhALxp.js"), "../fixtures/panguard/index.ts": () => import("./index-Bh-7q7aG.js"), "../fixtures/scrollguard/index.ts": () => import("./index-C82OPXlM.js"), "../fixtures/settings/index.ts": () => import("./index-BwiPJNYt.js"), "../fixtures/snowman/index.ts": () => import("./index-hyAIMGJJ.js"), "../fixtures/swipe/index.ts": () => import("./index-DbxVyBFz.js"), "../fixtures/wizard/index.ts": () => import("./index-BCAB_jrI.js") });
class cl extends re {
  /**
  ...
  async add(e, t) {
    ...
    if (t) {
      ...
      i = yi.updateBaseToInstance(new t(), e, this.$iApi);
    } else {
      const s = (await ll[`../fixtures/${e}/index.ts`]()).default;
      i = new s(e, this.$iApi);
    }
...
class yi extends re {
  ...
  mount(e, { props: t, children: i, element: s, app: a } = {}) {
    let o = s, l = Ss(e, t, i);
    return a && a._context && (l.appContext = a._context), o ? qt(l, o) : (o = document.createElement("div"), qt(l, o)), { vNode: l, destroy: () => {
      o && qt(null, o), o = null, l = null;
    }, el: o };
  }
  /**
...
class ul extends re {
  ...
  register(e, t) {
    ...
    const s = Object.entries(i).reduce((a, [o, l]) => (a.push(new Ot(this.$iApi, o, l)), a), []);
  ...
  open(e) {
    let t, i, s;
    if (typeof e == "string" || e instanceof Ot ? t = this.get(e) : (t = this.get(e.id), { screen: i, props: s } = e), !t)
      return t;
  ...
  toggle(e, t) {
    let i;
    return typeof e == "string" || e instanceof Ot ? i = this.get(e) : i = this.get(e.id), i && (t = typeof t < "u" ? t : !i.isVisible, t !== i.isVisible ? t ? this.open(e) : this.close(i) : i);
  }
  /**
  ...
  toggleMinimize(e, t) {
    let i;
    return typeof e == "string" || e instanceof Ot ? i = this.get(e) : i = this.get(e.id), i && (t = typeof t < "u" ? t : !i.isVisible, t !== i.isVisible ? t ? this.open(i) : this.minimize(i) : i);
  }
  /**
...
const fl = /* @__PURE__ */ qe(dl, [["render", hl], ["__scopeId", "data-v-a3c61802"]]), ml = /* @__PURE__ */ Object.assign({ "../fixtures/areas-of-interest/screen.vue": () => import("./screen-BFrvsCzc.js"), "../fixtures/basemap/screen.vue": () => import("./screen-BOrS84sH.js"), "../fixtures/export/screen.vue": () => import("./screen-D1lQed8c.js"), "../fixtures/geosearch/screen.vue": () => import("./screen-CFRLK47k.js"), "../fixtures/grid/screen.vue": () => import("./screen-B5xXm1fq.js"), "../fixtures/help/screen.vue": () => import("./screen-CQQpW3m0.js"), "../fixtures/layer-reorder/screen.vue": () => import("./screen-1B0t3BXq.js"), "../fixtures/legend/screen.vue": () => import("./screen-BwhkPuAN.js"), "../fixtures/metadata/screen.vue": () => import("./screen-CxhuPRG-.js"), "../fixtures/settings/screen.vue": () => import("./screen-CekiqIY9.js"), "../fixtures/wizard/screen.vue": () => import("./screen-nysUTPZR.js") });
class Ot extends re {
  /**
   * ID of this panel.
   *
  ...
  registerScreen(e) {
    ...
    if (Ks(t) || Js(t))
      ...
      let s;
      typeof t == "string" ? s = ml[`../fixtures/${t}`]() : s = t();
...
function vl(r) {
  ...
  return Al(r.services, e), bl(r.map, e), wl(r.ui, e), r.plugins && El(r.plugins, e), e;
}
function bl(r, e) {
  ...
  return r.controls && r.controls.length > 0 && (e.controls = gt(r.controls, t), r.controls.includes("visibility") && e.controls.push("visibilityButton"), (r.controls.length !== 1 || r.controls[0] !== "visibility") && console.warn(
    ...
    if (i.layerId)
      ...
      typeof i.collapse < "u" && console.warn(
        ...
        a.layerId ? s.children.push(Pi(a)) : s.children.push(ti(a));
      }), e.children.push(s);
    } else
...
function Jt(r) {
  ...
  )), typeof r.stateOnly < "u" && (e.cosmetic = r.stateOnly), r.initialFilteredQuery && (e.initialFilteredQuery = r.initialFilteredQuery), xl(r, e), typeof r.toggleSymbology < "u" && console.warn(`toggleSymbology property provided in layer ${r.id} cannot be mapped and will be skipped.`), r.table && (e.fixtures = {
    grid: {}
...
var pt = { major: "4", minor: "17", patch: "0", timestamp: "Wed Mar 4 11:41:59 2026 -0500", hash: "21dcb700cae65dcee948ea3e3f948bdfb9530715" };
console.info(
...
const uc = (r, e, t) => new dn(r, e, t), et = new Ys();
export {
  K as $,
  jr as A,
  cn as B,
