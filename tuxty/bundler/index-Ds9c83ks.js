...
import { _ as H, d as L, k as X, F as ee, G as te } from "./main-DbfnhtEc.js";
...
const G = /* @__PURE__ */ H(ne, [["render", ae]]), se = /* @__PURE__ */ T({
  ...
  setup(h) {
    ...
    const p = [
      {
        type: "point",
        icon: g(_(() => import("./point-icon-CeusRKlK.js")))
      },
      {
        type: "polyline",
        icon: g(_(() => import("./polyline-icon-Cvo7rJ0D.js")))
      },
      {
        type: "polygon",
        icon: g(_(() => import("./polygon-icon-aBTBamp7.js")))
      },
      {
        type: "circle",
        icon: g(_(() => import("./circle-icon-BawCzL7X.js")))
      },
      {
        type: "rectangle",
        icon: g(_(() => import("./rectangle-icon-Bp29ryff.js")))
      }
    ], a = A(() => {
      const s = p.filter((u) => e.supportedTypes.some((x) => x.type === u.type));
      return s.push({
        type: "edit",
        icon: g(_(() => import("./edit-icon-fXC6Sms6.js")))
      }), s;
    }), n = (s) => {
