import { defineComponent as Q, ref as E, onMounted as ye, resolveDirective as q, createElementBlock as a, openBlock as l, withModifiers as p, withDirectives as k, createElementVNode as o, unref as t, normalizeClass as w, withKeys as ce, inject as ue, computed as G, toRaw as C, resolveComponent as ve, createBlock as A, withCtx as me, createTextVNode as V, toDisplayString as x, createCommentVNode as u, Fragment as oe, renderList as se, normalizeStyle as ke, useTemplateRef as xe, watch as we, createStaticVNode as ge, resolveDynamicComponent as Me } from "vue";
import { s as Ce, r as y, a as Ie, a4 as I, G as X, _ as ie, Y as Te, q as Se, a6 as U, a7 as f, S as ze, a8 as O, a9 as ne } from "./main-DbfnhtEc.js";
import "pinia";
...
const Ae = ["type", "aria-label", "checked", "disabled", "content"], ae = /* @__PURE__ */ Q({
  ...
  emits: ["focusItem"],
  setup(e, { emit: T }) {
    const { t: i } = re(), c = ue("iApi"), b = E(), $ = E(!1), s = Ie(), B = E(s.mobileView), Z = T, N = E(0), v = e, Y = () => {
      ...
      if (v.legendItem.layerControlAvailable(I.Metadata) && M("metadata")) {
        ...
        if (m.url) {
          const P = m.url.split("."), z = P[P.length - 1], te = z === "xml" || z === "md" ? z : "html";
          c.event.emit(X.METADATA_TOGGLE, {
            ...
            xmlType: m.xmlType,
            treatXmlAsMarkdown: m.treatXmlAsMarkdown
          });
        } else
      ...
      R.value && C(v.legendItem.layer).reload().then(() => {
        N.value += 1, m.pointerType !== "mouse" && Z("focusItem");
      });
    }, R = G(() => v.legendItem.layerControlAvailable(I.Reload) && v.legendItem instanceof y && C(v.legendItem.layer)?.canReload), ee = (m) => {
      $.value = !0, setTimeout(() => {
        $.value && (B.value || m._tippy?.show());
      }, 300);
    }, M = (m) => {
      try {
        ...
        (l(), A(j, {
          ...
          default: me(() => [
            ...
            k((l(), a("a", {
              ...
              onMouseover: g[0] || (g[0] = p((z) => ee(z.currentTarget), ["stop"])),
              onMouseout: g[1] || (g[1] = (z) => (
                //@ts-expect-error TODO: explain why this is needed or remove
                (B.value || z.currentTarget?._tippy?.hide(), $.value = !1)
              )),
              onClick: g[2] || (g[2] = (z) => _(z)),
              role: "button",
...
}), Ye = /* @__PURE__ */ ie(Qe, [["__scopeId", "data-v-a96b0405"]]), Je = { class: "relative" }, _e = ["content"], et = {
  key: 0,
...
}, dt = { key: 1 }, ct = { key: 2 }, mt = ["src"], gt = ["innerHTML"], yt = {
  key: 6,
  class: "relative"
  ...
  setup(e) {
    const T = Te(), i = Ie(), { t: c } = re(), b = ue("iApi"), $ = E(), s = e, B = Se(), Z = B.multilineItems, N = (s.legendItem instanceof y && s.legendItem.maxLines) ?? B.maxLines, v = E(i.mobileView), Y = G(() => T.layerConfigs), H = E([]), F = E(!1), D = E(!1), K = xe("legendFocusItem"), J = G(() => s.legendItem instanceof y ? C(s.legendItem.layer)?.layerType : ""), _ = G(() => s.legendItem instanceof y && C(s.legendItem.layer)?.canModifyLayer), R = G(() => {
    ...
    s.legendItem instanceof y && C(s.legendItem.layer)?.sublayers.length > 0), m = (r) => r === U.Expand || r === U.Visibility ? s.legendItem.controlAvailable(r) : s.legendItem.layerControlAvailable(r), g = (r) => He(r), j = () => {
      s.legendItem.children.length === 0 || !m(U.Expand) || (s.legendItem.toggleExpanded(), b.updateAlert(c(`legend.alert.group${s.legendItem.expanded ? "Expanded" : "Collapsed"}`)));
    }, P = () => {
      if (m(I.Symbology)) {
      ...
      m(I.Datatable) && W() && b.event.emit(X.GRID_TOGGLE, s.legendItem.layer);
    }, te = (r) => {
      ...
      s.legendItem.reload(), setTimeout(() => {
        ...
        if (n) {
          const h = r.isSublayer ? r.parentLayerId : r.layerId, L = Y.value.find((S) => S.id === h);
          L !== void 0 && be(L);
        }
        ...
        o("div", Je, [
          k((l(), a("div", {
            class: w(["flex items-center hover:bg-gray-200 default-focus-style !p-5", [
              ...
              M.value && m(t(U).Expand) || !M.value && e.legendItem instanceof t(y) && m(t(I).Datatable) && W() && e.legendItem.type === t(f).Item ? "cursor-pointer" : "cursor-default",
            ...
            onClick: n[12] || (n[12] = () => {
              !M.value && e.legendItem instanceof t(y) && m(t(I).Datatable) && W() && e.legendItem.type === t(f).Item ? z() : M.value && j();
            }),
            content: M.value && m(t(U).Expand) ? t(c)(e.legendItem.expanded ? "legend.group.collapse" : "legend.group.expand") : e.legendItem instanceof t(y) && e.legendItem.type === t(f).Item && m(t(I).Datatable) && W() ? t(c)("legend.layer.data") : "",
            "truncate-trigger": "",
            ...
            e.legendItem.type !== t(f).Item ? (l(), a("div", et, [
              e.legendItem.type === t(f).Placeholder ? (l(), a("svg", tt, n[14] || (n[14] = [
                ge('<path d="M0 0h24v24H0V0z" fill="none" data-v-a8fe2840></path><path d="M0 0h24v24H0V0z" fill="none" data-v-a8fe2840></path><circle cx="15.5" cy="9.5" r="1.5" data-v-a8fe2840></circle><circle cx="8.5" cy="9.5" r="1.5" data-v-a8fe2840></circle><circle cx="15.5" cy="9.5" r="1.5" data-v-a8fe2840></circle><circle cx="8.5" cy="9.5" r="1.5" data-v-a8fe2840></circle><path d="M11.99 2C6.47 2 2 6.48 2 12s4.47 10 9.99 10C17.52 22 22 17.52 22 12S17.52 2 11.99 2zM12 20c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8zm0-2.5c2.33 0 4.32-1.45 5.12-3.5h-1.67c-.69 1.19-1.97 2-3.45 2s-2.75-.81-3.45-2H6.88c.8 2.05 2.79 3.5 5.12 3.5z" data-v-a8fe2840></path>', 7)
              ]))) : (l(), a("svg", lt, n[15] || (n[15] = [
                ge('<path d="M0 0h24v24H0V0z" fill="none" data-v-a8fe2840></path><path d="M0 0h24v24H0V0z" fill="none" data-v-a8fe2840></path><circle cx="15.5" cy="9.5" r="1.5" data-v-a8fe2840></circle><circle cx="8.5" cy="9.5" r="1.5" data-v-a8fe2840></circle><circle cx="15.5" cy="9.5" r="1.5" data-v-a8fe2840></circle><circle cx="8.5" cy="9.5" r="1.5" data-v-a8fe2840></circle><path d="M 20,12C 20,7.6 16.4,4 12,4C 7.6,4 4,7.6 4,12C 4,16.4 7.6,20 12,20C 16.4,20 20,16.4 20,12 Z M 22,12C 22,17.5 17.5,22 12,22C 6.5,22 2,17.5 2,12C 2,6.5 6.5,2.00001 12,2.00001C 17.5,2.00001 22,6.5 22,12 Z M 15.5,8C 16.3,8 17,8.7 17,9.5C 17,10.3 16.3,11 15.5,11C 14.7,11 14,10.3 14,9.5C 14,8.7 14.7,8 15.5,8 Z M 10,9.5C 10,10.3 9.3,11 8.5,11C 7.7,11 7,10.3 7,9.5C 7,8.7 7.7,8 8.5,8C 9.3,8 10,8.7 10,9.5 Z M 12,14C 13.7524,14 15.2943,14.7212 16.1871,15.8129L 14.7697,17.2302C 14.3175,16.5078 13.2477,16 12,16C 10.7523,16 9.68254,16.5078 9.23024,17.2302L 7.81291,15.8129C 8.7057,14.7212 10.2476,14 12,14 Z" data-v-a8fe2840></path>', 7)
              ])))
            ])) : u("", !0),
            e.legendItem.type === t(f).Item && e.legendItem instanceof t(y) && e.legendItem.layer.legend.length > 0 ? (l(), a("div", {
              ...
              k((l(), a("button", {
                type: "button",
                onClick: p(P, ["stop"]),
                class: w([m(t(I).Symbology) ? "cursor-pointer" : "cursor-default"]),
            ...
            e.legendItem instanceof t(y) && t(Z) ? k((l(), a("div", {
              ...
              }, null, 8, mt)) : e.legendItem.infoType === t(O).Markdown ? (l(), a("div", {
                key: 4,
                class: "ramp-markdown",
                innerHTML: g(e.legendItem.content)
              }, null, 8, gt)) : (l(), A(Me(`${e.legendItem.uid}-info-section`), { key: 5 }))
            ])) : u("", !0),
            ...
            ])) : e.legendItem.type === t(f).Item && m(t(U).Visibility) ? (l(), A(ae, {
              key: 12,
        ...
        e.legendItem instanceof t(y) && e.legendItem.symbologyExpanded ? k((l(), a("div", Mt, [
          H.value.length > 0 ? (l(), a("div", Ct, [
            ...
            (l(!0), a(oe, null, se(H.value, (d) => (l(), a("div", {
              ...
              d.imgUrl && e.legendItem.symbologyRenderStyle === "images" || !d.imgUrl && J.value === "ogc-wms" ? (l(), a("div", St, [
                d.imgUrl ? (l(), a("div", zt, [
                  o("img", {
                    class: "max-w-full",
                    src: d.imgUrl
...
}), zl = /* @__PURE__ */ ie(qt, [["__scopeId", "data-v-a8fe2840"]]);
export {
  zl as default
};
