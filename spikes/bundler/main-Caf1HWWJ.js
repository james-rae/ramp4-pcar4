...
const qs = ["data-cy"], Vi = /* @__PURE__ */ O({
  ...
  for (const [i, s] of e)
    t[i] = s;
  return t;
}, Hs = /* @__PURE__ */ Pe(Ws, [["__scopeId", "data-v-197830c4"]]), Ys = ["content", "aria-label"], Xt = /* @__PURE__ */ O({
...
}), Lr = /* @__PURE__ */ Pe(Tr, [["__scopeId", "data-v-ed2f8f44"]]), Rr = { class: "map-caption absolute bottom-0 h-29 sm:h-38 flex justify-end pointer-events-auto cursor-default select-none text-gray-200 bg-black-75 left-0 right-0 py-2 sm:py-6" }, $r = {
  key: 0,
...
}), eo = /* @__PURE__ */ Pe(Xr, [["__scopeId", "data-v-7a1e48c2"]]), to = O({
  name: "App",
  components: { Shell: eo },
  setup() {
    const r = us();
...
}), Do = { class: "w-32 h-32" }, Go = ["content", "aria-label"], Uo = {
  key: 0,
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 24 24",
  ...
  async loadLayerMetadata(e = {}) {
    ...
    if (!(t < this.lastCancel))
      if (this.geomType = i.geometryType, this.attribs.quickCache = new es(this.geomType), this.scaleSet.minScale = i.minScale, this.scaleSet.maxScale = i.maxScale, this.dataFormat = i.dataFormat, this.extent = this.extent ?? i.extent, this._serverVisibility = i.defaultVisibility, this.origRampConfig.name || (this.name = i.name ?? this.id), this.dataFormat === X.ESRI_FEATURE) {
        ...
        console.log("renderer from rest ping"), console.log(s.toJSON()), this.renderer = this.$iApi.geo.symbology.makeRenderer(s, this.fields), this.legend = this.$iApi.geo.symbology.rendererToLegend(this.renderer);
        const o = {
...
class pn extends si {
  ...
  onLoadActions() {
    ...
    this.layerIdx = o, this.serviceUrl = i, this.esriLayer && (console.log("original esri renderer"), console.log(this.esriLayer.renderer.toJSON()));
    const a = async () => {
      let n;
      if (this.esriLayer && this.origRampConfig.customRenderer?.type) {
        ...
        console.log("custom renderer in esri form"), console.log(c.toJSON()), this.esriLayer.renderer = c, n = { customRenderer: c };
      } else
        n = {};
...
const $n = /* @__PURE__ */ Object.assign({ "../fixtures/appbar/index.ts": () => import("./index-RHmag46K.js"), "../fixtures/areas-of-interest/index.ts": () => import("./index-C2pkaO03.js"), "../fixtures/basemap/index.ts": () => import("./index-D5o_dT3e.js"), "../fixtures/crosshairs/index.ts": () => import("./index-DreGNLoD.js"), "../fixtures/details/index.ts": () => import("./index-BVqg7bsc.js"), "../fixtures/export-footnote/index.ts": () => import("./index-CPTXNxch.js"), "../fixtures/export-legend/index.ts": () => import("./index-BpxKXgN7.js"), "../fixtures/export-map/index.ts": () => import("./index-nAhU0mcr.js"), "../fixtures/export-northarrow/index.ts": () => import("./index-sKfrJRHn.js"), "../fixtures/export-scalebar/index.ts": () => import("./index-CF4gnLew.js"), "../fixtures/export-timestamp/index.ts": () => import("./index-D3hS3CGF.js"), "../fixtures/export-title/index.ts": () => import("./index-BQVO33LG.js"), "../fixtures/export/index.ts": () => import("./index-COPFOjLq.js"), "../fixtures/extentguard/index.ts": () => import("./index-CsD-S6AM.js"), "../fixtures/gazebo/index.ts": () => import("./index-CavPooYQ.js"), "../fixtures/geosearch/index.ts": () => import("./index-DR1Wx9fl.js"), "../fixtures/grid/index.ts": () => import("./index-BQ84VHlR.js"), "../fixtures/help/index.ts": () => import("./index-C7u4dAYl.js"), "../fixtures/hilight/index.ts": () => import("./index-DPz-PAcC.js"), "../fixtures/layer-reorder/index.ts": () => import("./index-DBoQ8ArR.js"), "../fixtures/legend/index.ts": () => import("./index-Buf0OqAD.js"), "../fixtures/mapnav/index.ts": () => import("./index-d4YYJXSV.js"), "../fixtures/metadata/index.ts": () => import("./index-BQO8fTbs.js"), "../fixtures/northarrow/index.ts": () => import("./index-Tyt96bfv.js"), "../fixtures/overviewmap/index.ts": () => import("./index-dE81SFKH.js"), "../fixtures/panguard/index.ts": () => import("./index-Dsrt21Ll.js"), "../fixtures/scrollguard/index.ts": () => import("./index-C6Z44hjZ.js"), "../fixtures/settings/index.ts": () => import("./index-DVqV_FZ2.js"), "../fixtures/snowman/index.ts": () => import("./index-sjkSSA14.js"), "../fixtures/wizard/index.ts": () => import("./index-CAM4q1y1.js") });
class Cn extends Z {
  /**
...
const Nn = /* @__PURE__ */ Pe(Mn, [["render", Pn], ["__scopeId", "data-v-a3c61802"]]), Fn = /* @__PURE__ */ Object.assign({ "../fixtures/areas-of-interest/screen.vue": () => import("./screen-MAkusU1p.js"), "../fixtures/basemap/screen.vue": () => import("./screen-cvQ6Zn21.js"), "../fixtures/export/screen.vue": () => import("./screen-D2iqRTW0.js"), "../fixtures/geosearch/screen.vue": () => import("./screen-DEexmxKA.js"), "../fixtures/grid/screen.vue": () => import("./screen-B4FrQPtF.js"), "../fixtures/help/screen.vue": () => import("./screen-4cABLWph.js"), "../fixtures/layer-reorder/screen.vue": () => import("./screen-Db1irp1a.js"), "../fixtures/legend/screen.vue": () => import("./screen-rxWpjkx0.js"), "../fixtures/metadata/screen.vue": () => import("./screen-D71C6m2D.js"), "../fixtures/settings/screen.vue": () => import("./screen-DCTtPYgl.js"), "../fixtures/wizard/screen.vue": () => import("./screen-CkjV9VEL.js") });
class At extends Z {
  /**
   * ID of this panel.
   *
...
var tt = { major: "4", minor: "11", patch: "0-beta", timestamp: "Tue Jan 21 14:04:08 2025 -0500", hash: "594668424c7f66516ddca377475492f301da3fdf" };
console.info(
