import { AddressResultList, IFSAResult, IGeosearchConfig, INameResponse, INTSResult, IVisualResult, LocateResponseList, NameResultList, NTSResultList, VisualResultList } from '../definitions';
...
export declare class Query {
     ...
     * @returns
     */
    gnSearch(): Promise<VisualResultList>;
    /**
