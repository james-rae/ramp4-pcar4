...
import { defineStore as B, createPinia as ls } from "pinia";
import { ref as f, computed as N, markRaw as Q, defineComponent as O, inject as ve, reactive as we, watch as It, onBeforeUnmount as dt, resolveDirective as M, withDirectives as P, openBlock as v, createElementBlock as w, withKeys as cs, withModifiers as Zt, onMounted as Je, normalizeClass as oe, normalizeStyle as Oi, createVNode as re, Transition as ki, withCtx as te, createBlock as W, resolveDynamicComponent as us, mergeProps as ps, TransitionGroup as Mi, Fragment as He, renderList as ht, unref as S, nextTick as Ot, renderSlot as Pe, createElementVNode as y, vShow as ds, resolveComponent as Z, createTextVNode as at, toDisplayString as U, createCommentVNode as G, onUpdated as hs, Teleport as fs, getCurrentInstance as ms, useTemplateRef as hi, createApp as Pi, toRaw as _e, h as ys, render as Ut, defineAsyncComponent as gs } from "vue";
import _t from "@arcgis/core/Color";
import ft from "@arcgis/core/config";
import { watch as Ae } from "@arcgis/core/core/reactiveUtils.js";
import fi from "@arcgis/core/geometry/Extent";
import vs from "@arcgis/core/geometry/Multipoint";
import bs from "@arcgis/core/geometry/Point";
import Xt from "@arcgis/core/geometry/Polygon";
import Ni from "@arcgis/core/geometry/Polyline";
...
import xs from "@arcgis/core/symbols/PictureMarkerSymbol";
import Ss from "@arcgis/core/symbols/SimpleFillSymbol";
import Is from "@arcgis/core/symbols/SimpleLineSymbol";
...
class be extends Ke {
  ...
  constructor(e, t, i, r) {
    if (super(e, t.sr || i), r)
      this.rawArray = be.arrayDeepCopy(t);
      ...
      this.rawArray = t.map((o) => de.parsePointSet(o));
    } else
   ...
   */
  toArray() {
    return be.arrayDeepCopy(this.rawArray);
  }
  static arrayDeepCopy(e) {
    return e.map((t) => t.map((i) => i.slice()));
  }
  static fromESRI(e, t) {
    return new be(t, e.paths, _.fromESRI(e.spatialReference), !0);
  }
  toESRI() {
    return new Ni({
      paths: this.toArray(),
...
class se extends Ke {
  ...
  constructor(e, t, i, r) {
    super(e, t.sr || i), r ? this.rawArray = se.arrayDeepCopy(t) : this.rawArray = se.parsePolygon(t);
  }
  addLinearRings(e) {
   ...
   */
  toArray() {
    return se.arrayDeepCopy(this.rawArray);
  }
  ...
  static fromESRI(e, t) {
    return new se(t, e.rings, _.fromESRI(e.spatialReference), !0);
  }
  toESRI() {
    return new Xt({
      rings: this.toArray(),
  ...
  static fromGeoJSON(e, t) {
    return new se(t, e.coordinates, _.fromGeoJSON(e.crs), !0);
  }
  toGeoJSON() {
    return this.geoJsonFactory(z.POLYGON, this.toArray());
  }
...
class ke extends Ke {
  rawArray;
  constructor(e, t, i, r) {
    super(e, t.sr || i), r ? this.rawArray = ke.arrayDeepCopy(t) : this.rawArray = ke.parseMultiPolygon(t);
  }
  addPolygon(e) {
  ...
  get polygonArray() {
    return this.rawArray.map((e, t) => new se(this.childIdGenerator(t), e, this.sr, !0));
  }
   ...
   */
  toArray() {
    return ke.arrayDeepCopy(this.rawArray);
  }
  static parseMultiPolygon(e) {
    ...
    if (e instanceof be || e instanceof de)
      return [se.parsePolygon(e)];
    if (Array.isArray(e)) {
      if (e.length === 0)
        throw new Error("no polygons provided");
      return e.map((t) => se.parsePolygon(t));
    } else
  ...
  static fromESRI(e, t) {
    return new ke(t, [e.rings], _.fromESRI(e.spatialReference), !0);
  }
  toESRI() {
    const e = [];
...
class D extends Ke {
  ...
  expand(e) {
    return D.fromESRI(this.toESRI().expand(e), `${this.id}-expanded`);
  }
  clone() {
    return new D(this.id, this.rawMin, this.rawMax, this.sr);
  }
  /**
  ...
  toPolygon() {
    return new se(this.id, this.toPolygonArray(), this.sr, !0);
  }
  static fromParams(e, t, i, r, o, a) {
    return new D(e, [t, i], [r, o], a);
  }
  ...
  static fromArcServer(e, t) {
    return D.fromESRI(fi.fromJSON(e), t);
  }
  ...
  static fromGeoJSON(e, t) {
    ...
    return [1, 2, 3].forEach((o) => {
      [0, 1].forEach((a) => {
        ...
        i[a] > l[a] && (i[a] = l[a]), r[a] < l[a] && (r[a] = l[a]);
      });
    }), new D(t, i, r, _.fromGeoJSON(e.crs));
  }
  toGeoJSON() {
...
class Ne {
  ...
  get hex() {
    const e = this.rgba;
    return e[3] = e[3] * 255, `#${e.map((t) => Ne.intToHex(t)).join("")}`;
  }
  get r() {
    return this.c[0];
  }
...
class Ue extends Me {
  ...
  _angle;
  constructor(e) {
    if (e = e || { style: Ce.CIRCLE }, super(), this._style = e.style || Ce.CIRCLE, e.style === Ce.ICON) {
      const t = e;
      this._icon = t.icon || "", this._height = Me.convToPoints(t.height) || 16.5, this._width = Me.convToPoints(t.width) || 16.5, this._size = 0, this._colour = new Ne(), this._outline = new Le(), this._path = "";
    } else {
      const t = e;
      this._size = Me.convToPoints(t.size) || 12, this._colour = new Ne(t.colour ?? "#ffffff40"), this._outline = new Le(t.outline), this._path = this._style === Ce.PATH && t.path || "", this._height = 0, this._width = 0, this._icon = "";
    }
    this._xOffset = Me.convToPoints(e.xOffset) || 0, this._yOffset = Me.convToPoints(e.yOffset) || 0, this._angle = e.angle || 0;
  }
  ...
  propGrouse(e) {
    this._style === Ce.ICON !== e && console.warn(`Accessed a point style property that is invalid for the style type ${this._style}`);
  }
  toOptions() {
    const e = {
  ...
  static fromESRI(e) {
    ...
    if (e.type === "simple-marker") {
      const i = t;
      i.style = e.style, i.colour = e.color.toRgba(), i.size = e.size, i.path = e.path, i.outline = Le.fromESRI(e.outline).toOptions();
    } else {
      const i = t;
      i.style = Ce.ICON, i.width = e.width, i.height = e.height, i.icon = e.url;
    }
    return new Ue(t);
  }
  static fromArcServer(e) {
    return Ue.fromESRI(Qt(e));
  }
  /**
...
class Le extends Me {
  ...
  constructor(e) {
    ...
    const t = Me.convToPoints(e.width);
    this._width = typeof t > "u" || t < 0 ? 0.75 : t, this._colour = new Ne(e.colour), this._miter = e.miter ?? 2, this._cap = e.cap || Ui.ROUND, this._join = e.join || Gi.ROUND;
  }
...
class yt extends Me {
  ...
  _fillStyle;
  constructor(e) {
    super(), e = e || {}, e.fill || (e.fill = {}), this._fillColour = new Ne(e.fill.colour), this._fillStyle = e.fill.style || Bi.SOLID, this._outlineStyle = new Le(e.outline);
  }
  /** Returns the specified colour */
  get fillColour() {
  ...
  toESRI() {
    const e = this.outline.toESRI(), t = new _t(this.fillColour.rgba), i = new Ss();
  ...
  static fromESRI(e) {
    const t = {
      ...
      outline: Le.fromESRI(e.outline).toOptions()
    };
    return new yt(t);
  }
  static fromArcServer(e) {
    return yt.fromESRI(Qt(e));
  }
}
class Ns {
  ...
  geomEsriToRamp(e, t) {
    switch (e.type) {
      ...
      case "polyline": {
        const i = e;
        return i.paths.length === 1 ? Ve.fromESRI(i, t) : be.fromESRI(i, t);
      }
      case "polygon":
        return se.fromESRI(e, t);
      case "extent":
        return D.fromESRI(e, t);
      case "multipoint":
  ...
  graphicGeoJsonToRamp(e, t) {
    ...
    return Object.keys(e.properties.forEach((a) => r[a] = e.properties[a])), new xe(i, "", r);
  }
  /**
  ...
  styleEsriToRamp(e) {
    switch (e.type) {
      case "picture-marker":
      case "simple-marker":
        return Ue.fromESRI(e);
      case "simple-line":
        return Le.fromESRI(e);
      case "simple-fill":
        return yt.fromESRI(e);
      default:
        return console.error(`Unsupported ESRI symbol type encountered: ${e.type}`), new Ue();
    }
  }
...
class gt {
  ...
  static fromConfig(e) {
    return new gt(
      e.id,
      D.fromConfig(`${e.id}-extent-default`, e.default),
      e.full !== void 0 ? D.fromConfig(`${e.id}-extent-full`, e.full) : void 0,
      e.maximum !== void 0 ? D.fromConfig(`${e.id}-extent-maximum`, e.maximum) : void 0
    );
  }
  clone() {
...
class Fs {
  ...
  convertImageToCanvas(e, t, i = !0) {
    const r = t ?? document.createElement("canvas"), o = document.createElement("img");
    i && (o.crossOrigin = "anonymous");
    const a = new Promise((l, n) => {
      o.addEventListener("load", () => {
        r.width = o.width, r.height = o.height, r.getContext("2d")?.drawImage(o, 0, 0), l(r);
  ...
  parseUrlIndex(e) {
    ...
    if (r) {
      const o = r[1];
      t.index = isNaN(parseInt(o)) ? void 0 : parseInt(o), t.rootUrl = e.substr(0, e.length - r[0].length);
    } else
...
class Rt {
  ...
  updateQuery(e) {
    ...
    return `${this.base}${Object.entries(t).filter(([, r]) => r !== void 0).map(([r, o], a) => `${a === 0 ? "?" : ""}${r}=${o}`).join("&")}`;
  }
}
const Ds = "EPSG:4326";
class Gs {
  ...
  async checkProj(e) {
    ...
    return await (i ? o(i) : Promise.resolve(!1)) ? (r(i, t), !0) : o(t);
  }
  /**
  ...
  async projectGeoJson(e, t, i) {
    let r, o;
    if (t ? r = this.normalizeProj(t) : r = _.parseGeoJsonCrs(e.crs), i ? o = this.normalizeProj(i) : o = Ds, o === r)
      return e;
    await this.checkProjBomber([r, o]);
    const a = ne(r, o).forward;
    return _s(e, a);
  }
  /**
  ...
  async projectGeometry(e, t) {
    ...
    const i = t.toGeoJSON(), r = await this.projectGeoJson(i, this.normalizeProj(t.sr), this.normalizeProj(e)), o = ut.geom.geomGeoJsonToRamp(r, t.id);
    return o.sr = _.parseSR(e), o;
  }
  /**
  ...
  async projectExtent(e, t) {
    const i = (m, A, b) => {
      if (b === 0)
        return [m, A];
      const $ = [(m[0] + A[0]) / 2, (m[1] + A[1]) / 2];
      if (b === 1)
        return [m, $, A];
      if (b > 1) {
        const L = i(m, $, b - 1), k = i($, A, b - 1);
        return L.concat(k.slice(1));
      }
      return [[]];
    }, r = t.toPolygonArray().pop() || [];
    let o = [];
    [0, 1, 2, 3].map((m) => i(r[m], r[m + 1], 3).slice(1)).forEach((m) => o = o.concat(m));
    const a = new se("warpy", [o], t.sr, !0), l = await this.projectGeometry(e, a), n = l.toArray().pop() || [], c = n.map((m) => m[0]), u = n.map((m) => m[1]), p = Math.min.apply(null, c), d = Math.max.apply(null, c), g = Math.min.apply(null, u), h = Math.max.apply(null, u);
    return D.fromParams(t.id + "_projected", p, g, d, h, l.sr);
  }
}
class Us {
  // useful functions
  ...
  sharedUtils;
  constructor() {
    this.proj = new Gs(), this.geom = new Ns(), this.sharedUtils = new Fs();
  }
  defaultTileSchemas() {
...
const $t = B("appbar", () => {
  const s = f({}), e = f([]), t = f([]), i = N(
    () => e.value.map(
      (a) => a.map((l) => s.value[l]).filter((l) => {
  ...
  function o(a) {
    ...
    l !== -1 && t.value.splice(l, 1), a in s.value && delete s.value[a], e.value.forEach((n) => {
      const c = n.indexOf(a);
      c !== -1 && n.splice(c, 1);
    });
  }
  return { items: s, order: e, temporary: t, visible: i, addTempButton: r, removeButton: o };
}), Wt = B("grid", () => {
  const s = f({}), e = f(), t = f();
  function i(l) {
  ...
  function o(a) {
    s.value.text.value = a.text.value, s.value.text.disabled = a.text.disabled, s.value.logo.altText = a.logo.altText, s.value.logo.link = a.logo.link, s.value.logo.value = a.logo.value, s.value.logo.disabled = a.logo.disabled;
  }
  return {
    attribution: s,
    scale: e,
  ...
  const s = f([]), e = f([]), t = f([]);
  function i(p) {
    return Bt(s.value, (d) => d?.uid === p);
  }
  function r(p) {
    return Bt(s.value, (d) => d?.id === p);
  }
  function o(p) {
    return Bt(
      s.value,
  ...
  const s = f([]), e = f({}), t = f({}), i = f(), r = f(0), o = f(0), a = f(!0), l = f();
  function n(u) {
  ...
  function i(a) {
    if (s.value = { ...s.value, [a.id]: Q(a) }, a.id in e.value)
      e.value[a.id].resolveMe(Q(a));
    else {
      const l = new H();
      l.resolveMe(Q(a)), e.value = {
        ...e.value,
        [a.id]: l
      };
    }
  ...
  function r(a) {
    delete s.value[a.id], s.value = { ...s.value }, delete e.value[a.id], e.value = { ...e.value }, typeof a.removed == "function" && a.removed();
  }
  function o(a) {
    e.value = {
      ...e.value,
...
class js extends J {
   ...
   */
  addDefaultEvents(e) {
    return (!Array.isArray(e) || e.length === 0) && (e = Object.values(Ht)), e.map((t) => this.defaultHandlerFactory(t));
  }
  /**
    ...
    switch (e) {
      ...
      case "ramp_layer_remove_checks_grid":
        t = (i) => {
          if (this.$iApi.fixture.get("grid")) {
            const r = Wt(this.$vApp.$pinia), o = r.getGridId(i.id);
            if (o === void 0) return;
            if (r.removeLayer(o, i.id), r.grids[o].layerIds.length === 0) {
              r.removeGrid(o);
              const a = r.currentId;
              if (o === a) {
      ...
      case "ramp_map_mouse_updates_coords":
        this.$iApi.event.on(
          "map/mousemove",
          it(50, (i) => {
            const r = Be(this.$vApp.$pinia);
            r.coords?.disabled || this.$iApi.geo.map.caption.formatPoint(this.$iApi.geo.map.screenPointToMapPoint(i)).then((a) => {
              r.coords = {
                formattedString: a
              };
            });
...
function Ys() {
  return Ts({
    ...
    locale: document.documentElement.getAttribute("lang") || gi,
    fallbackLocale: gi,
    globalInjection: !0,
    messages: Ws,
    numberFormats: Hs
...
const Ct = B("maptip", () => {
  ...
  __name: "esri-map",
  setup(s) {
    const e = Ct(), t = ve("iApi"), i = N(() => e.maptipPoint), r = N(() => e.maptipInstance), o = N(() => e.content), a = we([]), l = f(!1);
    a.push(
      It(i, () => {
        if (i.value) {
  ...
  constructor(e) {
    this.resizeObserver = new ResizeObserver((t) => {
      t.length && window.requestAnimationFrame(() => {
        t.forEach((i) => {
          const r = i.target.dataset.breakpoints, o = r ? JSON.parse(r) : e ?? Ks;
...
const Zs = ["data-cy"], Hi = /* @__PURE__ */ O({
    ...
    return (n, c) => {
      ...
      return v(), w("div", {
        ...
        re(ki, {
          ...
          default: te(() => [
            P((v(), W(us(s.panel.route.screen), ps({ class: "h-full" }, s.panel.route.props, { panel: s.panel }), null, 16, ["panel"])), [
              [u]
            ])
          ]),
          _: 1
  ...
  const s = f(void 0), e = f(void 0), t = f(0), i = f(0), r = f(!1), o = f(!0), a = f({}), l = f({}), n = f([]), c = f([]), u = f([]), p = N(() => i.value);
  function d(I) {
    return I === "xs" && u.value.length > 0 ? [u.value.slice().pop()] : u.value;
  }
  function g(I) {
    const R = [];
    return I.forEach((ae) => {
  ...
  function k() {
    let I = t.value;
    const R = [], ae = 350, he = 12, pi = 600;
    for (let De = n.value.length - 1; De >= 0; De--) {
      const et = n.value[De];
      let $e = et.width || ae;
      if (r.value ? $e = I : $e += he, et.id === "grid" && ($e = Math.max(Math.min($e, I), pi)), (I >= $e && !r.value || R.length === 0) && (I -= $e, R.unshift(et)), et.id === "grid" && I < pi)
        break;
    }
    if (s.value && //@ts-expect-error TODO: explain why this is needed or remove
    !R.includes(s.value) && !r.value) {
      let De;
      for (let di = 0; di < R.length - 1 && I < (s.value.width || ae) + he; di++)
        De = R.shift(), I += De.width || ae;
      I >= (s.value.width || ae) ? R.unshift(s.value) : e.value || (De = R.shift(), R.unshift(s.value));
      const et = n.value.indexOf(s.value), $e = n.value.indexOf(De), Gt = n.value.slice();
      $e > -1 && (Gt.splice(et, 1), Gt.splice($e, 0, s.value)), n.value = Gt;
    }
    i.value = I, u.value = R;
  }
  function V(I) {
    if (a.value = { ...a.value, [I.id]: I }, I.id in l.value)
      l.value[I.id].resolveMe(I);
    else {
      const R = new H();
      R.resolveMe(I), l.value = {
        ...l.value,
        [I.id]: R
      };
    }
  ...
  function ye(I) {
    I.teleport ? c.value = [...c.value, I] : (n.value = [...n.value, I], e.value = I);
  }
  function Qe(I) {
    if (I.teleport) {
      const R = c.value.indexOf(I);
      R !== -1 && (c.value = [...c.value.slice(0, R), ...c.value.slice(R + 1)]);
    } else {
      const R = n.value.indexOf(I);
      R !== -1 && (n.value = [...n.value.slice(0, R), ...n.value.slice(R + 1)]);
    }
  }
  function Nt(I, R) {
    const ae = n.value.indexOf(I), he = R === "right" ? 1 : -1;
    u.value.includes(n.value[ae + he]) && ([n.value[ae], n.value[ae + he]] = [
      n.value[ae + he],
      n.value[ae]
    ]);
  }
  function Ft(I) {
    a.value[I.id] !== void 0 && delete a.value[I.id], l.value[I.id] !== void 0 && delete l.value[I.id];
    const R = u.value.indexOf(I);
    R !== -1 && (u.value = [...u.value.slice(0, R), ...u.value.slice(R + 1)]), s.value && s.value.id == I.id && (s.value = void 0);
  }
  function Dt(I) {
    l.value = {
      ...l.value,
  ...
  __name: "panel-stack",
  setup(s) {
    const e = Ye(), t = ve("iApi"), i = f(), r = N(() => e.mobileView);
    Je(() => {
      new ResizeObserver((u) => {
        const p = !(t?.$vApp.$root?.$refs["app-size"]).classList.contains("sm");
        r.value !== p && (e.mobileView = p, t?.event.emit(E.RAMP_MOBILEVIEW_CHANGE, p)), e.setStackWidth(u[0].contentRect.width);
      }).observe(i.value?.$el);
    });
    const o = (c) => (
    ...
    return (c, u) => (v(), W(Mi, {
      ...
      default: te(() => [
        (v(!0), w(He, null, ht(o(S(t).screenSize), (p) => (v(), W(Hi, {
          key: `${p.id}`,
          panel: p
        }, null, 8, ["panel"]))), 128))
      ]),
  ...
  for (const [i, r] of e)
    t[i] = r;
  return t;
}, Qs = /* @__PURE__ */ Fe(Xs, [["__scopeId", "data-v-197830c4"]]), er = ["content", "aria-label"], ei = /* @__PURE__ */ O({
  ...
  setup(s) {
    const e = f(!1), t = f(null), i = we([]), r = f(), o = f(), a = f(), l = s;
    i.push(
      It(e, () => {
        t.value.update();
      })
    ...
    return Je(() => {
      window.addEventListener(
        ...
        (!r.value || !r.value.contains(p.target)) && (e.value = !1);
      }), a.value.addEventListener("focus", c), a.value.addEventListener("blur", u), a.value.addEventListener("mouseover", c), a.value.addEventListener("mouseleave", u), Ot(() => {
        const p = {
          name: "overflowScroll",
          enabled: !0,
          phase: "main",
        ...
        a.value && o.value && (t.value = Os(a.value, o.value, {
  ...
  const s = f([]), e = f({}), t = N(() => s.value.length >= 99 ? 99 : s.value.length);
  function i(c) {
    s.value = [c, ...s.value];
  }
  function r(c) {
    if (s.value.includes(c)) {
      ...
      c instanceof Yi && n(c), u > -1 && s.value.splice(u, 1);
    }
  }
  function o(c) {
    e.value[c.id] = c;
...
}), tr = { class: "h-full flex flex-col" }, ir = { class: "w-full flex mb-6" }, sr = ["content", "aria-label"], rr = /* @__PURE__ */ O({
  __name: "screen",
  props: {
    panel: {
      type: Object,
  ...
  setup(s) {
    const e = Re(), { t } = Y(), i = N(() => e.notificationNumber), r = () => e.clearAll();
    return (o, a) => {
      const l = Z("panel-screen"), n = M("tippy");
      return v(), W(l, { panel: s.panel }, {
        header: te(() => [
          at(U(S(t)("notifications.title")), 1)
        ]),
        content: te(() => [
          y("div", tr, [
            y("div", ir, [
              P((v(), w("button", {
                ...
                content: S(t)("notifications.controls.clearAll"),
                "aria-label": S(t)("notifications.controls.clearAll")
              }, a[0] || (a[0] = [
                y("svg", {
...
class or extends J {
  ...
  constructor(e) {
    super(e), this.$iApi.panel.register({
      ...
      config: {
        screens: {
          "notifications-screen": Q(rr)
        },
        alertName: "notifications.title"
      }
    }), this.notificationStore = Re(this.$vApp.$pinia);
  }
  /**
  ...
  addGroup(e, t, i) {
    ...
    const r = new Yi(this.$iApi, e, t, i);
...
class Yi extends J {
  notificationStore = Re(this.$vApp.$pinia);
  id;
  message;
  type;
  messageList = [];
...
const ar = ["content"], nr = { class: "flex items-center text-left" }, lr = { class: "select-text cursor-text" }, cr = ["content"], ur = {
  key: 0,
  class: "text-left"
}, pr = /* @__PURE__ */ O({
  ...
  setup(s) {
    ...
    return (n, c) => {
      ...
      return P((v(), w("li", {
        ...
        content: S(t)(r.value ? "notifications.controls.collapse" : "notifications.controls.expand"),
        onClick: c[1] || (c[1] = (p) => r.value = !r.value)
      }, [
        y("div", nr, [
          y("span", null, [
            at(U(o[s.notification.type]) + " ", 1),
            y("span", lr, U(s.notification.message), 1)
          ]),
          c[4] || (c[4] = y("span", { class: "flex-grow" }, null, -1)),
          s.notification.messageList ? (v(), w("div", {
            key: 0,
          ...
          P((v(), w("button", {
            type: "button",
            onClick: c[0] || (c[0] = Zt((p) => a(s.notification), ["stop"])),
            class: "mx-4 p-4 text-gray-500 hover:text-black",
            content: S(t)("notifications.controls.dismiss")
          }, c[3] || (c[3] = [
            y("svg", {
              class: "fill-current",
              height: "16",
        ...
        s.notification.messageList && r.value ? (v(), w("div", ur, [
          (v(!0), w(He, null, ht(s.notification.messageList, (p, d) => (v(), w("p", {
  ...
  setup(s) {
    const e = Re(), { t } = Y(), i = f(), r = () => {
      i.value._tippy.hide();
    }, o = (l) => {
      l.key === "Tab" && i.value?.matches(":focus") && i.value._tippy.show();
    };
    Je(() => {
      i.value?.addEventListener("blur", r), i.value?.addEventListener("keyup", o);
    }), dt(() => {
      i.value?.removeEventListener("blur", r), i.value?.removeEventListener("keyup", o);
    });
    const a = N(() => e.notificationStack);
    return (l, n) => {
      const c = M("focus-item"), u = M("focus-list"), p = M("tippy");
      return v(), w("div", null, [
        a.value.length > 0 ? P((v(), w("ul", {
          key: 0,
          content: S(t)("panels.controls.items"),
          ref_key: "el",
          ref: i,
          class: "h-full overflow-y-auto"
        }, [
          (v(!0), w(He, null, ht(a.value, (d, g) => (v(), w(He, {
            key: d.message + g
          }, [
            g > 0 ? (v(), w("div", hr)) : G("", !0),
            P(re(pr, {
          ...
          n[0] || (n[0] = y("span", { class: "flex-grow" }, null, -1)),
          n[1] || (n[1] = y("svg", {
            xmlns: "http://www.w3.org/2000/svg",
            viewBox: "0 0 24 24",
          ...
          y("span", null, U(S(t)("notifications.empty")), 1),
          n[2] || (n[2] = y("span", { style: { "flex-grow": "6" } }, null, -1))
        ]))
      ]);
    };
  }
}), mr = { class: "flex items-center hover:text-white" }, yr = ["aria-label"], gr = {
  key: 0,
  class: "number rounded-full w-18 text-white"
}, vr = { class: "notification-dropdown pointer-events-auto bg-white rounded text-center text-black w-500 h-256 flex flex-col p-0" }, br = { class: "pb-8 border-b border-gray-600" }, Ar = { class: "absolute flex right-3 top-3" }, wr = ["content", "aria-label"], Er = /* @__PURE__ */ O({
  __name: "caption-button",
  setup(s) {
    const e = Re(), { t } = Y(), i = N(() => e.notificationNumber), r = () => e.clearAll();
    return (o, a) => {
      const l = Z("close"), n = M("tippy");
      return v(), W(ei, {
        position: "top-start",
        tooltip: S(t)("notifications.title"),
        ...
        header: te(() => [
          y("div", mr, [
            (v(), w("svg", {
              ...
              xmlns: "http://www.w3.org/2000/svg",
              viewBox: "0 0 24 24",
              "aria-label": S(t)("notifications.open")
            }, a[0] || (a[0] = [
            ...
            i.value && i.value > 0 ? (v(), w("span", gr, U(i.value), 1)) : G("", !0)
          ])
        ]),
        default: te((c) => [
          y("div", vr, [
            y("div", null, [
              y("h4", br, U(S(t)("notifications.title")), 1),
              y("div", Ar, [
                P((v(), w("button", {
                  type: "button",
                  onClick: r,
            ...
            re(Ji, { class: "overflow-y-auto h-230" })
          ])
        ]),
        _: 1
      }, 8, ["tooltip"]);
...
}), xr = /* @__PURE__ */ Fe(Er, [["__scopeId", "data-v-3623a7d2"]]), Sr = { class: "flex hover:text-white" }, Ir = ["aria-label"], _r = { class: "about-ramp-dropdown pointer-events-auto bg-white rounded w-256 h-50" }, Tr = ["aria-label", "content"], Lr = { class: "pb-8 border-b border-gray-600 mb-10" }, Rr = { class: "absolute right-5 top-5" }, $r = { class: "select-text" }, Cr = { class: "font-bold cursor-text" }, Or = { class: "text-sm cursor-text" }, kr = { class: "text-sm cursor-text" }, Mr = /* @__PURE__ */ O({
  ...
  setup(s) {
    const { t: e } = Y(), t = ve("iApi"), i = () => {
      t.reload();
    }, r = N(() => `${mt.major}.${mt.minor}.${mt.patch}`), o = N(() => mt.hash.slice(0, 9)), a = N(() => {
      const l = new Date(mt.timestamp);
      if (isNaN(l))
        return "dev mode, no date";
      {
        const n = (c) => c < 10 ? "0" + c.toString() : c.toString();
        return `${l.getFullYear()}-${l.getMonth() + 1}-${l.getDate()} ${l.getHours()}:${n(
          l.getMinutes()
        )}:${n(l.getSeconds())}`;
      }
    });
    return (l, n) => {
      const c = Z("close"), u = Z("dropdown-menu"), p = M("tippy"), d = M("focus-item");
      return P((v(), W(u, {
        class: "pointer-events-auto sm:flex",
        position: s.position,
        tooltip: S(e)("ramp.about"),
        ...
        header: te(() => [
          y("div", Sr, [
            (v(), w("svg", {
              ...
              "aria-label": S(e)("ramp.about.open")
            }, n[0] || (n[0] = [
          ...
          y("div", _r, [
            y("div", null, [
              P((v(), w("button", {
                ...
                onClick: i,
                "aria-label": S(e)("ramp.reload"),
                content: S(e)("ramp.reload")
              }, n[1] || (n[1] = [
                y("svg", {
              ...
              y("div", $r, [
                y("div", null, [
                  y("span", Cr, U(r.value), 1),
                  y("span", Or, " [" + U(o.value) + "] ", 1)
                ]),
                y("div", null, [
                  y("span", kr, U(a.value), 1)
                ]),
...
}), Pr = /* @__PURE__ */ Fe(Mr, [["__scopeId", "data-v-dc5124c0"]]), Nr = { class: "map-caption absolute bottom-0 h-29 sm:h-38 flex justify-end pointer-events-auto cursor-default select-none text-gray-200 bg-black-75 left-0 right-0 py-2 sm:py-6" }, Fr = {
  key: 0,
  class: "relative top-2 sm:top-1 ml-4 sm:ml-0 shrink-0"
}, Dr = ["href", "aria-label"], Gr = ["src", "alt"], Ur = {
  key: 1,
  class: "relative ml-10 top-2 text-sm sm:text-base"
}, Br = { class: "flex min-w-fit justify-end" }, Vr = {
  key: 0,
  class: "pl-8 px-14 sm:block display-none relative top-2"
}, zr = ["aria-pressed", "aria-label", "content"], qr = { class: "relative top-1 text-sm sm:text-base" }, jr = { class: "text-gray-200 hover:text-white text-sm sm:text-base pb-5" }, Wr = ["onClick"], Hr = {
  key: 0,
  class: "sr-only"
}, Yr = /* @__PURE__ */ O({
  __name: "map-caption",
  setup(s) {
    const e = Be(), t = pe(), { t: i } = Y(), r = ve("iApi"), o = N(() => e.scale), a = N(() => e.attribution), l = N(() => e.coords), n = N(() => e.langtoggle), c = N(() => t.config.map), u = f([]), p = we([]);
    p.push(
      It(c, (A) => {
        A && r.geo.map.caption.createCaption(c.value?.caption);
      })
    ), dt(() => {
      p.forEach((A) => A());
    }), hs(() => {
    ...
    const d = () => a.value?.logo?.link && a.value?.logo?.value && !a.value?.logo?.disabled, g = (A) => {
      r.$i18n.locale.value != A && r.setLanguage(A);
    }, h = () => {
      e.toggleScale(), r.geo.map.caption.updateScale();
    }, m = (A = !1) => i(A ? "map.toggleScaleToMetric" : "map.toggleScaleToImperial");
    return (A, b) => {
      const $ = Z("dropdown-menu"), L = M("truncate"), k = M("tippy");
      return v(), w("div", Nr, [
        re(Pr, {
          class: "sm:block display-none ml-8 mr-4",
          position: "top-end"
        }),
        re(xr, { class: "sm:block display-none" }),
        d() ? (v(), w("span", Fr, [
          y("a", {
        ...
        a.value?.text.disabled ? G("", !0) : P((v(), w("span", Ur, [
          at(U(a.value?.text.value), 1)
        ])), [
          [L, {
            options: {
              placement: "top",
        ...
        b[0] || (b[0] = y("span", { class: "flex-grow w-15" }, null, -1)),
        y("div", Br, [
          l.value?.disabled ? G("", !0) : P((v(), w("div", Vr, [
            at(U(l.value?.formattedString), 1)
          ])), [
            [L, {
              options: {
                hideOnClick: !1,
          ...
          o.value?.disabled ? G("", !0) : P((v(), w("button", {
            key: 1,
            type: "button",
            ...
            "aria-label": `
                ...
                `,
            content: m(o.value?.isImperialScale)
          }, [
            y("span", {
              class: "border-solid border-2 border-white border-t-0 h-5 mr-4 inline-block",
              style: Oi({ width: o.value?.width })
            }, null, 4),
            y("span", qr, U(o.value?.label), 1)
          ], 8, zr)), [
            [k, {
              delay: [300, 0],
              placement: "top",
          ...
          n.value?.disabled ? G("", !0) : (v(), W($, {
            key: 2,
            class: "flex-shrink-0 pointer-events-auto focus:outline-none px-4 mr-4 relative top-2",
            position: "top-end",
            tooltip: S(i)("map.changeLanguage"),
            ariaLabel: `${S(i)("map.language.short")} - ${S(i)("map.changeLanguage")}`,
            tooltipPlacement: "top-start",
            tooltipPlacementAlt: "left-end"
          }, {
            header: te(() => [
              y("span", jr, U(S(i)("map.language.short")), 1)
            ]),
            default: te(() => [
              (v(!0), w(He, null, ht(u.value, (V, ye) => (v(), w("a", {
                key: `${V}-${ye}`,
                class: oe(["flex-auto items-center text-sm sm:text-base cursor-pointer", { "font-bold": V === S(r).$i18n.locale.value }]),
                href: "javascript:;",
                onClick: (Qe) => g(V)
              }, [
                at(U(S(i)("map.language." + V)) + " ", 1),
                V === S(r).$i18n.locale.value ? (v(), w("span", Hr, U(S(i)("map.language.curr")), 1)) : G("", !0)
              ], 10, Wr))), 128))
            ]),
            _: 1
          }, 8, ["tooltip", "ariaLabel"]))
...
}), Jr = ["content", "aria-label"], Kr = {
  key: 0,
  class: "number absolute -top-2 -right-2 text-white w-18 rounded-full"
}, Zr = /* @__PURE__ */ O({
  __name: "floating-button",
  setup(s) {
    const e = Re(), t = ve("iApi"), { t: i } = Y(), r = N(() => e.notificationNumber);
    return (o, a) => {
      const l = M("tippy");
      return P((v(), w("button", {
        type: "button",
        onClick: a[0] || (a[0] = (n) => S(t).panel.get("notifications").open()),
        ...
        content: S(i)("notifications.title"),
        "aria-label": S(i)("notifications.title")
      }, [
        a[1] || (a[1] = y("svg", {
          class: "fill-current w-24 h-24",
          xmlns: "http://www.w3.org/2000/svg",
        ...
        r.value && r.value > 0 ? (v(), w("span", Kr, U(r.value), 1)) : G("", !0)
      ], 8, Jr)), [
        [l]
      ]);
    };
  }
}), Xr = /* @__PURE__ */ Fe(Zr, [["__scopeId", "data-v-a451db5c"]]), Qr = { class: "flex items-center mb-20" }, eo = { class: "text-xl" }, to = /* @__PURE__ */ O({
  __name: "keyboard-instructions",
  setup(s) {
    const e = ve("iApi"), { t } = Y(), i = f(!1), r = f(["app", "lists", "map"]), o = f([]), a = f(null), l = f(null);
    Je(() => {
      o.value.push(
    ...
    return (c, u) => {
      ...
      return i.value ? (v(), w("div", {
        ...
        y("div", {
          ...
          y("div", Qr, [
            y("h2", eo, U(S(t)("keyboardInstructions.title")), 1),
            re(p, {
              class: "ml-auto",
              onClick: u[0] || (u[0] = (d) => i.value = !1)
            })
          ]),
          (v(!0), w(He, null, ht(r.value, (d) => (v(), w("p", {
            class: "whitespace-pre-line pb-10",
            key: d
          }, U(S(t)(`keyboardInstructions.${d}`)), 1))), 128)),
          y("button", {
            type: "button",
            ...
            ref_key: "lastEl",
            ref: l
          }, U(S(t)("keyboardInstructions.OK")), 513)
        ], 512)
      ], 32)) : G("", !0);
    };
  }
}), st = B("instance", () => ({ started: f(!1) })), io = { class: "h-full relative" }, so = { class: "inner-shell absolute top-0 left-0 h-full w-full pointer-events-none" }, ro = { class: "absolute top-8 w-full flex justify-center" }, oo = {
  key: 1,
  class: "w-full h-full"
}, ao = /* @__PURE__ */ O({
  __name: "shell",
  setup(s) {
    const e = ve("iApi"), t = st(), i = ge(), r = Ye(), { t: o } = Y(), a = N(() => i.items.appbar), l = () => {
      e?.event.emit("openKeyboardInstructions");
    }, n = () => r.teleported;
    return (c, u) => (v(), w("div", io, [
      y("div", so, [
        ...
        y("div", ro, [
          y("button", {
            ...
            onClick: l
          }, U(S(o)("keyboardInstructions.open")), 1)
        ]),
        re(to),
        re(Qs, { class: "panel-stack sm:flex absolute inset-0 overflow-hidden sm:p-12 z-10 sm:pl-80 xs:pl-40 sm:pb-48 xs:pb-28 xs:pr-0 sm:pr-40" }),
        a.value ? G("", !0) : (v(), W(Xr, { key: 0 })),
        re(Yr, { class: "z-30" })
      ]),
      S(t).started ? (v(), W(Js, { key: 0 })) : (v(), w("div", oo, u[1] || (u[1] = [
        y("div", { class: "spinner relative inset-x-1/2 inset-y-9/20" }, null, -1)
      ]))),
      (v(!0), w(He, null, ht(n(), (p) => (v(), W(fs, {
...
}), no = /* @__PURE__ */ Fe(ao, [["__scopeId", "data-v-7a1e48c2"]]), lo = O({
  name: "App",
  components: { Shell: no },
  setup() {
    const s = ms();
    Je(() => {
      new Wi().observe(s?.proxy?.$refs["app-size"]), Rs({
        aria: {
          content: "labelledby"
        },
        theme: "ramp4",
...
const ho = /* @__PURE__ */ Fe(lo, [["render", po]]), Ie = "focus-list", je = "focus-item", fo = "focus-icon", mo = "focus-container", ct = `[${Ie}],[${mo}]`, At = "truncate-text", wt = "show-truncate", ot = "focused", Yt = `button,input,select,a,textarea,[contenteditable],[${Ie}],[${fo}],[tabIndex]`, yo = {
  mounted(s, e) {
    +s.getAttribute("tabindex") <= 0 && s.setAttribute("tabindex", "0"), s.toggleAttribute(Ie, !0), new go(s, e.value);
  },
  updated(s) {
    Ki(s);
  }
...
function Ki(s) {
  s.querySelectorAll(Yt).forEach((t) => {
    if (t.closest(ct) === s || t.closest(ct) === t && t.parentElement.closest(ct) === s)
      if (t.closest(`[${Ie}],.${ot}`).classList.contains(ot))
...
class go {
  ...
  constructor(e, t) {
    ...
    e.addEventListener("keydown", function(r) {
      ...
      const a = r.detail.focusItem;
      i.element.focus(), i.focusItem(a), this.highlightedItem = a;
  ...
  setTabIndex(e, t = this.element) {
    t.querySelectorAll(Yt).forEach((r) => {
      (e === -1 || r.closest(ct) === this.element || r.closest(ct) === r && r.parentElement.closest(ct) === this.element || r.closest(`[${Ie}],.${ot}`).classList.contains(ot)) && r.setAttribute("tabindex", e.toString());
    });
  }
  /**
   ...
   */
  defocusItem(e) {
    e.classList.remove(ot), this.setTabIndex(-1, e), e._tippy && e._tippy.hide(), e.getAttribute(je) === wt && e.querySelector(`[${At}]`)?._tippy?.hide();
  }
  /**
   ...
   */
  focusItem(e) {
    e.classList.add(ot), this.setAriaActiveDescendant(e), this.setTabIndex(0, e), e.scrollIntoView({ block: "nearest" }), e._tippy && !this.isTapped && e._tippy.show(), e.getAttribute(je) === wt && e.querySelector(`[${At}]`)?._tippy?.show(), this.isTapped = !1;
  }
  /**
  ...
  onKeydown(e) {
    const t = this, i = Array.prototype.filter.call(
      ...
      (r) => r.closest(`[${Ie}]`) === t.element && !!r.offsetParent
    );
    if (i.length !== 0)
      switch (e.key) {
        case "Up":
        ...
        case " ":
          ...
          break;
        case "Tab":
          const r = this.highlightedItem.querySelectorAll(Yt).length === 0, o = this.element.isEqualNode(e.target);
          this.highlightedItem !== this.element && o && (r && this.defocusItem(this.highlightedItem), e.shiftKey && (e.preventDefault(), e.stopPropagation(), this.defocusItem(this.highlightedItem), this.highlightedItem = this.element, this.element.removeAttribute("aria-activedescendant"), this.element.focus()));
      }
  }
  /**
  ...
  onClick(e) {
    ...
    let t = e.target;
    if (!t.hasAttribute(Ie))
      for (; t.parentElement.closest(`[${Ie}]`) !== this.element; )
        t = t.parentElement.closest(`[${Ie}]`);
    this.highlightedItem = t.closest(`[${je}]`) || t.closest(`[${Ie}]`) || this.highlightedItem, t.hasAttribute(`${je}`) && this.element.focus(), this.highlightedItem !== this.element ? this.focusItem(this.highlightedItem) : this.element.removeAttribute("aria-activedescendant");
  }
  /**
   ...
   */
  onFocus() {
    this.highlightedItem && !this.isClicked && (this.highlightedItem._tippy && this.highlightedItem._tippy.show(), this.highlightedItem.getAttribute(je) === wt && this.highlightedItem.querySelector(`[${At}]`)?._tippy?.show()), this.isClicked = !1, this.element.hasAttribute("aria-activedescendant") || this.highlightedItem === this.element ? this.highlightedItem !== this.element && this.focusItem(this.highlightedItem) : this.setAriaActiveDescendant(this.highlightedItem), Ki(this.element), this.highlightedItem && this.highlightedItem !== this.element && this.highlightedItem.setAttribute("tabindex", "-1");
  }
  /**
   ...
   */
  onBlur() {
    this.highlightedItem && (this.highlightedItem._tippy && this.highlightedItem._tippy.hide(), this.highlightedItem.getAttribute(je) === wt && this.highlightedItem.querySelector(`[${At}]`)?._tippy?.hide());
  }
  /**
...
const vi = "focus-item", vo = {
  beforeMount(s, e) {
    s.hasAttribute("id") || s.setAttribute("id", bo()), e.value ? s.setAttribute(vi, e.value) : s.toggleAttribute(vi, !0);
  }
};
function bo() {
  let s;
...
const ti = "focus-container", Zi = "focus-list", Ao = "focus-icon", Vt = `[${Zi}],[${ti}]`, bi = `button,input,select,a,textarea,[contenteditable],.ag-tab-guard,[${Zi}],[${ti}],[${Ao}],[tabIndex]`;
let zt = [];
const wo = {
  mounted(s) {
    [...document.querySelectorAll(".inner-shell")].some((t) => t.contains(s)) && zt.push(new Eo(s));
  },
  beforeUnmount(s) {
    zt = zt.filter((e) => e.element === s ? (e.removeEventListeners(), !1) : !0);
  }
};
class Eo {
  element;
   ...
   */
  constructor(e) {
    this.element = e, this.element.toggleAttribute(ti, !0), this.element.tabIndex = 0, setTimeout(() => this.disableTabbing(), 600);
    const t = this;
   ...
   */
  disableTabbing() {
    Array.prototype.filter.call(this.element.querySelectorAll(bi), () => !0).forEach((t) => {
      t.tabIndex = -1;
    });
  }
  /**
  ...
  enableTabbing() {
    let e;
    return Array.prototype.map.call(this.element.querySelectorAll(bi), (t) => {
      (t.closest(Vt) === this.element || t.closest(Vt) === t && t.parentElement.closest(Vt) === this.element) && t.offsetParent && (t.tabIndex = 0, e === void 0 && (e = t));
    }), e;
  }
}
const xo = "truncate-text", So = "truncate-trigger", Io = {
  beforeMount(s, e) {
    !s.classList.contains("truncate") && !e.value?.noTruncateClass && s.classList.add("truncate"), s.toggleAttribute(xo, !0);
  },
  mounted(s, e) {
    let t;
    e.value && e.value.externalTrigger && (t = s.closest(`[${So}]`)), $s(s, {
      content: Ai(s.textContent),
      onShow: _o,
      allowHTML: !0,
      placement: "bottom-start",
      maxWidth: 320,
  ...
  updated(s, e) {
    s._tippy && (s._tippy.setContent(Ai(s.textContent)), e.value && e.value.options && s._tippy.setProps(e.value.options));
  },
  unmounted(s) {
...
const To = ["content"], Lo = {
  ...
  setup(s, { expose: e }) {
    const { t } = Y(), i = Ye(), r = $t(), o = ve("iApi"), a = hi("el"), l = hi("contentEl"), n = f();
    e({ el: a });
    const c = s, u = N(() => o?.fixture.get("appbar") ? r.temporary : []), p = N(() => i.mobileView), d = N(() => i.reorderable), g = (b) => b.scrollHeight > b.clientHeight, h = () => !p.value && !c.panel.teleport, m = (b) => {
      c.panel.move(b), b === "left" && Ot(() => {
        (a.value?.querySelector(".move-left")).focus();
      });
    }, A = N(() => c.screenId ? c.panel.screens[c.screenId][o?.$i18n.locale.value ?? "en"] : null);
    return Je(() => {
      a.value?.addEventListener("blur", () => {
        a.value._tippy.hide();
      }), a.value?.addEventListener("keyup", (b) => {
        b.key === "Tab" && a.value?.matches(":focus") && a.value._tippy.show();
      ...
      a.value?.removeEventListener("blur", () => {
        a.value._tippy.hide();
      }), a.value?.removeEventListener("keyup", (b) => {
        b.key === "Tab" && a.value?.matches(":focus") && a.value._tippy.show();
      }), n.value.disconnect();
    }), (b, $) => {
      const L = Z("back"), k = Z("panel-options-menu"), V = Z("left"), ye = Z("right"), Qe = Z("pin"), Nt = Z("expand"), Ft = Z("minimize"), Dt = Z("close"), I = M("truncate"), R = M("focus-item"), ae = M("tippy");
      return P((v(), w("div", {
        class: "h-full flex flex-col items-stretch",
        content: `<div style='word-break: break-word;'>${S(t)(s.panel.alertName) + ". " + S(t)("panels.access")}</div>`,
        ref_key: "el",
        ref: a
      }, [
        s.header ? (v(), w("header", Lo, [
          re(L, {
            class: oe(s.panel.teleport ? "display-none" : "block sm:display-none"),
            onClick: $[0] || ($[0] = (he) => s.panel.close())
          }, null, 8, ["class"]),
          P((v(), w("h2", Ro, [
            b.$slots.header ? Pe(b.$slots, "header", { key: 0 }) : (v(), w("div", $o, U(S(t)(s.panel.alertName)), 1))
          ])), [
            [I]
          ]),
          b.$slots.controls ? (v(), W(k, { key: 0 }, {
            default: te(() => [
              Pe(b.$slots, "controls")
            ]),
            _: 3
        ...
        s.content ? (v(), w("div", {
          ...
          b.$slots.content ? Pe(b.$slots, "content", { key: 0 }) : A.value ? (v(), w("div", {
            key: 1,
            innerHTML: A.value.innerHTML
          }, null, 8, Oo)) : G("", !0)
        ], 512)) : G("", !0),
        s.footer ? P((v(), w("div", ko, [
          Pe(b.$slots, "footer")
        ])), [
          [R]
        ]) : G("", !0)
...
}), Po = { class: "relative" }, No = ["content", "aria-label"], Fo = ["transform"], Do = /* @__PURE__ */ O({
  __name: "pin",
  props: {
    active: Boolean
  },
    ...
    return (t, i) => {
      ...
      return v(), w("div", Po, [
        P((v(), w("button", {
          ...
          content: S(e)(s.active ? "panels.controls.unpin" : "panels.controls.pin"),
          "aria-label": S(e)(s.active ? "panels.controls.unpin" : "panels.controls.pin")
        }, [
          (v(), w("svg", {
            class: "fill-current w-16 h-16",
            xmlns: "http://www.w3.org/2000/svg",
...
}), Go = { class: "relative" }, Uo = ["content", "aria-label"], Bo = /* @__PURE__ */ O({
  __name: "close",
  props: {
    active: Boolean
  },
    ...
    return (t, i) => {
      ...
      return v(), w("div", Go, [
        P((v(), w("button", {
          type: "button",
          class: oe(["text-gray-500 hover:text-black focus:text-black p-8", { "text-gray-700": s.active }]),
          content: S(e)("panels.controls.close"),
          "aria-label": S(e)("panels.controls.close")
        }, i[0] || (i[0] = [
          y("svg", {
            class: "fill-current w-16 h-16",
            xmlns: "http://www.w3.org/2000/svg",
...
}), Vo = { class: "relative" }, zo = ["content", "aria-label"], qo = /* @__PURE__ */ O({
  __name: "back",
  props: {
    active: Boolean
  },
    ...
    return (t, i) => {
      ...
      return v(), w("div", Vo, [
        P((v(), w("button", {
          type: "button",
          class: oe(["text-gray-500 hover:text-black focus:text-black p-8", { "text-gray-700": s.active }]),
          content: S(e)("panels.controls.back"),
          "aria-label": S(e)("panels.controls.back")
        }, i[0] || (i[0] = [
          y("svg", {
            xmlns: "http://www.w3.org/2000/svg",
            class: "fill-current w-16 h-16",
...
}), jo = { class: "w-32 h-32" }, Wo = ["content", "aria-label"], Ho = {
  key: 0,
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 24 24",
    ...
    return (t, i) => {
      ...
      return v(), w("div", jo, [
        P((v(), w("button", {
          ...
          content: S(e)(`panels.controls.${s.active ? "collapse" : "expand"}`),
          "aria-label": S(e)(`panels.controls.${s.active ? "collapse" : "expand"}`)
        }, [
          s.active ? (v(), w("svg", Yo, i[1] || (i[1] = [
            y("path", {
              d: "M0 0h24v24H0z",
              fill: "none"
            }, null, -1),
...
}), Ko = { class: "relative" }, Zo = ["content", "aria-label"], Xo = /* @__PURE__ */ O({
  __name: "minimize",
  props: {
    active: Boolean
  },
    ...
    return (t, i) => {
      ...
      return v(), w("div", Ko, [
        P((v(), w("button", {
          ...
          content: S(e)("panels.controls.minimize"),
          "aria-label": S(e)("panels.controls.minimize")
        }, i[0] || (i[0] = [
          y("svg", {
            class: "fill-current w-20 h-20",
            xmlns: "http://www.w3.org/2000/svg",
...
}), Qo = { class: "relative" }, ea = ["content", "aria-label"], ta = /* @__PURE__ */ O({
  __name: "right",
  props: {
    active: Boolean
  },
    ...
    return (t, i) => {
      ...
      return v(), w("div", Qo, [
        P((v(), w("button", {
          ...
          content: S(e)("panels.controls.moveRight"),
          "aria-label": S(e)("panels.controls.moveRight")
        }, i[0] || (i[0] = [
          y("svg", {
            class: "fill-current w-16 h-16",
            xmlns: "http://www.w3.org/2000/svg",
...
}), ia = { class: "relative" }, sa = ["content", "aria-label"], ra = /* @__PURE__ */ O({
  __name: "left",
  props: {
    active: Boolean
  },
    ...
    return (t, i) => {
      ...
      return v(), w("div", ia, [
        P((v(), w("button", {
          ...
          content: S(e)("panels.controls.moveLeft"),
          "aria-label": S(e)("panels.controls.moveLeft")
        }, i[0] || (i[0] = [
          y("svg", {
            class: "fill-current w-16 h-16",
            xmlns: "http://www.w3.org/2000/svg",
  ...
  setup(s) {
    ...
    return (t, i) => (v(), W(ei, {
      class: "flex",
      tooltip: S(e)("panels.controls.optionsMenu"),
...
}), aa = /* @__PURE__ */ Fe(oa, [["__scopeId", "data-v-51e22a4a"]]), na = {
  key: 0,
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 24 24",
  ...
  setup(s) {
    ...
    return (r, o) => {
      const a = Z("mapnav-button");
      return v(), W(a, {
        onClickFunction: i,
        tooltip: S(e)("mapnav.fullscreen")
      }, {
        default: te(() => [
          S(t).isFullscreen ? (v(), w("svg", na, o[0] || (o[0] = [
            y("path", {
              d: "M0 0h24v24H0z",
              fill: "none"
            }, null, -1),
  ...
  tabindex: "-1"
}, ha = ["content", "aria-label"], fa = /* @__PURE__ */ O({
  __name: "button",
  props: {
    onClickFunction: {
      type: Function,
  ...
  setup(s) {
    return (e, t) => {
      const i = M("focus-item"), r = M("tippy");
      return v(), w("div", da, [
        P((v(), w("button", {
          type: "button",
          class: "w-full h-full default-focus-style focus:outline-none",
          onClick: t[0] || (t[0] = (o) => s.onClickFunction()),
          content: s.tooltip,
  ...
  class: "relative",
  tabindex: "-1"
}, ya = ["aria-label", "content"], ga = /* @__PURE__ */ O({
  __name: "button",
  props: {
    onClickFunction: {
      type: Function,
  ...
  setup(s) {
    const e = ve("iApi"), t = s, i = () => e?.event.emit(E.APPBAR_BUTTON_CLICK, t.buttonId);
    return (r, o) => {
...
}), va = /* @__PURE__ */ Fe(ga, [["__scopeId", "data-v-f0341fec"]]), ba = B("areas-of-interest", () => ({ areas: f([]) })), Aa = B("export", () => {
  const s = f({
    title: !0,
    map: !0,
    mapElements: !0,
...
class Sa {
  ...
  constructor(e) {
    bt.get(e).then((t) => {
      ...
      this.provinceList.push(i), t.data.definitions.forEach((r) => {
        const o = parseInt(r.code);
        this.provinceList.push({
          code: o,
          abbr: xa[o],
          name: r.description
        });
      }), this.provinceList.sort((r, o) => r.name > o.name ? 1 : -1), this.listFetched = !0;
    });
  }
  /**
  ...
  fsaToProvince(e) {
    ...
    return r === "X" ? i === "X0A" || i === "X0B" || i === "X0C" ? t = 62 : t = 61 : t = Ea[r], this.codeToProvince(t);
  }
}
function Ia(s) {
  return new Sa(s);
...
async function La(s, e) {
  let t, i;
  const r = /^[-+]?([1-8]?\d(\.\d+)?|90(\.0+)?)(\s*[,|;\s]\s*)[-+]?(180(\.0+)?|((1[0-7]\d)|([1-9]?\d))(\.\d+)?)[*]$/, o = /^\d{2,3}[A-P]/, a = /^[ABCEGHJKLMNPRSTVXY]\d[A-Z]/;
  return r.test(e) && !s.disabledSearchTypes.includes("LAT/LNG") ? (i = e.slice(0, -1), t = new xt(s, i), await Ca(t)) : a.test(e) && !s.disabledSearchTypes.includes("FSA") ? (i = e.substring(0, 3).toUpperCase(), t = new xt(s, i), await Oa(t)) : o.test(e) && !s.disabledSearchTypes.includes("NTS") ? (i = e.substring(0, 6).toUpperCase(), t = new xt(s, i), await ka(t)) : (i = encodeURIComponent(e.trim()), t = new xt(s, i), await Ma(t)), t;
}
const ii = async (s) => {
  const [e, t] = await Ee(bt.get(s));
  ...
  let r = "";
  const o = s.config;
  return e ? r = o.geoLocateUrl + "?q=" + s.query : (t && i ? r = `${o.geoNameUrl}?lat=${t}&lon=${i}&num=${o.maxResults}` : r = `${o.geoNameUrl}?q=${s.query}&num=${o.maxResults}`, o.categories.length > 0 && (r += `&concise=${o.categories.join(",")}`), o.officialOnly && (r += "&category=O")), r;
}, Xi = (s, e) => e.filter((t) => s.types.validTypes[t.concise.code]).map((t) => ({
  name: t.name,
  flav: "nme",
  bbox: t.bbox,
  ...
  const [e, t] = await Ee(ii(si(s, !0)));
  return e ? (console.error("Geolocation service failed"), s.failedServs.push("geolocation"), []) : t;
}, Ra = async (s) => {
  const [e, t] = await Ee(ii(si(s, !1)));
  let i;
  e ? (console.error("GeoName service targeting Name failed"), s.failedServs.push("geoname"), i = []) : i = t.items, s.results = s.results.concat(Xi(s.config, i));
}, $a = async (s, e, t) => {
  const [i, r] = await Ee(ii(si(s, !1, e, t)));
  let o;
  i ? (console.error("GeoName service targeting Lat Lon failed"), s.failedServs.push("geoname"), o = []) : o = r.items, s.results = s.results.concat(Xi(s.config, o));
}, Ca = async (s) => {
  const e = s.query.split(/[\s|,|;|]/).filter((o) => !isNaN(o) && o !== "").map((o) => parseFloat(o)), t = e[0], i = e[1], r = {
    name: `${t},${i}`,
    flav: "llg",
    location: {},
  ...
  await $a(s, t, i), s.results.push(r);
}, Oa = async (s) => {
  const e = s.config, t = await ri(s);
  if (t.length) {
    const r = t[0].geometry.coordinates, o = r[1], a = r[0], l = {
      name: s.query,
      flav: "fsa",
      bbox: Mt(a, o, 0.03),
  ...
  const e = s.config, t = await ri(s);
  if (t.length) {
    const i = t[0], r = i.title.split(" "), o = r.shift() || "", a = r.join(" "), l = i.geometry.coordinates, n = l[1], c = l[0], u = {
      name: o,
      flav: "nts",
  ...
  const e = s.config;
  if (await Ra(s), e.categories.length === 0 || e.categories.includes("ADDR")) {
    const t = await ri(s), i = e.sortOrder.indexOf("ADDR"), r = i >= 0 ? i : e.sortOrder.length, o = t.filter((a) => a.type?.includes("Street")).map((a) => {
      const [l, n, c] = a.title.split(", "), u = a.geometry.coordinates, p = u[1], d = u[0];
      return {
        name: l,
        flav: "add",
        bbox: Mt(d, p, 2e-3),
    ...
    s.results = s.results.concat(o);
  }
}, Pa = "~FSA~", wi = "https://geogratis.gc.ca/services/geolocation/@{language}/locate", Ei = "https://geogratis.gc.ca/services/geoname/@{language}/geonames.json", xi = "https://geogratis.gc.ca/services/geoname/@{language}/codes/province.json", Si = "https://geogratis.gc.ca/services/geoname/@{language}/codes/concise.json";
class Ii {
  config;
  constructor(e, t) {
    let i, r, o, a;
    const l = t?.serviceUrls;
    l ? (i = l.geoLocation ? l.geoLocation : wi, r = l.geoNames ? l.geoNames : Ei, o = l.geoProvince ? l.geoProvince : xi, a = l.geoTypes ? l.geoTypes : Si) : (i = wi, r = Ei, o = xi, a = Si), i = i.replace("@{language}", e), r = r.replace("@{language}", e), o = o.replace("@{language}", e), a = a.replace("@{language}", e);
    let n = "";
    const c = t?.fsaBoundaries;
    if (c && c.serviceUrl) {
      const A = c.keyField || "CFSAUID";
      n = `${c.serviceUrl}/query/?where=${A}%3D'${Pa}'&outFields=${A}&returnGeometry=true&f=json`;
    }
    const u = t?.settings;
    let p, d, g, h, m;
    u ? (p = u.categories ? u.categories : [], d = u.sortOrder ? u.sortOrder : [], g = u.disabledSearchTypes ? u.disabledSearchTypes : [], h = u.maxResults > 0 ? u.maxResults : 100, m = !!u.officialOnly) : (p = [], d = [], g = [], h = 100, m = !1), this.config = {
      language: e,
      geoNameUrl: r,
      geoLocateUrl: i,
      fsaUrl: n,
  ...
  levenshteinDistance(e, t) {
    ...
    for (let r = 0; r <= t.length; r++) {
      ...
      for (let o = 1; o <= e.length; o++)
        i[r][o] = r === 0 ? o : Math.min(
          i[r][o - 1] + 1,
          // delete
          i[r - 1][o] + 0.2,
          // insert
          i[r - 1][o - 1] + (e[o - 1] === t[r - 1] ? 0 : 1)
          // substitute
        );
    }
   ...
   */
  async query(e) {
    const t = await La(this.config, e.toUpperCase()), i = this.config.sortOrder.length, r = t.results.filter((n) => n.order < i), o = t.results.filter((n) => n.order >= i);
    r.sort((n, c) => n.order - c.order);
    const a = this.config.maxResults;
    let l;
    return r.length >= a ? l = r.slice(0, a) : (o.forEach((n) => n.order = this.levenshteinDistance(t.query, n.name)), o.sort((n, c) => n.order - c.order), l = r.concat(o.slice(0, a - r.length))), {
      results: l,
...
const Na = B("geosearch", () => {
  const s = f(new Ii("en", void 0)), e = f({
    type: "",
    province: "",
    extent: void 0
  }), t = f(!1), i = f(""), r = f(""), o = f(""), a = f([]), l = f([]), n = f(!1), c = f([]), u = N(() => s.value.fetchProvinces()), p = N(
    () => new Promise((L) => {
      s.value.fetchTypes().then((k) => {
        k.sort((V, ye) => V.name > ye.name ? 1 : -1), L(k);
      });
    })
  );
  function d(L, k) {
  ...
  function g(L) {
    n.value = !0;
    const k = i.value.replace(/["!*$+?^{}()|[\]\\]/g, "").trim();
    if (!k)
      a.value = [], l.value = [], n.value = !1;
    else if (k && k !== o.value || L) {
      const V = setInterval(() => {
        s.value.config.provinces.listFetched && s.value.config.types.typesFetched && (clearInterval(V), s.value.query(`${k}*`).then((ye) => {
          c.value = ye.failedServs, o.value = k, l.value = ye.results;
          const Qe = _i(
            t.value,
            //@ts-expect-error TODO: explain why this is needed or remove
            e.value,
  ...
  function A(L) {
    o.value = i.value.replace(/["!*$+?^{}()|[\]\\]/g, "").trim(), i.value = L, g();
  }
  function b(L) {
    const k = {
    ...
    L = L.normalize("NFD").replace(/[\u0300-\u036f]/g, "").toLowerCase(), r.value = Array.from(L).map((V) => Object.keys(k).includes(V) ? "[" + V + k[V] + "]" : V.replace(/["$!*+?^{}()|[\]\\]/g, "").replace(/[.\\]/g, "\\$&").trim()).join("");
  }
  function $(L) {
...
}), Fa = B("help", () => ({ location: f("./help/") }));
var Qi = /* @__PURE__ */ ((s) => (s.Visibility = "visibilityButton", s.Expand = "expandButton", s))(Qi || {}), Jt = /* @__PURE__ */ ((s) => (s.Item = "item", s.Placeholder = "placeholder", s.Error = "error", s))(Jt || {});
class es extends J {
  _uid;
  _name;
  _type;
  ...
  toggleVisibility(e, t = !0) {
    if (this.visibility !== e) {
      if (this._visibility = e ?? !this.visibility, !this.exclusive)
        ...
        if (this._lastVisible && (!(this._lastVisible instanceof Ge) || this._lastVisible.layerControlAvailable(j.Visibility)))
          this._lastVisible.toggleVisibility(!0);
        else {
          const i = this.children.find(
            (r) => !(r instanceof Ge) || r.layerControlAvailable(j.Visibility)
          );
   ...
   */
  checkVisibility(e) {
    this instanceof Ge && !this.layerControlAvailable(j.Visibility) || (this.exclusive ? e.visibility ? (this.children.forEach((t) => {
      t.uid !== e.uid && t.toggleVisibility(!1, !1);
    }), this._lastVisible = e, this._visibility = !0, this instanceof Ge && this.layer && this.layer.layerExists && (this.layer.visibility = !0)) : (this._visibility = !1, this instanceof Ge && this.layer && this.layer.layerExists && (this.layer.visibility = !1), this._lastVisible = e) : this.children.some((t) => t.visibility) ? (this._visibility = !0, this._visibleChildren = this.children.filter((t) => t.visibility), this instanceof Ge && this.layer && this.layer.layerExists && (this.layer.visibility = !0)) : (this._visibility = !1, this._visibleChildren = [], this instanceof Ge && this.layer && this.layer.layerExists && (this.layer.visibility = !1)), this.parent && this.parent.checkVisibility(this));
  }
  /**
...
class Ge extends es {
  ...
  constructor(e, t, i) {
    if (super(e, t, i), this._type = Jt.Placeholder, this._layerId = t.layerId, this._layerIdx = t.sublayerIndex, this._isSublayer = t.sublayerIndex !== void 0, this._layerControls = t.layerControls ?? [], this._origLayerControls = t.layerControls, this._layerDisabledControls = t.disabledLayerControls ?? [], this._origLayerDisabledControls = t.disabledLayerControls, this._layerRedrawing = !1, this._symbologyExpanded = t.symbologyExpanded || !1, t.coverIcon && (this._coverIcon = t.coverIcon), t.description && (this._description = t.description), this._symbologyRenderStyle = t.symbologyRenderStyle ?? "icons", this._customSymbology = !!t.symbologyStack, this._symbologyStack = t.symbologyStack?.map((r) => ({
      ...
      if (r && Array.isArray(r)) {
        const o = r.find((a) => a.id === this._layerId);
        if (o)
          if (this._isSublayer) {
            if (o.sublayers && Array.isArray(o.sublayers)) {
              const a = o.sublayers.find((l) => l.index === this._layerIdx);
              a && a.name && (this._name = a.name);
            }
          } else o.name && (this._name = o.name);
      }
    }
  }
  ...
  toggleVisibility(e, t = !0, i = !1) {
    if (!(!this.layerControlAvailable(j.Visibility) && !i) && (super.toggleVisibility(e, t), this.layer && this.layer.layerExists)) {
      ...
      const r = this._symbologyStack.some((o) => o.lastVisbility);
      this._symbologyStack.forEach((o) => {
        r || (o.lastVisbility = !0), o.visibility = this.visibility ? o.lastVisbility : !1;
      });
    }
  }
  /**
  ...
  // @ts-expect-error TODO: explain why this is needed or remove
  load(e) {
    const t = e instanceof ai ? e : this.$iApi.geo.layer.getLayer(this._layerId ?? this._layerUid);
    t && (this.layer = t, this._layerRedrawing = t.mapLayer && t.drawState !== ue.UP_TO_DATE, t.loadPromise().then(() => {
      this._layerInitVis = typeof this._layerInitVis < "u" ? this._visibility : t.visibility, super.load(), this.toggleVisibility(this._layerInitVis, !0, !0), t.visibility || this.setSymbologyVisibility(void 0, !1), this.handlers.push(
        this.$iApi.event.on(
          ...
          (i) => {
            i.layer.uid === this.layer.uid && this._type === Jt.Item && this.toggleVisibility(i.visibility, !0, !0);
          }
        )
      ), this.handlers.push(
        this.$iApi.event.on(
...
var Da = /* @__PURE__ */ ((s) => (s.Title = "title", s.Text = "text", s.Image = "image", s.Markdown = "markdown", s.Template = "template", s))(Da || {});
class Ti extends es {
  _infoType;
...
const Ga = B("legend", () => {
  ...
  function o(n) {
    if (n.parent === void 0)
      ...
      if (!(n.item instanceof Ti) && !(n.item instanceof Ge)) {
  ...
  function a(n) {
    const c = (u) => (u = u.filter((p) => (p === n && !p.children.length && p.onRemoved(), p !== n)), u.forEach((p) => {
      ...
      (p) => !(p instanceof Ti && !p.children.length && p.content === "")
    ), u);
    e.value = c(e.value);
  }
  function l(n) {
  ...
  const s = f({
    ...
    tileSchemas: [],
    initialBasemapId: ""
  }), e = f({}), t = f(!0), i = f(1.5), r = f("#FF0000"), o = f(1), a = f("#000000"), l = f(0.25);
  function n(c) {
...
var ie = /* @__PURE__ */ ((s) => (s[s.UPLOAD = 0] = "UPLOAD", s[s.FORMAT = 1] = "FORMAT", s[s.CONFIGURE = 2] = "CONFIGURE", s))(ie || {});
const ja = B("wizard", () => {
  const s = {
    id: "Placeholder",
    layerType: x.UNKNOWN,
    url: ""
  }, e = f(), t = f(""), i = f(""), r = f(!0), o = f(null), a = f({
    config: s,
    configOptions: []
  }), l = f(ie.UPLOAD);
  function n(c) {
    switch (l.value) {
      case ie.UPLOAD:
        c === ie.UPLOAD ? t.value = "" : c === ie.FORMAT && (l.value = ie.FORMAT);
        break;
      case ie.FORMAT:
        c === ie.UPLOAD ? (o.value && (t.value = "", o.value = null), i.value = "", l.value = ie.UPLOAD) : c === ie.CONFIGURE && (l.value = ie.CONFIGURE);
        break;
      case ie.CONFIGURE:
        c === ie.UPLOAD ? (t.value = "", i.value = "", o.value = null, r.value = !0, a.value = {
          config: s,
          configOptions: []
        }, l.value = ie.UPLOAD) : c === ie.FORMAT && (a.value = {
          config: s,
          configOptions: []
        }, r.value = !0, l.value = ie.FORMAT);
        break;
    }
  }
  return {
...
class Wa {
  ...
  _isFullscreen;
  constructor(e, t, i) {
    this.event = new js(this);
    const r = Ha(e, this);
    this.$vApp = r.app, this.$element = r.element, this.$i18n = r.i18n, this.$rootEl = r.app.$root?.$el, this.fixture = new Vn(this), this.panel = new zn(this), this.geo = new Un(this), this.dev = new Jn(this), this.ui = {
      ...
      escapeHtml: () => "",
      isPlainText: () => !0
    }, this.notify = new or(this), this._isFullscreen = Se.isEnabled && !!this.$vApp.$root && Se.isFullscreen && Se.element === this.$vApp.$root.$el, Se.isEnabled && Se.onchange(() => {
      this._isFullscreen = Se.isEnabled && !!this.$vApp.$root && Se.isFullscreen && Se.element === this.$vApp.$root.$el;
   ...
   */
  initialize(e, t, i) {
    const r = pe(this.$vApp.$pinia), o = Ye(this.$vApp.$pinia), a = Ct(this.$vApp.$pinia);
    if (t?.configs !== void 0) {
      ...
      const u = setInterval(() => {
        ...
        h && (clearInterval(u), this.geo.map.createMap(c.map, h).then(() => {
          if (h._tippy.hide(0), a.setMaptipInstance(h._tippy), c.layers && c.layers.length > 0) {
            let m = 0;
            c.layers.forEach((A) => {
              const b = this.geo.layer.createLayer(A);
              this.geo.map.addLayer(b, m).catch(() => {
              }), b.mapLayer && m++;
            });
          }
        }));
   ...
   */
  reloadWorker(e, t) {
    const i = st(this.$vApp.$pinia), r = Re(this.$vApp.$pinia), o = pe(this.$vApp.$pinia), a = ge(this.$vApp.$pinia), l = Te(this.$vApp.$pinia), n = Wt(this.$vApp.$pinia), c = !!e;
    ...
    if (!([
      ...
      switch (e) {
        ...
        case "areas-of-interest":
          return ba(this.$vApp.$pinia);
        case "details":
          return ji(this.$vApp.$pinia);
        case "export":
          return Aa(this.$vApp.$pinia);
        case "extentguard":
          return wa(this.$vApp.$pinia);
        case "geosearch":
          return Na(this.$vApp.$pinia);
        case "grid":
          return Wt(this.$vApp.$pinia);
        case "help":
          return Fa(this.$vApp.$pinia);
        case "legend":
          return Ga(this.$vApp.$pinia);
        case "mapnav":
          return Ua(this.$vApp.$pinia);
        case "metadata":
          return Ba(this.$vApp.$pinia);
        case "northarrow":
          return Va(this.$vApp.$pinia);
        case "overviewmap":
          return za(this.$vApp.$pinia);
        case "scrollguard":
          return qa(this.$vApp.$pinia);
        case "wizard":
          return ja(this.$vApp.$pinia);
        // core stores
        case "config":
  ...
  setLanguage(e) {
    if (this.$i18n.locale.value === e)
      return;
    const t = pe(this.$vApp.$pinia), i = Re(this.$vApp.$pinia), r = t.registeredLangs;
    ...
    r[o] !== r[e] && (this.reloadWorker(), this.event.emit(E.CONFIG_CHANGE, a)), this.event.emit(E.LANG_CHANGE, {
      oldLang: o,
      newLang: e
    });
  }
   ...
   */
  toggleFullscreen() {
    Se.isEnabled && Se.toggle(this.$element._container || void 0);
  }
  /**
...
function Ha(s, e) {
  ...
  t.use(({ store: a }) => {
    const l = mi(a.$state);
    a.$reset = () => a.$patch(mi(l));
  });
  const i = Ys(), r = Pi(ho).use(i).use(Ls, {
    directive: "tippy",
    // => v-tippy
    component: "tippy"
    // => <tippy/>
  }).use(t);
  r.directive("focus-container", wo), r.directive("focus-list", yo), r.directive("focus-item", vo), r.directive("truncate", Io), r.component("panel-screen", Mo), r.component("pin", Do), r.component("close", Bo), r.component("back", qo), r.component("expand", Jo), r.component("panel-options-menu", aa), r.component("dropdown-menu", ei), r.component("minimize", Xo), r.component("right", ta), r.component("left", ra), r.component("fullscreen-nav-button", ca), r.component("geolocator-nav-button", ua), r.component("home-nav-button", pa), r.component("mapnav-button", fa), r.component("appbar-button", va), r.component("transition", ki), r.component("transition-group", Mi), r.config.globalProperties.$iApi = e, r.config.globalProperties.$pinia = t, r.config.idPrefix = `ramp-${s.id || e.geo.shared.generateUUID()}`, r.provide("iApi", e);
  const o = r.mount(s);
  return { element: r, app: o, i18n: i.global };
}
class oi {
  /**
  ...
  static async create(e) {
    const t = new oi(e), i = e.layers.map((a) => {
...
class Ya extends J {
  ...
  async createMap(e, t) {
    ...
    }, r = e.basemaps.map((n) => oi.create(n)), a = (await Promise.all(r)).filter((n) => (n.createErr && i(n), n.esriBasemap.baseLayers.length > 0));
    a.forEach((n) => {
  ...
  async applyBasemap(e) {
    ...
    this.esriMap.basemap = _e(t.esriBasemap);
  }
  /**
   ...
   */
  async zoomMapTo(e, t, i = !0, r = 200, o = "ease") {
    if (this.esriView) {
      if (e.invalid())
      ...
      a.type === T.POINT && (l.scale = t || this.pointZoomScale);
      const n = { animate: i, duration: r, easing: o };
   ...
   */
  getExtent() {
    return this.esriView ? D.fromESRI(this.esriView.extent) : (this.noMapErr(), D.fromParams("i_am_error", 0, 1, 0, 1));
  }
  /**
...
class Ja extends J {
  ...
  async checkAtCoord(e) {
    ...
    if (!i.hovertips)
      return;
    const r = await i.getIcon(t.oid), o = await i.getGraphic(t.oid, {
      getAttribs: !0
    });
...
class Ka extends J {
   ...
   */
  updateScale() {
    const e = Be(this.$vApp.$pinia), t = e.scale;
    if (t?.disabled)
      return;
    const i = t?.isImperialScale || !1, r = this.scaleHelper().find((o) => o.isImperialScale === i) ?? {
      isImperialScale: !1,
      units: "error",
      pixels: 1,
      distance: 1
   ...
   */
  scaleHelper() {
    const e = window.innerWidth > 600 ? 70 : 35, t = this.$iApi.geo.map.getResolution(), i = [], r = t * e, o = 1609.34, a = 3.28084, l = r > 1e3 ? ["km", "mi"] : ["m", "ft"];
    for (let n = 0; n < 2; n++) {
      const c = n === 1;
      if (i.push({
        isImperialScale: c,
        ...
        i[n].distance = Math.ceil(c ? r * a : r), i[n].pixels = r / t;
    }
    return i;
  }
  /**
  ...
  async formatLatLongDMS(e) {
    const t = await this.$iApi.geo.proj.projectGeometry(4326, e), i = this.wrapValue(t.y, -90, 90), r = this.wrapValue(t.x, -180, 180), o = "°", a = Math.floor(Math.abs(i)) * (i < 0 ? -1 : 1), l = Math.floor(Math.abs((i - a) * 60)), n = Math.floor((Math.abs(i) - Math.abs(a) - l / 60) * 3600), c = Math.floor(Math.abs(r)) * (r < 0 ? -1 : 1), u = Math.floor(Math.abs((r - c) * 60)), p = Math.floor((Math.abs(r) - Math.abs(c) - u / 60) * 3600);
  ...
  async formatLatLongDDM(e) {
    const t = await this.$iApi.geo.proj.projectGeometry(4326, e), i = this.wrapValue(t.y, -90, 90), r = this.wrapValue(t.x, -180, 180), o = "°", a = Math.floor(Math.abs(i)) * (i < 0 ? -1 : 1), l = Math.abs((i - a) * 60), n = Math.floor(Math.abs(r)) * (r < 0 ? -1 : 1), c = Math.abs((r - n) * 60);
    return `${this.$iApi.$i18n.n(Math.abs(a), "number")}${o} ${this.$iApi.$i18n.n(l, "number", {
      minimumIntegerDigits: 2,
  ...
  async formatLatLongDD(e) {
    const t = await this.$iApi.geo.proj.projectGeometry(4326, e), i = this.wrapValue(t.y, -90, 90), r = this.wrapValue(t.x, -180, 180), o = "°", a = Math.abs(i), l = Math.abs(r);
    return `${this.$iApi.$i18n.n(a, "number", {
      ...
      minimumFractionDigits: 5,
      maximumFractionDigits: 5
    })}${o} ${this.$iApi.$i18n.t("map.coordinates." + (0 > r ? "west" : "east"))}`;
  }
  /**
   ...
   */
  async formatUTM(e) {
    const t = await this.$iApi.geo.proj.projectGeometry(4326, e), i = this.wrapValue(t.y, -90, 90), r = this.wrapValue(t.x, -180, 180), o = Math.ceil((r + 180) / 6), a = await this.$iApi.geo.proj.projectGeometry(parseInt("326" + o), e);
...
class Za extends Ya {
   ...
   */
  constructor(e) {
    super(e, "main"), this.maptip = new Ja(e), this.caption = new Ka(e), this.mapMouseThrottle = 0;
  }
  async createMap(e, t) {
  ...
  async createMapView(e) {
    ...
    const r = (typeof e == "string" ? await this.findBasemap(e) : e) || await this.findBasemap(i.initialBasemapId), o = i.tileSchemas.find(
    ...
    this._rampExtentSet = gt.fromConfig(a), this._rampSR = this._rampExtentSet.sr.clone();
    ...
    this.esriView = Q(
      ...
      n.preventDefault();
    }) : console.error("ESRI Map View is missing its container"), Ae(
      ...
      if (this._viewPromise.resolveMe(), this.created = !0, this.applyBasemap(r), o.recoveryBasemap?.basemapId) {
  ...
  async setBasemap(e) {
    ...
    const t = pe(this.$vApp.$pinia), i = await this.findBasemap(e), o = t.activeBasemapConfig.tileSchemaId !== i.tileSchemaId;
    if (o) {
      ...
      const a = await C.ColorBackground({
        color: new Ne(i.backgroundColour).toESRI()
      });
  ...
  async recoverBasemap(e) {
    ...
    const i = pe(this.$vApp.$pinia).config.map;
    if (i) {
      const r = i.tileSchemas.find((o) => o.id === e);
      if (r?.recoveryBasemap?.basemapId) {
        const o = await this.findBasemap(r.recoveryBasemap.basemapId);
  ...
  addLayer(e, t = void 0) {
    return new Promise((i, r) => {
      if (this.esriMap || (this.noMapErr(), r()), e.initiationState !== F.INITIATING && e.initiationState !== F.INITIATED && e.layerState !== q.ERROR && e.initiate(), e.mapLayer && t === void 0) {
      ...
      Te(this.$vApp.$pinia).addLayer(e, t), this.$iApi.event.emit(E.LAYER_REGISTERED, e);
      const a = Date.now();
      let l = 0;
      const n = setInterval(() => {
        l += 250, l >= e.expectedTime.fail || e.layerState === q.ERROR ? (clearInterval(n), e.lastCancel < a && console.error(`Failed to add layer: ${e.id}.`), r()) : e.initiationState === F.INITIATED && (e.esriLayer || !e.mapLayer) && (clearInterval(n), e.mapLayer ? this.insertToEsriMap(e) : e.onLoad(), i());
      }, 250);
    });
  }
  /**
  ...
  insertToEsriMap(e) {
    ...
    if (i > 0) {
      const r = this.$iApi.geo.layer.layerOrderIds(), o = this.$iApi.geo.layer.allLayers();
      for (let a = i - 1; a > -1; a--) {
        const l = r[a], n = o.find((c) => c.id === l);
        if (n && n.esriLayer) {
  ...
  reorder(e, t, i = !1) {
    ...
    if (a === t)
      return;
    if (Te(this.$vApp.$pinia).reorderLayer(e, t), e.esriLayer && this.esriMap.layers.indexOf(e.esriLayer) > -1) {
      let n = 0;
      if (t > 0) {
        o = this.$iApi.geo.layer.layerOrderIds();
        for (let c = t - 1; c > -1; c--) {
          const u = o[c], p = r.find((d) => d.id === u);
          if (p && p.esriLayer) {
  ...
  removeLayer(e) {
    ...
    let t;
    if (e instanceof ai ? t = e : t = this.$iApi.geo.layer.getLayer(e), !t)
    ...
    const i = Te(this.$vApp.$pinia);
    i.removeLayer(t), i.removeLayerConfig(t.id), t.removeEsriLayer(), t.initiationState === F.INITIATED && t.terminate(), t.isRemoved = !0, this.$iApi.event.emit(E.LAYER_REMOVE, t);
  }
  /**
  ...
  async zoomToVisibleScale(e) {
    ...
    const r = t.zoomIn ? i : [...i].reverse(), o = r.find(
  ...
  findClosestScale(e) {
    ...
    if (!t)
      return e;
    const i = t.map((o) => Math.abs(o.scale - e)), r = i.indexOf(Math.min(...i));
    return t[r].scale;
  }
  /**
  ...
  async symbolIdentify(e, t) {
    ...
    const r = (await this.esriView.hitTest({
      x: e,
      y: t
    })).results.filter((a) => a.type === "graphic").map(async (a) => {
      const l = a.layer;
      if (a.graphic.isAggregate === !0) {
        const n = await this.esriView.whenLayerView(l), c = n.createQuery();
        return c.aggregateIds = [a.graphic.getObjectId()], (await n.queryFeatures(c)).features.map((p) => ({
          layerId: l.id,
          layerIdx: 0,
          oid: p.getObjectId()
        }));
  ...
  */
  ...
  runIdentify(e) {
    ...
    t.some((c) => c.identifyMode === X.HYBRID || c.identifyMode === X.SYMBOLIC) && (r = this.symbolIdentify(i.screenX, i.screenY));
    const o = {
      geometry: i.mapPoint,
      hitTest: r
  ...
  async getGraphicAtCoord(e) {
    ...
    if (r.some((n) => {
      ...
      return c ? (c.isCosmetic || c.layerType === x.GRAPHIC || n.graphic.isAggregate || (o = c, a = n.graphic), !0) : (l.add(n.layer.id), !1);
    }), o && a)
      return {
        oid: a.getObjectId(),
        layerId: o.id,
  ...
  keyPan() {
    ...
    const e = this.getExtent().center(), t = this.mapPointToScreenPoint(e), i = this.screenPointToMapPoint({
      screenX: t.screenX + 5,
      screenY: t.screenY + 5
    }), r = Math.abs(i.x - e.x), o = Math.abs(i.y - e.y);
    let a = 0, l = 0, n = 1;
...
const Xa = { geometryType: "point", renderer: { type: "simple", symbol: { type: "esriSMS", style: "esriSMSCircle", color: [67, 100, 255, 200], size: 7, outline: { color: [0, 0, 0, 255], width: 1 } } } }, Qa = { geometryType: "polyline", renderer: { type: "simple", symbol: { type: "esriSLS", style: "esriSLSSolid", color: [90, 90, 90, 200], width: 2 } } }, en = { geometryType: "polygon", renderer: { type: "simple", symbol: { type: "esriSFS", style: "esriSFSSolid", color: [76, 76, 125, 200], outline: { type: "esriSLS", style: "esriSLSSolid", color: [110, 110, 110, 255], width: 1 } } } }, tn = { geometryType: "polygon", renderer: { type: "simple", symbol: { type: "esriSFS", style: "esriSFSSolid", color: [255, 0, 0, 64], outline: { type: "esriSLS", style: "esriSLSSolid", color: [240, 128, 128, 255], width: 1 } } } }, sn = {
  circlePoint: Xa,
  solidLine: Qa,
  outlinedPoly: en,
  boundingBoxPoly: tn
...
function an(s, e) {
  ...
  e.fields?.forEach((i) => {
    if (i.name && t(i.name)) {
      ...
      let o, a = "_", l;
      do
        o = r.replace(/ /g, a), l = e.fields?.find((n) => n.name === o), l && (a += "_");
      while (l);
      i.alias = r, i.name = o;
      for (let n = 0; n < s.features.length; n++) {
        const c = s.features[n];
        c.properties[o] = c.properties[r], delete c.properties[r];
      }
    }
  });
}
...
class cn extends J {
  ...
  extractCsvFields(e, t = ",") {
    return yi.dsvFormat(t).parseRows(e)[0].map((r) => ({ name: r, type: Oe.STRING }));
  }
  /**
  ...
  filterCsvLatLonFields(e, t = ",") {
    const i = yi.dsvFormat(t).parseRows(e), r = i[0], o = {
      lat: JSON.parse(JSON.stringify(r)),
      lon: JSON.parse(JSON.stringify(r))
    };
    for (let a = 0; a < r.length; a++)
      for (let l = 1; l < i.length; l++) {
        const n = Number(i[l][a]), c = o.lat.indexOf(r[a]), u = o.lon.indexOf(r[a]);
  ...
  async geoJsonToEsriJson(e, t) {
    ...
    on(e);
    const l = e.features[0].geometry.type, n = rn[l], c = JSON.parse(
      // @ts-expect-error TODO: explain why this is needed or remove
      JSON.stringify(sn[n])
    );
    if (t) {
      ...
      t.layerId ? o = t.layerId : o = this.$iApi.geo.shared.generateUUID(), t.colour && (c.renderer.symbol.color = new Ne(t.colour).toArcServer());
    } else
      throw new Error("geoJsonToEsriJson - missing opts arguement");
    r || (r = _.parseGeoJsonCrs(e.crs)), a.renderer = await C.RendererFromJson(c.renderer), a.fields = (a.fields || []).concat(
    ...
    const d = Ms(e, { sr: 8888 });
    a.geometryType = this.$iApi.geo.geom.geoJsonGeomTypeToEsriGeomType(l);
    const g = a.fields.map((m) => m.name);
    for (let m = 0; m < d.length; m++) {
      const A = d[m];
      A.geometry.spatialReference = p, A.geometry.type = a.geometryType, Object.keys(A.attributes).forEach((b) => {
        g.includes(b) ? (Array.isArray(A.attributes[b]) || typeof A.attributes[b] == "object") && A.attributes[b] != null && (A.attributes[b] = JSON.stringify(A.attributes[b])) : delete A.attributes[b];
      });
    }
    return (t.fieldMetadata?.fieldInfo && t.fieldMetadata?.fieldInfo.length > 0 ? t.fieldMetadata.fieldInfo.filter((m) => m.trim && g.includes(m.name)).map((m) => m.name) : []).forEach((m) => {
      for (let A = 0; A < d.length; A++) {
        ...
        typeof b[m] == "string" && (b[m] = b[m].trim());
      }
  ...
  async csvToGeoJson(e, t) {
    ...
    return t && (t.latfield && (i.latfield = t.latfield), t.lonfield && (i.lonfield = t.lonfield), t.delimiter && (i.delimiter = t.delimiter)), new Promise((r, o) => {
      Ps(e, i, (a, l) => {
   ...
   */
  fgbToGeoJson(e, t) {
    return import("flatgeobuf").then(({ geojson: r }) => new Promise((o) => {
      let a = !1, l = null;
      ...
      const u = setInterval(() => {
        if (n && a) {
          clearInterval(u);
          let p;
          l && (l.code && l.code !== 4326 && l.org === "EPSG" ? p = new _(l.code) : l.wkt ? p = new _(l.wkt) : console.error("Encountered FlatGeobuf with non-EPSG org: ", l)), p && (n.crs = p.toGeoJSON()), o(n);
        } else
   ...
   */
  inferType(e) {
    return typeof e == "number" ? Oe.DOUBLE : Oe.STRING;
  }
  /**
  ...
  async unzipSingleFile(e) {
    const t = await import("jszip"), r = await new t.default().loadAsync(e), o = Object.keys(r.files)[0];
    if (o && r.file(o))
      return await r.file(o).async("arraybuffer");
...
class pn extends J {
   ...
   */
  async loadWfsData(e, t = -1, i = 0, r = 1e3, o = {
    type: "FeatureCollection",
    features: []
  }, a = !1) {
    let l = {
    ...
    const c = new Rt(e).updateQuery(l), [u, p] = await Ee(bt.get(c));
    if (!p)
      return console.error(`WFS data failed to load for ${e}`, u), Promise.reject(u);
    const d = p.data;
    if (t === -1)
      return t = p.data.numberMatched, this.loadWfsData(e, t, i, r, o, a);
    if (o.features = o.features.concat(d.features), d.features.length < t - i) {
      ...
      return a && o.features.length > 0 && o.features[0].geometry.type === z.POINT && o.features.forEach((g) => {
...
class dn extends J {
  ...
  ogc;
  constructor(e) {
    super(e), this.files = new cn(e), this.ogc = new pn(e);
  }
  /**
   ...
   */
  getLayer(e) {
    return Te(this.$vApp.$pinia).getLayerByAny(e);
  }
  /**
   ...
   */
  getSublayer(e, t) {
    const i = Te(this.$vApp.$pinia).getLayerById(e);
  ...
  async awaitLayer(e) {
    ...
    const i = new H();
    let r = 0;
    const o = 300, a = setInterval(() => {
      r += o;
      const l = this.getLayer(e);
      if (l)
        clearInterval(a), i.resolveMe(l);
      else if (r > 8e3) {
        clearInterval(a);
        const n = setInterval(() => {
          const c = this.getLayer(e);
          c && (clearInterval(n), i.resolveMe(c));
        }, 1500);
      }
    }, o);
    return i.getPromise();
  ...
  getLayerPosition(e) {
    const t = this.getLayer(e);
    if (t && t.mapLayer) {
      const i = t.isSublayer ? t.parentLayer.id : t.id, r = this.layerOrderIds().findIndex((o) => o === i);
      return r === -1 ? void 0 : r;
    } else
      return;
  }
   ...
   */
  layerOrderIds() {
    return Te(this.$vApp.$pinia).mapOrder.slice(0) || [];
  }
  /**
   ...
   */
  allLayers() {
    return Te(this.$vApp.$pinia).layers || [];
  }
  /**
  ...
  allActiveLayers() {
    return this.allLayers().filter(
      (e) => e.layerState !== q.ERROR && e.initiationState === F.INITIATED
    );
  }
  /**
   ...
   */
  allLayersOnMap(e = !0) {
    const t = this.allLayers().filter((i) => i.mapLayer && i.initiationState === F.INITIATED);
    if (e) {
      const i = this.layerOrderIds(), r = new Map(i.map((o, a) => [o, a]));
      t.sort((o, a) => r.get(o.id) - r.get(a.id));
    }
    return t;
  }
  /**
   ...
   */
  allDataLayers() {
    return this.allLayers().filter((e) => !e.mapLayer && e.initiationState === F.INITIATED);
  }
  /**
   ...
   */
  allInitiatingLayers() {
    return this.allLayers().filter((e) => e.initiationState === F.INITIATING);
  }
  /**
  ...
  getLayerControls(e) {
    ...
    return t.supportsFeatures || r.push(j.Datatable), t.extent === void 0 && r.push(j.BoundaryZoom), (t.config?.metadata || (t.isSublayer ? t.parentLayer?.config?.metadata : {}) || {}).url || r.push(j.Metadata), !t.mapLayer && !t.config.controls?.includes(j.Settings) && r.push(j.Settings), r.forEach((a) => {
  ...
  async loadLayerMetadata(e) {
    ...
    const [t, i] = await Ee(ze(e, { query: { f: "json" } }));
    if (!i)
    ...
    if (o.name = r.name || "", o.currentVersion = r.currentVersion || -1, o.minScale = r.effectiveMinScale || r.minScale || 0, o.maxScale = r.effectiveMaxScale || r.maxScale || 0, o.extent = r.extent ? D.fromArcServer(r.extent, "layer_extent") : void 0, o.defaultVisibility = r.defaultVisibility ?? !0, o.canModifyLayer = r.canModifyLayer ?? !0, r.type === "Feature Layer" || r.type === "Table") {
      if (o.dataFormat = ee.ESRI_FEATURE, o.displayField = r.displayField || "", Array.isArray(r.fields)) {
        ...
        o.fields = a.map((n) => ({
          ...
          type: n.type,
          length: n.length
        })), a.every((n) => n.type === "oid" ? (o.objectIdField = n.name, !1) : !0) && (o.objectIdField = r.objectIdField || (console.error(`Encountered service with no OID defined: ${e}`), "")), r.type === "Feature Layer" ? (o.geometryType = this.$iApi.geo.geom.serverGeomTypeToRampGeomType(r.geometryType), r.drawingInfo?.renderer && (o.renderer = await C.RendererFromJson(r.drawingInfo.renderer)), r.sourceSpatialReference && (o.sourceSR = _.fromConfig(r.sourceSpatialReference))) : o.mapLayer = !1;
      }
    } else
      o.dataFormat = ee.ESRI_RASTER;
    return o;
  }
  /**
  ...
  async loadFeatureCount(e, t = "") {
    ...
    }, [r, o] = await Ee(ze(`${e}/query`, i));
    return o ? o.data ? Number.isInteger(o.data.count) ? o.data.count : (console.error(`Funny result (${o.data.count}) during feature count: ${e}`), 0) : (console.error(`Unable to load feature count: ${e}`), 0) : (console.error(`Feature count request unsuccessful: ${e}`, r), 0);
  }
}
class ai extends J {
  config = {};
   ...
   */
  getGraphic(e, t) {
    return Promise.resolve(new xe(new qe()));
  }
  /**
   ...
   */
  getGraphicExtent(e) {
    return Promise.resolve(D.fromParams("fake", 0, 0, 0, 0));
  }
  /**
...
class ts extends ai {
  ...
  constructor(e, t) {
    super(e, t), this.name = e.name || "", this.geomType = T.NONE, this.dataFormat = ee.UNKNOWN, this.layerType = x.UNKNOWN, this.layerFormat = me.UNKNOWN;
    ...
    this.expectedTime.draw = e.expectedDrawTime ?? i.draw, this.expectedTime.load = e.expectedLoadTime ?? i.load, this.expectedTime.fail = e.maxLoadTime || i.fail, this.lastCancel = 0, this.timers = {
      draw: void 0,
      load: void 0
    }, this.origRampConfig = e, this.id = e.id || "", this.uid = this.$iApi.geo.shared.generateUUID(), this.isCosmetic = !1, this.isSystem = e.system || !1, this.isRemoved = !1, this.isSublayer = !1, this.supportsIdentify = !1, this.mapLayer = !0, this.identifyMode = X.NONE, this.supportsFeatures = !1, this.hovertips = !1, this.supportsSublayers = !1, this.isFile = !1, this.layerState = q.NEW, this.initiationState = F.NEW, this.drawState = ue.NOT_LOADED, this.loadDefProm = new H(), this.url = this.origRampConfig.url, this.canReload = !!(this.url || this.origRampConfig.caching), this.loadPromDone = !1, this.nameArcadeFormula = "", this.tooltipArcadeFormula = "", this.layerTree = new Lt(0, this.uid, this.name, !0);
  }
  updateInitiationState(e) {
  ...
  async initiate() {
    this.updateInitiationState(F.INITIATING), this.startTimer(
      "load"
      /* LOAD */
    );
    const e = (o) => {
      this.layerState !== q.ERROR && (console.error(o), this.onError());
    }, t = Date.now(), i = setTimeout(() => {
      t > this.lastCancel && (this.lastCancel = Date.now(), e("Layer timed out during initialize. Id: " + this.id));
    }, this.expectedTime.fail), [r] = await Ee(this.onInitiate());
    clearTimeout(i), t > this.lastCancel && (this.drawState !== ue.UP_TO_DATE && this.startTimer(
      "draw"
      /* DRAW */
    ), r ? e(`Init error on layer id: ${this.id} . ${r.message}`) : this.updateInitiationState(F.INITIATED));
  }
  async onInitiate() {
    if (this.isSublayer)
      return console.warn("Attempted to initiate a sublayer as a CommonLayer"), Promise.resolve();
    this.initiationState === F.INITIATED && console.error(`Encountered layer initialize while already initiated, layer id ${this.id}`);
  }
  async terminate() {
    this.updateInitiationState(F.TERMINATING), await Promise.all(this.sublayers.map((e) => e.terminate())), this.loadDefProm = new H(), this.loadPromDone = !1, this.updateLayerState(q.NEW), this.updateDrawState(ue.NOT_LOADED), this.updateInitiationState(F.TERMINATED);
  }
  // ----------- LAYER LOAD -----------
    ...
    try {
      ...
      Promise.all(r).then(() => {
        clearTimeout(i), t ? this.visibility = !1 : (this.stopTimer(
          "load"
          /* LOAD */
        ), e > this.lastCancel && (this.loadPromDone && (this.loadDefProm = new H()), this.loadDefProm.resolveMe(), this.loadPromDone = !0, this.sublayers.forEach((o) => o.onLoad()), this.updateLayerState(q.LOADED)));
      }).catch(() => {
  ...
  onError(e = !0) {
    this.layerState !== q.ERROR && (this.initiationState === F.INITIATING && this.updateInitiationState(F.NEW), this.loadPromDone && (this.loadDefProm = new H()), this.loadDefProm.rejectMe(), this.loadPromDone = !0, this.sublayers.forEach((t) => t.onError(e)), e && this.$iApi.notify.show(
      fe.ERROR,
      this.$iApi.$i18n.t("layer.error", {
        id: this.id
      })
  ...
  cancelLoad() {
    this.isLoaded || this.initiationState === F.NEW || this.initiationState === F.TERMINATING || this.initiationState === F.TERMINATED || (this.lastCancel = Date.now(), this.esriLayer && this.esriLayer.loadStatus === "loading" && this.esriLayer.cancelLoad(), this.removeEsriLayer(), this.onError(!1));
  }
  loadPromise() {
   ...
   */
  getGraphic(e, t) {
    return this.stubError(), Promise.resolve(new xe(new qe()));
  }
  getIcon(e) {
    return this.stubError(), Promise.resolve("");
  }
   ...
   */
  getGraphicExtent(e) {
    return this.stubError(), Promise.resolve(D.fromParams("fake", 0, 0, 0, 0));
  }
  applySqlFilter(e = []) {
    this.stubError();
  }
...
class Ze extends ts {
  ...
  // ----------- LAYER CONSTRUCTION AND INITIALIZAION -----------
  constructor(e, t) {
    super(e, t), this._scaleSet = new Vi(), this._mouseTolerance = e.mouseTolerance != null ? e.mouseTolerance : 5, this._touchTolerance = e.touchTolerance != null ? e.touchTolerance : 15, this._drawOrder = [], this._serverVisibility = void 0, this.isCosmetic = e.cosmetic || !1, this.extent = e.extent ? D.fromConfig(`${this.id}_extent`, e.extent) : void 0, this.viewDefProm = new H(), this.esriWatches = [];
  }
  noLayerErr() {
    console.error(
   ...
   */
  get layerExists() {
    return this.initiationState === F.INITIATED && !!this.esriLayer;
  }
  /**
...
class ni extends Ze {
  ...
  filter;
  constructor(e, t) {
    super(e, t), this.supportsIdentify = !0, this.geomType = T.UNKNOWN, this.serviceUrl = "", this.fieldList = "", this.canModifyLayer = !0, this.filter = new zi(e.permanentFilteredQuery || "", e.initialFilteredQuery || ""), this.hovertips = e.state?.hovertips ?? !0, this.attribs = new ss();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
  ...
  async loadLayerMetadata(e = {}) {
    ...
    if (!(t < this.lastCancel))
      if (this.geomType = i.geometryType, this.attribs.quickCache = new os(this.geomType), this.scaleSet.minScale = i.minScale, this.scaleSet.maxScale = i.maxScale, this.dataFormat = i.dataFormat, this.extent = this.extent ?? i.extent, this._serverVisibility = i.defaultVisibility, this.origRampConfig.name || (this.name = i.name ?? this.id), this.dataFormat === ee.ESRI_FEATURE) {
        ...
        this.attribs.attLoader = new rs(this.$iApi, o);
      } else
  ...
  async getGraphic(e, t) {
    ...
    if (a || l) {
      ...
      l && (this.attribs.quickCache.setGeom(e, p.geometry, n), r = p.geometry), (a || typeof this.attribs.quickCache.getAttribs(e) > "u") && (this.attribs.quickCache.setAttribs(e, p.attributes), a && (i = p.attributes));
    }
    const c = new xe(r, "", t.getAttribs ? i : void 0);
    if (t.getStyle) {
      const u = _e(this.renderer.getGraphicSymbol(i));
  ...
  async getFilterOIDs(e = [], t = void 0) {
    ...
    let a = this.filter.getCache(o, r);
    if (!a) {
      const l = {
        filterGeometry: t,
        filterSql: i,
      ...
      a = this.queryOIDs(l), this.filter.setCache(a, o, r);
    }
    return a;
  }
  /**
...
class hn extends Ze {
  constructor(e, t) {
    super(e, t), this.dataFormat = ee.ESRI_FEATURE, this.layerFormat = me.GRAPHIC, this.hovertips = !1;
  }
  _graphics = [];
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
  ...
  async addGraphic(e) {
    ...
    const i = t.filter((n) => this._graphics.findIndex((u) => u.id === n.id) === -1 ? (this._graphics.push(n), !0) : (console.error(`Attempting to add graphic with id '${n.id}' that has already been added.`), !1)), r = this.$iApi.geo.map.getSR(), o = i.map((n) => this.$iApi.geo.proj.projectGeometry(r, n.geometry)), a = await Promise.all(o), l = i.map((n, c) => {
      const u = new xe(a[c], n.id, n.attributes);
  ...
  removeGraphic(e) {
    ...
    Array.isArray(e) ? t = e : t = [e], t.map((r) => typeof r == "string" ? r : r.id).forEach((r) => {
      const o = this.esriLayer.graphics.findIndex((l) => l.id === r);
      o > -1 && this.esriLayer.graphics.removeAt(o);
      const a = this._graphics.findIndex((l) => l.id === r);
...
class Xe extends ni {
  ...
  sourceGeoJson;
  constructor(e, t) {
    super(e, t), this.supportsIdentify = !0, this.isFile = !0, this.dataFormat = ee.ESRI_FEATURE, this.layerFormat = me.FEATURE, this.layerIdx = 0, e.identifyMode && e.identifyMode !== X.NONE ? this.identifyMode = e.identifyMode : this.identifyMode = X.HYBRID;
  }
  async reload() {
  ...
  runIdentify(e) {
    ...
    let r = Promise.resolve(), o = Promise.resolve(), a = [], l = [];
    if (this.identifyMode === X.HYBRID || this.identifyMode === X.GEOMETRIC) {
      const n = {
        includeGeometry: !1
      };
      this.geomType !== T.POLYGON && e.geometry.type === T.POINT ? n.filterGeometry = this.$iApi.geo.query.makeClickBuffer(e.geometry, e.tolerance) : n.filterGeometry = e.geometry, n.filterSql = this.getCombinedSqlFilter(), o = this.queryFeatures(n).then((c) => {
        a = c;
      });
    }
    return e.hitTest && (this.identifyMode === X.HYBRID || this.identifyMode === X.SYMBOLIC) && (r = o.then(async () => {
  ...
  extractLayerMetadata() {
    ...
    this.supportsFeatures = !0, this.geomType = this.$iApi.geo.geom.clientGeomTypeToRampGeomType(e.geometryType), this.scaleSet.minScale = e.minScale || 0, this.scaleSet.maxScale = e.maxScale || 0, this.extent = this.extent ?? D.fromESRI(e.fullExtent, this.id + "_extent");
  ...
  async getGraphic(e, t) {
    ...
    if (t.getStyle) {
      const r = _e(this.renderer.getGraphicSymbol(i.attributes));
...
class wn extends ni {
  constructor(e, t) {
    super(e, t), this.dataFormat = ee.ESRI_FEATURE, this.supportsIdentify = !0, this.layerType = x.FEATURE, this.layerFormat = me.FEATURE, e.identifyMode && e.identifyMode !== X.NONE ? this.identifyMode = e.identifyMode : this.identifyMode = X.HYBRID;
  }
  async onInitiate() {
  ...
  runIdentify(e) {
    ...
    let r = Promise.resolve(), o = Promise.resolve(), a = [];
    if (this.identifyMode === X.HYBRID || this.identifyMode === X.GEOMETRIC) {
      const l = {
        includeGeometry: !1,
        sourceSR: this.sourceSR
      };
      this.geomType !== T.POLYGON && e.geometry.type === T.POINT ? l.filterGeometry = this.$iApi.geo.query.makeClickBuffer(e.geometry, e.tolerance) : l.filterGeometry = e.geometry, l.filterSql = this.getCombinedSqlFilter(), o = this.queryOIDs(l).then((n) => {
        a = n;
      });
    }
    return e.hitTest && (this.identifyMode === X.HYBRID || this.identifyMode === X.SYMBOLIC) && (r = o.then(async () => {
...
class En extends Ze {
  ...
  onLoadActions() {
    ...
    this.isDynamic = this.esriLayer.capabilities.exportMap.supportsDynamicLayers, this.extent = this.extent ?? D.fromESRI(this.esriLayer.fullExtent, this.id + "_extent");
    const i = (n) => {
    ...
    const o = [], a = (n, c) => {
      ...
      if (n.sublayers && n.sublayers.length > 0) {
        ...
        this._sublayers[u] || (this._sublayers[u] = new xn(
          {
        ...
        if (d.isRemoved)
          return;
        if (d.name = p?.name || n.title || "", o.push(d), !c.children.map((g) => g.layerIdx).includes(u)) {
  ...
  runIdentify(e) {
    ...
    return e.geometry.type === T.POINT && (i = this.$iApi.geo.query.makeClickBuffer(e.geometry, e.tolerance)), t.map((r) => {
      ...
      return r.geomType !== T.POLYGON && i ? a.filterGeometry = i : a.filterGeometry = e.geometry, a.filterSql = r.getCombinedSqlFilter(), a.sourceSR = r.sourceSR, r.queryOIDs(a).then((n) => {
        n.forEach((c) => {
...
class xn extends ni {
  constructor(e, t, i) {
    if (super(e, t), this.layerType = x.SUBLAYER, this.layerFormat = me.MAPIMAGE, this.isSublayer = !0, this.layerIdx = e.index, this.parentLayer = i, this.isSystem = i.isSystem, this.dataFormat = ee.ESRI_FEATURE, this.supportsFeatures = !0, this.hovertips = !1, this.url = this.parentLayer?.url, this.canReload = !!(this.url || this.origRampConfig.caching), !i.esriLayer)
   ...
   */
  async onInitiate() {
    this.initiationState = F.INITIATED;
   ...
   */
  get layerExists() {
    return !!(this.parentLayer?.layerExists && this.esriSubLayer && this.initiationState === F.INITIATED);
  }
  /**
...
class Sn extends Ze {
  constructor(e, t) {
    super(e, t), this.supportsIdentify = !1, this.layerType = x.OSM, this.layerFormat = me.OSM, this.dataFormat = ee.OSM_TILE, this.supportsFeatures = !1;
  }
  async onInitiate() {
...
class In extends Ze {
  constructor(e, t) {
    super(e, t), this.supportsIdentify = !1, this.layerType = x.IMAGERY, this.layerFormat = me.IMAGERY, this.dataFormat = ee.ESRI_RASTER;
  }
  async onInitiate() {
...
class _n extends Ze {
  constructor(e, t) {
    super(e, t), this.supportsIdentify = !1, this.layerType = x.TILE, this.layerFormat = me.TILE, this.dataFormat = ee.ESRI_TILE;
  }
  async onInitiate() {
...
class Tn extends Ze {
  ...
  mimeType;
  constructor(e, t) {
    super(e, t), this.supportsIdentify = !0, this.layerType = x.WMS, this.layerFormat = me.WMS, this.mimeType = e.featureInfoMimeType || "", this.sublayerNames = [], this.dataFormat = ee.OGC_RASTER, this.identifyMode = X.GEOMETRIC;
  }
  async onInitiate() {
  ...
  makeEsriLayerConfig(e) {
    ...
    const r = i.map((o) => o.currentStyle).join();
  ...
  onLoadActions() {
    ...
    const t = (i) => {
      let r = !1;
      return i.forEach((o) => {
        this.sublayerNames.indexOf(o.name) > -1 || o.sublayers && o.sublayers.length > 0 && t(o.sublayers) ? r = !0 : o.visible = !1;
      }), r;
    };
  ...
  runIdentify(e) {
    ...
    return this.getFeatureInfo(this.sublayerNames, e.geometry, this.mimeType).then((r) => {
      if (r) {
        let o = !0, a;
        typeof r != "string" ? a = nt.JSON : r.indexOf("Search returned no results") === -1 && r !== "" ? a = nt.TEXT : (o = !1, a = nt.UNKNOWN), o && i.items.push(vt.makeRawItem(a, r));
      }
      i.loaded = !0, t.resolveMe();
    }).catch(() => {
      i.errored = !0, t.resolveMe();
  ...
  getFeatureInfo(e, t, i) {
    const r = this.$iApi.geo.map, o = this.esriLayer;
    if (!r.esriView)
    ...
    let a, l;
    const n = r.getExtent(), c = o.spatialReferences, u = e.join(","), p = r.esriView.toScreen(t.toESRI()), d = Math.floor(p.x), g = Math.floor(p.y), m = {
      "application/json": "json",
      "text/html": "text",
      "text/plain": "text"
    }[i] || "text", A = r.getSR();
    A.wkid ? a = A.wkid : (a = 4326, console.error("Map is likely in a WKT projection. WMS Identify request will likely fail.")), c && c.length > 1 ? c.indexOf(a) === -1 && (A.latestWkid && c.indexOf(A.latestWkid) > -1 ? a = A.latestWkid : console.error(
    ...
    }, this.$iApi.geo.layer.ogc.reversedAxisWKIDs().indexOf(a) > -1 && (l.BBOX = `${n.ymin},${n.xmin},${n.ymax},${n.xmax}`)) : l = { SRS: "EPSG:" + a, X: d, Y: g }, Object.prototype.hasOwnProperty.call(l, "BBOX") || (l.BBOX = `${n.xmin},${n.ymin},${n.xmax},${n.ymax}`);
    const b = {
      SERVICE: "WMS",
    ...
    }), Object.keys(b).forEach((L) => l[L] = b[L]), ze(o.url.split("?")[0], {
      query: l,
      responseType: m
    });
  }
  ...
  getLegendUrls(e) {
    ...
    this.esriLayer.allSublayers.forEach((r) => {
      r.visible && (r.legendUrl && this.origRampConfig.sublayers?.forEach((o) => {
        if (o.id && o.currentStyle && o.id === r.name) {
          const a = new Rt(r.legendUrl);
          "STYLE" in a.queryMap && a.queryMap.STYLE !== o.currentStyle && (r.legendUrl = a.updateQuery({
    ...
    const i = e.map(
      (r) => r.styleLegends && r.currentStyle ? r.styleLegends.find((o) => o.name === r.currentStyle).url : void 0
    );
...
class Ln extends Xe {
  ...
  async onInitiate() {
    const e = Date.now(), t = new Rt(this.config.url), { offset: i, limit: r } = t.queryMap, o = await this.$iApi.geo.layer.ogc.loadWfsData(
      this.config.url,
      -1,
      parseInt(i) || 0,
      parseInt(r) || 1e3,
...
class is extends ts {
  ...
  // ----------- LAYER CONSTRUCTION AND INITIALIZAION -----------
  constructor(e, t) {
    super(e, t), this.dataFormat = ee.ESRI_FEATURE, this.layerFormat = me.NOLAYER, this.drawState = ue.NOT_VISUAL, this.attribs = new ss(), this.supportsFeatures = !0, this.mapLayer = !1, this.isFile = !1, this._visibility = e.state?.visibility ?? !0, this.expectedTime.draw = 0;
  }
  async onInitiate() {
    if (this.sourceJson) {
      ...
      this.fields = t.map((c, u) => {
        ...
        return {
          ...
          alias: p,
          type: g,
          length: g === Oe.STRING ? 256 : void 0
        };
      }), this.oidField = "rampOID", this.fields.push({ name: this.oidField, type: Oe.OID }), e.fields.push(this.oidField), e.data.forEach((c, u) => c.push(u + 1)), this.$iApi.geo.attributes.applyFieldMetadata(this, this.origRampConfig.fieldMetadata), this.fieldList = "*";
      const o = {
        batchSize: -1,
      ...
      this.attribs.attLoader = new Mn(this.$iApi, o), await this.attribs.attLoader.getAttribs(), this.featureCount = e.data.length;
      const a = this.origRampConfig.nameField, n = {
...
class $n extends is {
  ...
  serviceUrl;
  constructor(e, t) {
    super(e, t), this.layerType = x.DATATABLE, this.serviceUrl = e.url, this.filter = new zi(e.permanentFilteredQuery || "", e.initialFilteredQuery || "");
  }
  async onInitiate() {
  }
  onLoadActions() {
    const e = super.onLoadActions(), t = Date.now(), r = this.$iApi.geo.shared.parseUrlIndex(this.serviceUrl).index || 0, o = this.$iApi.geo.layer.loadLayerMetadata(this.serviceUrl).then((l) => {
      if (t < this.lastCancel)
        return;
      ...
      this.attribs.attLoader = new rs(this.$iApi, n), this.attribs.quickCache = new os(this.geomType);
    ...
    return this.layerTree.layerIdx = r, e.push(o, a), e;
  }
  async getGraphic(e) {
    let t = {};
  ...
  async getFilterOIDs(e = []) {
    ...
    if (!r) {
      ...
      r = this.queryOIDs(o), this.filter.setCache(r, i, !1);
    }
    return r;
  }
  /**
...
class On extends J {
  ...
  async loadGraphicsAttributes(e, t) {
    ...
    const r = {
      features: e.sourceGraphics.map((o) => _e(o).attributes).toArray(),
      oidIndex: {}
    };
  ...
  async loadCompactJsonAttributes(e, t) {
    ...
    const i = e.sourceDataJson.fields, r = e.fieldsToTrim ?? [], a = {
  ...
  async loadSingleFeature(e) {
    ...
    if (o.length > 0) {
      ...
      if (e.includeGeometry) {
        ...
        const n = ws(l.geometry);
        a = this.$iApi.geo.geom.geomEsriToRamp(n);
      } else
        a = new qe();
      return new xe(a, "", l.attributes);
    }
   ...
   */
  orderFields(e, t) {
    const i = (o, a) => o.findIndex((l) => l.name === a), r = (o, a) => {
  ...
  applyFieldMetadata(e, t = void 0) {
    ...
    if (e.fields.forEach((r) => {
      ...
      const r = t.fieldInfo;
      e.fields = e.fields.filter((o) => r.find((a) => a.name === o.name));
    } else
      e.fieldList = "*";
    t.fieldInfo.forEach((r) => {
      if (r.alias) {
        const o = e.fields.find((a) => a.name === r.name);
        o && (o.alias = r.alias);
      }
    });
  }
...
class li extends J {
  ...
  constructor(e, t) {
    super(e), this.aac = new Li(), this.details = t;
  }
  /**
  ...
  getAttribs() {
    return this.loadPromise || (this.aac = new Li(), this.loadPromise = this.loadPromiseGenerator()), this.loadPromise;
  }
  abortAttribLoad() {
...
class ci {
  ...
  cleanFieldName(e, t) {
      ...
      return e;
    {
      ...
      return i = t.find((o) => o.name.toLowerCase() === r), i ? i.name : e;
    }
  }
  makeElseClause() {
...
class Fn extends ci {
  valField;
  constructor(e, t, i = !1) {
    if (super(e, t, i), this.valField = this.cleanFieldName(e.field, t), e.classBreakInfos.forEach((r, o) => {
      const a = o === 0, l = new $i(this, r.minValue, r.maxValue, a);
      l.label = r.label || "", l.symbol = r.symbol, this.falseRenderer || (l.definitionClause = `(${this.valField} >${a ? "=" : ""}  ${r.minValue} AND ${this.valField} <= ${r.maxValue})`), this.symbolUnits.push(l);
    }), e.defaultSymbol) {
      const r = new $i(this, 0, 0, !1);
...
class Dn extends J {
  ...
  async renderSymbologyIcon(e, t = null) {
    if (t === null) {
      ...
      o.setAttribute("style", "opacity:0;position:fixed;left:100%;top:100%;overflow:hidden"), document.body.appendChild(o), t = tt(o).size(this.CONTAINER_SIZE, this.CONTAINER_SIZE).viewbox(0, 0, this.CONTAINER_SIZE, this.CONTAINER_SIZE);
    }
  ...
  async symbolToSvg(e) {
    ...
    const o = tt(r).size(this.CONTAINER_SIZE, this.CONTAINER_SIZE).viewbox(0, 0, this.CONTAINER_SIZE, this.CONTAINER_SIZE), a = {
      // @ts-expect-error TODO: explain why this is needed or remove
      path({ size: h, path: m }) {
        return o.path(m).size(h * i);
      },
      // @ts-expect-error TODO: explain why this is needed or remove
      circle({ size: h }) {
        return o.circle(h * i);
      ...
      // @ts-expect-error TODO: explain why this is needed or remove
      cross({ size: h }) {
        return o.path("M 0,10 L 20,10 M 10,0 L 10,20").size(h * i);
      },
      // @ts-expect-error TODO: explain why this is needed or remove
      x({ size: h }) {
        return o.path("M 0,0 L 20,20 M 20,0 L 0,20").size(h * i);
      },
      // @ts-expect-error TODO: explain why this is needed or remove
      triangle({ size: h }) {
        return o.path("M 20,20 L 10,0 0,20 Z").size(h * i);
      },
      // @ts-expect-error TODO: explain why this is needed or remove
      diamond({ size: h }) {
        return o.path("M 20,10 L 10,0 0,10 10,20 Z").size(h * i);
      },
      // @ts-expect-error TODO: explain why this is needed or remove
      square({ size: h }) {
        return o.path("M 0,0 20,0 20,20 0,20 Z").size(h * i);
      }
    }, l = {
      [ce.SOLID]: "none",
      // esriSLSSolid
      ...
      none: () => "transparent",
      // esriSFSNull
      horizontal: (h, m) => o.pattern(5, 5, (b) => b.line(0, 5 / 2, 5, 5 / 2)).stroke(m),
      vertical: (h, m) => o.pattern(5, 5, (b) => b.line(5 / 2, 0, 5 / 2, 5)).stroke(m),
      "forward-diagonal": (h, m) => o.pattern(5, 5, (b) => {
        b.line(0, 0, 5, 5).stroke(m), b.line(0, 0, 5, 5).move(0, 5).stroke(m), b.line(0, 0, 5, 5).move(5, 0).stroke(m);
      }),
      "backward-diagonal": (h, m) => o.pattern(5, 5, (b) => {
        b.line(5, 0, 0, 5).stroke(m), b.line(5, 0, 0, 5).move(5 / 2, 5 / 2).stroke(m), b.line(5, 0, 0, 5).move(-5 / 2, -5 / 2).stroke(m);
      }),
      cross: (h, m) => o.pattern(5, 5, (b) => {
        b.line(5 / 2, 0, 5 / 2, 5).stroke(m), b.line(0, 5 / 2, 5, 5 / 2).stroke(m);
      }),
      "diagonal-cross": (h, m) => o.pattern(7, 7, (b) => {
        b.line(0, 0, 7, 7).stroke(m), b.line(7, 0, 0, 7).stroke(m);
      })
    }, p = {
      "simple-marker"() {
        const h = g(e.color);
      ...
      "simple-fill"() {
        ...
        o.rect(t.CONTENT_SIZE, t.CONTENT_SIZE).center(t.CONTAINER_CENTER, t.CONTAINER_CENTER).fill(A).stroke($);
      },
      text() {
      ...
      "picture-fill"() {
        ...
        return t.$iApi.geo.shared.convertImagetoDataURL(h).then((k) => {
          const V = o.pattern(
            m,
            A,
            (ye) => (
          ...
          o.rect(t.CONTENT_SIZE, t.CONTENT_SIZE).center(t.CONTAINER_CENTER, t.CONTAINER_CENTER).fill(V).stroke($);
        });
      },
      "picture-marker"() {
        const h = e.source, m = h && h.imageData ? `data:${h.contentType};base64,${h.imageData}` : e.url;
        return t.$iApi.geo.shared.convertImagetoDataURL(m).then((b) => t.svgDrawImage(o, b)).then(({ image: b }) => {
          b.center(t.CONTAINER_CENTER, t.CONTAINER_CENTER).rotate(e.angle || 0), t.fitInto(b, t.CONTENT_IMAGE_SIZE);
        });
      }
    };
    try {
      return await Promise.resolve(p[e.type]()), document.body.removeChild(r), o.svg();
    } catch (h) {
   ...
   */
  async svgDrawImage(e, t, i = 0, r = 0, o = !0) {
    return new Promise((a, l) => {
      const n = e.image(t, i, r, o).loaded((c) => a({ image: n, loader: c })).error((c) => {
        l(c), console.error(c);
      });
    });
  }
  ...
  rendererToLegend(e) {
    ...
    if (e.defaultUnit && i.push(e.defaultUnit), e.falseRenderer)
      ...
      i.forEach((o) => {
        const a = r.get(o.label);
        a ? a.push(o) : r.set(o.label, [o]);
      }), t = [], r.forEach((o) => t.push(o));
    }
    return t.map((r) => {
      const o = r[0], a = {
        uid: this.$iApi.geo.shared.generateUUID(),
        label: o.label || "",
        definitionClause: r.length === 1 ? o.definitionClause : `(${r.map((l) => l.definitionClause).join(" OR ")})`,
        svgcode: "",
  ...
  async getMapServerLegend(e) {
    ...
    const t = {
      query: { f: "json" }
    }, i = { layers: [] }, [r, o] = await Ee(ze(`${e}/legend`, t));
    return o ? o.data ? o.data : (console.error(`Error loading legend data for ${e}`), i) : (console.error(`Error loading legend for ${e}`, r), i);
  }
  /**
  ...
  async mapServerLegendToRenderer(e, t) {
    ...
    if (typeof i < "u") {
      ...
      const o = await C.RendererFromJson(r);
  ...
  async mapServerToLocalLegend(e, t = void 0) {
    ...
    let r, o;
    return typeof t > "u" ? (o = 0, r = await this.mapServerLegendToRendererAll(i)) : (o = parseInt(t), r = await this.mapServerLegendToRenderer(i, o)), this.rendererToLegend(r);
  }
}
class Gn extends J {
  constructor(e) {
  ...
  async geoJsonQuery(e) {
    ...
    return (await e.layer.esriLayer.queryFeatures(t)).features.map((r, o) => {
      let a;
      return t.returnGeometry ? a = this.$iApi.geo.geom.geomEsriToRamp(r.geometry, `queryResult${o}`) : a = new qe(), new xe(a, "", r.attributes);
    });
  }
  /**
  ...
  makeClickBuffer(e, t = 5) {
    const i = this.$iApi.geo.map, r = i.getExtent(), o = t * (r.xmax - r.xmin) / i.getPixelWidth();
    return new D(
      "ze_buffer",
      [e.x - o, e.y - o],
      [e.x + o, e.y + o],
...
class Un extends J {
   ...
   */
  constructor(e) {
    super(e), this.geom = ut.geom, this.proj = ut.proj, this.shared = ut.sharedUtils, this.map = new Za(e), this.layer = new dn(e), this.attributes = new On(e), this.query = new Gn(e), this.symbology = new Dn(e), Array.isArray(ft.request.interceptors) || (ft.request.interceptors = []), ft.request.interceptors.push({
      before: (t) => {
...
const Bn = /* @__PURE__ */ Object.assign({ "../fixtures/appbar/index.ts": () => import("./index-CY7dUzXh.js"), "../fixtures/areas-of-interest/index.ts": () => import("./index-lM0J7GYB.js"), "../fixtures/basemap/index.ts": () => import("./index-6o5q7Qrb.js"), "../fixtures/crosshairs/index.ts": () => import("./index-CKtKMORS.js"), "../fixtures/details/index.ts": () => import("./index-B4pFSmzJ.js"), "../fixtures/export-footnote/index.ts": () => import("./index-BbbcEOk3.js"), "../fixtures/export-legend/index.ts": () => import("./index-DrOjKAUZ.js"), "../fixtures/export-map/index.ts": () => import("./index-Jo-9o9sG.js"), "../fixtures/export-northarrow/index.ts": () => import("./index-Dt3y6gM2.js"), "../fixtures/export-scalebar/index.ts": () => import("./index-Dl1zbOx4.js"), "../fixtures/export-timestamp/index.ts": () => import("./index-BNBdtrs6.js"), "../fixtures/export-title/index.ts": () => import("./index-BZC1PMFZ.js"), "../fixtures/export/index.ts": () => import("./index-DTxhW0ue.js"), "../fixtures/extentguard/index.ts": () => import("./index-CfuDwzDY.js"), "../fixtures/gazebo/index.ts": () => import("./index-BwILv9hT.js"), "../fixtures/geosearch/index.ts": () => import("./index-C0jZvmgp.js"), "../fixtures/grid/index.ts": () => import("./index-Bt8hisTM.js"), "../fixtures/help/index.ts": () => import("./index-BC27qVwD.js"), "../fixtures/hilight/index.ts": () => import("./index-CLc2GKh8.js"), "../fixtures/layer-reorder/index.ts": () => import("./index-Dxg1mdyD.js"), "../fixtures/legend/index.ts": () => import("./index-DRN08mJP.js"), "../fixtures/mapnav/index.ts": () => import("./index-C3X_3OxW.js"), "../fixtures/metadata/index.ts": () => import("./index-DAHYe1Ia.js"), "../fixtures/northarrow/index.ts": () => import("./index-BEvltuHE.js"), "../fixtures/overviewmap/index.ts": () => import("./index-CzvUjktg.js"), "../fixtures/panguard/index.ts": () => import("./index-EcJVlyRe.js"), "../fixtures/scrollguard/index.ts": () => import("./index-Tn1abI-z.js"), "../fixtures/settings/index.ts": () => import("./index-CgWrZeWG.js"), "../fixtures/snowman/index.ts": () => import("./index-BsWRD708.js"), "../fixtures/wizard/index.ts": () => import("./index-DhlpuXH0.js") });
class Vn extends J {
  /**
  ...
  async add(e, t) {
    ...
    if (t) {
      ...
      i = ui.updateBaseToInstance(new t(), e, this.$iApi);
    } else {
      const r = (await Bn[`../fixtures/${e}/index.ts`]()).default;
      i = new r(e, this.$iApi);
    }
  ...
  get(e) {
    ...
    const i = t.map((r) => {
      const o = ge(this.$vApp.$pinia).items[r];
      if (o)
        return o;
    });
...
class ui extends J {
   ...
   * @memberof FixtureInstance
   */
  mount(e, { props: t, children: i, element: r, app: o } = {}) {
    let a = r, l = ys(e, t, i);
    return o && o._context && (l.appContext = o._context), a ? Ut(l, a) : (a = document.createElement("div"), Ut(l, a)), { vNode: l, destroy: () => {
      a && Ut(null, a), a = null, l = null;
    }, el: a };
  }
  /**
  ...
  getLayerFixtureConfigs() {
    const e = {}, t = (i, r = void 0) => {
      if (i.fixtures && i.fixtures[this.id] !== void 0) {
        let o = i.id;
        r !== void 0 && (o = this.$iApi.geo.layer.sublayerId(r.id, i.index)), e[o] = i.fixtures[this.id];
      }
  ...
  handlePanelTeleports(e) {
    if (this.config?.panelTeleport) {
      const t = Ye(this.$vApp.$pinia), i = !!this.config.panelTeleport.target;
      e.forEach((r) => {
...
class zn extends J {
   ...
   */
  updateHTML(e, t, i) {
    const r = this.get(e), o = i ? r.screens[i] : Object.values(r.screens)[0];
    if (qi(o))
      for (const a in t)
  ...
  register(e, t) {
    ...
    const r = Object.entries(i).reduce((o, [a, l]) => (o.push(new St(this.$iApi, a, l)), o), []);
    return r.forEach((o) => this.panelStore.registerPanel(o)), r.length === 1 ? r[0] : r.reduce((o, a) => (o[a.id] = a, o), {});
  }
  /**
  ...
  show(e, t) {
    ...
    if (i.screens[t.screen]) {
      if (i.screens[t.screen]?.props) {
        const r = Object.keys(i.screens[t.screen]?.props).filter((a) => a !== "panel"), o = t.props ? Object.keys(t.props) : [];
        for (let a = 0; a < r.length; a++)
          if (!o.includes(r[a]) && i.screens[t.screen].props[r[a]].required)
            return;
      }
...
const Hn = /* @__PURE__ */ Fe(jn, [["render", Wn], ["__scopeId", "data-v-a3c61802"]]), Yn = /* @__PURE__ */ Object.assign({ "../fixtures/areas-of-interest/screen.vue": () => import("./screen-kUbk2S3d.js"), "../fixtures/basemap/screen.vue": () => import("./screen-C9gKdXRx.js"), "../fixtures/export/screen.vue": () => import("./screen-B1sNeFfJ.js"), "../fixtures/geosearch/screen.vue": () => import("./screen-pQiNkyEm.js"), "../fixtures/grid/screen.vue": () => import("./screen-FY2-cSkb.js"), "../fixtures/help/screen.vue": () => import("./screen-Dei0vtYC.js"), "../fixtures/layer-reorder/screen.vue": () => import("./screen-BfeFptUT.js"), "../fixtures/legend/screen.vue": () => import("./screen-BURHPQW5.js"), "../fixtures/metadata/screen.vue": () => import("./screen-BHOgGUT4.js"), "../fixtures/settings/screen.vue": () => import("./screen-CVoyHGhB.js"), "../fixtures/wizard/screen.vue": () => import("./screen-CNewEKc5.js") });
class St extends J {
  /**
   * ID of this panel.
   *
  ...
  registerScreen(e) {
    ...
    if (Vs(t) || Bs(t))
      ...
      let r;
      typeof t == "string" ? r = Yn[`../fixtures/${t}`]() : r = t();
      const o = new Promise((a, l) => {
        r.then((n) => {
          this.loadedScreens.push(e), a(zs(n) ? n.default : n);
        }), r.catch((n) => l(n));
      });
      i = gs({
...
function Zn(s) {
  ...
  return Qn(s.services, e), Xn(s.map, e), el(s.ui, e), s.plugins && tl(s.plugins, e), e;
}
function Xn(s, e) {
  if (s.layers && s.layers.forEach((t) => {
    e.layers.unshift(as(t));
  ...
  s.extentSets && (e.map.extentSets = [], s.extentSets.forEach((t) => {
    ...
    if (t.type === "esri-map-image" || t.type === "ogc-wms") {
      ...
      t.sublayers.forEach((r) => {
        ...
        r.name && (o.name = r.name), r.controls && (o.controls = r.controls), r.disabledControls && (o.disabledControls = r.disabledControls), t.type === "esri-map-image" ? o.sublayerIndex = r.index : (o.sublayerId = r.id, console.warn(
  ...
  return s.controls && s.controls.length > 0 && (e.controls = pt(s.controls, t), s.controls.includes("visibility") && e.controls.push("visibilityButton"), (s.controls.length !== 1 || s.controls[0] !== "visibility") && console.warn(
    ...
    if (i.layerId)
      ...
      typeof i.collapse < "u" && console.warn(
        ...
        o.layerId ? r.children.push(Ci(o)) : r.children.push(Kt(o));
      }), e.children.push(r);
    } else
      e.children.push(Kt(i));
  }), e;
}
function Ci(s) {
  const e = s, t = [
...
function qt(s) {
  ...
  )), typeof s.stateOnly < "u" && (e.cosmetic = s.stateOnly), s.initialFilteredQuery && (e.initialFilteredQuery = s.initialFilteredQuery), il(s, e), (typeof s.toggleSymbology < "u" || s.table) && (e.fixtures = {}, typeof s.toggleSymbology < "u" && (e.fixtures.legend = {
...
function el(s, e) {
  if (s.navBar) {
    ...
    s.navBar.extra.forEach((o) => {
      const a = o.toLowerCase();
      r.includes(a) ? e.fixtures.mapnav.items.push(a) : console.warn(`Ignored invalid mapnav item: ${o}`);
...
function il(s, e) {
  ...
  s.fieldMetadata ? (i.fieldInfo = s.fieldMetadata.map((r) => {
    ...
    return r.alias && (o.alias = r.alias), o;
  }), t && (s.outfields.split(",").map((o) => o.trim()).forEach((o) => {
...
var rt = { major: "4", minor: "12", patch: "0-beta", timestamp: "Thu May 22 16:15:27 2025 -0400", hash: "02e25717ba4b132ada374ca7e3c2a263786a345b" };
console.info(
...
const Vl = (s, e, t) => new Wa(s, e, t), ut = new Us();
export {
  H as $,
  Pr as A,
  yt as B,
