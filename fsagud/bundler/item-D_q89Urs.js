import { defineComponent as Q, ref as H, onMounted as ye, resolveDirective as q, openBlock as l, createElementBlock as o, withModifiers as k, withDirectives as x, createElementVNode as a, unref as t, withKeys as ce, normalizeClass as C, inject as ue, computed as R, toRaw as S, resolveComponent as ve, createBlock as $, withCtx as ge, createTextVNode as Z, toDisplayString as w, Fragment as ae, renderList as ie, normalizeStyle as ke, createCommentVNode as u, useTemplateRef as xe, watch as we, createStaticVNode as me, resolveDynamicComponent as Ce } from "vue";
import { p as Me, o as y, Y as Se, a as be, a0 as b, G as Y, _ as se, O as Te, n as ze, a2 as I, a3 as G, S as Ee, a4 as F, a5 as ne } from "./main-BGgyvEBU.js";
import "pinia";
...
const Ae = ["type", "aria-label", "checked", "disabled", "content"], oe = /* @__PURE__ */ Q({
  __name: "checkbox",
  props: {
    value: {
      type: Object,
...
}), Be = ["aria-label"], $e = ["aria-label"], Ze = ["aria-label"], Ge = ["aria-label"], Re = ["aria-label"], Ue = ["aria-label"], Oe = ["content", "aria-label"], Pe = /* @__PURE__ */ Q({
  ...
  emits: ["focusItem"],
  setup(e, { emit: T }) {
    const { t: i } = re(), c = ue("iApi"), f = H(), A = H(!1), s = be(), L = H(s.mobileView), E = T, U = H(0), v = e, J = () => {
      v.legendItem.layerControlAvailable(b.Symbology) && v.legendItem.toggleSymbology();
    }, B = () => {
      v.legendItem.layerControlAvailable(b.Datatable) && M("grid") && c.event.emit(Y.GRID_TOGGLE, v.legendItem.layer);
    }, N = () => {
      v.legendItem.layerControlAvailable(b.Settings) && M("settings") && c.event.emit(Y.SETTINGS_TOGGLE, v.legendItem.layer);
    }, P = () => {
      if (v.legendItem.layerControlAvailable(b.Metadata) && M("metadata")) {
        ...
        if (m.url) {
          const O = m.url.split("."), V = O[O.length - 1], te = V === "xml" || V === "md" ? V : "html";
          c.event.emit(Y.METADATA_TOGGLE, {
            type: te,
            layerName: g,
            url: m.url,
            catalogueUrl: j,
      ...
      D.value && S(v.legendItem.layer).reload().then(() => {
        U.value += 1, m.pointerType !== "mouse" && E("focusItem");
      });
    }, D = R(() => v.legendItem.layerControlAvailable(b.Reload) && v.legendItem instanceof y && S(v.legendItem.layer)?.canReload), ee = (m) => {
    ...
    return (m, g) => {
      const j = ve("dropdown-menu"), O = q("tippy");
      return l(), o("div", {
        onClick: g[3] || (g[3] = k(() => {
        }, ["stop"])),
        ...
        (l(), $(j, {
          ...
          default: ge(() => [
            ...
            x((l(), o("a", {
              ...
              content: D.value ? "" : t(i)("legend.layer.controls.reloadDisabled"),
...
}), De = /* @__PURE__ */ se(Pe, [["__scopeId", "data-v-2ade21d9"]]), je = { key: 0 }, Fe = {
  key: 0,
  class: "relative left-3"
}, qe = ["innerHTML"], Ne = ["src"], Ke = {
  key: 1,
  class: "symbologyIcon w-32 h-32"
}, We = ["innerHTML"], Ye = ["src"], Qe = {
  key: 1,
  ...
  setup(e) {
    ...
    return ye(() => {
    ...
    }), (c, f) => e.visible ? (l(), o("div", Qe, f[0] || (f[0] = [
      a("svg", {
      ...
      i.value.length > 1 ? (l(), o("div", Fe, [
        (l(!0), o(ae, null, ie(i.value.slice(0, 3).reverse(), (A, s) => (l(), o("div", {
  ...
  key: 1,
  class: "symbologyIcon"
}, Rt = ["innerHTML"], Ut = { class: "flex-1 ml-15" }, Ot = { key: 1 }, Pt = { class: "flex p-5 ml-48" }, Dt = {
  key: 0,
  ...
  setup(e) {
    const T = Te(), i = be(), { t: c } = re(), f = ue("iApi"), A = H(), s = e, L = ze(), E = L.multilineItems, U = (s.legendItem instanceof y && s.legendItem.maxLines) ?? L.maxLines, v = H(i.mobileView), J = R(() => T.layerConfigs), B = H([]), N = H(!1), P = H(!1), K = xe("legendFocusItem"), X = R(() => s.legendItem instanceof y ? S(s.legendItem.layer)?.layerType : ""), _ = R(() => s.legendItem instanceof y && S(s.legendItem.layer)?.canModifyLayer), D = R(() => {
    ...
    s.legendItem instanceof y && S(s.legendItem.layer)?.sublayers.length > 0), m = (r) => r === G.Expand || r === G.Visibility ? s.legendItem.controlAvailable(r) : s.legendItem.layerControlAvailable(r), g = (r) => He(r), j = () => {
      ...
      m(b.Datatable) && W() && f.event.emit(Y.GRID_TOGGLE, s.legendItem.layer);
    }, te = (r) => {
    ...
    return s.legendItem instanceof y && (de(), we(
      ...
      return e.legendItem.hidden ? u("", !0) : (l(), o("div", {
        ...
        a("div", _e, [
          x((l(), o("div", {
            ...
            onMouseout: n[11] || (n[11] = (d) => (
              //@ts-expect-error TODO: explain why this is needed or remove
              (v.value || d.currentTarget?._tippy?.hide(), P.value = !1)
            )),
            onClick: n[12] || (n[12] = () => {
            ...
            e.legendItem.type === t(I).Error && D.value ? (l(), o("div", ut, [
              x((l(), o("button", {
                type: "button",
            ...
            (e.legendItem.type === t(I).Item || e.legendItem.type === t(I).Placeholder && t(E)) && e.legendItem instanceof t(y) ? (l(), $(De, {
              key: 7,
              class: C({
            ...
            ])) : e.legendItem.type === t(I).Item && m(t(G).Visibility) ? (l(), $(oe, {
              key: 12,
        ...
        e.legendItem instanceof t(y) && e.legendItem.symbologyExpanded ? x((l(), o("div", Mt, [
          B.value.length > 0 ? (l(), o("div", St, [
            e.legendItem instanceof t(y) && e.legendItem.description ? (l(), o("p", Tt, w(e.legendItem.description), 1)) : u("", !0),
            (l(!0), o(ae, null, ie(B.value, (d) => (l(), o("div", {
              class: "m-5",
              key: d.uid
            }, [
              d.imgUrl && e.legendItem.symbologyRenderStyle === "images" || !d.imgUrl && X.value === "ogc-wms" ? (l(), o("div", zt, [
                d.imgUrl ? (l(), o("div", Et, [
                  a("img", {
                    class: "max-w-full",
                    src: d.imgUrl
                ...
                d.label ? x((l(), o("div", At, [
                  a("span", null, w(d.label), 1),
                  !d.imgUrl && B.value.length > 1 || d.imgUrl && d.definitionClause ? (l(), $(oe, {
                    key: 0,
                    class: "float-right",
                    value: d,
                    legendItem: e.legendItem,
                ...
                _.value && e.legendItem.layer.supportsFeatures && (!d.imgUrl && B.value.length > 1 || d.imgUrl && d.definitionClause) ? (l(), $(oe, {
                  key: 2,
                  value: d,
                  legendItem: e.legendItem,
                  checked: d.visibility,
          ...
          N.value ? u("", !0) : (l(), o("div", Ot, [
            x((l(), o("div", Pt, [
              ee.value ? (l(), o("div", Dt)) : u("", !0),
              x((l(), o("div", jt, [
        ...
        e.legendItem.expanded ? (l(), o("div", Ft, [
          (l(!0), o(ae, null, ie(e.legendItem.children, (d) => (l(), $(h, {
            legendItem: d,
            key: d.uid,
