...
import { defineStore as z, createPinia as as } from "pinia";
import { ref as f, computed as N, markRaw as X, defineComponent as k, inject as ve, reactive as we, watch as xt, onBeforeUnmount as dt, resolveDirective as M, withDirectives as P, openBlock as v, createElementBlock as w, withKeys as ns, withModifiers as Xt, onMounted as Je, normalizeClass as oe, normalizeStyle as Ci, createVNode as re, Transition as Oi, withCtx as te, createBlock as W, resolveDynamicComponent as ls, mergeProps as cs, TransitionGroup as ki, Fragment as We, renderList as ht, unref as S, nextTick as $t, renderSlot as Me, createElementVNode as y, vShow as us, resolveComponent as K, createTextVNode as at, toDisplayString as B, createCommentVNode as U, onUpdated as ps, Teleport as ds, getCurrentInstance as hs, useTemplateRef as di, createApp as Mi, toRaw as Ie, h as fs, render as Gt, defineAsyncComponent as ms } from "vue";
...
import hi from "@arcgis/core/geometry/Extent";
import ys from "@arcgis/core/geometry/Multipoint";
import gs from "@arcgis/core/geometry/Point";
import ei from "@arcgis/core/geometry/Polygon";
import Pi from "@arcgis/core/geometry/Polyline";
import vs from "@arcgis/core/geometry/SpatialReference";
import { fromJSON as bs } from "@arcgis/core/geometry/support/jsonUtils";
import As from "@arcgis/core/Graphic";
import ze from "@arcgis/core/request";
import ws from "@arcgis/core/symbols/PictureMarkerSymbol";
import Es from "@arcgis/core/symbols/SimpleFillSymbol";
import xs from "@arcgis/core/symbols/SimpleLineSymbol";
...
class G extends Ze {
  ...
  static fromArcServer(e, t) {
    return G.fromESRI(hi.fromJSON(e), t);
  }
...
class Te extends ke {
  ...
  constructor(e) {
    ...
    this._width = typeof t > "u" || t < 0 ? 0.75 : t, this._colour = new Pe(e.colour), this._miter = e.miter ?? 2, this._cap = e.cap || Gi.ROUND, this._join = e.join || Di.ROUND;
  }
...
class yt extends ke {
  ...
  _fillStyle;
  constructor(e) {
    super(), e = e || {}, e.fill || (e.fill = {}), this._fillColour = new Pe(e.fill.colour), this._fillStyle = e.fill.style || Ui.SOLID, this._outlineStyle = new Te(e.outline);
  }
  /** Returns the specified colour */
  get fillColour() {
  ...
  toESRI() {
    const e = this.outline.toESRI(), t = new St(this.fillColour.rgba), i = new Es();
...
class Ms {
  ...
  graphicRampToEsri(e) {
    ...
    return t.geometry = this.geomRampToEsri(e.geometry), Object.keys(e.attributes).forEach((i) => t.attributes[i] = e.attributes[i]), e.style && (t.symbol = this.styleRampToEsri(e.style)), new As(t);
  }
  styleRampToEsri(e) {
    return e.toESRI();
  }
...
class Fs {
  ...
  async projectGeoJson(e, t, i) {
    let s, o;
    if (t ? s = this.normalizeProj(t) : s = _.parseGeoJsonCrs(e.crs), i ? o = this.normalizeProj(i) : o = Ns, o === s)
      return e;
  ...
  async projectExtent(e, t) {
    const i = (m, A, b) => {
      ...
      if (b === 1)
        return [m, $, A];
      if (b > 1) {
        const T = i(m, $, b - 1), C = i($, A, b - 1);
        return T.concat(C.slice(1));
      }
      return [[]];
    }, s = t.toPolygonArray().pop() || [];
    let o = [];
    [0, 1, 2, 3].map((m) => i(s[m], s[m + 1], 3).slice(1)).forEach((m) => o = o.concat(m));
...
class Ds {
  ...
  sharedUtils;
  constructor() {
    this.proj = new Fs(), this.geom = new Ms(), this.sharedUtils = new Ps();
  }
  defaultTileSchemas() {
...
const Lt = z("appbar", () => {
  ...
  const r = f([]), e = f({}), t = f({}), i = f(), s = f(0), o = f(0), a = f(!0), l = f();
  function n(u) {
...
class Vs extends J {
  ...
  _funCounter;
  constructor(e) {
    super(e), this._eventBus = new os(), this._eventRegister = [], this._funCounter = 1, this._nameRegister = Object.values(E).filter((t) => typeof t == "string" && t.indexOf("/") > -1);
  }
  /**
      ...
      case "ramp_layer_remove_checks_grid":
        t = (i) => {
          if (this.$iApi.fixture.get("grid")) {
            const s = Yt(this.$vApp.$pinia), o = s.getGridId(i.id);
            if (o === void 0) return;
...
function Ws() {
  return Is({
    ...
    locale: document.documentElement.getAttribute("lang") || yi,
    fallbackLocale: yi,
    globalInjection: !0,
    messages: js,
    numberFormats: qs
...
const Rt = z("maptip", () => {
  ...
  __name: "esri-map",
  setup(r) {
    const e = Rt(), t = ve("iApi"), i = N(() => e.maptipPoint), s = N(() => e.maptipInstance), o = N(() => e.content), a = we([]), l = f(!1);
    a.push(
      xt(i, () => {
        if (i.value) {
  ...
  constructor(e) {
    this.resizeObserver = new ResizeObserver((t) => {
      t.length && window.requestAnimationFrame(() => {
        t.forEach((i) => {
          const s = i.target.dataset.breakpoints, o = s ? JSON.parse(s) : e ?? Ys;
...
const Js = ["data-cy"], Wi = /* @__PURE__ */ k({
    ...
    return (n, c) => {
      ...
      return v(), w("div", {
        ...
        re(Oi, {
          ...
          default: te(() => [
            P((v(), W(ls(r.panel.route.screen), cs({ class: "h-full" }, r.panel.route.props, { panel: r.panel }), null, 16, ["panel"])), [
              [u]
            ])
          ]),
          _: 1
  ...
  const r = f(void 0), e = f(void 0), t = f(0), i = f(0), s = f(!1), o = f(!0), a = f({}), l = f({}), n = f([]), c = f([]), u = f([]), p = N(() => i.value);
  function d(I) {
  ...
  function C() {
    let I = t.value;
    const R = [], ae = 350, fe = 12, ui = 600;
    for (let Fe = n.value.length - 1; Fe >= 0; Fe--) {
      const et = n.value[Fe];
      let Re = et.width || ae;
      if (s.value ? Re = I : Re += fe, et.id === "grid" && (Re = Math.max(Math.min(Re, I), ui)), (I >= Re && !s.value || R.length === 0) && (I -= Re, R.unshift(et)), et.id === "grid" && I < ui)
        break;
    }
    if (r.value && //@ts-expect-error TODO: explain why this is needed or remove
    !R.includes(r.value) && !s.value) {
      let Fe;
      for (let pi = 0; pi < R.length - 1 && I < (r.value.width || ae) + fe; pi++)
  ...
  __name: "panel-stack",
  setup(r) {
    const e = Ye(), t = ve("iApi"), i = f(), s = N(() => e.mobileView);
    Je(() => {
    ...
    return (c, u) => (v(), W(ki, {
      ...
      default: te(() => [
        (v(!0), w(We, null, ht(o(S(t).screenSize), (p) => (v(), W(Wi, {
          key: `${p.id}`,
          panel: p
        }, null, 8, ["panel"]))), 128))
      ]),
  ...
  for (const [i, s] of e)
    t[i] = s;
  return t;
}, Ks = /* @__PURE__ */ Ne(Zs, [["__scopeId", "data-v-197830c4"]]), Qs = ["content", "aria-label"], ii = /* @__PURE__ */ k({
  ...
  setup(r) {
    const e = f(!1), t = f(null), i = we([]), s = f(), o = f(), a = f(), l = r;
    i.push(
      xt(e, () => {
        t.value.update();
      })
    ...
    return Je(() => {
      window.addEventListener(
        ...
        a.value && o.value && (t.value = $s(a.value, o.value, {
  ...
  const r = f([]), e = f({}), t = N(() => r.value.length >= 99 ? 99 : r.value.length);
  function i(c) {
    r.value = [c, ...r.value];
  }
  function s(c) {
    if (r.value.includes(c)) {
      ...
      c instanceof Hi && n(c), u > -1 && r.value.splice(u, 1);
    }
  }
  function o(c) {
    e.value[c.id] = c;
...
}), Xs = { class: "h-full flex flex-col" }, er = { class: "w-full flex mb-6" }, tr = ["content", "aria-label"], ir = /* @__PURE__ */ k({
  __name: "screen",
  props: {
    panel: {
      type: Object,
...
const rr = ["content"], or = { class: "flex items-center text-left" }, ar = { class: "select-text cursor-text" }, nr = ["content"], lr = {
  key: 0,
  class: "text-left"
}, cr = /* @__PURE__ */ k({
      ...
      return P((v(), w("li", {
        ...
        y("div", or, [
          y("span", null, [
            ...
            y("span", ar, B(r.notification.message), 1)
          ]),
          ...
          P((v(), w("button", {
            type: "button",
            onClick: c[0] || (c[0] = Xt((p) => a(r.notification), ["stop"])),
        ...
        r.notification.messageList && s.value ? (v(), w("div", lr, [
          (v(!0), w(We, null, ht(r.notification.messageList, (p, d) => (v(), w("p", {
    ...
    return (l, n) => {
      ...
      return v(), w("div", null, [
        a.value.length > 0 ? P((v(), w("ul", {
          ...
          (v(!0), w(We, null, ht(a.value, (d, g) => (v(), w(We, {
            key: d.message + g
          }, [
            g > 0 ? (v(), w("div", pr)) : U("", !0),
            P(re(cr, {
          ...
          y("span", null, B(S(t)("notifications.empty")), 1),
          n[2] || (n[2] = y("span", { style: { "flex-grow": "6" } }, null, -1))
        ]))
      ]);
    };
  }
}), hr = { class: "flex items-center hover:text-white" }, fr = ["aria-label"], mr = {
  key: 0,
  class: "number rounded-full w-18 text-white"
}, yr = { class: "notification-dropdown pointer-events-auto bg-white rounded text-center text-black w-500 h-256 flex flex-col p-0" }, gr = { class: "pb-8 border-b border-gray-600" }, vr = { class: "absolute flex right-3 top-3" }, br = ["content", "aria-label"], Ar = /* @__PURE__ */ k({
      ...
      return v(), W(ii, {
        ...
        header: te(() => [
          y("div", hr, [
            ...
            i.value && i.value > 0 ? (v(), w("span", mr, B(i.value), 1)) : U("", !0)
          ])
        ]),
        default: te((c) => [
          y("div", yr, [
            y("div", null, [
              y("h4", gr, B(S(t)("notifications.title")), 1),
              y("div", vr, [
                P((v(), w("button", {
                  type: "button",
                  onClick: s,
            ...
            re(Yi, { class: "overflow-y-auto h-230" })
          ])
        ]),
        _: 1
      }, 8, ["tooltip"]);
...
}), wr = /* @__PURE__ */ Ne(Ar, [["__scopeId", "data-v-3623a7d2"]]), Er = { class: "flex hover:text-white" }, xr = ["aria-label"], Sr = { class: "about-ramp-dropdown pointer-events-auto bg-white rounded w-256 h-50" }, Ir = ["aria-label", "content"], _r = { class: "pb-8 border-b border-gray-600 mb-10" }, Tr = { class: "absolute right-5 top-5" }, Lr = { class: "select-text" }, Rr = { class: "font-bold cursor-text" }, $r = { class: "text-sm cursor-text" }, Cr = { class: "text-sm cursor-text" }, Or = /* @__PURE__ */ k({
        ...
        default: te((g) => [
          y("div", Sr, [
            y("div", null, [
              ...
              y("div", Lr, [
                y("div", null, [
                  y("span", Rr, B(s.value), 1),
                  y("span", $r, " [" + B(o.value) + "] ", 1)
                ]),
                y("div", null, [
                  y("span", Cr, B(a.value), 1)
                ]),
...
}), kr = /* @__PURE__ */ Ne(Or, [["__scopeId", "data-v-dc5124c0"]]), Mr = { class: "map-caption absolute bottom-0 h-29 sm:h-38 flex justify-end pointer-events-auto cursor-default select-none text-gray-200 bg-black-75 left-0 right-0 py-2 sm:py-6" }, Pr = {
  key: 0,
  class: "relative top-2 sm:top-1 ml-4 sm:ml-0 shrink-0"
}, Nr = ["href", "aria-label"], Fr = ["src", "alt"], Dr = {
  key: 1,
  class: "relative ml-10 top-2 text-sm sm:text-base"
}, Gr = { class: "flex min-w-fit justify-end" }, Ur = {
  key: 0,
  class: "pl-8 px-14 sm:block display-none relative top-2"
}, Br = ["aria-pressed", "aria-label", "content"], zr = { class: "relative top-1 text-sm sm:text-base" }, Vr = { class: "text-gray-200 hover:text-white text-sm sm:text-base pb-5" }, jr = ["onClick"], qr = {
  key: 0,
  class: "sr-only"
}, Wr = /* @__PURE__ */ k({
  __name: "map-caption",
  setup(r) {
    const e = Ue(), t = de(), { t: i } = Y(), s = ve("iApi"), o = N(() => e.scale), a = N(() => e.attribution), l = N(() => e.coords), n = N(() => e.langtoggle), c = N(() => t.config.map), u = f([]), p = we([]);
    p.push(
      xt(c, (A) => {
    ...
    return (A, b) => {
      ...
      return v(), w("div", Mr, [
        ...
        re(wr, { class: "sm:block display-none" }),
        d() ? (v(), w("span", Pr, [
          y("a", {
        ...
        a.value?.text.disabled ? U("", !0) : P((v(), w("span", Dr, [
        ...
        y("div", Gr, [
          l.value?.disabled ? U("", !0) : P((v(), w("div", Ur, [
          ...
          o.value?.disabled ? U("", !0) : P((v(), w("button", {
            key: 1,
            type: "button",
            ...
            y("span", {
              ...
              style: Ci({ width: o.value?.width })
            }, null, 4),
            y("span", zr, B(o.value?.label), 1)
          ], 8, Br)), [
            [C, {
              delay: [300, 0],
              placement: "top",
          ...
          n.value?.disabled ? U("", !0) : (v(), W($, {
            ...
            header: te(() => [
              y("span", Vr, B(S(i)("map.language.short")), 1)
            ]),
            default: te(() => [
              (v(!0), w(We, null, ht(u.value, (F, ce) => (v(), w("a", {
                key: `${F}-${ce}`,
                ...
                F === S(s).$i18n.locale.value ? (v(), w("span", qr, B(S(i)("map.language.curr")), 1)) : U("", !0)
              ], 10, jr))), 128))
            ]),
            _: 1
          }, 8, ["tooltip", "ariaLabel"]))
  ...
  setup(r) {
    ...
    return (o, a) => {
      ...
      return P((v(), w("button", {
        ...
        s.value && s.value > 0 ? (v(), w("span", Yr, B(s.value), 1)) : U("", !0)
      ], 8, Hr)), [
        [l]
      ]);
    };
  }
}), Zr = /* @__PURE__ */ Ne(Jr, [["__scopeId", "data-v-a451db5c"]]), Kr = { class: "flex items-center mb-20" }, Qr = { class: "text-xl" }, Xr = /* @__PURE__ */ k({
  __name: "keyboard-instructions",
  setup(r) {
    const e = ve("iApi"), { t } = Y(), i = f(!1), s = f(["app", "lists", "map"]), o = f([]), a = f(null), l = f(null);
    Je(() => {
      o.value.push(
    ...
    return (c, u) => {
      ...
      return i.value ? (v(), w("div", {
        ...
        y("div", {
          ...
          y("div", Kr, [
            y("h2", Qr, B(S(t)("keyboardInstructions.title")), 1),
            re(p, {
              class: "ml-auto",
              onClick: u[0] || (u[0] = (d) => i.value = !1)
            })
          ]),
          (v(!0), w(We, null, ht(s.value, (d) => (v(), w("p", {
...
}), st = z("instance", () => ({ started: f(!1) })), eo = { class: "h-full relative" }, to = { class: "inner-shell absolute top-0 left-0 h-full w-full pointer-events-none" }, io = { class: "absolute top-8 w-full flex justify-center" }, so = {
  key: 1,
  class: "w-full h-full"
}, ro = /* @__PURE__ */ k({
  __name: "shell",
  setup(r) {
    ...
    return (c, u) => (v(), w("div", eo, [
      y("div", to, [
        ...
        re(Xr),
        re(Ks, { class: "panel-stack sm:flex absolute inset-0 overflow-hidden sm:p-12 z-10 sm:pl-80 xs:pl-40 sm:pb-48 xs:pb-28 xs:pr-0 sm:pr-40" }),
        a.value ? U("", !0) : (v(), W(Zr, { key: 0 })),
        re(Wr, { class: "z-30" })
      ]),
      S(t).started ? (v(), W(Hs, { key: 0 })) : (v(), w("div", so, u[1] || (u[1] = [
        y("div", { class: "spinner relative inset-x-1/2 inset-y-9/20" }, null, -1)
      ]))),
      (v(!0), w(We, null, ht(n(), (p) => (v(), W(ds, {
...
}), oo = /* @__PURE__ */ Ne(ro, [["__scopeId", "data-v-7a1e48c2"]]), ao = k({
  name: "App",
  components: { Shell: oo },
  setup() {
    const r = hs();
    Je(() => {
      new qi().observe(r?.proxy?.$refs["app-size"]), Ts({
        aria: {
          content: "labelledby"
        },
        theme: "ramp4",
...
const uo = /* @__PURE__ */ Ne(ao, [["render", co]]), Se = "focus-list", je = "focus-item", po = "focus-icon", ho = "focus-container", ct = `[${Se}],[${ho}]`, bt = "truncate-text", At = "show-truncate", ot = "focused", Zt = `button,input,select,a,textarea,[contenteditable],[${Se}],[${po}],[tabIndex]`, fo = {
  mounted(r, e) {
    +r.getAttribute("tabindex") <= 0 && r.setAttribute("tabindex", "0"), r.toggleAttribute(Se, !0), new mo(r, e.value);
  },
  updated(r) {
    Ji(r);
  }
...
class mo {
    ...
    if (i.length !== 0)
      switch (e.key) {
        ...
        case " ":
          ...
          break;
        case "Tab":
          const s = this.highlightedItem.querySelectorAll(Zt).length === 0, o = this.element.isEqualNode(e.target);
   ...
   */
  onFocus() {
    this.highlightedItem && !this.isClicked && (this.highlightedItem._tippy && this.highlightedItem._tippy.show(), this.highlightedItem.getAttribute(je) === At && this.highlightedItem.querySelector(`[${bt}]`)?._tippy?.show()), this.isClicked = !1, this.element.hasAttribute("aria-activedescendant") || this.highlightedItem === this.element ? this.highlightedItem !== this.element && this.focusItem(this.highlightedItem) : this.setAriaActiveDescendant(this.highlightedItem), Ji(this.element), this.highlightedItem && this.highlightedItem !== this.element && this.highlightedItem.setAttribute("tabindex", "-1");
  }
  /**
...
const gi = "focus-item", yo = {
  beforeMount(r, e) {
    r.hasAttribute("id") || r.setAttribute("id", go()), e.value ? r.setAttribute(gi, e.value) : r.toggleAttribute(gi, !0);
  }
};
function go() {
  let r;
...
const si = "focus-container", Zi = "focus-list", vo = "focus-icon", Bt = `[${Zi}],[${si}]`, vi = `button,input,select,a,textarea,[contenteditable],.ag-tab-guard,[${Zi}],[${si}],[${vo}],[tabIndex]`;
let zt = [];
const bo = {
  mounted(r) {
    [...document.querySelectorAll(".inner-shell")].some((t) => t.contains(r)) && zt.push(new Ao(r));
  },
  beforeUnmount(r) {
...
class Ao {
   ...
   */
  disableTabbing() {
    Array.prototype.filter.call(this.element.querySelectorAll(vi), () => !0).forEach((t) => {
      t.tabIndex = -1;
    });
  }
  /**
  ...
  enableTabbing() {
    let e;
    return Array.prototype.map.call(this.element.querySelectorAll(vi), (t) => {
...
const wo = "truncate-text", Eo = "truncate-trigger", xo = {
  beforeMount(r, e) {
    !r.classList.contains("truncate") && !e.value?.noTruncateClass && r.classList.add("truncate"), r.toggleAttribute(wo, !0);
  },
  mounted(r, e) {
    let t;
    e.value && e.value.externalTrigger && (t = r.closest(`[${Eo}]`)), Ls(r, {
      content: bi(r.textContent),
      onShow: So,
      allowHTML: !0,
      placement: "bottom-start",
      maxWidth: 320,
  ...
  updated(r, e) {
    r._tippy && (r._tippy.setContent(bi(r.textContent)), e.value && e.value.options && r._tippy.setProps(e.value.options));
  },
  unmounted(r) {
...
const Io = ["content"], _o = {
  ...
  setup(r, { expose: e }) {
    const { t } = Y(), i = Ye(), s = Lt(), o = ve("iApi"), a = di("el"), l = di("contentEl"), n = f();
    e({ el: a });
    const c = r, u = N(() => o?.fixture.get("appbar") ? s.temporary : []), p = N(() => i.mobileView), d = N(() => i.reorderable), g = (b) => b.scrollHeight > b.clientHeight, h = () => !p.value && !c.panel.teleport, m = (b) => {
    ...
    return Je(() => {
      ...
      return P((v(), w("div", {
        ...
        r.header ? (v(), w("header", _o, [
          re(T, {
            class: oe(r.panel.teleport ? "display-none" : "block sm:display-none"),
            onClick: $[0] || ($[0] = (fe) => r.panel.close())
          }, null, 8, ["class"]),
          P((v(), w("h2", To, [
            b.$slots.header ? Me(b.$slots, "header", { key: 0 }) : (v(), w("div", Lo, B(S(t)(r.panel.alertName)), 1))
          ])), [
            [I]
          ]),
          b.$slots.controls ? (v(), W(C, { key: 0 }, {
            default: te(() => [
              Me(b.$slots, "controls")
            ]),
            _: 3
          ...
          y("div", {
            ...
            r.panel.teleport ? U("", !0) : (v(), w("div", Ro, [
              d.value ? (v(), W(F, {
                key: 0,
                onClick: $[1] || ($[1] = (fe) => m("left")),
                active: !r.panel.isLeftMostPanel
              }, null, 8, ["active"])) : U("", !0),
              d.value ? (v(), W(ce, {
                key: 1,
                onClick: $[2] || ($[2] = (fe) => m("right")),
              ...
              r.panel.controls && r.panel.controls.expand ? (v(), W(Pt, {
                key: 2,
                onClick: $[4] || ($[4] = (fe) => r.panel.expand()),
                active: r.panel.expanded
              }, null, 8, ["active"])) : U("", !0)
            ])),
            r.panel.button && u.value?.includes(r.panel.id) ? (v(), W(Nt, {
              key: 1,
        ...
        r.content ? (v(), w("div", {
          ...
          b.$slots.content ? Me(b.$slots, "content", { key: 0 }) : A.value ? (v(), w("div", {
            key: 1,
            innerHTML: A.value.innerHTML
          }, null, 8, $o)) : U("", !0)
        ], 512)) : U("", !0),
        r.footer ? P((v(), w("div", Co, [
          Me(b.$slots, "footer")
        ])), [
          [R]
        ]) : U("", !0)
...
}), ko = { class: "relative" }, Mo = ["content", "aria-label"], Po = ["transform"], No = /* @__PURE__ */ k({
  __name: "pin",
  props: {
    active: Boolean
  },
...
}), Fo = { class: "relative" }, Do = ["content", "aria-label"], Go = /* @__PURE__ */ k({
  __name: "close",
  props: {
    active: Boolean
  },
...
}), Uo = { class: "relative" }, Bo = ["content", "aria-label"], zo = /* @__PURE__ */ k({
  __name: "back",
  props: {
    active: Boolean
  },
...
}), Vo = { class: "w-32 h-32" }, jo = ["content", "aria-label"], qo = {
  key: 0,
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 24 24",
...
}), Yo = { class: "relative" }, Jo = ["content", "aria-label"], Zo = /* @__PURE__ */ k({
  __name: "minimize",
  props: {
    active: Boolean
  },
...
}), Ko = { class: "relative" }, Qo = ["content", "aria-label"], Xo = /* @__PURE__ */ k({
  __name: "right",
  props: {
    active: Boolean
  },
...
}), ea = { class: "relative" }, ta = ["content", "aria-label"], ia = /* @__PURE__ */ k({
  __name: "left",
  props: {
    active: Boolean
  },
...
}), ra = /* @__PURE__ */ Ne(sa, [["__scopeId", "data-v-51e22a4a"]]), oa = {
  key: 0,
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 24 24",
  ...
  setup(r) {
    ...
    return (s, o) => {
      ...
      return v(), W(a, {
        ...
        default: te(() => [
          S(t).isFullscreen ? (v(), w("svg", oa, o[0] || (o[0] = [
            y("path", {
              d: "M0 0h24v24H0z",
              fill: "none"
            }, null, -1),
  ...
  tabindex: "-1"
}, pa = ["content", "aria-label"], da = /* @__PURE__ */ k({
  __name: "button",
  props: {
    onClickFunction: {
      type: Function,
  ...
  class: "relative",
  tabindex: "-1"
}, fa = ["aria-label", "content"], ma = /* @__PURE__ */ k({
  __name: "button",
  props: {
    onClickFunction: {
      type: Function,
...
}), ya = /* @__PURE__ */ Ne(ma, [["__scopeId", "data-v-457cd2d4"]]), ga = z("areas-of-interest", () => ({ areas: f([]) })), va = z("export", () => {
  const r = f({
    title: !0,
    map: !0,
    mapElements: !0,
...
class wa {
  ...
  constructor(e, t) {
    Ct.get(t).then((i) => {
      i.data.definitions.forEach(
        (s) => Vt[e][s.code] = s.description
      ), Object.keys(Vt[e]).forEach((s) => {
        this.list[s] = Vt[e][s];
      }), this.listFetched = !0;
    });
  }
  ...
  fsaToProvinces(e) {
    const t = {};
    let i = Aa[e.substring(0, 1).toUpperCase()];
...
function Ia(r, e) {
  ...
  if (t.test(e) && !r.disabledSearchTypes.includes("LAT/LNG")) {
    const o = e.slice(0, -1);
    return new _a(r, o);
  } else return s.test(e) && !r.disabledSearchTypes.includes("FSA") ? new Ta(r, e) : i.test(e) && !r.disabledSearchTypes.includes("NTS") ? new La(r, e.substring(0, 6).toUpperCase()) : new Ra(r, e);
}
const jt = (r) => new Promise((e, t) => {
  const i = new XMLHttpRequest();
  i.open("GET", r, !0), i.responseType = "json", i.onload = () => {
    if (i.status === 200) {
      const s = typeof i.response == "string" ? JSON.parse(i.response) : i.response;
      e(s);
    } else
      t("Could not load results from remote service.");
  }, i.send();
});
class kt {
  config;
   ...
   */
  results = [];
  // TODO what is the difference between results and featureResults, other than looser type definitions?
  /**
  ...
  resultType = "geoname";
  constructor(e, t) {
    this.onComplete = Promise.resolve(this), this.query = t, this.config = e;
  }
  /**
   ...
   */
  search() {
    return jt(this.getUrl()).then((e) => this.normalizeNameItems(e.items)).catch(() => (console.error("Geoname service failed"), this.failedServs.push("geoname"), this.normalizeNameItems([])));
  }
  /**
  ...
  getUrl(e, t, i) {
    let s = "";
    return e ? s = this.config.geoLocateUrl + "?q=" + this.query : (t && i ? s = `${this.config.geoNameUrl}?lat=${t}&lon=${i}&num=${this.config.maxResults}` : s = `${this.config.geoNameUrl}?q=${this.query}&num=${this.config.maxResults}`, this.config.categories.length > 0 && (s += `&concise=${this.config.categories.join(",")}`), this.config.officialOnly && (s += "&category=O")), s;
  }
  /**
   ...
   */
  locateByQuery() {
    return jt(this.getUrl(!0));
  }
  /**
   * Hits the geonames (named locations) service for items at the given lat/lon. All other query params are ignored.
   */
  nameByLatLon(e, t) {
    return jt(this.getUrl(!1, e, t)).then((i) => this.normalizeNameItems(i.items)).catch(() => (console.error("LatLon service failed"), this.failedServs.push("geoname"), this.normalizeNameItems([])));
  }
}
class _a extends kt {
  constructor(e, t) {
  ...
  constructor(e, t) {
    t = t.substring(0, 3).toUpperCase(), super(e, t), this.resultType = "fsa", this.onComplete = new Promise((i) => {
      this.formatLocationResult().then((s) => {
        s ? (this.featureResults.push(s), this.nameByLatLon(s.LatLon.lat, s.LatLon.lon).then((o) => {
    ...
    super(e, t), this.resultType = "nts", t = isNaN(parseInt(t[2])) ? "0" + t : t, this.unitName = t, this.onComplete = new Promise((i) => {
      this.locateByQuery().then((s) => {
        if (s.length > 0 && this.query) {
          ...
          this.unit = o[0], this.featureResults.push(this.unit), this.nameByLatLon(this.unit.LatLon.lat, this.unit.LatLon.lon).then((a) => {
...
const $a = "~FSA~", Ai = "https://geogratis.gc.ca/services/geolocation/@{language}/locate", wi = "https://geogratis.gc.ca/services/geoname/@{language}/geonames.json", Ei = "https://geogratis.gc.ca/services/geoname/@{language}/codes/province.json", xi = "https://geogratis.gc.ca/services/geoname/@{language}/codes/concise.json", Ca = {
  10: "NL",
  11: "PE",
  12: "NS",
  13: "NB",
...
class Si {
  ...
  constructor(e, t) {
    ...
    l ? (i = l.geoLocation ? l.geoLocation : Ai, s = l.geoNames ? l.geoNames : wi, o = l.geoProvince ? l.geoProvince : Ei, a = l.geoTypes ? l.geoTypes : xi) : (i = Ai, s = wi, o = Ei, a = xi), i = i.replace("@{language}", e), s = s.replace("@{language}", e), o = o.replace("@{language}", e), a = a.replace("@{language}", e);
    let n = "";
    const c = t?.fsaBoundaries;
    if (c && c.serviceUrl) {
      const A = c.keyField || "CFSAUID";
      n = `${c.serviceUrl}/query/?where=${A}%3D'${$a}'&outFields=${A}&returnGeometry=true&f=json`;
    }
    const u = t?.settings;
    let p, d, g, h, m;
   ...
   */
  query(e) {
    return Ia(this.config, e.toUpperCase()).onComplete.then((t) => {
      let i = [];
      t.featureResults.length > 0 ? t.resultType === "fsa" ? i = t.featureResults.map((o) => ({
        name: o.fsa,
        flav: "fsa",
        bbox: qt(o.LatLon, 0.02),
        type: o.desc,
      ...
      })), this.config.sortOrder.length > 0 && (i = i.sort((o, a) => this.levenshteinDistance(t, o.name) > this.levenshteinDistance(t, a.name) ? 1 : -1))) : t.resultType === "latlong" && (i = [t.latLongResult]);
      const s = t.results.map(
        (o) => ({
          name: o.name,
          flav: o.flav,
          bbox: o.bbox,
...
const Oa = z("geosearch", () => {
  const r = f(new Si("en", void 0)), e = f({
    type: "",
    province: "",
    extent: void 0
  }), t = f(!1), i = f(""), s = f(""), o = f(""), a = f([]), l = f([]), n = f(!1), c = f([]), u = N(
    () => new Promise((T) => {
  ...
  function A(T) {
    o.value = i.value.replace(/["!*$+?^{}()|[\]\\]/g, "").trim(), i.value = T, g();
  }
  function b(T) {
    const C = {
...
}), ka = z("help", () => ({ location: f("./help/") }));
var Ki = /* @__PURE__ */ ((r) => (r.Visibility = "visibilityButton", r.Expand = "expandButton", r))(Ki || {}), Kt = /* @__PURE__ */ ((r) => (r.Item = "item", r.Placeholder = "placeholder", r.Error = "error", r))(Kt || {});
class Qi extends J {
  _uid;
  _name;
  _type;
...
class De extends Qi {
  ...
  // @ts-expect-error TODO: explain why this is needed or remove
  load(e) {
    const t = e instanceof oi ? e : this.$iApi.geo.layer.getLayer(this._layerId ?? this._layerUid);
    t && (this.layer = t, this._layerRedrawing = t.mapLayer && t.drawState !== pe.UP_TO_DATE, t.loadPromise().then(() => {
      this._layerInitVis = typeof this._layerInitVis < "u" ? this._visibility : t.visibility, super.load(), this.toggleVisibility(this._layerInitVis, !0, !0), t.visibility || this.setSymbologyVisibility(void 0, !1), this.handlers.push(
        this.$iApi.event.on(
          ...
          (i) => {
            i.layer.uid === this.layer.uid && this._type === Kt.Item && this.toggleVisibility(i.visibility, !0, !0);
          }
        )
      ), this.handlers.push(
        this.$iApi.event.on(
...
var Ma = /* @__PURE__ */ ((r) => (r.Title = "title", r.Text = "text", r.Image = "image", r.Markdown = "markdown", r.Template = "template", r))(Ma || {});
class _i extends Qi {
  _infoType;
...
const Pa = z("legend", () => {
  ...
  function o(n) {
    if (n.parent === void 0)
      ...
      if (!(n.item instanceof _i) && !(n.item instanceof De)) {
  ...
  function a(n) {
    const c = (u) => (u = u.filter((p) => (p === n && !p.children.length && p.onRemoved(), p !== n)), u.forEach((p) => {
      ...
      (p) => !(p instanceof _i && !p.children.length && p.content === "")
    ), u);
    e.value = c(e.value);
  }
  function l(n) {
  ...
  const r = f({
    ...
    tileSchemas: [],
    initialBasemapId: ""
  }), e = f({}), t = f(!0), i = f(1.5), s = f("#FF0000"), o = f(1), a = f("#000000"), l = f(0.25);
  function n(c) {
...
const Ba = z("wizard", () => {
  const r = {
    ...
    layerType: x.UNKNOWN,
    url: ""
  }, e = f(), t = f(""), i = f(""), s = f(!0), o = f(null), a = f({
    config: r,
    configOptions: []
  }), l = f(ie.UPLOAD);
  function n(c) {
...
class za {
  ...
  _isFullscreen;
  constructor(e, t, i) {
    this.event = new Vs(this);
    const s = Va(e, this);
    this.$vApp = s.app, this.$element = s.element, this.$i18n = s.i18n, this.$rootEl = s.app.$root?.$el, this.fixture = new Dn(this), this.panel = new Gn(this), this.geo = new Nn(this), this.dev = new qn(this), this.ui = {
      ...
      escapeHtml: () => "",
      isPlainText: () => !0
    }, this.notify = new sr(this), this._isFullscreen = xe.isEnabled && !!this.$vApp.$root && xe.isFullscreen && xe.element === this.$vApp.$root.$el, xe.isEnabled && xe.onchange(() => {
   ...
   */
  reloadWorker(e, t) {
    const i = st(this.$vApp.$pinia), s = Le(this.$vApp.$pinia), o = de(this.$vApp.$pinia), a = ge(this.$vApp.$pinia), l = _e(this.$vApp.$pinia), n = Yt(this.$vApp.$pinia), c = !!e;
    ...
    )), s.clearAll(), this.geo.map.maptip.clear(), this.initialize(c, e, t), c && this.event.emit(E.CONFIG_CHANGE, this.getConfig());
  }
  /**
  ...
  setLanguage(e) {
    ...
    s[o] !== s[e] && (this.reloadWorker(), this.event.emit(E.CONFIG_CHANGE, a)), this.event.emit(E.LANG_CHANGE, {
      oldLang: o,
      newLang: e
    });
  }
...
function Va(r, e) {
  ...
  t.use(({ store: a }) => {
    const l = fi(a.$state);
    a.$reset = () => a.$patch(fi(l));
  });
  const i = Ws(), s = Mi(uo).use(i).use(_s, {
    directive: "tippy",
    // => v-tippy
    component: "tippy"
    // => <tippy/>
  }).use(t);
  s.directive("focus-container", bo), s.directive("focus-list", fo), s.directive("focus-item", yo), s.directive("truncate", xo), s.component("panel-screen", Oo), s.component("pin", No), s.component("close", Go), s.component("back", zo), s.component("expand", Ho), s.component("panel-options-menu", ra), s.component("dropdown-menu", ii), s.component("minimize", Zo), s.component("right", Xo), s.component("left", ia), s.component("fullscreen-nav-button", na), s.component("geolocator-nav-button", la), s.component("home-nav-button", ca), s.component("mapnav-button", da), s.component("appbar-button", ya), s.component("transition", Oi), s.component("transition-group", ki), s.config.globalProperties.$iApi = e, s.config.globalProperties.$pinia = t, s.config.idPrefix = `ramp-${r.id || e.geo.shared.generateUUID()}`, s.provide("iApi", e);
  const o = s.mount(r);
...
class ri {
  ...
  static async create(e) {
    const t = new ri(e), i = e.layers.map((a) => {
...
class ja extends J {
  ...
  async createMap(e, t) {
    ...
    }, s = e.basemaps.map((n) => ri.create(n)), a = (await Promise.all(s)).filter((n) => (n.createErr && i(n), n.esriBasemap.baseLayers.length > 0));
    a.forEach((n) => {
...
class Ha extends ja {
   ...
   */
  constructor(e) {
    super(e, "main"), this.maptip = new qa(e), this.caption = new Wa(e), this.mapMouseThrottle = 0;
  }
  async createMap(e, t) {
  ...
  removeLayer(e) {
    ...
    let t;
    if (e instanceof oi ? t = e : t = this.$iApi.geo.layer.getLayer(e), !t)
...
const Ya = { geometryType: "point", renderer: { type: "simple", symbol: { type: "esriSMS", style: "esriSMSCircle", color: [67, 100, 255, 200], size: 7, outline: { color: [0, 0, 0, 255], width: 1 } } } }, Ja = { geometryType: "polyline", renderer: { type: "simple", symbol: { type: "esriSLS", style: "esriSLSSolid", color: [90, 90, 90, 200], width: 2 } } }, Za = { geometryType: "polygon", renderer: { type: "simple", symbol: { type: "esriSFS", style: "esriSFSSolid", color: [76, 76, 125, 200], outline: { type: "esriSLS", style: "esriSLSSolid", color: [110, 110, 110, 255], width: 1 } } } }, Ka = { geometryType: "polygon", renderer: { type: "simple", symbol: { type: "esriSFS", style: "esriSFSSolid", color: [255, 0, 0, 64], outline: { type: "esriSLS", style: "esriSLSSolid", color: [240, 128, 128, 255], width: 1 } } } }, Qa = {
  circlePoint: Ya,
  solidLine: Ja,
  outlinedPoly: Za,
  boundingBoxPoly: Ka
...
class on extends J {
  ...
  extractCsvFields(e, t = ",") {
    return mi.dsvFormat(t).parseRows(e)[0].map((s) => ({ name: s, type: Ce.STRING }));
  }
  /**
  ...
  filterCsvLatLonFields(e, t = ",") {
    const i = mi.dsvFormat(t).parseRows(e), s = i[0], o = {
  ...
  async geoJsonToEsriJson(e, t) {
    ...
    en(e);
    const l = e.features[0].geometry.type, n = Xa[l], c = JSON.parse(
      // @ts-expect-error TODO: explain why this is needed or remove
      JSON.stringify(Qa[n])
    );
    if (t) {
...
class nn extends J {
  ...
  async loadWfsData(e, t = -1, i = 0, s = 1e3, o = {
    ...
    if (o.features = o.features.concat(d.features), d.features.length < t - i) {
      const g = Math.min(s, t - i - d.features.length);
      ...
      return a && o.features.length > 0 && o.features[0].geometry.type === V.POINT && o.features.forEach((g) => {
...
class ln extends J {
  ...
  ogc;
  constructor(e) {
    super(e), this.files = new on(e), this.ogc = new nn(e);
  }
  /**
...
class ai extends Ke {
  ...
  filter;
  constructor(e, t) {
    super(e, t), this.supportsIdentify = !0, this.geomType = L.UNKNOWN, this.serviceUrl = "", this.fieldList = "", this.canModifyLayer = !0, this.filter = new zi(e.permanentFilteredQuery || "", e.initialFilteredQuery || ""), this.hovertips = e.state?.hovertips ?? !0, this.attribs = new ts();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
  ...
  async loadLayerMetadata(e = {}) {
    ...
    if (!(t < this.lastCancel))
      if (this.geomType = i.geometryType, this.attribs.quickCache = new ss(this.geomType), this.scaleSet.minScale = i.minScale, this.scaleSet.maxScale = i.maxScale, this.dataFormat = i.dataFormat, this.extent = this.extent ?? i.extent, this._serverVisibility = i.defaultVisibility, this.origRampConfig.name || (this.name = i.name ?? this.id), this.dataFormat === ee.ESRI_FEATURE) {
        ...
        this.attribs.attLoader = new is(this.$iApi, o);
      } else
...
class Qe extends ai {
  ...
  extractLayerMetadata() {
    ...
    this.attribs.attLoader = new Rn(this.$iApi, i);
  }
  async getGraphic(e, t) {
    let i;
  ...
  onLoadActions() {
    ...
    const o = [], a = (n, c) => {
      ...
      if (n.sublayers && n.sublayers.length > 0) {
        const d = (p ? p.name : "") || n.title || "", g = new _t(u, "", d, !1);
        c.findChildByIdx(u) || c.children.push(g), n.sublayers.reverse().forEach((h) => {
          a(h, g);
        });
      } else {
        this._sublayers[u] || (this._sublayers[u] = new bn(
          {
        ...
        if (d.name = p?.name || n.title || "", o.push(d), !c.children.map((g) => g.layerIdx).includes(u)) {
          const g = new _t(u, d.uid, d.name, !1);
          c.children.push(g);
        }
        d.esriWatches.push(
          Ae(
    ...
    const l = o.map(async (n) => {
      ...
      if (n.esriSubLayer && u?.customRenderer?.type) {
        const g = await O.RendererFromJson(u.customRenderer);
...
class xn extends Ke {
  ...
  getFeatureInfo(e, t, i) {
    ...
    let a, l;
    const n = s.getExtent(), c = o.spatialReferences, u = e.join(","), p = s.esriView.toScreen(t.toESRI()), d = Math.floor(p.x), g = Math.floor(p.y), m = {
...
class es extends Xi {
  ...
  // ----------- LAYER CONSTRUCTION AND INITIALIZAION -----------
  constructor(e, t) {
    super(e, t), this.dataFormat = ee.ESRI_FEATURE, this.layerFormat = ye.NOLAYER, this.drawState = pe.NOT_VISUAL, this.attribs = new ts(), this.supportsFeatures = !0, this.mapLayer = !1, this.isFile = !1, this._visibility = e.state?.visibility ?? !0, this.expectedTime.draw = 0;
  }
  async onInitiate() {
    if (this.sourceJson) {
      ...
      this.attribs.attLoader = new $n(this.$iApi, o), await this.attribs.attLoader.getAttribs(), this.featureCount = e.data.length;
...
class _n extends es {
  ...
  onLoadActions() {
    const e = super.onLoadActions(), t = Date.now(), s = this.$iApi.geo.shared.parseUrlIndex(this.serviceUrl).index || 0, o = this.$iApi.geo.layer.loadLayerMetadata(this.serviceUrl).then((l) => {
      ...
      this.attribs.attLoader = new is(this.$iApi, n), this.attribs.quickCache = new ss(this.geomType);
...
class ni extends J {
  ...
  constructor(e, t) {
    super(e), this.aac = new Ti(), this.details = t;
  }
  /**
  ...
  getAttribs() {
    return this.loadPromise || (this.aac = new Ti(), this.loadPromise = this.loadPromiseGenerator()), this.loadPromise;
  }
  abortAttribLoad() {
...
class kn extends li {
  ...
  constructor(e, t, i = !1) {
    if (super(e, t, i), this.valField = this.cleanFieldName(e.field, t), e.classBreakInfos.forEach((s, o) => {
      const a = o === 0, l = new Ri(this, s.minValue, s.maxValue, a);
  ...
  async symbolToSvg(e) {
    ...
    const o = tt(s).size(this.CONTAINER_SIZE, this.CONTAINER_SIZE).viewbox(0, 0, this.CONTAINER_SIZE, this.CONTAINER_SIZE), a = {
      ...
      "picture-fill"() {
        ...
        return t.$iApi.geo.shared.convertImagetoDataURL(h).then((C) => {
          const F = o.pattern(
            m,
            A,
            (ce) => (
...
class Nn extends J {
   ...
   */
  constructor(e) {
    super(e), this.geom = ut.geom, this.proj = ut.proj, this.shared = ut.sharedUtils, this.map = new Ha(e), this.layer = new ln(e), this.attributes = new Ln(e), this.query = new Pn(e), this.symbology = new Mn(e), Array.isArray(ft.request.interceptors) || (ft.request.interceptors = []), ft.request.interceptors.push({
      before: (t) => {
...
const Fn = /* @__PURE__ */ Object.assign({ "../fixtures/appbar/index.ts": () => import("./index-DlFPlmCt.js"), "../fixtures/areas-of-interest/index.ts": () => import("./index-Z7vnSK-4.js"), "../fixtures/basemap/index.ts": () => import("./index-DrYIIjRp.js"), "../fixtures/crosshairs/index.ts": () => import("./index-SqlpjHpN.js"), "../fixtures/details/index.ts": () => import("./index-SyHJ26SW.js"), "../fixtures/export-footnote/index.ts": () => import("./index-B89cLWzP.js"), "../fixtures/export-legend/index.ts": () => import("./index-tlYWBwcD.js"), "../fixtures/export-map/index.ts": () => import("./index-DR-SpbTr.js"), "../fixtures/export-northarrow/index.ts": () => import("./index-Eh9fcrfl.js"), "../fixtures/export-scalebar/index.ts": () => import("./index-DF8H9L3X.js"), "../fixtures/export-timestamp/index.ts": () => import("./index-Sc4HCKcD.js"), "../fixtures/export-title/index.ts": () => import("./index-C_IA20bF.js"), "../fixtures/export/index.ts": () => import("./index-BydZky1U.js"), "../fixtures/extentguard/index.ts": () => import("./index-CzdWCf1r.js"), "../fixtures/gazebo/index.ts": () => import("./index-CCBLhqza.js"), "../fixtures/geosearch/index.ts": () => import("./index-nY0Aon93.js"), "../fixtures/grid/index.ts": () => import("./index-C-nwvtzG.js"), "../fixtures/help/index.ts": () => import("./index-D1yDhpun.js"), "../fixtures/hilight/index.ts": () => import("./index-BY_FDkfx.js"), "../fixtures/layer-reorder/index.ts": () => import("./index-Dhv4GRGF.js"), "../fixtures/legend/index.ts": () => import("./index-Dcc_ImEN.js"), "../fixtures/mapnav/index.ts": () => import("./index-vCjLAYAC.js"), "../fixtures/metadata/index.ts": () => import("./index-CCBBDaCu.js"), "../fixtures/northarrow/index.ts": () => import("./index-C4vm75_s.js"), "../fixtures/overviewmap/index.ts": () => import("./index-DwO4FSs0.js"), "../fixtures/panguard/index.ts": () => import("./index-DXgK8J67.js"), "../fixtures/scrollguard/index.ts": () => import("./index-DhBk8eAi.js"), "../fixtures/settings/index.ts": () => import("./index-DxUVXtd7.js"), "../fixtures/snowman/index.ts": () => import("./index-l6B2GXqf.js"), "../fixtures/wizard/index.ts": () => import("./index-BiyYdRfH.js") });
class Dn extends J {
  /**
  ...
  async add(e, t) {
    ...
    if (t) {
      ...
      i = ci.updateBaseToInstance(new t(), e, this.$iApi);
    } else {
      const s = (await Fn[`../fixtures/${e}/index.ts`]()).default;
      i = new s(e, this.$iApi);
    }
...
const Vn = /* @__PURE__ */ Ne(Bn, [["render", zn], ["__scopeId", "data-v-a3c61802"]]), jn = /* @__PURE__ */ Object.assign({ "../fixtures/areas-of-interest/screen.vue": () => import("./screen-D-Vh6tzY.js"), "../fixtures/basemap/screen.vue": () => import("./screen-FxOS-mY1.js"), "../fixtures/export/screen.vue": () => import("./screen-C5_IOvrt.js"), "../fixtures/geosearch/screen.vue": () => import("./screen-DG7Enlxk.js"), "../fixtures/grid/screen.vue": () => import("./screen-DO49Fxzy.js"), "../fixtures/help/screen.vue": () => import("./screen-CQ5FxX7V.js"), "../fixtures/layer-reorder/screen.vue": () => import("./screen-DufPAAlQ.js"), "../fixtures/legend/screen.vue": () => import("./screen-CxWEiRZI.js"), "../fixtures/metadata/screen.vue": () => import("./screen-CEpIOwYU.js"), "../fixtures/settings/screen.vue": () => import("./screen-UXyZQOUL.js"), "../fixtures/wizard/screen.vue": () => import("./screen-q6cHO-Cr.js") });
class Et extends J {
  /**
   * ID of this panel.
   *
  ...
  registerScreen(e) {
    ...
    if (Us(t) || Gs(t))
      ...
      let s;
      typeof t == "string" ? s = jn[`../fixtures/${t}`]() : s = t();
      const o = new Promise((a, l) => {
        s.then((n) => {
          this.loadedScreens.push(e), a(Bs(n) ? n.default : n);
        }), s.catch((n) => l(n));
      });
      i = ms({
...
function Hn(r) {
  ...
  return Jn(r.services, e), Yn(r.map, e), Zn(r.ui, e), r.plugins && Kn(r.plugins, e), e;
}
function Yn(r, e) {
  ...
  return r.controls && r.controls.length > 0 && (e.controls = pt(r.controls, t), r.controls.includes("visibility") && e.controls.push("visibilityButton"), (r.controls.length !== 1 || r.controls[0] !== "visibility") && console.warn(
    ...
    if (i.layerId)
      ...
      typeof i.collapse < "u" && console.warn(
        ...
        o.layerId ? s.children.push($i(o)) : s.children.push(Qt(o));
      }), e.children.push(s);
    } else
      e.children.push(Qt(i));
  }), e;
}
function $i(r) {
  const e = r, t = [
...
var rt = { major: "4", minor: "12", patch: "0-beta", timestamp: "Fri May 16 15:30:42 2025 -0400", hash: "67fbb77e5edcef88d38993d5d4d3f0cd7273f6ac" };
console.info(
...
const Dl = (r, e, t) => new za(r, e, t), ut = new Ds();
export {
  j as $,
  kr as A,
  yt as B,
