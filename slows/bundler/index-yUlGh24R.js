...
import { _ as C, d as A, F as j, G } from "./main-CtoZlKr-.js";
...
const D = /* @__PURE__ */ C(q, [["render", U]]), W = /* @__PURE__ */ $({
  ...
  setup(_) {
    const i = k("iApi"), { t } = z(), e = Y(), o = [
      {
        type: "point",
        icon: h(f(() => import("./point-icon-C8k4wpLY.js")))
      },
      {
        type: "polyline",
        icon: h(f(() => import("./polyline-icon-CZh2qkiM.js")))
      },
      {
        type: "polygon",
        icon: h(f(() => import("./polygon-icon-C04OdgdP.js")))
      },
      {
        type: "circle",
        icon: h(f(() => import("./circle-icon-BmZ4qP8Q.js")))
      },
      {
        type: "rectangle",
        icon: h(f(() => import("./rectangle-icon-BbRYgEBN.js")))
      }
    ], d = x(() => {
      const a = o.filter((s) => e.supportedTypes.some((c) => c.type === s.type));
      return a.push({
        type: "edit",
        icon: h(f(() => import("./edit-icon-DwOEW8ek.js")))
      }), a;
    }), n = (a) => {
