...
import { _ as C, d as A, F as j, G } from "./main-DIaVuYD-.js";
...
const D = /* @__PURE__ */ C(q, [["render", U]]), W = /* @__PURE__ */ $({
  ...
  setup(_) {
    const i = k("iApi"), { t } = z(), e = Y(), o = [
      {
        type: "point",
        icon: h(f(() => import("./point-icon-E593RaNe.js")))
      },
      {
        type: "polyline",
        icon: h(f(() => import("./polyline-icon-BEFkEusY.js")))
      },
      {
        type: "polygon",
        icon: h(f(() => import("./polygon-icon-Bbllxo-F.js")))
      },
      {
        type: "circle",
        icon: h(f(() => import("./circle-icon-CjxbZ_fe.js")))
      },
      {
        type: "rectangle",
        icon: h(f(() => import("./rectangle-icon-CVfgky64.js")))
      }
    ], d = x(() => {
      const a = o.filter((s) => e.supportedTypes.some((c) => c.type === s.type));
      return a.push({
        type: "edit",
        icon: h(f(() => import("./edit-icon-E78eFkjp.js")))
      }), a;
    }), n = (a) => {
