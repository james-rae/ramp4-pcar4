...
import { defineStore as B, createPinia as ps } from "pinia";
import { ref as f, computed as P, markRaw as ee, defineComponent as O, inject as ge, reactive as we, watch as It, onBeforeUnmount as dt, resolveDirective as k, withDirectives as M, openBlock as v, createElementBlock as A, withKeys as ds, withModifiers as ei, onMounted as Ye, normalizeClass as oe, normalizeStyle as Pi, createVNode as ae, Transition as Ni, withCtx as ie, createBlock as W, resolveDynamicComponent as hs, mergeProps as fs, useCssVars as ms, TransitionGroup as Fi, Fragment as We, renderList as ht, unref as I, nextTick as Ot, renderSlot as Me, createElementVNode as y, vShow as ys, resolveComponent as Z, createTextVNode as ot, toDisplayString as D, createCommentVNode as U, onUpdated as gs, Teleport as vs, getCurrentInstance as bs, useTemplateRef as yi, createApp as Di, toRaw as Ie, h as ws, render as Vt, defineAsyncComponent as As } from "vue";
...
class C {
  ...
  // --- Layers ---
  static async PrefetchFeatureLayer() {
    return zt || (zt = import("@arcgis/core/layers/FeatureLayer")), zt;
  }
  static async FeatureLayer(e) {
    const t = await C.PrefetchFeatureLayer();
    return Reflect.construct(t.default, [e]);
  }
...
class F extends Je {
  ...
  static fromArcServer(e, t) {
    return F.fromESRI(gi.fromJSON(e), t);
  }
...
class yt extends ke {
  ...
  toESRI() {
    const e = this.outline.toESRI(), t = new _t(this.fillColour.rgba), i = new Ls();
...
class zs {
  ...
  async projectExtent(e, t) {
    const i = (m, w, b) => {
      if (b === 0)
        return [m, w];
      const $ = [(m[0] + w[0]) / 2, (m[1] + w[1]) / 2];
      if (b === 1)
        return [m, $, w];
      if (b > 1) {
        const L = i(m, $, b - 1), G = i($, w, b - 1);
    ...
    const o = new re("warpy", [a], t.sr, !0), l = await this.projectGeometry(e, o), n = l.toArray().pop() || [], c = n.map((m) => m[0]), u = n.map((m) => m[1]), p = Math.min.apply(null, c), d = Math.max.apply(null, c), g = Math.min.apply(null, u), h = Math.max.apply(null, u);
...
const tr = ["data-cy"], Ki = /* @__PURE__ */ O({
  ...
  function Q() {
    let S = t.value;
    const R = [], he = 350, Qe = 12, fi = 600;
    for (let Fe = n.value.length - 1; Fe >= 0; Fe--) {
      const et = n.value[Fe];
      let Re = et.width || he;
      if (r.value ? Re = S : Re += Qe, et.id === "grid" && (Re = Math.max(Math.min(Re, S), fi)), (S >= Re && !r.value || R.length === 0) && (S -= Re, R.unshift(et)), et.id === "grid" && S < fi)
        break;
    }
    if (s.value && //@ts-expect-error TODO: explain why this is needed or remove
    !R.includes(s.value) && !r.value) {
      let Fe;
      for (let mi = 0; mi < R.length - 1 && S < (s.value.width || he) + Qe; mi++)
  ...
  setup(s) {
    ...
    return (u, p) => (v(), W(Fi, {
      ...
      default: ie(() => [
        (v(!0), A(We, null, ht(o(I(t).screenSize), (d) => (v(), W(Ki, {
          key: `${d.id}`,
          panel: d
        }, null, 8, ["panel"]))), 128))
      ]),
...
const ur = ["content"], pr = { class: "flex items-center text-left" }, dr = { class: "select-text cursor-text" }, hr = ["content"], fr = {
      ...
      return M((v(), A("li", {
        ...
        y("div", pr, [
          y("span", null, [
            ...
            y("span", dr, D(s.notification.message), 1)
          ]),
    ...
    return (l, n) => {
      ...
      return v(), A("div", null, [
        o.value.length > 0 ? M((v(), A("ul", {
          ...
          y("span", null, D(I(t)("notifications.empty")), 1),
      ...
      return v(), W(si, {
        ...
        header: ie(() => [
          y("div", br, [
            ...
            i.value && i.value > 0 ? (v(), A("span", Ar, D(i.value), 1)) : U("", !0)
          ])
        ]),
        default: ie((c) => [
          y("div", Er, [
            y("div", null, [
              y("h4", xr, D(I(t)("notifications.title")), 1),
              y("div", Sr, [
                M((v(), A("button", {
                  type: "button",
                  onClick: r,
            ...
            ae(Xi, { class: "overflow-y-auto h-230" })
          ])
        ]),
        _: 1
      }, 8, ["tooltip"]);
        ...
        default: ie((g) => [
          y("div", $r, [
            y("div", null, [
              ...
              y("div", Mr, [
                y("div", null, [
                  y("span", Pr, D(r.value), 1),
                  y("span", Nr, " [" + D(a.value) + "] ", 1)
                ]),
                y("div", null, [
                  y("span", Fr, D(o.value[0]), 1),
                  y("span", Dr, D(o.value[1]), 1)
                ]),
  ...
  setup(s) {
    ...
    }, m = (w = !1) => i(w ? "map.toggleScaleToMetric" : "map.toggleScaleToImperial");
    return (w, b) => {
      ...
      return v(), A("div", Br, [
        ...
        ae(Tr, { class: "sm:block display-none" }),
        d() ? (v(), A("span", Vr, [
          y("a", {
        ...
        o.value?.text.disabled ? U("", !0) : M((v(), A("span", jr, [
        ...
        y("div", Wr, [
          l.value?.disabled ? U("", !0) : M((v(), A("div", Hr, [
          ...
          n.value?.disabled ? U("", !0) : (v(), W($, {
            ...
            header: ie(() => [
              y("span", Kr, D(I(i)("map.language.short")), 1)
            ]),
            default: ie(() => [
              (v(!0), A(We, null, ht(u.value, (V, Q) => (v(), A("a", {
                ...
                V === I(r).$i18n.locale.value ? (v(), A("span", Xr, D(I(i)("map.language.curr")), 1)) : U("", !0)
              ], 10, Zr))), 128))
            ]),
            _: 1
          }, 8, ["tooltip", "ariaLabel"]))
  ...
  setup(s) {
    ...
    return (a, o) => {
      ...
      return M((v(), A("button", {
        ...
        r.value && r.value > 0 ? (v(), A("span", ta, D(r.value), 1)) : U("", !0)
      ], 8, ea)), [
        [l]
      ]);
    };
    ...
    return (c, u) => {
      ...
      return i.value ? (v(), A("div", {
        ...
        y("div", {
          ...
          y("div", ra, [
            y("h2", aa, D(I(t)("keyboardInstructions.title")), 1),
            ae(p, {
              class: "ml-auto",
...
}), st = B("instance", () => ({ started: f(!1) })), na = { class: "h-full relative" }, la = { class: "inner-shell absolute top-0 left-0 h-full w-full pointer-events-none" }, ca = { class: "absolute top-8 w-full flex justify-center" }, ua = {
  key: 1,
  class: "w-full h-full"
}, pa = /* @__PURE__ */ O({
  __name: "shell",
  setup(s) {
    ...
    return (c, u) => (v(), A("div", na, [
      y("div", la, [
        ...
        ae(oa),
        ae(sr, { class: "panel-stack sm:flex absolute inset-0 overflow-hidden sm:p-12 z-10 sm:pl-80 xs:pl-40 sm:pb-48 xs:pb-28 xs:pr-0 sm:pr-40" }),
        o.value ? U("", !0) : (v(), W(sa, { key: 0 })),
        ae(Qr, { class: "z-30" })
      ]),
      I(t).started ? (v(), W(Qs, { key: 0 })) : (v(), A("div", ua, u[1] || (u[1] = [
        y("div", { class: "spinner relative inset-x-1/2 inset-y-9/20" }, null, -1)
      ]))),
      (v(!0), A(We, null, ht(n(), (p) => (v(), W(vs, {
...
}), da = /* @__PURE__ */ Ne(pa, [["__scopeId", "data-v-7bc0478f"]]), ha = O({
  name: "App",
  components: { Shell: da },
  setup() {
    const s = bs();
...
const ga = /* @__PURE__ */ Ne(ha, [["render", ya]]), Se = "focus-list", qe = "focus-item", va = "focus-icon", ba = "focus-container", ct = `[${Se}],[${ba}]`, wt = "truncate-text", At = "show-truncate", at = "focused", Zt = `button,input,select,a,textarea,[contenteditable],[${Se}],[${va}],[tabIndex]`, wa = {
  mounted(s, e) {
...
class Aa {
   ...
   */
  onFocus() {
    this.highlightedItem && !this.isClicked && (this.highlightedItem._tippy && this.highlightedItem._tippy.show(), this.highlightedItem.getAttribute(qe) === At && this.highlightedItem.querySelector(`[${wt}]`)?._tippy?.show()), this.isClicked = !1, this.element.hasAttribute("aria-activedescendant") || this.highlightedItem === this.element ? this.highlightedItem !== this.element && this.focusItem(this.highlightedItem) : this.setAriaActiveDescendant(this.highlightedItem), Qi(this.element), this.highlightedItem && this.highlightedItem !== this.element && this.highlightedItem.setAttribute("tabindex", "-1");
  }
  /**
...
const Ca = ["content"], Oa = {
  ...
  setup(s, { expose: e }) {
    const { t } = Y(), i = He(), r = $t(), a = ge("iApi"), o = yi("el"), l = yi("contentEl"), n = f();
    e({ el: o });
    const c = s, u = P(() => a.fixture.get("appbar") ? r.temporary : []), p = P(() => i.mobileView), d = P(() => i.reorderable), g = (b) => b.scrollHeight > b.clientHeight, h = () => !p.value && !c.panel.teleport, m = (b) => {
    ...
    return Ye(() => {
      ...
      return M((v(), A("div", {
        ...
        s.header ? (v(), A("header", Oa, [
          ...
          M((v(), A("h2", ka, [
            b.$slots.header ? Me(b.$slots, "header", { key: 0 }) : (v(), A("div", Ma, D(I(t)(s.panel.alertName)), 1))
          ])), [
            [Gt]
          ]),
          ...
          y("div", {
            ...
            s.panel.teleport ? U("", !0) : (v(), A("div", Pa, [
              d.value ? (v(), W(V, {
                key: 0,
                onClick: $[1] || ($[1] = (R) => m("left")),
                active: !s.panel.isLeftMostPanel
              }, null, 8, ["active"])) : U("", !0),
              d.value ? (v(), W(Q, {
                key: 1,
                onClick: $[2] || ($[2] = (R) => m("right")),
...
class Zo {
  ...
  _isFullscreen;
  constructor(e, t, i) {
    console.log("Instance constructor starting now"), console.time("Instance"), this.event = new Js(this);
    const r = Xo(e, this);
  ...
  initialize(e, t, i) {
    ...
    if (t?.configs !== void 0) {
      ...
      const u = setInterval(() => {
        ...
        h && (console.timeEnd("Map Creating"), console.time("Map Initializing"), clearInterval(u), this.geo.map.createMap(c.map, h).then(() => {
          if (console.timeEnd("Map Initializing"), h._tippy.hide(0), o.setMaptipInstance(h._tippy), c.layers && c.layers.length > 0) {
            let m = 0;
            c.layers.forEach((w) => {
              const b = "Add To Map: Layer " + w.id;
              console.time(b);
              const $ = this.geo.layer.createLayer(w);
              this.geo.map.addLayer($, m).then(() => console.timeEnd(b)).catch(() => {
              }), $.mapLayer && m++;
            });
          }
        }));
      ...
      this.ui.getZoomIcon = () => g, this.ui.formatNumber = (h) => this.ui.suppressNumberLocalization ? h.toString() : this.$i18n.n(h, "number"), this.ui.escapeHtml = (h) => {
        ...
        return h.replace(/[<>"']/g, (w) => m[w]);
      }, this.ui.isPlainText = (h) => typeof h == "string" ? !this.containsValidHtml(h) && !this.representsObject(h) : !1;
    }
    i || (i = {});
    const l = st(this.$vApp.$pinia);
    i?.startRequired ? (this.startRequired = !0, l.started = !1) : (this.startRequired = !1, l.started = !0, console.timeEnd("Instance"), console.time("Map Creating"), this.event.emit(E.MAP_START)), e && (i.loadDefaultFixtures !== !1 || t?.startingFixtures !== void 0) ? this.fixture.addDefaultFixtures(t?.startingFixtures) : e || this.fixture.restore(), i.loadDefaultEvents !== !1 && !this._eventsOn && (this.event.addDefaultEvents(), this._eventsOn = !0);
  }
  /**
   ...
   */
  reloadWorker(e, t) {
    const i = st(this.$vApp.$pinia), r = Le(this.$vApp.$pinia), a = pe(this.$vApp.$pinia), o = ye(this.$vApp.$pinia), l = _e(this.$vApp.$pinia), n = Jt(this.$vApp.$pinia), c = !!e;
...
class sn extends Qo {
  ...
  addLayer(e, t = void 0) {
    return new Promise((i, r) => {
      this.esriMap || (this.noMapErr(), r());
      const a = "Layer Initiate " + e.id;
      if (console.time(a), e.initiationState !== N.INITIATING && e.initiationState !== N.INITIATED && e.layerState !== q.ERROR && e.initiate(), e.mapLayer && t === void 0) {
        const u = this.$iApi.geo.layer.layerOrderIds();
        if (e.isCosmetic)
          t = u.length;
        else {
          const p = this.$iApi.geo.layer.allLayers();
          let d = !0;
          for (let g = u.length - 1; g >= 0 && d; g--) {
            const h = p.find((m) => m.id === u[g]);
            h && !h.isCosmetic && (t = g + 1, d = !1);
          }
          d && (t = 0);
        }
      }
      ...
      let n = 0;
      const c = setInterval(() => {
        n += 250, n >= e.expectedTime.fail || e.layerState === q.ERROR ? (clearInterval(c), e.lastCancel < l && console.error(`Failed to add layer: ${e.id}.`), r()) : e.initiationState === N.INITIATED && (e.esriLayer || !e.mapLayer) && (console.timeEnd(a), clearInterval(c), e.mapLayer ? this.insertToEsriMap(e) : e.onLoad(), i());
      }, 250);
    });
  }
  /**
  ...
  async geoJsonToEsriJson(e, t) {
    ...
    r || (r = _.parseGeoJsonCrs(e.crs)), o.renderer = await C.RendererFromJson(c.renderer), o.fields = (o.fields || []).concat(
      t.fieldMetadata?.exclusiveFields ? this.extractGeoJsonFields(e).filter(
        (m) => t.fieldMetadata?.fieldInfo?.find((w) => w.name === m.name)
...
class rs extends ci {
  ...
  async initiate() {
    if (this.updateInitiationState(N.INITIATING), this.layerType === x.FEATURE) {
      const a = "FL Prefetch " + this.id;
      console.time(a), await C.PrefetchFeatureLayer(), console.timeEnd(a);
    }
    this.startTimer(
      "load"
      /* LOAD */
  ...
  onLoad() {
    ...
    const i = setTimeout(() => {
      t = !0, this.onError();
    }, this.expectedTime.fail), r = "Layer Load " + this.id;
    console.time(r);
    try {
      const a = this.onLoadActions();
      Promise.all(a).then(() => {
        clearTimeout(i), t ? this.visibility = !1 : (this.stopTimer(
          "load"
          /* LOAD */
        ), e > this.lastCancel && (this.loadPromDone && (this.loadDefProm = new H()), this.loadDefProm.resolveMe(), this.loadPromDone = !0, console.timeEnd(r), this.sublayers.forEach((o) => o.onLoad()), this.updateLayerState(q.LOADED)));
      }).catch(() => {
        clearTimeout(i), this.onError();
      });
    } catch (a) {
      console.error("Encountered error on layer load: ", a), clearTimeout(i), this.onError();
    }
  }
  onError(e = !0) {
...
class ui extends Ke {
  ...
  filter;
  constructor(e, t) {
    super(e, t), this.supportsIdentify = !0, this.geomType = T.UNKNOWN, this.serviceUrl = "", this.fieldList = "", this.canModifyLayer = !0, this.filter = new Wi(e.permanentFilteredQuery || "", e.initialFilteredQuery || ""), this.hovertips = e.state?.hovertips ?? !0, this.attribs = new os();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
...
class zn extends J {
  ...
  async symbolToSvg(e) {
    ...
    const a = tt(r).size(this.CONTAINER_SIZE, this.CONTAINER_SIZE).viewbox(0, 0, this.CONTAINER_SIZE, this.CONTAINER_SIZE), o = {
      ...
      "picture-fill"() {
        const h = e.imageData ? `data:${e.contentType};base64,${e.imageData}` : e.url, m = e.width * e.xscale, w = e.height * e.yscale;
        e.outline = e.outline || c;
        const b = g(e.outline.color), $ = d({
          color: b.colour,
          opacity: b.opacity,
...
class jn extends J {
   ...
   */
  constructor(e) {
    super(e), this.geom = ut.geom, this.proj = ut.proj, this.shared = ut.sharedUtils, this.map = new sn(e), this.layer = new gn(e), this.attributes = new Fn(e), this.query = new qn(e), this.symbology = new zn(e), Array.isArray(ft.request.interceptors) || (ft.request.interceptors = []), ft.request.interceptors.push({
      before: (t) => {
...
const Wn = /* @__PURE__ */ Object.assign({ "../fixtures/appbar/index.ts": () => import("./index-DsCW9MCq.js"), "../fixtures/areas-of-interest/index.ts": () => import("./index-CsYJrQyQ.js"), "../fixtures/basemap/index.ts": () => import("./index-Dnfg35E2.js"), "../fixtures/crosshairs/index.ts": () => import("./index-CLASFYFL.js"), "../fixtures/details/index.ts": () => import("./index-BtTkSuw5.js"), "../fixtures/draw/index.ts": () => import("./index-CT4sPx__.js"), "../fixtures/export-footnote/index.ts": () => import("./index-CGAWgTJK.js"), "../fixtures/export-legend/index.ts": () => import("./index-CjY-BTAt.js"), "../fixtures/export-map/index.ts": () => import("./index-D5nNTyyD.js"), "../fixtures/export-northarrow/index.ts": () => import("./index-Djwsr_id.js"), "../fixtures/export-scalebar/index.ts": () => import("./index-DNTMv6NA.js"), "../fixtures/export-timestamp/index.ts": () => import("./index-B_caPFg1.js"), "../fixtures/export-title/index.ts": () => import("./index-D6o8Kv1g.js"), "../fixtures/export/index.ts": () => import("./index-BAREdx8K.js"), "../fixtures/extentguard/index.ts": () => import("./index-yAgoGQW5.js"), "../fixtures/gazebo/index.ts": () => import("./index-CBQjLB2J.js"), "../fixtures/geosearch/index.ts": () => import("./index-BPQOEZzL.js"), "../fixtures/grid/index.ts": () => import("./index-xKjRhSTx.js"), "../fixtures/help/index.ts": () => import("./index-unHufCNf.js"), "../fixtures/hilight/index.ts": () => import("./index-BkjGPziz.js"), "../fixtures/layer-reorder/index.ts": () => import("./index-C32k_wUO.js"), "../fixtures/legend/index.ts": () => import("./index-Bn24_UPp.js"), "../fixtures/mapnav/index.ts": () => import("./index-Bb4MHMo5.js"), "../fixtures/metadata/index.ts": () => import("./index-CXdQ5ANe.js"), "../fixtures/northarrow/index.ts": () => import("./index-BdD0SkQj.js"), "../fixtures/overviewmap/index.ts": () => import("./index-Cd2-Is2x.js"), "../fixtures/panguard/index.ts": () => import("./index-BcaNPJwU.js"), "../fixtures/scrollguard/index.ts": () => import("./index-Ci3V092k.js"), "../fixtures/settings/index.ts": () => import("./index-D6BDs0r-.js"), "../fixtures/snowman/index.ts": () => import("./index-BLB-Ufzb.js"), "../fixtures/swipe/index.ts": () => import("./index-tyaRdejI.js"), "../fixtures/wizard/index.ts": () => import("./index-wuraS6gU.js") });
class Hn extends J {
  /**
...
const Xn = /* @__PURE__ */ Ne(Kn, [["render", Zn], ["__scopeId", "data-v-a3c61802"]]), Qn = /* @__PURE__ */ Object.assign({ "../fixtures/areas-of-interest/screen.vue": () => import("./screen-BcomQ86b.js"), "../fixtures/basemap/screen.vue": () => import("./screen-Ciwgh8EG.js"), "../fixtures/export/screen.vue": () => import("./screen-EraePOMS.js"), "../fixtures/geosearch/screen.vue": () => import("./screen-DTwcKKkf.js"), "../fixtures/grid/screen.vue": () => import("./screen-Cc6PTh3o.js"), "../fixtures/help/screen.vue": () => import("./screen--D_VtUY1.js"), "../fixtures/layer-reorder/screen.vue": () => import("./screen-B9zYdi--.js"), "../fixtures/legend/screen.vue": () => import("./screen-Dv4ooL7b.js"), "../fixtures/metadata/screen.vue": () => import("./screen-r4XLFKUr.js"), "../fixtures/settings/screen.vue": () => import("./screen-BHwUe3kz.js"), "../fixtures/wizard/screen.vue": () => import("./screen-DsJ99Cb5.js") });
class St extends J {
  /**
   * ID of this panel.
   *
...
var rt = { major: "4", minor: "13", patch: "0-beta", timestamp: "Thu Jun 19 14:10:05 2025 -0400", hash: "7e910c06b94a107ce9cb56fbc5cf5708289382f5" };
console.info(
...
const Yl = (s, e, t) => new Zo(s, e, t), ut = new qs();
export {
  H as $,
  Ur as A,
  yt as B,
