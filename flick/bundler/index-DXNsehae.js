...
import { _ as H, d as L, F as X, G as ee } from "./main-Be3JXPFA.js";
...
const G = /* @__PURE__ */ H(ne, [["render", ae]]), se = /* @__PURE__ */ T({
  ...
  setup(h) {
    ...
    const p = [
      {
        type: "point",
        icon: g(_(() => import("./point-icon-CmsB-xzL.js")))
      },
      {
        type: "polyline",
        icon: g(_(() => import("./polyline-icon-WR4lB4Pv.js")))
      },
      {
        type: "polygon",
        icon: g(_(() => import("./polygon-icon-CEEzRQys.js")))
      },
      {
        type: "circle",
        icon: g(_(() => import("./circle-icon-BqBbWWPl.js")))
      },
      {
        type: "rectangle",
        icon: g(_(() => import("./rectangle-icon-CfQpdrta.js")))
      }
    ], a = A(() => {
      const s = p.filter((u) => e.supportedTypes.some((x) => x.type === u.type));
      return s.push({
        type: "edit",
        icon: g(_(() => import("./edit-icon-vMJm8mbr.js")))
      }), s;
    }), n = (s) => {
