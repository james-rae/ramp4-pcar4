...
var De = /* @__PURE__ */ ((s) => (s.BLOB = "blob", s.DATE = "date", s.DOUBLE = "double", s.GEOMETRY = "geometry", s.GLOBAL_ID = "global-id", s.GUID = "guid", s.INTEGER = "integer", s.LONG = "long", s.OID = "oid", s.RASTER = "raster", s.SINGLE = "single", s.SMALL_INTEGER = "small-integer", s.STRING = "string", s.XML = "xml", s))(De || {}), Fe = /* @__PURE__ */ ((s) => (s.CIRCLE = "circle", s.CROSS = "cross", s.DIAMOND = "diamond", s.ICON = "icon", s.PATH = "path", s.SQUARE = "square", s.TRIANGLE = "triangle", s.X = "x", s))(Fe || {}), ve = /* @__PURE__ */ ((s) => (s.DASH = "dash", s.DASHDOT = "dash-dot", s.DASHDOTDOT = "short-dash-dot-dot", s.DOT = "dot", s.LONGDASH = "long-dash", s.LONGDASHDOT = "long-dash-dot", s.LONGDASHDOTDOT = "long-dash-dot-dot", s.NONE = "none", s.NULL = "none", s.SHORTDASH = "short-dash", s.SHORTDASHDOT = "short-dash-dot", s.SHORTDASHDOTDOT = "short-dash-dot-dot", s.SHORTDOT = "short-dot", s.SOLID = "solid", s))(ve || {}), zi = /* @__PURE__ */ ((s) => (s.BEVEL = "bevel", s.MITER = "miter", s.ROUND = "round", s))(zi || {}), Bi = /* @__PURE__ */ ((s) => (s.ROUND = "round", s.BUTT = "butt", s.SQUARE = "square", s))(Bi || {}), qi = /* @__PURE__ */ ((s) => (s.BDIAG = "backward-diagonal", s.CROSS = "cross", s.DIAG_CROSS = "diagonal-cross", s.FDIAG = "forward-diagonal", s.HORIZONTAL = "horizontal", s.NONE = "none", s.NULL = "none", s.SOLID = "solid", s.VERTICAL = "vertical", s))(qi || {}), $ = /* @__PURE__ */ ((s) => (s.POINT = "Point", s.MULTIPOINT = "MultiPoint", s.LINESTRING = "LineString", s.MULTILINESTRING = "MultiLineString", s.POLYGON = "Polygon", s.MULTIPOLYGON = "MultiPolygon", s.LINEARRING = "LinearRing", s.EXTENT = "Extent", s.NONE = "None", s.UNKNOWN = "Unknown", s))($ || {}), Gt = /* @__PURE__ */ ((s) => (s.Simple = "simple", s.Unique = "uniqueValue", s.ClassBreaks = "classBreaks", s.Unknown = "unknown", s))(Gt || {}), S = /* @__PURE__ */ ((s) => (s.FEATURE = "esri-feature", s.MAPIMAGE = "esri-map-image", s.TILE = "esri-tile", s.VECTORTILE = "esri-vector-tile", s.IMAGERY = "esri-imagery", s.IMAGERYTILE = "esri-imagery-tile", s.GRAPHIC = "esri-graphic", s.WMS = "ogc-wms", s.WFS = "ogc-wfs", s.GEOJSON = "file-geojson", s.GEOJSONZIPPED = "file-zip-geojson", s.CSV = "file-csv", s.SHAPEFILE = "file-shape", s.FLATGEOBUF = "file-fgb", s.FLATGEOBUFZIPPED = "file-zip-fgb", s.OSM = "osm-tile", s.DATACSV = "data-csv", s.DATAJSON = "data-json", s.DATATABLE = "data-esri-table", s.UNKNOWN = "unknown", s.SUBLAYER = "sublayer", s))(S || {}), ge = /* @__PURE__ */ ((s) => (s.FEATURE = "feature", s.GRAPHIC = "graphic", s.IMAGERY = "imagery", s.IMAGERYTILE = "imagery-tile", s.MAPIMAGE = "map-image", s.NOLAYER = "no-layer", s.OSM = "osm-tile", s.TILE = "tile", s.UNKNOWN = "unknown", s.VECTORTILE = "vector-tile", s.WMS = "wms", s))(ge || {}), le = /* @__PURE__ */ ((s) => (s.ESRI_FEATURE = "esriFeature", s.ESRI_RASTER = "esriRaster", s.ESRI_TILE = "esriTile", s.OSM_TILE = "osmTile", s.OGC_RASTER = "ogcRaster", s.UNKNOWN = "unknown", s))(le || {}), K = /* @__PURE__ */ ((s) => (s.POINT = "Point", s.MULTIPOINT = "MultiPoint", s.LINESTRING = "LineString", s.MULTILINESTRING = "MultiLineString", s.POLYGON = "Polygon", s.MULTIPOLYGON = "MultiPolygon", s))(K || {}), oe = /* @__PURE__ */ ((s) => (s.GEOMETRIC = "geometric", s.SYMBOLIC = "symbolic", s.HYBRID = "hybrid", s.NONE = "none", s))(oe || {}), j = /* @__PURE__ */ ((s) => (s.NEW = "new", s.INITIATING = "initiating", s.INITIATED = "initiated", s.TERMINATING = "terminating", s.TERMINATED = "terminated", s))(j || {}), Z = /* @__PURE__ */ ((s) => (s.NEW = "new", s.LOADING = "loading", s.LOADED = "loaded", s.ERROR = "error", s))(Z || {}), ye = /* @__PURE__ */ ((s) => (s.NOT_LOADED = "not-loaded", s.NOT_VISUAL = "not-visual", s.REFRESH = "refresh", s.UP_TO_DATE = "up-to-date", s))(ye || {}), ft = /* @__PURE__ */ ((s) => (s.ESRI = "esri", s.TEXT = "text", s.IMAGE = "image", s.HTML = "html", s.XML = "xml", s.JSON = "json", s.UNKNOWN = "unknown", s))(ft || {}), de = /* @__PURE__ */ ((s) => (s.SYMBOL = "symbol", s.GRID = "grid", s.EXTENT = "extent", s.INITIAL = "initial", s.API = "api", s.PERMANENT = "permanent", s))(de || {}), ee = /* @__PURE__ */ ((s) => (s.BoundaryZoom = "boundaryZoom", s.Datatable = "datatable", s.Identify = "identify", s.Metadata = "metadata", s.Opacity = "opacity", s.Refresh = "refresh", s.Reload = "reload", s.Remove = "remove", s.Settings = "settings", s.Symbology = "symbology", s.Visibility = "visibility", s))(ee || {});
class $e {
  attributes;
  geometry;
  style;
...
class ie extends rt {
  ...
  rawArray;
  constructor(e, t, i, r) {
    super(e, t.sr || i), r ? this.rawArray = t.slice() : this.rawArray = ie.parseXY(t);
  }
  ...
  static fromESRI(e, t) {
    return new ie(t, [e.x, e.y], T.fromESRI(e.spatialReference), !0);
  }
  toESRI() {
    return new _s({
      x: this.x,
  ...
  static fromGeoJSON(e, t) {
    return new ie(t, e.coordinates, T.fromGeoJSON(e.crs), !0);
  }
  toGeoJSON() {
...
class Ae extends rt {
  ...
  rawArray;
  constructor(e, t, i, r) {
    super(e, t.sr || i), r ? this.rawArray = Ae.arrayDeepCopy(t) : t instanceof Ae ? this.rawArray = t.toArray() : this.rawArray = Ae.parsePointSet(t);
  }
  ...
  getAt(e) {
    return new ie(this.childIdGenerator(e), this.rawArray[e], this.sr, !0);
  }
...
class Xe extends Ae {
  constructor(e, t, i, r) {
    if (super(e, t, i, r), Xe.closeRing(this.rawArray), this.length < 4)
...
class he extends rt {
  ...
  constructor(e, t, i, r) {
    super(e, t.sr || i), r ? this.rawArray = he.arrayDeepCopy(t) : this.rawArray = he.parsePolygon(t);
  }
  addLinearRings(e) {
...
class Ge extends rt {
  rawArray;
  constructor(e, t, i, r) {
    super(e, t.sr || i), r ? this.rawArray = Ge.arrayDeepCopy(t) : this.rawArray = Ge.parseMultiPolygon(t);
  }
  addPolygon(e) {
...
class H extends rt {
  ...
  rawMax;
  constructor(e, t, i, r) {
    super(e, t.sr || r), this.rawMin = ie.parseXY(t), this.rawMax = ie.parseXY(i);
  }
  ...
  static fromGeoJSON(e, t) {
    ...
    }), new H(t, i, r, T.fromGeoJSON(e.crs));
  }
  toGeoJSON() {
...
class Bs {
  ...
  esriMapClickToRamp(e, t) {
    return {
      mapPoint: ie.fromESRI(e.mapPoint, t),
      screenX: e.x,
      screenY: e.y,
      button: e.button,
  ...
  graphicGeoJsonToRamp(e, t) {
    ...
    return Object.keys(e.properties.forEach((o) => r[o] = e.properties[o])), new $e(i, "", r);
  }
  /**
...
class Hs {
  ...
  async projectGeoJson(e, t, i) {
    let r, a;
    if (t ? r = this.normalizeProj(t) : r = T.parseGeoJsonCrs(e.crs), i ? a = this.normalizeProj(i) : a = js, a === r)
      return e;
    await this.checkProjBomber([r, a]);
    const o = me(r, a).forward;
    return ks(e, o);
  }
  /**
  ...
  async projectGeometry(e, t) {
    ...
    const i = t.toGeoJSON(), r = await this.projectGeoJson(i, this.normalizeProj(t.sr), this.normalizeProj(e)), a = et.geom.geomGeoJsonToRamp(r, t.id);
...
const Ft = W("appbar", () => {
  ...
  function i(o) {
    if (s.value = { ...s.value, [o.id]: ne(o) }, o.id in e.value)
  ...
  defaultHandlerFactory(e) {
    ...
    switch (e) {
      ...
      case "ramp_map_basemap_checks_tile_proj":
        t = (i) => {
          i.schemaChanged && this.$iApi.geo.layer.allLayers().filter((r) => r.dataFormat === le.ESRI_TILE && r.schemaLocked).forEach((r) => {
            r.checkProj();
          });
...
const Dt = W("maptip", () => {
  ...
  __name: "esri-map",
  setup(s) {
    const e = Dt(), t = Se("iApi"), i = D(() => e.maptipPoint), r = D(() => e.maptipInstance), a = D(() => e.content), o = Le([]), l = f(!1);
    o.push(
      Ot(i, () => {
        if (i.value) {
  ...
  constructor(e) {
    this.resizeObserver = new ResizeObserver((t) => {
      t.length && window.requestAnimationFrame(() => {
        t.forEach((i) => {
          const r = i.target.dataset.breakpoints, a = r ? JSON.parse(r) : e ?? sr;
...
const rr = ["data-cy"], Ki = /* @__PURE__ */ N({
  ...
  setup(s) {
    ...
    return (n, c) => {
      ...
      return b(), w("div", {
        class: ce(["shadow-tm bg-white h-full xs:mr-0 sm:mr-12 last:mr-0 pointer-events-auto min-w-0 shrink-0", s.panel.expanded ? "flex-grow max-w-full" : ""]),
        ...
        fe(Ni, {
          ...
          default: ue(() => [
            U((b(), te(ys(s.panel.route.screen), gs({ class: "h-full" }, s.panel.route.props, { panel: s.panel }), null, 16, ["panel"])), [
              [u]
            ])
          ]),
          _: 1
  ...
  const s = f(void 0), e = f(void 0), t = f(0), i = f(0), r = f(!1), a = f(!0), o = f({}), l = f({}), n = f([]), c = f([]), u = f([]), p = f(1), d = D(() => i.value);
  function g(E) {
  ...
  function h(E) {
    const L = [];
    return E.forEach((X) => {
      X in l.value && L.push(l.value[X].getPromise());
    }), L;
  }
  function m(E) {
  ...
  function O() {
    let E = t.value;
    const L = [], X = 350, we = 12, je = 600;
    for (let Ie = n.value.length - 1; Ie >= 0; Ie--) {
      const nt = n.value[Ie];
      let Ne = nt.width || X;
      if (r.value ? Ne = E : Ne += we, nt.id === "grid" && (Ne = Math.max(Math.min(Ne, E), je)), (E >= Ne && !r.value || L.length === 0) && (E -= Ne, L.unshift(nt)), nt.id === "grid" && E < je)
        break;
    }
    if (s.value && //@ts-expect-error TODO: explain why this is needed or remove
    !L.includes(s.value) && !r.value) {
      let Ie;
      for (let mi = 0; mi < L.length - 1 && E < (s.value.width || X) + we; mi++)
        Ie = L.shift(), E += Ie.width || X;
      E >= (s.value.width || X) ? L.unshift(s.value) : e.value || (Ie = L.shift(), L.unshift(s.value));
      const nt = n.value.indexOf(s.value), Ne = n.value.indexOf(Ie), zt = n.value.slice();
      Ne > -1 && (zt.splice(nt, 1), zt.splice(Ne, 0, s.value)), n.value = zt;
    }
    i.value = E, u.value = L;
  }
  function F(E) {
  ...
  function P(E, L) {
    const X = n.value.indexOf(E), we = L === "right" ? 1 : -1;
  ...
  function q(E) {
    ...
    L !== -1 && (u.value = [...u.value.slice(0, L), ...u.value.slice(L + 1)]), s.value && s.value.id == E.id && (s.value = void 0);
  }
  function J(E) {
    l.value = {
      ...l.value,
  ...
  setup(s) {
    ...
    const e = it(), t = Se("iApi"), i = f(), r = D(() => e.opacity), a = D(() => e.mobileView);
    st(() => {
    ...
    return (u, p) => (b(), te(Fi, {
      ...
      default: ue(() => [
        (b(!0), w(tt, null, bt(o(I(t).screenSize), (d) => (b(), te(Ki, {
          key: `${d.id}`,
          panel: d
        }, null, 8, ["panel"]))), 128))
      ]),
  ...
  setup(s) {
    const e = f(!1), t = f(null), i = Le([]), r = f(), a = f(), o = f(), l = s;
    i.push(
      Ot(e, () => {
        t.value.update();
      })
    ...
    return st(() => {
      ...
      return b(), w("div", {
        ...
        U(y("div", {
          ...
          class: ce(["rv-dropdown shadow-md border border-gray:200 py-8 bg-white rounded z-10", { "text-center": s.centered }]),
          ref_key: "dropdown",
          ref: a
        }, [
          Ve(p.$slots, "default", {
  ...
  setup(s) {
    const e = ze(), { t } = se(), i = D(() => e.notificationNumber), r = () => e.clearAll();
    return (a, o) => {
      const l = ae("panel-screen"), n = G("tippy");
      return b(), te(l, { panel: s.panel }, {
        header: ue(() => [
...
var xe = /* @__PURE__ */ ((s) => (s.ERROR = "error", s.INFO = "info", s.WARNING = "warning", s))(xe || {});
class dr extends re {
  notificationStore;
  /**
...
const hr = ["content"], fr = { class: "flex items-center text-left" }, mr = { class: "select-text cursor-text" }, yr = ["content", "aria-label"], gr = {
  ...
  emits: ["remove"],
  setup(s, { emit: e }) {
    const { t } = se(), i = e, r = s, a = f(!1), o = Le({
      [xe.WARNING]: "⚠",
      [xe.INFO]: "ℹ️",
      [xe.ERROR]: "❌"
    }), l = () => {
      if (!r.notification.messageList)
        return !1;
    };
    return (n, c) => {
      const u = G("tippy");
      return U((b(), w("li", {
        class: ce(["flex-col default-focus-style p-4", s.notification.messageList ? "cursor-pointer" : ""]),
        content: I(t)(a.value ? "notifications.controls.collapse" : "notifications.controls.expand"),
        onClick: c[1] || (c[1] = (p) => a.value = !a.value)
      }, [
        y("div", fr, [
          y("span", null, [
            ht(z(o[s.notification.type]) + " ", 1),
            y("span", mr, z(s.notification.message), 1)
          ]),
          c[4] || (c[4] = y("span", { class: "flex-grow" }, null, -1)),
          s.notification.messageList ? (b(), w("div", {
            key: 0,
        ...
        s.notification.messageList && a.value ? (b(), w("div", gr, [
          (b(!0), w(tt, null, bt(s.notification.messageList, (p, d) => (b(), w("p", {
  ...
  setup(s) {
    const e = ze(), { t } = se(), i = f(), r = f({}), a = () => {
      ...
      const p = n.value[u];
      p && It(() => {
        const d = r.value[p.id].$el ?? r.value[p.id];
        if (d) {
      ...
      return b(), w("div", null, [
        n.value.length > 0 ? U((b(), w("ul", {
          ...
          (b(!0), w(tt, null, bt(n.value, (h, m) => (b(), w(tt, {
            ...
            U(fe(vr, {
              ref_for: !0,
              ref: (A) => A ? r.value[h.id] = A : delete r.value[h.id],
              class: ce([h.type]),
              notification: h,
              onRemove: (A) => l(m)
  ...
  setup(s) {
    const { t: e } = se(), t = Se("iApi"), i = () => {
      t.reload();
    }, r = D(() => `${wt.major}.${wt.minor}.${wt.patch}`), a = D(() => wt.hash.slice(0, 9)), o = D(() => {
  ...
  const s = f(), e = f({}), t = f(!1), i = f([]), r = f(), a = f("idle"), o = ["H", "?"];
  function l() {
  ...
  function u(_) {
    s.value === _ && (s.value = void 0), delete e.value[_];
  }
  function p(_, M, P) {
    if (_) {
      if (_ === "clear") {
  ...
  function d(_, M, P) {
    s.value = _, !P?.suppressHandler && e.value[_]?.activeHandler?.(F, M);
  }
  function g(_, M) {
    s.value && !M?.suppressHandler && e.value[s.value]?.deactiveHandler?.(F, _), s.value = void 0;
  }
  function h(_, M) {
    const P = s.value;
    if (!P) return;
  ...
  function m(_) {
    g(_?.event, { suppressHandler: _?.suppressHandler }), _?.preserveChain || (i.value = []), _?.preserveLastAction || (r.value = void 0), a.value = "idle";
  }
  function A(_) {
    i.value = [..._];
  }
  ...
  __name: "map-caption",
  setup(s) {
    const e = Je(), t = Xi(), i = be(), { t: r } = se(), a = Se("iApi"), o = D(() => e.scale), l = D(() => e.attribution), n = D(() => e.coords), c = D(() => e.langtoggle), u = D(() => i.config.map), { keyChain: p, lastAction: d, chainState: g, namespaces: h, activeNamespace: m } = hs(t), A = D(() => {
      ...
      if (P)
        if (P.namespace === jr)
          M = r("keyboardnav.chain.help");
        else {
          const J = `keyboardnav.key.${P.namespace}.${P.key}`, E = r(J);
          E !== J && (M = E);
        }
      let q;
      if (g.value === "awaitNamespace") {
        const J = `H - ${r("keyboardnav.chain.help")}`, E = Object.keys(h.value).map((X) => {
          const we = `keyboardnav.ns.${X}`, je = r(we);
          return `${X} - ${je === we ? X : je}`;
        });
        q = `[${[J, ...E].join(", ")}]`;
      } else if (g.value === "awaitAction") {
        const J = m.value ?? p.value[1], E = J ? h.value[J] : void 0;
        E && E.keys?.length && (q = `[${E.keys.map((X) => {
          const we = `keyboardnav.key.${J}.${X.key}`, je = r(we), Ie = je === we ? X.key : je;
          return `${X.key} - ${Ie}`;
        }).join(", ")}]`);
      }
      return {
    ...
    }, O = (F = !1) => r(F ? "map.toggleScaleToMetric" : "map.toggleScaleToImperial");
    return (F, _) => {
      ...
      return b(), w("div", Hr, [
        ...
        y("div", sa, [
          ...
          c.value?.disabled ? B("", !0) : (b(), te(M, {
            key: 2,
            class: "flex-shrink-0 pointer-events-auto focus:outline-none px-4 mr-4 relative top-2",
            position: "top-end",
            tooltip: I(r)("map.changeLanguage"),
            ariaLabel: `${I(r)("map.language.short")} - ${I(r)("map.changeLanguage")}`,
            tooltipPlacement: "top-start",
            tooltipPlacementAlt: "left-end"
          }, {
            header: ue(() => [
              y("span", na, z(I(r)("map.language.short")), 1)
            ]),
            default: ue(() => [
              (b(!0), w(tt, null, bt(v.value, (J, E) => (b(), w("a", {
                ...
                ht(z(I(r)("map.language." + J)) + " ", 1),
                J === I(a).$i18n.locale.value ? (b(), w("span", ca, z(I(r)("map.language.curr")), 1)) : B("", !0)
              ], 10, la))), 128))
            ]),
            _: 1
          }, 8, ["tooltip", "ariaLabel"]))
  ...
  setup(s) {
    const e = ze(), t = Se("iApi"), { t: i } = se(), r = D(() => e.notificationNumber);
    return (a, o) => {
      const l = G("tippy");
      return U((b(), w("button", {
        type: "button",
        ...
        r.value && r.value > 0 ? (b(), w("span", da, z(r.value), 1)) : B("", !0)
      ], 8, pa)), [
        [l]
      ]);
    };
  ...
  setup(s) {
    const e = Se("iApi"), { t } = se(), i = f(!1), r = f(["app", "lists", "map", "keyboardNav"]), a = f([]), o = f(null), l = f(null);
    st(() => {
      a.value.push(
    ...
    return (c, u) => {
      ...
      return i.value ? (b(), w("div", {
        ...
        y("div", {
          ...
          (b(!0), w(tt, null, bt(r.value, (d) => (b(), w("p", {
  ...
  __name: "shell",
  setup(s) {
    const e = Se("iApi"), t = ut(), i = Ee(), r = it(), { t: a } = se(), o = D(() => i.items.appbar), l = () => {
    ...
    return (c, u) => (b(), w("div", va, [
      y("div", ba, [
        ...
        o.value ? B("", !0) : (b(), te(fa, { key: 0 })),
        fe(ua, { class: "z-30" })
      ]),
      I(t).started ? (b(), te(ir, { key: 0 })) : (b(), w("div", wa, u[1] || (u[1] = [
        y("div", { class: "spinner relative inset-x-1/2 inset-y-9/20" }, null, -1)
      ]))),
      (b(!0), w(tt, null, bt(n(), (p) => (b(), te(ws, {
  ...
  setup() {
    const s = Es();
    st(() => {
      new Ji().observe(s?.proxy?.$refs["app-size"]), Ns({
        aria: {
          content: "labelledby"
        },
        theme: "ramp4",
...
const La = /* @__PURE__ */ qe(Sa, [["render", Ta]]), Oe = "focus-list", He = "focus-item", Ra = "focus-icon", $a = "focus-container", yt = `[${Oe}],[${$a}]`, Tt = "truncate-text", Lt = "show-truncate", dt = "focused", Zt = `button,input,select,a,textarea,[contenteditable],[${Oe}],[${Ra}],[tabIndex]`, Ca = {
  mounted(s, e) {
    +s.getAttribute("tabindex") <= 0 && s.setAttribute("tabindex", "0"), s.toggleAttribute(Oe, !0), new Oa(s, e.value);
  },
  updated(s) {
    es(s);
  }
...
function es(s) {
  s.querySelectorAll(Zt).forEach((t) => {
    if (t.closest(yt) === s || t.closest(yt) === t && t.parentElement.closest(yt) === s)
...
class Oa {
  ...
  constructor(e, t) {
    ...
    e.addEventListener("keydown", function(r) {
      ...
      i.onTouchstart();
    }), e.addEventListener("switchFocusItem", (r) => {
  ...
  setTabIndex(e, t = this.element) {
    t.querySelectorAll(Zt).forEach((r) => {
      (e === -1 || r.closest(yt) === this.element || r.closest(yt) === r && r.parentElement.closest(yt) === this.element || r.closest(`[${Oe}],.${dt}`).classList.contains(dt)) && r.setAttribute("tabindex", e.toString());
    });
  }
  /**
  ...
  onKeydown(e) {
    const t = this, i = Array.prototype.filter.call(
      ...
      (r) => r.closest(`[${Oe}]`) === t.element && !!r.offsetParent
    );
    if (i.length !== 0)
      switch (e.key) {
        case "Up":
        ...
        case "Tab":
          ...
          this.highlightedItem !== this.element && a && (r && this.defocusItem(this.highlightedItem), e.shiftKey && i.length > 1 && (e.preventDefault(), e.stopPropagation(), this.defocusItem(this.highlightedItem), this.highlightedItem = this.element, this.element.removeAttribute("aria-activedescendant"), this.element.focus()));
      }
  }
  /**
...
const wi = "focus-item", ka = {
  beforeMount(s, e) {
    s.hasAttribute("id") || s.setAttribute("id", Ma()), e.value ? s.setAttribute(wi, e.value) : s.toggleAttribute(wi, !0);
  }
};
function Ma() {
  let s;
...
const Na = {
  mounted(s) {
    [...document.querySelectorAll(".inner-shell")].some((t) => t.contains(s)) && Ht.push(new Fa(s));
  },
  beforeUnmount(s) {
    Ht = Ht.filter((e) => e.element === s ? (e.removeEventListeners(), !1) : !0);
  }
};
class Fa {
  element;
...
const Da = "truncate-text", Ga = "truncate-trigger", Ua = {
  beforeMount(s, e) {
    !s.classList.contains("truncate") && !e.value?.noTruncateClass && s.classList.add("truncate"), s.toggleAttribute(Da, !0);
  },
  mounted(s, e) {
    let t;
    e.value && e.value.externalTrigger && (t = s.closest(`[${Ga}]`)), Fs(s, {
...
const Ba = ["content"], qa = {
  ...
  setup(s, { expose: e }) {
    const { t } = se(), i = it(), r = Ft(), a = Se("iApi"), o = yi("el"), l = yi("contentEl"), n = f();
    e({ el: o });
    const c = s, u = D(() => a.fixture.get("appbar") ? r.temporary : []), p = D(() => i.mobileView), d = D(() => i.reorderable), g = (v) => v.scrollHeight > v.clientHeight, h = () => !p.value && !c.panel.teleport, m = (v) => {
    ...
    return st(() => {
      ...
      return U((b(), w("div", {
        ...
        s.header ? (b(), w("header", qa, [
          fe(Y, {
            class: ce(s.panel.teleport ? "display-none" : "block sm:display-none"),
            onClick: C[0] || (C[0] = (L) => s.panel.close())
          }, null, 8, ["class"]),
          U((b(), w("h2", ja, [
            v.$slots.header ? Ve(v.$slots, "header", { key: 0 }) : (b(), w("div", Ha, z(I(t)(s.panel.alertName)), 1))
          ])), [
            [q]
          ]),
          v.$slots.controls ? (b(), te(R, { key: 0 }, {
            default: ue(() => [
              Ve(v.$slots, "controls")
            ]),
            _: 3
          ...
          y("div", {
            class: ce(s.panel.teleport ? "flex" : "display-none sm:flex")
          }, [
            s.panel.teleport ? B("", !0) : (b(), w("div", Wa, [
              d.value ? (b(), te(V, {
                key: 0,
              ...
              fe(F, {
                onClick: C[3] || (C[3] = (L) => s.panel.pin()),
                active: s.panel.isPinned
              }, null, 8, ["active"]),
              s.panel.controls && s.panel.controls.expand ? (b(), te(_, {
                key: 2,
                onClick: C[4] || (C[4] = (L) => s.panel.expand()),
                active: s.panel.expanded
              }, null, 8, ["active"])) : B("", !0)
            ])),
            s.panel.button && u.value?.includes(s.panel.id) ? (b(), te(M, {
              key: 1,
              onClick: C[5] || (C[5] = (L) => s.panel.minimize())
            })) : B("", !0),
            fe(P, {
              onClick: C[6] || (C[6] = (L) => s.panel.close())
            })
          ], 2)
        ])) : B("", !0),
        s.content ? (b(), w("div", {
  ...
  setup(s) {
    ...
    return (t, i) => {
      ...
      return b(), w("div", Za, [
        U((b(), w("button", {
          type: "button",
          class: ce(["text-gray-500 hover:text-black focus:text-black p-8", { "text-gray-700": s.active }]),
  ...
  setup(s) {
    ...
    return (t, i) => {
      ...
      return b(), w("div", ho, [
        U((b(), w("button", {
          type: "button",
          class: ce(["text-gray-500 hover:text-black focus:text-black p-6", { "text-gray-700": s.active }]),
  ...
  setup(s) {
    ...
    const r = async () => {
      ...
      const n = new ie("geolocation", l, T.latLongSR(), !0);
  ...
  setup(s) {
    return (e, t) => {
      const i = G("focus-item"), r = G("tippy");
      return b(), w("div", Ro, [
        U((b(), w("button", {
          type: "button",
  ...
  setup(s) {
    const e = Se("iApi"), t = s, i = () => e.event.emit(x.APPBAR_BUTTON_CLICK, t.buttonId);
    return (r, a) => {
...
class Vo {
  ...
  fsaToProvince(e) {
    ...
    return r === "X" ? i === "X0A" || i === "X0B" || i === "X0C" ? t = 62 : t = 61 : t = Go[r], this.codeToProvince(t);
  }
}
function zo(s) {
  return new Vo(s);
  ...
  constructor(e, t) {
    _t.get(t).then((i) => {
      i.data.definitions.forEach((r) => {
        Rt[e][r.code] = r.term.split(`${r.code}-`)[1];
      }), Object.keys(Rt[e]).forEach((r) => {
        this.allTypes[r] = Rt[e][r], this.validTypes[r] = Rt[e][r];
      }), this.typesFetched = !0;
    });
  }
...
async function jo(s, e) {
  ...
  return r.test(e) && !s.disabledSearchTypes.includes("LAT/LNG") ? (i = e.slice(0, -1), t = new $t(s, i), await Jo(t)) : o.test(e) && !s.disabledSearchTypes.includes("FSA") ? (i = e.substring(0, 3).toUpperCase(), t = new $t(s, i), await Ko(t)) : a.test(e) && !s.disabledSearchTypes.includes("NTS") ? (i = e.substring(0, 6).toUpperCase(), t = new $t(s, i), await Zo(t)) : (i = encodeURIComponent(e.trim()), t = new $t(s, i), await Qo(t)), s.customSources.length && await Ho(t, s.customSources), t;
}
const ai = async (s) => {
  const [e, t] = await Re(_t.get(s));
...
}, is = (s, e) => e.filter((t) => s.types.validTypes[t.concise.code]).map((t) => ({
  name: t.name,
  flav: "nme",
  bbox: t.bbox,
  ...
  const i = (await Promise.all(e.map((r) => r.onSearch(s.query)))).flat();
  s.addResult(i);
}, ni = async (s) => {
  const [e, t] = await Re(ai(oi(s, !0)));
  return e ? (console.error("Geolocation service failed"), s.failedServs.push("geolocation"), []) : t;
}, Wo = async (s) => {
  const [e, t] = await Re(ai(oi(s, !1)));
  let i;
  e ? (console.error("GeoName service targeting Name failed"), s.failedServs.push("geoname"), i = []) : i = t.items, s.addResult(is(s.config, i));
}, Yo = async (s, e, t) => {
  const [i, r] = await Re(ai(oi(s, !1, e, t)));
  let a;
  i ? (console.error("GeoName service targeting Lat Lon failed"), s.failedServs.push("geoname"), a = []) : a = r.items, s.addResult(is(s.config, a));
}, Jo = async (s) => {
  ...
  const e = s.config;
  if (await Wo(s), e.categories.length === 0 || e.categories.includes("ADDR")) {
...
class Li {
   ...
   */
  async query(e) {
    const t = await jo(this.config, e.toUpperCase()), i = this.config.sortOrder.length, r = t.results.filter((n) => n.order < i), a = t.results.filter((n) => n.order >= i);
...
function Ri(s, e, t) {
  if (s && e.extent) {
    const i = e.extent;
    t = t.filter(
      (r) => r.bbox[0] <= i.xmax && r.bbox[1] <= i.ymax && r.bbox[2] >= i.xmin && r.bbox[3] >= i.ymin
    );
  }
...
const ss = W("geosearch", () => {
  const s = f(new Li("en", void 0)), e = f({
    ...
    province: "",
    extent: void 0
  }), t = f(!1), i = f(""), r = f(""), a = f(""), o = f([]), l = f([]), n = f(!1), c = f([]), u = D(
    () => s.value.fetchProvinces().then((R) => (R.sort((V, O) => V.name.localeCompare(O.name, void 0, { sensitivity: "case" })), R))
  ), p = D(
    () => new Promise((R) => {
      s.value.fetchTypes().then((V) => {
        V.sort(
  ...
  function h(R) {
    ...
    if (!V)
      ...
      const O = setInterval(() => {
        s.value.config.provinces.listFetched && s.value.config.types.typesFetched && (clearInterval(O), s.value.query(`${V}*`).then((F) => {
  ...
  function C(R) {
    ...
    R = g(R), r.value = Array.from(R).map((O) => Object.keys(V).includes(O) ? "[" + O + V[O] + "]" : O.replace(/["$!*+?^{}()|[\]\\]/g, "").replace(/[.\\]/g, "\\$&").trim()).join("");
  }
  function Y(R) {
...
var rs = /* @__PURE__ */ ((s) => (s.Visibility = "visibilityButton", s.Expand = "expandButton", s))(rs || {}), Qt = /* @__PURE__ */ ((s) => (s.Item = "item", s.Placeholder = "placeholder", s.Error = "error", s))(Qt || {});
class as extends re {
  _uid;
  _name;
  _type;
   ...
   */
  constructor(e, t, i) {
    super(e), this._uid = et.sharedUtils.generateUUID(), this._name = t.name, this._type = t.type ?? "placeholder", this._parent = i, this._children = [], this._loadPromise = new Q(), this._hidden = t.hidden ?? !1, this._expanded = t.expanded ?? !0, this._visibility = !0, this._exclusive = t.exclusive ?? !1, this._controls = t.controls?.slice() ?? [
      "visibilityButton",
      "expandButton"
      /* Expand */
  ...
  toggleVisibility(e, t = !0) {
    if (this.visibility !== e) {
      if (this._visibility = e ?? !this.visibility, !this.exclusive)
        ...
        if (this._lastVisible && (!(this._lastVisible instanceof We) || this._lastVisible.layerControlAvailable(ee.Visibility)))
          this._lastVisible.toggleVisibility(!0);
        else {
          const i = this.children.find(
            (r) => !(r instanceof We) || r.layerControlAvailable(ee.Visibility)
          );
   ...
   */
  checkVisibility(e) {
    this instanceof We && !this.layerControlAvailable(ee.Visibility) || (this.exclusive ? e.visibility ? (this.children.forEach((t) => {
   ...
   */
  reload() {
    this._type = "placeholder", this._loadPromise = new Q();
  }
  /**
...
class We extends as {
  ...
  toggleVisibility(e, t = !0, i = !1) {
    if (!(!this.layerControlAvailable(ee.Visibility) && !i) && (super.toggleVisibility(e, t), this.layer && this.layer.layerExists)) {
  ...
  clickSymbology(e, t) {
    let i;
    !this.symbolsVisible() && t !== !1 ? (this.setSymbologyVisibility(void 0, !1), this.setSymbologyVisibility(e, !0), i = !0) : this.setSymbologyVisibility(e, t), this.symbolsVisible() || (i = !1), this.updateSymbolFilter().then(() => {
      i !== void 0 && this.toggleVisibility(i);
    });
  }
  async updateSymbolFilter() {
    if (this.layer?.supportsFeatures) {
      const e = this.symbologyStack.filter((i) => i.lastVisbility).map((i) => i.definitionClause || "");
      let t = "";
      return e.length === 0 ? t = "1=2" : e.length < this.symbologyStack.length && (t = e.join(" OR ")), console.log("updating symbol filter: " + t), this.layer.setSqlFilter(de.SYMBOL, t);
    }
  }
  /**
  ...
  setSymbologyVisibility(e, t) {
    ...
    this._symbologyStack.some((r) => {
      if (i || r.uid === e) {
        const a = t ?? !r.lastVisbility;
        r.visibility = a, r.lastVisbility = a;
      }
      return !i && r.uid === e;
    });
  }
...
var tn = /* @__PURE__ */ ((s) => (s.Title = "title", s.Text = "text", s.Image = "image", s.Markdown = "markdown", s.Template = "template", s))(tn || {});
class $i extends as {
  _infoType;
...
var pe = /* @__PURE__ */ ((s) => (s[s.UPLOAD = 0] = "UPLOAD", s[s.FORMAT = 1] = "FORMAT", s[s.CONFIGURE = 2] = "CONFIGURE", s))(pe || {});
const cn = W("wizard", () => {
  const s = {
    id: "Placeholder",
    layerType: S.UNKNOWN,
  ...
  function n(c) {
    switch (l.value) {
      ...
      case pe.FORMAT:
        ...
        break;
      case pe.CONFIGURE:
        c === pe.UPLOAD ? (t.value = "", i.value = "", a.value = null, r.value = !0, o.value = {
          config: s,
          configOptions: []
        }, l.value = pe.UPLOAD) : c === pe.FORMAT && (o.value = {
          config: s,
          configOptions: []
        }, r.value = !0, l.value = pe.FORMAT);
        break;
    }
  }
  return {
...
class un {
  ...
  constructor(e, t, i) {
    ...
    const r = pn(e, this);
    this.$vApp = r.app, this.$element = r.element, this.$i18n = r.i18n, this.$rootEl = r.app.$root?.$el, this.fixture = new nl(this), this.panel = new ll(this), this.geo = new al(this), this.dev = new fl(this), this.ui = {
   ...
   */
  initialize(e, t, i) {
    const r = be(this.$vApp.$pinia), a = it(this.$vApp.$pinia), o = Dt(this.$vApp.$pinia);
    if (t?.configs !== void 0) {
   ...
   */
  reloadWorker(e, t) {
    const i = ut(this.$vApp.$pinia), r = ze(this.$vApp.$pinia), a = be(this.$vApp.$pinia), o = Ee(this.$vApp.$pinia), l = Me(this.$vApp.$pinia), n = Jt(this.$vApp.$pinia), c = !!e;
    ...
    )), r.clearAll(), this.geo.map.maptip.clear(), this.initialize(c, e, t), c && this.event.emit(x.CONFIG_CHANGE, this.getConfig());
  }
  /**
  ...
  setLanguage(e) {
    if (this.$i18n.locale.value === e)
      return;
    const t = be(this.$vApp.$pinia), i = ze(this.$vApp.$pinia), r = t.registeredLangs;
    ...
    r[a] !== r[e] && (this.reloadWorker(), this.event.emit(x.CONFIG_CHANGE, o)), this.event.emit(x.LANG_CHANGE, {
      oldLang: a,
      newLang: e
    });
  }
...
function pn(s, e) {
  ...
  const i = tr(), r = Di(La).use(i).use(Ps, {
    directive: "tippy",
    // => v-tippy
    component: "tippy"
    // => <tippy/>
  }).use(t);
  r.directive("focus-container", Na), r.directive("focus-list", Ca), r.directive("focus-item", ka), r.directive("truncate", Ua), r.component("panel-screen", Ka), r.component("pin", eo), r.component("close", so), r.component("back", oo), r.component("expand", po), r.component("panel-options-menu", xo), r.component("dropdown-menu", si), r.component("minimize", mo), r.component("right", vo), r.component("left", wo), r.component("fullscreen-nav-button", _o), r.component("geolocator-nav-button", To), r.component("home-nav-button", Lo), r.component("mapnav-button", Co), r.component("appbar-button", Po), r.component("transition", Ni), r.component("transition-group", Fi), r.config.globalProperties.$iApi = e, r.config.globalProperties.$pinia = t, r.config.idPrefix = `ramp-${s.id || et.sharedUtils.generateUUID()}`, r.provide("iApi", e);
  const a = r.mount(s);
...
class dn extends re {
  ...
  pointZoomScale;
  constructor(e, t = "") {
    super(e), this.esriMap = void 0, this._basemapStore = [], this._viewPromise = new Q(), this.handlers = [], this.pointZoomScale = 5e4, this.name = t;
  }
  noMapErr() {
  ...
  destroyMapView() {
    ...
    this._viewPromise = new Q(), this.created = !1, this.handlers.forEach((e) => e.handler.remove()), this.handlers = [], this.esriView.map = null, this.esriView.container = null, this.esriView.spatialReference = null, this.esriView.extent = null, this.esriView.navigation = null, this.esriView.destroy(), delete this.esriView;
  }
  /**
    ...
    if (e ? (e.logo ? e.logo.disabled ? r.logo.disabled = !0 : (r.logo.altText = e.logo.altText || i.altText, r.logo.link = e.logo.link || i.link, r.logo.value = e.logo.value || i.value) : (r.logo.altText = i.altText, r.logo.link = i.link, r.logo.value = i.value), e.text ? e.text.disabled ? r.text.disabled = !0 : r.text.value = e.text.value || t.value : r.text.value = t.value, Je(this.$vApp.$pinia).setAttribution(r)) : (r.logo.altText = i.altText, r.logo.link = i.link, r.logo.value = i.value, r.text.value = t.value), !e || e.text?.disabled || !e.text) {
      ...
      if (n) {
        ...
        Promise.all(c).then((u) => {
          a = u.filter((d) => d?.copyright).map((d) => d.copyright).join(" | "), r.text.value = a || r.text.value || t.value, Je(this.$vApp.$pinia).setAttribution(r);
        });
      }
    }
  }
...
class mn extends dn {
  ...
  async setBasemap(e) {
    ...
    if (a) {
      ...
      this._viewPromise = new Q(), this.created = !1, this.$iApi.event.emit(x.MAP_REFRESH_START), this.destroyMapView(), this.createMapView(i), await this.viewPromise.then(() => {
  ...
  addLayer(e, t = void 0) {
    return new Promise((i, r) => {
      if (this.esriMap || (this.noMapErr(), r()), e.initiationState !== j.INITIATING && e.initiationState !== j.INITIATED && e.layerState !== Z.ERROR && e.initiate(), e.mapLayer && t === void 0) {
      ...
      let l = 0;
      const n = setInterval(() => {
        l += 250, l >= e.expectedTime.fail || e.layerState === Z.ERROR ? (clearInterval(n), e.lastCancel < o && console.error(`Failed to add layer: ${e.id}.`), r()) : e.initiationState === j.INITIATED && (e.esriLayer || !e.mapLayer) && (clearInterval(n), e.mapLayer ? this.insertToEsriMap(e) : e.onLoad(), i());
      }, 250);
    });
  }
  /**
  ...
  removeSublayer(e) {
    ...
    i.visibility = !1, i.isRemoved = !0, this.$iApi.event.emit(x.LAYER_REMOVE, e), i.parentLayer?.sublayers.every((r) => r.isRemoved) && this.removeLayer(i.parentLayer);
  }
  /**
  ...
  screenPointToMapPoint(e) {
    return this.esriView ? ie.fromESRI(
      this.esriView.toMap({
        x: e.screenX,
        y: e.screenY
      }),
      "mappoint"
    ) : (this.noMapErr(), new ie("i_am_error", [0, 0], void 0, !0));
  }
  /**
...
class _n extends re {
  ...
  extractCsvFields(e, t = ",") {
    return bi.dsvFormat(t).parseRows(e)[0].map((r) => ({ name: r, type: De.STRING }));
  }
  /**
  ...
  async geoJsonToEsriJson(e, t) {
    ...
    r || (r = T.parseGeoJsonCrs(e.crs)), o.renderer = await k.RendererFromJson(c.renderer), o.fields = (o.fields || []).concat(
...
class Ln extends re {
  ...
  async loadWfsData(e, t = -1, i = 0, r = 1e3, a = {
    ...
    if (t === -1) {
      ...
      return t = d.data.numberMatched, this.loadWfsData(e, t, i, r, a, o, l);
    }
    if (a.features = a.features.concat(g.features), g.features.length < t - i) {
      const h = Math.min(r, t - i - g.features.length);
...
class Rn extends re {
  ...
  getLayerControls(e) {
    ...
    return t.supportsFeatures || r.push(ee.Datatable), t.extent === void 0 && r.push(ee.BoundaryZoom), (t.config?.metadata || (t.isSublayer ? t.parentLayer?.config?.metadata : {}) || {}).url || r.push(ee.Metadata), !t.mapLayer && !t.config.controls?.includes(ee.Settings) && r.push(ee.Settings), r.forEach((o) => {
  ...
  async loadLayerMetadata(e) {
    ...
    if (a.name = r.name || "", a.currentVersion = r.currentVersion || -1, a.minScale = r.effectiveMinScale || r.minScale || 0, a.maxScale = r.effectiveMaxScale || r.maxScale || 0, a.extent = r.extent ? H.fromArcServer(r.extent, "layer_extent") : void 0, a.defaultVisibility = r.defaultVisibility ?? !0, a.canModifyLayer = r.canModifyLayer ?? !0, r.type === "Feature Layer" || r.type === "Table") {
      if (a.dataFormat = le.ESRI_FEATURE, a.displayField = r.displayField || "", Array.isArray(r.fields)) {
        const o = await Promise.all(
          r.fields.map((n) => k.FieldFromJson(n))
        );
        a.fields = o.map((n) => ({
          name: n.name,
          alias: n.alias,
...
class os extends ci {
  ...
  constructor(e, t) {
    ...
    this.expectedTime.draw = e.expectedDrawTime ?? i.draw, this.expectedTime.load = e.expectedLoadTime ?? i.load, this.expectedTime.fail = e.maxLoadTime || i.fail, this.lastCancel = 0, this.timers = {
      draw: void 0,
      load: void 0
    }, this.origRampConfig = e, this.id = e.id || "", this.uid = this.$iApi.geo.shared.generateUUID(), this.isCosmetic = !1, this.isSystem = e.system || !1, this.isRemoved = !1, this.isSublayer = !1, this.supportsIdentify = !1, this.mapLayer = !0, this.identifyMode = oe.NONE, this.supportsFeatures = !1, this.maptips = !1, this.supportsSublayers = !1, this.isFile = !1, this.layerState = Z.NEW, this.initiationState = j.NEW, this.drawState = ye.NOT_LOADED, this.loadDefProm = new Q(), this.url = this.origRampConfig.url, this.canReload = !!(this.url || this.origRampConfig.caching), this.loadPromDone = !1, this.nameArcadeFormula = "", this.maptipArcadeFormula = "", this.layerTree = new Pt(0, this.uid, this.name, !0);
  }
  updateInitiationState(e) {
  ...
  async initiate() {
    ...
    }, this.expectedTime.fail), [r] = await Re(this.onInitiate());
    clearTimeout(i), t > this.lastCancel && (this.drawState !== ye.UP_TO_DATE && this.startTimer(
      "draw"
      /* DRAW */
    ), r ? e(`Init error on layer id: ${this.id} . ${r.message}`) : this.updateInitiationState(j.INITIATED));
  }
  async onInitiate() {
    if (this.isSublayer)
  ...
  async terminate() {
    this.updateInitiationState(j.TERMINATING), await Promise.all(this.sublayers.map((e) => e.terminate())), this.loadDefProm = new Q(), this.loadPromDone = !1, this.updateLayerState(Z.NEW), this.updateDrawState(ye.NOT_LOADED), this.updateInitiationState(j.TERMINATED);
  }
  // ----------- LAYER LOAD -----------
    ...
    try {
      ...
      Promise.all(r).then(() => {
        clearTimeout(i), t ? this.visibility = !1 : (this.stopTimer(
          "load"
          /* LOAD */
        ), e > this.lastCancel && (this.loadPromDone && (this.loadDefProm = new Q()), this.loadDefProm.resolveMe(), this.loadPromDone = !0, this.sublayers.forEach((a) => a.onLoad()), this.updateLayerState(Z.LOADED)));
      }).catch(() => {
  ...
  onError(e = !0) {
    this.layerState !== Z.ERROR && (this.initiationState === j.INITIATING && this.updateInitiationState(j.NEW), this.loadPromDone && (this.loadDefProm = new Q()), this.loadDefProm.rejectMe(), this.loadPromDone = !0, this.sublayers.forEach((t) => t.onError(e)), e && this.$iApi.notify.show(
      xe.ERROR,
      this.$iApi.$i18n.t("layer.error", {
        id: this.id
      })
...
class at extends os {
  ...
  // ----------- LAYER CONSTRUCTION AND INITIALIZAION -----------
  constructor(e, t) {
    super(e, t), this._scaleSet = new ji(), this._mouseTolerance = e.mouseTolerance != null ? e.mouseTolerance : 5, this._touchTolerance = e.touchTolerance != null ? e.touchTolerance : 15, this._drawOrder = [], this._serverVisibility = void 0, this.isCosmetic = e.cosmetic || !1, this.extent = e.extent ? H.fromConfig(`${this.id}_extent`, e.extent) : void 0, this.viewDefProm = new Q(), this.esriWatches = [];
  }
  noLayerErr() {
    console.error(
  ...
  async terminate() {
    this.esriWatches.forEach((e) => e.remove()), this.esriWatches = [], this.esriLayer = void 0, await super.terminate(), this.viewDefProm = new Q();
  }
  async reload() {
    if (!this.$iApi.geo.map.esriMap) {
  ...
  zoomToLayerBoundary() {
    ...
    if (this.mapCheck()) {
      if (this.extent.xmin === this.extent.xmax && this.extent.ymin === this.extent.ymax) {
        const e = new ie("point", [this.extent.xmin, this.extent.ymin], this.extent.sr);
...
class ui extends at {
  ...
  async getGraphic(e, t) {
    ...
    const c = new $e(r, "", t.getAttribs ? i : void 0);
    if (t.getStyle) {
  ...
  setSqlFilter(e, t) {
    ...
    this._lastFilterUpdate = r;
    const a = new Q();
    return setTimeout(() => {
      this._lastFilterUpdate === r && this.applySqlFilter(), a.resolveMe();
    }, 25), a.getPromise();
  }
  applySqlFilter(e = []) {
    throw new Error(
...
class ot extends ui {
  ...
  onLoadActions() {
    const e = super.onLoadActions(), t = async () => {
      ...
      const i = this.origRampConfig.maptipField || this.origRampConfig.tooltipField || "", r = i ? this.$iApi.geo.attributes.fieldValidator(this.fields, i) : "";
  ...
  runIdentify(e) {
    ...
    return e.hitTest && (this.identifyMode === oe.HYBRID || this.identifyMode === oe.SYMBOLIC) && (r = a.then(async () => {
  ...
  async getGraphic(e, t) {
    ...
    if (!t.getGeom && this.attribs.attLoader.isLoaded()) {
      ...
      i = new $e(new Qe(), "", r.features[r.oidIndex[e]]);
    } else {
      const r = {
        filterOIDs: [e],
    ...
    if (t.getStyle) {
      const r = ke(this.renderer.getGraphicSymbol(i.attributes));
...
class Gn extends at {
  ...
  runIdentify(e) {
    ...
    if (t.length === 0)
      return [];
    let i;
    return e.geometry.type === $.POINT && (i = this.$iApi.geo.query.makeClickBuffer(e.geometry, e.tolerance)), t.map((r) => {
      const a = new Q(), o = {}, l = Le({
        items: [],
      ...
      return r.geomType !== $.POLYGON && i ? o.filterGeometry = i : o.filterGeometry = e.geometry, o.filterSql = r.getCombinedSqlFilter(), o.sourceSR = r.sourceSR, r.queryOIDs(o).then((n) => {
        n.forEach((c) => {
          l.items.push(St.makeOidItem(c, r));
...
class pi extends at {
   ...
   */
  async checkProj() {
    const e = this.getSR(), i = this.$iApi.geo.map.getSR().isEqual(e), r = () => this.$iApi.notify.show(
      xe.WARNING,
    ...
    if (this.layerState === Z.LOADED && !i)
      r(), this.onError(), this.updateDrawState(ye.NOT_LOADED);
...
class qn extends pi {
  ...
  onLoadActions() {
    const e = super.onLoadActions(), t = Date.now(), i = this.$iApi.geo.symbology.mapServerToLocalLegend(this.origRampConfig.url).then((r) => {
      t > this.lastCancel && (this.legend = r);
    });
    return e.push(i), e;
  }
...
class Hn extends at {
  ...
  runIdentify(e) {
    ...
    return this.getFeatureInfo(this.sublayerNames, e.geometry, this.mimeType).then((r) => {
      if (r) {
        let a = !0, o;
        typeof r != "string" ? o = ft.JSON : r.indexOf("Search returned no results") === -1 && r !== "" ? o = ft.TEXT : (a = !1, o = ft.UNKNOWN), a && i.items.push(St.makeRawItem(o, r));
      }
      i.loaded = !0, t.resolveMe();
    }).catch(() => {
      i.errored = !0, t.resolveMe();
...
class Wn extends ot {
  ...
  async onInitiate() {
    const e = Date.now(), t = new Nt(this.config.url), { offset: i, limit: r } = t.queryMap, a = await this.$iApi.geo.layer.ogc.loadWfsData(
      this.config.url,
      -1,
      parseInt(i) || 0,
      parseInt(r) || 1e3,
...
class sl extends re {
  ...
  async symbolToSvg(e) {
    ...
    const a = lt(r).size(this.CONTAINER_SIZE, this.CONTAINER_SIZE).viewbox(0, 0, this.CONTAINER_SIZE, this.CONTAINER_SIZE), o = {
      // @ts-expect-error TODO: explain why this is needed or remove
      path({ size: h, path: m }) {
  ...
  async getMapServerLegend(e) {
    ...
    const t = {
      query: { f: "json" }
    }, i = { layers: [] }, [r, a] = await Re(Ze(`${e}/legend`, t));
  ...
  async mapServerLegendToRenderer(e, t) {
    ...
    if (typeof i < "u") {
      ...
      const a = await k.RendererFromJson(r);
...
class rl extends re {
  ...
  async geoJsonQuery(e) {
    ...
    return (await e.layer.esriLayer.queryFeatures(t)).features.map((r, a) => {
      let o;
      return t.returnGeometry ? o = this.$iApi.geo.geom.geomEsriToRamp(r.geometry, `queryResult${a}`) : o = new Qe(), new $e(o, "", r.attributes);
    });
  }
  /**
  ...
  async queryGeometryHelper(e, t, i, r) {
    return !t && e.type === $.EXTENT && r && !r.isEqual(e.sr) && !(i && i > 2e7 && e.sr.wkid === 3978 && r.wkid === 4326) ? (await this.$iApi.geo.proj.projectExtent(r, e)).toESRI() : e.toESRI();
  }
  /**
...
const ol = /* @__PURE__ */ Object.assign({ "../fixtures/appbar/index.ts": () => import("./index-CMM0tmyc.js"), "../fixtures/areas-of-interest/index.ts": () => import("./index-CUto6VqF.js"), "../fixtures/basemap/index.ts": () => import("./index-CfpoNt7z.js"), "../fixtures/crosshairs/index.ts": () => import("./index-CarSpu7I.js"), "../fixtures/details/index.ts": () => import("./index-jAvm1oMP.js"), "../fixtures/draw/index.ts": () => import("./index-Bw8SymAo.js"), "../fixtures/export-footnote/index.ts": () => import("./index-ubJjohUd.js"), "../fixtures/export-legend/index.ts": () => import("./index-C_rJQ2Ez.js"), "../fixtures/export-map/index.ts": () => import("./index-tSShV-o1.js"), "../fixtures/export-northarrow/index.ts": () => import("./index-Bs6zGYeP.js"), "../fixtures/export-scalebar/index.ts": () => import("./index-Cf_wWx-r.js"), "../fixtures/export-timestamp/index.ts": () => import("./index-BUStODiK.js"), "../fixtures/export-title/index.ts": () => import("./index-CqpwYppk.js"), "../fixtures/export/index.ts": () => import("./index-DF_fOou7.js"), "../fixtures/extentguard/index.ts": () => import("./index-BJ64WrbP.js"), "../fixtures/gazebo/index.ts": () => import("./index-qp32U5D_.js"), "../fixtures/geosearch/index.ts": () => import("./index-eww011Vx.js"), "../fixtures/grid/index.ts": () => import("./index-DNmr07PU.js"), "../fixtures/help/index.ts": () => import("./index-Cr7WvSJZ.js"), "../fixtures/hilight/index.ts": () => import("./index-B5btrwLK.js"), "../fixtures/keyboardnav/index.ts": () => import("./index-C-u-Ok5R.js"), "../fixtures/layer-reorder/index.ts": () => import("./index-DJ9REcic.js"), "../fixtures/legend/index.ts": () => import("./index-DI5QGJjh.js"), "../fixtures/mapnav/index.ts": () => import("./index-DXNsehae.js"), "../fixtures/metadata/index.ts": () => import("./index-BzhI8gMG.js"), "../fixtures/northarrow/index.ts": () => import("./index-mvL_cKNz.js"), "../fixtures/overviewmap/index.ts": () => import("./index-BpI7eWLh.js"), "../fixtures/panguard/index.ts": () => import("./index-Cvl50GpU.js"), "../fixtures/scrollguard/index.ts": () => import("./index-D_3Aa-BQ.js"), "../fixtures/settings/index.ts": () => import("./index-1C93HgeY.js"), "../fixtures/snowman/index.ts": () => import("./index-D22Ef4ZV.js"), "../fixtures/swipe/index.ts": () => import("./index-Bo13_Ace.js"), "../fixtures/wizard/index.ts": () => import("./index-DtT78QVl.js") });
class nl extends re {
  /**
  ...
  async add(e, t) {
    ...
    if (t) {
      ...
      const r = (await ol[`../fixtures/${e}/index.ts`]()).default;
      i = new r(e, this.$iApi);
    }
  ...
  get(e) {
    ...
    const i = t.map((r) => {
      const a = Ee(this.$vApp.$pinia).items[r];
      if (a)
        return a;
    });
...
class ll extends re {
  ...
  register(e, t) {
    ...
    const r = Object.entries(i).reduce((a, [o, l]) => (a.push(new Ct(this.$iApi, o, l)), a), []);
  ...
  open(e) {
    let t, i, r;
    if (typeof e == "string" || e instanceof Ct ? t = this.get(e) : (t = this.get(e.id), { screen: i, props: r } = e), !t)
      return t;
  ...
  close(e) {
    ...
    if (!t)
      return t;
    const r = this.visible.slice().indexOf(t), a = this.$vApp.$el.querySelector("[focus-container]");
    return t.isPinned && t.pin(!1), this.panelStore.closePanel(t), this.$iApi.updateAlert(
      ...
      const o = r > 0 ? this.visible[r - 1] : this.visible[0];
...
const dl = /* @__PURE__ */ qe(ul, [["render", pl], ["__scopeId", "data-v-a3c61802"]]), hl = /* @__PURE__ */ Object.assign({ "../fixtures/areas-of-interest/screen.vue": () => import("./screen-DnN8WTTa.js"), "../fixtures/basemap/screen.vue": () => import("./screen-BN6y9YNX.js"), "../fixtures/export/screen.vue": () => import("./screen-CGWi23pn.js"), "../fixtures/geosearch/screen.vue": () => import("./screen-nxTjLnvP.js"), "../fixtures/grid/screen.vue": () => import("./screen-BHN_Jc50.js"), "../fixtures/help/screen.vue": () => import("./screen-DTleYyEw.js"), "../fixtures/layer-reorder/screen.vue": () => import("./screen-CvrbSdVV.js"), "../fixtures/legend/screen.vue": () => import("./screen-6EZYWBQ9.js"), "../fixtures/metadata/screen.vue": () => import("./screen-DB9B1dyW.js"), "../fixtures/settings/screen.vue": () => import("./screen-BByw71kZ.js"), "../fixtures/wizard/screen.vue": () => import("./screen-DH6ksJ30.js") });
class Ct extends re {
  /**
   * ID of this panel.
   *
  ...
  registerScreen(e) {
    ...
    if (Js(t) || Ys(t))
      ...
      let r;
      typeof t == "string" ? r = hl[`../fixtures/${t}`]() : r = t();
...
function yl(s) {
  ...
  return vl(s.services, e), gl(s.map, e), bl(s.ui, e), s.plugins && Al(s.plugins, e), e;
}
function gl(s, e) {
    ...
    if (s.components.scaleBar && s.components.scaleBar.enabled) {
      switch (e.map.caption = {
        ...
        scaleBar: {
          ...
          imperialScale: s?.components?.scaleBar?.scalebarUnit === "english"
        }
  ...
  s.extentSets && (e.map.extentSets = [], s.extentSets.forEach((t) => {
    ...
    t.attribution && (i.attribution = {
      ...
      const o = {
        id: r.id || `${t.id}-${a}`,
        layerType: r.layerType === "esriDynamic" ? S.MAPIMAGE : S.TILE,
        url: r.url,
        opacity: r.opacity ?? 1
      };
      i.layers.push(o);
...
function Xt(s) {
  ...
  return s.controls && s.controls.length > 0 && (e.controls = gt(s.controls, t), s.controls.includes("visibility") && e.controls.push("visibilityButton"), (s.controls.length !== 1 || s.controls[0] !== "visibility") && console.warn(
    "Legend entry groups currently support only the visibility control. All other controls are currently not supported."
  ), e.controls.push("expandButton")), s.disabledControls && s.disabledControls.length > 0 && (e.disabledControls = gt(s.disabledControls, t), s.disabledControls.includes("visibility") && e.disabledControls.push("visibilityButton"), (s.disabledControls.length !== 1 || s.disabledControls[0] !== "visibility") && console.warn(
    "Legend entry groups currently support only the visibility control. All other controls are currently not supported."
    ...
    if (i.layerId)
      ...
      typeof i.collapse < "u" && console.warn(
        ...
        a.layerId ? r.children.push(Mi(a)) : r.children.push(Xt(a));
      }), e.children.push(r);
    } else
...
function Mi(s) {
  ...
  return s.controls && s.controls.length > 0 && (e.layerControls = gt(s.controls, t), e.layerControls.push("symbology")), s.disabledControls && s.disabledControls.length > 0 && (e.disabledLayerControls = gt(s.disabledControls, t)), s.controlledIds && (console.warn(
...
function ps(s) {
  ...
  ), s.tooltipField && (e.maptipField = s.tooltipField), s.tolerance && (e.mouseTolerance = s.tolerance, s.layerType === "esriDynamic" && (e.touchTolerance = s.tolerance + 10)), s.customRenderer && (e.customRenderer = s.customRenderer), s.layerType) {
    case "esriDynamic":
...
function Wt(s) {
  ...
  return s.controls && s.controls.length > 0 && (e.controls = gt(s.controls, t), e.controls.push("symbology")), s.disabledControls && s.disabledControls.length > 0 && (e.disabledControls = gt(s.disabledControls, t)), s.state && (e.state = {
    opacity: s.state.opacity ?? 1,
    visibility: s.state.visibility ?? !0,
    identify: s.state.query ?? !0,
    maptips: s.state.hovertips ?? !0
  ...
  )), typeof s.stateOnly < "u" && (e.cosmetic = s.stateOnly), s.initialFilteredQuery && (e.initialFilteredQuery = s.initialFilteredQuery), wl(s, e), (typeof s.toggleSymbology < "u" || s.table) && (e.fixtures = {}, typeof s.toggleSymbology < "u" && (e.fixtures.legend = {
...
var pt = { major: "4", minor: "16", patch: "0-beta", timestamp: "Thu Feb 5 14:55:28 2026 -0500", hash: "d1177341645653bb18fe8fb733d43c3675858dc1" };
console.info(
...
const lc = (s, e, t) => new un(s, e, t), et = new Ws();
export {
  De as $,
  Br as A,
  nn as B,
