import { af as le, hX as ue } from "./main-9SanlBxi.js";
...
async function xe() {
  ee = await (le("esri-csp-restrictions") ? await import("./libtess-asm-w25Q46gf.js").then((i) => i.l) : await import("./libtess-B9BEx3Zr.js").then((i) => i.l)).default({ locateFile: (i) => ue(`esri/core/libs/libtess/${i}`) });
}
function sr(s, i) {
...
//# sourceMappingURL=TurboLine-BTIuIsFW.js.map
