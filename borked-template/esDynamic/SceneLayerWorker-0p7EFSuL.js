import { hX as K, bh as D } from "./main-9SanlBxi.js";
import { y as X } from "./DoubleArray-zFzfXuex.js";
import { i as Q, a as W } from "./MeshLocalVertexSpace-CgD2GIOO.js";
import { n as Z, s as ee } from "./vec3-D8tEszcO.js";
import "./sphere-DVZUk1fx.js";
import "./I3SUtil-DKofAnF_.js";
var S, $;
(function(e) {
...
function te() {
  return x || (x = new Promise((e) => import("./i3s-DQJOQMrz.js").then((t) => t.i).then(({ default: t }) => {
...
async function be(e) {
  ...
  if (i.type === "georeferenced" && i.origin == null) {
    const [{ projectBuffer: c }, { initializeProjection: b }] = await Promise.all([import("./main-9SanlBxi.js").then((d) => d.qK), import("./main-9SanlBxi.js").then((d) => d.qL)]);
    await b(f, l), s = new Float64Array(a.length), c(a, f, 0, s, l, 0, s.length / 3);
  } else {
    const c = i.type === "georeferenced" ? Q.fromJSON(i) : W.fromJSON(i), { project: b } = await import("./georeference-d8tN4CFx.js").then((d) => d.g);
...
//# sourceMappingURL=SceneLayerWorker-0p7EFSuL.js.map
