...
import { _ as H, d as L, F as X, G as ee } from "./main-BCWRYwwy.js";
...
const G = /* @__PURE__ */ H(ne, [["render", ae]]), se = /* @__PURE__ */ T({
  ...
  setup(h) {
    ...
    const p = [
      {
        type: "point",
        icon: g(_(() => import("./point-icon-CZZW11jG.js")))
      },
      {
        type: "polyline",
        icon: g(_(() => import("./polyline-icon-BJV2rQ0G.js")))
      },
      {
        type: "polygon",
        icon: g(_(() => import("./polygon-icon-BK5cdhAo.js")))
      },
      {
        type: "circle",
        icon: g(_(() => import("./circle-icon-8Ox50vzE.js")))
      },
      {
        type: "rectangle",
        icon: g(_(() => import("./rectangle-icon-DuRQQxho.js")))
      }
    ], a = A(() => {
      const s = p.filter((u) => e.supportedTypes.some((x) => x.type === u.type));
      return s.push({
        type: "edit",
        icon: g(_(() => import("./edit-icon-DSPKkA4g.js")))
      }), s;
    }), n = (s) => {
