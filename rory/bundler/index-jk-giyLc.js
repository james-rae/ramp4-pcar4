...
import { _ as H, d as L, F as X, G as ee } from "./main-Bh3Bl5En.js";
...
const G = /* @__PURE__ */ H(ne, [["render", ae]]), se = /* @__PURE__ */ T({
  ...
  setup(h) {
    ...
    const p = [
      {
        type: "point",
        icon: g(_(() => import("./point-icon-c6O82kjt.js")))
      },
      {
        type: "polyline",
        icon: g(_(() => import("./polyline-icon-C2PGJwBF.js")))
      },
      {
        type: "polygon",
        icon: g(_(() => import("./polygon-icon-ksp8_xX8.js")))
      },
      {
        type: "circle",
        icon: g(_(() => import("./circle-icon-DZY3lrY1.js")))
      },
      {
        type: "rectangle",
        icon: g(_(() => import("./rectangle-icon-BeYcR8v8.js")))
      }
    ], a = A(() => {
      const s = p.filter((u) => e.supportedTypes.some((x) => x.type === u.type));
      return s.push({
        type: "edit",
        icon: g(_(() => import("./edit-icon-D131CLJw.js")))
      }), s;
    }), n = (s) => {
