...
import { _ as H, d as L, F as X, G as ee } from "./main-CeOVjQTm.js";
...
const G = /* @__PURE__ */ H(ne, [["render", ae]]), se = /* @__PURE__ */ T({
  ...
  setup(h) {
    ...
    const p = [
      {
        type: "point",
        icon: g(_(() => import("./point-icon-wRMFV20V.js")))
      },
      {
        type: "polyline",
        icon: g(_(() => import("./polyline-icon-BvNS1aSs.js")))
      },
      {
        type: "polygon",
        icon: g(_(() => import("./polygon-icon-rUoUVAV8.js")))
      },
      {
        type: "circle",
        icon: g(_(() => import("./circle-icon-BEGA08_5.js")))
      },
      {
        type: "rectangle",
        icon: g(_(() => import("./rectangle-icon-B4WHb3uA.js")))
      }
    ], a = A(() => {
      const s = p.filter((u) => e.supportedTypes.some((x) => x.type === u.type));
      return s.push({
        type: "edit",
        icon: g(_(() => import("./edit-icon-DAD3QoqA.js")))
      }), s;
    }), n = (s) => {
