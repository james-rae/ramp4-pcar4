import { defineComponent as H, inject as de, resolveComponent as Pe, resolveDirective as O, createBlock as tt, openBlock as C, unref as f, withCtx as oe, createElementBlock as _, Fragment as lt, renderList as at, createElementVNode as n, withDirectives as $, createTextVNode as ie, toDisplayString as D, normalizeClass as B, ref as w, onBeforeMount as fe, withKeys as N, withModifiers as z, vModelText as ue, vModelSelect as Ft, onMounted as ee, nextTick as Ee, onBeforeUnmount as te, createCommentVNode as I, computed as P, useTemplateRef as At, getCurrentInstance as $t, watch as Ie, vShow as se, createVNode as Me, markRaw as Ve } from "vue";
import "tiny-emitter";
import { a as ge, _ as he, G as J, W as Tt, X as Rt, L as St, Y as Dt, Z as rt, $ as ne, i as st, a0 as Gt, a1 as Xe, a2 as _e, a3 as It } from "./main-Bh3Bl5En.js";
...
import "csv2geojson";
import "redaxios";
import Pt from "await-to-js";
import "svg.js";
import "ag-grid-community/styles/ag-grid.css";
import "ag-grid-community/styles/ag-theme-material.css";
import { AgGridVue as Ht } from "ag-grid-vue3";
import { T as Bt, C as Nt } from "./table-state-manager-BxfbugKY.js";
import { AG_GRID_LOCALE_EN as zt, AG_GRID_LOCALE_FR as Ot } from "@ag-grid-community/locale";
import { ModuleRegistry as Ut, AllCommunityModule as Kt, provideGlobalGridOptions as jt } from "ag-grid-community";
function nt(b, s, e) {
  return b[s].find(
...
function He(b, s) {
  const e = nt(b, s.id, s.oidField);
  return e ? e.mappedAttr ?? e.origAttr : s.oidField;
}
const qt = ".ag-root", Wt = ".ag-header-viewport .ag-header-row";
class et {
  element;
  agGrid;
  headerRows;
   ...
   */
  constructor(s, e) {
    this.element = s, this.agGridApi = e, this.agGrid = this.element.querySelector(qt), this.headerRows = Array.prototype.slice.call(
      this.element.querySelectorAll(Wt)
...
const Qt = ["onClick"], Xt = { class: "md-icon-small flex w-full" }, Jt = { class: "flex-1 truncate whitespace-nowrap overflow-hidden pr-4" }, el = /* @__PURE__ */ H({
  ...
  setup(b) {
    ...
    return (r, t) => {
      ...
      return C(), tt(o, {
        ...
        default: oe(() => [
          (C(!0), _(lt, null, at(b.columnDefs.filter(
...
}), tl = { class: "h-full flex items-center justify-center" }, ll = ["placeholder", "aria-label", "disabled"], al = ["placeholder", "aria-label", "disabled"], rl = {
  methods: {
...
}), nl = /* @__PURE__ */ he(sl, [["__scopeId", "data-v-ab99947a"]]), ol = { class: "h-full flex items-center justify-center" }, il = ["placeholder", "aria-label", "disabled"], ul = {
  methods: {
    onParentModelChanged() {
    }
  }
...
}), pl = { class: "h-full flex items-center justify-center" }, cl = ["aria-label", "disabled"], ml = ["value"], vl = {
  methods: {
    onParentModelChanged() {
    }
  }
  ...
  setup(b) {
    ...
    return fe(() => {
      ...
      $(n("select", {
        ...
        (C(!0), _(lt, null, at(r.value, (m) => (C(), _("option", {
          value: m,
          key: m
        }, D(m), 9, ml))), 128))
      ], 42, cl), [
...
}), gl = /* @__PURE__ */ he(fl, [["__scopeId", "data-v-46624a34"]]), hl = { class: "h-full flex items-center justify-center w-full" }, yl = ["placeholder", "aria-label", "disabled"], bl = ["placeholder", "aria-label", "disabled"], wl = {
  methods: {
    onParentModelChanged() {
    }
  }
...
}), Cl = /* @__PURE__ */ he(xl, [["__scopeId", "data-v-4019b3f7"]]), Ll = ["content", "disabled", "aria-label"], _l = /* @__PURE__ */ H({
  __name: "clear-filter",
  props: ["params"],
  setup(b) {
...
}, Rl = ["content", "aria-label", "disabled"], Sl = ["content", "aria-label", "disabled"], Dl = /* @__PURE__ */ H({
  ...
  setup(b) {
    ...
    return ee(() => {
      ...
      return C(), _("div", {
        ...
        o.value ? (C(), _("div", Fl, [
          b.params.enableSorting && t.value === 0 ? (C(), _("span", Al)) : I("", !0),
          b.params.enableSorting && t.value === 1 ? (C(), _("span", $l, k[3] || (k[3] = [
          ...
          b.params.enableSorting && t.value === 2 ? (C(), _("span", Tl, k[4] || (k[4] = [
            n("div", { class: "md-icon-small" }, [
              n("svg", {
                height: "24",
                width: "24"
...
}), Gl = ["content", "aria-label"], Il = /* @__PURE__ */ H({
  ...
  stroke: "red",
  class: "w-20 h-20"
}, Nl = ["innerHTML"], zl = /* @__PURE__ */ H({
  __name: "zoom-button-renderer",
  props: ["params"],
  setup(b) {
    const s = w("none"), e = b, r = de("iApi"), t = Rt(), o = w(), { t: v } = U(), i = P(() => {
      ...
      M.layerType === St.FEATURE && M.geomType !== Dt.POINT ? M.getGraphicExtent(h).then((k) => {
    ...
    return ee(() => {
      ...
      return i.value ? $((C(), _("button", {
        ...
        s.value === "zooming" ? (C(), _("div", Pl)) : s.value === "zoomed" ? (C(), _("svg", Hl, L[0] || (L[0] = [
          n("path", {
            "stroke-linecap": "round",
            "stroke-linejoin": "round",
            d: "M4.5 12.75l6 6 9-13.5"
          }, null, -1)
        ]))) : s.value === "error" ? (C(), _("svg", Bl, L[1] || (L[1] = [
          n("path", {
            "stroke-linecap": "round",
            "stroke-linejoin": "round",
...
}), Ol = ["content"], Ul = ["innerHTML"], Kl = /* @__PURE__ */ H({
...
}), jl = ["name", "content", "innerHTML"], ql = ["content"], Wl = /* @__PURE__ */ H({
  ...
  setup(b) {
    ...
    }, M = P(() => i.params.type === "number" ? i.params.value == null ? "" : e.ui.formatNumber(i.params.value) : i.params.type === "date" ? i.params.value == null ? "" : new Date(i.params.value).toISOString().slice(0, 10) : i.params.type === "string" ? !i.params.value || /<a[^>]*>[^<]+<\/a>/g.test(i.params.value) ? i.params.value : Vt(i.params.value, {
      target: "_blank",
      validate: {
        url: (h) => /^https?:\/\//.test(h)
...
}), Yl = { class: "pl-8" }, Zl = { class: "flex flex-col justify-center items-center h-full" }, Ql = { class: "flex flex-row" }, Xl = { class: "font-bold text-2xl" }, Jl = { class: "mt-20 text-xl" }, ea = { class: "my-20" }, ta = { class: "text-sm" }, la = ["aria-label"], aa = { class: "flex flex-wrap gap-y-8 items-center pl-8 pb-8" }, ra = { class: "flex flex-1 flex-col max-w-full mr-8" }, sa = { class: "w-full font-bold" }, na = { class: "w-full text-sm" }, oa = { key: 0 }, ia = { class: "flex flex-1 grow-[1.4] items-center max-w-full" }, ua = { class: "search-bar flex flex-1 min-w-0 items-center pb-4 mr-8" }, da = ["aria-label", "placeholder"], pa = { class: "-ml-30 text-gray-500 search-clear-container" }, ca = {
  key: 0,
  xmlns: "http://www.w3.org/2000/svg",
  fit: "",
  preserveAspectRatio: "xMidYMid meet",
...
}, ma = ["aria-label"], va = { class: "pb-2 flex ml-auto justify-end" }, fa = ["content", "aria-label"], ga = ["aria-label"], ha = { class: "md-icon-small flex flex-nowrap items-center gap-x-4" }, ya = { class: "grow" }, ba = {
  key: 0,
  height: "18",
  width: "18",
  viewBox: "0 0 24 24"
  ...
  width: "18",
  viewBox: "0 0 24 24"
}, _a = ["aria-label"], Ea = { class: "md-icon-small flex flex-nowrap items-center gap-x-4" }, Ma = { class: "grow" }, ka = {
  key: 0,
  height: "18",
  width: "18",
  viewBox: "0 0 24 24"
}, Fa = ["aria-label"], Aa = { class: "md-icon-small flex flex-nowrap items-center gap-x-4" }, $a = {
  key: 0,
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 24 24",
  ...
  width: "18",
  viewBox: "0 0 24 24"
}, Da = ["aria-label"], Ga = { class: "md-icon-small flex flex-nowrap items-center gap-x-4" }, Ia = { class: "grow" }, Va = ["content"], Pa = /* @__PURE__ */ H({
  ...
  setup(b) {
    Ut.registerModules([Kt]), jt({ theme: "legacy" });
    const s = [ne.OID, ne.DOUBLE, ne.SINGLE, ne.INTEGER], e = de("iApi"), r = st(), t = ge(), o = P(() => t.mobileView), v = w(!o.value), i = w(), m = At("gridContainer"), { t: g, locale: M } = U(), L = () => $t()?.proxy?.$forceUpdate(), h = b, u = w({
      id: "dummy",
      layerIds: [],
      state: new Bt(),
      fieldMap: {}
    }), k = w(!0), R = w(null), q = w(), le = w(), W = w(!1), ae = w(!1), pe = w([]), ke = w(0), Z = w([]), ye = w([]), Fe = w(""), re = w([]), ce = w([]), be = w("OBJECTID"), Ae = w(void 0), ot = et.onCellKeyPress, K = w({ firstRow: 0, lastRow: 0, visibleRows: 0 }), we = w({}), me = w({}), Be = w(r.grids[h.gridId].layerIds), V = P(() => r.grids[h.gridId] ? Be.value.map((a) => e.geo.layer.getLayer(a)).filter((a) => a !== void 0) : []), Ne = P(
      ...
      () => V.value.some((a) => a.layerState === Gt.LOADED && a.visibility)
    ), it = (a) => {
      R.value = a.api;
      let l = u.value.state.title;
      l || (l = e.geo.layer.getLayer(h.gridId)?.name || h.gridId), Fe.value = l, Re(), ce.value.length > 0 && T.value.autoSizeAllColumns(), Ce(), T.value.addEventListener("rowDataUpdated", Ce), Z.value.push(
        ...
        e.event.on(J.LAYER_REMOVE, (y) => {
          Be.value.includes(y.id) && V.value.length !== 0 && We();
        })
      ), Q();
    }, ut = () => {
      T.value.autoSizeAllColumns(), Ae.value = new et(i.value, R.value), Ce();
    }, Te = () => {
      ...
      if (a.field === "rvInteractive") {
        ...
        if (p.includes("details") && l.push(d), kt.value) {
          const x = {
            field: "rvZoomButton",
            headerName: "",
            headerComponentParams: { isStatic: !0, preventExport: !0 },
    ...
    }, wt = () => !Object.values(we.value).every((a) => a === void 0), xt = (a) => {
      const l = we.value[a.data.rvUid];
      return l === void 0 || l.includes(a.data[be.value]);
    }, Q = async () => {
      const a = new It(), l = xe.value.slice().map((p) => p.getPromise());
      ...
      if (Object.keys(l || {}).forEach((p) => {
        const d = De(a, p);
        d ? y.push(_t(d.origAttr, l[p])) : y.push("1=2");
      ...
      return p.forEach((c) => {
        ...
        for (const S of y) {
          ...
          let Y = !1;
          for (const Ge of d ?? []) {
            const ve = Ge.getColId(), Le = De(a, Ge.getColId())?.origAttr, Qe = Ge.getColDef();
            if (c.data[ve] === void 0)
              Y = !1;
      ...
      qe(), h.panel.isOpen && h.panel.close();
    }, qe = () => {
    ...
    ), De = (a, l) => nt(me.value, a, l), We = async () => {
      const a = V.value.filter((c) => c && c.supportsFeatures && c.isLoaded);
      a.length === 0 && je(), ke.value = a.reduce((c, { featureCount: F }) => c + F, 0), pe.value = new Array(V.value.length).fill(0), a.forEach((c, F) => pe.value[F] += c.downloadedAttributes()), a.forEach((c, F) => {
        ye.value.push(
          Ie(
      ...
      ["rvRowIndex", "rvInteractive", "rvSymbol"].map((c) => ({
        ...
        u.value.state.columns[c.data] === void 0 && (u.value.state.columns[c.data] = new Nt({
          field: c.data,
          title: c.title
        ...
        if (c.special)
          bt(S, re.value, u.value.state);
        else {
          const E = d.fields.find((G) => G.name === S.field);
          S.cellRenderer = F.template === "" ? Wl : e.component(F.template), S.autoHeight = !0, s.indexOf(E.type) > -1 ? (ht(S, u.value.state), S.filter = "agNumberColumnFilter", S.cellRendererParams = {
            type: "number"
          }) : E.type === ne.DATE ? (ft(S, u.value.state), S.filter = "agDateColumnFilter", S.minWidth = 400, S.cellRendererParams = {
            type: "date"
          }) : E.type === ne.STRING && (A ? gt(S, d.rows, u.value.state) : yt(S, u.value.state), S.filter = "agTextColumnFilter", S.cellRendererParams = {
            type: "string"
          }), re.value.push(S);
        }
    ...
    return ee(() => {
      ...
      u.value = r.grids[h.gridId], W.value = !0, L(), K.value = {
        ...
        agColumnHeader: Dl,
        numberFloatingFilter: nl,
        textFloatingFilter: dl,
        selectorFloatingFilter: gl,
        dateFloatingFilter: Cl,
        clearFloatingFilter: _l
      }, q.value = {
      ...
      }, We(), j.value === "partial" && e.notify.show(Xe.WARNING, e.$i18n.t("layer.filterwarning")), ye.value.push(
        Ie(M, () => {
      ...
      qe(), Z.value.forEach((a) => e.event.off(a)), ye.value.forEach((a) => a()), Ae.value?.removeAccessibilityListeners(), Ae.value?.removeScrollListeners(), m.value?.removeEventListener("keyup", Ye), m.value?.removeEventListener("blur", Ze);
    }), (a, l) => {
      ...
      return C(), _("div", {
        ...
        $(n("div", null, [
          n("p", Yl, D(f(g)("grid.splash.error")), 1)
        ], 512), [
          [se, ae.value]
        ]),
        $(n("div", Zl, [
          n("div", Ql, [
            n("span", Xl, D(pe.value.reduce((x, c) => x + c, 0)), 1),
            l[12] || (l[12] = n("svg", {
            ...
            n("span", Jl, D(ke.value), 1)
          ]),
          n("div", ea, [
            n("span", ta, D(pe.value.reduce((x, c) => x + c, 0) < ke.value ? f(g)("grid.splash.loading") : f(g)("grid.splash.building")), 1)
          ]),
          n("div", null, [
            n("button", {
              type: "button",
        ...
        $(n("div", aa, [
          n("div", ra, [
            ...
            $((C(), _("div", na, [
              ie(D((!ze.value && K.value.visibleRows === 0 ? `${f(g)("grid.filters.label.hidden")} — ` : "") + f(g)("grid.filters.label.info", {
                range: K.value.visibleRows !== 0 ? `${K.value.firstRow} - ${K.value.lastRow}` : "0",
                total: K.value.visibleRows
              })) + " ", 1),
              K.value.visibleRows !== ce.value.length && ze.value ? (C(), _("span", oa, D(f(g)("grid.filters.label.filtered", {
                max: ce.value.length
              })), 1)) : I("", !0)
            ])), [
              [p]
          ...
          n("div", ia, [
            $(n("div", ua, [
              ...
              n("div", pa, [
                u.value.state.searchFilter.length < 3 ? (C(), _("svg", ca, l[13] || (l[13] = [
              ...
              Me(y, {
                ...
                default: oe(() => [
                  n("a", {
                    ...
                    onClick: l[7] || (l[7] = (x) => j.value !== "disabled" && Ct()),
                    role: "button",
                    ...
                    n("div", ha, [
                      ...
                      n("span", ya, D(f(g)("grid.label.filters.apply")), 1),
                      j.value !== "disabled" && u.value.state.applyToMap ? (C(), _("svg", ba, l[17] || (l[17] = [
                        n("g", { id: "done" }, [
                          n("path", { d: "M9 16.2L4.8 12l-1.4 1.4L9 19 21 7l-1.4-1.4L9 16.2z" })
                        ], -1)
                      ]))) : I("", !0)
                  ...
                  n("a", {
                    ...
                    n("div", xa, [
                      ...
                      n("span", Ca, D(f(g)("grid.label.filters.show")), 1),
                      u.value.state.colFilter ? (C(), _("svg", La, l[19] || (l[19] = [
                        n("g", { id: "done" }, [
                          n("path", { d: "M9 16.2L4.8 12l-1.4 1.4L9 19 21 7l-1.4-1.4L9 16.2z" })
                        ], -1)
                      ]))) : I("", !0)
                  ...
                  n("a", {
                    ...
                    onClick: l[9] || (l[9] = (x) => j.value !== "disabled" && pt()),
                    role: "button",
                    ...
                    n("div", Ea, [
                      ...
                      n("span", Ma, D(f(g)("grid.filters.label.extent")), 1),
                  ...
                  n("a", {
                    ...
                    onClick: l[10] || (l[10] = (x) => mt()),
                    role: "button",
                    "aria-label": f(g)("grid.label.pinColumns")
                  }, [
                    n("div", Aa, [
                      v.value ? (C(), _("svg", $a, l[23] || (l[23] = [
                      ...
                      ]))) : v.value ? I("", !0) : (C(), _("svg", Ta, l[24] || (l[24] = [
                      ...
                      n("span", Ra, D(f(g)("grid.label.pinColumns")), 1),
                      v.value ? (C(), _("svg", Sa, l[25] || (l[25] = [
                        n("g", { id: "done" }, [
                          n("path", { d: "M9 16.2L4.8 12l-1.4 1.4L9 19 21 7l-1.4-1.4L9 16.2z" })
                        ], -1)
                      ]))) : I("", !0)
                  ...
                  n("a", {
                    ...
                    n("div", Ga, [
                      ...
                      n("span", Ia, D(f(g)("grid.label.export")), 1)
                    ])
                  ], 8, Da)
                ]),
                _: 1
...
}), Ha = /* @__PURE__ */ he(Pa, [["__scopeId", "data-v-36756ea1"]]), Ba = /* @__PURE__ */ H({
  __name: "screen",
  props: {
    panel: {
      type: rt,
  ...
  setup(b) {
    const s = st(), { t: e } = U(), r = P(() => s.currentId);
    return (t, o) => {
      const v = Pe("panel-screen");
      return C(), tt(v, { panel: b.panel }, {
        header: oe(() => [
...
}), $r = /* @__PURE__ */ he(Ba, [["__scopeId", "data-v-904e67ef"]]);
export {
  $r as default
};
