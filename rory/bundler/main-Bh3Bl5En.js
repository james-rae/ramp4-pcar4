...
import { ref as f, computed as D, markRaw as ne, defineComponent as N, inject as Se, reactive as Le, watch as Ot, onBeforeUnmount as vt, resolveDirective as G, withDirectives as U, createElementBlock as A, openBlock as b, withKeys as ms, withModifiers as ei, onMounted as st, normalizeStyle as Pi, normalizeClass as ce, createVNode as fe, Transition as Ni, withCtx as ue, createBlock as ee, resolveDynamicComponent as ys, mergeProps as gs, useCssVars as vs, TransitionGroup as Fi, Fragment as tt, renderList as bt, unref as I, nextTick as It, renderSlot as Ve, createElementVNode as y, vShow as bs, resolveComponent as ae, createTextVNode as ht, toDisplayString as B, createCommentVNode as z, onUpdated as ws, Teleport as As, getCurrentInstance as Es, useTemplateRef as yi, createApp as Di, toRaw as ke, h as xs, render as zt, defineAsyncComponent as Ss } from "vue";
...
class Ge extends rt {
  ...
  static parseMultiPolygon(e) {
    ...
    if (e instanceof he)
      return [e.toArray()];
    if (e instanceof _e || e instanceof we)
...
class ze {
  ...
  get hex() {
    const e = this.rgba;
    return e[3] = e[3] * 255, `#${e.map((t) => ze.intToHex(t)).join("")}`;
  }
  get r() {
    return this.c[0];
  }
...
class Ye extends Ue {
  ...
  constructor(e) {
    if (e = e || { style: Fe.CIRCLE }, super(), this._style = e.style || Fe.CIRCLE, e.style === Fe.ICON) {
      const t = e;
      this._icon = t.icon || "", this._height = Ue.convToPoints(t.height) || 16.5, this._width = Ue.convToPoints(t.width) || 16.5, this._size = 0, this._colour = new ze(), this._outline = new Pe(), this._path = "";
    } else {
      const t = e;
      this._size = Ue.convToPoints(t.size) || 12, this._colour = new ze(t.colour ?? "#ffffff40"), this._outline = new Pe(t.outline), this._path = this._style === Fe.PATH && t.path || "", this._height = 0, this._width = 0, this._icon = "";
    }
...
class Pe extends Ue {
  ...
  constructor(e) {
    ...
    this._width = typeof t > "u" || t < 0 ? 0.75 : t, this._colour = new ze(e.colour), this._miter = e.miter ?? 2, this._cap = e.cap || zi.ROUND, this._join = e.join || Bi.ROUND;
  }
...
class Et extends Ue {
  ...
  _fillStyle;
  constructor(e) {
    super(), e = e || {}, e.fill || (e.fill = {}), this._fillColour = new ze(e.fill.colour), this._fillStyle = e.fill.style || qi.SOLID, this._outlineStyle = new Pe(e.outline);
  }
  /** Returns the specified colour */
  get fillColour() {
...
class Hs {
  ...
  async projectExtent(e, t) {
    const i = (m, w, v) => {
      if (v === 0)
        return [m, w];
      const C = [(m[0] + w[0]) / 2, (m[1] + w[1]) / 2];
      if (v === 1)
        return [m, C, w];
      if (v > 1) {
        const Y = i(m, C, v - 1), R = i(C, w, v - 1);
...
class Ws {
  ...
  sharedUtils;
  constructor() {
    this.proj = new Hs(), this.geom = new zs(), this.sharedUtils = new qs();
  }
  defaultTileSchemas() {
...
const rr = ["data-cy"], Ki = /* @__PURE__ */ N({
  ...
  function O() {
    let E = t.value;
    const L = [], Q = 350, Ae = 12, je = 600;
    for (let Ie = n.value.length - 1; Ie >= 0; Ie--) {
      const nt = n.value[Ie];
      let Ne = nt.width || Q;
      if (s.value ? Ne = E : Ne += Ae, nt.id === "grid" && (Ne = Math.max(Math.min(Ne, E), je)), (E >= Ne && !s.value || L.length === 0) && (E -= Ne, L.unshift(nt)), nt.id === "grid" && E < je)
        break;
    }
    if (r.value && //@ts-expect-error TODO: explain why this is needed or remove
    !L.includes(r.value) && !s.value) {
      let Ie;
      for (let mi = 0; mi < L.length - 1 && E < (r.value.width || Q) + Ae; mi++)
  ...
  function P(E, L) {
    const Q = n.value.indexOf(E), Ae = L === "right" ? 1 : -1;
    u.value.includes(n.value[Q + Ae]) && ([n.value[Q], n.value[Q + Ae]] = [
      n.value[Q + Ae],
      n.value[Q]
    ]);
  }
  ...
  setup(r) {
    const e = Be(), { t } = se(), i = D(() => e.notificationNumber), s = () => e.clearAll();
    return (a, o) => {
      const l = ae("panel-screen"), n = G("tippy");
      return b(), ee(l, { panel: r.panel }, {
        header: ue(() => [
          ht(B(I(t)("notifications.title")), 1)
        ]),
        content: ue(() => [
          y("div", lr, [
            y("div", cr, [
...
class dr extends re {
  ...
  constructor(e) {
    ...
    }), this.notificationStore = Be(this.$vApp.$pinia);
  }
  /**
...
class Zi extends re {
  notificationStore = Be(this.$vApp.$pinia);
  id;
  message;
  type;
  messageList = [];
...
const hr = ["content"], fr = { class: "flex items-center text-left" }, mr = { class: "select-text cursor-text" }, yr = ["content", "aria-label"], gr = {
  ...
  setup(r, { emit: e }) {
    ...
    return (n, c) => {
      ...
      return U((b(), A("li", {
        ...
        y("div", fr, [
          y("span", null, [
            ht(B(o[r.notification.type]) + " ", 1),
            y("span", mr, B(r.notification.message), 1)
          ]),
    ...
    return (c, u) => {
      ...
      return b(), A("div", null, [
        n.value.length > 0 ? U((b(), A("ul", {
          ...
          (b(!0), A(tt, null, bt(n.value, (h, m) => (b(), A(tt, {
            key: h.id
          }, [
            m > 0 ? (b(), A("div", wr)) : z("", !0),
            U(fe(vr, {
          ...
          y("span", null, B(I(t)("notifications.empty")), 1),
      ...
      return b(), ee(si, {
        ...
        header: ue(() => [
          y("div", Er, [
            ...
            i.value && i.value > 0 ? (b(), A("span", Sr, B(i.value), 1)) : z("", !0)
          ])
        ]),
        default: ue((c) => [
          y("div", Ir, [
            y("div", null, [
              y("h4", _r, B(I(t)("notifications.title")), 1),
              y("div", Tr, [
                U((b(), A("button", {
                  type: "button",
                  onClick: s,
...
}), $r = /* @__PURE__ */ qe(Rr, [["__scopeId", "data-v-3623a7d2"]]), Cr = { class: "flex hover:text-white" }, Or = ["aria-label"], kr = { class: "about-ramp-dropdown pointer-events-auto bg-white rounded w-256 h-50" }, Mr = ["aria-label", "content"], Pr = { class: "pb-8 pt-1 border-b border-gray-600 mb-10" }, Nr = { class: "absolute right-5 top-5" }, Fr = { class: "select-text" }, Dr = { class: "font-bold cursor-text" }, Gr = { class: "text-sm cursor-text" }, Ur = { class: "font-bold cursor-text" }, Vr = { class: "ml-5 cursor-text" }, Br = /* @__PURE__ */ N({
  ...
  setup(r) {
    const { t: e } = se(), t = Se("iApi"), i = () => {
      t.reload();
    }, s = D(() => `${At.major}.${At.minor}.${At.patch}`), a = D(() => At.hash.slice(0, 9)), o = D(() => {
        ...
        default: ue((g) => [
          y("div", kr, [
            y("div", null, [
              ...
              y("div", Fr, [
                y("div", null, [
                  y("span", Dr, B(s.value), 1),
                  y("span", Gr, " [" + B(a.value) + "] ", 1)
                ]),
                y("div", null, [
                  y("span", Ur, B(o.value[0]), 1),
                  y("span", Vr, B(o.value[1]), 1)
                ]),
...
}), zr = /* @__PURE__ */ qe(Br, [["__scopeId", "data-v-e0d1ce9f"]]), qr = "S", jr = "__HELP__", Xi = W("keyboardnav", () => {
  ...
  function p(_, M, P) {
    if (_) {
      ...
      if (_ === "reset") {
        ...
        w([qr, q]), Y(void 0), R("awaitAction"), F.activeNamespace = q;
      }
    }
  }
  function d(_, M, P) {
  ...
  __name: "map-caption",
  setup(r) {
    const e = Je(), t = Xi(), i = be(), { t: s } = se(), a = Se("iApi"), o = D(() => e.scale), l = D(() => e.attribution), n = D(() => e.coords), c = D(() => e.langtoggle), u = D(() => i.config.map), { keyChain: p, lastAction: d, chainState: g, namespaces: h, activeNamespace: m } = hs(t), w = D(() => {
      ...
      if (g.value === "awaitNamespace") {
        const J = `H - ${s("keyboardnav.chain.help")}`, E = Object.keys(h.value).map((Q) => {
          const Ae = `keyboardnav.ns.${Q}`, je = s(Ae);
          return `${Q} - ${je === Ae ? Q : je}`;
        });
        q = `[${[J, ...E].join(", ")}]`;
        ...
        E && E.keys?.length && (q = `[${E.keys.map((Q) => {
          const Ae = `keyboardnav.key.${J}.${Q.key}`, je = s(Ae), Ie = je === Ae ? Q.key : je;
          return `${Q.key} - ${Ie}`;
        }).join(", ")}]`);
      }
      return {
      ...
      return b(), A("div", Hr, [
        ...
        w.value ? (b(), A("span", Kr, [
          y("span", Zr, [
            ...
            y("span", Qr, B(w.value.keys), 1),
            w.value.cursor ? (b(), A("span", Xr, "_")) : z("", !0),
            w.value.options ? (b(), A("span", ea, B(w.value.options), 1)) : z("", !0)
          ]),
          w.value.description ? (b(), A("span", ta, "- " + B(w.value.description) + "...", 1)) : z("", !0)
        ])) : l.value?.text.disabled ? z("", !0) : U((b(), A("span", ia, [
          ht(B(l.value?.text.value), 1)
        ])), [
          [P, {
            options: {
              placement: "top",
        ...
        y("div", sa, [
          n.value?.disabled ? z("", !0) : U((b(), A("div", ra, [
            ht(B(n.value?.formattedString), 1)
          ])), [
            [P, {
              options: {
                hideOnClick: !1,
          ...
          o.value?.disabled ? z("", !0) : U((b(), A("button", {
            key: 1,
            type: "button",
          ...
          c.value?.disabled ? z("", !0) : (b(), ee(M, {
            ...
            header: ue(() => [
              y("span", na, B(I(s)("map.language.short")), 1)
            ]),
            default: ue(() => [
              (b(!0), A(tt, null, bt(v.value, (J, E) => (b(), A("a", {
                key: `${J}-${E}`,
                class: ce(["flex-auto items-center text-sm sm:text-base cursor-pointer", { "font-bold": J === I(a).$i18n.locale.value }]),
                href: "javascript:;",
                onClick: (L) => R(J)
              }, [
                ht(B(I(s)("map.language." + J)) + " ", 1),
                J === I(a).$i18n.locale.value ? (b(), A("span", ca, B(I(s)("map.language.curr")), 1)) : z("", !0)
              ], 10, la))), 128))
            ]),
            _: 1
          }, 8, ["tooltip", "ariaLabel"]))
  ...
  setup(r) {
    const e = Be(), t = Se("iApi"), { t: i } = se(), s = D(() => e.notificationNumber);
    return (a, o) => {
      const l = G("tippy");
      return U((b(), A("button", {
        type: "button",
        ...
        s.value && s.value > 0 ? (b(), A("span", da, B(s.value), 1)) : z("", !0)
      ], 8, pa)), [
        [l]
      ]);
    };
    ...
    return (c, u) => {
      ...
      return i.value ? (b(), A("div", {
        ...
        y("div", {
          ...
          y("div", ma, [
            y("h2", ya, B(I(t)("keyboardInstructions.title")), 1),
            fe(p, {
              class: "ml-auto",
...
function Va(r) {
  ...
  t.style.position = "fixed", t.style.overflow = "visible", t.style.whiteSpace = "nowrap", t.style.visibility = "hidden", e.parentElement?.appendChild(t);
  const i = t.getBoundingClientRect().width, s = e.getBoundingClientRect().width, a = t.getBoundingClientRect().height, o = e.getBoundingClientRect().height;
  if (t.remove(), i <= s || o > a)
    return !1;
}
const Ba = (r) => {
...
const za = ["content"], qa = {
  ...
  setup(r, { expose: e }) {
    ...
    }, w = D(() => c.screenId ? c.panel.screens[c.screenId][a.$i18n.locale.value ?? "en"] : null);
    return st(() => {
      ...
      return U((b(), A("div", {
        ...
        r.header ? (b(), A("header", qa, [
          ...
          U((b(), A("h2", ja, [
            v.$slots.header ? Ve(v.$slots, "header", { key: 0 }) : (b(), A("div", Ha, B(I(t)(r.panel.alertName)), 1))
          ])), [
            [q]
          ]),
          ...
          y("div", {
            ...
            r.panel.teleport ? z("", !0) : (b(), A("div", Wa, [
              d.value ? (b(), ee(V, {
                key: 0,
...
}), bo = { class: "relative" }, wo = ["content", "aria-label"], Ao = /* @__PURE__ */ N({
  __name: "left",
  props: {
    active: Boolean
  },
...
class Li {
  ...
  constructor(e, t) {
    ...
    const u = t?.settings;
    let p, d, g, h, m, w;
    u ? (p = u.categories ? u.categories : [], d = u.sortOrder ? u.sortOrder : [], g = u.disabledSearchTypes ? u.disabledSearchTypes : [], h = u.maxResults > 0 ? u.maxResults : 100, m = !!u.officialOnly) : (p = [], d = [], g = [], h = 100, m = !1), w = t?.customSources ?? [], w = w.map((v) => ({
      ...v,
      onSearch: async (C) => {
...
class un {
   ...
   */
  reloadWorker(e, t) {
    const i = ut(this.$vApp.$pinia), s = Be(this.$vApp.$pinia), a = be(this.$vApp.$pinia), o = Ee(this.$vApp.$pinia), l = Me(this.$vApp.$pinia), n = Jt(this.$vApp.$pinia), c = !!e;
  ...
  setLanguage(e) {
    if (this.$i18n.locale.value === e)
      return;
    const t = be(this.$vApp.$pinia), i = Be(this.$vApp.$pinia), s = t.registeredLangs;
  ...
  async setBasemap(e) {
    ...
    if (a) {
      ...
      const o = await k.ColorBackground({
        color: new ze(i.backgroundColour).toESRI()
      });
...
class _n extends re {
  ...
  async geoJsonToEsriJson(e, t) {
    ...
    if (t) {
      ...
      t.layerId ? a = t.layerId : a = this.$iApi.geo.shared.generateUUID(), t.colour && (c.renderer.symbol.color = new ze(t.colour).toArcServer());
    } else
    ...
    for (let m = 0; m < d.length; m++) {
      ...
      w.geometry.spatialReference = p, w.geometry.type = o.geometryType, Object.keys(w.attributes).forEach((v) => {
        g.includes(v) ? (Array.isArray(w.attributes[v]) || typeof w.attributes[v] == "object") && w.attributes[v] != null && (w.attributes[v] = JSON.stringify(w.attributes[v])) : delete w.attributes[v];
      });
    }
...
const ol = /* @__PURE__ */ Object.assign({ "../fixtures/appbar/index.ts": () => import("./index-B9BB-FYe.js"), "../fixtures/areas-of-interest/index.ts": () => import("./index-CJssKLJt.js"), "../fixtures/basemap/index.ts": () => import("./index-CKIsNAyc.js"), "../fixtures/crosshairs/index.ts": () => import("./index-B_uhdd8N.js"), "../fixtures/details/index.ts": () => import("./index-CzQqso1b.js"), "../fixtures/draw/index.ts": () => import("./index-BH1ilhvn.js"), "../fixtures/export-footnote/index.ts": () => import("./index-huTdp4U1.js"), "../fixtures/export-legend/index.ts": () => import("./index-BzU2M9OX.js"), "../fixtures/export-map/index.ts": () => import("./index-C1o8ilbs.js"), "../fixtures/export-northarrow/index.ts": () => import("./index-C-dlltHS.js"), "../fixtures/export-scalebar/index.ts": () => import("./index-D2OT-xaj.js"), "../fixtures/export-timestamp/index.ts": () => import("./index-neX-725k.js"), "../fixtures/export-title/index.ts": () => import("./index-DPUfYQQp.js"), "../fixtures/export/index.ts": () => import("./index-DKXoq9Jv.js"), "../fixtures/extentguard/index.ts": () => import("./index-Ct3RptKn.js"), "../fixtures/gazebo/index.ts": () => import("./index-CjRMonHi.js"), "../fixtures/geosearch/index.ts": () => import("./index-35IjpBiS.js"), "../fixtures/grid/index.ts": () => import("./index-BCbWmh2d.js"), "../fixtures/help/index.ts": () => import("./index-D5mgGkNY.js"), "../fixtures/hilight/index.ts": () => import("./index-BqV9vAb0.js"), "../fixtures/keyboardnav/index.ts": () => import("./index-DSXIYuf-.js"), "../fixtures/layer-reorder/index.ts": () => import("./index-LvyQGQp4.js"), "../fixtures/legend/index.ts": () => import("./index-D2O_omOC.js"), "../fixtures/mapnav/index.ts": () => import("./index-jk-giyLc.js"), "../fixtures/metadata/index.ts": () => import("./index-D8tRRNvU.js"), "../fixtures/northarrow/index.ts": () => import("./index-D2YwJEtM.js"), "../fixtures/overviewmap/index.ts": () => import("./index-DphPPDZg.js"), "../fixtures/panguard/index.ts": () => import("./index-CgFQ-8ns.js"), "../fixtures/scrollguard/index.ts": () => import("./index-YdvvQG3-.js"), "../fixtures/settings/index.ts": () => import("./index-aguZCWiI.js"), "../fixtures/snowman/index.ts": () => import("./index-WuN1lAfP.js"), "../fixtures/swipe/index.ts": () => import("./index-N8GynxQC.js"), "../fixtures/wizard/index.ts": () => import("./index-CKOg5Mil.js") });
class nl extends re {
  /**
...
const dl = /* @__PURE__ */ qe(ul, [["render", pl], ["__scopeId", "data-v-a3c61802"]]), hl = /* @__PURE__ */ Object.assign({ "../fixtures/areas-of-interest/screen.vue": () => import("./screen-BGB4ZiA-.js"), "../fixtures/basemap/screen.vue": () => import("./screen--3oYbzYu.js"), "../fixtures/export/screen.vue": () => import("./screen-C1ngFTtj.js"), "../fixtures/geosearch/screen.vue": () => import("./screen-BKub043T.js"), "../fixtures/grid/screen.vue": () => import("./screen-DnmHMHAM.js"), "../fixtures/help/screen.vue": () => import("./screen-CoxPUpHK.js"), "../fixtures/layer-reorder/screen.vue": () => import("./screen-BVDu9bHt.js"), "../fixtures/legend/screen.vue": () => import("./screen-k1sVJyic.js"), "../fixtures/metadata/screen.vue": () => import("./screen-jfZl7p9-.js"), "../fixtures/settings/screen.vue": () => import("./screen-C3ooRgjD.js"), "../fixtures/wizard/screen.vue": () => import("./screen-BObq8Ry1.js") });
class Ct extends re {
  /**
   * ID of this panel.
   *
...
function Wt(r) {
  ...
  )), typeof r.stateOnly < "u" && (e.cosmetic = r.stateOnly), r.initialFilteredQuery && (e.initialFilteredQuery = r.initialFilteredQuery), Al(r, e), (typeof r.toggleSymbology < "u" || r.table) && (e.fixtures = {}, typeof r.toggleSymbology < "u" && (e.fixtures.legend = {
...
var pt = { major: "4", minor: "15", patch: "0-beta", timestamp: "Tue Feb 3 15:25:09 2026 -0500", hash: "0c03e66bb7b2acf5cb803b897fcea853f918519e" };
console.info(
