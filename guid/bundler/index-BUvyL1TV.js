...
import { _ as H, d as L, F as K, G as X } from "./main-_XhbXLqv.js";
...
const G = /* @__PURE__ */ H(te, [["render", ne]]), ie = /* @__PURE__ */ I({
  ...
  setup(f) {
    const i = S("iApi"), { t } = B(), o = ee(), p = [
      {
        type: "point",
        icon: g(_(() => import("./point-icon-DHKh4c1H.js")))
      },
      {
        type: "polyline",
        icon: g(_(() => import("./polyline-icon-CPHNRHHy.js")))
      },
      {
        type: "polygon",
        icon: g(_(() => import("./polygon-icon-mH0XpQUX.js")))
      },
      {
        type: "circle",
        icon: g(_(() => import("./circle-icon-BfuUWLVQ.js")))
      },
      {
        type: "rectangle",
        icon: g(_(() => import("./rectangle-icon-DLZVv8iN.js")))
      }
    ], a = M(() => {
      const s = p.filter((u) => o.supportedTypes.some((x) => x.type === u.type));
      return s.push({
        type: "edit",
        icon: g(_(() => import("./edit-icon-7kt4EM0Y.js")))
      }), s;
    }), n = (s) => {
