...
import { ref as f, computed as P, markRaw as ee, defineComponent as O, inject as ge, reactive as we, watch as It, onBeforeUnmount as dt, resolveDirective as k, withDirectives as M, createElementBlock as A, openBlock as v, withKeys as ps, withModifiers as Qt, onMounted as Je, normalizeStyle as Mi, normalizeClass as ie, createVNode as oe, Transition as Pi, withCtx as se, createBlock as W, resolveDynamicComponent as ds, mergeProps as hs, useCssVars as fs, TransitionGroup as Ni, Fragment as He, renderList as ht, unref as I, nextTick as Ot, renderSlot as Me, createElementVNode as m, vShow as ms, resolveComponent as Z, createTextVNode as nt, toDisplayString as U, createCommentVNode as B, onUpdated as ys, Teleport as gs, getCurrentInstance as vs, useTemplateRef as mi, createApp as Fi, toRaw as Ie, h as bs, render as Vt, defineAsyncComponent as ws } from "vue";
...
class Ee {
  ...
  id;
  constructor(e, t, i) {
    this.geometry = e, t ? this.id = t : this.id = We.sharedUtils.generateUUID(), i ? this.attributes = i : this.attributes = {};
  }
  _hover;
...
class Vs {
  ...
  async projectGeometry(e, t) {
    ...
    const i = t.toGeoJSON(), r = await this.projectGeoJson(i, this.normalizeProj(t.sr), this.normalizeProj(e)), a = We.geom.geomGeoJsonToRamp(r, t.id);
...
const er = ["data-cy"], Ji = /* @__PURE__ */ O({
  ...
  function Q() {
    ...
    !R.includes(s.value) && !r.value) {
      let Fe;
      for (let fi = 0; fi < R.length - 1 && S < (s.value.width || he) + et; fi++)
        Fe = R.shift(), S += Fe.width || he;
      S >= (s.value.width || he) ? R.unshift(s.value) : e.value || (Fe = R.shift(), R.unshift(s.value));
      const tt = n.value.indexOf(s.value), Re = n.value.indexOf(Fe), Bt = n.value.slice();
      Re > -1 && (Bt.splice(tt, 1), Bt.splice(Re, 0, s.value)), n.value = Bt;
    }
    i.value = S, u.value = R;
  }
  function Qe(S) {
  ...
  setup(s) {
    ...
    return (u, p) => (v(), W(Ni, {
      ...
      default: se(() => [
        (v(!0), A(He, null, ht(o(I(t).screenSize), (d) => (v(), W(Ji, {
          key: `${d.id}`,
          panel: d
        }, null, 8, ["panel"]))), 128))
      ]),
    ...
    return (n, c) => {
      ...
      return M((v(), A("li", {
        ...
        s.notification.messageList && r.value ? (v(), A("div", hr, [
          (v(!0), A(He, null, ht(s.notification.messageList, (p, d) => (v(), A("p", {
    ...
    return (l, n) => {
      ...
      return v(), A("div", null, [
        o.value.length > 0 ? M((v(), A("ul", {
          ...
          (v(!0), A(He, null, ht(o.value, (d, g) => (v(), A(He, {
            key: d.message + g
          }, [
            g > 0 ? (v(), A("div", yr)) : B("", !0),
            M(oe(fr, {
      ...
      return v(), W(ii, {
        ...
        default: se((c) => [
          m("div", Ar, [
            ...
            oe(Zi, { class: "overflow-y-auto h-230" })
          ])
        ]),
        _: 1
      }, 8, ["tooltip"]);
  ...
  setup(s) {
    ...
    return (w, b) => {
      ...
      return v(), A("div", Ur, [
        ...
        oe(_r, { class: "sm:block display-none" }),
        d() ? (v(), A("span", Br, [
          m("a", {
        ...
        m("div", jr, [
          ...
          n.value?.disabled ? B("", !0) : (v(), W($, {
            ...
            default: se(() => [
              (v(!0), A(He, null, ht(u.value, (F, Q) => (v(), A("a", {
                key: `${F}-${Q}`,
    ...
    return (c, u) => {
      ...
      return i.value ? (v(), A("div", {
        ...
        m("div", {
          ...
          (v(!0), A(He, null, ht(r.value, (d) => (v(), A("p", {
...
}), rt = V("instance", () => ({ started: f(!1) })), oa = { class: "h-full relative" }, na = { class: "inner-shell absolute top-0 left-0 h-full w-full pointer-events-none" }, la = { class: "absolute top-8 w-full flex justify-center" }, ca = {
  key: 1,
  class: "w-full h-full"
}, ua = /* @__PURE__ */ O({
  __name: "shell",
  setup(s) {
    ...
    return (c, u) => (v(), A("div", oa, [
      m("div", na, [
        ...
        oe(aa, { class: "keyboard-instructions-modal" }),
        oe(ir, { class: "panel-stack sm:flex absolute inset-0 overflow-hidden sm:p-12 z-10 sm:pl-80 xs:pl-40 sm:pb-48 xs:pb-28 xs:pr-0 sm:pr-40" }),
...
const ya = /* @__PURE__ */ Ne(da, [["render", ma]]), Se = "focus-list", qe = "focus-item", ga = "focus-icon", va = "focus-container", ut = `[${Se}],[${va}]`, wt = "truncate-text", At = "show-truncate", ot = "focused", Kt = `button,input,select,a,textarea,[contenteditable],[${Se}],[${ga}],[tabIndex]`, ba = {
  mounted(s, e) {
...
class wa {
   ...
   */
  defocusItem(e) {
    e.classList.remove(ot), this.setTabIndex(-1, e), e._tippy && e._tippy.hide(), e.getAttribute(qe) === At && e.querySelector(`[${wt}]`)?._tippy?.hide();
  }
  /**
   ...
   */
  focusItem(e) {
    e.classList.add(ot), this.setAriaActiveDescendant(e), this.setTabIndex(0, e), e.scrollIntoView({ block: "nearest" }), e._tippy && !this.isTapped && e._tippy.show(), e.getAttribute(qe) === At && e.querySelector(`[${wt}]`)?._tippy?.show(), this.isTapped = !1;
  }
  /**
...
const $a = ["content"], Ca = {
  ...
  setup(s, { expose: e }) {
    const { t } = Y(), i = Ye(), r = $t(), a = ge("iApi"), o = mi("el"), l = mi("contentEl"), n = f();
    e({ el: o });
    ...
    return Je(() => {
      ...
      const T = Z("back"), N = Z("panel-options-menu"), F = Z("left"), Q = Z("right"), Qe = Z("pin"), Nt = Z("expand"), Ft = Z("minimize"), Dt = Z("close"), Gt = k("truncate"), Ut = k("focus-item"), S = k("tippy");
      return M((v(), A("div", {
...
class is extends J {
   ...
   */
  constructor(e, t, i) {
    super(e), this._uid = We.sharedUtils.generateUUID(), this._name = t.name, this._type = t.type ?? "placeholder", this._parent = i, this._children = [], this._loadPromise = new H(), this._hidden = t.hidden ?? !1, this._expanded = t.expanded ?? !0, this._visibility = !0, this._exclusive = t.exclusive ?? !1, this._controls = t.controls?.slice() ?? [
      "visibilityButton",
      "expandButton"
      /* Expand */
...
function Zo(s, e) {
  ...
  r.directive("focus-container", Sa), r.directive("focus-list", ba), r.directive("focus-item", Aa), r.directive("truncate", La), r.component("panel-screen", Fa), r.component("pin", Ba), r.component("close", qa), r.component("back", Ha), r.component("expand", Xa), r.component("panel-options-menu", co), r.component("dropdown-menu", ii), r.component("minimize", to), r.component("right", ro), r.component("left", no), r.component("fullscreen-nav-button", ho), r.component("geolocator-nav-button", fo), r.component("home-nav-button", mo), r.component("mapnav-button", vo), r.component("appbar-button", Eo), r.component("transition", Pi), r.component("transition-group", Ni), r.config.globalProperties.$iApi = e, r.config.globalProperties.$pinia = t, r.config.idPrefix = `ramp-${s.id || We.sharedUtils.generateUUID()}`, r.provide("iApi", e);
  const a = r.mount(s);
...
class qn extends J {
   ...
   */
  constructor(e) {
    super(e), this.geom = We.geom, this.proj = We.proj, this.shared = We.sharedUtils, this.map = new tn(e), this.layer = new yn(e), this.attributes = new Nn(e), this.query = new zn(e), this.symbology = new Vn(e), Array.isArray(ft.request.interceptors) || (ft.request.interceptors = []), ft.request.interceptors.push({
      before: (t) => {
...
const jn = /* @__PURE__ */ Object.assign({ "../fixtures/appbar/index.ts": () => import("./index-DWPVgYx6.js"), "../fixtures/areas-of-interest/index.ts": () => import("./index-DxG0NFyk.js"), "../fixtures/basemap/index.ts": () => import("./index-CvWX6VJt.js"), "../fixtures/crosshairs/index.ts": () => import("./index-CFFy01LU.js"), "../fixtures/details/index.ts": () => import("./index-ANOZqrHK.js"), "../fixtures/draw/index.ts": () => import("./index-D8c4TIDR.js"), "../fixtures/export-footnote/index.ts": () => import("./index-BXjeWpV4.js"), "../fixtures/export-legend/index.ts": () => import("./index-DCnAMvgy.js"), "../fixtures/export-map/index.ts": () => import("./index-cAB6wdSO.js"), "../fixtures/export-northarrow/index.ts": () => import("./index-wz5yWhpt.js"), "../fixtures/export-scalebar/index.ts": () => import("./index-DgZQfjs4.js"), "../fixtures/export-timestamp/index.ts": () => import("./index-Cwq2vZfo.js"), "../fixtures/export-title/index.ts": () => import("./index-COdNEi9T.js"), "../fixtures/export/index.ts": () => import("./index-CYX3hTWm.js"), "../fixtures/extentguard/index.ts": () => import("./index-DZGFjh8Y.js"), "../fixtures/gazebo/index.ts": () => import("./index-BxYlOdp6.js"), "../fixtures/geosearch/index.ts": () => import("./index-fSUN2Nrx.js"), "../fixtures/grid/index.ts": () => import("./index-079K7YPW.js"), "../fixtures/help/index.ts": () => import("./index-HKd6pXRH.js"), "../fixtures/hilight/index.ts": () => import("./index-kFMkGjw5.js"), "../fixtures/layer-reorder/index.ts": () => import("./index-BOcPyg7v.js"), "../fixtures/legend/index.ts": () => import("./index-DWVBtPZh.js"), "../fixtures/mapnav/index.ts": () => import("./index-BUvyL1TV.js"), "../fixtures/metadata/index.ts": () => import("./index-Ck6AAy-B.js"), "../fixtures/northarrow/index.ts": () => import("./index-DBAXltmX.js"), "../fixtures/overviewmap/index.ts": () => import("./index-s1XYc-Xf.js"), "../fixtures/panguard/index.ts": () => import("./index-DnFeuBE8.js"), "../fixtures/scrollguard/index.ts": () => import("./index-C40szbyL.js"), "../fixtures/settings/index.ts": () => import("./index-XnmA2djT.js"), "../fixtures/snowman/index.ts": () => import("./index-C24BTsOa.js"), "../fixtures/swipe/index.ts": () => import("./index-CIi5fCrr.js"), "../fixtures/wizard/index.ts": () => import("./index-BpbRqQWE.js") });
class Wn extends J {
  /**
...
const Zn = /* @__PURE__ */ Ne(Jn, [["render", Kn], ["__scopeId", "data-v-a3c61802"]]), Xn = /* @__PURE__ */ Object.assign({ "../fixtures/areas-of-interest/screen.vue": () => import("./screen-Cwf0MqK5.js"), "../fixtures/basemap/screen.vue": () => import("./screen-CYyrao-K.js"), "../fixtures/export/screen.vue": () => import("./screen-CcODn_H2.js"), "../fixtures/geosearch/screen.vue": () => import("./screen-DkEJK5Md.js"), "../fixtures/grid/screen.vue": () => import("./screen-Bmd3qypU.js"), "../fixtures/help/screen.vue": () => import("./screen-D1maptxI.js"), "../fixtures/layer-reorder/screen.vue": () => import("./screen-BLCxKzuo.js"), "../fixtures/legend/screen.vue": () => import("./screen-BBRk2qQr.js"), "../fixtures/metadata/screen.vue": () => import("./screen-tLES-wY5.js"), "../fixtures/settings/screen.vue": () => import("./screen-pTTHP5jk.js"), "../fixtures/wizard/screen.vue": () => import("./screen-l1Hq5WLt.js") });
class St extends J {
  /**
   * ID of this panel.
   *
...
var at = { major: "4", minor: "13", patch: "0-beta", timestamp: "Mon Aug 11 07:35:19 2025 -0400", hash: "dc62b9da051b329294f7d2e4dd53097e4addf2b7" };
console.info(
...
const Hl = (s, e, t) => new Ko(s, e, t), We = new zs();
export {
  H as $,
  Gr as A,
  yt as B,
