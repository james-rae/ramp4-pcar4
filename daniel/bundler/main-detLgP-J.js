import { TinyEmitter as ss } from "tiny-emitter";
import { defineStore as z, createPinia as rs } from "pinia";
import { ref as h, computed as N, markRaw as X, defineComponent as k, inject as ve, reactive as we, watch as xt, onBeforeUnmount as dt, resolveDirective as M, withDirectives as P, openBlock as g, createElementBlock as w, withKeys as os, withModifiers as Kt, onMounted as Je, normalizeClass as oe, normalizeStyle as Ri, createVNode as re, Transition as $i, withCtx as te, createBlock as W, resolveDynamicComponent as as, mergeProps as ns, TransitionGroup as Ci, Fragment as We, renderList as ht, unref as S, nextTick as $t, renderSlot as Me, createElementVNode as m, vShow as ls, resolveComponent as K, createTextVNode as at, toDisplayString as B, createCommentVNode as U, onUpdated as cs, Teleport as us, getCurrentInstance as ps, useTemplateRef as ui, createApp as Oi, toRaw as Ie, h as ds, render as Gt, defineAsyncComponent as hs } from "vue";
import St from "@arcgis/core/Color";
import ft from "@arcgis/core/config";
import { watch as Ae } from "@arcgis/core/core/reactiveUtils.js";
import pi from "@arcgis/core/geometry/Extent";
import fs from "@arcgis/core/geometry/Multipoint";
import ms from "@arcgis/core/geometry/Point";
import Qt from "@arcgis/core/geometry/Polygon";
import ki from "@arcgis/core/geometry/Polyline";
import ys from "@arcgis/core/geometry/SpatialReference";
import { fromJSON as gs } from "@arcgis/core/geometry/support/jsonUtils";
import vs from "@arcgis/core/Graphic";
import ze from "@arcgis/core/request";
import bs from "@arcgis/core/symbols/PictureMarkerSymbol";
import As from "@arcgis/core/symbols/SimpleFillSymbol";
import ws from "@arcgis/core/symbols/SimpleLineSymbol";
import qt from "@arcgis/core/symbols/SimpleMarkerSymbol";
import { fromJSON as Xt } from "@arcgis/core/symbols/support/jsonUtils";
import Mi from "deepmerge";
import { applyConverter as Es } from "@terraformer/spatial";
import ne from "proj4";
import { debounce as It, throttle as it } from "throttle-debounce";
import { createI18n as xs, useI18n as Y } from "vue-i18n";
import xe from "screenfull";
import di from "lodash.clonedeep";
import Ss, { setDefaultProps as Is, useTippy as _s } from "vue-tippy";
import Ts from "linkify-html";
import { createPopper as Ls, detectOverflow as Rs } from "@popperjs/core";
import Ct from "redaxios";
import { geojsonToArcGIS as $s } from "@terraformer/arcgis";
import { dsv as hi, csv2geojson as Cs } from "csv2geojson";
import He from "await-to-js";
import tt from "svg.js";
import Pi from "animejs";
import "tippy.js/animations/scale.css";
var Ce = /* @__PURE__ */ ((r) => (r.BLOB = "blob", r.DATE = "date", r.DOUBLE = "double", r.GEOMETRY = "geometry", r.GLOBAL_ID = "global-id", r.GUID = "guid", r.INTEGER = "integer", r.LONG = "long", r.OID = "oid", r.RASTER = "raster", r.SINGLE = "single", r.SMALL_INTEGER = "small-integer", r.STRING = "string", r.XML = "xml", r))(Ce || {}), $e = /* @__PURE__ */ ((r) => (r.CIRCLE = "circle", r.CROSS = "cross", r.DIAMOND = "diamond", r.ICON = "icon", r.PATH = "path", r.SQUARE = "square", r.TRIANGLE = "triangle", r.X = "x", r))($e || {}), ue = /* @__PURE__ */ ((r) => (r.DASH = "dash", r.DASHDOT = "dash-dot", r.DASHDOTDOT = "short-dash-dot-dot", r.DOT = "dot", r.LONGDASH = "long-dash", r.LONGDASHDOT = "long-dash-dot", r.LONGDASHDOTDOT = "long-dash-dot-dot", r.NONE = "none", r.NULL = "none", r.SHORTDASH = "short-dash", r.SHORTDASHDOT = "short-dash-dot", r.SHORTDASHDOTDOT = "short-dash-dot-dot", r.SHORTDOT = "short-dot", r.SOLID = "solid", r))(ue || {}), Ni = /* @__PURE__ */ ((r) => (r.BEVEL = "bevel", r.MITER = "miter", r.ROUND = "round", r))(Ni || {}), Fi = /* @__PURE__ */ ((r) => (r.ROUND = "round", r.BUTT = "butt", r.SQUARE = "square", r))(Fi || {}), Di = /* @__PURE__ */ ((r) => (r.BDIAG = "backward-diagonal", r.CROSS = "cross", r.DIAG_CROSS = "diagonal-cross", r.FDIAG = "forward-diagonal", r.HORIZONTAL = "horizontal", r.NONE = "none", r.NULL = "none", r.SOLID = "solid", r.VERTICAL = "vertical", r))(Di || {}), L = /* @__PURE__ */ ((r) => (r.POINT = "Point", r.MULTIPOINT = "MultiPoint", r.LINESTRING = "LineString", r.MULTILINESTRING = "MultiLineString", r.POLYGON = "Polygon", r.MULTIPOLYGON = "MultiPolygon", r.LINEARRING = "LinearRing", r.EXTENT = "Extent", r.NONE = "None", r.UNKNOWN = "Unknown", r))(L || {}), Ot = /* @__PURE__ */ ((r) => (r.Simple = "simple", r.Unique = "uniqueValue", r.ClassBreaks = "classBreaks", r.Unknown = "unknown", r))(Ot || {}), x = /* @__PURE__ */ ((r) => (r.FEATURE = "esri-feature", r.MAPIMAGE = "esri-map-image", r.TILE = "esri-tile", r.IMAGERY = "esri-imagery", r.GRAPHIC = "esri-graphic", r.WMS = "ogc-wms", r.WFS = "ogc-wfs", r.GEOJSON = "file-geojson", r.GEOJSONZIPPED = "file-zip-geojson", r.CSV = "file-csv", r.SHAPEFILE = "file-shape", r.FLATGEOBUF = "file-fgb", r.FLATGEOBUFZIPPED = "file-zip-fgb", r.OSM = "osm-tile", r.DATACSV = "data-csv", r.DATAJSON = "data-json", r.DATATABLE = "data-esri-table", r.UNKNOWN = "unknown", r.SUBLAYER = "sublayer", r))(x || {}), ye = /* @__PURE__ */ ((r) => (r.FEATURE = "feature", r.GRAPHIC = "graphic", r.IMAGERY = "imagery", r.MAPIMAGE = "map-image", r.NOLAYER = "no-layer", r.OSM = "osm-tile", r.TILE = "tile", r.UNKNOWN = "unknown", r.WMS = "wms", r))(ye || {}), ee = /* @__PURE__ */ ((r) => (r.ESRI_FEATURE = "esriFeature", r.ESRI_RASTER = "esriRaster", r.ESRI_TILE = "esriTile", r.OSM_TILE = "osmTile", r.OGC_RASTER = "ogcRaster", r.UNKNOWN = "unknown", r))(ee || {}), V = /* @__PURE__ */ ((r) => (r.POINT = "Point", r.MULTIPOINT = "MultiPoint", r.LINESTRING = "LineString", r.MULTILINESTRING = "MultiLineString", r.POLYGON = "Polygon", r.MULTIPOLYGON = "MultiPolygon", r))(V || {}), Q = /* @__PURE__ */ ((r) => (r.GEOMETRIC = "geometric", r.SYMBOLIC = "symbolic", r.HYBRID = "hybrid", r.NONE = "none", r))(Q || {}), D = /* @__PURE__ */ ((r) => (r.NEW = "new", r.INITIATING = "initiating", r.INITIATED = "initiated", r.TERMINATING = "terminating", r.TERMINATED = "terminated", r))(D || {}), j = /* @__PURE__ */ ((r) => (r.NEW = "new", r.LOADING = "loading", r.LOADED = "loaded", r.ERROR = "error", r))(j || {}), pe = /* @__PURE__ */ ((r) => (r.NOT_LOADED = "not-loaded", r.NOT_VISUAL = "not-visual", r.REFRESH = "refresh", r.UP_TO_DATE = "up-to-date", r))(pe || {}), nt = /* @__PURE__ */ ((r) => (r.ESRI = "esri", r.TEXT = "text", r.IMAGE = "image", r.HTML = "html", r.XML = "xml", r.JSON = "json", r.UNKNOWN = "unknown", r))(nt || {}), le = /* @__PURE__ */ ((r) => (r.SYMBOL = "symbol", r.GRID = "grid", r.EXTENT = "extent", r.INITIAL = "initial", r.API = "api", r.PERMANENT = "permanent", r))(le || {}), q = /* @__PURE__ */ ((r) => (r.BoundaryZoom = "boundaryZoom", r.Datatable = "datatable", r.Identify = "identify", r.Metadata = "metadata", r.Opacity = "opacity", r.Refresh = "refresh", r.Reload = "reload", r.Remove = "remove", r.Settings = "settings", r.Symbology = "symbology", r.Visibility = "visibility", r))(q || {});
class Ee {
  attributes;
  geometry;
  style;
...
class Z extends Ze {
  ...
  rawArray;
  constructor(e, t, i, s) {
    super(e, t.sr || i), s ? this.rawArray = t.slice() : this.rawArray = Z.parseXY(t);
  }
  ...
  static fromESRI(e, t) {
    return new Z(t, [e.x, e.y], _.fromESRI(e.spatialReference), !0);
  }
  toESRI() {
    return new ms({
      x: this.x,
  ...
  static fromGeoJSON(e, t) {
    return new Z(t, e.coordinates, _.fromGeoJSON(e.crs), !0);
  }
  toGeoJSON() {
...
class he extends Ze {
  ...
  get pointArray() {
    return this.rawArray.map((e, t) => new Z(this.childIdGenerator(t), e, this.sr, !0));
  }
  /** Returns a copy of the n-th contained point. */
  getAt(e) {
    return new Z(this.childIdGenerator(e), this.rawArray[e], this.sr, !0);
  }
...
class qe extends he {
  ...
  static fromESRI(e, t) {
    return new qe(t, e.rings[0], _.fromESRI(e.spatialReference), !0);
  }
  toESRI() {
    return new Qt({
      rings: [this.toArray()],
  ...
  static fromGeoJSON(e, t) {
    return new qe(t, e.coordinates, _.fromGeoJSON(e.crs), !0);
  }
  toGeoJSON() {
...
class se extends Ze {
  ...
  constructor(e, t, i, s) {
    super(e, t.sr || i), s ? this.rawArray = se.arrayDeepCopy(t) : this.rawArray = se.parsePolygon(t);
  }
  addLinearRings(e) {
...
class Oe extends Ze {
  rawArray;
  constructor(e, t, i, s) {
    super(e, t.sr || i), s ? this.rawArray = Oe.arrayDeepCopy(t) : this.rawArray = Oe.parseMultiPolygon(t);
  }
  addPolygon(e) {
  ...
  static parseMultiPolygon(e) {
    ...
    if (e instanceof se)
      return [e.toArray()];
    if (e instanceof be || e instanceof he)
...
class G extends Ze {
  ...
  rawMax;
  constructor(e, t, i, s) {
    super(e, t.sr || s), this.rawMin = Z.parseXY(t), this.rawMax = Z.parseXY(i);
  }
  ...
  static fromArcServer(e, t) {
    return G.fromESRI(pi.fromJSON(e), t);
  }
  ...
  static fromGeoJSON(e, t) {
    ...
    }), new G(t, i, s, _.fromGeoJSON(e.crs));
  }
  toGeoJSON() {
...
class Ge extends ke {
  ...
  toESRI() {
    let e;
    return this.styleType === $e.ICON ? Ge.isImageUrl(this.icon) ? (e = new bs(), e.url = this.icon, e.width = this.width, e.height = this.height, e.xoffset = this.xOffset, e.yoffset = this.yOffset, e.angle = this.angle) : (e = new qt(), e.color = new St(this.colour.rgba), e.size = this.width, e.xoffset = this.xOffset, e.yoffset = this.yOffset, e.angle = this.angle) : (e = new qt(), e.color = new St(this.colour.rgba), e.size = this.size, e.xoffset = this.xOffset, e.yoffset = this.yOffset, e.angle = this.angle, e.path = this.path, e.style = this.styleType, e.outline = this.outline.toESRI()), e;
  }
  static fromESRI(e) {
    const t = {
      xOffset: e.xoffset,
...
class Te extends ke {
  ...
  constructor(e) {
    ...
    this._width = typeof t > "u" || t < 0 ? 0.75 : t, this._colour = new Pe(e.colour), this._miter = e.miter ?? 2, this._cap = e.cap || Fi.ROUND, this._join = e.join || Ni.ROUND;
  }
...
class yt extends ke {
  ...
  _fillStyle;
  constructor(e) {
    super(), e = e || {}, e.fill || (e.fill = {}), this._fillColour = new Pe(e.fill.colour), this._fillStyle = e.fill.style || Di.SOLID, this._outlineStyle = new Te(e.outline);
  }
  /** Returns the specified colour */
  get fillColour() {
  ...
  toESRI() {
    const e = this.outline.toESRI(), t = new St(this.fillColour.rgba), i = new As();
...
class Os {
  ...
  esriMapClickToRamp(e, t) {
    return {
      mapPoint: Z.fromESRI(e.mapPoint, t),
      screenX: e.x,
      screenY: e.y,
      button: e.button,
  ...
  geomEsriToRamp(e, t) {
    switch (e.type) {
      ...
      case "polyline": {
        const i = e;
        return i.paths.length === 1 ? Be.fromESRI(i, t) : be.fromESRI(i, t);
      }
      case "polygon":
  ...
  graphicGeoJsonToRamp(e, t) {
    ...
    return Object.keys(e.properties.forEach((a) => s[a] = e.properties[a])), new Ee(i, "", s);
  }
  /**
  ...
  graphicRampToEsri(e) {
    ...
    return t.geometry = this.geomRampToEsri(e.geometry), Object.keys(e.attributes).forEach((i) => t.attributes[i] = e.attributes[i]), e.style && (t.symbol = this.styleRampToEsri(e.style)), new vs(t);
  }
  styleRampToEsri(e) {
    return e.toESRI();
  }
...
class Tt {
   ...
   */
  updateQuery(e) {
    const t = Mi.all([{}, this.queryMap, e]);
...
class Ps {
  ...
  async projectGeoJson(e, t, i) {
    let s, o;
    if (t ? s = this.normalizeProj(t) : s = _.parseGeoJsonCrs(e.crs), i ? o = this.normalizeProj(i) : o = Ms, o === s)
      return e;
  ...
  async projectGeometry(e, t) {
    ...
    const i = t.toGeoJSON(), s = await this.projectGeoJson(i, this.normalizeProj(t.sr), this.normalizeProj(e)), o = ut.geom.geomGeoJsonToRamp(s, t.id);
  ...
  async projectExtent(e, t) {
    const i = (y, A, b) => {
      if (b === 0)
        return [y, A];
      const $ = [(y[0] + A[0]) / 2, (y[1] + A[1]) / 2];
      if (b === 1)
        return [y, $, A];
      if (b > 1) {
        const T = i(y, $, b - 1), C = i($, A, b - 1);
    ...
    const a = new se("warpy", [o], t.sr, !0), l = await this.projectGeometry(e, a), n = l.toArray().pop() || [], c = n.map((y) => y[0]), u = n.map((y) => y[1]), p = Math.min.apply(null, c), d = Math.max.apply(null, c), v = Math.min.apply(null, u), f = Math.max.apply(null, u);
    return G.fromParams(t.id + "_projected", p, v, d, f, l.sr);
  }
}
class Ns {
  // useful functions
  ...
  sharedUtils;
  constructor() {
    this.proj = new Ps(), this.geom = new Os(), this.sharedUtils = new ks();
  }
  defaultTileSchemas() {
...
const Lt = z("appbar", () => {
  ...
  const r = h([]), e = h([]), t = h([]);
  function i(p) {
    return Ut(r.value, (d) => d?.uid === p);
  }
  function s(p) {
    return Ut(r.value, (d) => d?.id === p);
  }
  function o(p) {
    return Ut(
      r.value,
  ...
  function n(p, d) {
    ...
    const v = t.value.findIndex((f) => f === p.id);
    v !== -1 && v !== d && (t.value.splice(v, 1), t.value.splice(d, 0, p.id), t.value = [...t.value]);
  }
  function c(p) {
    const d = r.value.filter((v) => v.id !== p.id || v.uid !== p.uid);
    if (r.value = d, p.mapLayer) {
      const v = t.value.filter((f) => f !== p.id);
      t.value = v;
    }
  }
  function u(p) {
    const d = e.value.filter((v) => v.id !== p);
    e.value = d;
  }
  return {
    /**
  ...
  function i(a) {
    if (r.value = { ...r.value, [a.id]: X(a) }, a.id in e.value)
      e.value[a.id].resolveMe(X(a));
    else {
      const l = new H();
      l.resolveMe(X(a)), e.value = {
        ...e.value,
        [a.id]: l
      };
    }
...
class Bs extends J {
  ...
  _funCounter;
  constructor(e) {
    super(e), this._eventBus = new ss(), this._eventRegister = [], this._funCounter = 1, this._nameRegister = Object.values(E).filter((t) => typeof t == "string" && t.indexOf("/") > -1);
  }
  /**
  ...
  defaultHandlerFactory(e) {
    ...
    switch (e) {
      ...
      case "ramp_layer_remove_checks_grid":
        t = (i) => {
          if (this.$iApi.fixture.get("grid")) {
            const s = Wt(this.$vApp.$pinia), o = s.getGridId(i.id);
            if (o === void 0) return;
      ...
      case "ramp_map_resize_updates_scalebar":
        this.$iApi.event.on(
          "map/resized",
          It(100, () => this.$iApi.geo.map.caption.updateScale()),
          e
        );
        break;
      case "ramp_map_scale_updates_scalebar":
        this.$iApi.event.on(
          "map/scalechanged",
          It(300, () => this.$iApi.geo.map.caption.updateScale()),
          e
        );
        break;
      case "ramp_panel_close_updates_appbar":
        t = (i) => {
          const s = Lt(this.$vApp.$pinia);
...
function js() {
  return xs({
    ...
    locale: document.documentElement.getAttribute("lang") || fi,
    fallbackLocale: fi,
    globalInjection: !0,
    messages: zs,
    numberFormats: Vs
...
const Rt = z("maptip", () => {
  ...
  __name: "esri-map",
  setup(r) {
    const e = Rt(), t = ve("iApi"), i = N(() => e.maptipPoint), s = N(() => e.maptipInstance), o = N(() => e.content), a = we([]), l = h(!1);
    a.push(
      xt(i, () => {
        if (i.value) {
          const c = t.geo.map.getPixelWidth() / 2, u = 0, p = t.geo.map.mapPointToScreenPoint(i.value), d = p.screenX - c, v = u - p.screenY;
          s.value.setProps({
            // Offset more for touch devices so tooltip is visible above finger
            offset: l.value ? [d, v + 25] : [d, v]
  ...
  constructor(e) {
    this.resizeObserver = new ResizeObserver((t) => {
      t.length && window.requestAnimationFrame(() => {
        t.forEach((i) => {
          const s = i.target.dataset.breakpoints, o = s ? JSON.parse(s) : e ?? Ws;
...
const Hs = ["data-cy"], ji = /* @__PURE__ */ k({
    ...
    return (n, c) => {
      ...
      return g(), w("div", {
        ...
        re($i, {
          ...
          default: te(() => [
            P((g(), W(as(r.panel.route.screen), ns({ class: "h-full" }, r.panel.route.props, { panel: r.panel }), null, 16, ["panel"])), [
              [u]
            ])
          ]),
          _: 1
  ...
  function C() {
    let I = t.value;
    const R = [], ae = 350, fe = 12, li = 600;
    for (let Fe = n.value.length - 1; Fe >= 0; Fe--) {
      const et = n.value[Fe];
      let Re = et.width || ae;
      if (s.value ? Re = I : Re += fe, et.id === "grid" && (Re = Math.max(Math.min(Re, I), li)), (I >= Re && !s.value || R.length === 0) && (I -= Re, R.unshift(et)), et.id === "grid" && I < li)
        break;
    }
    if (r.value && //@ts-expect-error TODO: explain why this is needed or remove
    !R.includes(r.value) && !s.value) {
      let Fe;
      for (let ci = 0; ci < R.length - 1 && I < (r.value.width || ae) + fe; ci++)
        Fe = R.shift(), I += Fe.width || ae;
      I >= (r.value.width || ae) ? R.unshift(r.value) : e.value || (Fe = R.shift(), R.unshift(r.value));
      const et = n.value.indexOf(r.value), Re = n.value.indexOf(Fe), Dt = n.value.slice();
      Re > -1 && (Dt.splice(et, 1), Dt.splice(Re, 0, r.value)), n.value = Dt;
    }
    i.value = I, u.value = R;
  }
  function F(I) {
  ...
  function Pt(I, R) {
    const ae = n.value.indexOf(I), fe = R === "right" ? 1 : -1;
  ...
  function Nt(I) {
    ...
    R !== -1 && (u.value = [...u.value.slice(0, R), ...u.value.slice(R + 1)]), r.value && r.value.id == I.id && (r.value = void 0);
  }
  function Ft(I) {
    l.value = {
      ...l.value,
  ...
  __name: "panel-stack",
  setup(r) {
    const e = Ye(), t = ve("iApi"), i = h(), s = N(() => e.mobileView);
    Je(() => {
    ...
    return (c, u) => (g(), W(Ci, {
      ...
      default: te(() => [
        (g(!0), w(We, null, ht(o(S(t).screenSize), (p) => (g(), W(ji, {
          key: `${p.id}`,
          panel: p
        }, null, 8, ["panel"]))), 128))
      ]),
  ...
  for (const [i, s] of e)
    t[i] = s;
  return t;
}, Js = /* @__PURE__ */ Ne(Ys, [["__scopeId", "data-v-197830c4"]]), Zs = ["content", "aria-label"], ei = /* @__PURE__ */ k({
  ...
  setup(r) {
    const e = h(!1), t = h(null), i = we([]), s = h(), o = h(), a = h(), l = r;
    i.push(
      xt(e, () => {
        t.value.update();
      })
    ...
    return Je(() => {
      window.addEventListener(
        ...
        (!s.value || !s.value.contains(p.target)) && (e.value = !1);
      }), a.value.addEventListener("focus", c), a.value.addEventListener("blur", u), a.value.addEventListener("mouseover", c), a.value.addEventListener("mouseleave", u), $t(() => {
        const p = {
          name: "overflowScroll",
          enabled: !0,
          phase: "main",
        ...
        a.value && o.value && (t.value = Ls(a.value, o.value, {
  ...
  function s(c) {
    if (r.value.includes(c)) {
      ...
      c instanceof qi && n(c), u > -1 && r.value.splice(u, 1);
    }
  }
  function o(c) {
    e.value[c.id] = c;
...
}), Ks = { class: "h-full flex flex-col" }, Qs = { class: "w-full flex mb-6" }, Xs = ["content", "aria-label"], er = /* @__PURE__ */ k({
  __name: "screen",
  props: {
    panel: {
      type: Object,
  ...
  setup(r) {
    const e = Le(), { t } = Y(), i = N(() => e.notificationNumber), s = () => e.clearAll();
    return (o, a) => {
      const l = K("panel-screen"), n = M("tippy");
      return g(), W(l, { panel: r.panel }, {
        header: te(() => [
          at(B(S(t)("notifications.title")), 1)
        ]),
        content: te(() => [
          m("div", Ks, [
            m("div", Qs, [
...
class tr extends J {
  ...
  addGroup(e, t, i) {
    ...
    const s = new qi(this.$iApi, e, t, i);
...
const ir = ["content"], sr = { class: "flex items-center text-left" }, rr = { class: "select-text cursor-text" }, or = ["content"], ar = {
  key: 0,
  class: "text-left"
}, nr = /* @__PURE__ */ k({
  ...
  setup(r) {
    ...
    return (n, c) => {
      ...
      return P((g(), w("li", {
        ...
        content: S(t)(s.value ? "notifications.controls.collapse" : "notifications.controls.expand"),
        onClick: c[1] || (c[1] = (p) => s.value = !s.value)
      }, [
        m("div", sr, [
          m("span", null, [
            at(B(o[r.notification.type]) + " ", 1),
            m("span", rr, B(r.notification.message), 1)
          ]),
          c[4] || (c[4] = m("span", { class: "flex-grow" }, null, -1)),
          r.notification.messageList ? (g(), w("div", {
            key: 0,
          ...
          P((g(), w("button", {
            type: "button",
            onClick: c[0] || (c[0] = Kt((p) => a(r.notification), ["stop"])),
        ...
        r.notification.messageList && s.value ? (g(), w("div", ar, [
          (g(!0), w(We, null, ht(r.notification.messageList, (p, d) => (g(), w("p", {
    ...
    return (l, n) => {
      ...
      return g(), w("div", null, [
        a.value.length > 0 ? P((g(), w("ul", {
          ...
          (g(!0), w(We, null, ht(a.value, (d, v) => (g(), w(We, {
            key: d.message + v
          }, [
            v > 0 ? (g(), w("div", cr)) : U("", !0),
            P(re(nr, {
          ...
          m("span", null, B(S(t)("notifications.empty")), 1),
          n[2] || (n[2] = m("span", { style: { "flex-grow": "6" } }, null, -1))
        ]))
      ]);
    };
  }
}), pr = { class: "flex items-center hover:text-white" }, dr = ["aria-label"], hr = {
  key: 0,
  class: "number rounded-full w-18 text-white"
}, fr = { class: "notification-dropdown pointer-events-auto bg-white rounded text-center text-black w-500 h-256 flex flex-col p-0" }, mr = { class: "pb-8 border-b border-gray-600" }, yr = { class: "absolute flex right-3 top-3" }, gr = ["content", "aria-label"], vr = /* @__PURE__ */ k({
      ...
      return g(), W(ei, {
        ...
        header: te(() => [
          m("div", pr, [
            ...
            i.value && i.value > 0 ? (g(), w("span", hr, B(i.value), 1)) : U("", !0)
          ])
        ]),
        default: te((c) => [
          m("div", fr, [
            m("div", null, [
              m("h4", mr, B(S(t)("notifications.title")), 1),
              m("div", yr, [
                P((g(), w("button", {
                  type: "button",
                  onClick: s,
            ...
            re(Wi, { class: "overflow-y-auto h-230" })
          ])
        ]),
        _: 1
      }, 8, ["tooltip"]);
...
}), br = /* @__PURE__ */ Ne(vr, [["__scopeId", "data-v-3623a7d2"]]), Ar = { class: "flex hover:text-white" }, wr = ["aria-label"], Er = { class: "about-ramp-dropdown pointer-events-auto bg-white rounded w-256 h-50" }, xr = ["aria-label", "content"], Sr = { class: "pb-8 border-b border-gray-600 mb-10" }, Ir = { class: "absolute right-5 top-5" }, _r = { class: "select-text" }, Tr = { class: "font-bold cursor-text" }, Lr = { class: "text-sm cursor-text" }, Rr = { class: "text-sm cursor-text" }, $r = /* @__PURE__ */ k({
  ...
  setup(r) {
    const { t: e } = Y(), t = ve("iApi"), i = () => {
      t.reload();
    }, s = N(() => `${mt.major}.${mt.minor}.${mt.patch}`), o = N(() => mt.hash.slice(0, 9)), a = N(() => {
    ...
    return (l, n) => {
      const c = K("close"), u = K("dropdown-menu"), p = M("tippy"), d = M("focus-item");
      return P((g(), W(u, {
        ...
        default: te((v) => [
          m("div", Er, [
            m("div", null, [
              ...
              m("div", _r, [
                m("div", null, [
                  m("span", Tr, B(s.value), 1),
                  m("span", Lr, " [" + B(o.value) + "] ", 1)
                ]),
                m("div", null, [
                  m("span", Rr, B(a.value), 1)
                ]),
...
}), Cr = /* @__PURE__ */ Ne($r, [["__scopeId", "data-v-dc5124c0"]]), Or = { class: "map-caption absolute bottom-0 h-29 sm:h-38 flex justify-end pointer-events-auto cursor-default select-none text-gray-200 bg-black-75 left-0 right-0 py-2 sm:py-6" }, kr = {
  key: 0,
  class: "relative top-2 sm:top-1 ml-4 sm:ml-0 shrink-0"
}, Mr = ["href", "aria-label"], Pr = ["src", "alt"], Nr = {
  key: 1,
  class: "relative ml-10 top-2 text-sm sm:text-base"
}, Fr = { class: "flex min-w-fit justify-end" }, Dr = {
  key: 0,
  class: "pl-8 px-14 sm:block display-none relative top-2"
}, Gr = ["aria-pressed", "aria-label", "content"], Ur = { class: "relative top-1 text-sm sm:text-base" }, Br = { class: "text-gray-200 hover:text-white text-sm sm:text-base pb-5" }, zr = ["onClick"], Vr = {
  key: 0,
  class: "sr-only"
}, jr = /* @__PURE__ */ k({
  __name: "map-caption",
  setup(r) {
    const e = Ue(), t = de(), { t: i } = Y(), s = ve("iApi"), o = N(() => e.scale), a = N(() => e.attribution), l = N(() => e.coords), n = N(() => e.langtoggle), c = N(() => t.config.map), u = h([]), p = we([]);
    p.push(
      xt(c, (A) => {
        A && s.geo.map.caption.createCaption(c.value?.caption);
      })
    ), dt(() => {
      p.forEach((A) => A());
    }), cs(() => {
    ...
    const d = () => a.value?.logo?.link && a.value?.logo?.value && !a.value?.logo?.disabled, v = (A) => {
      s.$i18n.locale.value != A && s.setLanguage(A);
    }, f = () => {
      e.toggleScale(), s.geo.map.caption.updateScale();
    }, y = (A = !1) => i(A ? "map.toggleScaleToMetric" : "map.toggleScaleToImperial");
    return (A, b) => {
      ...
      return g(), w("div", Or, [
        ...
        re(br, { class: "sm:block display-none" }),
        d() ? (g(), w("span", kr, [
          m("a", {
        ...
        a.value?.text.disabled ? U("", !0) : P((g(), w("span", Nr, [
          at(B(a.value?.text.value), 1)
        ])), [
          [T, {
            options: {
              placement: "top",
        ...
        m("div", Fr, [
          l.value?.disabled ? U("", !0) : P((g(), w("div", Dr, [
            at(B(l.value?.formattedString), 1)
          ])), [
            [T, {
              options: {
                hideOnClick: !1,
          ...
          o.value?.disabled ? U("", !0) : P((g(), w("button", {
            key: 1,
            type: "button",
            ...
            m("span", {
              ...
              style: Ri({ width: o.value?.width })
            }, null, 4),
            m("span", Ur, B(o.value?.label), 1)
          ], 8, Gr)), [
            [C, {
              delay: [300, 0],
              placement: "top",
          ...
          n.value?.disabled ? U("", !0) : (g(), W($, {
            ...
            header: te(() => [
              m("span", Br, B(S(i)("map.language.short")), 1)
            ]),
            default: te(() => [
              (g(!0), w(We, null, ht(u.value, (F, ce) => (g(), w("a", {
                key: `${F}-${ce}`,
                class: oe(["flex-auto items-center text-sm sm:text-base cursor-pointer", { "font-bold": F === S(s).$i18n.locale.value }]),
                href: "javascript:;",
                onClick: (Xe) => v(F)
              }, [
                at(B(S(i)("map.language." + F)) + " ", 1),
                F === S(s).$i18n.locale.value ? (g(), w("span", Vr, B(S(i)("map.language.curr")), 1)) : U("", !0)
              ], 10, zr))), 128))
            ]),
            _: 1
          }, 8, ["tooltip", "ariaLabel"]))
  ...
  setup(r) {
    ...
    return (o, a) => {
      ...
      return P((g(), w("button", {
        ...
        s.value && s.value > 0 ? (g(), w("span", Wr, B(s.value), 1)) : U("", !0)
      ], 8, qr)), [
        [l]
      ]);
    };
  }
}), Yr = /* @__PURE__ */ Ne(Hr, [["__scopeId", "data-v-a451db5c"]]), Jr = { class: "flex items-center mb-20" }, Zr = { class: "text-xl" }, Kr = /* @__PURE__ */ k({
  __name: "keyboard-instructions",
  setup(r) {
    const e = ve("iApi"), { t } = Y(), i = h(!1), s = h(["app", "lists", "map"]), o = h([]), a = h(null), l = h(null);
    Je(() => {
      o.value.push(
    ...
    return (c, u) => {
      ...
      return i.value ? (g(), w("div", {
        ...
        m("div", {
          ...
          m("div", Jr, [
            m("h2", Zr, B(S(t)("keyboardInstructions.title")), 1),
            re(p, {
              class: "ml-auto",
              onClick: u[0] || (u[0] = (d) => i.value = !1)
            })
          ]),
          (g(!0), w(We, null, ht(s.value, (d) => (g(), w("p", {
            class: "whitespace-pre-line pb-10",
            key: d
          }, B(S(t)(`keyboardInstructions.${d}`)), 1))), 128)),
          m("button", {
            type: "button",
            ...
            ref_key: "lastEl",
            ref: l
          }, B(S(t)("keyboardInstructions.OK")), 513)
        ], 512)
      ], 32)) : U("", !0);
    };
  }
}), st = z("instance", () => ({ started: h(!1) })), Qr = { class: "h-full relative" }, Xr = { class: "inner-shell absolute top-0 left-0 h-full w-full pointer-events-none" }, eo = { class: "absolute top-8 w-full flex justify-center" }, to = {
  key: 1,
  class: "w-full h-full"
}, io = /* @__PURE__ */ k({
  __name: "shell",
  setup(r) {
    const e = ve("iApi"), t = st(), i = ge(), s = Ye(), { t: o } = Y(), a = N(() => i.items.appbar), l = () => {
      e?.event.emit("openKeyboardInstructions");
    }, n = () => s.teleported;
    return (c, u) => (g(), w("div", Qr, [
      m("div", Xr, [
        ...
        m("div", eo, [
          m("button", {
            ...
            onClick: l
          }, B(S(o)("keyboardInstructions.open")), 1)
        ]),
        re(Kr),
        re(Js, { class: "panel-stack sm:flex absolute inset-0 overflow-hidden sm:p-12 z-10 sm:pl-80 xs:pl-40 sm:pb-48 xs:pb-28 xs:pr-0 sm:pr-40" }),
        a.value ? U("", !0) : (g(), W(Yr, { key: 0 })),
        re(jr, { class: "z-30" })
      ]),
      S(t).started ? (g(), W(qs, { key: 0 })) : (g(), w("div", to, u[1] || (u[1] = [
        m("div", { class: "spinner relative inset-x-1/2 inset-y-9/20" }, null, -1)
      ]))),
      (g(!0), w(We, null, ht(n(), (p) => (g(), W(us, {
...
}), so = /* @__PURE__ */ Ne(io, [["__scopeId", "data-v-7a1e48c2"]]), ro = k({
  name: "App",
  components: { Shell: so },
  setup() {
    const r = ps();
    Je(() => {
      new Vi().observe(r?.proxy?.$refs["app-size"]), Is({
        aria: {
          content: "labelledby"
        },
        theme: "ramp4",
...
const lo = /* @__PURE__ */ Ne(ro, [["render", no]]), Se = "focus-list", je = "focus-item", co = "focus-icon", uo = "focus-container", ct = `[${Se}],[${uo}]`, bt = "truncate-text", At = "show-truncate", ot = "focused", Yt = `button,input,select,a,textarea,[contenteditable],[${Se}],[${co}],[tabIndex]`, po = {
  mounted(r, e) {
    +r.getAttribute("tabindex") <= 0 && r.setAttribute("tabindex", "0"), r.toggleAttribute(Se, !0), new ho(r, e.value);
  },
  updated(r) {
    Hi(r);
  }
...
function Hi(r) {
  r.querySelectorAll(Yt).forEach((t) => {
    if (t.closest(ct) === r || t.closest(ct) === t && t.parentElement.closest(ct) === r)
...
class ho {
  ...
  constructor(e, t) {
    ...
    e.addEventListener("keydown", function(s) {
      ...
      i.onTouchstart();
    }), e.addEventListener("refocusLegendItem", (s) => {
      const a = s.detail.focusItem;
  ...
  setTabIndex(e, t = this.element) {
    t.querySelectorAll(Yt).forEach((s) => {
      (e === -1 || s.closest(ct) === this.element || s.closest(ct) === s && s.parentElement.closest(ct) === this.element || s.closest(`[${Se}],.${ot}`).classList.contains(ot)) && s.setAttribute("tabindex", e.toString());
    });
  }
  /**
   ...
   */
  defocusItem(e) {
    e.classList.remove(ot), this.setTabIndex(-1, e), e._tippy && e._tippy.hide(), e.getAttribute(je) === At && e.querySelector(`[${bt}]`)?._tippy?.hide();
  }
  /**
   ...
   */
  focusItem(e) {
    e.classList.add(ot), this.setAriaActiveDescendant(e), this.setTabIndex(0, e), e.scrollIntoView({ block: "nearest" }), e._tippy && !this.isTapped && e._tippy.show(), e.getAttribute(je) === At && e.querySelector(`[${bt}]`)?._tippy?.show(), this.isTapped = !1;
  }
  /**
  ...
  onKeydown(e) {
    const t = this, i = Array.prototype.filter.call(
      ...
      (s) => s.closest(`[${Se}]`) === t.element && !!s.offsetParent
    );
    if (i.length !== 0)
      switch (e.key) {
        case "Up":
        ...
        case " ":
          ...
          break;
        case "Tab":
          const s = this.highlightedItem.querySelectorAll(Yt).length === 0, o = this.element.isEqualNode(e.target);
   ...
   */
  onFocus() {
    this.highlightedItem && !this.isClicked && (this.highlightedItem._tippy && this.highlightedItem._tippy.show(), this.highlightedItem.getAttribute(je) === At && this.highlightedItem.querySelector(`[${bt}]`)?._tippy?.show()), this.isClicked = !1, this.element.hasAttribute("aria-activedescendant") || this.highlightedItem === this.element ? this.highlightedItem !== this.element && this.focusItem(this.highlightedItem) : this.setAriaActiveDescendant(this.highlightedItem), Hi(this.element), this.highlightedItem && this.highlightedItem !== this.element && this.highlightedItem.setAttribute("tabindex", "-1");
  }
  /**
   ...
   */
  onBlur() {
    this.highlightedItem && (this.highlightedItem._tippy && this.highlightedItem._tippy.hide(), this.highlightedItem.getAttribute(je) === At && this.highlightedItem.querySelector(`[${bt}]`)?._tippy?.hide());
  }
  /**
...
const mi = "focus-item", fo = {
  beforeMount(r, e) {
    r.hasAttribute("id") || r.setAttribute("id", mo()), e.value ? r.setAttribute(mi, e.value) : r.toggleAttribute(mi, !0);
  }
};
function mo() {
  let r;
...
const ti = "focus-container", Yi = "focus-list", yo = "focus-icon", Bt = `[${Yi}],[${ti}]`, yi = `button,input,select,a,textarea,[contenteditable],.ag-tab-guard,[${Yi}],[${ti}],[${yo}],[tabIndex]`;
let zt = [];
const go = {
  mounted(r) {
    [...document.querySelectorAll(".inner-shell")].some((t) => t.contains(r)) && zt.push(new vo(r));
  },
  beforeUnmount(r) {
    zt = zt.filter((e) => e.element === r ? (e.removeEventListeners(), !1) : !0);
  }
};
class vo {
  element;
   ...
   */
  disableTabbing() {
    Array.prototype.filter.call(this.element.querySelectorAll(yi), () => !0).forEach((t) => {
      t.tabIndex = -1;
    });
  }
  /**
  ...
  enableTabbing() {
    let e;
    return Array.prototype.map.call(this.element.querySelectorAll(yi), (t) => {
      (t.closest(Bt) === this.element || t.closest(Bt) === t && t.parentElement.closest(Bt) === this.element) && t.offsetParent && (t.tabIndex = 0, e === void 0 && (e = t));
    }), e;
  }
}
const bo = "truncate-text", Ao = "truncate-trigger", wo = {
  beforeMount(r, e) {
    !r.classList.contains("truncate") && !e.value?.noTruncateClass && r.classList.add("truncate"), r.toggleAttribute(bo, !0);
  },
  mounted(r, e) {
    let t;
    e.value && e.value.externalTrigger && (t = r.closest(`[${Ao}]`)), _s(r, {
...
const xo = ["content"], So = {
  ...
  setup(r, { expose: e }) {
    const { t } = Y(), i = Ye(), s = Lt(), o = ve("iApi"), a = ui("el"), l = ui("contentEl"), n = h();
    e({ el: a });
    const c = r, u = N(() => o?.fixture.get("appbar") ? s.temporary : []), p = N(() => i.mobileView), d = N(() => i.reorderable), v = (b) => b.scrollHeight > b.clientHeight, f = () => !p.value && !c.panel.teleport, y = (b) => {
      c.panel.move(b), b === "left" && $t(() => {
    ...
    return Je(() => {
      a.value?.addEventListener("blur", () => {
        ...
        v(l.value) ? l.value?.setAttribute("tabIndex", "0") : l.value?.removeAttribute("tabIndex");
      ...
      const T = K("back"), C = K("panel-options-menu"), F = K("left"), ce = K("right"), Xe = K("pin"), Pt = K("expand"), Nt = K("minimize"), Ft = K("close"), I = M("truncate"), R = M("focus-item"), ae = M("tippy");
      return P((g(), w("div", {
        class: "h-full flex flex-col items-stretch",
        content: `<div style='word-break: break-word;'>${S(t)(r.panel.alertName) + ". " + S(t)("panels.access")}</div>`,
        ref_key: "el",
        ref: a
      }, [
        r.header ? (g(), w("header", So, [
          re(T, {
            class: oe(r.panel.teleport ? "display-none" : "block sm:display-none"),
            onClick: $[0] || ($[0] = (fe) => r.panel.close())
          }, null, 8, ["class"]),
          P((g(), w("h2", Io, [
            b.$slots.header ? Me(b.$slots, "header", { key: 0 }) : (g(), w("div", _o, B(S(t)(r.panel.alertName)), 1))
          ])), [
            [I]
          ]),
          b.$slots.controls ? (g(), W(C, { key: 0 }, {
            default: te(() => [
              Me(b.$slots, "controls")
            ]),
            _: 3
          ...
          m("div", {
            ...
            r.panel.teleport ? U("", !0) : (g(), w("div", To, [
              d.value ? (g(), W(F, {
                key: 0,
              ...
              r.panel.controls && r.panel.controls.expand ? (g(), W(Pt, {
                key: 2,
                onClick: $[4] || ($[4] = (fe) => r.panel.expand()),
                active: r.panel.expanded
              }, null, 8, ["active"])) : U("", !0)
            ])),
            r.panel.button && u.value?.includes(r.panel.id) ? (g(), W(Nt, {
              key: 1,
        ...
        r.content ? (g(), w("div", {
          ...
          b.$slots.content ? Me(b.$slots, "content", { key: 0 }) : A.value ? (g(), w("div", {
            key: 1,
            innerHTML: A.value.innerHTML
          }, null, 8, Lo)) : U("", !0)
        ], 512)) : U("", !0),
        r.footer ? P((g(), w("div", Ro, [
          Me(b.$slots, "footer")
        ])), [
          [R]
        ]) : U("", !0)
...
}), Co = { class: "relative" }, Oo = ["content", "aria-label"], ko = ["transform"], Mo = /* @__PURE__ */ k({
  __name: "pin",
  props: {
    active: Boolean
  },
    ...
    return (t, i) => {
      ...
      return g(), w("div", Co, [
        P((g(), w("button", {
          ...
          content: S(e)(r.active ? "panels.controls.unpin" : "panels.controls.pin"),
          "aria-label": S(e)(r.active ? "panels.controls.unpin" : "panels.controls.pin")
        }, [
          (g(), w("svg", {
            class: "fill-current w-16 h-16",
            xmlns: "http://www.w3.org/2000/svg",
...
}), Po = { class: "relative" }, No = ["content", "aria-label"], Fo = /* @__PURE__ */ k({
  __name: "close",
  props: {
    active: Boolean
  },
...
}), Do = { class: "relative" }, Go = ["content", "aria-label"], Uo = /* @__PURE__ */ k({
  __name: "back",
  props: {
    active: Boolean
  },
...
}), Bo = { class: "w-32 h-32" }, zo = ["content", "aria-label"], Vo = {
  key: 0,
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 24 24",
    ...
    return (t, i) => {
      ...
      return g(), w("div", Bo, [
        P((g(), w("button", {
          ...
          content: S(e)(`panels.controls.${r.active ? "collapse" : "expand"}`),
          "aria-label": S(e)(`panels.controls.${r.active ? "collapse" : "expand"}`)
        }, [
          r.active ? (g(), w("svg", jo, i[1] || (i[1] = [
            m("path", {
              d: "M0 0h24v24H0z",
              fill: "none"
            }, null, -1),
...
}), Wo = { class: "relative" }, Ho = ["content", "aria-label"], Yo = /* @__PURE__ */ k({
  __name: "minimize",
  props: {
    active: Boolean
  },
...
}), Jo = { class: "relative" }, Zo = ["content", "aria-label"], Ko = /* @__PURE__ */ k({
  __name: "right",
  props: {
    active: Boolean
  },
...
}), Qo = { class: "relative" }, Xo = ["content", "aria-label"], ea = /* @__PURE__ */ k({
  __name: "left",
  props: {
    active: Boolean
  },
...
}), ia = /* @__PURE__ */ Ne(ta, [["__scopeId", "data-v-51e22a4a"]]), sa = {
  key: 0,
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 24 24",
  ...
  setup(r) {
    ...
    return (s, o) => {
      ...
      return g(), W(a, {
        ...
        default: te(() => [
          S(t).isFullscreen ? (g(), w("svg", sa, o[0] || (o[0] = [
            m("path", {
              d: "M0 0h24v24H0z",
              fill: "none"
            }, null, -1),
  ...
  setup(r) {
    ...
    const s = async () => {
      ...
      const n = new Z("geolocation", l, _.latLongSR(), !0);
  ...
  tabindex: "-1"
}, ca = ["content", "aria-label"], ua = /* @__PURE__ */ k({
  __name: "button",
  props: {
    onClickFunction: {
      type: Function,
  ...
  class: "relative",
  tabindex: "-1"
}, da = ["aria-label", "content"], ha = /* @__PURE__ */ k({
  __name: "button",
  props: {
    onClickFunction: {
      type: Function,
  ...
  setup(r) {
    const e = ve("iApi"), t = r, i = () => e?.event.emit(E.APPBAR_BUTTON_CLICK, t.id);
    return (s, o) => {
...
}), fa = /* @__PURE__ */ Ne(ha, [["__scopeId", "data-v-457cd2d4"]]), ma = z("areas-of-interest", () => ({ areas: h([]) })), ya = z("export", () => {
  const r = h({
    title: !0,
    map: !0,
    mapElements: !0,
...
class ba {
  ...
  constructor(e, t) {
    Ct.get(t).then((i) => {
      i.data.definitions.forEach((s) => Vt[e][s.code] = s.description), Object.keys(Vt[e]).forEach((s) => {
        this.list[s] = Vt[e][s];
      }), this.listFetched = !0;
    });
  }
  ...
  fsaToProvinces(e) {
    const t = {};
    let i = va[e.substring(0, 1).toUpperCase()];
...
function xa(r, e) {
  ...
  if (t.test(e) && !r.disabledSearchTypes.includes("LAT/LNG")) {
    const o = e.slice(0, -1);
    return new Sa(r, o);
  } else return s.test(e) && !r.disabledSearchTypes.includes("FSA") ? new Ia(r, e) : i.test(e) && !r.disabledSearchTypes.includes("NTS") ? new _a(r, e.substring(0, 6).toUpperCase()) : new Ta(r, e);
}
class kt {
  config;
  query;
...
const vi = "https://geogratis.gc.ca/services/geolocation/@{language}/locate", bi = "https://geogratis.gc.ca/services/geoname/@{language}/geonames.json", Ai = "https://geogratis.gc.ca/services/geoname/@{language}/codes/province.json", wi = "https://geogratis.gc.ca/services/geoname/@{language}/codes/concise.json", La = {
  10: "NL",
  11: "PE",
  12: "NS",
  13: "NB",
...
class Ei {
  ...
  constructor(e, t) {
    ...
    l ? (i = l.geoLocation ? l.geoLocation : vi, s = l.geoNames ? l.geoNames : bi, o = l.geoProvince ? l.geoProvince : Ai, a = l.geoTypes ? l.geoTypes : wi) : (i = vi, s = bi, o = Ai, a = wi), i = i.replace("@{language}", e), s = s.replace("@{language}", e), o = o.replace("@{language}", e), a = a.replace("@{language}", e);
    const n = t?.settings;
    let c, u, p, d, v;
    n ? (c = n.categories ? n.categories : [], u = n.sortOrder ? n.sortOrder : [], p = n.disabledSearchTypes ? n.disabledSearchTypes : [], d = n.maxResults > 0 ? n.maxResults : 100, v = !!n.officialOnly) : (c = [], u = [], p = [], d = 100, v = !1), this.config = {
      language: e,
      geoNameUrl: s,
      geoLocateUrl: i,
      types: Ea(e, a),
   ...
   */
  query(e) {
    return xa(this.config, e.toUpperCase()).onComplete.then((t) => {
      let i = [];
...
const Ra = z("geosearch", () => {
  const r = h(new Ei("en", void 0)), e = h({
    type: "",
    province: "",
    extent: void 0
  ...
  function f(T) {
    e.value.province = typeof T.province > "u" ? "" : T.province, v(T.forceReRun);
  }
  function y(T) {
    e.value.type = typeof T.type > "u" ? "" : T.type, v(T.forceReRun);
  }
  function A(T) {
    o.value = i.value.replace(/["!*$+?^{}()|[\]\\]/g, "").trim(), i.value = T, v();
  }
  function b(T) {
    const C = {
...
}), $a = z("help", () => ({ location: h("./help/") }));
var Ji = /* @__PURE__ */ ((r) => (r.Visibility = "visibilityButton", r.Expand = "expandButton", r))(Ji || {}), Jt = /* @__PURE__ */ ((r) => (r.Item = "item", r.Placeholder = "placeholder", r.Error = "error", r))(Jt || {});
class Zi extends J {
  _uid;
  _name;
  _type;
  ...
  toggleVisibility(e, t = !0) {
    if (this.visibility !== e) {
      if (this._visibility = e ?? !this.visibility, !this.exclusive)
        ...
        if (this._lastVisible && (!(this._lastVisible instanceof De) || this._lastVisible.layerControlAvailable(q.Visibility)))
          this._lastVisible.toggleVisibility(!0);
        else {
          const i = this.children.find(
            (s) => !(s instanceof De) || s.layerControlAvailable(q.Visibility)
          );
   ...
   */
  checkVisibility(e) {
    this instanceof De && !this.layerControlAvailable(q.Visibility) || (this.exclusive ? e.visibility ? (this.children.forEach((t) => {
...
class De extends Zi {
  ...
  // @ts-expect-error TODO: explain why this is needed or remove
  load(e) {
    const t = e instanceof si ? e : this.$iApi.geo.layer.getLayer(this._layerId ?? this._layerUid);
...
var Ca = /* @__PURE__ */ ((r) => (r.Title = "title", r.Text = "text", r.Image = "image", r.Markdown = "markdown", r.Template = "template", r))(Ca || {});
class Si extends Zi {
  _infoType;
  ...
  constructor(e, t, i) {
    ...
    }), (t.infoType || t.content) && (this._controls = t.controls?.slice() ?? [Ji.Expand]), super.load();
  }
...
const Oa = z("legend", () => {
  ...
  function o(n) {
    if (n.parent === void 0)
      ...
      if (!(n.item instanceof Si) && !(n.item instanceof De)) {
  ...
  function a(n) {
    const c = (u) => (u = u.filter((p) => (p === n && !p.children.length && p.onRemoved(), p !== n)), u.forEach((p) => {
      ...
      (p) => !(p instanceof Si && !p.children.length && p.content === "")
    ), u);
    e.value = c(e.value);
  }
  function l(n) {
...
var ie = /* @__PURE__ */ ((r) => (r[r.UPLOAD = 0] = "UPLOAD", r[r.FORMAT = 1] = "FORMAT", r[r.CONFIGURE = 2] = "CONFIGURE", r))(ie || {});
const Da = z("wizard", () => {
  const r = {
    id: "Placeholder",
    layerType: x.UNKNOWN,
  ...
  function n(c) {
    switch (l.value) {
      ...
      case ie.FORMAT:
        ...
        break;
      case ie.CONFIGURE:
        c === ie.UPLOAD ? (t.value = "", i.value = "", o.value = null, s.value = !0, a.value = {
          config: r,
          configOptions: []
        }, l.value = ie.UPLOAD) : c === ie.FORMAT && (a.value = {
          config: r,
          configOptions: []
        }, s.value = !0, l.value = ie.FORMAT);
        break;
    }
  }
  return {
...
class Ga {
  ...
  _isFullscreen;
  constructor(e, t, i) {
    this.event = new Bs(this);
    const s = Ua(e, this);
    this.$vApp = s.app, this.$element = s.element, this.$i18n = s.i18n, this.$rootEl = s.app.$root?.$el, this.fixture = new Pn(this), this.panel = new Nn(this), this.geo = new kn(this), this.dev = new zn(this), this.ui = {
      ...
      escapeHtml: () => "",
      isPlainText: () => !0
    }, this.notify = new tr(this), this._isFullscreen = xe.isEnabled && !!this.$vApp.$root && xe.isFullscreen && xe.element === this.$vApp.$root.$el, xe.isEnabled && xe.onchange(() => {
   ...
   */
  initialize(e, t, i) {
    const s = de(this.$vApp.$pinia), o = Ye(this.$vApp.$pinia), a = Rt(this.$vApp.$pinia);
    if (t?.configs !== void 0) {
      ...
      const u = setInterval(() => {
        ...
        f && (clearInterval(u), this.geo.map.createMap(c.map, f).then(() => {
          if (f._tippy.hide(0), a.setMaptipInstance(f._tippy), c.layers && c.layers.length > 0) {
            let y = 0;
            c.layers.forEach((A) => {
      ...
      if (c.panels) {
        if (c.panels.open && c.panels.open.length > 0) {
          const f = c.panels.open.map((y) => y.id);
      ...
      }, d = c.system?.zoomIcon || "globe", v = p[d] || d;
   ...
   */
  reload(e, t) {
    const i = st(this.$vApp.$pinia), s = Le(this.$vApp.$pinia), o = de(this.$vApp.$pinia), a = ge(this.$vApp.$pinia), l = _e(this.$vApp.$pinia), n = Wt(this.$vApp.$pinia), c = !!e;
  ...
  useStore(e) {
    if (!([
      ...
      switch (e) {
        ...
        case "details":
          return zi(this.$vApp.$pinia);
        case "export":
          return ya(this.$vApp.$pinia);
        case "extentguard":
          return ga(this.$vApp.$pinia);
        case "geosearch":
          return Ra(this.$vApp.$pinia);
        case "grid":
  ...
  setLanguage(e) {
    if (this.$i18n.locale.value === e)
      return;
    const t = de(this.$vApp.$pinia), i = Le(this.$vApp.$pinia), s = t.registeredLangs;
...
function Ua(r, e) {
  ...
  t.use(({ store: a }) => {
    const l = di(a.$state);
    a.$reset = () => a.$patch(di(l));
  });
  const i = js(), s = Oi(lo).use(i).use(Ss, {
    directive: "tippy",
    // => v-tippy
    component: "tippy"
    // => <tippy/>
  }).use(t);
  s.directive("focus-container", go), s.directive("focus-list", po), s.directive("focus-item", fo), s.directive("truncate", wo), s.component("panel-screen", $o), s.component("pin", Mo), s.component("close", Fo), s.component("back", Uo), s.component("expand", qo), s.component("panel-options-menu", ia), s.component("dropdown-menu", ei), s.component("minimize", Yo), s.component("right", Ko), s.component("left", ea), s.component("fullscreen-nav-button", oa), s.component("geolocator-nav-button", aa), s.component("home-nav-button", na), s.component("mapnav-button", ua), s.component("appbar-button", fa), s.component("transition", $i), s.component("transition-group", Ci), s.config.globalProperties.$iApi = e, s.config.globalProperties.$pinia = t, s.config.idPrefix = `ramp-${r.id || e.geo.shared.generateUUID()}`, s.provide("iApi", e);
  const o = s.mount(r);
...
class ii {
  ...
  static async create(e) {
    const t = new ii(e), i = e.layers.map((a) => {
      ...
      if (a.layerType === x.MAPIMAGE)
        return O.MapImageLayer({
          url: a.url,
          opacity: a.opacity
        });
      if (a.layerType === x.OSM)
        return O.OpenStreetMapLayer({
          opacity: a.opacity
        });
    ...
    return t.esriBasemap = await O.Basemap({
      baseLayers: o,
      title: e.name || "",
      id: e.id
    }), t;
...
class Ba extends J {
  ...
  pointZoomScale;
  constructor(e) {
    super(e), this.esriMap = void 0, this._basemapStore = [], this._viewPromise = new H(), this.handlers = [], this.pointZoomScale = 5e4;
  }
  noMapErr() {
  ...
  async createMap(e, t) {
    ...
    }, s = e.basemaps.map((n) => ii.create(n)), a = (await Promise.all(s)).filter((n) => (n.createErr && i(n), n.esriBasemap.baseLayers.length > 0));
    a.forEach((n) => {
    ...
    const l = {};
    this.esriMap = X(await O.Map(l)), this.pointZoomScale = e.pointZoomScale && e.pointZoomScale > 0 ? e.pointZoomScale : 5e4, this._targetDiv = t, this.createMapView(e.initialBasemapId);
  }
  /**
...
class za extends J {
   ...
   */
  constructor(e) {
    super(e), this.maptipStore = Rt(this.$vApp.$pinia);
  }
    ...
    if (e ? (e.logo ? e.logo.disabled ? s.logo.disabled = !0 : (s.logo.altText = e.logo.altText || i.altText, s.logo.link = e.logo.link || i.link, s.logo.value = e.logo.value || i.value) : (s.logo.altText = i.altText, s.logo.link = i.link, s.logo.value = i.value), e.text ? e.text.disabled ? s.text.disabled = !0 : s.text.value = e.text.value || t.value : s.text.value = t.value, Ue(this.$vApp.$pinia).setAttribution(s)) : (s.logo.altText = i.altText, s.logo.link = i.link, s.logo.value = i.value, s.text.value = t.value), !e || e.text?.disabled || !e.text) {
      ...
      if (n) {
        const c = n.baseLayers.map((u) => new Promise((p) => {
          let d = 0;
          const v = a / l, f = setInterval(function() {
            u.loaded && !u.loadError ? (clearInterval(f), p(u)) : d > v && (clearInterval(f), p(null)), d++;
          }, l);
        })).toArray();
        Promise.all(c).then((u) => {
          o = u.filter((d) => d?.copyright).map((d) => d.copyright).join(" | "), s.text.value = o || s.text.value || t.value, Ue(this.$vApp.$pinia).setAttribution(s);
        });
      }
    }
  }
...
class ja extends Ba {
   ...
   */
  constructor(e) {
    super(e), this.maptip = new za(e), this.caption = new Va(e), this.mapMouseThrottle = 0;
  }
  async createMap(e, t) {
  ...
  async setBasemap(e) {
    ...
    if (o) {
      ...
      const a = await O.ColorBackground({
      ...
      if (this.esriMap || (this.noMapErr(), s()), e.initiationState !== D.INITIATING && e.initiationState !== D.INITIATED && e.layerState !== j.ERROR && e.initiate(), e.mapLayer && t === void 0) {
        ...
        if (e.isCosmetic)
          ...
          for (let d = c.length - 1; d >= 0 && p; d--) {
            const v = u.find((f) => f.id === c[d]);
            v && !v.isCosmetic && (t = d + 1, p = !1);
          }
          p && (t = 0);
        }
      }
  ...
  removeLayer(e) {
    ...
    let t;
    if (e instanceof si ? t = e : t = this.$iApi.geo.layer.getLayer(e), !t)
  ...
  screenPointToMapPoint(e) {
    return this.esriView ? Z.fromESRI(
      this.esriView.toMap({
        x: e.screenX,
        y: e.screenY
      }),
      "mappoint"
    ) : (this.noMapErr(), new Z("i_am_error", [0, 0], void 0, !0));
  }
  /**
  ...
  async symbolIdentify(e, t) {
    ...
    const s = (await this.esriView.hitTest({
      ...
      if (a.graphic.isAggregate === !0) {
        const n = await Promise.resolve(this.esriView.whenLayerView(l)), c = n.createQuery();
  ...
  */
  ...
  runIdentify(e) {
    ...
    t.some((c) => c.identifyMode === Q.HYBRID || c.identifyMode === Q.SYMBOLIC) && (s = this.symbolIdentify(i.screenX, i.screenY));
    const o = {
      geometry: i.mapPoint,
      hitTest: s
...
const qa = { geometryType: "point", renderer: { type: "simple", symbol: { type: "esriSMS", style: "esriSMSCircle", color: [67, 100, 255, 200], size: 7, outline: { color: [0, 0, 0, 255], width: 1 } } } }, Wa = { geometryType: "polyline", renderer: { type: "simple", symbol: { type: "esriSLS", style: "esriSLSSolid", color: [90, 90, 90, 200], width: 2 } } }, Ha = { geometryType: "polygon", renderer: { type: "simple", symbol: { type: "esriSFS", style: "esriSFSSolid", color: [76, 76, 125, 200], outline: { type: "esriSLS", style: "esriSLSSolid", color: [110, 110, 110, 255], width: 1 } } } }, Ya = { geometryType: "polygon", renderer: { type: "simple", symbol: { type: "esriSFS", style: "esriSFSSolid", color: [255, 0, 0, 64], outline: { type: "esriSLS", style: "esriSLSSolid", color: [240, 128, 128, 255], width: 1 } } } }, Ja = {
  circlePoint: qa,
  solidLine: Wa,
  outlinedPoly: Ha,
  boundingBoxPoly: Ya
...
class tn extends J {
  ...
  extractCsvFields(e, t = ",") {
    return hi.dsvFormat(t).parseRows(e)[0].map((s) => ({ name: s, type: Ce.STRING }));
  }
  /**
  ...
  filterCsvLatLonFields(e, t = ",") {
    const i = hi.dsvFormat(t).parseRows(e), s = i[0], o = {
  ...
  async geoJsonToEsriJson(e, t) {
    ...
    Ka(e);
    const l = e.features[0].geometry.type, n = Za[l], c = JSON.parse(
      // @ts-expect-error TODO: explain why this is needed or remove
      JSON.stringify(Ja[n])
    );
    if (t) {
      ...
      t.layerId ? o = t.layerId : o = this.$iApi.geo.shared.generateUUID(), t.colour && (c.renderer.symbol.color = new Pe(t.colour).toArcServer());
    } else
      throw new Error("geoJsonToEsriJson - missing opts arguement");
    s || (s = _.parseGeoJsonCrs(e.crs)), a.renderer = await O.RendererFromJson(c.renderer), a.fields = (a.fields || []).concat(
    ...
    const v = a.fields.map((y) => y.name);
    for (let y = 0; y < d.length; y++) {
      const A = d[y];
      A.geometry.spatialReference = p, A.geometry.type = a.geometryType, Object.keys(A.attributes).forEach((b) => {
        v.includes(b) ? (Array.isArray(A.attributes[b]) || typeof A.attributes[b] == "object") && A.attributes[b] != null && (A.attributes[b] = JSON.stringify(A.attributes[b])) : delete A.attributes[b];
      });
    }
    return (t.fieldMetadata?.fieldInfo && t.fieldMetadata?.fieldInfo.length > 0 ? t.fieldMetadata.fieldInfo.filter((y) => y.trim && v.includes(y.name)).map((y) => y.name) : []).forEach((y) => {
...
class rn extends J {
  ...
  async loadWfsData(e, t = -1, i = 0, s = 1e3, o = {
    ...
    const c = new Tt(e).updateQuery(l), [u, p] = await He(Ct.get(c));
    if (!p)
    ...
    if (o.features = o.features.concat(d.features), d.features.length < t - i) {
      ...
      return a && o.features.length > 0 && o.features[0].geometry.type === V.POINT && o.features.forEach((v) => {
  ...
  parseCapabilities(e) {
    const t = () => {
      ...
      return l ? (Array.isArray(l) || (l = [l]), l.map((n) => {
        ...
        let p = n.Style;
        const d = [], v = {};
        return p && (Array.isArray(p) || (p = [p]), p.forEach((f) => {
          const y = f.Name;
          if (d.push(y), f.LegendURL) {
            const b = f.LegendURL.OnlineResource["@_xlink:href"];
            v[y] = b.replaceAll("&amp;", "&");
          }
        })), {
...
class on extends J {
  ...
  ogc;
  constructor(e) {
    super(e), this.files = new tn(e), this.ogc = new rn(e);
  }
  /**
  ...
  async loadLayerMetadata(e) {
    ...
    const [t, i] = await He(ze(e, { query: { f: "json" } }));
    if (!i)
    ...
    if (o.name = s.name || "", o.currentVersion = s.currentVersion || -1, o.minScale = s.effectiveMinScale || s.minScale || 0, o.maxScale = s.effectiveMaxScale || s.maxScale || 0, o.extent = s.extent ? G.fromArcServer(s.extent, "layer_extent") : void 0, o.defaultVisibility = s.defaultVisibility ?? !0, o.canModifyLayer = s.canModifyLayer ?? !0, s.type === "Feature Layer" || s.type === "Table") {
      if (o.dataFormat = ee.ESRI_FEATURE, o.displayField = s.displayField || "", Array.isArray(s.fields)) {
        const a = await Promise.all(
          s.fields.map((n) => O.FieldFromJson(n))
        );
        o.fields = a.map((n) => ({
          name: n.name,
          alias: n.alias,
...
class si extends J {
   ...
   */
  constructor(e, t) {
    super(t), this.config = e, this.id = "", this.uid = "", this.name = "error", this.layerState = j.NEW, this.drawState = pe.NOT_LOADED, this.initiationState = D.NEW, this.layerIdx = -1, this.layerFormat = ye.UNKNOWN, this.layerType = x.UNKNOWN, this.dataFormat = ee.UNKNOWN, this.supportsIdentify = !1, this.identifyMode = Q.NONE, this.supportsFeatures = !1, this.mapLayer = !0, this.featureCount = 0, this.fields = [], this.fieldList = "", this.nameField = "", this.tooltipField = "", this.oidField = "", this.supportsSublayers = !1, this.isSublayer = !1, this.isRemoved = !1, this.isFile = !1, this.isCosmetic = !1, this.userAdded = !1, this.identify = !1, this.hovertips = !1, this.geomType = L.UNKNOWN, this.legend = [], this._sublayers = [], this.expectedTime = { draw: 0, load: 0, fail: 0 }, this.lastCancel = 0, this.canModifyLayer = !0, this.canReload = !0, this.url = "";
  }
  /**
   ...
   */
  getGraphic(e, t) {
    return Promise.resolve(new Ee(new Ve()));
  }
  /**
...
class Ki extends si {
  ...
  constructor(e, t) {
    super(e, t), this.name = e.name || "", this.geomType = L.NONE, this.dataFormat = ee.UNKNOWN, this.layerType = x.UNKNOWN, this.layerFormat = ye.UNKNOWN;
  ...
  async initiate() {
    ...
    }, this.expectedTime.fail), [s] = await He(this.onInitiate());
  ...
  async terminate() {
    this.updateInitiationState(D.TERMINATING), await Promise.all(this.sublayers.map((e) => e.terminate())), this.loadDefProm = new H(), this.loadPromDone = !1, this.updateLayerState(j.NEW), this.updateDrawState(pe.NOT_LOADED), this.updateInitiationState(D.TERMINATED);
  }
  // ----------- LAYER LOAD -----------
    ...
    try {
      ...
      Promise.all(s).then(() => {
        clearTimeout(i), t ? this.visibility = !1 : (this.stopTimer(
          "load"
          /* LOAD */
        ), e > this.lastCancel && (this.loadPromDone && (this.loadDefProm = new H()), this.loadDefProm.resolveMe(), this.loadPromDone = !0, this.sublayers.forEach((o) => o.onLoad()), this.updateLayerState(j.LOADED)));
      }).catch(() => {
  ...
  onError(e = !0) {
    this.layerState !== j.ERROR && (this.initiationState === D.INITIATING && this.updateInitiationState(D.NEW), this.loadPromDone && (this.loadDefProm = new H()), this.loadDefProm.rejectMe(), this.loadPromDone = !0, this.sublayers.forEach((t) => t.onError(e)), e && this.$iApi.notify.show(
      me.ERROR,
      this.$iApi.$i18n.t("layer.error", {
        id: this.id
      })
   ...
   */
  getGraphic(e, t) {
    return this.stubError(), Promise.resolve(new Ee(new Ve()));
  }
  getIcon(e) {
    return this.stubError(), Promise.resolve("");
  }
      ...
      variables: [
        {
          ...
          properties: this.fields.map((i) => {
            ...
            return s ? { name: i.name, type: s } : (console.error(`Encountered field type with no arcade support: ${i.type} [${i.name}]`), s);
          }).filter((i) => !!i)
        }
      ]
    };
    return O.ArcadeExecutor(e, t);
  }
  get nameArcade() {
...
class Ke extends Ki {
  ...
  async onInitiate() {
    ...
    this.esriWatches.push(
      ...
      this.esriView = X(e.layerView), this.esriWatches.push(
        Ae(
...
class ri extends Ke {
  ...
  filter;
  constructor(e, t) {
    super(e, t), this.supportsIdentify = !0, this.geomType = L.UNKNOWN, this.serviceUrl = "", this.fieldList = "", this.canModifyLayer = !0, this.filter = new Ui(e.permanentFilteredQuery || "", e.initialFilteredQuery || ""), this.hovertips = e.state?.hovertips ?? !0, this.attribs = new Xi();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
  ...
  async loadLayerMetadata(e = {}) {
    ...
    if (!(t < this.lastCancel))
      if (this.geomType = i.geometryType, this.attribs.quickCache = new ts(this.geomType), this.scaleSet.minScale = i.minScale, this.scaleSet.maxScale = i.maxScale, this.dataFormat = i.dataFormat, this.extent = this.extent ?? i.extent, this._serverVisibility = i.defaultVisibility, this.origRampConfig.name || (this.name = i.name ?? this.id), this.dataFormat === ee.ESRI_FEATURE) {
        ...
        this.attribs.attLoader = new es(this.$iApi, o);
      } else
  ...
  async getGraphic(e, t) {
    ...
    if (t.getGeom) {
      ...
      if (u)
        ...
        await this.viewPromise(), this.esriView.updating && await new Promise((v) => {
          const f = Ae(
        ...
        const p = await O.Query();
        p.objectIds = [e], p.returnGeometry = !0;
        const d = await this.esriView.queryFeatures(p);
        if (d.features.length) {
          const v = d.features[0], f = this.$iApi.geo.geom.geomEsriToRamp(v.geometry);
          this.attribs.quickCache.setGeom(e, f, n), s = f;
        } else
          l = !0;
      } else
        l = !0;
    ...
    const c = new Ee(s, "", t.getAttribs ? i : void 0);
    if (t.getStyle) {
...
class an extends Ke {
  constructor(e, t) {
    super(e, t), this.dataFormat = ee.ESRI_FEATURE, this.layerFormat = ye.GRAPHIC, this.hovertips = !1;
  }
  _graphics = [];
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
  ...
  async addGraphic(e) {
    ...
    const i = t.filter((n) => this._graphics.findIndex((u) => u.id === n.id) === -1 ? (this._graphics.push(n), !0) : (console.error(`Attempting to add graphic with id '${n.id}' that has already been added.`), !1)), s = this.$iApi.geo.map.getSR(), o = i.map((n) => this.$iApi.geo.proj.projectGeometry(s, n.geometry)), a = await Promise.all(o), l = i.map((n, c) => {
      const u = new Ee(a[c], n.id, n.attributes);
...
class nn extends an {
  ...
  async onInitiate() {
    this.esriLayer = X(await O.GraphicsLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
...
class Qe extends ri {
  ...
  sourceGeoJson;
  constructor(e, t) {
    super(e, t), this.supportsIdentify = !0, this.isFile = !0, this.dataFormat = ee.ESRI_FEATURE, this.layerFormat = ye.FEATURE, this.layerIdx = 0, e.identifyMode && e.identifyMode !== Q.NONE ? this.identifyMode = e.identifyMode : this.identifyMode = Q.HYBRID;
  }
  async reload() {
  ...
  async onInitiate() {
    ...
    this.esriJson = await this.$iApi.geo.layer.files.geoJsonToEsriJson(this.sourceGeoJson, e), this.esriLayer = X(await O.FeatureLayer(this.makeEsriLayerConfig(this.origRampConfig))), this.esriJson = void 0, this.origRampConfig.caching || delete this.origRampConfig.rawData, delete this.sourceGeoJson, await super.onInitiate();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
  ...
  onLoadActions() {
    const e = super.onLoadActions(), t = async () => {
      this.esriLayer && this.origRampConfig.customRenderer?.type && (this.esriLayer.renderer = await O.RendererFromJson(this.config.customRenderer)), this.layerTree.name = this.name, this.extractLayerMetadata(), this.$iApi.geo.attributes.applyFieldMetadata(this, this.origRampConfig.fieldMetadata), this.attribs.attLoader.updateFieldList(this.fieldList), await this.nameInitializer(
  ...
  async getGraphic(e, t) {
    ...
    if (t.getStyle) {
      const s = Ie(this.renderer.getGraphicSymbol(i.attributes));
...
class fn extends ri {
  constructor(e, t) {
    super(e, t), this.dataFormat = ee.ESRI_FEATURE, this.supportsIdentify = !0, this.layerType = x.FEATURE, this.layerFormat = ye.FEATURE, e.identifyMode && e.identifyMode !== Q.NONE ? this.identifyMode = e.identifyMode : this.identifyMode = Q.HYBRID;
  }
  async onInitiate() {
    X(this.esriLayer = await O.FeatureLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
  ...
  onLoadActions() {
    ...
    const a = async () => {
      ...
      if (this.esriLayer && this.origRampConfig.customRenderer?.type) {
        const c = await O.RendererFromJson(this.origRampConfig.customRenderer);
...
class mn extends Ke {
  ...
  async onInitiate() {
    this.esriLayer = X(await O.MapImageLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
  ...
  onLoadActions() {
    ...
    const o = [], a = (n, c) => {
      ...
      if (n.sublayers && n.sublayers.length > 0) {
        const d = (p ? p.name : "") || n.title || "", v = new _t(u, "", d, !1);
        c.findChildByIdx(u) || c.children.push(v), n.sublayers.reverse().forEach((f) => {
          a(f, v);
        });
      } else {
        this._sublayers[u] || (this._sublayers[u] = new yn(
          {
        ...
        if (d.isRemoved)
          return;
        if (d.name = p?.name || n.title || "", o.push(d), !c.children.map((v) => v.layerIdx).includes(u)) {
          const v = new _t(u, d.uid, d.name, !1);
          c.children.push(v);
        }
        d.esriWatches.push(
          Ae(
    ...
    const l = o.map(async (n) => {
      ...
      if (p && (n.esriSubLayer.renderer = await O.RendererFromJson(u.customRenderer)), await n.loadLayerMetadata(p ? { customRenderer: n.esriSubLayer?.renderer } : {}), t < this.lastCancel)
        return;
      ...
      if (d ? (n.visibility = n.isRemoved ? !1 : d.state?.visibility ?? (this.origState.visibility ? n._serverVisibility ?? this.origState.visibility : this.origState.visibility ?? n._serverVisibility) ?? !0, n.opacity = d.state?.opacity ?? this.origState.opacity ?? 1, this.$iApi.geo.attributes.applyFieldMetadata(n, d.fieldMetadata), n.canModifyLayer || this.$iApi.notify.show(
        ...
        t > this.lastCancel && (n.featureCount = v);
      }
    });
  ...
  runIdentify(e) {
    ...
    return e.geometry.type === L.POINT && (i = this.$iApi.geo.query.makeClickBuffer(e.geometry, e.tolerance)), t.map((s) => {
      ...
      return s.geomType !== L.POLYGON && i ? a.filterGeometry = i : a.filterGeometry = e.geometry, a.filterSql = s.getCombinedSqlFilter(), a.sourceSR = s.sourceSR, s.queryOIDs(a).then((n) => {
        n.forEach((c) => {
          l.items.push(vt.makeOidItem(c, s));
...
class yn extends ri {
  constructor(e, t, i) {
    if (super(e, t), this.layerType = x.SUBLAYER, this.layerFormat = ye.MAPIMAGE, this.isSublayer = !0, this.layerIdx = e.index, this.parentLayer = i, this.dataFormat = ee.ESRI_FEATURE, this.supportsFeatures = !0, this.hovertips = !1, this.url = this.parentLayer?.url, this.canReload = !!(this.url || this.origRampConfig.caching), !i.esriLayer)
...
class gn extends Ke {
  constructor(e, t) {
    super(e, t), this.supportsIdentify = !1, this.layerType = x.OSM, this.layerFormat = ye.OSM, this.dataFormat = ee.OSM_TILE, this.supportsFeatures = !1;
  }
  async onInitiate() {
    this.esriLayer = X(await O.OpenStreetMapLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
...
class vn extends Ke {
  constructor(e, t) {
    super(e, t), this.supportsIdentify = !1, this.layerType = x.IMAGERY, this.layerFormat = ye.IMAGERY, this.dataFormat = ee.ESRI_RASTER;
  }
  async onInitiate() {
    this.esriLayer = X(await O.ImageryLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
...
class bn extends Ke {
  constructor(e, t) {
    super(e, t), this.supportsIdentify = !1, this.layerType = x.TILE, this.layerFormat = ye.TILE, this.dataFormat = ee.ESRI_TILE;
  }
  async onInitiate() {
    this.esriLayer = X(await O.TileLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
...
class An extends Ke {
  ...
  mimeType;
  constructor(e, t) {
    super(e, t), this.supportsIdentify = !0, this.layerType = x.WMS, this.layerFormat = ye.WMS, this.mimeType = e.featureInfoMimeType || "", this.sublayerNames = [], this.dataFormat = ee.OGC_RASTER, this.identifyMode = Q.GEOMETRIC;
  }
  async onInitiate() {
    this.esriLayer = X(await O.WMSLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
  ...
  runIdentify(e) {
    ...
    return this.getFeatureInfo(this.sublayerNames, e.geometry, this.mimeType).then((s) => {
      if (s) {
        let o = !0, a;
        typeof s != "string" ? a = nt.JSON : s.indexOf("Search returned no results") === -1 && s !== "" ? a = nt.TEXT : (o = !1, a = nt.UNKNOWN), o && i.items.push(vt.makeRawItem(a, s));
      }
      i.loaded = !0, t.resolveMe();
    }).catch(() => {
      i.errored = !0, t.resolveMe();
  ...
  getFeatureInfo(e, t, i) {
    ...
    let a, l;
    const n = s.getExtent(), c = o.spatialReferences, u = e.join(","), p = s.esriView.toScreen(t.toESRI()), d = Math.floor(p.x), v = Math.floor(p.y), y = {
    ...
    }, this.$iApi.geo.layer.ogc.reversedAxisWKIDs().indexOf(a) > -1 && (l.BBOX = `${n.ymin},${n.xmin},${n.ymax},${n.xmax}`)) : l = { SRS: "EPSG:" + a, X: d, Y: v }, Object.prototype.hasOwnProperty.call(l, "BBOX") || (l.BBOX = `${n.xmin},${n.ymin},${n.xmax},${n.ymax}`);
    const b = {
      SERVICE: "WMS",
    ...
    }), Object.keys(b).forEach((T) => l[T] = b[T]), ze(o.url.split("?")[0], {
      query: l,
      responseType: y
    });
  }
...
class wn extends Qe {
  ...
  async onInitiate() {
    const e = Date.now(), t = new Tt(this.config.url), { offset: i, limit: s } = t.queryMap, o = await this.$iApi.geo.layer.ogc.loadWfsData(
      this.config.url,
      -1,
      parseInt(i) || 0,
      parseInt(s) || 1e3,
...
class Qi extends Ki {
  ...
  // ----------- LAYER CONSTRUCTION AND INITIALIZAION -----------
  constructor(e, t) {
    super(e, t), this.dataFormat = ee.ESRI_FEATURE, this.layerFormat = ye.NOLAYER, this.drawState = pe.NOT_VISUAL, this.attribs = new Xi(), this.supportsFeatures = !0, this.mapLayer = !1, this.isFile = !1, this._visibility = e.state?.visibility ?? !0, this.expectedTime.draw = 0;
  }
  async onInitiate() {
    if (this.sourceJson) {
      ...
      this.fields = t.map((c, u) => {
        ...
        const v = this.$iApi.geo.layer.files.inferType(i[u]);
        return {
          name: d,
          alias: p,
          type: v,
          length: v === Ce.STRING ? 256 : void 0
        };
      ...
      this.attribs.attLoader = new Tn(this.$iApi, o), await this.attribs.attLoader.getAttribs(), this.featureCount = e.data.length;
...
class xn extends Qi {
  ...
  serviceUrl;
  constructor(e, t) {
    super(e, t), this.layerType = x.DATATABLE, this.serviceUrl = e.url, this.filter = new Ui(e.permanentFilteredQuery || "", e.initialFilteredQuery || "");
  }
  async onInitiate() {
  }
  onLoadActions() {
    const e = super.onLoadActions(), t = Date.now(), s = this.$iApi.geo.shared.parseUrlIndex(this.serviceUrl).index || 0, o = this.$iApi.geo.layer.loadLayerMetadata(this.serviceUrl).then((l) => {
      ...
      this.attribs.attLoader = new es(this.$iApi, n), this.attribs.quickCache = new ts(this.geomType);
...
class In extends J {
  ...
  async loadGraphicsAttributes(e, t) {
    ...
    const s = {
      features: e.sourceGraphics.map((o) => Ie(o).attributes).toArray(),
      oidIndex: {}
    };
  ...
  async loadSingleFeature(e) {
    ...
    if (o.length > 0) {
      ...
      if (e.includeGeometry) {
        ...
        const n = gs(l.geometry);
        a = this.$iApi.geo.geom.geomEsriToRamp(n);
      } else
        a = new Ve();
      return new Ee(a, "", l.attributes);
    }
...
class oi extends J {
  ...
  constructor(e, t) {
    super(e), this.aac = new Ii(), this.details = t;
  }
  /**
  ...
  getAttribs() {
    return this.loadPromise || (this.aac = new Ii(), this.loadPromise = this.loadPromiseGenerator()), this.loadPromise;
  }
  abortAttribLoad() {
...
class ai {
  ...
  constructor(e, t, i = !1) {
    this.innerRenderer = e, this.symbolUnits = [], this.falseRenderer = i, this.type = Ot.Unknown;
  }
...
class Mt {
  ...
  parent;
  constructor(e) {
    this.parent = e, this.symbol = new qt();
  }
  match(e) {
    return !!e;
  }
...
class Rn extends ai {
  ...
  keyFields;
  constructor(e, t, i = !1) {
    super(e, t, i), this.type = Ot.Unique, this.delim = e.fieldDelimiter || ", ";
...
class $n extends ai {
  ...
  constructor(e, t, i = !1) {
    if (super(e, t, i), this.valField = this.cleanFieldName(e.field, t), e.classBreakInfos.forEach((s, o) => {
      const a = o === 0, l = new Ti(this, s.minValue, s.maxValue, a);
...
class Cn extends J {
  ...
  async symbolToSvg(e) {
    ...
    const o = tt(s).size(this.CONTAINER_SIZE, this.CONTAINER_SIZE).viewbox(0, 0, this.CONTAINER_SIZE, this.CONTAINER_SIZE), a = {
      // @ts-expect-error TODO: explain why this is needed or remove
      path({ size: f, path: y }) {
        return o.path(y).size(f * i);
      },
      // @ts-expect-error TODO: explain why this is needed or remove
      circle({ size: f }) {
        return o.circle(f * i);
      ...
      none: () => "transparent",
      // esriSFSNull
      horizontal: (f, y) => o.pattern(5, 5, (b) => b.line(0, 5 / 2, 5, 5 / 2)).stroke(y),
      vertical: (f, y) => o.pattern(5, 5, (b) => b.line(5 / 2, 0, 5 / 2, 5)).stroke(y),
      "forward-diagonal": (f, y) => o.pattern(5, 5, (b) => {
        b.line(0, 0, 5, 5).stroke(y), b.line(0, 0, 5, 5).move(0, 5).stroke(y), b.line(0, 0, 5, 5).move(5, 0).stroke(y);
      }),
      "backward-diagonal": (f, y) => o.pattern(5, 5, (b) => {
        b.line(5, 0, 0, 5).stroke(y), b.line(5, 0, 0, 5).move(5 / 2, 5 / 2).stroke(y), b.line(5, 0, 0, 5).move(-5 / 2, -5 / 2).stroke(y);
      }),
      cross: (f, y) => o.pattern(5, 5, (b) => {
        b.line(5 / 2, 0, 5 / 2, 5).stroke(y), b.line(0, 5 / 2, 5, 5 / 2).stroke(y);
      }),
      "diagonal-cross": (f, y) => o.pattern(7, 7, (b) => {
      ...
      "picture-fill"() {
        const f = e.imageData ? `data:${e.contentType};base64,${e.imageData}` : e.url, y = e.width * e.xscale, A = e.height * e.yscale;
        e.outline = e.outline || c;
        const b = v(e.outline.color), $ = d({
          color: b.colour,
          opacity: b.opacity,
        ...
        return t.$iApi.geo.shared.convertImagetoDataURL(f).then((C) => {
          const F = o.pattern(
            y,
            A,
            (ce) => (
      ...
      "picture-marker"() {
        const f = e.source, y = f && f.imageData ? `data:${f.contentType};base64,${f.imageData}` : e.url;
        return t.$iApi.geo.shared.convertImagetoDataURL(y).then((b) => t.svgDrawImage(o, b)).then(({ image: b }) => {
  ...
  async getMapServerLegend(e) {
    ...
    const t = {
      query: { f: "json" }
    }, i = { layers: [] }, [s, o] = await He(ze(`${e}/legend`, t));
  ...
  async mapServerLegendToRenderer(e, t) {
    ...
    if (typeof i < "u") {
      ...
      const o = await O.RendererFromJson(s);
...
class On extends J {
  ...
  async arcGisServerQueryIds(e) {
    ...
    const i = await O.QueryByIds(e.url, t);
  ...
  async geoJsonQuery(e) {
    ...
    return (await e.layer.esriLayer.queryFeatures(t)).features.map((s, o) => {
      let a;
      return t.returnGeometry ? a = this.$iApi.geo.geom.geomEsriToRamp(s.geometry, `queryResult${o}`) : a = new Ve(), new Ee(a, "", s.attributes);
    });
  }
  /**
...
class kn extends J {
   ...
   */
  constructor(e) {
    super(e), this.geom = ut.geom, this.proj = ut.proj, this.shared = ut.sharedUtils, this.map = new ja(e), this.layer = new on(e), this.attributes = new In(e), this.query = new On(e), this.symbology = new Cn(e), Array.isArray(ft.request.interceptors) || (ft.request.interceptors = []), ft.request.interceptors.push({
      before: (t) => {
...
const Mn = /* @__PURE__ */ Object.assign({ "../fixtures/appbar/index.ts": () => import("./index-CUNGmww_.js"), "../fixtures/areas-of-interest/index.ts": () => import("./index-pwgEOX9a.js"), "../fixtures/basemap/index.ts": () => import("./index-DdnJpEID.js"), "../fixtures/crosshairs/index.ts": () => import("./index-0VezoDNF.js"), "../fixtures/details/index.ts": () => import("./index-CEeKXBuZ.js"), "../fixtures/export-footnote/index.ts": () => import("./index-Bz7UkChZ.js"), "../fixtures/export-legend/index.ts": () => import("./index-Crw9SOz-.js"), "../fixtures/export-map/index.ts": () => import("./index-DXjUFgmj.js"), "../fixtures/export-northarrow/index.ts": () => import("./index-LoenP-5p.js"), "../fixtures/export-scalebar/index.ts": () => import("./index-DqJAv1-D.js"), "../fixtures/export-timestamp/index.ts": () => import("./index-CIan2g-G.js"), "../fixtures/export-title/index.ts": () => import("./index-B5nla8C_.js"), "../fixtures/export/index.ts": () => import("./index-7yQDwNeL.js"), "../fixtures/extentguard/index.ts": () => import("./index-C8Jcr21T.js"), "../fixtures/gazebo/index.ts": () => import("./index-0rPvOxgt.js"), "../fixtures/geosearch/index.ts": () => import("./index-W3hStZXs.js"), "../fixtures/grid/index.ts": () => import("./index-B7p9miUg.js"), "../fixtures/help/index.ts": () => import("./index-CpIqtSNV.js"), "../fixtures/hilight/index.ts": () => import("./index-DQfDmgj1.js"), "../fixtures/layer-reorder/index.ts": () => import("./index-B8hOh5Hd.js"), "../fixtures/legend/index.ts": () => import("./index-B7BDhoQI.js"), "../fixtures/mapnav/index.ts": () => import("./index-BLhWRj_O.js"), "../fixtures/metadata/index.ts": () => import("./index-Cfe08obZ.js"), "../fixtures/northarrow/index.ts": () => import("./index-t_MgN_CA.js"), "../fixtures/overviewmap/index.ts": () => import("./index-Ch2NQ8eu.js"), "../fixtures/panguard/index.ts": () => import("./index-CEx_BD2F.js"), "../fixtures/scrollguard/index.ts": () => import("./index-CxfnEFup.js"), "../fixtures/settings/index.ts": () => import("./index-XgEfdPvI.js"), "../fixtures/snowman/index.ts": () => import("./index-z6P1lyas.js"), "../fixtures/wizard/index.ts": () => import("./index-DQKmXQOr.js") });
class Pn extends J {
  /**
  ...
  async add(e, t) {
    ...
    if (t) {
      ...
      i = ni.updateBaseToInstance(new t(), e, this.$iApi);
    } else {
      const s = (await Mn[`../fixtures/${e}/index.ts`]()).default;
      i = new s(e, this.$iApi);
    }
...
class ni extends J {
  ...
  mount(e, { props: t, children: i, element: s, app: o } = {}) {
    let a = s, l = ds(e, t, i);
    return o && o._context && (l.appContext = o._context), a ? Gt(l, a) : (a = document.createElement("div"), Gt(l, a)), { vNode: l, destroy: () => {
      a && Gt(null, a), a = null, l = null;
    }, el: a };
  }
  /**
  ...
  getLayerFixtureConfigs() {
    const e = {}, t = (i, s = void 0) => {
      if (i.fixtures && i.fixtures[this.id] !== void 0) {
        let o = i.id;
        s !== void 0 && (o = this.$iApi.geo.layer.sublayerId(s.id, i.index)), e[o] = i.fixtures[this.id];
      }
...
class Nn extends J {
  ...
  register(e, t) {
    ...
    const s = Object.entries(i).reduce((o, [a, l]) => (o.push(new Et(this.$iApi, a, l)), o), []);
  ...
  open(e) {
    let t, i, s;
    if (typeof e == "string" || e instanceof Et ? t = this.get(e) : (t = this.get(e.id), { screen: i, props: s } = e), !t)
      return t;
  ...
  toggle(e, t) {
    let i;
    return typeof e == "string" || e instanceof Et ? i = this.get(e) : i = this.get(e.id), i && (t = typeof t < "u" ? t : !i.isVisible, t !== i.isVisible ? t ? this.open(e) : this.close(i) : i);
  }
  /**
  ...
  toggleMinimize(e, t) {
    let i;
    return typeof e == "string" || e instanceof Et ? i = this.get(e) : i = this.get(e.id), i && (t = typeof t < "u" ? t : !i.isVisible, t !== i.isVisible ? t ? this.open(i) : this.minimize(i) : i);
  }
  /**
...
const Un = /* @__PURE__ */ Ne(Dn, [["render", Gn], ["__scopeId", "data-v-a3c61802"]]), Bn = /* @__PURE__ */ Object.assign({ "../fixtures/areas-of-interest/screen.vue": () => import("./screen-PR99PAlQ.js"), "../fixtures/basemap/screen.vue": () => import("./screen-BIvn5ruQ.js"), "../fixtures/export/screen.vue": () => import("./screen-SyYtMLj9.js"), "../fixtures/geosearch/screen.vue": () => import("./screen-DLXAEzdU.js"), "../fixtures/grid/screen.vue": () => import("./screen-D6cIAPMu.js"), "../fixtures/help/screen.vue": () => import("./screen-3OiX2uHm.js"), "../fixtures/layer-reorder/screen.vue": () => import("./screen-UAGKc9YV.js"), "../fixtures/legend/screen.vue": () => import("./screen-DNMJbHi8.js"), "../fixtures/metadata/screen.vue": () => import("./screen-CqHOfEXT.js"), "../fixtures/settings/screen.vue": () => import("./screen-BnA6Cr-1.js"), "../fixtures/wizard/screen.vue": () => import("./screen-M3UoTyMb.js") });
class Et extends J {
  /**
   * ID of this panel.
   *
  ...
  registerScreen(e) {
    ...
    if (Ds(t) || Fs(t))
      ...
      let s;
      typeof t == "string" ? s = Bn[`../fixtures/${t}`]() : s = t();
      const o = new Promise((a, l) => {
        s.then((n) => {
          this.loadedScreens.push(e), a(Gs(n) ? n.default : n);
        }), s.catch((n) => l(n));
      });
      i = hs({
...
function jn(r) {
  ...
  return Wn(r.services, e), qn(r.map, e), Hn(r.ui, e), r.plugins && Yn(r.plugins, e), e;
}
function qn(r, e) {
  if (r.layers && r.layers.forEach((t) => {
    e.layers.unshift(is(t));
...
function Zt(r) {
  ...
  return r.controls && r.controls.length > 0 && (e.controls = pt(r.controls, t), r.controls.includes("visibility") && e.controls.push("visibilityButton"), (r.controls.length !== 1 || r.controls[0] !== "visibility") && console.warn(
    "Legend entry groups currently support only the visibility control. All other controls are currently not supported."
  ), e.controls.push("expandButton")), r.disabledControls && r.disabledControls.length > 0 && (e.disabledControls = pt(r.disabledControls, t), r.disabledControls.includes("visibility") && e.disabledControls.push("visibilityButton"), (r.disabledControls.length !== 1 || r.disabledControls[0] !== "visibility") && console.warn(
    "Legend entry groups currently support only the visibility control. All other controls are currently not supported."
  )), r.children.forEach((i) => {
    if (i.layerId)
      e.children.push(Li(i));
    else if (i.infoType)
      ...
      typeof i.collapse < "u" && console.warn(
        ...
        o.layerId ? s.children.push(Li(o)) : s.children.push(Zt(o));
      }), e.children.push(s);
    } else
      e.children.push(Zt(i));
  }), e;
}
function Li(r) {
  const e = r, t = [
  ...
  return r.controls && r.controls.length > 0 && (e.layerControls = pt(r.controls, t), e.layerControls.push("symbology")), r.disabledControls && r.disabledControls.length > 0 && (e.disabledLayerControls = pt(r.disabledControls, t)), r.controlledIds && (console.warn(
...
function jt(r) {
  ...
  return r.controls && r.controls.length > 0 && (e.controls = pt(r.controls, t), e.controls.push("symbology")), r.disabledControls && r.disabledControls.length > 0 && (e.disabledControls = pt(r.disabledControls, t)), r.state && (e.state = {
  ...
  )), typeof r.stateOnly < "u" && (e.cosmetic = r.stateOnly), r.initialFilteredQuery && (e.initialFilteredQuery = r.initialFilteredQuery), Jn(r, e), (typeof r.toggleSymbology < "u" || r.table) && (e.fixtures = {}, typeof r.toggleSymbology < "u" && (e.fixtures.legend = {
...
var rt = { major: "4", minor: "12", patch: "0-beta", timestamp: "Mon May 5 16:01:35 2025 -0400", hash: "e66d42ffcadd9271f33b5eb812b4497fe557c8f5" };
console.info(
...
const Pl = (r, e, t) => new Ga(r, e, t), ut = new Ns();
export {
  q as $,
  Cr as A,
  yt as B,
