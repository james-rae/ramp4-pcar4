...
import { E, _ as N, c as D } from "./main-jcSpRpL3.js";
...
const K = { class: "mt-10" }, q = ["aria-label"], F = ["alt", "src"], H = ["alt"], L = { class: "absolute flex w-full bg-black opacity-75 text-white h-30 bottom-6 items-center" }, G = { class: "pl-5" }, J = { class: "ml-auto pr-5" }, P = ["content"], Q = /* @__PURE__ */ w({
  ...
  setup(e) {
    ...
    return (a, t) => {
      const h = l("truncate"), u = l("tippy"), p = l("focus-item");
      return i(), n("div", K, [
        s((i(), n("button", {
          type: "button",
...
}), R = /* @__PURE__ */ N(Q, [["__scopeId", "data-v-06be115a"]]), U = { class: "h-600 overflow-y-auto" }, W = { class: "mx-5" }, X = { key: 0 }, xe = /* @__PURE__ */ w({
  __name: "screen",
  props: {
    panel: {
      type: Object
          ...
          o("div", U, [
            o("div", W, [
              r.value.length > 0 ? s((i(), n("ul", X, [
                (i(!0), n(S, null, V(r.value, (d, k) => (i(), n("li", { key: k }, [
                  $(R, {
                    area: d,
