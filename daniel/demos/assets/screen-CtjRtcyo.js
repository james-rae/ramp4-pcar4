import{ek as A,gf as H,el as j,eC as R,eD as O,eo as T,h0 as C,eI as X,eN as V,eH as B,eJ as D,ep as F,et as q,eu as k,es as o,eK as U,ez as m,eA as p,ew as d,ev as h}from"./main-CImGUKij.js";import{m as G}from"./marked.esm-DmSrlTiT.js";import"./preload-helper-ExcqyqRp.js";const z=`<?xml version="1.0" encoding="UTF-8"?>
...
`,K={key:0},Y={class:"flex justify-center"},Q={key:0,class:"flex flex-col justify-center text-center"},W=["innerHTML"],Z=["innerHTML"],ee={key:3,class:"flex flex-col justify-center text-center"},te={class:"text-xl mt-20"},ne={key:1,class:"p-5"},oe=A({__name:"screen",props:{panel:{type:Object,required:!0},payload:{type:Object,required:!0}},setup(r){const s=H(),{t:l}=j(),u=R("iApi"),M=O(),a=r,f=T(()=>s.status),v=T(()=>s.response),b=O(!1),x=C({}),y=C([]),S=C([]);X(()=>{$(),y.push(u.event.on(V.LAYER_REMOVE,e=>{a.payload.layer?.uid===e.uid&&a.panel.close()})),S.push(B(()=>a.payload.layer.uid,(e,t)=>{e!==t&&$()}))}),D(()=>{y.forEach(e=>u.event.off(e)),S.forEach(e=>e())});const $=()=>{b.value=a.payload.layer!==void 0&&!a.payload.layer.isRemoved,a.payload.type==="xml"?I(a.payload.url,[]).then(e=>{if(s.status="success",e!==null){const t=document.createElement("div");t.appendChild(g(`${e.firstElementChild.outerHTML}`)),(a.payload.catalogueUrl||a.payload.url)&&t.appendChild(g(`<h5 class="text-xl font-bold mb-3">${l("metadata.xslt.metadata")}</h5>`)),a.payload.catalogueUrl&&t.appendChild(g(`<p><a style="color: blue;" href="${a.payload.catalogueUrl}" target="_blank">${l("metadata.xslt.cataloguePage")}</a></p>`)),t.appendChild(g(`<p><a style="color: blue;" href="${a.payload.url}" target="_blank">${l("metadata.xslt.metadataPage")}</a> (xml)</p>`)),s.response=t.outerHTML}}):a.payload.type==="html"?w(a.payload.url).then(e=>{s.status=e.status,s.response=e.response}):a.payload.type==="md"&&w(a.payload.url).then(e=>{s.status=e.status,s.response=G(e.response)})},I=(e,t)=>{let n=u.language==="en"?z:J;return n=n.replace(/\{\{([\w.]+)\}\}/g,(i,c)=>l(c)),x[e]?Promise.resolve(_(x[e],n,t)):w(e).then(i=>(x[e]=i.response,_(x[e],n,t)))},_=(e,t,n)=>{let i=null;if(window.XSLTProcessor){const c=new window.XSLTProcessor,L=new DOMParser,N=L.parseFromString(e,"text/xml"),E=L.parseFromString(t,"text/xml");c.importStylesheet(E),n&&n.forEach(P=>c.setParameter("",P.key,P.value||"")),i=c.transformToFragment(N,document)}return i},w=e=>new Promise(t=>{const n=new XMLHttpRequest;n.open("GET",e,!0),n.responseType="text",n.onload=()=>{n.status===200?t({status:"success",response:n.response}):t({status:"error",response:"Could not load results from remote service."})},n.onerror=()=>{t({status:"error",response:"Could not load results from remote service."})},n.send()});function g(e){const t=document.createElement("div");return t.innerHTML=e,t}return(e,t)=>{const n=F("panel-screen");return o(),q(n,{panel:r.panel,ref_key:"el",ref:M},{header:k(()=>[U(m(p(l)("metadata.title"))+": "+m(r.payload.layerName),1)]),content:k(()=>[b.value?(o(),d("div",K,[h("div",Y,[f.value=="loading"?(o(),d("div",Q,m(p(l)("metadata.loading")),1)):r.payload.type==="xml"&&f.value=="success"?(o(),d("div",{key:1,innerHTML:v.value,class:"flex flex-col justify-center xml-content"},null,8,W)):(r.payload.type==="html"||r.payload.type==="md")&&f.value=="success"?(o(),d("div",{key:2,innerHTML:v.value,class:"flex flex-col justify-center max-w-full metadata-view"},null,8,Z)):(o(),d("div",ee,[t[0]||(t[0]=h("img",{src:"https://i.imgur.com/fA5EqV6.png"},null,-1)),h("span",te,m(p(l)("metadata.error")),1)]))])])):(o(),d("div",ne,[h("span",null,m(p(l)("metadata.label.no.layer")),1)]))]),_:1},8,["panel"])}}});export{oe as default};
