import { $ as e, B as t, G as n, V as r, ct as i, s as a } from "./main-Ck4jBxAm.js";
...
Chaque forme sélectionnée peut avoir des options différentes des valeurs par défaut. Utilisez l'onglet Style de l'inspecteur de forme pour les couleurs et l'opacité. Utilisez l'onglet Modifier de l'inspecteur de forme pour la distance du tampon, l'unité du tampon, l'utilisation du tampon d'identification, les aides de modification et la suppression.`
	...
	async init() {
		...
		this.$iApi.panel.get("draw-settings") || (e[S] = {
			screens: { "draw-settings-screen": () => F(import("./draw-defaults-screen-uWqJ5zLT.js")) },
			style: { width: "350px" },
			button: {
			...
			screens: { "draw-shape-details-screen": () => F(import("./shape-inspector-screen-9_iORVWR.js")) },
			style: { width: "350px" },
			button: {
	...
	async added() {
		this.unregisterIdentifyGeometryProvider ||= this.$iApi.geo.map.registerIdentifyGeometryProvider(this), this.registerHelpSection(), this.eventHandlers.length || (this.$iApi.geo.map.created ? this.init() : this.eventHandlers.push(this.$iApi.event.on(r.MAP_CREATED, () => {
			this.init();
		})), this.eventHandlers.push(this.$iApi.event.on(r.FIXTURE_ADDED, (e) => {
