import { B as e, V as t, s as n } from "./main-Ck4jBxAm.js";
import { t as r } from "./_plugin-vue_export-helper-C6QCLu9I.js";
...
var b = { class: "swipe-container" }, x = [
	...
	setup(n) {
		let r = c("iApi"), s = e(), C = _("slider"), w = m(45), T = m(0), E = m(0), D = m(50), O = m(), k = m(), A = i(() => {
		...
		}), j = i(() => `${T.value}px`), M = i(() => `${-T.value / 2 - 18}px`), N = n;
		u(() => {
		...
		f(async () => {
			...
			if (!e()) {
				let t = new MutationObserver((t, n) => {
					e() && n.disconnect();
				});
				t.observe(k.value, {
					childList: !0,
			...
			r.event.on(t.MAP_BASEMAPCHANGE, async (e) => {
			...
			}), r.event.on(t.LAYER_RELOAD_END, (e) => {
...
}), [["__scopeId", "data-v-2c7cd867"]]), w = class extends n {
	_parseConfig(e) {
