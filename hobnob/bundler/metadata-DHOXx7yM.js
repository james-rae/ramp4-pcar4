import { G as e, b as t, s as n } from "./main-Ck4jBxAm.js";
...
var i = class extends n {
	...
	en: {
		...
		"metadata.notification.rawFallback": "Metadata could not be displayed in formatted view. Raw metadata is available instead.",
		"metadata.notification.rawFallbackWithReason": "Metadata could not be displayed in formatted view. Raw metadata is available instead. Reason: {reason}",
	...
	fr: {
		...
		"metadata.notification.rawFallback": "Les métadonnées n'ont pas pu être affichées en format structuré. Les métadonnées brutes sont disponibles à la place.",
		"metadata.notification.rawFallbackWithReason": "Les métadonnées n'ont pas pu être affichées en format structuré. Les métadonnées brutes sont disponibles à la place. Raison : {reason}",
	...
	async added() {
		this.$iApi.panel.register({ metadata: {
			screens: { "metadata-screen-content": () => r(import("./screen-CFJZ3RY3.js")) },
			style: { width: "350px" },
			button: {
			...
			this.$iApi.fixture.exists("appbar") && e(this.$vApp.$pinia).removeButton("metadata"), t(this.$vApp.$pinia).$reset(), this.$iApi.panel.remove("metadata");
		};
	}
};
//#endregion
