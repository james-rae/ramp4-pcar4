import { B as e, V as t, s as n, x as r } from "./main-Ck4jBxAm.js";
import { t as i } from "./_plugin-vue_export-helper-C6QCLu9I.js";
import { t as a } from "./keyboard-DErRoD5p.js";
import { a as o, i as s, t as c } from "./store-De1UwLdA.js";
import { n as l, t as u } from "./panel-utils-OKyvGxOq.js";
import { t as d } from "./info-icon-DVqwcwNm.js";
import { t as f } from "./settings-icon-5SEJ2EbE.js";
...
var W = /* @__PURE__ */ i(V, [["render", U]]), G = /* @__PURE__ */ x({
	...
	setup(t) {
		let n = S("iApi"), { t: r } = B(), i = c(), a = e();
		i.mapNavEl = I("mapNavEl");
		let v = [
			{
				type: "point",
				icon: C(b(() => import("./point-icon-BgRroKa9.js")))
			},
			{
				type: "polyline",
				icon: C(b(() => import("./polyline-icon-DvMDwwZJ.js")))
			},
			{
				type: "polygon",
				icon: C(b(() => import("./polygon-icon-G72ajNKZ.js")))
			},
			{
				type: "rectangle",
				icon: C(b(() => import("./rectangle-icon-D4eNHILC.js")))
			},
			{
				type: "circle",
				icon: C(b(() => import("./circle-icon-B5cowh_X.js")))
			}
			...
			if (i.setShapeDetailsPickEnabled(e), !e) {
				A.value && n.panel.close(o);
				return;
			}
			i.setActiveTool(null), i.clearSelection(), a.mobileView || V("details");
		}, O = m(() => u(a, s)), A = m(() => u(a, o)), N = m(() => i.graphics.length > 0), R = m(() => N.value && i.shapeDetailsPickEnabled), z = () => {
			if (O.value) {
				n.panel.close(s);
				return;
			}
