import { V as e, s as t, x as n } from "./main-Ck4jBxAm.js";
import { t as r } from "./store-BUJNAlWI.js";
...
var m = class extends t {
	...
	addDynamicSection(e) {
		r(this.$vApp.$pinia).addDynamicSection(e);
	}
	removeDynamicSection(e) {
		r(this.$vApp.$pinia).removeDynamicSection(e);
	}
	get config() {
		return super.config;
	}
	...
	added() {
		this.$iApi.component("help-nav-button", h), this.$iApi.panel.register({ help: {
			screens: { "help-screen": () => c(import("./screen-CYkky8X1.js")) },
			style: {
				"flex-grow": "1",
				"max-width": "750px"
			},
		...
		this.removed = () => {
			e(), this.$iApi.fixture.exists("mapnav") && n(this.$vApp.$pinia).removeItem("help"), r(this.$vApp.$pinia).$reset(), this.$iApi.panel.remove("help");
		};
	}
};
//#endregion
