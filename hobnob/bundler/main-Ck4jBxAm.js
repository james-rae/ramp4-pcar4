import { A as e, C as t, D as n, E as r, F as i, M as a, N as o, O as s, S as c, T as l, a as u, c as d, k as f, o as p, t as m, v as h, w as g, y as ee } from "./esri-C6orwzKs.js";
import { n as _, t as v } from "./config-vKemIUe8.js";
import { t as te } from "./_plugin-vue_export-helper-C6QCLu9I.js";
import { t as ne } from "./keyboard-DErRoD5p.js";
import { t as re } from "./store-BUJNAlWI.js";
import { merge as ie } from "es-toolkit";
import { applyConverter as ae } from "@terraformer/spatial";
import y from "proj4";
import { TinyEmitter as oe } from "tiny-emitter";
import { createPinia as se, defineStore as b, storeToRefs as ce } from "pinia";
import { Fragment as le, Teleport as ue, Transition as de, TransitionGroup as fe, computed as x, createApp as pe, createBlock as S, createCommentVNode as C, createElementBlock as w, createElementVNode as T, createTextVNode as me, createVNode as E, defineAsyncComponent as he, defineComponent as D, getCurrentInstance as ge, h as _e, inject as ve, markRaw as O, mergeProps as ye, nextTick as be, normalizeClass as k, normalizeStyle as xe, onBeforeUnmount as Se, onMounted as Ce, onUpdated as we, openBlock as A, reactive as Te, ref as j, render as Ee, renderList as De, renderSlot as Oe, resolveComponent as M, resolveDirective as N, resolveDynamicComponent as ke, toDisplayString as P, toRaw as Ae, unref as F, useCssVars as je, useTemplateRef as Me, vShow as Ne, watch as Pe, withCtx as I, withDirectives as L, withKeys as Fe, withModifiers as Ie } from "vue";
import { debounce as Le, throttle as Re } from "es-toolkit/function";
import { createI18n as ze, useI18n as R } from "vue-i18n";
import Be from "screenfull";
import { cloneDeep as Ve } from "es-toolkit/object";
import He from "animejs";
import { createPopper as Ue, detectOverflow as We } from "@popperjs/core";
import "tippy.js/animations/scale.css";
import Ge, { setDefaultProps as Ke, useTippy as qe } from "vue-tippy";
import Je from "linkify-html";
import Ye from "redaxios";
import Xe from "await-to-js";
import { geojsonToArcGIS as Ze } from "@terraformer/arcgis";
import { csv2geojson as Qe, dsv as $e } from "csv2geojson";
...
var tt = /* @__PURE__ */ function(e) {
	...
	id;
	constructor(e, t) {
		this.id = e ? e.toString() : "", this.sr = J.parseSR(t);
	}
	get type() {
		return z.UNKNOWN;
	}
	...
	invalid() {
		return this.type === z.NONE || this.type === z.UNKNOWN;
	}
	geoJsonFactory(e, t) {
		let n = {
			type: e,
	...
	static fromESRI(t, n) {
		return new e(n, [t.x, t.y], J.fromESRI(t.spatialReference), !0);
	}
	toESRI() {
		return new g({
			x: this.x,
	...
	static fromGeoJSON(t, n) {
		return new e(n, t.coordinates, J.fromGeoJSON(t.crs), !0);
	}
	toGeoJSON() {
		return this.geoJsonFactory(H.POINT, this.toArray());
	}
	...
	static fromESRI(t, n) {
		return new e(n, t.points, J.fromESRI(t.spatialReference), !0);
	}
	toESRI() {
		return new c({
			points: this.toArray(),
	...
	toGeoJSON() {
		return this.geoJsonFactory(H.MULTIPOINT, this.toArray());
	}
	...
	static fromESRI(t, n) {
		return new e(n, t.paths[0], J.fromESRI(t.spatialReference), !0);
	}
	toESRI() {
		return new r({
			paths: [this.toArray()],
	...
	toGeoJSON() {
		return this.geoJsonFactory(H.LINESTRING, this.toArray());
	}
}, _t = class e extends ft {
	rawArray;
	constructor(t, n, r, i) {
		if (super(t, n.sr || r), i) this.rawArray = e.arrayDeepCopy(n);
		else if (n instanceof e) this.rawArray = n.toArray();
		else if (n instanceof mt) this.rawArray = [n.toArray()];
		else if (Array.isArray(n)) {
			if (n.length === 0) throw Error("no lines provided");
			this.rawArray = n.map((e) => mt.parsePointSet(e));
		} else throw Error("invalid lines format for MulitLineString");
	}
	get lineArray() {
		return this.rawArray.map((e, t) => new gt(this.childIdGenerator(t), e, this.sr, !0));
	}
	getAt(e) {
		return new gt(this.childIdGenerator(e), this.rawArray[e], this.sr, !0);
	}
	updateAt(e, t) {
		this.rawArray[t] = mt.parsePointSet(e);
	}
	get length() {
		return this.rawArray.length;
	}
	get type() {
		return z.MULTILINESTRING;
	}
	toArray() {
		return e.arrayDeepCopy(this.rawArray);
	}
	...
	static fromESRI(t, n) {
		return new e(n, t.paths, J.fromESRI(t.spatialReference), !0);
	}
	toESRI() {
		return new r({
			paths: this.toArray(),
	...
	toGeoJSON() {
		return this.geoJsonFactory(H.MULTILINESTRING, this.toArray());
	}
}, vt = class e extends mt {
	constructor(t, n, r, i) {
	...
	static fromESRI(t, n) {
		return new e(n, t.rings[0], J.fromESRI(t.spatialReference), !0);
	}
	toESRI() {
		return new l({
			rings: [this.toArray()],
	...
	toGeoJSON() {
		return this.geoJsonFactory(H.POLYGON, [this.toArray()]);
	}
}, yt = class e extends ft {
	rawArray;
	constructor(t, n, r, i) {
	...
	static parsePolygon(t) {
		...
		if (t instanceof _t) n = t.toArray();
		else if (t instanceof mt) n = [t.toArray()];
		else if (Array.isArray(t)) {
			if (t.length === 0) throw Error("no rings provided");
			n = t.map((e) => mt.parsePointSet(e));
		} else throw Error("invalid input format for parsePolygon");
		return n.forEach((e) => vt.closeRing(e)), n;
	}
	static arrayDeepCopy(e) {
		return e.map((e) => e.map((e) => e.slice()));
	}
	static fromESRI(t, n) {
		return new e(n, t.rings, J.fromESRI(t.spatialReference), !0);
	}
	toESRI() {
		return new l({
			rings: this.toArray(),
	...
	static parseMultiPolygon(t) {
		if (t instanceof e) return t.toArray();
		if (t instanceof yt) return [t.toArray()];
		if (t instanceof _t || t instanceof mt) return [yt.parsePolygon(t)];
		if (Array.isArray(t)) {
			if (t.length === 0) throw Error("no polygons provided");
			return t.map((e) => yt.parsePolygon(e));
	...
	toGeoJSON() {
		return this.geoJsonFactory(H.MULTIPOLYGON, this.toArray());
	}
}, xt = class e extends ft {
	rawMin;
	rawMax;
	constructor(e, t, n, r) {
		super(e, t.sr || r), this.rawMin = Y.parseXY(t), this.rawMax = Y.parseXY(n);
	}
	get type() {
		return z.EXTENT;
	}
	...
	center() {
		return new Y(this.id + "_centerPoint", [(this.xmax - this.xmin) / 2 + this.xmin, (this.ymax - this.ymin) / 2 + this.ymin], this.sr, !0);
	}
	expand(t) {
	...
	toPolygon() {
		return new yt(this.id, this.toPolygonArray(), this.sr, !0);
	}
	static fromParams(t, n, r, i, a, o) {
		return new e(t, [n, r], [i, a], o);
	}
	static fromConfig(t, n) {
		return new e(t, [n.xmin, n.ymin], [n.xmax, n.ymax], J.fromConfig(n.spatialReference));
	}
	isEqual(e) {
		return e ? this.xmin === e.xmin && this.ymin === e.ymin && this.xmax === e.xmax && this.ymax === e.ymax : !1;
	}
	static fromESRI(t, n) {
		return e.fromParams(n, t.xmin, t.ymin, t.xmax, t.ymax, J.fromESRI(t.spatialReference));
	}
	toESRI() {
		return new d({
			xmin: this.xmin,
	...
	static fromGeoJSON(t, n) {
		...
		}), new e(n, r, i, J.fromGeoJSON(t.crs));
	}
	toGeoJSON() {
		return this.geoJsonFactory(H.POLYGON, this.toPolygonArray());
	}
}, St = class e {
	c;
	constructor(t) {
	...
	_angle;
	constructor(e) {
		if (e ||= { style: nt.CIRCLE }, super(), this._style = e.style || nt.CIRCLE, e.style === nt.ICON) {
			let t = e;
			this._icon = t.icon || "", this._height = Ct.convToPoints(t.height) || 16.5, this._width = Ct.convToPoints(t.width) || 16.5, this._size = 0, this._colour = new St(), this._outline = new Tt(), this._path = "";
		} else {
			let t = e;
			this._size = Ct.convToPoints(t.size) || 12, this._colour = new St(t.colour ?? "#ffffff40"), this._outline = new Tt(t.outline), this._path = this._style === nt.PATH && t.path || "", this._height = 0, this._width = 0, this._icon = "";
		}
		this._xOffset = Ct.convToPoints(e.xOffset) || 0, this._yOffset = Ct.convToPoints(e.yOffset) || 0, this._angle = e.angle || 0;
	}
	get colour() {
	...
	propGrouse(e) {
		this._style === nt.ICON !== e && console.warn(`Accessed a point style property that is invalid for the style type ${this._style}`);
	}
	toOptions() {
		let e = {
	...
	static fromESRI(e) {
		...
		if (e.type === "simple-marker") {
			let n = t;
			n.style = e.style, n.colour = e.color.toRgba(), n.size = e.size, n.path = e.path, n.outline = Tt.fromESRI(e.outline).toOptions();
		} else {
			let n = t;
			n.style = nt.ICON, n.width = e.width, n.height = e.height, n.icon = e.url;
		}
		return new n(t);
	}
	...
	_colour;
	constructor(e) {
		e ||= {}, super(), this._style = e.style || rt.SOLID;
		let t = Ct.convToPoints(e.width);
		this._width = t === void 0 || t < 0 ? .75 : t, this._colour = new St(e.colour), this._miter = e.miter ?? 2, this._cap = e.cap || at.ROUND, this._join = e.join || it.ROUND;
	}
	get styleType() {
		return this._style;
	}
	...
	_fillStyle;
	constructor(e) {
		super(), e ||= {}, e.fill ||= {}, this._fillColour = new St(e.fill.colour), this._fillStyle = e.fill.style || ot.SOLID, this._outlineStyle = new Tt(e.outline);
	}
	get fillColour() {
	...
	static fromESRI(t) {
		return new e({
			...
			outline: Tt.fromESRI(t.outline).toOptions()
		});
	}
	static fromArcServer(t) {
		return e.fromESRI(o(t));
	...
	geomEsriToRamp(e, t) {
		switch (e.type) {
			case "point": return Y.fromESRI(e, t);
			case "polyline": {
				let n = e;
				return n.paths.length === 1 ? gt.fromESRI(n, t) : _t.fromESRI(n, t);
			}
			case "polygon": return yt.fromESRI(e, t);
			case "extent": return xt.fromESRI(e, t);
			case "multipoint": return ht.fromESRI(e, t);
			default: throw Error(`Encountered unhandled geometry type ${e.type}`);
		}
	}
	geomGeoJsonToRamp(e, t) {
		switch (e.type) {
			case H.POINT: return Y.fromGeoJSON(e, t);
			case H.LINESTRING: return gt.fromGeoJSON(e, t);
			case H.POLYGON: return yt.fromGeoJSON(e, t);
			case H.MULTIPOINT: return ht.fromGeoJSON(e, t);
			case H.MULTILINESTRING: return _t.fromGeoJSON(e, t);
			case H.MULTIPOLYGON: return bt.fromGeoJSON(e, t);
			default: throw Error(`Encountered unhandled geometry type ${e.type}`);
		}
	}
	geomRampToGeoJson(e) {
	...
	graphicGeoJsonToRamp(e, t) {
		...
		return Object.keys(e.properties.forEach((t) => r[t] = e.properties[t])), new dt(n, "", r);
	}
	graphicRampToEsri(e) {
		let t = {
			attributes: {},
	...
	styleEsriToRamp(e) {
		switch (e.type) {
			case "picture-marker":
			case "simple-marker": return wt.fromESRI(e);
			case "simple-line": return Tt.fromESRI(e);
			case "simple-fill": return Et.fromESRI(e);
			default: return console.error(`Unsupported ESRI symbol type encountered: ${e.type}`), new wt();
		}
	}
	serverGeomTypeToRampGeomType(e) {
		if (!e) return z.NONE;
		switch (e) {
			case "esriGeometryPolygon": return z.POLYGON;
			case "esriGeometryPolyline": return z.LINESTRING;
			case "esriGeometryPoint": return z.POINT;
			case "esriGeometryMultipoint": return z.MULTIPOINT;
			case "esriGeometryEnvelope": return z.EXTENT;
			default: return console.error(`Unrecognized server geometry type encountered: ${e}`), z.UNKNOWN;
		}
	}
	clientGeomTypeToRampGeomType(e) {
		if (!e) return z.NONE;
		switch (e) {
			case "polygon": return z.POLYGON;
			case "polyline": return z.LINESTRING;
			case "point": return z.POINT;
			case "multipoint": return z.MULTIPOINT;
			default: return console.error(`Unrecognized client geometry type encountered: ${e}`), z.UNKNOWN;
		}
	}
	geoJsonGeomTypeToEsriGeomType(e) {
		switch (e) {
			case H.POINT: return "point";
			case H.LINESTRING:
			case H.MULTILINESTRING: return "polyline";
			case H.POLYGON:
			case H.MULTIPOLYGON: return "polygon";
			case H.MULTIPOINT: return "multipoint";
			default: throw Error(`Encountered unhandled geometry type ${e}`);
		}
	}
	isImageUrl(e) {
		return wt.isImageUrl(e);
	}
}, Ot = class {
	layerIdx;
	name;
	...
	isActive() {
		return this.sqlActiveFilters([K.PERMANENT]).length > 0;
	}
	getCombinedSql(e = []) {
	...
	setSql(e, t) {
		e === K.PERMANENT ? console.error("Attempted to overwrite a permanent filter. Not allowed.") : (this.sql[e] = t, this.clearCacheSet(e));
	}
	getSql(e) {
		return this.sql[e] || "";
	}
	setExtent(e) {
		e.isEqual(this.extent) || (this.extent = e, this.clearCacheSet(K.EXTENT));
	}
	getCacheKey(e, t) {
		return `_cache$${e.sort().join("$")}${t ? "$" + K.EXTENT : ""}$`;
	}
	getCache(e, t) {
	...
	clearAll() {
		this.sql = { [K.PERMANENT]: this.sql[K.PERMANENT] }, this.extent = void 0, this.clearAllCaches();
	}
}, jt = class e {
	id;
	sr;
	...
	static fromConfig(t) {
		return new e(t.id, xt.fromConfig(`${t.id}-extent-default`, t.default), t.full === void 0 ? void 0 : xt.fromConfig(`${t.id}-extent-full`, t.full), t.maximum === void 0 ? void 0 : xt.fromConfig(`${t.id}-extent-maximum`, t.maximum));
	}
	clone() {
	...
	updateQuery(e) {
		let t = ie({}, this.queryMap);
		return ie(t, e), `${this.base}${Object.entries(t).filter(([, e]) => e !== void 0).map(([e, t], n) => `${n === 0 ? "?" : ""}${e}=${t}`).join("&")}`;
	}
}, Pt = "EPSG:4326", Ft = class {
	espgWorker;
	constructor() {
		this.espgWorker = this.defaultEpsgLookup, y.defs("EPSG:3978", "+proj=lcc +lat_1=49 +lat_2=77 +lat_0=49 +lon_0=-95 +x_0=0 +y_0=0 +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +units=m +no_defs"), y.defs("EPSG:3979", "+proj=lcc +lat_1=49 +lat_2=77 +lat_0=49 +lon_0=-95 +x_0=0 +y_0=0 +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +units=m +no_defs"), y.defs("EPSG:54004", "+proj=merc +lon_0=0 +k=1 +x_0=0 +y_0=0 +ellps=WGS84 +datum=WGS84 +units=m +no_defs"), y.defs("EPSG:102100", y.defs("EPSG:3857")), y.defs("EPSG:102187", "+proj=tmerc +lat_0=0 +lon_0=-114 +k=0.9999 +x_0=0 +y_0=0 +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +units=m +no_defs"), y.defs("EPSG:102190", "+proj=aea +lat_1=50 +lat_2=58.5 +lat_0=45 +lon_0=-126 +x_0=1000000 +y_0=0 +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +units=m +no_defs");
		let e = 1;
		for (; e <= 60;) {
			let t = e < 10 ? `0${e}` : e;
			y.defs(`EPSG:326${t}`, `+proj=utm +zone=${e} +ellps=WGS84 +datum=WGS84 +units=m +no_defs`), e++;
		}
	}
	addProjection(e, t) {
		e = typeof e == "number" ? `EPSG:${e}` : e, y.defs(e, t);
	}
	defaultEpsgLookup(e) {
	...
	async checkProj(e) {
		...
		let r = (e, t) => {
			e !== t && y.defs(t, y.defs(e));
		};
		if (y.defs(t)) return !0;
		if (n && y.defs(n)) return r(n, t), !0;
		let i = async (e) => {
			try {
				let t = await this.epsgLookup(e);
				return t === null || t === "" ? !1 : (y.defs(e, t), !0);
			} catch {
				return !1;
			}
		};
	...
	async projectGeoJson(e, t, n) {
		let r, i;
		if (r = t ? this.normalizeProj(t) : J.parseGeoJsonCrs(e.crs), i = n ? this.normalizeProj(n) : Pt, i === r) return e;
		await this.checkProjBomber([r, i]);
		let a = y(r, i).forward;
		return ae(e, a);
	}
	async projectGeometry(e, t) {
		if (t.type === z.EXTENT) return this.projectExtent(e, t);
	...
	async projectExtent(e, t) {
		...
		let a = new yt("warpy", [i], t.sr, !0), o = await this.projectGeometry(e, a), s = o.toArray().pop() || [], c = s.map((e) => e[0]), l = s.map((e) => e[1]), u = Math.min.apply(null, c), d = Math.max.apply(null, c), f = Math.min.apply(null, l), p = Math.max.apply(null, l);
		return xt.fromParams(t.id + "_projected", u, f, d, p, o.sr);
	}
}, It = class {
	...
	sharedUtils;
	constructor() {
		this.proj = new Ft(), this.geom = new Dt(), this.sharedUtils = new Mt();
	}
	defaultTileSchemas() {
...
var Vt = class {
	...
	let e = j({}), t = j([]), n = j([]), r = x(() => t.value.map((t) => t.map((t) => e.value[t]).filter((e) => {
	...
	let e = j([]), t = j({}), n = j({}), r = j(), i = j(0), a = j(0), o = j(!0), s = j();
	function c(t) {
	...
	function r(n) {
		if (e.value = {
			...e.value,
			[n.id]: O(n)
		}, n.id in t.value) t.value[n.id].resolveMe(O(n));
		else {
			let e = new X();
			e.resolveMe(O(n)), t.value = {
				...t.value,
				[n.id]: e
			};
		}
	...
	_funCounter;
	constructor(e) {
		super(e), this._eventBus = new oe(), this._eventRegister = [], this._funCounter = 1, this._nameRegister = Object.values(Q).filter((e) => typeof e == "string" && e.indexOf("/") > -1);
	}
	findHandler(e) {
	...
	addDefaultEvents(e) {
		return (!Array.isArray(e) || e.length === 0) && (e = Object.values($)), e.map((e) => this.defaultHandlerFactory(e));
	}
	defaultHandlerFactory(e) {
		let t;
		switch (e) {
			case $.LAYER_ERROR_UPDATES_LEGEND:
				t = (e) => {
					if (e.layer.layerState === G.ERROR) {
						let t = this.$iApi.fixture.get("legend");
						t && t.updateLegend(e.layer);
					}
				}, this.$iApi.event.on(Q.LAYER_LAYERSTATECHANGE, t, e);
				break;
			case $.LAYER_REGISTER_BINDS_LEGEND:
				t = (e) => {
					let t = this.$iApi.fixture.get("legend");
					t && t.updateLegend(e);
				}, this.$iApi.event.on(Q.LAYER_REGISTERED, t, e);
				break;
			case $.LAYER_RELOAD_END_BINDS_LEGEND:
				t = (e) => {
					let t = this.$iApi.fixture.get("legend");
					t && t.updateLegend(e);
				}, this.$iApi.event.on(Q.LAYER_RELOAD_END, t, e);
				break;
			case $.LAYER_RELOAD_START_UPDATES_LEGEND:
				t = (e) => {
					if (!e.isSublayer) {
						let t = this.$iApi.fixture.get("legend");
						t && t.reloadLayerItem(e.uid);
					}
				}, this.$iApi.event.on(Q.LAYER_RELOAD_START, t, e);
				break;
			case $.LAYER_REMOVE_CHECKS_GRID:
				t = (e) => {
					if (this.$iApi.fixture.get("grid")) {
						let t = Ut(this.$vApp.$pinia), n = t.getGridId(e.id);
						if (n === void 0) return;
				...
				}, this.$iApi.event.on(Q.LAYER_REMOVE, t, e);
				break;
			case $.LAYER_REMOVE_UPDATES_DETAILS:
				t = (e) => {
					let t = Kt(this.$vApp.$pinia);
					this.$iApi.fixture.get("details") && t.removeLayer(e);
				}, this.$iApi.event.on(Q.LAYER_REMOVE, t, e);
				break;
			case $.LAYER_REMOVE_UPDATES_LEGEND:
				t = (e) => {
					let t = this.$iApi.fixture.get("legend");
					t && (t.removeLayerItem(e), this.$iApi.updateAlert(this.$iApi.$i18n.t("legend.alert.layerRemoved", { name: e.name })));
				}, this.$iApi.event.on(Q.LAYER_REMOVE, t, e);
				break;
			case $.LAYER_USERADD_UPDATES_LEGEND:
				t = (e) => {
					let t = this.$iApi.fixture.get("legend");
					t && t.addLayerItem(e);
				}, this.$iApi.event.on(Q.USER_LAYER_ADDED, t, e);
				break;
			case $.MAP_BASEMAP_CHECKS_TILE_PROJ:
				t = (e) => {
					e.schemaChanged && this.$iApi.geo.layer.allLayers().filter((e) => e.dataFormat === V.ESRI_TILE && e.schemaLocked).forEach((e) => {
						e.checkProj();
					});
				}, this.$iApi.event.on(Q.MAP_BASEMAPCHANGE, t, e);
				break;
			case $.MAP_BASEMAP_UPDATES_MAP_ATTRIBS:
				t = () => {
					this.$iApi.geo.map.caption.updateAttribution(v(this.$vApp.$pinia).activeBasemapConfig?.attribution);
				}, this.$iApi.event.on(Q.MAP_BASEMAPCHANGE, t, e);
				break;
			case $.MAP_BLUR_UPDATES_KEY_HANDLER:
				t = () => {
					this.$iApi.geo.map.stopKeyPan();
				}, this.$iApi.event.on(Q.MAP_BLUR, t, e);
				break;
			case $.MAP_CLICK_RUNS_IDENTIFY:
				t = (e) => {
					e.button === 0 && this.$iApi.geo.map.runIdentify(e);
				}, this.on(Q.MAP_CLICK, t, e);
				break;
			case $.MAP_CREATED_INITIALIZES_FIXTURES:
				t = () => {
					let e = qt(this.$vApp.$pinia).items;
					Object.keys(e).forEach((t) => {
						e[t].initialized?.();
					});
				}, this.$iApi.geo.map.created && t(), this.$iApi.event.on(Q.MAP_CREATED, t, e);
				break;
			case $.MAP_CREATED_UPDATES_MAP_ATTRIBS:
				t = () => {
					this.$iApi.geo.map.caption.updateAttribution(v(this.$vApp.$pinia).activeBasemapConfig?.attribution);
				}, this.$iApi.geo.map.created && t(), this.$iApi.event.on(Q.MAP_CREATED, t, e);
				break;
			case $.MAP_EXTENT_UPDATES_MAPTIP:
				t = () => {
				...
				}, this.$iApi.event.on(Q.MAP_EXTENTCHANGE, Re(() => t(), 50, { edges: ["leading"] }), e);
				break;
			case $.MAP_GRAPHICHIT_CREATES_MAPTIP:
				t = (e) => {
					this.$iApi.geo.map.maptip.generateDefaultMaptip(e);
				}, this.$iApi.event.on(Q.MAP_GRAPHICHIT, t, e);
				break;
			case $.MAP_IDENTIFY_OPENS_IDENTIFY_RESULTS:
				t = (e) => {
					let t = this.$iApi.fixture.get("details");
					t && t.openDetails(e.results);
				}, this.on(Q.MAP_IDENTIFY, t, e);
				break;
			case $.MAP_KEYDOWN_UPDATES_COORDS:
				this.$iApi.event.on(Q.MAP_KEYDOWN, Re(() => {
					let e = Wt(this.$vApp.$pinia);
				...
				break;
			case $.MAP_KEYDOWN_UPDATES_KEY_HANDLER:
				t = (e) => {
					this.$iApi.geo.map.mapKeyDown(e);
				}, this.$iApi.event.on(Q.MAP_KEYDOWN, t, e);
				break;
			case $.MAP_KEYUP_UPDATES_KEY_HANDLER:
				t = (e) => {
					this.$iApi.geo.map.mapKeyUp(e);
				}, this.$iApi.event.on(Q.MAP_KEYUP, t, e);
				break;
			case $.MAP_MOUSE_UPDATES_COORDS:
				this.$iApi.event.on(Q.MAP_MOUSEMOVE, Re((e) => {
					let t = Wt(this.$vApp.$pinia);
				...
				break;
			case $.MAP_MOUSE_UPDATES_MAPTIP:
				t = (e) => {
					this.$iApi.geo.map.maptip.checkAtCoord({
						screenX: e.screenX,
						screenY: e.screenY
					});
				}, this.$iApi.event.on(Q.MAP_MOUSEMOVE, Re((e) => t(e), 50), e);
				break;
			case $.MAP_MOUSEDOWN_UPDATES_MAPTIP:
				t = (e) => {
					this.$iApi.geo.map.maptip.checkAtCoord({
						screenX: e.screenX,
						screenY: e.screenY
					});
				}, this.$iApi.event.on(Q.MAP_MOUSEDOWN, Re((e) => {
					let n = {
						screenX: e.offsetX,
						screenY: e.offsetY,
						button: e.button,
				...
				break;
			case $.MAP_MOUSELEAVE_REMOVES_MAPTIP:
				t = () => {
					this.$iApi.geo.map.maptip.clear();
				}, this.$iApi.event.on(Q.MAP_MOUSELEAVE, t);
				break;
			case $.MAP_RESIZE_UPDATES_SCALEBAR:
				this.$iApi.event.on(Q.MAP_RESIZED, Le(() => this.$iApi.geo.map.caption.updateScale(), 100), e);
				break;
			case $.MAP_SCALE_UPDATES_SCALEBAR:
				this.$iApi.event.on(Q.MAP_SCALECHANGE, Le(() => this.$iApi.geo.map.caption.updateScale(), 300), e);
				break;
			case $.PANEL_CLOSE_UPDATES_APPBAR:
				t = (e) => {
					let t = Ht(this.$vApp.$pinia);
					this.$iApi.fixture.get("appbar") && !t.order.flat().find((t) => t === e.id) && t.removeButton(e.id);
				}, this.on(Q.PANEL_CLOSED, t, e);
				break;
			case $.PANEL_OPEN_UPDATES_APPBAR:
				t = (e) => {
					let t = Ht(this.$vApp.$pinia);
					this.$iApi.fixture.get("appbar") && (!e.teleport || e.teleport?.showAppbarButton) && !t.order.flat().find((t) => t === e.id) && t.addTempButton(e.id);
				}, this.on(Q.PANEL_OPENED, t, e);
				break;
			case $.TOGGLE_DETAILS:
				t = (e, t) => {
					let n = this.$iApi.fixture.get("details");
					n && n.toggleFeature(e, t);
				}, this.$iApi.event.on(Q.DETAILS_TOGGLE, t, e);
				break;
			case $.TOGGLE_GRID:
				t = (e, t) => {
					let n = this.$iApi.fixture.get("grid");
					n && n.toggleGrid(e.id, t);
				}, this.$iApi.event.on(Q.GRID_TOGGLE, t, e);
				break;
			case $.TOGGLE_HELP:
				t = (e) => {
					let t = this.$iApi.fixture.get("help");
					t && t.toggleHelp(e);
				}, this.$iApi.event.on(Q.HELP_TOGGLE, t, e);
				break;
			case $.TOGGLE_METADATA:
				t = (e, t) => {
					let n = this.$iApi.fixture.get("metadata");
					n && n.toggleMetadata(e, t);
				}, this.$iApi.event.on(Q.METADATA_TOGGLE, t, e);
				break;
			case $.TOGGLE_REORDER:
				t = (e) => {
					let t = this.$iApi.fixture.get("layer-reorder");
					t && t.toggleLayerReorder(e);
				}, this.$iApi.event.on(Q.REORDER_TOGGLE, t, e);
				break;
			case $.TOGGLE_SETTINGS:
				t = (e, t) => {
					let n = this.$iApi.fixture.get("settings");
					n && n.toggleSettings(e, t);
				}, this.$iApi.event.on(Q.SETTINGS_TOGGLE, t, e);
				break;
			case $.TOGGLE_WIZARD:
				t = (e) => {
					let t = this.$iApi.fixture.get("wizard");
					t && t.toggleWizard(e);
				}, this.$iApi.event.on(Q.WIZARD_TOGGLE, t, e);
				break;
...
var tn = b("maptip", () => {
	...
	__name: "esri-map",
	setup(e) {
		let t = tn(), n = ve("iApi"), r = x(() => t.maptipPoint), i = x(() => t.maptipInstance), a = x(() => t.content), o = Te([]), s = j(!1);
		o.push(Pe(r, () => {
			if (r.value) {
	...
	setup(e) {
		...
		return (n, r) => {
			let i = N("focus-container");
			return A(), w("div", {
				class: k(["shadow-tm bg-white h-full xs:mr-0 sm:mr-12 last:mr-0 pointer-events-auto min-w-0 shrink-0", e.panel.expanded ? "flex-grow max-w-full" : ""]),
				style: xe(e.panel.style),
				"data-cy": e.panel.id,
				ref_key: "componentEl",
				ref: t
			}, [E(de, {
				...
				default: I(() => [L((A(), S(ke(e.panel.route.screen), ye({ class: "h-full" }, e.panel.route.props, { panel: e.panel }), null, 16, ["panel"])), [[i]])]),
				_: 1
			})], 14, on);
		};
	}
}), cn = b("panel", () => {
	let e = j(void 0), t = j(void 0), n = j(0), r = j(0), i = j(!1), a = j(!0), o = j({}), s = j({}), c = j([]), l = j([]), u = j([]), d = j(1), f = x(() => r.value);
	function p(e) {
...
}), ln = /* @__PURE__ */ te(/* @__PURE__ */ D({
	__name: "panel-stack",
	setup(e) {
		je((e) => ({ v3d36ee4c: i.value }));
		let t = cn(), n = ve("iApi"), r = j(), i = x(() => t.opacity), a = x(() => t.mobileView);
		Ce(() => {
			new ResizeObserver((e) => {
				let r = !(n.$vApp.$root?.$refs["app-size"]).classList.contains("sm");
				a.value !== r && (t.mobileView = r, n.event.emit(Q.RAMP_MOBILEVIEW_CHANGE, r)), t.setStackWidth(e[0].contentRect.width);
			}).observe(r.value?.$el);
		});
		...
		return (e, t) => (A(), S(fe, {
			...
			default: I(() => [(A(!0), w(le, null, De(o(F(n).screenSize), (e) => (A(), S(sn, {
				key: `${e.id}`,
				panel: e
			}, null, 8, ["panel"]))), 128))]),
			_: 1
...
}), [["__scopeId", "data-v-717e4bd7"]]), un = ["content", "aria-label"], dn = /* @__PURE__ */ D({
	...
	setup(e) {
		let t = j(!1), n = j(null), r = Te([]), i = j(), a = j(), o = j(), s = e;
		r.push(Pe(t, () => {
			n.value.update();
		}));
		let c = () => {
		...
		return Ce(() => {
			window.addEventListener("click", (e) => {
				...
				(!i.value || !i.value.contains(e.target)) && (t.value = !1);
			}), o.value.addEventListener("focus", l), o.value.addEventListener("blur", u), o.value.addEventListener("mouseover", l), o.value.addEventListener("mouseleave", u), be(() => {
				o.value && a.value && (n.value = Ue(o.value, a.value, {
			...
			return A(), w("div", {
				...
				type: "button",
				class: k(["dropdown-button", e.triggerClass]),
				onClick: c,
				content: e.tooltip,
				"aria-label": e.ariaLabel ? String(e.ariaLabel) : String(e.tooltip),
				ref_key: "dropdownTrigger",
				ref: o
			}, [Oe(r.$slots, "header")], 10, un)), [[l, {
				...
				class: k(["rv-dropdown shadow-md border border-gray:200 py-8 bg-white rounded z-10", { "text-center": e.centered }]),
				ref_key: "dropdown",
				ref: a
			}, [Oe(r.$slots, "default", { close: () => t.value = !t.value })], 2), [[Ne, t.value]])], 512);
		};
	}
}), fn = b("notification", () => {
	let e = 0, t = j([]), n = j({}), r = x(() => t.value.length >= 99 ? 99 : t.value.length);
	function i(n) {
		t.value = [{
			...n,
			id: `notif-${e++}`
...
}), pn = { class: "h-full flex flex-col" }, mn = { class: "w-full flex mb-6" }, hn = ["content", "aria-label"], gn = /* @__PURE__ */ D({
	__name: "screen",
	props: { panel: {
		type: Object,
		required: !0
	...
	setup(e) {
		let t = fn(), { t: n } = R(), r = x(() => t.notificationNumber), i = () => t.clearAll();
		return (t, a) => {
			let o = M("panel-screen"), s = N("tippy");
			return A(), S(o, { panel: e.panel }, {
				header: I(() => [me(P(F(n)("notifications.title")), 1)]),
				content: I(() => [T("div", pn, [T("div", mn, [L((A(), w("button", {
					type: "button",
					onClick: i,
					class: k(["p-4 ml-auto", [r.value ? "text-gray-500 hover:text-black" : "text-gray-300 cursor-default pointer-events-none"]]),
					content: F(n)("notifications.controls.clearAll"),
					"aria-label": F(n)("notifications.controls.clearAll")
				}, [...a[0] ||= [T("svg", {
					...
					T("path", { d: "M13 17h-9a4 4 0 0 0 2 -3v-3a7 7 0 0 1 4 -6a2 2 0 1 1 4 0a7 7 0 0 1 4 6v2" }),
					T("path", { d: "M9 17v1a3 3 0 0 0 4.194 2.753" }),
					T("path", { d: "M22 22l-5 -5" }),
					T("path", { d: "M17 22l5 -5" })
				], -1)]], 10, hn)), [[s, {
					placement: "bottom",
					theme: "ramp4",
					animation: "scale"
				}]])]), E(kn, { class: "overflow-y-auto" })])]),
				_: 1
			}, 8, ["panel"]);
		};
	}
	...
	constructor(e) {
		super(e), this.$iApi.panel.register({
			id: "notifications",
			config: {
				screens: { "notifications-screen": O(gn) },
	...
	setup(e, { emit: t }) {
		...
		return (t, i) => {
			let c = N("tippy");
			return L((A(), w("li", {
				class: k(["flex-col default-focus-style p-4", e.notification.messageList ? "cursor-pointer" : ""]),
				content: F(n)(a.value ? "notifications.controls.collapse" : "notifications.controls.expand"),
				onClick: i[1] ||= (e) => a.value = !a.value
			}, [T("div", xn, [
				T("span", null, [me(P(o[e.notification.type]) + " ", 1), T("span", Sn, P(e.notification.message), 1)]),
				i[4] ||= T("span", { class: "flex-grow" }, null, -1),
				e.notification.messageList ? (A(), w("div", {
					key: 0,
					class: k(["dropdown-icon p-4 pointer-events-none", { "transform -rotate-180": a.value }])
				}, [...i[2] ||= [T("svg", {
					xmlns: "http://www.w3.org/2000/svg",
					height: "24",
					viewBox: "0 0 24 24",
					width: "24"
				}, [T("path", { d: "M7.41 8.59L12 13.17l4.59-4.58L18 10l-6 6-6-6 1.41-1.41z" })], -1)]], 2)) : C("", !0),
				L((A(), w("button", {
					type: "button",
					onClick: i[0] ||= Ie(() => r("remove"), ["stop"]),
					class: "mx-4 p-4 text-gray-500 hover:text-black",
					content: F(n)("notifications.controls.dismiss"),
					"aria-label": F(n)("notifications.controls.dismiss")
				}, [...i[3] ||= [T("svg", {
					class: "fill-current",
					height: "16",
					width: "16",
			...
			]), e.notification.messageList && a.value ? (A(), w("div", wn, [(A(!0), w(le, null, De(e.notification.messageList, (t, n) => (A(), w("p", { key: e.notification.id + t + n }, P(t), 1))), 128))])) : C("", !0)], 10, bn)), [[c, {
				onShow: s,
				theme: "ramp4",
				animation: "scale"
			}]]);
	...
	setup(e) {
		...
		let c = x(() => t.notificationStack);
		return (e, t) => {
			let a = N("focus-item"), o = N("focus-list"), l = N("tippy");
			return A(), w("div", null, [c.value.length > 0 ? L((A(), w("ul", {
				key: 0,
				content: F(n)("panels.controls.items"),
				ref_key: "el",
				ref: r,
				class: "h-full overflow-y-auto"
			}, [(A(!0), w(le, null, De(c.value, (e, t) => (A(), w(le, { key: e.id }, [t > 0 ? (A(), w("div", Dn)) : C("", !0), L(E(Tn, {
				ref_for: !0,
				...
				t[0] ||= T("span", { class: "flex-grow" }, null, -1),
				t[1] ||= T("svg", {
					xmlns: "http://www.w3.org/2000/svg",
					viewBox: "0 0 24 24",
					...
					d: "M0 0h24v24H0z",
					fill: "none"
				}), T("path", { d: "M18 7l-1.41-1.41-6.34 6.34 1.41 1.41L18 7zm4.24-1.41L11.66 16.17 7.48 12l-1.41 1.41L11.66 19l12-12-1.42-1.41zM.41 13.41L6 19l1.41-1.41L1.83 12 .41 13.41z" })], -1),
				T("span", null, P(F(n)("notifications.empty")), 1),
				t[2] ||= T("span", { style: { "flex-grow": "6" } }, null, -1)
			]))]);
		};
	}
...
}, Nn = { class: "notification-dropdown pointer-events-auto bg-white rounded text-center text-black w-500 h-256 flex flex-col p-0" }, Pn = { class: "pb-8 border-b border-gray-600" }, Fn = { class: "absolute flex right-3 top-3" }, In = ["content", "aria-label"], Ln = /* @__PURE__ */ te(/* @__PURE__ */ D({
	__name: "caption-button",
	setup(e) {
		let t = fn(), { t: n } = R(), r = x(() => t.notificationNumber), i = () => t.clearAll();
		return (e, t) => {
			let a = M("close"), o = N("tippy");
			return A(), S(dn, {
				position: "top-start",
				tooltip: F(n)("notifications.title"),
				tooltipPlacement: "top",
				"trigger-class": "text-gray-500 hover:text-white",
				class: "pointer-events-auto sm:flex ml-4 mr-8"
			}, {
				header: I(() => [T("div", An, [(A(), w("svg", {
					class: "fill-current w-24 h-24",
					xmlns: "http://www.w3.org/2000/svg",
					viewBox: "0 0 24 24",
					"aria-label": F(n)("notifications.open")
				}, [...t[0] ||= [T("path", { d: "M12 22c1.1 0 2-.9 2-2h-4c0 1.1.89 2 2 2zm6-6v-5c0-3.07-1.64-5.64-4.5-6.32V4c0-.83-.67-1.5-1.5-1.5s-1.5.67-1.5 1.5v.68C7.63 5.36 6 7.92 6 11v5l-2 2v1h16v-1l-2-2z" }, null, -1)]], 8, jn)), r.value && r.value > 0 ? (A(), w("span", Mn, P(r.value), 1)) : C("", !0)])]),
				default: I((e) => [T("div", Nn, [T("div", null, [T("h4", Pn, P(F(n)("notifications.title")), 1), T("div", Fn, [L((A(), w("button", {
					type: "button",
					onClick: i,
					class: k(["p-4 mr-6", [r.value ? "text-gray-500 hover:text-black" : "text-gray-300 cursor-default pointer-events-none"]]),
					content: F(n)("notifications.controls.clearAll"),
					"aria-label": F(n)("notifications.controls.clearAll")
				}, [...t[1] ||= [T("svg", {
					xmlns: "http://www.w3.org/2000/svg",
					...
					animation: "scale",
					appendTo: "parent"
				}]]), E(a, { onClick: e.close }, null, 8, ["onClick"])])]), E(kn, { class: "overflow-y-auto h-230" })])]),
				_: 1
			}, 8, ["tooltip"]);
		};
	}
}), [["__scopeId", "data-v-28078ee6"]]), Rn = { class: "flex" }, zn = ["aria-label"], Bn = { class: "about-ramp-dropdown pointer-events-auto bg-white rounded w-256 h-50" }, Vn = ["aria-label", "content"], Hn = { class: "pb-8 pt-1 border-b border-gray-600 mb-10" }, Un = { class: "absolute right-5 top-5" }, Wn = { class: "select-text" }, Gn = { class: "font-bold cursor-text" }, Kn = { class: "text-sm cursor-text" }, qn = { class: "font-bold cursor-text" }, Jn = { class: "ml-5 cursor-text" }, Yn = { class: "mt-5" }, Xn = ["href"], Zn = /* @__PURE__ */ te(/* @__PURE__ */ D({
	...
	setup(e) {
		let { t } = R(), n = ve("iApi"), r = () => {
			n.reload();
		}, i = x(() => `${Ns.major}.${Ns.minor}.${Ns.patch}`), a = x(() => Ns.hash.slice(0, 9)), o = x(() => {
		...
		return (n, s) => {
			let c = M("close"), l = M("dropdown-menu"), u = N("tippy"), d = N("focus-item");
			return L((A(), S(l, {
				class: "pointer-events-auto sm:flex",
				position: e.position,
				tooltip: F(t)("ramp.about"),
				tooltipPlacement: e.position,
				"trigger-class": "text-gray-500 hover:text-white"
			}, {
				header: I(() => [T("div", Rn, [(A(), w("svg", {
					xmlns: "http://www.w3.org/2000/svg",
					viewBox: "0 0 24 24",
					class: "fill-current w-20 h-20",
					"aria-label": F(t)("ramp.about.open")
				...
				default: I((e) => [T("div", Bn, [T("div", null, [
					L((A(), w("button", {
						class: "absolute left-5 top-5 text-gray-500 hover:text-black focus:text-black p-8",
						onClick: r,
						"aria-label": F(t)("ramp.reload"),
						content: F(t)("ramp.reload")
					}, [...s[1] ||= [T("svg", {
						class: "fill-current w-16 h-16",
						xmlns: "http://www.w3.org/2000/svg",
						viewBox: "0 0 24 24"
					}, [T("path", { d: "M17.65 6.35C16.2 4.9 14.21 4 12 4c-4.42 0-7.99 3.58-7.99 8s3.57 8 7.99 8c3.73 0 6.84-2.55 7.73-6h-2.08c-.82 2.33-3.04 4-5.65 4-3.31 0-6-2.69-6-6s2.69-6 6-6c1.66 0 3.14.69 4.22 1.78L13 11h7V4l-2.35 2.35z" })], -1)]], 8, Vn)), [[u, {
						placement: "bottom-start",
						theme: "ramp4",
						animation: "scale"
					}]]),
					T("h4", Hn, P(F(t)("ramp.about")), 1),
					T("div", Un, [E(c, { onClick: e.close }, null, 8, ["onClick"])]),
					T("div", Wn, [
						T("div", null, [T("span", Gn, P(i.value), 1), T("span", Kn, " [" + P(a.value) + "] ", 1)]),
						T("div", null, [T("span", qn, P(o.value[0]), 1), T("span", Jn, P(o.value[1]), 1)]),
						s[3] ||= T("div", { class: "mt-5" }, [T("a", {
...
}), [["__scopeId", "data-v-966796d3"]]), Qn = "__HELP__", $n = b("keyboardnav", () => {
	let e = j(), t = j({}), n = j(!1), r = j([]), i = j(), a = j("idle"), o = ["H", "?"];
	function s() {
	...
	function d(e, t, n) {
		if (e) {
			...
			if (e === "reset") {
				let e = n ?? ie.activeNamespace ?? ie.keyChain[1];
				if (!e) {
					h({ suppressHandler: !0 });
					return;
				}
				g(["S", e]), v(void 0), te("awaitAction"), ie.activeNamespace = e;
			}
		}
	}
	function f(n, r, i) {
		e.value = n, !i?.suppressHandler && t.value[n]?.activeHandler?.(ie, r);
	}
	function p(n, r) {
		e.value && !r?.suppressHandler && t.value[e.value]?.deactiveHandler?.(ie, n), e.value = void 0;
	}
	function m(n, r) {
		let i = e.value;
		if (!i) return;
	...
	__name: "map-caption",
	setup(e) {
		let t = Wt(), n = $n(), r = v(), { t: i } = R(), a = ve("iApi"), o = x(() => t.scale), s = x(() => t.attribution), c = x(() => t.coords), l = x(() => t.langtoggle), u = x(() => r.config.map), { keyChain: d, lastAction: f, chainState: p, namespaces: m, activeNamespace: h } = ce(n), g = x(() => {
		...
		}, re = (e = !1) => i(e ? "map.toggleScaleToMetric" : "map.toggleScaleToImperial");
		return (e, t) => {
			let n = M("dropdown-menu"), r = N("truncate"), u = N("tippy");
			return A(), w("div", er, [
				E(Zn, {
					class: "sm:block display-none ml-8 mr-4",
					position: "top-end"
				}),
				E(Ln, { class: "sm:block display-none" }),
				g.value ? (A(), w("span", tr, [T("span", nr, [
					t[0] ||= T("span", { class: "chain-colon" }, ":", -1),
					T("span", rr, P(g.value.keys), 1),
					g.value.cursor ? (A(), w("span", ir, "_")) : C("", !0),
					g.value.options ? (A(), w("span", ar, P(g.value.options), 1)) : C("", !0)
				]), g.value.description ? (A(), w("span", or, "- " + P(g.value.description) + "...", 1)) : C("", !0)])) : s.value?.text.disabled ? C("", !0) : L((A(), w("span", sr, [me(P(s.value?.text.value), 1)])), [[r, { options: {
					placement: "top",
					hideOnClick: !1,
					theme: "ramp4",
					animation: "scale"
				} }]]),
				t[1] ||= T("span", { class: "flex-grow w-15" }, null, -1),
				T("div", cr, [
					c.value?.disabled ? C("", !0) : L((A(), w("div", lr, [me(P(c.value?.formattedString), 1)])), [[r, { options: {
						hideOnClick: !1,
						theme: "ramp4",
						animation: "scale"
					} }]]),
					o.value?.disabled ? C("", !0) : L((A(), w("button", {
						key: 1,
						type: "button",
						...
						"aria-label": `
                    ${o.value?.label} - ${re(o.value?.isImperialScale)}
                `,
						content: re(o.value?.isImperialScale)
					}, [T("span", {
						class: "border-solid border-2 border-white border-t-0 h-5 mr-4 inline-block",
						style: xe({ width: o.value?.width })
					}, null, 4), T("span", dr, P(o.value?.label), 1)], 8, ur)), [[u, {
						delay: [300, 0],
						placement: "top",
						hideOnClick: !1,
						theme: "ramp4",
					...
					l.value?.disabled ? C("", !0) : (A(), S(n, {
						key: 2,
						class: "flex-shrink-0 pointer-events-auto focus:outline-none px-4 mr-4 relative top-2",
						position: "top-end",
						tooltip: F(i)("map.changeLanguage"),
						ariaLabel: `${F(i)("map.language.short")} - ${F(i)("map.changeLanguage")}`,
						tooltipPlacement: "top-start",
						tooltipPlacementAlt: "left-end"
					}, {
						header: I(() => [T("span", fr, P(F(i)("map.language.short")), 1)]),
						default: I(() => [(A(!0), w(le, null, De(ee.value, (e, t) => (A(), w("a", {
							key: `${e}-${t}`,
							class: k(["flex-auto items-center text-sm sm:text-base cursor-pointer", { "font-bold": e === F(a).$i18n.locale.value }]),
							href: "javascript:;",
							onClick: (t) => te(e)
						}, [me(P(F(i)("map.language." + e)) + " ", 1), e === F(a).$i18n.locale.value ? (A(), w("span", mr, P(F(i)("map.language.curr")), 1)) : C("", !0)], 10, pr))), 128))]),
						_: 1
					}, 8, ["tooltip", "ariaLabel"]))
				])
			]);
...
}, vr = /* @__PURE__ */ te(/* @__PURE__ */ D({
	__name: "floating-button",
	setup(e) {
		let t = fn(), n = ve("iApi"), { t: r } = R(), i = x(() => t.notificationNumber);
		return (e, t) => {
			let a = N("tippy");
			return L((A(), w("button", {
				type: "button",
				onClick: t[0] ||= (e) => F(n).panel.get("notifications").open(),
				...
				content: F(r)("notifications.title"),
				"aria-label": F(r)("notifications.title")
			}, [t[1] ||= T("svg", {
				class: "fill-current w-24 h-24",
				xmlns: "http://www.w3.org/2000/svg",
				viewBox: "0 0 24 24"
			}, [T("path", { d: "M12 22c1.1 0 2-.9 2-2h-4c0 1.1.89 2 2 2zm6-6v-5c0-3.07-1.64-5.64-4.5-6.32V4c0-.83-.67-1.5-1.5-1.5s-1.5.67-1.5 1.5v.68C7.63 5.36 6 7.92 6 11v5l-2 2v1h16v-1l-2-2z" })], -1), i.value && i.value > 0 ? (A(), w("span", _r, P(i.value), 1)) : C("", !0)], 8, gr)), [[a]]);
		};
	}
}), [["__scopeId", "data-v-a451db5c"]]), yr = { class: "flex items-center mb-20" }, br = { class: "text-xl" }, xr = /* @__PURE__ */ D({
	__name: "keyboard-instructions",
	setup(e) {
		let t = ve("iApi"), { t: n } = R(), r = j(!1), i = j([
			"app",
			"lists",
			"map",
			"keyboardNav"
		]), a = j([]), o = j(null), s = j(null);
		Ce(() => {
		...
		return (e, t) => {
			...
			return r.value ? (A(), w("div", {
				...
				onClick: t[2] ||= Ie(() => {}, ["stop", "prevent"]),
				tabindex: "0",
				ref_key: "firstEl",
				ref: o
			}, [
				T("div", yr, [T("h2", br, P(F(n)("keyboardInstructions.title")), 1), E(a, {
					class: "ml-auto",
					onClick: t[0] ||= (e) => r.value = !1
				})]),
				(A(!0), w(le, null, De(i.value, (e) => (A(), w("p", {
					class: "whitespace-pre-line pb-10",
					key: e
				}, P(F(n)(`keyboardInstructions.${e}`)), 1))), 128)),
				T("button", {
					type: "button",
					...
					ref_key: "lastEl",
					ref: s
				}, P(F(n)("keyboardInstructions.OK")), 513)
			], 512)], 32)) : C("", !0);
		};
	}
}), Sr = b("instance", () => ({ started: j(!1) })), Cr = { class: "h-full relative" }, wr = { class: "inner-shell absolute top-0 left-0 h-full w-full pointer-events-none" }, Tr = { class: "absolute top-8 w-full flex justify-center" }, Er = {
	key: 1,
	class: "w-full h-full"
}, Dr = D({
	name: "App",
	components: { Shell: /* @__PURE__ */ te(/* @__PURE__ */ D({
		__name: "shell",
		setup(e) {
			let t = ve("iApi"), n = Sr(), r = qt(), i = cn(), { t: a } = R(), o = x(() => r.items.appbar), s = () => {
				t.event.emit("openKeyboardInstructions");
			}, c = () => i.teleported;
			return (e, t) => (A(), w("div", Cr, [
				T("div", wr, [
					t[0] ||= T("div", { class: "sr-only screen-reader-alert" }, null, -1),
					T("div", Tr, [T("button", {
						type: "button",
						class: "bg-white hidden-until-focus z-50 shadow-md px-10",
						onClick: s
					}, P(F(a)("keyboardInstructions.open")), 1)]),
					E(xr, { class: "keyboard-instructions-modal" }),
					E(ln, { class: "panel-stack sm:flex absolute inset-0 overflow-hidden sm:p-12 z-10 sm:pl-80 xs:pl-40 sm:pb-48 xs:pb-28 xs:pr-0 sm:pr-40" }),
					o.value ? C("", !0) : (A(), S(vr, { key: 0 })),
					E(hr, { class: "z-30" })
				]),
				F(n).started ? (A(), S(nn, { key: 0 })) : (A(), w("div", Er, [...t[1] ||= [T("div", { class: "spinner relative inset-x-1/2 inset-y-9/20" }, null, -1)]])),
				(A(!0), w(le, null, De(c(), (e) => (A(), S(ue, {
	...
	setup() {
		let e = ge();
		Ce(() => {
			new an().observe(e?.proxy?.$refs["app-size"]), Ke({
...
function Ar(e, t, n, r, i, a) {
	...
	return A(), w("div", {
		...
		lang: e.$i18n.locale
	}, [T("div", kr, [E(o)], 512)], 8, Or);
}
var jr = /* @__PURE__ */ te(Dr, [["render", Ar]]), Mr = /* @__PURE__ */ function(e) {
...
}(Mr || {}), Nr = "focus-list", Pr = "focus-item", Fr = "focus-icon", Ir = `[${Nr}],[focus-container]`, Lr = "truncate-text", Rr = "show-truncate", zr = "focused", Br = `button,input,select,a,textarea,[contenteditable],[${Nr}],[${Fr}],[tabindex]`, Vr = {
	mounted(e, t) {
		+e.getAttribute("tabindex") <= 0 && e.setAttribute("tabindex", "0"), e.toggleAttribute(Nr, !0), new Ur(e, t.value);
	},
	updated(e) {
		Hr(e);
	}
...
function Hr(e) {
	e.querySelectorAll(Br).forEach((t) => {
		if (t.closest(Ir) === e || t.closest(Ir) === t && t.parentElement.closest(Ir) === e) if (t.closest(`[${Nr}],.${zr}`).classList.contains(zr)) t.setAttribute("tabindex", "0");
		else {
...
var Ur = class {
	...
	setTabIndex(e, t = this.element) {
		t.querySelectorAll(Br).forEach((t) => {
			(e === -1 || t.closest(Ir) === this.element || t.closest(Ir) === t && t.parentElement.closest(Ir) === this.element || t.closest(`[${Nr}],.${zr}`).classList.contains(zr)) && t.setAttribute("tabindex", e.toString());
		});
	}
	defocusItem(e) {
		e.classList.remove(zr), this.setTabIndex(-1, e), e._tippy && e._tippy.hide(), e.getAttribute(Pr) === Rr && e.querySelector(`[${Lr}]`)?._tippy?.hide();
	}
	focusItem(e) {
		e.classList.add(zr), this.setAriaActiveDescendant(e), this.setTabIndex(0, e), e.scrollIntoView({ block: "nearest" }), e._tippy && !this.isTapped && e._tippy.show(), e.getAttribute(Pr) === Rr && e.querySelector(`[${Lr}]`)?._tippy?.show(), this.isTapped = !1;
	}
	...
	onKeydown(e) {
		let t = this, n = Array.prototype.filter.call(this.element.querySelectorAll(`[${Pr}]`), (e) => e.closest(`[${Nr}]`) === t.element && !!e.offsetParent);
		if (n.length !== 0) switch (e.key) {
			...
			case Mr.Space:
				...
				break;
			case Mr.Tab:
				let t = this.highlightedItem.querySelectorAll(Br).length === 0, r = this.element.isEqualNode(e.target);
	...
	onClick(e) {
		...
		let t = e.target;
		if (!t.hasAttribute(Nr)) for (; t.parentElement.closest(`[${Nr}]`) !== this.element;) t = t.parentElement.closest(`[${Nr}]`);
		this.highlightedItem = t.closest(`[${Pr}]`) || t.closest(`[${Nr}]`) || this.highlightedItem, t.hasAttribute(`${Pr}`) && this.element.focus(), this.highlightedItem === this.element ? this.element.removeAttribute("aria-activedescendant") : this.focusItem(this.highlightedItem);
	}
	onFocus() {
		if (this.highlightedItem === this.element) {
			let e = this.element.querySelectorAll(`[${Pr}]`);
			if (e.length === 1) {
				this.defocusItem(this.highlightedItem), this.highlightedItem = e[0], this.focusItem(e[0]);
				return;
			}
		}
		this.highlightedItem && !this.isClicked && (this.highlightedItem._tippy && this.highlightedItem._tippy.show(), this.highlightedItem.getAttribute(Pr) === Rr && this.highlightedItem.querySelector(`[${Lr}]`)?._tippy?.show()), this.isClicked = !1, this.element.hasAttribute("aria-activedescendant") || this.highlightedItem === this.element ? this.highlightedItem !== this.element && this.focusItem(this.highlightedItem) : this.setAriaActiveDescendant(this.highlightedItem), Hr(this.element), this.highlightedItem && this.highlightedItem !== this.element && this.highlightedItem.setAttribute("tabindex", "-1");
	}
	onBlur() {
		this.highlightedItem && (this.highlightedItem._tippy && this.highlightedItem._tippy.hide(), this.highlightedItem.getAttribute(Pr) === Rr && this.highlightedItem.querySelector(`[${Lr}]`)?._tippy?.hide());
	}
	onMousedown() {
		this.isClicked = !0;
	}
...
}, Wr = "focus-item", Gr = { beforeMount(e, t) {
	e.hasAttribute("id") || e.setAttribute("id", Kr()), t.value ? e.setAttribute(Wr, t.value) : e.toggleAttribute(Wr, !0);
} };
function Kr() {
	let e;
	do
...
var qr = /* @__PURE__ */ function(e) {
...
}(qr || {}), Jr = "focus-container", Yr = "focus-container-active", Xr = "focus-list", Zr = "focus-icon", Qr = `[${Xr}],[${Jr}]`, $r = `button,input,select,a,textarea,[contenteditable],.ag-tab-guard,[${Xr}],[${Jr}],[${Zr}],[tabindex]`, ei = {
	childList: !0,
	subtree: !0,
	attributes: !0,
	attributeFilter: [
	...
	mounted(e) {
		[...document.querySelectorAll(".inner-shell")].some((t) => t.contains(e)) && ti.push(new ri(e));
	},
	beforeUnmount(e) {
		ti = ti.filter((t) => t.element === e ? (t.removeEventListeners(), !1) : !0);
	}
}, ri = class {
	element;
	isTabbingEnabled;
	...
	focusHandler;
	constructor(e) {
		this.element = e, this.isTabbingEnabled = !1, this.element.toggleAttribute(Jr, !0), this.element.toggleAttribute(Yr, !1), this.element.tabIndex = 0, this.initialDisableTimeout = setTimeout(() => this.disableTabbing(), 600), this.keypressHandler = (e) => {
			this.onKeypress(e);
		}, this.clickHandler = () => {
			this.onClick();
	...
	onKeypress(e) {
		e.target === this.element && (e.key === qr.Enter || e.key === qr.Space) && this.enableTabbing()?.focus();
	}
	onClick() {
		this.enableTabbing();
	}
	...
	disableTabbing() {
		...
		let t = Array.prototype.filter.call(this.element.querySelectorAll($r), () => !0);
	...
	enableTabbing() {
		...
		return this.withPausedObserver(() => {
			Array.prototype.map.call(this.element.querySelectorAll($r), (t) => {
				(t.closest(Qr) === this.element || t.closest(Qr) === t && t.parentElement.closest(Qr) === this.element) && t.offsetParent && (t.tabIndex !== 0 && (t.tabIndex = 0), e === void 0 && (e = t));
			});
		}), e;
	}
	setTabbingEnabled(e) {
		this.isTabbingEnabled = e, this.element.toggleAttribute(Yr, e);
	}
	observeMutations() {
		this.mutationObserver?.observe(this.element, ei);
	}
...
}, ii = "truncate-text", ai = "truncate-trigger", oi = {
	beforeMount(e, t) {
		!e.classList.contains("truncate") && !t.value?.noTruncateClass && e.classList.add("truncate"), e.toggleAttribute(ii, !0);
	},
	mounted(e, t) {
		let n;
		t.value && t.value.externalTrigger && (n = e.closest(`[${ai}]`)), qe(e, {
			content: li(e.textContent),
			onShow: si,
			allowHTML: !0,
			placement: "bottom-start",
			maxWidth: 320,
	...
	updated(e, t) {
		e._tippy && (e._tippy.setContent(li(e.textContent)), t.value && t.value.options && e._tippy.setProps(t.value.options));
	},
	unmounted(e) {
...
var ui = ["content"], di = {
...
}, _i = "focus-container", vi = "focus-container-active", yi = /* @__PURE__ */ D({
	__name: "panel-screen",
	props: {
		header: {
			type: Boolean,
	...
	setup(e, { expose: t }) {
		let { t: n } = R(), r = cn(), i = Ht(), a = ve("iApi"), o = Me("el"), s = Me("contentEl"), c = j(), l = j(), u = j();
		t({ el: o });
		let d = e, f = x(() => a.fixture.get("appbar") ? i.temporary : []), p = x(() => r.mobileView), m = x(() => r.reorderable), h = `[focus-list], [${_i}]`, g = (e) => e.scrollHeight > e.clientHeight, ee = (e) => e.querySelector(h), _ = () => {
			if (!s.value) return "-1";
			let e = s.value.closest(`[${_i}]`);
			if (e && !e.hasAttribute(vi)) return "-1";
			let t = !!ee(s.value);
			...
			ne(e, o.value) && o.value?._tippy?.show();
		}, ae = () => !p.value && !d.panel.teleport, y = (e) => {
			d.panel.move(e), e === "left" && be(() => {
				(o.value?.querySelector(".move-left")).focus();
			});
		}, oe = x(() => d.screenId ? d.panel.screens[d.screenId][a.$i18n.locale.value ?? "en"] : null);
		return Ce(() => {
			o.value?.addEventListener("blur", re), o.value?.addEventListener("keyup", ie), s.value && (s.value.addEventListener("focus", te), c.value = new ResizeObserver(v), c.value.observe(s.value), l.value = new MutationObserver(v), l.value.observe(s.value, {
				childList: !0,
				subtree: !0,
				attributes: !0,
			...
			o.value?.removeEventListener("blur", re), o.value?.removeEventListener("keyup", ie), s.value?.removeEventListener("focus", te), c.value?.disconnect(), l.value?.disconnect(), u.value?.disconnect();
		}), (t, r) => {
			let i = M("back"), a = M("panel-options-menu"), c = M("left"), l = M("right"), u = M("pin"), d = M("expand"), p = M("minimize"), h = M("close"), g = N("truncate"), ee = N("focus-item"), _ = N("tippy");
			return L((A(), w("div", {
				class: "h-full flex flex-col items-stretch",
				content: `<div style='word-break: break-word;'>${F(n)(e.panel.alertName) + ". " + F(n)("panels.access")}</div>`,
				ref_key: "el",
				ref: o
			}, [
				e.header ? (A(), w("header", di, [
					E(i, {
						class: k(e.panel.teleport ? "display-none" : "block sm:display-none"),
						onClick: r[0] ||= (t) => e.panel.close()
					}, null, 8, ["class"]),
					L((A(), w("h2", fi, [t.$slots.header ? Oe(t.$slots, "header", { key: 0 }) : (A(), w("div", pi, P(F(n)(e.panel.alertName)), 1))])), [[g]]),
					t.$slots.controls ? (A(), S(a, { key: 0 }, {
						default: I(() => [Oe(t.$slots, "controls")]),
						_: 3
					})) : C("", !0),
					T("div", { class: k(e.panel.teleport ? "flex" : "display-none sm:flex") }, [
						e.panel.teleport ? C("", !0) : (A(), w("div", mi, [
							m.value ? (A(), S(c, {
								key: 0,
								onClick: r[1] ||= (e) => y("left"),
								active: !e.panel.isLeftMostPanel
							}, null, 8, ["active"])) : C("", !0),
							m.value ? (A(), S(l, {
								key: 1,
								onClick: r[2] ||= (e) => y("right"),
							...
							e.panel.controls && e.panel.controls.expand ? (A(), S(d, {
								key: 2,
								onClick: r[4] ||= (t) => e.panel.expand(),
								active: e.panel.expanded
							}, null, 8, ["active"])) : C("", !0)
						])),
						e.panel.button && f.value?.includes(e.panel.id) ? (A(), S(p, {
							key: 1,
							onClick: r[5] ||= (t) => e.panel.minimize()
						})) : C("", !0),
						E(h, { onClick: r[6] ||= (t) => e.panel.close() })
					], 2)
				])) : C("", !0),
				e.content ? (A(), w("div", {
					key: 1,
					...
					ref: s,
					tabindex: "-1"
				}, [t.$slots.content ? Oe(t.$slots, "content", { key: 0 }) : oe.value ? (A(), w("div", {
					key: 1,
					innerHTML: oe.value.innerHTML
				}, null, 8, hi)) : C("", !0)], 512)) : C("", !0),
				e.footer ? L((A(), w("div", gi, [Oe(t.$slots, "footer")])), [[ee]]) : C("", !0)
			], 8, ui)), [[_, {
				trigger: "manual",
				touch: !1,
				onShow: ae,
...
}), bi = { class: "relative" }, xi = ["content", "aria-label"], Si = ["transform"], Ci = /* @__PURE__ */ D({
	__name: "pin",
	...
	setup(e) {
		...
		return (n, r) => {
			let i = N("tippy");
			return A(), w("div", bi, [L((A(), w("button", {
				type: "button",
				class: k(["text-gray-500 hover:text-black focus:text-black p-8", { "text-gray-700": e.active }]),
				content: F(t)(e.active ? "panels.controls.unpin" : "panels.controls.pin"),
				"aria-label": F(t)(e.active ? "panels.controls.unpin" : "panels.controls.pin")
			}, [(A(), w("svg", {
				class: "fill-current w-16 h-16",
				xmlns: "http://www.w3.org/2000/svg",
				viewBox: "0 0 384 512",
				transform: `rotate(${e.active ? 30 : 0})`
			}, [...r[0] ||= [T("path", { d: "M298.028 214.267L285.793 96H328c13.255 0 24-10.745 24-24V24c0-13.255-10.745-24-24-24H56C42.745 0 32 10.745 32 24v48c0 13.255 10.745 24 24 24h42.207L85.972 214.267C37.465 236.82 0 277.261 0 328c0 13.255 10.745 24 24 24h136v104.007c0 1.242.289 2.467.845 3.578l24 48c2.941 5.882 11.364 5.893 14.311 0l24-48a8.008 8.008 0 0 0 .845-3.578V352h136c13.255 0 24-10.745 24-24-.001-51.183-37.983-91.42-85.973-113.733z" }, null, -1)]], 8, Si))], 10, xi)), [[i, {
				placement: "bottom",
				hideOnClick: !1
			}]])]);
		};
	}
}), wi = { class: "relative" }, Ti = ["content", "aria-label"], Ei = /* @__PURE__ */ D({
	__name: "close",
	props: { active: Boolean },
	setup(e) {
		let { t } = R();
		return (n, r) => {
			let i = N("tippy");
			return A(), w("div", wi, [L((A(), w("button", {
				type: "button",
				class: k(["text-gray-500 hover:text-black focus:text-black p-8", { "text-gray-700": e.active }]),
				content: F(t)("panels.controls.close"),
				"aria-label": F(t)("panels.controls.close")
			}, [...r[0] ||= [T("svg", {
				class: "fill-current w-16 h-16",
				xmlns: "http://www.w3.org/2000/svg",
				viewBox: "0 0 352 512"
			}, [T("path", { d: "M242.72 256l100.07-100.07c12.28-12.28 12.28-32.19 0-44.48l-22.24-22.24c-12.28-12.28-32.19-12.28-44.48 0L176 189.28 75.93 89.21c-12.28-12.28-32.19-12.28-44.48 0L9.21 111.45c-12.28 12.28-12.28 32.19 0 44.48L109.28 256 9.21 356.07c-12.28 12.28-12.28 32.19 0 44.48l22.24 22.24c12.28 12.28 32.2 12.28 44.48 0L176 322.72l100.07 100.07c12.28 12.28 32.2 12.28 44.48 0l22.24-22.24c12.28-12.28 12.28-32.19 0-44.48L242.72 256z" })], -1)]], 10, Ti)), [[i, {
				placement: "bottom",
				theme: "ramp4",
				animation: "scale"
			}]])]);
...
}), Di = { class: "relative" }, Oi = ["content", "aria-label"], ki = /* @__PURE__ */ D({
	__name: "back",
	props: { active: Boolean },
	setup(e) {
		let { t } = R();
		return (n, r) => {
			let i = N("tippy");
			return A(), w("div", Di, [L((A(), w("button", {
				type: "button",
				class: k(["text-gray-500 hover:text-black focus:text-black p-8", { "text-gray-700": e.active }]),
				content: F(t)("panels.controls.back"),
				"aria-label": F(t)("panels.controls.back")
			}, [...r[0] ||= [T("svg", {
				xmlns: "http://www.w3.org/2000/svg",
				class: "fill-current w-16 h-16",
				viewBox: "0 0 16 16"
...
}), Ai = { class: "w-32 h-32" }, ji = ["content", "aria-label"], Mi = {
	key: 0,
	xmlns: "http://www.w3.org/2000/svg",
	viewBox: "0 0 24 24",
	...
	setup(e) {
		...
		return (n, r) => {
			let i = N("tippy");
			return A(), w("div", Ai, [L((A(), w("button", {
				type: "button",
				class: "text-gray-500 hover:text-black focus:text-black w-full h-full flex justify-center items-center",
				content: F(t)(`panels.controls.${e.active ? "collapse" : "expand"}`),
				"aria-label": F(t)(`panels.controls.${e.active ? "collapse" : "expand"}`)
			}, [e.active ? (A(), w("svg", Ni, [...r[1] ||= [
				T("path", {
					d: "M0 0h24v24H0z",
					fill: "none"
				}, null, -1),
				...
				T("path", { d: "M8 19h3v3h2v-3h3l-4-4-4 4zm8-15h-3V1h-2v3H8l4 4 4-4zM4 9v2h16V9H4z" }, null, -1),
				T("path", { d: "M4 12h16v2H4z" }, null, -1)
			]])) : (A(), w("svg", Mi, [...r[0] ||= [
				T("path", {
					d: "M0 0h24v24H0z",
					fill: "none"
				...
				T("path", { d: "M4 20h16v2H4zM4 2h16v2H4zm9 7h3l-4-4-4 4h3v6H8l4 4 4-4h-3z" }, null, -1)
			]]))], 8, ji)), [[i, {
				placement: "bottom",
				theme: "ramp4",
				animation: "scale",
...
}), Fi = { class: "relative" }, Ii = ["content", "aria-label"], Li = /* @__PURE__ */ D({
	__name: "minimize",
	props: { active: Boolean },
	setup(e) {
		let { t } = R();
		return (n, r) => {
			let i = N("tippy");
			return A(), w("div", Fi, [L((A(), w("button", {
				type: "button",
				class: k(["text-gray-500 hover:text-black focus:text-black p-6", { "text-gray-700": e.active }]),
				content: F(t)("panels.controls.minimize"),
				"aria-label": F(t)("panels.controls.minimize")
			}, [...r[0] ||= [T("svg", {
				class: "fill-current w-20 h-20",
				xmlns: "http://www.w3.org/2000/svg",
				viewBox: "0 0 24 24"
				...
				d: "M0 0h24v24H0V0z",
				fill: "none"
			}), T("path", { d: "M6 19h12v2H6z" })], -1)]], 10, Ii)), [[i, {
				placement: "bottom",
				theme: "ramp4",
				animation: "scale"
			}]])]);
...
var zi = { class: "relative" }, Bi = ["content", "aria-label"], Vi = /* @__PURE__ */ D({
	__name: "right",
	props: { active: Boolean },
	setup(e) {
		let { t } = R(), n = e, r = j(null), { syncTooltipAfterKeyboardMove: i } = Ri(r, () => !!n.active);
		return (n, a) => {
			let o = N("tippy");
			return A(), w("div", zi, [L((A(), w("button", {
				ref_key: "buttonRef",
				ref: r,
				type: "button",
				class: k(["p-8", {
				...
				onClick: a[0] ||= (...e) => F(i) && F(i)(...e),
				content: F(t)("panels.controls.moveRight"),
				"aria-label": F(t)("panels.controls.moveRight")
			}, [...a[1] ||= [T("svg", {
				class: "fill-current w-16 h-16",
				xmlns: "http://www.w3.org/2000/svg",
				viewBox: "4 4 16 16"
			}, [T("path", { d: "M 8.59 16.34 L 13.17 11.75 L 8.59 7.16 L 10 5.75 L 16 11.75 L 10 17.75 Z" })], -1)]], 10, Bi)), [[o, {
				placement: "bottom",
				theme: "ramp4",
				animation: "scale"
			}]])]);
...
}), Hi = { class: "relative" }, Ui = ["content", "aria-label"], Wi = /* @__PURE__ */ D({
	__name: "left",
	props: { active: Boolean },
	setup(e) {
		let t = e, { t: n } = R(), r = j(null), { syncTooltipAfterKeyboardMove: i } = Ri(r, () => !!t.active);
		return (t, a) => {
			let o = N("tippy");
			return A(), w("div", Hi, [L((A(), w("button", {
				ref_key: "buttonRef",
				ref: r,
				type: "button",
				class: k(["p-8 move-left", {
					"text-gray-500 hover:text-black focus:text-black": e.active,
					"text-gray-300": !e.active
				}]),
				onClick: a[0] ||= (...e) => F(i) && F(i)(...e),
				content: F(n)("panels.controls.moveLeft"),
				"aria-label": F(n)("panels.controls.moveLeft")
			}, [...a[1] ||= [T("svg", {
				class: "fill-current w-16 h-16",
				xmlns: "http://www.w3.org/2000/svg",
				viewBox: "4 4 16 16"
			}, [T("path", { d: "M 15.41 16.09 L 10.83 11.5 L 15.41 6.91 L 14 5.5 L 8 11.5 L 14 17.5 Z" })], -1)]], 10, Ui)), [[o, {
				placement: "bottom",
				theme: "ramp4",
				animation: "scale"
			}]])]);
...
}), Gi = /* @__PURE__ */ te(/* @__PURE__ */ D({
	__name: "panel-options-menu",
	setup(e) {
		let { t } = R();
		return (e, n) => (A(), S(dn, {
			class: "flex",
			tooltip: F(t)("panels.controls.optionsMenu"),
			popperOptions: { strategy: "fixed" },
			position: "bottom-end"
		}, {
			header: I(() => [...n[0] ||= [T("div", { class: "p-6" }, [T("svg", {
				xmlns: "http://www.w3.org/2000/svg",
				viewBox: "0 0 24 24",
				class: "fill-current w-20 h-20"
			}, [T("path", { d: "M12 8c1.1 0 2-.9 2-2s-.9-2-2-2-2 .9-2 2 .9 2 2 2zm0 2c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2zm0 6c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2z" })])], -1)]]),
			default: I(() => [Oe(e.$slots, "default", {}, void 0, !0)]),
			_: 3
		}, 8, ["tooltip"]));
	}
}), [["__scopeId", "data-v-51e22a4a"]]), Ki = {
	key: 0,
	xmlns: "http://www.w3.org/2000/svg",
	viewBox: "0 0 24 24",
	...
	setup(e) {
		...
		return (e, i) => {
			...
			return A(), S(a, {
				onClickFunction: r,
				tooltip: F(t)("mapnav.fullscreen")
			}, {
				default: I(() => [F(n).isFullscreen ? (A(), w("svg", Ki, [...i[0] ||= [T("path", {
					d: "M0 0h24v24H0z",
					fill: "none"
				}, null, -1), T("path", { d: "M5 16h3v3h2v-5H5v2zm3-8H5v2h5V5H8v3zm6 11h2v-3h3v-2h-5v5zm2-11V5h-2v5h5V8h-3z" }, null, -1)]])) : (A(), w("svg", qi, [...i[1] ||= [T("path", {
					d: "M0 0h24v24H0z",
					fill: "none"
				}, null, -1), T("path", { d: "M7 14H5v5h5v-2H7v-3zm-2-4h2V7h3V5H5v5zm12 7h-3v2h5v-5h-2v3zM14 5v2h3v3h2V5h-5z" }, null, -1)]]))]),
				_: 1
			}, 8, ["tooltip"]);
		};
	}
	...
	setup(e) {
		let { t } = R(), n = ve("iApi"), r = Te([]), i = async () => {
			if (r.length) a(r);
			else {
				let e = await o({
					maximumAge: Infinity,
			...
			let t = new Y("geolocation", e, J.latLongSR(), !0);
			n.geo.map.zoomMapTo(t);
		}, o = (e) => new Promise((t, n) => navigator.geolocation.getCurrentPosition(t, n, e));
		return (e, n) => {
			let r = M("mapnav-button");
			return A(), S(r, {
				onClickFunction: i,
				tooltip: F(t)("mapnav.geolocator")
			}, {
				default: I(() => [...n[0] ||= [T("svg", {
					xmlns: "http://www.w3.org/2000/svg",
					viewBox: "0 0 24 24",
					class: "fill-current w-32 h-20"
				}, [T("path", { d: "M12 8c-2.21 0-4 1.79-4 4s1.79 4 4 4 4-1.79 4-4-1.79-4-4-4zm8.94 3c-.46-4.17-3.77-7.48-7.94-7.94V1h-2v2.06C6.83 3.52 3.52 6.83 3.06 11H1v2h2.06c.46 4.17 3.77 7.48 7.94 7.94V23h2v-2.06c4.17-.46 7.48-3.77 7.94-7.94H23v-2h-2.06zM12 19c-3.87 0-7-3.13-7-7s3.13-7 7-7 7 3.13 7 7-3.13 7-7 7z" })], -1)]]),
				_: 1
			}, 8, ["tooltip"]);
		};
	}
	...
	setup(e) {
		...
		return (e, n) => {
			let i = M("mapnav-button");
			return A(), S(i, {
				onClickFunction: r,
				tooltip: F(t)("mapnav.home")
			}, {
				default: I(() => [...n[0] ||= [T("svg", {
					xmlns: "http://www.w3.org/2000/svg",
					viewBox: "0 0 24 24",
					class: "fill-current w-32 h-20"
				}, [T("path", { d: "M10 20v-6h4v6h5v-8h3L12 3 2 12h3v8z" }), T("path", {
					d: "M0 0h24v24H0z",
					fill: "none"
				})], -1)]]),
				_: 1
	...
	setup(e) {
		return (t, n) => {
			let r = N("focus-item"), i = N("tippy");
			return A(), w("div", Zi, [L((A(), w("button", {
				type: "button",
				class: k(["w-full h-full default-focus-style", [e.showOutline ? "focus:outline focus:outline-2 focus:outline-blue-400 focus:absolute focus:z-50" : "focus:outline-none"]]),
				disabled: e.disabled,
			...
			}, [Oe(t.$slots, "default", {}, void 0, !0)], 10, Qi)), [[r], [i, { placement: "left" }]])]);
		};
	}
}), [["__scopeId", "data-v-bafb7e3d"]]), ea = {
	class: "relative",
	tabindex: "-1"
}, ta = ["aria-label", "content"], na = /* @__PURE__ */ te(/* @__PURE__ */ D({
	__name: "button",
	props: {
		onClickFunction: {
			type: Function,
	...
	setup(e) {
		let t = ve("iApi"), n = e, r = () => t.event.emit(Q.APPBAR_BUTTON_CLICK, n.buttonId);
		return (t, n) => {
			let i = N("focus-item"), a = N("tippy");
			return A(), w("div", ea, [L((A(), w("button", {
				type: "button",
			...
			}, [Oe(t.$slots, "default", {}, void 0, !0)], 8, ta)), [[i], [a, {
				allowHTML: !0,
				placement: "right"
			}]])]);
		};
	}
}), [["__scopeId", "data-v-1cb84ae1"]]), ra = b("areas-of-interest", () => ({ areas: j([]) })), ia = b("export", () => {
	let e = j({
		title: !0,
		map: !0,
		mapElements: !0,
	...
	fsaToProvince(e) {
		...
		return t = r === "X" ? n === "X0A" || n === "X0B" || n === "X0C" ? 62 : 61 : oa[r], this.codeToProvince(t);
	}
};
function la(e) {
	return new ca(e);
	...
	constructor(e, t) {
		Ye.get(t).then((t) => {
			t.data.definitions.forEach((t) => {
				ua[e][t.code] = t.term.split(`${t.code}-`)[1];
			}), Object.keys(ua[e]).forEach((t) => {
				this.allTypes[t] = ua[e][t], this.validTypes[t] = ua[e][t];
			}), this.typesFetched = !0;
		});
	}
	filterValidTypes(e) {
...
async function ma(e, t) {
	let n, r;
	return /^[-+]?([1-8]?\d(\.\d+)?|90(\.0+)?)(\s*[,|;\s]\s*)[-+]?(180(\.0+)?|((1[0-7]\d)|([1-9]?\d))(\.\d+)?)[*]$/.test(t) && !e.disabledSearchTypes.includes("LAT/LNG") ? (r = t.slice(0, -1), n = new pa(e, r), await Ca(n)) : /^[ABCEGHJKLMNPRSTVXY]\d[A-Z]/.test(t) && !e.disabledSearchTypes.includes("FSA") ? (r = t.substring(0, 3).toUpperCase(), n = new pa(e, r), await wa(n)) : /^\d{2,3}[A-P]/.test(t) && !e.disabledSearchTypes.includes("NTS") ? (r = t.substring(0, 6).toUpperCase(), n = new pa(e, r), await Ta(n)) : (r = encodeURIComponent(t.trim()), n = new pa(e, r), await Ea(n)), e.customSources.length && await ya(n, e.customSources), n;
}
var ha = async (e) => {
	let [t, n] = await Xe(Ye.get(e));
...
}, va = (e, t) => t.filter((t) => e.types.validTypes[t.concise.code]).map((t) => ({
	name: t.name,
	flav: "nme",
	bbox: t.bbox,
	...
	let [t, n] = await Xe(ha(_a(e, !0)));
	return t ? (console.error("Geolocation service failed"), e.failedServs.push("geolocation"), []) : n;
}, xa = async (e) => {
	let [t, n] = await Xe(ha(_a(e, !1))), r;
	t ? (console.error("GeoName service targeting Name failed"), e.failedServs.push("geoname"), r = []) : r = n.items, e.addResult(va(e.config, r));
}, Sa = async (e, t, n) => {
	let [r, i] = await Xe(ha(_a(e, !1, t, n))), a;
	r ? (console.error("GeoName service targeting Lat Lon failed"), e.failedServs.push("geoname"), a = []) : a = i.items, e.addResult(va(e.config, a));
}, Ca = async (e) => {
	...
	await Sa(e, n, r), e.addResult(i);
}, wa = async (e) => {
	let t = e.config, n = await ba(e);
	if (n.length) {
	...
	let t = e.config;
	if (await xa(e), t.categories.length === 0 || t.categories.includes("ADDR")) {
		let n = await ba(e), r = t.sortOrder.indexOf("ADDR"), i = r >= 0 ? r : t.sortOrder.length, a = n.filter((e) => e.type?.includes("Street")).map((e) => {
...
}, Da = "~FSA~", Oa = "https://geogratis.gc.ca/services/geolocation/@{language}/locate", ka = "https://geogratis.gc.ca/services/geoname/@{language}/geonames.json", Aa = "https://geogratis.gc.ca/services/geoname/@{language}/codes/province.json", ja = "https://geogratis.gc.ca/services/geoname/@{language}/codes/concise.json", Ma = class {
	config;
	constructor(e, t) {
		let n, r, i, a, o = t?.serviceUrls;
		o ? (n = o.geoLocation ? o.geoLocation : Oa, r = o.geoNames ? o.geoNames : ka, i = o.geoProvince ? o.geoProvince : Aa, a = o.geoTypes ? o.geoTypes : ja) : (n = Oa, r = ka, i = Aa, a = ja), n = n.replace("@{language}", e), r = r.replace("@{language}", e), i = i.replace("@{language}", e), a = a.replace("@{language}", e);
		let s = "", c = t?.fsaBoundaries;
		if (c && c.serviceUrl) {
			let e = c.keyField || "CFSAUID";
			s = `${c.serviceUrl}/query/?where=${e}%3D'${Da}'&outFields=${e}&returnGeometry=true&f=json`;
		}
		...
		l ? (u = l.categories ? l.categories : [], d = l.sortOrder ? l.sortOrder : [], f = l.disabledSearchTypes ? l.disabledSearchTypes : [], p = l.maxResults > 0 ? l.maxResults : 100, m = !!l.officialOnly) : (u = [], d = [], f = [], p = 100, m = !1), h = t?.customSources ?? [], h = h.map((e) => ({
			...e,
			onSearch: async (t) => {
				let n = e.data ?? [], r = Pa(), i = decodeURIComponent(r.cleanVal(t)).replace("*", "");
	...
	async query(e) {
		let t = await ma(this.config, e.toUpperCase()), n = this.config.sortOrder.length, r = t.results.filter((e) => e.order < n), i = t.results.filter((e) => e.order >= n);
...
var Pa = b("geosearch", () => {
	let e = j(new Ma("en", void 0)), t = j({
		type: "",
		province: "",
		extent: void 0
	}), n = j(!1), r = j(""), i = j(""), a = j(""), o = j([]), s = j([]), c = j(!1), l = j([]), u = x(() => e.value.fetchProvinces().then((e) => (e.sort((e, t) => e.name.localeCompare(t.name, void 0, { sensitivity: "case" })), e))), d = x(() => new Promise((t) => {
		...
		if (!u) o.value = [], s.value = [], c.value = !1;
			...
			let r = setInterval(() => {
				e.value.config.provinces.listFetched && e.value.config.types.typesFetched && (clearInterval(r), e.value.query(`${u}*`).then((e) => {
					l.value = e.failedServs, a.value = u, s.value = e.results, o.value = Na(n.value, t.value, s.value) || [], c.value = !1;
				}));
			}, 250);
		} else o.value = Na(n.value, t.value, s.value) || [], c.value = !1;
	}
	function h(e) {
	...
	_visibleChildren;
	constructor(e, t, n) {
		super(e), this._uid = Ls.sharedUtils.generateUUID(), this._name = t.name, this._type = t.type ?? Ia.Placeholder, this._parent = n, this._children = [], this._loadPromise = new X(), this._hidden = t.hidden ?? !1, this._expanded = t.expanded ?? !0, this._visibility = !0, this._exclusive = t.exclusive ?? !1, this._controls = t.controls?.slice() ?? [Fa.Visibility, Fa.Expand], this._disabledControls = t.disabledControls?.slice(), this._visibleChildren = [];
	}
	get uid() {
		return this._uid;
	}
	...
	toggleVisibility(e, t = !0) {
		if (this.visibility !== e) {
			...
			else if (this.visibility) if (this._lastVisible && (!(this._lastVisible instanceof Ra) || this._lastVisible.layerControlAvailable(q.Visibility))) this._lastVisible.toggleVisibility(!0);
			else {
				let e = this.children.find((e) => !(e instanceof Ra) || e.layerControlAvailable(q.Visibility));
	...
	checkVisibilityRules() {
		(this.parent && !this.parent.visibility || this.parent?.exclusive && this.parent.children.some((e) => e.visibility && e !== this && e.type === Ia.Item)) && this.toggleVisibility(!1, !1);
	}
	checkVisibility(e) {
		this instanceof Ra && !this.layerControlAvailable(q.Visibility) || (this.exclusive ? e.visibility ? (this.children.forEach((t) => {
			t.uid !== e.uid && t.toggleVisibility(!1, !1);
		}), this._lastVisible = e, this._visibility = !0, this instanceof Ra && this.layer && this.layer.layerExists && (this.layer.visibility = !0)) : (this._visibility = !1, this instanceof Ra && this.layer && this.layer.layerExists && (this.layer.visibility = !1), this._lastVisible = e) : this.children.some((e) => e.visibility) ? (this._visibility = !0, this._visibleChildren = this.children.filter((e) => e.visibility), this instanceof Ra && this.layer && this.layer.layerExists && (this.layer.visibility = !0)) : (this._visibility = !1, this._visibleChildren = [], this instanceof Ra && this.layer && this.layer.layerExists && (this.layer.visibility = !1)), this.parent && this.parent.checkVisibility(this));
	}
	getConfig() {
		let e = {
			name: this._name,
	...
	load() {
		this._type = Ia.Item, this._loadPromise.resolveMe(), this.checkVisibilityRules();
	}
	reload() {
		this._type = Ia.Placeholder, this._loadPromise = new X();
	}
	error() {
		this._type !== Ia.Error && (this._type = Ia.Error, this._loadPromise.getPromise().catch(() => {}), this._loadPromise.rejectMe(), this.checkVisibilityRules());
	}
}, Ra = class extends La {
	_layerId;
	_layerIdx;
	...
	toggleVisibility(e, t = !0, n = !1) {
		if (!(!this.layerControlAvailable(q.Visibility) && !n) && (super.toggleVisibility(e, t), this.layer && this.layer.layerExists)) {
	...
	clickSymbology(e, t) {
		if (!this.symbolsVisible() && t !== !1 ? (this.setSymbologyVisibility(void 0, !1), this.setSymbologyVisibility(e, !0), this.toggleVisibility(!0)) : this.setSymbologyVisibility(e, t), this.symbolsVisible() || this.toggleVisibility(!1), this.layer?.supportsFeatures) {
			...
			e.length === 0 ? t = "1=2" : e.length < this.symbologyStack.length && (t = e.join(" OR ")), this.layer.setSqlFilter(K.SYMBOL, t);
		}
	}
	...
	load(e) {
		...
		t && (this.layer = t, this._layerRedrawing = t.mapLayer && t.drawState !== lt.UP_TO_DATE, t.loadPromise().then(() => {
			this._layerInitVis = this._layerInitVis === void 0 ? t.visibility : this._visibility, super.load(), this.toggleVisibility(this._layerInitVis, !0, !0), t.visibility || this.setSymbologyVisibility(void 0, !1), this.handlers.push(this.$iApi.event.on(Q.LAYER_VISIBILITYCHANGE, (e) => {
				e.layer.uid === this.layer.uid && this._type === Ia.Item && this.toggleVisibility(e.visibility, !0, !0);
			})), this.handlers.push(this.$iApi.event.on(Q.LAYER_DRAWSTATECHANGE, (e) => {
				this.layer.uid === e.layer.uid && (e.layer.drawState === lt.REFRESH ? this.layerRedrawing = !0 : setTimeout(() => {
					this.layerRedrawing = e.layer.drawState === lt.REFRESH;
				}, 500));
			})), this._layerOffscale = this.$iApi.geo.map.created ? t.isOffscale() : !1, this.handlers.push(this.$iApi.event.on(Q.MAP_SCALECHANGE, () => {
...
}, za = /* @__PURE__ */ function(e) {
	return e.Title = "title", e.Text = "text", e.Image = "image", e.Markdown = "markdown", e.Template = "template", e;
}({}), Ba = class extends La {
	_infoType;
	_content;
	constructor(e, t, n) {
		super(e, t, n), this._infoType = t.infoType ?? za.Title, this._content = t.content ?? "", t.infoType === za.Template && this.$element.component(`${this._uid}-info-section`, { template: this._content }), (t.infoType || t.content) && (this._controls = t.controls?.slice() ?? [Fa.Expand]), super.load();
	}
	get infoType() {
	...
	let e = j(), t = j([]), n = j([]), r = j(!0), i = j(3);
	function a(e) {
		if (e.parent === void 0) t.value.push(e.item);
		else {
			if (!(e.item instanceof Ba) && !(e.item instanceof Ra)) {
	...
	function o(e) {
		...
		}), t = t.filter((e) => !(e instanceof Ba && !e.children.length && e.content === "")), t);
		t.value = n(t.value);
	}
	function s(e) {
	...
	let e = j({
		...
		tileSchemas: [],
		initialBasemapId: ""
	}), t = j({}), n = j(!0), r = j(1.5), i = j("#FF0000"), a = j(1), o = j("#000000"), s = j(.25);
	function c(t) {
	...
	let e = {
		...
		layerType: B.UNKNOWN,
		url: ""
	}, t = j(), n = j(""), r = j(""), i = j(!0), a = j(null), o = j({
		config: e,
		configOptions: []
	}), s = j(Ja.UPLOAD);
	function c(t) {
		switch (s.value) {
			case Ja.UPLOAD:
				t === Ja.UPLOAD ? n.value = "" : t === Ja.FORMAT && (s.value = Ja.FORMAT);
				break;
			case Ja.FORMAT:
				t === Ja.UPLOAD ? (a.value &&= (n.value = "", null), r.value = "", s.value = Ja.UPLOAD) : t === Ja.CONFIGURE && (s.value = Ja.CONFIGURE);
				break;
			case Ja.CONFIGURE:
				t === Ja.UPLOAD ? (n.value = "", r.value = "", a.value = null, i.value = !0, o.value = {
					config: e,
					configOptions: []
				}, s.value = Ja.UPLOAD) : t === Ja.FORMAT && (o.value = {
					config: e,
					configOptions: []
				}, i.value = !0, s.value = Ja.FORMAT);
				break;
		}
	}
	return {
	...
	constructor(e, t, n) {
		...
		this.$vApp = r.app, this.$element = r.element, this.$i18n = r.i18n, this.$rootEl = r.app.$root?.$el, this.fixture = new ds(this), this.panel = new ps(this), this.geo = new ls(this), this.dev = new bs(this), this.ui = {
			...
			escapeHtml: () => "",
			isPlainText: () => !0
		}, this.notify = new vn(this), this._isFullscreen = Be.isEnabled && !!this.$vApp.$root && Be.isFullscreen && Be.element === this.$vApp.$root.$el, Be.isEnabled && Be.onchange(() => {
			this._isFullscreen = Be.isEnabled && !!this.$vApp.$root && Be.isFullscreen && Be.element === this.$vApp.$root.$el;
	...
	initialize(e, t, n) {
		...
		n?.startRequired ? (this.startRequired = !0, o.started = !1) : (this.startRequired = !1, o.started = !0, this.event.emit(Q.MAP_START)), e && (n.loadDefaultFixtures !== !1 || t?.startingFixtures !== void 0) ? this.fixture.addDefaultFixtures(t?.startingFixtures) : e || this.fixture.restore(), n.loadDefaultEvents !== !1 && !this._eventsOn && (this.event.addDefaultEvents(), this._eventsOn = !0);
	}
	reloadWorker(e, t) {
		let n = Sr(this.$vApp.$pinia), r = fn(this.$vApp.$pinia), i = v(this.$vApp.$pinia), a = qt(this.$vApp.$pinia), o = _(this.$vApp.$pinia), s = Ut(this.$vApp.$pinia), c = !!e;
		...
		}))), r.clearAll(), this.geo.map.maptip.clear(), this.initialize(c, e, t), c && this.event.emit(Q.CONFIG_CHANGE, this.getConfig());
	}
	reload(e, t) {
		this.reloadWorker(e, t), this.event.emit(Q.RAMP_RELOAD);
	}
	component(e, t) {
		if (t) {
			...
			return this.event.emit(Q.COMPONENT, e), r;
		}
	...
	useStore(e) {
		if (!([
			...
			case "appbar": return Ht(this.$vApp.$pinia);
			case "areas-of-interest": return ra(this.$vApp.$pinia);
			case "details": return Kt(this.$vApp.$pinia);
			case "export": return ia(this.$vApp.$pinia);
			case "extentguard": return aa(this.$vApp.$pinia);
			case "geosearch": return Pa(this.$vApp.$pinia);
			case "grid": return Ut(this.$vApp.$pinia);
			case "help": return re(this.$vApp.$pinia);
			case "keyboardnav": return $n(this.$vApp.$pinia);
			case "legend": return Va(this.$vApp.$pinia);
			case "mapnav": return Ha(this.$vApp.$pinia);
			case "metadata": return Ua(this.$vApp.$pinia);
			case "northarrow": return Wa(this.$vApp.$pinia);
			case "overviewmap": return Ga(this.$vApp.$pinia);
			case "panguard": return Ka(this.$vApp.$pinia);
			case "scrollguard": return qa(this.$vApp.$pinia);
			case "wizard": return Ya(this.$vApp.$pinia);
			case "config": return v(this.$vApp.$pinia);
			case "fixture": return qt(this.$vApp.$pinia);
			case "instance": return Sr(this.$vApp.$pinia);
			case "layer": return _(this.$vApp.$pinia);
			case "map-caption": return Wt(this.$vApp.$pinia);
	...
	setLanguage(e) {
		...
		r[i] !== r[e] && (this.reloadWorker(), this.event.emit(Q.CONFIG_CHANGE, a)), this.event.emit(Q.LANG_CHANGE, {
			oldLang: i,
			newLang: e
		});
	}
	...
	toggleFullscreen() {
		Be.isEnabled && Be.toggle(this.$element._container || void 0);
	}
	get isFullscreen() {
	...
	start() {
		...
		!e.started && this.startRequired ? (this.event.emit(Q.MAP_START), e.started = !0) : e.started && console.warn("start has already been called");
	}
	containsValidHtml(e) {
		return /<(\w+)([^>]*)>(.*?)<\/\1>/.test(e);
	}
...
function Za(e, t) {
	...
	n.use(({ store: e }) => {
		let t = Ve(e.$state);
		e.$reset = () => e.$patch(Ve(t));
	});
	let r = en(), i = pe(jr).use(r).use(Ge, {
		directive: "tippy",
		component: "tippy"
	}).use(n);
	return i.directive("focus-container", ni), i.directive("focus-list", Vr), i.directive("focus-item", Gr), i.directive("truncate", oi), i.component("panel-screen", yi), i.component("pin", Ci), i.component("close", Ei), i.component("back", ki), i.component("expand", Pi), i.component("panel-options-menu", Gi), i.component("dropdown-menu", dn), i.component("minimize", Li), i.component("right", Vi), i.component("left", Wi), i.component("fullscreen-nav-button", Ji), i.component("geolocator-nav-button", Yi), i.component("home-nav-button", Xi), i.component("mapnav-button", $i), i.component("appbar-button", na), i.component("transition", de), i.component("transition-group", fe), i.config.globalProperties.$iApi = t, i.config.globalProperties.$pinia = n, i.config.idPrefix = `ramp-${e.id || Ls.sharedUtils.generateUUID()}`, i.provide("iApi", t), {
		element: i,
		app: i.mount(e),
		i18n: r.global
	};
...
var Qa = class e {
	...
	static async create(t) {
		let n = new e(t), r = t.layers.map((e) => {
			...
			if (e.layerType === B.TILE) return m.TileLayer(t);
			if (e.layerType === B.VECTORTILE) return m.VectorTileLayer(t);
			if (e.layerType === B.MAPIMAGE) return m.MapImageLayer(t);
			if (e.layerType === B.OSM) return m.OpenStreetMapLayer(t);
	...
	pointZoomScale;
	constructor(e, t = "") {
		super(e), this.esriMap = void 0, this._basemapStore = [], this._viewPromise = new X(), this.handlers = [], this.pointZoomScale = 5e4, this.name = t;
	}
	noMapErr() {
	...
	async createMap(e, t) {
		...
		}, r = e.basemaps.map((e) => Qa.create(e)), a = (await Promise.all(r)).filter((e) => (e.createErr && n(e), e.esriBasemap.baseLayers.length > 0));
		a.forEach((e) => {
		...
		let o = {};
		this.esriMap = O(await m.Map(o)), this.pointZoomScale = e.pointZoomScale && e.pointZoomScale > 0 ? e.pointZoomScale : 5e4, this._targetDiv = t, this.createMapView(e.initialBasemapId);
	}
	destroyMap() {
	...
	destroyMapView() {
		...
		this._viewPromise = new X(), this.created = !1, this.handlers.forEach((e) => e.handler.remove()), this.handlers = [], this.esriView.map = null, this.esriView.container = null, this.esriView.spatialReference = null, this.esriView.extent = null, this.esriView.navigation = null, this.esriView.destroy(), delete this.esriView;
	}
	async findBasemap(e) {
	...
	async applyBasemap(e) {
		...
		t.esriBasemap.id !== n && (this.esriMap.basemap = Ae(t.esriBasemap));
	}
	async setBasemap(e) {
	...
	async zoomMapTo(e, t, n = !0, r = 200, i = "ease") {
		if (this.esriView) {
			...
			a.type === z.POINT && (o.scale = t || this.pointZoomScale);
			let s = {
				animate: n,
				duration: r,
				easing: i
	...
	getExtent() {
		return this.esriView ? xt.fromESRI(this.esriView.extent) : (this.noMapErr(), xt.fromParams("i_am_error", 0, 1, 0, 1));
	}
	getExtentSet() {
		return this._rampExtentSet ? this._rampExtentSet : (this.noMapErr(), jt.fromConfig({
	...
	getSR() {
		return this._rampSR ? this._rampSR.clone() : (this.noMapErr(), J.latLongSR());
	}
	getPixelHeight() {
	...
	async checkAtCoord(e) {
		...
		if (n?.geomType != z.POLYGON && this.#e && this.#e.layerId === t.layerId && this.#e.oid === t.oid && this.#e.layerIdx === t.layerIdx) return;
		...
		this.maptipStore.maptipInstance.enable(), this.setPoint(this.$iApi.geo.map.screenPointToMapPoint(e)), this.$iApi.event.emit(Q.MAP_GRAPHICHIT, {
			layer: n,
			graphicHit: t,
	...
	constructor(e) {
		super(e, "overview"), this.overviewGraphicLayer = this.$iApi.geo.layer.createLayer({
			...
			cosmetic: !0,
			system: !0
		}), this.overviewmapStore = Ga(this.$vApp.$pinia);
	}
	async createMapView(e) {
		...
		this.esriView = O(await m.MapView({
			map: this.esriMap,
	...
	async addMapGraphicLayer() {
		...
		let e = new dt(this.$iApi.geo.map.getExtent(), "overview-graphic"), t = this.overviewmapStore.borderColour ?? "#FF0000", n = this.overviewmapStore.borderWidth ?? 1, r = this.overviewmapStore.areaColour ?? "#000000", i = this.overviewmapStore.areaOpacity ?? .25;
		e.style = new Et({
	...
	async mapDrag(e) {
		if (e.native.pointerType === "mouse") {
			if (e.action === "start") await this.cursorHitTest(e) && (this.startExtent = O(this.overviewGraphicLayer.getEsriGraphic("overview-graphic").geometry));
	...
	updateAttribution(e) {
		...
		if (e ? (e.text ? e.text.disabled ? n.text.disabled = !0 : n.text.value = e.text.value || t.value : n.text.value = t.value, Wt(this.$vApp.$pinia).setAttribution(n)) : n.text.value = t.value, !e || e.text?.disabled || !e.text) {
			...
			if (r) {
				...
				Promise.all(i).then((r) => {
					e = r.filter((e) => e?.copyright).map((e) => e.copyright).join(" | "), n.text.value = e || n.text.value || t.value, Wt(this.$vApp.$pinia).setAttribution(n);
				});
			}
		}
	}
	updateScale() {
		let e = Wt(this.$vApp.$pinia), t = e.scale;
	...
	async createMap(e, t) {
		this.setMapMouseThrottle(e.mapMouseThrottle ?? 0), this.trackFirstBasemap = !0, this.layerDefaultTimes.draw = e.layerTimeDefault?.expectedDrawTime ?? 12e3, this.layerDefaultTimes.load = e.layerTimeDefault?.expectedLoadTime ?? 12e3, this.layerDefaultTimes.fail = e.layerTimeDefault?.maxLoadTime || 9e4, await super.createMap(e, t), this.viewPromise.then(() => {
			this.$iApi.event.emit(Q.MAP_CREATED);
		});
	}
	destroyMap() {
		if (!this.esriMap || !this.esriView) {
		...
		this.$iApi.geo.layer.allLayersOnMap(!1).map((e) => e.uid).forEach((e) => this.removeLayer(e)), super.destroyMap(), this.$iApi.event.emit(Q.MAP_DESTROYED);
	}
	async createMapView(e) {
		let t = v(this.$vApp.$pinia).config.map;
		...
		this._rampExtentSet = jt.fromConfig(a), this._rampSR = this._rampExtentSet.sr.clone();
		...
		this.esriView = O(await m.MapView({
			...
			handler: i(() => this.esriView.extent, (e) => {
				if (e) {
					...
					this.$iApi.event.emit(Q.MAP_EXTENTCHANGE, t), this.$iApi.event.emit(Q.FILTER_CHANGE, {
						extent: t,
						filterKey: K.EXTENT
					});
				}
			...
			handler: i(() => this.esriView.scale, (e) => {
				this.$iApi.event.emit(Q.MAP_SCALECHANGE, e);
			})
		}), this.handlers.push({
			type: "resize",
			handler: this.esriView.on("resize", (e) => {
				this.$iApi.event.emit(Q.MAP_RESIZED, {
					height: e.height,
					width: e.width
				});
			})
			...
			handler: this.esriView.on("click", (e) => {
				this.$iApi.event.emit(Q.MAP_CLICK, this.$iApi.geo.geom.esriMapClickToRamp(e, "map_click_point"));
			})
		}), this.handlers.push({
			type: "double-click",
			handler: this.esriView.on("double-click", (e) => {
				this.$iApi.event.emit(Q.MAP_DOUBLECLICK, this.$iApi.geo.geom.esriMapClickToRamp(e, "map_doubleclick_point"));
			})
		}), this.handlers.push({
			type: "pointer-move",
			...
			handler: this.esriView.on("pointer-move", Le((e) => {
				this.$iApi.event.emit(Q.MAP_MOUSEMOVE_START, this.$iApi.geo.geom.esriMapMouseToRamp(e));
			}, 100, { edges: ["leading"] }))
		}), this.handlers.push({
			type: "pointer-move-end",
			handler: this.esriView.on("pointer-move", Le((e) => {
				this.$iApi.event.emit(Q.MAP_MOUSEMOVE_END, this.$iApi.geo.geom.esriMapMouseToRamp(e));
			}, 100))
		}), this.handlers.push({
			type: "pointer-leave",
			handler: this.esriView.on("pointer-leave", (e) => {
				setTimeout(() => {
					this.$iApi.event.emit(Q.MAP_MOUSELEAVE, e.native);
				}, Math.max(this.mapMouseThrottle, 100) + 1);
			})
		}), this.handlers.push({
			type: "pointer-down",
			handler: this.esriView.on("pointer-down", (e) => {
				this.$iApi.event.emit(Q.MAP_MOUSEDOWN, e.native);
			})
		}), this.handlers.push({
			type: "key-down",
			handler: this.esriView.on("key-down", (e) => {
				this.$iApi.event.emit(Q.MAP_KEYDOWN, e.native), e.stopPropagation();
			})
		}), this.handlers.push({
			type: "key-up",
			handler: this.esriView.on("key-up", (e) => {
				this.$iApi.event.emit(Q.MAP_KEYUP, e.native), e.stopPropagation();
			})
		}), this.handlers.push({
			type: "focus",
			handler: this.esriView.on("focus", (e) => {
				this.$iApi.event.emit(Q.MAP_FOCUS, e.native);
			})
		}), this.handlers.push({
			type: "blur",
			handler: this.esriView.on("blur", (e) => {
				this.$iApi.event.emit(Q.MAP_BLUR, e.native);
			})
	...
	async applyBasemap(e) {
		...
		let t = typeof e == "string" ? await this.findBasemap(e) : e;
		this.esriMap.basemap = Ae(t.esriBasemap);
	...
	async setBasemap(e) {
		...
		if (r) {
			...
			this._viewPromise = new X(), this.created = !1, this.$iApi.event.emit(Q.MAP_REFRESH_START), this.destroyMapView(), this.createMapView(n), await this.viewPromise.then(() => {
				this.$iApi.event.emit(Q.MAP_REFRESH_END), this.$iApi.event.emit(Q.MAP_BASEMAPCHANGE, {
					basemapId: e,
					schemaChanged: r
				});
			...
			let t = await m.ColorBackground({ color: new St(n.backgroundColour).toESRI() });
			this.esriView.background = t, this.$iApi.event.emit(Q.MAP_BASEMAPCHANGE, {
				basemapId: e,
				schemaChanged: r
			});
		}
	...
	addLayer(e, t = void 0) {
		return new Promise((n, r) => {
			if (this.esriMap || (this.noMapErr(), r()), e.initiationState !== W.INITIATING && e.initiationState !== W.INITIATED && e.layerState !== G.ERROR && e.initiate(), e.mapLayer && t === void 0) {
			...
			_(this.$vApp.$pinia).addLayer(e, t), this.$iApi.event.emit(Q.LAYER_REGISTERED, e);
			let i = Date.now(), a = 0, o = setInterval(() => {
				a += 250, a >= e.expectedTime.fail || e.layerState === G.ERROR ? (clearInterval(o), e.lastCancel < i && console.error(`Failed to add layer: ${e.id}.`), r()) : e.initiationState === W.INITIATED && (e.esriLayer || !e.mapLayer) && (clearInterval(o), e.mapLayer ? this.insertToEsriMap(e) : e.onLoad(), n());
			}, 250);
		});
	}
	insertToEsriMap(e) {
	...
	reorder(e, t, n = !1) {
		...
		if (a !== t) {
			...
			this.$iApi.event.emit(Q.MAP_REORDER, {
				layer: e,
				newIndex: t
			});
		}
	...
	removeSublayer(e) {
		...
		n.visibility = !1, n.isRemoved = !0, this.$iApi.event.emit(Q.LAYER_REMOVE, e), n.parentLayer?.sublayers.every((e) => e.isRemoved) && this.removeLayer(n.parentLayer);
	}
	removeLayer(e) {
		if (!this.esriMap) {
			this.noMapErr();
		...
		let t;
		if (t = e instanceof go ? e : this.$iApi.geo.layer.getLayer(e), !t) throw Error("Layer could not be found for removal.");
		if (t.isSublayer) {
		...
		n.removeLayer(t), n.removeLayerConfig(t.id), t.removeEsriLayer(), t.initiationState === W.INITIATED && t.terminate(), t.isRemoved = !0, this.$iApi.event.emit(Q.LAYER_REMOVE, t);
	}
	...
	createMouseMoveHandler() {
		...
		return Re((e) => {
			this.$iApi.event.emit(Q.MAP_MOUSEMOVE, this.$iApi.geo.geom.esriMapMouseToRamp(e));
	...
	screenPointToMapPoint(e) {
		return this.esriView ? Y.fromESRI(this.esriView.toMap({
			x: e.screenX,
			y: e.screenY
		}), "mappoint") : (this.noMapErr(), new Y("i_am_error", [0, 0], void 0, !0));
	}
	...
	runIdentify(e) {
		...
		r.type === z.POINT && t.some((e) => e.identifyMode === U.HYBRID || e.identifyMode === U.SYMBOLIC) && (i = this.symbolIdentify(n.screenX, n.screenY));
		let a = {
			geometry: r,
			hitTest: i
		...
		return this.$iApi.event.emit(Q.MAP_IDENTIFY, c), c;
	}
	async getGraphicAtCoord(e) {
		...
		let t = this.$iApi.geo.layer.allLayersOnMap(!1).filter((e) => e.supportsFeatures || e.layerType === B.GRAPHIC);
		...
		if (r.some((e) => {
			...
			if (n) {
				if (!(n.isCosmetic || n.layerType === B.GRAPHIC || e.graphic.isAggregate)) i = n, a = e.graphic.getObjectId();
...
var uo = class extends Z {
	async fetchFileData(e, t) {
		let n = await Ye.get(e, { responseType: "arrayBuffer" });
		switch (t) {
			case B.GEOJSON:
			case B.DATAJSON: return JSON.parse(this.arbToStr(n.data));
			case B.SHAPEFILE:
			case B.GEOJSONZIPPED:
			case B.FLATGEOBUF:
			case B.FLATGEOBUFZIPPED: return n.data;
			case B.CSV:
			case B.DATACSV: return this.arbToStr(n.data);
	...
	extractCsvFields(e, t = ",") {
		return $e.dsvFormat(t).parseRows(e)[0].map((e) => ({
			name: e,
			type: tt.STRING
		}));
	}
	filterCsvLatLonFields(e, t = ",") {
		let n = $e.dsvFormat(t).parseRows(e), r = n[0], i = {
		...
		return import("flatgeobuf").then(({ geojson: n }) => new Promise((r) => {
			...
			let c = 0, l = setInterval(() => {
				if (o && i) {
					clearInterval(l);
					let e;
					a && (a.code && a.code !== 4326 && a.org === "EPSG" ? e = new J(a.code) : a.wkt ? e = new J(a.wkt) : console.error("Encountered FlatGeobuf with non-EPSG org: ", a)), e && (o.crs = e.toGeoJSON()), r(o);
				} else c += 60, c > t && (clearInterval(l), r({}));
			}, 60);
		}));
	}
	inferType(e) {
		return typeof e == "number" ? tt.DOUBLE : tt.STRING;
	}
	...
	async loadWfsData(e, t = -1, n = 0, r = 1e3, i = {
		...
		let c = new Nt(e).updateQuery(s), [l, u] = await Xe(Ye.get(c, { signal: o }));
		...
		} else return a && i.features.length > 0 && i.features[0].geometry.type === H.POINT && i.features.forEach((e) => {
	...
	allActiveLayers() {
		return this.allLayers().filter((e) => e.layerState !== G.ERROR && e.initiationState === W.INITIATED);
	}
	allLayersOnMap(e = !0) {
		let t = this.allLayers().filter((e) => e.mapLayer && e.initiationState === W.INITIATED);
		if (e) {
	...
	allDataLayers() {
		return this.allLayers().filter((e) => !e.mapLayer && e.initiationState === W.INITIATED);
	}
	allErrorLayers() {
		return this.allLayers().filter((e) => e.layerState === G.ERROR);
	}
	allInitiatingLayers() {
		return this.allLayers().filter((e) => e.initiationState === W.INITIATING);
	}
	getLayerControls(e) {
		let t = this.getLayer(e);
		if (!t) return;
		...
		return t.supportsFeatures || r.push(q.Datatable), t.extent === void 0 && r.push(q.BoundaryZoom), (t.config?.metadata || (t.isSublayer ? t.parentLayer?.config?.metadata : {}) || {}).url || r.push(q.Metadata), !t.mapLayer && !t.config.controls?.includes(q.Settings) && r.push(q.Settings), r.forEach((e) => {
			let t = n?.indexOf(e) ?? -1;
			t !== -1 && n?.splice(t, 1);
		}), {
			controls: n,
	...
	async loadLayerMetadata(e) {
		...
		let [t, r] = await Xe(n(e, { query: { f: "json" } }));
	...
	_sublayers;
	constructor(e, t) {
		super(t), this.config = e, this.id = "", this.uid = "", this.name = "error", this.layerState = G.NEW, this.drawState = lt.NOT_LOADED, this.initiationState = W.NEW, this.layerIdx = -1, this.layerFormat = ct.UNKNOWN, this.layerType = B.UNKNOWN, this.dataFormat = V.UNKNOWN, this.supportsIdentify = !1, this.identifyMode = U.NONE, this.supportsFeatures = !1, this.mapLayer = !0, this.featureCount = 0, this.fields = [], this.fieldList = "", this.nameField = "", this.maptipField = "", this.oidField = "", this.supportsSublayers = !1, this.isSublayer = !1, this.isRemoved = !1, this.isFile = !1, this.isCosmetic = !1, this.isSystem = !1, this.userAdded = !1, this.identify = !1, this.maptips = !1, this.geomType = z.UNKNOWN, this.legend = [], this._sublayers = [], this.expectedTime = {
			draw: 0,
			load: 0,
			fail: 0
	...
	getLayerTree() {
		return new Ot(0, "Fake tree", "getLayerTree() was not implemented in layer");
	}
	getSR() {
		return J.latLongSR();
	}
	...
	getGraphic(e, t) {
		return Promise.resolve(new dt(new pt()));
	}
	getIcon(e) {
		return Promise.resolve("");
	}
	...
	constructor(e, t) {
		super(e, t), this.name = e.name || "", this.geomType = z.NONE, this.dataFormat = V.UNKNOWN, this.layerType = B.UNKNOWN, this.layerFormat = ct.UNKNOWN;
		...
		this.expectedTime.draw = e.expectedDrawTime ?? n.draw, this.expectedTime.load = e.expectedLoadTime ?? n.load, this.expectedTime.fail = e.maxLoadTime || n.fail, this.lastCancel = 0, this.timers = {
			draw: void 0,
			load: void 0
		}, this.origRampConfig = e, this.id = e.id || "", this.uid = this.$iApi.geo.shared.generateUUID(), this.isCosmetic = !1, this.isSystem = e.system || !1, this.isRemoved = !1, this.isSublayer = !1, this.supportsIdentify = !1, this.mapLayer = !0, this.identifyMode = U.NONE, this.supportsFeatures = !1, this.maptips = !1, this.supportsSublayers = !1, this.isFile = !1, this.layerState = G.NEW, this.initiationState = W.NEW, this.drawState = lt.NOT_LOADED, this.loadDefProm = new X(), this.url = this.origRampConfig.url, this.canReload = !!(this.url || this.origRampConfig.caching), this.loadPromDone = !1, this.nameArcadeFormula = "", this.maptipArcadeFormula = "", this.layerTree = new Ot(0, this.uid, this.name, !0);
	}
	updateInitiationState(e) {
		this.initiationState = e, this.$iApi.event.emit(Q.LAYER_INITIATIONSTATECHANGE, {
			state: e,
			layer: this
		});
	}
	updateLayerState(e, t = !1) {
		this.layerState = e, this.$iApi.event.emit(Q.LAYER_LAYERSTATECHANGE, {
			state: e,
			layer: this,
			userCancel: t
		});
	...
	updateDrawState(e) {
		this.drawState = e, e === lt.REFRESH ? this.startTimer(_o.DRAW) : e === lt.UP_TO_DATE && this.stopTimer(_o.DRAW), this.$iApi.event.emit(Q.LAYER_DRAWSTATECHANGE, {
			state: e,
			layer: this
		});
	}
	async initiate() {
		this.updateInitiationState(W.INITIATING), this.startTimer(_o.LOAD);
		let e = (e) => {
			this.layerState !== G.ERROR && (console.error(e), this.onError());
		}, t = Date.now(), n = setTimeout(() => {
			t > this.lastCancel && (this.lastCancel = Date.now(), e("Layer timed out during initialize. Id: " + this.id));
		}, this.expectedTime.fail), [r] = await Xe(this.onInitiate());
		clearTimeout(n), t > this.lastCancel && (this.drawState !== lt.UP_TO_DATE && this.startTimer(_o.DRAW), r ? e(`Init error on layer id: ${this.id} . ${r.message}`) : this.updateInitiationState(W.INITIATED));
	}
	async onInitiate() {
		if (this.isSublayer) return console.warn("Attempted to initiate a sublayer as a CommonLayer"), Promise.resolve();
		this.initiationState === W.INITIATED && console.error(`Encountered layer initialize while already initiated, layer id ${this.id}`);
	}
	async terminate() {
		this.updateInitiationState(W.TERMINATING), await Promise.all(this.sublayers.map((e) => e.terminate())), this.loadDefProm = new X(), this.loadPromDone = !1, this.updateLayerState(G.NEW), this.updateDrawState(lt.NOT_LOADED), this.updateInitiationState(W.TERMINATED);
	}
	onLoad() {
		...
		try {
			...
			Promise.all(r).then(() => {
				clearTimeout(n), t ? this.visibility = !1 : (this.stopTimer(_o.LOAD), e > this.lastCancel && (this.loadPromDone && (this.loadDefProm = new X()), this.loadDefProm.resolveMe(), this.loadPromDone = !0, this.sublayers.forEach((e) => e.onLoad()), this.updateLayerState(G.LOADED)));
			}).catch(() => {
	...
	onError(e = !0) {
		this.layerState !== G.ERROR && (this.initiationState === W.INITIATING && this.updateInitiationState(W.NEW), this.loadPromDone && (this.loadDefProm = new X()), this.loadDefProm.rejectMe(), this.loadPromDone = !0, this.sublayers.forEach((t) => t.onError(e)), e && this.$iApi.notify.show(_n.ERROR, this.$iApi.$i18n.t("layer.error", { id: this.id })), this.stopTimer(_o.DRAW), this.stopTimer(_o.LOAD), this.updateLayerState(G.ERROR, !e));
	}
	onLoadActions() {
		return [];
	}
	cancelLoad() {
		this.isLoaded || this.initiationState === W.NEW || this.initiationState === W.TERMINATING || this.initiationState === W.TERMINATED || (this.lastCancel = Date.now(), this.esriLayer && this.esriLayer.loadStatus === "loading" && this.esriLayer.cancelLoad(), this.removeEsriLayer(), this.onError(!1));
	}
	loadPromise() {
		return this.loadDefProm.getPromise();
	}
	get isLoaded() {
		return this.layerState === G.LOADED;
	}
	canIdentify() {
	...
	getGraphic(e, t) {
		return this.stubError(), Promise.resolve(new dt(new pt()));
	}
	getIcon(e) {
		return this.stubError(), Promise.resolve("");
	}
	...
	esriWatches;
	constructor(e, t) {
		super(e, t), this._scaleSet = new kt(), this._mouseTolerance = e.mouseTolerance == null ? 5 : e.mouseTolerance, this._touchTolerance = e.touchTolerance == null ? 15 : e.touchTolerance, this._drawOrder = [], this._serverVisibility = void 0, this.isCosmetic = e.cosmetic || !1, this.extent = e.extent ? xt.fromConfig(`${this.id}_extent`, e.extent) : void 0, this.viewDefProm = new X(), this.esriWatches = [];
	}
	noLayerErr() {
	...
	async onInitiate() {
		...
		this.esriWatches.push(i(() => this.esriLayer.visible, (e) => {
			this.$iApi.event.emit(Q.LAYER_VISIBILITYCHANGE, {
				visibility: e,
				layer: this
			});
		})), this.esriWatches.push(i(() => this.esriLayer.opacity, (e) => {
			this.$iApi.event.emit(Q.LAYER_OPACITYCHANGE, {
				opacity: e,
				layer: this
			});
		})), this.esriWatches.push(i(() => this.esriLayer.loadStatus, (e) => {
			let t = {
				"not-loaded": G.LOADING,
				loading: G.LOADING,
				loaded: G.LOADED,
				failed: G.ERROR
			};
			...
			this.esriView = O(e.layerView), this.esriWatches.push(i(() => e.layerView.updating, (e) => {
				this.updateDrawState(e ? lt.REFRESH : lt.UP_TO_DATE);
			})), this.viewDefProm.resolveMe();
		}), this.sublayers.forEach((e) => e.initiate());
	}
	async terminate() {
		this.esriWatches.forEach((e) => e.remove()), this.esriWatches = [], this.esriLayer = void 0, await super.terminate(), this.viewDefProm = new X();
	}
	async reload() {
		if (!this.$iApi.geo.map.esriMap) {
		...
		let e = Date.now();
		if (this.$iApi.event.emit(Q.LAYER_RELOAD_START, this), this.sublayers.forEach((e) => this.$iApi.event.emit(Q.LAYER_RELOAD_START, e)), await this.terminate(), await this.initiate(), !(this.lastCancel > e)) {
			if (!this.esriLayer) {
				console.error("ESRI layer failed to re-create during reload.");
				return;
			}
			this.$iApi.geo.map.insertToEsriMap(this), this.$iApi.event.emit(Q.LAYER_RELOAD_END, this), this.sublayers.forEach((e) => this.$iApi.event.emit(Q.LAYER_RELOAD_END, e));
		}
	}
	...
	zoomToLayerBoundary() {
		...
		if (this.mapCheck()) {
			if (this.extent.xmin === this.extent.xmax && this.extent.ymin === this.extent.ymax) {
				let e = new Y("point", [this.extent.xmin, this.extent.ymin], this.extent.sr);
	...
	get layerExists() {
		return this.initiationState === W.INITIATED && !!this.esriLayer;
	}
	get drawOrder() {
	...
	getSR() {
		return this.esriLayer ? J.fromESRI(this.esriLayer.spatialReference) : (this.noLayerErr(), J.latLongSR());
	}
}, bo = class extends yo {
	attribs;
	renderer;
	...
	filter;
	constructor(e, t) {
		super(e, t), this.supportsIdentify = !0, this.geomType = z.UNKNOWN, this.serviceUrl = "", this.fieldList = "", this.canModifyLayer = !0, this.filter = new At(e.permanentFilteredQuery || "", e.initialFilteredQuery || ""), e.state?.hovertips !== void 0 && console.warn("hovertips layer configuration property is deprecated. Please adjust to use maptips instead"), this.maptips = e.state?.maptips ?? e.state?.hovertips ?? !0, this.attribs = new qo();
	}
	makeEsriLayerConfig(e) {
	...
	async loadLayerMetadata(e = {}) {
		...
		if (!(t < this.lastCancel)) if (this.geomType = n.geometryType, this.attribs.quickCache = new $o(this.geomType), this.scaleSet.minScale = n.minScale, this.scaleSet.maxScale = n.maxScale, this.dataFormat = n.dataFormat, this.extent = this.extent ?? n.extent, this._serverVisibility = n.defaultVisibility, this.origRampConfig.name || (this.name = n.name ?? this.id), this.dataFormat === V.ESRI_FEATURE) {
			this.supportsFeatures = !0, this.canModifyLayer = this.layerType === B.SUBLAYER ? n.canModifyLayer : !0, this.fields = n.fields, this.nameField = n.displayField, this.oidField = n.objectIdField, this.sourceSR = n.sourceSR, this.drawOrder.forEach((e) => {
			...
			let r = {
				...
				batchSize: -1,
				attribs: "*",
				permanentFilter: this.getSqlFilter(K.PERMANENT)
			};
	...
	async getGraphic(e, t) {
		let n = {}, r = new pt(), i = this.$iApi.geo.map, a = !1, o = !1, s = 0;
		...
		if (t.getGeom) {
			...
			if (n) r = n;
			else if (this.layerType === B.FEATURE && !(this.attribs.quickCache.isPoint && t.forZoom)) {
		...
		let c = new dt(r, "", t.getAttribs ? n : void 0);
		if (t.getStyle) {
			let e = Ae(this.renderer.getGraphicSymbol(n));
	...
	setSqlFilter(e, t) {
		if (t !== this.filter.getSql(e)) if (this.filter.setSql(e, t), this.$iApi.event.emit(Q.FILTER_CHANGE, {
			uid: this.uid,
			filterKey: e
		}), this.layerFormat === ct.MAPIMAGE) this.applySqlFilter();
		else {
			let n = `${this.uid}-${e}-${t}`;
	...
	constructor(e, t) {
		super(e, t), this.dataFormat = V.ESRI_FEATURE, this.layerFormat = ct.GRAPHIC, this.maptips = !1;
	}
	_graphics = [];
	makeEsriLayerConfig(e) {
		return super.makeEsriLayerConfig(e);
	...
	async addGraphic(e) {
		...
		let n = t.filter((e) => this._graphics.findIndex((t) => t.id === e.id) === -1 ? (this._graphics.push(e), !0) : (console.error(`Attempting to add graphic with id '${e.id}' that has already been added.`), !1)), r = this.$iApi.geo.map.getSR(), i = n.map((e) => this.$iApi.geo.proj.projectGeometry(r, e.geometry)), a = await Promise.all(i), o = n.map((e, t) => {
			let n = new dt(a[t], e.id, e.attributes);
	...
	constructor(e, t) {
		super(e, t), this.layerType = B.GRAPHIC;
	}
	async onInitiate() {
		this.esriLayer = O(await m.GraphicsLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
	}
	makeEsriLayerConfig(e) {
		return super.makeEsriLayerConfig(e);
	}
	onLoadActions() {
		let e = super.onLoadActions();
		return this.layerTree.name = this.name, this.updateDrawState(lt.UP_TO_DATE), e;
	}
}, Co = class extends bo {
	esriJson;
	sourceGeoJson;
	constructor(e, t) {
		super(e, t), this.supportsIdentify = !0, this.isFile = !0, this.dataFormat = V.ESRI_FEATURE, this.layerFormat = ct.FEATURE, this.layerIdx = 0, e.identifyMode && e.identifyMode !== U.NONE ? this.identifyMode = e.identifyMode : this.identifyMode = U.HYBRID;
	}
	async reload() {
	...
	async onInitiate() {
		...
		this.esriJson = await this.$iApi.geo.layer.files.geoJsonToEsriJson(this.sourceGeoJson, e), this.esriLayer = O(await m.FeatureLayer(this.makeEsriLayerConfig(this.origRampConfig))), this.esriJson = void 0, this.origRampConfig.caching || delete this.origRampConfig.rawData, delete this.sourceGeoJson, await super.onInitiate();
	}
	makeEsriLayerConfig(e) {
	...
	runIdentify(e) {
		...
		if (this.identifyMode === U.HYBRID || this.identifyMode === U.GEOMETRIC) {
			let t = { includeGeometry: !1 };
			this.geomType !== z.POLYGON && e.geometry.type === z.POINT ? t.filterGeometry = this.$iApi.geo.query.makeClickBuffer(e.geometry, e.tolerance) : t.filterGeometry = e.geometry, t.filterSql = this.getCombinedSqlFilter(), i = this.queryFeatures(t).then((e) => {
				a = e;
			});
		}
		return e.hitTest && (this.identifyMode === U.HYBRID || this.identifyMode === U.SYMBOLIC) && (r = i.then(async () => {
			...
			a.forEach((e) => {
				n.items.push(mo.makeRawItem(ut.ESRI, e.attributes));
			}), o.forEach((e) => {
	...
	extractLayerMetadata() {
		...
		this.supportsFeatures = !0, this.geomType = this.$iApi.geo.geom.clientGeomTypeToRampGeomType(e.geometryType), this.scaleSet.minScale = e.minScale || 0, this.scaleSet.maxScale = e.maxScale || 0, this.extent = this.extent ?? xt.fromESRI(e.fullExtent, this.id + "_extent");
		let t = O(e.fields.slice());
		this.fields = t.map((e) => ({
			name: e.name,
			alias: e.alias,
			type: e.type,
		...
		this.attribs.attLoader = new Zo(this.$iApi, n);
	}
	async getGraphic(e, t) {
		let n;
		if (!t.getGeom && this.attribs.attLoader.isLoaded()) {
			let t = await this.attribs.attLoader.getAttribs();
			n = new dt(new pt(), "", t.features[t.oidIndex[e]]);
		} else {
			let r = {
				filterOIDs: [e],
		...
		if (t.getStyle) {
			let e = Ae(this.renderer.getGraphicSymbol(n.attributes));
	...
	applySqlFilter(e = []) {
		...
		m.FeatureFilter({ where: t }).then((e) => {
			Ae(this.esriView).filter = e;
		});
	}
}, wo = class extends Co {
	constructor(e, t) {
		super(e, t), this.layerType = B.GEOJSON;
	}
	async onInitiate() {
		let e, t = Date.now();
	...
	constructor(e, t) {
		super(e, t), this.layerType = B.SHAPEFILE;
	}
	async onInitiate() {
	...
	constructor(e, t) {
		super(e, t), this.layerType = B.CSV;
	}
	async onInitiate() {
	...
	constructor(e, t) {
		super(e, t), this.layerType = B.GEOJSONZIPPED;
	}
	async onInitiate() {
		let e = Date.now(), t = await this.$iApi.geo.layer.files.binaryInitHelper(this.origRampConfig);
		if (e > this.lastCancel) {
	...
	constructor(e, t) {
		super(e, t), this.layerType = B.FLATGEOBUF;
	}
	async onInitiate() {
		let e = Date.now(), t = await this.$iApi.geo.layer.files.binaryInitHelper(this.origRampConfig);
		if (e > this.lastCancel) {
	...
	constructor(e, t) {
		super(e, t), this.layerType = B.FLATGEOBUFZIPPED;
	}
	async onInitiate() {
		let e = Date.now(), t = await this.$iApi.geo.layer.files.binaryInitHelper(this.origRampConfig);
		if (e > this.lastCancel) {
	...
	constructor(e, t) {
		super(e, t), this.dataFormat = V.ESRI_FEATURE, this.supportsIdentify = !0, this.layerType = B.FEATURE, this.layerFormat = ct.FEATURE, e.identifyMode && e.identifyMode !== U.NONE ? this.identifyMode = e.identifyMode : this.identifyMode = U.HYBRID;
	}
	async onInitiate() {
		O(this.esriLayer = await m.FeatureLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
	}
	makeEsriLayerConfig(e) {
	...
	onLoadActions() {
		...
		}, a = this.$iApi.geo.layer.loadFeatureCount(this.serviceUrl, this.getSqlFilter(K.PERMANENT)).then((t) => {
	...
	runIdentify(e) {
		...
		if (this.identifyMode === U.HYBRID || this.identifyMode === U.GEOMETRIC) {
			...
			this.geomType !== z.POLYGON && e.geometry.type === z.POINT ? t.filterGeometry = this.$iApi.geo.query.makeClickBuffer(e.geometry, e.tolerance) : t.filterGeometry = e.geometry, t.filterSql = this.getCombinedSqlFilter(), i = this.queryOIDs(t).then((e) => {
				a = e;
			});
		}
		return e.hitTest && (this.identifyMode === U.HYBRID || this.identifyMode === U.SYMBOLIC) && (r = i.then(async () => {
	...
	async getGraphicExtent(e) {
		...
		else if (this.geomType === z.POINT) console.error(`Attempted to query extent for invalid geometry type ${this.geomType}.`);
		else {
			let n = this.attribs.quickCache.getExtent(e);
			if (n) t = n;
			else {
				let [n, r] = await Xe(this.esriLayer.queryExtent({
					objectIds: [e],
					outSpatialReference: this.$iApi.geo.map.getSR().toESRI()
				}));
				!n && r.extent && (t = xt.fromESRI(r.extent), this.attribs.quickCache.setExtent(e, t));
			}
		}
		return t;
	}
	...
	async zoomToFeature(e) {
		let t;
		return this.geomType !== z.POINT && (t = this.attribs.quickCache.getAnyScaleGeom(e), t || (t = await this.getLocalGeometry(e), t ? this.geomType !== z.MULTIPOINT && this.attribs.quickCache.setGeom(e, t, this.$iApi.geo.map.getScale()) : t = await this.getGraphicExtent(e))), t && !t.invalid() ? (await this.$iApi.geo.map.zoomMapTo(t), !0) : await super.zoomToFeature(e);
	}
}, jo = class extends yo {
	isDynamic;
	origState;
	constructor(e, t) {
		super(e, t), this.supportsIdentify = !0, this.supportsSublayers = !0, this.layerType = B.MAPIMAGE, this.layerFormat = ct.MAPIMAGE, this.isDynamic = !1, this.maptips = !1, this.layerTree.layerIdx = -1, this.identifyMode = U.GEOMETRIC;
	}
	actualViz = !1;
	get visibility() {
	...
	set visibility(e) {
		...
		if (e || Mo(this, "1=2"), this.actualViz = e, e && !this.esriLayer.visible) this.esriLayer.visible = !0;
			...
			e = this.$iApi.event.on(Q.LAYER_DRAWSTATECHANGE, (n) => {
				n.layer.id === this.id && n.state === lt.UP_TO_DATE && (clearTimeout(t), this.$iApi.event.off(e), this.actualViz || (this.esriLayer.visible = !1, Mo(this, "")));
			});
		}
		e && Mo(this, "");
	}
	async onInitiate() {
		this.esriLayer = O(await m.MapImageLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
	}
	makeEsriLayerConfig(e) {
		let t = super.makeEsriLayerConfig(e);
	...
	onLoadActions() {
		...
		this.isDynamic = this.esriLayer.capabilities.exportMap.supportsDynamicLayers, this.extent = this.extent ?? xt.fromESRI(this.esriLayer.fullExtent, this.id + "_extent");
		let n = (e) => {
		...
		let a = [], o = (e, t) => {
			...
			if (e.sublayers && e.sublayers.length > 0) {
				let r = new Ot(n, "", (s ? s.name : "") || e.title || "", !1);
		...
		let s = a.map(async (e) => {
			...
			if (s ? (e.visibility = e.isRemoved ? !1 : s.state?.visibility ?? (this.origState.visibility ? e._serverVisibility ?? this.origState.visibility : this.origState.visibility ?? e._serverVisibility) ?? !0, e.opacity = s.state?.opacity ?? this.origState.opacity ?? 1, this.$iApi.geo.attributes.applyFieldMetadata(e, s.fieldMetadata), e.canModifyLayer || this.$iApi.notify.show(_n.WARNING, this.$iApi.$i18n.t("layer.filtersdisabled", { name: e.name || e.id }))) : this.$iApi.geo.attributes.applyFieldMetadata(e), e.supportsFeatures) {
				...
				let n = await this.$iApi.geo.layer.loadFeatureCount(e.serviceUrl, e.getSqlFilter(K.PERMANENT));
				t > this.lastCancel && (e.featureCount = n);
			}
		});
		return e.push(...s), this.esriLayer.allSublayers.forEach((e) => {
	...
	runIdentify(e) {
		...
		if (t.length === 0) return [];
		let n;
		return e.geometry.type === z.POINT && (n = this.$iApi.geo.query.makeClickBuffer(e.geometry, e.tolerance)), t.map((t) => {
			let r = new X(), i = {}, a = Te({
				items: [],
			...
			return t.geomType !== z.POLYGON && n ? i.filterGeometry = n : i.filterGeometry = e.geometry, i.filterSql = t.getCombinedSqlFilter(), i.sourceSR = t.sourceSR, t.queryOIDs(i).then((e) => {
				e.forEach((e) => {
	...
	e.sublayers.forEach((e) => {
		e.layerExists && e.canModifyLayer && e.setSqlFilter(K.MIL_FLICKER_ERASER, t);
	});
}, No = class extends bo {
	constructor(e, t, n) {
		if (super(e, t), this.layerType = B.SUBLAYER, this.layerFormat = ct.MAPIMAGE, this.isSublayer = !0, this.layerIdx = e.index, this.parentLayer = n, this.isSystem = n.isSystem, this.dataFormat = V.ESRI_FEATURE, this.supportsFeatures = !0, this.maptips = !1, this.url = this.parentLayer?.url, this.canReload = !!(this.url || this.origRampConfig.caching), !n.esriLayer) throw Error("Map Image Layer with no internal esri layer encountered in sublayer creation");
	...
	fetchEsriSublayer(e) {
		...
		this.esriSubLayer = O(e.esriLayer.allSublayers.find((e) => e.id === this.layerIdx));
	}
	onLoadActions() {
	...
	async onInitiate() {
		this.initiationState = W.INITIATED;
	...
	get layerExists() {
		return !!(this.parentLayer?.layerExists && this.esriSubLayer && this.initiationState === W.INITIATED);
	}
	get visibility() {
	...
	getSR() {
		if (this.parentLayer?.esriLayer) {
			...
			return e ? J.fromESRI(e) : J.latLongSR();
		} else return this.noLayerErr(), J.latLongSR();
	}
	updateFieldList() {
	...
	constructor(e, t) {
		super(e, t), this.supportsIdentify = !1, this.layerType = B.OSM, this.layerFormat = ct.OSM, this.dataFormat = V.OSM_TILE, this.supportsFeatures = !1;
	}
	async onInitiate() {
		this.esriLayer = O(await m.OpenStreetMapLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
	}
	makeEsriLayerConfig(e) {
		return super.makeEsriLayerConfig(e);
	}
	...
	constructor(e, t) {
		super(e, t), this.supportsIdentify = !1, this.layerType = B.IMAGERY, this.layerFormat = ct.IMAGERY, this.dataFormat = V.ESRI_RASTER;
	}
	async onInitiate() {
		this.esriLayer = O(await m.ImageryLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
	}
	makeEsriLayerConfig(e) {
		return super.makeEsriLayerConfig(e);
	}
	...
	schemaLocked = !0;
	constructor(e, t) {
		super(e, t), this.supportsIdentify = !1, this.dataFormat = V.ESRI_TILE;
	}
	onLoadActions() {
		let e = super.onLoadActions();
	...
	async checkProj() {
		...
		if (this.layerState === G.LOADED && !t) n(), this.onError(), this.updateDrawState(lt.NOT_LOADED);
		else if (this.layerState === G.ERROR && t) this.reload();
		else if (this.layerState !== G.ERROR && !t) return n(), Promise.reject();
	}
}, Lo = class extends Io {
	constructor(e, t) {
		super(e, t), this.layerType = B.IMAGERYTILE, this.layerFormat = ct.IMAGERYTILE, this.schemaLocked = !1;
	}
	async onInitiate() {
		this.esriLayer = O(await m.ImageryTileLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
	}
	makeEsriLayerConfig(e) {
		return super.makeEsriLayerConfig(e);
	}
	...
	constructor(e, t) {
		super(e, t), this.layerType = B.TILE, this.layerFormat = ct.TILE;
	}
	async onInitiate() {
		this.esriLayer = O(await m.TileLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
	}
	makeEsriLayerConfig(e) {
		return super.makeEsriLayerConfig(e);
	}
	...
	constructor(e, t) {
		super(e, t), this.layerType = B.VECTORTILE, this.layerFormat = ct.VECTORTILE;
	}
	async onInitiate() {
		this.esriLayer = O(await m.VectorTileLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
	}
	makeEsriLayerConfig(e) {
		return super.makeEsriLayerConfig(e);
	}
	...
	mimeType;
	constructor(e, t) {
		super(e, t), this.supportsIdentify = !0, this.layerType = B.WMS, this.layerFormat = ct.WMS, this.mimeType = e.featureInfoMimeType || "", this.sublayerNames = [], this.dataFormat = V.OGC_RASTER, this.identifyMode = U.GEOMETRIC;
	}
	async onInitiate() {
		this.esriLayer = O(await m.WMSLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
	}
	makeEsriLayerConfig(e) {
	...
	runIdentify(e) {
		if (e.geometry.type !== z.POINT || !this.canIdentify()) return [];
		let t = new X(), n = Te({
			items: [],
			loading: t.getPromise(),
			loaded: !1,
		...
		return this.getFeatureInfo(this.sublayerNames, e.geometry, this.mimeType).then((e) => {
			if (e) {
				let t = !0, r;
				typeof e == "string" ? e.indexOf("Search returned no results") === -1 && e !== "" ? r = ut.TEXT : (t = !1, r = ut.UNKNOWN) : r = ut.JSON, t && n.items.push(mo.makeRawItem(r, e));
			}
			n.loaded = !0, t.resolveMe();
		}).catch(() => {
			n.errored = !0, t.resolveMe();
	...
	constructor(e, t) {
		super(e, t), this.layerType = B.WFS;
	}
	async onInitiate() {
		let e = Date.now(), { offset: t, limit: n } = new Nt(this.config.url).queryMap, r = await this.$iApi.geo.layer.ogc.loadWfsData(this.config.url, -1, parseInt(t) || 0, parseInt(n) || 1e3, void 0, this.config.xyInAttribs);
	...
	_visibility;
	constructor(e, t) {
		super(e, t), this.dataFormat = V.ESRI_FEATURE, this.layerFormat = ct.NOLAYER, this.drawState = lt.NOT_VISUAL, this.attribs = new qo(), this.supportsFeatures = !0, this.mapLayer = !1, this.isFile = !1, this._visibility = e.state?.visibility ?? !0, this.expectedTime.draw = 0;
	}
	async onInitiate() {
		if (this.sourceJson) {
	...
	async reload() {
		this.$iApi.event.emit(Q.LAYER_RELOAD_START, this), await this.terminate(), await this.initiate(), this.layerState !== G.ERROR && this.onLoad(), setTimeout(() => {
			this.$iApi.event.emit(Q.LAYER_RELOAD_END, this);
		}, 300);
	}
	onLoadActions() {
		let e = super.onLoadActions();
	...
	set visibility(e) {
		this._visibility !== e && (this._visibility = e, this.$iApi.event.emit(Q.LAYER_VISIBILITYCHANGE, {
			visibility: e,
			layer: this
		}));
	}
	...
	constructor(e, t) {
		super(e, t), this.layerType = B.DATAJSON;
	}
	async onInitiate() {
		let e = Date.now(), t;
	...
	serviceUrl;
	constructor(e, t) {
		super(e, t), this.layerType = B.DATATABLE, this.serviceUrl = e.url, this.filter = new At(e.permanentFilteredQuery || "", e.initialFilteredQuery || "");
	}
	async onInitiate() {}
	onLoadActions() {
		...
		}), i = this.$iApi.geo.layer.loadFeatureCount(this.serviceUrl, this.getSqlFilter(K.PERMANENT)).then((e) => {
	...
	setSqlFilter(e, t) {
		t !== this.filter.getSql(e) && (this.filter.setSql(e, t), this.$iApi.event.emit(Q.FILTER_CHANGE, {
			uid: this.uid,
			filterKey: e
		}));
	}
	...
	async arcGisBatchLoad(e, t) {
		...
		let r = e.permanentFilter ? ` AND ${e.permanentFilter}` : "", i = { query: {
			...
			f: "json"
		} }, [a, o] = await Xe(n(e.serviceUrl + "/query", i));
	...
	async loadGraphicsAttributes(e, t) {
		...
		let n = {
			features: e.sourceGraphics.map((e) => Ae(e).attributes).toArray(),
			oidIndex: {}
		};
	...
	async loadSingleFeature(e) {
		...
		let [r, i] = await Xe(n(e.serviceUrl + "/query", t));
	...
	async generateTabularAttributesWorker(e, t) {
		if (e.dataFormat === V.ESRI_RASTER) throw Error("Attempting to get attributes on a raster layer.");
		...
		let r = e.fields.filter((e) => Object.prototype.hasOwnProperty.call(n.features[0], Ae(e).name)).map((e) => ({
			data: Ae(e).name,
			title: Ae(e).alias || Ae(e).name
		})), i = n.features.map((t) => {
			let n = ie({}, t);
	...
	isPoint;
	constructor(e) {
		this.attribs = {}, this.geoms = {}, this.extents = {}, this.isPoint = e === z.POINT || e === z.MULTIPOINT;
	}
	getScaleStore(e) {
	...
	falseRenderer;
	constructor(e, t, n = !1) {
		this.innerRenderer = e, this.symbolUnits = [], this.falseRenderer = n, this.type = st.Unknown;
	}
	makeSearchParams(e) {
		return e;
	}
	...
	keyFields;
	constructor(e, t, n = !1) {
		super(e, t, n), this.type = st.Unique, this.delim = e.fieldDelimiter || ", ";
		let r = (e) => e.replace(/'/g, "''");
		this.keyFields = [
			e.field,
			e.field2,
	...
	async generateWMSSymbology(e) {
		let t = et(document.createElement("div")).size(this.CONTAINER_SIZE, this.CONTAINER_SIZE).viewbox(0, 0, 0, 0), n = {
			svgcode: "",
			imgHeight: "",
			imgWidth: ""
		};
	...
	async renderSymbologyIcon(e, t = null) {
		if (t === null) {
			...
			e.setAttribute("style", "opacity:0;position:fixed;left:100%;top:100%;overflow:hidden"), document.body.appendChild(e), t = et(e).size(this.CONTAINER_SIZE, this.CONTAINER_SIZE).viewbox(0, 0, this.CONTAINER_SIZE, this.CONTAINER_SIZE);
		}
	...
	generatePlaceholderSymbology(e, t = "#000") {
		let n = et(document.createElement("div")).size(this.CONTAINER_SIZE, this.CONTAINER_SIZE).viewbox(0, 0, this.CONTAINER_SIZE, this.CONTAINER_SIZE);
	...
	async symbolToSvg(e) {
		...
		let i = et(r).size(this.CONTAINER_SIZE, this.CONTAINER_SIZE).viewbox(0, 0, this.CONTAINER_SIZE, this.CONTAINER_SIZE), a = {
			path({ size: e, path: t }) {
			...
			[rt.DASH]: "5.333,4",
			[rt.DOT]: "1.333,4",
			[rt.DASHDOT]: "5.333,4,1.333,4",
			[rt.LONGDASH]: "10.666,4",
			[rt.LONGDASHDOT]: "10.666,4,1.333,4",
			[rt.LONGDASHDOTDOT]: "10.666,4,1.333,4,1.333,4",
			[rt.SHORTDOT]: "1.333,1.333",
			[rt.SHORTDASH]: "5.333,1.333",
			[rt.SHORTDASHDOT]: "5.333,1.333,1.333,1.333",
			[rt.SHORTDASHDOTDOT]: "5.333,1.333,1.333,1.333,1.333,1.333"
		}, s = {
			color: "#000",
			opacity: 1,
			width: 1,
	...
	async getMapServerLegend(e) {
		...
		let t = { query: { f: "json" } }, r = { layers: [] }, [i, a] = await Xe(n(`${e}/legend`, t));
	...
	async geoJsonQuery(e) {
		...
		return (await e.layer.esriLayer.queryFeatures(t)).features.map((e, n) => {
			let r;
			return r = t.returnGeometry ? this.$iApi.geo.geom.geomEsriToRamp(e.geometry, `queryResult${n}`) : new pt(), new dt(r, "", e.attributes);
		});
	}
	async queryGeometryHelper(e, t, n, r) {
		return !t && e.type === z.EXTENT && r && !r.isEqual(e.sr) && !(n && n > 2e7 && e.sr.wkid === 3978 && r.wkid === 4326) ? (await this.$iApi.geo.proj.projectExtent(r, e)).toESRI() : e.toESRI();
	}
	makeClickBuffer(e, t = 5) {
		let n = this.$iApi.geo.map, r = n.getExtent(), i = t * (r.xmax - r.xmin) / n.getPixelWidth();
		return new xt("ze_buffer", [e.x - i, e.y - i], [e.x + i, e.y + i], e.sr);
	}
}, ls = class extends Z {
	attributes;
	geom;
	...
	symbology;
	constructor(e) {
		super(e), this.geom = Ls.geom, this.proj = Ls.proj, this.shared = Ls.sharedUtils, this.map = new ro(e), this.layer = new ho(e), this.attributes = new Ko(e), this.query = new cs(e), this.symbology = new ss(e), Array.isArray(p.request.interceptors) || (p.request.interceptors = []), p.request.interceptors.push({ before: (e) => {
	...
	"../fixtures/appbar/index.ts": () => import("./appbar-tRTCqPEm.js"),
	"../fixtures/areas-of-interest/index.ts": () => import("./areas-of-interest-mBFt6c9S.js"),
	"../fixtures/basemap/index.ts": () => import("./basemap-DZvQVbYI.js"),
	"../fixtures/crosshairs/index.ts": () => import("./crosshairs-Dlo6FRz4.js"),
	"../fixtures/details/index.ts": () => import("./details-H_2K-gB5.js"),
	"../fixtures/draw/index.ts": () => import("./draw-DOSbpgn8.js"),
	"../fixtures/export/index.ts": () => import("./export-BcyoIreK.js"),
	"../fixtures/export-footnote/index.ts": () => import("./export-footnote-DXShcsYR.js"),
	"../fixtures/export-legend/index.ts": () => import("./export-legend-Ceg4fPcE.js"),
	"../fixtures/export-map/index.ts": () => import("./export-map-B7SDx6K4.js"),
	"../fixtures/export-northarrow/index.ts": () => import("./export-northarrow-D7ZQT2Ln.js"),
	"../fixtures/export-scalebar/index.ts": () => import("./export-scalebar-DNqhJeZF.js"),
	"../fixtures/export-timestamp/index.ts": () => import("./export-timestamp-Dw5cQc3C.js"),
	"../fixtures/export-title/index.ts": () => import("./export-title-C2C-oR2K.js"),
	"../fixtures/extentguard/index.ts": () => import("./extentguard-BibciCrN.js"),
	"../fixtures/gazebo/index.ts": () => import("./gazebo-C_Jml50p.js"),
	"../fixtures/geosearch/index.ts": () => import("./geosearch-syQ9z6aC.js"),
	"../fixtures/grid/index.ts": () => import("./grid-CvOcQXtS.js"),
	"../fixtures/help/index.ts": () => import("./help-BDgEtPI3.js"),
	"../fixtures/hilight/index.ts": () => import("./hilight-gytjYzBi.js"),
	"../fixtures/keyboardnav/index.ts": () => import("./keyboardnav-CIhqFQ2_.js"),
	"../fixtures/layer-reorder/index.ts": () => import("./layer-reorder-B9tg7GeM.js"),
	"../fixtures/legend/index.ts": () => import("./legend-Cko6Tq2O.js"),
	"../fixtures/mapnav/index.ts": () => import("./mapnav-BNmJMTXd.js"),
	"../fixtures/metadata/index.ts": () => import("./metadata-DHOXx7yM.js"),
	"../fixtures/northarrow/index.ts": () => import("./northarrow-SBTzXJ8i.js"),
	"../fixtures/overviewmap/index.ts": () => import("./overviewmap-Bm8wb8_0.js"),
	"../fixtures/panguard/index.ts": () => import("./panguard-D1mn0ucF.js"),
	"../fixtures/scrollguard/index.ts": () => import("./scrollguard-BQlOz9TP.js"),
	"../fixtures/settings/index.ts": () => import("./settings-jH1Nwez9.js"),
	"../fixtures/snowman/index.ts": () => import("./snowman-BN7TuQNn.js"),
	"../fixtures/swipe/index.ts": () => import("./swipe-BHLikvSG.js"),
	"../fixtures/wizard/index.ts": () => import("./wizard-m3uAMM8N.js")
}), ds = class extends Z {
	constructor(e) {
		super(e);
	}
	exists(e) {
		return e in qt(this.$vApp.$pinia).items;
	}
	async add(e, t) {
		let n;
		if (e in qt(this.$vApp.$pinia).items) return this.get(e);
		if (t) {
		...
		return qt(this.$vApp.$pinia).addFixture(n), this.$iApi.event.emit(Q.FIXTURE_ADDED, n), this.$iApi.geo.map.created && n.initialized?.(), n;
	}
	remove(e) {
		let t = this.get(e);
		if (!t) throw Error(`Could not find fixture ${e} for removal`);
		return qt(this.$vApp.$pinia).removeFixture(t), this.$iApi.event.emit(Q.FIXTURE_REMOVED, t), t;
	}
	flush() {
		let e = qt(this.$vApp.$pinia);
	...
	get(e) {
		...
		let n = t.map((e) => {
			let t = qt(this.$vApp.$pinia).items[e];
			if (t) return t;
		});
		return n.length === 1 ? n[0] : n;
	}
	isLoaded(e) {
		let t = qt(this.$vApp.$pinia), n = Array.isArray(e) ? e : [e];
		n.forEach((e) => {
	...
	mount(e, { props: t, children: n, element: r, app: i } = {}) {
		let a = r, o = _e(e, t, n);
		return i && i._context && (o.appContext = i._context), a ||= document.createElement("div"), Ee(o, a), {
			vNode: o,
			destroy: () => {
				a && Ee(null, a), a = null, o = null;
			},
			el: a
		};
	}
	...
	updateHTML(e, t, n) {
		...
		if (zt(i)) for (let e in t) i[e].innerHTML = t[e] instanceof HTMLElement ? t[e].outerHTML : t[e];
	...
	open(e) {
		...
		return n || (t.route && !r ? {screen: n, props: r} = t.route : n = Object.keys(t.screens).pop()), this.show(t, {
			screen: n,
			props: r
		}) ? (this.panelStore.openPanel(t), this.$iApi.updateAlert(this.$iApi.$i18n.t("panels.alert.open", { name: t.alertName ? this.$iApi.$i18n.t(t.alertName) : t.id })), this.$iApi.event.emit(Q.PANEL_OPENED, t)) : console.error(`Failed to open ${t.id} panel.`), t;
	}
	get opened() {
	...
	close(e) {
		...
		return t.isPinned && t.pin(!1), this.panelStore.closePanel(t), this.$iApi.updateAlert(this.$iApi.$i18n.t("panels.alert.close", { name: t.alertName ? this.$iApi.$i18n.t(t.alertName) : t.id })), this.$iApi.event.emit(Q.PANEL_CLOSED, t), this.$vApp.$nextTick(() => {
	...
	minimize(e) {
		let t = this.get(e);
		return t && (t.isPinned && t.pin(!1), this.panelStore.closePanel(t), this.$iApi.updateAlert(this.$iApi.$i18n.t("panels.alert.minimize", { name: t.alertName ? this.$iApi.$i18n.t(t.alertName) : t.id })), this.$iApi.event.emit(Q.PANEL_MINIMIZED, t), t);
	}
	move(e, t) {
		let n = this.get(e);
...
var hs = {};
function gs(e, t) {
	let n = M("panel-screen");
	return A(), S(n, {
		header: !1,
		class: "screen-spinner"
	}, {
		content: I(() => [...t[0] ||= [T("div", { class: "loader" }, null, -1)]]),
		_: 1
	});
}
var _s = /* @__PURE__ */ te(hs, [["render", gs], ["__scopeId", "data-v-a3c61802"]]), vs = /* @__PURE__ */ Object.assign({
	"../fixtures/areas-of-interest/screen.vue": () => import("./screen-ZqLTueQJ.js"),
	"../fixtures/basemap/screen.vue": () => import("./screen-CecNqNOc.js"),
	"../fixtures/export/screen.vue": () => import("./screen-BYhlN0iQ.js"),
	"../fixtures/geosearch/screen.vue": () => import("./screen-C2--HRCg.js"),
	"../fixtures/grid/screen.vue": () => import("./screen-Bb4CC3nl.js"),
	"../fixtures/help/screen.vue": () => import("./screen-CYkky8X1.js"),
	"../fixtures/layer-reorder/screen.vue": () => import("./screen-B3OudAg3.js"),
	"../fixtures/legend/screen.vue": () => import("./screen-DJ9WU6lQ.js"),
	"../fixtures/metadata/screen.vue": () => import("./screen-CFJZ3RY3.js"),
	"../fixtures/settings/screen.vue": () => import("./screen-D80ipGtR.js"),
	"../fixtures/wizard/screen.vue": () => import("./screen-D9yhRB1b.js")
}), ys = class extends Z {
	id;
	screens;
	loadedScreens = [];
	...
	registerScreen(e) {
		...
		if (Rt(t) || Lt(t)) n = t, this.loadedScreens.push(e);
		else if (zt(t)) n = { template: `<panel-screen :panel="this" :screenId="'${e}'">
                           </panel-screen>` };
		else {
			let r;
			...
			let i = new Promise((t, n) => {
				r.then((n) => {
					this.loadedScreens.push(e), t(Bt(n) ? n.default : n);
				}), r.catch((e) => n(e));
			});
			n = he({
				loader: () => i,
	...
	e.extentSets && (t.map.extentSets = [], e.extentSets.forEach((e) => {
		...
		e.overviewUrl && (t.fixtures.overviewmap || (t.fixtures.overviewmap = { basemaps: {} }, t.fixturesEnabled.push("overviewmap")), t.fixtures.overviewmap.basemaps[e.id] = {
			...
			layers: [{
				...
				layerType: e.overviewUrl.layerType === "esriDynamic" ? B.MAPIMAGE : B.TILE,
		...
		e.attribution && (n.attribution = { text: {} }, e.attribution.text && (n.attribution.text.disabled = !e.attribution.text.enabled, n.attribution.text.value = e.attribution.text.value)), e.layers.forEach((t, r) => {
			let i = {
				id: t.id || `${e.id}-${r}`,
				layerType: t.layerType === "esriDynamic" ? B.MAPIMAGE : B.TILE,
				url: t.url,
				opacity: t.opacity ?? 1
			};
			n.layers.push(i);
...
console.info(`RAMP v${{
	...
	minor: "21",
	patch: "0",
	timestamp: "Thu May 21 10:47:59 2026 -0400",
	hash: "3c780838883a335eebf222d4cc4dfff705097a31"
}.major}.${{
	major: "4",
	minor: "21",
	patch: "0",
...
var Is = (e, t, n) => new Xa(e, t, n), Ls = new It();
//#endregion
export { Y as $, Da as A, cn as B, za as C, La as D, Fa as E, $n as F, Ht as G, Kt as H, Qn as I, Nt as J, Vt as K, Zn as L, aa as M, ia as N, Ia as O, ra as P, yt as Q, _n as R, Va as S, Ra as T, Gt as U, Q as V, Ut as W, wt as X, X as Y, xt as Z, Ka as _, Ns as a, W as at, Ua as b, Ro as c, B as ct, go as d, J as et, mo as f, qa as g, Ja as h, Fs as i, ut as it, ha as j, Pa as k, So as l, nt as lt, Ya as m, Is as n, K as nt, ys as o, q as ot, to as p, Z as q, Ls as r, tt as rt, fs as s, G as st, Ps as t, dt as tt, xo as u, Ga as v, Ba as w, Ha as x, Wa as y, fn as z };
