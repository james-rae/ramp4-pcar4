import { $ as e, et as t } from "./main-Ck4jBxAm.js";
import { i as n, w as r } from "./esri-C6orwzKs.js";
import { t as i } from "./_plugin-vue_export-helper-C6QCLu9I.js";
import { _ as a, c as o, g as s, l as ee, n as te, o as ne, p as re, t as ie, v as ae, y as oe } from "./store-De1UwLdA.js";
import { t as se } from "./color-control-CPE87eFY.js";
import { t as ce } from "./download-icon-DV7LbF-E.js";
import { n as le, r as ue } from "./shape-io-ShjLFHiS.js";
import { t as c } from "./copy-icon-B40EsZcu.js";
import { t as de } from "./delete-icon-yHl5oxBI.js";
import { t as fe } from "./identify-icon-D1O0y6k-.js";
import { t as pe } from "./info-icon-DVqwcwNm.js";
import { a as me, c as he, n as ge, o as _e, r as ve, s as ye, t as be } from "./measurement-utils-CoLIeI7c.js";
...
var Le = { class: "rv-header-title" }, Re = {
	...
	setup(i) {
		let Ce = i, { t: D, locale: dr } = Fe(), O = we("iApi"), k = ie(), A = v(Ce.initialTab), j = v(!1), M = v([]), N = v([]), P = v([]), F = v(""), fr = v([]), pr = v(null), I = v(!1), L = v(!1), R = v(!1), mr = 0, z = [
			{
				id: "details",
		...
		], B = u(() => k.getSelectedGraphic()), V = u(() => B.value?.id ?? B.value?.attributes?.id), H = u(() => Ae(B.value?.geometry)), U = u(() => B.value?.attributes), W = u(() => oe(U.value)), G = u(() => s(U.value)), K = u(() => ae(U.value)), hr = u(() => B.value?.type ?? U.value?.type ?? H.value?.type), gr = u(() => D(`draw.details.shapeType.${hr.value ?? "unknown"}`)), _r = u(() => `${gr.value} - ${Y.value > 0 ? D("draw.inspector.subtitle.segments", { count: Y.value }) : D("draw.inspector.subtitle.selected")}`), q = u(() => [
			"polyline",
			"polygon",
			"rectangle"
			...
			k.setSelectedGraphicStyleSettings(o(k.styleSettings)), k.setSelectedGraphicBufferSettings(ne(k.bufferSettings)), k.setSelectedGraphicIdentifyBufferMode(k.identifyBufferMode);
		}, mi = (e) => {
			if (e === "default") {
				pi();
				return;
