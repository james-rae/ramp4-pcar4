...
import { _ as H, d as L, F as X, G as ee } from "./main-BvqzXN-s.js";
...
const G = /* @__PURE__ */ H(ne, [["render", ae]]), se = /* @__PURE__ */ T({
  ...
  setup(h) {
    ...
    const p = [
      {
        type: "point",
        icon: g(_(() => import("./point-icon-DL7I75V5.js")))
      },
      {
        type: "polyline",
        icon: g(_(() => import("./polyline-icon-E4m7kXBi.js")))
      },
      {
        type: "polygon",
        icon: g(_(() => import("./polygon-icon-CvYIssym.js")))
      },
      {
        type: "circle",
        icon: g(_(() => import("./circle-icon--BiNiCCZ.js")))
      },
      {
        type: "rectangle",
        icon: g(_(() => import("./rectangle-icon-D9qST1yV.js")))
      }
    ], a = A(() => {
      const s = p.filter((u) => e.supportedTypes.some((x) => x.type === u.type));
      return s.push({
        type: "edit",
        icon: g(_(() => import("./edit-icon-B8pb6Fad.js")))
      }), s;
    }), n = (s) => {
