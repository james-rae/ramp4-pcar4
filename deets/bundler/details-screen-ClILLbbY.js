import { defineComponent as G, ref as k, onMounted as re, createElementBlock as l, openBlock as t, createElementVNode as h, normalizeClass as U, createCommentVNode as N, Fragment as X, renderList as K, normalizeStyle as ge, toDisplayString as z, computed as I, resolveDirective as q, withDirectives as O, withModifiers as he, createVNode as ie, onBeforeMount as Q, watch as R, onBeforeUnmount as ee, unref as L, createBlock as Z, inject as te, resolveDynamicComponent as pe, nextTick as ne, createTextVNode as oe, resolveComponent as Me, withCtx as fe } from "vue";
import { _ as ue, e as se, X as ce, a0 as Ee, G as J } from "./main-BvqzXN-s.js";
...
import "await-to-js";
import "svg.js";
import { T as Ce } from "./toggle-switch-control-C9uFAxfY.js";
const De = {
  key: 0,
  class: "relative"
}, Se = {
    ...
    return re(() => {
      ...
      h("div", {
        ...
        s.value.length > 1 ? (t(), l("div", Se, [
          (t(!0), l(X, null, K(s.value.slice(0, 3).reverse(), (_, m) => (t(), l("div", {
  ...
  setup(v, { emit: E }) {
    ...
    return Q(() => {
      ...
      return O((t(), l("div", {
        ...
        (t(!0), l(X, null, K(D.results, ($, o) => (t(), l("div", {
  ...
  setup(v) {
    const { t: E } = W(), s = te("iApi"), p = v, y = (e, r, n, i) => {
  ...
  setup(v) {
    ...
    }, null, 8, Ke)) : (t(), l("div", Qe, z(L(E)("details.layers.results.empty")), 1));
  }
  ...
  setup(v) {
    const E = ce(), s = v, p = te("iApi"), y = k([]), _ = se(), { t: m } = W(), H = k(!1), D = k(""), e = k("none"), r = k(), n = () => E.getLayerByUid(s.uid), i = I(() => _.properties), f = I(() => _.defaultTemplates), u = I(() => n()?.supportsFeatures ?? !1), b = I(() => n()?.mapLayer ?? !1), S = I(() => {
      const o = n();
      ...
      return f.value && f.value[s.data.format] ? f.value[s.data.format] : u.value ? Je : et;
  ...
  setup(v, { emit: E }) {
    ...
    }, _ = te("iApi"), m = se(), H = ce(), D = E, e = v, { t: r } = W(), n = k(!1), i = k(_.fixture.get("details")), f = k(!0), u = k(!1), b = k(0), S = k(20), j = k([]), c = k([]), g = I(() => m.activeGreedy), M = I(() => m.properties), B = I(() => b.value + S.value), A = () => H.getLayerByUid(e.uid), C = () => e.results.find((a) => a.uid === e.uid), $ = I(() => C()?.loaded ?? !1), o = I(() => C()?.requestTime), d = I(
    ...
    return re(() => {
      j.value.push(
        _.event.on(J.LAYER_REMOVE, (a) => {
          const x = _.panel.get("details");
          e.uid === a.uid && x && x.close();
        })
      ), j.value.push(
        _.event.on(J.PANEL_CLOSED, (a) => {
          a.id === "details" && Le();
        })
      ), j.value.push(
        _.event.on(J.PANEL_MINIMIZED, (a) => {
          a.id === "details" && we();
        })
      ), j.value.push(
        _.event.on(J.MAP_BASEMAPCHANGE, (a) => {
        ...
        n.value ? (t(), l("div", Lt, [
          T().length > 0 ? (t(), l("div", wt, [
            u.value ? O((t(), l("div", {
              ...
              (t(!0), l(X, null, K(T().slice(b.value, B.value), (Y, me) => O((t(), l("button", {
  ...
  setup(v) {
    const { t: E } = W(), s = te("iApi"), p = se(), y = k([]), _ = k([]), m = k([]), H = k(!1), D = k(null), e = k(""), r = I(() => p.activeGreedy), n = I(() => p.payload), i = (c) => {
      e.value = c;
...
}), hs = /* @__PURE__ */ ue(St, [["__scopeId", "data-v-b149ae00"]]);
export {
  hs as default
};
