...
import "tiny-emitter";
import { G as le, L as Te, F as xe } from "./main-vuG1Jmf_.js";
...
class ft extends Me {
  async init() {
    Object.entries(Le).forEach((b) => this.$iApi.$i18n.mergeLocaleMessage(...b)), this._parseConfig(this.config), Z(this.$vApp.$pinia).supportedTypes.forEach((b) => {
      const o = `${b.type}-icon`;
      this.$iApi.component(o, Ae(Se(/* @__PURE__ */ Object.assign({ "./icons/circle-icon.vue": () => import("./circle-icon-B16xJAKI.js"), "./icons/edit-icon.vue": () => import("./edit-icon-Bi6u_xYG.js"), "./icons/point-icon.vue": () => import("./point-icon-CKrFhuBv.js"), "./icons/polygon-icon.vue": () => import("./polygon-icon-Cex6eeJc.js"), "./icons/polyline-icon.vue": () => import("./polyline-icon-C40TY-Nr.js"), "./icons/rectangle-icon.vue": () => import("./rectangle-icon-BALIVSz3.js") }), `./icons/${b.type}-icon.vue`, 3)));
    });
