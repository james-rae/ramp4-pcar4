...
import { _ as H, d as L, k as X, F as ee, G as te } from "./main-vuG1Jmf_.js";
...
const G = /* @__PURE__ */ H(ne, [["render", ae]]), se = /* @__PURE__ */ T({
  ...
  setup(h) {
    ...
    const p = [
      {
        type: "point",
        icon: g(_(() => import("./point-icon-CKrFhuBv.js")))
      },
      {
        type: "polyline",
        icon: g(_(() => import("./polyline-icon-C40TY-Nr.js")))
      },
      {
        type: "polygon",
        icon: g(_(() => import("./polygon-icon-Cex6eeJc.js")))
      },
      {
        type: "circle",
        icon: g(_(() => import("./circle-icon-B16xJAKI.js")))
      },
      {
        type: "rectangle",
        icon: g(_(() => import("./rectangle-icon-BALIVSz3.js")))
      }
    ], a = A(() => {
      const s = p.filter((u) => e.supportedTypes.some((x) => x.type === u.type));
      return s.push({
        type: "edit",
        icon: g(_(() => import("./edit-icon-Bi6u_xYG.js")))
      }), s;
    }), n = (s) => {
