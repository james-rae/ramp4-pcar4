...
const tr = ["content"], ir = { class: "flex items-center text-left" }, sr = { class: "select-text cursor-text" }, rr = ["content"], or = {
...
}), vr = /* @__PURE__ */ Pe(gr, [["__scopeId", "data-v-3623a7d2"]]), br = { class: "flex hover:text-white" }, Ar = ["aria-label"], wr = { class: "about-ramp-dropdown pointer-events-auto bg-white rounded w-256 h-50" }, Er = { class: "pb-8 border-b border-gray-600 mb-10" }, xr = { class: "absolute right-5 top-5" }, Sr = { class: "select-text" }, _r = { class: "font-bold cursor-text" }, Ir = { class: "text-sm cursor-text" }, Tr = { class: "text-sm cursor-text" }, Lr = /* @__PURE__ */ O({
  ...
  setup(r) {
    ...
    return (A, v) => {
      ...
      return g(), w("div", $r, [
        ...
        a.value?.text.disabled ? U("", !0) : P((g(), w("span", Mr, [
        ...
        f("div", Pr, [
          l.value?.disabled ? U("", !0) : P((g(), w("div", Nr, [
          ...
          n.value?.disabled ? U("", !0) : (g(), W($, {
            ...
            default: ee(() => [
              (g(!0), w(qe, null, pt(u.value, (F, ce) => (g(), w("a", {
                ...
                F === _(s).$i18n.locale.value ? (g(), w("span", Br, B(_(i)("map.language.curr")), 1)) : U("", !0)
              ], 10, Ur))), 128))
            ]),
            _: 1
          }, 8, ["tooltip", "ariaLabel"]))
  ...
  setup(r) {
    ...
    return (o, a) => {
      ...
      return P((g(), w("button", {
        ...
        s.value && s.value > 0 ? (g(), w("span", jr, B(s.value), 1)) : U("", !0)
      ], 8, Vr)), [
        [l]
      ]);
    };
  ...
  setup(r) {
    ...
    return (c, u) => (g(), w("div", Zr, [
      ...
      _(t).started ? (g(), W(js, { key: 0 })) : (g(), w("div", Xr, u[1] || (u[1] = [
  ...
  setup(r, { expose: e }) {
    ...
    return Ye(() => {
      ...
      return P((g(), w("div", {
        ...
        r.header ? (g(), w("header", Eo, [
          re(T, {
            class: oe(r.panel.teleport ? "display-none" : "block sm:display-none"),
            onClick: $[0] || ($[0] = (fe) => r.panel.close())
          }, null, 8, ["class"]),
          P((g(), w("h2", xo, [
            v.$slots.header ? ke(v.$slots, "header", { key: 0 }) : (g(), w("div", So, B(_(t)(r.panel.alertName)), 1))
          ])), [
            [S]
          ]),
          ...
          f("div", {
            ...
            r.panel.teleport ? U("", !0) : (g(), w("div", _o, [
              d.value ? (g(), W(F, {
                key: 0,
  ...
  setup(r) {
    ...
    return (s, o) => {
      ...
      return g(), W(a, {
        ...
        default: ee(() => [
          _(t).isFullscreen ? (g(), w("svg", ta, o[0] || (o[0] = [
            f("path", {
              d: "M0 0h24v24H0z",
              fill: "none"
            }, null, -1),
...
const gi = "https://geogratis.gc.ca/services/geolocation/@{language}/locate", vi = "https://geogratis.gc.ca/services/geoname/@{language}/geonames.json", bi = "https://geogratis.gc.ca/services/geoname/@{language}/codes/province.json", Ai = "https://geogratis.gc.ca/services/geoname/@{language}/codes/concise.json", Ia = {
  10: "NL",
  11: "PE",
  12: "NS",
  13: "NB",
...
class Ki extends Zi {
  ...
  async onInitiate() {
    if (this.sourceJson) {
      ...
      this.attribs.attLoader = new _n(this.$iApi, o), await this.attribs.attLoader.getAttribs(), this.featureCount = e.data.length;
...
class Cn extends Z {
   ...
   */
  constructor(e) {
    super(e), this.geom = lt.geom, this.proj = lt.proj, this.shared = lt.sharedUtils, this.map = new za(e), this.layer = new sn(e), this.attributes = new xn(e), this.query = new $n(e), this.symbology = new Rn(e), Array.isArray(dt.request.interceptors) || (dt.request.interceptors = []), dt.request.interceptors.push({
      before: (t) => {
...
const On = /* @__PURE__ */ Object.assign({ "../fixtures/appbar/index.ts": () => import("./index-BUiYqbJV.js"), "../fixtures/areas-of-interest/index.ts": () => import("./index-lxI5uUdX.js"), "../fixtures/basemap/index.ts": () => import("./index-Dk5ONtKP.js"), "../fixtures/crosshairs/index.ts": () => import("./index-BVkFmSgs.js"), "../fixtures/details/index.ts": () => import("./index-B2MnuAoc.js"), "../fixtures/export-footnote/index.ts": () => import("./index-CXPFt53W.js"), "../fixtures/export-legend/index.ts": () => import("./index-bcbp-PRO.js"), "../fixtures/export-map/index.ts": () => import("./index-BCm0Ftd7.js"), "../fixtures/export-northarrow/index.ts": () => import("./index-73vBpPQG.js"), "../fixtures/export-scalebar/index.ts": () => import("./index-DDl5NF_C.js"), "../fixtures/export-timestamp/index.ts": () => import("./index-CWKDjjnO.js"), "../fixtures/export-title/index.ts": () => import("./index-B-blVuLj.js"), "../fixtures/export/index.ts": () => import("./index-DbfNwn4_.js"), "../fixtures/extentguard/index.ts": () => import("./index-BHGIe4_p.js"), "../fixtures/gazebo/index.ts": () => import("./index-DjCK9SJO.js"), "../fixtures/geosearch/index.ts": () => import("./index-BhvZBdH8.js"), "../fixtures/grid/index.ts": () => import("./index-BXOOOLfh.js"), "../fixtures/help/index.ts": () => import("./index-DgdMT9dV.js"), "../fixtures/hilight/index.ts": () => import("./index-VgcL8FzP.js"), "../fixtures/layer-reorder/index.ts": () => import("./index-BsnjJUng.js"), "../fixtures/legend/index.ts": () => import("./index-DLwtzWUA.js"), "../fixtures/mapnav/index.ts": () => import("./index-BmyJOCEm.js"), "../fixtures/metadata/index.ts": () => import("./index-BuDNiXD4.js"), "../fixtures/northarrow/index.ts": () => import("./index-DEe_4AoG.js"), "../fixtures/overviewmap/index.ts": () => import("./index-Ckbw4WBa.js"), "../fixtures/panguard/index.ts": () => import("./index-FrePMMya.js"), "../fixtures/scrollguard/index.ts": () => import("./index-BfL_heVT.js"), "../fixtures/settings/index.ts": () => import("./index-CeTDLMCy.js"), "../fixtures/snowman/index.ts": () => import("./index-DtcSJcbc.js"), "../fixtures/wizard/index.ts": () => import("./index-Dyk-9UVU.js") });
class kn extends Z {
  /**
...
const Dn = /* @__PURE__ */ Pe(Nn, [["render", Fn], ["__scopeId", "data-v-a3c61802"]]), Gn = /* @__PURE__ */ Object.assign({ "../fixtures/areas-of-interest/screen.vue": () => import("./screen-CMYHiQME.js"), "../fixtures/basemap/screen.vue": () => import("./screen-DUG4lf-i.js"), "../fixtures/export/screen.vue": () => import("./screen-BiwJE2Gw.js"), "../fixtures/geosearch/screen.vue": () => import("./screen-BoBIm4Rk.js"), "../fixtures/grid/screen.vue": () => import("./screen-Bz3WSFDr.js"), "../fixtures/help/screen.vue": () => import("./screen-DCpoC4lQ.js"), "../fixtures/layer-reorder/screen.vue": () => import("./screen-BsYcFYp0.js"), "../fixtures/legend/screen.vue": () => import("./screen-Cxt1IHYf.js"), "../fixtures/metadata/screen.vue": () => import("./screen-CNNz0sFo.js"), "../fixtures/settings/screen.vue": () => import("./screen-B713qccT.js"), "../fixtures/wizard/screen.vue": () => import("./screen-D9vQtRPE.js") });
class wt extends Z {
  /**
   * ID of this panel.
   *
...
var it = { major: "4", minor: "11", patch: "0-beta", timestamp: "Wed Mar 5 15:11:29 2025 -0500", hash: "9d625af44d6d254ff926460dccb4a432822fc401" };
console.info(
...
const Cl = (r, e, t) => new Fa(r, e, t), lt = new Ps();
export {
  q as $,
  Rr as A,
  mt as B,
