...
import { DataFormat, DrawState, Extent, GeometryType, Graphic, InitiationState, LayerControl, LayerFormat, LayerIdentifyMode, LayerState, LayerType, ScaleSet, SpatialReference, TreeNode, Attributes, AttributeSet, DrawOrder, FieldDefinition, GetGraphicParams, IdentifyParameters, LayerTimes, LegendSymbology, TabularAttributeSet } from '../api';
/**
