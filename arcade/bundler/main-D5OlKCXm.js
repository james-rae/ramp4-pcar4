...
const Lt = z("maptip", () => {
  ...
  __name: "esri-map",
  setup(r) {
    const e = Lt(), t = we("iApi"), i = N(() => e.maptipPoint), s = N(() => e.maptipInstance), o = N(() => e.content), a = be([]);
    a.push(
      Et(i, () => {
        if (i.value) {
...
const qs = ["data-cy"], Vi = /* @__PURE__ */ O({
  ...
  __name: "panel-stack",
  setup(r) {
    const e = He(), t = we("iApi"), i = h(), s = N(() => e.mobileView);
    Ye(() => {
    ...
    return (c, u) => (g(), W($i, {
      ...
      default: ee(() => [
        (g(!0), w(qe, null, pt(o(_(t).screenSize), (p) => (g(), W(Vi, {
          key: `${p.id}`,
          panel: p
        }, null, 8, ["panel"]))), 128))
      ]),
...
const er = ["content"], tr = { class: "flex items-center text-left" }, ir = { class: "select-text cursor-text" }, sr = ["content"], rr = {
      ...
      return P((g(), w("li", {
        ...
        f("div", tr, [
          f("span", null, [
            ...
            f("span", ir, B(r.notification.message), 1)
          ]),
        ...
        r.notification.messageList && s.value ? (g(), w("div", rr, [
          (g(!0), w(qe, null, pt(r.notification.messageList, (p, d) => (g(), w("p", {
    ...
    return (l, n) => {
      ...
      return g(), w("div", null, [
        a.value.length > 0 ? P((g(), w("ul", {
          ...
          (g(!0), w(qe, null, pt(a.value, (d, b) => (g(), w(qe, {
            key: d.message + b
          }, [
            b > 0 ? (g(), w("div", nr)) : U("", !0),
            P(re(or, {
      ...
      return g(), W(Xt, {
        ...
        header: ee(() => [
          f("div", cr, [
            ...
            i.value && i.value > 0 ? (g(), w("span", pr, B(i.value), 1)) : U("", !0)
          ])
        ]),
        default: ee((c) => [
          f("div", dr, [
            f("div", null, [
              f("h4", hr, B(_(t)("notifications.title")), 1),
              f("div", fr, [
                P((g(), w("button", {
                  type: "button",
                  onClick: s,
...
}), gr = /* @__PURE__ */ Pe(yr, [["__scopeId", "data-v-3623a7d2"]]), vr = { class: "flex hover:text-white" }, br = ["aria-label"], Ar = { class: "about-ramp-dropdown pointer-events-auto bg-white rounded w-256 h-50" }, wr = { class: "pb-8 border-b border-gray-600 mb-10" }, Er = { class: "absolute right-5 top-5" }, xr = { class: "select-text" }, Sr = { class: "font-bold cursor-text" }, _r = { class: "text-sm cursor-text" }, Ir = { class: "text-sm cursor-text" }, Tr = /* @__PURE__ */ O({
        ...
        default: ee((u) => [
          f("div", Ar, [
            f("div", null, [
              ...
              f("div", xr, [
                f("div", null, [
                  f("span", Sr, B(t.value), 1),
                  f("span", _r, " [" + B(i.value) + "] ", 1)
                ]),
                f("div", null, [
  ...
  __name: "map-caption",
  setup(r) {
    const e = Ge(), t = de(), { t: i } = H(), s = we("iApi"), o = N(() => e.scale), a = N(() => e.attribution), l = N(() => e.coords), n = N(() => e.langtoggle), c = N(() => t.config.map), u = h([]), p = be([]);
    p.push(
      Et(c, (A) => {
    ...
    const d = () => a.value?.logo?.link && a.value?.logo?.value && !a.value?.logo?.disabled, b = (A) => {
    ...
    return (A, v) => {
      ...
      return g(), w("div", Rr, [
        ...
        a.value?.text.disabled ? U("", !0) : P((g(), w("span", kr, [
        ...
        f("div", Mr, [
          l.value?.disabled ? U("", !0) : P((g(), w("div", Pr, [
          ...
          n.value?.disabled ? U("", !0) : (g(), W($, {
            ...
            header: ee(() => [
              f("span", Dr, B(_(i)("map.language.short")), 1)
            ]),
            default: ee(() => [
              (g(!0), w(qe, null, pt(u.value, (F, ce) => (g(), w("a", {
                key: `${F}-${ce}`,
                ...
                F === _(s).$i18n.locale.value ? (g(), w("span", Ur, B(_(i)("map.language.curr")), 1)) : U("", !0)
              ], 10, Gr))), 128))
            ]),
            _: 1
          }, 8, ["tooltip", "ariaLabel"]))
  ...
  setup(r) {
    const e = Te(), t = we("iApi"), { t: i } = H(), s = N(() => e.notificationNumber);
    return (o, a) => {
      const l = M("tippy");
      return P((g(), w("button", {
        type: "button",
        ...
        s.value && s.value > 0 ? (g(), w("span", Vr, B(s.value), 1)) : U("", !0)
      ], 8, zr)), [
        [l]
      ]);
    };
  ...
  setup(r) {
    const e = we("iApi"), { t } = H(), i = h(!1), s = h(["app", "lists", "map"]), o = h([]), a = h(null), l = h(null);
    Ye(() => {
      o.value.push(
    ...
    return (c, u) => {
      ...
      return i.value ? (g(), w("div", {
        ...
        f("div", {
          ...
          f("div", Wr, [
            f("h2", Hr, B(_(t)("keyboardInstructions.title")), 1),
            re(p, {
              class: "ml-auto",
              onClick: u[0] || (u[0] = (d) => i.value = !1)
            })
          ]),
          (g(!0), w(qe, null, pt(s.value, (d) => (g(), w("p", {
...
}), tt = z("instance", () => ({ started: h(!1) })), Jr = { class: "h-full relative" }, Zr = { class: "inner-shell absolute top-0 left-0 h-full w-full pointer-events-none" }, Kr = { class: "absolute top-8 w-full flex justify-center" }, Qr = {
  key: 1,
  class: "w-full h-full"
}, Xr = /* @__PURE__ */ O({
  __name: "shell",
  setup(r) {
    const e = we("iApi"), t = tt(), i = ge(), s = He(), { t: o } = H(), a = N(() => i.items.appbar), l = () => {
    ...
    return (c, u) => (g(), w("div", Jr, [
      f("div", Zr, [
        ...
        a.value ? U("", !0) : (g(), W(qr, { key: 0 })),
        re(Br, { class: "z-30" })
      ]),
      _(t).started ? (g(), W(js, { key: 0 })) : (g(), w("div", Qr, u[1] || (u[1] = [
        f("div", { class: "spinner relative inset-x-1/2 inset-y-9/20" }, null, -1)
      ]))),
      (g(!0), w(qe, null, pt(n(), (p) => (g(), W(cs, {
...
const oo = /* @__PURE__ */ Pe(to, [["render", ro]]), xe = "focus-list", Ve = "focus-item", ao = "focus-icon", no = "focus-container", nt = `[${xe}],[${no}]`, vt = "truncate-text", bt = "show-truncate", st = "focused", Ht = `button,input,select,a,textarea,[contenteditable],[${xe}],[${ao}],[tabIndex]`, lo = {
  mounted(r, e) {
...
const Ao = ["content"], wo = {
  ...
  setup(r, { expose: e }) {
    const { t } = H(), i = He(), s = Tt(), o = we("iApi"), a = ci("el"), l = ci("contentEl"), n = h();
    e({ el: a });
    ...
    return Ye(() => {
      ...
      return P((g(), w("div", {
        ...
        r.header ? (g(), w("header", wo, [
          re(T, {
            class: oe(r.panel.teleport ? "display-none" : "block sm:display-none"),
            onClick: $[0] || ($[0] = (fe) => r.panel.close())
          }, null, 8, ["class"]),
          P((g(), w("h2", Eo, [
            v.$slots.header ? ke(v.$slots, "header", { key: 0 }) : (g(), w("div", xo, B(_(t)(r.panel.alertName)), 1))
          ])), [
            [S]
          ]),
          ...
          f("div", {
            ...
            r.panel.teleport ? U("", !0) : (g(), w("div", So, [
              d.value ? (g(), W(F, {
                key: 0,
  ...
  setup(r) {
    const e = we("iApi"), t = r, i = () => e?.event.emit(E.APPBAR_BUTTON_CLICK, t.id);
    return (s, o) => {
...
}), pa = /* @__PURE__ */ Pe(ua, [["__scopeId", "data-v-457cd2d4"]]), da = z("areas-of-interest", () => ({ areas: h([]) })), ha = z("export", () => {
  const r = h({
    title: !0,
    map: !0,
    mapElements: !0,
...
const gi = "https://geogratis.gc.ca/services/geolocation/@{language}/locate", vi = "https://geogratis.gc.ca/services/geoname/@{language}/geonames.json", bi = "https://geogratis.gc.ca/services/geoname/@{language}/codes/province.json", Ai = "https://geogratis.gc.ca/services/geoname/@{language}/codes/concise.json", _a = {
  10: "NL",
  11: "PE",
  12: "NS",
  13: "NB",
...
class Zi extends ii {
  ...
  async setNameArcade(e) {
    if (this.supportsFeatures)
      if (e.trim() === "")
        this.nameArcadeFormula = "", this.nameArcadeExecutor = void 0;
      else {
        this.nameArcadeFormula = e;
        const t = {
          variables: [
            {
              name: "$Attr",
              ...
              properties: this.fields.map((i) => {
                ...
                return s ? { name: i.name, type: s } : (console.error(
                  `Encountered field type with no arcade support: ${i.type} [${i.name}]`
                ), s);
              }).filter((i) => !!i)
            }
          ]
        };
        this.nameArcadeExecutor = await k.ArcadeExecutor(e, t);
      }
    else
...
class si extends Ze {
  ...
  filter;
  constructor(e, t) {
    super(e, t), this.supportsIdentify = !0, this.geomType = L.UNKNOWN, this.serviceUrl = "", this.fieldList = "", this.tooltipField = "", this.canModifyLayer = !0, this.filter = new Gi(e.permanentFilteredQuery || "", e.initialFilteredQuery || ""), this.hovertips = e.state?.hovertips ?? !0, this.attribs = new Qi();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
...
class Ke extends si {
  ...
  onLoadActions() {
    const e = super.onLoadActions(), t = async () => {
      this.esriLayer && this.origRampConfig.customRenderer?.type && (this.esriLayer.renderer = await k.RendererFromJson(this.config.customRenderer)), this.layerTree.name = this.name, this.extractLayerMetadata(), this.$iApi.geo.attributes.applyFieldMetadata(this, this.origRampConfig.fieldMetadata), this.attribs.attLoader.updateFieldList(this.fieldList), await this.nameInitializer(this.origRampConfig, this.nameField), this.origRampConfig.tooltipField ? this.tooltipField = this.$iApi.geo.attributes.fieldValidator(this.fields, this.origRampConfig.tooltipField) || this.nameField : this.tooltipField = this.nameField, this.featureCount = this.esriLayer?.source.length || 0;
    };
  ...
  onLoadActions() {
    ...
    const a = async () => {
      ...
      if (this.esriLayer && this.origRampConfig.customRenderer?.type) {
        ...
        n = {};
      await this.loadLayerMetadata(n), e > this.lastCancel && (this.layerTree.name = this.name, this.visibility = this.origRampConfig?.state?.visibility ?? this._serverVisibility ?? !0, this.$iApi.geo.attributes.applyFieldMetadata(this, this.origRampConfig.fieldMetadata), this.attribs.attLoader.updateFieldList(this.fieldList), this.attribs.attLoader.updateFieldsToTrim(this.getFieldsToTrim()), await this.nameInitializer(this.origRampConfig, this.nameField), this.tooltipField = this.origRampConfig.tooltipField || this.nameField);
  ...
  async onInitiate() {
    if (this.sourceJson) {
      ...
      this.fields = t.map((c, u) => {
        ...
        const b = this.$iApi.geo.layer.files.inferType(i[u]);
        return {
          name: d,
          alias: p,
          type: b,
          length: b === $e.STRING ? 256 : void 0
        };
      ...
      this.attribs.attLoader = new Sn(this.$iApi, o), await this.attribs.attLoader.getAttribs(), this.featureCount = e.data.length;
...
class En extends Z {
   ...
   * Undefined if a valid mapping could not be derived.
   *
   * @param fieldType
   * @returns
   */
...
class $n extends Z {
   ...
   */
  constructor(e) {
    super(e), this.geom = lt.geom, this.proj = lt.proj, this.shared = lt.sharedUtils, this.map = new Ba(e), this.layer = new tn(e), this.attributes = new En(e), this.query = new Rn(e), this.symbology = new Ln(e), Array.isArray(dt.request.interceptors) || (dt.request.interceptors = []), dt.request.interceptors.push({
      before: (t) => {
...
const Cn = /* @__PURE__ */ Object.assign({ "../fixtures/appbar/index.ts": () => import("./index-CwH-A3aL.js"), "../fixtures/areas-of-interest/index.ts": () => import("./index-BO-Hbf4F.js"), "../fixtures/basemap/index.ts": () => import("./index-8vZJF7J4.js"), "../fixtures/crosshairs/index.ts": () => import("./index-DhRqMNJC.js"), "../fixtures/details/index.ts": () => import("./index-CwzIa7Q8.js"), "../fixtures/export-footnote/index.ts": () => import("./index-CWRK-cgO.js"), "../fixtures/export-legend/index.ts": () => import("./index-ZjUooEJZ.js"), "../fixtures/export-map/index.ts": () => import("./index-C5z3kuFo.js"), "../fixtures/export-northarrow/index.ts": () => import("./index-jsQ4qf06.js"), "../fixtures/export-scalebar/index.ts": () => import("./index-Be6p5af0.js"), "../fixtures/export-timestamp/index.ts": () => import("./index-DxQnEe-G.js"), "../fixtures/export-title/index.ts": () => import("./index-klgAMvJs.js"), "../fixtures/export/index.ts": () => import("./index-D37zby59.js"), "../fixtures/extentguard/index.ts": () => import("./index-DFpZZUow.js"), "../fixtures/gazebo/index.ts": () => import("./index-d7L5EQwu.js"), "../fixtures/geosearch/index.ts": () => import("./index-CAcK5G-b.js"), "../fixtures/grid/index.ts": () => import("./index-DTnIKbUu.js"), "../fixtures/help/index.ts": () => import("./index-Bg_kT_GH.js"), "../fixtures/hilight/index.ts": () => import("./index-DuijLh01.js"), "../fixtures/layer-reorder/index.ts": () => import("./index-IMfpuEnB.js"), "../fixtures/legend/index.ts": () => import("./index-7yE5qAoK.js"), "../fixtures/mapnav/index.ts": () => import("./index-QfPythf8.js"), "../fixtures/metadata/index.ts": () => import("./index-DrHv8j91.js"), "../fixtures/northarrow/index.ts": () => import("./index-elMbCFPf.js"), "../fixtures/overviewmap/index.ts": () => import("./index-CRMXnBAn.js"), "../fixtures/panguard/index.ts": () => import("./index-TdeiBG6P.js"), "../fixtures/scrollguard/index.ts": () => import("./index-DITQvo5n.js"), "../fixtures/settings/index.ts": () => import("./index-BdSO6wJC.js"), "../fixtures/snowman/index.ts": () => import("./index-D5eegY2r.js"), "../fixtures/wizard/index.ts": () => import("./index-DnBE7cOY.js") });
class On extends Z {
  /**
...
const Fn = /* @__PURE__ */ Pe(Pn, [["render", Nn], ["__scopeId", "data-v-a3c61802"]]), Dn = /* @__PURE__ */ Object.assign({ "../fixtures/areas-of-interest/screen.vue": () => import("./screen-B2IG09JE.js"), "../fixtures/basemap/screen.vue": () => import("./screen-DCWkbrx_.js"), "../fixtures/export/screen.vue": () => import("./screen-BEfNcroy.js"), "../fixtures/geosearch/screen.vue": () => import("./screen-C5oWjfGS.js"), "../fixtures/grid/screen.vue": () => import("./screen-73UC1LC9.js"), "../fixtures/help/screen.vue": () => import("./screen-DVnkH7Ns.js"), "../fixtures/layer-reorder/screen.vue": () => import("./screen-CvO-pPvY.js"), "../fixtures/legend/screen.vue": () => import("./screen-omhnIIjv.js"), "../fixtures/metadata/screen.vue": () => import("./screen-zUcBdlSZ.js"), "../fixtures/settings/screen.vue": () => import("./screen-CwKxvBmQ.js"), "../fixtures/wizard/screen.vue": () => import("./screen-xAl_CyVN.js") });
class wt extends Z {
  /**
   * ID of this panel.
   *
...
var it = { major: "4", minor: "11", patch: "0-beta", timestamp: "Fri Feb 21 13:47:40 2025 -0500", hash: "05efc18e725fb5eff18b2f4051fccd3ad5d183c4" };
console.info(
...
const $l = (r, e, t) => new Na(r, e, t), lt = new Ps();
export {
  q as $,
  Lr as A,
  mt as B,
