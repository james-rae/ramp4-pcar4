import { iO as A, iP as y, bx as M, fB as $, ha as O, fK as D, hb as B } from "./main-B8aVjPQ9.js";
import { _ as k } from "./screen.vue_vue_type_script_setup_true_lang-DNWE-Gv0.js";
var H = { exports: {} };
(function(S, i) {
  (function(n, a) {
    a();
...
class _ extends M {
   ...
   */
  async make(i, n) {
    const { fabric: a } = await import("./fabric-EndpF8zJ.js").then((g) => g.f);
...
class I extends _ {
  ...
  async needed() {
    const i = (await import("./index-BDde_N93.js")).default, n = (await import("./index-G7bIGcoq.js")).default, a = (await import("./index-zSueabbB.js")).default, w = (await import("./index-CUkSQQZ9.js")).default, p = (await import("./index-CN1z6aoh.js")).default, r = (await import("./index-mt0N85_q.js")).default, b = (await import("./index-Goci7pxf.js")).default;
...
//# sourceMappingURL=index-D_ROZCo7.js.map
