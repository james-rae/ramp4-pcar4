import { bx as we, nJ as R, nK as $e, bC as j, bF as w, bG as le, bN as i, bT as o, fC as _, bU as Z, bV as W, fD as P, iG as me, fI as z, bP as A, i4 as ne, bI as L, bK as F, bS as C, bR as ie, ii as pe, bD as V, lu as oe, fG as Y, fH as G, bH as X, bL as q, bQ as k, bE as ee, nL as ve, kF as Le, iB as Ie, nM as Te, fK as Q, bO as ae, bJ as Se, bM as de, ha as He, hb as Ae } from "./main-sj-uz2v-.js";
import { H as ze } from "./hilight-defs-DzKgjtLG.js";
import { T as De } from "./toggle-switch-control-B6hZVtry.js";
class Ee {
  id;
  name;
  template;
...
class Me extends we {
  ...
  async getHilightGraphics(e, t) {
    ...
    return s && await Promise.all(
      e.map(async (u) => {
        await u.loading;
        const y = u.data[s.oidField], m = await s.getGraphic(y, {
          getGeom: !0,
          getAttribs: !0,
          getStyle: !0
        });
        m.id = l.constructGraphicKey(
          se,
          t,
          y
        ), r.push(m);
...
const Ce = {
  ...
  setup(h) {
    ...
    return le(() => {
    ...
    }), (s, l) => h.result.loaded ? (i(), o("div", Ce, [
      _("div", {
        class: P(h.result.items.length === 0 ? "opacity-50" : "")
      }, [
      ...
      _("div", qe, [
        h.result.loaded ? (i(), o("div", Re, A(h.result.items.length), 1)) : z("", !0)
      ])
    ])) : (i(), o("div", Ve, l[0] || (l[0] = [
  ...
  setup(h) {
    ...
    return (r, u) => {
      const y = F("tippy");
      return C((i(), o("button", {
        class: P(["flex flex-grow justify-start items-center px-7 py-10 default-focus-style symbologyStackButton truncate", h.selected ? "detailsButtonSelected" : "px-11"]),
        onClick: u[0] || (u[0] = pe(() => {
        }, ["stop"])),
        content: l()
      }, [
  ...
  setup(h, { emit: e }) {
    ...
    }, y = e, m = h, v = w(""), g = w([]), d = w(!1), a = w(!1), c = (I) => s.getLayerByUid(I), $ = (I) => {
      v.value = I, y("selection-changed", I), d.value = !1;
    }, D = () => {
      a.value || setTimeout(() => {
        d.value = a.value;
      }, 500), a.value = !0;
    ...
    return Y(() => {
      ...
      g.value.forEach((I) => I()), l.value?.removeEventListener("blur", r), l.value?.removeEventListener("keyup", u);
    }), (I, S) => {
      const N = F("focus-item"), M = F("focus-list"), U = F("tippy");
      return C((i(), o("div", {
        class: P(["symbology-list absolute overflow-hidden z-50 p-0 w-48 bg-white text-sm inline-flex flex-col", { "symbology-list-expanded": d.value }]),
        onMouseover: D,
        onMouseleave: E,
        onFocus: b,
        onBlur: pe(T, ["self"]),
        content: k(t)("details.layers.results.list.tooltip"),
        ref_key: "el",
        ref: l
      }, [
        (i(!0), o(Z, null, W(m.results, (n, f) => (i(), o("div", {
  ...
  setup(h) {
    const { t: e } = V(), t = ee("iApi"), s = h, l = (v, g, d, a) => {
      const c = v.find(
      ...
      l(s.fields, "type", "geometry", v), t?.ui.exposeOids || l(s.fields, "type", "oid", v), t?.ui.exposeMeasurements || (l(s.fields, "name", "shape_length", v), l(s.fields, "name", "shape_area", v));
      const g = {};
      s.fields.forEach((a) => {
        const c = s.fixtureFields?.find(
          ($) => a.name === $.field
        );
        g[a.name] = {
          name: c?.alias || a.alias || a.name,
          type: a.type,
          visible: c?.visible ?? !0
        };
      });
      ...
      if (v.trim().match(/\.(jpeg|jpg|gif|png)$/) || v.trim().match(
        ...
        return `<img src="${v}" alt="${e(
          "details.item.alert.defaultAltText",
          { alias: g }
        )}" />`;
      const d = "underline text-blue-700 break-all", a = document.createElement("div");
      return a.innerHTML = v.trim(), a.firstElementChild?.tagName == "A" ? (a.firstElementChild.className = d, a.innerHTML) : ve(v, {
        className: d,
        target: "_blank",
        validate: {
          url: ($) => /^https?:\/\//.test($)
      ...
      const g = parseInt(v);
      return isNaN(g) ? v : new Date(g).toISOString().split("T")[0];
    };
    return (v, g) => (i(), o("div", null, [
      (i(!0), o(Z, null, W(r(), (d, a, c) => (i(), o("div", {
        class: "p-5 pl-3 flex justify-end flex-wrap even:bg-gray-300",
        key: c
      }, [
        _("span", Xe, A(d.alias), 1),
        g[0] || (g[0] = _("span", { class: "flex-auto" }, null, -1)),
        _("span", {
          class: "inline",
  ...
  setup(h) {
    const e = oe(), t = h, s = ee("iApi"), l = w([]), r = R(), { t: u } = V(), y = w(""), m = w("none"), v = w(), g = () => e.getLayerByUid(t.uid), d = L(
      () => r.properties
    ), a = L(
      () => r.defaultTemplates
    ), c = L(() => g()?.supportsFeatures ?? !1), $ = L(() => g()?.mapLayer ?? !1), D = L(() => {
      const n = g()?.nameField;
      let f = n && t.data.loaded ? t.data.data[n] : s.$i18n.t("details.items.title");
      return s.ui.isPlainText(f) && (f = s.ui.escapeHtml(f)), f;
    }), E = (n) => {
      if (typeof n == "string") {
        const f = "underline text-blue-700 break-all", H = document.createElement("div");
        return H.innerHTML = n.trim(), H.firstElementChild?.tagName == "A" ? (H.firstElementChild.className = f, H.innerHTML) : ve(n, {
          className: f,
          target: "_blank",
          validate: {
            url: (B) => /^https?:\/\//.test(B)
      ...
      M("none"), t.data.loaded ? T() : t.data.load().then(() => {
        T();
      });
    }, T = () => {
      ...
      if (n.supportsFeatures) {
        const f = n.oidField;
        n.getIcon(t.data.data[f]).then((H) => {
          y.value = H;
        });
      }
    }, I = L(() => {
      const n = g();
      return n && d.value[n.id] && d.value[n.id].template ? d.value[n.id].template : a.value && a.value[t.data.format] ? a.value[t.data.format] : c.value ? tt : at;
    }), S = L(() => c.value ? g()?.fields || [] : []), N = L(() => {
      const n = g();
      if (n && d.value[n.id] && d.value[n.id].fields)
        return d.value[n.id].fields;
    }), M = (n) => {
      n === "zoomed" || n === "error" ? setTimeout(() => {
        m.value = n, v.value?._tippy.show(), setTimeout(() => {
          v.value?._tippy.hide(), m.value = "none";
        }, 3e3);
      }, 300) : m.value = n;
    }, U = () => {
      if (m.value !== "none")
      ...
      const f = t.data.data[n.oidField], H = () => {
        const O = { getGeom: !0 };
        n.getGraphic(f, O).then((B) => {
          B.geometry.invalid() ? (console.error(`Could not find graphic for objectid ${f}`), M("error")) : (s.geo.map.zoomMapTo(B.geometry), M("zoomed"), s.updateAlert(s.$i18n.t("details.item.alert.zoom")));
        }).catch(() => {
          M("error");
        });
      };
      n.layerType === Ie.FEATURE && n.geomType !== Te.POINT ? n.getGraphicExtent(f).then((O) => {
        s.geo.map.zoomMapTo(O), M("zoomed"), s.updateAlert(s.$i18n.t("details.item.alert.zoom"));
      }).catch(() => {
        H();
      }) : H();
    };
    return Y(() => {
      ...
      return i(), o(Z, null, [
        _("div", lt, [
          c.value ? (i(), o("div", nt, [
            _("div", ot, [
              h.data.loaded && y.value ? (i(), o("span", {
                key: 0,
                class: "flex-none symbologyIcon",
                innerHTML: y.value
              }, null, 8, rt)) : (i(), o("div", ut, f[1] || (f[1] = [
                _("div", { class: "animate-spin spinner h-20 w-20" }, null, -1)
              ])))
            ]),
            h.data.loaded ? C((i(), o("span", {
              key: 0,
            ...
            ]) : (i(), o("div", ct, A(k(u)("details.loading")), 1)),
            h.data.loaded ? (i(), o("span", mt, [
              $.value ? C((i(), o("button", {
                key: 0,
                type: "button",
                content: k(u)(
                  `details.item.zoom${m.value === "none" ? "" : `.${m.value}`}`
                ),
                "aria-label": k(u)(
                  `grid.cells.zoom${m.value === "none" ? "" : `.${m.value}`}`
                ),
                ref_key: "zoomButton",
                ref: v,
                onClick: f[0] || (f[0] = (B) => {
                ...
                m.value === "zooming" ? (i(), o("div", vt)) : m.value === "zoomed" ? (i(), o("svg", ft, f[2] || (f[2] = [
                  _("path", {
                    "stroke-linecap": "round",
                    "stroke-linejoin": "round",
                    d: "M4.5 12.75l6 6 9-13.5"
                  }, null, -1)
                ]))) : m.value === "error" ? (i(), o("svg", ht, f[3] || (f[3] = [
                  _("path", {
                    "stroke-linecap": "round",
                    "stroke-linejoin": "round",
        ...
        h.open ? (i(), q(Le(I.value), {
          key: 0,
          identifyData: h.data,
          fields: S.value,
          fixtureFields: N.value,
          class: "p-8"
        }, null, 8, ["identifyData", "fields", "fixtureFields"])) : z("", !0)
      ], 64);
    };
  }
}), yt = {
...
}, kt = { class: "flex" }, wt = ["aria-label"], $t = ["content", "aria-label", "disabled"], Lt = { class: "px-3 text-center flex-grow" }, It = ["content", "aria-label", "disabled"], Tt = { key: 3 }, St = { key: 0 }, Ht = ["content"], At = ["onClick"], zt = {
  key: 1,
  class: "text-center"
}, Dt = {
  key: 4,
  ...
  setup(h) {
    const e = w(), t = () => {
    ...
    }, l = ee("iApi"), r = R(), u = oe(), y = h, { t: m } = V(), v = w(!1), g = w(l.fixture.get("details")), d = w(!0), a = w(!1), c = w(0), $ = w(20), D = w([]), E = w([]), b = L(() => r.activeGreedy), T = L(
      () => r.properties
    ), I = L(() => c.value + $.value), S = () => u.getLayerByUid(y.uid), N = L(() => y.results.find((x) => x.uid === y.uid)?.loaded ?? !1), M = L(() => y.results.find((x) => x.uid === y.uid)?.requestTime), U = L(
      () => v.value && (!a.value && f().length > 1 || a.value && f().length > $.value)
    ), n = L(() => {
      const p = S();
      return p && T.value[p.id] && T.value[p.id].name ? T.value[p.id].name : p?.name ?? "";
    }), f = () => {
      const p = y.results.find((x) => x.uid === y.uid);
      return p ? p.items : [];
    }, H = L(() => f()[c.value]), O = L(() => {
      if (g.value.hasHilighter()) {
        const p = S();
        if (p)
      ...
      const p = S();
      c.value = c.value ?? 0, d.value = r.hilightToggle ?? d.value, a.value = !1, v.value = !!p, K();
    }, re = (p) => {
      a.value ? c.value += p * $.value : c.value += p;
    }, K = () => {
      const p = f();
      if (d.value && N && p.length > 0 && O.value)
        if (a.value)
          g.value.hilightDetailsItems(
            p.slice(c.value, I.value),
            y.uid
          );
        else {
          const x = p[c.value];
          x && g.value.hilightDetailsItems([x], y.uid);
        }
      else
        g.value.removeDetailsHilight();
    }, he = () => {
      a.value = !0, c.value = Math.floor(c.value / $.value) * $.value, K();
    }, ge = () => {
      g.value.removeDetailsHilight();
    }, ye = () => {
      g.value.removeDetailsHilight();
    ...
    return le(() => {
      D.value.push(
        l.event.on(
          Q.LAYER_REMOVE,
          (p) => {
            const x = l.panel.get("details-panel");
            y.uid === p.uid && x && x.close();
          }
        )
      ), D.value.push(
      ...
      E.value.push(
        G(
          () => f(),
          () => {
            fe(), H.value === void 0 && g.value.removeDetailsHilight();
          },
          {
            deep: !1,
            immediate: !0
      ...
      E.value.forEach((p) => p()), D.value.forEach((p) => l.event.off(p)), e.value?.removeEventListener("blur", t), e.value?.removeEventListener("keyup", s);
    }), (p, x) => {
      ...
      return N.value && b.value === 0 ? (i(), o("div", {
        ...
        style: me(h.results.length > 1 ? { "margin-left": "42px" } : "")
      }, [
        v.value ? C((i(), o("h1", yt, [
          ae(A(n.value), 1)
        ])), [
        ...
        O.value ? (i(), o("div", bt, [
          _("label", _t, A(k(m)("details.togglehilight.title")), 1),
          ie(De, {
            config: {
              value: d.value,
              disabled: !1
        ...
        U.value ? (i(), o("div", xt, [
          _("div", kt, [
            a.value ? z("", !0) : (i(), o("button", {
              key: 0,
              type: "button",
              class: "px-8 font-bold hover:bg-gray-200 focus:bg-gray-200",
              "aria-label": k(m)("details.item.see.list"),
              onClick: x[0] || (x[0] = (J) => he())
            }, A(k(m)("details.item.see.list")), 9, wt)),
            _("div", {
              class: P(["flex ml-auto bg-gray-200 py-8 items-center", { "w-full": a.value }])
            }, [
              C((i(), o("button", {
                type: "button",
                content: k(m)(
              ...
              _("span", Lt, A(a.value ? k(m)("details.items.range", [
                c.value + 1,
                Math.min(
                  I.value,
                  f().length
        ...
        v.value ? (i(), o("div", Tt, [
          f().length > 0 ? (i(), o("div", St, [
            a.value ? C((i(), o("div", {
              key: 0,
              class: "flex flex-col",
              content: k(m)("details.layers.results.list.tooltip"),
              ref_key: "el",
              ref: e
            }, [
              (i(!0), o(Z, null, W(f().slice(
                c.value,
                I.value
              ), (J, ue) => C((i(), o("button", {
                class: "flex flex-grow truncate default-focus-style hover:bg-gray-200",
                key: ue,
                onClick: (jt) => be(c.value + ue)
              }, [
                ie(ce, {
                  data: J,
                  uid: h.uid,
          ...
          ])) : (i(), o("div", zt, A(k(m)("details.layers.results.empty.currentLayer")), 1))
        ])) : (i(), o("div", Dt, A(k(m)("details.item.no.data")), 1))
      ], 4)) : (i(), o("div", {
        key: 1,
        class: P(["flex justify-center py-10 items-center", h.results.length > 1 ? "ml-42" : ""])
      }, [
        x[5] || (x[5] = _("span", { class: "animate-spin spinner h-20 w-20 px-5 mr-8" }, null, -1)),
        ae(" " + A(k(m)("details.item.loading")), 1)
      ], 2));
    };
  }
  ...
  setup(h) {
    const { t: e } = V(), t = ee("iApi"), s = R(), l = w([]), r = w([]), u = w([]), y = w(!1), m = w(""), v = L(() => s.activeGreedy), g = L(() => s.payload), d = L(
      () => s.properties
    ), a = (b) => {
      m.value = b;
    }, c = (b) => u.value.find((T) => T.uid === b), $ = (b) => {
      b !== void 0 && (s.activeGreedy = b.length === 0 ? 0 : b[0].requestTime, u.value = b, D(b));
    }, D = (b) => {
      if (m.value) {
        const T = c(m.value);
        T ? T.loading.then(() => {
          T.requestTime === v.value && (T.items.length > 0 ? (s.activeGreedy = 0, y.value = !1) : E(b));
        }) : E(b);
      } else
        E(b);
    }, E = (b) => {
      ...
      ), I = b.length === 0 ? 0 : b[0].requestTime;
      Promise.any(T).then((S) => {
        if (S.requestTime !== v.value)
          return;
        const N = c(S.uid);
        s.activeGreedy = 0, N && (m.value = N.uid, y.value = !1);
      }).catch(() => {
        I === v.value && (s.activeGreedy = 0, y.value = !0);
      });
    };
    return Y(() => {
      r.value.push(
      ...
      const I = Se("panel-screen");
      return i(), q(I, { panel: h.panel }, {
        header: de(() => [
          ae(A(
            // Show different titles based on what requested the panel
            k(s).origin === "toggleEvent" ? k(e)("details.layers.title.gridOrigin") : k(e)("details.layers.title.identifyOrigin")
          ), 1)
        ]),
        content: de(() => [
          _("div", Ct, [
            u.value.length > 1 ? (i(), q(Ye, {
              key: 0,
              results: u.value,
              detailsProperties: d.value,
              selected: m.value,
              onSelectionChanged: a
            }, null, 8, ["results", "detailsProperties", "selected"])) : z("", !0),
            _("div", Ft, [
              y.value ? (i(), o("div", {
                key: 1,
                class: P([
              ...
              }, A(u.value.length >= 1 ? k(e)("details.layers.results.empty") : k(e)("details.layers.results.empty.noLayers")), 3)) : (i(), q(Mt, {
                key: 0,
                uid: m.value,
                results: u.value
              }, null, 8, ["uid", "results"]))
...
//# sourceMappingURL=index-BEpOKr6B.js.map
