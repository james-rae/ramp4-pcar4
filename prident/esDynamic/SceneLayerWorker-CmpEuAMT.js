import { hX as K, bh as D } from "./main-CTfNeatF.js";
import { y as X } from "./DoubleArray-DUv7tKeJ.js";
import { i as Q, a as W } from "./MeshLocalVertexSpace--0_P1_dE.js";
import { n as Z, s as ee } from "./vec3-BN3nI3lH.js";
import "./sphere-BIosHDYF.js";
import "./I3SUtil-DrI1EobP.js";
var S, $;
(function(e) {
...
function te() {
  return x || (x = new Promise((e) => import("./i3s-Dfo5LaiC.js").then((t) => t.i).then(({ default: t }) => {
...
async function be(e) {
  ...
  if (i.type === "georeferenced" && i.origin == null) {
    const [{ projectBuffer: c }, { initializeProjection: b }] = await Promise.all([import("./main-CTfNeatF.js").then((d) => d.qK), import("./main-CTfNeatF.js").then((d) => d.qL)]);
    await b(f, l), s = new Float64Array(a.length), c(a, f, 0, s, l, 0, s.length / 3);
  } else {
    const c = i.type === "georeferenced" ? Q.fromJSON(i) : W.fromJSON(i), { project: b } = await import("./georeference-x2vLv-zK.js").then((d) => d.g);
...
//# sourceMappingURL=SceneLayerWorker-CmpEuAMT.js.map
