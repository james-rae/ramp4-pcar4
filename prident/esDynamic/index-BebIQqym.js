import { iO as A, iP as y, bx as M, fB as $, ha as O, fK as D, hb as B } from "./main-sj-uz2v-.js";
import { _ as k } from "./screen.vue_vue_type_script_setup_true_lang-ep_oiqIF.js";
var H = { exports: {} };
(function(S, i) {
  (function(n, a) {
    a();
...
class _ extends M {
   ...
   */
  async make(i, n) {
    const { fabric: a } = await import("./fabric-CvZ9Xkl_.js").then((g) => g.f);
...
class I extends _ {
  ...
  async needed() {
    const i = (await import("./index-DXvW4P9d.js")).default, n = (await import("./index-QYmQOp9C.js")).default, a = (await import("./index-C6btLOis.js")).default, w = (await import("./index-BgUPcSsc.js")).default, p = (await import("./index-BLHBqGV_.js")).default, r = (await import("./index-Dxc_BkLu.js")).default, b = (await import("./index-CuyFNhUX.js")).default;
...
//# sourceMappingURL=index-BebIQqym.js.map
