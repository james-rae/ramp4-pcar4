import { hX as K, bh as D } from "./main-B8aVjPQ9.js";
import { y as X } from "./DoubleArray-DZxJglF7.js";
import { i as Q, a as W } from "./MeshLocalVertexSpace-BvhwwrHo.js";
import { n as Z, s as ee } from "./vec3-B3Ib854D.js";
import "./sphere-ilXuk5qU.js";
import "./I3SUtil-hKnm7aeL.js";
var S, $;
(function(e) {
...
function te() {
  return x || (x = new Promise((e) => import("./i3s-D3eqf9oS.js").then((t) => t.i).then(({ default: t }) => {
...
async function be(e) {
  ...
  if (i.type === "georeferenced" && i.origin == null) {
    const [{ projectBuffer: c }, { initializeProjection: b }] = await Promise.all([import("./main-B8aVjPQ9.js").then((d) => d.qK), import("./main-B8aVjPQ9.js").then((d) => d.qL)]);
    await b(f, l), s = new Float64Array(a.length), c(a, f, 0, s, l, 0, s.length / 3);
  } else {
    const c = i.type === "georeferenced" ? Q.fromJSON(i) : W.fromJSON(i), { project: b } = await import("./georeference-vfSnhH6_.js").then((d) => d.g);
...
//# sourceMappingURL=SceneLayerWorker-C5YI5Owl.js.map
