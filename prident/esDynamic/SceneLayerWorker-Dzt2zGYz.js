import { hX as K, bh as D } from "./main-sj-uz2v-.js";
import { y as X } from "./DoubleArray-C6MeRRLI.js";
import { i as Q, a as W } from "./MeshLocalVertexSpace-CFPpkA4u.js";
import { n as Z, s as ee } from "./vec3-woHv7ONU.js";
import "./sphere-MpUpe9D7.js";
import "./I3SUtil-BoYo3TXG.js";
var S, $;
(function(e) {
...
function te() {
  return x || (x = new Promise((e) => import("./i3s-C--5FRBu.js").then((t) => t.i).then(({ default: t }) => {
...
async function be(e) {
  ...
  if (i.type === "georeferenced" && i.origin == null) {
    const [{ projectBuffer: c }, { initializeProjection: b }] = await Promise.all([import("./main-sj-uz2v-.js").then((d) => d.qK), import("./main-sj-uz2v-.js").then((d) => d.qL)]);
    await b(f, l), s = new Float64Array(a.length), c(a, f, 0, s, l, 0, s.length / 3);
  } else {
    const c = i.type === "georeferenced" ? Q.fromJSON(i) : W.fromJSON(i), { project: b } = await import("./georeference-Cns7PzAf.js").then((d) => d.g);
...
//# sourceMappingURL=SceneLayerWorker-Dzt2zGYz.js.map
