import { af as le, hX as ue } from "./main-CTfNeatF.js";
...
async function xe() {
  ee = await (le("esri-csp-restrictions") ? await import("./libtess-asm-DZUl-JfE.js").then((i) => i.l) : await import("./libtess-BlPfMbVl.js").then((i) => i.l)).default({ locateFile: (i) => ue(`esri/core/libs/libtess/${i}`) });
}
function sr(s, i) {
...
//# sourceMappingURL=TurboLine-BuYh_O9R.js.map
