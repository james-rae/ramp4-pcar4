import { af as le, hX as ue } from "./main-B8aVjPQ9.js";
...
async function xe() {
  ee = await (le("esri-csp-restrictions") ? await import("./libtess-asm-BAQYcP7G.js").then((i) => i.l) : await import("./libtess-C8eiIbIw.js").then((i) => i.l)).default({ locateFile: (i) => ue(`esri/core/libs/libtess/${i}`) });
}
function sr(s, i) {
...
//# sourceMappingURL=TurboLine-B7GIU62h.js.map
