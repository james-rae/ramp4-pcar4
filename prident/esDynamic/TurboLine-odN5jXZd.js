import { af as le, hX as ue } from "./main-sj-uz2v-.js";
...
async function xe() {
  ee = await (le("esri-csp-restrictions") ? await import("./libtess-asm-2nmybNjJ.js").then((i) => i.l) : await import("./libtess-DBbO0VQL.js").then((i) => i.l)).default({ locateFile: (i) => ue(`esri/core/libs/libtess/${i}`) });
}
function sr(s, i) {
...
//# sourceMappingURL=TurboLine-odN5jXZd.js.map
