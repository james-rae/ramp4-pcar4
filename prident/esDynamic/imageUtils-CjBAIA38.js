import { am as m, au as d, a2 as u, K as w, s as p } from "./main-B8aVjPQ9.js";
let r = null, s = !0;
function T(e, a, t) {
...
async function B(e, a) {
  ...
  if (n === "image/gif") {
    const { isAnimatedGIF: o, parseGif: c } = await import("./gif-FJA_5jUs.js");
    if (o(t)) return c(t, a);
  }
  if (i) {
    const { isAnimatedPNG: o, parseApng: c } = await import("./apng-3HIt8td6.js");
    if (o(t)) return c(t, a);
  }
...
//# sourceMappingURL=imageUtils-CjBAIA38.js.map
