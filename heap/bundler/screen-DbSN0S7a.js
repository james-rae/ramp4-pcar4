import { defineComponent as A, inject as H, ref as O, computed as T, reactive as C, onMounted as j, watch as R, onBeforeUnmount as X, resolveComponent as V, openBlock as s, createBlock as F, withCtx as k, createTextVNode as q, toDisplayString as c, unref as g, createElementBlock as i, createElementVNode as h } from "vue";
import { q as B, G as D } from "./main-C_46O0w1.js";
import "pinia";
...
`, J = { key: 0 }, K = { class: "flex justify-center" }, Q = {
  ...
  setup(r) {
    const o = B(), { t: l } = G(), u = H("iApi"), M = O(), a = r, f = T(() => o.status), v = T(() => o.response), b = O(!1), x = C({}), y = C([]), S = C([]);
    j(() => {
      $(), y.push(
        u.event.on(D.LAYER_REMOVE, (t) => {
    ...
    return (t, e) => {
      ...
      return s(), F(n, {
        ...
        header: k(() => [
          q(c(g(l)("metadata.title")) + ": " + c(r.payload.layerName), 1)
        ]),
        content: k(() => [
          b.value ? (s(), i("div", J, [
            h("div", K, [
