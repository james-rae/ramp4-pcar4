import { defineComponent as ie, ref as b, watch as ye, toRef as je, openBlock as v, createElementBlock as g, createElementVNode as s, toDisplayString as y, unref as o, inject as ge, useTemplateRef as ee, reactive as re, onMounted as he, onBeforeUnmount as ce, resolveDirective as Ie, createCommentVNode as L, createVNode as $, withCtx as C, withDirectives as be, normalizeClass as se, createTextVNode as we, Fragment as Ye, renderList as Ke, vShow as Ae, Transition as Je, renderSlot as Te, computed as H, provide as Ze, onErrorCaptured as Qe, resolveComponent as Xe, createBlock as q, withModifiers as $e, nextTick as et } from "vue";
import { ColorPicker as tt } from "vue-accessible-color-picker";
import { _ as ve, H as lt, L as S, W as K, G as Oe, K as pe } from "./main-C_46O0w1.js";
...
const ot = { class: "flex justify-end mb-20" }, nt = ["disabled", "animation"], st = { class: "button-text" }, rt = /* @__PURE__ */ ie({
  ...
  key: 1,
  class: "text-red-900 text-xs"
}, Vt = { key: 3 }, At = ["aria-label"], $t = { class: "text-base font-bold" }, Ot = { key: 4 }, It = { class: "text-base font-bold" }, Tt = { class: "relative mb-0.5" }, Ct = ["value", "aria-label"], Mt = {
  key: 0,
  class: "text-red-900 text-xs"
}, Rt = /* @__PURE__ */ ie({
  __name: "form-input",
  ...
  setup(n, { expose: c, emit: l }) {
    const w = ge("iApi"), { t: E } = Se(), h = l, p = n, A = b(), M = ee("textInput"), I = ee("selectInput"), _ = ee("urlInput");
    c({ selectInput: I, textInput: M, urlInput: _ });
    const z = b(!1), W = b(!1), D = b(!1), te = b(!1), B = b([...p.selectedValues]), P = b("value-label"), J = b("option-label"), R = b(void 0), T = b(null), G = re([]);
    ...
    const Z = (u) => {
      ...
      le(u.target.value), h("link", u.target.value, z), W.value = !1;
    }, x = (u, i) => {
      h(u ? "select" : "update:modelValue", i.target.value);
    }, ae = (u) => {
      h("nested", u.target.checked);
    }, oe = (u) => {
      Z(u.target.value), h("link", u.target.value, z), D.value = !1;
    }, V = () => {
        ...
        n.type === "file" ? (v(), g("div", it, [
          ...
          s("div", mt, [
            s("input", {
              ...
              value: n.modelValue,
              "aria-label": p.ariaLabel,
              onChange: i[1] || (i[1] = (f) => z.value ? W.value = !1 : W.value = !0),
              onInput: i[2] || (i[2] = (f) => {
                Q(f);
              }),
              ref_key: "urlInput",
          ...
          W.value ? (v(), g("div", yt, y(n.modelValue ? n.validationMessages?.invalid : n.validationMessages?.required), 1)) : L("", !0)
            ...
            n.multiple ? (v(), g("div", St, [
              s("div", {
                ...
                $(o(at), {
                  ...
                  [J.value]: C(({ node: f, labelClassName: ne }) => [
                    be((v(), g("label", {
                      class: se(ne)
                    }, [
                      we(y(f.label), 1)
          ...
          s("div", Tt, [
            s("input", {
              ...
              value: n.modelValue,
              "aria-label": p.ariaLabel,
              onChange: i[9] || (i[9] = (f) => z.value ? D.value = !1 : D.value = !0),
              onInput: i[10] || (i[10] = (f) => {
                oe(f);
              }),
              ref_key: "textInput",
...
}, Bt = { class: "flex flex-col overflow-hidden" }, qt = { class: "pl-12 flex items-center text-md" }, Ht = { class: "pl-12 text-xs transition-opacity duration-1000 ease-out" }, Wt = /* @__PURE__ */ ie({
  __name: "stepper-item",
  props: {
    title: {
      type: String,
  ...
  setup(n, { emit: c }) {
    const l = ge("stepper"), w = b(), E = c, h = b(-1), p = (I) => {
      M() || (I.stopPropagation(), E("focusPanel"), E("focusFirstElement"));
    };
    he(() => {
...
}), me = /* @__PURE__ */ ve(Wt, [["__scopeId", "data-v-53b5c8d8"]]), Dt = { class: "py-12 h-auto stepper" }, Pt = /* @__PURE__ */ ie({
  __name: "stepper",
  props: {
    activeStep: {
      type: Number,
...
}, Zt = { class: "sr-only" }, Qt = { class: "sr-only" }, Xt = /* @__PURE__ */ ie({
  __name: "screen",
  props: {
    panel: {
      type: Object,
  ...
  setup(n) {
    const c = lt(), { t: l } = Se(), w = ge("iApi"), E = b(), h = b([]), p = H(() => c.layerSource), A = H(() => c.currStep), M = b(), I = b(), _ = b(0), z = b(!1), W = b(), D = ee("stepOneStart"), te = ee("stepTwoStart"), B = ee("stepThreeStart"), P = b(!1), J = b(!1), R = b(!1), T = b(!1), G = b(!1), Z = b(!1), le = b(!0), ue = b(""), Q = b(""), x = b([]), ae = re([
      {
        value: S.FEATURE,
    ...
    const f = async (e) => {
      ...
      }), d.userAdded = !0, w.event.emit(Oe.USER_LAYER_ADDED, d), R.value = !1, c.goToStep(K.UPLOAD);
      ...
      do
        I.value = Math.random().toString(36).substring(2, 9);
      while (document.getElementById(I.value + "-hue-slider") !== null);
    }, We = (e) => {
      ...
      R.value = !1, c.goToStep(0), U(D);
    }, Pe = () => {
      z.value = !1, P.value = !1, J.value = !1, R.value = !!V.value, G.value = !1, c.goToStep(0), Q.value = "";
    }, Ge = () => {
              ...
              $(me, {
                ...
                default: C(() => [
                  s("form", {
                    ...
                    s("label", {
                      class: "sr-only",
                      for: `${I.value}-color-hex`
                    }, y(o(l)("wizard.configure.colour.hex")), 9, Kt),
                    a.value?.configOptions.includes("colour") ? (v(), g("label", Jt, y(o(l)("wizard.configure.colour.label")), 1)) : L("", !0),
                    a.value?.configOptions.includes("colour") ? (v(), q(o(tt), {
                      ...
                      "hue-range-input-label": C(() => [
                        s("span", Zt, y(o(l)("wizard.configure.colour.hue")), 1)
                      ]),
                      "copy-button": C(() => [
...
}), Ul = /* @__PURE__ */ ve(Xt, [["__scopeId", "data-v-b4e000a5"]]);
export {
  Ul as default
};
