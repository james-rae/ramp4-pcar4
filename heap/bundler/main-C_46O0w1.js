...
import { defineStore as j, createPinia as ss } from "pinia";
import { ref as f, computed as N, markRaw as se, defineComponent as O, inject as ve, reactive as we, watch as xt, onBeforeUnmount as dt, resolveDirective as k, withDirectives as M, openBlock as g, createElementBlock as A, withKeys as rs, withModifiers as Zt, onMounted as Je, normalizeClass as oe, normalizeStyle as Li, createVNode as re, Transition as Ri, withCtx as ee, createBlock as W, resolveDynamicComponent as os, mergeProps as as, TransitionGroup as $i, Fragment as We, renderList as ht, unref as S, nextTick as $t, renderSlot as Me, createElementVNode as h, vShow as ns, resolveComponent as K, createTextVNode as at, toDisplayString as B, createCommentVNode as U, onUpdated as ls, Teleport as cs, getCurrentInstance as us, useTemplateRef as ci, createApp as Ci, toRaw as Se, h as ps, render as Gt, defineAsyncComponent as ds } from "vue";
...
import { applyConverter as As } from "@terraformer/spatial";
...
import { geojsonToArcGIS as Rs } from "@terraformer/arcgis";
...
class Te extends ke {
  ...
  constructor(e) {
    ...
    this._width = typeof t > "u" || t < 0 ? 0.75 : t, this._colour = new Pe(e.colour), this._miter = e.miter ?? 2, this._cap = e.cap || Ni.ROUND, this._join = e.join || Pi.ROUND;
  }
...
class yt extends ke {
  ...
  _fillStyle;
  constructor(e) {
    super(), e = e || {}, e.fill || (e.fill = {}), this._fillColour = new Pe(e.fill.colour), this._fillStyle = e.fill.style || Fi.SOLID, this._outlineStyle = new Te(e.outline);
  }
  /** Returns the specified colour */
  get fillColour() {
  ...
  toESRI() {
    const e = this.outline.toESRI(), t = new St(this.fillColour.rgba), i = new bs();
...
const Ws = ["data-cy"], Vi = /* @__PURE__ */ O({
    ...
    return (n, c) => {
      ...
      return g(), A("div", {
        ...
        re(Ri, {
          ...
          default: ee(() => [
            M((g(), W(os(r.panel.route.screen), as({ class: "h-full" }, r.panel.route.props, { panel: r.panel }), null, 16, ["panel"])), [
              [u]
            ])
          ]),
          _: 1
  ...
  function C() {
    ...
    for (let Fe = n.value.length - 1; Fe >= 0; Fe--) {
      const et = n.value[Fe];
      let Re = et.width || ae;
      if (s.value ? Re = _ : Re += fe, et.id === "grid" && (Re = Math.max(Math.min(Re, _), ni)), (_ >= Re && !s.value || R.length === 0) && (_ -= Re, R.unshift(et)), et.id === "grid" && _ < ni)
        break;
    }
    if (r.value && //@ts-expect-error TODO: explain why this is needed or remove
    !R.includes(r.value) && !s.value) {
      let Fe;
      for (let li = 0; li < R.length - 1 && _ < (r.value.width || ae) + fe; li++)
  ...
  setup(r) {
    ...
    return (c, u) => (g(), W($i, {
      ...
      default: ee(() => [
        (g(!0), A(We, null, ht(o(S(t).screenSize), (p) => (g(), W(Vi, {
          key: `${p.id}`,
          panel: p
        }, null, 8, ["panel"]))), 128))
      ]),
  ...
  for (const [i, s] of e)
    t[i] = s;
  return t;
}, Ys = /* @__PURE__ */ Ne(Hs, [["__scopeId", "data-v-197830c4"]]), Js = ["content", "aria-label"], Xt = /* @__PURE__ */ O({
            ...
            h("div", Ks, [
              M((g(), A("button", {
                ...
                h("svg", {
                  ...
                  h("path", { d: "M13 17h-9a4 4 0 0 0 2 -3v-3a7 7 0 0 1 4 -6a2 2 0 1 1 4 0a7 7 0 0 1 4 6v2" }),
                  h("path", { d: "M9 17v1a3 3 0 0 0 4.194 2.753" }),
                  h("path", { d: "M22 22l-5 -5" }),
                  h("path", { d: "M17 22l5 -5" })
                ], -1)
              ]), 10, Qs)), [
                [n, {
...
const tr = ["content"], ir = { class: "flex items-center text-left" }, sr = { class: "select-text cursor-text" }, rr = ["content"], or = {
      ...
      return M((g(), A("li", {
        ...
        h("div", ir, [
          h("span", null, [
            ...
            h("span", sr, B(r.notification.message), 1)
          ]),
          c[4] || (c[4] = h("span", { class: "flex-grow" }, null, -1)),
    ...
    return (l, n) => {
      ...
      return g(), A("div", null, [
        a.value.length > 0 ? M((g(), A("ul", {
          ...
          n[0] || (n[0] = h("span", { class: "flex-grow" }, null, -1)),
          n[1] || (n[1] = h("svg", {
            xmlns: "http://www.w3.org/2000/svg",
            viewBox: "0 0 24 24",
          ...
          h("span", null, B(S(t)("notifications.empty")), 1),
          n[2] || (n[2] = h("span", { style: { "flex-grow": "6" } }, null, -1))
        ]))
      ]);
    };
  }
    ...
    return (o, a) => {
      ...
      return g(), W(Xt, {
        ...
        header: ee(() => [
          h("div", ur, [
            (g(), A("svg", {
              ...
              h("path", { d: "M12 22c1.1 0 2-.9 2-2h-4c0 1.1.89 2 2 2zm6-6v-5c0-3.07-1.64-5.64-4.5-6.32V4c0-.83-.67-1.5-1.5-1.5s-1.5.67-1.5 1.5v.68C7.63 5.36 6 7.92 6 11v5l-2 2v1h16v-1l-2-2z" }, null, -1)
            ]), 8, pr)),
        ...
        default: ee((c) => [
          h("div", hr, [
            h("div", null, [
              h("h4", fr, B(S(t)("notifications.title")), 1),
              h("div", mr, [
                M((g(), A("button", {
                  type: "button",
                  onClick: s,
...
}), vr = /* @__PURE__ */ Ne(gr, [["__scopeId", "data-v-3623a7d2"]]), br = { class: "flex hover:text-white" }, wr = ["aria-label"], Ar = { class: "about-ramp-dropdown pointer-events-auto bg-white rounded w-256 h-50" }, Er = ["aria-label", "content"], xr = { class: "pb-8 border-b border-gray-600 mb-10" }, Sr = { class: "absolute right-5 top-5" }, _r = { class: "select-text" }, Ir = { class: "font-bold cursor-text" }, Tr = { class: "text-sm cursor-text" }, Lr = { class: "text-sm cursor-text" }, Rr = /* @__PURE__ */ O({
        ...
        default: ee((b) => [
          h("div", Ar, [
            h("div", null, [
              ...
              h("div", _r, [
                h("div", null, [
                  h("span", Ir, B(s.value), 1),
                  h("span", Tr, " [" + B(o.value) + "] ", 1)
                ]),
                h("div", null, [
                  h("span", Lr, B(a.value), 1)
                ]),
                n[2] || (n[2] = h("div", { class: "mt-5" }, [
                  h("a", {
...
}), $r = /* @__PURE__ */ Ne(Rr, [["__scopeId", "data-v-dc5124c0"]]), Cr = { class: "map-caption absolute bottom-0 h-29 sm:h-38 flex justify-end pointer-events-auto cursor-default select-none text-gray-200 bg-black-75 left-0 right-0 py-2 sm:py-6" }, Or = {
  key: 0,
  ...
  __name: "map-caption",
  setup(r) {
    const e = Ue(), t = de(), { t: i } = H(), s = ve("iApi"), o = N(() => e.scale), a = N(() => e.attribution), l = N(() => e.coords), n = N(() => e.langtoggle), c = N(() => t.config.map), u = f([]), p = we([]);
    p.push(
      xt(c, (w) => {
    ...
    return (w, v) => {
      ...
      return g(), A("div", Cr, [
        ...
        a.value?.text.disabled ? U("", !0) : M((g(), A("span", Pr, [
        ...
        v[0] || (v[0] = h("span", { class: "flex-grow w-15" }, null, -1)),
        h("div", Nr, [
          l.value?.disabled ? U("", !0) : M((g(), A("div", Fr, [
          ...
          n.value?.disabled ? U("", !0) : (g(), W($, {
            ...
            header: ee(() => [
              h("span", Ur, B(S(i)("map.language.short")), 1)
            ]),
            default: ee(() => [
              (g(!0), A(We, null, ht(u.value, (F, ce) => (g(), A("a", {
                ...
                F === S(s).$i18n.locale.value ? (g(), A("span", zr, B(S(i)("map.language.curr")), 1)) : U("", !0)
              ], 10, Br))), 128))
            ]),
            _: 1
          }, 8, ["tooltip", "ariaLabel"]))
  ...
  setup(r) {
    ...
    return (o, a) => {
      ...
      return M((g(), A("button", {
        ...
        s.value && s.value > 0 ? (g(), A("span", qr, B(s.value), 1)) : U("", !0)
      ], 8, jr)), [
        [l]
      ]);
    };
  }
}), Hr = /* @__PURE__ */ Ne(Wr, [["__scopeId", "data-v-a451db5c"]]), Yr = { class: "flex items-center mb-20" }, Jr = { class: "text-xl" }, Zr = /* @__PURE__ */ O({
  __name: "keyboard-instructions",
  setup(r) {
    const e = ve("iApi"), { t } = H(), i = f(!1), s = f(["app", "lists", "map"]), o = f([]), a = f(null), l = f(null);
    Je(() => {
      o.value.push(
    ...
    return (c, u) => {
      ...
      return i.value ? (g(), A("div", {
        ...
        h("div", {
          ...
          h("div", Yr, [
            h("h2", Jr, B(S(t)("keyboardInstructions.title")), 1),
            re(p, {
              class: "ml-auto",
...
}), st = j("instance", () => ({ started: f(!1) })), Kr = { class: "h-full relative" }, Qr = { class: "inner-shell absolute top-0 left-0 h-full w-full pointer-events-none" }, Xr = { class: "absolute top-8 w-full flex justify-center" }, eo = {
  key: 1,
  class: "w-full h-full"
}, to = /* @__PURE__ */ O({
  __name: "shell",
  setup(r) {
    ...
    return (c, u) => (g(), A("div", Kr, [
      h("div", Qr, [
        u[0] || (u[0] = h("div", { class: "sr-only screen-reader-alert" }, null, -1)),
        h("div", Xr, [
          h("button", {
            type: "button",
        ...
        a.value ? U("", !0) : (g(), W(Hr, { key: 0 })),
        re(Vr, { class: "z-30" })
      ]),
      S(t).started ? (g(), W(js, { key: 0 })) : (g(), A("div", eo, u[1] || (u[1] = [
        h("div", { class: "spinner relative inset-x-1/2 inset-y-9/20" }, null, -1)
      ]))),
      (g(!0), A(We, null, ht(n(), (p) => (g(), W(cs, {
...
}), io = /* @__PURE__ */ Ne(to, [["__scopeId", "data-v-7a1e48c2"]]), so = O({
  name: "App",
  components: { Shell: io },
  setup() {
    const r = us();
...
const no = /* @__PURE__ */ Ne(so, [["render", ao]]), xe = "focus-list", je = "focus-item", lo = "focus-icon", co = "focus-container", ct = `[${xe}],[${co}]`, bt = "truncate-text", wt = "show-truncate", ot = "focused", Ht = `button,input,select,a,textarea,[contenteditable],[${xe}],[${lo}],[tabIndex]`, uo = {
  mounted(r, e) {
...
class po {
   ...
   */
  onFocus() {
    this.highlightedItem && !this.isClicked && (this.highlightedItem._tippy && this.highlightedItem._tippy.show(), this.highlightedItem.getAttribute(je) === wt && this.highlightedItem.querySelector(`[${bt}]`)?._tippy?.show()), this.isClicked = !1, this.element.hasAttribute("aria-activedescendant") || this.highlightedItem === this.element ? this.highlightedItem !== this.element && this.focusItem(this.highlightedItem) : this.setAriaActiveDescendant(this.highlightedItem), Wi(this.element), this.highlightedItem && this.highlightedItem !== this.element && this.highlightedItem.setAttribute("tabindex", "-1");
  }
  /**
...
const ei = "focus-container", Hi = "focus-list", mo = "focus-icon", Bt = `[${Hi}],[${ei}]`, mi = `button,input,select,a,textarea,[contenteditable],.ag-tab-guard,[${Hi}],[${ei}],[${mo}],[tabIndex]`;
let zt = [];
const yo = {
  mounted(r) {
    [...document.querySelectorAll(".inner-shell")].some((t) => t.contains(r)) && zt.push(new go(r));
  },
  beforeUnmount(r) {
...
const Eo = ["content"], xo = {
  ...
  setup(r, { expose: e }) {
    const { t } = H(), i = Ye(), s = Lt(), o = ve("iApi"), a = ci("el"), l = ci("contentEl"), n = f();
    e({ el: a });
    ...
    return Je(() => {
      ...
      return M((g(), A("div", {
        ...
        r.header ? (g(), A("header", xo, [
          re(T, {
            class: oe(r.panel.teleport ? "display-none" : "block sm:display-none"),
            onClick: $[0] || ($[0] = (fe) => r.panel.close())
          }, null, 8, ["class"]),
          M((g(), A("h2", So, [
            v.$slots.header ? Me(v.$slots, "header", { key: 0 }) : (g(), A("div", _o, B(S(t)(r.panel.alertName)), 1))
          ])), [
            [_]
          ]),
          ...
          h("div", {
            ...
            r.panel.teleport ? U("", !0) : (g(), A("div", Io, [
              d.value ? (g(), W(F, {
                key: 0,
      ...
      return g(), A("div", $o, [
        M((g(), A("button", {
          ...
          (g(), A("svg", {
            ...
            h("path", { d: "M298.028 214.267L285.793 96H328c13.255 0 24-10.745 24-24V24c0-13.255-10.745-24-24-24H56C42.745 0 32 10.745 32 24v48c0 13.255 10.745 24 24 24h42.207L85.972 214.267C37.465 236.82 0 277.261 0 328c0 13.255 10.745 24 24 24h136v104.007c0 1.242.289 2.467.845 3.578l24 48c2.941 5.882 11.364 5.893 14.311 0l24-48a8.008 8.008 0 0 0 .845-3.578V352h136c13.255 0 24-10.745 24-24-.001-51.183-37.983-91.42-85.973-113.733z" }, null, -1)
          ]), 8, Oo))
        ], 10, Co)), [
...
}), Uo = { class: "w-32 h-32" }, Bo = ["content", "aria-label"], zo = {
  key: 0,
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 24 24",
      ...
      return g(), A("div", Uo, [
        M((g(), A("button", {
          ...
          r.active ? (g(), A("svg", Vo, i[1] || (i[1] = [
            ...
            h("path", { d: "M8 19h3v3h2v-3h3l-4-4-4 4zm8-15h-3V1h-2v3H8l4 4 4-4zM4 9v2h16V9H4z" }, null, -1),
            h("path", { d: "M4 12h16v2H4z" }, null, -1)
          ]))) : (g(), A("svg", zo, i[0] || (i[0] = [
            h("path", {
              d: "M0 0h24v24H0z",
              fill: "none"
            ...
            h("path", { d: "M4 20h16v2H4zM4 2h16v2H4zm9 7h3l-4-4-4 4h3v6H8l4 4 4-4h-3z" }, null, -1)
          ])))
        ], 8, Bo)), [
          [s, {
            placement: "bottom",
      ...
      return g(), A("div", Yo, [
        M((g(), A("button", {
          ...
          h("svg", {
            ...
            h("path", { d: "M 8.59 16.34 L 13.17 11.75 L 8.59 7.16 L 10 5.75 L 16 11.75 L 10 17.75 Z" })
          ], -1)
        ]), 10, Jo)), [
          [s, {
            placement: "bottom",
      ...
      return g(), A("div", Ko, [
        M((g(), A("button", {
          ...
          h("svg", {
            ...
            h("path", { d: "M 15.41 16.09 L 10.83 11.5 L 15.41 6.91 L 14 5.5 L 8 11.5 L 14 17.5 Z" })
          ], -1)
        ]), 10, Qo)), [
          [s, {
            placement: "bottom",
...
}), ta = /* @__PURE__ */ Ne(ea, [["__scopeId", "data-v-51e22a4a"]]), ia = {
  key: 0,
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 24 24",
  ...
  setup(r) {
    ...
    return (s, o) => {
      ...
      return g(), W(a, {
        ...
        default: ee(() => [
          S(t).isFullscreen ? (g(), A("svg", ia, o[0] || (o[0] = [
            h("path", {
              d: "M0 0h24v24H0z",
              fill: "none"
            }, null, -1),
            h("path", { d: "M5 16h3v3h2v-5H5v2zm3-8H5v2h5V5H8v3zm6 11h2v-3h3v-2h-5v5zm2-11V5h-2v5h5V8h-3z" }, null, -1)
          ]))) : (g(), A("svg", sa, o[1] || (o[1] = [
            h("path", {
              d: "M0 0h24v24H0z",
              fill: "none"
            }, null, -1),
            h("path", { d: "M7 14H5v5h5v-2H7v-3zm-2-4h2V7h3V5H5v5zm12 7h-3v2h5v-5h-2v3zM14 5v2h3v3h2V5h-5z" }, null, -1)
          ])))
        ]),
        _: 1
      }, 8, ["tooltip"]);
      ...
      return g(), W(c, {
        ...
        default: ee(() => n[0] || (n[0] = [
          h("svg", {
            ...
            h("path", { d: "M12 8c-2.21 0-4 1.79-4 4s1.79 4 4 4 4-1.79 4-4-1.79-4-4-4zm8.94 3c-.46-4.17-3.77-7.48-7.94-7.94V1h-2v2.06C6.83 3.52 3.52 6.83 3.06 11H1v2h2.06c.46 4.17 3.77 7.48 7.94 7.94V23h2v-2.06c4.17-.46 7.48-3.77 7.94-7.94H23v-2h-2.06zM12 19c-3.87 0-7-3.13-7-7s3.13-7 7-7 7 3.13 7 7-3.13 7-7 7z" })
          ], -1)
        ])),
        _: 1
      }, 8, ["tooltip"]);
...
}), ha = /* @__PURE__ */ Ne(da, [["__scopeId", "data-v-457cd2d4"]]), fa = j("areas-of-interest", () => ({ areas: f([]) })), ma = j("export", () => {
  const r = f({
    title: !0,
    map: !0,
    mapElements: !0,
...
const La = j("geosearch", () => {
  const r = f(new Ai("en", void 0)), e = f({
    type: "",
    province: "",
    extent: void 0
...
const Ca = j("legend", () => {
  ...
  function o(n) {
    if (n.parent === void 0)
      ...
      if (!(n.item instanceof xi) && !(n.item instanceof De)) {
...
class Da {
   ...
   */
  reload(e, t) {
    const i = st(this.$vApp.$pinia), s = Le(this.$vApp.$pinia), o = de(this.$vApp.$pinia), a = ge(this.$vApp.$pinia), l = Ie(this.$vApp.$pinia), n = !!e;
    n ? Object.keys(a.items).forEach((u) => {
      this.fixture.exists(u) && this.fixture.remove(u);
    }) : this.fixture.flush(), i.started = !1, this.geo.map.destroyMap(), l.$reset(), t?.loadDefaultEvents === !1 && (this.event.removeDefaultEvents(), this._eventsOn = !1), e === void 0 && (e = JSON.parse(
      JSON.stringify({
        startingFixtures: o.startingFixtures,
        configs: o.registeredConfigs
      })
    )), s.clearAll(), this.geo.map.maptip.clear(), this.initialize(n, e, t);
  }
  component(e, t) {
    if (t) {
...
function Ga(r, e) {
  ...
  const i = Vs(), s = Ci(no).use(i).use(xs, {
    directive: "tippy",
    // => v-tippy
    component: "tippy"
    // => <tippy/>
...
class Va extends Ua {
  ...
  addLayer(e, t = void 0) {
    return new Promise((i, s) => {
      if (this.esriMap || (this.noMapErr(), s()), e.initiationState !== D.INITIATING && e.initiationState !== D.INITIATED && e.layerState !== V.ERROR && e.initiate(), e.mapLayer && t === void 0) {
      ...
      let l = 0;
      const n = setInterval(() => {
        l += 250, l >= e.expectedTime.fail || e.layerState === V.ERROR ? (clearInterval(n), e.lastCancel < a && console.error(`Failed to add layer: ${e.id}.`), s()) : e.initiationState === D.INITIATED && (e.esriLayer || !e.mapLayer) && (clearInterval(n), e.mapLayer ? this.insertToEsriMap(e) : e.onLoad(), i());
      }, 250);
    });
  }
  /**
...
class en extends Z {
  ...
  extractCsvFields(e, t = ",") {
    return di.dsvFormat(t).parseRows(e)[0].map((s) => ({ name: s, type: Ce.STRING }));
  }
  /**
...
class sn extends Z {
  ...
  async loadWfsData(e, t = -1, i = 0, s = 1e3, o = {
    ...
    if (o.features = o.features.concat(d.features), d.features.length < t - i) {
      ...
      return a && o.features.length > 0 && o.features[0].geometry.type === z.POINT && o.features.forEach((b) => {
...
class rn extends Z {
  ...
  allActiveLayers() {
    return this.allLayers().filter(
      (e) => e.layerState !== V.ERROR && e.initiationState === D.INITIATED
    );
  }
  /**
...
class Zi extends ii {
  ...
  async terminate() {
    this.updateInitiationState(D.TERMINATING), await Promise.all(this.sublayers.map((e) => e.terminate())), this.loadDefProm = new J(), this.loadPromDone = !1, this.updateLayerState(V.NEW), this.updateDrawState(pe.NOT_LOADED), this.updateInitiationState(D.TERMINATED);
  }
  // ----------- LAYER LOAD -----------
    ...
    try {
      ...
      Promise.all(s).then(() => {
        clearTimeout(i), t ? this.visibility = !1 : (this.stopTimer(
          "load"
          /* LOAD */
        ), e > this.lastCancel && (this.loadPromDone && (this.loadDefProm = new J()), this.loadDefProm.resolveMe(), this.loadPromDone = !0, this.sublayers.forEach((o) => o.onLoad()), this.updateLayerState(V.LOADED)));
      }).catch(() => {
  ...
  onError(e = !0) {
    this.layerState !== V.ERROR && (this.initiationState === D.INITIATING && this.updateInitiationState(D.NEW), this.loadPromDone && (this.loadDefProm = new J()), this.loadDefProm.rejectMe(), this.loadPromDone = !0, this.sublayers.forEach((t) => t.onError(e)), e && this.$iApi.notify.show(
      me.ERROR,
      this.$iApi.$i18n.t("layer.error", {
        id: this.id
      })
...
class Cn extends Z {
   ...
   */
  constructor(e) {
    super(e), this.geom = ut.geom, this.proj = ut.proj, this.shared = ut.sharedUtils, this.map = new Va(e), this.layer = new rn(e), this.attributes = new xn(e), this.query = new $n(e), this.symbology = new Rn(e), Array.isArray(ft.request.interceptors) || (ft.request.interceptors = []), ft.request.interceptors.push({
      before: (t) => {
...
const On = /* @__PURE__ */ Object.assign({ "../fixtures/appbar/index.ts": () => import("./index-DjZto15N.js"), "../fixtures/areas-of-interest/index.ts": () => import("./index-CbldYQU1.js"), "../fixtures/basemap/index.ts": () => import("./index-Cxo6HAs7.js"), "../fixtures/crosshairs/index.ts": () => import("./index-C5ewj-k7.js"), "../fixtures/details/index.ts": () => import("./index-CC1WYyXV.js"), "../fixtures/export-footnote/index.ts": () => import("./index-DlqrlTe2.js"), "../fixtures/export-legend/index.ts": () => import("./index-BECXxYUj.js"), "../fixtures/export-map/index.ts": () => import("./index-S8iS59oX.js"), "../fixtures/export-northarrow/index.ts": () => import("./index-p-EKAG61.js"), "../fixtures/export-scalebar/index.ts": () => import("./index-DRPdirEq.js"), "../fixtures/export-timestamp/index.ts": () => import("./index-Ck-WLhpc.js"), "../fixtures/export-title/index.ts": () => import("./index-B7pH7n9Q.js"), "../fixtures/export/index.ts": () => import("./index-CKdXFXcc.js"), "../fixtures/extentguard/index.ts": () => import("./index-C1o6VvId.js"), "../fixtures/gazebo/index.ts": () => import("./index-DTCaASc1.js"), "../fixtures/geosearch/index.ts": () => import("./index-BXp4-GmO.js"), "../fixtures/help/index.ts": () => import("./index-CggPl3Q8.js"), "../fixtures/hilight/index.ts": () => import("./index-CW3hjQhM.js"), "../fixtures/layer-reorder/index.ts": () => import("./index-C77r4nMT.js"), "../fixtures/legend/index.ts": () => import("./index-DvrjqO7v.js"), "../fixtures/mapnav/index.ts": () => import("./index-BPYezsny.js"), "../fixtures/metadata/index.ts": () => import("./index-CJrGjy61.js"), "../fixtures/northarrow/index.ts": () => import("./index-BlqksArL.js"), "../fixtures/overviewmap/index.ts": () => import("./index-BRNeTCRr.js"), "../fixtures/panguard/index.ts": () => import("./index-CkhfDwqE.js"), "../fixtures/scrollguard/index.ts": () => import("./index-BSji0rav.js"), "../fixtures/settings/index.ts": () => import("./index-Dw6QC-Y3.js"), "../fixtures/snowman/index.ts": () => import("./index-pwyz1VYU.js"), "../fixtures/wizard/index.ts": () => import("./index-hIb6qef5.js") });
class kn extends Z {
  /**
...
const Dn = /* @__PURE__ */ Ne(Nn, [["render", Fn], ["__scopeId", "data-v-a3c61802"]]), Gn = /* @__PURE__ */ Object.assign({ "../fixtures/areas-of-interest/screen.vue": () => import("./screen-FISqwpjQ.js"), "../fixtures/basemap/screen.vue": () => import("./screen-Bniyp07g.js"), "../fixtures/export/screen.vue": () => import("./screen-D9oHZAJu.js"), "../fixtures/geosearch/screen.vue": () => import("./screen-B0LFlysN.js"), "../fixtures/help/screen.vue": () => import("./screen-CFr7OLYF.js"), "../fixtures/layer-reorder/screen.vue": () => import("./screen-BCQBi74D.js"), "../fixtures/legend/screen.vue": () => import("./screen-Cnk7nIrB.js"), "../fixtures/metadata/screen.vue": () => import("./screen-DbSN0S7a.js"), "../fixtures/settings/screen.vue": () => import("./screen-DwqbJEg1.js"), "../fixtures/wizard/screen.vue": () => import("./screen-BtEDYGDF.js") });
class Et extends Z {
  /**
   * ID of this panel.
   *
...
var rt = { major: "4", minor: "12", patch: "0-beta", timestamp: "Mon Mar 24 14:40:03 2025 -0400", hash: "c6b40400eddc117428b06f0d23227d22dd75a6db" };
console.info(
...
const Ol = (r, e, t) => new Da(r, e, t), ut = new Ps();
export {
  mt as $,
  $r as A,
  ti as B,
