...
import { o as we, n as u, Q as Ce, a as ye, M as I, G as K, _ as ae, N as Me, m as Se, V as f, X as G, S as Te, Y as O, Z as ee } from "./main-C_46O0w1.js";
import "pinia";
...
const Ee = ["type", "aria-label", "checked", "disabled", "content"], te = /* @__PURE__ */ Q({
  ...
  setup(e) {
    ...
    }, j = U(() => r.legendItem.layerControlAvailable(I.Reload) && r.legendItem instanceof u && M(r.legendItem.layer)?.canReload), X = (z) => {
        ...
        Le(L, {
          ...
          default: re(() => [
            ...
            x((l(), a("a", {
              ...
              onMouseover: c[0] || (c[0] = k((E) => X(E.currentTarget), ["stop"])),
...
}), Ye = /* @__PURE__ */ ae(Qe, [["__scopeId", "data-v-34dfeccd"]]), Xe = { class: "relative" }, Je = ["content"], _e = {
  key: 0,
  ...
  setup(e) {
    const y = Me(), s = ye(), { t: m } = oe(), b = ge("iApi"), $ = V(), i = e, r = Se(), T = r.multilineItems, P = (i.legendItem instanceof u && i.legendItem.maxLines) ?? r.maxLines, q = V(s.mobileView), Y = U(() => y.layerConfigs), H = V([]), F = V(!1), D = V(!1), j = U(() => i.legendItem instanceof u ? M(i.legendItem.layer)?.layerType : ""), X = U(() => i.legendItem instanceof u && M(i.legendItem.layer)?.canModifyLayer), A = U(() => {
          ...
          H.value.length > 0 ? (l(), a("div", Ct, [
            ...
            (l(!0), a(le, null, ne(H.value, (g) => (l(), a("div", {
              ...
              g.imgUrl && e.legendItem.symbologyRenderStyle === "images" || !g.imgUrl && j.value === "ogc-wms" ? (l(), a("div", St, [
                ...
                X.value && e.legendItem.layer.supportsFeatures && (!g.imgUrl && H.value.length > 1 || g.imgUrl && g.definitionClause) ? (l(), Z(te, {
                  key: 2,
                  value: g,
                  legendItem: e.legendItem,
                  checked: g.visibility,
...
}), Ml = /* @__PURE__ */ ae(Ot, [["__scopeId", "data-v-999de570"]]);
export {
  Ml as default
};
