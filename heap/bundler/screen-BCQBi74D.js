...
const Z = ["content", "aria-label"], ee = ["disabled", "aria-label"], te = /* @__PURE__ */ R({
  ...
  setup(m) {
    const o = Y("iApi"), { t: c } = $(), i = E([]), f = E([]), _ = E([]), D = E([]), z = j(() => o.animate), g = () => {
      ...
      const t = o.geo.layer.layerOrderIds(), a = [...K(o.geo.layer.allLayersOnMap(!0))].filter(
