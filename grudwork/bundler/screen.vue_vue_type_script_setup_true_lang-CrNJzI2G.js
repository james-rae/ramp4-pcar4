...
import { E, _ as N, c as D } from "./main-CqZV6lyb.js";
...
const K = { class: "mt-10" }, q = ["aria-label"], F = ["alt", "src"], H = ["alt"], L = { class: "absolute flex w-full bg-black opacity-75 text-white h-30 bottom-6 items-center" }, G = { class: "pl-5" }, J = { class: "ml-auto pr-5" }, P = ["content"], Q = /* @__PURE__ */ w({
  ...
  setup(e) {
    const { t: c } = y(), m = C("iApi"), a = (r) => {
      if (!r.extent) {
        console.error("selected area of interest doesn't have an extent specified.");
        return;
      }
      m.geo.map.zoomMapTo(E.fromConfig("area-of-interest-extent", r.extent));
    };
    return (r, t) => {
...
}), R = /* @__PURE__ */ N(Q, [["__scopeId", "data-v-e64041d0"]]), U = { class: "h-600 overflow-y-auto" }, W = { class: "mx-5" }, X = { key: 0 }, ke = /* @__PURE__ */ w({
  __name: "screen",
  props: {
    panel: {
      type: Object
  ...
  setup(e) {
    const { t: c } = y(), m = D(), a = I(() => m.areas), r = j(!1);
    return A(() => {
      r.value = !!a.value?.some((t) => t.thumbnail);
    }), (t, d) => {
      ...
      return i(), M(u, { panel: e.panel }, {
        ...
        content: b(() => [
          o("div", U, [
            o("div", W, [
              a.value.length > 0 ? s((i(), n("ul", X, [
                (i(!0), n(O, null, S(a.value, (h, k) => (i(), n("li", { key: k }, [
                  V(R, {
                    area: h,
                    "show-thumbnail": r.value,
