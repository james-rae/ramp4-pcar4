...
import { _ as H, d as L, k as X, F as ee, G as te } from "./main-CqZV6lyb.js";
...
const G = /* @__PURE__ */ H(ne, [["render", ae]]), se = /* @__PURE__ */ T({
  ...
  setup(h) {
    ...
    const p = [
      {
        type: "point",
        icon: g(_(() => import("./point-icon-CTLheTye.js")))
      },
      {
        type: "polyline",
        icon: g(_(() => import("./polyline-icon-B10b2ExF.js")))
      },
      {
        type: "polygon",
        icon: g(_(() => import("./polygon-icon-vai-lMq1.js")))
      },
      {
        type: "circle",
        icon: g(_(() => import("./circle-icon-Bd8zofcx.js")))
      },
      {
        type: "rectangle",
        icon: g(_(() => import("./rectangle-icon-Cp8xEnix.js")))
      }
    ], a = A(() => {
      const s = p.filter((u) => e.supportedTypes.some((x) => x.type === u.type));
      return s.push({
        type: "edit",
        icon: g(_(() => import("./edit-icon-DbV9T6en.js")))
      }), s;
    }), n = (s) => {
