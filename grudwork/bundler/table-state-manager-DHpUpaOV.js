...
class a {
  ...
  clearFilters() {
    Object.entries(this._columns).forEach(([, t]) => {
      t.filter.static || (t.filter.min = "", t.filter.max = "", t.filter.value = "");
    }), this._filterByExtent = !1, this._filtered = !1;
  }
  _checkFilters() {
    this._filtered = Object.values(this._columns).some((t) => !t.filter.static && (t.filter.value !== "" || t.filter.min !== "" || t.filter.max !== ""));
  }
  get filtered() {
