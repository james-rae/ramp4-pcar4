      ...
      if (!(!document.activeElement || !i?.contains(document.activeElement)))
        switch (e.key) {
          case "Enter":
            if (e.preventDefault(), t.activeTool && t.activeTool !== "edit")
              if ((t.activeTool === "polyline" || t.activeTool === "polygon") && (P || w.length === 0)) {
                ...
                P ? (w.push([u.x, u.y]), t.activeTool === "polyline" ? v.geometry = new V({
                  paths: [w],
                ...
                )) : (P = !0, w = [[u.x, u.y]], t.activeTool === "polyline" ? v = new $({
                  geometry: new V({
                    paths: [w],
                    spatialReference: l.spatialReference
                  }),
          ...
          case "Backspace":
            ...
            P && w.length > 1 ? (e.preventDefault(), w.pop(), t.activeTool === "polyline" ? v.geometry = new V({
              paths: [w],
...
class ft extends Me {
  async init() {
    Object.entries(Le).forEach((b) => this.$iApi.$i18n.mergeLocaleMessage(...b)), this._parseConfig(this.config), Z(this.$vApp.$pinia).supportedTypes.forEach((b) => {
      const o = `${b.type}-icon`;
      this.$iApi.component(o, Ae(Se(/* @__PURE__ */ Object.assign({ "./icons/circle-icon.vue": () => import("./circle-icon-Bd8zofcx.js"), "./icons/edit-icon.vue": () => import("./edit-icon-DbV9T6en.js"), "./icons/point-icon.vue": () => import("./point-icon-CTLheTye.js"), "./icons/polygon-icon.vue": () => import("./polygon-icon-vai-lMq1.js"), "./icons/polyline-icon.vue": () => import("./polyline-icon-B10b2ExF.js"), "./icons/rectangle-icon.vue": () => import("./rectangle-icon-Cp8xEnix.js") }), `./icons/${b.type}-icon.vue`, 3)));
    });
