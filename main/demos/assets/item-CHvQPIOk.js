import { bF as defineComponent, bG as useI18n, bI as ref, bJ as onMounted, bN as resolveDirective, bQ as openBlock, bW as createElementBlock, bV as withDirectives, fG as createBaseVNode, bT as unref, im as withModifiers, io as withKeys, fH as normalizeClass, iD as LegendItem, iC as LayerItem, ly as CoreFilter, bH as inject, fE as usePanelStore, bL as computed, lz as LayerControl, kS as toRaw, bM as resolveComponent, bU as createVNode, bP as withCtx, bR as createTextVNode, bS as toDisplayString, fO as GlobalEvents, i8 as _export_sfc, bX as Fragment, bY as renderList, iK as normalizeStyle, fM as createCommentVNode, lA as useLayerStore, fL as watch, lB as LegendType, lC as LegendControl, lD as createStaticVNode, bO as createBlock, iB as SectionItem, lE as InfoType, kL as resolveDynamicComponent, lF as to, lG as InitiationState } from './main-Cr6PLPJi.js';
...
const LegendOptions = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-37c5e371"]]);
...
const _hoisted_18 = ["content", "aria-label"];
const _hoisted_19 = { class: "flex p-8" };
const _hoisted_20 = {
  key: 0,
...
const _hoisted_22 = ["content"];
const _hoisted_23 = ["content"];
const _hoisted_24 = {
  key: 10,
  class: "relative top-1"
};
const _hoisted_25 = ["content"];
const _hoisted_26 = {
  key: 0,
...
const _hoisted_40 = { class: "flex-1 ml-15" };
const _hoisted_41 = { key: 1 };
const _hoisted_42 = { class: "flex p-5 ml-48" };
const _hoisted_43 = {
  key: 0,
  class: "relative animate-spin spinner h-20 w-20 mr-10 pt-2"
};
const _hoisted_44 = { class: "flex-1 text-gray-500" };
const _hoisted_45 = {
  key: 1,
    ...
    return (_ctx, _cache) => {
      ...
      return !__props.legendItem.hidden ? (openBlock(), createElementBlock("div", {
        ...
        createBaseVNode("div", _hoisted_1, [
          withDirectives((openBlock(), createElementBlock("div", {
            ...
            __props.legendItem.type !== unref(LegendType).Item ? (openBlock(), createElementBlock("div", _hoisted_3, [
              __props.legendItem.type === unref(LegendType).Placeholder ? (openBlock(), createElementBlock("svg", _hoisted_4, _cache[12] || (_cache[12] = [
                createStaticVNode('<path d="M0 0h24v24H0V0z" fill="none" data-v-812351d5></path><path d="M0 0h24v24H0V0z" fill="none" data-v-812351d5></path><circle cx="15.5" cy="9.5" r="1.5" data-v-812351d5></circle><circle cx="8.5" cy="9.5" r="1.5" data-v-812351d5></circle><circle cx="15.5" cy="9.5" r="1.5" data-v-812351d5></circle><circle cx="8.5" cy="9.5" r="1.5" data-v-812351d5></circle><path d="M11.99 2C6.47 2 2 6.48 2 12s4.47 10 9.99 10C17.52 22 22 17.52 22 12S17.52 2 11.99 2zM12 20c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8zm0-2.5c2.33 0 4.32-1.45 5.12-3.5h-1.67c-.69 1.19-1.97 2-3.45 2s-2.75-.81-3.45-2H6.88c.8 2.05 2.79 3.5 5.12 3.5z" data-v-812351d5></path>', 7)
              ]))) : (openBlock(), createElementBlock("svg", _hoisted_5, _cache[13] || (_cache[13] = [
                createStaticVNode('<path d="M0 0h24v24H0V0z" fill="none" data-v-812351d5></path><path d="M0 0h24v24H0V0z" fill="none" data-v-812351d5></path><circle cx="15.5" cy="9.5" r="1.5" data-v-812351d5></circle><circle cx="8.5" cy="9.5" r="1.5" data-v-812351d5></circle><circle cx="15.5" cy="9.5" r="1.5" data-v-812351d5></circle><circle cx="8.5" cy="9.5" r="1.5" data-v-812351d5></circle><path d="M 20,12C 20,7.6 16.4,4 12,4C 7.6,4 4,7.6 4,12C 4,16.4 7.6,20 12,20C 16.4,20 20,16.4 20,12 Z M 22,12C 22,17.5 17.5,22 12,22C 6.5,22 2,17.5 2,12C 2,6.5 6.5,2.00001 12,2.00001C 17.5,2.00001 22,6.5 22,12 Z M 15.5,8C 16.3,8 17,8.7 17,9.5C 17,10.3 16.3,11 15.5,11C 14.7,11 14,10.3 14,9.5C 14,8.7 14.7,8 15.5,8 Z M 10,9.5C 10,10.3 9.3,11 8.5,11C 7.7,11 7,10.3 7,9.5C 7,8.7 7.7,8 8.5,8C 9.3,8 10,8.7 10,9.5 Z M 12,14C 13.7524,14 15.2943,14.7212 16.1871,15.8129L 14.7697,17.2302C 14.3175,16.5078 13.2477,16 12,16C 10.7523,16 9.68254,16.5078 9.23024,17.2302L 7.81291,15.8129C 8.7057,14.7212 10.2476,14 12,14 Z" data-v-812351d5></path>', 7)
              ])))
            ])) : createCommentVNode("", true),
            ...
            __props.legendItem instanceof unref(LayerItem) ? withDirectives((openBlock(), createElementBlock("div", _hoisted_8, [
            ...
            ]) : __props.legendItem instanceof unref(SectionItem) ? (openBlock(), createElementBlock("div", _hoisted_9, [
              __props.legendItem.infoType === unref(InfoType).Title && __props.legendItem.content ? (openBlock(), createElementBlock("h3", _hoisted_10, toDisplayString(__props.legendItem.content), 1)) : __props.legendItem.infoType === unref(InfoType).Title ? (openBlock(), createElementBlock("h3", _hoisted_11, toDisplayString(__props.legendItem.name), 1)) : __props.legendItem.infoType === unref(InfoType).Text ? (openBlock(), createElementBlock("p", _hoisted_12, toDisplayString(__props.legendItem.content), 1)) : __props.legendItem.infoType === unref(InfoType).Image ? (openBlock(), createElementBlock("img", {
                key: 3,
                src: __props.legendItem.content,
                alt: "InfoType image not found :("
              }, null, 8, _hoisted_13)) : __props.legendItem.infoType === unref(InfoType).Markdown ? (openBlock(), createElementBlock("div", {
                key: 4,
                class: "ramp-markdown",
                innerHTML: markdownToHtml(__props.legendItem.content)
              }, null, 8, _hoisted_14)) : (openBlock(), createBlock(resolveDynamicComponent(`${__props.legendItem.uid}-info-section`), { key: 5 }))
            ])) : createCommentVNode("", true),
            __props.legendItem.type === unref(LegendType).Error && reloadableLayer.value ? (openBlock(), createElementBlock("div", _hoisted_15, [
              withDirectives((openBlock(), createElementBlock("button", {
                type: "button",
            ...
            __props.legendItem.type !== unref(LegendType).Item && __props.legendItem instanceof unref(LayerItem) ? (openBlock(), createElementBlock("div", _hoisted_17, [
              withDirectives((openBlock(), createElementBlock("button", {
                type: "button",
                class: "text-gray-500 hover:text-black",
                ...
                createBaseVNode("div", _hoisted_19, [
                  __props.legendItem.type === unref(LegendType).Placeholder ? (openBlock(), createElementBlock("svg", _hoisted_20, _cache[16] || (_cache[16] = [
                    createBaseVNode("path", { d: "M242.72 256l100.07-100.07c12.28-12.28 12.28-32.19 0-44.48l-22.24-22.24c-12.28-12.28-32.19-12.28-44.48 0L176 189.28 75.93 89.21c-12.28-12.28-32.19-12.28-44.48 0L9.21 111.45c-12.28 12.28-12.28 32.19 0 44.48L109.28 256 9.21 356.07c-12.28 12.28-12.28 32.19 0 44.48l22.24 22.24c12.28 12.28 32.2 12.28 44.48 0L176 322.72l100.07 100.07c12.28 12.28 32.2 12.28 44.48 0l22.24-22.24c12.28-12.28 12.28-32.19 0-44.48L242.72 256z" }, null, -1)
                  ]))) : (openBlock(), createElementBlock("svg", _hoisted_21, _cache[17] || (_cache[17] = [
            ...
            __props.legendItem.type === unref(LegendType).Item && __props.legendItem instanceof unref(LayerItem) && __props.legendItem.layerOffscale ? (openBlock(), createElementBlock("div", _hoisted_24, [
              withDirectives((openBlock(), createElementBlock("button", {
                type: "button",
                class: "p-4",
          ...
          __props.legendItem.type === unref(LegendType).Placeholder || __props.legendItem instanceof unref(LayerItem) && __props.legendItem.layerRedrawing && __props.legendItem.visibility ? (openBlock(), createElementBlock("div", _hoisted_26, _cache[21] || (_cache[21] = [
            createBaseVNode("div", { class: "progress-line" }, null, -1)
          ]))) : createCommentVNode("", true)
        ]),
        __props.legendItem instanceof unref(LayerItem) && __props.legendItem.symbologyExpanded ? withDirectives((openBlock(), createElementBlock("div", _hoisted_27, [
          symbologyStack.value.length > 0 ? (openBlock(), createElementBlock("div", _hoisted_28, [
            __props.legendItem instanceof unref(LayerItem) && __props.legendItem.description ? (openBlock(), createElementBlock("p", _hoisted_29, toDisplayString(__props.legendItem.description), 1)) : createCommentVNode("", true),
            (openBlock(true), createElementBlock(Fragment, null, renderList(symbologyStack.value, (item) => {
              return openBlock(), createElementBlock("div", {
                class: "m-5",
                key: item.uid
              }, [
                item.imgUrl && __props.legendItem.symbologyRenderStyle === "images" || !item.imgUrl && layerType.value === "ogc-wms" ? (openBlock(), createElementBlock("div", _hoisted_30, [
                  item.imgUrl ? (openBlock(), createElementBlock("div", _hoisted_31, [
                    createBaseVNode("img", {
                      class: "max-w-full",
                      src: item.imgUrl
                    }, null, 8, _hoisted_32)
                  ...
                  item.label ? withDirectives((openBlock(), createElementBlock("div", _hoisted_34, [
                  ...
                  item.imgUrl ? (openBlock(), createElementBlock("div", _hoisted_36, [
                    createBaseVNode("img", {
                      class: "w-32 h-32",
                      src: item.imgUrl
                    }, null, 8, _hoisted_37)
                  ])) : item.svgcode ? (openBlock(), createElementBlock("div", _hoisted_38, [
                    createBaseVNode("span", {
                      innerHTML: item.svgcode
                    }, null, 8, _hoisted_39)
                  ])) : createCommentVNode("", true),
                  withDirectives((openBlock(), createElementBlock("div", _hoisted_40, [
          ...
          !symbologyStackLoaded.value ? (openBlock(), createElementBlock("div", _hoisted_41, [
            withDirectives((openBlock(), createElementBlock("div", _hoisted_42, [
              isAnimationEnabled.value ? (openBlock(), createElementBlock("div", _hoisted_43)) : createCommentVNode("", true),
              withDirectives((openBlock(), createElementBlock("div", _hoisted_44, [
        ...
        __props.legendItem.expanded ? (openBlock(), createElementBlock("div", _hoisted_45, [
...
const item = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-812351d5"]]);
