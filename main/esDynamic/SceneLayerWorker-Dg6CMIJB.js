import { hX as K, bh as D } from "./main-7OeqHT8E.js";
import { y as X } from "./DoubleArray-jwKzg_-v.js";
import { i as Q, a as W } from "./MeshLocalVertexSpace-CpCk_RrT.js";
import { n as Z, s as ee } from "./vec3-DZie1AbW.js";
import "./sphere-BSRST25O.js";
import "./I3SUtil-DMgj-6b8.js";
var S, $;
(function(e) {
...
function te() {
  return x || (x = new Promise((e) => import("./i3s-BjwzW7y3.js").then((t) => t.i).then(({ default: t }) => {
...
async function be(e) {
  ...
  if (i.type === "georeferenced" && i.origin == null) {
    const [{ projectBuffer: c }, { initializeProjection: b }] = await Promise.all([import("./main-7OeqHT8E.js").then((d) => d.qK), import("./main-7OeqHT8E.js").then((d) => d.qL)]);
    await b(f, l), s = new Float64Array(a.length), c(a, f, 0, s, l, 0, s.length / 3);
  } else {
    const c = i.type === "georeferenced" ? Q.fromJSON(i) : W.fromJSON(i), { project: b } = await import("./georeference-BO7KDQX_.js").then((d) => d.g);
...
//# sourceMappingURL=SceneLayerWorker-Dg6CMIJB.js.map
