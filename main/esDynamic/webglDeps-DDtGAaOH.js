import{E as m}from"./BufferObject-QeKcAenP.js";import{r as c}from"./Program-jdjfMs00.js";import{x as p,s as l}from"./Program-jdjfMs00.js";import"./main-B3heGUDs.js";import{t as u}from"./NestedMap-Ddo7BfvO.js";import{e as $,a as d}from"./ProgramTemplate-BxyqH9yL.js";import{m as b}from"./Texture-D8lefgir.js";import{o as h}from"./VertexArrayObject-BxIsSlwC.js";class x{constructor(e){this._rctx=e,this._store=new u}dispose(){this._store.forAll(e=>e.dispose()),this._store.clear()}acquire(e,r,t,i){const o=this._store.get(e,r);if(o!=null)return o.ref(),o;const s=new c(this._rctx,e,r,t,i);return s.ref(),this._store.set(e,r,s),s}get test(){}}function _(n){const{options:e,value:r}=n;return typeof e[r]=="number"}function y(n){let e="";for(const r in n){const t=n[r];if(typeof t=="boolean")t&&(e+=`#define ${r}
