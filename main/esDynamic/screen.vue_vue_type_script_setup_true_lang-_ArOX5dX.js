import { bC as Or, bD as Ir, bK as ie, bS as kt, bN as Pt, bT as jt, fC as Rt, fD as pr, bQ as Bt, i4 as nn, bA as on, iO as an, iP as sn, bE as ln, bF as $e, bI as fn, bG as un, fK as or, bH as cn, bP as Ie, bL as Hr, bM as gr, fI as Ar, bR as mr, bU as dn, bV as vn, bO as Vr, kM as hn, kN as pn, bJ as gn } from "./main-CqTmyBdW.js";
import { r as mn } from "./vue.esm-bundler-Cy6jHWjK.js";
...
}), Rr = /* @__PURE__ */ nn(Sn, [["__scopeId", "data-v-fd14520e"]]);
var Wr = { exports: {} };
/**!
 * Sortable 1.14.0
...
const ao = /* @__PURE__ */ sn(oo), io = {
  ...
  setup(s) {
    const e = ln("iApi"), { t: n } = Ir(), i = $e([]), r = $e([]), f = $e([]), t = $e([]), o = fn(() => e.animate), a = () => {
      ...
      const g = e.geo.layer.layerOrderIds(), y = [
        ...hn(e.geo.layer.allLayersOnMap(!0))
      ].filter(
      ...
      g && (g.name = h.name, g.sublayers = h.sublayers.filter(
        (y) => y !== void 0 && !y.isRemoved
      ).map((y) => ({
        id: y.id,
        name: y.name
      })), g.isLoaded = !0);
      ...
      h.supportsSublayers && (h.isExpanded = !h.isExpanded, e.updateAlert(
        n(
          h.isExpanded ? "layer-reorder.expanded" : "layer-reorder.collapsed",
          {
            name: h.name
          }
        )
            ...
            E.isLoaded ? kt((Pt(), jt("div", {
              ...
              Rt("div", fo, [
                E.supportsSublayers ? kt((Pt(), jt("button", {
                  ...
                  content: Bt(n)(
                    `layer-reorder.${E.isExpanded ? "collapse" : "expand"}`
                  ),
                  "aria-label": Bt(n)(
                    `layer-reorder.${E.isExpanded ? "collapse" : "expand"}`
                  )
...
//# sourceMappingURL=screen.vue_vue_type_script_setup_true_lang-_ArOX5dX.js.map
