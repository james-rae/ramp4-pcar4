...
class Fe extends $e {
  ...
  toggleFeature(e, t) {
    ...
    const l = this.$iApi.geo.layer.getLayer(
      e.uid
    ), u = `${e.uid}-${// see https://github.com/ramp4-pcar4/ramp4-pcar4/issues/1767 for the reasoning behind this
  ...
  async hilightDetailsItems(e, t) {
    ...
    if (l) {
      ...
      const g = await this.getHilightGraphics(
        s,
        t
      );
  ...
  async reloadDetailsHilight(e, t) {
    const s = e instanceof Array ? e : [e], l = this.$iApi.fixture.get("hilight");
    if (l) {
      const u = await this.getHilightGraphics(
        s,
        t
      );
      l.reloadHilight(u);
...
const Ne = {
      ...
      _("div", {
        ...
        t.value.length > 1 ? (a(), r("div", Oe, [
          (a(!0), r(K, null, W(t.value.slice(0, 3).reverse(), (u, d) => (a(), r("div", {
            class: q(["absolute", [
              d == 0 ? "symbol-0" : d == 1 ? "left-3" : "left-6"
            ]]),
...
}), Je = /* @__PURE__ */ oe(Ke, [["__scopeId", "data-v-256f0518"]]), Qe = ["content"], We = { class: "symbologyLayerName truncate" }, Ye = /* @__PURE__ */ P({
  ...
  setup(h) {
    const { t: e } = V(), t = ee("iApi"), s = h, l = (f, p, c, i) => {
      const m = f.find(
        (I) => I[p].toLowerCase() === c.toLowerCase()
      );
      m && delete i[m.name];
    }, u = () => {
      ...
      for (const [i] of Object.entries(c))
        t.ui.isPlainText(c[i].value) && (c[i].value = t.ui.escapeHtml(
          c[i].value
        ));
      return c;
    }, d = (f, p, c) => {
  ...
  setup(h) {
    const e = ne(), t = h, s = ee("iApi"), l = k([]), u = U(), { t: d } = V(), g = k(""), v = k("none"), f = k(), p = () => e.getLayerByUid(t.uid), c = $(
      () => u.properties
    ), i = $(
      () => u.defaultTemplates
    ), m = $(() => p()?.supportsFeatures ?? !1), I = $(() => p()?.mapLayer ?? !1), C = $(() => {
      const n = p()?.nameField;
  ...
  setup(h) {
    const e = k(), t = () => {
    ...
    }, l = ee("iApi"), u = U(), d = ne(), g = h, { t: v } = V(), f = k(!1), p = k(l.fixture.get("details")), c = k(!0), i = k(!1), m = k(0), I = k(20), C = k([]), E = k([]), y = $(() => u.activeGreedy), S = $(
      () => u.properties
    ), x = $(() => m.value + I.value), H = () => d.getLayerByUid(g.uid), F = () => g.results.find((o) => o.uid === g.uid), A = $(() => F()?.loaded ?? !1), Z = $(() => F()?.requestTime), n = $(
      ...
      if (c.value && A.value && o.length > 0 && re.value)
        if (i.value)
          p.value.hilightDetailsItems(
            o.slice(m.value, x.value),
            g.uid
          );
        else {
          const w = o[m.value];
          ...
          _("div", Lt, [
            ...
            _("div", {
              ...
              O((a(), r("button", {
                type: "button",
                content: L(v)(
                  i.value ? "details.items.previous" : "details.item.previous.item"
                ),
              ...
              O((a(), r("button", {
                type: "button",
                content: L(v)(
                  i.value ? "details.items.next" : "details.item.next.item"
                ),
...
}), Ft = /* @__PURE__ */ oe(Ct, [["__scopeId", "data-v-f58b4939"]]), Nt = { class: "relative h-full" }, Ot = { class: "detailsContentSection overflow-y-auto h-full" }, Bt = /* @__PURE__ */ P({
  ...
  setup(h) {
    const { t: e } = V(), t = ee("iApi"), s = U(), l = k([]), u = k([]), d = k([]), g = k(!1), v = k(""), f = k(!1), p = $(() => s.activeGreedy), c = $(() => s.payload), i = $(
      () => s.properties
    ), m = (y) => {
      v.value = y, f.value = !0;
    }, I = (y) => {
...
//# sourceMappingURL=index-LRNCv82w.js.map
