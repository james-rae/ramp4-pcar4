import{E as m}from"./BufferObject-D2wC2XOa.js";import{r as c}from"./Program-DcozcZIy.js";import{x as p,s as l}from"./Program-DcozcZIy.js";import"./main-C9JjxZR3.js";import{t as u}from"./NestedMap-Ddo7BfvO.js";import{e as $,a as d}from"./ProgramTemplate-ZhSSkQIh.js";import{m as b}from"./Texture-ikm6YhjF.js";import{o as h}from"./VertexArrayObject-DzTUPBiG.js";class x{constructor(e){this._rctx=e,this._store=new u}dispose(){this._store.forAll(e=>e.dispose()),this._store.clear()}acquire(e,r,t,i){const o=this._store.get(e,r);if(o!=null)return o.ref(),o;const s=new c(this._rctx,e,r,t,i);return s.ref(),this._store.set(e,r,s),s}get test(){}}function _(n){const{options:e,value:r}=n;return typeof e[r]=="number"}function y(n){let e="";for(const r in n){const t=n[r];if(typeof t=="boolean")t&&(e+=`#define ${r}
