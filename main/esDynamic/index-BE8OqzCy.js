import { iO as A, iP as y, bx as M, fB as $, ha as O, fK as D, hb as B } from "./main-7OeqHT8E.js";
import { _ as k } from "./screen.vue_vue_type_script_setup_true_lang-FHkkhSHU.js";
var H = { exports: {} };
(function(S, i) {
  (function(n, a) {
    a();
...
class _ extends M {
   ...
   */
  async make(i, n) {
    const { fabric: a } = await import("./fabric-DztFbEDR.js").then((g) => g.f);
...
class I extends _ {
  ...
  async needed() {
    const i = (await import("./index-DGESWihy.js")).default, n = (await import("./index-D8ZgCc8F.js")).default, a = (await import("./index-CzpkVZjh.js")).default, w = (await import("./index-DuToHf-K.js")).default, p = (await import("./index-Bf97tnmY.js")).default, r = (await import("./index-B3QGMA6T.js")).default, b = (await import("./index-DHeTdlQM.js")).default;
...
//# sourceMappingURL=index-BE8OqzCy.js.map
