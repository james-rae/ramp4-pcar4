import { bx as m, fJ as h, fK as r, fL as p } from "./main-CqTmyBdW.js";
class A extends m {
  /**
...
class E extends A {
  ...
  checkActive() {
    ...
    t.alwaysOn || t.extentSetIds.includes(this.$iApi.geo.map.getExtentSet().id) ? t.active || (t.setActive(!0), this.extentEH = this.$iApi.event.on(
      r.MAP_EXTENTCHANGE,
      (e) => {
   ...
   */
  enforceBoundary(t, e) {
    const i = this.$iApi.geo.map.getExtentSet().maximumExtent, s = f(
      t.xmax,
      t.xmin,
      i.xmax,
      i.xmin
    ...
    if (n.changed || s.changed) {
      ...
      o.setEnforcing(!0), setTimeout(() => {
        this.$iApi.geo.map.zoomMapTo(
          ...
          o.setEnforcing(!1), this.enforceBoundary(
...
//# sourceMappingURL=index-CKsA9EJx.js.map
