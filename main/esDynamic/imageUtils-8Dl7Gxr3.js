import { am as m, au as d, a2 as u, K as w, s as p } from "./main-7OeqHT8E.js";
let r = null, s = !0;
function T(e, a, t) {
...
async function B(e, a) {
  ...
  if (n === "image/gif") {
    const { isAnimatedGIF: o, parseGif: c } = await import("./gif-D-atNDlE.js");
    if (o(t)) return c(t, a);
  }
  if (i) {
    const { isAnimatedPNG: o, parseApng: c } = await import("./apng-CsN_CN29.js");
    if (o(t)) return c(t, a);
  }
...
//# sourceMappingURL=imageUtils-8Dl7Gxr3.js.map
