import{E as m,o as p}from"./VertexArrayObject-UE0Z6xi-.js";import{x as l,s as u}from"./FramebufferObject-DTxnxHXY.js";import{r as c}from"./ProgramTemplate-D6yMgRpq.js";import{e as d,a as $}from"./ProgramTemplate-D6yMgRpq.js";import"./main-DpFPk5v0.js";import{t as x}from"./NestedMap-Ddo7BfvO.js";import{w as b}from"./Texture-IRS9MLAU.js";class h{constructor(e){this._rctx=e,this._store=new x}dispose(){this._store.forAll(e=>e.dispose()),this._store.clear()}acquire(e,t,r,i){const s=this._store.get(e,t);if(s!=null)return s.ref(),s;const o=new c(this._rctx,e,t,r,i);return o.ref(),this._store.set(e,t,o),o}get test(){}}function _(n){const{options:e,value:t}=n;return typeof e[t]=="number"}function g(n){let e="";for(const t in n){const r=n[t];if(typeof r=="boolean")r&&(e+=`#define ${t}
