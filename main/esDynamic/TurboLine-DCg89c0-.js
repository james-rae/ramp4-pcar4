import { af as le, hX as ue } from "./main-CqTmyBdW.js";
...
async function xe() {
  ee = await (le("esri-csp-restrictions") ? await import("./libtess-asm-ASXnCeHp.js").then((i) => i.l) : await import("./libtess-DX7kBGQB.js").then((i) => i.l)).default({ locateFile: (i) => ue(`esri/core/libs/libtess/${i}`) });
}
function sr(s, i) {
...
//# sourceMappingURL=TurboLine-DCg89c0-.js.map
