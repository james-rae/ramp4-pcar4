import { bC as T, bD as q, bE as W, bI as O, bJ as X, bN as p, bL as x, bM as j, fC as A, fD as E, bQ as L, fI as B, i4 as G, bT as h, mp as te, bF as I, fH as ne, bG as Y, bH as Z, bK as P, bS as H, i3 as ee, im as oe, mq as V, mr as ae, ms as se, bP as re, fA as ie, hb as D, fG as le, mt as pe, bU as w, bV as z, bR as R, mu as F, kF as J, mv as ce, bx as ue, fK as de } from "./main-CqTmyBdW.js";
class U {
  id;
  /**
...
}), ye = /* @__PURE__ */ G($e, [["__scopeId", "data-v-faf44ca4"]]), _e = {
  key: 0,
...
}), xe = /* @__PURE__ */ G(we, [["__scopeId", "data-v-f2294fce"]]), Ie = ["content"], ke = /* @__PURE__ */ T({
  __name: "appbar",
  setup($) {
    const a = ie(), n = D(), o = I(0), d = I(0), l = O(() => n.visible), e = O(
      () => n.temporary
    ), { t: y } = q(), u = I(!1), c = I({}), v = I(), S = () => {
      V(() => {
        F()?.proxy?.$forceUpdate();
      });
    }, _ = () => {
    ...
    return Y(() => {
      ...
      V(() => {
        ...
        Object.keys(c.value).forEach((i) => {
          m.querySelector(`.identifier-${i}`) || (delete c.value[i], i.includes("divider") || (o.value = Math.max(
            0,
            o.value - 1
          )), d.value++);
        });
...
//# sourceMappingURL=index-mxQvBiKj.js.map
