import { iO as A, iP as y, bx as M, fB as $, ha as O, fK as D, hb as B } from "./main-CqTmyBdW.js";
import { _ as k } from "./screen.vue_vue_type_script_setup_true_lang-Be_NGvBU.js";
var H = { exports: {} };
(function(S, i) {
  (function(n, a) {
    a();
...
class _ extends M {
   ...
   */
  async make(i, n) {
    const { fabric: a } = await import("./fabric-Cp9Rd-GB.js").then((g) => g.f);
...
class I extends _ {
  ...
  async needed() {
    const i = (await import("./index-BZoAnk8i.js")).default, n = (await import("./index-D4RSW2dT.js")).default, a = (await import("./index-BnPjNLIK.js")).default, w = (await import("./index-BS0QH3Cn.js")).default, p = (await import("./index-f3YjnpL4.js")).default, r = (await import("./index-k4jYWEUQ.js")).default, b = (await import("./index-BeyzzqWJ.js")).default;
...
//# sourceMappingURL=index-CDjl_CBE.js.map
