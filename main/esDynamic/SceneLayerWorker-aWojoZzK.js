import { hX as K, bh as D } from "./main-CqTmyBdW.js";
import { y as X } from "./DoubleArray-Bh5qEsVi.js";
import { i as Q, a as W } from "./MeshLocalVertexSpace-Cvj3TMI0.js";
import { n as Z, s as ee } from "./vec3-BgLh9Jul.js";
import "./sphere-BERAhVrN.js";
import "./I3SUtil-VrlME56h.js";
var S, $;
(function(e) {
...
function te() {
  return x || (x = new Promise((e) => import("./i3s-B_15P1Jf.js").then((t) => t.i).then(({ default: t }) => {
...
async function be(e) {
  ...
  if (i.type === "georeferenced" && i.origin == null) {
    const [{ projectBuffer: c }, { initializeProjection: b }] = await Promise.all([import("./main-CqTmyBdW.js").then((d) => d.qK), import("./main-CqTmyBdW.js").then((d) => d.qL)]);
    await b(f, l), s = new Float64Array(a.length), c(a, f, 0, s, l, 0, s.length / 3);
  } else {
    const c = i.type === "georeferenced" ? Q.fromJSON(i) : W.fromJSON(i), { project: b } = await import("./georeference-DtlFCkIR.js").then((d) => d.g);
...
//# sourceMappingURL=SceneLayerWorker-aWojoZzK.js.map
