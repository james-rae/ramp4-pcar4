import { bx as L, iC as y, bC as z, ik as B, bE as G, bF as a, bI as E, ip as T, bG as H, fK as W, fF as R, bH as O, bz as Y, iD as q, iB as F, iE as j, iF as X, bT as V, fC as D, iG as K, bN as U } from "./main-CqTmyBdW.js";
class J extends L {
  /**
...
const Q = "path", Z = 12, ee = "M14.4 6L14 4H5v17h2v-7h5.6l.4 2h7V6z", te = "#ff0000ff", oe = 5, ae = 6, se = {
  ...
  setup(S) {
    ...
    H(() => {
      ...
      _.value = s.tileSchemas, n?.value && (b.value = `<img width='25' src='${n.value}'>`), e.geo.map.esriView?.ready && A(e.geo.map.getExtent()), P.push(
        e.event.on(
          W.MAP_EXTENTCHANGE,
          R(300, A)
        )
    ...
    const A = async (s) => {
      ...
      if (p || typeof p > "u" && !I.isWebMercator()) {
        const f = new Y("pole", { x: -96, y: 90 }), $ = await e.geo.proj.projectGeometry(
          I,
          f
        ), m = e.geo.map.mapPointToScreenPoint($);
        if (m.screenY < 0) {
          h.value = !0;
          const r = {
...
//# sourceMappingURL=index-2mMTpBTy.js.map
