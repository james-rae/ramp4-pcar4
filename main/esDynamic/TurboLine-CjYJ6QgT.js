import { af as le, hX as ue } from "./main-7OeqHT8E.js";
...
async function xe() {
  ee = await (le("esri-csp-restrictions") ? await import("./libtess-asm-Kcy-4vac.js").then((i) => i.l) : await import("./libtess-DGP39HZT.js").then((i) => i.l)).default({ locateFile: (i) => ue(`esri/core/libs/libtess/${i}`) });
}
function sr(s, i) {
...
//# sourceMappingURL=TurboLine-CjYJ6QgT.js.map
