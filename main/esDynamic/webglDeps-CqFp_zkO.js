import{E as m}from"./BufferObject-DFaryCNa.js";import{r as c}from"./Program-avKsaBeD.js";import{x as p,s as l}from"./Program-avKsaBeD.js";import"./main-BL33V88t.js";import{t as u}from"./NestedMap-Ddo7BfvO.js";import{e as $,a as d}from"./ProgramTemplate-CWPx1lPQ.js";import{m as b}from"./Texture-CPZ73x3d.js";import{o as h}from"./VertexArrayObject-BwE37J7k.js";class x{constructor(e){this._rctx=e,this._store=new u}dispose(){this._store.forAll(e=>e.dispose()),this._store.clear()}acquire(e,r,t,i){const o=this._store.get(e,r);if(o!=null)return o.ref(),o;const s=new c(this._rctx,e,r,t,i);return s.ref(),this._store.set(e,r,s),s}get test(){}}function _(n){const{options:e,value:r}=n;return typeof e[r]=="number"}function y(n){let e="";for(const r in n){const t=n[r];if(typeof t=="boolean")t&&(e+=`#define ${r}
