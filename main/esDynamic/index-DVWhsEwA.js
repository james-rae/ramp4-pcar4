import { kg as I, iB as O, kh as d, ha as E, ki as P, iE as k, kj as F, ik as L, kk as R, bx as T, bC as z, bD as H, bE as N, bF as f, bI as v, ip as x, bG as D, fK as m, fF as j, bH as W, bK as q, bT as y, fC as c, fD as K, bS as X, bQ as S, iG as G, bN as g, i4 as Q } from "./main-CqTmyBdW.js";
class U extends I {
  ...
  async addMapGraphicLayer() {
    ...
    const e = new k(
      ...
      "overview-graphic"
    ), i = this.overviewmapStore.borderColour ?? "#FF0000", a = this.overviewmapStore.borderWidth ?? 1, t = this.overviewmapStore.areaColour ?? "#000000", s = this.overviewmapStore.areaOpacity ?? 0.25, n = `${t}${Math.round(s * 255).toString(
      16
    )}`;
    e.style = new F({
      fill: { colour: n },
   ...
   */
  findBasemap(e) {
    const i = this._basemapStore.find(
      (a) => a.id === e
    );
    if (i)
      return i;
   ...
   */
  updateOverview(e) {
    const i = this.overviewmapStore.expandFactor, a = this.zoomMapTo(
      e.expand(i),
      void 0,
      !1
...
const Z = { class: "relative h-full w-full overflow-hidden" }, J = { class: "absolute h-30 w-30 top-0 right-0" }, ee = ["content", "aria-label"], te = /* @__PURE__ */ z({
  __name: "overviewmap",
  setup(u) {
    const e = d(), { t: i } = H(), a = N("iApi"), t = L(), s = f(), n = v(
...
}), ie = /* @__PURE__ */ Q(te, [["__scopeId", "data-v-61900420"]]), ae = { en: { "overviewmap.expand": "Expand Overview", "overviewmap.minimize": "Minimize Overview" }, fr: { "overviewmap.expand": "Développer l'aperçu", "overviewmap.minimize": "Réduire l'aperçu" } };
class oe extends Y {
  added() {
...
//# sourceMappingURL=index-DVWhsEwA.js.map
