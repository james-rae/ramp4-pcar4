import { B as e, h as t, ht as n, m as r, mt as i } from "./main-Ll3BQWQ6.js";
...
var M = { class: "flex justify-end mb-20" }, N = ["disabled", "animation"], P = { class: "button-text" }, F = /* @__PURE__ */ a(/* @__PURE__ */ m({
	...
	setup(a) {
		let o = r(), { t: s } = ce(), m = te("iApi"), v = b(), ae = T(), x = b([]), S = c(() => o.layerSource), D = c(() => o.currStep), O = b(null), A = b(), le = b(0), M = b(!1), N = b(), P = E("stepOneStart"), ue = E("stepTwoStart"), de = E("stepThreeStart"), I = b(!1), L = b(!1), R = b(!1), z = b(!1), B = b(!1), V = b(!1), H = b(!0), fe = b(""), U = b(""), W = b([]), G = y([
			{
				value: n.FEATURE,
			...
			switch (J.value) {
				...
				case n.MAPIMAGE:
				case n.TILE:
				case n.IMAGERY: return !e;
				case n.WFS: return !0;
				case n.WMS: return !e;
				case n.GEOJSON:
				case n.SHAPEFILE:
				case n.CSV: return !!($() && !q.value);
				default: return !1;
			}
		}), he = c(() => {
		...
		let _e = async (e) => {
			...
			let r = J.value === n.FEATURE && !(Y.value && Y.value.fields);
			if (!Y.value || r) {
				I.value = !0, Y.value = {
					config: {
						id: "Placeholder",
			...
			if (o.nested = e, W.value = [], le.value += 1, J.value === n.MAPIMAGE) {
