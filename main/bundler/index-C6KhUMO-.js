...
import "tiny-emitter";
import { G as re, L as ve, F as be } from "./main-Bb_nYiRc.js";
...
class ut extends xe {
  async init() {
    ...
    this.$vApp.$el.getElementsByClassName("inner-shell")[0].appendChild(r.childNodes[0]), Object.entries(Pe).forEach((t) => this.$iApi.$i18n.mergeLocaleMessage(...t)), this._parseConfig(this.config), Y(this.$vApp.$pinia).supportedTypes.forEach((t) => {
      const n = `${t.type}-icon`;
      this.$iApi.component(n, fe(Ae(/* @__PURE__ */ Object.assign({ "./icons/circle-icon.vue": () => import("./circle-icon-Cjhivo08.js"), "./icons/edit-icon.vue": () => import("./edit-icon-DYWISd1o.js"), "./icons/point-icon.vue": () => import("./point-icon-D2z5sPUG.js"), "./icons/polygon-icon.vue": () => import("./polygon-icon-C3NDiv0w.js"), "./icons/polyline-icon.vue": () => import("./polyline-icon-D9hrD4t0.js"), "./icons/rectangle-icon.vue": () => import("./rectangle-icon-DGLPd1tt.js") }), `./icons/${t.type}-icon.vue`, 3)));
    });
  }
  async added() {
