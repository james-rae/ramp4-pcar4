...
import { _ as H, d as L, F as K, G as X } from "./main-Bb_nYiRc.js";
...
const W = /* @__PURE__ */ H(te, [["render", ne]]), ie = /* @__PURE__ */ O({
  ...
  setup(b) {
    const i = S("iApi"), { t } = N(), o = ee(), p = [
      {
        type: "point",
        icon: f(g(() => import("./point-icon-D2z5sPUG.js")))
      },
      {
        type: "polyline",
        icon: f(g(() => import("./polyline-icon-D9hrD4t0.js")))
      },
      {
        type: "polygon",
        icon: f(g(() => import("./polygon-icon-C3NDiv0w.js")))
      },
      {
        type: "circle",
        icon: f(g(() => import("./circle-icon-Cjhivo08.js")))
      },
      {
        type: "rectangle",
        icon: f(g(() => import("./rectangle-icon-DGLPd1tt.js")))
      }
    ], a = E(() => {
      const s = p.filter((v) => o.supportedTypes.some((x) => x.type === v.type));
      return s.push({
        type: "edit",
        icon: f(g(() => import("./edit-icon-DYWISd1o.js")))
      }), s;
    }), n = (s) => {
