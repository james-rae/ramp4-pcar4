...
import { _ as H, d as L, F as K, G as X } from "./main-D3pwgo8A.js";
...
const G = /* @__PURE__ */ H(te, [["render", ne]]), ie = /* @__PURE__ */ I({
  ...
  setup(f) {
    const i = S("iApi"), { t } = B(), o = ee(), p = [
      {
        type: "point",
        icon: g(_(() => import("./point-icon-CYjELMs8.js")))
      },
      {
        type: "polyline",
        icon: g(_(() => import("./polyline-icon-GUTci_Kp.js")))
      },
      {
        type: "polygon",
        icon: g(_(() => import("./polygon-icon-SUB9DaDB.js")))
      },
      {
        type: "circle",
        icon: g(_(() => import("./circle-icon-2OlQ8NxF.js")))
      },
      {
        type: "rectangle",
        icon: g(_(() => import("./rectangle-icon-BxBCacZs.js")))
      }
    ], a = M(() => {
      const s = p.filter((u) => o.supportedTypes.some((x) => x.type === u.type));
      return s.push({
        type: "edit",
        icon: g(_(() => import("./edit-icon-PZejC5Bl.js")))
      }), s;
    }), n = (s) => {
