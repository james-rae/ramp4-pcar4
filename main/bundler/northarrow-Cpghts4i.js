import { B as e, Q as t, Y as n, ct as r, gt as i, ht as a, s as o, v as s } from "./main-Ll3BQWQ6.js";
...
var x = class extends o {
	...
	setup(o) {
		...
		let L = async (e) => {
			...
			if (o || o === void 0 && !u.isWebMercator()) {
				let e = new t("pole", {
					x: -96,
					y: 90
				}), o = await w.geo.proj.projectGeometry(u, e), d = w.geo.map.mapPointToScreenPoint(o);
				if (d.screenY < 0) {
					j.value = !0;
					let e = {
					...
					w.geo.map.addLayer(t), t.loadPromise().then(() => {
						let i = new r(o, "northpole");
						i.style = new n(e), t.addGraphic(i);
					});
				}
