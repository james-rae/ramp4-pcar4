...
var L = /* @__PURE__ */ r(P, [["render", I]]), R = /* @__PURE__ */ m({
	...
	setup(e) {
		...
		], d = s(() => r.configParsed ? [...i.filter((e) => r.supportedTypes.some((t) => t.type === e.type)), {
			type: "edit",
		...
		return (t, i) => {
			let a = T("mapnav-button");
			return d.value.length ? (S(), u("div", {
				key: 0,
				class: v([{ active: O(r).activeTool || O(r).activeTool == "" }, "mapnav-section bg-white-75 hover:bg-white"])
			}, [(S(!0), u(o, null, w(d.value, (t, i) => (S(), c(a, {
				key: t.type,
				onMousedown: m,
				onClickFunction: () => f(t.type),
				tooltip: O(n)(`draw.${t.type}.tooltip`),
				style: y({ marginBottom: i === d.value.length - 1 ? "0" : "0px" }),
...
}), [["__scopeId", "data-v-9be7441e"]]), B = { class: "mapnav absolute right-0 bottom-0 pb-36 sm:pb-48 pr-12" }, V = ["content"], H = { class: "mapnav-section bg-white-75 hover:bg-white" }, U = {
	key: 1,
