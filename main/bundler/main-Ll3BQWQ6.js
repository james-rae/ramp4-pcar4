...
import * as h from "@arcgis/core/geometry/operators/intersectsOperator";
import { fromJSON as ee } from "@arcgis/core/geometry/support/jsonUtils";
import g from "@arcgis/core/request";
import te from "@arcgis/core/symbols/PictureMarkerSymbol";
import ne from "@arcgis/core/symbols/SimpleFillSymbol";
import re from "@arcgis/core/symbols/SimpleLineSymbol";
import ie from "@arcgis/core/symbols/SimpleMarkerSymbol";
import { fromJSON as ae } from "@arcgis/core/symbols/support/jsonUtils";
import "@arcgis/map-components/components/arcgis-sketch";
import "@arcgis/map-components/components/arcgis-swipe";
import { merge as oe } from "es-toolkit";
import { applyConverter as se } from "@terraformer/spatial";
import _ from "proj4";
import { TinyEmitter as ce } from "tiny-emitter";
import { createPinia as le, defineStore as v, storeToRefs as ue } from "pinia";
import { Fragment as de, Teleport as fe, Transition as pe, TransitionGroup as me, computed as y, createApp as he, createBlock as b, createCommentVNode as x, createElementBlock as S, createElementVNode as C, createTextVNode as ge, createVNode as w, defineAsyncComponent as _e, defineComponent as T, getCurrentInstance as ve, h as ye, inject as be, markRaw as E, mergeProps as xe, nextTick as Se, normalizeClass as D, normalizeStyle as Ce, onBeforeUnmount as we, onMounted as Te, onUpdated as Ee, openBlock as O, reactive as De, ref as k, render as Oe, renderList as ke, renderSlot as Ae, resolveComponent as A, resolveDirective as j, resolveDynamicComponent as je, toDisplayString as M, toRaw as Me, unref as N, useCssVars as Ne, useTemplateRef as Pe, vShow as Fe, watch as Ie, withCtx as P, withDirectives as F, withKeys as Le, withModifiers as Re } from "vue";
import { debounce as ze, throttle as Be } from "es-toolkit/function";
import { createI18n as Ve, useI18n as I } from "vue-i18n";
import He from "screenfull";
import { cloneDeep as Ue } from "es-toolkit/object";
import We from "animejs";
import { createPopper as Ge, detectOverflow as Ke } from "@popperjs/core";
import "tippy.js/animations/scale.css";
import qe, { setDefaultProps as Je, useTippy as Ye } from "vue-tippy";
import Xe from "linkify-html";
import Ze from "redaxios";
import Qe from "await-to-js";
import { geojsonToArcGIS as $e } from "@terraformer/arcgis";
import { csv2geojson as et, dsv as tt } from "csv2geojson";
import nt from "svg.js";
...
var rt = /* @__PURE__ */ function(e) {
	...
	_angle;
	constructor(e) {
		if (e ||= { style: it.CIRCLE }, super(), this._style = e.style || it.CIRCLE, e.style === it.ICON) {
			let t = e;
			...
			let t = e;
			this._size = Tt.convToPoints(t.size) || 12, this._colour = new wt(t.colour ?? "#ffffff40"), this._outline = new Dt(t.outline), this._path = this._style === it.PATH && t.path || "", this._height = 0, this._width = 0, this._icon = "";
		}
	...
	propGrouse(e) {
		this._style === it.ICON !== e && console.warn(`Accessed a point style property that is invalid for the style type ${this._style}`);
	}
	toOptions() {
		let e = {
	...
	static fromESRI(t) {
		...
		if (t.type === "simple-marker") {
			let e = n;
			e.style = t.style, e.colour = t.color.toRgba(), e.size = t.size, e.path = t.path, e.outline = Dt.fromESRI(t.outline).toOptions();
		} else {
			let e = n;
			e.style = it.ICON, e.width = t.width, e.height = t.height, e.icon = t.url;
		}
		return new e(n);
	}
	static fromArcServer(t) {
		return e.fromESRI(ae(t));
	}
	static isImageUrl(e) {
	...
	_colour;
	constructor(e) {
		e ||= {}, super(), this._style = e.style || at.SOLID;
		let t = Tt.convToPoints(e.width);
		this._width = t === void 0 || t < 0 ? .75 : t, this._colour = new wt(e.colour), this._miter = e.miter ?? 2, this._cap = e.cap || st.ROUND, this._join = e.join || ot.ROUND;
	}
	get styleType() {
		return this._style;
	}
	...
	_fillStyle;
	constructor(e) {
		super(), e ||= {}, e.fill ||= {}, this._fillColour = new wt(e.fill.colour), this._fillStyle = e.fill.style || ct.SOLID, this._outlineStyle = new Dt(e.outline);
	}
	get fillColour() {
	...
	toESRI() {
		let e = this.outline.toESRI(), t = new a(this.fillColour.rgba), n = new ne();
	...
	geomGeoJsonToRamp(e, t) {
		switch (e.type) {
			...
			case B.LINESTRING: return vt.fromGeoJSON(e, t);
			case B.POLYGON: return xt.fromGeoJSON(e, t);
			case B.MULTIPOINT: return _t.fromGeoJSON(e, t);
			case B.MULTILINESTRING: return yt.fromGeoJSON(e, t);
			case B.MULTIPOLYGON: return St.fromGeoJSON(e, t);
			default: throw Error(`Encountered unhandled geometry type ${e.type}`);
		}
	}
	geomRampToGeoJson(e) {
	...
	updateQuery(e) {
		let t = oe({}, this.queryMap);
		return oe(t, e), `${this.base}${Object.entries(t).filter(([, e]) => e !== void 0).map(([e, t], n) => `${n === 0 ? "?" : ""}${e}=${t}`).join("&")}`;
	}
	...
	defaultEpsgLookup(e) {
		...
		return new Promise((e, n) => {
			g(`https://epsg.io/${t[1]}.proj4`, { responseType: "text" }).then((t) => {
				t.data ? e(t.data) : n();
			}, (e) => {
				n(e);
			});
	...
	async projectGeoJson(e, t, n) {
		let r, i;
		if (r = t ? this.normalizeProj(t) : q.parseGeoJsonCrs(e.crs), i = n ? this.normalizeProj(n) : It, i === r) return e;
...
var Ut = class {
	...
	_funCounter;
	constructor(e) {
		super(e), this._eventBus = new ce(), this._eventRegister = [], this._funCounter = 1, this._nameRegister = Object.values(Z).filter((e) => typeof e == "string" && e.indexOf("/") > -1);
	}
	findHandler(e) {
	...
	defaultHandlerFactory(e) {
		...
		switch (e) {
			...
			case Q.MAP_EXTENT_UPDATES_MAPTIP:
				...
				}, this.$iApi.event.on(Z.MAP_EXTENTCHANGE, Be(() => n(), 50, { edges: ["leading"] }), e);
				break;
			...
			case Q.MAP_KEYDOWN_UPDATES_COORDS:
				this.$iApi.event.on(Z.MAP_KEYDOWN, Be(() => {
			...
			case Q.MAP_MOUSE_UPDATES_COORDS:
				this.$iApi.event.on(Z.MAP_MOUSEMOVE, Be((e) => {
			...
			case Q.MAP_MOUSE_UPDATES_MAPTIP:
				...
				}, this.$iApi.event.on(Z.MAP_MOUSEMOVE, Be((e) => n(e), 50), e);
				break;
			case Q.MAP_MOUSEDOWN_UPDATES_MAPTIP:
				...
				}, this.$iApi.event.on(Z.MAP_MOUSEDOWN, Be((e) => {
					let t = {
						screenX: e.offsetX,
						screenY: e.offsetY,
						button: e.button,
...
var rn = v("maptip", () => {
	...
	__name: "esri-map",
	setup(e) {
		let t = rn(), n = be("iApi"), r = y(() => t.maptipPoint), i = y(() => t.maptipInstance), a = y(() => t.content), o = De([]), s = k(!1);
		o.push(Ie(r, () => {
			if (r.value) {
	...
	setup(e) {
		...
		return (n, r) => {
			...
			return O(), S("div", {
				...
				default: P(() => [F((O(), b(je(e.panel.route.screen), xe({ class: "h-full" }, e.panel.route.props, { panel: e.panel }), null, 16, ["panel"])), [[i]])]),
				_: 1
			})], 14, cn);
		};
	}
...
}), dn = /* @__PURE__ */ n(/* @__PURE__ */ T({
	__name: "panel-stack",
	setup(e) {
		Ne((e) => ({ v3d36ee4c: i.value }));
		let t = un(), n = be("iApi"), r = k(), i = y(() => t.opacity), a = y(() => t.mobileView);
		Te(() => {
		...
		return (e, t) => (O(), b(me, {
			...
			default: P(() => [(O(!0), S(de, null, ke(o(N(n).screenSize), (e) => (O(), b(ln, {
				key: `${e.id}`,
				panel: e
			}, null, 8, ["panel"]))), 128))]),
			_: 1
...
}), [["__scopeId", "data-v-717e4bd7"]]), fn = ["content", "aria-label"], pn = /* @__PURE__ */ T({
	...
	setup(e) {
		let t = k(!1), n = k(null), r = De([]), i = k(), a = k(), o = k(), s = e;
		r.push(Ie(t, () => {
			n.value.update();
		}));
		let c = () => {
		...
		return Te(() => {
			window.addEventListener("click", (e) => {
				...
				(!i.value || !i.value.contains(e.target)) && (t.value = !1);
			}), o.value.addEventListener("focus", l), o.value.addEventListener("blur", u), o.value.addEventListener("mouseover", l), o.value.addEventListener("mouseleave", u), Se(() => {
				o.value && a.value && (n.value = Ge(o.value, a.value, {
			...
			return O(), S("div", {
				...
				ref_key: "dropdown",
				ref: a
			}, [Ae(r.$slots, "default", { close: () => t.value = !t.value })], 2), [[Fe, t.value]])], 512);
		};
	}
}), mn = v("notification", () => {
...
}), hn = { class: "h-full flex flex-col" }, gn = { class: "w-full flex mb-6" }, _n = ["content", "aria-label"], vn = /* @__PURE__ */ T({
	__name: "screen",
	props: { panel: {
		type: Object,
		required: !0
	...
	setup(e) {
		let t = mn(), { t: n } = I(), r = y(() => t.notificationNumber), i = () => t.clearAll();
		return (t, a) => {
			let o = A("panel-screen"), s = j("tippy");
			return O(), b(o, { panel: e.panel }, {
				header: P(() => [ge(M(N(n)("notifications.title")), 1)]),
				content: P(() => [C("div", hn, [C("div", gn, [F((O(), S("button", {
					type: "button",
					onClick: i,
	...
	constructor(e) {
		super(e), this.$iApi.panel.register({
			id: "notifications",
			config: {
				screens: { "notifications-screen": E(vn) },
	...
	setup(e, { emit: t }) {
		...
		return (t, i) => {
			...
			return F((O(), S("li", {
				...
				C("span", null, [ge(M(o[e.notification.type]) + " ", 1), C("span", wn, M(e.notification.message), 1)]),
			...
			]), e.notification.messageList && a.value ? (O(), S("div", En, [(O(!0), S(de, null, ke(e.notification.messageList, (t, n) => (O(), S("p", { key: e.notification.id + t + n }, M(t), 1))), 128))])) : x("", !0)], 10, Sn)), [[c, {
				onShow: s,
				theme: "ramp4",
				animation: "scale"
			}]]);
	...
	setup(e) {
		...
		return (e, t) => {
			...
			}, [(O(!0), S(de, null, ke(c.value, (e, t) => (O(), S(de, { key: e.id }, [t > 0 ? (O(), S("div", kn)) : x("", !0), F(w(Dn, {
				ref_for: !0,
...
}), Mn = { class: "flex items-center hover:text-white" }, Nn = ["aria-label"], Pn = {
	key: 0,
	class: "number rounded-full w-18 text-white"
}, Fn = { class: "notification-dropdown pointer-events-auto bg-white rounded text-center text-black w-500 h-256 flex flex-col p-0" }, In = { class: "pb-8 border-b border-gray-600" }, Ln = { class: "absolute flex right-3 top-3" }, Rn = ["content", "aria-label"], zn = /* @__PURE__ */ n(/* @__PURE__ */ T({
	...
	setup(e) {
		...
		return (e, t) => {
			...
			return O(), b(pn, {
				...
				header: P(() => [C("div", Mn, [(O(), S("svg", {
					class: "fill-current w-24 h-24",
					xmlns: "http://www.w3.org/2000/svg",
					viewBox: "0 0 24 24",
					"aria-label": N(n)("notifications.open")
				}, [...t[0] ||= [C("path", { d: "M12 22c1.1 0 2-.9 2-2h-4c0 1.1.89 2 2 2zm6-6v-5c0-3.07-1.64-5.64-4.5-6.32V4c0-.83-.67-1.5-1.5-1.5s-1.5.67-1.5 1.5v.68C7.63 5.36 6 7.92 6 11v5l-2 2v1h16v-1l-2-2z" }, null, -1)]], 8, Nn)), r.value && r.value > 0 ? (O(), S("span", Pn, M(r.value), 1)) : x("", !0)])]),
				default: P((e) => [C("div", Fn, [C("div", null, [C("h4", In, M(N(n)("notifications.title")), 1), C("div", Ln, [F((O(), S("button", {
					type: "button",
					onClick: i,
					...
					animation: "scale",
					appendTo: "parent"
				}]]), w(a, { onClick: e.close }, null, 8, ["onClick"])])]), w(jn, { class: "overflow-y-auto h-230" })])]),
				_: 1
			}, 8, ["tooltip"]);
		};
	}
}), [["__scopeId", "data-v-3623a7d2"]]), Bn = { class: "flex hover:text-white" }, Vn = ["aria-label"], Hn = { class: "about-ramp-dropdown pointer-events-auto bg-white rounded w-256 h-50" }, Un = ["aria-label", "content"], Wn = { class: "pb-8 pt-1 border-b border-gray-600 mb-10" }, Gn = { class: "absolute right-5 top-5" }, Kn = { class: "select-text" }, qn = { class: "font-bold cursor-text" }, Jn = { class: "text-sm cursor-text" }, Yn = { class: "font-bold cursor-text" }, Xn = { class: "ml-5 cursor-text" }, Zn = { class: "mt-5" }, Qn = ["href"], $n = /* @__PURE__ */ n(/* @__PURE__ */ T({
	...
	setup(e) {
		...
		return (n, s) => {
			...
			return F((O(), b(l, {
				...
				default: P((e) => [C("div", Hn, [C("div", null, [
					F((O(), S("button", {
						...
						xmlns: "http://www.w3.org/2000/svg",
						viewBox: "0 0 24 24"
					}, [C("path", { d: "M17.65 6.35C16.2 4.9 14.21 4 12 4c-4.42 0-7.99 3.58-7.99 8s3.57 8 7.99 8c3.73 0 6.84-2.55 7.73-6h-2.08c-.82 2.33-3.04 4-5.65 4-3.31 0-6-2.69-6-6s2.69-6 6-6c1.66 0 3.14.69 4.22 1.78L13 11h7V4l-2.35 2.35z" })], -1)]], 8, Un)), [[u, {
						placement: "bottom-start",
						theme: "ramp4",
						animation: "scale"
					}]]),
					C("h4", Wn, M(N(t)("ramp.about")), 1),
					C("div", Gn, [w(c, { onClick: e.close }, null, 8, ["onClick"])]),
					C("div", Kn, [
						C("div", null, [C("span", qn, M(i.value), 1), C("span", Jn, " [" + M(a.value) + "] ", 1)]),
						C("div", null, [C("span", Yn, M(o.value[0]), 1), C("span", Xn, M(o.value[1]), 1)]),
...
}), [["__scopeId", "data-v-cf71f458"]]), er = "__HELP__", tr = v("keyboardnav", () => {
	...
	__name: "map-caption",
	setup(e) {
		let n = Kt(), r = tr(), i = t(), { t: a } = I(), o = be("iApi"), s = y(() => n.scale), c = y(() => n.attribution), l = y(() => n.coords), u = y(() => n.langtoggle), d = y(() => i.config.map), { keyChain: f, lastAction: p, chainState: m, namespaces: h, activeNamespace: ee } = ue(r), g = y(() => {
		...
		return (e, t) => {
			...
			return O(), S("div", nr, [
				...
				w(zn, { class: "sm:block display-none" }),
				...
				]), g.value.description ? (O(), S("span", cr, "- " + M(g.value.description) + "...", 1)) : x("", !0)])) : c.value?.text.disabled ? x("", !0) : F((O(), S("span", lr, [ge(M(c.value?.text.value), 1)])), [[r, { options: {
					placement: "top",
					hideOnClick: !1,
					theme: "ramp4",
					animation: "scale"
				...
				C("div", ur, [
					l.value?.disabled ? x("", !0) : F((O(), S("div", dr, [ge(M(l.value?.formattedString), 1)])), [[r, { options: {
						hideOnClick: !1,
						theme: "ramp4",
						animation: "scale"
					} }]]),
                ...
                `,
					...
					u.value?.disabled ? x("", !0) : (O(), b(n, {
						...
						default: P(() => [(O(!0), S(de, null, ke(te.value, (e, t) => (O(), S("a", {
							key: `${e}-${t}`,
							class: D(["flex-auto items-center text-sm sm:text-base cursor-pointer", { "font-bold": e === N(o).$i18n.locale.value }]),
							href: "javascript:;",
							onClick: (t) => re(e)
						}, [ge(M(N(a)("map.language." + e)) + " ", 1), e === N(o).$i18n.locale.value ? (O(), S("span", gr, M(N(a)("map.language.curr")), 1)) : x("", !0)], 10, hr))), 128))]),
						_: 1
					}, 8, ["tooltip", "ariaLabel"]))
				])
			]);
	...
	setup(e) {
		let t = mn(), n = be("iApi"), { t: r } = I(), i = y(() => t.notificationNumber);
		return (e, t) => {
			let a = j("tippy");
			return F((O(), S("button", {
				type: "button",
	...
	setup(e) {
		...
		return (e, t) => {
			...
			return r.value ? (O(), S("div", {
				...
				(O(!0), S(de, null, ke(i.value, (e) => (O(), S("p", {
	...
	components: { Shell: /* @__PURE__ */ n(/* @__PURE__ */ T({
		__name: "shell",
		setup(e) {
			let t = be("iApi"), n = wr(), r = Yt(), i = un(), { t: a } = I(), o = y(() => r.items.appbar), s = () => {
			...
			return (e, t) => (O(), S("div", Tr, [
				C("div", Er, [
					...
					w(dn, { class: "panel-stack sm:flex absolute inset-0 overflow-hidden sm:p-12 z-10 sm:pl-80 xs:pl-40 sm:pb-48 xs:pb-28 xs:pr-0 sm:pr-40" }),
					o.value ? x("", !0) : (O(), b(br, { key: 0 })),
					w(_r, { class: "z-30" })
				]),
				N(n).started ? (O(), b(an, { key: 0 })) : (O(), S("div", Or, [...t[1] ||= [C("div", { class: "spinner relative inset-x-1/2 inset-y-9/20" }, null, -1)]])),
				(O(!0), S(de, null, ke(c(), (e) => (O(), b(fe, {
	...
	setup() {
		let e = ve();
		Te(() => {
			new sn().observe(e?.proxy?.$refs["app-size"]), Je({
...
var Yr = /* @__PURE__ */ function(e) {
	...
	mounted(e, t) {
		let n;
		t.value && t.value.externalTrigger && (n = e.closest(`[${si}]`)), Ye(e, {
...
var fi = ["content"], pi = {
	...
	setup(e, { expose: t }) {
		let { t: n } = I(), i = un(), a = Wt(), o = be("iApi"), s = Pe("el"), c = Pe("contentEl"), l = k(), u = k(), d = k();
		t({ el: s });
		...
		}, se = () => !m.value && !f.panel.teleport, _ = (e) => {
			f.panel.move(e), e === "left" && Se(() => {
		...
		return Te(() => {
			...
			return F((O(), S("div", {
				...
				e.header ? (O(), S("header", pi, [
					...
					F((O(), S("h2", mi, [t.$slots.header ? Ae(t.$slots, "header", { key: 0 }) : (O(), S("div", hi, M(N(n)(e.panel.alertName)), 1))])), [[ee]]),
					t.$slots.controls ? (O(), b(a, { key: 0 }, {
						default: P(() => [Ae(t.$slots, "controls")]),
						_: 3
					})) : x("", !0),
					C("div", { class: D(e.panel.teleport ? "flex" : "display-none sm:flex") }, [
						e.panel.teleport ? x("", !0) : (O(), S("div", gi, [
							h.value ? (O(), b(o, {
								key: 0,
								onClick: r[1] ||= (e) => _("left"),
								active: !e.panel.isLeftMostPanel
							}, null, 8, ["active"])) : x("", !0),
							h.value ? (O(), b(l, {
								key: 1,
								onClick: r[2] ||= (e) => _("right"),
				...
				e.content ? (O(), S("div", {
					...
					ref: c,
					tabindex: "-1"
				}, [t.$slots.content ? Ae(t.$slots, "content", { key: 0 }) : ce.value ? (O(), S("div", {
					key: 1,
					innerHTML: ce.value.innerHTML
				}, null, 8, _i)) : x("", !0)], 512)) : x("", !0),
				e.footer ? F((O(), S("div", vi, [Ae(t.$slots, "footer")])), [[g]]) : x("", !0)
			], 8, fi)), [[te, {
				trigger: "manual",
				touch: !1,
				onShow: se,
...
var Vi = { class: "relative" }, Hi = ["content", "aria-label"], Ui = /* @__PURE__ */ T({
	...
	setup(e) {
		...
		return (e, n) => (O(), b(pn, {
			...
			default: P(() => [Ae(e.$slots, "default", {}, void 0, !0)]),
			_: 3
		}, 8, ["tooltip"]));
	}
	...
	setup(e) {
		let { t } = I(), n = be("iApi"), r = De([]), i = async () => {
			if (r.length) a(r);
			else {
				let e = await o({
					maximumAge: Infinity,
					...
					e.code === GeolocationPositionError.PERMISSION_DENIED ? n.notify.show(yn.ERROR, t("mapnav.geolocator.error.permission")) : n.notify.show(yn.ERROR, t("mapnav.geolocator.error.internal"));
				});
	...
	setup(e) {
		return (t, n) => {
			...
			}, [Ae(t.$slots, "default")], 10, ea)), [[r], [i, { placement: "left" }]])]);
		};
	}
}), na = {
	class: "relative",
	...
	setup(e) {
		let t = be("iApi"), n = e, r = () => t.event.emit(Z.APPBAR_BUTTON_CLICK, n.buttonId);
		return (t, n) => {
			...
			}, [Ae(t.$slots, "default", {}, void 0, !0)], 8, ra)), [[i], [a, {
				allowHTML: !0,
				placement: "right"
			}]])]);
		};
...
var Ia = v("geosearch", () => {
	...
	constructor(e, t, n) {
		...
		this.$vApp = r.app, this.$element = r.element, this.$i18n = r.i18n, this.$rootEl = r.app.$root?.$el, this.fixture = new ds(this), this.panel = new ps(this), this.geo = new ls(this), this.dev = new bs(this), this.ui = {
			...
			escapeHtml: () => "",
			isPlainText: () => !0
		}, this.notify = new bn(this), this._isFullscreen = He.isEnabled && !!this.$vApp.$root && He.isFullscreen && He.element === this.$vApp.$root.$el, He.isEnabled && He.onchange(() => {
			this._isFullscreen = He.isEnabled && !!this.$vApp.$root && He.isFullscreen && He.element === this.$vApp.$root.$el;
		}), this.initialize(!0, t, n);
	}
	initialize(e, n, r) {
		let i = t(this.$vApp.$pinia), a = un(this.$vApp.$pinia), o = rn(this.$vApp.$pinia);
		if (n?.configs !== void 0) {
	...
	reloadWorker(n, r) {
		let i = wr(this.$vApp.$pinia), a = mn(this.$vApp.$pinia), o = t(this.$vApp.$pinia), s = Yt(this.$vApp.$pinia), c = e(this.$vApp.$pinia), l = Gt(this.$vApp.$pinia), u = !!n;
	...
	setLanguage(e) {
		...
		let n = t(this.$vApp.$pinia), r = mn(this.$vApp.$pinia), i = n.registeredLangs;
	...
	toggleFullscreen() {
		He.isEnabled && He.toggle(this.$element._container || void 0);
	}
	get isFullscreen() {
...
function Za(e, t) {
	...
	n.use(({ store: e }) => {
		let t = Ue(e.$state);
		e.$reset = () => e.$patch(Ue(t));
	});
	let r = nn(), i = he(Nr).use(r).use(qe, {
		directive: "tippy",
		component: "tippy"
	}).use(n);
	return i.directive("focus-container", ii), i.directive("focus-list", Ur), i.directive("focus-item", qr), i.directive("truncate", ci), i.component("panel-screen", xi), i.component("pin", Ti), i.component("close", Oi), i.component("back", ji), i.component("expand", Ii), i.component("panel-options-menu", qi), i.component("dropdown-menu", pn), i.component("minimize", zi), i.component("right", Ui), i.component("left", Ki), i.component("fullscreen-nav-button", Xi), i.component("geolocator-nav-button", Zi), i.component("home-nav-button", Qi), i.component("mapnav-button", ta), i.component("appbar-button", ia), i.component("transition", pe), i.component("transition-group", me), i.config.globalProperties.$iApi = t, i.config.globalProperties.$pinia = n, i.config.idPrefix = `ramp-${e.id || Ls.sharedUtils.generateUUID()}`, i.provide("iApi", t), {
		element: i,
		app: i.mount(e),
		i18n: r.global
	};
...
var Qa = class e {
	...
	async applyBasemap(e) {
		...
		t.esriBasemap.id !== n && (this.esriMap.basemap = Me(t.esriBasemap));
	}
	async setBasemap(e) {
	...
	async applyBasemap(e) {
		...
		this.esriMap.basemap = Me(n.esriBasemap);
	...
	async setBasemap(e) {
		...
		if (i) {
			...
			let t = await K.ColorBackground({ color: new wt(r.backgroundColour).toESRI() });
	...
	runIdentify(e) {
		...
		r.type === L.POINT && t.some((e) => e.identifyMode === V.HYBRID || e.identifyMode === V.SYMBOLIC) && (i = this.symbolIdentify(n.screenX, n.screenY));
		let a = {
			geometry: r,
			hitTest: i
...
var uo = class extends X {
	async fetchFileData(e, t) {
		let n = await Ze.get(e, { responseType: "arrayBuffer" });
		switch (t) {
			case R.GEOJSON:
	...
	extractCsvFields(e, t = ",") {
		return tt.dsvFormat(t).parseRows(e)[0].map((e) => ({
			name: e,
			type: rt.STRING
		}));
	}
	filterCsvLatLonFields(e, t = ",") {
		let n = tt.dsvFormat(t).parseRows(e), r = n[0], i = {
	...
	inferType(e) {
		return typeof e == "number" ? rt.DOUBLE : rt.STRING;
	}
	...
	async loadWfsData(e, t = -1, n = 0, r = 1e3, i = {
		...
		let c = new Ft(e).updateQuery(s), [l, u] = await Qe(Ze.get(c, { signal: o }));
	...
	async parseCapabilities(e) {
		let t = async () => {
			...
			return (await g(t, { responseType: "xml" })).data;
		}, n = new Promise((e) => {
			t().then((t) => e(t)).catch(() => {
	...
	async loadLayerMetadata(e) {
		...
		let [t, n] = await Qe(g(e, { query: { f: "json" } }));
	...
	constructor(e, t) {
		super(e, t), this.name = e.name || "", this.geomType = L.NONE, this.dataFormat = z.UNKNOWN, this.layerType = R.UNKNOWN, this.layerFormat = ut.UNKNOWN;
	...
	updateDrawState(e) {
		this.drawState = e, e === dt.REFRESH ? this.startTimer(_o.DRAW) : e === dt.UP_TO_DATE && this.stopTimer(_o.DRAW), this.$iApi.event.emit(Z.LAYER_DRAWSTATECHANGE, {
			state: e,
			layer: this
		});
	}
	async initiate() {
		...
		}, this.expectedTime.fail), [r] = await Qe(this.onInitiate());
		clearTimeout(n), t > this.lastCancel && (this.drawState !== dt.UP_TO_DATE && this.startTimer(_o.DRAW), r ? e(`Init error on layer id: ${this.id} . ${r.message}`) : this.updateInitiationState(H.INITIATED));
	}
	async onInitiate() {
	...
	async terminate() {
		this.updateInitiationState(H.TERMINATING), await Promise.all(this.sublayers.map((e) => e.terminate())), this.loadDefProm = new Y(), this.loadPromDone = !1, this.updateLayerState(U.NEW), this.updateDrawState(dt.NOT_LOADED), this.updateInitiationState(H.TERMINATED);
	}
	onLoad() {
	...
	onError(e = !0) {
		this.layerState !== U.ERROR && (this.initiationState === H.INITIATING && this.updateInitiationState(H.NEW), this.loadPromDone && (this.loadDefProm = new Y()), this.loadDefProm.rejectMe(), this.loadPromDone = !0, this.sublayers.forEach((t) => t.onError(e)), e && this.$iApi.notify.show(yn.ERROR, this.$iApi.$i18n.t("layer.error", { id: this.id })), this.stopTimer(_o.DRAW), this.stopTimer(_o.LOAD), this.updateLayerState(U.ERROR, !e));
	}
	onLoadActions() {
		return [];
	}
	...
	esriWatches;
	constructor(e, t) {
		super(e, t), this._scaleSet = new jt(), this._mouseTolerance = e.mouseTolerance == null ? 5 : e.mouseTolerance, this._touchTolerance = e.touchTolerance == null ? 15 : e.touchTolerance, this._drawOrder = [], this._serverVisibility = void 0, this.isCosmetic = e.cosmetic || !1, this.extent = e.extent ? Ct.fromConfig(`${this.id}_extent`, e.extent) : void 0, this.viewDefProm = new Y(), this.esriWatches = [];
	}
	noLayerErr() {
	...
	filter;
	constructor(e, t) {
		super(e, t), this.supportsIdentify = !0, this.geomType = L.UNKNOWN, this.serviceUrl = "", this.fieldList = "", this.canModifyLayer = !0, this.filter = new Mt(e.permanentFilteredQuery || "", e.initialFilteredQuery || ""), e.state?.hovertips !== void 0 && console.warn("hovertips layer configuration property is deprecated. Please adjust to use maptips instead"), this.maptips = e.state?.maptips ?? e.state?.hovertips ?? !0, this.attribs = new qo();
	}
	makeEsriLayerConfig(e) {
	...
	async getGraphic(e, t) {
		...
		if (t.getStyle) {
			let e = Me(this.renderer.getGraphicSymbol(n));
	...
	constructor(e, t) {
		super(e, t), this.dataFormat = z.ESRI_FEATURE, this.layerFormat = ut.GRAPHIC, this.maptips = !1;
	}
	_graphics = [];
	makeEsriLayerConfig(e) {
		return super.makeEsriLayerConfig(e);
	...
	sourceGeoJson;
	constructor(e, t) {
		super(e, t), this.supportsIdentify = !0, this.isFile = !0, this.dataFormat = z.ESRI_FEATURE, this.layerFormat = ut.FEATURE, this.layerIdx = 0, e.identifyMode && e.identifyMode !== V.NONE ? this.identifyMode = e.identifyMode : this.identifyMode = V.HYBRID;
	}
	async reload() {
	...
	extractLayerMetadata() {
		...
		this.supportsFeatures = !0, this.geomType = this.$iApi.geo.geom.clientGeomTypeToRampGeomType(e.geometryType), this.scaleSet.minScale = e.minScale || 0, this.scaleSet.maxScale = e.maxScale || 0, this.extent = this.extent ?? Ct.fromESRI(e.fullExtent, this.id + "_extent"), this.fields = E(e.fields.slice()).map((e) => ({
			name: e.name,
			alias: e.alias,
			type: e.type,
			length: e.length
	...
	async getGraphic(e, t) {
		...
		if (t.getStyle) {
			let e = Me(this.renderer.getGraphicSymbol(n.attributes));
	...
	constructor(e, t) {
		super(e, t), this.dataFormat = z.ESRI_FEATURE, this.supportsIdentify = !0, this.layerType = R.FEATURE, this.layerFormat = ut.FEATURE, e.identifyMode && e.identifyMode !== V.NONE ? this.identifyMode = e.identifyMode : this.identifyMode = V.HYBRID;
	}
	async onInitiate() {
	...
	async getGraphicExtent(e) {
		...
		if (!this.layerExists) this.noLayerErr();
			...
			if (n) t = n;
				...
				let [n, r] = await Qe(this.esriLayer.queryExtent({
					objectIds: [e],
	...
	origState;
	constructor(e, t) {
		super(e, t), this.supportsIdentify = !0, this.supportsSublayers = !0, this.layerType = R.MAPIMAGE, this.layerFormat = ut.MAPIMAGE, this.isDynamic = !1, this.maptips = !1, this.layerTree.layerIdx = -1, this.identifyMode = V.GEOMETRIC;
	}
	actualViz = !1;
	get visibility() {
	...
	onLoadActions() {
		...
		let i = [], a = (e, t) => {
			...
			if (e.sublayers && e.sublayers.length > 0) {
				let r = new At(n, "", (o ? o.name : "") || e.title || "", !1);
	...
	constructor(e, t, n) {
		if (super(e, t), this.layerType = R.SUBLAYER, this.layerFormat = ut.MAPIMAGE, this.isSublayer = !0, this.layerIdx = e.index, this.parentLayer = n, this.isSystem = n.isSystem, this.dataFormat = z.ESRI_FEATURE, this.supportsFeatures = !0, this.maptips = !1, this.url = this.parentLayer?.url, this.canReload = !!(this.url || this.origRampConfig.caching), !n.esriLayer) throw Error("Map Image Layer with no internal esri layer encountered in sublayer creation");
	...
	constructor(e, t) {
		super(e, t), this.supportsIdentify = !1, this.layerType = R.OSM, this.layerFormat = ut.OSM, this.dataFormat = z.OSM_TILE, this.supportsFeatures = !1;
	}
	async onInitiate() {
	...
	constructor(e, t) {
		super(e, t), this.supportsIdentify = !1, this.layerType = R.IMAGERY, this.layerFormat = ut.IMAGERY, this.dataFormat = z.ESRI_RASTER;
	}
	async onInitiate() {
	...
	async checkProj() {
		...
		if (this.layerState === U.LOADED && !t) n(), this.onError(), this.updateDrawState(dt.NOT_LOADED);
		else if (this.layerState === U.ERROR && t) this.reload();
		else if (this.layerState !== U.ERROR && !t) return n(), Promise.reject();
	}
}, Lo = class extends Io {
	constructor(e, t) {
		super(e, t), this.layerType = R.IMAGERYTILE, this.layerFormat = ut.IMAGERYTILE, this.schemaLocked = !1;
	}
	async onInitiate() {
	...
	constructor(e, t) {
		super(e, t), this.layerType = R.TILE, this.layerFormat = ut.TILE;
	}
	async onInitiate() {
	...
	constructor(e, t) {
		super(e, t), this.layerType = R.VECTORTILE, this.layerFormat = ut.VECTORTILE;
	}
	async onInitiate() {
	...
	mimeType;
	constructor(e, t) {
		super(e, t), this.supportsIdentify = !0, this.layerType = R.WMS, this.layerFormat = ut.WMS, this.mimeType = e.featureInfoMimeType || "", this.sublayerNames = [], this.dataFormat = z.OGC_RASTER, this.identifyMode = V.GEOMETRIC;
	}
	async onInitiate() {
	...
	runIdentify(e) {
		if (e.geometry.type !== L.POINT || !this.canIdentify()) return [];
		let t = new Y(), n = De({
			items: [],
			loading: t.getPromise(),
			loaded: !1,
	...
	getFeatureInfo(e, t, n) {
		...
		}), Object.keys(h).forEach((e) => o[e] = h[e]), g(i.url.split("?")[0], {
			query: o,
			responseType: p
		});
	}
	...
	_visibility;
	constructor(e, t) {
		super(e, t), this.dataFormat = z.ESRI_FEATURE, this.layerFormat = ut.NOLAYER, this.drawState = dt.NOT_VISUAL, this.attribs = new qo(), this.supportsFeatures = !0, this.mapLayer = !1, this.isFile = !1, this._visibility = e.state?.visibility ?? !0, this.expectedTime.draw = 0;
	}
	async onInitiate() {
		if (this.sourceJson) {
	...
	serviceUrl;
	constructor(e, t) {
		super(e, t), this.layerType = R.DATATABLE, this.serviceUrl = e.url, this.filter = new Mt(e.permanentFilteredQuery || "", e.initialFilteredQuery || "");
	}
	async onInitiate() {}
	onLoadActions() {
	...
	async arcGisBatchLoad(e, t) {
		...
		let n = e.permanentFilter ? ` AND ${e.permanentFilter}` : "", r = { query: {
			...
			f: "json"
		} }, [i, a] = await Qe(g(e.serviceUrl + "/query", r));
	...
	async loadGraphicsAttributes(e, t) {
		...
		let n = {
			features: e.sourceGraphics.map((e) => Me(e).attributes).toArray(),
			oidIndex: {}
		};
	...
	async loadSingleFeature(e) {
		...
		let [n, r] = await Qe(g(e.serviceUrl + "/query", t));
	...
	async generateTabularAttributesWorker(e, t) {
		...
		let r = e.fields.filter((e) => Object.prototype.hasOwnProperty.call(n.features[0], Me(e).name)).map((e) => ({
			data: Me(e).name,
			title: Me(e).alias || Me(e).name
		})), i = n.features.map((t) => {
			let n = oe({}, t);
	...
	parent;
	constructor(e) {
		this.parent = e, this.symbol = new ie();
	}
	match(e) {
		return !!e;
	}
	...
	async generateWMSSymbology(e) {
		let t = nt(document.createElement("div")).size(this.CONTAINER_SIZE, this.CONTAINER_SIZE).viewbox(0, 0, 0, 0), n = {
			svgcode: "",
			imgHeight: "",
			imgWidth: ""
		};
	...
	async renderSymbologyImage(e, t = null) {
		t === null && (t = nt(document.createElement("div")).size(this.CONTAINER_SIZE, this.CONTAINER_SIZE).viewbox(0, 0, 0, 0));
	...
	async renderSymbologyIcon(e, t = null) {
		if (t === null) {
			...
			e.setAttribute("style", "opacity:0;position:fixed;left:100%;top:100%;overflow:hidden"), document.body.appendChild(e), t = nt(e).size(this.CONTAINER_SIZE, this.CONTAINER_SIZE).viewbox(0, 0, this.CONTAINER_SIZE, this.CONTAINER_SIZE);
		}
	...
	generatePlaceholderSymbology(e, t = "#000") {
		let n = nt(document.createElement("div")).size(this.CONTAINER_SIZE, this.CONTAINER_SIZE).viewbox(0, 0, this.CONTAINER_SIZE, this.CONTAINER_SIZE);
	...
	async generateBlankSymbology() {
		return nt(document.createElement("div")).size(this.CONTAINER_SIZE, this.CONTAINER_SIZE).svg();
	}
	async symbolToSvg(e) {
		...
		let i = nt(r).size(this.CONTAINER_SIZE, this.CONTAINER_SIZE).viewbox(0, 0, this.CONTAINER_SIZE, this.CONTAINER_SIZE), a = {
			path({ size: e, path: t }) {
			...
			[at.DASH]: "5.333,4",
			[at.DOT]: "1.333,4",
			[at.DASHDOT]: "5.333,4,1.333,4",
			[at.LONGDASH]: "10.666,4",
			[at.LONGDASHDOT]: "10.666,4,1.333,4",
			[at.LONGDASHDOTDOT]: "10.666,4,1.333,4,1.333,4",
			[at.SHORTDOT]: "1.333,1.333",
			[at.SHORTDASH]: "5.333,1.333",
			[at.SHORTDASHDOT]: "5.333,1.333,1.333,1.333",
			[at.SHORTDASHDOTDOT]: "5.333,1.333,1.333,1.333,1.333,1.333"
		}, s = {
			color: "#000",
			opacity: 1,
			width: 1,
	...
	async getMapServerLegend(e) {
		...
		let t = { query: { f: "json" } }, n = { layers: [] }, [r, i] = await Qe(g(`${e}/legend`, t));
	...
	"../fixtures/appbar/index.ts": () => import("./appbar-CO7glTx8.js"),
	"../fixtures/areas-of-interest/index.ts": () => import("./areas-of-interest-DaWovdmR.js"),
	"../fixtures/basemap/index.ts": () => import("./basemap-Cnk7TTcA.js"),
	"../fixtures/crosshairs/index.ts": () => import("./crosshairs-DksOKG2F.js"),
	"../fixtures/details/index.ts": () => import("./details-DYn2Mhc3.js"),
	"../fixtures/draw/index.ts": () => import("./draw-K8NzcU4n.js"),
	"../fixtures/export/index.ts": () => import("./export-FjxC7W94.js"),
	"../fixtures/export-footnote/index.ts": () => import("./export-footnote-D2etPbJs.js"),
	"../fixtures/export-legend/index.ts": () => import("./export-legend-DcmWK-ki.js"),
	"../fixtures/export-map/index.ts": () => import("./export-map-zzP45CwV.js"),
	"../fixtures/export-northarrow/index.ts": () => import("./export-northarrow-Dlrj5SR3.js"),
	"../fixtures/export-scalebar/index.ts": () => import("./export-scalebar-BrpFSFrJ.js"),
	"../fixtures/export-timestamp/index.ts": () => import("./export-timestamp-C9B1z_L6.js"),
	"../fixtures/export-title/index.ts": () => import("./export-title-BTI0wVAV.js"),
	"../fixtures/extentguard/index.ts": () => import("./extentguard-ORDCyba3.js"),
	"../fixtures/gazebo/index.ts": () => import("./gazebo-DzH2YY2Y.js"),
	"../fixtures/geosearch/index.ts": () => import("./geosearch-BVcqssl_.js"),
	"../fixtures/grid/index.ts": () => import("./grid-CxC82Klu.js"),
	"../fixtures/help/index.ts": () => import("./help-DC3pcaud.js"),
	"../fixtures/hilight/index.ts": () => import("./hilight-B_GP5fjy.js"),
	"../fixtures/keyboardnav/index.ts": () => import("./keyboardnav-DZ5eW2M4.js"),
	"../fixtures/layer-reorder/index.ts": () => import("./layer-reorder-DiWWP72T.js"),
	"../fixtures/legend/index.ts": () => import("./legend-DEZ0zizb.js"),
	"../fixtures/mapnav/index.ts": () => import("./mapnav-DyP5c3R2.js"),
	"../fixtures/metadata/index.ts": () => import("./metadata-D7xBGOer.js"),
	"../fixtures/northarrow/index.ts": () => import("./northarrow-Cpghts4i.js"),
	"../fixtures/overviewmap/index.ts": () => import("./overviewmap-AHGMI_Me.js"),
	"../fixtures/panguard/index.ts": () => import("./panguard-CL0_PutX.js"),
	"../fixtures/scrollguard/index.ts": () => import("./scrollguard-C0pnzEmL.js"),
	"../fixtures/settings/index.ts": () => import("./settings-4NZhYf17.js"),
	"../fixtures/snowman/index.ts": () => import("./snowman-CgXN9t8S.js"),
	"../fixtures/swipe/index.ts": () => import("./swipe-Cmdo2XIH.js"),
	"../fixtures/wizard/index.ts": () => import("./wizard-i385GVQk.js")
}), ds = class extends X {
	constructor(e) {
		super(e);
	}
	...
	async add(e, t) {
		...
		return Yt(this.$vApp.$pinia).addFixture(n), this.$iApi.event.emit(Z.FIXTURE_ADDED, n), this.$iApi.geo.map.created && n.initialized?.(), n;
	}
	remove(e) {
		let t = this.get(e);
		if (!t) throw Error(`Could not find fixture ${e} for removal`);
		return Yt(this.$vApp.$pinia).removeFixture(t), this.$iApi.event.emit(Z.FIXTURE_REMOVED, t), t;
	}
	flush() {
	...
	mount(e, { props: t, children: n, element: r, app: i } = {}) {
		let a = r, o = ye(e, t, n);
		return i && i._context && (o.appContext = i._context), a ||= document.createElement("div"), Oe(o, a), {
			vNode: o,
			destroy: () => {
				a && Oe(null, a), a = null, o = null;
			},
			el: a
		};
	}
...
var _s = /* @__PURE__ */ n(hs, [["render", gs], ["__scopeId", "data-v-a3c61802"]]), vs = /* @__PURE__ */ Object.assign({
	"../fixtures/areas-of-interest/screen.vue": () => import("./screen-B1SFBnKg.js"),
	"../fixtures/basemap/screen.vue": () => import("./screen-BX74V795.js"),
	"../fixtures/export/screen.vue": () => import("./screen-DwJHEMnI.js"),
	"../fixtures/geosearch/screen.vue": () => import("./screen-DLcvnuWM.js"),
	"../fixtures/grid/screen.vue": () => import("./screen-CC8GkTMd.js"),
	"../fixtures/help/screen.vue": () => import("./screen-RgybRxx4.js"),
	"../fixtures/layer-reorder/screen.vue": () => import("./screen-MNBfMZzq.js"),
	"../fixtures/legend/screen.vue": () => import("./screen-BrcfqQvu.js"),
	"../fixtures/metadata/screen.vue": () => import("./screen-BSvQMm3b.js"),
	"../fixtures/settings/screen.vue": () => import("./screen-DZF7JLnS.js"),
	"../fixtures/wizard/screen.vue": () => import("./screen-DDMSxkc0.js")
}), ys = class extends X {
	id;
	screens;
	loadedScreens = [];
...
console.info(`RAMP v${{
	...
	minor: "21",
	patch: "0-beta",
	timestamp: "Fri May 1 10:49:12 2026 -0400",
	hash: "2c91dd642f26c1a50df0692c72ee6d0bf7a00509"
}.major}.${{
	major: "4",
	minor: "21",
	patch: "0-beta",
...
//#endregion
export { q as $, _a as A, Z as B, Ha as C, Ra as D, za as E, er as F, Ut as G, qt as H, $n as I, Y as J, X as K, yn as L, oa as M, aa as N, Ia as O, tr as P, J as Q, mn as R, Va as S, La as T, Gt as U, Jt as V, Wt as W, Ct as X, Et as Y, xt as Z, qa as _, Ns as a, ne as at, Wa as b, Ro as c, pt as ct, go as d, ft as dt, c as et, mo as f, H as ft, Ja as g, it as gt, $ as h, R as ht, Fs as i, p as it, sa as j, ka as k, So as l, W as lt, Ya as m, U as mt, Is as n, d as nt, ys as o, re as ot, to as p, G as pt, Ft as q, Ls as r, f as rt, fs as s, ie as st, Ps as t, h as tt, xo as u, rt as ut, Ka as v, Ba as w, Ua as x, Ga as y, un as z };
