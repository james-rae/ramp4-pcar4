...
import { _ as H, d as L, F as K, G as X } from "./main-DOZx9OXm.js";
...
const G = /* @__PURE__ */ H(te, [["render", ne]]), ie = /* @__PURE__ */ I({
  ...
  setup(f) {
    const i = S("iApi"), { t } = B(), o = ee(), p = [
      {
        type: "point",
        icon: g(_(() => import("./point-icon-Ccqa50Q7.js")))
      },
      {
        type: "polyline",
        icon: g(_(() => import("./polyline-icon-C6VbOt6i.js")))
      },
      {
        type: "polygon",
        icon: g(_(() => import("./polygon-icon-DoV3Zeux.js")))
      },
      {
        type: "circle",
        icon: g(_(() => import("./circle-icon-Q7mrbBjT.js")))
      },
      {
        type: "rectangle",
        icon: g(_(() => import("./rectangle-icon-BUKd-cXy.js")))
      }
    ], a = M(() => {
      const s = p.filter((u) => o.supportedTypes.some((x) => x.type === u.type));
      return s.push({
        type: "edit",
        icon: g(_(() => import("./edit-icon-Co4KUqTp.js")))
      }), s;
    }), n = (s) => {
