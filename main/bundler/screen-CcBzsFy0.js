import { B as e, R as t, V as n, W as r, Y as i, at as a, ct as o, nt as s, o as c, rt as l } from "./main-DgnOnp_l.js";
import { n as u } from "./config-BhPbUOhN.js";
import { t as d } from "./_plugin-vue_export-helper-B3ysoDQm.js";
import { n as ee, t as te } from "./table-state-manager-DiApvpVP.js";
...
var z = ["onClick"], Te = { class: "md-icon-small flex w-full" }, B = { class: "flex-1 truncate whitespace-nowrap overflow-hidden pr-4" }, Ee = /* @__PURE__ */ v({
	...
	setup(a) {
		...
		}, Je = f(() => X.value.some((e) => e.layerState === o.LOADED && e.visibility)), Ye = (e) => {
			B.value = e.api;
