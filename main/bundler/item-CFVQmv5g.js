import { defineComponent as X, ref as H, onMounted as ye, resolveDirective as q, openBlock as l, createElementBlock as a, withModifiers as k, withDirectives as x, createElementVNode as o, unref as t, withKeys as ce, normalizeClass as C, inject as ue, computed as R, toRaw as S, resolveComponent as ve, createBlock as B, withCtx as ge, createTextVNode as Z, toDisplayString as w, Fragment as oe, renderList as ie, normalizeStyle as ke, createCommentVNode as u, useTemplateRef as xe, watch as we, createStaticVNode as me, resolveDynamicComponent as Ce } from "vue";
import { p as Me, o as y, X as Se, a as Ie, $ as I, G as Q, _ as se, N as Te, n as ze, a1 as b, a2 as G, S as Ee, a3 as F, a4 as ne } from "./main-DwE8E7HF.js";
import "pinia";
...
const $e = ["type", "aria-label", "checked", "disabled", "content"], ae = /* @__PURE__ */ X({
  __name: "checkbox",
  props: {
    value: {
      type: Object,
  ...
  emits: ["focusItem"],
  setup(e, { emit: T }) {
    const { t: i } = re(), c = ue("iApi"), f = H(), $ = H(!1), s = Ie(), L = H(s.mobileView), E = T, U = H(0), v = e, Y = () => {
  ...
  setup(e) {
    ...
    return ye(() => {
      ...
      i.value.length > 1 ? (l(), a("div", Fe, [
        (l(!0), a(oe, null, ie(i.value.slice(0, 3).reverse(), ($, s) => (l(), a("div", {
      ...
      return e.legendItem.hidden ? u("", !0) : (l(), a("div", {
        ...
        o("div", _e, [
          x((l(), a("div", {
            ...
            (e.legendItem.type === t(b).Item || e.legendItem.type === t(b).Placeholder && t(E)) && e.legendItem instanceof t(y) ? (l(), B(Oe, {
              key: 7,
              class: C({
            ...
            ])) : e.legendItem.type === t(b).Item && m(t(G).Visibility) ? (l(), B(ae, {
              key: 12,
            ...
            (l(!0), a(oe, null, ie(A.value, (d) => (l(), a("div", {
              ...
              d.imgUrl && e.legendItem.symbologyRenderStyle === "images" || !d.imgUrl && J.value === "ogc-wms" ? (l(), a("div", zt, [
                ...
                d.label ? x((l(), a("div", $t, [
                  ...
                  !d.imgUrl && A.value.length > 1 || d.imgUrl && d.definitionClause ? (l(), B(ae, {
                    key: 0,
                    class: "float-right",
                    value: d,
                    legendItem: e.legendItem,
                ...
                _.value && e.legendItem.layer.supportsFeatures && (!d.imgUrl && A.value.length > 1 || d.imgUrl && d.definitionClause) ? (l(), B(ae, {
                  key: 2,
                  value: d,
                  legendItem: e.legendItem,
                  checked: d.visibility,
        ...
        e.legendItem.expanded ? (l(), a("div", Ft, [
          (l(!0), a(oe, null, ie(e.legendItem.children, (d) => (l(), B(h, {
            legendItem: d,
            key: d.uid,
