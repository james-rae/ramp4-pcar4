...
import { _ as H, d as L, F as X, G as ee } from "./main-C6h8guJH.js";
...
const G = /* @__PURE__ */ H(ne, [["render", ae]]), se = /* @__PURE__ */ T({
  ...
  setup(h) {
    ...
    const p = [
      {
        type: "point",
        icon: g(_(() => import("./point-icon-CHMiY91D.js")))
      },
      {
        type: "polyline",
        icon: g(_(() => import("./polyline-icon-D0XrjGob.js")))
      },
      {
        type: "polygon",
        icon: g(_(() => import("./polygon-icon-DXZIKURs.js")))
      },
      {
        type: "circle",
        icon: g(_(() => import("./circle-icon-B_HEi6lJ.js")))
      },
      {
        type: "rectangle",
        icon: g(_(() => import("./rectangle-icon-DX7S_GyG.js")))
      }
    ], a = A(() => {
      const s = p.filter((u) => e.supportedTypes.some((x) => x.type === u.type));
      return s.push({
        type: "edit",
        icon: g(_(() => import("./edit-icon-BFOeQ-zP.js")))
      }), s;
    }), n = (s) => {
