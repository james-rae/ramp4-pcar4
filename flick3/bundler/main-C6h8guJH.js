...
class te extends rt {
  ...
  rawArray;
  constructor(e, t, i, r) {
    super(e, t.sr || i), r ? this.rawArray = t.slice() : this.rawArray = te.parseXY(t);
  }
...
class H extends rt {
  ...
  rawMax;
  constructor(e, t, i, r) {
    super(e, t.sr || r), this.rawMin = te.parseXY(t), this.rawMax = te.parseXY(i);
  }
...
const rr = ["data-cy"], Ki = /* @__PURE__ */ N({
    ...
    return (n, c) => {
      ...
      return b(), w("div", {
        ...
        fe(Ni, {
          ...
          default: ue(() => [
            U((b(), ee(ys(s.panel.route.screen), gs({ class: "h-full" }, s.panel.route.props, { panel: s.panel }), null, 16, ["panel"])), [
              [u]
            ])
          ]),
          _: 1
  ...
  function O() {
    ...
    !L.includes(s.value) && !r.value) {
      let Ie;
      for (let mi = 0; mi < L.length - 1 && E < (s.value.width || Q) + we; mi++)
        Ie = L.shift(), E += Ie.width || Q;
      E >= (s.value.width || Q) ? L.unshift(s.value) : e.value || (Ie = L.shift(), L.unshift(s.value));
  ...
  setup(s) {
    const e = Je(), t = Xi(), i = be(), { t: r } = se(), a = Se("iApi"), o = D(() => e.scale), l = D(() => e.attribution), n = D(() => e.coords), c = D(() => e.langtoggle), u = D(() => i.config.map), { keyChain: p, lastAction: d, chainState: g, namespaces: h, activeNamespace: m } = hs(t), A = D(() => {
      ...
      if (g.value === "awaitNamespace") {
        const J = `H - ${r("keyboardnav.chain.help")}`, E = Object.keys(h.value).map((Q) => {
          const we = `keyboardnav.ns.${Q}`, je = r(we);
          return `${Q} - ${je === we ? Q : je}`;
        });
        q = `[${[J, ...E].join(", ")}]`;
        ...
        E && E.keys?.length && (q = `[${E.keys.map((Q) => {
          const we = `keyboardnav.key.${J}.${Q.key}`, je = r(we), Ie = je === we ? Q.key : je;
          return `${Q.key} - ${Ie}`;
        }).join(", ")}]`);
      }
      return {
        ...
        s.header ? (b(), w("header", qa, [
          ...
          y("div", {
            ...
            s.panel.teleport ? B("", !0) : (b(), w("div", Wa, [
              ...
              s.panel.controls && s.panel.controls.expand ? (b(), ee(_, {
                key: 2,
                onClick: C[4] || (C[4] = (L) => s.panel.expand()),
                active: s.panel.expanded
              }, null, 8, ["active"])) : B("", !0)
            ])),
            s.panel.button && u.value?.includes(s.panel.id) ? (b(), ee(M, {
              key: 1,
      ...
      if (this._visibility = e ?? !this.visibility, !this.exclusive)
        ...
        if (this._lastVisible && (!(this._lastVisible instanceof We) || this._lastVisible.layerControlAvailable(X.Visibility)))
          ...
          const i = this.children.find(
            (r) => !(r instanceof We) || r.layerControlAvailable(X.Visibility)
          );
...
class We extends as {
  ...
  toggleVisibility(e, t = !0, i = !1) {
    if (!this.layerControlAvailable(X.Visibility) && !i)
      return;
    console.log("starting toggle viz in legend for block: " + this.layerId);
    const r = this.layer && this.layer.layerExists;
    if (r) {
      const a = this._symbologyStack.some((o) => o.lastVisbility);
      this._symbologyStack.forEach((o) => {
        a || (o.lastVisbility = !0), o.visibility = this.visibility ? o.lastVisbility : !1;
      }), this.updateSymbolFilter();
    }
    super.toggleVisibility(e, !1), r && (console.log(
      "toggle viz in legend for block: " + this.layerId + ", changing layer viz to " + this.visibility
    ), this.layer.visibility = this.visibility), this.parent && t && this.parent.checkVisibility(this);
  }
  /**
  ...
  clickSymbology(e, t) {
    let i;
    !this.symbolsVisible() && t !== !1 ? (this.setSymbologyVisibility(void 0, !1), this.setSymbologyVisibility(e, !0), i = !0) : this.setSymbologyVisibility(e, t), this.symbolsVisible() || (i = !1), this.updateSymbolFilter(), i !== void 0 && this.toggleVisibility(i);
  }
  updateSymbolFilter() {
    if (this.layer?.supportsFeatures) {
      const e = this.symbologyStack.filter((i) => i.lastVisbility).map((i) => i.definitionClause || "");
      let t = "";
      e.length === 0 ? t = "1=2" : e.length < this.symbologyStack.length && (t = e.join(" OR ")), console.log("updating symbol filter: " + t), this.layer.setSqlFilter(de.SYMBOL, t);
    }
  }
  /**
...
class Rn extends re {
  ...
  getLayerControls(e) {
    ...
    return t.supportsFeatures || r.push(X.Datatable), t.extent === void 0 && r.push(X.BoundaryZoom), (t.config?.metadata || (t.isSublayer ? t.parentLayer?.config?.metadata : {}) || {}).url || r.push(X.Metadata), !t.mapLayer && !t.config.controls?.includes(X.Settings) && r.push(X.Settings), r.forEach((o) => {
...
const ol = /* @__PURE__ */ Object.assign({ "../fixtures/appbar/index.ts": () => import("./index-t5futGRU.js"), "../fixtures/areas-of-interest/index.ts": () => import("./index-DIzzf2a-.js"), "../fixtures/basemap/index.ts": () => import("./index-DGX_OFTb.js"), "../fixtures/crosshairs/index.ts": () => import("./index-qXZaBzLj.js"), "../fixtures/details/index.ts": () => import("./index-CyRAskFN.js"), "../fixtures/draw/index.ts": () => import("./index-DfnvZYCF.js"), "../fixtures/export-footnote/index.ts": () => import("./index-Dyj-v5RF.js"), "../fixtures/export-legend/index.ts": () => import("./index-CSaSrl73.js"), "../fixtures/export-map/index.ts": () => import("./index-DZmFQSf2.js"), "../fixtures/export-northarrow/index.ts": () => import("./index-D3DK01HN.js"), "../fixtures/export-scalebar/index.ts": () => import("./index-CdZl1RYq.js"), "../fixtures/export-timestamp/index.ts": () => import("./index-NrKom3hq.js"), "../fixtures/export-title/index.ts": () => import("./index-DtE61491.js"), "../fixtures/export/index.ts": () => import("./index-DAsJFwEo.js"), "../fixtures/extentguard/index.ts": () => import("./index-f7YZsVMI.js"), "../fixtures/gazebo/index.ts": () => import("./index-BOB48NKT.js"), "../fixtures/geosearch/index.ts": () => import("./index-Cjw2XquE.js"), "../fixtures/grid/index.ts": () => import("./index-Hdl-25_Q.js"), "../fixtures/help/index.ts": () => import("./index-2LbybEWF.js"), "../fixtures/hilight/index.ts": () => import("./index-DqK5rmaQ.js"), "../fixtures/keyboardnav/index.ts": () => import("./index-D8Ru4h5d.js"), "../fixtures/layer-reorder/index.ts": () => import("./index-mLgpf_Kg.js"), "../fixtures/legend/index.ts": () => import("./index-DyxJeNEU.js"), "../fixtures/mapnav/index.ts": () => import("./index-DrTM7Ou8.js"), "../fixtures/metadata/index.ts": () => import("./index-oRsmLwLd.js"), "../fixtures/northarrow/index.ts": () => import("./index-BrEnB2iC.js"), "../fixtures/overviewmap/index.ts": () => import("./index-c24m1A1c.js"), "../fixtures/panguard/index.ts": () => import("./index-N4zmqU6O.js"), "../fixtures/scrollguard/index.ts": () => import("./index-_IjX-imw.js"), "../fixtures/settings/index.ts": () => import("./index-C7MM3FmK.js"), "../fixtures/snowman/index.ts": () => import("./index-BLQ-m5dY.js"), "../fixtures/swipe/index.ts": () => import("./index-JjXeeC5D.js"), "../fixtures/wizard/index.ts": () => import("./index-BmQ3L5r5.js") });
class nl extends re {
  /**
...
const dl = /* @__PURE__ */ qe(ul, [["render", pl], ["__scopeId", "data-v-a3c61802"]]), hl = /* @__PURE__ */ Object.assign({ "../fixtures/areas-of-interest/screen.vue": () => import("./screen-BVphZAZM.js"), "../fixtures/basemap/screen.vue": () => import("./screen-Ujt-eHbH.js"), "../fixtures/export/screen.vue": () => import("./screen-1OaRPxWF.js"), "../fixtures/geosearch/screen.vue": () => import("./screen-BQ71WI8A.js"), "../fixtures/grid/screen.vue": () => import("./screen-RbsejQrS.js"), "../fixtures/help/screen.vue": () => import("./screen-CPhGY50n.js"), "../fixtures/layer-reorder/screen.vue": () => import("./screen-CDUYgiq0.js"), "../fixtures/legend/screen.vue": () => import("./screen-JeVGW2ce.js"), "../fixtures/metadata/screen.vue": () => import("./screen-BgRIhKoG.js"), "../fixtures/settings/screen.vue": () => import("./screen-BXMmCP9s.js"), "../fixtures/wizard/screen.vue": () => import("./screen-Bxfy8XCi.js") });
class Ct extends re {
  /**
   * ID of this panel.
   *
...
var pt = { major: "4", minor: "16", patch: "0-beta", timestamp: "Fri Feb 6 11:54:59 2026 -0500", hash: "c62f8f71e034a4b5100fb7f83060f661d36eeb96" };
console.info(
