...
import { _ as be, H as ot, L as S, $ as Z, G as Ce, Y as ye } from "./main-BHVuCadI.js";
...
const st = { class: "flex justify-end mb-20" }, nt = ["disabled", "animation"], it = { class: "button-text" }, ut = /* @__PURE__ */ ue({
  ...
  key: 0,
  class: "text-red-900 text-xs"
}, Et = { key: 1 }, Ft = ["size", "value", "aria-label"], Lt = ["value"], At = {
  key: 0,
  class: "text-red-900 text-xs"
}, Vt = {
  key: 1,
    ...
    return ze(() => {
      ...
      return c(), y("div", {
        ...
        r.type === "file" ? (c(), y("div", dt, [
          ...
          P.value ? (c(), y("div", ht, g(r.modelValue ? r.validationMessages?.invalid : r.validationMessages?.required), 1)) : A("", !0)
          ...
          n("div", xt, [
            r.multiple ? (c(), y("div", zt, [
              ...
              r.validation && H.value ? (c(), y("div", kt, g(r.validationMessages?.required), 1)) : A("", !0)
            ])) : (c(), y("div", Et, [
              fe((c(), y("select", {
              ...
              r.validation && r.formatError ? (c(), y("div", At, g(r.validationMessages?.invalid), 1)) : A("", !0),
              r.validation && r.failureError ? (c(), y("div", Vt, g(r.validationMessages?.failure), 1)) : A("", !0)
            ]))
          ])
          ...
          r.validation && !r.modelValue ? (c(), y("div", _t, g(r.validationMessages?.required), 1)) : A("", !0)
        ]))
      ], 512);
    };
  }
  ...
  setup(r) {
    ...
    const ve = () => {
      ...
      t.onload = (d) => {
        Y.value = t.result, V.value = e.name, b(d);
    ...
    })), Ae = (e) => a.value?.latLonFields[e].map((t) => ({
      value: t,
      label: t
    })), J = () => Y.value || V.value.match(/\.(zip|csv|json|geojson)$/), Re = (e) => {
      q(e), V.value = "";
    }, _e = (e, t) => {
      ...
      while (w.$vApp.$el.getElementById(z.value + "-hue-slider") !== null);
    }, Pe = (e) => {
      ...
      k.value = !1, G.value = !1, Q.value = !1, C.value = !!V.value, j.value = !1, v.goToStep(0), ee.value = "";
    }, Ye = () => {
              ...
              O(he, {
                ...
                default: M(() => [
                  n("form", {
                    ...
                    a.value?.configOptions.includes("colour") ? (c(), y("label", Qt, g(o(l)("wizard.configure.colour.label")), 1)) : A("", !0),
...
}), la = /* @__PURE__ */ be(tl, [["__scopeId", "data-v-549b4eab"]]);
export {
  la as default
};
