import { TinyEmitter as os } from "tiny-emitter";
import { defineStore as G, createPinia as ns } from "pinia";
import { ref as m, computed as M, markRaw as ie, defineComponent as C, inject as be, reactive as ye, watch as Et, onBeforeUnmount as ct, resolveDirective as O, withDirectives as k, openBlock as y, createElementBlock as b, withKeys as as, withModifiers as Zt, onMounted as We, normalizeClass as re, normalizeStyle as Ti, createVNode as se, Transition as Li, withCtx as X, createBlock as V, resolveDynamicComponent as ls, mergeProps as cs, TransitionGroup as $i, Fragment as Ve, renderList as pt, unref as _, nextTick as $t, renderSlot as Ce, createElementVNode as g, vShow as ps, resolveComponent as Z, createTextVNode as it, toDisplayString as D, createCommentVNode as F, onUpdated as us, Teleport as ds, getCurrentInstance as hs, createApp as Ri, toRaw as Ee, h as fs, render as Dt, defineAsyncComponent as ms } from "vue";
import gs from "@arcgis/core/Basemap";
import xt from "@arcgis/core/Color";
import dt from "@arcgis/core/config";
import li from "@arcgis/core/geometry/Extent";
import ys from "@arcgis/core/geometry/Multipoint";
import vs from "@arcgis/core/geometry/Point";
import Kt from "@arcgis/core/geometry/Polygon";
import Ci from "@arcgis/core/geometry/Polyline";
import bs from "@arcgis/core/geometry/SpatialReference";
import { fromJSON as As } from "@arcgis/core/geometry/support/jsonUtils";
import ws from "@arcgis/core/Graphic";
import Oi from "@arcgis/core/layers/FeatureLayer";
import Es from "@arcgis/core/layers/GraphicsLayer";
import xs from "@arcgis/core/layers/ImageryLayer";
import ki from "@arcgis/core/layers/MapImageLayer";
import Mi from "@arcgis/core/layers/OpenStreetMapLayer";
import Pi from "@arcgis/core/layers/TileLayer";
import Ss from "@arcgis/core/layers/WMSLayer";
import _s from "@arcgis/core/layers/support/Field";
import Is from "@arcgis/core/Map";
import Ts from "@arcgis/core/renderers/SimpleRenderer";
import { fromJSON as at } from "@arcgis/core/renderers/support/jsonUtils";
import Ge from "@arcgis/core/request";
import { executeForIds as Ls } from "@arcgis/core/rest/query";
import ci from "@arcgis/core/rest/support/Query";
import $s from "@arcgis/core/symbols/PictureMarkerSymbol";
import Rs from "@arcgis/core/symbols/SimpleFillSymbol";
import Cs from "@arcgis/core/symbols/SimpleLineSymbol";
import jt from "@arcgis/core/symbols/SimpleMarkerSymbol";
import { fromJSON as Qt } from "@arcgis/core/symbols/support/jsonUtils";
import Os from "@arcgis/core/layers/support/FeatureFilter";
import ks from "@arcgis/core/views/MapView";
import Ms from "@arcgis/core/webmap/background/ColorBackground";
import Ni from "deepmerge";
import { Tools as Ps } from "terraformer";
import oe from "proj4";
import { debounce as St, throttle as ft } from "throttle-debounce";
import { createI18n as Ns, useI18n as j } from "vue-i18n";
import Ae from "screenfull";
import pi from "lodash.clonedeep";
import Fs, { setDefaultProps as Ds, useTippy as Gs } from "vue-tippy";
import Us from "linkify-html";
import { createPopper as Bs, detectOverflow as zs } from "@popperjs/core";
import Rt from "redaxios";
import Vs from "terraformer-arcgis-parser";
import { dsv as ui, csv2geojson as js } from "csv2geojson";
import je from "await-to-js";
import Qe from "svg.js";
import Fi from "animejs";
import "tippy.js/animations/scale.css";
var Le = /* @__PURE__ */ ((r) => (r.BLOB = "blob", r.DATE = "date", r.DOUBLE = "double", r.GEOMETRY = "geometry", r.GLOBAL_ID = "global-id", r.GUID = "guid", r.INTEGER = "integer", r.LONG = "long", r.OID = "oid", r.RASTER = "raster", r.SINGLE = "single", r.SMALL_INTEGER = "small-integer", r.STRING = "string", r.XML = "xml", r))(Le || {}), Te = /* @__PURE__ */ ((r) => (r.CIRCLE = "circle", r.CROSS = "cross", r.DIAMOND = "diamond", r.ICON = "icon", r.PATH = "path", r.SQUARE = "square", r.TRIANGLE = "triangle", r.X = "x", r))(Te || {}), ae = /* @__PURE__ */ ((r) => (r.DASH = "dash", r.DASHDOT = "dash-dot", r.DASHDOTDOT = "short-dash-dot-dot", r.DOT = "dot", r.LONGDASH = "long-dash", r.LONGDASHDOT = "long-dash-dot", r.LONGDASHDOTDOT = "long-dash-dot-dot", r.NONE = "none", r.NULL = "none", r.SHORTDASH = "short-dash", r.SHORTDASHDOT = "short-dash-dot", r.SHORTDASHDOTDOT = "short-dash-dot-dot", r.SHORTDOT = "short-dot", r.SOLID = "solid", r))(ae || {}), Di = /* @__PURE__ */ ((r) => (r.BEVEL = "bevel", r.MITER = "miter", r.ROUND = "round", r))(Di || {}), Gi = /* @__PURE__ */ ((r) => (r.ROUND = "round", r.BUTT = "butt", r.SQUARE = "square", r))(Gi || {}), Ui = /* @__PURE__ */ ((r) => (r.BDIAG = "backward-diagonal", r.CROSS = "cross", r.DIAG_CROSS = "diagonal-cross", r.FDIAG = "forward-diagonal", r.HORIZONTAL = "horizontal", r.NONE = "none", r.NULL = "none", r.SOLID = "solid", r.VERTICAL = "vertical", r))(Ui || {}), T = /* @__PURE__ */ ((r) => (r.POINT = "Point", r.MULTIPOINT = "MultiPoint", r.LINESTRING = "LineString", r.MULTILINESTRING = "MultiLineString", r.POLYGON = "Polygon", r.MULTIPOLYGON = "MultiPolygon", r.LINEARRING = "LinearRing", r.EXTENT = "Extent", r.NONE = "None", r.UNKNOWN = "Unknown", r))(T || {}), Ct = /* @__PURE__ */ ((r) => (r.Simple = "simple", r.Unique = "uniqueValue", r.ClassBreaks = "classBreaks", r.Unknown = "unknown", r))(Ct || {}), S = /* @__PURE__ */ ((r) => (r.FEATURE = "esri-feature", r.MAPIMAGE = "esri-map-image", r.TILE = "esri-tile", r.IMAGERY = "esri-imagery", r.GRAPHIC = "esri-graphic", r.WMS = "ogc-wms", r.WFS = "ogc-wfs", r.GEOJSON = "file-geojson", r.GEOJSONZIPPED = "file-zip-geojson", r.CSV = "file-csv", r.SHAPEFILE = "file-shape", r.FLATGEOBUF = "file-fgb", r.FLATGEOBUFZIPPED = "file-zip-fgb", r.OSM = "osm-tile", r.DATACSV = "data-csv", r.DATAJSON = "data-json", r.DATATABLE = "data-esri-table", r.UNKNOWN = "unknown", r.SUBLAYER = "sublayer", r))(S || {}), fe = /* @__PURE__ */ ((r) => (r.FEATURE = "feature", r.GRAPHIC = "graphic", r.IMAGERY = "imagery", r.MAPIMAGE = "map-image", r.NOLAYER = "no-layer", r.OSM = "osm-tile", r.TILE = "tile", r.UNKNOWN = "unknown", r.WMS = "wms", r))(fe || {}), Q = /* @__PURE__ */ ((r) => (r.ESRI_FEATURE = "esriFeature", r.ESRI_RASTER = "esriRaster", r.ESRI_TILE = "esriTile", r.OSM_TILE = "osmTile", r.OGC_RASTER = "ogcRaster", r.UNKNOWN = "unknown", r))(Q || {}), U = /* @__PURE__ */ ((r) => (r.POINT = "Point", r.MULTIPOINT = "MultiPoint", r.LINESTRING = "LineString", r.MULTILINESTRING = "MultiLineString", r.POLYGON = "Polygon", r.MULTIPOLYGON = "MultiPolygon", r))(U || {}), K = /* @__PURE__ */ ((r) => (r.GEOMETRIC = "geometric", r.SYMBOLIC = "symbolic", r.HYBRID = "hybrid", r.NONE = "none", r))(K || {}), P = /* @__PURE__ */ ((r) => (r.NEW = "new", r.INITIATING = "initiating", r.INITIATED = "initiated", r.TERMINATING = "terminating", r.TERMINATED = "terminated", r))(P || {}), B = /* @__PURE__ */ ((r) => (r.NEW = "new", r.LOADING = "loading", r.LOADED = "loaded", r.ERROR = "error", r))(B || {}), le = /* @__PURE__ */ ((r) => (r.NOT_LOADED = "not-loaded", r.NOT_VISUAL = "not-visual", r.REFRESH = "refresh", r.UP_TO_DATE = "up-to-date", r))(le || {}), st = /* @__PURE__ */ ((r) => (r.ESRI = "esri", r.TEXT = "text", r.IMAGE = "image", r.HTML = "html", r.XML = "xml", r.JSON = "json", r.UNKNOWN = "unknown", r))(st || {}), ne = /* @__PURE__ */ ((r) => (r.SYMBOL = "symbol", r.GRID = "grid", r.EXTENT = "extent", r.INITIAL = "initial", r.API = "api", r.PERMANENT = "permanent", r))(ne || {}), z = /* @__PURE__ */ ((r) => (r.BoundaryZoom = "boundaryZoom", r.Datatable = "datatable", r.Identify = "identify", r.Metadata = "metadata", r.Opacity = "opacity", r.Refresh = "refresh", r.Reload = "reload", r.Remove = "remove", r.Settings = "settings", r.Symbology = "symbology", r.Visibility = "visibility", r))(z || {});
class ve {
  attributes;
  geometry;
  style;
...
class De extends pe {
  ...
  static fromESRI(e, t) {
    return new De(t, e.paths[0], I.fromESRI(e.spatialReference), !0);
  }
  toESRI() {
    return new Ci({
      paths: [this.toArray()],
  ...
  static fromGeoJSON(e, t) {
    return new De(t, e.coordinates, I.fromGeoJSON(e.crs), !0);
  }
  toGeoJSON() {
...
class ge extends He {
  ...
  constructor(e, t, i, s) {
    if (super(e, t.sr || i), s)
      this.rawArray = ge.arrayDeepCopy(t);
  ...
  get lineArray() {
    return this.rawArray.map((e, t) => new De(this.childIdGenerator(t), e, this.sr, !0));
  }
  /** Returns a copy of the n-th contained line. */
  getAt(e) {
    return new De(this.childIdGenerator(e), this.rawArray[e], this.sr, !0);
  }
  ...
  static fromESRI(e, t) {
    return new ge(t, e.paths, I.fromESRI(e.spatialReference), !0);
  }
  toESRI() {
    return new Ci({
      paths: this.toArray(),
...
class ze extends pe {
  constructor(e, t, i, s) {
    if (super(e, t, i, s), ze.closeRing(this.rawArray), this.length < 4)
  ...
  static fromESRI(e, t) {
    return new ze(t, e.rings[0], I.fromESRI(e.spatialReference), !0);
  }
  toESRI() {
    return new Kt({
      rings: [this.toArray()],
  ...
  static fromGeoJSON(e, t) {
    return new ze(t, e.coordinates, I.fromGeoJSON(e.crs), !0);
  }
  toGeoJSON() {
...
class te extends He {
  ...
  get ringArray() {
    return this.rawArray.map((e, t) => new ze(this.childIdGenerator(t), e, this.sr, !0));
  }
  ...
  static parsePolygon(e) {
    ...
    return t.forEach((i) => ze.closeRing(i)), t;
  }
  static arrayDeepCopy(e) {
    return e.map((t) => t.map((i) => i.slice()));
  }
...
class $e extends He {
  rawArray;
  constructor(e, t, i, s) {
    super(e, t.sr || i), s ? this.rawArray = $e.arrayDeepCopy(t) : this.rawArray = $e.parseMultiPolygon(t);
  }
  addPolygon(e) {
  ...
  static parseMultiPolygon(e) {
    ...
    if (e instanceof te)
      return [e.toArray()];
    if (e instanceof ge || e instanceof pe)
  ...
  static fromESRI(e, t) {
    return new $e(t, [e.rings], I.fromESRI(e.spatialReference), !0);
  }
  toESRI() {
    const e = [];
...
class N extends He {
  ...
  expand(e) {
    return N.fromESRI(this.toESRI().expand(e), `${this.id}-expanded`);
  }
  clone() {
    return new N(this.id, this.rawMin, this.rawMax, this.sr);
  }
  /**
  ...
  static fromArcServer(e, t) {
    return N.fromESRI(li.fromJSON(e), t);
  }
  ...
  static fromGeoJSON(e, t) {
    ...
    }), new N(t, i, s, I.fromGeoJSON(e.crs));
  }
  toGeoJSON() {
...
class Oe {
  ...
  get hex() {
    const e = this.rgba;
    return e[3] = e[3] * 255, `#${e.map((t) => Oe.intToHex(t)).join("")}`;
  }
  get r() {
    return this.c[0];
  }
...
class Ne extends Re {
  ...
  _angle;
  constructor(e) {
    if (e = e || { style: Te.CIRCLE }, super(), this._style = e.style || Te.CIRCLE, e.style === Te.ICON) {
      const t = e;
      this._icon = t.icon || "", this._height = Re.convToPoints(t.height) || 16.5, this._width = Re.convToPoints(t.width) || 16.5, this._size = 0, this._colour = new Oe(), this._outline = new Se(), this._path = "";
    } else {
      const t = e;
      this._size = Re.convToPoints(t.size) || 12, this._colour = new Oe(t.colour ?? "#ffffff40"), this._outline = new Se(t.outline), this._path = this._style === Te.PATH && t.path || "", this._height = 0, this._width = 0, this._icon = "";
    }
    this._xOffset = Re.convToPoints(e.xOffset) || 0, this._yOffset = Re.convToPoints(e.yOffset) || 0, this._angle = e.angle || 0;
  }
  ...
  propGrouse(e) {
    this._style === Te.ICON !== e && console.warn(`Accessed a point style property that is invalid for the style type ${this._style}`);
  }
  toOptions() {
    const e = {
  ...
  static fromESRI(e) {
    ...
    if (e.type === "simple-marker") {
      const i = t;
      i.style = e.style, i.colour = e.color.toRgba(), i.size = e.size, i.path = e.path, i.outline = Se.fromESRI(e.outline).toOptions();
    } else {
      const i = t;
      i.style = Te.ICON, i.width = e.width, i.height = e.height, i.icon = e.url;
    }
    return new Ne(t);
  }
  static fromArcServer(e) {
    return Ne.fromESRI(Qt(e));
  }
  /**
...
class Se extends Re {
  ...
  _colour;
  constructor(e) {
    e = e || {}, super(), this._style = e.style || ae.SOLID;
    const t = Re.convToPoints(e.width);
    this._width = typeof t > "u" || t < 0 ? 0.75 : t, this._colour = new Oe(e.colour), this._miter = e.miter ?? 2, this._cap = e.cap || Gi.ROUND, this._join = e.join || Di.ROUND;
  }
...
class mt extends Re {
  ...
  _fillStyle;
  constructor(e) {
    super(), e = e || {}, e.fill || (e.fill = {}), this._fillColour = new Oe(e.fill.colour), this._fillStyle = e.fill.style || Ui.SOLID, this._outlineStyle = new Se(e.outline);
  }
  /** Returns the specified colour */
  get fillColour() {
  ...
  toESRI() {
    const e = this.outline.toESRI(), t = new xt(this.fillColour.rgba), i = new Rs();
  ...
  static fromESRI(e) {
    const t = {
      ...
      outline: Se.fromESRI(e.outline).toOptions()
    };
    return new mt(t);
  }
  static fromArcServer(e) {
...
class qs {
  ...
  geomEsriToRamp(e, t) {
    switch (e.type) {
      ...
      case "polyline": {
        const i = e;
        return i.paths.length === 1 ? De.fromESRI(i, t) : ge.fromESRI(i, t);
      }
      case "polygon":
        return te.fromESRI(e, t);
      case "extent":
        return N.fromESRI(e, t);
      case "multipoint":
  ...
  graphicGeoJsonToRamp(e, t) {
    ...
    return Object.keys(e.properties.forEach((n) => s[n] = e.properties[n])), new ve(i, "", s);
  }
  /**
  ...
  graphicRampToEsri(e) {
    ...
    return t.geometry = this.geomRampToEsri(e.geometry), Object.keys(e.attributes).forEach((i) => t.attributes[i] = e.attributes[i]), e.style && (t.symbol = this.styleRampToEsri(e.style)), new ws(t);
  }
  styleRampToEsri(e) {
    return e.toESRI();
  }
  styleEsriToRamp(e) {
    switch (e.type) {
      case "picture-marker":
      case "simple-marker":
        return Ne.fromESRI(e);
      case "simple-line":
        return Se.fromESRI(e);
      case "simple-fill":
        return mt.fromESRI(e);
      default:
        return console.error(`Unsupported ESRI symbol type encountered: ${e.type}`), new Ne();
    }
  }
...
class zi {
   ...
   */
  isActive() {
    return this.sqlActiveFilters([ne.PERMANENT]).length > 0;
  }
  /**
   ...
   */
  setSql(e, t) {
    e === ne.PERMANENT ? console.error("Attempted to overwrite a permanent filter. Not allowed.") : (this.sql[e] = t, this.clearCacheSet(e));
  }
  /**
   ...
   */
  setExtent(e) {
    e.isEqual(this.extent) || (this.extent = e, this.clearCacheSet(ne.EXTENT));
  }
  /**
   ...
   */
  getCacheKey(e, t) {
    return `_cache$${e.sort().join("$")}${t ? "$" + ne.EXTENT : ""}$`;
  }
  /**
   ...
   */
  clearAll() {
    this.sql = { [ne.PERMANENT]: this.sql[ne.PERMANENT] }, this.extent = void 0, this.clearAllCaches();
  }
}
class gt {
  id;
  ...
  static fromConfig(e) {
    return new gt(
      e.id,
      N.fromConfig(`${e.id}-extent-default`, e.default),
      e.full !== void 0 ? N.fromConfig(`${e.id}-extent-full`, e.full) : void 0,
      e.maximum !== void 0 ? N.fromConfig(`${e.id}-extent-maximum`, e.maximum) : void 0
    );
  }
  clone() {
...
class It {
   ...
   */
  updateQuery(e) {
    const t = Ni.all([{}, this.queryMap, e]);
...
class Ys {
  espgWorker;
  constructor() {
    this.espgWorker = this.defaultEpsgLookup, oe.defs(
      "EPSG:3978",
      "+proj=lcc +lat_1=49 +lat_2=77 +lat_0=49 +lon_0=-95 +x_0=0 +y_0=0 +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +units=m +no_defs"
    ), oe.defs(
      "EPSG:3979",
      "+proj=lcc +lat_1=49 +lat_2=77 +lat_0=49 +lon_0=-95 +x_0=0 +y_0=0 +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +units=m +no_defs"
    ), oe.defs("EPSG:54004", "+proj=merc +lon_0=0 +k=1 +x_0=0 +y_0=0 +ellps=WGS84 +datum=WGS84 +units=m +no_defs"), oe.defs("EPSG:102100", oe.defs("EPSG:3857")), oe.defs(
      "EPSG:102187",
    ...
    for (; e <= 60; ) {
      const t = e < 10 ? `0${e}` : e;
      oe.defs(`EPSG:326${t}`, `+proj=utm +zone=${e} +ellps=WGS84 +datum=WGS84 +units=m +no_defs`), e++;
    }
  }
  /**
   ...
   */
  addProjection(e, t) {
    e = typeof e == "number" ? `EPSG:${e}` : e, oe.defs(e, t);
  }
  ...
  async checkProj(e) {
    ...
    const o = async (a) => {
      try {
        ...
        return c === null || c === "" ? !1 : (oe.defs(a, c), !0);
      } catch {
        return !1;
      }
    };
  ...
  async projectGeoJson(e, t, i) {
    let s, o;
    if (t ? s = this.normalizeProj(t) : s = I.parseGeoJsonCrs(e.crs), i ? o = this.normalizeProj(i) : o = Hs, o === s)
      return e;
    await this.checkProjBomber([s, o]);
    const n = oe(s, o).forward;
    return Ps.applyConverter(e, n);
  }
  /**
  ...
  async projectExtent(e, t) {
    const i = (h, w, A) => {
      if (A === 0)
        return [h, w];
      const q = [(h[0] + w[0]) / 2, (h[1] + w[1]) / 2];
      if (A === 1)
        return [h, q, w];
      if (A > 1) {
        const L = i(h, q, A - 1), $ = i(q, w, A - 1);
        return L.concat($.slice(1));
      }
      return [[]];
    }, s = t.toPolygonArray().pop() || [];
    let o = [];
    [0, 1, 2, 3].map((h) => i(s[h], s[h + 1], 3).slice(1)).forEach((h) => o = o.concat(h));
    const n = new te("warpy", [o], t.sr, !0), l = await this.projectGeometry(e, n), a = l.toArray().pop() || [], c = a.map((h) => h[0]), p = a.map((h) => h[1]), u = Math.min.apply(null, c), d = Math.max.apply(null, c), v = Math.min.apply(null, p), f = Math.max.apply(null, p);
    return N.fromParams(t.id + "_projected", u, v, d, f, l.sr);
  }
}
class Js {
  // useful functions
  ...
  sharedUtils;
  constructor() {
    this.proj = new Ys(), this.geom = new qs(), this.sharedUtils = new Ws();
  }
  defaultTileSchemas() {
...
const Tt = G("appbar", () => {
  ...
  const r = m({ text: {}, logo: {} }), e = m({}), t = m({}), i = m({});
  function s(n) {
  ...
  const r = m([]), e = m([]), t = m([]);
  function i(u) {
    return Gt(r.value, (d) => d?.uid === u);
  }
  function s(u) {
    return Gt(r.value, (d) => d?.id === u);
  }
  function o(u) {
    return Gt(
      r.value,
      (d) => d !== void 0 && (d.id === u || d.uid === u)
    );
  }
  function n(u) {
    e.value = [...e.value, u];
  }
  function l(u, d = void 0) {
    r.value = [...r.value, u], u.mapLayer && ((d === void 0 || d < 0) && (console.error("Map layer added to store with invalid index!"), d = t.value.length), t.value.splice(d, 0, u.id), t.value = [...t.value]);
  }
  function a(u, d) {
    if (!u.mapLayer) {
    ...
    const v = t.value.findIndex((f) => f === u.id);
    v !== -1 && v !== d && (t.value.splice(v, 1), t.value.splice(d, 0, u.id), t.value = [...t.value]);
  }
  function c(u) {
    const d = r.value.filter((v) => v.id !== u.id || v.uid !== u.uid);
    if (r.value = d, u.mapLayer) {
      const v = t.value.filter((f) => f !== u.id);
      t.value = v;
    }
  }
  function p(u) {
    const d = e.value.filter((v) => v.id !== u);
    e.value = d;
  }
  return {
    /**
  ...
  function l(a) {
    const c = a.configLangs, p = a.config, u = a.allLangs;
    c !== void 0 && c.length > 0 && c.forEach((d) => {
      i.value[d] = p, s.value[d] = d;
    }), u !== void 0 && u.length > 0 && u.forEach((d) => {
  ...
  const r = m([]), e = m({}), t = m({}), i = m(), s = m(0), o = m(0), n = m(!0), l = m();
  function a(p) {
    const u = r.value.findIndex((d) => d.uid === p.uid);
    u !== -1 && r.value.splice(u, 1);
  }
  function c(p) {
    e.value = { ...e.value, [p.id]: p };
  }
  return {
    payload: r,
    properties: e,
...
class er extends J {
  ...
  _funCounter;
  constructor(e) {
    super(e), this._eventBus = new os(), this._eventRegister = [], this._funCounter = 1, this._nameRegister = Object.values(x).filter((t) => typeof t == "string" && t.indexOf("/") > -1);
  }
  /**
  ...
  defaultHandlerFactory(e) {
    ...
    switch (e) {
      ...
      case "ramp_map_basemap_checks_tile_proj":
        t = (i) => {
          i.schemaChanged && this.$iApi.geo.layer.allLayers().filter((s) => s.layerType === S.TILE).forEach((s) => {
            s.checkProj();
          });
      ...
      case "ramp_map_basemap_updates_map_attribs":
        t = () => {
          this.$iApi.geo.map.caption.updateAttribution(
            ce(this.$vApp.$pinia).activeBasemapConfig?.attribution
          );
        }, this.$iApi.event.on("map/basemapchanged", t, e);
        break;
      ...
      case "ramp_map_created_initializes_fixtures":
        t = () => {
          const i = me(this.$vApp.$pinia).items;
...
function sr() {
  return Ns({
    ...
    locale: document.documentElement.getAttribute("lang") || di,
    fallbackLocale: di,
    globalInjection: !0,
    //@ts-ignore
    messages: tr,
...
const Lt = G("maptip", () => {
  const r = m(void 0), e = m(void 0), t = m("");
  function i(n) {
    r.value = n;
  }
  function s(n) {
  ...
  __name: "esri-map",
  setup(r) {
    const e = Lt(), t = be("iApi"), i = M(() => e.maptipPoint), s = M(() => e.maptipInstance), o = M(() => e.content), n = ye([]);
    n.push(
      Et(i, () => {
        if (i.value) {
          let a, c;
          const p = t.geo.map.getPixelWidth() / 2, u = 0, d = t.geo.map.mapPointToScreenPoint(i.value);
          a = d.screenX - p, c = u - d.screenY, s.value.setProps({
            offset: [a, c]
...
const or = ["data-cy"], Wi = /* @__PURE__ */ C({
  ...
  setup(r) {
    const e = m(null), t = r, i = m(!1);
    We(() => {
      t.panel.teleport && new qi(
    ...
    return (a, c) => {
      ...
      return y(), b("div", {
        ...
        se(Li, {
          ...
          default: X(() => [
            k((y(), V(ls(r.panel.route.screen), cs({ class: "h-full" }, r.panel.route.props, { panel: r.panel }), null, 16, ["panel"])), [
              [p]
            ])
          ]),
          _: 1
  ...
  const r = m(void 0), e = m(void 0), t = m(0), i = m(0), s = m(!1), o = m(!0), n = m({}), l = m({}), a = m([]), c = m([]), p = m([]), u = M(() => i.value);
  function d(E) {
    return E === "xs" && p.value.length > 0 ? [p.value.slice().pop()] : p.value;
  }
  function v(E) {
    const R = [];
    return E.forEach((de) => {
      de in l.value && R.push(l.value[de].getPromise());
    }), R;
  }
  function f(E) {
    ue(E), $(), e.value = void 0;
  ...
  function $() {
    let E = t.value;
    const R = [], de = 350, Ze = 12, ni = 600;
    for (let Me = a.value.length - 1; Me >= 0; Me--) {
      const Ke = a.value[Me];
      let Ie = Ke.width || de;
      if (s.value ? Ie = E : Ie += Ze, Ke.id === "grid" && (Ie = Math.max(Math.min(Ie, E), ni)), (E >= Ie && !s.value || R.length === 0) && (E -= Ie, R.unshift(Ke)), Ke.id === "grid" && E < ni)
        break;
    }
    if (r.value && //@ts-ignore
    !R.includes(r.value) && !s.value) {
      let Me;
      for (let ai = 0; ai < R.length - 1 && E < (r.value.width || de) + Ze; ai++)
        Me = R.shift(), E += Me.width || de;
      E >= (r.value.width || de) ? R.unshift(r.value) : e.value || (Me = R.shift(), R.unshift(r.value));
      const Ke = a.value.indexOf(r.value), Ie = a.value.indexOf(Me), Ft = a.value.slice();
      Ie > -1 && (Ft.splice(Ke, 1), Ft.splice(Ie, 0, r.value)), a.value = Ft;
    }
    i.value = E, p.value = R;
  }
  function W(E) {
    if (n.value = { ...n.value, [E.id]: E }, E.id in l.value)
      l.value[E.id].resolveMe(E);
    else {
      const R = new Y();
      R.resolveMe(E), l.value = {
        ...l.value,
        [E.id]: R
      };
    }
  ...
  function ue(E) {
    E.teleport ? c.value = [...c.value, E] : (a.value = [...a.value, E], e.value = E);
  }
  function ut(E) {
    if (E.teleport) {
      const R = c.value.indexOf(E);
      R !== -1 && (c.value = [...c.value.slice(0, R), ...c.value.slice(R + 1)]);
    } else {
      const R = a.value.indexOf(E);
      R !== -1 && (a.value = [...a.value.slice(0, R), ...a.value.slice(R + 1)]);
    }
  }
  function Mt(E, R) {
    const de = a.value.indexOf(E), Ze = R === "right" ? 1 : -1;
    p.value.includes(a.value[de + Ze]) && ([a.value[de], a.value[de + Ze]] = [
      a.value[de + Ze],
      a.value[de]
    ]);
  }
  function Pt(E) {
    n.value[E.id] !== void 0 && delete n.value[E.id], l.value[E.id] !== void 0 && delete l.value[E.id];
    const R = p.value.indexOf(E);
    R !== -1 && (p.value = [...p.value.slice(0, R), ...p.value.slice(R + 1)]), r.value && r.value.id == E.id && (r.value = void 0);
  }
  function Nt(E) {
    l.value = {
      ...l.value,
  ...
  __name: "panel-stack",
  setup(r) {
    const e = qe(), t = be("iApi"), i = m(), s = M(() => e.mobileView);
    We(() => {
      new ResizeObserver((p) => {
        const u = !(t?.$vApp.$root?.$refs["app-size"]).classList.contains("sm");
        s.value !== u && (e.mobileView = u, t?.event.emit(x.RAMP_MOBILEVIEW_CHANGE, u)), e.setStackWidth(p[0].contentRect.width);
      }).observe(i.value?.$el);
    });
    const o = (c) => (
      //@ts-ignore
      ...
      const [u, d] = [c.children[0].getBoundingClientRect(), c.parentElement.getBoundingClientRect()];
      c.style.width = `${u.width}px`, c.style.height = `${u.height}px`, c.style.left = `${u.left - d.left}px`, c.style.position = "absolute", a(c, p, [
        [0, -6],
        [1, 0]
      ]);
    }, a = (c, p, u) => {
    ...
    return (c, p) => (y(), V($i, {
      ...
      default: X(() => [
        (y(!0), b(Ve, null, pt(o(_(t).screenSize), (u) => (y(), V(Wi, {
          key: `${u.id}`,
          panel: u
        }, null, 8, ["panel"]))), 128))
      ]),
  ...
  for (const [i, s] of e)
    t[i] = s;
  return t;
}, ar = /* @__PURE__ */ ke(nr, [["__scopeId", "data-v-11f38702"]]), lr = ["content", "aria-label"], Xt = /* @__PURE__ */ C({
  ...
  setup(r) {
    const e = m(!1), t = m(null), i = ye([]), s = m(), o = m(), n = m(), l = r;
    i.push(
      Et(e, () => {
        t.value.update();
      })
    ...
    return We(() => {
      window.addEventListener(
        "click",
        (u) => {
          (!s.value || !s.value.contains(u.target)) && (e.value = !1);
        },
        { capture: !0 }
      ), window.addEventListener("blur", () => {
        e.value = !1;
      }), window.addEventListener("focusin", (u) => {
        (!s.value || !s.value.contains(u.target)) && (e.value = !1);
      }), n.value.addEventListener("focus", c), n.value.addEventListener("blur", p), n.value.addEventListener("mouseover", c), n.value.addEventListener("mouseleave", p), $t(() => {
        const u = {
          name: "overflowScroll",
          enabled: !0,
          phase: "main",
          fn({ state: d }) {
            const { bottom: v } = zs(d);
            v > 0 ? (d.styles.popper.overflowY = v > 100 ? "auto" : void 0, d.styles.popper.overflowX = "hidden", d.styles.popper.height = `${d.rects.popper.height - v - 8}px`) : d.styles.popper.height = "auto";
          }
        };
        n.value && o.value && (t.value = Bs(n.value, o.value, {
      ...
      i.forEach((u) => u()), window.removeEventListener(
        "click",
        (u) => {
          (!s.value || !s.value.contains(u.target)) && (e.value = !1);
        },
        ...
        e.value = !1;
      }), window.removeEventListener("focusin", (u) => {
        (!s.value || !s.value.contains(u.target)) && (e.value = !1);
      }), n.value.removeEventListener("focus", c), n.value.removeEventListener("blur", p), n.value.removeEventListener("mouseover", c), n.value.removeEventListener("mouseleave", p), e.value = !1;
    }), (u, d) => {
      const v = O("tippy");
      return y(), b("div", {
        ref_key: "el",
        ...
        k(g("div", {
          onClick: d[0] || (d[0] = (f) => t.value.update()),
  ...
  const r = m([]), e = m({}), t = M(() => r.value.length >= 99 ? 99 : r.value.length);
  function i(c) {
    r.value = [c, ...r.value];
  }
  function s(c) {
    if (r.value.includes(c)) {
      const p = r.value.indexOf(c);
      c instanceof Hi && a(c), p > -1 && r.value.splice(p, 1);
    }
  }
  function o(c) {
    e.value[c.id] = c;
  ...
  function n(c, p) {
    e.value[c] && (e.value[c].messageList.push(p), r.value.includes(e.value[c]) || (r.value = [e.value[c], ...r.value]));
  }
  function l() {
  ...
  function a(c) {
    const p = r.value.indexOf(c);
    p > -1 && r.value.splice(p, 1), c.messageList = [];
  }
  return {
    notificationStack: r,
    groups: e,
...
}), cr = { class: "h-full flex flex-col" }, pr = { class: "w-full flex mb-6" }, ur = ["content", "aria-label"], dr = /* @__PURE__ */ C({
  __name: "screen",
  props: {
    panel: {
      type: Object,
  ...
  setup(r) {
    const e = _e(), { t } = j(), i = M(() => e.notificationNumber), s = () => e.clearAll();
    return (o, n) => {
      const l = Z("panel-screen"), a = O("tippy");
      return y(), V(l, { panel: r.panel }, {
        header: X(() => [
          it(D(_(t)("notifications.title")), 1)
        ]),
        content: X(() => [
          g("div", cr, [
            g("div", pr, [
...
var he = /* @__PURE__ */ ((r) => (r.ERROR = "error", r.INFO = "info", r.WARNING = "warning", r))(he || {});
class hr extends J {
  notificationStore;
  /**
  ...
  constructor(e) {
    super(e), this.$iApi.panel.register({
      ...
      config: {
        screens: {
          "notifications-screen": ie(dr)
        },
        alertName: "notifications.title"
      }
    }), this.notificationStore = _e(this.$vApp.$pinia);
  }
  /**
  ...
  addGroup(e, t, i) {
    ...
    const s = new Hi(this.$iApi, e, t, i);
...
class Hi extends J {
  notificationStore = _e(this.$vApp.$pinia);
  id;
  message;
  type;
  messageList = [];
...
const fr = ["content"], mr = { class: "flex items-center text-left" }, gr = { class: "select-text cursor-text" }, yr = ["content"], vr = {
  key: 0,
  class: "text-left"
}, br = /* @__PURE__ */ C({
  ...
  setup(r) {
    ...
    return (a, c) => {
      ...
      return k((y(), b("li", {
        ...
        onClick: c[1] || (c[1] = (u) => s.value = !s.value)
      }, [
        g("div", mr, [
          g("span", null, [
            it(D(o[r.notification.type]) + " ", 1),
            g("span", gr, D(r.notification.message), 1)
          ]),
          c[4] || (c[4] = g("span", { class: "flex-grow" }, null, -1)),
          r.notification.messageList ? (y(), b("div", {
            key: 0,
          ...
          k((y(), b("button", {
            type: "button",
            onClick: c[0] || (c[0] = Zt((u) => n(r.notification), ["stop"])),
            ...
            [p, { theme: "ramp4", animation: "scale" }]
          ])
        ]),
        r.notification.messageList && s.value ? (y(), b("div", vr, [
          (y(!0), b(Ve, null, pt(r.notification.messageList, (u, d) => (y(), b("p", {
            key: r.notification.id + u + d
          }, D(u), 1))), 128))
        ])) : F("", !0)
      ], 10, fr)), [
        [p, { onShow: l, theme: "ramp4", animation: "scale" }]
      ]);
    };
  }
}), Ar = ["content"], wr = {
  ...
  setup(r) {
    ...
    const n = M(() => e.notificationStack);
    return (l, a) => {
      const c = O("focus-item"), p = O("focus-list"), u = O("tippy");
      return y(), b("div", null, [
        n.value.length > 0 ? k((y(), b("ul", {
          key: 0,
          content: _(t)("panels.controls.items"),
          ref_key: "el",
          ref: i
        }, [
          (y(!0), b(Ve, null, pt(n.value, (d, v) => (y(), b(Ve, {
            key: d.message + v
          }, [
            v > 0 ? (y(), b("div", wr)) : F("", !0),
            k(se(br, {
          ...
          [p],
          [u, { trigger: "manual", placement: "top-start" }]
        ]) : (y(), b("div", Er, [
          a[0] || (a[0] = g("span", { class: "flex-grow" }, null, -1)),
          a[1] || (a[1] = g("svg", {
            xmlns: "http://www.w3.org/2000/svg",
            viewBox: "0 0 24 24",
          ...
          g("span", null, D(_(t)("notifications.empty")), 1),
          a[2] || (a[2] = g("span", { style: { "flex-grow": "6" } }, null, -1))
        ]))
      ]);
    };
  }
}), xr = { class: "flex items-center hover:text-white" }, Sr = ["aria-label"], _r = {
  key: 0,
  class: "number rounded-full w-18 text-white"
}, Ir = { class: "notification-dropdown pointer-events-auto bg-white rounded text-center text-black w-500 h-256 flex flex-col p-0" }, Tr = { class: "pb-8 border-b border-gray-600" }, Lr = { class: "absolute flex right-3 top-3" }, $r = ["content", "aria-label"], Rr = /* @__PURE__ */ C({
  __name: "caption-button",
  setup(r) {
    const e = _e(), { t } = j(), i = M(() => e.notificationNumber), s = () => e.clearAll();
    return (o, n) => {
      const l = Z("close"), a = O("tippy");
      return y(), V(Xt, {
        position: "top-start",
        ...
        header: X(() => [
          g("div", xr, [
            ...
            i.value && i.value > 0 ? (y(), b("span", _r, D(i.value), 1)) : F("", !0)
          ])
        ]),
        default: X((c) => [
          g("div", Ir, [
            g("div", null, [
              g("h4", Tr, D(_(t)("notifications.title")), 1),
              g("div", Lr, [
                k((y(), b("button", {
                  type: "button",
                  onClick: s,
            ...
            se(Yi, { class: "overflow-y-auto h-230" })
          ])
        ]),
        _: 1
      }, 8, ["tooltip"]);
...
}), Cr = /* @__PURE__ */ ke(Rr, [["__scopeId", "data-v-3623a7d2"]]), Or = { class: "flex hover:text-white" }, kr = ["aria-label"], Mr = { class: "about-ramp-dropdown pointer-events-auto bg-white rounded w-256 h-50" }, Pr = { class: "pb-8 border-b border-gray-600 mb-10" }, Nr = { class: "absolute right-5 top-5" }, Fr = { class: "select-text" }, Dr = { class: "font-bold cursor-text" }, Gr = { class: "text-sm cursor-text" }, Ur = { class: "text-sm cursor-text" }, Br = /* @__PURE__ */ C({
  ...
  setup(r) {
    const { t: e } = j(), t = M(() => `${ht.major}.${ht.minor}.${ht.patch}`), i = M(() => ht.hash.slice(0, 9)), s = M(() => {
    ...
    return (o, n) => {
      const l = Z("close"), a = Z("dropdown-menu"), c = O("focus-item");
      return k((y(), V(a, {
        ...
        default: X((p) => [
          g("div", Mr, [
            g("div", null, [
              ...
              g("div", Fr, [
                g("div", null, [
                  g("span", Dr, D(t.value), 1),
                  g("span", Gr, " [" + D(i.value) + "] ", 1)
                ]),
                g("div", null, [
                  g("span", Ur, D(s.value), 1)
                ]),
                n[1] || (n[1] = g("div", { class: "mt-5" }, [
                  g("a", {
...
}), zr = /* @__PURE__ */ ke(Br, [["__scopeId", "data-v-dd0345a4"]]), Vr = { class: "map-caption absolute bottom-0 h-29 sm:h-38 flex justify-end pointer-events-auto cursor-default select-none text-gray-200 bg-black-75 left-0 right-0 py-2 sm:py-6" }, jr = {
  key: 0,
  class: "relative top-2 sm:top-1 ml-4 sm:ml-0 shrink-0"
}, qr = ["href", "aria-label"], Wr = ["src", "alt"], Hr = {
  key: 1,
  class: "relative ml-10 top-2 text-sm sm:text-base"
}, Yr = { class: "flex min-w-fit justify-end" }, Jr = {
  key: 0,
  class: "pl-8 px-14 sm:block display-none relative top-2"
}, Zr = ["aria-pressed", "aria-label", "content"], Kr = { class: "relative top-1 text-sm sm:text-base" }, Qr = { class: "text-gray-200 hover:text-white text-sm sm:text-base pb-5" }, Xr = ["onClick"], eo = {
  key: 0,
  class: "sr-only"
}, to = /* @__PURE__ */ C({
  __name: "map-caption",
  setup(r) {
    const e = Fe(), t = ce(), { t: i } = j(), s = be("iApi"), o = M(() => e.scale), n = M(() => e.attribution), l = M(() => e.coords), a = M(() => e.langtoggle), c = M(() => t.config.map), p = m([]), u = ye([]);
    u.push(
      Et(c, (h) => {
        h && s.geo.map.caption.createCaption(c.value?.caption);
      })
    ), ct(() => {
      u.forEach((h) => h());
    }), us(() => {
      $t(() => {
        s.$i18n.locale.value && p.value.length == 0 && (p.value = s.$i18n.availableLocales);
      });
    });
    const d = (h) => {
      s.$i18n.locale.value != h && s.setLanguage(h);
    }, v = () => {
      e.toggleScale(), s.geo.map.caption.updateScale();
    }, f = (h = !1) => i(h ? "map.toggleScaleToMetric" : "map.toggleScaleToImperial");
    return (h, w) => {
      const A = Z("dropdown-menu"), q = O("truncate"), L = O("tippy");
      return y(), b("div", Vr, [
        se(zr, {
          class: "sm:block display-none ml-8 mr-4",
          position: "top-end"
        }),
        se(Cr, { class: "sm:block display-none" }),
        n.value?.logo.disabled ? F("", !0) : (y(), b("span", jr, [
          g("a", {
        ...
        n.value?.text.disabled ? F("", !0) : k((y(), b("span", Hr, [
          it(D(n.value?.text.value), 1)
        ])), [
          [q, {
            options: {
              placement: "top",
        ...
        w[0] || (w[0] = g("span", { class: "flex-grow w-15" }, null, -1)),
        g("div", Yr, [
          l.value?.disabled ? F("", !0) : k((y(), b("div", Jr, [
            it(D(l.value?.formattedString), 1)
          ])), [
            [q, {
              options: {
                hideOnClick: !1,
          ...
          o.value?.disabled ? F("", !0) : k((y(), b("button", {
            key: 1,
            type: "button",
            ...
            "aria-label": `
                ...
                `,
            content: f(o.value?.isImperialScale)
          }, [
            g("span", {
              class: "border-solid border-2 border-white border-t-0 h-5 mr-4 inline-block",
              style: Ti({ width: o.value?.width })
            }, null, 4),
            g("span", Kr, D(o.value?.label), 1)
          ], 8, Zr)), [
            [L, {
              delay: [300, 0],
              placement: "top",
          ...
          a.value?.disabled ? F("", !0) : (y(), V(A, {
            ...
            header: X(() => [
              g("span", Qr, D(_(i)("map.language.short")), 1)
            ]),
            default: X(() => [
              (y(!0), b(Ve, null, pt(p.value, ($, W) => (y(), b("a", {
                key: `${$}-${W}`,
                class: re(["flex-auto items-center text-sm sm:text-base cursor-pointer", { "font-bold": $ === _(s).$i18n.locale.value }]),
                href: "javascript:;",
                onClick: (ue) => d($)
              }, [
                it(D(_(i)("map.language." + $)) + " ", 1),
                $ === _(s).$i18n.locale.value ? (y(), b("span", eo, D(_(i)("map.language.curr")), 1)) : F("", !0)
              ], 10, Xr))), 128))
            ]),
            _: 1
          }, 8, ["tooltip", "ariaLabel"]))
  ...
  setup(r) {
    const e = _e(), t = be("iApi"), { t: i } = j(), s = M(() => e.notificationNumber);
    return (o, n) => {
      const l = O("tippy");
      return k((y(), b("button", {
        type: "button",
        ...
        s.value && s.value > 0 ? (y(), b("span", so, D(s.value), 1)) : F("", !0)
      ], 8, io)), [
        [l]
      ]);
    };
  }
}), oo = /* @__PURE__ */ ke(ro, [["__scopeId", "data-v-b03e7e33"]]), no = { class: "flex items-center mb-20" }, ao = { class: "text-xl" }, lo = /* @__PURE__ */ C({
  __name: "keyboard-instructions",
  setup(r) {
    const e = be("iApi"), { t } = j(), i = m(!1), s = m(["app", "lists", "map"]), o = m([]), n = m(null), l = m(null);
    We(() => {
      o.value.push(
    ...
    return (c, p) => {
      ...
      return i.value ? (y(), b("div", {
        ...
        g("div", {
          ...
          g("div", no, [
            g("h2", ao, D(_(t)("keyboardInstructions.title")), 1),
            se(u, {
              class: "ml-auto",
              onClick: p[0] || (p[0] = (d) => i.value = !1)
            })
          ]),
          (y(!0), b(Ve, null, pt(s.value, (d) => (y(), b("p", {
            class: "whitespace-pre-line pb-10",
            key: d
          }, D(_(t)(`keyboardInstructions.${d}`)), 1))), 128)),
          g("button", {
            type: "button",
            ...
            ref_key: "lastEl",
            ref: l
          }, D(_(t)("keyboardInstructions.OK")), 513)
        ], 512)
      ], 32)) : F("", !0);
    };
  }
}), Xe = G("instance", () => ({ started: m(!1) })), co = { class: "h-full relative" }, po = { class: "inner-shell absolute top-0 left-0 h-full w-full pointer-events-none" }, uo = { class: "absolute top-8 w-full flex justify-center" }, ho = {
  key: 1,
  class: "w-full h-full"
}, fo = /* @__PURE__ */ C({
  __name: "shell",
  setup(r) {
    const e = be("iApi"), t = Xe(), i = me(), s = qe(), { t: o } = j(), n = M(() => i.items.appbar), l = () => {
      e?.event.emit("openKeyboardInstructions");
    }, a = () => (
      // @ts-ignore
      s.teleported
    );
    return (c, p) => (y(), b("div", co, [
      g("div", po, [
        p[0] || (p[0] = g("div", { class: "sr-only screen-reader-alert" }, null, -1)),
        g("div", uo, [
          g("button", {
            type: "button",
            class: "bg-white hidden-until-focus z-50 shadow-md px-10",
            onClick: l
          }, D(_(o)("keyboardInstructions.open")), 1)
        ]),
        se(lo),
        se(ar, { class: "panel-stack sm:flex absolute inset-0 overflow-hidden sm:p-12 z-10 sm:pl-80 xs:pl-40 sm:pb-48 xs:pb-28 xs:pr-0 sm:pr-40" }),
        n.value ? F("", !0) : (y(), V(oo, { key: 0 })),
        se(to, { class: "z-30" })
      ]),
      _(t).started ? (y(), V(rr, { key: 0 })) : (y(), b("div", ho, p[1] || (p[1] = [
        g("div", { class: "spinner relative inset-x-1/2 inset-y-9/20" }, null, -1)
      ]))),
      (y(!0), b(Ve, null, pt(a(), (u) => (y(), V(ds, {
        to: u.teleport?.target,
        key: u.id
      }, [
        (y(), V(Wi, {
          key: `${u.id}`,
...
}), mo = /* @__PURE__ */ ke(fo, [["__scopeId", "data-v-6c131943"]]), go = C({
  name: "App",
  components: { Shell: mo },
  setup() {
    const r = hs();
    We(() => {
      new qi().observe(r?.proxy?.$refs["app-size"]), Ds({
        aria: {
          content: "labelledby"
        },
        theme: "ramp4",
...
const Ao = /* @__PURE__ */ ke(go, [["render", bo]]), we = "focus-list", Be = "focus-item", wo = "focus-icon", Eo = "focus-container", ot = `[${we}],[${Eo}]`, vt = "truncate-text", bt = "show-truncate", tt = "focused", Ht = `button,input,select,a,textarea,[contenteditable],[${we}],[${wo}],[tabIndex]`, xo = {
  mounted(r, e) {
    +r.getAttribute("tabindex") <= 0 && r.setAttribute("tabindex", "0"), r.toggleAttribute(we, !0), new So(r, e.value);
  },
  updated(r) {
    Ji(r);
  }
...
function Ji(r) {
  r.querySelectorAll(Ht).forEach((t) => {
    if (t.closest(ot) === r || t.closest(ot) === t && t.parentElement.closest(ot) === r)
      if (t.closest(`[${we}],.${tt}`).classList.contains(tt))
...
class So {
  ...
  setTabIndex(e, t = this.element) {
    t.querySelectorAll(Ht).forEach((s) => {
      (e === -1 || s.closest(ot) === this.element || s.closest(ot) === s && s.parentElement.closest(ot) === this.element || s.closest(`[${we}],.${tt}`).classList.contains(tt)) && s.setAttribute("tabindex", e.toString());
    });
  }
  /**
   ...
   */
  defocusItem(e) {
    e.classList.remove(tt), this.setTabIndex(-1, e), e._tippy && e._tippy.hide(), e.getAttribute(Be) === bt && e.querySelector(`[${vt}]`)?._tippy?.hide();
  }
  /**
   ...
   */
  focusItem(e) {
    e.classList.add(tt), this.setAriaActiveDescendant(e), this.setTabIndex(0, e), e.scrollIntoView({ block: "nearest" }), e._tippy && !this.isTapped && e._tippy.show(), e.getAttribute(Be) === bt && e.querySelector(`[${vt}]`)?._tippy?.show(), this.isTapped = !1;
  }
  /**
  ...
  onKeydown(e) {
    const t = this, i = Array.prototype.filter.call(
      this.element.querySelectorAll(`[${Be}]`),
      (s) => s.closest(`[${we}]`) === t.element && !!s.offsetParent
    );
    if (i.length !== 0)
      switch (e.key) {
        case "Up":
  ...
  onClick(e) {
    ...
    let t = e.target;
    if (!t.hasAttribute(we))
      for (; t.parentElement.closest(`[${we}]`) !== this.element; )
        t = t.parentElement.closest(`[${we}]`);
    this.highlightedItem = t.closest(`[${Be}]`) || t.closest(`[${we}]`) || this.highlightedItem, t.hasAttribute(`${Be}`) && this.element.focus(), this.highlightedItem !== this.element ? this.focusItem(this.highlightedItem) : this.element.removeAttribute("aria-activedescendant");
  }
  /**
   ...
   */
  onFocus() {
    this.highlightedItem && !this.isClicked && (this.highlightedItem._tippy && this.highlightedItem._tippy.show(), this.highlightedItem.getAttribute(Be) === bt && this.highlightedItem.querySelector(`[${vt}]`)?._tippy?.show()), this.isClicked = !1, this.element.hasAttribute("aria-activedescendant") || this.highlightedItem === this.element ? this.highlightedItem !== this.element && this.focusItem(this.highlightedItem) : this.setAriaActiveDescendant(this.highlightedItem), Ji(this.element), this.highlightedItem && this.highlightedItem !== this.element && this.highlightedItem.setAttribute("tabindex", "-1");
  }
  /**
   ...
   */
  onBlur() {
    this.highlightedItem && (this.highlightedItem._tippy && this.highlightedItem._tippy.hide(), this.highlightedItem.getAttribute(Be) === bt && this.highlightedItem.querySelector(`[${vt}]`)?._tippy?.hide());
  }
  /**
...
const hi = "focus-item", _o = {
  beforeMount(r, e) {
    r.hasAttribute("id") || r.setAttribute("id", Io()), e.value ? r.setAttribute(hi, e.value) : r.toggleAttribute(hi, !0);
  }
};
function Io() {
  let r;
...
const ei = "focus-container", Zi = "focus-list", To = "focus-icon", Ut = `[${Zi}],[${ei}]`, fi = `button,input,select,a,textarea,[contenteditable],.ag-tab-guard,[${Zi}],[${ei}],[${To}],[tabIndex]`;
let Bt = [];
const Lo = {
  mounted(r) {
    [...document.querySelectorAll(".inner-shell")].some((t) => t.contains(r)) && Bt.push(new $o(r));
  },
  beforeUnmount(r) {
...
class $o {
   ...
   */
  disableTabbing() {
    Array.prototype.filter.call(this.element.querySelectorAll(fi), () => !0).forEach((t) => {
      t.tabIndex = -1;
    });
  }
  /**
  ...
  enableTabbing() {
    let e;
    return Array.prototype.map.call(this.element.querySelectorAll(fi), (t) => {
...
const Ro = "truncate-text", Co = "truncate-trigger", Oo = {
  beforeMount(r, e) {
    !r.classList.contains("truncate") && !e.value?.noTruncateClass && r.classList.add("truncate"), r.toggleAttribute(Ro, !0);
  },
  mounted(r, e) {
    let t;
    e.value && e.value.externalTrigger && (t = r.closest(`[${Co}]`)), Gs(r, {
      content: mi(r.textContent),
      onShow: ko,
      allowHTML: !0,
  ...
  updated(r, e) {
    r._tippy && (r._tippy.setContent(mi(r.textContent)), e.value && e.value.options && r._tippy.setProps(e.value.options));
  },
  unmounted(r) {
...
const Mo = ["content"], Po = {
  ...
  setup(r, { expose: e }) {
    const { t } = j(), i = qe(), s = Tt(), o = be("iApi"), n = m();
    e({ el: n });
    const l = r, a = M(() => o?.fixture.get("appbar") ? s.temporary : []), c = M(() => i.mobileView), p = M(() => i.reorderable), u = () => !c.value && !l.panel.teleport, d = (f) => {
      l.panel.move(f), f === "left" && $t(() => {
        (n.value?.querySelector(".move-left")).focus();
      });
    }, v = M(() => l.screenId ? l.panel.screens[l.screenId][o?.$i18n.locale.value ?? "en"] : null);
    return We(() => {
      n.value?.addEventListener("blur", () => {
        n.value._tippy.hide();
      }), n.value?.addEventListener("keyup", (f) => {
        f.key === "Tab" && n.value?.matches(":focus") && n.value._tippy.show();
      });
    }), ct(() => {
      n.value?.removeEventListener("blur", () => {
        n.value._tippy.hide();
      }), n.value?.removeEventListener("keyup", (f) => {
        f.key === "Tab" && n.value?.matches(":focus") && n.value._tippy.show();
      });
    }), (f, h) => {
      const w = Z("back"), A = Z("panel-options-menu"), q = Z("left"), L = Z("right"), $ = Z("pin"), W = Z("expand"), ue = Z("minimize"), ut = Z("close"), Mt = O("truncate"), Pt = O("focus-item"), Nt = O("tippy");
      return k((y(), b("div", {
        ...
        r.header ? (y(), b("header", Po, [
          se(w, {
            class: re(r.panel.teleport ? "display-none" : "block sm:display-none"),
            onClick: h[0] || (h[0] = (E) => r.panel.close())
          }, null, 8, ["class"]),
          k((y(), b("h2", No, [
            f.$slots.header ? Ce(f.$slots, "header", { key: 0 }) : (y(), b("div", Fo, D(_(t)(r.panel.alertName)), 1))
          ])), [
            [Mt]
          ]),
          f.$slots.controls ? (y(), V(A, { key: 0 }, {
            default: X(() => [
              Ce(f.$slots, "controls")
            ]),
            _: 3
          ...
          g("div", {
            ...
            r.panel.teleport ? F("", !0) : (y(), b("div", Do, [
              p.value ? (y(), V(q, {
                key: 0,
                onClick: h[1] || (h[1] = (E) => d("left")),
                active: !r.panel.isLeftMostPanel
              }, null, 8, ["active"])) : F("", !0),
              p.value ? (y(), V(L, {
                key: 1,
                onClick: h[2] || (h[2] = (E) => d("right")),
                active: !r.panel.isRightMostPanel
              }, null, 8, ["active"])) : F("", !0),
              se($, {
                onClick: h[3] || (h[3] = (E) => r.panel.pin()),
                active: r.panel.isPinned
              }, null, 8, ["active"]),
              r.panel.controls && r.panel.controls.expand ? (y(), V(W, {
                key: 2,
                onClick: h[4] || (h[4] = (E) => r.panel.expand()),
                active: r.panel.expanded
              }, null, 8, ["active"])) : F("", !0)
            ])),
            r.panel.button && a.value?.includes(r.panel.id) ? (y(), V(ue, {
              key: 1,
              onClick: h[5] || (h[5] = (E) => r.panel.minimize())
            })) : F("", !0),
            se(ut, {
              onClick: h[6] || (h[6] = (E) => r.panel.close())
            })
          ], 2)
        ])) : F("", !0),
        r.content ? (y(), b("div", Go, [
          f.$slots.content ? Ce(f.$slots, "content", { key: 0 }) : v.value ? (y(), b("div", {
            key: 1,
            innerHTML: v.value.innerHTML
          }, null, 8, Uo)) : F("", !0)
        ])) : F("", !0),
        r.footer ? k((y(), b("div", Bo, [
          Ce(f.$slots, "footer")
        ])), [
          [Pt]
        ]) : F("", !0)
...
}), Vo = { class: "relative" }, jo = ["content", "aria-label"], qo = ["transform"], Wo = /* @__PURE__ */ C({
  __name: "pin",
  props: {
    active: Boolean
  },
...
}), Ho = { class: "relative" }, Yo = ["content", "aria-label"], Jo = /* @__PURE__ */ C({
  __name: "close",
  props: {
    active: Boolean
  },
...
}), Zo = { class: "relative" }, Ko = ["content", "aria-label"], Qo = /* @__PURE__ */ C({
  __name: "back",
  props: {
    active: Boolean
  },
...
}), on = { class: "relative" }, nn = ["content", "aria-label"], an = /* @__PURE__ */ C({
  __name: "minimize",
  props: {
    active: Boolean
  },
...
}), ln = { class: "relative" }, cn = ["content", "aria-label"], pn = /* @__PURE__ */ C({
  __name: "right",
  props: {
    active: Boolean
  },
...
}), un = { class: "relative" }, dn = ["content", "aria-label"], hn = /* @__PURE__ */ C({
  __name: "left",
  props: {
    active: Boolean
  },
...
}), mn = /* @__PURE__ */ ke(fn, [["__scopeId", "data-v-51e22a4a"]]), gn = {
  key: 0,
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 24 24",
  ...
  setup(r) {
    ...
    return (s, o) => {
      ...
      return y(), V(n, {
        ...
        default: X(() => [
          _(t).isFullscreen ? (y(), b("svg", gn, o[0] || (o[0] = [
            g("path", {
              d: "M0 0h24v24H0z",
              fill: "none"
            }, null, -1),
    ...
    const s = async () => {
      if (i.length)
        ...
        const l = await n({
          ...
          a.code === GeolocationPositionError.PERMISSION_DENIED ? t.notify.show(he.ERROR, e("mapnav.geolocator.error.permission")) : t.notify.show(he.ERROR, e("mapnav.geolocator.error.internal"));
        });
  ...
  tabindex: "-1"
}, En = ["content", "aria-label"], xn = /* @__PURE__ */ C({
  __name: "button",
  props: {
    onClickFunction: {
      type: Function,
  ...
  setup(r) {
    return (e, t) => {
      const i = O("focus-item"), s = O("tippy");
      return y(), b("div", wn, [
        k((y(), b("button", {
          type: "button",
  ...
  class: "relative",
  tabindex: "-1"
}, _n = ["aria-label", "content"], In = /* @__PURE__ */ C({
  __name: "button",
  props: {
    onClickFunction: {
      type: Function,
  ...
  setup(r) {
    const e = be("iApi"), t = r, i = () => e?.event.emit(x.APPBAR_BUTTON_CLICK, t.id);
    return (s, o) => {
      const n = O("focus-item"), l = O("tippy");
      return y(), b("div", Sn, [
        k((y(), b("button", {
          type: "button",
...
}), Tn = /* @__PURE__ */ ke(In, [["__scopeId", "data-v-457cd2d4"]]), Ln = G("areas-of-interest", () => ({ areas: m([]) })), $n = G("export", () => {
  const r = m({
    title: !0,
    map: !0,
    mapElements: !0,
...
const gi = "https://geogratis.gc.ca/services/geolocation/@{language}/locate", yi = "https://geogratis.gc.ca/services/geoname/@{language}/geonames.json", vi = "https://geogratis.gc.ca/services/geoname/@{language}/codes/province.json", bi = "https://geogratis.gc.ca/services/geoname/@{language}/codes/concise.json", Bn = {
  10: "NL",
  11: "PE",
  12: "NS",
  13: "NB",
...
class Ai {
  ...
  constructor(e, t) {
    ...
    l ? (i = l.geoLocation ? l.geoLocation : gi, s = l.geoNames ? l.geoNames : yi, o = l.geoProvince ? l.geoProvince : vi, n = l.geoTypes ? l.geoTypes : bi) : (i = gi, s = yi, o = vi, n = bi), i = i.replace("@{language}", e), s = s.replace("@{language}", e), o = o.replace("@{language}", e), n = n.replace("@{language}", e);
    const a = t?.settings;
    let c, p, u, d, v;
    a ? (c = a.categories ? a.categories : [], p = a.sortOrder ? a.sortOrder : [], u = a.disabledSearchTypes ? a.disabledSearchTypes : [], d = a.maxResults > 0 ? a.maxResults : 100, v = !!a.officialOnly) : (c = [], p = [], u = [], d = 100, v = !1), this.config = {
      language: e,
      geoNameUrl: s,
      geoLocateUrl: i,
      types: Pn(e, n),
...
const zn = G("geosearch", () => {
  const r = m(new Ai("en", void 0)), e = m({
    type: "",
    province: "",
    extent: void 0
  }), t = m(!1), i = m(""), s = m(""), o = m(""), n = m([]), l = m([]), a = m(!1), c = m([]), p = M(
    () => new Promise((L) => {
      r.value.fetchProvinces().then(($) => {
        $.sort((W, ue) => W.name > ue.name ? 1 : -1), L($);
      });
    })
  ), u = M(
    () => new Promise((L) => {
  ...
  function v(L) {
    ...
    if (!$)
      ...
      const W = setInterval(() => {
        r.value.config.provinces.listFetched && r.value.config.types.typesFetched && (clearInterval(W), r.value.query(`${$}*`).then((ue) => {
          c.value = ue.failedServs, o.value = $, l.value = ue.results;
          const ut = wi(
            t.value,
            //@ts-ignore
            e.value,
  ...
  function f(L) {
    e.value.province = typeof L.province > "u" ? "" : L.province, v(L.forceReRun);
  }
  function h(L) {
    e.value.type = typeof L.type > "u" ? "" : L.type, v(L.forceReRun);
  }
  function w(L) {
    o.value = i.value.replace(/["!*$+?^{}()|[\]\\]/g, "").trim(), i.value = L, v();
  }
  function A(L) {
    const $ = {
...
}), Vn = G("help", () => ({ location: m("./help/") }));
var Ki = /* @__PURE__ */ ((r) => (r.Visibility = "visibilityButton", r.Expand = "expandButton", r))(Ki || {}), Yt = /* @__PURE__ */ ((r) => (r.Item = "item", r.Placeholder = "placeholder", r.Error = "error", r))(Yt || {});
class Qi extends J {
  _uid;
  _name;
  _type;
  ...
  toggleVisibility(e, t = !0) {
    if (this.visibility !== e) {
      if (this._visibility = e ?? !this.visibility, !this.exclusive)
        ...
        if (this._lastVisible && (!(this._lastVisible instanceof Pe) || this._lastVisible.layerControlAvailable(z.Visibility)))
          this._lastVisible.toggleVisibility(!0);
        else {
          const i = this.children.find(
            (s) => !(s instanceof Pe) || s.layerControlAvailable(z.Visibility)
          );
   ...
   */
  checkVisibility(e) {
    this instanceof Pe && !this.layerControlAvailable(z.Visibility) || (this.exclusive ? e.visibility ? (this.children.forEach((t) => {
      t.uid !== e.uid && t.toggleVisibility(!1, !1);
    }), this._lastVisible = e, this._visibility = !0, this instanceof Pe && this.layer && this.layer.layerExists && (this.layer.visibility = !0)) : (this._visibility = !1, this instanceof Pe && this.layer && this.layer.layerExists && (this.layer.visibility = !1), this._lastVisible = e) : this.children.some((t) => t.visibility) ? (this._visibility = !0, this._visibleChildren = this.children.filter((t) => t.visibility), this instanceof Pe && this.layer && this.layer.layerExists && (this.layer.visibility = !0)) : (this._visibility = !1, this._visibleChildren = [], this instanceof Pe && this.layer && this.layer.layerExists && (this.layer.visibility = !1)), this.parent && this.parent.checkVisibility(this));
  }
  /**
...
class Pe extends Qi {
  ...
  toggleVisibility(e, t = !0, i = !1) {
    if (!(!this.layerControlAvailable(z.Visibility) && !i) && (super.toggleVisibility(e, t), this.layer && this.layer.layerExists)) {
  ...
  load(e) {
    ...
    t && (this.layer = t, this._layerRedrawing = t.mapLayer && t.drawState !== le.UP_TO_DATE, t.loadPromise().then(() => {
      this._layerInitVis = typeof this._layerInitVis < "u" ? this._visibility : t.visibility, super.load(), this.toggleVisibility(this._layerInitVis, !0, !0), t.visibility || this.setSymbologyVisibility(void 0, !1), this.handlers.push(
        ...
        this.$iApi.event.on(
          ...
          (i) => {
            this.layer.uid === i.layer.uid && (i.layer.drawState === le.REFRESH ? this.layerRedrawing = !0 : setTimeout(() => {
              this.layerRedrawing = i.layer.drawState === le.REFRESH;
            }, 500));
          }
        )
...
class Ei extends Qi {
  ...
  constructor(e, t, i) {
    ...
    }), (t.infoType || t.content) && (this._controls = t.controls?.slice() ?? [Ki.Expand]), super.load();
  }
...
const qn = G("legend", () => {
  const r = m(), e = m([]), t = m([]), i = m(!0), s = m(3);
  function o(a) {
    if (a.parent === void 0)
      e.value.push(a.item);
    else {
      if (!(a.item instanceof Ei) && !(a.item instanceof Pe)) {
  ...
  function n(a) {
    const c = (p) => (p = p.filter((u) => (u === a && !u.children.length && u.onRemoved(), u !== a)), p.forEach((u) => {
      u.children = c(u.children);
    }), p = p.filter(
      (u) => !(u instanceof Ei && !u.children.length && u.content === "")
    ), p);
    e.value = c(e.value);
  }
  function l(a) {
    if (a.oldItem.parent === void 0) {
      const c = e.value, p = c.indexOf(a.oldItem);
      p > -1 && (e.value[p] = a.newItem), e.value = c;
    } else {
      const c = a.oldItem.parent.children, p = c.indexOf(a.oldItem);
      p > -1 && (c[p] = a.newItem), a.oldItem.parent.children = c;
    }
  }
  return {
    legendConfig: r,
  ...
  const r = m(""), e = m({ type: "LineString", coordinates: [] });
  ...
  const r = m({
    ...
    tileSchemas: [],
    initialBasemapId: ""
  }), e = m({}), t = m(!0), i = m(1.5), s = m("#FF0000"), o = m(1), n = m("#000000"), l = m(0.25);
  function a(c) {
...
const Kn = G("wizard", () => {
  const r = {
    ...
    layerType: S.UNKNOWN,
    url: ""
  }, e = m(), t = m(""), i = m(""), s = m(!0), o = m(null), n = m({
    config: r,
    configOptions: []
  }), l = m(ee.UPLOAD);
  function a(c) {
...
class Qn {
  ...
  _isFullscreen;
  constructor(e, t, i) {
    this.event = new er(this);
    const s = Xn(e, this);
    this.$vApp = s.app, this.$element = s.element, this.$i18n = s.i18n, this.fixture = new Ha(this), this.panel = new Ya(this), this.geo = new qa(this), this.ui = {
      ...
      escapeHtml: () => "",
      isPlainText: () => !0
    }, this.notify = new hr(this), this._isFullscreen = Ae.isEnabled && !!this.$vApp.$root && Ae.isFullscreen && Ae.element === this.$vApp.$root.$el, Ae.isEnabled && Ae.onchange(() => {
      this._isFullscreen = Ae.isEnabled && !!this.$vApp.$root && Ae.isFullscreen && Ae.element === this.$vApp.$root.$el;
   ...
   */
  initialize(e, t, i) {
    const s = ce(this.$vApp.$pinia), o = qe(this.$vApp.$pinia), n = Lt(this.$vApp.$pinia);
    if (t?.configs !== void 0) {
      ...
      s.activeBasemapConfig = c.map.basemaps.find(
        (f) => f.id === c.map.initialBasemapId
      );
      const p = setInterval(() => {
        const f = this.$vApp.$el.querySelector("#esriMap");
        if (f && (clearInterval(p), this.geo.map.createMap(c.map, f), f._tippy.hide(0), n.setMaptipInstance(f._tippy), c.layers && c.layers.length > 0)) {
          let h = 0;
          c.layers.forEach((w) => {
            const A = this.geo.layer.createLayer(w);
            this.geo.map.addLayer(A, h).catch(() => {
            }), A.mapLayer && h++;
          });
        }
      }, 100);
      if (c.panels) {
        if (c.panels.open && c.panels.open.length > 0) {
          const f = c.panels.open.map((h) => h.id);
          this.panel.isRegistered(f).then(() => {
            c.panels?.open?.forEach((h) => {
              this.panel.open({
                id: h.id,
                screen: h.screen
              }), h.pin && this.panel.pin(h.id);
            });
          });
        }
      ...
      }, d = c.system?.zoomIcon || "globe", v = u[d] || d;
      this.ui.getZoomIcon = () => v, this.ui.formatNumber = (f) => this.ui.suppressNumberLocalization ? f.toString() : this.$i18n.n(f, "number"), this.ui.escapeHtml = (f) => {
        const h = {
          "<": "&lt;",
          ">": "&gt;",
          '"': "&quot;",
        ...
        return f.replace(/[<>"']/g, (w) => h[w]);
      }, this.ui.isPlainText = (f) => typeof f == "string" ? !this.containsValidHtml(f) && !this.representsObject(f) : !1;
    }
    i || (i = {});
   ...
   */
  reload(e, t) {
    const i = Xe(this.$vApp.$pinia), s = _e(this.$vApp.$pinia), o = ce(this.$vApp.$pinia), n = me(this.$vApp.$pinia), l = xe(this.$vApp.$pinia), a = qt(this.$vApp.$pinia), c = !!e;
    c ? Object.keys(n.items).forEach((d) => {
      this.fixture.exists(d) && this.fixture.remove(d);
    }) : this.fixture.flush(), Object.keys(a.grids).forEach((u) => {
      a.removeGrid(u);
  ...
  setLanguage(e) {
    if (this.$i18n.locale.value === e)
      return;
    const t = ce(this.$vApp.$pinia), i = _e(this.$vApp.$pinia), s = t.registeredLangs;
    ...
    s[o] !== s[e] && (this.event.emit(x.CONFIG_CHANGE, n), this.reload()), this.event.emit(x.LANG_CHANGE, {
      oldLang: o,
      newLang: e
    });
  }
   ...
   */
  toggleFullscreen() {
    Ae.isEnabled && Ae.toggle(this.$element._container || void 0);
  }
  /**
...
function Xn(r, e) {
  ...
  const i = sr(), s = Ri(Ao).use(i).use(Fs, {
    directive: "tippy",
    // => v-tippy
    component: "tippy"
    // => <tippy/>
  }).use(t);
  s.directive("focus-container", Lo), s.directive("focus-list", xo), s.directive("focus-item", _o), s.directive("truncate", Oo), s.component("panel-screen", zo), s.component("pin", Wo), s.component("close", Jo), s.component("back", Qo), s.component("expand", rn), s.component("panel-options-menu", mn), s.component("dropdown-menu", Xt), s.component("minimize", an), s.component("right", pn), s.component("left", hn), s.component("fullscreen-nav-button", vn), s.component("geolocator-nav-button", bn), s.component("home-nav-button", An), s.component("mapnav-button", xn), s.component("appbar-button", Tn), s.component("transition", Li), s.component("transition-group", $i), s.config.globalProperties.$iApi = e, s.config.globalProperties.$pinia = t, s.provide("iApi", e);
  const o = s.mount(r);
...
class ea {
  ...
  config;
  constructor(e) {
    this.config = e, this.esriBasemap = new gs({
      ...
      baseLayers: e.layers.map((t) => {
        if (t.layerType === S.TILE)
          return new Pi({
            url: t.url,
            opacity: t.opacity
          });
        if (t.layerType === S.MAPIMAGE)
          return new ki({
            url: t.url,
            opacity: t.opacity
          });
        if (t.layerType === S.OSM)
          return new Mi({
            opacity: t.opacity
          });
...
class ta extends J {
  ...
  createMap(e, t) {
    ...
    const i = {};
    this.esriMap = ie(new Is(i)), this.pointZoomScale = e.pointZoomScale && e.pointZoomScale > 0 ? e.pointZoomScale : 5e4, this._targetDiv = t, this.createMapView(e.initialBasemapId);
  }
  /**
  ...
  applyBasemap(e) {
    ...
    this.esriMap.basemap = Ee(t.esriBasemap);
  }
  /**
   ...
   */
  getExtent() {
    return this.esriView ? N.fromESRI(this.esriView.extent) : (this.noMapErr(), N.fromParams("i_am_error", 0, 1, 0, 1));
  }
  /**
...
class ia extends J {
  ...
  async checkAtCoord(e) {
    ...
    this.setPoint(this.$iApi.geo.map.screenPointToMapPoint(e)), this.$iApi.event.emit(x.MAP_GRAPHICHIT, {
      layer: i,
      graphicHit: t,
...
class sa extends J {
  ...
  updateAttribution(e) {
    ...
    if (e ? (e.logo ? e.logo.disabled ? s.logo.disabled = !0 : (s.logo.altText = e.logo.altText || i.altText, s.logo.link = e.logo.link || i.link, s.logo.value = e.logo.value || i.value) : (s.logo.altText = i.altText, s.logo.link = i.link, s.logo.value = i.value), e.text ? e.text.disabled ? s.text.disabled = !0 : s.text.value = e.text.value || t.value : s.text.value = t.value, Fe(this.$vApp.$pinia).setAttribution(s)) : (s.logo.altText = i.altText, s.logo.link = i.link, s.logo.value = i.value, s.text.value = t.value), !e || e.text?.disabled || !e.text) {
      ...
      let o = "";
      const n = 5e3, l = 20, a = this.$iApi.geo.map.esriMap.basemap.baseLayers.map((c) => new Promise((p) => {
        let u = 0;
        const d = n / l, v = setInterval(function() {
          c.loaded && !c.loadError ? (clearInterval(v), p(c)) : u > d && (clearInterval(v), p(null)), u++;
        }, l);
      })).toArray();
      Promise.all(a).then((c) => {
        o = c.filter((u) => u?.copyright).map((u) => u.copyright).join(" | "), s.text.value = o || s.text.value || t.value, Fe(this.$vApp.$pinia).setAttribution(s);
      });
    }
  }
  /**
   ...
   */
  updateScale() {
    const e = Fe(this.$vApp.$pinia), t = e.scale;
    if (t?.disabled)
      return;
  ...
  scaleHelper() {
    ...
    for (let a = 0; a < 2; a++) {
      ...
      if (i.push({
        ...
        const p = t * e / (c ? o : 1e3), u = Math.round(p).toString().length, d = Math.pow(10, u - 1);
        i[a].distance = Math.ceil(p / d) * d, i[a].pixels = i[a].distance * (c ? o : 1e3) / t;
      } else
  ...
  async formatLatLongDMS(e) {
    const t = await this.$iApi.geo.proj.projectGeometry(4326, e), i = this.wrapValue(t.y, -90, 90), s = this.wrapValue(t.x, -180, 180), o = "°", n = Math.floor(Math.abs(i)) * (i < 0 ? -1 : 1), l = Math.floor(Math.abs((i - n) * 60)), a = Math.floor((Math.abs(i) - Math.abs(n) - l / 60) * 3600), c = Math.floor(Math.abs(s)) * (s < 0 ? -1 : 1), p = Math.floor(Math.abs((s - c) * 60)), u = Math.floor((Math.abs(s) - Math.abs(c) - p / 60) * 3600);
    return `${this.$iApi.$i18n.n(Math.abs(n), "number")}${o} ${this.$iApi.$i18n.n(l, "number", {
      ...
      Math.abs(c),
      "number"
    )}${o} ${this.$iApi.$i18n.n(p, "number", {
      minimumIntegerDigits: 2
    })}' ${this.$iApi.$i18n.n(u, "number", {
      minimumIntegerDigits: 2
...
class ra extends ta {
   ...
   */
  createMapView(e) {
    const i = ce(this.$vApp.$pinia).config.map;
    if (!i)
    ...
    this.esriView = ie(
      ...
      handler: this.esriView.watch("scale", (a) => {
        this.$iApi.event.emit(x.MAP_SCALECHANGE, a);
      })
    }), this.handlers.push({
      type: "resize",
      ...
      handler: this.esriView.on("pointer-leave", (a) => {
        setTimeout(
          () => {
            this.$iApi.event.emit(x.MAP_MOUSELEAVE, a.native);
          },
      ...
      handler: this.esriView.on("pointer-down", (a) => {
        this.$iApi.event.emit(x.MAP_MOUSEDOWN, a.native);
      })
    }), this.handlers.push({
      type: "key-down",
      handler: this.esriView.on("key-down", (a) => {
        this.$iApi.event.emit(x.MAP_KEYDOWN, a.native), a.stopPropagation();
      })
    }), this.handlers.push({
      type: "key-up",
      handler: this.esriView.on("key-up", (a) => {
        this.$iApi.event.emit(x.MAP_KEYUP, a.native), a.stopPropagation();
      })
    }), this.handlers.push({
      type: "focus",
      handler: this.esriView.on("focus", (a) => {
        this.$iApi.event.emit(x.MAP_FOCUS, a.native);
      })
    }), this.handlers.push({
      type: "blur",
      handler: this.esriView.on("blur", (a) => {
        this.$iApi.event.emit(x.MAP_BLUR, a.native);
      })
      ...
      const a = new IntersectionObserver((c) => {
        c.forEach((p) => {
          p.isIntersecting && (this.esriView?.tryFatalErrorRecovery(), a.disconnect());
        });
      });
  ...
  setBasemap(e) {
    ...
    const t = ce(this.$vApp.$pinia), i = this.findBasemap(e), o = t.activeBasemapConfig.tileSchemaId !== i.tileSchemaId;
    if (o) {
      const n = this.getExtent().center(), l = this.getScale();
      this._viewPromise = new Y(), this.created = !1, this.$iApi.event.emit(x.MAP_REFRESH_START), this.destroyMapView(), this.createMapView(i), this.viewPromise.then(() => {
      ...
      this.applyBasemap(i), this.esriView.background = new Ms({
        color: new Oe(i.backgroundColour).toESRI()
      }), this.$iApi.event.emit(x.MAP_BASEMAPCHANGE, {
        basemapId: e,
        schemaChanged: o
      });
    return o;
  ...
  addLayer(e, t = void 0) {
    return new Promise((i, s) => {
      if (this.esriMap || (this.noMapErr(), s()), e.initiationState !== P.INITIATING && e.initiationState !== P.INITIATED && e.layerState !== B.ERROR && e.initiate(), e.mapLayer && t === void 0) {
        const c = this.$iApi.geo.layer.layerOrderIds();
        if (e.isCosmetic)
          t = c.length;
        else {
          const p = this.$iApi.geo.layer.allLayers();
          let u = !0;
          for (let d = c.length - 1; d >= 0 && u; d--) {
            const v = p.find((f) => f.id === c[d]);
            v && !v.isCosmetic && (t = d + 1, u = !1);
          }
          u && (t = 0);
        }
      }
      xe(this.$vApp.$pinia).addLayer(e, t), this.$iApi.event.emit(x.LAYER_REGISTERED, e);
      const n = Date.now();
      let l = 0;
      const a = setInterval(() => {
        l += 250, l >= e.expectedTime.fail || e.layerState === B.ERROR ? (clearInterval(a), e.lastCancel < n && console.error(`Failed to add layer: ${e.id}.`), s()) : e.initiationState === P.INITIATED && (e.esriLayer || !e.mapLayer) && (clearInterval(a), e.mapLayer ? this.insertToEsriMap(e) : e.onLoad(), i());
      }, 250);
    });
  }
  /**
  ...
  reorder(e, t, i = !1) {
    ...
    if (i) {
      ...
      if (t > 0) {
        const a = o.filter((c) => {
          const p = s.find((u) => u.id === c);
          return p ? !p.isCosmetic : (console.error("Layer reorder had critical error"), !1);
        });
    ...
    if (n === t)
      return;
    if (xe(this.$vApp.$pinia).reorderLayer(e, t), e.esriLayer && this.esriMap.layers.indexOf(e.esriLayer) > -1) {
      let a = 0;
      if (t > 0) {
        o = this.$iApi.geo.layer.layerOrderIds();
        for (let c = t - 1; c > -1; c--) {
          const p = o[c], u = s.find((d) => d.id === p);
          if (u && u.esriLayer) {
            const d = this.esriMap.layers.indexOf(u.esriLayer);
            if (d > -1) {
              const v = t < n ? 1 : 0;
              a = d + v;
              break;
            }
          } else u || console.error("Layer reorder had critical error");
        }
      }
  ...
  removeLayer(e) {
    ...
    const i = xe(this.$vApp.$pinia);
    i.removeLayer(t), i.removeLayerConfig(t.id), t.removeEsriLayer(), t.initiationState === P.INITIATED && t.terminate(), t.isRemoved = !0, this.$iApi.event.emit(x.LAYER_REMOVE, t);
  }
  /**
  ...
  */
  ...
  runIdentify(e) {
    ...
    return this.$iApi.event.emit(x.MAP_IDENTIFY, a), a;
  }
  /**
  ...
  async getGraphicAtCoord(e) {
    ...
    const t = this.$iApi.geo.layer.allLayersOnMap(!1).filter((a) => a.supportsFeatures || a.layerType === S.GRAPHIC);
    if (t.length === 0)
      return;
    ...
    if (s.some((a) => {
      if (l.has(a.layer.id))
        return !1;
      const c = t.find((p) => p.id === a.layer.id);
      return c ? (!c.isCosmetic && c.layerType !== S.GRAPHIC && (o = c, n = a.graphic), !0) : (l.add(a.layer.id), !1);
    }), o && n)
      return {
        oid: n.getObjectId(),
        layerId: o.id,
  ...
  keyPan() {
    ...
    let n = 0, l = 0, a = 1;
    for (let p = 0; p < this._activeKeys.length; ++p)
      switch (this._activeKeys[p]) {
        case "ArrowLeft":
          n -= s;
          break;
        case "ArrowRight":
...
class ma extends J {
  ...
  extractGeoJsonFields(e) {
    ...
    for (; s < e.features.length; ) {
      ...
      if (n.properties && Object.keys(n.properties).filter((l) => o.includes(l)).forEach((l) => {
        ...
        if (a != null) {
          const c = i.findIndex((p) => p.name === l);
          i[c] = {
            name: l,
  ...
  extractCsvFields(e, t = ",") {
    return ui.dsvFormat(t).parseRows(e)[0].map((s) => ({ name: s, type: Le.STRING }));
  }
  /**
  ...
  filterCsvLatLonFields(e, t = ",") {
    const i = ui.dsvFormat(t).parseRows(e), s = i[0], o = {
      lat: JSON.parse(JSON.stringify(s)),
      lon: JSON.parse(JSON.stringify(s))
    };
    for (let n = 0; n < s.length; n++)
      for (let l = 1; l < i.length; l++) {
        const a = Number(i[l][n]), c = o.lat.indexOf(s[n]), p = o.lon.indexOf(s[n]);
        if ((isNaN(a) || a < -90 || a > 90) && c !== -1 && o.lat.splice(c, 1), (isNaN(a) || a < -180 || a > 180) && p !== -1 && o.lon.splice(p, 1), c === -1 && p === -1)
          break;
      }
    return o;
  }
  ...
  async geoJsonToEsriJson(e, t) {
    ...
    ua(e);
    const l = e.features[0].geometry.type, a = pa[l], c = JSON.parse(
      // @ts-ignore
      JSON.stringify(ca[a])
    );
    if (t) {
      ...
      t.layerId ? o = t.layerId : o = this.$iApi.geo.shared.generateUUID(), t.colour && (c.renderer.symbol.color = new Oe(t.colour).toArcServer());
    } else
      throw new Error("geoJsonToEsriJson - missing opts arguement");
    s || (s = I.parseGeoJsonCrs(e.crs)), n.renderer = Ts.fromJSON(c.renderer), n.fields = (n.fields || []).concat(
      t.fieldMetadata?.exclusiveFields ? this.extractGeoJsonFields(e).filter(
        (h) => t.fieldMetadata?.fieldInfo?.find((w) => w.name === h.name)
    ...
    const p = this.$iApi.geo.proj.normalizeProj(i);
    if (t) {
      if (t.latField) {
        const h = n.fields.find(
    ...
    const u = I.parseSR(i).toESRI();
    await this.$iApi.geo.proj.projectGeoJson(e, s, p);
    const d = Vs.convert(e, { sr: 8888 });
    n.geometryType = this.$iApi.geo.geom.geoJsonGeomTypeToEsriGeomType(l);
    const v = n.fields.map((h) => h.name);
    for (let h = 0; h < d.length; h++) {
      const w = d[h];
      w.geometry.spatialReference = u, w.geometry.type = n.geometryType, Object.keys(w.attributes).forEach((A) => {
        v.includes(A) ? (Array.isArray(w.attributes[A]) || typeof w.attributes[A] == "object") && w.attributes[A] != null && (w.attributes[A] = JSON.stringify(w.attributes[A])) : delete w.attributes[A];
      });
    }
    return (t.fieldMetadata?.fieldInfo && t.fieldMetadata?.fieldInfo.length > 0 ? t.fieldMetadata.fieldInfo.filter((h) => h.trim && v.includes(h.name)).map((h) => h.name) : []).forEach((h) => {
      for (let w = 0; w < d.length; w++) {
        const A = d[w].attributes;
        typeof A[h] == "string" && (A[h] = A[h].trim());
      }
    }), n.source = d, n.spatialReference = u, n.id = o, n;
  }
  ...
  fgbToGeoJson(e, t) {
    return import("flatgeobuf").then(({ geojson: s }) => new Promise((o) => {
      let n = !1, l = null;
      const a = s.deserialize(new Uint8Array(e), void 0, (u) => {
        l = u.crs, n = !0;
      });
      let c = 0;
      const p = setInterval(() => {
        if (a && n) {
          clearInterval(p);
          let u;
          l && (l.code && l.code !== 4326 && l.org === "EPSG" ? u = new I(l.code) : l.wkt ? u = new I(l.wkt) : console.error("Encountered FlatGeobuf with non-EPSG org: ", l)), u && (a.crs = u.toGeoJSON()), o(a);
        } else
          c += 60, c > t && (clearInterval(p), o({}));
      }, 60);
    }));
  }
  /**
   ...
   */
  inferType(e) {
    return typeof e == "number" ? Le.DOUBLE : Le.STRING;
  }
  /**
...
class ya extends J {
  ...
  async loadWfsData(e, t = -1, i = 0, s = 1e3, o = {
    ...
    const c = new It(e).updateQuery(l), [p, u] = await je(Rt.get(c));
    if (!u)
      return console.error(`WFS data failed to load for ${e}`, p), Promise.reject(p);
    const d = u.data;
    if (t === -1)
      return t = u.data.numberMatched, this.loadWfsData(e, t, i, s, o, n);
    if (o.features = o.features.concat(d.features), d.features.length < t - i) {
      const v = Math.min(s, t - i - d.features.length);
      ...
      return n && o.features.length > 0 && o.features[0].geometry.type === U.POINT && o.features.forEach((v) => {
        const f = v.geometry.coordinates;
        v.properties.rvInternalCoordX = f[0], v.properties.rvInternalCoordY = f[1];
      }), o;
  }
  /**
  ...
  parseCapabilities(e) {
    const t = () => {
      ...
      return l ? (Array.isArray(l) || (l = [l]), l.map((a) => {
        const c = a.Name, p = a.Title;
        let u = a.Style;
        const d = [], v = {};
        return u && (Array.isArray(u) || (u = [u]), u.forEach((f) => {
          const h = f.Name;
          if (d.push(h), f.LegendURL) {
            const A = f.LegendURL.OnlineResource["@_xlink:href"];
            v[h] = A.replaceAll("&amp;", "&");
          }
        })), {
    ...
    return import("fast-xml-parser").then(({ XMLParser: n }) => i.then((l) => {
      ...
      if ("ServiceExceptionReport" in p)
        return console.error(p.ServiceExceptionReport.ServiceException), [];
      const u = p.WMS_Capabilities.Capability;
      return {
        layers: s(u),
        queryTypes: o(u.Request.GetFeatureInfo)
      };
    }));
  }
}
...
class va extends J {
   ...
   */
  getLayer(e) {
    return xe(this.$vApp.$pinia).getLayerByAny(e);
  }
  /**
   ...
   */
  getSublayer(e, t) {
    const i = xe(this.$vApp.$pinia).getLayerById(e);
   ...
   */
  layerOrderIds() {
    return xe(this.$vApp.$pinia).mapOrder.slice(0) || [];
  }
  /**
   ...
   */
  allLayers() {
    return xe(this.$vApp.$pinia).layers || [];
  }
  /**
  ...
  allActiveLayers() {
    return this.allLayers().filter(
      (e) => e.layerState !== B.ERROR && e.initiationState === P.INITIATED
    );
  }
  /**
   ...
   */
  allLayersOnMap(e = !0) {
    let t = this.allLayers().filter((i) => i.mapLayer && i.initiationState === P.INITIATED);
    if (e) {
   ...
   */
  allDataLayers() {
    return this.allLayers().filter((e) => !e.mapLayer && e.initiationState === P.INITIATED);
  }
  /**
   ...
   */
  allErrorLayers() {
    return this.allLayers().filter((e) => e.layerState === B.ERROR);
  }
  /**
   ...
   */
  allInitiatingLayers() {
    return this.allLayers().filter((e) => e.initiationState === P.INITIATING);
  }
  /**
  ...
  getLayerControls(e) {
    ...
    return t.supportsFeatures || s.push(z.Datatable), t.extent === void 0 && s.push(z.BoundaryZoom), (t.config?.metadata || (t.isSublayer ? t.parentLayer?.config?.metadata : {}) || {}).url || s.push(z.Metadata), !t.mapLayer && !t.config.controls?.includes(z.Settings) && s.push(z.Settings), s.forEach((n) => {
  ...
  async loadLayerMetadata(e) {
    ...
    const [t, i] = await je(Ge(e, { query: { f: "json" } }));
    if (!i)
...
class ti extends J {
   ...
   */
  getGraphic(e, t) {
    return Promise.resolve(new ve(new Ue()));
  }
  /**
   ...
   */
  getGraphicExtent(e) {
    return Promise.resolve(N.fromParams("fake", 0, 0, 0, 0));
  }
  /**
...
class Xi extends ti {
  ...
  constructor(e, t) {
    super(e, t), this.name = e.name || "", this.geomType = T.NONE, this.dataFormat = Q.UNKNOWN, this.layerType = S.UNKNOWN, this.layerFormat = fe.UNKNOWN;
    ...
    this.expectedTime.draw = e.expectedDrawTime ?? i.draw, this.expectedTime.load = e.expectedLoadTime ?? i.load, this.expectedTime.fail = e.maxLoadTime || i.fail, this.lastCancel = 0, this.timers = {
      draw: void 0,
      load: void 0
    }, this.origRampConfig = e, this.id = e.id || "", this.uid = this.$iApi.geo.shared.generateUUID(), this.isCosmetic = !1, this.isRemoved = !1, this.isSublayer = !1, this.supportsIdentify = !1, this.mapLayer = !0, this.identifyMode = K.NONE, this.supportsFeatures = !1, this.hovertips = !1, this.supportsSublayers = !1, this.isFile = !1, this.layerState = B.NEW, this.initiationState = P.NEW, this.drawState = le.NOT_LOADED, this.loadDefProm = new Y(), this.url = this.origRampConfig.url, this.canReload = !!(this.url || this.origRampConfig.caching), this.loadPromDone = !1, this.layerTree = new _t(0, this.uid, this.name, !0);
  }
  updateInitiationState(e) {
  ...
  updateDrawState(e) {
    this.drawState = e, e === le.REFRESH ? this.startTimer(
      "draw"
      /* DRAW */
    ) : e === le.UP_TO_DATE && this.stopTimer(
      "draw"
      /* DRAW */
  ...
  async initiate() {
    this.updateInitiationState(P.INITIATING), this.startTimer(
      "load"
      /* LOAD */
    );
    const e = (o) => {
      this.layerState !== B.ERROR && (console.error(o), this.onError());
    }, t = Date.now(), i = setTimeout(() => {
      t > this.lastCancel && (this.lastCancel = Date.now(), e("Layer timed out during initialize. Id: " + this.id));
    }, this.expectedTime.fail), [s] = await je(this.onInitiate());
    clearTimeout(i), t > this.lastCancel && (this.drawState !== le.UP_TO_DATE && this.startTimer(
      "draw"
      /* DRAW */
    ), s ? e(`Init error on layer id: ${this.id} . ${s.message}`) : this.updateInitiationState(P.INITIATED));
  }
  async onInitiate() {
    if (this.isSublayer)
      return console.warn("Attempted to initiate a sublayer as a CommonLayer"), Promise.resolve();
    this.initiationState === P.INITIATED && console.error(`Encountered layer initialize while already initiated, layer id ${this.id}`);
  }
  async terminate() {
    this.updateInitiationState(P.TERMINATING), await Promise.all(this.sublayers.map((e) => e.terminate())), this.loadDefProm = new Y(), this.loadPromDone = !1, this.updateLayerState(B.NEW), this.updateDrawState(le.NOT_LOADED), this.updateInitiationState(P.TERMINATED);
  }
  // ----------- LAYER LOAD -----------
    ...
    try {
      ...
      Promise.all(s).then(() => {
        clearTimeout(i), t ? this.visibility = !1 : (this.stopTimer(
          "load"
          /* LOAD */
        ), e > this.lastCancel && (this.loadPromDone && (this.loadDefProm = new Y()), this.loadDefProm.resolveMe(), this.loadPromDone = !0, this.sublayers.forEach((o) => o.onLoad()), this.updateLayerState(B.LOADED)));
      }).catch(() => {
  ...
  onError(e = !0) {
    this.layerState !== B.ERROR && (this.initiationState === P.INITIATING && this.updateInitiationState(P.NEW), this.loadPromDone && (this.loadDefProm = new Y()), this.loadDefProm.rejectMe(), this.loadPromDone = !0, this.sublayers.forEach((t) => t.onError(e)), e && this.$iApi.notify.show(
      he.ERROR,
      this.$iApi.$i18n.t("layer.error", {
        id: this.id
      })
      ...
      "load"
      /* LOAD */
    ), this.updateLayerState(B.ERROR, !e));
  }
  /**
  ...
  cancelLoad() {
    this.isLoaded || this.initiationState === P.NEW || this.initiationState === P.TERMINATING || this.initiationState === P.TERMINATED || (this.lastCancel = Date.now(), this.esriLayer && this.esriLayer.loadStatus === "loading" && this.esriLayer.cancelLoad(), this.removeEsriLayer(), this.onError(!1));
  }
  loadPromise() {
    return this.loadDefProm.getPromise();
  }
  get isLoaded() {
    return this.layerState === B.LOADED;
  }
  // ----------- LAYER MANAGEMENT -----------
  /**
   * Indicates if layer should participate in an identify request.
   ...
   */
  getGraphic(e, t) {
    return this.stubError(), Promise.resolve(new ve(new Ue()));
  }
  getIcon(e) {
    return this.stubError(), Promise.resolve("");
  }
   ...
   */
  getGraphicExtent(e) {
    return this.stubError(), Promise.resolve(N.fromParams("fake", 0, 0, 0, 0));
  }
  applySqlFilter(e = []) {
    this.stubError();
  }
...
class Ye extends Xi {
  ...
  // ----------- LAYER CONSTRUCTION AND INITIALIZAION -----------
  constructor(e, t) {
    super(e, t), this._scaleSet = new Bi(), this._mouseTolerance = e.mouseTolerance != null ? e.mouseTolerance : 5, this._touchTolerance = e.touchTolerance != null ? e.touchTolerance : 15, this._drawOrder = [], this._serverVisibility = void 0, this.isCosmetic = e.cosmetic || !1, this.extent = e.extent ? N.fromConfig(`${this.id}_extent`, e.extent) : void 0, this.viewDefProm = new Y(), this.esriWatches = [];
  }
  noLayerErr() {
    console.error(
    ...
    this.esriWatches.push(
      ...
      this.esriView = e.layerView, this.esriWatches.push(
        e.layerView.watch("updating", (t) => {
          this.updateDrawState(t ? le.REFRESH : le.UP_TO_DATE);
        })
   ...
   */
  get layerExists() {
    return this.initiationState === P.INITIATED && !!this.esriLayer;
  }
  /**
...
class ii extends Ye {
  ...
  filter;
  constructor(e, t) {
    super(e, t), this.supportsIdentify = !0, this.geomType = T.UNKNOWN, this.serviceUrl = "", this.fieldList = "", this.canModifyLayer = !0, this.filter = new zi(e.permanentFilteredQuery || "", e.initialFilteredQuery || ""), this.hovertips = e.state?.hovertips ?? !0, this.attribs = new ts();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
  ...
  async loadLayerMetadata(e = {}) {
    ...
    if (!(t < this.lastCancel))
      if (this.geomType = i.geometryType, this.attribs.quickCache = new ss(this.geomType), this.scaleSet.minScale = i.minScale, this.scaleSet.maxScale = i.maxScale, this.dataFormat = i.dataFormat, this.extent = this.extent ?? i.extent, this._serverVisibility = i.defaultVisibility, this.dataFormat === Q.ESRI_FEATURE) {
        this.supportsFeatures = !0, this.canModifyLayer = this.layerType === S.SUBLAYER ? i.canModifyLayer : !0, this.fields = i.fields, this.nameField = i.displayField, this.oidField = i.objectIdField, this.sourceSR = i.sourceSR, this.drawOrder.forEach((n) => {
        ...
        const o = {
          ...
          permanentFilter: this.getSqlFilter(ne.PERMANENT)
        };
        this.attribs.attLoader = new is(this.$iApi, o), this.origRampConfig.name || (this.name = i.name ?? this.id);
      } else
  ...
  async getGraphic(e, t) {
    ...
    if (t.getAttribs || t.getStyle) {
      ...
      if (p)
        ...
        const u = await this.attribs.attLoader.getAttribs();
        i = u.features[u.oidIndex[e]];
      } else
        n = !0;
    }
    if (t.getGeom) {
      a = o.getScale();
      const p = this.attribs.quickCache.getGeom(e, a);
      p ? s = p : l = !0;
    }
    if (n || l) {
      const p = {
      ...
      l && (p.mapSR = o.getSR().wkid?.toString(), this.attribs.quickCache.isPoint || (p.maxOffset = o.esriView?.resolution));
      const u = await this.$iApi.geo.attributes.loadSingleFeature(p);
      l && (this.attribs.quickCache.setGeom(e, u.geometry, a), s = u.geometry), (n || typeof this.attribs.quickCache.getAttribs(e) > "u") && (this.attribs.quickCache.setAttribs(e, u.attributes), n && (i = u.attributes));
    }
    const c = new ve(s, "", t.getAttribs ? i : void 0);
    if (t.getStyle) {
      const p = Ee(this.renderer.getGraphicSymbol(i));
      c.style = this.$iApi.geo.geom.styleEsriToRamp(p);
    }
    return c;
  }
  async getIcon(e) {
...
class ba extends Ye {
  constructor(e, t) {
    super(e, t), this.dataFormat = Q.ESRI_FEATURE, this.layerFormat = fe.GRAPHIC, this.hovertips = !1;
  }
  _graphics = [];
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
  ...
  async addGraphic(e) {
    ...
    const i = t.filter((a) => this._graphics.findIndex((p) => p.id === a.id) === -1 ? (this._graphics.push(a), !0) : (console.error(`Attempting to add graphic with id '${a.id}' that has already been added.`), !1)), s = this.$iApi.geo.map.getSR(), o = i.map((a) => this.$iApi.geo.proj.projectGeometry(s, a.geometry)), n = await Promise.all(o), l = i.map((a, c) => {
      const p = new ve(n[c], a.id, a.attributes);
      return p.style = a.style, this.$iApi.geo.geom.graphicRampToEsri(p);
    });
...
class Aa extends ba {
  ...
  async onInitiate() {
    this.esriLayer = ie(new Es(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
  ...
  onLoadActions() {
    const e = super.onLoadActions();
    return this.layerTree.name = this.name, this.updateDrawState(le.UP_TO_DATE), e;
  }
  // ----------- LAYER ACTIONS -----------
}
class Je extends ii {
  ...
  constructor(e, t) {
    super(e, t), this.supportsIdentify = !0, this.isFile = !0, this.dataFormat = Q.ESRI_FEATURE, this.layerFormat = fe.FEATURE, this.tooltipField = "", this.layerIdx = 0, e.identifyMode && e.identifyMode !== K.NONE ? this.identifyMode = e.identifyMode : this.identifyMode = K.HYBRID;
  }
  async reload() {
  ...
  async onInitiate() {
    ...
    this.esriJson = await this.$iApi.geo.layer.files.geoJsonToEsriJson(this.sourceGeoJson, e), this.esriLayer = ie(new Oi(this.makeEsriLayerConfig(this.origRampConfig))), this.esriJson = void 0, this.origRampConfig.caching || delete this.origRampConfig.rawData, delete this.sourceGeoJson, await super.onInitiate();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
  ...
  runIdentify(e) {
    ...
    return e.hitTest && (this.identifyMode === K.HYBRID || this.identifyMode === K.SYMBOLIC) && (s = o.then(async () => {
      ...
      l = await Promise.all(
        a.filter(
          (c) => c.layerId === this.id && n.findIndex((p) => c.oid === p.attributes[this.oidField]) === -1
        ).map((c) => c.oid)
      );
  ...
  extractLayerMetadata() {
    ...
    this.supportsFeatures = !0, this.geomType = this.$iApi.geo.geom.clientGeomTypeToRampGeomType(e.geometryType), this.scaleSet.minScale = e.minScale || 0, this.scaleSet.maxScale = e.maxScale || 0, this.extent = this.extent ?? N.fromESRI(e.fullExtent, this.id + "_extent");
  ...
  async getGraphic(e, t) {
    ...
    if (!t.getGeom && this.attribs.attLoader.isLoaded()) {
      ...
      i = new ve(new Ue(), "", s.features[s.oidIndex[e]]);
    } else {
      const s = {
        filterOIDs: [e],
    ...
    if (t.getStyle) {
      const s = Ee(this.renderer.getGraphicSymbol(i.attributes));
  ...
  applySqlFilter(e = []) {
    ...
    Ee(this.esriView).filter = new Os({
      where: t
    });
  }
}
...
class Ta extends ii {
  tooltipField;
  constructor(e, t) {
    super(e, t), this.dataFormat = Q.ESRI_FEATURE, this.tooltipField = "", this.supportsIdentify = !0, this.layerType = S.FEATURE, this.layerFormat = fe.FEATURE, e.identifyMode && e.identifyMode !== K.NONE ? this.identifyMode = e.identifyMode : this.identifyMode = K.HYBRID;
  }
  async onInitiate() {
    ie(this.esriLayer = new Oi(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
  ...
  onLoadActions() {
    ...
    }), a = this.$iApi.geo.layer.loadFeatureCount(this.serviceUrl, this.getSqlFilter(ne.PERMANENT)).then((c) => {
...
class La extends Ye {
  ...
  origState;
  constructor(e, t) {
    super(e, t), this.supportsIdentify = !0, this.supportsSublayers = !0, this.layerType = S.MAPIMAGE, this.layerFormat = fe.MAPIMAGE, this.isDynamic = !1, this.hovertips = !1, this.layerTree.layerIdx = -1, this.identifyMode = K.GEOMETRIC;
  }
  async onInitiate() {
    this.esriLayer = ie(new ki(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
  ...
  onLoadActions() {
    ...
    this.isDynamic = this.esriLayer.capabilities.exportMap.supportsDynamicLayers, this.extent = this.extent ?? N.fromESRI(this.esriLayer.fullExtent, this.id + "_extent");
    const i = (a) => {
      const c = this.esriLayer?.allSublayers.find((p) => p.id === a);
      if (!c)
    ...
    const o = [], n = (a, c) => {
      ...
      if (a.sublayers && a.sublayers.length > 0) {
        const d = (u ? u.name : "") || a.title || "", v = new _t(p, "", d, !1);
        c.findChildByIdx(p) || c.children.push(v), a.sublayers.reverse().forEach((f) => {
          n(f, v);
        });
      } else {
        this._sublayers[p] || (this._sublayers[p] = new $a(
          {
            id: `${this.id}-${p}`,
            index: p,
            ...
            extent: u?.extent,
            controls: u?.controls,
            disabledControls: u?.disabledControls,
            initialFilteredQuery: u?.initialFilteredQuery,
            permanentFilteredQuery: u?.permanentFilteredQuery,
            labels: u?.labels
          },
          this.$iApi,
          this
        ));
        const d = this._sublayers[p];
        if (d.isRemoved)
          return;
        if (d.name = u?.name || a.title || "", o.push(d), !c.children.map((v) => v.layerIdx).includes(p)) {
          const v = new _t(p, d.uid, d.name, !1);
          c.children.push(v);
        }
        d.esriWatches.push(
          a.watch("visible", () => {
    ...
    const l = o.map(async (a) => {
      const c = i(a.layerIdx), p = s[a.layerIdx];
      if (a.serviceUrl = c.url, a.fetchEsriSublayer(this), await a.initiate(), t < this.lastCancel)
        return;
      const u = a.esriSubLayer && p?.customRenderer?.type;
      if (u && (a.esriSubLayer.renderer = at(p.customRenderer)), await a.loadLayerMetadata(u ? { customRenderer: a.esriSubLayer?.renderer } : {}), t < this.lastCancel)
        return;
      ...
      if (d ? (a.visibility = a.isRemoved ? !1 : d.state?.visibility ?? (this.origState.visibility ? a._serverVisibility ?? this.origState.visibility : this.origState.visibility ?? a._serverVisibility) ?? !0, a.opacity = d.state?.opacity ?? this.origState.opacity ?? 1, a.nameField = d.nameField || a.nameField || "", this.$iApi.geo.attributes.applyFieldMetadata(a, d.fieldMetadata), a.canModifyLayer || this.$iApi.notify.show(
        ...
        const v = await this.$iApi.geo.layer.loadFeatureCount(
          a.serviceUrl,
          a.getSqlFilter(ne.PERMANENT)
        );
        t > this.lastCancel && (a.featureCount = v);
      }
    });
...
class $a extends ii {
  tooltipField;
  constructor(e, t, i) {
    if (super(e, t), this.layerType = S.SUBLAYER, this.layerFormat = fe.MAPIMAGE, this.isSublayer = !0, this.layerIdx = e.index, this.parentLayer = i, this.dataFormat = Q.ESRI_FEATURE, this.supportsFeatures = !0, this.tooltipField = "", this.hovertips = !1, this.url = this.parentLayer?.url, this.canReload = !!(this.url || this.origRampConfig.caching), !i.esriLayer)
   ...
   */
  async onInitiate() {
    this.initiationState = P.INITIATED;
   ...
   */
  get layerExists() {
    return !!(this.parentLayer?.layerExists && this.esriSubLayer && this.initiationState === P.INITIATED);
  }
  /**
...
class Ra extends Ye {
  constructor(e, t) {
    super(e, t), this.supportsIdentify = !1, this.layerType = S.OSM, this.layerFormat = fe.OSM, this.dataFormat = Q.OSM_TILE, this.supportsFeatures = !1;
  }
  async onInitiate() {
...
class Ca extends Ye {
  constructor(e, t) {
    super(e, t), this.supportsIdentify = !1, this.layerType = S.IMAGERY, this.layerFormat = fe.IMAGERY, this.dataFormat = Q.ESRI_RASTER;
  }
  async onInitiate() {
...
class Oa extends Ye {
  constructor(e, t) {
    super(e, t), this.supportsIdentify = !1, this.layerType = S.TILE, this.layerFormat = fe.TILE, this.dataFormat = Q.ESRI_TILE;
  }
  async onInitiate() {
  ...
  checkProj() {
    ...
    else if (this.layerState === B.ERROR && i)
      this.reload();
    else if (this.layerState !== B.ERROR && !i)
...
class ka extends Ye {
  ...
  mimeType;
  constructor(e, t) {
    super(e, t), this.supportsIdentify = !0, this.layerType = S.WMS, this.layerFormat = fe.WMS, this.mimeType = e.featureInfoMimeType || "", this.sublayerNames = [], this.dataFormat = Q.OGC_RASTER, this.identifyMode = K.GEOMETRIC;
  }
  async onInitiate() {
  ...
  getFeatureInfo(e, t, i) {
    ...
    let n, l;
    const a = s.getExtent(), c = o.spatialReferences, p = e.join(","), u = s.esriView.toScreen(t.toESRI()), d = Math.floor(u.x), v = Math.floor(u.y), h = {
    ...
    }, this.$iApi.geo.layer.ogc.reversedAxisWKIDs().indexOf(n) > -1 && (l.BBOX = `${a.ymin},${a.xmin},${a.ymax},${a.xmax}`)) : l = { SRS: "EPSG:" + n, X: d, Y: v }, Object.prototype.hasOwnProperty.call(l, "BBOX") || (l.BBOX = `${a.xmin},${a.ymin},${a.xmax},${a.ymax}`);
    const A = {
      SERVICE: "WMS",
      ...
      LAYERS: p,
      INFO_FORMAT: i
    }, q = o.customLayerParameters;
    return q && Object.keys(q).forEach((L) => {
      L.toLowerCase() !== "styles" && (A[L] = q[L]);
    }), Object.keys(A).forEach((L) => l[L] = A[L]), Ge(o.url.split("?")[0], {
      query: l,
      responseType: h
    });
  }
...
class es extends Xi {
  ...
  // ----------- LAYER CONSTRUCTION AND INITIALIZAION -----------
  constructor(e, t) {
    super(e, t), this.dataFormat = Q.ESRI_FEATURE, this.layerFormat = fe.NOLAYER, this.drawState = le.NOT_VISUAL, this.attribs = new ts(), this.supportsFeatures = !0, this.mapLayer = !1, this.isFile = !1, this._visibility = e.state?.visibility ?? !0, this.expectedTime.draw = 0;
  }
  async onInitiate() {
    if (this.sourceJson) {
      ...
      this.fields = t.map((n, l) => {
        ...
        const p = this.$iApi.geo.layer.files.inferType(i[l]);
        return {
          name: c,
          alias: a,
          type: p,
          length: p === Le.STRING ? 256 : void 0
        };
      }), this.oidField = "rampOID", this.fields.push({ name: this.oidField, type: Le.OID }), e.fields.push(this.oidField), e.data.forEach((n, l) => n.push(l + 1)), this.$iApi.geo.attributes.applyFieldMetadata(this, this.origRampConfig.fieldMetadata), this.fieldList = "*";
      const o = {
        batchSize: -1,
  ...
  async reload() {
    this.$iApi.event.emit(x.LAYER_RELOAD_START, this), await this.terminate(), await this.initiate(), this.layerState !== B.ERROR && this.onLoad(), setTimeout(() => {
...
class Na extends es {
  ...
  serviceUrl;
  constructor(e, t) {
    super(e, t), this.layerType = S.DATATABLE, this.serviceUrl = e.url, this.filter = new zi(e.permanentFilteredQuery || "", e.initialFilteredQuery || "");
  }
  async onInitiate() {
  }
  onLoadActions() {
    const e = super.onLoadActions(), t = Date.now(), s = this.$iApi.geo.shared.parseUrlIndex(this.serviceUrl).index || 0, o = this.$iApi.geo.layer.loadLayerMetadata(this.serviceUrl).then((l) => {
      ...
      this.attribs.attLoader = new is(this.$iApi, a), this.attribs.quickCache = new ss(this.geomType);
    }), n = this.$iApi.geo.layer.loadFeatureCount(this.serviceUrl, this.getSqlFilter(ne.PERMANENT)).then((l) => {
...
class Fa extends J {
  ...
  async arcGisBatchLoad(e, t) {
    ...
    if (a > 0) {
      ...
      if (e.supportsLimit ? c = n.data.exceededTransferLimit : (e.batchSize === -1 && (e.batchSize = a), c = a >= e.batchSize), l = this.trimFeatureSetAttributes(l, e.fieldsToTrim ?? []), c) {
        ...
        const p = await this.arcGisBatchLoad(e, t);
        return t.loadAbortFlag ? [] : l.concat(p);
      } else
  ...
  async loadGraphicsAttributes(e, t) {
    ...
    const s = {
      features: e.sourceGraphics.map((o) => Ee(o).attributes).toArray(),
      oidIndex: {}
    };
    ...
    const i = e.sourceDataJson.fields, s = e.fieldsToTrim ?? [], n = {
      features: e.sourceDataJson.data.map((l) => {
        ...
        return l.forEach((c, p) => {
          a[i[p]] = typeof c == "string" && s.includes(i[p]) ? c.trim() : c;
        }), a;
      }),
      oidIndex: {}
    };
  ...
  async loadSingleFeature(e) {
    ...
    if (o.length > 0) {
      ...
      if (e.includeGeometry) {
        ...
        const a = As(l.geometry);
        n = this.$iApi.geo.geom.geomEsriToRamp(a);
      } else
        n = new Ue();
      return new ve(n, "", l.attributes);
    }
...
class si extends J {
  ...
  constructor(e, t) {
    super(e), this.aac = new xi(), this.details = t;
  }
  /**
  ...
  getAttribs() {
    return this.loadPromise || (this.aac = new xi(), this.loadPromise = this.loadPromiseGenerator()), this.loadPromise;
  }
  abortAttribLoad() {
...
class za extends ri {
  ...
  constructor(e, t, i = !1) {
    if (super(e, t, i), this.valField = this.cleanFieldName(e.field, t), e.classBreakInfos.forEach((s, o) => {
      const n = o === 0, l = new _i(this, s.minValue, s.maxValue, n);
...
class Va extends J {
  ...
  async symbolToSvg(e) {
    ...
    const o = Qe(s).size(this.CONTAINER_SIZE, this.CONTAINER_SIZE).viewbox(0, 0, this.CONTAINER_SIZE, this.CONTAINER_SIZE), n = {
      ...
      // @ts-ignore
      cross({ size: f }) {
        return o.path("M 0,10 L 20,10 M 10,0 L 10,20").size(f * i);
      },
      // @ts-ignore
      x({ size: f }) {
        return o.path("M 0,0 L 20,20 M 20,0 L 0,20").size(f * i);
      },
      // @ts-ignore
      triangle({ size: f }) {
        return o.path("M 20,20 L 10,0 0,20 Z").size(f * i);
      },
      // @ts-ignore
      diamond({ size: f }) {
        return o.path("M 20,10 L 10,0 0,10 10,20 Z").size(f * i);
      },
      // @ts-ignore
      square({ size: f }) {
        return o.path("M 0,0 20,0 20,20 0,20 Z").size(f * i);
      }
    }, l = {
      [ae.SOLID]: "none",
      // esriSLSSolid
      ...
      [ae.DOT]: "1.333,4",
      // esriSLSDot
      [ae.DASHDOT]: "5.333,4,1.333,4",
      // esriSLSDashDot
      [ae.LONGDASH]: "10.666,4",
      // esriSLSLongDash
      [ae.LONGDASHDOT]: "10.666,4,1.333,4",
      // esriSLSLongDashDot
      [ae.LONGDASHDOTDOT]: "10.666,4,1.333,4,1.333,4",
      // esriSLSLongDashDotDot
      [ae.SHORTDOT]: "1.333,1.333",
      // esriSLSShortDot
      [ae.SHORTDASH]: "5.333,1.333",
      // esriSLSShortDash
      [ae.SHORTDASHDOT]: "5.333,1.333,1.333,1.333",
      // esriSLSShortDashDot
      [ae.SHORTDASHDOTDOT]: "5.333,1.333,1.333,1.333,1.333,1.333"
      ...
      none: () => "transparent",
      // esriSFSNull
      horizontal: (f, h) => o.pattern(5, 5, (A) => A.line(0, 5 / 2, 5, 5 / 2)).stroke(h),
      vertical: (f, h) => o.pattern(5, 5, (A) => A.line(5 / 2, 0, 5 / 2, 5)).stroke(h),
      "forward-diagonal": (f, h) => o.pattern(5, 5, (A) => {
        A.line(0, 0, 5, 5).stroke(h), A.line(0, 0, 5, 5).move(0, 5).stroke(h), A.line(0, 0, 5, 5).move(5, 0).stroke(h);
      }),
      "backward-diagonal": (f, h) => o.pattern(5, 5, (A) => {
        A.line(5, 0, 0, 5).stroke(h), A.line(5, 0, 0, 5).move(5 / 2, 5 / 2).stroke(h), A.line(5, 0, 0, 5).move(-5 / 2, -5 / 2).stroke(h);
      }),
      cross: (f, h) => o.pattern(5, 5, (A) => {
        A.line(5 / 2, 0, 5 / 2, 5).stroke(h), A.line(0, 5 / 2, 5, 5 / 2).stroke(h);
      }),
      "diagonal-cross": (f, h) => o.pattern(7, 7, (A) => {
        A.line(0, 0, 7, 7).stroke(h), A.line(7, 0, 0, 7).stroke(h);
      })
    }, u = {
      "simple-marker"() {
        const f = v(e.color);
        e.outline = e.outline || c;
        const h = v(e.outline.color), w = d({
          color: h.colour,
          opacity: h.opacity,
        ...
        t.fitInto(A, t.CONTENT_SIZE);
      },
      "simple-line"() {
        const f = v(e.color), h = d({
          color: f.colour,
          opacity: f.opacity,
          width: e.width,
          linecap: "butt",
          // @ts-ignore
          dasharray: l[e.style]
        }), w = t.CONTENT_PADDING, A = t.CONTAINER_SIZE - t.CONTENT_PADDING;
        o.line(w, w, A, A).stroke(h);
      },
      ...
      "simple-fill"() {
        ...
        o.rect(t.CONTENT_SIZE, t.CONTENT_SIZE).center(t.CONTAINER_CENTER, t.CONTAINER_CENTER).fill(w).stroke(q);
      },
      text() {
        console.error("no support for feature service legend of text symbols");
      },
      "picture-fill"() {
        const f = e.imageData ? `data:${e.contentType};base64,${e.imageData}` : e.url, h = e.width * e.xscale, w = e.height * e.yscale;
        e.outline = e.outline || c;
        const A = v(e.outline.color), q = d({
          color: A.colour,
          opacity: A.opacity,
        ...
        return t.$iApi.geo.shared.convertImagetoDataURL(f).then(($) => {
          const W = o.pattern(
            h,
            w,
            (ue) => (
      ...
      "picture-marker"() {
        const f = e.source, h = f && f.imageData ? `data:${f.contentType};base64,${f.imageData}` : e.url;
        return t.$iApi.geo.shared.convertImagetoDataURL(h).then((A) => t.svgDrawImage(o, A)).then(({ image: A }) => {
          A.center(t.CONTAINER_CENTER, t.CONTAINER_CENTER).rotate(e.angle || 0), t.fitInto(A, t.CONTENT_IMAGE_SIZE);
        });
      }
    };
    try {
      return await Promise.resolve(u[e.type]()), document.body.removeChild(s), o.svg();
    } catch (f) {
      return console.error(f), this.generateBlankSymbology();
    }
    function d(f) {
  ...
  async getMapServerLegend(e) {
    ...
    const t = {
      query: { f: "json" }
    }, i = { layers: [] }, [s, o] = await je(Ge(`${e}/legend`, t));
...
class ja extends J {
  ...
  async geoJsonQuery(e) {
    ...
    return (await e.layer.esriLayer.queryFeatures(t)).features.map((s, o) => {
      let n;
      return t.returnGeometry ? n = this.$iApi.geo.geom.geomEsriToRamp(s.geometry, `queryResult${o}`) : n = new Ue(), new ve(n, "", s.attributes);
    });
  }
  /**
...
const Wa = /* @__PURE__ */ Object.assign({ "../fixtures/appbar/index.ts": () => import("./index-B269768D.js"), "../fixtures/areas-of-interest/index.ts": () => import("./index-DA2WeoEp.js"), "../fixtures/basemap/index.ts": () => import("./index-DXj34tJN.js"), "../fixtures/crosshairs/index.ts": () => import("./index-DXpjUnw6.js"), "../fixtures/details/index.ts": () => import("./index-tupGqicL.js"), "../fixtures/export-footnote/index.ts": () => import("./index-Bv1UqdpI.js"), "../fixtures/export-legend/index.ts": () => import("./index-BbSnhdhj.js"), "../fixtures/export-map/index.ts": () => import("./index-BnMg0T36.js"), "../fixtures/export-northarrow/index.ts": () => import("./index-Dp9DpP1L.js"), "../fixtures/export-scalebar/index.ts": () => import("./index-DoQxosRu.js"), "../fixtures/export-timestamp/index.ts": () => import("./index-BtjB36hC.js"), "../fixtures/export-title/index.ts": () => import("./index-B7PchGq7.js"), "../fixtures/export/index.ts": () => import("./index-DXQih65x.js"), "../fixtures/extentguard/index.ts": () => import("./index-C21r0MHc.js"), "../fixtures/gazebo/index.ts": () => import("./index-D8U8i4bN.js"), "../fixtures/geosearch/index.ts": () => import("./index-DeK178XH.js"), "../fixtures/grid/index.ts": () => import("./index-intqQo8-.js"), "../fixtures/help/index.ts": () => import("./index-DnbM6lor.js"), "../fixtures/hilight/index.ts": () => import("./index-CZtQgKHl.js"), "../fixtures/layer-reorder/index.ts": () => import("./index-CR_T7p7g.js"), "../fixtures/legend/index.ts": () => import("./index-B1U_I3gW.js"), "../fixtures/mapnav/index.ts": () => import("./index-BzhTOxIq.js"), "../fixtures/metadata/index.ts": () => import("./index-BC2MHYLH.js"), "../fixtures/northarrow/index.ts": () => import("./index-BR4QptoL.js"), "../fixtures/overviewmap/index.ts": () => import("./index-CtNTUIut.js"), "../fixtures/panguard/index.ts": () => import("./index-BCDIACM1.js"), "../fixtures/scrollguard/index.ts": () => import("./index-WDVhy61v.js"), "../fixtures/settings/index.ts": () => import("./index-Dv03MjO7.js"), "../fixtures/snowman/index.ts": () => import("./index-BGf1eDRa.js"), "../fixtures/wizard/index.ts": () => import("./index-DZ6CU4V9.js") });
class Ha extends J {
  /**
   ...
   */
  exists(e) {
    return e in me(this.$vApp.$pinia).items;
  }
  /**
  ...
  async add(e, t) {
    let i;
    if (e in me(this.$vApp.$pinia).items)
      return this.get(e);
    if (t) {
    ...
    return me(this.$vApp.$pinia).addFixture(i), this.$iApi.event.emit(x.FIXTURE_ADDED, i), this.$iApi.geo.map.created && i.initialized?.(), i;
  }
  /**
  ...
  remove(e) {
    ...
    return me(this.$vApp.$pinia).removeFixture(t), this.$iApi.event.emit(x.FIXTURE_REMOVED, t), t;
  }
  ...
  get(e) {
    ...
    const i = t.map((s) => {
      const o = me(this.$vApp.$pinia).items[s];
      if (o)
        return o;
    });
   ...
   */
  isLoaded(e) {
    const t = me(this.$vApp.$pinia), i = Array.isArray(e) ? e : [e];
    i.forEach((o) => {
...
class oi extends J {
   ...
   */
  get config() {
    return ce(this.$vApp.$pinia).config.fixtures[this.id];
  }
  /**
  ...
  handlePanelTeleports(e) {
    if (this.config?.panelTeleport) {
      const t = qe(this.$vApp.$pinia), i = !!this.config.panelTeleport.target;
      e.forEach((s) => {
...
class Ya extends J {
  ...
  close(e) {
    ...
    ), this.$iApi.event.emit(x.PANEL_CLOSED, t), t);
  }
  /**
...
const Qa = /* @__PURE__ */ ke(Za, [["render", Ka], ["__scopeId", "data-v-a3c61802"]]), Xa = /* @__PURE__ */ Object.assign({ "../fixtures/areas-of-interest/screen.vue": () => import("./screen-B8B3x5u3.js"), "../fixtures/basemap/screen.vue": () => import("./screen-DgUOrlqi.js"), "../fixtures/export/screen.vue": () => import("./screen-WU4P5XsA.js"), "../fixtures/geosearch/screen.vue": () => import("./screen-jS2YOrmG.js"), "../fixtures/grid/screen.vue": () => import("./screen-toqiCvVT.js"), "../fixtures/help/screen.vue": () => import("./screen-BA-uP5vM.js"), "../fixtures/layer-reorder/screen.vue": () => import("./screen-p7dSnQ86.js"), "../fixtures/legend/screen.vue": () => import("./screen-BBwXi736.js"), "../fixtures/metadata/screen.vue": () => import("./screen-CM2hPg8U.js"), "../fixtures/settings/screen.vue": () => import("./screen-B7hwRyKc.js"), "../fixtures/wizard/screen.vue": () => import("./screen-DB9LYNPw.js") });
class wt extends J {
  /**
   * ID of this panel.
   *
  ...
  registerScreen(e) {
    ...
    if (Ks(t) || Zs(t))
      ...
      const o = new Promise((n, l) => {
        s.then((a) => {
          this.loadedScreens.push(e), n(Qs(a) ? a.default : a);
        }), s.catch((a) => l(a));
      });
      i = ms({
  ...
  return r.controls && r.controls.length > 0 && (e.controls = lt(r.controls, t), r.controls.includes("visibility") && e.controls.push("visibilityButton"), (r.controls.length !== 1 || r.controls[0] !== "visibility") && console.warn(
    ...
    if (i.layerId)
      ...
      typeof i.collapse < "u" && console.warn(
        ...
        o.layerId ? s.children.push(Ii(o)) : s.children.push(Jt(o));
      }), e.children.push(s);
    } else
...
var et = { major: "4", minor: "10", patch: "0-beta", timestamp: "Tue Dec 10 11:47:41 2024 -0500", hash: "2432876e7241e0c274e26ce06b4a0b8fe9dae83f" };
console.info(
...
const lc = (r, e, t) => new Qn(r, e, t), nt = new Js();
export {
  ee as $,
  zr as A,
  ea as B,
