import { defineComponent as R, resolveDirective as b, withDirectives as y, openBlock as s, createElementBlock as l, normalizeClass as L, unref as m, createElementVNode as d, inject as T, ref as E, computed as j, onMounted as q, onBeforeUnmount as P, toDisplayString as h, createBlock as V, withCtx as w, createCommentVNode as S, createVNode as I, Fragment as U, renderList as F, createTextVNode as M, toRaw as J, resolveComponent as K } from "vue";
import { _ as Q, G as k, Y as W } from "./main-BHVuCadI.js";
import "pinia";
...
}, pe = ["content", "aria-label"], me = ["content", "aria-label"], ue = { class: "flex-1 mx-10" }, ve = /* @__PURE__ */ R({
  __name: "layer-component",
  setup(u) {
    const o = T("iApi"), { t: c } = $(), i = E([]), f = E([]), _ = E([]), D = E([]), z = j(() => o.animate), g = () => {
      let e = {};
      i.value.forEach((r) => {
        e[r.id] = r.isExpanded;
      }), i.value = [];
      ...
      let t = i.value.find((a) => a.id === e.id);
    ...
    return q(() => {
      ...
      return s(), l("div", null, [
        i.value.length === 0 ? y((s(), l("div", re, [
          d("span", oe, h(m(c)("layer-reorder.nolayers")), 1)
        ])), [
          [a]
        ]) : (s(), V(m(X), {
          key: 1,
            ...
            n.isLoaded ? y((s(), l("div", {
              ...
              d("div", ne, [
                n.supportsSublayers ? y((s(), l("button", {
                  ...
                  content: m(c)(`layer-reorder.${n.isExpanded ? "collapse" : "expand"}`),
                  "aria-label": m(c)(`layer-reorder.${n.isExpanded ? "collapse" : "expand"}`)
                }, [
              ...
              content: m(c)("layer-reorder.loading"),
              "aria-label": m(c)("layer-reorder.loading"),
              "truncate-trigger": ""
            }, [
              t[4] || (t[4] = d("div", { class: "animate-spin spinner h-20 w-20 px-5" }, null, -1)),
              d("div", ue, [
                d("span", null, h(m(c)("layer-reorder.loading")), 1)
              ])
            ], 8, me)), [
              [v, {
                placement: "top-start",
