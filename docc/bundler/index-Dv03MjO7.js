...
import "tiny-emitter";
import { F as a, b as n } from "./main-BHVuCadI.js";
...
class l extends a {
   ...
   */
  toggleSettings(t, e) {
    const i = this.$iApi.panel.get("settings");
    if (!i.isOpen && e !== !1)
      ...
      const r = i.route.props.layer.uid;
      e !== !0 && i.close(), r !== t.uid && setTimeout(() => {
        this.$iApi.panel.open({
          id: "settings",
          props: { layer: t }
        });
...
class lt extends l {
    ...
    this.$iApi.panel.register(
      {
        settings: {
          screens: {
            "settings-screen-content": () => o(import("./screen-B7hwRyKc.js"))
          },
          style: {
            width: "350px"
          },
  ...
  removed() {
    this.$iApi.fixture.exists("appbar") && n(this.$vApp.$pinia).removeButton("settings"), this.$iApi.panel.remove("settings");
  }
}
export {
  lt as default
