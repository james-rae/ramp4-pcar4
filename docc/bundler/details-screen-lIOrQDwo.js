...
import { T as Ee } from "./toggle-switch-control-DFLLg8C3.js";
import "pinia";
import "screenfull";
...
const Ie = {
  ...
  key: 1,
  class: "w-32 h-32"
}, Se = { class: "symbologyIcon" }, je = ["innerHTML"], Be = ["src"], Ne = { class: "badge z-50 rounded-full text-white absolute h-10 w-10 p-8 inline-flex items-center justify-center" }, Oe = {
  key: 0,
  class: "px-5"
}, Ae = {
  key: 1,
  ...
  setup(v) {
    ...
    return ae(() => {
      ...
      h("div", Ne, [
        v.result.loaded ? (t(), a("div", Oe, S(v.result.items.length), 1)) : j("", !0)
      ])
    ])) : (t(), a("div", Ae, m[0] || (m[0] = [
  ...
  setup(v, { emit: b }) {
    ...
    }, _ = b, u = v, r = w(""), d = w([]), n = w(!1), e = w(!1), o = (g) => c.getLayerByUid(g), E = (g) => {
      r.value = g, _("selection-changed", g), n.value = !1;
    }, B = () => {
      e.value || setTimeout(() => {
        n.value = e.value;
      }, 500), e.value = !0;
    ...
    return Q(() => {
      ...
      d.value.forEach((g) => g()), m.value?.removeEventListener("blur", $), m.value?.removeEventListener("keyup", f);
    }), (g, N) => {
      const O = q("focus-item"), z = q("focus-list"), C = q("tippy");
      return A((t(), a("div", {
  ...
  setup(v) {
    ...
    return (r, d) => (t(), a("div", null, [
      (t(!0), a(Z, null, K($(), (n, e, o) => (t(), a("div", {
        ...
        h("span", Ze, S(n.alias), 1),
        d[0] || (d[0] = h("span", { class: "flex-auto" }, null, -1)),
        h("span", {
          class: "inline",
  ...
  setup(v) {
    const b = ne(), i = v, c = X("iApi"), m = w([]), $ = ee(), { t: f } = V(), _ = w(""), u = w("none"), r = w(), d = () => b.getLayerByUid(i.uid), n = M(() => $.properties), e = M(() => $.defaultTemplates), o = M(() => d()?.supportsFeatures ?? !1), E = M(() => d()?.mapLayer ?? !1), B = M(() => {
      const s = d()?.nameField;
  ...
  setup(v) {
    const b = w(), i = () => {
    ...
    }, m = X("iApi"), $ = ee(), f = ne(), _ = v, { t: u } = V(), r = w(!1), d = w(m.fixture.get("details")), n = w(!0), e = w(!1), o = w(0), E = w(20), B = w([]), D = w([]), p = M(() => $.activeGreedy), I = M(() => $.properties), g = M(() => o.value + E.value), N = () => f.getLayerByUid(_.uid), O = () => _.results.find((l) => l.uid === _.uid), z = M(() => O()?.loaded ?? !1), C = M(() => O()?.requestTime), s = M(
      ...
      if (n.value && z.value && l.length > 0 && oe.value)
        if (e.value)
          d.value.hilightDetailsItems(l.slice(o.value, g.value), _.uid);
        else {
          const x = l[o.value];
    ...
    return ae(() => {
      ...
      D.value.forEach((l) => l()), B.value.forEach((l) => m.event.off(l)), b.value?.removeEventListener("blur", i), b.value?.removeEventListener("keyup", c);
    }), (l, x) => {
      ...
      return z.value && p.value === 0 ? (t(), a("div", {
        ...
        oe.value ? (t(), a("div", mt, [
          h("label", pt, S(L(u)("details.togglehilight.title")), 1),
          se(Ee, {
            config: {
              value: n.value,
              disabled: !1
        ...
        s.value ? (t(), a("div", ft, [
          h("div", yt, [
            e.value ? j("", !0) : (t(), a("button", {
              ...
              onClick: x[0] || (x[0] = (Y) => ge())
            }, S(L(u)("details.item.see.list")), 9, gt)),
            h("div", {
              ...
              h("span", _t, S(e.value ? L(u)("details.items.range", [
                o.value + 1,
                Math.min(g.value, T().length),
                T().length
              ...
              A((t(), a("button", {
                ...
                disabled: !e.value && o.value === T().length - 1 || e.value && g.value >= T().length
              }, x[4] || (x[4] = [
                h("svg", {
                  height: "24",
                  width: "24",
        ...
        r.value ? (t(), a("div", kt, [
          T().length > 0 ? (t(), a("div", xt, [
            e.value ? A((t(), a("div", {
              ...
              (t(!0), a(Z, null, K(T().slice(o.value, g.value), (Y, ue) => A((t(), a("button", {
...
}), Et = /* @__PURE__ */ ie(Mt, [["__scopeId", "data-v-4c39ec75"]]), It = { class: "relative h-full" }, Ct = { class: "detailsContentSection overflow-y-auto h-full" }, zt = /* @__PURE__ */ F({
  ...
  setup(v) {
    const { t: b } = V(), i = X("iApi"), c = ee(), m = w([]), $ = w([]), f = w([]), _ = w(!1), u = w(""), r = M(() => c.activeGreedy), d = M(() => c.payload), n = M(() => c.properties), e = (p) => {
      ...
      p !== void 0 && (c.activeGreedy = p.length === 0 ? 0 : p[0].requestTime, f.value = p, B(p));
    }, B = (p) => {
      if (u.value) {
        const I = o(u.value);
        I ? I.loading.then(() => {
...
}), zs = /* @__PURE__ */ ie(zt, [["__scopeId", "data-v-2a8a1e06"]]);
export {
  zs as default
};
