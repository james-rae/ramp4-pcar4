import { defineComponent as x, ref as p, reactive as f, watch as S, onBeforeUnmount as V, openBlock as g, createElementBlock as w, createElementVNode as n, createTextVNode as I, toDisplayString as u, createVNode as b, unref as r, withKeys as T, withModifiers as N, markRaw as E, createBlock as B, resolveDynamicComponent as Y, inject as D, onMounted as Z, resolveComponent as G, withCtx as O } from "vue";
import { _ as q, G as h, Z as z } from "./main-BHVuCadI.js";
import "pinia";
...
import "await-to-js";
import "svg.js";
import P from "vue-slider-component";
import "vue-slider-component/theme/default.css";
import { T as U } from "./toggle-switch-control-DFLLg8C3.js";
const K = { class: "rv-label" }, F = ["innerHTML"], J = { class: "flex flex-row pl-30" }, Q = /* @__PURE__ */ x({
  ...
  setup(i) {
    const o = i, s = p(o.config.value), t = p(!!o.config.disabled), d = f([]);
    return d.push(
      // watch the config for changes to the opacity value
      S(
        () => o.config,
        (a) => {
          s.value = a.value, t.value = !!a.disabled;
        },
        { deep: !0 }
      )
    ), V(() => {
      ...
      n("div", J, [
        ...
        I(" " + u(i.config.value) + "% ", 1)
      ])
    ]));
  }
}), W = /* @__PURE__ */ q(Q, [["__scopeId", "data-v-9f0c5af5"]]), X = { class: "rv-label text-sm pt-10" }, ee = { class: "flex flex-row" }, te = ["value", "disabled"], ie = { class: "text-xs pt-10 text-gray-600 mb-20" }, oe = /* @__PURE__ */ x({
  ...
  setup(i) {
    const { t: o } = R(), s = i, t = p(!!s.config.disabled), d = f([]);
    return d.push(
      // watch the config for changes to the opacity value
      S(
        () => s.config,
      ...
      n("div", ie, u(r(o)("settings.label.refreshOff")), 1)
    ]));
  }
}), ne = /* @__PURE__ */ q(oe, [["__scopeId", "data-v-89fc1190"]]), se = {
...
}), le = { key: 0 }, ae = { class: "p-8 font-bold break-words mb-8 bg-gray-100" }, re = { class: "flex flex-col justify-center" }, ce = { class: "rv-subheader" }, de = { class: "flex flex-col justify-center" }, pe = { class: "rv-subheader" }, ue = {
  key: 1,
  class: "p-5"
}, ve = /* @__PURE__ */ x({
  __name: "screen",
  ...
  setup(i) {
    const { t: o } = R(), s = D("iApi"), t = i, d = p(""), a = p(t.layer.uid), c = p(t.layer.visibility), v = p(t.layer.opacity * 100), L = p(t.layer.identify), _ = p(!1), y = f([]), H = f([]);
    _.value = t.layer !== void 0 && !t.layer.isRemoved, H.push(
      ...
      M(), y.push(
        s.event.on(h.LAYER_VISIBILITYCHANGE, (e) => {
          a.value === e.layer.uid && (c.value = e.visibility);
        })
      ), y.push(
        s.event.on(h.LAYER_OPACITYCHANGE, (e) => {
          a.value === e.layer.uid && (v.value = Math.round(e.opacity * 100));
        })
      ), y.push(
        s.event.on(h.LAYER_RELOAD_END, (e) => {
          e.loadPromise().then(() => {
            a.value === e.uid && M();
          });
        })
      ), y.push(
        s.event.on(h.LAYER_REMOVE, (e) => {
          a.value === e.uid && t.panel.close();
        })
      );
    }), V(() => {
      y.forEach((e) => s.event.off(e)), H.forEach((e) => e());
    });
    const C = (e) => {
      const l = s.fixture.get("settings");
      ...
      return m && (m.controls || m.disabledControls) ? s.geo.shared.controlAvailable(e, m) : t.layer.controlAvailable(e);
    }, $ = (e) => {
    ...
    return (e, l) => {
      const m = G("panel-screen");
      return g(), B(m, { panel: i.panel }, {
        header: O(() => [
          I(u(r(o)("settings.title")), 1)
        ]),
        content: O(() => [
          _.value ? (g(), w("div", le, [
            n("div", ae, u(d.value), 1),
            n("div", re, [
              n("span", ce, u(r(o)("settings.label.display")), 1),
              l[0] || (l[0] = n("div", { class: "rv-settings-divider" }, null, -1)),
              b(A, {
                class: "rv-subsection",
                type: "toggle",
                icon: "visibility",
                onToggled: $,
                name: r(o)("settings.label.visibility"),
                config: {
                  value: c.value,
                  disabled: !C(r(z).Visibility)
                },
                ariaLabel: r(o)("settings.label.visibility")
              }, null, 8, ["name", "config", "ariaLabel"]),
              l[1] || (l[1] = n("div", { class: "rv-settings-divider" }, null, -1)),
              b(A, {
                class: "rv-subsection",
                type: "slider",
                name: r(o)("settings.label.opacity"),
                icon: "opacity",
                config: {
                  onChange: j,
                  value: v.value,
                ...
                ariaLabel: r(o)("settings.label.opacity")
              }, null, 8, ["name", "config", "ariaLabel"]),
              l[2] || (l[2] = n("div", { class: "rv-settings-divider" }, null, -1))
            ]),
            n("div", de, [
              n("span", pe, u(r(o)("settings.label.data")), 1),
              l[3] || (l[3] = n("div", { class: "rv-settings-divider" }, null, -1)),
              b(A, {
                class: "rv-subsection",
                type: "toggle",
                name: r(o)("settings.label.identify"),
                icon: "location",
                onToggled: k,
                config: {
                  value: L.value,
                ...
                ariaLabel: r(o)("settings.label.identify")
              }, null, 8, ["name", "config", "ariaLabel"]),
              l[4] || (l[4] = n("div", { class: "rv-settings-divider" }, null, -1))
            ])
          ])) : (g(), w("div", ue, [
            n("span", null, u(r(o)("settings.label.no.layer")), 1)
          ]))
        ]),
        _: 1
      }, 8, ["panel"]);
...
}), mt = /* @__PURE__ */ q(ve, [["__scopeId", "data-v-72efbdd5"]]);
export {
  mt as default
};
