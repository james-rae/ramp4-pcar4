import { defineComponent as D, inject as ie, resolveComponent as Ve, openBlock as E, createBlock as Ye, unref as y, withCtx as ne, createElementVNode as o, createElementBlock as M, Fragment as Ze, renderList as Qe, createTextVNode as H, toDisplayString as T, createCommentVNode as R, ref as C, onBeforeMount as ve, withDirectives as F, normalizeClass as z, withModifiers as V, withKeys as P, vModelText as oe, vModelSelect as Lt, onMounted as X, nextTick as Le, onBeforeUnmount as J, resolveDirective as U, computed as O, useTemplateRef as _t, watch as De, vShow as re, createVNode as _e, getCurrentInstance as Et, markRaw as Ie } from "vue";
import "tiny-emitter";
import { a as fe, _ as ge, G as Q, K as Mt, M as kt, L as At, N as Ft, O as Xe, Q as se, i as Je, V as je, W as Ce, X as Tt } from "./main-BHVuCadI.js";
...
import { T as St, C as Dt } from "./table-state-manager-CQv-OGS1.js";
import { AG_GRID_LOCALE_EN as It, AG_GRID_LOCALE_FR as Gt } from "@ag-grid-community/locale";
import { GridApi as Vt, ColumnApi as Pt } from "ag-grid-community";
const Ht = ["onClick"], Nt = { class: "md-icon-small inline" }, Bt = {
  key: 0,
  height: "18",
  width: "18",
  viewBox: "0 0 24 24",
  ...
  setup(_) {
    ...
    return (a, l) => {
      ...
      return E(), Ye(r, {
        ...
        default: ne(() => [
          (E(!0), M(Ze, null, Qe(_.columnDefs.filter(
            (i) => i.headerName && i.headerName.length > 0 && !(!y(n).ui.exposeOids && _.systemCols?.has(i.headerName)) && !(!y(n).ui.exposeMeasurements && (_.systemCols?.has(i.headerName) || _.systemCols?.has(i.field)))
          ), (i) => (E(), M("a", {
            key: i.headerName,
            onClick: (d) => {
...
}), Ot = ".ag-root", Ut = ".ag-header-viewport .ag-header-row";
class We {
  element;
  agGrid;
  headerRows;
   ...
   */
  constructor(n, e, a) {
    this.element = n, this.agGridApi = e, this.agColumnApi = a, this.agGrid = this.element.querySelector(Ot), this.headerRows = Array.prototype.slice.call(
...
const qt = { class: "h-full flex items-center justify-center" }, Wt = ["placeholder", "aria-label", "disabled"], Yt = ["placeholder", "aria-label", "disabled"], Zt = {
  methods: {
  ...
  setup(_) {
    ...
    return ve(() => {
      ...
      h[10] || (h[10] = o("span", { class: "w-12" }, null, -1)),
      F(o("input", {
        ...
        style: { width: "45%" },
        type: "number",
        "onUpdate:modelValue": h[5] || (h[5] = (L) => r.value = L),
        onInput: h[6] || (h[6] = (L) => v()),
...
}), Xt = /* @__PURE__ */ ge(Qt, [["__scopeId", "data-v-6583eadd"]]), Jt = { class: "h-full flex items-center justify-center" }, el = ["placeholder", "aria-label", "disabled"], tl = {
  methods: {
    onParentModelChanged() {
    }
  }
  ...
  setup(_) {
    ...
    return ve(() => {
      ...
      F(o("input", {
        ...
        onKeyup: v[4] || (v[4] = P((b) => {
          y(n).mobileView && b.target.blur();
        }, ["enter"])),
        enterkeyhint: "done",
        placeholder: y(e)("grid.filters.column.label.text", [_.params.column.colDef.headerName]),
        "aria-label": y(e)("grid.filters.column.label.text", [_.params.column.colDef.headerName]),
        disabled: r.value
      }, null, 42, el), [
        [oe, l.value]
      ])
...
}), al = { class: "h-full flex items-center justify-center" }, rl = ["aria-label", "disabled"], sl = ["value"], nl = {
  methods: {
    onParentModelChanged() {
    }
  }
  ...
  setup(_) {
    ...
    return ve(() => {
      ...
      F(o("select", {
        ...
        (E(!0), M(Ze, null, Qe(a.value, (v) => (E(), M("option", {
          value: v,
          key: v
        }, T(v), 9, sl))), 128))
      ], 42, rl), [
...
}), il = /* @__PURE__ */ ge(ol, [["__scopeId", "data-v-f1c7aa13"]]), ul = { class: "h-full flex items-center justify-center w-full" }, dl = ["placeholder", "aria-label", "disabled"], pl = ["placeholder", "aria-label", "disabled"], cl = {
  methods: {
    onParentModelChanged() {
    }
  }
...
}), vl = /* @__PURE__ */ ge(ml, [["__scopeId", "data-v-9db9be0a"]]), fl = ["content", "disabled"], gl = /* @__PURE__ */ D({
  __name: "clear-filter",
  props: ["params"],
  setup(_) {
...
}, _l = ["content", "aria-label", "disabled"], El = ["content", "aria-label", "disabled"], Ml = /* @__PURE__ */ D({
  __name: "custom-header",
  props: ["params"],
  setup(_) {
    const { t: n } = N(), e = _, a = C(), l = C(0), r = C(!1), i = C(!1), d = C(!1), v = C(null), b = () => {
      const c = v.value.getAllDisplayedColumns(), k = c.indexOf(e.params.column);
      i.value = k > 3 && !c[k - 1].colDef.isStatic, d.value = k < c.length - 1 && !c[k + 1].colDef.isStatic;
    }, x = () => {
      const c = v.value.getAllDisplayedColumns(), k = v.value.getAllGridColumns(), A = k.indexOf(c[c.indexOf(e.params.column) - 1]);
      i.value && (v.value.moveColumn(e.params.column, A), e.params.api.ensureColumnVisible(k[A]), a.value?.closest(".ag-header-row")?.querySelector(`[col-id="${e.params.column.colId}"]`)?.querySelector(".move-left")?.focus());
    }, h = () => {
      const c = v.value.getAllDisplayedColumns(), k = v.value.getAllGridColumns(), A = k.indexOf(c[c.indexOf(e.params.column) + 1]);
      d.value && (v.value.moveColumn(e.params.column, A), e.params.api.ensureColumnVisible(k[A]));
    }, L = (c) => {
    ...
    return X(() => {
      ...
      return E(), M("div", {
        ...
        r.value ? (E(), M("div", wl, [
          _.params.enableSorting && l.value === 0 ? (E(), M("span", xl)) : R("", !0),
          _.params.enableSorting && l.value === 1 ? (E(), M("span", Cl, k[3] || (k[3] = [
          ...
          _.params.enableSorting && l.value === 2 ? (E(), M("span", Ll, k[4] || (k[4] = [
            o("div", { class: "md-icon-small" }, [
              o("svg", {
                height: "24",
                width: "24"
...
}), kl = ["content"], Al = /* @__PURE__ */ D({
  __name: "details-button-renderer",
  props: ["params"],
  setup(_) {
    const n = _, { t: e } = N(), a = ie("iApi"), l = C(), r = async () => {
      const i = n.params.data, d = i.rvUid, v = a.geo.layer.getLayer(d), b = v.oidField, h = n.params.layerCols[v.id].find(
        (c) => c.origAttr === b
      )?.mappedAttr || b, L = await v.getGraphic(i[h], {
        getAttribs: !0
      });
      a.event.emit(
        Q.DETAILS_TOGGLE,
  ...
  stroke: "red",
  class: "w-20 h-20"
}, Sl = ["innerHTML"], Dl = /* @__PURE__ */ D({
  __name: "zoom-button-renderer",
  props: ["params"],
  setup(_) {
    const n = C("none"), e = _, a = ie("iApi"), l = kt(), r = C(), { t: i } = N(), d = O(() => {
      ...
      const h = e.params.layerCols[x.id].find((k) => k.origAttr === x.oidField), L = e.params.data[h ? h.mappedAttr ?? h.origAttr : x.oidField], c = () => {
        const k = { getGeom: !0 };
        x.getGraphic(L, k).then((A) => {
      ...
      x.layerType === At.FEATURE && x.geomType !== Ft.POINT ? x.getGraphicExtent(L).then((k) => {
        a.geo.map.zoomMapTo(k), b("zoomed"), a.updateAlert(a.$i18n.t("grid.cells.alert.zoom")), e.params.isTeleport && a.scrollToInstance();
      }).catch(() => {
        c();
      }) : c();
    }, b = (x) => {
    ...
    return X(() => {
      ...
      const L = U("tippy");
      return d.value ? F((E(), M("button", {
        key: 0,
        type: "button",
        class: "flex items-center justify-center w-40 h-36",
        content: y(i)(`grid.cells.zoom${n.value === "none" ? "" : `.${n.value}`}`),
        onClick: v,
        tabindex: "-1",
        ref_key: "button",
        ref: r
      }, [
        n.value === "zooming" ? (E(), M("div", Tl)) : n.value === "zoomed" ? (E(), M("svg", $l, h[0] || (h[0] = [
          o("path", {
            "stroke-linecap": "round",
            "stroke-linejoin": "round",
            d: "M4.5 12.75l6 6 9-13.5"
          }, null, -1)
        ]))) : n.value === "error" ? (E(), M("svg", Rl, h[1] || (h[1] = [
          o("path", {
            "stroke-linecap": "round",
            "stroke-linejoin": "round",
...
}), Il = ["content"], Gl = ["innerHTML"], Vl = /* @__PURE__ */ D({
  __name: "custom-button-renderer",
  props: ["params"],
  setup(_) {
    const n = _, e = ie("iApi"), a = C(), l = O(() => {
      let i = Object.assign({}, n.params.data);
      const d = e.geo.layer.getLayer(i.rvUid), v = n.params.config.displayOn;
      return !(!d || v === "geo" && !d.mapLayer || v === "data" && d.mapLayer);
    }), r = () => {
      let i = Object.assign({}, n.params.data);
      const d = e.geo.layer.getLayer(i.rvUid), v = n.params.layerCols[d.id].find((x) => x.origAttr === d.oidField), b = v.mappedAttr ? i[v.mappedAttr] : i[v.origAttr];
...
}), Pl = ["name", "content", "innerHTML"], Hl = ["content"], Ge = /* @__PURE__ */ D({
  __name: "cell-renderer",
  props: ["params"],
  setup(_) {
    const n = fe(), e = ie("iApi"), { t: a } = N(), l = C(), r = C(), i = C(!1), d = _, v = O(() => n.mobileView), b = () => {
      r.value?.textContent && (i.value = !0, l.value?._tippy.show(), navigator.clipboard.writeText(r.value?.textContent), setTimeout(() => {
        i.value = !1;
      }, 2e3));
    }, x = O(() => d.params.type === "number" ? d.params.value == null ? "" : e.ui.formatNumber(d.params.value) : d.params.type === "date" ? d.params.value == null ? "" : new Date(d.params.value).toISOString().slice(0, 10) : d.params.type === "string" ? !d.params.value || /<a[^>]*>[^<]+<\/a>/g.test(d.params.value) ? d.params.value : $t(d.params.value, {
      target: "_blank",
      validate: {
        url: (L) => /^https?:\/\//.test(L)
        // only links that begin with a protocol will be hyperlinked
      }
    }) : ""), h = O(() => /<a[^>]*>[^<]+<\/a>/g.test(d.params.value) || /(http(s)?:\/\/.*)/g.test(d.params.value));
    return X(() => {
      ...
      return E(), M("div", null, [
        ...
        r.value?.textContent ? F((E(), M("div", {
          key: 0,
          ref_key: "copyTooltip",
          ref: l,
          content: y(a)(`grid.label.${i.value ? "copied" : "copy"}`)
        }, null, 8, Hl)), [
          [A, {
...
}), Nl = { class: "pl-8" }, Bl = { class: "flex flex-col justify-center items-center h-full" }, zl = { class: "flex flex-row" }, Ol = { class: "font-bold text-2xl" }, Ul = { class: "mt-20 text-xl" }, Kl = { class: "my-20" }, jl = { class: "text-sm" }, ql = ["aria-label"], Wl = { class: "flex flex-wrap gap-y-8 items-center pl-8 pb-8" }, Yl = { class: "flex flex-1 flex-col max-w-full mr-8" }, Zl = { class: "w-full font-bold" }, Ql = { class: "w-full text-sm" }, Xl = { key: 0 }, Jl = { class: "flex flex-1 grow-[1.4] items-center max-w-full" }, ea = { class: "flex flex-1 min-w-0 items-center pb-4 mr-8" }, ta = ["aria-label", "placeholder"], la = { class: "-ml-30" }, aa = {
  key: 0,
  xmlns: "http://www.w3.org/2000/svg",
  fit: "",
  preserveAspectRatio: "xMidYMid meet",
...
}, ra = { class: "pb-2 flex ml-auto justify-end" }, sa = ["content", "aria-label"], na = ["aria-label"], oa = { class: "md-icon-small inline items-start" }, ia = {
  key: 0,
  height: "18",
  width: "18",
  viewBox: "0 0 24 24",
  class: "inline float-right"
}, ua = ["aria-label"], da = { class: "md-icon-small inline items-start" }, pa = {
  key: 0,
  height: "18",
  width: "18",
  viewBox: "0 0 24 24",
  ...
  viewBox: "0 0 24 24",
  class: "inline float-right"
}, ba = ["aria-label"], wa = ["content"], xa = /* @__PURE__ */ D({
  ...
  setup(_) {
    const n = [se.OID, se.DOUBLE, se.SINGLE, se.INTEGER], e = ie("iApi"), a = Je(), l = fe(), r = O(() => l.mobileView), i = C(!r.value), d = C(), v = _t("gridContainer"), { t: b, locale: x } = N(), h = () => Et()?.proxy?.$forceUpdate(), L = _, c = C({
      id: "dummy",
      layerIds: [],
      state: new St(),
      fieldMap: {}
    }), k = C(!0), A = C(new Vt()), K = C(), ee = C(), j = C(!1), te = C(!1), ue = C([]), Ee = C(0), W = C([]), he = C([]), Me = C(""), I = C(new Pt()), le = C([]), de = C([]), ye = C("OBJECTID"), ke = C(void 0), et = We.onCellKeyPress, q = C({ firstRow: 0, lastRow: 0, visibleRows: 0 }), be = C({}), tt = e.geo.layer.getLayer(L.gridId), pe = C({}), lt = C(a.grids[L.gridId].layerIds), G = O(() => a.grids[L.gridId] ? a.grids[L.gridId].layerIds.map((s) => e.geo.layer.getLayer(s)).filter((s) => s !== void 0) : []), Ae = C(/* @__PURE__ */ new Set()), we = C([]), at = (s) => {
      A.value = s.api, I.value = s.columnApi, Me.value = c.value.state.title || tt?.name || L.gridId, Te(), de.value.length > 0 && I.value.autoSizeAllColumns();
      const t = () => {
      ...
      t(), A.value.addEventListener("rowDataChanged", t), W.value.push(
        ...
        e.event.on(Q.LAYER_REMOVE, (m) => {
          lt.value.includes(m.id) && G.value.length !== 0 && Oe();
        })
      ), Y();
    }, rt = () => {
      I.value.autoSizeAllColumns(), ke.value = new We(
        d.value,
        A.value,
        I.value
      );
      ...
      let s = K.value.api.getColumnDefs();
      ...
      A.value && !j.value && (c.value.state.searchFilter !== "" && Fe(), c.value.state.applyToMap && $e(), Le(() => {
        let s = I.value.getAllDisplayedColumns();
      ...
      i.value = !i.value;
      let s = I.value.getAllDisplayedColumns();
      I.value.setColumnsPinned(s.slice(1, 3), i.value ? "left" : "");
    }, ut = () => {
      ...
      A.value.exportDataAsCsv({
        ...
        processCellCallback: (t) => {
          let m = t.column.getColDef().cellRendererParams;
      ...
      if (s.field === "rvInteractive") {
        const u = c.value.state.controls;
        let p = {
          sortable: !1,
          pinned: r.value ? "" : "left",
          filter: !1,
        ...
        if (u.includes("details") && t.push(p), Ct.value) {
          let f = {
            sortable: !1,
            pinned: r.value ? "" : "left",
            filter: !1,
    ...
    }, ft = () => !Object.values(be.value).every((s) => s === void 0), gt = (s) => {
      const t = be.value[s.data.rvUid];
      return t === void 0 || t.includes(s.data[ye.value]);
    }, Y = async () => {
      const s = new Tt(), t = we.value.slice().map((u) => u.getPromise());
      ...
      const t = A.value.getFilterModel();
      let m = [];
      if (Object.keys(t).forEach((u) => {
        const p = Re(s, u);
        p ? m.push(bt(p.origAttr, t[u])) : m.push("1=2");
      ...
      switch (t.filterType) {
        ...
        case "text": {
          ...
          if (m !== "") {
            ...
            let g = `UPPER(${s}) LIKE '${f.replace(/\*/g, "%").toUpperCase()}%'`;
      ...
      return u.forEach((w) => {
        let S = !0, g = "";
        for (let $ of m) {
          const ce = new RegExp(`.*${$.split(" ").join(".*").toUpperCase()}`), Ue = `%${$.replace(/\*/g, "%").split(" ").join("%").toUpperCase()}`;
          let ae = !1;
          for (let Se of p) {
            const me = Se.getColId(), xe = Re(s, Se.getColId())?.origAttr, Ke = Se.getColDef();
            if (w.data[me] === void 0)
              ae = !1;
            else if (Ke.filter === "agTextColumnFilter") {
              const Z = w.data[me] === null ? null : w.data[me].toString();
              if (Z !== null && ce.test(Z.toUpperCase())) {
                g ? g = g.concat(" AND ", `(UPPER(${xe}) LIKE '${Ue}%')`) : g = g.concat("(", `(UPPER(${xe}) LIKE '${Ue}%')`), f.includes(g + ")") ? ae = !1 : ae = !0;
                break;
              }
            } else if (Ke.filter === "agNumberColumnFilter") {
              const Z = w.data[me] === null ? null : w.data[me];
              if (Z !== null && ce.test(Z)) {
                g ? g = g.concat(" AND ", `(${xe} = ${Z})`) : g = g.concat("(", `(${xe} = ${Z})`), f.includes(g + ")") ? ae = !1 : ae = !0;
                break;
              }
            }
          }
    ...
    ), Re = (s, t) => pe.value[s].find((m) => (m.mappedAttr ?? m.origAttr) === t), Oe = () => {
      const s = G.value.filter(
        (t) => t && t.supportsFeatures && t.isLoaded
      );
      s.length === 0 && Be(), Ee.value = s.reduce((t, { featureCount: m }) => t + m, 0), ue.value = new Array(G.value.length).fill(0), s.forEach((t, m) => ue.value[m] += t.downloadedAttributes()), s.forEach((t, m) => {
        he.value.push(
          De(
        ...
        Promise.all(t).then((m) => {
          ...
          m.forEach((p, f) => {
            ...
            p.columns.forEach((g) => {
              ...
              p.rows.map((g) => {
                if (c.value.fieldMap)
                  for (const [$, ce] of Object.entries(c.value.fieldMap))
                    g[$] !== void 0 && g[ce] === void 0 && (g[ce] = g[$], delete g[$]);
                return g;
              })
            );
            ...
            ), u.oidField = c.value.fieldMap && c.value.fieldMap[p.oidField] ? c.value.fieldMap[p.oidField] : p.oidField, pe.value[S] = w;
          }), ye.value = u.oidField, ["rvRowIndex", "rvInteractive", "rvSymbol", ...u.columns].forEach((p) => {
            c.value.state?.columns[p.data] === void 0 && (c.value.state.columns[p.data] = new Dt({
              field: p.data,
              title: p.title
            })), (!e.ui.exposeOids || !e.ui.exposeMeasurements) && Ae.value.has(p.data) && (c.value.state.columns[p.data].visible = !1);
            let f = c.value.state?.columns[p.data], w = {
            ...
            p === "rvRowIndex" || p === "rvSymbol" || p === "rvInteractive" ? vt(w, le.value, c.value.state) : (n.indexOf(S.type) > -1 ? (ct(w, c.value.state), w.filter = "agNumberColumnFilter", w.autoHeight = !0, w.cellRenderer = f.template === "" ? Ge : e.component(f.template), w.cellRendererParams = {
              type: "number"
            }) : S.type === se.DATE ? (dt(w, c.value.state), w.filter = "agDateColumnFilter", w.autoHeight = !0, w.minWidth = 400, w.cellRenderer = f.template === "" ? Ge : e.component(f.template), w.cellRendererParams = {
              type: "date"
            }) : S.type === se.STRING && (w.isSelector ? pt(w, u.rows, c.value.state) : mt(w, c.value.state), w.filter = "agTextColumnFilter", w.autoHeight = !0, w.cellRenderer = f.template === "" ? Ge : e.component(f.template), w.cellRendererParams = {
              type: "string"
            }), le.value.push(w));
          }), de.value = Ie(u.rows), le.value = Ie(le.value), Te(), j.value = !1;
        }).catch((m) => {
    ...
    return X(() => {
      v.value?.addEventListener("focus", () => {
        v.value._tippy.show();
      }), v.value?.addEventListener("blur", () => {
        v.value._tippy.hide();
      });
    }), ve(() => {
      c.value = a.grids[L.gridId], j.value = !0, h(), q.value = {
        firstRow: 0,
        lastRow: 0,
        visibleRows: 0
      }, ee.value = {
        agColumnHeader: Ml,
        numberFloatingFilter: Xt,
        textFloatingFilter: ll,
        selectorFloatingFilter: il,
        dateFloatingFilter: vl,
        clearFloatingFilter: gl
      }, K.value = {
        ...
        tabToNextHeader: Kt,
        onModelUpdated: qe(300, () => I.value.autoSizeAllColumns())
      }, Oe(), B.value === "partial" && e.notify.show(je.WARNING, e.$i18n.t("layer.filterwarning")), he.value.push(
        De(x, () => {
      ...
      ze(), W.value.forEach((s) => e.event.off(s)), he.value.forEach((s) => s()), ke.value?.removeAccessibilityListeners(), ke.value?.removeScrollListeners(), v.value?.removeEventListener("focus", () => {
        v.value._tippy.show();
      }), v.value?.removeEventListener("blur", () => {
        v.value._tippy.hide();
      });
    }), (s, t) => {
      ...
      return E(), M("div", {
        ...
        F(o("div", null, [
          o("p", Nl, T(y(b)("grid.splash.error")), 1)
        ], 512), [
          [re, te.value]
        ]),
        F(o("div", Bl, [
          o("div", zl, [
            o("span", Ol, T(ue.value.reduce((f, w) => f + w, 0)), 1),
            t[12] || (t[12] = o("svg", {
            ...
            o("span", Ul, T(Ee.value), 1)
          ]),
          o("div", Kl, [
            o("span", jl, T(ue.value.reduce((f, w) => f + w, 0) < Ee.value ? y(b)("grid.splash.loading") : y(b)("grid.splash.building")), 1)
          ]),
          o("div", null, [
            o("button", {
              type: "button",
              ...
              "aria-label": y(b)("grid.splash.cancel")
            }, T(y(b)("grid.splash.cancel")), 9, ql)
          ])
        ], 512), [
          [re, j.value && !te.value]
        ]),
        F(o("div", Wl, [
          o("div", Yl, [
            ...
            F((E(), M("div", Ql, [
              H(T(y(b)("grid.filters.label.info", {
                range: q.value.visibleRows !== 0 ? `${q.value.firstRow} - ${q.value.lastRow}` : "0",
                total: q.value.visibleRows
              })) + " ", 1),
              q.value.visibleRows !== de.value.length ? (E(), M("span", Xl, T(y(b)("grid.filters.label.filtered", {
                max: de.value.length
              })), 1)) : R("", !0)
            ])), [
              [u]
          ...
          o("div", Jl, [
            F(o("div", ea, [
              F(o("input", {
                ...
                onKeyup: t[2] || (t[2] = P((f) => {
                  y(l).mobileView && f?.target?.blur();
                }, ["enter"])),
                enterkeyhint: "done",
                "onUpdate:modelValue": t[3] || (t[3] = (f) => c.value.state.searchFilter = f),
                class: "rv-global-search rv-input pr-32 min-w-0",
                "aria-invalid": "false",
                "aria-label": y(b)("grid.filters.label.global"),
                placeholder: y(b)("grid.filters.label.global")
              }, null, 40, ta), [
                [oe, c.value.state.searchFilter]
              ]),
              o("div", la, [
                c.value.state.searchFilter.length < 3 ? (E(), M("svg", aa, t[13] || (t[13] = [
            ...
            o("div", ra, [
              ...
              F((E(), M("button", {
                ...
                onClick: t[6] || (t[6] = (f) => st()),
                content: y(b)("grid.clearAll"),
                "aria-label": y(b)("grid.clearAll")
              }, t[15] || (t[15] = [
                o("svg", {
                  xmlns: "http://www.w3.org/2000/svg",
                  height: "24px",
              ...
              _e(m, {
                class: "h-40 w-40",
                position: "bottom-end",
                tooltip: y(b)("panels.controls.optionsMenu"),
                centered: !1
              }, {
                header: ne(() => t[16] || (t[16] = [
                  o("svg", {
                ...
                default: ne(() => [
                  o("a", {
                    ...
                    onClick: t[7] || (t[7] = (f) => B.value !== "disabled" && ht()),
                    role: "button",
                    "aria-label": y(b)("grid.label.filters.apply")
                  }, [
                    o("div", oa, [
                      t[18] || (t[18] = o("svg", {
                        xmlns: "http://www.w3.org/2000/svg",
                      ...
                      H(" " + T(y(b)("grid.label.filters.apply")) + " ", 1),
                      B.value !== "disabled" && c.value.state.applyToMap ? (E(), M("svg", ia, t[17] || (t[17] = [
                        o("g", { id: "done" }, [
                          o("path", { d: "M9 16.2L4.8 12l-1.4 1.4L9 19 21 7l-1.4-1.4L9 16.2z" })
                        ], -1)
                      ]))) : R("", !0)
                  ...
                  o("a", {
                    ...
                    onClick: t[8] || (t[8] = (f) => ot()),
                    role: "button",
                    "aria-label": y(b)("grid.label.filters.show")
                  }, [
                    o("div", da, [
                      t[20] || (t[20] = o("svg", {
                        xmlns: "http://www.w3.org/2000/svg",
                      ...
                      H(" " + T(y(b)("grid.label.filters.show")) + " ", 1),
                      c.value.state.colFilter ? (E(), M("svg", pa, t[19] || (t[19] = [
                        o("g", { id: "done" }, [
                          o("path", { d: "M9 16.2L4.8 12l-1.4 1.4L9 19 21 7l-1.4-1.4L9 16.2z" })
                        ], -1)
                      ]))) : R("", !0)
                  ...
                  o("a", {
                    ...
                    onClick: t[9] || (t[9] = (f) => B.value !== "disabled" && nt()),
                    role: "button",
                    "aria-label": y(b)("grid.filters.label.extent")
                  }, [
                    o("div", ma, [
                      t[22] || (t[22] = o("svg", {
                        xmlns: "http://www.w3.org/2000/svg",
                      ...
                      H(" " + T(y(b)("grid.filters.label.extent")) + " ", 1),
                      B.value !== "disabled" && c.value.state.filterByExtent ? (E(), M("svg", va, t[21] || (t[21] = [
                        o("g", { id: "done" }, [
                          o("path", { d: "M9 16.2L4.8 12l-1.4 1.4L9 19 21 7l-1.4-1.4L9 16.2z" })
                        ], -1)
                      ]))) : R("", !0)
                  ...
                  o("a", {
                    ...
                    onClick: t[10] || (t[10] = (f) => it()),
                    role: "button",
                    "aria-label": y(b)("grid.label.pinColumns")
                  }, [
                    i.value ? (E(), M("svg", ga, t[23] || (t[23] = [
                    ...
                    ]))) : i.value ? R("", !0) : (E(), M("svg", ha, t[24] || (t[24] = [
                    ...
                    H(" " + T(y(b)("grid.label.pinColumns")) + " ", 1),
                    i.value ? (E(), M("svg", ya, t[25] || (t[25] = [
                      o("g", { id: "done" }, [
                        o("path", { d: "M9 16.2L4.8 12l-1.4 1.4L9 19 21 7l-1.4-1.4L9 16.2z" })
                      ], -1)
                    ]))) : R("", !0)
                  ...
                  o("a", {
                    href: "javascript:;",
                    class: z(["flex leading-snug items-center w-256", { hover: "text-black" }]),
                    onClick: t[11] || (t[11] = (f) => ut()),
                    role: "button",
                    "aria-label": y(b)("grid.label.export")
                  }, [
                    t[26] || (t[26] = o("svg", {
                      xmlns: "http://www.w3.org/2000/svg",
                      viewBox: "0 0 24 24",
        ...
        k.value ? F((E(), M("div", {
          key: 0,
          content: y(b)("grid.cells.controls"),
          ...
          _e(y(Rt), {
            ...
            onGridReady: at,
            onKeydown: xt,
            onFirstDataRendered: rt,
            onCellKeyPress: y(et),
            doesExternalFilterPass: gt,
            isExternalFilterPresent: ft
...
}), Ca = /* @__PURE__ */ ge(xa, [["__scopeId", "data-v-c791a890"]]), La = /* @__PURE__ */ D({
  __name: "screen",
  props: {
    panel: {
      type: Xe,
  ...
  setup(_) {
    const n = Je(), { t: e } = N(), a = O(() => n.currentId);
    return (l, r) => {
      const i = Ve("panel-screen");
      return E(), Ye(i, { panel: _.panel }, {
        header: ne(() => [
          H(T(y(e)("grid.title")), 1)
        ]),
        content: ne(() => [
          _e(Ca, {
            class: "rv-grid",
...
}), Ar = /* @__PURE__ */ ge(La, [["__scopeId", "data-v-904e67ef"]]);
export {
  Ar as default
};
