...
import { _ as C, d as A, F as j, G } from "./main-B5curx7T.js";
...
const D = /* @__PURE__ */ C(q, [["render", U]]), W = /* @__PURE__ */ $({
  ...
  setup(_) {
    const i = k("iApi"), { t } = z(), e = Y(), o = [
      {
        type: "point",
        icon: h(f(() => import("./point-icon-7SxKp0W1.js")))
      },
      {
        type: "polyline",
        icon: h(f(() => import("./polyline-icon-DyaQtFVX.js")))
      },
      {
        type: "polygon",
        icon: h(f(() => import("./polygon-icon-BacL5LVG.js")))
      },
      {
        type: "circle",
        icon: h(f(() => import("./circle-icon-SQEfM1rw.js")))
      },
      {
        type: "rectangle",
        icon: h(f(() => import("./rectangle-icon-BpjYZIEG.js")))
      }
    ], d = x(() => {
      const a = o.filter((s) => e.supportedTypes.some((c) => c.type === s.type));
      return a.push({
        type: "edit",
        icon: h(f(() => import("./edit-icon-BjH2z3DZ.js")))
      }), a;
    }), n = (a) => {
