...
class ie extends rt {
  ...
  rawArray;
  constructor(e, t, i, s) {
    super(e, t.sr || i), s ? this.rawArray = t.slice() : this.rawArray = ie.parseXY(t);
  }
...
class H extends rt {
  ...
  rawMax;
  constructor(e, t, i, s) {
    super(e, t.sr || s), this.rawMin = ie.parseXY(t), this.rawMax = ie.parseXY(i);
  }
...
const rr = ["data-cy"], Ki = /* @__PURE__ */ N({
    ...
    return (n, c) => {
      ...
      return b(), w("div", {
        ...
        fe(Ni, {
          ...
          default: ue(() => [
            U((b(), te(ys(r.panel.route.screen), gs({ class: "h-full" }, r.panel.route.props, { panel: r.panel }), null, 16, ["panel"])), [
              [u]
            ])
          ]),
          _: 1
  ...
  function O() {
    ...
    !L.includes(r.value) && !s.value) {
      let Ie;
      for (let mi = 0; mi < L.length - 1 && E < (r.value.width || X) + we; mi++)
        Ie = L.shift(), E += Ie.width || X;
      E >= (r.value.width || X) ? L.unshift(r.value) : e.value || (Ie = L.shift(), L.unshift(r.value));
  ...
  setup(r) {
    const e = Je(), t = Xi(), i = be(), { t: s } = se(), a = Se("iApi"), o = D(() => e.scale), l = D(() => e.attribution), n = D(() => e.coords), c = D(() => e.langtoggle), u = D(() => i.config.map), { keyChain: p, lastAction: d, chainState: g, namespaces: h, activeNamespace: m } = hs(t), A = D(() => {
      ...
      if (g.value === "awaitNamespace") {
        const J = `H - ${s("keyboardnav.chain.help")}`, E = Object.keys(h.value).map((X) => {
        ...
        E && E.keys?.length && (q = `[${E.keys.map((X) => {
          const we = `keyboardnav.key.${J}.${X.key}`, je = s(we), Ie = je === we ? X.key : je;
          return `${X.key} - ${Ie}`;
        }).join(", ")}]`);
      }
      return {
        ...
        r.header ? (b(), w("header", qa, [
          ...
          y("div", {
            ...
            r.panel.teleport ? B("", !0) : (b(), w("div", Wa, [
              ...
              r.panel.controls && r.panel.controls.expand ? (b(), te(_, {
                key: 2,
                onClick: C[4] || (C[4] = (L) => r.panel.expand()),
                active: r.panel.expanded
              }, null, 8, ["active"])) : B("", !0)
            ])),
            r.panel.button && u.value?.includes(r.panel.id) ? (b(), te(M, {
              key: 1,
      ...
      if (this._visibility = e ?? !this.visibility, !this.exclusive)
        ...
        if (this._lastVisible && (!(this._lastVisible instanceof We) || this._lastVisible.layerControlAvailable(ee.Visibility)))
          ...
          const i = this.children.find(
            (s) => !(s instanceof We) || s.layerControlAvailable(ee.Visibility)
          );
...
class Rn extends re {
  ...
  getLayerControls(e) {
    ...
    return t.supportsFeatures || s.push(ee.Datatable), t.extent === void 0 && s.push(ee.BoundaryZoom), (t.config?.metadata || (t.isSublayer ? t.parentLayer?.config?.metadata : {}) || {}).url || s.push(ee.Metadata), !t.mapLayer && !t.config.controls?.includes(ee.Settings) && s.push(ee.Settings), s.forEach((o) => {
...
class ui extends at {
  ...
  setSqlFilter(e, t) {
    ...
    this._lastFilterUpdate = s;
    const a = new Q();
    return setTimeout(() => {
      this._lastFilterUpdate === s && this.applySqlFilter(), a.resolveMe();
    }, 25), a.getPromise();
  }
  applySqlFilter(e = []) {
    throw new Error(
...
class Un extends ui {
  ...
  set visibility(e) {
    if (this.layerExists) {
      ...
      this.canModifyLayer && !e && (console.log("blocking ON"), t = this.setSqlFilter("lolfilter", "1=2")), t.then(() => {
        console.log("setting viz: " + e), this.esriSubLayer.visible = e, this.canModifyLayer && e && (console.log("blocking OFF"), this.setSqlFilter("lolfilter", ""));
      });
    } else
      this.noLayerErr();
  }
...
const ol = /* @__PURE__ */ Object.assign({ "../fixtures/appbar/index.ts": () => import("./index-DZWgiXYZ.js"), "../fixtures/areas-of-interest/index.ts": () => import("./index-DkDf8Ak3.js"), "../fixtures/basemap/index.ts": () => import("./index-U1nPT4Vv.js"), "../fixtures/crosshairs/index.ts": () => import("./index-CJVCcUCF.js"), "../fixtures/details/index.ts": () => import("./index-DvYvs4vs.js"), "../fixtures/draw/index.ts": () => import("./index-CswFGhB5.js"), "../fixtures/export-footnote/index.ts": () => import("./index-CmNUB30F.js"), "../fixtures/export-legend/index.ts": () => import("./index-DC0J_imK.js"), "../fixtures/export-map/index.ts": () => import("./index-Y1QV6R3O.js"), "../fixtures/export-northarrow/index.ts": () => import("./index-DBLx1D6k.js"), "../fixtures/export-scalebar/index.ts": () => import("./index-CfjMLm4g.js"), "../fixtures/export-timestamp/index.ts": () => import("./index-BsrkMo8Y.js"), "../fixtures/export-title/index.ts": () => import("./index-DYg1kCnZ.js"), "../fixtures/export/index.ts": () => import("./index-CaOUXRO9.js"), "../fixtures/extentguard/index.ts": () => import("./index-BwrlXaTF.js"), "../fixtures/gazebo/index.ts": () => import("./index-D069RE-K.js"), "../fixtures/geosearch/index.ts": () => import("./index-Dz3B9tVk.js"), "../fixtures/grid/index.ts": () => import("./index-CJy7DxoY.js"), "../fixtures/help/index.ts": () => import("./index-4MyEYEcO.js"), "../fixtures/hilight/index.ts": () => import("./index-CuPe3XiS.js"), "../fixtures/keyboardnav/index.ts": () => import("./index-D4ll9ysM.js"), "../fixtures/layer-reorder/index.ts": () => import("./index-tmvG9f4h.js"), "../fixtures/legend/index.ts": () => import("./index-ntDhefLR.js"), "../fixtures/mapnav/index.ts": () => import("./index-D5VwgRNy.js"), "../fixtures/metadata/index.ts": () => import("./index-CUYBeEGO.js"), "../fixtures/northarrow/index.ts": () => import("./index-Bw2kO3HG.js"), "../fixtures/overviewmap/index.ts": () => import("./index-CWAwiDpX.js"), "../fixtures/panguard/index.ts": () => import("./index-CuJTODMH.js"), "../fixtures/scrollguard/index.ts": () => import("./index-Bl6-15RV.js"), "../fixtures/settings/index.ts": () => import("./index-B3J_uWnb.js"), "../fixtures/snowman/index.ts": () => import("./index-UJTMJsoY.js"), "../fixtures/swipe/index.ts": () => import("./index-BGZJvvdE.js"), "../fixtures/wizard/index.ts": () => import("./index-DfCK1YZg.js") });
class nl extends re {
  /**
...
const dl = /* @__PURE__ */ qe(ul, [["render", pl], ["__scopeId", "data-v-a3c61802"]]), hl = /* @__PURE__ */ Object.assign({ "../fixtures/areas-of-interest/screen.vue": () => import("./screen-Bf8zEFEg.js"), "../fixtures/basemap/screen.vue": () => import("./screen-DSlhSEfj.js"), "../fixtures/export/screen.vue": () => import("./screen-Z7QRgoUf.js"), "../fixtures/geosearch/screen.vue": () => import("./screen-Cg2oXMWg.js"), "../fixtures/grid/screen.vue": () => import("./screen-Kkz4vZDj.js"), "../fixtures/help/screen.vue": () => import("./screen-BtIY5K9V.js"), "../fixtures/layer-reorder/screen.vue": () => import("./screen-DUHJ98aH.js"), "../fixtures/legend/screen.vue": () => import("./screen-D-Sfxmrr.js"), "../fixtures/metadata/screen.vue": () => import("./screen-tbfUMAFY.js"), "../fixtures/settings/screen.vue": () => import("./screen-CkC1kgfc.js"), "../fixtures/wizard/screen.vue": () => import("./screen-DYkZBWok.js") });
class Ct extends re {
  /**
   * ID of this panel.
   *
...
var pt = { major: "4", minor: "16", patch: "0-beta", timestamp: "Thu Feb 5 15:28:40 2026 -0500", hash: "a8b268fea056fac1a5d9bdc4c5e59b71a64b2ac4" };
console.info(
