...
import { _ as H, d as L, F as X, G as ee } from "./main-qn3PFFL7.js";
...
const G = /* @__PURE__ */ H(ne, [["render", ae]]), se = /* @__PURE__ */ T({
  ...
  setup(h) {
    ...
    const p = [
      {
        type: "point",
        icon: g(_(() => import("./point-icon-DiY_g-Bm.js")))
      },
      {
        type: "polyline",
        icon: g(_(() => import("./polyline-icon-0O_VL5ob.js")))
      },
      {
        type: "polygon",
        icon: g(_(() => import("./polygon-icon-zRJ9tiAI.js")))
      },
      {
        type: "circle",
        icon: g(_(() => import("./circle-icon-Bs0gnAjd.js")))
      },
      {
        type: "rectangle",
        icon: g(_(() => import("./rectangle-icon-BZNQuBuI.js")))
      }
    ], a = A(() => {
      const s = p.filter((u) => e.supportedTypes.some((x) => x.type === u.type));
      return s.push({
        type: "edit",
        icon: g(_(() => import("./edit-icon-CAYrHJxT.js")))
      }), s;
    }), n = (s) => {
