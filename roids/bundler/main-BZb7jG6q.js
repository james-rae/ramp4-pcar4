...
var nt = /* @__PURE__ */ function(e) {
	...
	static fromESRI(e) {
		...
		if (e.type === "simple-marker") {
			let n = t;
			n.style = e.style, n.colour = e.color.toRgba(), n.size = e.size, n.path = e.path, n.outline = Et.fromESRI(e.outline).toOptions();
		} else {
			let n = t;
	...
	geomGeoJsonToRamp(e, t) {
		switch (e.type) {
			...
			case H.LINESTRING: return _t.fromGeoJSON(e, t);
			case H.POLYGON: return bt.fromGeoJSON(e, t);
			case H.MULTIPOINT: return gt.fromGeoJSON(e, t);
			case H.MULTILINESTRING: return vt.fromGeoJSON(e, t);
			case H.MULTIPOLYGON: return xt.fromGeoJSON(e, t);
			default: throw Error(`Encountered unhandled geometry type ${e.type}`);
		}
	}
	geomRampToGeoJson(e) {
	...
	async projectGeoJson(e, t, n) {
		let r, i;
		if (r = t ? this.normalizeProj(t) : J.parseGeoJsonCrs(e.crs), i = n ? this.normalizeProj(n) : Ft, i === r) return e;
...
var Ht = class {
	...
	addDefaultEvents(e) {
		return (!Array.isArray(e) || e.length === 0) && (e = Object.values(Yt)), e.map((e) => this.defaultHandlerFactory(e));
	}
...
function nn() {
	let e = document.documentElement.getAttribute("lang") || $t;
	return en.includes(e) || (e = $t), Be({
		legacy: !1,
		locale: e,
		fallbackLocale: $t,
		globalInjection: !0,
...
var rn = x("maptip", () => {
	...
	__name: "esri-map",
	setup(e) {
		let t = rn(), n = ye("iApi"), r = S(() => t.maptipPoint), i = S(() => t.maptipInstance), a = S(() => t.content), o = Ee([]), s = j(!1);
		o.push(Fe(r, () => {
			if (r.value) {
	...
	constructor(e) {
		this.resizeObserver = new ResizeObserver((t) => {
			t.length && window.requestAnimationFrame(() => {
				t.forEach((t) => {
					let n = t.target.dataset.breakpoints, r = n ? JSON.parse(n) : e ?? on;
...
}), dn = /*#__PURE__*/ ne(/* @__PURE__ */ D({
	__name: "panel-stack",
	setup(e) {
		Me((e) => ({ v3d36ee4c: i.value }));
		let t = un(), n = ye("iApi"), r = j(), i = S(() => t.opacity), a = S(() => t.mobileView);
		we(() => {
		...
		return (e, t) => (A(), C(fe, {
			...
			default: I(() => [(A(!0), T(le, null, Oe(o(F(n).screenSize), (e) => (A(), C(ln, {
				key: `${e.id}`,
				panel: e
			}, null, 8, ["panel"]))), 128))]),
			_: 1
...
}), [["__scopeId", "data-v-717e4bd7"]]), fn = ["content", "aria-label"], pn = /* @__PURE__ */ D({
	...
	function a(e) {
		if (t.value.includes(e)) {
			...
			e instanceof xn && l(e), n > -1 && t.value.splice(n, 1);
		}
	}
	function o(e) {
		n.value[e.id] = e;
...
}), hn = { class: "h-full flex flex-col" }, gn = { class: "w-full flex mb-6" }, _n = ["content", "aria-label"], vn = /* @__PURE__ */ D({
	__name: "screen",
	props: { panel: {
		type: Object,
		required: !0
	...
	constructor(e) {
		super(e), this.$iApi.panel.register({
			id: "notifications",
			config: {
				screens: { "notifications-screen": O(vn) },
				alertName: "notifications.title"
			}
		}), this.notificationStore = mn(this.$vApp.$pinia);
	}
	show(e, t) {
	...
	notificationStore = mn(this.$vApp.$pinia);
	id;
	message;
	type;
	messageList = [];
...
}, Sn = ["content"], Cn = { class: "flex items-center text-left" }, wn = { class: "select-text cursor-text" }, Tn = ["content", "aria-label"], En = {
	key: 0,
	class: "text-left"
}, Dn = /* @__PURE__ */ D({
	...
	setup(e, { emit: t }) {
		...
		return (t, i) => {
			...
			return L((A(), T("li", {
				...
				E("span", null, [me(P(o[e.notification.type]) + " ", 1), E("span", wn, P(e.notification.message), 1)]),
				...
				L((A(), T("button", {
					...
					"fill-rule": "evenodd"
				}, [E("path", { d: "M11.17,37.16H94.65a8.4,8.4,0,0,1,2,.16,5.93,5.93,0,0,1,2.88,1.56,5.43,5.43,0,0,1,1.64,3.34,7.65,7.65,0,0,1-.06,1.44L94,117.31v0l0,.13,0,.28v0a7.06,7.06,0,0,1-.2.9v0l0,.06v0a5.89,5.89,0,0,1-5.47,4.07H17.32a6.17,6.17,0,0,1-1.25-.19,6.17,6.17,0,0,1-1.16-.48h0a6.18,6.18,0,0,1-3.08-4.88l-7-73.49a7.69,7.69,0,0,1-.06-1.66,5.37,5.37,0,0,1,1.63-3.29,6,6,0,0,1,3-1.58,8.94,8.94,0,0,1,1.79-.13ZM5.65,8.8H37.12V6h0a2.44,2.44,0,0,1,0-.27,6,6,0,0,1,1.76-4h0A6,6,0,0,1,43.09,0H62.46l.3,0a6,6,0,0,1,5.7,6V6h0V8.8h32l.39,0a4.7,4.7,0,0,1,4.31,4.43c0,.18,0,.32,0,.5v9.86a2.59,2.59,0,0,1-2.59,2.59H2.59A2.59,2.59,0,0,1,0,23.62V13.53H0a1.56,1.56,0,0,1,0-.31v0A4.72,4.72,0,0,1,3.88,8.88,10.4,10.4,0,0,1,5.65,8.8Zm42.1,52.7a4.77,4.77,0,0,1,9.49,0v37a4.77,4.77,0,0,1-9.49,0v-37Zm23.73-.2a4.58,4.58,0,0,1,5-4.06,4.47,4.47,0,0,1,4.51,4.46l-2,37a4.57,4.57,0,0,1-5,4.06,4.47,4.47,0,0,1-4.51-4.46l2-37ZM25,61.7a4.46,4.46,0,0,1,4.5-4.46,4.58,4.58,0,0,1,5,4.06l2,37a4.47,4.47,0,0,1-4.51,4.46,4.57,4.57,0,0,1-5-4.06l-2-37Z" })], -1)]], 8, Tn)), [[c, {
					theme: "ramp4",
					animation: "scale"
				}]])
			]), e.notification.messageList && a.value ? (A(), T("div", En, [(A(!0), T(le, null, Oe(e.notification.messageList, (t, n) => (A(), T("p", { key: e.notification.id + t + n }, P(t), 1))), 128))])) : w("", !0)], 10, Sn)), [[c, {
				onShow: s,
				theme: "ramp4",
				animation: "scale"
			}]]);
	...
	setup(e) {
		...
		return (e, t) => {
			...
			}, [(A(!0), T(le, null, Oe(c.value, (e, t) => (A(), T(le, { key: e.id }, [t > 0 ? (A(), T("div", kn)) : w("", !0), L(he(Dn, {
				ref_for: !0,
...
}), Mn = { class: "flex items-center" }, Nn = ["aria-label"], Pn = {
	key: 0,
	class: "number rounded-full w-18 text-white"
}, Fn = { class: "notification-dropdown pointer-events-auto bg-white rounded text-center text-black w-500 h-256 flex flex-col p-0" }, In = { class: "pb-8 border-b border-gray-600" }, Ln = { class: "absolute flex right-3 top-3" }, Rn = ["content", "aria-label"], zn = /*#__PURE__*/ ne(/* @__PURE__ */ D({
	...
	setup(e) {
		...
		return (e, t) => {
			...
			return A(), C(pn, {
				...
				header: I(() => [E("div", Mn, [(A(), T("svg", {
					class: "fill-current w-24 h-24",
					xmlns: "http://www.w3.org/2000/svg",
					viewBox: "0 0 24 24",
					"aria-label": F(n)("notifications.open")
				}, [...t[0] ||= [E("path", { d: "M12 22c1.1 0 2-.9 2-2h-4c0 1.1.89 2 2 2zm6-6v-5c0-3.07-1.64-5.64-4.5-6.32V4c0-.83-.67-1.5-1.5-1.5s-1.5.67-1.5 1.5v.68C7.63 5.36 6 7.92 6 11v5l-2 2v1h16v-1l-2-2z" }, null, -1)]], 8, Nn)), r.value && r.value > 0 ? (A(), T("span", Pn, P(r.value), 1)) : w("", !0)])]),
				default: I((e) => [E("div", Fn, [E("div", null, [E("h4", In, P(F(n)("notifications.title")), 1), E("div", Ln, [L((A(), T("button", {
					type: "button",
					onClick: i,
					...
					animation: "scale",
					appendTo: "parent"
				}]]), he(a, { onClick: e.close }, null, 8, ["onClick"])])]), he(jn, { class: "overflow-y-auto h-230" })])]),
				_: 1
			}, 8, ["tooltip"]);
		};
	}
}), [["__scopeId", "data-v-28078ee6"]]), Bn = { class: "flex" }, Vn = ["aria-label"], Hn = { class: "about-ramp-dropdown pointer-events-auto bg-white rounded w-256 h-50" }, Un = ["aria-label", "content"], Wn = { class: "pb-8 pt-1 border-b border-gray-600 mb-10" }, Gn = { class: "absolute right-5 top-5" }, Kn = { class: "select-text" }, qn = { class: "font-bold cursor-text" }, Jn = { class: "text-sm cursor-text" }, Yn = { class: "font-bold cursor-text" }, Xn = { class: "ml-5 cursor-text" }, Zn = { class: "mt-5" }, Qn = ["href"], $n = /*#__PURE__*/ ne(/* @__PURE__ */ D({
	...
	setup(e) {
		let { t } = R(), n = ye("iApi"), r = () => {
			n.reload();
		}, i = S(() => `${Ms.major}.${Ms.minor}.${Ms.patch}`), a = S(() => Ms.hash.slice(0, 9)), o = S(() => {
			...
			return L((A(), C(l, {
				...
				default: I((e) => [E("div", Hn, [E("div", null, [
					L((A(), T("button", {
						...
						xmlns: "http://www.w3.org/2000/svg",
						viewBox: "0 0 24 24"
					}, [E("path", { d: "M17.65 6.35C16.2 4.9 14.21 4 12 4c-4.42 0-7.99 3.58-7.99 8s3.57 8 7.99 8c3.73 0 6.84-2.55 7.73-6h-2.08c-.82 2.33-3.04 4-5.65 4-3.31 0-6-2.69-6-6s2.69-6 6-6c1.66 0 3.14.69 4.22 1.78L13 11h7V4l-2.35 2.35z" })], -1)]], 8, Un)), [[u, {
						placement: "bottom-start",
						theme: "ramp4",
						animation: "scale"
					}]]),
					E("h4", Wn, P(F(t)("ramp.about")), 1),
					E("div", Gn, [he(c, { onClick: e.close }, null, 8, ["onClick"])]),
					E("div", Kn, [
						E("div", null, [E("span", qn, P(i.value), 1), E("span", Jn, " [" + P(a.value) + "] ", 1)]),
						E("div", null, [E("span", Yn, P(o.value[0]), 1), E("span", Xn, P(o.value[1]), 1)]),
...
}), [["__scopeId", "data-v-966796d3"]]), er = "__HELP__", tr = x("keyboardnav", () => {
	...
	return re;
}), nr = { class: "map-caption absolute bottom-0 h-29 sm:h-38 flex justify-end pointer-events-auto cursor-default select-none text-gray-200 bg-black-75 left-0 right-0 py-2 sm:py-6" }, rr = {
	key: 0,
	...
	__name: "map-caption",
	setup(e) {
		let t = Gt(), n = tr(), r = v(), { t: i } = R(), a = ye("iApi"), o = S(() => t.scale), s = S(() => t.attribution), c = S(() => t.coords), l = S(() => t.langtoggle), u = S(() => r.config.map), { keyChain: d, lastAction: f, chainState: p, namespaces: m, activeNamespace: h } = ce(n), g = S(() => {
		...
		return (e, t) => {
			...
			return A(), T("div", nr, [
				...
				he(zn, { class: "sm:block display-none" }),
				g.value ? (A(), T("span", rr, [E("span", ir, [
					t[0] ||= E("span", { class: "chain-colon" }, ":", -1),
					E("span", ar, P(g.value.keys), 1),
					g.value.cursor ? (A(), T("span", or, "_")) : w("", !0),
					g.value.options ? (A(), T("span", sr, P(g.value.options), 1)) : w("", !0)
				]), g.value.description ? (A(), T("span", cr, "- " + P(g.value.description) + "...", 1)) : w("", !0)])) : s.value?.text.disabled ? w("", !0) : L((A(), T("span", lr, [me(P(s.value?.text.value), 1)])), [[r, { options: {
					placement: "top",
					hideOnClick: !1,
					theme: "ramp4",
					animation: "scale"
				...
				E("div", ur, [
					c.value?.disabled ? w("", !0) : L((A(), T("div", dr, [me(P(c.value?.formattedString), 1)])), [[r, { options: {
						hideOnClick: !1,
						theme: "ramp4",
						animation: "scale"
					} }]]),
                ...
                `,
					...
					}, null, 4), E("span", pr, P(o.value?.label), 1)], 8, fr)), [[u, {
						delay: [300, 0],
						placement: "top",
						hideOnClick: !1,
						theme: "ramp4",
					...
					l.value?.disabled ? w("", !0) : (A(), C(n, {
						...
						header: I(() => [E("span", mr, P(F(i)("map.language.short")), 1)]),
						default: I(() => [(A(!0), T(le, null, Oe(ee.value, (e, t) => (A(), T("a", {
							...
							href: "javascript:;",
							onClick: (t) => _(e)
						}, [me(P(F(i)("map.language." + e)) + " ", 1), e === F(a).$i18n.locale.value ? (A(), T("span", gr, P(F(i)("map.language.curr")), 1)) : w("", !0)], 10, hr))), 128))]),
						_: 1
					}, 8, ["tooltip", "ariaLabel"]))
				])
			]);
...
}, br = /*#__PURE__*/ ne(/* @__PURE__ */ D({
	__name: "floating-button",
	setup(e) {
		let t = mn(), n = ye("iApi"), { t: r } = R(), i = S(() => t.notificationNumber);
		return (e, t) => {
			let a = N("tippy");
			return L((A(), T("button", {
				type: "button",
				...
				xmlns: "http://www.w3.org/2000/svg",
				viewBox: "0 0 24 24"
			}, [E("path", { d: "M12 22c1.1 0 2-.9 2-2h-4c0 1.1.89 2 2 2zm6-6v-5c0-3.07-1.64-5.64-4.5-6.32V4c0-.83-.67-1.5-1.5-1.5s-1.5.67-1.5 1.5v.68C7.63 5.36 6 7.92 6 11v5l-2 2v1h16v-1l-2-2z" })], -1), i.value && i.value > 0 ? (A(), T("span", yr, P(i.value), 1)) : w("", !0)], 8, vr)), [[a]]);
		};
	}
}), [["__scopeId", "data-v-a451db5c"]]), xr = { class: "flex items-center mb-20" }, Sr = { class: "text-xl" }, Cr = /* @__PURE__ */ D({
	...
	setup(e) {
		...
		return (e, t) => {
			...
			return r.value ? (A(), T("div", {
				...
				E("div", xr, [E("h2", Sr, P(F(n)("keyboardInstructions.title")), 1), he(a, {
					class: "ml-auto",
...
}), wr = x("instance", () => ({ started: j(!1) })), Tr = { class: "h-full relative" }, Er = { class: "inner-shell absolute top-0 left-0 h-full w-full pointer-events-none" }, Dr = { class: "absolute top-8 w-full flex justify-center" }, Or = {
	key: 1,
	class: "w-full h-full"
}, kr = D({
	name: "App",
	components: { Shell: /* @__PURE__ */ ne(/* @__PURE__ */ D({
		__name: "shell",
		setup(e) {
			let t = ye("iApi"), n = wr(), r = Jt(), i = un(), { t: a } = R(), o = S(() => r.items.appbar), s = () => {
				t.event.emit("openKeyboardInstructions");
			}, c = () => i.teleported;
			return (e, t) => (A(), T("div", Tr, [
				E("div", Er, [
					...
					he(Cr, { class: "keyboard-instructions-modal" }),
					he(dn, { class: "panel-stack sm:flex absolute inset-0 overflow-hidden sm:p-12 z-10 sm:pl-80 xs:pl-40 sm:pb-48 xs:pb-28 xs:pr-0 sm:pr-40" }),
					o.value ? w("", !0) : (A(), C(br, { key: 0 })),
					he(_r, { class: "z-30" })
				]),
				F(n).started ? (A(), C(an, { key: 0 })) : (A(), T("div", Or, [...t[1] ||= [E("div", { class: "spinner relative inset-x-1/2 inset-y-9/20" }, null, -1)]])),
	...
	setup() {
		let e = _e();
		we(() => {
			new sn().observe(e?.proxy?.$refs["app-size"]), qe({
...
function Mr(e, t, n, r, i, a) {
	...
	return A(), T("div", {
		...
		lang: e.$i18n.locale
	}, [E("div", jr, [he(o)], 512)], 8, Ar);
}
var Nr = /*#__PURE__*/ ne(kr, [["render", Mr]]), Pr = "focus-list", Fr = "focus-item", Ir = "focus-icon", Lr = `[${Pr}],[focus-container]`, Rr = "truncate-text", zr = "show-truncate", Br = "focused", Vr = `button,input,select,a,textarea,[contenteditable],[${Pr}],[${Ir}],[tabindex]`, Hr = {
	mounted(e, t) {
...
var Jr = "focus-container", Yr = "focus-container-active", Xr = "focus-list", Zr = "focus-icon", Qr = `[${Xr}],[${Jr}]`, $r = `button,input,select,a,textarea,[contenteditable],.ag-tab-guard,[${Xr}],[${Jr}],[${Zr}],[tabindex]`, ei = {
	childList: !0,
	subtree: !0,
	attributes: !0,
	attributeFilter: [
	...
	mounted(e, t) {
		let n;
		t.value && t.value.externalTrigger && (n = e.closest(`[${ai}]`)), Je(e, {
...
var ui = ["content"], di = {
	...
	setup(e, { expose: t }) {
		let { t: n } = R(), r = un(), i = Ut(), a = ye("iApi"), o = Ne("el"), s = Ne("contentEl"), c = j(), l = j(), u = j();
		t({ el: o });
		let d = e, f = S(() => a.fixture.get("appbar") ? i.temporary : []), p = S(() => r.mobileView), m = S(() => r.reorderable), h = S(() => r.pinable), g = `[focus-list], [${_i}]`, ee = (e) => e.scrollHeight > e.clientHeight, te = (e) => e.querySelector(g), _ = () => {
			if (!s.value) return "-1";
		...
		return we(() => {
			...
			return L((A(), T("div", {
				...
				}, null, 8, hi)) : w("", !0)], 512)) : w("", !0),
				e.footer ? L((A(), T("div", gi, [ke(t.$slots, "footer")])), [[te]]) : w("", !0)
			], 8, ui)), [[_, {
				trigger: "manual",
				touch: !1,
				onShow: ae,
	...
	setup(e) {
		...
		return (n, r) => {
			let i = N("tippy");
			return A(), T("div", wi, [L((A(), T("button", {
				type: "button",
				class: k(["text-gray-500 hover:text-black focus:text-black p-8", { "text-gray-700": e.active }]),
	...
	setup(e) {
		...
		return (n, r) => {
			let i = N("tippy");
			return A(), T("div", Di, [L((A(), T("button", {
				type: "button",
				class: k(["text-gray-500 hover:text-black focus:text-black p-8", { "text-gray-700": e.active }]),
	...
	setup(e) {
		...
		return (n, r) => {
			let i = N("tippy");
			return A(), T("div", Ai, [L((A(), T("button", {
				type: "button",
	...
	setup(e) {
		...
		return (n, r) => {
			let i = N("tippy");
			return A(), T("div", Fi, [L((A(), T("button", {
				type: "button",
				...
				d: "M0 0h24v24H0V0z",
				fill: "none"
			}), E("path", { d: "M6 19h12v2H6z" })], -1)]], 10, Ii)), [[i, {
				placement: "bottom",
				theme: "ramp4",
				animation: "scale"
			}]])]);
...
var zi = { class: "relative" }, Bi = ["content", "aria-label"], Vi = /* @__PURE__ */ D({
	...
	setup(e) {
		...
		return (n, a) => {
			let o = N("tippy");
			return A(), T("div", zi, [L((A(), T("button", {
				ref_key: "buttonRef",
				ref: r,
				type: "button",
				class: k(["p-8", {
				...
				xmlns: "http://www.w3.org/2000/svg",
				viewBox: "4 4 16 16"
			}, [E("path", { d: "M 8.59 16.34 L 13.17 11.75 L 8.59 7.16 L 10 5.75 L 16 11.75 L 10 17.75 Z" })], -1)]], 10, Bi)), [[o, {
				placement: "bottom",
				theme: "ramp4",
				animation: "scale"
			}]])]);
	...
	setup(e) {
		...
		return (t, a) => {
			let o = N("tippy");
			return A(), T("div", Hi, [L((A(), T("button", {
				ref_key: "buttonRef",
				ref: r,
				type: "button",
				...
				xmlns: "http://www.w3.org/2000/svg",
				viewBox: "4 4 16 16"
			}, [E("path", { d: "M 15.41 16.09 L 10.83 11.5 L 15.41 6.91 L 14 5.5 L 8 11.5 L 14 17.5 Z" })], -1)]], 10, Ui)), [[o, {
				placement: "bottom",
				theme: "ramp4",
				animation: "scale"
			}]])]);
	...
	setup(e) {
		...
		return (e, i) => {
			...
			return A(), C(a, {
				...
				default: I(() => [F(n).isFullscreen ? (A(), T("svg", Ki, [...i[0] ||= [E("path", {
					d: "M0 0h24v24H0z",
					fill: "none"
				}, null, -1), E("path", { d: "M5 16h3v3h2v-5H5v2zm3-8H5v2h5V5H8v3zm6 11h2v-3h3v-2h-5v5zm2-11V5h-2v5h5V8h-3z" }, null, -1)]])) : (A(), T("svg", qi, [...i[1] ||= [E("path", {
					d: "M0 0h24v24H0z",
					fill: "none"
	...
	setup(e) {
		return (t, n) => {
			...
			}, [ke(t.$slots, "default", {}, void 0, !0)], 10, Qi)), [[r], [i, { placement: "left" }]])]);
		};
	}
}), [["__scopeId", "data-v-bafb7e3d"]]), ea = {
	class: "relative",
	tabindex: "-1"
}, ta = ["aria-label", "content"], na = /*#__PURE__*/ ne(/* @__PURE__ */ D({
	__name: "button",
	props: {
		onClickFunction: {
			type: Function,
	...
	setup(e) {
		...
		return (t, n) => {
			...
			return A(), T("div", ea, [L((A(), T("button", {
				type: "button",
			...
			}, [ke(t.$slots, "default", {}, void 0, !0)], 8, ta)), [[i], [a, {
				allowHTML: !0,
				placement: "right"
			}]])]);
		};
	}
}), [["__scopeId", "data-v-1cb84ae1"]]), ra = x("areas-of-interest", () => ({ areas: j([]) })), ia = x("export", () => {
	let e = j({
		title: !0,
		map: !0,
		mapElements: !0,
...
var Pa = x("geosearch", () => {
		...
		if (!u) o.value = [], s.value = [], c.value = !1;
			...
			let r = setInterval(() => {
				e.value.config.provinces.listFetched && e.value.config.types.typesFetched && (clearInterval(r), e.value.query(`${u}*`).then((e) => {
					...
					let r = Na(n.value, t.value, s.value);
					o.value = r || [], c.value = !1;
				}));
			}, 250);
		} else {
			let e = Na(n.value, t.value, s.value);
			o.value = e || [], c.value = !1;
		}
	}
	function h(e) {
	...
	_content;
	constructor(e, t, n) {
		super(e, t, n), this._infoType = t.infoType ?? "title", this._content = t.content ?? "", t.infoType === "template" && this.$element.component(`${this._uid}-info-section`, { template: this._content }), (t.infoType || t.content) && (this._controls = t.controls?.slice() ?? [Fa.Expand]), super.load();
	}
	get infoType() {
	...
	_isFullscreen;
	constructor(e, t, n) {
		this.event = new Zt(this);
		let r = Xa(e, this);
		this.$vApp = r.app, this.$element = r.element, this.$i18n = r.i18n, this.$rootEl = r.app.$root?.$el, this.fixture = new us(this), this.panel = new fs(this), this.geo = new ss(this), this.dev = new ys(this), this.ui = {
			...
			escapeHtml: () => "",
			isPlainText: () => !0
		}, this.notify = new bn(this), this._isFullscreen = Ve.isEnabled && !!this.$vApp.$root && Ve.isFullscreen && Ve.element === this.$vApp.$root.$el, Ve.isEnabled && Ve.onchange(() => {
			this._isFullscreen = Ve.isEnabled && !!this.$vApp.$root && Ve.isFullscreen && Ve.element === this.$vApp.$root.$el;
		}), this.initialize(!0, t, n);
	}
	initialize(e, t, n) {
		let r = v(this.$vApp.$pinia), i = un(this.$vApp.$pinia), a = rn(this.$vApp.$pinia);
		if (t?.configs !== void 0) {
	...
	reloadWorker(e, t) {
		let n = wr(this.$vApp.$pinia), r = mn(this.$vApp.$pinia), i = v(this.$vApp.$pinia), a = Jt(this.$vApp.$pinia), o = _(this.$vApp.$pinia), s = Wt(this.$vApp.$pinia), c = !!e;
	...
	useStore(e) {
		if (!([
			...
			case "keyboardnav": return tr(this.$vApp.$pinia);
			...
			case "maptip": return rn(this.$vApp.$pinia);
			case "notification": return mn(this.$vApp.$pinia);
			case "panel": return un(this.$vApp.$pinia);
			default:
	...
	setLanguage(e) {
		...
		let t = v(this.$vApp.$pinia), n = mn(this.$vApp.$pinia), r = t.registeredLangs;
...
function Xa(e, t) {
	...
	let r = nn(), i = pe(Nr).use(r).use(Ke, {
		directive: "tippy",
		component: "tippy"
	}).use(n);
	return i.directive("focus-container", ni), i.directive("focus-list", Hr), i.directive("focus-item", Kr), i.directive("truncate", oi), i.component("panel-screen", yi), i.component("pin", Ci), i.component("close", Ei), i.component("back", ki), i.component("expand", Pi), i.component("panel-options-menu", Gi), i.component("dropdown-menu", pn), i.component("minimize", Li), i.component("right", Vi), i.component("left", Wi), i.component("fullscreen-nav-button", Ji), i.component("geolocator-nav-button", Yi), i.component("home-nav-button", Xi), i.component("mapnav-button", $i), i.component("appbar-button", na), i.component("transition", de), i.component("transition-group", fe), i.config.globalProperties.$iApi = t, i.config.globalProperties.$pinia = n, i.config.idPrefix = `ramp-${e.id || Is.sharedUtils.generateUUID()}`, i.provide("iApi", t), {
		element: i,
		app: i.mount(e),
		i18n: r.global
	};
...
var Za = class e {
	...
	async createMap(e, t) {
		let n = (e) => {
			this.$iApi.notify.show(yn.ERROR, this.$iApi.$i18n.t("layer.error", { id: e.name }));
		}, r = e.basemaps.map((e) => Za.create(e)), a = (await Promise.all(r)).filter((e) => (e.createErr && n(e), e.esriBasemap.baseLayers.length > 0));
		a.forEach((e) => {
	...
	maptipStore;
	constructor(e) {
		super(e), this.maptipStore = rn(this.$vApp.$pinia);
	}
	#e = void 0;
	#t = void 0;
	...
	async setBasemap(e) {
		...
		if (r) {
			...
			let t = await h.ColorBackground({ color: new Ct(n.backgroundColour).toESRI() });
	...
	removeLayer(e) {
		...
		let t;
		if (t = e instanceof ho ? e : this.$iApi.geo.layer.getLayer(e), !t) throw Error("Layer could not be found for removal.");
		if (t.isSublayer) {
...
var lo = class extends Z {
	...
	extractGeoJsonFields(e) {
		...
		for (let n = 0; n < e.features.length; n++) {
			let r = e.features[n];
			r.geometry.type === "GeometryCollection" && so(e, n);
	...
	constructor(e, t) {
		super(e, t), this.name = e.name || "", this.geomType = z.NONE, this.dataFormat = V.UNKNOWN, this.layerType = B.UNKNOWN, this.layerFormat = lt.UNKNOWN;
		...
		this.expectedTime.draw = e.expectedDrawTime ?? n.draw, this.expectedTime.load = e.expectedLoadTime ?? n.load, this.expectedTime.fail = e.maxLoadTime || n.fail, this.lastCancel = 0, this.timers = {
			draw: void 0,
			load: void 0
		}, this.origRampConfig = e, this.id = e.id || "", this.uid = this.$iApi.geo.shared.generateUUID(), this.isCosmetic = !1, this.isSystem = e.system || !1, this.isRemoved = !1, this.isSublayer = !1, this.supportsIdentify = !1, this.mapLayer = !0, this.identifyMode = U.NONE, this.supportsFeatures = !1, this.maptips = !1, this.supportsSublayers = !1, this.isFile = !1, this.layerState = G.NEW, this.initiationState = W.NEW, this.drawState = ut.NOT_LOADED, this.loadDefProm = new X(), this.url = this.origRampConfig.url, this.canReload = !!(this.url || this.origRampConfig.caching), this.loadPromDone = !1, this.nameArcadeFormula = "", this.maptipArcadeFormula = "", this.layerTree = new kt(0, this.uid, this.name, !0);
	}
	updateInitiationState(e) {
	...
	updateDrawState(e) {
		this.drawState = e, e === ut.REFRESH ? this.startTimer("draw") : e === ut.UP_TO_DATE && this.stopTimer("draw"), this.$iApi.event.emit(Q.LAYER_DRAWSTATECHANGE, {
			state: e,
			layer: this
		});
	}
	async initiate() {
		...
		clearTimeout(n), t > this.lastCancel && (this.drawState !== ut.UP_TO_DATE && this.startTimer("draw"), r ? e(`Init error on layer id: ${this.id} . ${r.message}`) : this.updateInitiationState(W.INITIATED));
	}
	async onInitiate() {
	...
	async terminate() {
		this.updateInitiationState(W.TERMINATING), await Promise.all(this.sublayers.map((e) => e.terminate())), this.loadDefProm = new X(), this.loadPromDone = !1, this.updateLayerState(G.NEW), this.updateDrawState(ut.NOT_LOADED), this.updateInitiationState(W.TERMINATED);
	}
	onLoad() {
	...
	onError(e = !0) {
		this.layerState !== G.ERROR && (this.initiationState === W.INITIATING && this.updateInitiationState(W.NEW), this.loadPromDone && (this.loadDefProm = new X()), this.loadDefProm.rejectMe(), this.loadPromDone = !0, this.sublayers.forEach((t) => t.onError(e)), e && this.$iApi.notify.show(yn.ERROR, this.$iApi.$i18n.t("layer.error", { id: this.id })), this.stopTimer("draw"), this.stopTimer("load"), this.updateLayerState(G.ERROR, !e));
	}
	onLoadActions() {
		return [];
	}
	...
	startTimer(e) {
		this.stopTimer(e), this.expectedTime[e] > 0 && (this.timers[e] = window.setTimeout(() => this.$iApi.notify.show(yn.WARNING, this.$iApi.$i18n.t(`layer.long${e}`, { id: this.name || this.id })), this.expectedTime[e]));
	}
	stopTimer(e) {
	...
	esriWatches;
	constructor(e, t) {
		super(e, t), this._scaleSet = new At(), this._mouseTolerance = e.mouseTolerance == null ? 5 : e.mouseTolerance, this._touchTolerance = e.touchTolerance == null ? 15 : e.touchTolerance, this._drawOrder = [], this._serverVisibility = void 0, this.isCosmetic = e.cosmetic || !1, this.extent = e.extent ? St.fromConfig(`${this.id}_extent`, e.extent) : void 0, this.viewDefProm = new X(), this.esriWatches = [];
	}
	noLayerErr() {
	...
	filter;
	constructor(e, t) {
		super(e, t), this.supportsIdentify = !0, this.geomType = z.UNKNOWN, this.serviceUrl = "", this.fieldList = "", this.canModifyLayer = !0, this.filter = new jt(e.permanentFilteredQuery || "", e.initialFilteredQuery || ""), e.state?.hovertips !== void 0 && console.warn("hovertips layer configuration property is deprecated. Please adjust to use maptips instead"), this.maptips = e.state?.maptips ?? e.state?.hovertips ?? !0, this.attribs = new Go();
	}
	makeEsriLayerConfig(e) {
	...
	async loadLayerMetadata(e = {}) {
		...
		if (!(t < this.lastCancel)) if (this.geomType = n.geometryType, this.attribs.quickCache = new Zo(this.geomType), this.scaleSet.minScale = n.minScale, this.scaleSet.maxScale = n.maxScale, this.dataFormat = n.dataFormat, this.extent = this.extent ?? n.extent, this._serverVisibility = n.defaultVisibility, this.origRampConfig.name || (this.name = n.name ?? this.id), this.dataFormat === V.ESRI_FEATURE) {
			...
			this.attribs.attLoader = new Jo(this.$iApi, r);
	...
	constructor(e, t) {
		super(e, t), this.dataFormat = V.ESRI_FEATURE, this.layerFormat = lt.GRAPHIC, this.maptips = !1;
	}
	_graphics = [];
	makeEsriLayerConfig(e) {
		return super.makeEsriLayerConfig(e);
	...
	sourceGeoJson;
	constructor(e, t) {
		super(e, t), this.supportsIdentify = !0, this.isFile = !0, this.dataFormat = V.ESRI_FEATURE, this.layerFormat = lt.FEATURE, this.layerIdx = 0, e.identifyMode && e.identifyMode !== U.NONE ? this.identifyMode = e.identifyMode : this.identifyMode = U.HYBRID;
	}
	async reload() {
	...
	extractLayerMetadata() {
		...
		this.supportsFeatures = !0, this.geomType = this.$iApi.geo.geom.clientGeomTypeToRampGeomType(e.geometryType), this.scaleSet.minScale = e.minScale || 0, this.scaleSet.maxScale = e.maxScale || 0, this.extent = this.extent ?? St.fromESRI(e.fullExtent, this.id + "_extent");
		...
		this.attribs.attLoader = new Yo(this.$iApi, n);
	}
	async getGraphic(e, t) {
		let n;
	...
	constructor(e, t) {
		super(e, t), this.dataFormat = V.ESRI_FEATURE, this.supportsIdentify = !0, this.layerType = B.FEATURE, this.layerFormat = lt.FEATURE, e.identifyMode && e.identifyMode !== U.NONE ? this.identifyMode = e.identifyMode : this.identifyMode = U.HYBRID;
	}
	async onInitiate() {
	...
	origState;
	constructor(e, t) {
		super(e, t), this.supportsIdentify = !0, this.supportsSublayers = !0, this.layerType = B.MAPIMAGE, this.layerFormat = lt.MAPIMAGE, this.isDynamic = !1, this.maptips = !1, this.layerTree.layerIdx = -1, this.identifyMode = U.GEOMETRIC;
	}
	actualViz = !1;
	get visibility() {
	...
	set visibility(e) {
		...
		if (e || Ao(this, "1=2"), this.actualViz = e, e && !this.esriLayer.visible) this.esriLayer.visible = !0;
		else if (!e && this.esriLayer.visible) {
			let e = "", t = setTimeout(() => {
				this.$iApi.event.off(e), this.actualViz || (this.esriLayer.visible = !1, Ao(this, ""));
			}, 1600);
			e = this.$iApi.event.on(Q.LAYER_DRAWSTATECHANGE, (n) => {
				n.layer.id === this.id && n.state === ut.UP_TO_DATE && (clearTimeout(t), this.$iApi.event.off(e), this.actualViz || (this.esriLayer.visible = !1, Ao(this, "")));
			});
		}
		e && Ao(this, "");
	}
	...
	onLoadActions() {
		...
		let t = Date.now();
		if (this.layerTree.name = this.name, !this.esriLayer.capabilities.exportMap) throw this.$iApi.notify.show(yn.WARNING, this.$iApi.$i18n.t("layer.noexportmap", { name: this.name || this.id })), Error("Service does not support Map Image Layer, Map Export is not enabled");
		...
		let a = [], o = (e, t) => {
			...
			if (e.sublayers && e.sublayers.length > 0) {
				let r = new kt(n, "", (s ? s.name : "") || e.title || "", !1);
				t.findChildByIdx(n) || t.children.push(r), e.sublayers.reverse().forEach((e) => {
					o(e, r);
				});
			} else {
				this._sublayers[n] || (this._sublayers[n] = new jo({
	...
	constructor(e, t, n) {
		if (super(e, t), this.layerType = B.SUBLAYER, this.layerFormat = lt.MAPIMAGE, this.isSublayer = !0, this.layerIdx = e.index, this.parentLayer = n, this.isSystem = n.isSystem, this.dataFormat = V.ESRI_FEATURE, this.supportsFeatures = !0, this.maptips = !1, this.url = this.parentLayer?.url, this.canReload = !0, !n.esriLayer) throw Error("Map Image Layer with no internal esri layer encountered in sublayer creation");
	...
	constructor(e, t) {
		super(e, t), this.supportsIdentify = !1, this.layerType = B.OSM, this.layerFormat = lt.OSM, this.dataFormat = V.OSM_TILE, this.supportsFeatures = !1;
	}
	async onInitiate() {
	...
	constructor(e, t) {
		super(e, t), this.supportsIdentify = !1, this.layerType = B.IMAGERY, this.layerFormat = lt.IMAGERY, this.dataFormat = V.ESRI_RASTER;
	}
	async onInitiate() {
	...
	async checkProj() {
		let e = this.getSR(), t = this.$iApi.geo.map.getSR().isEqual(e), n = () => this.$iApi.notify.show(yn.WARNING, this.$iApi.$i18n.t("layer.mismatch", { name: this.name || this.id }));
		if (this.layerState === G.LOADED && !t) n(), this.onError(), this.updateDrawState(ut.NOT_LOADED);
		else if (this.layerState === G.ERROR && t) this.reload();
		else if (this.layerState !== G.ERROR && !t) return n(), Promise.reject();
	}
}, Fo = class extends Po {
	constructor(e, t) {
		super(e, t), this.layerType = B.IMAGERYTILE, this.layerFormat = lt.IMAGERYTILE, this.schemaLocked = !1;
	}
	async onInitiate() {
	...
	constructor(e, t) {
		super(e, t), this.layerType = B.TILE, this.layerFormat = lt.TILE;
	}
	async onInitiate() {
	...
	constructor(e, t) {
		super(e, t), this.layerType = B.VECTORTILE, this.layerFormat = lt.VECTORTILE;
	}
	async onInitiate() {
	...
	mimeType;
	constructor(e, t) {
		super(e, t), this.supportsIdentify = !0, this.layerType = B.WMS, this.layerFormat = lt.WMS, this.mimeType = e.featureInfoMimeType || "", this.sublayerNames = [], this.dataFormat = V.OGC_RASTER, this.identifyMode = U.GEOMETRIC;
	}
	async onInitiate() {
	...
	_visibility;
	constructor(e, t) {
		super(e, t), this.dataFormat = V.ESRI_FEATURE, this.layerFormat = lt.NOLAYER, this.drawState = ut.NOT_VISUAL, this.attribs = new Go(), this.supportsFeatures = !0, this.mapLayer = !1, this.isFile = !1, this._visibility = e.state?.visibility ?? !0, this.expectedTime.draw = 0;
	}
	async onInitiate() {
		if (this.sourceJson) {
			...
			this.attribs.attLoader = new Xo(this.$iApi, i), await this.attribs.attLoader.getAttribs(), this.featureCount = e.data.length;
	...
	serviceUrl;
	constructor(e, t) {
		super(e, t), this.layerType = B.DATATABLE, this.serviceUrl = e.url, this.filter = new jt(e.permanentFilteredQuery || "", e.initialFilteredQuery || "");
	}
	async onInitiate() {}
	onLoadActions() {
		let e = super.onLoadActions(), t = Date.now(), n = this.$iApi.geo.shared.parseUrlIndex(this.serviceUrl).index || 0, r = this.$iApi.geo.layer.loadLayerMetadata(this.serviceUrl).then((e) => {
			...
			this.attribs.attLoader = new Jo(this.$iApi, n), this.attribs.quickCache = new Zo(this.geomType);
	...
	constructor(e, t) {
		super(e), this.aac = new Ko(), this.details = t;
	}
	updateFieldList(e) {
	...
	getAttribs() {
		return this.loadPromise ||= (this.aac = new Ko(), this.loadPromiseGenerator()), this.loadPromise;
	}
	abortAttribLoad() {
	...
	constructor(e, t, n = !1) {
		if (super(e, t, n), this.valField = this.cleanFieldName(e.field, t), e.classBreakInfos.forEach((e, t) => {
			let n = t === 0, r = new is(this, e.minValue, e.maxValue, n);
	...
	makeRenderer(e, t, n = !1) {
		switch (e.type) {
			case this.SIMPLE: return new es(e, t);
			case this.CLASS_BREAKS: return new rs(e, t, n);
			case this.UNIQUE_VALUE: return new ts(e, t, n);
	...
	symbology;
	constructor(e) {
		super(e), this.geom = Is.geom, this.proj = Is.proj, this.shared = Is.sharedUtils, this.map = new no(e), this.layer = new mo(e), this.attributes = new Wo(e), this.query = new os(e), this.symbology = new as(e), Array.isArray(m.request.interceptors) || (m.request.interceptors = []), m.request.interceptors.push({ before: (e) => {
	...
	async getGeolocation(e = !1) {
		...
		if (this.glCoord.length) r = n();
			...
			if (!i || typeof i == "string") {
				let t = i || "internal";
				e || this.$iApi.notify.show(yn.ERROR, this.$iApi.$i18n.t("mapnav.geolocator.error." + t)), r = {
					success: !1,
					error: t
				};
...
}, cs = /* #__PURE__ */ Object.assign({
	"../fixtures/appbar/index.ts": () => import("./appbar-DI_CasIQ.js"),
	"../fixtures/areas-of-interest/index.ts": () => import("./areas-of-interest-DhLY6hmE.js"),
	"../fixtures/basemap/index.ts": () => import("./basemap-DeoHkrLB.js"),
	"../fixtures/crosshairs/index.ts": () => import("./crosshairs-QRPCN0d9.js"),
	"../fixtures/details/index.ts": () => import("./details-uuteRycU.js"),
	"../fixtures/draw/index.ts": () => import("./draw-C1krAHpB.js"),
	"../fixtures/export/index.ts": () => import("./export-8Wv9c2Vf.js"),
	"../fixtures/export-footnote/index.ts": () => import("./export-footnote-B6KT4M9T.js"),
	"../fixtures/export-legend/index.ts": () => import("./export-legend-CuqznGWV.js"),
	"../fixtures/export-map/index.ts": () => import("./export-map-tAqJ2DSi.js"),
	"../fixtures/export-northarrow/index.ts": () => import("./export-northarrow-D3GzMOTq.js"),
	"../fixtures/export-scalebar/index.ts": () => import("./export-scalebar-COZlzIMw.js"),
	"../fixtures/export-timestamp/index.ts": () => import("./export-timestamp-CUSpYbS6.js"),
	"../fixtures/export-title/index.ts": () => import("./export-title-DQL3qYdf.js"),
	"../fixtures/extentguard/index.ts": () => import("./extentguard-fmJP6InG.js"),
	"../fixtures/gazebo/index.ts": () => import("./gazebo-B8WDQWky.js"),
	"../fixtures/geosearch/index.ts": () => import("./geosearch-B-3SfTOe.js"),
	"../fixtures/grid/index.ts": () => import("./grid-2wyHPJwm.js"),
	"../fixtures/help/index.ts": () => import("./help-CXW9hENv.js"),
	"../fixtures/hilight/index.ts": () => import("./hilight-B0Kt-LfF.js"),
	"../fixtures/keyboardnav/index.ts": () => import("./keyboardnav-BQbotX1-.js"),
	"../fixtures/layer-reorder/index.ts": () => import("./layer-reorder-C7GkD83y.js"),
	"../fixtures/legend/index.ts": () => import("./legend-BBUBkDAA.js"),
	"../fixtures/mapnav/index.ts": () => import("./mapnav-C3w12Dwp.js"),
	"../fixtures/metadata/index.ts": () => import("./metadata-DFsjhz1U.js"),
	"../fixtures/northarrow/index.ts": () => import("./northarrow-DdzoaP6n.js"),
	"../fixtures/overviewmap/index.ts": () => import("./overviewmap-CNp1MhOp.js"),
	"../fixtures/panguard/index.ts": () => import("./panguard-rQUeGoLk.js"),
	"../fixtures/pindrop/index.ts": () => import("./pindrop-DIL2u2UL.js"),
	"../fixtures/scrollguard/index.ts": () => import("./scrollguard-CHe8lyZI.js"),
	"../fixtures/settings/index.ts": () => import("./settings-5FJS4iwV.js"),
	"../fixtures/snowman/index.ts": () => import("./snowman-pMQQF75l.js"),
	"../fixtures/swipe/index.ts": () => import("./swipe-Cvf8VJDb.js"),
	"../fixtures/wizard/index.ts": () => import("./wizard-Z3-a2BpX.js")
}), ls = (e) => e === ds || e.prototype instanceof ds, us = class extends Z {
	constructor(e) {
		super(e);
	}
	exists(e) {
	...
	async add(e, t) {
		...
		if (t) {
			...
			n = ls(t) ? new t(e, this.$iApi) : ds.updateBaseToInstance(new t(), e, this.$iApi);
		} else {
			let t = (await cs[`../fixtures/${e}/index.ts`]()).default;
			n = new t(e, this.$iApi);
		}
		return Jt(this.$vApp.$pinia).addFixture(n), this.$iApi.event.emit(Q.FIXTURE_ADDED, n), this.$iApi.geo.map.created && n.initialized?.(), n;
	}
	remove(e) {
		let t = this.get(e);
		if (!t) throw Error(`Could not find fixture ${e} for removal`);
		return Jt(this.$vApp.$pinia).removeFixture(t), this.$iApi.event.emit(Q.FIXTURE_REMOVED, t), t;
	}
	flush() {
	...
	handlePanelTeleports(e) {
		if (this.config?.panelTeleport) {
			let t = un(this.$vApp.$pinia), n = !!this.config.panelTeleport.target;
			e.forEach((e) => {
...
var gs = /*#__PURE__*/ ne(ms, [["render", hs], ["__scopeId", "data-v-a3c61802"]]), _s = /* #__PURE__ */ Object.assign({
	"../fixtures/areas-of-interest/screen.vue": () => import("./screen-Yn355eIb.js"),
	"../fixtures/basemap/screen.vue": () => import("./screen-xleFbhnm.js"),
	"../fixtures/export/screen.vue": () => import("./screen-DQhmoX78.js"),
	"../fixtures/geosearch/screen.vue": () => import("./screen-Bx5wWqTu.js"),
	"../fixtures/grid/screen.vue": () => import("./screen--IMCtzxr.js"),
	"../fixtures/help/screen.vue": () => import("./screen-Bqf9r587.js"),
	"../fixtures/layer-reorder/screen.vue": () => import("./screen-CUe-qmYo.js"),
	"../fixtures/legend/screen.vue": () => import("./screen-DeW-nAzX.js"),
	"../fixtures/metadata/screen.vue": () => import("./screen-D6btHYIS.js"),
	"../fixtures/settings/screen.vue": () => import("./screen-Dq6gfpOS.js"),
	"../fixtures/wizard/screen.vue": () => import("./screen-CMyz2w5w.js")
}), vs = class extends Z {
	id;
	screens;
	loadedScreens = [];
...
console.info(`RAMP v${{
	...
	minor: "23",
	patch: "0-beta",
	timestamp: "Tue Sep 1 13:01:06 2026 -0400",
	hash: "2759365c1b7e026b97fd7d9689b5e0cbd2b7b866"
}.major}.${{
	major: "4",
	minor: "23",
	patch: "0-beta",
...
//#endregion
export { Y as $, Da as A, un as B, za as C, La as D, Fa as E, tr as F, Ut as G, qt as H, er as I, Pt as J, Ht as K, $n as L, aa as M, ia as N, Ia as O, ra as P, bt as Q, yn as R, Va as S, Ra as T, Kt as U, Q as V, Wt as W, Tt as X, X as Y, St as Z, Ka as _, Ms as a, dt as at, Ua as b, Io as c, G as ct, ho as d, J as et, po as f, qa as g, $ as h, Ps as i, z as it, ha as j, Pa as k, bo as l, B as lt, Ja as m, Fs as n, K as nt, vs as o, W as ot, eo as p, Z as q, Is as r, nt as rt, ds as s, q as st, Ns as t, ft as tt, yo as u, rt as ut, Ga as v, Ba as w, Ha as x, Wa as y, mn as z };
