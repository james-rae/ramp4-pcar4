import { V as e, X as t, lt as n, s as r, tt as i, ut as a } from "./main-BZb7jG6q.js";
...
var o = "ramp-pin-identify", s = "ramp-pin-panel-open", c = "ramp-pin-panel-close", l = "ramp-pin-panel-min", u = "Ramp-Pin-Drop", d = {
	...
	_insertPin() {
		...
		if (e && this._pinPoint) {
			this._erasePin(e);
			let t = new i(this._pinPoint, "ramp-pin");
			t.style = this._pinSymbol, e.addGraphic(t), this._pinVisible = !0;
			let n = this.$iApi.geo, r = n.layer.layerOrderIds(), a = r.length - 1;
			r[a] !== u && n.map.reorder(e, a, !1);
		}
	}
	_erasePin(e) {
		if (this._pinVisible) {
