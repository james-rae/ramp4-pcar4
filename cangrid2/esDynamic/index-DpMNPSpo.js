import { bY as E, j0 as y, c1 as j, iL as z, c3 as B, c4 as a, c7 as N, iP as T, c5 as W, g1 as Y, fY as G, c6 as H, b_ as R, j1 as O, i$ as q, j2 as V, j3 as X, ci as F, fV as D, j4 as K, cc as U } from "./main-DHXLMse1.js";
class J extends E {
  /**
...
const Q = "path", Z = 12, ee = "M14.4 6L14 4H5v17h2v-7h5.6l.4 2h7V6z", te = "#ff0000ff", oe = 5, ae = 6, se = {
  ...
  __name: "northarrow",
  setup(S) {
    const t = z(), o = y(), e = B("iApi"), u = a(), n = N(() => o.arrowIcon), M = N(() => o.poleIcon), c = a(0), i = a(0), h = a(!1), P = a(`<svg xmlns="http://www.w3.org/2000/svg" fit=""  width="25" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24" focusable="false">
    ...
    W(() => {
      ...
      A.value = s.tileSchemas, n?.value && (P.value = `<img width='25' src='${n.value}'>`), e.geo.map.esriView?.ready && I(e.geo.map.getExtent()), _.push(e.event.on(Y.MAP_EXTENTCHANGE, G(300, I)));
    }), H(() => {
      _.forEach((s) => e.event.off(s));
    });
    const I = async (s) => {
      ...
      const l = document.querySelector(".inner-shell"), d = u.value.querySelector(".northarrow").getBoundingClientRect().width, v = document.querySelector(".appbar")?.clientWidth || 0, $ = s.sr;
      if (p || typeof p > "u" && !$.isWebMercator()) {
        const f = new R("pole", { x: -96, y: 90 }), b = await e.geo.proj.projectGeometry($, f), m = e.geo.map.mapPointToScreenPoint(b);
        if (m.screenY < 0) {
          h.value = !0;
          const r = {
...
//# sourceMappingURL=index-DpMNPSpo.js.map
