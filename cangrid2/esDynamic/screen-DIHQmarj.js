import { fV as H, c4 as ee, iP as Xe, c7 as Se, f_ as lt, c5 as Pt, c6 as ct, cc as k, ci as te, iN as Ge, cd as Ze, f$ as ce, cj as gn, ck as mn, ce as re, c1 as qe, c2 as zt, iQ as br, cf as G, ix as ut, js as Sr, c3 as $t, c9 as yn, cg as pe, cb as ge, ch as Dt, fW as Je, iw as un, iT as Or, nH as xr, j7 as Er, i$ as ae, nI as Nr, g1 as dn, ld as Et, nJ as ze, c8 as Tr, ca as Ie, iJ as fn, mR as Cr } from "./main-DHXLMse1.js";
import { r as Ir } from "./vue.esm-bundler-BLHSO7-K.js";
function $e(d, o, l) {
...
const Lr = { hex: [["hsl", (d) => ye(d, [ot, Rt])], ["hsv", (d) => ye(d, [ot, We, Ue])], ["hwb", (d) => ye(d, [ot, We])], ["rgb", ot]], hsl: [["hex", (d) => ye(d, [Lt, it])], ["hsv", function(d) {
  const o = d.l + d.s * Math.min(d.l, 1 - d.l), l = o === 0 ? 0 : 2 - 2 * d.l / o;
  return { h: d.h, s: l, v: o, a: d.a };
}], ["hwb", (d) => ye(d, [Lt, We])], ["rgb", Lt]], hsv: [["hex", (d) => ye(d, [ke, it])], ["hsl", function(d) {
  const o = d.v - d.v * d.s / 2, l = Math.min(o, 1 - o), e = l === 0 ? 0 : (d.v - o) / l;
  return { h: d.h, s: e, l: o, a: d.a };
}], ["hwb", function(d) {
  return { h: d.h, w: (1 - d.s) * d.v, b: 1 - d.v, a: d.a };
}], ["rgb", ke]], hwb: [["hex", (d) => ye(d, [Ue, ke, it])], ["hsl", (d) => ye(d, [Ue, ke, Rt])], ["hsv", Ue], ["rgb", (d) => ye(d, [Ue, ke])]], rgb: [["hex", it], ["hsl", Rt], ["hsv", (d) => ye(d, [We, Ue])], ["hwb", We]] };
function ye(d, o) {
...
var Sn = { __name: "ColorPicker", props: { color: { type: [String, Object], default: "#ffffffff" }, id: { type: String, default: "color-picker" }, visibleFormats: { type: Array, default: () => wt, validator: (d) => d.length > 0 && d.every((o) => wt.includes(o)) }, defaultFormat: { type: String, default: "hsl", validator: (d) => wt.includes(d) }, alphaChannel: { type: String, default: "show", validator: (d) => Rr.includes(d) } }, emits: ["color-change"], setup(d, { emit: o }) {
  ...
  let r = !1;
  const c = ee(l.visibleFormats.includes(l.defaultFormat) ? l.defaultFormat : l.visibleFormats[0]), u = Xe({ hex: "#ffffffff", hsl: { h: 0, s: 0, l: 1, a: 1 }, hsv: { h: 0, s: 0, v: 1, a: 1 }, hwb: { h: 0, w: 1, b: 0, a: 1 }, rgb: { r: 1, g: 1, b: 1, a: 1 } }), h = Se(function() {
  ...
  function p() {
    const g = (l.visibleFormats.findIndex((L) => L === c.value) + 1) % l.visibleFormats.length;
  ...
  function R(g, L, y) {
    const S = function(U, W, Z) {
      const X = U.getBoundingClientRect(), ie = W - X.left, ue = Z - X.top;
      return { x: X.width === 0 ? 0 : $e(ie / X.width, 0, 1), y: X.height === 0 ? 0 : $e(1 - ue / X.height, 0, 1) };
    }(g, L, y), P = st(u.hsv);
  ...
  function M(g) {
    ...
    g.preventDefault();
    const L = ["ArrowLeft", "ArrowDown"].includes(g.key) ? -1 : 1, y = ["ArrowLeft", "ArrowRight"].includes(g.key) ? "s" : "v", S = g.shiftKey ? 10 : 1, P = u.hsv[y] + L * S * 0.01, U = st(u.hsv);
    U[y] = $e(P, 0, 1), T("hsv", U);
  }
  function F(g) {
    const L = Mr(g);
  ...
  function D(g, L) {
    const y = g.currentTarget, S = st(u.hsv);
    S[L] = parseInt(y.value) / parseInt(y.max), T("hsv", S);
  }
  function V(g) {
    const L = g.target;
    bn(L.value) && T("hex", L.value);
  }
  function I(g, L) {
    const y = g.target, S = st(u[c.value]), P = Vt[c.value][L].from(y.value);
    Number.isNaN(P) || P === void 0 || (S[L] = P, T(c.value, S));
  }
  function T(g, L) {
    let y = L;
    if (l.alphaChannel === "hide") if (typeof L != "string") L.a = 1, y = L;
    else if ([5, 9].includes(L.length)) {
      const S = (L.length - 1) / 4;
      y = L.substring(0, L.length - S) + "f".repeat(S);
    } else [4, 7].includes(L.length) && (y = L + "f".repeat((L.length - 1) / 3));
    if (!function(S, P) {
      ...
      (function(P, U) {
        u[P] = U;
        for (const [W, Z] of Lr[P]) u[W] = Z(u[P]);
      })(g, y);
      const S = function() {
        const P = l.alphaChannel === "hide", U = pn(u[c.value], c.value, P);
        return { colors: u, cssColor: U };
      }();
      o("color-change", S);
    }
    (function() {
  ...
  async function A() {
    const g = u[c.value], L = l.alphaChannel === "hide", y = pn(g, c.value, L);
    await window.navigator.clipboard.writeText(y);
  }
  function z(g, L) {
    return Vt[g][L].to(u[g][L]);
  }
  function C(g) {
    if (!["ArrowUp", "ArrowRight", "ArrowDown", "ArrowLeft"].includes(g.key) || !g.shiftKey) return;
    const L = g.currentTarget, y = parseFloat(L.step), S = ["ArrowLeft", "ArrowDown"].includes(g.key) ? -1 : 1, P = $e(parseFloat(L.value) + S * y * 10, parseInt(L.min), parseInt(L.max));
    L.value = String(P - S * y);
  }
  return lt(() => l.color, F), Pt(function() {
    document.addEventListener("mousemove", E, { passive: !1 }), document.addEventListener("touchmove", w, { passive: !1 }), document.addEventListener("mouseup", b), document.addEventListener("touchend", b), F(l.color);
  }), ct(function() {
    document.removeEventListener("mousemove", E), document.removeEventListener("touchmove", w), document.removeEventListener("mouseup", b), document.removeEventListener("touchend", b);
  }), (g, L) => (k(), te("div", { ref_key: "colorPicker", ref: e, class: "vacp-color-picker" }, [H("div", { ref_key: "colorSpace", ref: a, class: "vacp-color-space", onMousedown: O, onTouchstart: m }, [H("div", { ref_key: "thumb", ref: i, class: "vacp-color-space-thumb", tabindex: "0", "aria-label": "Color space thumb", onKeydown: M }, null, 544)], 544), H("div", wr, [H("label", { class: "vacp-range-input-label vacp-range-input-label--hue", for: `${d.id}-hue-slider` }, [H("span", Fr, [Ge(g.$slots, "hue-range-input-label", {}, () => [Ze("Hue")])]), H("input", { id: `${d.id}-hue-slider`, class: "vacp-range-input vacp-range-input--hue", value: 360 * u.hsv.h, type: "range", min: "0", max: "360", step: "1", onKeydownPassive: C, onInput: L[0] || (L[0] = (y) => D(y, "h")) }, null, 40, Dr)], 8, jr), d.alphaChannel === "show" ? (k(), te("label", { key: 0, class: "vacp-range-input-label vacp-range-input-label--alpha", for: `${d.id}-alpha-slider` }, [H("span", Pr, [Ge(g.$slots, "alpha-range-input-label", {}, () => [Ze("Alpha")])]), H("input", { id: `${d.id}-alpha-slider`, class: "vacp-range-input vacp-range-input--alpha", value: 100 * u.hsv.a, type: "range", min: "0", max: "100", step: "1", onKeydownPassive: C, onInput: L[1] || (L[1] = (y) => D(y, "a")) }, null, 40, zr)], 8, Vr)) : ce("v-if", !0)]), H("button", { class: "vacp-copy-button", type: "button", onClick: A }, [Ge(g.$slots, "copy-button", {}, () => [$r, Br])]), H("div", Hr, [H("div", Ur, [c.value === "hex" ? (k(), te("label", { key: 0, class: "vacp-color-input-label", for: `${d.id}-color-hex` }, [Gr, H("input", { id: `${d.id}-color-hex`, class: "vacp-color-input", type: "text", value: v.value, onInput: V }, null, 40, Kr)], 8, Wr)) : (k(!0), te(gn, { key: 1 }, mn(h.value, (y) => (k(), te("label", { id: `${d.id}-color-${c.value}-${y}-label`, key: `${d.id}-color-${c.value}-${y}-label`, class: "vacp-color-input-label", for: `${d.id}-color-${c.value}-${y}`, onInput: (S) => I(S, y) }, [H("span", Qr, re(y.toUpperCase()), 1), H("input", { id: `${d.id}-color-${c.value}-${y}`, class: "vacp-color-input", type: "text", value: z(c.value, y), onInput: (S) => I(S, y) }, null, 40, Yr)], 40, Xr))), 128))]), d.visibleFormats.length > 1 ? (k(), te("button", { key: 0, class: "vacp-format-switch-button", type: "button", onClick: p }, [Ge(g.$slots, "format-switch-button", {}, () => [kr, Jr])])) : ce("v-if", !0)])], 512));
} };
(function(d, o) {
  o === void 0 && (o = {});
  var l = o.insertAt;
...
}), jt = /* @__PURE__ */ ut(ea, [["__scopeId", "data-v-5e77d8d6"]]);
var On = { exports: {} };
(function(d) {
  d.exports = /******/
  function(o) {
    ...
    "0481": (
      ...
      function(o, l, e) {
        ...
        a({ target: "Array", proto: !0 }, {
          flat: function() {
            var p = arguments.length ? arguments[0] : void 0, O = r(this), m = c(O.length), b = h(O, 0);
            return b.length = i(b, O, O, m, 0, p === void 0 ? 1 : u(p)), b;
          }
        });
      }
    ),
    ...
    "06cf": (
      ...
      function(o, l, e) {
        ...
        l.f = a ? p : function(m, b) {
          if (m = c(m), b = u(b, !0), v) try {
            return p(m, b);
          } catch {
          }
          if (h(m, b)) return r(!i.f.call(m, b), m[b]);
        };
      }
    ),
    /***/
    "0cb2": (
      ...
      function(o, l, e) {
        ...
        o.exports = function(h, v, p, O, m, b) {
          var E = p + h.length, w = O.length, R = u;
          return m !== void 0 && (m = a(m), R = c), r.call(b, R, function(M, F) {
            var D;
            switch (F.charAt(0)) {
              case "$":
                return "$";
    ...
    1276: (
      /***/
      function(o, l, e) {
        var a = e("d784"), i = e("44e7"), r = e("825a"), c = e("1d80"), u = e("4840"), h = e("8aa5"), v = e("50c4"), p = e("14c3"), O = e("9263"), m = e("d039"), b = [].push, E = Math.min, w = 4294967295, R = !m(function() {
          return !RegExp(w, "y");
        });
        a("split", 2, function(M, F, D) {
          ...
          return "abbc".split(/(b)*/)[1] == "c" || "test".split(/(?:)/, -1).length != 4 || "ab".split(/(?:ab)*/).length != 2 || ".".split(/(.?)(.?)/).length != 4 || ".".split(/()()/).length > 1 || "".split(/.?/).length ? V = function(I, T) {
            var A = String(c(this)), z = T === void 0 ? w : T >>> 0;
            if (z === 0) return [];
            if (I === void 0) return [A];
            if (!i(I))
              return F.call(A, I, z);
            for (var C = [], g = (I.ignoreCase ? "i" : "") + (I.multiline ? "m" : "") + (I.unicode ? "u" : "") + (I.sticky ? "y" : ""), L = 0, y = new RegExp(I.source, g + "g"), S, P, U; (S = O.call(y, A)) && (P = y.lastIndex, !(P > L && (C.push(A.slice(L, S.index)), S.length > 1 && S.index < A.length && b.apply(C, S.slice(1)), U = S[0].length, L = P, C.length >= z))); )
              y.lastIndex === S.index && y.lastIndex++;
            return L === A.length ? (U || !y.test("")) && C.push("") : C.push(A.slice(L)), C.length > z ? C.slice(0, z) : C;
            ...
            function(I, T) {
              ...
              var z = r(I), C = String(this), g = u(z, RegExp), L = z.unicode, y = (z.ignoreCase ? "i" : "") + (z.multiline ? "m" : "") + (z.unicode ? "u" : "") + (R ? "y" : "g"), S = new g(R ? z : "^(?:" + z.source + ")", y), P = T === void 0 ? w : T >>> 0;
              if (P === 0) return [];
              ...
              for (var U = 0, W = 0, Z = []; W < C.length; ) {
                ...
                if (X === null || (ie = E(v(S.lastIndex + (R ? 0 : W)), C.length)) === U)
                  ...
                  for (var ue = 1; ue <= X.length - 1; ue++)
                    if (Z.push(X[ue]), Z.length === P) return Z;
                  W = U = ie;
                }
              }
    ...
    "13d5": (
      /***/
      function(o, l, e) {
        var a = e("23e7"), i = e("d58f").left, r = e("a640"), c = e("ae40"), u = e("2d00"), h = e("605d"), v = r("reduce"), p = c("reduce", { 1: 0 }), O = !h && u > 79 && u < 83;
        a({ target: "Array", proto: !0, forced: !v || !p || O }, {
          reduce: function(b) {
            return i(this, b, arguments.length, arguments.length > 1 ? arguments[1] : void 0);
          }
        });
      }
    ),
    ...
    "23e7": (
      ...
      function(o, l, e) {
        ...
        o.exports = function(p, O) {
          var m = p.target, b = p.global, E = p.stat, w, R, M, F, D, V;
          if (b ? R = a : E ? R = a[m] || u(m, {}) : R = (a[m] || {}).prototype, R) for (M in O) {
            if (D = O[M], p.noTargetGet ? (V = i(R, M), F = V && V.value) : F = R[M], w = v(b ? M : m + (E ? "." : "#") + M, p.forced), !w && F !== void 0) {
              if (typeof D == typeof F) continue;
              h(D, F);
            }
            (p.sham || F && F.sham) && r(D, "sham", !0), c(R, M, D, p);
          }
        };
      }
    ),
    ...
    "25f0": (
      ...
      function(o, l, e) {
        ...
        (p || O) && a(RegExp.prototype, u, function() {
          var b = i(this), E = String(b.source), w = b.flags, R = String(w === void 0 && b instanceof RegExp && !("flags" in h) ? c.call(b) : w);
          return "/" + E + "/" + R;
        }, { unsafe: !0 });
      }
    ),
    ...
    "37e8": (
      ...
      function(o, l, e) {
        ...
        o.exports = a ? Object.defineProperties : function(h, v) {
          r(h);
          for (var p = c(v), O = p.length, m = 0, b; O > m; ) i.f(h, b = p[m++], v[b]);
          return h;
        };
      }
    ),
      ...
      function(o, l, e) {
        var a = e("fc6a"), i = e("50c4"), r = e("23cb"), c = function(u) {
          return function(h, v, p) {
            var O = a(h), m = i(O.length), b = r(p, m), E;
            if (u && v != v) {
              for (; m > b; )
                if (E = O[b++], E != E) return !0;
            } else for (; m > b; b++)
              if ((u || b in O) && O[b] === v) return u || b || 0;
            return !u && -1;
          };
        };
        o.exports = {
    ...
    "4e82": (
      ...
      function(o, l, e) {
        ...
        a({ target: "Array", proto: !0, forced: b }, {
          sort: function(w) {
    ...
    5319: (
      /***/
      function(o, l, e) {
        var a = e("d784"), i = e("825a"), r = e("50c4"), c = e("a691"), u = e("1d80"), h = e("8aa5"), v = e("0cb2"), p = e("14c3"), O = Math.max, m = Math.min, b = function(E) {
          ...
          return [
            ...
            function(I, T) {
              ...
              for (var S = []; ; ) {
                ...
                var U = String(P[0]);
                U === "" && (z.lastIndex = h(C, r(z.lastIndex), y));
              }
              for (var W = "", Z = 0, X = 0; X < S.length; X++) {
                P = S[X];
                for (var ie = String(P[0]), ue = O(m(c(P.index), C.length), 0), Le = [], Ae = 1; Ae < P.length; Ae++) Le.push(b(P[Ae]));
                var Te = P.groups;
                if (g) {
                  var Me = [ie].concat(Le, ue, C);
                  Te !== void 0 && Me.push(Te);
                  var Re = String(T.apply(void 0, Me));
                } else
                  Re = v(ie, C, ue, Le, Te, T);
                ue >= Z && (W += C.slice(Z, ue) + Re, Z = ue + ie.length);
              }
              return W + C.slice(Z);
            }
          ];
...
\v\f\r                　\u2028\u2029\uFEFF`;
    ...
    "58a8": (
      ...
      function(o, l, e) {
        var a = e("1d80"), i = e("5899"), r = "[" + i + "]", c = RegExp("^" + r + r + "*"), u = RegExp(r + r + "*$"), h = function(v) {
          return function(p) {
            var O = String(a(p));
            return v & 1 && (O = O.replace(c, "")), v & 2 && (O = O.replace(u, "")), O;
          };
        };
        o.exports = {
    ...
    6547: (
      ...
      function(o, l, e) {
        var a = e("a691"), i = e("1d80"), r = function(c) {
          return function(u, h) {
            var v = String(i(u)), p = a(h), O = v.length, m, b;
            return p < 0 || p >= O ? c ? "" : void 0 : (m = v.charCodeAt(p), m < 55296 || m > 56319 || p + 1 === O || (b = v.charCodeAt(p + 1)) < 56320 || b > 57343 ? c ? v.charAt(p) : m : c ? v.slice(p, p + 2) : (m - 55296 << 10) + (b - 56320) + 65536);
          };
        };
        o.exports = {
    ...
    "69f3": (
      /***/
      function(o, l, e) {
        var a = e("7f9a"), i = e("da84"), r = e("861d"), c = e("9112"), u = e("5135"), h = e("c6cd"), v = e("f772"), p = e("d012"), O = i.WeakMap, m, b, E, w = function(T) {
          return E(T) ? b(T) : m(T, {});
        }, R = function(T) {
          return function(A) {
            var z;
    ...
    "6eeb": (
      /***/
      function(o, l, e) {
        var a = e("da84"), i = e("9112"), r = e("5135"), c = e("ce4e"), u = e("8925"), h = e("69f3"), v = h.get, p = h.enforce, O = String(String).split("String");
        (o.exports = function(m, b, E, w) {
          var R = w ? !!w.unsafe : !1, M = w ? !!w.enumerable : !1, F = w ? !!w.noTargetGet : !1, D;
          if (typeof E == "function" && (typeof b == "string" && !r(E, "name") && i(E, "name", b), D = p(E), D.source || (D.source = O.join(typeof b == "string" ? b : ""))), m === a) {
            M ? m[b] = E : c(b, E);
            return;
          } else R ? !F && m[b] && (M = !0) : delete m[b];
          M ? m[b] = E : i(m, b, E);
    ...
    "7c73": (
      /***/
      function(o, l, e) {
        var a = e("825a"), i = e("37e8"), r = e("7839"), c = e("d012"), u = e("1be4"), h = e("cc12"), v = e("f772"), p = ">", O = "<", m = "prototype", b = "script", E = v("IE_PROTO"), w = function() {
        }, R = function(I) {
          return O + b + p + I + O + "/" + b + p;
        }, M = function(I) {
          I.write(R("")), I.close();
          var T = I.parentWindow.Object;
          return I = null, T;
        }, F = function() {
          var I = h("iframe"), T = "java" + b + ":", A;
          return I.style.display = "none", u.appendChild(I), I.src = String(T), A = I.contentWindow.document, A.open(), A.write(R("document.F=Object")), A.close(), A.F;
        }, D, V = function() {
          try {
        ...
        c[E] = !0, o.exports = Object.create || function(T, A) {
          var z;
    ...
    9263: (
      ...
      function(o, l, e) {
        var a = e("ad6d"), i = e("9f7f"), r = RegExp.prototype.exec, c = String.prototype.replace, u = r, h = function() {
          var m = /a/, b = /b*/g;
          return r.call(m, "a"), r.call(b, "a"), m.lastIndex !== 0 || b.lastIndex !== 0;
        }(), v = i.UNSUPPORTED_Y || i.BROKEN_CARET, p = /()??/.exec("")[1] !== void 0, O = h || p || v;
        O && (u = function(b) {
          var E = this, w, R, M, F, D = v && E.sticky, V = a.call(E), I = E.source, T = 0, A = b;
          return D && (V = V.replace("y", ""), V.indexOf("g") === -1 && (V += "g"), A = String(b).slice(E.lastIndex), E.lastIndex > 0 && (!E.multiline || E.multiline && b[E.lastIndex - 1] !== `
`) && (I = "(?: " + I + ")", A = " " + A, T++), R = new RegExp("^(?:" + I + ")", V)), p && (R = new RegExp("^" + I + "$(?!\\s)", V)), h && (w = E.lastIndex), M = r.call(D ? R : E, A), D ? M ? (M.input = M.input.slice(T), M[0] = M[0].slice(T), M.index = E.lastIndex, E.lastIndex += M[0].length) : E.lastIndex = 0 : h && M && (E.lastIndex = E.global ? M.index + M[0].length : w), p && M && M.length > 1 && c.call(M[0], R, function() {
    ...
    "99af": (
      /***/
      function(o, l, e) {
        var a = e("23e7"), i = e("d039"), r = e("e8b5"), c = e("861d"), u = e("7b0b"), h = e("50c4"), v = e("8418"), p = e("65f0"), O = e("1dde"), m = e("b622"), b = e("2d00"), E = m("isConcatSpreadable"), w = 9007199254740991, R = "Maximum allowed index exceeded", M = b >= 51 || !i(function() {
          var I = [];
        ...
        a({ target: "Array", proto: !0, forced: V }, {
          concat: function(T) {
            var A = u(this), z = p(A, 0), C = 0, g, L, y, S, P;
            for (g = -1, y = arguments.length; g < y; g++)
    ...
    "9bf2": (
      ...
      function(o, l, e) {
        ...
        l.f = a ? u : function(v, p, O) {
          if (r(v), p = c(p, !0), r(O), i) try {
            return u(v, p, O);
          } catch {
          }
    ...
    a15b: (
      ...
      function(o, l, e) {
        ...
        a({ target: "Array", proto: !0, forced: h || !v }, {
          join: function(O) {
            return u.call(r(this), O === void 0 ? "," : O);
          }
        });
      }
    ),
    ...
    a2bf: (
      /***/
      function(o, l, e) {
        var a = e("e8b5"), i = e("50c4"), r = e("0366"), c = function(u, h, v, p, O, m, b, E) {
          for (var w = O, R = 0, M = b ? r(b, E, 3) : !1, F; R < p; ) {
            if (R in v) {
              if (F = M ? M(v[R], R, h) : v[R], m > 0 && a(F))
                w = c(u, h, F, i(F.length), w, m - 1) - 1;
              else {
    ...
    a434: (
      /***/
      function(o, l, e) {
        var a = e("23e7"), i = e("23cb"), r = e("a691"), c = e("50c4"), u = e("7b0b"), h = e("65f0"), v = e("8418"), p = e("1dde"), O = e("ae40"), m = p("splice"), b = O("splice", { ACCESSORS: !0, 0: 0, 1: 2 }), E = Math.max, w = Math.min, R = 9007199254740991, M = "Maximum allowed length exceeded";
        a({ target: "Array", proto: !0, forced: !m || !b }, {
          splice: function(D, V) {
            var I = u(this), T = c(I.length), A = i(D, T), z = arguments.length, C, g, L, y, S, P;
            if (z === 0 ? C = g = 0 : z === 1 ? (C = 0, g = T - A) : (C = z - 2, g = w(E(r(V), 0), T - A)), T + C - g > R)
              throw TypeError(M);
            for (L = h(I, g), y = 0; y < g; y++)
              S = A + y, S in I && v(L, y, I[S]);
            if (L.length = g, C < g) {
              for (y = A; y < T - g; y++)
                S = y + g, P = y + C, S in I ? I[P] = I[S] : delete I[P];
              for (y = T; y > T - g + C; y--) delete I[y - 1];
            } else if (C > g)
              for (y = T - g; y > A; y--)
                S = y + g - 1, P = y + C - 1, S in I ? I[P] = I[S] : delete I[P];
            for (y = 0; y < C; y++)
              I[y + A] = arguments[y + 2];
    ...
    a9e3: (
      /***/
      function(o, l, e) {
        var a = e("83ab"), i = e("da84"), r = e("94ca"), c = e("6eeb"), u = e("5135"), h = e("c6b6"), v = e("7156"), p = e("c04e"), O = e("d039"), m = e("7c73"), b = e("241c").f, E = e("06cf").f, w = e("9bf2").f, R = e("58a8").trim, M = "Number", F = i[M], D = F.prototype, V = h(m(D)) == M, I = function(g) {
          var L = p(g, !1), y, S, P, U, W, Z, X, ie;
          if (typeof L == "string" && L.length > 2) {
            if (L = R(L), y = L.charCodeAt(0), y === 43 || y === 45) {
        ...
        if (r(M, !F(" 0o1") || !F("0b1") || F("+0x1"))) {
          for (var T = function(L) {
            var y = arguments.length < 1 ? 0 : L, S = this;
            return S instanceof T && (V ? O(function() {
              D.valueOf.call(S);
            }) : h(S) != M) ? v(new F(I(y)), S, T) : I(y);
          }, A = a ? b(F) : (
            // ES3:
            "MAX_VALUE,MIN_VALUE,NaN,NEGATIVE_INFINITY,POSITIVE_INFINITY,EPSILON,isFinite,isInteger,isNaN,isSafeInteger,MAX_SAFE_INTEGER,MIN_SAFE_INTEGER,parseFloat,parseInt,isInteger,fromString,range".split(",")
          ), z = 0, C; A.length > z; z++)
            u(F, C = A[z]) && !u(T, C) && w(T, C, E(F, C));
          T.prototype = D, D.constructor = T, c(i, M, T);
        }
      }
    ),
    /***/
    ...
    ae40: (
      ...
      function(o, l, e) {
        ...
        o.exports = function(v, p) {
          if (r(u, v)) return u[v];
          p || (p = {});
          var O = [][v], m = r(p, "ACCESSORS") ? p.ACCESSORS : !1, b = r(p, 0) ? p[0] : h, E = r(p, 1) ? p[1] : void 0;
          return u[v] = !!O && !i(function() {
            if (m && !a) return !0;
            var w = { length: -1 };
            m ? c(w, 1, { enumerable: !0, get: h }) : w[1] = 1, O.call(w, b, E);
          });
        };
      }
    ),
    ...
    b047: (
      ...
      function(o, l, e) {
        ...
        function v(p, O, m) {
          var b, E, w, R, M, F, D = 0, V = !1, I = !1, T = !0;
          if (typeof p != "function")
            throw new TypeError(c);
          O = r(O) || 0, a(m) && (V = !!m.leading, I = "maxWait" in m, w = I ? u(r(m.maxWait) || 0, O) : w, T = "trailing" in m ? !!m.trailing : T);
          function A(W) {
            var Z = b, X = E;
            return b = E = void 0, D = W, R = p.apply(X, Z), R;
          }
          function z(W) {
          ...
          function y(W) {
            return M = void 0, T && b ? A(W) : (b = E = void 0, R);
          }
          function S() {
            M !== void 0 && clearTimeout(M), D = 0, b = F = E = M = void 0;
          }
          function P() {
            return M === void 0 ? R : y(i());
          }
          function U() {
            var W = i(), Z = g(W);
            if (b = arguments, E = this, F = W, Z) {
              if (M === void 0)
                return z(F);
              if (I)
    ...
    b4b0: (
      ...
      function(o, l, e) {
        ...
        function O(m) {
          ...
          m = m.replace(c, "");
          var E = h.test(m);
          return E || v.test(m) ? p(m.slice(2), E ? 2 : 8) : u.test(m) ? r : +m;
        }
        o.exports = O;
      }
    ),
    ...
    b622: (
      /***/
      function(o, l, e) {
        var a = e("da84"), i = e("5692"), r = e("5135"), c = e("90e3"), u = e("4930"), h = e("fdbf"), v = i("wks"), p = a.Symbol, O = h ? p : p && p.withoutSetter || c;
        o.exports = function(m) {
          return r(v, m) || (u && r(p, m) ? v[m] = p[m] : v[m] = O("Symbol." + m)), v[m];
        };
      }
    ),
    /***/
    ...
    b727: (
      ...
      function(o, l, e) {
        var a = e("0366"), i = e("44ad"), r = e("7b0b"), c = e("50c4"), u = e("65f0"), h = [].push, v = function(p) {
          var O = p == 1, m = p == 2, b = p == 3, E = p == 4, w = p == 6, R = p == 7, M = p == 5 || w;
          return function(F, D, V, I) {
            for (var T = r(F), A = i(T), z = a(D, V, 3), C = c(A.length), g = 0, L = I || u, y = O ? L(F, C) : m || R ? L(F, 0) : void 0, S, P; C > g; g++) if ((M || g in A) && (S = A[g], P = z(S, g, T), p))
              if (O) y[g] = P;
              else if (P) switch (p) {
                case 3:
                  return !0;
    ...
    ca84: (
      ...
      function(o, l, e) {
        ...
        o.exports = function(u, h) {
          var v = i(u), p = 0, O = [], m;
          for (m in v) !a(c, m) && a(v, m) && O.push(m);
      ...
      function(o, l, e) {
        var a = e("1c0b"), i = e("7b0b"), r = e("44ad"), c = e("50c4"), u = function(h) {
          return function(v, p, O, m) {
            a(p);
            var b = i(v), E = r(b), w = c(b.length), R = h ? w - 1 : 0, M = h ? -1 : 1;
            if (O < 2) for (; ; ) {
              if (R in E) {
                m = E[R], R += M;
                break;
            ...
            for (; h ? R >= 0 : w > R; R += M) R in E && (m = p(m, E[R], R, b));
            return m;
          };
        };
        o.exports = {
    ...
    d784: (
      ...
      function(o, l, e) {
        ...
        o.exports = function(E, w, R, M) {
          ...
          if (!D || !V || E === "replace" && !(v && p && !m) || E === "split" && !b) {
            var I = /./[F], T = R(F, ""[E], function(C, g, L, y, S) {
              return g.exec === c ? D && !S ? { done: !0, value: I.call(g, L, y) } : { done: !0, value: C.call(L, g, y) } : { done: !1 };
            }, {
              REPLACE_KEEPS_$0: p,
    ...
    e893: (
      ...
      function(o, l, e) {
        ...
        o.exports = function(u, h) {
          for (var v = i(h), p = c.f, O = r.f, m = 0; m < v.length; m++) {
            var b = v[m];
            a(u, b) || p(u, b, O(h, b));
          }
        };
    ...
    f5df: (
      ...
      function(o, l, e) {
        ...
        o.exports = a ? i : function(v) {
          var p, O, m;
          return v === void 0 ? "Undefined" : v === null ? "Null" : typeof (O = h(p = Object(v), c)) == "string" ? O : u ? i(p) : (m = i(p)) == "Object" && typeof p.callee == "function" ? "Arguments" : m;
        };
      }
    ),
    /***/
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
        ...
        var z = e("72f0"), C = /* @__PURE__ */ e.n(z), g = e("cd9d"), L = /* @__PURE__ */ e.n(g), y = function() {
        ...
        var ie = e("4416"), ue = /* @__PURE__ */ e.n(ie), Le = e("1d92"), Ae = /* @__PURE__ */ e.n(Le), Te = e("2655"), Me = /* @__PURE__ */ e.n(Te);
        e("a434");
        function Re(s, t) {
          var n = s.indexOf(t);
          n !== -1 && s.splice(n, 1);
        }
        var Oe = null, Qe = 0, _e = 1, Ye = 2, xe = "ALL_CHILDREN", we = "ALL_DESCENDANTS", je = "LEAF_CHILDREN", Fe = "LEAF_DESCENDANTS", B = "LOAD_ROOT_OPTIONS", $ = "LOAD_CHILDREN_OPTIONS", J = "ASYNC_SEARCH", q = "ALL", oe = "BRANCH_PRIORITY", K = "LEAF_PRIORITY", de = "ALL_WITH_INDETERMINATE", Ee = "ORDER_SELECTED", Bt = "LEVEL", Ht = "INDEX", le = {
          BACKSPACE: 8,
          ENTER: 13,
          ESCAPE: 27,
          END: 35,
        ...
        var Tn = 0, Xt = {
          ...
          computed: {
            ...
            internalValue: function() {
              ...
              return this.sortValueBy === Bt ? n.sort(function(N, j) {
          ...
          methods: {
            ...
            initialize: function() {
              ...
              if (Array.isArray(t)) {
                ...
                this.forest.nodeMap = y(), this.keepDataOfSelectedNodes(n), this.forest.normalizedOptions = this.normalize(Oe, t, n), this.fixSelectedNodeIds(this.internalValue);
              } else
            ...
            fixSelectedNodeIds: function(t) {
              ...
              if (this.single || this.flat || this.disableBranchNodes || this.valueConsistsOf === q)
                ...
                for (var x = y(), N = t.slice(); N.length; ) {
                ...
                for (var ne = y(), se = t.filter(function(me) {
                  var De = n.getNode(me);
            ...
            handleLocalSearch: function() {
              ...
              this.localSearch.active = !0, this.localSearch.noResults = !0, this.traverseAllNodesDFS(function(j) {
                if (j.isBranch) {
                  var Q;
                  j.isExpandedOnSearch = !1, j.showAllChildrenOnSearch = !1, j.isMatched = !1, j.hasMatchedDescendants = !1, t.localSearch.countMap[j.id] = (Q = {}, b(Q, xe, 0), b(Q, we, 0), b(Q, je, 0), b(Q, Fe, 0), Q);
                }
              });
            ...
            highlightLastOption: function() {
              if (this.hasVisibleOptions) {
                var t = ue()(this.visibleOptionIds);
                this.setCurrentHighlightedOption(this.getNode(t));
              }
            },
            ...
            normalize: function(t, n, f) {
              var x = this, N = n.map(function(ne) {
                ...
                var me = _.id, De = _.label, Be = _.children, bt = _.isDefaultExpanded, Ve = t === Oe, sn = Ve ? 0 : t.level + 1, St = Array.isArray(Be) || Be === null, Ot = !St, ln = !!_.isDisabled || !x.flat && !Ve && t.isDisabled, mr = !!_.isNew, xt = x.matchKeys.reduce(function(Pe, cn) {
                  return D(D({}, Pe), {}, b({}, cn, Nn(_[cn]).toLocaleLowerCase()));
                }, {}), yr = Ve ? xt.label : t.nestedSearchLabel + " " + xt.label;
                x.forest.nodeMap[me] = y();
                var Y = x.forest.nodeMap[me];
                if (Y.id = me, Y.label = De, Y.level = sn, Y.ancestors = Ve ? [] : [t].concat(t.ancestors), Y.index = (Ve ? [] : t.index).concat(se), Y.parentNode = t, Y.lowerCased = xt, Y.nestedSearchLabel = yr, Y.isDisabled = ln, Y.isNew = mr, Y.isMatched = !1, Y.isHighlighted = !1, Y.isBranch = St, Y.isLeaf = Ot, Y.isRootNode = Ve, Y.raw = he, St) {
                  var He, rt = Array.isArray(Be);
                  Y.childrenStates = D(D({}, dt()), {}, {
                    isLoaded: rt
                  }), Y.isExpanded = typeof bt == "boolean" ? bt : sn < x.defaultExpandLevel, Y.hasMatchedDescendants = !1, Y.hasDisabledDescendants = !1, Y.isExpandedOnSearch = !1, Y.showAllChildrenOnSearch = !1, Y.count = (He = {}, b(He, xe, 0), b(He, we, 0), b(He, je, 0), b(He, Fe, 0), He), Y.children = rt ? x.normalize(Y, Be, f) : [], bt === !0 && Y.ancestors.forEach(function(Pe) {
                    Pe.isExpanded = !0;
            ...
            removeLastValue: function() {
              if (this.hasValue) {
                ...
                var t = ue()(this.internalValue), n = this.getNode(t);
                this.select(n);
              }
            },
        ...
        var pt, gt, mt, sr = {
          ...
          render: function() {
            var t, n = this.node, f = this.instance.shouldFlattenOptions ? 0 : n.level, x = b({
        ...
        var dr = {
          ...
          render: function() {
            return yt || (yt = Object(r.createVNode)("div", {
    ...
    fb6a: (
      /***/
      function(o, l, e) {
        var a = e("23e7"), i = e("861d"), r = e("e8b5"), c = e("23cb"), u = e("50c4"), h = e("fc6a"), v = e("8418"), p = e("b622"), O = e("1dde"), m = e("ae40"), b = O("slice"), E = m("slice", { ACCESSORS: !0, 0: 0, 1: 2 }), w = p("species"), R = [].slice, M = Math.max;
        a({ target: "Array", proto: !0, forced: !b || !E }, {
          slice: function(D, V) {
            var I = h(this), T = u(I.length), A = c(D, T), z = c(V === void 0 ? T : V, T), C, g, L;
...
const na = /* @__PURE__ */ Sr(ta), ra = { key: 0 }, aa = { class: "text-base font-bold" }, oa = {
  ...
  setup(d, { emit: o }) {
    const l = $t("iApi"), { t: e } = zt(), a = o, i = d, r = ee(), c = ee(!1), u = ee(!1), h = ee(!1), v = ee(!1), p = ee([...i.selectedValues]), O = ee("value-label"), m = ee("option-label"), b = ee(void 0), E = ee(null), w = Xe([]);
    if (i.defaultOption && i.modelValue === "" && i.options.length) {
      let y = i.options[0].value;
      if (i.name === "latField") {
        const S = new RegExp(/^(y|lat.*)$/i);
        y = i.options.find((U) => S.test(U.label))?.value || y;
    ...
    const R = (y) => {
      y.trim() !== "" ? c.value = !0 : (c.value = !1, l.updateAlert(e("wizard.configure.name.error.required")));
    }, M = (y) => {
      let S;
      try {
        S = new URL(y);
      ...
      S.protocol === "http:" || S.protocol === "https:" ? c.value = !0 : c.value = !1;
    }, F = (y) => {
      a("upload", y.target.files[0]), y.target.value = "";
    }, D = (y) => {
      M(y.target.value), a("link", y.target.value, c), u.value = !1;
    }, V = (y, S) => {
      a(y ? "select" : "update:modelValue", S.target.value);
    }, I = (y) => {
      a("nested", y.target.checked);
    }, T = (y) => {
      R(y.target.value), a("link", y.target.value, c), h.value = !1;
    }, A = () => {
      a("select", i.sublayerOptions(p.value)), p.value && p.value.length > 0 ? v.value = !1 : v.value = !0;
    }, z = (y) => y.length > 5 ? `${y.slice(0, 5)}...` : y;
    function C() {
      b.value = new ResizeObserver(function() {
        g();
      }), b.value.observe(l.$vApp.$el.querySelector(".vue-treeselect__control")), b.value.observe(l.$vApp.$el.querySelector(".vue-treeselect__menu"));
    }
    const g = () => {
      const y = l.$vApp.$el.querySelector(".vue-treeselect__menu")?.clientHeight, S = l.$vApp.$el.querySelector(".vue-treeselect__control")?.clientHeight;
      r.value.style.height = `${y + S + 30}px`;
    };
    w.push(
      lt(E, (y) => {
        y && L();
    ...
    const L = () => {
      if (E.value) {
        const y = E.value.querySelector('input[type="text"]');
        y && y.setAttribute("aria-label", e("wizard.configure.sublayers.select"));
      }
    };
    return ct(() => {
      b.value.disconnect(), w.forEach((y) => y());
    }), (y, S) => {
      const P = yn("truncate");
      return k(), te("div", {
        ...
        d.type === "file" ? (k(), te("div", ra, [
          ...
          H("div", ua, [
            H("input", {
              ...
              value: d.modelValue,
              "aria-label": i.ariaLabel,
              onChange: S[1] || (S[1] = (U) => c.value ? u.value = !1 : u.value = !0),
              onInput: S[2] || (S[2] = (U) => {
                D(U);
              })
            }, null, 40, da)
          ]),
          u.value ? (k(), te("div", fa, re(d.modelValue ? d.validationMessages?.invalid : d.validationMessages?.required), 1)) : ce("", !0)
          ...
          H("div", pa, [
            d.multiple ? (k(), te("div", ga, [
              ...
              d.validation && v.value ? (k(), te("div", ma, re(d.validationMessages?.required), 1)) : ce("", !0)
            ])) : (k(), te("div", ya, [
              H("select", {
              ...
              d.validation && d.formatError ? (k(), te("div", Oa, re(d.validationMessages?.invalid), 1)) : ce("", !0),
              d.validation && d.failureError ? (k(), te("div", xa, re(d.validationMessages?.failure), 1)) : ce("", !0)
            ]))
          ])
          ...
          H("div", La, [
            H("input", {
              ...
              value: d.modelValue,
              "aria-label": i.ariaLabel,
              onChange: S[9] || (S[9] = (U) => c.value ? h.value = !1 : h.value = !0),
              onInput: S[10] || (S[10] = (U) => {
                T(U);
              })
            }, null, 42, Aa)
          ]),
          d.validation && !d.modelValue ? (k(), te("div", Ma, re(d.validationMessages?.required), 1)) : ce("", !0)
        ]))
      ], 512);
    };
  }
}), be = /* @__PURE__ */ ut(Ra, [["__scopeId", "data-v-be5c9863"]]), wa = { class: "step relative flex flex-col px-12" }, ja = { class: "stepper-header flex pb-24" }, Fa = {
  key: 1,
...
}), Ft = /* @__PURE__ */ ut($a, [["__scopeId", "data-v-686fab2c"]]), Ba = { class: "py-12 h-auto stepper" }, Ha = /* @__PURE__ */ qe({
  __name: "stepper",
  props: {
    activeStep: {
      type: Number,
  ...
  setup(d) {
    const o = Er(), { t: l } = zt(), e = $t("iApi"), a = ee(), i = ee([]), r = Se(() => o.layerSource), c = Se(() => o.currStep), u = ee(), h = ee(), v = ee(0), p = ee(!1), O = ee(!1), m = ee(!1), b = ee(!1), E = ee(!1), w = ee(!1), R = ee(!1), M = ee(!0), F = ee(""), D = ee(""), V = ee([]), I = Xe([
      {
        value: ae.FEATURE,
    ...
    Nr(() => ((c.value === ze.FORMAT || c.value === ze.CONFIGURE) && (O.value = !0, o.goToStep(ze.FORMAT)), !1)), Pt(() => {
      i.value.push(
        e.event.on(dn.LAYER_LAYERSTATECHANGE, (B) => {
          B.layer.userAdded && (F.value = B.layer.name, R.value = B.state !== Et.LOADING && B.state !== Et.NEW, M.value = R.value && B.state === Et.LOADED);
        })
      ), c.value === ze.CONFIGURE && (g.value?.configOptions.includes("colour") && xe(), E.value = !g.value?.configOptions.includes("sublayers") && !!g.value?.config.name);
    }), ct(() => {
      i.value.forEach((B) => e.event.off(B));
    });
    const y = async (B) => {
      const $ = new FileReader();
      $.onload = (J) => {
        z.value = $.result, A.value = B.name, S(J);
      }, $.readAsArrayBuffer(B);
    }, S = (B) => {
      B?.preventDefault(), C.value = r.value.guessFormatFromURL(A.value), o.goToStep(ze.FORMAT);
    }, P = async (B) => {
      B?.preventDefault(), p.value = !0, m.value = !1, w.value = !0, D.value = X() ? T.find((J) => J.value === C.value)?.label : I.find((J) => J.value === C.value)?.label;
      try {
      ...
      const $ = C.value === ae.FEATURE && !(g.value && g.value.fields);
      if (!g.value || $) {
        O.value = !0, g.value = {
          config: {
            id: "Placeholder",
      ...
      B?.preventDefault();
      const $ = Object.assign(g.value.config, B);
      V.value = [], D.value = "";
      const J = e.geo.layer.createLayer($);
      e.geo.map.addLayer(J).catch(() => {
      }), J.userAdded = !0, e.event.emit(dn.USER_LAYER_ADDED, J), b.value = !1, o.goToStep(ze.UPLOAD);
    }, W = () => g.value?.fields.map((B) => ({
      value: B.name,
      label: B.alias || B.name
    })), Z = (B) => g.value?.latLonFields[B].map(($) => ({
      value: $,
      label: $
    })), X = () => z.value || A.value.match(/\.(zip|csv|json|geojson)$/), ie = (B) => {
      y(B), A.value = "";
    }, ue = (B, $) => {
      A.value = B.trim(), $ ? b.value = !0 : b.value = !1;
    }, Le = (B) => {
      C.value = B, O.value = !1;
    }, Ae = (B) => {
      g.value.config.name = B.trim();
      const $ = g.value?.config.sublayers;
      ($ ? B && $.length > 0 : B.trim()) ? E.value = !0 : E.value = !1;
    }, Te = (B) => {
      g.value.config.sublayers = B, B.length > 0 && g.value?.config.name ? E.value = !0 : E.value = !1;
    }, Me = (B) => {
      if (o.nested = B, V.value = [], v.value += 1, C.value === ae.MAPIMAGE) {
        ...
        const $ = new Set((g.value?.config?.sublayers ?? []).map((J) => J.id));
        o.nested ? Oe(g, $) : _e(g, $);
      }
      Te(Ye(V.value));
    }, Re = (B, $) => {
      const J = /* @__PURE__ */ new Map();
      for (const K of B.value.layersRaw)
      ...
      const q = (K) => {
        const de = J.get(K);
        return de ? de.every((Ee) => J.has(Ee) ? q(Ee) : $.has(Ee)) : !1;
      }, oe = (K) => {
        if (q(K))
          V.value.push(K);
        else {
          ...
          if (de)
            for (const Ee of de)
              $.has(Ee) && V.value.push(Ee);
        }
      };
      for (const K of J.keys()) oe(K);
      for (const K of B.value.layersRaw)
        K.parentLayerId === -1 && !J.has(K.id) && $.has(K.id) && V.value.push(K.id);
      V.value = Array.from(new Set(V.value));
    }, Oe = (B, $) => {
      const J = (K) => !K.layers || K.layers.length === 0 ? $.has(K.name) : K.layers.every((de) => J(de)), q = (K) => {
        J(K) ? V.value.push(K.name) : K.layers && K.layers.forEach(q);
      }, oe = B.value.layersRaw[0];
      oe && oe.layers && oe.layers.forEach((K) => q(K)), V.value = Array.from(new Set(V.value));
    }, Qe = (B, $) => {
      const J = (q) => {
        const oe = B.value.layersRaw.filter((K) => K.parentLayerId === q);
        if (oe.length > 0)
          for (const K of oe)
            $.has(K.id) ? V.value.push(K.id) : J(K.id);
        else V.value.push(q);
      };
      for (const q of B.value.layersRaw)
        $.has(q.id) && J(q.id);
      V.value = Array.from(new Set(V.value));
    }, _e = (B, $) => {
      const J = (oe) => {
        oe.layers && oe.layers.length > 0 ? oe.layers.forEach(J) : V.value.push(oe.name);
      }, q = B.value.layersRaw[0];
      for (const oe of $) {
      ...
      g.value.config.colour = B.colors.hex.substring(0, 7), Cr(() => {
    ...
    return (B, $) => {
      ...
      return k(), Ie(J, { panel: d.panel }, {
        ...
        content: ge(() => [
              ...
              pe(Ft, {
                ...
                default: ge(() => [
                  H("form", {
                    ...
                    $[12] || ($[12] = H("span", { class: "block text-center mb-10" }, "or", -1)),
                    pe(be, {
                      type: "url",
                      name: "url",
                      modelValue: A.value,
                ...
                default: ge(() => [
                  H("form", {
                    ...
                    pe(be, {
                      ...
                      name: "type",
                      modelValue: C.value,
                      "onUpdate:modelValue": $[2] || ($[2] = (q) => C.value = q),
                      onSelect: Le,
                    ...
                    pe(jt, {
                      onSubmit: P,
                      onCancel: $[4] || ($[4] = () => {
                        p.value = !1, O.value = !1, m.value = !1, A.value ? b.value = !0 : b.value = !1, w.value = !1, G(o).goToStep(0), D.value = "";
                      }),
                      animation: !0,
                      disabled: p.value
                    }, null, 8, ["disabled"])
                ...
                default: ge(() => [
                  H("form", {
                    ...
                    g.value?.configOptions.includes("name") ? (k(), Ie(be, {
                      ...
                      "onUpdate:modelValue": $[5] || ($[5] = (q) => g.value.config.name = q),
                      onLink: Ae,
                    ...
                    g.value?.configOptions.includes("latField") ? (k(), Ie(be, {
                      ...
                      "onUpdate:modelValue": $[8] || ($[8] = (q) => g.value.config.latField = q),
                      defaultOption: !0,
                    ...
                    g.value?.configOptions.includes("longField") ? (k(), Ie(be, {
                      ...
                      "onUpdate:modelValue": $[9] || ($[9] = (q) => g.value.config.longField = q),
                      defaultOption: !0,
                    ...
                    g.value?.configOptions.includes("sublayers") ? (k(), te("div", Ga, [
                      ...
                      (k(), Ie(be, {
                        ...
                        "onUpdate:modelValue": $[10] || ($[10] = (q) => g.value.config.sublayers = q),
                        onSelect: Te,
                    ...
                    g.value?.configOptions.includes("colour") ? (k(), te("label", Xa, re(G(l)("wizard.configure.colour.label")), 1)) : ce("", !0),
          ...
          }, re(F.value) + " " + re(G(l)(`wizard.upload.${M.value ? "success" : "fail"}`)), 3)) : ce("", !0)
        ]),
        _: 1
      }, 8, ["panel"]);
    };
  }
}), qa = /* @__PURE__ */ ut(ka, [["__scopeId", "data-v-085c20bf"]]);
export {
  qa as default
};
//# sourceMappingURL=screen-DIHQmarj.js.map
