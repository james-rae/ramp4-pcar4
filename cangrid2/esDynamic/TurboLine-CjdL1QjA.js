import { a9 as Et, fq as bt } from "./main-DHXLMse1.js";
...
async function Mt() {
  gt = await (Et("esri-csp-restrictions") ? await import("./libtess-asm-D7cctOnw.js").then((i) => i.l) : await import("./libtess-CQLEvs9L.js").then((i) => i.l)).default({ locateFile: (i) => bt(`esri/core/libs/libtess/${i}`) });
}
function $t(x, i) {
...
//# sourceMappingURL=TurboLine-CjdL1QjA.js.map
