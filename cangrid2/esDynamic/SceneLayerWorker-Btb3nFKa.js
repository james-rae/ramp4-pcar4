import { fq as q, bx as v, cy as K } from "./main-DHXLMse1.js";
import { y as Q } from "./DoubleArray-Cl3ev9Ra.js";
import { i as W, a as X } from "./MeshLocalVertexSpace-DJ_2_Us1.js";
import { f as Z, l as ee } from "./vec3-C9VLTIyn.js";
import "./sphere-DLzBE5sm.js";
import "./I3SUtil-B2Lz5RTc.js";
var U, D;
(function(e) {
...
function te() {
  return _ || (_ = new Promise((e) => import("./i3s-CSj7K-xk.js").then((t) => t.i).then(({ default: t }) => {
...
async function pe(e) {
  ...
  let s;
  const [{ projectBuffer: I }, { initializeProjection: M }] = await Promise.all([import("./main-DHXLMse1.js").then((a) => a.r9), import("./main-DHXLMse1.js").then((a) => a.ra)]);
  await M(c, l);
  const g = [0, 0, 0];
  ...
  if (i.type === "georeferenced" && i.origin == null) {
    ...
    const a = i.type === "georeferenced" ? W.fromJSON(i) : X.fromJSON(i), { project: m } = await import("./projection-BITClnVQ.js"), d = m({ positions: f, transform: t ? { localMatrix: t } : void 0, vertexSpace: a, inSpatialReference: c, outSpatialReference: l, localMode: u });
...
//# sourceMappingURL=SceneLayerWorker-Btb3nFKa.js.map
