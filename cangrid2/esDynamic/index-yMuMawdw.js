import { jr as A, js as y, bY as M, fU as $, hG as O, g1 as D, hH as j } from "./main-DHXLMse1.js";
import { _ as k } from "./screen.vue_vue_type_script_setup_true_lang-BixlRNrL.js";
var H = { exports: {} };
(function(S, i) {
  (function(n, a) {
    a();
...
class _ extends M {
   ...
   */
  async make(i, n) {
    const { fabric: a } = await import("./fabric-DhENsc66.js").then((g) => g.f);
...
class I extends _ {
  ...
  async needed() {
    const i = (await import("./index-NyyZ7E0k.js")).default, n = (await import("./index-BP36oKWz.js")).default, a = (await import("./index-CtcbBUDI.js")).default, w = (await import("./index-BnvP13jl.js")).default, p = (await import("./index-2cJska8F.js")).default, r = (await import("./index-CTRyUpRI.js")).default, b = (await import("./index-BjsggA_C.js")).default;
...
//# sourceMappingURL=index-yMuMawdw.js.map
