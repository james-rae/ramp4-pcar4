...
import { a as U, f as z } from "./main-BE1wx6ld.js";
const W = ["onClick", "aria-label"], G = { class: "md-icon-small inline" }, J = /* @__PURE__ */ k({
  ...
  setup(v) {
    const { t: f } = E(), s = U(), u = z(), _ = h(() => s.mobileView ? "top-end" : "left-end"), l = (a) => {
  ...
  ref: "componentEl"
}, Q = { class: "flex" }, X = ["aria-label"], Y = ["aria-label"], le = /* @__PURE__ */ k({
  __name: "screen",
  props: {
    panel: {
      type: Object,
  ...
  setup(v) {
    const f = v, { t: s } = E(), u = q("iApi"), _ = z(), l = b(), a = b(void 0), n = b(void 0), x = b([]), p = D("componentEl"), o = h(() => _.componentSelectedState), g = h(() => {
      let c = {};
    ...
    }), L = h(() => !!l.value?.customRendererFunc), d = I(300, () => {
      if (!l.value || !p.value)
        return;
    ...
    return N(() => {
      ...
      l.value = u.fixture.get("export"), a.value = new ResizeObserver(d), n.value = new ResizeObserver(d), a.value.observe(u.$rootEl), n.value.observe(u.$rootEl.querySelector('[data-cy="export"]'));
    }), F(() => {
