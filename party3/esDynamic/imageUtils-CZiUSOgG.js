import { ag as m, aJ as d, $ as u, M as w, s as p } from "./main-s2Ig2EGT.js";
let r = null, s = !0;
function T(e, a, t) {
...
async function B(e, a) {
  ...
  if (n === "image/gif") {
    const { isAnimatedGIF: o, parseGif: c } = await import("./gif-19Pdc1_d.js");
    if (o(t)) return c(t, a);
  }
  if (i) {
    const { isAnimatedPNG: o, parseApng: c } = await import("./apng-CPQzrC5a.js");
    if (o(t)) return c(t, a);
  }
...
//# sourceMappingURL=imageUtils-CZiUSOgG.js.map
