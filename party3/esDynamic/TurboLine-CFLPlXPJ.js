import { a9 as Et, fq as bt } from "./main-s2Ig2EGT.js";
...
async function Mt() {
  gt = await (Et("esri-csp-restrictions") ? await import("./libtess-asm-C1_wuhzi.js").then((i) => i.l) : await import("./libtess-DhAy0lXQ.js").then((i) => i.l)).default({ locateFile: (i) => bt(`esri/core/libs/libtess/${i}`) });
}
function $t(x, i) {
...
//# sourceMappingURL=TurboLine-CFLPlXPJ.js.map
