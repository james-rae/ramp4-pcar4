import { fq as q, bx as v, cy as K } from "./main-s2Ig2EGT.js";
import { y as Q } from "./DoubleArray-DyjWd-Bv.js";
import { i as W, a as X } from "./MeshLocalVertexSpace-xvpKUauf.js";
import { f as Z, l as ee } from "./vec3-B-_DmNKU.js";
import "./sphere-Csr6SpDN.js";
import "./I3SUtil-CjgAKnbs.js";
var U, D;
(function(e) {
...
function te() {
  return _ || (_ = new Promise((e) => import("./i3s-te_kjg4U.js").then((t) => t.i).then(({ default: t }) => {
...
async function pe(e) {
  ...
  let s;
  const [{ projectBuffer: I }, { initializeProjection: M }] = await Promise.all([import("./main-s2Ig2EGT.js").then((a) => a.r9), import("./main-s2Ig2EGT.js").then((a) => a.ra)]);
  await M(c, l);
  const g = [0, 0, 0];
  ...
  if (i.type === "georeferenced" && i.origin == null) {
    ...
    const a = i.type === "georeferenced" ? W.fromJSON(i) : X.fromJSON(i), { project: m } = await import("./projection-BXkLcm6U.js"), d = m({ positions: f, transform: t ? { localMatrix: t } : void 0, vertexSpace: a, inSpatialReference: c, outSpatialReference: l, localMode: u });
...
//# sourceMappingURL=SceneLayerWorker-B2S4_LVV.js.map
