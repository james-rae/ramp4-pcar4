...
import { createI18n as Es, useI18n as Y } from "vue-i18n";
...
const Ws = ["data-cy"], Vi = /* @__PURE__ */ O({
  ...
  setup(r) {
    const e = Te(), { t } = Y(), i = N(() => e.notificationNumber), s = () => e.clearAll();
    return (o, a) => {
...
const tr = ["content"], ir = { class: "flex items-center text-left" }, sr = { class: "select-text cursor-text" }, rr = ["content"], or = {
  ...
  setup(r) {
    const { t: e } = Y(), t = N(() => `${ht.major}.${ht.minor}.${ht.patch}`), i = N(() => ht.hash.slice(0, 9)), s = N(() => {
  ...
  __name: "map-caption",
  setup(r) {
    const e = Ge(), t = de(), { t: i } = Y(), s = Ae("iApi"), o = N(() => e.scale), a = N(() => e.attribution), l = N(() => e.coords), n = N(() => e.langtoggle), c = N(() => t.config.map), u = h([]), p = be([]);
    p.push(
      Et(c, (w) => {
  ...
  setup(r) {
    const e = Te(), t = Ae("iApi"), { t: i } = Y(), s = N(() => e.notificationNumber);
    return (o, a) => {
      const l = M("tippy");
      return P((g(), A("button", {
        type: "button",
  ...
  setup(r) {
    const e = Ae("iApi"), { t } = Y(), i = h(!1), s = h(["app", "lists", "map"]), o = h([]), a = h(null), l = h(null);
    Ye(() => {
      o.value.push(
  ...
  __name: "shell",
  setup(r) {
    const e = Ae("iApi"), t = tt(), i = ge(), s = He(), { t: o } = Y(), a = N(() => i.items.appbar), l = () => {
...
const Ao = ["content"], Eo = {
  ...
  setup(r, { expose: e }) {
    const { t } = Y(), i = He(), s = Tt(), o = Ae("iApi"), a = ci("el"), l = ci("contentEl"), n = h();
    e({ el: a });
...
class Ji extends Z {
   ...
   */
  constructor(e, t, i) {
    super(e), this._uid = lt.sharedUtils.generateUUID(), this._name = t.name, this._type = t.type ?? "placeholder", this._parent = i, this._children = [], this._loadPromise = new H(), this._hidden = t.hidden ?? !1, this._expanded = t.expanded ?? !0, this._visibility = !0, this._exclusive = t.exclusive ?? !1, this._controls = t.controls?.slice() ?? [
      "visibilityButton",
      "expandButton"
      /* Expand */
...
const Cn = /* @__PURE__ */ Object.assign({ "../fixtures/appbar/index.ts": () => import("./index-CLBO6RCw.js"), "../fixtures/areas-of-interest/index.ts": () => import("./index-D7_XSmF-.js"), "../fixtures/basemap/index.ts": () => import("./index-CjPjzZqN.js"), "../fixtures/crosshairs/index.ts": () => import("./index-7_XxD50E.js"), "../fixtures/details/index.ts": () => import("./index-SgtrlAzf.js"), "../fixtures/export-footnote/index.ts": () => import("./index-i6KO89_K.js"), "../fixtures/export-legend/index.ts": () => import("./index--Sjtr2dn.js"), "../fixtures/export-map/index.ts": () => import("./index-BfIKAVWK.js"), "../fixtures/export-northarrow/index.ts": () => import("./index-B4OLCH9P.js"), "../fixtures/export-scalebar/index.ts": () => import("./index-l8opOcPC.js"), "../fixtures/export-timestamp/index.ts": () => import("./index-B73TxOdf.js"), "../fixtures/export-title/index.ts": () => import("./index-Dd4y8swZ.js"), "../fixtures/export/index.ts": () => import("./index-y9c9hWm2.js"), "../fixtures/extentguard/index.ts": () => import("./index-CV9eu83G.js"), "../fixtures/gazebo/index.ts": () => import("./index-COa6FhC_.js"), "../fixtures/geosearch/index.ts": () => import("./index-BWWrdmC0.js"), "../fixtures/grid/index.ts": () => import("./index-BJT19kA3.js"), "../fixtures/help/index.ts": () => import("./index-CQ8bV50C.js"), "../fixtures/hilight/index.ts": () => import("./index-WcvhCYGb.js"), "../fixtures/layer-reorder/index.ts": () => import("./index-D1p4Nc3D.js"), "../fixtures/legend/index.ts": () => import("./index-B6R5s_qP.js"), "../fixtures/mapnav/index.ts": () => import("./index-DHdJLaMP.js"), "../fixtures/metadata/index.ts": () => import("./index-09zVgVjQ.js"), "../fixtures/northarrow/index.ts": () => import("./index-WnJODne-.js"), "../fixtures/overviewmap/index.ts": () => import("./index-DSYcjCoX.js"), "../fixtures/panguard/index.ts": () => import("./index-RNdpDEPY.js"), "../fixtures/scrollguard/index.ts": () => import("./index-J_ukdF0l.js"), "../fixtures/settings/index.ts": () => import("./index-BsnW3vKt.js"), "../fixtures/snowman/index.ts": () => import("./index-CntAcEa8.js"), "../fixtures/wizard/index.ts": () => import("./index-DADsE84N.js") });
class On extends Z {
  /**
...
const Fn = /* @__PURE__ */ Pe(Pn, [["render", Nn], ["__scopeId", "data-v-a3c61802"]]), Dn = /* @__PURE__ */ Object.assign({ "../fixtures/areas-of-interest/screen.vue": () => import("./screen-cw5HdpWA.js"), "../fixtures/basemap/screen.vue": () => import("./screen-DqiDMm0H.js"), "../fixtures/export/screen.vue": () => import("./screen-DqR_nTY5.js"), "../fixtures/geosearch/screen.vue": () => import("./screen-CJFk3nnb.js"), "../fixtures/grid/screen.vue": () => import("./screen-C0OUAL0I.js"), "../fixtures/help/screen.vue": () => import("./screen-BZMYMsBO.js"), "../fixtures/layer-reorder/screen.vue": () => import("./screen-dMD9ItiL.js"), "../fixtures/legend/screen.vue": () => import("./screen-BHqvVf2e.js"), "../fixtures/metadata/screen.vue": () => import("./screen-COZyXy_L.js"), "../fixtures/settings/screen.vue": () => import("./screen-DPWLrBsg.js"), "../fixtures/wizard/screen.vue": () => import("./screen-Bh7t8lLK.js") });
class At extends Z {
  /**
   * ID of this panel.
   *
...
var it = { major: "4", minor: "11", patch: "0-beta", timestamp: "Thu Mar 6 13:58:38 2025 -0500", hash: "e4191ea71af872bfee288ae3c2ee5264072118eb" };
console.info(
