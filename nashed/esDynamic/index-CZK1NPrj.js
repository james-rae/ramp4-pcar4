import { i4 as x, bN as i, bT as c, bC as y, bD as $, bE as E, kE as f, bJ as A, bR as u, bM as _, fC as r, bQ as m, hc as h, bF as M, bG as S, bH as F, bI as O, bK as b, bS as N, bU as g, bV as V, bL as w, kF as B, fI as L, bx as D, fK as H } from "./main-dhqBKhJU.js";
...
const k = /* @__PURE__ */ x(P, [["render", Z]]), j = /* @__PURE__ */ y({
  ...
  setup(v) {
    ...
    const t = O(
      () => n.order.map((s) => n.items[s]).filter((s) => s.componentId)
    );
    return (s, p) => {
      ...
      return i(), c("div", G, [
        N((i(), c("div", {
          ...
          r("div", U, [
            (i(!0), c(g, null, V(t.value, (d, z) => (i(), c(g, {
              key: d.id + "button"
            }, [
              (i(), w(B(d.id + "-nav-button"))),
...
}), q = /* @__PURE__ */ x(Y, [["__scopeId", "data-v-667ea86e"]]);
class J extends D {
  mapnavStore = h(this.$vApp.$pinia);
  /**
  ...
  _parseConfig(n) {
    ...
    this.mapnavStore.items = o.reduce(
      (e, a) => (e[a.id] = a, e),
      {}
    ), this.mapnavStore.order = o.map((e) => e.id), this._validateItems();
  }
  /**
...
class W extends J {
  async added() {
    Object.entries(Q).forEach(
      (t) => this.$iApi.$i18n.mergeLocaleMessage(...t)
    );
    ...
    this.removed = () => {
      ...
      const t = h(this.$vApp.$pinia), s = { ...t.items };
...
//# sourceMappingURL=index-CZK1NPrj.js.map
