import { bC as k, bD as y, fA as z, fB as $, bI as x, bJ as L, bK as V, bS as O, bN as i, bL as B, bM as u, fC as e, bT as h, bV as j, fD as w, bP as _, bQ as n, bU as D, bE as N, bF as S, fE as R, fF as A, fG as F, fH as P, bG as q, bH as H, bR as I, bO as T, fI as G } from "./main-dhqBKhJU.js";
const U = ["onClick", "aria-label"], J = { class: "md-icon-small inline" }, K = /* @__PURE__ */ k({
  ...
  setup(p) {
    const { t: d } = y(), a = z(), m = $(), g = x(
      () => a.mobileView ? "top-end" : "left-end"
    ), o = (l) => {
  ...
  setup(p) {
    const d = p, { t: a } = y(), m = N("iApi"), g = $(), o = S(), l = S(void 0), r = S([]), b = R("componentEl"), v = x(
      () => g.componentSelectedState
    ), s = x(() => {
      let c = {};
      return o.value && Object.keys(v.value).forEach(
        (t) => {
          c[t] = {
            name: t,
...
//# sourceMappingURL=screen.vue_vue_type_script_setup_true_lang-D9hre8au.js.map
