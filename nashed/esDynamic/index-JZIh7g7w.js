import { iH as u, jV as f, fK as c, ik as m, iB as p, jW as L, jX as w, bx as A } from "./main-dhqBKhJU.js";
...
class v extends A {
  ...
  _parseConfig(e) {
    if (e)
      switch (e.mode) {
        case h.NONE:
          this.hilightMode = new d(
            e,
            this.$iApi
          );
          break;
        case h.GLOW:
          this.hilightMode = new g(
            e,
            this.$iApi
          );
          break;
        case h.LIFT:
          this.hilightMode = new y(
            e,
            this.$iApi
          );
          break;
        case h.FOG:
          this.hilightMode = new $(
            e,
            this.$iApi
          );
          break;
...
//# sourceMappingURL=index-JZIh7g7w.js.map
