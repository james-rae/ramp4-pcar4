import { iO as A, iP as y, bx as M, fB as $, ha as O, fK as D, hb as B } from "./main-dhqBKhJU.js";
import { _ as k } from "./screen.vue_vue_type_script_setup_true_lang-D9hre8au.js";
var H = { exports: {} };
(function(S, i) {
  (function(n, a) {
    a();
...
class _ extends M {
   ...
   */
  async make(i, n) {
    const { fabric: a } = await import("./fabric-DoQmC7E3.js").then((g) => g.f);
    ...
    if (r.title && b && (f = await b.make({
      ...
      await this.customRendererFunc(
        ...
        p,
        g
      ), this.fcFabric.renderAll(), this.fcFabric.clone((F) => {
...
class I extends _ {
  ...
  async needed() {
    const i = (await import("./index-BLr2f5WL.js")).default, n = (await import("./index-DAItaFUv.js")).default, a = (await import("./index-banW9buv.js")).default, w = (await import("./index-C-RtNLpA.js")).default, p = (await import("./index-OxCXolCH.js")).default, r = (await import("./index-BygTlDEg.js")).default, b = (await import("./index-B0o4vp5O.js")).default;
...
//# sourceMappingURL=index-BeWNfqRp.js.map
