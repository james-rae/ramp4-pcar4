import { af as le, hX as ue } from "./main-dhqBKhJU.js";
...
async function xe() {
  ee = await (le("esri-csp-restrictions") ? await import("./libtess-asm-7gwa6yxw.js").then((i) => i.l) : await import("./libtess-Cvf4QTFZ.js").then((i) => i.l)).default({ locateFile: (i) => ue(`esri/core/libs/libtess/${i}`) });
}
function sr(s, i) {
...
//# sourceMappingURL=TurboLine-B0mJ5q2Q.js.map
