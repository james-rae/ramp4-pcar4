import { dK as d, s as n, dL as a, bl as m, dM as v, ci as c } from "./main-dhqBKhJU.js";
let u = h();
function h() {
  return new d(50);
}
async function p(r, o = null) {
  if (!r.isPrimitive) {
    ...
    const { fetch: l } = await import("./objectResourceUtils-CK7nZUIO.js"), f = await l(e, { disableTextures: !0 }), s = a(f.referenceBoundingBox, c());
    return u.put(e, s), s;
  }
...
//# sourceMappingURL=symbolLayerUtils-BkrpJoJ3.js.map
