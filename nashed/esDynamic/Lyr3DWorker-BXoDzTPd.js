import { hX as T } from "./main-dhqBKhJU.js";
...
function y() {
  return new Promise((t) => import("./lyr3DWorker-B9UC8UAR.js").then((r) => r.l).then(({ default: r }) => {
...
//# sourceMappingURL=Lyr3DWorker-BXoDzTPd.js.map
