import { hX as K, bh as D } from "./main-dhqBKhJU.js";
import { y as X } from "./DoubleArray-GGBY3j89.js";
import { i as Q, a as W } from "./MeshLocalVertexSpace-CvhQPBiL.js";
import { n as Z, s as ee } from "./vec3-DjZkGCsm.js";
import "./sphere-D4FZAevA.js";
import "./I3SUtil-HYYJ3KN9.js";
var S, $;
(function(e) {
...
function te() {
  return x || (x = new Promise((e) => import("./i3s-KtbLrpFF.js").then((t) => t.i).then(({ default: t }) => {
...
async function be(e) {
  ...
  if (i.type === "georeferenced" && i.origin == null) {
    const [{ projectBuffer: c }, { initializeProjection: b }] = await Promise.all([import("./main-dhqBKhJU.js").then((d) => d.qK), import("./main-dhqBKhJU.js").then((d) => d.qL)]);
    await b(f, l), s = new Float64Array(a.length), c(a, f, 0, s, l, 0, s.length / 3);
  } else {
    const c = i.type === "georeferenced" ? Q.fromJSON(i) : W.fromJSON(i), { project: b } = await import("./georeference-0-bh-X1Q.js").then((d) => d.g);
...
//# sourceMappingURL=SceneLayerWorker-Ck1D3bLv.js.map
