import { bC as S, bD as z, bE as V, ik as I, bI as j, bK as o, bN as t, bT as a, bS as r, bQ as M, fC as l, fD as x, bU as u, bV as d, bP as k, ii as C, ij as D, fI as U, i4 as L, bF as T, bG as N, bJ as $, bL as O, bM as _, bO as B, bR as K } from "./main-dhqBKhJU.js";
const q = { class: "mb-10" }, A = ["aria-label"], E = {
  ...
  setup(e) {
    const { t: h } = z(), p = V("iApi"), m = I(), c = j(
      () => m.activeBasemapConfig
    ), v = (n) => {
        ...
        r((t(), a("button", {
          ...
          l("div", null, [
            l("div", {
              ...
              }, null, 8, F)) : e.tileSchema.thumbnailTileUrls && e.tileSchema.thumbnailTileUrls.length > 0 && e.basemap.layers.every(
                (i) => i.layerType === "esri-tile"
              ) ? (t(!0), a(u, { key: 2 }, d(e.basemap.layers, (i) => (t(), a("div", {
                key: i.id,
          ...
          l("div", {
            class: x([
              ...
              e.basemap.hideThumbnail && e.basemap.id === c.value.id ? "opacity-85" : "opacity-75"
            ])
          }, [
            r((t(), a("div", J, [
...
}), X = /* @__PURE__ */ L(W, [["__scopeId", "data-v-dbfed424"]]), Y = { class: "h-600 overflow-y-auto" }, Z = { class: "font-bold text-xl" }, ee = {
  key: 0,
...
//# sourceMappingURL=screen.vue_vue_type_script_setup_true_lang-ORm3Z6MU.js.map
