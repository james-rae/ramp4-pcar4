import { bC as d, jY as l, bD as p, bE as u, bF as g, bI as h, bG as v, fK as f, bH as m, bT as b, fC as $, bP as _, bQ as A, bN as S, i4 as w, bx as C } from "./main-dhqBKhJU.js";
const E = { en: { "scrollguard.instructions": "Use ctrl + scroll to zoom the map" }, fr: { "scrollguard.instructions": "Utilisez les touches Ctrl et + pour faire un zoom de la carte" } }, x = { class: "sg-label" }, y = /* @__PURE__ */ d({
  ...
  setup(c) {
    const e = l(), { t: n } = p(), s = u("iApi"), a = g(), t = h(() => e.enabled);
    v(() => {
      s.$vApp.$el.querySelector(
        ".inner-shell + .esri-view"
      )?.addEventListener("wheel", o, {
        capture: !0
      ...
      s.$vApp.$el.querySelector(
        ".inner-shell + .esri-view"
      )?.removeEventListener("wheel", o, {
        capture: !0
      });
    });
    const o = (i) => {
      if (!t.value) return;
      const r = a.value.classList;
    ...
    return (i, r) => (S(), b("div", {
      ...
      $("p", x, _(A(n)("scrollguard.instructions")), 1)
    ], 512));
  }
}), L = /* @__PURE__ */ w(y, [["__scopeId", "data-v-66120e5d"]]);
class B extends C {
  /**
...
//# sourceMappingURL=index-C1s7-ZhC.js.map
