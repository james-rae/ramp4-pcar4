import { bx as a, h9 as s, ha as i, hb as n } from "./main-dhqBKhJU.js";
import { _ as o } from "./screen.vue_vue_type_script_setup_true_lang-D6YSt9aW.js";
...
class g extends f {
  added() {
    ...
    this.removed = () => {
      e(), this.$iApi.fixture.exists("appbar") && n(this.$vApp.$pinia).removeButton("areas-of-interest"), this.$iApi.panel.remove("areas-of-interest"), s(
        this.$vApp.$pinia
      ).$reset();
    };
  }
...
//# sourceMappingURL=index-D4vP0SVY.js.map
