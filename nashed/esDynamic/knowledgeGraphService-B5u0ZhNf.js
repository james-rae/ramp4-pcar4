import { N as i, O as s, P as w, dU as Y, b_ as O, bh as L, af as Fe, hX as le, s as d, eJ as ee, aT as fe, a6 as ge, aS as te, aR as re, C as _e, a2 as k, a3 as De } from "./main-dhqBKhJU.js";
import { m as me, p as we, t as Ne, c as ze } from "./GraphQueryStreaming-CgagdP8h.js";
...
async function Le(e) {
  if (e) {
    const { default: t } = await import("./arcgis-knowledge-client-core-simd-CfOaidm7.js").then((n) => n.a);
    return t({ locateFile: (n) => le(ue + n) });
  }
  const { default: r } = await import("./arcgis-knowledge-client-core-Bu5Q40b6.js").then((t) => t.a);
...
//# sourceMappingURL=knowledgeGraphService-B5u0ZhNf.js.map
