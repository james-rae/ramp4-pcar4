import { bx as u, i2 as a, ix as y, iy as g, iz as m, iA as h, iB as f, bC as L, bD as v, bE as b, bJ as I, bL as x, bM as A, bQ as $, bN as w, fC as c, ha as _, hb as S, hc as E } from "./main-dhqBKhJU.js";
import { _ as M } from "./screen.vue_vue_type_script_setup_true_lang-WbSunx4P.js";
class C extends u {
  /**
  ...
  createItem(e, t) {
    let l;
    e.layerId === void 0 ? l = new y(this.$iApi, e, t) : (e.sublayerIndex !== void 0 && (e.layerId = `${e.layerId}-${e.sublayerIndex}`), l = new g(
      this.$iApi,
      e,
      t
    ));
  ...
  getAllExpanded(e) {
    ...
    return this.searchLegend(
      (l) => l.children.length > 0 && l.expanded === t
    );
  }
  /**
  ...
  updateLegend(e) {
    const t = (l, n) => {
      ...
      n ? (r && l instanceof h && (r.layer = l), r?.error()) : r?.load(
        l instanceof h ? l : void 0
      );
    };
    e.loadPromise().then(() => {
      ...
      if (e.layerType === f.MAPIMAGE) {
        const n = (r) => {
          if (r.isLayerRoot && !r.isLogicalLayer)
            l = this.getLayerItem(e), t(e, !1), l && !l.treeGrown && (r.children.map(
              (i) => this._treeWalker(e, i)
            ).map(
              (i) => this.addItem(
                i,
                l
              )
            ), l.treeGrown = !0), r.children.forEach(
              (i) => n(i)
            );
          else if (!r.isLayerRoot && !r.isLogicalLayer) {
            if (l = this.getLayerItem(
              `${e.id}-${r.layerIdx}`
            ), l) {
              const i = l.getConfig();
          ...
          } else r.isLogicalLayer && t(
            this._treeWalker(e, r).layer,
            !1
          );
        };
        n(e.getLayerTree());
  ...
  _deleteItem(e) {
    const t = a(this.$vApp.$pinia), l = (n) => {
      n.children.length > 0 && n.children.forEach((r) => {
        l(r);
      }), n instanceof g && n.handlers.forEach(
        (r) => this.$iApi.event.off(r)
      ), t.removeItem(n);
    };
    return l(e), !0;
  }
  ...
  _treeWalker(e, t, l) {
    ...
    return t.isLayerRoot && !t.isLogicalLayer ? (i.layer = r, i.name = r.name, i.children = t.children.map(
      (s) => this._treeWalker(e, s, l)
    )) : !t.isLayerRoot && !t.isLogicalLayer ? (i.name = t.name, i.children = t.children.map(
      (s) => this._treeWalker(e, s, l)
    )) : t.isLogicalLayer && (i.layer = r, i.name = r.name, i.layerId = r.id, i.sublayerIndex = e.isSublayer ? e.layerIdx : void 0), { ...i, ...l };
  }
}
const T = /* @__PURE__ */ L({
  __name: "nav-button",
...
class z extends C {
  added() {
    ...
    const e = this.$vApp.$watch(
      () => this.config,
      (t) => this._parseConfig(
        t !== void 0 ? JSON.parse(JSON.stringify(t)) : void 0
      )
    );
    this.removed = () => {
...
//# sourceMappingURL=index-BAfric_0.js.map
