import { bC as H, he as A, bD as j, bE as R, bF as O, bI as T, ip as C, bG as X, fK as V, fH as F, bH as B, bJ as D, bL as q, bM as k, bN as o, bO as G, bP as m, bQ as p, bT as d, fC as h } from "./main-dhqBKhJU.js";
    ...
    const _ = () => {
      v.value = a.payload.layer !== void 0 && !a.payload.layer.isRemoved, a.payload.type === "xml" ? I(a.payload.url, []).then((e) => {
        if (s.status = "success", e !== null) {
          ...
          t.appendChild(
            g(`${e.firstElementChild.outerHTML}`)
          ), (a.payload.catalogueUrl || a.payload.url) && t.appendChild(
            g(
              `<h5 class="text-xl font-bold mb-3">${l(
                "metadata.xslt.metadata"
              )}</h5>`
            )
      ...
      return n = n.replace(
        /\{\{([\w.]+)\}\}/g,
        (i, c) => l(c)
      ), x[e] ? Promise.resolve($(x[e], n, t)) : w(e).then((i) => (x[e] = i.response, $(x[e], n, t)));
    }, $ = (e, t, n) => {
      let i = null;
      if (window.XSLTProcessor) {
        const c = new window.XSLTProcessor(), L = new DOMParser(), N = L.parseFromString(e, "text/xml"), E = L.parseFromString(t, "text/xml");
        c.importStylesheet(E), n && n.forEach(
          (P) => c.setParameter("", P.key, P.value || "")
        ), i = c.transformToFragment(N, document);
      }
      return i;
    }, w = (e) => new Promise((t) => {
...
//# sourceMappingURL=screen.vue_vue_type_style_index_0_lang-C3Hhn3UC.js.map
