import { A as e, C as t, D as n, E as r, F as i, M as a, N as o, O as s, S as c, T as l, a as u, c as d, i as f, k as p, o as m, t as h, v as g, w as ee, y as te } from "./esri-vcEQ1sbb.js";
import { n as _, t as v } from "./config-BhPbUOhN.js";
import { t as ne } from "./_plugin-vue_export-helper-B3ysoDQm.js";
import { t as re } from "./keyboard-B1sq5rh1.js";
...
import { createPinia as se, defineStore as x, storeToRefs as ce } from "pinia";
import { Fragment as le, Teleport as ue, Transition as de, TransitionGroup as fe, computed as S, createApp as pe, createBlock as C, createCommentVNode as w, createElementBlock as T, createElementVNode as E, createTextVNode as me, createVNode as he, defineAsyncComponent as ge, defineComponent as D, getCurrentInstance as _e, h as ve, inject as ye, markRaw as O, mergeProps as be, nextTick as xe, normalizeClass as k, normalizeStyle as Se, onBeforeUnmount as Ce, onMounted as we, onUpdated as Te, openBlock as A, reactive as Ee, ref as j, render as De, renderList as Oe, renderSlot as ke, resolveComponent as M, resolveDirective as N, resolveDynamicComponent as Ae, toDisplayString as P, toRaw as je, unref as F, useCssVars as Me, useTemplateRef as Ne, vShow as Pe, watch as Fe, withCtx as I, withDirectives as L, withKeys as Ie, withModifiers as Le } from "vue";
import { debounce as Re, throttle as ze } from "es-toolkit/function";
import { createI18n as Be, useI18n as R } from "vue-i18n";
...
var nt = /* @__PURE__ */ function(e) {
	...
	return e.POINT = "Point", e.LINE = "Line", e.POLYGON = "Polygon", e.NONE = "None", e;
	...
	id;
	constructor(e, t, n) {
		this.geometry = e, t ? this.id = t : this.id = Rs.sharedUtils.generateUUID(), n ? this.attributes = n : this.attributes = {};
	}
	_hover;
	get hover() {
		return this._hover;
	...
	getAt(e) {
		return new vt(this.childIdGenerator(e), this.rawArray[e], this.sr, !0);
	}
	updateAt(e, t) {
		this.rawArray[t] = gt.parsePointSet(e);
	}
	get length() {
		return this.rawArray.length;
	}
	...
	static parsePolygon(t) {
		...
		if (t instanceof yt) n = t.toArray();
		else if (t instanceof gt) n = [t.toArray()];
		else if (Array.isArray(t)) {
			if (t.length === 0) throw Error("no rings provided");
			n = t.map((e) => gt.parsePointSet(e));
		} else throw Error("invalid input format for parsePolygon");
		return n.forEach((e) => bt.closeRing(e)), n;
	}
	static arrayDeepCopy(e) {
		return e.map((e) => e.map((e) => e.slice()));
	}
	...
	get polygonArray() {
		return this.rawArray.map((e, t) => new xt(this.childIdGenerator(t), e, this.sr, !0));
	}
	get type() {
	...
	static parseMultiPolygon(t) {
		if (t instanceof e) return t.toArray();
		if (t instanceof xt) return [t.toArray()];
		if (t instanceof yt || t instanceof gt) return [xt.parsePolygon(t)];
		if (Array.isArray(t)) {
			if (t.length === 0) throw Error("no polygons provided");
			return t.map((e) => xt.parsePolygon(e));
	...
	toPolygon() {
		return new xt(this.id, this.toPolygonArray(), this.sr, !0);
	}
	...
	constructor(e) {
		if (e ||= { style: rt.CIRCLE }, super(), this._style = e.style || rt.CIRCLE, e.style === rt.ICON) {
			let t = e;
			this._icon = t.icon || "", this._height = Tt.convToPoints(t.height) || 16.5, this._width = Tt.convToPoints(t.width) || 16.5, this._size = 0, this._colour = new wt(), this._outline = new Dt(), this._path = "";
		} else {
			let t = e;
			this._size = Tt.convToPoints(t.size) || 12, this._colour = new wt(t.colour ?? "#ffffff40"), this._outline = new Dt(t.outline), this._path = this._style === rt.PATH && t.path || "", this._height = 0, this._width = 0, this._icon = "";
		}
		this._xOffset = Tt.convToPoints(e.xOffset) || 0, this._yOffset = Tt.convToPoints(e.yOffset) || 0, this._angle = e.angle || 0;
	}
	get colour() {
	...
	static fromESRI(e) {
		...
		if (e.type === "simple-marker") {
			let n = t;
			n.style = e.style, n.colour = e.color.toRgba(), n.size = e.size, n.path = e.path, n.outline = Dt.fromESRI(e.outline).toOptions();
		} else {
			let n = t;
			n.style = rt.ICON, n.width = e.width, n.height = e.height, n.icon = e.url;
		}
		return new n(t);
	}
	...
	constructor(e) {
		...
		let t = Tt.convToPoints(e.width);
		this._width = t === void 0 || t < 0 ? .75 : t, this._colour = new wt(e.colour), this._miter = e.miter ?? 2, this._cap = e.cap || ot.ROUND, this._join = e.join || at.ROUND;
	}
	get styleType() {
		return this._style;
	}
...
}, Ot = class e extends Tt {
	_outlineStyle;
	_fillColour;
	_fillStyle;
	constructor(e) {
		super(), e ||= {}, e.fill ||= {}, this._fillColour = new wt(e.fill.colour), this._fillStyle = e.fill.style || st.SOLID, this._outlineStyle = new Dt(e.outline);
	}
	get fillColour() {
	...
	static fromESRI(t) {
		let n = {
			...
			outline: Dt.fromESRI(t.outline).toOptions()
		};
		return new e(n);
	}
	static fromArcServer(t) {
	...
	geomEsriToRamp(e, t) {
		switch (e.type) {
			...
			case "polyline": {
				let n = e;
				return n.paths.length === 1 ? vt.fromESRI(n, t) : yt.fromESRI(n, t);
			}
			case "polygon": return xt.fromESRI(e, t);
			case "extent": return Ct.fromESRI(e, t);
			case "multipoint": return _t.fromESRI(e, t);
	...
	geomGeoJsonToRamp(e, t) {
		switch (e.type) {
			...
			case H.LINESTRING: return vt.fromGeoJSON(e, t);
			case H.POLYGON: return xt.fromGeoJSON(e, t);
			case H.MULTIPOINT: return _t.fromGeoJSON(e, t);
			case H.MULTILINESTRING: return yt.fromGeoJSON(e, t);
			case H.MULTIPOLYGON: return St.fromGeoJSON(e, t);
			default: throw Error(`Encountered unhandled geometry type ${e.type}`);
		}
	}
	geomRampToGeoJson(e) {
	...
	graphicGeoJsonToRamp(e, t) {
		...
		return Object.keys(e.properties.forEach((t) => r[t] = e.properties[t])), new pt(n, "", r);
	}
	graphicRampToEsri(e) {
		let t = {
			attributes: {},
		...
		return t.geometry = this.geomRampToEsri(e.geometry), Object.keys(e.attributes).forEach((n) => t.attributes[n] = e.attributes[n]), e.style && (t.symbol = this.styleRampToEsri(e.style)), new te(t);
	}
	styleRampToEsri(e) {
		return e.toESRI();
	}
	styleEsriToRamp(e) {
		switch (e.type) {
			case "picture-marker":
			case "simple-marker": return Et.fromESRI(e);
			case "simple-line": return Dt.fromESRI(e);
			case "simple-fill": return Ot.fromESRI(e);
			default: return console.error(`Unsupported ESRI symbol type encountered: ${e.type}`), new Et();
		}
	}
	...
	isImageUrl(e) {
		return Et.isImageUrl(e);
	}
	getCentroid(e) {
		let t = (e, t, n) => new Y("centroid", [e, t], n);
		if (e.type === z.POINT) return t(e.x, e.y, e.sr);
		let n = e.toESRI();
		try {
			let r = f(n);
			if (r) return t(r.x, r.y, e.sr);
		} catch {}
		let r = n.extent;
		return r ? t((r.xmin + r.xmax) / 2, (r.ymin + r.ymax) / 2, e.sr) : (console.error("Encountered a geometry that we could not centroid"), console.log(e, n), t(1, 1, void 0));
	}
}, At = class {
	layerIdx;
	name;
	...
	static fromConfig(t) {
		return new e(t.id, Ct.fromConfig(`${t.id}-extent-default`, t.default), t.full === void 0 ? void 0 : Ct.fromConfig(`${t.id}-extent-full`, t.full), t.maximum === void 0 ? void 0 : Ct.fromConfig(`${t.id}-extent-maximum`, t.maximum));
	}
	clone() {
	...
	async projectGeoJson(e, t, n) {
		let r, i;
		if (r = t ? this.normalizeProj(t) : J.parseGeoJsonCrs(e.crs), i = n ? this.normalizeProj(n) : It, i === r) return e;
	...
	async projectGeometry(e, t) {
		...
		let n = t.toGeoJSON(), r = await this.projectGeoJson(n, this.normalizeProj(t.sr), this.normalizeProj(e)), i = Rs.geom.geomGeoJsonToRamp(r, t.id);
	...
	async projectExtent(e, t) {
		...
		let a = new xt("warpy", [i], t.sr, !0), o = await this.projectGeometry(e, a), s = o.toArray().pop() || [], c = s.map((e) => e[0]), l = s.map((e) => e[1]), u = Math.min.apply(null, c), d = Math.max.apply(null, c), f = Math.min.apply(null, l), p = Math.max.apply(null, l);
		return Ct.fromParams(t.id + "_projected", u, f, d, p, o.sr);
	}
}, Rt = class {
	...
	sharedUtils;
	constructor() {
		this.proj = new Lt(), this.geom = new kt(), this.sharedUtils = new Pt();
	}
	defaultTileSchemas() {
...
var Ut = class {
	...
	let e = j({}), t = j([]), n = j([]), r = S(() => t.value.map((t) => t.map((t) => e.value[t]).filter((e) => {
	...
	let e = j([]), t = j({}), n = j({}), r = j(), i = j(0), a = j(0), o = j(0), s = j(!0), c = j();
	function l(t) {
	...
	addDefaultEvents(e) {
		return (!Array.isArray(e) || e.length === 0) && (e = Object.values(Xt)), e.map((e) => this.defaultHandlerFactory(e));
	}
	defaultHandlerFactory(e) {
		...
		switch (e) {
			...
			case "ramp_layer_remove_checks_grid":
				t = (e) => {
					if (this.$iApi.fixture.get("grid")) {
						let t = Gt(this.$vApp.$pinia), n = t.getGridId(e.id);
						if (n === void 0) return;
			...
			case "ramp_map_created_initializes_fixtures":
				t = () => {
					let e = Yt(this.$vApp.$pinia).items;
			...
			case "ramp_map_extent_updates_maptip":
				...
				}, this.$iApi.event.on("map/extentchanged", ze(() => t(), 50, { edges: ["leading"] }), e);
				break;
			...
			case "ramp_map_keydown_updates_coords":
				this.$iApi.event.on("map/keydown", ze(() => {
			...
			case "ramp_map_mouse_updates_coords":
				this.$iApi.event.on("map/mousemove", ze((e) => {
			...
			case "ramp_map_mouse_updates_maptip":
				...
				}, this.$iApi.event.on("map/mousemove", ze((e) => t(e), 50), e);
				break;
			case "ramp_map_mousedown_updates_maptip":
				...
				}, this.$iApi.event.on("map/mousedown", ze((e) => {
					let n = {
						screenX: e.offsetX,
						screenY: e.offsetY,
						button: e.button,
			...
			case "ramp_map_resize_updates_scalebar":
				this.$iApi.event.on("map/resized", Re(() => this.$iApi.geo.map.caption.updateScale(), 100), e);
				break;
			case "ramp_map_scale_updates_scalebar":
				this.$iApi.event.on("map/scalechanged", Re(() => this.$iApi.geo.map.caption.updateScale(), 300), e);
				break;
	...
	en: {
		...
		"layer.diverted.error": "The diverted identify layer for {id} failed to load",
	...
	fr: {
		...
		"layer.diverted.error": "La couche d'identification détournée pour {id} n'a pas pu se charger",
...
function rn() {
	let e = document.documentElement.getAttribute("lang") || en;
	return tn.includes(e) || (e = en), Be({
		legacy: !1,
		locale: e,
		fallbackLocale: en,
		globalInjection: !0,
...
var an = x("maptip", () => {
	...
	__name: "esri-map",
	setup(e) {
		let t = an(), n = ye("iApi"), r = S(() => t.maptipPoint), i = S(() => t.maptipInstance), a = S(() => t.content), o = Ee([]), s = j(!1);
		o.push(Fe(r, () => {
			if (r.value) {
	...
	constructor(e) {
		this.resizeObserver = new ResizeObserver((t) => {
			t.length && window.requestAnimationFrame(() => {
				t.forEach((t) => {
					let n = t.target.dataset.breakpoints, r = n ? JSON.parse(n) : e ?? sn;
	...
	setup(e) {
		...
		return (n, r) => {
			...
			return A(), T("div", {
				...
				default: I(() => [L((A(), C(Ae(e.panel.route.screen), be({ class: "h-full" }, e.panel.route.props, { panel: e.panel }), null, 16, ["panel"])), [[i]])]),
				_: 1
			})], 14, ln);
		};
	}
}), dn = x("panel", () => {
	let e = j(void 0), t = j(void 0), n = j(0), r = j(0), i = j(!1), a = j(!0), o = j(!0), s = j({}), c = j({}), l = j([]), u = j([]), d = j([]), f = j(1), p = S(() => r.value);
	function m(e) {
		return e === "xs" && d.value.length > 0 ? [d.value.slice().pop()] : d.value;
	}
	function h(e) {
		let t = [];
		return e.forEach((e) => {
			e in c.value && t.push(c.value[e].getPromise());
		}), t;
	}
	function g(e) {
		ae(e), y(), t.value = void 0;
	}
	function ee(e) {
		b(e), y();
	}
	...
	function y() {
		let a = n.value, o = [];
		for (let e = l.value.length - 1; e >= 0; e--) {
			let t = l.value[e], n = t.width || 350;
		...
		if (e.value && !o.includes(e.value) && !i.value) {
			...
			let r = l.value.indexOf(e.value), i = l.value.indexOf(n), s = l.value.slice();
			i > -1 && (s.splice(r, 1), s.splice(i, 0, e.value)), l.value = s;
		}
		r.value = a, d.value = o;
	}
	function ie(e) {
		if (s.value = {
			...s.value,
			[e.id]: e
		}, e.id in c.value) c.value[e.id].resolveMe(e);
		else {
			let t = new X();
			t.resolveMe(e), c.value = {
				...c.value,
				[e.id]: t
			};
		}
	...
	function ae(e) {
		e.teleport ? u.value = [...u.value, e] : (l.value = [...l.value, e], t.value = e);
	}
	function b(e) {
		if (e.teleport) {
			let t = u.value.indexOf(e);
			t !== -1 && (u.value = [...u.value.slice(0, t), ...u.value.slice(t + 1)]);
		} else {
	...
	function oe(e, t) {
		let n = l.value.indexOf(e), r = t === "right" ? 1 : -1;
		d.value.includes(l.value[n + r]) && ([l.value[n], l.value[n + r]] = [l.value[n + r], l.value[n]]);
	}
	function se(t) {
		s.value[t.id] !== void 0 && delete s.value[t.id], c.value[t.id] !== void 0 && delete c.value[t.id];
		let n = d.value.indexOf(t);
		n !== -1 && (d.value = [...d.value.slice(0, n), ...d.value.slice(n + 1)]), e.value && e.value.id == t.id && (e.value = void 0);
	}
	function x(e) {
		c.value = {
			...c.value,
...
}), fn = /*#__PURE__*/ ne(/* @__PURE__ */ D({
	__name: "panel-stack",
	setup(e) {
		Me((e) => ({ v3d36ee4c: i.value }));
		let t = dn(), n = ye("iApi"), r = j(), i = S(() => t.opacity), a = S(() => t.mobileView);
		we(() => {
		...
		return (e, t) => (A(), C(fe, {
			...
			default: I(() => [(A(!0), T(le, null, Oe(o(F(n).screenSize), (e) => (A(), C(un, {
				key: `${e.id}`,
				panel: e
			}, null, 8, ["panel"]))), 128))]),
			_: 1
...
}), [["__scopeId", "data-v-717e4bd7"]]), pn = ["content", "aria-label"], mn = /* @__PURE__ */ D({
	...
	setup(e) {
		let t = j(!1), n = j(null), r = Ee([]), i = j(), a = j(), o = j(), s = e;
		r.push(Fe(t, () => {
			n.value.update();
		}));
		let c = () => {
	...
	let e = 0, t = j([]), n = j({}), r = S(() => t.value.length >= 99 ? 99 : t.value.length);
	function i(n) {
		let r = {
			...n,
			id: `notif-${e++}`
	...
	function a(e) {
		if (t.value.includes(e)) {
			...
			e instanceof Sn && l(e), n > -1 && t.value.splice(n, 1);
		}
	}
	function o(e) {
		n.value[e.id] = e;
...
}), gn = { class: "h-full flex flex-col" }, _n = { class: "w-full flex mb-6" }, vn = ["content", "aria-label"], yn = /* @__PURE__ */ D({
	__name: "screen",
	props: { panel: {
		type: Object,
		required: !0
	...
	setup(e) {
		let t = hn(), { t: n } = R(), r = S(() => t.notificationNumber), i = () => t.clearAll();
		return (t, a) => {
			let o = M("panel-screen"), s = N("tippy");
			return A(), C(o, { panel: e.panel }, {
				header: I(() => [me(P(F(n)("notifications.title")), 1)]),
				content: I(() => [E("div", gn, [E("div", _n, [L((A(), T("button", {
					type: "button",
					onClick: i,
	...
	constructor(e) {
		super(e), this.$iApi.panel.register({
			id: "notifications",
			config: {
				screens: { "notifications-screen": O(yn) },
				alertName: "notifications.title"
			}
		}), this.notificationStore = hn(this.$vApp.$pinia);
	}
	show(e, t) {
	...
	notificationStore = hn(this.$vApp.$pinia);
	id;
	message;
	type;
	messageList = [];
...
}, Cn = ["content"], wn = { class: "flex items-center text-left" }, Tn = { class: "select-text cursor-text" }, En = ["content", "aria-label"], Dn = {
	key: 0,
	class: "text-left"
}, On = /* @__PURE__ */ D({
	...
	setup(e, { emit: t }) {
		...
		return (t, i) => {
			...
			return L((A(), T("li", {
				...
				E("span", null, [me(P(o[e.notification.type]) + " ", 1), E("span", Tn, P(e.notification.message), 1)]),
				i[4] ||= E("span", { class: "flex-grow" }, null, -1),
				e.notification.messageList ? (A(), T("div", {
					key: 0,
				...
				L((A(), T("button", {
					...
					"fill-rule": "evenodd"
				}, [E("path", { d: "M11.17,37.16H94.65a8.4,8.4,0,0,1,2,.16,5.93,5.93,0,0,1,2.88,1.56,5.43,5.43,0,0,1,1.64,3.34,7.65,7.65,0,0,1-.06,1.44L94,117.31v0l0,.13,0,.28v0a7.06,7.06,0,0,1-.2.9v0l0,.06v0a5.89,5.89,0,0,1-5.47,4.07H17.32a6.17,6.17,0,0,1-1.25-.19,6.17,6.17,0,0,1-1.16-.48h0a6.18,6.18,0,0,1-3.08-4.88l-7-73.49a7.69,7.69,0,0,1-.06-1.66,5.37,5.37,0,0,1,1.63-3.29,6,6,0,0,1,3-1.58,8.94,8.94,0,0,1,1.79-.13ZM5.65,8.8H37.12V6h0a2.44,2.44,0,0,1,0-.27,6,6,0,0,1,1.76-4h0A6,6,0,0,1,43.09,0H62.46l.3,0a6,6,0,0,1,5.7,6V6h0V8.8h32l.39,0a4.7,4.7,0,0,1,4.31,4.43c0,.18,0,.32,0,.5v9.86a2.59,2.59,0,0,1-2.59,2.59H2.59A2.59,2.59,0,0,1,0,23.62V13.53H0a1.56,1.56,0,0,1,0-.31v0A4.72,4.72,0,0,1,3.88,8.88,10.4,10.4,0,0,1,5.65,8.8Zm42.1,52.7a4.77,4.77,0,0,1,9.49,0v37a4.77,4.77,0,0,1-9.49,0v-37Zm23.73-.2a4.58,4.58,0,0,1,5-4.06,4.47,4.47,0,0,1,4.51,4.46l-2,37a4.57,4.57,0,0,1-5,4.06,4.47,4.47,0,0,1-4.51-4.46l2-37ZM25,61.7a4.46,4.46,0,0,1,4.5-4.46,4.58,4.58,0,0,1,5,4.06l2,37a4.47,4.47,0,0,1-4.51,4.46,4.57,4.57,0,0,1-5-4.06l-2-37Z" })], -1)]], 8, En)), [[c, {
					theme: "ramp4",
					animation: "scale"
				}]])
			]), e.notification.messageList && a.value ? (A(), T("div", Dn, [(A(!0), T(le, null, Oe(e.notification.messageList, (t, n) => (A(), T("p", { key: e.notification.id + t + n }, P(t), 1))), 128))])) : w("", !0)], 10, Cn)), [[c, {
				onShow: s,
				theme: "ramp4",
				animation: "scale"
			}]]);
	...
	setup(e) {
		...
		return (e, t) => {
			...
			return A(), T("div", null, [c.value.length > 0 ? L((A(), T("ul", {
				key: 0,
				content: F(n)("panels.controls.items"),
				ref_key: "el",
				ref: r,
				class: "h-full overflow-y-auto"
			}, [(A(!0), T(le, null, Oe(c.value, (e, t) => (A(), T(le, { key: e.id }, [t > 0 ? (A(), T("div", An)) : w("", !0), L(he(On, {
				ref_for: !0,
				...
				E("span", null, P(F(n)("notifications.empty")), 1),
				t[2] ||= E("span", { style: { "flex-grow": "6" } }, null, -1)
			]))]);
		};
	}
}), Nn = { class: "flex items-center" }, Pn = ["aria-label"], Fn = {
	key: 0,
	class: "number rounded-full w-18 text-white"
}, In = { class: "notification-dropdown pointer-events-auto bg-white rounded text-center text-black w-500 h-256 flex flex-col p-0" }, Ln = { class: "pb-8 border-b border-gray-600" }, Rn = { class: "absolute flex right-3 top-3" }, zn = ["content", "aria-label"], Bn = /*#__PURE__*/ ne(/* @__PURE__ */ D({
	...
	setup(e) {
		...
		return (e, t) => {
			...
			return A(), C(mn, {
				...
				header: I(() => [E("div", Nn, [(A(), T("svg", {
					class: "fill-current w-24 h-24",
					xmlns: "http://www.w3.org/2000/svg",
					viewBox: "0 0 24 24",
					"aria-label": F(n)("notifications.open")
				}, [...t[0] ||= [E("path", { d: "M12 22c1.1 0 2-.9 2-2h-4c0 1.1.89 2 2 2zm6-6v-5c0-3.07-1.64-5.64-4.5-6.32V4c0-.83-.67-1.5-1.5-1.5s-1.5.67-1.5 1.5v.68C7.63 5.36 6 7.92 6 11v5l-2 2v1h16v-1l-2-2z" }, null, -1)]], 8, Pn)), r.value && r.value > 0 ? (A(), T("span", Fn, P(r.value), 1)) : w("", !0)])]),
				default: I((e) => [E("div", In, [E("div", null, [E("h4", Ln, P(F(n)("notifications.title")), 1), E("div", Rn, [L((A(), T("button", {
					type: "button",
					onClick: i,
					...
					animation: "scale",
					appendTo: "parent"
				}]]), he(a, { onClick: e.close }, null, 8, ["onClick"])])]), he(Mn, { class: "overflow-y-auto h-230" })])]),
				_: 1
			}, 8, ["tooltip"]);
		};
	}
}), [["__scopeId", "data-v-28078ee6"]]), Vn = { class: "flex" }, Hn = ["aria-label"], Un = { class: "about-ramp-dropdown pointer-events-auto bg-white rounded w-256 h-50" }, Wn = ["aria-label", "content"], Gn = { class: "pb-8 pt-1 border-b border-gray-600 mb-10" }, Kn = { class: "absolute right-5 top-5" }, qn = { class: "select-text" }, Jn = { class: "font-bold cursor-text" }, Yn = { class: "text-sm cursor-text" }, Xn = { class: "font-bold cursor-text" }, Zn = { class: "ml-5 cursor-text" }, Qn = { class: "mt-5" }, $n = ["href"], er = /*#__PURE__*/ ne(/* @__PURE__ */ D({
	...
	setup(e) {
		let { t } = R(), n = ye("iApi"), r = () => {
			n.reload();
		}, i = S(() => `${Ps.major}.${Ps.minor}.${Ps.patch}`), a = S(() => Ps.hash.slice(0, 9)), o = S(() => {
			let e = new Date(Ps.timestamp);
			...
			return L((A(), C(l, {
				...
				default: I((e) => [E("div", Un, [E("div", null, [
					L((A(), T("button", {
						...
						xmlns: "http://www.w3.org/2000/svg",
						viewBox: "0 0 24 24"
					}, [E("path", { d: "M17.65 6.35C16.2 4.9 14.21 4 12 4c-4.42 0-7.99 3.58-7.99 8s3.57 8 7.99 8c3.73 0 6.84-2.55 7.73-6h-2.08c-.82 2.33-3.04 4-5.65 4-3.31 0-6-2.69-6-6s2.69-6 6-6c1.66 0 3.14.69 4.22 1.78L13 11h7V4l-2.35 2.35z" })], -1)]], 8, Wn)), [[u, {
						placement: "bottom-start",
						theme: "ramp4",
						animation: "scale"
					}]]),
					E("h4", Gn, P(F(t)("ramp.about")), 1),
					E("div", Kn, [he(c, { onClick: e.close }, null, 8, ["onClick"])]),
					E("div", qn, [
						E("div", null, [E("span", Jn, P(i.value), 1), E("span", Yn, " [" + P(a.value) + "] ", 1)]),
						E("div", null, [E("span", Xn, P(o.value[0]), 1), E("span", Zn, P(o.value[1]), 1)]),
...
}), [["__scopeId", "data-v-966796d3"]]), tr = "__HELP__", nr = x("keyboardnav", () => {
	...
	function d(e, t, n) {
		if (e) {
			...
			if (e === "reset") {
				let e = n ?? y.activeNamespace ?? y.keyChain[1];
				if (!e) {
					h({ suppressHandler: !0 });
					return;
				}
				g(["S", e]), _(void 0), v("awaitAction"), y.activeNamespace = e;
			}
		}
	}
	function f(n, r, i) {
		e.value = n, !i?.suppressHandler && t.value[n]?.activeHandler?.(y, r);
	}
	function p(n, r) {
		e.value && !r?.suppressHandler && t.value[e.value]?.deactiveHandler?.(y, n), e.value = void 0;
	}
	function m(n, r) {
		let i = e.value;
		if (!i) return;
	...
	return re;
}), rr = { class: "map-caption absolute bottom-0 h-29 sm:h-38 flex justify-end pointer-events-auto cursor-default select-none text-gray-200 bg-black-75 left-0 right-0 py-2 sm:py-6" }, ir = {
	key: 0,
	class: "relative ml-10 top-2 text-sm sm:text-base font-mono flex items-center gap-2",
	"aria-live": "polite"
}, ar = { class: "chain-content" }, or = { class: "chain-keys" }, sr = {
	key: 0,
	class: "chain-cursor"
}, cr = {
	key: 1,
...
}, dr = { class: "flex min-w-fit justify-end" }, fr = {
	key: 0,
	...
	"aria-label",
	"content"
], mr = { class: "relative top-1 text-sm sm:text-base" }, hr = { class: "text-gray-200 hover:text-white text-sm sm:text-base pb-5" }, gr = ["onClick"], _r = {
	key: 0,
	class: "sr-only"
}, vr = /* @__PURE__ */ D({
	__name: "map-caption",
	setup(e) {
		let t = Kt(), n = nr(), r = v(), { t: i } = R(), a = ye("iApi"), o = S(() => t.scale), s = S(() => t.attribution), c = S(() => t.coords), l = S(() => t.langtoggle), u = S(() => r.config.map), { keyChain: d, lastAction: f, chainState: p, namespaces: m, activeNamespace: h } = ce(n), g = S(() => {
		...
		return (e, t) => {
			...
			return A(), T("div", rr, [
				...
				he(Bn, { class: "sm:block display-none" }),
				g.value ? (A(), T("span", ir, [E("span", ar, [
					t[0] ||= E("span", { class: "chain-colon" }, ":", -1),
					E("span", or, P(g.value.keys), 1),
					g.value.cursor ? (A(), T("span", sr, "_")) : w("", !0),
					g.value.options ? (A(), T("span", cr, P(g.value.options), 1)) : w("", !0)
				]), g.value.description ? (A(), T("span", lr, "- " + P(g.value.description) + "...", 1)) : w("", !0)])) : s.value?.text.disabled ? w("", !0) : L((A(), T("span", ur, [me(P(s.value?.text.value), 1)])), [[r, { options: {
					placement: "top",
					hideOnClick: !1,
					theme: "ramp4",
					animation: "scale"
				...
				E("div", dr, [
					c.value?.disabled ? w("", !0) : L((A(), T("div", fr, [me(P(c.value?.formattedString), 1)])), [[r, { options: {
						hideOnClick: !1,
						theme: "ramp4",
						animation: "scale"
					} }]]),
					o.value?.disabled ? w("", !0) : L((A(), T("button", {
						key: 1,
						type: "button",
                ...
                `,
						...
						style: Se({ width: o.value?.width })
					}, null, 4), E("span", mr, P(o.value?.label), 1)], 8, pr)), [[u, {
						delay: [300, 0],
						placement: "top",
						hideOnClick: !1,
						theme: "ramp4",
					...
					l.value?.disabled ? w("", !0) : (A(), C(n, {
						...
						header: I(() => [E("span", hr, P(F(i)("map.language.short")), 1)]),
						default: I(() => [(A(!0), T(le, null, Oe(ee.value, (e, t) => (A(), T("a", {
							key: `${e}-${t}`,
							class: k(["flex-auto items-center text-sm sm:text-base cursor-pointer", { "font-bold": e === F(a).$i18n.locale.value }]),
							href: "javascript:;",
							onClick: (t) => _(e)
						}, [me(P(F(i)("map.language." + e)) + " ", 1), e === F(a).$i18n.locale.value ? (A(), T("span", _r, P(F(i)("map.language.curr")), 1)) : w("", !0)], 10, gr))), 128))]),
						_: 1
					}, 8, ["tooltip", "ariaLabel"]))
				])
			]);
...
}), yr = ["content", "aria-label"], br = {
	key: 0,
	class: "number absolute -top-2 -right-2 text-white w-18 rounded-full"
}, xr = /*#__PURE__*/ ne(/* @__PURE__ */ D({
	__name: "floating-button",
	setup(e) {
		let t = hn(), n = ye("iApi"), { t: r } = R(), i = S(() => t.notificationNumber);
		return (e, t) => {
			let a = N("tippy");
			return L((A(), T("button", {
				type: "button",
				...
				xmlns: "http://www.w3.org/2000/svg",
				viewBox: "0 0 24 24"
			}, [E("path", { d: "M12 22c1.1 0 2-.9 2-2h-4c0 1.1.89 2 2 2zm6-6v-5c0-3.07-1.64-5.64-4.5-6.32V4c0-.83-.67-1.5-1.5-1.5s-1.5.67-1.5 1.5v.68C7.63 5.36 6 7.92 6 11v5l-2 2v1h16v-1l-2-2z" })], -1), i.value && i.value > 0 ? (A(), T("span", br, P(i.value), 1)) : w("", !0)], 8, yr)), [[a]]);
		};
	}
}), [["__scopeId", "data-v-a451db5c"]]), Sr = { class: "flex items-center mb-20" }, Cr = { class: "text-xl" }, wr = /* @__PURE__ */ D({
	__name: "keyboard-instructions",
	setup(e) {
		let t = ye("iApi"), { t: n } = R(), r = j(!1), i = j([
			"app",
			"lists",
			"map",
			"keyboardNav"
		...
		return (e, t) => {
			...
			return r.value ? (A(), T("div", {
				...
				E("div", Sr, [E("h2", Cr, P(F(n)("keyboardInstructions.title")), 1), he(a, {
					class: "ml-auto",
					onClick: t[0] ||= (e) => r.value = !1
				})]),
				(A(!0), T(le, null, Oe(i.value, (e) => (A(), T("p", {
...
}), Tr = x("instance", () => ({ started: j(!1) })), Er = { class: "h-full relative" }, Dr = { class: "inner-shell absolute top-0 left-0 h-full w-full pointer-events-none" }, Or = { class: "absolute top-8 w-full flex justify-center" }, kr = {
	key: 1,
	class: "w-full h-full"
}, Ar = D({
	name: "App",
	components: { Shell: /* @__PURE__ */ ne(/* @__PURE__ */ D({
		__name: "shell",
		setup(e) {
			let t = ye("iApi"), n = Tr(), r = Yt(), i = dn(), { t: a } = R(), o = S(() => r.items.appbar), s = () => {
				t.event.emit("openKeyboardInstructions");
			}, c = () => i.teleported;
			return (e, t) => (A(), T("div", Er, [
				E("div", Dr, [
					...
					he(wr, { class: "keyboard-instructions-modal" }),
					he(fn, { class: "panel-stack sm:flex absolute inset-0 overflow-hidden sm:p-12 z-10 sm:pl-80 xs:pl-40 sm:pb-48 xs:pb-28 xs:pr-0 sm:pr-40" }),
					o.value ? w("", !0) : (A(), C(xr, { key: 0 })),
					he(vr, { class: "z-30" })
				]),
				F(n).started ? (A(), C(on, { key: 0 })) : (A(), T("div", kr, [...t[1] ||= [E("div", { class: "spinner relative inset-x-1/2 inset-y-9/20" }, null, -1)]])),
				(A(!0), T(le, null, Oe(c(), (e) => (A(), C(ue, {
	...
	setup() {
		let e = _e();
		we(() => {
			new cn().observe(e?.proxy?.$refs["app-size"]), qe({
...
function Nr(e, t, n, r, i, a) {
	...
	return A(), T("div", {
		...
		lang: e.$i18n.locale
	}, [E("div", Mr, [he(o)], 512)], 8, jr);
}
var Pr = /*#__PURE__*/ ne(Ar, [["render", Nr]]), Fr = "focus-list", Ir = "focus-item", Lr = "focus-icon", Rr = `[${Fr}],[focus-container]`, zr = "truncate-text", Br = "show-truncate", Vr = "focused", Hr = `button,input,select,a,textarea,[contenteditable],[${Fr}],[${Lr}],[tabindex]`, Ur = {
	mounted(e, t) {
...
var Yr = "focus-container", Xr = "focus-container-active", Zr = "focus-list", Qr = "focus-icon", $r = `[${Zr}],[${Yr}]`, ei = `button,input,select,a,textarea,[contenteditable],.ag-tab-guard,[${Zr}],[${Yr}],[${Qr}],[tabindex]`, ti = {
	childList: !0,
	subtree: !0,
	attributes: !0,
	attributeFilter: [
...
var di = ["content"], fi = {
...
}, vi = "focus-container", yi = "focus-container-active", bi = /* @__PURE__ */ D({
	__name: "panel-screen",
	props: {
		header: {
			type: Boolean,
	...
	setup(e, { expose: t }) {
		let { t: n } = R(), r = dn(), i = Wt(), a = ye("iApi"), o = Ne("el"), s = Ne("contentEl"), c = j(), l = j(), u = j();
		t({ el: o });
		let d = e, f = S(() => a.fixture.get("appbar") ? i.temporary : []), p = S(() => r.mobileView), m = S(() => r.reorderable), h = S(() => r.pinable), g = `[focus-list], [${vi}]`, ee = (e) => e.scrollHeight > e.clientHeight, te = (e) => e.querySelector(g), _ = () => {
			if (!s.value) return "-1";
			let e = s.value.closest(`[${vi}]`);
			if (e && !e.hasAttribute(yi)) return "-1";
			let t = !!te(s.value);
			return ee(s.value) && !t ? "0" : "-1";
		}, v = () => {
			if (!s.value) return;
			let e = _();
			...
			re(e, o.value) && o.value?._tippy?.show();
		}, ae = () => !p.value && !d.panel.teleport, b = (e) => {
			d.panel.move(e), e === "left" && xe(() => {
				(o.value?.querySelector(".move-left")).focus();
			});
		}, oe = S(() => d.screenId ? d.panel.screens[d.screenId][a.$i18n.locale.value ?? "en"] : null);
		return we(() => {
			o.value?.addEventListener("blur", y), o.value?.addEventListener("keyup", ie), s.value && (s.value.addEventListener("focus", ne), c.value = new ResizeObserver(v), c.value.observe(s.value), l.value = new MutationObserver(v), l.value.observe(s.value, {
				childList: !0,
				subtree: !0,
				attributes: !0,
			...
			o.value?.removeEventListener("blur", y), o.value?.removeEventListener("keyup", ie), s.value?.removeEventListener("focus", ne), c.value?.disconnect(), l.value?.disconnect(), u.value?.disconnect();
		}), (t, r) => {
			let i = M("back"), a = M("panel-options-menu"), c = M("left"), l = M("right"), u = M("pin"), d = M("expand"), p = M("minimize"), g = M("close"), ee = N("truncate"), te = N("focus-item"), _ = N("tippy");
			return L((A(), T("div", {
				...
				e.header ? (A(), T("header", fi, [
					he(i, {
						class: k(e.panel.teleport ? "display-none" : "block sm:display-none"),
						onClick: r[0] ||= (t) => e.panel.close()
					}, null, 8, ["class"]),
					L((A(), T("h2", pi, [t.$slots.header ? ke(t.$slots, "header", { key: 0 }) : (A(), T("div", mi, P(F(n)(e.panel.alertName)), 1))])), [[ee]]),
					t.$slots.controls ? (A(), C(a, { key: 0 }, {
						default: I(() => [ke(t.$slots, "controls")]),
						_: 3
					})) : w("", !0),
					E("div", { class: k(e.panel.teleport ? "flex" : "display-none sm:flex") }, [
						e.panel.teleport ? w("", !0) : (A(), T("div", hi, [
							m.value ? (A(), C(c, {
								key: 0,
							...
							e.panel.controls && e.panel.controls.expand ? (A(), C(d, {
								key: 3,
								onClick: r[4] ||= (t) => e.panel.expand(),
								active: e.panel.expanded
							}, null, 8, ["active"])) : w("", !0)
						])),
						e.panel.button && f.value?.includes(e.panel.id) ? (A(), C(p, {
							key: 1,
							onClick: r[5] ||= (t) => e.panel.minimize()
						})) : w("", !0),
						he(g, { onClick: r[6] ||= (t) => e.panel.close() })
					], 2)
				])) : w("", !0),
				e.content ? (A(), T("div", {
					key: 1,
					...
					ref: s,
					tabindex: "-1"
				}, [t.$slots.content ? ke(t.$slots, "content", { key: 0 }) : oe.value ? (A(), T("div", {
					key: 1,
					innerHTML: oe.value.innerHTML
				}, null, 8, gi)) : w("", !0)], 512)) : w("", !0),
				e.footer ? L((A(), T("div", _i, [ke(t.$slots, "footer")])), [[te]]) : w("", !0)
			], 8, di)), [[_, {
				trigger: "manual",
				touch: !1,
				onShow: ae,
...
}), xi = { class: "relative" }, Si = ["content", "aria-label"], Ci = ["transform"], wi = /* @__PURE__ */ D({
	__name: "pin",
	...
	setup(e) {
		...
		return (n, r) => {
			let i = N("tippy");
			return A(), T("div", xi, [L((A(), T("button", {
				type: "button",
...
}), Ti = { class: "relative" }, Ei = ["content", "aria-label"], Di = /* @__PURE__ */ D({
	__name: "close",
	props: { active: Boolean },
	setup(e) {
		let { t } = R();
		return (n, r) => {
			let i = N("tippy");
			return A(), T("div", Ti, [L((A(), T("button", {
				type: "button",
				class: k(["text-gray-500 hover:text-black focus:text-black p-8", { "text-gray-700": e.active }]),
...
}), Oi = { class: "relative" }, ki = ["content", "aria-label"], Ai = /* @__PURE__ */ D({
	__name: "back",
	props: { active: Boolean },
	setup(e) {
		let { t } = R();
		return (n, r) => {
			let i = N("tippy");
			return A(), T("div", Oi, [L((A(), T("button", {
				type: "button",
				class: k(["text-gray-500 hover:text-black focus:text-black p-8", { "text-gray-700": e.active }]),
	...
	setup(e) {
		...
		return (n, r) => {
			let i = N("tippy");
			return A(), T("div", ji, [L((A(), T("button", {
				type: "button",
...
}), Ii = { class: "relative" }, Li = ["content", "aria-label"], Ri = /* @__PURE__ */ D({
	__name: "minimize",
	props: { active: Boolean },
	setup(e) {
		let { t } = R();
		return (n, r) => {
			let i = N("tippy");
			return A(), T("div", Ii, [L((A(), T("button", {
				type: "button",
				...
				d: "M0 0h24v24H0V0z",
				fill: "none"
			}), E("path", { d: "M6 19h12v2H6z" })], -1)]], 10, Li)), [[i, {
				placement: "bottom",
				theme: "ramp4",
				animation: "scale"
			}]])]);
...
var Bi = { class: "relative" }, Vi = ["content", "aria-label"], Hi = /* @__PURE__ */ D({
	__name: "right",
	props: { active: Boolean },
	setup(e) {
		let { t } = R(), n = e, r = j(null), { syncTooltipAfterKeyboardMove: i } = zi(r, () => !!n.active);
		return (n, a) => {
			let o = N("tippy");
			return A(), T("div", Bi, [L((A(), T("button", {
				ref_key: "buttonRef",
				ref: r,
				type: "button",
				class: k(["p-8", {
				...
				xmlns: "http://www.w3.org/2000/svg",
				viewBox: "4 4 16 16"
			}, [E("path", { d: "M 8.59 16.34 L 13.17 11.75 L 8.59 7.16 L 10 5.75 L 16 11.75 L 10 17.75 Z" })], -1)]], 10, Vi)), [[o, {
				placement: "bottom",
				theme: "ramp4",
				animation: "scale"
			}]])]);
...
}), Ui = { class: "relative" }, Wi = ["content", "aria-label"], Gi = /* @__PURE__ */ D({
	__name: "left",
	props: { active: Boolean },
	setup(e) {
		let t = e, { t: n } = R(), r = j(null), { syncTooltipAfterKeyboardMove: i } = zi(r, () => !!t.active);
		return (t, a) => {
			let o = N("tippy");
			return A(), T("div", Ui, [L((A(), T("button", {
				ref_key: "buttonRef",
				ref: r,
				type: "button",
				...
				xmlns: "http://www.w3.org/2000/svg",
				viewBox: "4 4 16 16"
			}, [E("path", { d: "M 15.41 16.09 L 10.83 11.5 L 15.41 6.91 L 14 5.5 L 8 11.5 L 14 17.5 Z" })], -1)]], 10, Wi)), [[o, {
				placement: "bottom",
				theme: "ramp4",
				animation: "scale"
			}]])]);
	...
	setup(e) {
		...
		return (e, n) => (A(), C(mn, {
			...
			header: I(() => [...n[0] ||= [E("div", { class: "p-6" }, [E("svg", {
				xmlns: "http://www.w3.org/2000/svg",
				viewBox: "0 0 24 24",
				class: "fill-current w-20 h-20"
			...
			default: I(() => [ke(e.$slots, "default", {}, void 0, !0)]),
			_: 3
		}, 8, ["tooltip"]));
	}
	...
	setup(e) {
		...
		return (e, i) => {
			...
			return A(), C(a, {
				...
				default: I(() => [F(n).isFullscreen ? (A(), T("svg", qi, [...i[0] ||= [E("path", {
					d: "M0 0h24v24H0z",
					fill: "none"
				}, null, -1), E("path", { d: "M5 16h3v3h2v-5H5v2zm3-8H5v2h5V5H8v3zm6 11h2v-3h3v-2h-5v5zm2-11V5h-2v5h5V8h-3z" }, null, -1)]])) : (A(), T("svg", Ji, [...i[1] ||= [E("path", {
					d: "M0 0h24v24H0z",
					fill: "none"
	...
	setup(e) {
		let { t } = R(), n = ye("iApi"), r = async () => {
			let e = await n.geo.getGeolocation();
			e.success && n.geo.map.zoomMapTo(e.coord);
		};
		return (e, n) => {
	...
	setup(e) {
		return (t, n) => {
			...
			return A(), T("div", Qi, [L((A(), T("button", {
				type: "button",
			...
			}, [ke(t.$slots, "default", {}, void 0, !0)], 10, $i)), [[r], [i, { placement: "left" }]])]);
		};
	}
}), [["__scopeId", "data-v-bafb7e3d"]]), ta = {
	class: "relative",
	tabindex: "-1"
}, na = ["aria-label", "content"], ra = /*#__PURE__*/ ne(/* @__PURE__ */ D({
	__name: "button",
	props: {
		onClickFunction: {
			type: Function,
	...
	setup(e) {
		let t = ye("iApi"), n = e, r = () => t.event.emit(Q.APPBAR_BUTTON_CLICK, n.buttonId);
		return (t, n) => {
			let i = N("focus-item"), a = N("tippy");
			return A(), T("div", ta, [L((A(), T("button", {
				type: "button",
...
}), [["__scopeId", "data-v-1cb84ae1"]]), ia = x("areas-of-interest", () => ({ areas: j([]) })), aa = x("export", () => {
	let e = j({
		title: !0,
		map: !0,
		mapElements: !0,
...
var Fa = x("geosearch", () => {
	let e = j(new Na("en", void 0)), t = j({
		type: "",
		province: "",
		extent: void 0
	}), n = j(!1), r = j(""), i = j(""), a = j(""), o = j([]), s = j([]), c = j(!1), l = j([]), u = S(() => e.value.fetchProvinces().then((e) => (e.sort((e, t) => e.name.localeCompare(t.name, void 0, { sensitivity: "case" })), e))), d = S(() => new Promise((t) => {
		...
		if (!u) o.value = [], s.value = [], c.value = !1;
			...
			let r = setInterval(() => {
				e.value.config.provinces.listFetched && e.value.config.types.typesFetched && (clearInterval(r), e.value.query(`${u}*`).then((e) => {
					l.value = e.failedServs, a.value = u, s.value = e.results;
					let r = Pa(n.value, t.value, s.value);
					o.value = r || [], c.value = !1;
				}));
			}, 250);
		} else {
			let e = Pa(n.value, t.value, s.value);
			o.value = e || [], c.value = !1;
		}
	}
	function h(e) {
	...
	_visibleChildren;
	constructor(e, t, n) {
		super(e), this._uid = Rs.sharedUtils.generateUUID(), this._name = t.name, this._type = t.type ?? "placeholder", this._parent = n, this._children = [], this._loadPromise = new X(), this._hidden = t.hidden ?? !1, this._expanded = t.expanded ?? !0, this._visibility = !0, this._exclusive = t.exclusive ?? !1, this._controls = t.controls?.slice() ?? ["visibilityButton", "expandButton"], this._disabledControls = t.disabledControls?.slice(), this._visibleChildren = [];
	}
	get uid() {
		return this._uid;
	}
	...
	toggleVisibility(e, t = !0) {
		if (this.visibility !== e) {
			...
			else if (this.visibility) if (this._lastVisible && (!(this._lastVisible instanceof za) || this._lastVisible.layerControlAvailable(q.Visibility))) this._lastVisible.toggleVisibility(!0);
			else {
				let e = this.children.find((e) => !(e instanceof za) || e.layerControlAvailable(q.Visibility));
	...
	checkVisibility(e) {
		this instanceof za && !this.layerControlAvailable(q.Visibility) || (this.exclusive ? e.visibility ? (this.children.forEach((t) => {
	...
	reload() {
		this._type = "placeholder", this._loadPromise = new X();
	}
	error() {
	...
	load(e) {
		...
		t && (this.layer = t, this._layerRedrawing = t.mapLayer && t.drawState !== dt.UP_TO_DATE, t.loadPromise().then(() => {
			this._layerInitVis = this._layerInitVis === void 0 ? t.visibility : this._visibility, super.load(), this.toggleVisibility(this._layerInitVis, !0, !0), t.visibility || this.setSymbologyVisibility(void 0, !1), this.handlers.push(this.$iApi.event.on(Q.LAYER_VISIBILITYCHANGE, (e) => {
				...
				this.layer.uid === e.layer.uid && (e.layer.drawState === dt.REFRESH ? this.layerRedrawing = !0 : setTimeout(() => {
					this.layerRedrawing = e.layer.drawState === dt.REFRESH;
				}, 500));
	...
	_content;
	constructor(e, t, n) {
		super(e, t, n), this._infoType = t.infoType ?? "title", this._content = t.content ?? "", t.infoType === "template" && this.$element.component(`${this._uid}-info-section`, { template: this._content }), (t.infoType || t.content) && (this._controls = t.controls?.slice() ?? [Ia.Expand]), super.load();
	}
	get infoType() {
	...
	_isFullscreen;
	constructor(e, t, n) {
		this.event = new Qt(this);
		let r = Za(e, this);
		this.$vApp = r.app, this.$element = r.element, this.$i18n = r.i18n, this.$rootEl = r.app.$root?.$el, this.fixture = new fs(this), this.panel = new ms(this), this.geo = new ls(this), this.dev = new xs(this), this.ui = {
			...
			escapeHtml: () => "",
			isPlainText: () => !0
		}, this.notify = new xn(this), this._isFullscreen = Ve.isEnabled && !!this.$vApp.$root && Ve.isFullscreen && Ve.element === this.$vApp.$root.$el, Ve.isEnabled && Ve.onchange(() => {
			this._isFullscreen = Ve.isEnabled && !!this.$vApp.$root && Ve.isFullscreen && Ve.element === this.$vApp.$root.$el;
		}), this.initialize(!0, t, n);
	}
	initialize(e, t, n) {
		let r = v(this.$vApp.$pinia), i = dn(this.$vApp.$pinia), a = an(this.$vApp.$pinia);
		if (t?.configs !== void 0) {
			...
			if (n.panels) {
				...
				i.reorderable = n.panels.reorderable ?? !0, i.pinable = n.panels.pinable ?? !0;
			}
			!n.system?.animate && this.$element._container && this.$element._container.children[0] && this.$element._container.children[0].classList.remove("animation-enabled"), n.system?.proxyUrl && (this.geo.proxy = n.system.proxyUrl), n.system?.exposeOid && (this.ui.exposeOids = n.system.exposeOid), n.system?.exposeMeasurements != null && (this.ui.exposeMeasurements = n.system.exposeMeasurements), n.system?.scrollToInstance && (this.ui.scrollToInstance = n.system?.scrollToInstance), n.system?.suppressNumberLocalization && (this.ui.suppressNumberLocalization = n.system?.suppressNumberLocalization), n.system?.showThousandsSeparator && (this.ui.showThousandsSeparator = n.system?.showThousandsSeparator);
			let s = {
			...
			this.ui.getZoomIcon = () => l, this.ui.formatNumber = (e) => this.ui.suppressNumberLocalization ? e.toString() : this.$i18n.n(e, {
				key: "number",
				useGrouping: this.ui.showThousandsSeparator
			}), this.ui.escapeHtml = (e) => {
				let t = {
					"<": "&lt;",
					">": "&gt;",
					"\"": "&quot;",
	...
	reloadWorker(e, t) {
		let n = Tr(this.$vApp.$pinia), r = hn(this.$vApp.$pinia), i = v(this.$vApp.$pinia), a = Yt(this.$vApp.$pinia), o = _(this.$vApp.$pinia), s = Gt(this.$vApp.$pinia), c = !!e;
	...
	useStore(e) {
		if (!([
			...
			case "appbar": return Wt(this.$vApp.$pinia);
			case "areas-of-interest": return ia(this.$vApp.$pinia);
			case "details": return Jt(this.$vApp.$pinia);
			case "export": return aa(this.$vApp.$pinia);
			case "extentguard": return oa(this.$vApp.$pinia);
			case "geosearch": return Fa(this.$vApp.$pinia);
			case "grid": return Gt(this.$vApp.$pinia);
			case "help": return y(this.$vApp.$pinia);
			case "keyboardnav": return nr(this.$vApp.$pinia);
			...
			case "panguard": return qa(this.$vApp.$pinia);
			case "scrollguard": return Ja(this.$vApp.$pinia);
			case "wizard": return Ya(this.$vApp.$pinia);
			case "config": return v(this.$vApp.$pinia);
			case "fixture": return Yt(this.$vApp.$pinia);
			case "instance": return Tr(this.$vApp.$pinia);
			case "layer": return _(this.$vApp.$pinia);
			case "map-caption": return Kt(this.$vApp.$pinia);
			case "maptip": return an(this.$vApp.$pinia);
			case "notification": return hn(this.$vApp.$pinia);
			case "panel": return dn(this.$vApp.$pinia);
			default:
	...
	setLanguage(e) {
		...
		let t = v(this.$vApp.$pinia), n = hn(this.$vApp.$pinia), r = t.registeredLangs;
	...
	get started() {
		return Tr(this.$vApp.$pinia).started;
	}
	updateAlert(e) {
...
function Za(e, t) {
	...
	let r = rn(), i = pe(Pr).use(r).use(Ke, {
		directive: "tippy",
		component: "tippy"
	}).use(n);
	return i.directive("focus-container", ri), i.directive("focus-list", Ur), i.directive("focus-item", qr), i.directive("truncate", si), i.component("panel-screen", bi), i.component("pin", wi), i.component("close", Di), i.component("back", Ai), i.component("expand", Fi), i.component("panel-options-menu", Ki), i.component("dropdown-menu", mn), i.component("minimize", Ri), i.component("right", Hi), i.component("left", Gi), i.component("fullscreen-nav-button", Yi), i.component("geolocator-nav-button", Xi), i.component("home-nav-button", Zi), i.component("mapnav-button", ea), i.component("appbar-button", ra), i.component("transition", de), i.component("transition-group", fe), i.config.globalProperties.$iApi = t, i.config.globalProperties.$pinia = n, i.config.idPrefix = `ramp-${e.id || Rs.sharedUtils.generateUUID()}`, i.provide("iApi", t), {
		element: i,
		app: i.mount(e),
		i18n: r.global
	};
...
var Qa = class e {
	...
	static async create(t) {
		let n = new e(t), r = t.layers.map((e) => {
			...
			if (e.layerType === B.TILE) return h.TileLayer(t);
			if (e.layerType === B.VECTORTILE) return h.VectorTileLayer(t);
			if (e.layerType === B.MAPIMAGE) return h.MapImageLayer(t);
			if (e.layerType === B.OSM) return h.OpenStreetMapLayer(t);
		...
		return n.esriBasemap = await h.Basemap({
			baseLayers: i,
			title: t.name || "",
			id: t.id
		}), n;
	...
	pointZoomScale;
	constructor(e, t = "") {
		super(e), this.esriMap = void 0, this._basemapStore = [], this._viewPromise = new X(), this.loadDefProm = new X(), this.handlers = [], this.pointZoomScale = 5e4, this.name = t;
	}
	noMapErr() {
	...
	async createMap(e, t) {
		let n = (e) => {
			this.$iApi.notify.show(bn.ERROR, this.$iApi.$i18n.t("layer.error", { id: e.name }));
		...
		let o = {};
		this.esriMap = O(await h.Map(o)), this.pointZoomScale = e.pointZoomScale && e.pointZoomScale > 0 ? e.pointZoomScale : 5e4, this._targetDiv = t, this.createMapView(e.initialBasemapId);
	}
	destroyMap() {
		...
		this.destroyMapView(), this.esriMap.destroy(), delete this.esriMap, this._basemapStore.forEach((e) => e.esriBasemap.destroy()), this._basemapStore = [], this.loadDefProm = new X();
	}
	async reloadMap(e, t) {
		if (!this.esriMap || !this.esriView) {
			this.noMapErr();
	...
	getExtent() {
		return this.esriView ? Ct.fromESRI(this.esriView.extent) : (this.noMapErr(), Ct.fromParams("i_am_error", 0, 1, 0, 1));
	}
	getExtentSet() {
		return this._rampExtentSet ? this._rampExtentSet : (this.noMapErr(), Nt.fromConfig({
	...
	maptipStore;
	constructor(e) {
		super(e), this.maptipStore = an(this.$vApp.$pinia);
	}
	#e = void 0;
	#t = void 0;
	...
	async createMapView(e) {
		...
		this.esriView = O(await h.MapView({
			map: this.esriMap,
	...
	async addMapGraphicLayer() {
		...
		let e = new pt(this.$iApi.geo.map.getExtent(), "overview-graphic"), t = this.overviewmapStore.borderColour ?? "#FF0000", n = this.overviewmapStore.borderWidth ?? 1, r = this.overviewmapStore.areaColour ?? "#000000", i = this.overviewmapStore.areaOpacity ?? .25;
		e.style = new Ot({
	...
	updateAttribution(e) {
		...
		if (e ? (e.text ? e.text.disabled ? n.text.disabled = !0 : n.text.value = e.text.value || t.value : n.text.value = t.value, Kt(this.$vApp.$pinia).setAttribution(n)) : n.text.value = t.value, !e || e.text?.disabled || !e.text) {
			...
			if (r) {
				...
				Promise.all(i).then((r) => {
					e = r.filter((e) => e?.copyright).map((e) => e.copyright).join(" | "), n.text.value = e || n.text.value || t.value, Kt(this.$vApp.$pinia).setAttribution(n);
				});
			}
		}
	}
	updateScale() {
		let e = Kt(this.$vApp.$pinia), t = e.scale;
		...
		e.scale = {
			width: `${r.pixels}px`,
			label: `${this.$iApi.ui.formatNumber(r.distance)}${r.units}`,
			isImperialScale: n
		};
	}
	async formatPoint(e) {
	...
	async formatLatLongDMS(e) {
		...
		return `${this.$iApi.ui.formatNumber(Math.abs(i))}° ${this.$iApi.$i18n.n(a, "number", { minimumIntegerDigits: 2 })}' ${this.$iApi.$i18n.n(o, "number", { minimumIntegerDigits: 2 })}" ${this.$iApi.$i18n.t("map.coordinates." + (n > 0 ? "north" : "south"))} | ${this.$iApi.ui.formatNumber(Math.abs(s))}° ${this.$iApi.$i18n.n(c, "number", { minimumIntegerDigits: 2 })}' ${this.$iApi.$i18n.n(l, "number", { minimumIntegerDigits: 2 })}" ${this.$iApi.$i18n.t("map.coordinates." + (0 > r ? "west" : "east"))}`;
	}
	async formatLatLongDDM(e) {
		...
		return `${this.$iApi.ui.formatNumber(Math.abs(i))}° ${this.$iApi.$i18n.n(a, "number", {
			minimumIntegerDigits: 2,
			minimumFractionDigits: 5,
			maximumFractionDigits: 5
		})} ${this.$iApi.$i18n.t("map.coordinates." + (n > 0 ? "north" : "south"))} | ${this.$iApi.ui.formatNumber(Math.abs(o))}° ${this.$iApi.$i18n.n(s, "number", {
			minimumIntegerDigits: 2,
			minimumFractionDigits: 5,
			maximumFractionDigits: 5
	...
	async formatMercator(e) {
		...
		return `${this.$iApi.ui.formatNumber(Math.floor(t.x))} m | ${this.$iApi.ui.formatNumber(Math.floor(t.y))} m`;
	}
	async formatLambert(e) {
		let t = await this.$iApi.geo.proj.projectGeometry(3978, e);
		return `${this.$iApi.ui.formatNumber(Math.abs(Math.floor(t.x)))} m ${this.$iApi.$i18n.t("map.coordinates." + (0 > t.x ? "west" : "east"))} | ${this.$iApi.ui.formatNumber(Math.abs(Math.floor(t.y)))} m ${this.$iApi.$i18n.t("map.coordinates." + (t.y > 0 ? "north" : "south"))}`;
	}
	async formatUTM(e) {
		...
		return `${this.$iApi.$i18n.n(i, "number", { minimumIntegerDigits: 2 })} ${this.$iApi.$i18n.t("map.coordinates." + (n > 0 ? "north" : "south"))} ${this.$iApi.ui.formatNumber(Math.floor(a.x))} m${this.$iApi.$i18n.t("map.coordinates.east")} | ${this.$iApi.ui.formatNumber(Math.abs(Math.floor(a.y)))} m${this.$iApi.$i18n.t("map.coordinates.north")}`;
	}
	async formatBasemap(e) {
		let t = await this.$iApi.geo.proj.projectGeometry(this.$iApi.geo.map.getSR(), e);
		return `${this.$iApi.ui.formatNumber(t.x)} | ${this.$iApi.ui.formatNumber(t.y)}`;
	}
}, ro = class extends $a {
	maptip;
	caption;
	...
	async createMap(e, t) {
		this.setMapMouseThrottle(e.mapMouseThrottle ?? 0), this.trackFirstBasemap = !0, this.layerDefaultTimes.draw = e.layerTimeDefault?.expectedDrawTime ?? 12e3, this.layerDefaultTimes.load = e.layerTimeDefault?.expectedLoadTime ?? 12e3, this.layerDefaultTimes.fail = e.layerTimeDefault?.maxLoadTime || 9e4, await super.createMap(e, t), this.viewPromise.then(() => {
			this.loadDefProm.resolveMe(), this.$iApi.event.emit(Q.MAP_CREATED);
		});
	}
	destroyMap() {
		if (!this.esriMap || !this.esriView) {
	...
	async createMapView(e) {
		...
		this._rampExtentSet = Nt.fromConfig(a), this._rampSR = this._rampExtentSet.sr.clone();
	...
	async applyBasemap(e) {
		...
		let t = typeof e == "string" ? await this.findBasemap(e) : e;
		this.esriMap.basemap = je(t.esriBasemap);
	...
	async setBasemap(e) {
		...
		if (r) {
			...
			let t = await h.ColorBackground({ color: new wt(n.backgroundColour).toESRI() });
...
function co(e, t) {
	let n = "Multi", r = e.features[t].geometry.geometries;
	if (r === void 0 || r.length === 0) throw console.error("GeoJSON file has geometry collection with missing geometries"), Error();
	if (r.length === 1) {
	...
	let i = /* @__PURE__ */ new Set(), a = r.flatMap((e) => {
		let t = e.type;
		return i.add(t), t.startsWith(n) ? e.coordinates : [e.coordinates];
	}), o = Array.from(i).map((e) => e.replace(n, "")), s = o.length;
	if (s > 2 || s === 0 || s === 2 && o[0] !== o[1]) throw console.error("GeoJSON file has geometry collection containing multiple geometry types: " + Array.from(i).join()), Error();
	e.features[t].geometry = {
		type: n + o[0],
		coordinates: a
	};
...
var uo = class extends Z {
	...
	extractGeoJsonFields(e) {
		...
		for (let n = 0; n < e.features.length; n++) {
			let r = e.features[n];
			r.geometry.type === "GeometryCollection" && co(e, n);
	...
	async loadWfsData(e, t = -1, n = 0, r = 1e3, i = {
		...
		let c = new Ft(e).updateQuery(s), [l, u] = await Ze(Xe.get(c, { signal: o }));
		...
		let t = async () => {
			...
			return t ? (Array.isArray(t) || (t = [t]), t.map((e) => {
				...
				return r && (Array.isArray(r) || (r = [r]), r.forEach((e) => {
					let t = e.Name;
					if (a.push(t), e.LegendURL) {
						let n = e.LegendURL.OnlineResource["@_xlink:href"];
						o[t] = n.replaceAll("&amp;", "&");
					}
				})), {
	...
	async loadLayerMetadata(e) {
		...
		let [t, r] = await Ze(n(e, { query: { f: "json" } }));
	...
	getLayerTree() {
		return new At(0, "Fake tree", "getLayerTree() was not implemented in layer");
	}
	getSR() {
		return J.latLongSR();
	}
	...
	getGraphic(e, t) {
		return Promise.resolve(new pt(new ht()));
	}
	getIcon(e) {
		return Promise.resolve("");
	}
	...
	constructor(e, t) {
		super(e, t), this.name = e.name || "", this.geomType = z.NONE, this.dataFormat = V.UNKNOWN, this.layerType = B.UNKNOWN, this.layerFormat = ut.UNKNOWN;
		...
		this.expectedTime.draw = e.expectedDrawTime ?? n.draw, this.expectedTime.load = e.expectedLoadTime ?? n.load, this.expectedTime.fail = e.maxLoadTime || n.fail, this.lastCancel = 0, this.timers = {
			draw: void 0,
			load: void 0
		}, this.origRampConfig = e, this.id = e.id || this.$iApi.geo.shared.generateUUID(), this.uid = this.$iApi.geo.shared.generateUUID(), this.isCosmetic = !1, this.isSystem = e.system || !1, this.isRemoved = !1, this.isSublayer = !1, this.supportsIdentify = !1, this.mapLayer = !0, this.identifyMode = U.NONE, this.supportsFeatures = !1, this.maptips = !1, this.supportsSublayers = !1, this.isFile = !1, this.layerState = G.NEW, this.initiationState = W.NEW, this.drawState = dt.NOT_LOADED, this.loadDefProm = new X(), this.url = this.origRampConfig.url, this.canReload = !!(this.url || this.origRampConfig.caching), this.loadPromDone = !1, this.nameArcadeFormula = "", this.maptipArcadeFormula = "", this.layerTree = new At(0, this.uid, this.name, !0);
	}
	updateInitiationState(e) {
	...
	updateDrawState(e) {
		this.drawState = e, e === dt.REFRESH ? this.startTimer("draw") : e === dt.UP_TO_DATE && this.stopTimer("draw"), this.$iApi.event.emit(Q.LAYER_DRAWSTATECHANGE, {
			state: e,
			layer: this
		});
	}
	async initiate() {
		this.updateInitiationState(W.INITIATING), this.startTimer("load");
		let e = (e) => {
		...
		clearTimeout(n), t > this.lastCancel && (this.drawState !== dt.UP_TO_DATE && this.startTimer("draw"), r ? e(`Init error on layer id: ${this.id} . ${r.message}`) : this.updateInitiationState(W.INITIATED));
	}
	async onInitiate() {
	...
	async terminate() {
		this.updateInitiationState(W.TERMINATING), await Promise.all(this.sublayers.map((e) => e.terminate())), this.loadDefProm = new X(), this.loadPromDone = !1, this.updateLayerState(G.NEW), this.updateDrawState(dt.NOT_LOADED), this.updateInitiationState(W.TERMINATED);
	}
	onLoad() {
		...
		try {
			...
			Promise.all(r).then(() => {
				clearTimeout(n), t ? this.visibility = !1 : (this.stopTimer("load"), e > this.lastCancel && (this.loadPromDone && (this.loadDefProm = new X()), this.loadDefProm.resolveMe(), this.loadPromDone = !0, this.sublayers.forEach((e) => e.onLoad()), this.updateLayerState(G.LOADED)));
			}).catch(() => {
	...
	onError(e = !0) {
		this.layerState !== G.ERROR && (this.initiationState === W.INITIATING && this.updateInitiationState(W.NEW), this.loadPromDone && (this.loadDefProm = new X()), this.loadDefProm.rejectMe(), this.loadPromDone = !0, this.sublayers.forEach((t) => t.onError(e)), e && this.$iApi.notify.show(bn.ERROR, this.$iApi.$i18n.t("layer.error", { id: this.name || this.id })), this.stopTimer("draw"), this.stopTimer("load"), this.updateLayerState(G.ERROR, !e));
	}
	onLoadActions() {
		return [];
	}
	...
	getGraphic(e, t) {
		return this.stubError(), Promise.resolve(new pt(new ht()));
	}
	getIcon(e) {
		return this.stubError(), Promise.resolve("");
	}
	...
	startTimer(e) {
		this.stopTimer(e), this.expectedTime[e] > 0 && (this.timers[e] = window.setTimeout(() => this.$iApi.notify.show(bn.WARNING, this.$iApi.$i18n.t(`layer.long${e}`, { id: this.name || this.id })), this.expectedTime[e]));
	}
	stopTimer(e) {
	...
	esriWatches;
	constructor(e, t) {
		super(e, t), this._scaleSet = new jt(), this._mouseTolerance = e.mouseTolerance == null ? 5 : e.mouseTolerance, this._touchTolerance = e.touchTolerance == null ? 15 : e.touchTolerance, this._drawOrder = [], this._serverVisibility = void 0, this.isCosmetic = e.cosmetic || !1, this.extent = e.extent ? Ct.fromConfig(`${this.id}_extent`, e.extent) : void 0, this.viewDefProm = new X(), this.esriWatches = [];
	}
	noLayerErr() {
	...
	async onInitiate() {
		...
		this.esriWatches.push(i(() => this.esriLayer.visible, (e) => {
			...
			this.esriView = O(e.layerView), this.esriWatches.push(i(() => e.layerView.updating, (e) => {
				this.updateDrawState(e ? dt.REFRESH : dt.UP_TO_DATE);
	...
	onLoadActions() {
		let e = super.onLoadActions();
		return this.origRampConfig.divertIdentifyLayer && e.push(new Promise(async (e) => {
			let t = structuredClone(je(this.origRampConfig.divertIdentifyLayer));
			t.id ||= this.id + "-divertedIdentify";
			let n = t.layerType === B.FEATURE, r = t.layerType === B.WMS;
			n && (t.identifyMode = U.GEOMETRIC), t.expectedDrawTime = 0;
			try {
				let e = this.$iApi.geo.layer.createLayer(t);
				await e.initiate();
				let i = e.esriLayer.visible;
				r && (e.esriLayer.visible = !1, this.$iApi.geo.map.esriMap?.add(e.esriLayer, 0), await new Promise((t, n) => {
					let r = 0, i = setInterval(() => {
						r += 150, e.esriLayer?.spatialReference ? (clearInterval(i), t()) : r > 8e3 && (clearInterval(i), n());
					}, 150);
				})), e.onLoad(), await e.loadPromise(), r && (e.removeEsriLayer(), e.esriLayer.visible = i), this.diLayer = e, this.divertedIdentify = !0, this.supportsIdentify = !0, this.identify = !0, n && (this.supportsFeatures = !0, this.oidField = e.oidField, this.fields = e.fields, this.featureCount = e.featureCount), this.legend.length || (this.legend = e.legend);
			} catch (e) {
				console.error(this.id + ": Diverted layer failed to load"), console.error(e), this.$iApi.notify.show(bn.ERROR, this.$iApi.$i18n.t("layer.diverted.error", { id: this.name || this.id }));
			}
			e();
		})), e;
	}
	async terminate() {
		this.diLayer && await this.diLayer.terminate(), await super.terminate();
	}
	diCheck() {
		if (this.divertedIdentify) {
			let e = !(this.diLayer && this.diLayer.layerState === G.LOADED);
			return e && console.error("Layer " + this.id + " encountered diverted identify layer not loaded", this.diLayer), !e;
		} else return !1;
	}
	runIdentify(e) {
		if (!this.canIdentify()) return [];
		if (this.diCheck()) {
			let t = this.diLayer.runIdentify(e);
			return t.forEach((e) => {
				e.layerId = this.id, e.uid = this.uid;
			}), t;
		}
		return super.runIdentify(e);
	}
	getAttributes() {
		return this.diCheck() ? this.diLayer.getAttributes() : super.getAttributes();
	}
	abortAttributeLoad() {
		return this.diCheck() ? this.diLayer.abortAttributeLoad() : super.abortAttributeLoad();
	}
	clearFeatureCache() {
		return this.diCheck() ? this.diLayer.clearFeatureCache() : super.clearFeatureCache();
	}
	downloadedAttributes() {
		return this.diCheck() ? this.diLayer.downloadedAttributes() : 0;
	}
	attribLoadAborted() {
		return this.diCheck() ? this.diLayer.attribLoadAborted() : !1;
	}
	getTabularAttributes() {
		return this.diCheck() ? this.diLayer.getTabularAttributes() : super.getTabularAttributes();
	}
	async getGraphic(e, t) {
		return this.diCheck() ? (t.serverOnly = !0, this.diLayer.getGraphic(e, t)) : super.getGraphic(e, t);
	}
	async zoomToFeature(e) {
		return this.diCheck() ? this.diLayer.zoomToFeature(e) : super.zoomToFeature(e);
	}
	async getIcon(e) {
		return this.diCheck() ? this.diLayer.getIcon(e) : super.getIcon(e);
	}
	setSqlFilter(e, t) {
		return this.diCheck() ? this.diLayer.setSqlFilter(e, t) : super.setSqlFilter(e, t);
	}
	applySqlFilter(e = []) {
		this.diCheck() && this.diLayer.applySqlFilter(e), super.applySqlFilter(e);
	}
	getSqlFilter(e) {
		return this.diCheck() ? this.diLayer.getSqlFilter(e) : super.getSqlFilter(e);
	}
	async getFilterOIDs(e = [], t = void 0) {
		return this.diCheck() ? this.diLayer.getFilterOIDs(e, t) : super.getFilterOIDs(e, t);
	}
	async getGraphicExtent(e) {
		return this.diCheck() ? this.diLayer.getGraphicExtent(e) : super.getGraphicExtent(e);
	}
	nameValue(e) {
		return this.diCheck() ? this.diLayer.nameValue(e) : super.nameValue(e);
	}
}, bo = class extends vo {
	attribs;
	renderer;
	...
	filter;
	constructor(e, t) {
		super(e, t), this.supportsIdentify = !0, this.geomType = z.UNKNOWN, this.serviceUrl = "", this.fieldList = "", this.canModifyLayer = !0, this.filter = new Mt(e.permanentFilteredQuery || "", e.initialFilteredQuery || ""), e.state?.hovertips !== void 0 && console.warn("hovertips layer configuration property is deprecated. Please adjust to use maptips instead"), this.maptips = e.state?.maptips ?? e.state?.hovertips ?? !0, this.attribs = new qo();
	}
	makeEsriLayerConfig(e) {
	...
	async getGraphic(e, t) {
		let n = {}, r = new ht(), i = this.$iApi.geo.map, a = !1, o = !1, s = 0;
		...
		if (t.getGeom) {
			...
			if (n) r = n;
			else if (this.layerType === B.FEATURE && !(t.forZoom && this.attribs.quickCache.isPoint || t.serverOnly)) {
		...
		let c = new pt(r, "", t.getAttribs ? n : void 0);
		if (t.getStyle) {
	...
	setSqlFilter(e, t) {
		if (t !== this.filter.getSql(e)) if (this.filter.setSql(e, t), this.$iApi.event.emit(Q.FILTER_CHANGE, {
			uid: this.uid,
			filterKey: e
		}), this.layerFormat === ut.MAPIMAGE) this.applySqlFilter();
		else {
			let n = `${this.uid}-${e}-${t}`;
	...
	constructor(e, t) {
		super(e, t), this.dataFormat = V.ESRI_FEATURE, this.layerFormat = ut.GRAPHIC, this.maptips = !1;
	}
	_graphics = [];
	makeEsriLayerConfig(e) {
		return super.makeEsriLayerConfig(e);
	...
	async addGraphic(e) {
		...
		let n = t.filter((e) => this._graphics.findIndex((t) => t.id === e.id) === -1 ? (this._graphics.push(e), !0) : (console.error(`Attempting to add graphic with id '${e.id}' that has already been added.`), !1)), r = this.$iApi.geo.map.getSR(), i = n.map((e) => this.$iApi.geo.proj.projectGeometry(r, e.geometry)), a = await Promise.all(i), o = n.map((e, t) => {
			let n = new pt(a[t], e.id, e.attributes);
	...
	async onInitiate() {
		this.esriLayer = O(await h.GraphicsLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
	}
	makeEsriLayerConfig(e) {
		return super.makeEsriLayerConfig(e);
	}
	onLoadActions() {
		let e = super.onLoadActions();
		return this.layerTree.name = this.name, this.updateDrawState(dt.UP_TO_DATE), e;
	}
}, Co = class extends bo {
	esriJson;
	sourceGeoJson;
	constructor(e, t) {
		super(e, t), this.supportsIdentify = !0, this.isFile = !0, this.dataFormat = V.ESRI_FEATURE, this.layerFormat = ut.FEATURE, this.layerIdx = 0, e.identifyMode && e.identifyMode !== U.NONE ? this.identifyMode = e.identifyMode : this.identifyMode = U.HYBRID;
	}
	async reload() {
	...
	async onInitiate() {
		...
		this.esriJson = await this.$iApi.geo.layer.files.geoJsonToEsriJson(this.sourceGeoJson, e), this.esriLayer = O(await h.FeatureLayer(this.makeEsriLayerConfig(this.origRampConfig))), this.esriJson = void 0, this.origRampConfig.caching || delete this.origRampConfig.rawData, delete this.sourceGeoJson, await super.onInitiate();
	}
	makeEsriLayerConfig(e) {
	...
	runIdentify(e) {
		...
		return e.hitTest && (this.identifyMode === U.HYBRID || this.identifyMode === U.SYMBOLIC) && (r = i.then(async () => {
			...
			a.forEach((e) => {
				n.items.push(mo.makeRawItem(ft.ESRI, e.attributes));
			}), o.forEach((e) => {
	...
	extractLayerMetadata() {
		...
		this.supportsFeatures = !0, this.geomType = this.$iApi.geo.geom.clientGeomTypeToRampGeomType(e.geometryType), this.scaleSet.minScale = e.minScale || 0, this.scaleSet.maxScale = e.maxScale || 0, this.extent = this.extent ?? Ct.fromESRI(e.fullExtent, this.id + "_extent");
	...
	async getGraphic(e, t) {
		...
		if (!t.getGeom && this.attribs.attLoader.isLoaded()) {
			let t = await this.attribs.attLoader.getAttribs();
			n = new pt(new ht(), "", t.features[t.oidIndex[e]]);
		} else {
			let r = {
				filterOIDs: [e],
	...
	applySqlFilter(e = []) {
		...
		h.FeatureFilter({ where: t }).then((e) => {
	...
	constructor(e, t) {
		super(e, t), this.dataFormat = V.ESRI_FEATURE, this.supportsIdentify = !0, this.layerType = B.FEATURE, this.layerFormat = ut.FEATURE, e.identifyMode && e.identifyMode !== U.NONE ? this.identifyMode = e.identifyMode : this.identifyMode = U.HYBRID;
	}
	async onInitiate() {
		O(this.esriLayer = await h.FeatureLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
	}
	makeEsriLayerConfig(e) {
	...
	onLoadActions() {
		...
		let i = async () => {
			...
			if (this.esriLayer && this.origRampConfig.customRenderer?.type) {
				let e = await h.RendererFromJson(this.origRampConfig.customRenderer);
	...
	async getGraphicExtent(e) {
		...
		if (!this.layerExists) this.noLayerErr();
			...
			if (n) t = n;
				...
				!n && r.extent && (t = Ct.fromESRI(r.extent), this.attribs.quickCache.setExtent(e, t));
			}
		}
		return t;
	}
	...
	origState;
	constructor(e, t) {
		super(e, t), this.supportsIdentify = !0, this.supportsSublayers = !0, this.layerType = B.MAPIMAGE, this.layerFormat = ut.MAPIMAGE, this.isDynamic = !1, this.maptips = !1, this.layerTree.layerIdx = -1, this.identifyMode = U.GEOMETRIC;
	}
	actualViz = !1;
	get visibility() {
	...
	set visibility(e) {
		...
		if (e || Mo(this, "1=2"), this.actualViz = e, e && !this.esriLayer.visible) this.esriLayer.visible = !0;
			...
			e = this.$iApi.event.on(Q.LAYER_DRAWSTATECHANGE, (n) => {
				n.layer.id === this.id && n.state === dt.UP_TO_DATE && (clearTimeout(t), this.$iApi.event.off(e), this.actualViz || (this.esriLayer.visible = !1, Mo(this, "")));
			});
		}
		e && Mo(this, "");
	}
	async onInitiate() {
		this.esriLayer = O(await h.MapImageLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
	}
	makeEsriLayerConfig(e) {
		let t = super.makeEsriLayerConfig(e);
	...
	onLoadActions() {
		...
		let t = Date.now();
		if (this.layerTree.name = this.name, !this.esriLayer.capabilities.exportMap) throw this.$iApi.notify.show(bn.WARNING, this.$iApi.$i18n.t("layer.noexportmap", { name: this.name || this.id })), Error("Service does not support Map Image Layer, Map Export is not enabled");
		this.isDynamic = this.esriLayer.capabilities.exportMap.supportsDynamicLayers, this.extent = this.extent ?? Ct.fromESRI(this.esriLayer.fullExtent, this.id + "_extent");
		let n = (e) => {
		...
		let a = [], o = (e, t) => {
			...
			if (e.sublayers && e.sublayers.length > 0) {
				let r = new At(n, "", (s ? s.name : "") || e.title || "", !1);
	...
	constructor(e, t, n) {
		if (super(e, t), this.layerType = B.SUBLAYER, this.layerFormat = ut.MAPIMAGE, this.isSublayer = !0, this.layerIdx = e.index, this.parentLayer = n, this.isSystem = n.isSystem, this.dataFormat = V.ESRI_FEATURE, this.supportsFeatures = !0, this.maptips = !1, this.url = this.parentLayer?.url, this.canReload = !0, !n.esriLayer) throw Error("Map Image Layer with no internal esri layer encountered in sublayer creation");
	...
	constructor(e, t) {
		super(e, t), this.supportsIdentify = !1, this.layerType = B.OSM, this.layerFormat = ut.OSM, this.dataFormat = V.OSM_TILE, this.supportsFeatures = !1;
	}
	async onInitiate() {
		this.esriLayer = O(await h.OpenStreetMapLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
	}
	makeEsriLayerConfig(e) {
		return super.makeEsriLayerConfig(e);
	}
	...
	constructor(e, t) {
		super(e, t), this.supportsIdentify = !1, this.layerType = B.IMAGERY, this.layerFormat = ut.IMAGERY, this.dataFormat = V.ESRI_RASTER;
	}
	async onInitiate() {
		this.esriLayer = O(await h.ImageryLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
	}
	makeEsriLayerConfig(e) {
		return super.makeEsriLayerConfig(e);
	}
	...
	async checkProj() {
		let e = this.getSR(), t = this.$iApi.geo.map.getSR().isEqual(e), n = () => this.$iApi.notify.show(bn.WARNING, this.$iApi.$i18n.t("layer.mismatch", { name: this.name || this.id }));
		if (this.layerState === G.LOADED && !t) n(), this.onError(), this.updateDrawState(dt.NOT_LOADED);
		else if (this.layerState === G.ERROR && t) this.reload();
		else if (this.layerState !== G.ERROR && !t) return n(), Promise.reject();
	}
}, Lo = class extends Io {
	constructor(e, t) {
		super(e, t), this.layerType = B.IMAGERYTILE, this.layerFormat = ut.IMAGERYTILE, this.schemaLocked = !1;
	}
	async onInitiate() {
		this.esriLayer = O(await h.ImageryTileLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
	}
	makeEsriLayerConfig(e) {
		return super.makeEsriLayerConfig(e);
	}
	...
	constructor(e, t) {
		super(e, t), this.layerType = B.TILE, this.layerFormat = ut.TILE;
	}
	async onInitiate() {
		this.esriLayer = O(await h.TileLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
	}
	makeEsriLayerConfig(e) {
		return super.makeEsriLayerConfig(e);
	}
	...
	constructor(e, t) {
		super(e, t), this.layerType = B.VECTORTILE, this.layerFormat = ut.VECTORTILE;
	}
	async onInitiate() {
		this.esriLayer = O(await h.VectorTileLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
	}
	makeEsriLayerConfig(e) {
		return super.makeEsriLayerConfig(e);
	}
	...
	mimeType;
	constructor(e, t) {
		super(e, t), this.supportsIdentify = !0, this.layerType = B.WMS, this.layerFormat = ut.WMS, this.mimeType = e.featureInfoMimeType || "", this.sublayerNames = [], this.dataFormat = V.OGC_RASTER, this.identifyMode = U.GEOMETRIC;
	}
	async onInitiate() {
		this.esriLayer = O(await h.WMSLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
	}
	makeEsriLayerConfig(e) {
	...
	runIdentify(e) {
		...
		return this.getFeatureInfo(this.sublayerNames, e.geometry, this.mimeType).then((e) => {
			if (e) {
				let t = !0, r;
				typeof e == "string" ? e.indexOf("Search returned no results") === -1 && e !== "" ? r = ft.TEXT : (t = !1, r = ft.UNKNOWN) : r = ft.JSON, t && n.items.push(mo.makeRawItem(r, e));
			}
			n.loaded = !0, t.resolveMe();
		}).catch(() => {
			n.errored = !0, t.resolveMe();
	...
	async onInitiate() {
		let e = Date.now(), { offset: t, limit: n } = new Ft(this.config.url).queryMap, r = await this.$iApi.geo.layer.ogc.loadWfsData(this.config.url, -1, parseInt(t) || 0, parseInt(n) || 1e3, void 0, this.config.xyInAttribs);
	...
	_visibility;
	constructor(e, t) {
		super(e, t), this.dataFormat = V.ESRI_FEATURE, this.layerFormat = ut.NOLAYER, this.drawState = dt.NOT_VISUAL, this.attribs = new qo(), this.supportsFeatures = !0, this.mapLayer = !1, this.isFile = !1, this._visibility = e.state?.visibility ?? !0, this.expectedTime.draw = 0;
	}
	async onInitiate() {
		if (this.sourceJson) {
	...
	serviceUrl;
	constructor(e, t) {
		super(e, t), this.layerType = B.DATATABLE, this.serviceUrl = e.url, this.filter = new Mt(e.permanentFilteredQuery || "", e.initialFilteredQuery || "");
	}
	async onInitiate() {}
	onLoadActions() {
	...
	async arcGisBatchLoad(e, t) {
		...
		let r = e.permanentFilter ? ` AND ${e.permanentFilter}` : "", i = { query: {
			...
			f: "json"
		} }, [a, o] = await Ze(n(e.serviceUrl + "/query", i));
	...
	async loadSingleFeature(e) {
		...
		let [r, i] = await Ze(n(e.serviceUrl + "/query", t));
	...
	falseRenderer;
	constructor(e, t, n = !1) {
		this.innerRenderer = e, this.symbolUnits = [], this.falseRenderer = n, this.type = lt.Unknown;
	}
	makeSearchParams(e) {
		return e;
	}
	...
	keyFields;
	constructor(e, t, n = !1) {
		super(e, t, n), this.type = lt.Unique, this.delim = e.fieldDelimiter || ", ";
		let r = (e) => e.replace(/'/g, "''");
		this.keyFields = [
			e.field,
			e.field2,
	...
	async getMapServerLegend(e) {
		...
		let t = { query: { f: "json" } }, r = { layers: [] }, [i, a] = await Ze(n(`${e}/legend`, t));
	...
	async mapServerLegendToRenderer(e, t) {
		...
		if (n !== void 0) {
			...
			let e = await h.RendererFromJson(r);
	...
	async arcGisServerQueryIds(e) {
		...
		let n = await h.QueryByIds(e.url, t);
	...
	async geoJsonQuery(e) {
		...
		return (await e.layer.esriLayer.queryFeatures(t)).features.map((e, n) => {
			let r;
			return r = t.returnGeometry ? this.$iApi.geo.geom.geomEsriToRamp(e.geometry, `queryResult${n}`) : new ht(), new pt(r, "", e.attributes);
		});
	}
	...
	makeClickBuffer(e, t = 5) {
		...
		return new Ct("ze_buffer", [e.x - i, e.y - i], [e.x + i, e.y + i], e.sr);
	}
}, ls = class extends Z {
	attributes;
	geom;
	...
	symbology;
	constructor(e) {
		super(e), this.geom = Rs.geom, this.proj = Rs.proj, this.shared = Rs.sharedUtils, this.map = new ro(e), this.layer = new ho(e), this.attributes = new Ko(e), this.query = new cs(e), this.symbology = new ss(e), Array.isArray(m.request.interceptors) || (m.request.interceptors = []), m.request.interceptors.push({ before: (e) => {
			e.url.includes("?blankTile=false") && (e.url = e.url.replace("?blankTile=false", "?blankTile=true"));
		} });
	}
	set proxy(e) {
		m.request.proxyUrl = e;
	}
	get proxy() {
		return m.request.proxyUrl || "";
	}
	glCoord = [];
	async getGeolocation(e = !1) {
		let t = (e) => new Promise((t, n) => navigator.geolocation.getCurrentPosition(t, n, e)), n = () => ({
			success: !0,
			coord: new Y("geolocation", this.glCoord, J.latLongSR(), !0)
		}), r;
		if (this.glCoord.length) r = n();
		else {
			let i = await t({
				maximumAge: Infinity,
				timeout: 5e3
			}).catch((e) => e.code === GeolocationPositionError.PERMISSION_DENIED ? "permission" : "internal");
			if (!i || typeof i == "string") {
				let t = i || "internal";
				e || this.$iApi.notify.show(bn.ERROR, this.$iApi.$i18n.t("mapnav.geolocator.error." + t)), r = {
					success: !1,
					error: t
				};
			} else this.glCoord = [i.coords.longitude, i.coords.latitude], r = n();
		}
		return this.$iApi.event.emit(Q.MAP_GEOLOCATE, r), r;
	}
}, us = /* #__PURE__ */ Object.assign({
	"../fixtures/appbar/index.ts": () => import("./appbar-D4VwoDVc.js"),
	"../fixtures/areas-of-interest/index.ts": () => import("./areas-of-interest-DVJ3Nk2z.js"),
	"../fixtures/basemap/index.ts": () => import("./basemap-BxteBUMw.js"),
	"../fixtures/crosshairs/index.ts": () => import("./crosshairs-B14_-77W.js"),
	"../fixtures/details/index.ts": () => import("./details-Cf1-qQfD.js"),
	"../fixtures/draw/index.ts": () => import("./draw-C2zh96Im.js"),
	"../fixtures/export/index.ts": () => import("./export-D-gxtCMk.js"),
	"../fixtures/export-footnote/index.ts": () => import("./export-footnote-BDfU-_v5.js"),
	"../fixtures/export-legend/index.ts": () => import("./export-legend-BTR-pP6_.js"),
	"../fixtures/export-map/index.ts": () => import("./export-map-DGwasyva.js"),
	"../fixtures/export-northarrow/index.ts": () => import("./export-northarrow-CaXG_2bg.js"),
	"../fixtures/export-scalebar/index.ts": () => import("./export-scalebar-C5lcmygC.js"),
	"../fixtures/export-timestamp/index.ts": () => import("./export-timestamp-wIoABCpM.js"),
	"../fixtures/export-title/index.ts": () => import("./export-title-BL4g5-Xg.js"),
	"../fixtures/extentguard/index.ts": () => import("./extentguard-wJO7PvnL.js"),
	"../fixtures/gazebo/index.ts": () => import("./gazebo-BejI5Y6Q.js"),
	"../fixtures/geosearch/index.ts": () => import("./geosearch-D7dW_bDj.js"),
	"../fixtures/grid/index.ts": () => import("./grid-CI01PkJy.js"),
	"../fixtures/help/index.ts": () => import("./help-CZNnj9If.js"),
	"../fixtures/hilight/index.ts": () => import("./hilight-qSxeE2Bz.js"),
	"../fixtures/keyboardnav/index.ts": () => import("./keyboardnav-BTFx_SZo.js"),
	"../fixtures/layer-reorder/index.ts": () => import("./layer-reorder-CVB9HN97.js"),
	"../fixtures/legend/index.ts": () => import("./legend-CVsZKNgb.js"),
	"../fixtures/mapnav/index.ts": () => import("./mapnav-ByDsyuIC.js"),
	"../fixtures/metadata/index.ts": () => import("./metadata-D3Hmnt6x.js"),
	"../fixtures/northarrow/index.ts": () => import("./northarrow-CwBoeIiY.js"),
	"../fixtures/overviewmap/index.ts": () => import("./overviewmap-rUtghEYO.js"),
	"../fixtures/panguard/index.ts": () => import("./panguard-BisvuH1H.js"),
	"../fixtures/pindrop/index.ts": () => import("./pindrop-BKWeTtxu.js"),
	"../fixtures/scrollguard/index.ts": () => import("./scrollguard-DBn5rp7X.js"),
	"../fixtures/settings/index.ts": () => import("./settings-KBDRv9QM.js"),
	"../fixtures/snowman/index.ts": () => import("./snowman-q11SB0nN.js"),
	"../fixtures/swipe/index.ts": () => import("./swipe-Otmqev1n.js"),
	"../fixtures/wizard/index.ts": () => import("./wizard-BJKN0gQB.js")
}), ds = (e) => e === ps || e.prototype instanceof ps, fs = class extends Z {
	constructor(e) {
		super(e);
	}
	exists(e) {
		return e in Yt(this.$vApp.$pinia).items;
	}
	async add(e, t) {
		let n;
		if (e in Yt(this.$vApp.$pinia).items) return this.get(e);
		if (t) {
			if (typeof t != "function") throw Error("malformed fixture constructor");
			n = ds(t) ? new t(e, this.$iApi) : ps.updateBaseToInstance(new t(), e, this.$iApi);
		} else {
			let t = (await us[`../fixtures/${e}/index.ts`]()).default;
			n = new t(e, this.$iApi);
		}
		return Yt(this.$vApp.$pinia).addFixture(n), this.$iApi.event.emit(Q.FIXTURE_ADDED, n), this.$iApi.geo.map.created && n.initialized?.(), n;
	}
	remove(e) {
		let t = this.get(e);
		if (!t) throw Error(`Could not find fixture ${e} for removal`);
		return Yt(this.$vApp.$pinia).removeFixture(t), this.$iApi.event.emit(Q.FIXTURE_REMOVED, t), t;
	}
	flush() {
		let e = Yt(this.$vApp.$pinia);
	...
	get(e) {
		...
		let n = t.map((e) => {
			let t = Yt(this.$vApp.$pinia).items[e];
			if (t) return t;
		});
		return n.length === 1 ? n[0] : n;
	}
	isLoaded(e) {
		let t = Yt(this.$vApp.$pinia), n = Array.isArray(e) ? e : [e];
		n.forEach((e) => {
	...
	handlePanelTeleports(e) {
		if (this.config?.panelTeleport) {
			let t = dn(this.$vApp.$pinia), n = !!this.config.panelTeleport.target;
			e.forEach((e) => {
	...
	panelStore = dn(this.$vApp.$pinia);
	updateHTML(e, t, n) {
		let r = this.get(e), i = n ? r.screens[n] : Object.values(r.screens)[0];
		if (Vt(i)) for (let e in t) i[e].innerHTML = t[e] instanceof HTMLElement ? t[e].outerHTML : t[e];
	...
	register(e, t) {
		...
		let r = Object.entries(n).reduce((e, [t, n]) => (e.push(new bs(this.$iApi, t, n)), e), []);
	...
	open(e) {
		let t, n, r;
		if (typeof e == "string" || e instanceof bs ? t = this.get(e) : (t = this.get(e.id), {screen: n, props: r} = e), !t) return t;
	...
	toggle(e, t) {
		let n;
		return n = typeof e == "string" || e instanceof bs ? this.get(e) : this.get(e.id), n && (t = t === void 0 ? !n.isVisible : t, t === n.isVisible ? n : t ? this.open(e) : this.close(n));
	}
	toggleMinimize(e, t) {
		let n;
		return n = typeof e == "string" || e instanceof bs ? this.get(e) : this.get(e.id), n && (t = t === void 0 ? !n.isVisible : t, t === n.isVisible ? n : t ? this.open(n) : this.minimize(n));
	}
	pin(e, t) {
		let n = this.get(e);
...
function _s(e, t) {
	...
	return A(), C(n, {
		...
		content: I(() => [...t[0] ||= [E("div", { class: "loader" }, null, -1)]]),
		_: 1
	});
}
var vs = /*#__PURE__*/ ne(gs, [["render", _s], ["__scopeId", "data-v-a3c61802"]]), ys = /* #__PURE__ */ Object.assign({
	"../fixtures/areas-of-interest/screen.vue": () => import("./screen-CU65zf6h.js"),
	"../fixtures/basemap/screen.vue": () => import("./screen-xleFbhnm.js"),
	"../fixtures/export/screen.vue": () => import("./screen-DS5_QVQG.js"),
	"../fixtures/geosearch/screen.vue": () => import("./screen-CI_eZ8CZ.js"),
	"../fixtures/grid/screen.vue": () => import("./screen-DprmAmEe.js"),
	"../fixtures/help/screen.vue": () => import("./screen-Bqf9r587.js"),
	"../fixtures/layer-reorder/screen.vue": () => import("./screen-CorAgmuc.js"),
	"../fixtures/legend/screen.vue": () => import("./screen-Dk1v5-8Y.js"),
	"../fixtures/metadata/screen.vue": () => import("./screen-BZoax7tY.js"),
	"../fixtures/settings/screen.vue": () => import("./screen-B6vCPzf9.js"),
	"../fixtures/wizard/screen.vue": () => import("./screen-DyEmJW7a.js")
}), bs = class extends Z {
	id;
	screens;
	loadedScreens = [];
	...
	registerScreen(e) {
		...
		if (Bt(t) || zt(t)) n = t, this.loadedScreens.push(e);
		else if (Vt(t)) n = { template: `<panel-screen :panel="this" :screenId="'${e}'">
                           </panel-screen>` };
		else {
			let r;
			r = typeof t == "string" ? ys[`../fixtures/${t}`]() : t();
			let i = new Promise((t, n) => {
				r.then((n) => {
					this.loadedScreens.push(e), t(Ht(n) ? n.default : n);
				}), r.catch((e) => n(e));
			});
			n = ge({
				loader: () => i,
...
function Cs(e) {
	...
	return As(e.services, t), ws(e.map, t), js(e.ui, t), e.plugins && Ms(e.plugins, t), t;
}
function ws(e, t) {
	if (e.layers && e.layers.forEach((e) => {
		t.layers.unshift(Ds(e));
	...
	})) : t.fixtures.legend = { root: Ts(e.legend.root) });
}
function Ts(e) {
	let t = {
		name: e.name,
	...
	return e.controls && e.controls.length > 0 && (t.controls = ks(e.controls, n), e.controls.includes("visibility") && t.controls.push("visibilityButton"), (e.controls.length !== 1 || e.controls[0] !== "visibility") && console.warn("Legend entry groups currently support only the visibility control. All other controls are currently not supported."), t.controls.push("expandButton")), e.disabledControls && e.disabledControls.length > 0 && (t.disabledControls = ks(e.disabledControls, n), e.disabledControls.includes("visibility") && t.disabledControls.push("visibilityButton"), (e.disabledControls.length !== 1 || e.disabledControls[0] !== "visibility") && console.warn("Legend entry groups currently support only the visibility control. All other controls are currently not supported.")), e.children.forEach((e) => {
		if (e.layerId) t.children.push(Es(e));
			...
			e.collapse !== void 0 && console.warn(`collapse property in visibilitySet in children list of legend entry group ${t.name} cannot be mapped and will be skipped.`), e.exclusiveVisibility.forEach((e) => {
				e.layerId ? n.children.push(Es(e)) : n.children.push(Ts(e));
			}), t.children.push(n);
		} else t.children.push(Ts(e));
	}), t;
}
function Es(e) {
	let t = e, n = [
	...
	return e.controls && e.controls.length > 0 && (t.layerControls = ks(e.controls, n), t.layerControls.push("symbology")), e.disabledControls && e.disabledControls.length > 0 && (t.disabledLayerControls = ks(e.disabledControls, n)), e.controlledIds && (console.warn(`controlledIds property defined in legend entry ${e.layerId} cannot be mapped and will be skipped.`), delete t.controlledIds), e.entryIndex && (t.sublayerIndex = e.entryIndex, delete e.entryIndex), e.entryId && console.warn(`entryId property defined in legend entry ${e.layerId} cannot be mapped and will be skipped.`), t;
}
function Ds(e) {
	let t = Os(e);
...
console.info(`RAMP v${{
	...
	minor: "23",
	patch: "0-beta",
	timestamp: "Tue Sep 8 13:03:41 2026 -0400",
	hash: "b67179e08ecb991592245d3ee729add5c608740c"
}.major}.${{
	major: "4",
	minor: "23",
	patch: "0-beta",
...
var Ls = (e, t, n) => new Xa(e, t, n), Rs = new Rt();
//#endregion
export { Y as $, Oa as A, dn as B, Ba as C, Ra as D, Ia as E, nr as F, Wt as G, Jt as H, tr as I, Ft as J, Ut as K, er as L, oa as M, aa as N, La as O, ia as P, xt as Q, bn as R, Ha as S, za as T, qt as U, Q as V, Gt as W, Et as X, X as Y, Ct as Z, qa as _, Ps as a, ft as at, Wa as b, Ro as c, G as ct, go as d, J as et, mo as f, Ja as g, $ as h, Is as i, z as it, ga as j, Fa as k, So as l, B as lt, Ya as m, Ls as n, K as nt, bs as o, W as ot, to as p, Z as q, Rs as r, nt as rt, ps as s, q as st, Fs as t, pt as tt, xo as u, rt as ut, Ka as v, Va as w, Ua as x, Ga as y, hn as z };
