...
var tn = S("maptip", () => {
	...
	__name: "esri-map",
	setup(e) {
		let t = tn(), n = _e("iApi"), r = C(() => t.maptipPoint), i = C(() => t.maptipInstance), a = C(() => t.content), o = we([]), s = M(!1);
		o.push(Ne(r, () => {
			if (r.value) {
	...
	setup(e) {
		...
		let t = cn(), n = _e("iApi"), r = M(), i = C(() => t.opacity), a = C(() => t.mobileView);
		Se(() => {
		...
		return (e, t) => (j(), w(ue, {
			...
			default: L(() => [(j(!0), E(se, null, Ee(o(I(n).screenSize), (e) => (j(), w(sn, {
				key: `${e.id}`,
				panel: e
			}, null, 8, ["panel"]))), 128))]),
			_: 1
	...
	setup(e, { emit: t }) {
		...
		return (t, i) => {
			...
			return R((j(), E("li", {
				...
				D("span", null, [fe(F(o[e.notification.type]) + " ", 1), D("span", Sn, F(e.notification.message), 1)]),
			...
			]), e.notification.messageList && a.value ? (j(), E("div", wn, [(j(!0), E(se, null, Ee(e.notification.messageList, (t, n) => (j(), E("p", { key: e.notification.id + t + n }, F(t), 1))), 128))])) : T("", !0)], 10, bn)), [[c, {
				onShow: s,
				theme: "ramp4",
				animation: "scale"
			}]]);
	...
	setup(e) {
		...
		return (e, t) => {
			...
			}, [(j(!0), E(se, null, Ee(c.value, (e, t) => (j(), E(se, { key: e.id }, [t > 0 ? (j(), E("div", Dn)) : T("", !0), R(pe(Tn, {
				ref_for: !0,
	...
	setup(e) {
		...
		return (e, t) => {
			...
			return j(), w(dn, {
				...
				header: L(() => [D("div", An, [(j(), E("svg", {
					class: "fill-current w-24 h-24",
					xmlns: "http://www.w3.org/2000/svg",
					viewBox: "0 0 24 24",
					"aria-label": I(n)("notifications.open")
				}, [...t[0] ||= [D("path", { d: "M12 22c1.1 0 2-.9 2-2h-4c0 1.1.89 2 2 2zm6-6v-5c0-3.07-1.64-5.64-4.5-6.32V4c0-.83-.67-1.5-1.5-1.5s-1.5.67-1.5 1.5v.68C7.63 5.36 6 7.92 6 11v5l-2 2v1h16v-1l-2-2z" }, null, -1)]], 8, jn)), r.value && r.value > 0 ? (j(), E("span", Mn, F(r.value), 1)) : T("", !0)])]),
				default: L((e) => [D("div", Nn, [D("div", null, [D("h4", Pn, F(I(n)("notifications.title")), 1), D("div", Fn, [R((j(), E("button", {
					type: "button",
					onClick: i,
					...
					animation: "scale",
					appendTo: "parent"
				}]]), pe(a, { onClick: e.close }, null, 8, ["onClick"])])]), pe(kn, { class: "overflow-y-auto h-230" })])]),
				_: 1
			}, 8, ["tooltip"]);
		};
	}
	...
	setup(e) {
		...
		return (n, s) => {
			...
			return R((j(), w(l, {
				...
				default: L((e) => [D("div", Bn, [D("div", null, [
					R((j(), E("button", {
						...
						xmlns: "http://www.w3.org/2000/svg",
						viewBox: "0 0 24 24"
					}, [D("path", { d: "M17.65 6.35C16.2 4.9 14.21 4 12 4c-4.42 0-7.99 3.58-7.99 8s3.57 8 7.99 8c3.73 0 6.84-2.55 7.73-6h-2.08c-.82 2.33-3.04 4-5.65 4-3.31 0-6-2.69-6-6s2.69-6 6-6c1.66 0 3.14.69 4.22 1.78L13 11h7V4l-2.35 2.35z" })], -1)]], 8, Vn)), [[u, {
						placement: "bottom-start",
						theme: "ramp4",
						animation: "scale"
					}]]),
					D("h4", Hn, F(I(t)("ramp.about")), 1),
					D("div", Un, [pe(c, { onClick: e.close }, null, 8, ["onClick"])]),
					D("div", Wn, [
						D("div", null, [D("span", Gn, F(i.value), 1), D("span", Kn, " [" + F(a.value) + "] ", 1)]),
						D("div", null, [D("span", qn, F(o.value[0]), 1), D("span", Jn, F(o.value[1]), 1)]),
...
}), [["__scopeId", "data-v-966796d3"]]), Qn = "__HELP__", $n = S("keyboardnav", () => {
	...
	__name: "map-caption",
	setup(e) {
		let t = Ut(), n = $n(), r = v(), { t: i } = z(), a = _e("iApi"), o = C(() => t.scale), s = C(() => t.attribution), c = C(() => t.coords), l = C(() => t.langtoggle), u = C(() => r.config.map), { keyChain: d, lastAction: f, chainState: p, namespaces: m, activeNamespace: h } = oe(n), g = C(() => {
		...
		return (e, t) => {
			...
			return j(), E("div", er, [
				...
				pe(Ln, { class: "sm:block display-none" }),
				g.value ? (j(), E("span", tr, [D("span", nr, [
					t[0] ||= D("span", { class: "chain-colon" }, ":", -1),
					D("span", rr, F(g.value.keys), 1),
					g.value.cursor ? (j(), E("span", ir, "_")) : T("", !0),
					g.value.options ? (j(), E("span", ar, F(g.value.options), 1)) : T("", !0)
				]), g.value.description ? (j(), E("span", or, "- " + F(g.value.description) + "...", 1)) : T("", !0)])) : s.value?.text.disabled ? T("", !0) : R((j(), E("span", sr, [fe(F(s.value?.text.value), 1)])), [[r, { options: {
					placement: "top",
					hideOnClick: !1,
					theme: "ramp4",
					animation: "scale"
				...
				D("div", cr, [
					c.value?.disabled ? T("", !0) : R((j(), E("div", lr, [fe(F(c.value?.formattedString), 1)])), [[r, { options: {
						hideOnClick: !1,
						theme: "ramp4",
						animation: "scale"
					} }]]),
                ...
                `,
					...
					}, null, 4), D("span", dr, F(o.value?.label), 1)], 8, ur)), [[u, {
						delay: [300, 0],
						placement: "top",
						hideOnClick: !1,
						theme: "ramp4",
					...
					l.value?.disabled ? T("", !0) : (j(), w(n, {
						...
						header: L(() => [D("span", fr, F(I(i)("map.language.short")), 1)]),
						default: L(() => [(j(!0), E(se, null, Ee(ee.value, (e, t) => (j(), E("a", {
							...
							href: "javascript:;",
							onClick: (t) => y(e)
						}, [fe(F(I(i)("map.language." + e)) + " ", 1), e === I(a).$i18n.locale.value ? (j(), E("span", mr, F(I(i)("map.language.curr")), 1)) : T("", !0)], 10, pr))), 128))]),
						_: 1
					}, 8, ["tooltip", "ariaLabel"]))
				])
			]);
	...
	setup(e) {
		let t = fn(), n = _e("iApi"), { t: r } = z(), i = C(() => t.notificationNumber);
		return (e, t) => {
			let a = P("tippy");
			return R((j(), E("button", {
				type: "button",
				...
				xmlns: "http://www.w3.org/2000/svg",
				viewBox: "0 0 24 24"
			}, [D("path", { d: "M12 22c1.1 0 2-.9 2-2h-4c0 1.1.89 2 2 2zm6-6v-5c0-3.07-1.64-5.64-4.5-6.32V4c0-.83-.67-1.5-1.5-1.5s-1.5.67-1.5 1.5v.68C7.63 5.36 6 7.92 6 11v5l-2 2v1h16v-1l-2-2z" })], -1), i.value && i.value > 0 ? (j(), E("span", _r, F(i.value), 1)) : T("", !0)], 8, gr)), [[a]]);
		};
	}
	...
	setup(e) {
		...
		return (e, t) => {
			...
			return r.value ? (j(), E("div", {
				...
				D("div", yr, [D("h2", br, F(I(n)("keyboardInstructions.title")), 1), pe(a, {
					class: "ml-auto",
...
}), Sr = S("instance", () => ({ started: M(!1) })), Cr = { class: "h-full relative" }, wr = { class: "inner-shell absolute top-0 left-0 h-full w-full pointer-events-none" }, Tr = { class: "absolute top-8 w-full flex justify-center" }, Er = {
	key: 1,
	class: "w-full h-full"
}, Dr = O({
	name: "App",
	components: { Shell: /* @__PURE__ */ y(/* @__PURE__ */ O({
		__name: "shell",
		setup(e) {
			let t = _e("iApi"), n = Sr(), r = Kt(), i = cn(), { t: a } = z(), o = C(() => r.items.appbar), s = () => {
				t.event.emit("openKeyboardInstructions");
			}, c = () => i.teleported;
			return (e, t) => (j(), E("div", Cr, [
				D("div", wr, [
					...
					pe(xr, { class: "keyboard-instructions-modal" }),
					pe(ln, { class: "panel-stack sm:flex absolute inset-0 overflow-hidden sm:p-12 z-10 sm:pl-80 xs:pl-40 sm:pb-48 xs:pb-28 xs:pr-0 sm:pr-40" }),
					o.value ? T("", !0) : (j(), w(vr, { key: 0 })),
					pe(hr, { class: "z-30" })
				]),
				I(n).started ? (j(), w(nn, { key: 0 })) : (j(), E("div", Er, [...t[1] ||= [D("div", { class: "spinner relative inset-x-1/2 inset-y-9/20" }, null, -1)]])),
...
var ci = ["content"], li = {
	...
	setup(e, { expose: t }) {
		...
		t({ el: o });
		let d = e, f = C(() => a.fixture.get("appbar") ? i.temporary : []), p = C(() => r.mobileView), m = C(() => r.reorderable), h = C(() => r.pinable), g = `[focus-list], [${hi}]`, ee = (e) => e.scrollHeight > e.clientHeight, _ = (e) => e.querySelector(g), v = () => {
			if (!s.value) return "-1";
		...
		return Se(() => {
			...
			return R((j(), E("div", {
				...
				}, null, 8, pi)) : T("", !0)], 512)) : T("", !0),
				e.footer ? R((j(), E("div", mi, [De(t.$slots, "footer")])), [[_]]) : T("", !0)
			], 8, ci)), [[v, {
				trigger: "manual",
				touch: !1,
				onShow: x,
	...
	setup(e) {
		...
		return (n, r) => {
			let i = P("tippy");
			return j(), E("div", Si, [R((j(), E("button", {
				type: "button",
				class: A(["text-gray-500 hover:text-black focus:text-black p-8", { "text-gray-700": e.active }]),
	...
	setup(e) {
		...
		return (n, r) => {
			let i = P("tippy");
			return j(), E("div", Ti, [R((j(), E("button", {
				type: "button",
				class: A(["text-gray-500 hover:text-black focus:text-black p-8", { "text-gray-700": e.active }]),
	...
	setup(e) {
		...
		return (n, r) => {
			let i = P("tippy");
			return j(), E("div", Oi, [R((j(), E("button", {
				type: "button",
	...
	setup(e) {
		...
		return (n, r) => {
			let i = P("tippy");
			return j(), E("div", Ni, [R((j(), E("button", {
				type: "button",
				...
				d: "M0 0h24v24H0V0z",
				fill: "none"
			}), D("path", { d: "M6 19h12v2H6z" })], -1)]], 10, Pi)), [[i, {
				placement: "bottom",
				theme: "ramp4",
				animation: "scale"
			}]])]);
...
var Li = { class: "relative" }, Ri = ["content", "aria-label"], zi = /* @__PURE__ */ O({
	...
	setup(e) {
		...
		return (n, a) => {
			let o = P("tippy");
			return j(), E("div", Li, [R((j(), E("button", {
				ref_key: "buttonRef",
				ref: r,
				type: "button",
				class: A(["p-8", {
				...
				xmlns: "http://www.w3.org/2000/svg",
				viewBox: "4 4 16 16"
			}, [D("path", { d: "M 8.59 16.34 L 13.17 11.75 L 8.59 7.16 L 10 5.75 L 16 11.75 L 10 17.75 Z" })], -1)]], 10, Ri)), [[o, {
				placement: "bottom",
				theme: "ramp4",
				animation: "scale"
			}]])]);
	...
	setup(e) {
		...
		return (t, a) => {
			let o = P("tippy");
			return j(), E("div", Bi, [R((j(), E("button", {
				ref_key: "buttonRef",
				ref: r,
				type: "button",
				...
				xmlns: "http://www.w3.org/2000/svg",
				viewBox: "4 4 16 16"
			}, [D("path", { d: "M 15.41 16.09 L 10.83 11.5 L 15.41 6.91 L 14 5.5 L 8 11.5 L 14 17.5 Z" })], -1)]], 10, Vi)), [[o, {
				placement: "bottom",
				theme: "ramp4",
				animation: "scale"
			}]])]);
	...
	setup(e) {
		...
		return (e, i) => {
			...
			return j(), w(a, {
				...
				default: L(() => [I(n).isFullscreen ? (j(), E("svg", Wi, [...i[0] ||= [D("path", {
					d: "M0 0h24v24H0z",
					fill: "none"
				}, null, -1), D("path", { d: "M5 16h3v3h2v-5H5v2zm3-8H5v2h5V5H8v3zm6 11h2v-3h3v-2h-5v5zm2-11V5h-2v5h5V8h-3z" }, null, -1)]])) : (j(), E("svg", Gi, [...i[1] ||= [D("path", {
					d: "M0 0h24v24H0z",
					fill: "none"
	...
	setup(e) {
		...
		return (t, n) => {
			...
			return j(), E("div", Qi, [R((j(), E("button", {
				type: "button",
...
}), [["__scopeId", "data-v-1cb84ae1"]]), ta = S("areas-of-interest", () => ({ areas: M([]) })), na = S("export", () => {
	let e = M({
		title: !0,
		map: !0,
		mapElements: !0,
		...
		if (!u) o.value = [], s.value = [], c.value = !1;
			...
			let r = setInterval(() => {
				e.value.config.provinces.listFetched && e.value.config.types.typesFetched && (clearInterval(r), e.value.query(`${u}*`).then((e) => {
					...
					let r = ja(n.value, t.value, s.value);
					o.value = r || [], c.value = !1;
				}));
			}, 250);
		} else {
			let e = ja(n.value, t.value, s.value);
			o.value = e || [], c.value = !1;
		}
	}
	function h(e) {
...
function Ya(e, t) {
	...
	let r = en(), i = de(jr).use(r).use(We, {
		directive: "tippy",
		component: "tippy"
	}).use(n);
	return i.directive("focus-container", ei), i.directive("focus-list", Br), i.directive("focus-item", Wr), i.directive("truncate", ii), i.component("panel-screen", _i), i.component("pin", xi), i.component("close", wi), i.component("back", Di), i.component("expand", Mi), i.component("panel-options-menu", Ui), i.component("dropdown-menu", dn), i.component("minimize", Fi), i.component("right", zi), i.component("left", Hi), i.component("fullscreen-nav-button", Ki), i.component("geolocator-nav-button", qi), i.component("home-nav-button", Ji), i.component("mapnav-button", Zi), i.component("appbar-button", ea), i.component("transition", le), i.component("transition-group", ue), i.config.globalProperties.$iApi = t, i.config.globalProperties.$pinia = n, i.config.idPrefix = `ramp-${e.id || Is.sharedUtils.generateUUID()}`, i.provide("iApi", t), {
		element: i,
		app: i.mount(e),
		i18n: r.global
	};
...
var co = class extends Q {
	...
	extractGeoJsonFields(e) {
		...
		for (let n = 0; n < e.features.length; n++) {
			let r = e.features[n];
			r.geometry.type === "GeometryCollection" && oo(e, n);
	...
	onLoadActions() {
		...
		return this.origRampConfig.divertIdentifyLayer && e.push(new Promise(async (e) => {
			let t = structuredClone(ke(this.origRampConfig.divertIdentifyLayer));
			t.id ||= this.id + "-divertedIdentify";
			let n = t.layerType === V.FEATURE, r = t.layerType === V.WMS;
			n && (t.identifyMode = W.GEOMETRIC), t.expectedDrawTime = 0;
			try {
				...
				console.error(this.id + ": Diverted layer failed to load"), console.error(e), this.$iApi.notify.show(_n.ERROR, this.$iApi.$i18n.t("layer.diverted.error", { id: this.name || this.id }));
			}
			e();
		})), e;
	}
	...
	diCheck() {
		if (this.divertedIdentify) {
			let e = !(this.diLayer && this.diLayer.layerState === K.LOADED);
	...
	async getGraphic(e, t) {
		...
		if (t.getGeom) {
			...
			if (n) r = n;
			else if (this.layerType === V.FEATURE && !(t.forZoom && this.attribs.quickCache.isPoint || t.serverOnly)) {
	...
	set visibility(e) {
		...
		if (e || Ao(this, "1=2"), this.actualViz = e, e && !this.esriLayer.visible) this.esriLayer.visible = !0;
			...
			e = this.$iApi.event.on($.LAYER_DRAWSTATECHANGE, (n) => {
				n.layer.id === this.id && n.state === ct.UP_TO_DATE && (clearTimeout(t), this.$iApi.event.off(e), this.actualViz || (this.esriLayer.visible = !1, Ao(this, "")));
			});
		}
		e && Ao(this, "");
	}
	...
	_visibility;
	constructor(e, t) {
		super(e, t), this.dataFormat = H.ESRI_FEATURE, this.layerFormat = st.NOLAYER, this.drawState = ct.NOT_VISUAL, this.attribs = new Go(), this.supportsFeatures = !0, this.mapLayer = !1, this.isFile = !1, this._visibility = e.state?.visibility ?? !0, this.expectedTime.draw = 0;
	}
	async onInitiate() {
		if (this.sourceJson) {
	...
	symbology;
	constructor(e) {
		super(e), this.geom = Is.geom, this.proj = Is.proj, this.shared = Is.sharedUtils, this.map = new to(e), this.layer = new po(e), this.attributes = new Wo(e), this.query = new os(e), this.symbology = new as(e), Array.isArray(p.request.interceptors) || (p.request.interceptors = []), p.request.interceptors.push({ before: (e) => {
	...
	async getGeolocation(e = !1) {
		...
		if (this.glCoord.length) r = n();
			...
			if (!i || typeof i == "string") {
				let t = i || "internal";
				e || this.$iApi.notify.show(_n.ERROR, this.$iApi.$i18n.t("mapnav.geolocator.error." + t)), r = {
					success: !1,
					error: t
				};
	...
	"../fixtures/appbar/index.ts": () => import("./appbar-BnxfXOau.js"),
	"../fixtures/areas-of-interest/index.ts": () => import("./areas-of-interest-BFxo243-.js"),
	"../fixtures/basemap/index.ts": () => import("./basemap-iLSS7RfI.js"),
	"../fixtures/crosshairs/index.ts": () => import("./crosshairs-BPt8bbJY.js"),
	"../fixtures/details/index.ts": () => import("./details-Cz25xZWB.js"),
	"../fixtures/draw/index.ts": () => import("./draw-DfTZMhh4.js"),
	"../fixtures/export/index.ts": () => import("./export-wA1rQUHJ.js"),
	"../fixtures/export-footnote/index.ts": () => import("./export-footnote-DPwQn9GU.js"),
	"../fixtures/export-legend/index.ts": () => import("./export-legend-C6ippmBk.js"),
	"../fixtures/export-map/index.ts": () => import("./export-map-CiI-rEuj.js"),
	"../fixtures/export-northarrow/index.ts": () => import("./export-northarrow-CYyCrC_G.js"),
	"../fixtures/export-scalebar/index.ts": () => import("./export-scalebar-KNqbGQxF.js"),
	"../fixtures/export-timestamp/index.ts": () => import("./export-timestamp-Bz7XYTAv.js"),
	"../fixtures/export-title/index.ts": () => import("./export-title-DPX97fvd.js"),
	"../fixtures/extentguard/index.ts": () => import("./extentguard-inrwJc_G.js"),
	"../fixtures/gazebo/index.ts": () => import("./gazebo-DZj9jnaQ.js"),
	"../fixtures/geosearch/index.ts": () => import("./geosearch-B_x5TkLi.js"),
	"../fixtures/grid/index.ts": () => import("./grid-DEMdwsIJ.js"),
	"../fixtures/help/index.ts": () => import("./help-DXPM0Isw.js"),
	"../fixtures/hilight/index.ts": () => import("./hilight-Rn8D6KNv.js"),
	"../fixtures/keyboardnav/index.ts": () => import("./keyboardnav-Dw-bBZnZ.js"),
	"../fixtures/layer-reorder/index.ts": () => import("./layer-reorder-CAqsvjFI.js"),
	"../fixtures/legend/index.ts": () => import("./legend-DhXCNAXn.js"),
	"../fixtures/mapnav/index.ts": () => import("./mapnav-W7vRFWvj.js"),
	"../fixtures/metadata/index.ts": () => import("./metadata-BYnnwVRY.js"),
	"../fixtures/northarrow/index.ts": () => import("./northarrow-CVvWeAjh.js"),
	"../fixtures/overviewmap/index.ts": () => import("./overviewmap-DjTUbQG6.js"),
	"../fixtures/panguard/index.ts": () => import("./panguard-J5q5afV0.js"),
	"../fixtures/pindrop/index.ts": () => import("./pindrop-CIDLQZ_q.js"),
	"../fixtures/scrollguard/index.ts": () => import("./scrollguard-BtSUdzvR.js"),
	"../fixtures/settings/index.ts": () => import("./settings-BLc1mTRo.js"),
	"../fixtures/snowman/index.ts": () => import("./snowman-DTxNA37q.js"),
	"../fixtures/swipe/index.ts": () => import("./swipe-DKiyhgOF.js"),
	"../fixtures/wizard/index.ts": () => import("./wizard-QkAn5uO9.js")
...
var gs = /*#__PURE__*/ y(ms, [["render", hs], ["__scopeId", "data-v-a3c61802"]]), _s = /* #__PURE__ */ Object.assign({
	"../fixtures/areas-of-interest/screen.vue": () => import("./screen-kXkIXW4J.js"),
	"../fixtures/basemap/screen.vue": () => import("./screen-xleFbhnm.js"),
	"../fixtures/export/screen.vue": () => import("./screen-C7XH6_b_.js"),
	"../fixtures/geosearch/screen.vue": () => import("./screen-DwKJvAcu.js"),
	"../fixtures/grid/screen.vue": () => import("./screen-DR49q0Ij.js"),
	"../fixtures/help/screen.vue": () => import("./screen-Bqf9r587.js"),
	"../fixtures/layer-reorder/screen.vue": () => import("./screen-BQz45DeU.js"),
	"../fixtures/legend/screen.vue": () => import("./screen-DKK4KARZ.js"),
	"../fixtures/metadata/screen.vue": () => import("./screen-QkvPAZRs.js"),
	"../fixtures/settings/screen.vue": () => import("./screen-De9qNHLZ.js"),
	"../fixtures/wizard/screen.vue": () => import("./screen-CKCX5V3n.js")
}), vs = class extends Q {
	id;
	screens;
	loadedScreens = [];
...
console.info(`RAMP v${{
	...
	minor: "23",
	patch: "0-beta",
	timestamp: "Wed Aug 26 10:37:10 2026 -0400",
	hash: "dc36c25ed909d99e1174c0c2d7d69f53cfb77780"
}.major}.${{
	major: "4",
	minor: "23",
	patch: "0-beta",
...
var Fs = (e, t, n) => new Ja(e, t, n), Is = new Ft();
//#endregion
export { X as $, Ta as A, cn as B, La as C, Fa as D, Na as E, $n as F, Vt as G, Gt as H, Qn as I, Mt as J, Bt as K, Zn as L, ra as M, na as N, Pa as O, ta as P, vt as Q, _n as R, za as S, Ia as T, Wt as U, $ as V, Ht as W, Ct as X, Z as Y, bt as Z, Wa as _, Ms as a, lt as at, Va as b, Io as c, K as ct, mo as d, Y as et, fo as f, Ga as g, Ka as h, Ps as i, B as it, pa as j, Ma as k, bo as l, V as lt, qa as m, Fs as n, q as nt, vs as o, G as ot, $a as p, Q as q, Is as r, et as rt, ds as s, J as st, Ns as t, ut as tt, yo as u, tt as ut, Ua as v, Ra as w, Ba as x, Ha as y, fn as z };
