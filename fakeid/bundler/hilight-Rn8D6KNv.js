import { V as e, c as t, l as n, lt as r, q as i, s as a, u as o } from "./main-CVc82HNP.js";
import { t as s } from "./config-BhPbUOhN.js";
import { i as c, n as l, r as u, t as d } from "./hilight-defs-ClNzkX2a.js";
...
var f = class extends i {
	...
	lastAdd = 0;
	constructor(t, n) {
		super(t, n), this.onOpacity = t.options?.onOpacity ?? .75, this.offOpacity = t.options?.offOpacity > .02 ? t.options.offOpacity : .02, this.$iApi.geo.map.loadPromise().then(() => {
			this.hilightSetup();
	...
	handlers = [];
	constructor(e, t) {
		super(e, t), this.$iApi.geo.map.loadPromise().then(() => {
			this.hilightSetup(e);
		});
	}
	hilightSetup(e) {
	...
	async add(e) {
		...
		if (t && t.esriLayer && t.isLoaded && t instanceof n) {
