import{B as e,G as t,I as n,b as r}from"./main-Bquw5Qxr.js";import{B as i,C as a,G as o,H as s,N as c,O as l,St as u,T as d,Y as f,b as p,ft as m,nt as h,pt as g,t as _,tt as v,vt as y,x as b,y as x}from"./vue.esm-bundler-Guv68nQe.js";import{n as S}from"./vue-i18n-840Hh1bp.js";import{t as C}from"./marked.esm-CbMAa6oD.js";_();var w=`<?xml version="1.0" encoding="UTF-8"?>
...
`,O={key:0},k={class:`flex justify-center`},A={key:0,class:`flex flex-col justify-center text-center`},j=[`innerHTML`],M=[`innerHTML`],N={key:3,class:`flex flex-col justify-center text-center`},P={class:`text-xl mt-20`},F={key:1,class:`p-5`},I=l({__name:`screen`,props:{panel:{type:Object,required:!0},payload:{type:Object,required:!0}},setup(l){let _=r(),{t:I}=S(),L=c(`iApi`),R=g(),z=l,B=x(()=>_.status),V=x(()=>_.response),H=g(!1),U=m({}),W=m([]),G=m([]);s(()=>{_.status=`loading`,K(),W.push(L.event.on(t.LAYER_REMOVE,e=>{z.payload.layer?.uid===e.uid&&z.panel.close()})),G.push(v(()=>z.payload.layer.uid,(e,t)=>{e!==t&&(_.status=`loading`,K())}))}),i(()=>{W.forEach(e=>L.event.off(e)),G.forEach(e=>e())});let K=async()=>{if(H.value=z.payload.layer!==void 0&&!z.payload.layer.isRemoved,H.value){if(z.payload.type===`xml`){let e=await q(z.payload.url,[]);if(_.status=`success`,e?.firstElementChild){let t=document.createElement(`div`);t.appendChild(X(`${e.firstElementChild.outerHTML}`)),(z.payload.catalogueUrl||z.payload.url)&&t.appendChild(X(`<h5 class="text-xl font-bold mb-3">${I(`metadata.xslt.metadata`)}</h5>`)),z.payload.catalogueUrl&&t.appendChild(X(`<p><a style="color: blue;" href="${z.payload.catalogueUrl}" target="_blank">${I(`metadata.xslt.cataloguePage`)}</a></p>`)),t.appendChild(X(`<p><a style="color: blue;" href="${z.payload.url}" target="_blank">${I(`metadata.xslt.metadataPage`)}</a> (xml)</p>`)),_.response=t.outerHTML}}else if(z.payload.type===`html`){let e=await Y(z.payload.url);_.status=e.status,_.response=e.response}else if(z.payload.type===`md`){let e=await Y(z.payload.url);_.status=e.status,_.response=C(e.response,{async:!1})}}},q=async(t,n)=>{let r;if(r=z.payload.xmlType&&z.payload.xmlType===`DCAT`?L.language===`en`?E:D:L.language===`en`?w:T,r=r.replace(/\{\{([\w.]+)\}\}/g,(e,t)=>I(t)),!U[t]){let n=await Y(t);if(n.status===`error`){let t=n.reason?I(`metadata.notification.rawFallbackWithReason`,{reason:n.reason}):I(`metadata.notification.rawFallback`);L.notify.show(e.WARNING,t)}U[t]=n.response}return J(U[t],r,n)},J=(e,t,r)=>{let i=null;if(window.XSLTProcessor){let a=new window.XSLTProcessor,o=new DOMParser,s=o.parseFromString(e,`text/xml`),c=o.parseFromString(t,`text/xml`);a.importStylesheet(c),r&&r.forEach(e=>a.setParameter(``,e.key,e.value||``)),i=a.transformToFragment(s,document);let l={className:`underline text-blue-700 break-all`,target:`_blank`,validate:{url:e=>/^https?:\/\//.test(e)}},u=i.firstElementChild;u&&(z.payload.treatXmlAsMarkdown?u.innerHTML=C.parse(u.innerHTML,{async:!1}):u.innerHTML=n(u.innerHTML,l))}return i},Y=e=>new Promise(t=>{let n=new XMLHttpRequest;n.open(`GET`,e,!0),n.responseType=`text`,n.onload=()=>{n.status===200?t({status:`success`,response:n.response}):t({status:`error`,response:`Could not load results from remote service.`,reason:(n.statusText?`${n.status} ${n.statusText}`:`HTTP ${n.status}`)||void 0})},n.onerror=()=>{t({status:`error`,response:`Could not load results from remote service.`})},n.send()});function X(e){let t=document.createElement(`div`);return t.innerHTML=e,t}return(e,t)=>{let n=f(`panel-screen`);return o(),b(n,{panel:l.panel,ref_key:`el`,ref:R},{header:h(()=>[d(u(y(I)(`metadata.title`))+`: `+u(l.payload.layerName),1)]),content:h(()=>[H.value?(o(),a(`div`,O,[p(`div`,k,[B.value==`loading`?(o(),a(`div`,A,u(y(I)(`metadata.loading`)),1)):l.payload.type===`xml`&&B.value==`success`?(o(),a(`div`,{key:1,innerHTML:V.value,class:`flex flex-col justify-center max-w-full xml-content`},null,8,j)):(l.payload.type===`html`||l.payload.type===`md`)&&B.value==`success`?(o(),a(`div`,{key:2,innerHTML:V.value,class:`flex flex-col justify-center max-w-full metadata-view`},null,8,M)):(o(),a(`div`,N,[t[0]||=p(`img`,{src:`https://i.imgur.com/fA5EqV6.png`},null,-1),p(`span`,P,u(y(I)(`metadata.error`)),1)]))])])):(o(),a(`div`,F,[p(`span`,null,u(y(I)(`metadata.label.no.layer`)),1)]))]),_:1},8,[`panel`])}}});export{I as default};