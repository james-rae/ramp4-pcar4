...
import type { MapIdentifyResult } from '@/geo/api';
import { LayerType } from '@/geo/api';
import { HILIGHT_LAYER_NAME } from './api/hilight-defs';

// TODO: Remove the vue file. lets just use the index.ts and hilight.ts
