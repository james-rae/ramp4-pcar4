...
import GraphicLayer from '@/geo/layer/graphic-layer';
import { HILIGHT_LAYER_NAME, type HilightGraphic } from '../hilight-defs';
...
export class GlowHilightMode extends BaseHilightMode {
    ...
    toggleHilightOn(hilightGraphics: Array<HilightGraphic> | HilightGraphic) {
        ...
        if (
            ...
            const hGraphics: Array<HilightGraphic> =
                hilightGraphics instanceof Array
                    ? hilightGraphics
                    : [hilightGraphics];
