...
const setUpColumns = async (): Promise<void> => {
     ...
     */
    const fancyLayers = gridLayers.value.filter(layer => layer && layer.supportsFeatures && layer.isLoaded);
    ...
    //          if not, the rvSymbol will lurk within regular columns. The accessibility setup code will
    //          attempt to add handlers to header buttons and explode.
