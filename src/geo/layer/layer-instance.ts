...
export class LayerInstance extends APIScope {
    ...
    get tooltipField(): string {
        console.warn('tooltipField layer property is deprecated. Please adjust to use maptipField instead');
    ...
    get tooltipArcade(): string {
        console.warn('tooltipArcade layer property is deprecated. Please adjust to use maptipArcade instead');
    ...
    async setTooltipArcade(formula: string): Promise<void> {
        console.warn('setTooltipArcade layer method is deprecated. Please adjust to use setMaptipArcade instead');
    ...
    get hovertips(): boolean {
        console.warn('hovertips layer property is deprecated. Please adjust to use maptips instead');
        return this.maptips;
    }
    ...
    tooltipValue(attributes: Attributes): string {
        console.warn('tooltipValue layer method is deprecated. Please adjust to use maptipValue instead');
