import{aL as x,cm as G,fX as Je,bO as Zt,gM as $t,bc as qe,jb as Xt,aZ as L,kj as Kt,tP as Qt,qH as ea,lS as ta,tQ as Ze,a7 as l,a8 as A,ab as j,tR as aa,tS as oa,lh as X,bp as $e,lg as Ce,kt as Xe,kh as ra,nr as Ke,tT as H,j0 as ne,aJ as Qe,h$ as se,e0 as ia,dy as na,cO as sa,cb as C,aU as la,b6 as ca,aX as da,bz as ha,b2 as ze,b1 as ua,bg as et,b7 as ma,kk as pa}from"./main-CO6m7wmX.js";import{h as V,aD as le,j as ce,aU as N,U as tt,aV as de,aW as at,aX as ot,u as fa,g as B,aY as va,aZ as ga,aj as xa,aE as ba,a_ as K,r as O,S as Q,N as k,aP as W,a$ as U,H as ee,d as M,P as Y,an as wa,L as ya,b0 as Ma,b1 as rt,aI as he,i as it,aF as nt,o as st,c as Ta,a as lt,b2 as ct,k as Sa,l as Fe,t as ue,w as _a,x as dt,b as Ca,O as S,K as Ne,al as za,b3 as Fa,e as te,b4 as Na,a1 as ae,b5 as Oa,b6 as ht,E as me,aQ as ut,f as mt,M as pt,b7 as ft,Q as vt,J as gt,aR as Ia,X as La,Y as Va,Z as Ea,_ as Ra,V as Pa,$ as Da,a0 as Ga,p as Aa,a7 as ja,s as m,a8 as Ha,b8 as Oe,b9 as Ie,at as Ba,aN as ka,ba as Wa,aT as Ua,aC as Ya}from"./VertexColor.glsl-DQCgbLEA.js";import{t as Le,Q as Ve}from"./InterleavedLayout-DONLDBgR.js";import{n as p,t as r}from"./glsl-Bw9xHunC.js";import{i as _,F as xt,z as pe,S as bt}from"./BufferView-Dxbk53yk.js";import{r as Ja}from"./VertexBuffer-B_5fe83T.js";import{s as fe}from"./ShaderBuilder-BT6kZ0Ah.js";import{w as Ee,u as Re,c as qa}from"./renderState-DbQislST.js";import{n as Za}from"./enums-DDJfd4_p.js";import{h as $a,E as Xa}from"./Texture-DaNkAwbR.js";function Ka(e){e.varyings.add("linearDepth","float",{invariant:!0})}function Qa(e,t){Ka(e),e.vertex.code.add(r`
...
}`)}}function q(e,t){go(e,t,new O("textureAlphaCutoff",o=>o.textureAlphaCutoff))}function go(e,t,o){const a=e.fragment,i=t.alphaDiscardMode,n=i===0;i!==2&&i!==3||a.uniforms.add(o),a.code.add(r`
...
forwardObjectAndLayerIdColor();`),e.include(q,t),a.main.add(r`
        ...
        vpos = addVerticalOffset(vpos, localOrigin);
        gl_Position = transformPosition(proj, view, vpos);
        forwardTextureCoordinates();`),a.include(Y,t),e.include(q,t),a.main.add(r`
        discardBySlice(vpos);
        ${p(d,r`vec4 texColor = texture(tex, ${g?"colorUV":"vuv0"});
                discardOrAdjustAlpha(texColor);`)}
...
vpos = addVerticalOffset(vpos, localOrigin);
gl_Position = transformPosition(proj, view, vpos);
forwardTextureCoordinates();`),a.include(Y,t),e.include(q,t),e.include(wa,t),a.main.add(r`
        discardBySlice(vpos);
        ${p(d,r`vec4 texColor = texture(tex, ${g?"colorUV":"vuv0"});
                discardOrAdjustAlpha(texColor);`)}
...
}`))}const At=x(),z=Je();function ie(e){e.uniforms.add(new B("mainLightDirection",t=>t.lighting.mainLight.direction))}function Z(e){e.uniforms.add(new B("mainLightIntensity",t=>t.lighting.mainLight.intensity))}function Fo(e){ie(e),Z(e),e.code.add(r`vec3 applyShading(vec3 shadingNormal, float shadow) {
...
return mix(mrr, vec3(0.0, 1.0, 0.04), snow);
  ...
  `);const{hasColorTexture:w,hasColorTextureTransform:I}=e;return i.include(je,e),i.include(Me,e),t.include(q,e),i.include(Y,e),t.include(vt,e),me(i,e),ie(i),Te(i),Se(i),i.uniforms.add(a.uniforms.get("localOrigin"),a.uniforms.get("view"),new te("ambient",f=>f.ambient),new te("diffuse",f=>f.diffuse),new O("opacity",f=>f.opacity),new O("layerOpacity",f=>f.layerOpacity)),w&&i.uniforms.add(new M("tex",f=>f.texture)),t.include(He,e),i.include(Ae,e),i.include(gt),i.include(ke,e),Z(i),i.main.add(r`
      discardBySlice(vpos);
      discardByTerrainDepth();
