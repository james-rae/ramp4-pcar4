import "tiny-emitter";
import { B as I, L as P, D as d, I as O, y as R, J as F, m as G, K as T, F as z, G as v, _ as k } from "./main-BtBsNTgZ.js";
...
import { markRaw as x, defineComponent as D, inject as W, ref as f, computed as l, reactive as E, onMounted as j, onBeforeUnmount as q, resolveDirective as J, createElementBlock as y, openBlock as g, createElementVNode as c, normalizeStyle as S, normalizeClass as K, withDirectives as U, unref as L } from "vue";
import "pinia";
...
const Q = { class: "relative h-full w-full overflow-hidden" }, ee = { class: "absolute h-30 w-30 top-0 right-0" }, te = ["content", "aria-label"], ie = /* @__PURE__ */ D({
  __name: "overviewmap",
  setup(u) {
    const e = d(), { t: i } = X(), a = W("iApi"), t = G(), o = f(), n = l(
      () => t.activeBasemapConfig
    ), _ = l(() => e.mapConfig), M = l(() => e.basemaps), A = l(() => e.startMinimized), r = E(new Y(a)), p = f(!0), b = f(!1), m = E([]);
    j(async () => {
