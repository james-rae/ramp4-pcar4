...
import { _ as H, d as L, k as X, F as ee, G as te } from "./main-BtBsNTgZ.js";
...
const G = /* @__PURE__ */ H(ne, [["render", ae]]), se = /* @__PURE__ */ T({
  ...
  setup(h) {
    ...
    const p = [
      {
        type: "point",
        icon: g(_(() => import("./point-icon-DRGOmRIg.js")))
      },
      {
        type: "polyline",
        icon: g(_(() => import("./polyline-icon-BYBz5hEp.js")))
      },
      {
        type: "polygon",
        icon: g(_(() => import("./polygon-icon-m3RX4a14.js")))
      },
      {
        type: "circle",
        icon: g(_(() => import("./circle-icon-BfE-X7T6.js")))
      },
      {
        type: "rectangle",
        icon: g(_(() => import("./rectangle-icon-BGaoCvhw.js")))
      }
    ], a = A(() => {
      const s = p.filter((u) => e.supportedTypes.some((x) => x.type === u.type));
      return s.push({
        type: "edit",
        icon: g(_(() => import("./edit-icon-BdcUcqGZ.js")))
      }), s;
    }), n = (s) => {
