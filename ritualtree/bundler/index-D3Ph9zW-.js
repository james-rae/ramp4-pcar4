...
import "tiny-emitter";
import { F as f, k as y, L as a, U as m, M as g } from "./main-BdGV-Vps.js";
...
class h extends y {
  ...
  mapWmsLayerList(e, r) {
    let i = [];
    return e.forEach((t) => {
      t.name === null && t.layers ? i = i.concat(t.layers) : i.push(t);
    }), r ? i.flatMap((t) => ({
    ...
    this.$iApi.panel.register(
      {
        wizard: {
          screens: {
            "wizard-screen": () => u(import("./screen-GCJWenOx.js"))
          },
          button: {
