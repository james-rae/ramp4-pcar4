...
import { _ as H, d as L, F as X, G as ee } from "./main-BdGV-Vps.js";
...
const G = /* @__PURE__ */ H(ne, [["render", ae]]), se = /* @__PURE__ */ T({
  ...
  setup(h) {
    ...
    const p = [
      {
        type: "point",
        icon: g(_(() => import("./point-icon-DUIMN2K0.js")))
      },
      {
        type: "polyline",
        icon: g(_(() => import("./polyline-icon-Cbuf-i0S.js")))
      },
      {
        type: "polygon",
        icon: g(_(() => import("./polygon-icon-CHN9CGLi.js")))
      },
      {
        type: "circle",
        icon: g(_(() => import("./circle-icon-aXDMaGHu.js")))
      },
      {
        type: "rectangle",
        icon: g(_(() => import("./rectangle-icon-CNmJBvee.js")))
      }
    ], a = A(() => {
      const s = p.filter((u) => e.supportedTypes.some((x) => x.type === u.type));
      return s.push({
        type: "edit",
        icon: g(_(() => import("./edit-icon-BTimgUDg.js")))
      }), s;
    }), n = (s) => {
