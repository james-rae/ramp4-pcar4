...
import { ref as f, computed as D, markRaw as ne, defineComponent as N, inject as Se, reactive as Le, watch as kt, onBeforeUnmount as vt, resolveDirective as G, withDirectives as U, createElementBlock as w, openBlock as b, withKeys as ys, withModifiers as ti, onMounted as st, normalizeStyle as Ni, normalizeClass as ue, createVNode as me, Transition as Fi, withCtx as pe, createBlock as ee, resolveDynamicComponent as gs, mergeProps as vs, useCssVars as bs, TransitionGroup as Di, Fragment as tt, renderList as bt, unref as I, nextTick as It, renderSlot as Ve, createElementVNode as y, vShow as As, resolveComponent as ae, createTextVNode as ht, toDisplayString as z, createCommentVNode as B, onUpdated as ws, Teleport as Es, getCurrentInstance as xs, useTemplateRef as gi, createApp as Gi, toRaw as ke, h as Ss, render as qt, defineAsyncComponent as Is } from "vue";
...
import { fromJSON as si } from "@arcgis/core/symbols/support/jsonUtils";
...
import { cloneDeep as bi } from "lodash-es";
...
class H extends rt {
  ...
  static fromArcServer(e, t) {
    return H.fromESRI(vi.fromJSON(e), t);
  }
...
class Xs extends re {
   ...
   */
  addDefaultEvents(e) {
    return (!Array.isArray(e) || e.length === 0) && (e = Object.values(Zt)), e.map((t) => this.defaultHandlerFactory(t));
  }
  /**
      ...
      case "ramp_layer_remove_checks_grid":
        t = (i) => {
          if (this.$iApi.fixture.get("grid")) {
            const s = Kt(this.$vApp.$pinia), a = s.getGridId(i.id);
            if (a === void 0) return;
...
function ir() {
  return Ps({
    ...
    locale: document.documentElement.getAttribute("lang") || wi,
    fallbackLocale: wi,
    globalInjection: !0,
    messages: er,
    numberFormats: tr
...
const Gt = W("maptip", () => {
  ...
  __name: "esri-map",
  setup(r) {
    const e = Gt(), t = Se("iApi"), i = D(() => e.maptipPoint), s = D(() => e.maptipInstance), a = D(() => e.content), o = Le([]), l = f(!1);
    o.push(
      kt(i, () => {
        if (i.value) {
  ...
  constructor(e) {
    this.resizeObserver = new ResizeObserver((t) => {
      t.length && window.requestAnimationFrame(() => {
        t.forEach((i) => {
          const s = i.target.dataset.breakpoints, a = s ? JSON.parse(s) : e ?? rr;
...
const ar = ["data-cy"], Zi = /* @__PURE__ */ N({
    ...
    return (n, c) => {
      ...
      return b(), w("div", {
        ...
        me(Fi, {
          ...
          default: pe(() => [
            U((b(), ee(gs(r.panel.route.screen), vs({ class: "h-full" }, r.panel.route.props, { panel: r.panel }), null, 16, ["panel"])), [
              [u]
            ])
          ]),
          _: 1
  ...
  function O() {
    ...
    !L.includes(r.value) && !s.value) {
      let Ie;
      for (let yi = 0; yi < L.length - 1 && E < (r.value.width || Q) + we; yi++)
        Ie = L.shift(), E += Ie.width || Q;
      E >= (r.value.width || Q) ? L.unshift(r.value) : e.value || (Ie = L.shift(), L.unshift(r.value));
      const nt = n.value.indexOf(r.value), Ne = n.value.indexOf(Ie), Bt = n.value.slice();
  ...
  for (const [i, s] of e)
    t[i] = s;
  return t;
}, nr = /* @__PURE__ */ qe(or, [["__scopeId", "data-v-717e4bd7"]]), lr = ["content", "aria-label"], ri = /* @__PURE__ */ N({
  ...
  function a(u) {
    if (e.value.includes(u)) {
      ...
      u instanceof Qi && c(u), p > -1 && e.value.splice(p, 1);
    }
  }
  function o(u) {
    t.value[u.id] = u;
...
}), cr = { class: "h-full flex flex-col" }, ur = { class: "w-full flex mb-6" }, pr = ["content", "aria-label"], dr = /* @__PURE__ */ N({
  __name: "screen",
  props: {
    panel: {
      type: Object,
...
const fr = ["content"], mr = { class: "flex items-center text-left" }, yr = { class: "select-text cursor-text" }, gr = ["content", "aria-label"], vr = {
  key: 0,
  class: "text-left"
}, br = /* @__PURE__ */ N({
      ...
      return U((b(), w("li", {
        ...
        y("div", mr, [
          y("span", null, [
            ...
            y("span", yr, z(r.notification.message), 1)
          ]),
          ...
          U((b(), w("button", {
            type: "button",
            onClick: c[0] || (c[0] = ti(() => i("remove"), ["stop"])),
        ...
        r.notification.messageList && a.value ? (b(), w("div", vr, [
...
}), xr = { class: "flex items-center hover:text-white" }, Sr = ["aria-label"], Ir = {
  key: 0,
  class: "number rounded-full w-18 text-white"
}, _r = { class: "notification-dropdown pointer-events-auto bg-white rounded text-center text-black w-500 h-256 flex flex-col p-0" }, Tr = { class: "pb-8 border-b border-gray-600" }, Lr = { class: "absolute flex right-3 top-3" }, Rr = ["content", "aria-label"], $r = /* @__PURE__ */ N({
      ...
      return b(), ee(ri, {
        ...
        header: pe(() => [
          y("div", xr, [
            ...
            i.value && i.value > 0 ? (b(), w("span", Ir, z(i.value), 1)) : B("", !0)
          ])
        ]),
        default: pe((c) => [
          y("div", _r, [
            y("div", null, [
              y("h4", Tr, z(I(t)("notifications.title")), 1),
              y("div", Lr, [
                U((b(), w("button", {
                  type: "button",
                  onClick: s,
            ...
            me(Xi, { class: "overflow-y-auto h-230" })
          ])
        ]),
        _: 1
      }, 8, ["tooltip"]);
...
}), Cr = /* @__PURE__ */ qe($r, [["__scopeId", "data-v-3623a7d2"]]), Or = { class: "flex hover:text-white" }, kr = ["aria-label"], Mr = { class: "about-ramp-dropdown pointer-events-auto bg-white rounded w-256 h-50" }, Pr = ["aria-label", "content"], Nr = { class: "pb-8 pt-1 border-b border-gray-600 mb-10" }, Fr = { class: "absolute right-5 top-5" }, Dr = { class: "select-text" }, Gr = { class: "font-bold cursor-text" }, Ur = { class: "text-sm cursor-text" }, Vr = { class: "font-bold cursor-text" }, zr = { class: "ml-5 cursor-text" }, Br = /* @__PURE__ */ N({
        ...
        default: pe((g) => [
          y("div", Mr, [
            y("div", null, [
              ...
              y("div", Dr, [
                y("div", null, [
                  y("span", Gr, z(s.value), 1),
                  y("span", Ur, " [" + z(a.value) + "] ", 1)
                ]),
                y("div", null, [
                  y("span", Vr, z(o.value[0]), 1),
                  y("span", zr, z(o.value[1]), 1)
                ]),
...
}), qr = /* @__PURE__ */ qe(Br, [["__scopeId", "data-v-e0d1ce9f"]]), jr = "S", Hr = "__HELP__", es = W("keyboardnav", () => {
  ...
  function p(_, M, P) {
    if (_) {
      ...
      if (_ === "reset") {
        ...
        A([jr, q]), Y(void 0), R("awaitAction"), F.activeNamespace = q;
      }
    }
  }
  function d(_, M, P) {
  ...
  return O;
}), Wr = { class: "map-caption absolute bottom-0 h-29 sm:h-38 flex justify-end pointer-events-auto cursor-default select-none text-gray-200 bg-black-75 left-0 right-0 py-2 sm:py-6" }, Yr = {
  key: 0,
  class: "relative top-2 sm:top-1 ml-4 sm:ml-0 shrink-0"
}, Jr = ["href", "aria-label"], Kr = ["src", "alt"], Zr = {
  key: 1,
  class: "relative ml-10 top-2 text-sm sm:text-base font-mono flex items-center gap-2",
  "aria-live": "polite"
}, Qr = { class: "chain-content" }, Xr = { class: "chain-keys" }, ea = {
  key: 0,
  class: "chain-cursor"
}, ta = {
  key: 1,
...
}, ra = { class: "flex min-w-fit justify-end" }, aa = {
  key: 0,
  class: "pl-8 px-14 sm:block display-none relative top-2"
}, oa = ["aria-pressed", "aria-label", "content"], na = { class: "relative top-1 text-sm sm:text-base" }, la = { class: "text-gray-200 hover:text-white text-sm sm:text-base pb-5" }, ca = ["onClick"], ua = {
  key: 0,
  class: "sr-only"
}, pa = /* @__PURE__ */ N({
  __name: "map-caption",
  setup(r) {
    const e = Je(), t = es(), i = be(), { t: s } = se(), a = Se("iApi"), o = D(() => e.scale), l = D(() => e.attribution), n = D(() => e.coords), c = D(() => e.langtoggle), u = D(() => i.config.map), { keyChain: p, lastAction: d, chainState: g, namespaces: h, activeNamespace: m } = fs(t), A = D(() => {
    ...
    return (F, _) => {
      ...
      return b(), w("div", Wr, [
        ...
        me(Cr, { class: "sm:block display-none" }),
        Y() ? (b(), w("span", Yr, [
          y("a", {
        ...
        A.value ? (b(), w("span", Zr, [
          y("span", Qr, [
            ...
            y("span", Xr, z(A.value.keys), 1),
            A.value.cursor ? (b(), w("span", ea, "_")) : B("", !0),
            A.value.options ? (b(), w("span", ta, z(A.value.options), 1)) : B("", !0)
          ]),
          A.value.description ? (b(), w("span", ia, "- " + z(A.value.description) + "...", 1)) : B("", !0)
        ])) : l.value?.text.disabled ? B("", !0) : U((b(), w("span", sa, [
        ...
        y("div", ra, [
          n.value?.disabled ? B("", !0) : U((b(), w("div", aa, [
          ...
          c.value?.disabled ? B("", !0) : (b(), ee(M, {
            ...
            header: pe(() => [
              y("span", la, z(I(s)("map.language.short")), 1)
            ]),
            default: pe(() => [
              (b(!0), w(tt, null, bt(v.value, (J, E) => (b(), w("a", {
                ...
                J === I(a).$i18n.locale.value ? (b(), w("span", ua, z(I(s)("map.language.curr")), 1)) : B("", !0)
              ], 10, ca))), 128))
            ]),
            _: 1
          }, 8, ["tooltip", "ariaLabel"]))
  ...
  setup(r) {
    ...
    return (a, o) => {
      ...
      return U((b(), w("button", {
        ...
        s.value && s.value > 0 ? (b(), w("span", ha, z(s.value), 1)) : B("", !0)
      ], 8, da)), [
        [l]
      ]);
    };
  }
}), ma = /* @__PURE__ */ qe(fa, [["__scopeId", "data-v-a451db5c"]]), ya = { class: "flex items-center mb-20" }, ga = { class: "text-xl" }, va = /* @__PURE__ */ N({
    ...
    return (c, u) => {
      ...
      return i.value ? (b(), w("div", {
        ...
        y("div", {
          ...
          y("div", ya, [
            y("h2", ga, z(I(t)("keyboardInstructions.title")), 1),
            me(p, {
              class: "ml-auto",
...
}), ut = W("instance", () => ({ started: f(!1) })), ba = { class: "h-full relative" }, Aa = { class: "inner-shell absolute top-0 left-0 h-full w-full pointer-events-none" }, wa = { class: "absolute top-8 w-full flex justify-center" }, Ea = {
  key: 1,
  class: "w-full h-full"
}, xa = /* @__PURE__ */ N({
  __name: "shell",
  setup(r) {
    ...
    return (c, u) => (b(), w("div", ba, [
      y("div", Aa, [
        ...
        me(va, { class: "keyboard-instructions-modal" }),
        me(nr, { class: "panel-stack sm:flex absolute inset-0 overflow-hidden sm:p-12 z-10 sm:pl-80 xs:pl-40 sm:pb-48 xs:pb-28 xs:pr-0 sm:pr-40" }),
        o.value ? B("", !0) : (b(), ee(ma, { key: 0 })),
        me(pa, { class: "z-30" })
      ]),
      I(t).started ? (b(), ee(sr, { key: 0 })) : (b(), w("div", Ea, u[1] || (u[1] = [
...
}), Sa = /* @__PURE__ */ qe(xa, [["__scopeId", "data-v-3d441124"]]), Ia = N({
  name: "App",
  components: { Shell: Sa },
  setup() {
    const r = xs();
...
const Ra = /* @__PURE__ */ qe(Ia, [["render", La]]), Oe = "focus-list", He = "focus-item", $a = "focus-icon", Ca = "focus-container", yt = `[${Oe}],[${Ca}]`, Tt = "truncate-text", Lt = "show-truncate", dt = "focused", Qt = `button,input,select,a,textarea,[contenteditable],[${Oe}],[${$a}],[tabIndex]`, Oa = {
  mounted(r, e) {
    +r.getAttribute("tabindex") <= 0 && r.setAttribute("tabindex", "0"), r.toggleAttribute(Oe, !0), new ka(r, e.value);
  },
  updated(r) {
    ts(r);
  }
...
const Ei = "focus-item", Ma = {
  beforeMount(r, e) {
    r.hasAttribute("id") || r.setAttribute("id", Pa()), e.value ? r.setAttribute(Ei, e.value) : r.toggleAttribute(Ei, !0);
  }
};
function Pa() {
  let r;
...
const ai = "focus-container", is = "focus-list", Na = "focus-icon", Ht = `[${is}],[${ai}]`, xi = `button,input,select,a,textarea,[contenteditable],.ag-tab-guard,[${is}],[${ai}],[${Na}],[tabIndex]`;
let Wt = [];
const Fa = {
  mounted(r) {
    [...document.querySelectorAll(".inner-shell")].some((t) => t.contains(r)) && Wt.push(new Da(r));
  },
  beforeUnmount(r) {
    Wt = Wt.filter((e) => e.element === r ? (e.removeEventListeners(), !1) : !0);
  }
};
class Da {
  element;
   ...
   */
  constructor(e) {
    this.element = e, this.element.toggleAttribute(ai, !0), this.element.tabIndex = 0, setTimeout(() => this.disableTabbing(), 600);
    const t = this;
  ...
  enableTabbing() {
    ...
    return Array.prototype.map.call(this.element.querySelectorAll(xi), (t) => {
      (t.closest(Ht) === this.element || t.closest(Ht) === t && t.parentElement.closest(Ht) === this.element) && t.offsetParent && (t.tabIndex = 0, e === void 0 && (e = t));
    }), e;
  }
}
const Ga = "truncate-text", Ua = "truncate-trigger", Va = {
  beforeMount(r, e) {
    !r.classList.contains("truncate") && !e.value?.noTruncateClass && r.classList.add("truncate"), r.toggleAttribute(Ga, !0);
  },
  mounted(r, e) {
    let t;
    e.value && e.value.externalTrigger && (t = r.closest(`[${Ua}]`)), Ds(r, {
...
const qa = ["content"], ja = {
  ...
  setup(r, { expose: e }) {
    const { t } = se(), i = it(), s = Dt(), a = Se("iApi"), o = gi("el"), l = gi("contentEl"), n = f();
    e({ el: o });
    ...
    return st(() => {
      ...
      return U((b(), w("div", {
        ...
        r.header ? (b(), w("header", ja, [
          me(Y, {
            class: ue(r.panel.teleport ? "display-none" : "block sm:display-none"),
            onClick: C[0] || (C[0] = (L) => r.panel.close())
          }, null, 8, ["class"]),
          U((b(), w("h2", Ha, [
            v.$slots.header ? Ve(v.$slots, "header", { key: 0 }) : (b(), w("div", Wa, z(I(t)(r.panel.alertName)), 1))
          ])), [
            [q]
          ]),
          ...
          y("div", {
            ...
            r.panel.teleport ? B("", !0) : (b(), w("div", Ya, [
              d.value ? (b(), ee(V, {
                key: 0,
...
}), Qa = { class: "relative" }, Xa = ["content", "aria-label"], eo = ["transform"], to = /* @__PURE__ */ N({
  __name: "pin",
  props: {
    active: Boolean
  },
...
}), io = { class: "relative" }, so = ["content", "aria-label"], ro = /* @__PURE__ */ N({
  __name: "close",
  props: {
    active: Boolean
  },
...
}), ao = { class: "relative" }, oo = ["content", "aria-label"], no = /* @__PURE__ */ N({
  __name: "back",
  props: {
    active: Boolean
  },
...
}), lo = { class: "w-32 h-32" }, co = ["content", "aria-label"], uo = {
  key: 0,
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 24 24",
...
}), fo = { class: "relative" }, mo = ["content", "aria-label"], yo = /* @__PURE__ */ N({
  __name: "minimize",
  props: {
    active: Boolean
  },
...
}), go = { class: "relative" }, vo = ["content", "aria-label"], bo = /* @__PURE__ */ N({
  __name: "right",
  props: {
    active: Boolean
  },
...
}), Ao = { class: "relative" }, wo = ["content", "aria-label"], Eo = /* @__PURE__ */ N({
  __name: "left",
  props: {
    active: Boolean
  },
...
}), So = /* @__PURE__ */ qe(xo, [["__scopeId", "data-v-51e22a4a"]]), Io = {
  key: 0,
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 24 24",
  ...
  setup(r) {
    ...
    return (s, a) => {
      ...
      return b(), ee(o, {
        ...
        default: pe(() => [
          I(t).isFullscreen ? (b(), w("svg", Io, a[0] || (a[0] = [
            y("path", {
              d: "M0 0h24v24H0z",
              fill: "none"
            }, null, -1),
  ...
  tabindex: "-1"
}, Co = ["content", "aria-label"], Oo = /* @__PURE__ */ N({
  __name: "button",
  props: {
    onClickFunction: {
      type: Function,
  ...
  class: "relative",
  tabindex: "-1"
}, Mo = ["aria-label", "content"], Po = /* @__PURE__ */ N({
  __name: "button",
  props: {
    onClickFunction: {
      type: Function,
...
}), No = /* @__PURE__ */ qe(Po, [["__scopeId", "data-v-1cb84ae1"]]), Fo = W("areas-of-interest", () => ({ areas: f([]) })), Do = W("export", () => {
  const r = f({
    title: !0,
    map: !0,
    mapElements: !0,
...
class zo {
  ...
  fsaToProvince(e) {
    ...
    return s === "X" ? i === "X0A" || i === "X0B" || i === "X0C" ? t = 62 : t = 61 : t = Uo[s], this.codeToProvince(t);
  }
}
function Bo(r) {
  return new zo(r);
...
async function Ho(r, e) {
  ...
  return s.test(e) && !r.disabledSearchTypes.includes("LAT/LNG") ? (i = e.slice(0, -1), t = new $t(r, i), await Ko(t)) : o.test(e) && !r.disabledSearchTypes.includes("FSA") ? (i = e.substring(0, 3).toUpperCase(), t = new $t(r, i), await Zo(t)) : a.test(e) && !r.disabledSearchTypes.includes("NTS") ? (i = e.substring(0, 6).toUpperCase(), t = new $t(r, i), await Qo(t)) : (i = encodeURIComponent(e.trim()), t = new $t(r, i), await Xo(t)), r.customSources.length && await Wo(t, r.customSources), t;
}
const oi = async (r) => {
  ...
  await Jo(r, t, i), r.addResult(s);
}, Zo = async (r) => {
  const e = r.config, t = await li(r);
  if (t.length) {
  ...
  const e = r.config;
  if (await Yo(r), e.categories.length === 0 || e.categories.includes("ADDR")) {
    const t = await li(r), i = e.sortOrder.indexOf("ADDR"), s = i >= 0 ? i : e.sortOrder.length, a = t.filter((o) => o.type?.includes("Street")).map((o) => {
...
}, en = "~FSA~", Ii = "https://geogratis.gc.ca/services/geolocation/@{language}/locate", _i = "https://geogratis.gc.ca/services/geoname/@{language}/geonames.json", Ti = "https://geogratis.gc.ca/services/geoname/@{language}/codes/province.json", Li = "https://geogratis.gc.ca/services/geoname/@{language}/codes/concise.json";
class Ri {
  config;
  constructor(e, t) {
    let i, s, a, o;
    ...
    if (c && c.serviceUrl) {
      ...
      n = `${c.serviceUrl}/query/?where=${v}%3D'${en}'&outFields=${v}&returnGeometry=true&f=json`;
    }
    const u = t?.settings;
    let p, d, g, h, m, A;
    u ? (p = u.categories ? u.categories : [], d = u.sortOrder ? u.sortOrder : [], g = u.disabledSearchTypes ? u.disabledSearchTypes : [], h = u.maxResults > 0 ? u.maxResults : 100, m = !!u.officialOnly) : (p = [], d = [], g = [], h = 100, m = !1), A = t?.customSources ?? [], A = A.map((v) => ({
      ...v,
      onSearch: async (C) => {
        const Y = v.data ?? [], V = rs().cleanVal(C).replace("*", "");
   ...
   */
  async query(e) {
    const t = await Ho(this.config, e.toUpperCase()), i = this.config.sortOrder.length, s = t.results.filter((n) => n.order < i), a = t.results.filter((n) => n.order >= i);
...
}), tn = W("help", () => ({ location: f("./help/") }));
var as = /* @__PURE__ */ ((r) => (r.Visibility = "visibilityButton", r.Expand = "expandButton", r))(as || {}), Xt = /* @__PURE__ */ ((r) => (r.Item = "item", r.Placeholder = "placeholder", r.Error = "error", r))(Xt || {});
class os extends re {
  _uid;
  _name;
  _type;
...
class We extends os {
  ...
  load(e) {
    const t = e instanceof ui ? e : this.$iApi.geo.layer.getLayer(this._layerId ?? this._layerUid);
    t && (this.layer = t, this._layerRedrawing = t.mapLayer && t.drawState !== fe.UP_TO_DATE, t.loadPromise().then(() => {
      this._layerInitVis = typeof this._layerInitVis < "u" ? this._visibility : t.visibility, super.load(), this.toggleVisibility(this._layerInitVis, !0, !0), t.visibility || this.setSymbologyVisibility(void 0, !1), this.handlers.push(
        this.$iApi.event.on(
          ...
          (i) => {
            i.layer.uid === this.layer.uid && this._type === Xt.Item && this.toggleVisibility(i.visibility, !0, !0);
          }
        )
      ), this.handlers.push(
        this.$iApi.event.on(
...
var sn = /* @__PURE__ */ ((r) => (r.Title = "title", r.Text = "text", r.Image = "image", r.Markdown = "markdown", r.Template = "template", r))(sn || {});
class Ci extends os {
  _infoType;
...
class pn {
  ...
  _isFullscreen;
  constructor(e, t, i) {
    this.event = new Xs(this);
    const s = dn(e, this);
    this.$vApp = s.app, this.$element = s.element, this.$i18n = s.i18n, this.$rootEl = s.app.$root?.$el, this.fixture = new ll(this), this.panel = new cl(this), this.geo = new ol(this), this.dev = new ml(this), this.ui = {
      ...
      escapeHtml: () => "",
      isPlainText: () => !0
    }, this.notify = new hr(this), this._isFullscreen = Ce.isEnabled && !!this.$vApp.$root && Ce.isFullscreen && Ce.element === this.$vApp.$root.$el, Ce.isEnabled && Ce.onchange(() => {
   ...
   */
  reloadWorker(e, t) {
    const i = ut(this.$vApp.$pinia), s = ze(this.$vApp.$pinia), a = be(this.$vApp.$pinia), o = Ee(this.$vApp.$pinia), l = Me(this.$vApp.$pinia), n = Kt(this.$vApp.$pinia), c = !!e;
  ...
  useStore(e) {
    if (!([
      ...
      switch (e) {
        ...
        case "grid":
          return Kt(this.$vApp.$pinia);
        case "help":
          return tn(this.$vApp.$pinia);
        case "keyboardnav":
...
function dn(r, e) {
  ...
  t.use(({ store: o }) => {
    const l = bi(o.$state);
    o.$reset = () => o.$patch(bi(l));
  });
  const i = ir(), s = Gi(Ra).use(i).use(Ns, {
    directive: "tippy",
    // => v-tippy
    component: "tippy"
    // => <tippy/>
  }).use(t);
  s.directive("focus-container", Fa), s.directive("focus-list", Oa), s.directive("focus-item", Ma), s.directive("truncate", Va), s.component("panel-screen", Za), s.component("pin", to), s.component("close", ro), s.component("back", no), s.component("expand", ho), s.component("panel-options-menu", So), s.component("dropdown-menu", ri), s.component("minimize", yo), s.component("right", bo), s.component("left", Eo), s.component("fullscreen-nav-button", To), s.component("geolocator-nav-button", Lo), s.component("home-nav-button", Ro), s.component("mapnav-button", Oo), s.component("appbar-button", No), s.component("transition", Fi), s.component("transition-group", Di), s.config.globalProperties.$iApi = e, s.config.globalProperties.$pinia = t, s.config.idPrefix = `ramp-${r.id || et.sharedUtils.generateUUID()}`, s.provide("iApi", e);
  const a = s.mount(r);
...
class ci {
  ...
  static async create(e) {
    const t = new ci(e), i = e.layers.map((o) => {
      const l = {
        url: o.url,
        opacity: o.opacity
      };
...
class hn extends re {
  ...
  async createMap(e, t) {
    ...
    }, s = e.basemaps.map((n) => ci.create(n)), o = (await Promise.all(s)).filter((n) => (n.createErr && i(n), n.esriBasemap.baseLayers.length > 0));
    o.forEach((n) => {
...
class yn extends hn {
   ...
   */
  constructor(e) {
    super(e, "main"), this.maptip = new fn(e), this.caption = new mn(e), this.mapMouseThrottle = 0;
  }
  async createMap(e, t) {
  ...
  removeLayer(e) {
    ...
    let t;
    if (e instanceof ui ? t = e : t = this.$iApi.geo.layer.getLayer(e), !t)
...
const gn = { geometryType: "point", renderer: { type: "simple", symbol: { type: "esriSMS", style: "esriSMSCircle", color: [67, 100, 255, 200], size: 7, outline: { color: [0, 0, 0, 255], width: 1 } } } }, vn = { geometryType: "polyline", renderer: { type: "simple", symbol: { type: "esriSLS", style: "esriSLSSolid", color: [90, 90, 90, 200], width: 2 } } }, bn = { geometryType: "polygon", renderer: { type: "simple", symbol: { type: "esriSFS", style: "esriSFSSolid", color: [76, 76, 125, 200], outline: { type: "esriSLS", style: "esriSLSSolid", color: [110, 110, 110, 255], width: 1 } } } }, An = { geometryType: "polygon", renderer: { type: "simple", symbol: { type: "esriSFS", style: "esriSFSSolid", color: [255, 0, 0, 64], outline: { type: "esriSLS", style: "esriSLSSolid", color: [240, 128, 128, 255], width: 1 } } } }, wn = {
  circlePoint: gn,
  solidLine: vn,
  outlinedPoly: bn,
  boundingBoxPoly: An
...
class Tn extends re {
  ...
  extractCsvFields(e, t = ",") {
    return Ai.dsvFormat(t).parseRows(e)[0].map((s) => ({ name: s, type: De.STRING }));
  }
  /**
  ...
  filterCsvLatLonFields(e, t = ",") {
    const i = Ai.dsvFormat(t).parseRows(e), s = i[0], a = {
  ...
  async geoJsonToEsriJson(e, t) {
    ...
    xn(e);
    const l = e.features[0].geometry.type, n = En[l], c = JSON.parse(
      // @ts-expect-error TODO: explain why this is needed or remove
      JSON.stringify(wn[n])
    );
    if (t) {
...
class Rn extends re {
  ...
  async loadWfsData(e, t = -1, i = 0, s = 1e3, a = {
    ...
    const u = new Ft(e).updateQuery(n), [p, d] = await Re(_t.get(u, { signal: l }));
    if (!d)
...
class ns extends ui {
  ...
  constructor(e, t) {
    ...
    this.expectedTime.draw = e.expectedDrawTime ?? i.draw, this.expectedTime.load = e.expectedLoadTime ?? i.load, this.expectedTime.fail = e.maxLoadTime || i.fail, this.lastCancel = 0, this.timers = {
      draw: void 0,
      load: void 0
    }, this.origRampConfig = e, this.id = e.id || "", this.uid = this.$iApi.geo.shared.generateUUID(), this.isCosmetic = !1, this.isSystem = e.system || !1, this.isRemoved = !1, this.isSublayer = !1, this.supportsIdentify = !1, this.mapLayer = !0, this.identifyMode = oe.NONE, this.supportsFeatures = !1, this.maptips = !1, this.supportsSublayers = !1, this.isFile = !1, this.layerState = Z.NEW, this.initiationState = j.NEW, this.drawState = fe.NOT_LOADED, this.loadDefProm = new ie(), this.url = this.origRampConfig.url, this.canReload = !!(this.url || this.origRampConfig.caching), this.loadPromDone = !1, this.nameArcadeFormula = "", this.maptipArcadeFormula = "", this.layerTree = new Nt(0, this.uid, this.name, !0);
  }
  updateInitiationState(e) {
  ...
  async terminate() {
    this.updateInitiationState(j.TERMINATING), await Promise.all(this.sublayers.map((e) => e.terminate())), this.loadDefProm = new ie(), this.loadPromDone = !1, this.updateLayerState(Z.NEW), this.updateDrawState(fe.NOT_LOADED), this.updateInitiationState(j.TERMINATED);
  }
  // ----------- LAYER LOAD -----------
  ...
  onLoadActions() {
    ...
    const a = [], o = (n, c) => {
      ...
      if (n.sublayers && n.sublayers.length > 0) {
        const d = (p ? p.name : "") || n.title || "", g = new Nt(u, "", d, !1);
        ...
        if (d.name = p?.name || n.title || "", a.push(d), !c.children.map((g) => g.layerIdx).includes(u)) {
          const g = new Nt(u, d.uid, d.name, !1);
          c.children.push(g);
        }
        d.esriWatches.push(
          Te(
...
class ls extends ns {
  ...
  async onInitiate() {
    if (this.sourceJson) {
      ...
      this.attribs.attLoader = new el(this.$iApi, a), await this.attribs.attLoader.getAttribs(), this.featureCount = e.data.length;
...
class ol extends re {
   ...
   */
  constructor(e) {
    super(e), this.geom = et.geom, this.proj = et.proj, this.shared = et.sharedUtils, this.map = new yn(e), this.layer = new $n(e), this.attributes = new Qn(e), this.query = new al(e), this.symbology = new rl(e), Array.isArray(At.request.interceptors) || (At.request.interceptors = []), At.request.interceptors.push({
      before: (t) => {
...
const nl = /* @__PURE__ */ Object.assign({ "../fixtures/appbar/index.ts": () => import("./index-C63IJ7as.js"), "../fixtures/areas-of-interest/index.ts": () => import("./index-DMacNSUD.js"), "../fixtures/basemap/index.ts": () => import("./index-CXgfKY_i.js"), "../fixtures/crosshairs/index.ts": () => import("./index-D3GObWcb.js"), "../fixtures/details/index.ts": () => import("./index-CYSC1qZj.js"), "../fixtures/draw/index.ts": () => import("./index-CiQ7VkxH.js"), "../fixtures/export-footnote/index.ts": () => import("./index-B2TixsRz.js"), "../fixtures/export-legend/index.ts": () => import("./index-ynKcw92z.js"), "../fixtures/export-map/index.ts": () => import("./index-B_jKtwzB.js"), "../fixtures/export-northarrow/index.ts": () => import("./index-D20ma1Uz.js"), "../fixtures/export-scalebar/index.ts": () => import("./index-DuzR5Qju.js"), "../fixtures/export-timestamp/index.ts": () => import("./index-CNw5lnP9.js"), "../fixtures/export-title/index.ts": () => import("./index-B8fJvy9i.js"), "../fixtures/export/index.ts": () => import("./index-ClFqLXLP.js"), "../fixtures/extentguard/index.ts": () => import("./index-mZf_TPdT.js"), "../fixtures/gazebo/index.ts": () => import("./index-DUEy2Y4c.js"), "../fixtures/geosearch/index.ts": () => import("./index-C8TXzOcS.js"), "../fixtures/grid/index.ts": () => import("./index-BVOxM_90.js"), "../fixtures/help/index.ts": () => import("./index-BceregY1.js"), "../fixtures/hilight/index.ts": () => import("./index-DOMupy8W.js"), "../fixtures/keyboardnav/index.ts": () => import("./index-Bn6fcXBw.js"), "../fixtures/layer-reorder/index.ts": () => import("./index-C4WQVDQY.js"), "../fixtures/legend/index.ts": () => import("./index-DrrVEqfj.js"), "../fixtures/mapnav/index.ts": () => import("./index-Bww7VfWW.js"), "../fixtures/metadata/index.ts": () => import("./index-B7JFnxan.js"), "../fixtures/northarrow/index.ts": () => import("./index-C1jShXVS.js"), "../fixtures/overviewmap/index.ts": () => import("./index-606jVbTa.js"), "../fixtures/panguard/index.ts": () => import("./index-DTdmsClN.js"), "../fixtures/scrollguard/index.ts": () => import("./index-Cdw_-pK5.js"), "../fixtures/settings/index.ts": () => import("./index-CDXjJc4u.js"), "../fixtures/snowman/index.ts": () => import("./index-D5iiXqZi.js"), "../fixtures/swipe/index.ts": () => import("./index-DK3YyULL.js"), "../fixtures/wizard/index.ts": () => import("./index-D3Ph9zW-.js") });
class ll extends re {
  /**
  ...
  async add(e, t) {
    ...
    if (t) {
      ...
      i = mi.updateBaseToInstance(new t(), e, this.$iApi);
    } else {
      const s = (await nl[`../fixtures/${e}/index.ts`]()).default;
      i = new s(e, this.$iApi);
    }
...
const hl = /* @__PURE__ */ qe(pl, [["render", dl], ["__scopeId", "data-v-a3c61802"]]), fl = /* @__PURE__ */ Object.assign({ "../fixtures/areas-of-interest/screen.vue": () => import("./screen-DRpcn2Gr.js"), "../fixtures/basemap/screen.vue": () => import("./screen-DvfTxgQP.js"), "../fixtures/export/screen.vue": () => import("./screen-ChuUxNdF.js"), "../fixtures/geosearch/screen.vue": () => import("./screen-CBqXYjvA.js"), "../fixtures/grid/screen.vue": () => import("./screen-V2paLXuT.js"), "../fixtures/help/screen.vue": () => import("./screen-BP_EN7Oj.js"), "../fixtures/layer-reorder/screen.vue": () => import("./screen-BAS46VaE.js"), "../fixtures/legend/screen.vue": () => import("./screen-DR_rW71O.js"), "../fixtures/metadata/screen.vue": () => import("./screen-D8SrIoRi.js"), "../fixtures/settings/screen.vue": () => import("./screen-B7WDz8Wf.js"), "../fixtures/wizard/screen.vue": () => import("./screen-GCJWenOx.js") });
class Ot extends re {
  /**
   * ID of this panel.
   *
  ...
  registerScreen(e) {
    ...
    if (Ks(t) || Js(t))
      ...
      let s;
      typeof t == "string" ? s = fl[`../fixtures/${t}`]() : s = t();
...
function gl(r) {
  ...
  return bl(r.services, e), vl(r.map, e), Al(r.ui, e), r.plugins && wl(r.plugins, e), e;
}
function vl(r, e) {
  ...
  return r.controls && r.controls.length > 0 && (e.controls = gt(r.controls, t), r.controls.includes("visibility") && e.controls.push("visibilityButton"), (r.controls.length !== 1 || r.controls[0] !== "visibility") && console.warn(
    ...
    if (i.layerId)
      ...
      typeof i.collapse < "u" && console.warn(
        ...
        a.layerId ? s.children.push(Pi(a)) : s.children.push(ei(a));
      }), e.children.push(s);
    } else
      e.children.push(ei(i));
  }), e;
}
function Pi(r) {
  const e = r, t = [
...
function Yt(r) {
  ...
  )), typeof r.stateOnly < "u" && (e.cosmetic = r.stateOnly), r.initialFilteredQuery && (e.initialFilteredQuery = r.initialFilteredQuery), El(r, e), typeof r.toggleSymbology < "u" && console.warn(`toggleSymbology property provided in layer ${r.id} cannot be mapped and will be skipped.`), r.table && (e.fixtures = {
    grid: {}
...
var pt = { major: "4", minor: "16", patch: "0-beta", timestamp: "Tue Feb 24 09:42:13 2026 -0500", hash: "03de8bc89fb327f777d7c870c272182f2d41ec3c" };
console.info(
...
const cc = (r, e, t) => new pn(r, e, t), et = new Ys();
export {
  De as $,
  qr as A,
  ln as B,
