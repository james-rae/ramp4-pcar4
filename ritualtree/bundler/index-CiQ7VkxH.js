...
import "tiny-emitter";
import { G as le, L as Te, F as xe } from "./main-BdGV-Vps.js";
...
class ft extends Me {
  async init() {
    Object.entries(Le).forEach((b) => this.$iApi.$i18n.mergeLocaleMessage(...b)), this._parseConfig(this.config), Z(this.$vApp.$pinia).supportedTypes.forEach((b) => {
      const o = `${b.type}-icon`;
      this.$iApi.component(o, Ae(Se(/* @__PURE__ */ Object.assign({ "./icons/circle-icon.vue": () => import("./circle-icon-aXDMaGHu.js"), "./icons/edit-icon.vue": () => import("./edit-icon-BTimgUDg.js"), "./icons/point-icon.vue": () => import("./point-icon-DUIMN2K0.js"), "./icons/polygon-icon.vue": () => import("./polygon-icon-CHN9CGLi.js"), "./icons/polyline-icon.vue": () => import("./polyline-icon-Cbuf-i0S.js"), "./icons/rectangle-icon.vue": () => import("./rectangle-icon-CNmJBvee.js") }), `./icons/${b.type}-icon.vue`, 3)));
    });
