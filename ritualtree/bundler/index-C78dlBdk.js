...
import "tiny-emitter";
import { F as r, b as l } from "./main-BtBsNTgZ.js";
...
class K extends o {
    ...
    this.$iApi.panel.register(
      {
        settings: {
          screens: {
            "settings-screen-content": () => n(import("./screen-C5jK1tvS.js"))
          },
          style: {
            width: "350px"
          },
  ...
  removed() {
    this.$iApi.fixture.exists("appbar") && l(this.$vApp.$pinia).removeButton("settings"), this.$iApi.panel.remove("settings");
  }
}
export {
  K as default
