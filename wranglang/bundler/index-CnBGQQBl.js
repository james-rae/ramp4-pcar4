...
import "tiny-emitter";
import { G as le, L as Te, F as xe } from "./main-DEMECrLi.js";
...
class ft extends Me {
  async init() {
    Object.entries(Le).forEach((b) => this.$iApi.$i18n.mergeLocaleMessage(...b)), this._parseConfig(this.config), Z(this.$vApp.$pinia).supportedTypes.forEach((b) => {
      const o = `${b.type}-icon`;
      this.$iApi.component(o, Ae(Se(/* @__PURE__ */ Object.assign({ "./icons/circle-icon.vue": () => import("./circle-icon-C_J43J5V.js"), "./icons/edit-icon.vue": () => import("./edit-icon-B2Aut-_5.js"), "./icons/point-icon.vue": () => import("./point-icon-DB-z3eM0.js"), "./icons/polygon-icon.vue": () => import("./polygon-icon-wHrguLt0.js"), "./icons/polyline-icon.vue": () => import("./polyline-icon-DyZRxGr7.js"), "./icons/rectangle-icon.vue": () => import("./rectangle-icon-B4nMDp1K.js") }), `./icons/${b.type}-icon.vue`, 3)));
    });
