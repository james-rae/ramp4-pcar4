...
import { _ as H, d as L, F as X, G as ee } from "./main-DEMECrLi.js";
...
const G = /* @__PURE__ */ H(ne, [["render", ae]]), se = /* @__PURE__ */ T({
  ...
  setup(h) {
    ...
    const p = [
      {
        type: "point",
        icon: g(_(() => import("./point-icon-DB-z3eM0.js")))
      },
      {
        type: "polyline",
        icon: g(_(() => import("./polyline-icon-DyZRxGr7.js")))
      },
      {
        type: "polygon",
        icon: g(_(() => import("./polygon-icon-wHrguLt0.js")))
      },
      {
        type: "circle",
        icon: g(_(() => import("./circle-icon-C_J43J5V.js")))
      },
      {
        type: "rectangle",
        icon: g(_(() => import("./rectangle-icon-B4nMDp1K.js")))
      }
    ], a = A(() => {
      const s = p.filter((u) => e.supportedTypes.some((x) => x.type === u.type));
      return s.push({
        type: "edit",
        icon: g(_(() => import("./edit-icon-B2Aut-_5.js")))
      }), s;
    }), n = (s) => {
