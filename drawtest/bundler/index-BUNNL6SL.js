...
import { _ as H, d as L, k as X, F as ee, G as te } from "./main-DsXUZ7ik.js";
...
const G = /* @__PURE__ */ H(ne, [["render", ae]]), se = /* @__PURE__ */ T({
  ...
  setup(h) {
    ...
    const p = [
      {
        type: "point",
        icon: g(_(() => import("./point-icon-CiRwNWxl.js")))
      },
      {
        type: "polyline",
        icon: g(_(() => import("./polyline-icon-TTHjX9yr.js")))
      },
      {
        type: "polygon",
        icon: g(_(() => import("./polygon-icon-DUhL49oT.js")))
      },
      {
        type: "circle",
        icon: g(_(() => import("./circle-icon-BFyK3l2W.js")))
      },
      {
        type: "rectangle",
        icon: g(_(() => import("./rectangle-icon-BiBLaWDA.js")))
      }
    ], a = A(() => {
      const s = p.filter((u) => e.supportedTypes.some((x) => x.type === u.type));
      return s.push({
        type: "edit",
        icon: g(_(() => import("./edit-icon-1nBABrsz.js")))
      }), s;
    }), n = (s) => {
...
}), he = /* @__PURE__ */ H(de, [["__scopeId", "data-v-5b4bcb7b"]]);
class fe extends ee {
