...
import { _ as H, d as L, F as X, G as ee } from "./main-BDAHkjpl.js";
...
const G = /* @__PURE__ */ H(ne, [["render", ae]]), se = /* @__PURE__ */ T({
  ...
  setup(h) {
    ...
    const p = [
      {
        type: "point",
        icon: g(_(() => import("./point-icon-DeL6kdt7.js")))
      },
      {
        type: "polyline",
        icon: g(_(() => import("./polyline-icon-cEoP-84p.js")))
      },
      {
        type: "polygon",
        icon: g(_(() => import("./polygon-icon-Ce90-TLs.js")))
      },
      {
        type: "circle",
        icon: g(_(() => import("./circle-icon-BI0NapeZ.js")))
      },
      {
        type: "rectangle",
        icon: g(_(() => import("./rectangle-icon-Bf3uBTMZ.js")))
      }
    ], a = A(() => {
      const s = p.filter((u) => e.supportedTypes.some((x) => x.type === u.type));
      return s.push({
        type: "edit",
        icon: g(_(() => import("./edit-icon-BEHUyqNS.js")))
      }), s;
    }), n = (s) => {
