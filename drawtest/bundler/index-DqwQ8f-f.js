...
import "tiny-emitter";
import { G as le, L as Te, F as xe } from "./main-DsXUZ7ik.js";
...
class ft extends Me {
  async init() {
    Object.entries(Le).forEach((b) => this.$iApi.$i18n.mergeLocaleMessage(...b)), this._parseConfig(this.config), Z(this.$vApp.$pinia).supportedTypes.forEach((b) => {
      const o = `${b.type}-icon`;
      this.$iApi.component(o, Ae(Se(/* @__PURE__ */ Object.assign({ "./icons/circle-icon.vue": () => import("./circle-icon-BFyK3l2W.js"), "./icons/edit-icon.vue": () => import("./edit-icon-1nBABrsz.js"), "./icons/point-icon.vue": () => import("./point-icon-CiRwNWxl.js"), "./icons/polygon-icon.vue": () => import("./polygon-icon-DUhL49oT.js"), "./icons/polyline-icon.vue": () => import("./polyline-icon-TTHjX9yr.js"), "./icons/rectangle-icon.vue": () => import("./rectangle-icon-BiBLaWDA.js") }), `./icons/${b.type}-icon.vue`, 3)));
    });
