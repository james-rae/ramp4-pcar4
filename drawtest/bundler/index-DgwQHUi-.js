...
import "tiny-emitter";
import { G as le, L as Te, F as xe } from "./main-BDAHkjpl.js";
...
class ft extends Me {
  async init() {
    Object.entries(Le).forEach((b) => this.$iApi.$i18n.mergeLocaleMessage(...b)), this._parseConfig(this.config), Z(this.$vApp.$pinia).supportedTypes.forEach((b) => {
      const o = `${b.type}-icon`;
      this.$iApi.component(o, Ae(Se(/* @__PURE__ */ Object.assign({ "./icons/circle-icon.vue": () => import("./circle-icon-BI0NapeZ.js"), "./icons/edit-icon.vue": () => import("./edit-icon-BEHUyqNS.js"), "./icons/point-icon.vue": () => import("./point-icon-DeL6kdt7.js"), "./icons/polygon-icon.vue": () => import("./polygon-icon-Ce90-TLs.js"), "./icons/polyline-icon.vue": () => import("./polyline-icon-cEoP-84p.js"), "./icons/rectangle-icon.vue": () => import("./rectangle-icon-Bf3uBTMZ.js") }), `./icons/${b.type}-icon.vue`, 3)));
    });
