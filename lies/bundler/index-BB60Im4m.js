...
import { _ as H, d as L, F as X, G as ee } from "./main-B_9HBXOk.js";
...
const G = /* @__PURE__ */ H(ne, [["render", ae]]), se = /* @__PURE__ */ T({
  ...
  setup(h) {
    ...
    const p = [
      {
        type: "point",
        icon: g(_(() => import("./point-icon-CoU7-pxH.js")))
      },
      {
        type: "polyline",
        icon: g(_(() => import("./polyline-icon-C-UIY2rG.js")))
      },
      {
        type: "polygon",
        icon: g(_(() => import("./polygon-icon-DXDdjEnV.js")))
      },
      {
        type: "circle",
        icon: g(_(() => import("./circle-icon-CILAgzQL.js")))
      },
      {
        type: "rectangle",
        icon: g(_(() => import("./rectangle-icon-DhnZMEij.js")))
      }
    ], a = A(() => {
      const s = p.filter((u) => e.supportedTypes.some((x) => x.type === u.type));
      return s.push({
        type: "edit",
        icon: g(_(() => import("./edit-icon-BXxElNzt.js")))
      }), s;
    }), n = (s) => {
