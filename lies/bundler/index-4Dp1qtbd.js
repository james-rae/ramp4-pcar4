import { defineComponent as y, inject as u, resolveComponent as m, createBlock as f, openBlock as I, unref as L, withCtx as v, createElementVNode as p, markRaw as b } from "vue";
import "tiny-emitter";
import { F as S, p as s, S as A, q as g, r as x, s as c, L as w, b as E, d as $ } from "./main-B_9HBXOk.js";
...
class C extends S {
  ...
  _parseConfig(e) {
    ...
    const l = [1, 2, 3, 4, 5, 6];
    !e.multilineItems?.maxLines || !l.includes(e.multilineItems?.maxLines) ? s(this.$vApp.$pinia).maxLines = 3 : s(this.$vApp.$pinia).maxLines = e.multilineItems.maxLines, this.handlePanelWidths(["legend"]), this.handlePanelTeleports(["legend"]), e.root.children.forEach((a) => {
      this.addItem(a);
    }), this.$iApi.geo.layer.allLayers().forEach((a) => {
      this.updateLegend(a);
    });
  }
  // Create
  ...
  createItem(e, t) {
    let l;
    e.layerId === void 0 ? l = new A(this.$iApi, e, t) : (e.sublayerIndex !== void 0 && (e.layerId = this.$iApi.geo.layer.sublayerId(e.layerId, e.sublayerIndex)), l = new g(this.$iApi, e, t));
    const a = e.children;
    return a && a.forEach((r) => {
      l.children.push(this.createItem(r, l));
    }), l;
  }
  /**
   ...
   */
  addItem(e, t) {
    const l = e instanceof x ? e : this.createItem(e, t);
...
class ue extends C {
  added() {
    this.$iApi.component("legend-nav-button", _), this.$iApi.panel.register(
      {
        legend: {
          screens: {
            "legend-screen": () => b(import("./screen-BsqEP1Ea.js"))
          },
          style: {
            width: "350px"
          },
    ...
    this.removed = () => {
      e(), this.$iApi.fixture.exists("appbar") && E(this.$vApp.$pinia).removeButton("legend"), this.$iApi.fixture.exists("mapnav") && $(this.$vApp.$pinia).removeItem("legend"), s().$reset(), this.$iApi.panel.remove("legend");
    };
  }
}
export {
