...
import { ref as h, computed as N, markRaw as X, defineComponent as O, inject as ve, reactive as Ae, watch as xt, onBeforeUnmount as dt, resolveDirective as M, withDirectives as P, openBlock as y, createElementBlock as A, withKeys as os, withModifiers as Kt, onMounted as Je, normalizeClass as oe, normalizeStyle as Ri, createVNode as re, Transition as $i, withCtx as te, createBlock as W, resolveDynamicComponent as as, mergeProps as ns, TransitionGroup as Ci, Fragment as We, renderList as ht, unref as S, nextTick as $t, renderSlot as Me, createElementVNode as m, vShow as ls, resolveComponent as K, createTextVNode as at, toDisplayString as B, createCommentVNode as U, onUpdated as cs, Teleport as us, getCurrentInstance as ps, useTemplateRef as ui, createApp as Oi, toRaw as _e, h as ds, render as Gt, defineAsyncComponent as hs } from "vue";
import St from "@arcgis/core/Color";
import ft from "@arcgis/core/config";
import { watch as we } from "@arcgis/core/core/reactiveUtils.js";
...
import gs from "@arcgis/core/geometry/SpatialReference";
...
import ws from "@arcgis/core/symbols/SimpleFillSymbol";
import As from "@arcgis/core/symbols/SimpleLineSymbol";
...
import { debounce as _t, throttle as it } from "throttle-debounce";
import { createI18n as xs, useI18n as H } from "vue-i18n";
import xe from "screenfull";
import di from "lodash.clonedeep";
import Ss, { setDefaultProps as _s, useTippy as Is } from "vue-tippy";
...
class Be extends he {
  ...
  static fromESRI(e, t) {
    return new Be(t, e.paths[0], I.fromESRI(e.spatialReference), !0);
  }
  toESRI() {
    return new ki({
      paths: [this.toArray()],
  ...
  static fromGeoJSON(e, t) {
    return new Be(t, e.coordinates, I.fromGeoJSON(e.crs), !0);
  }
  toGeoJSON() {
...
class be extends Ze {
  ...
  static fromESRI(e, t) {
    return new be(t, e.paths, I.fromESRI(e.spatialReference), !0);
  }
  toESRI() {
    return new ki({
      paths: this.toArray(),
...
class qe extends he {
  ...
  static fromESRI(e, t) {
    return new qe(t, e.rings[0], I.fromESRI(e.spatialReference), !0);
  }
  toESRI() {
    return new Qt({
      rings: [this.toArray()],
  ...
  static fromGeoJSON(e, t) {
    return new qe(t, e.coordinates, I.fromGeoJSON(e.crs), !0);
  }
  toGeoJSON() {
...
class se extends Ze {
  ...
  static fromESRI(e, t) {
    return new se(t, e.rings, I.fromESRI(e.spatialReference), !0);
  }
  toESRI() {
    return new Qt({
      rings: this.toArray(),
  ...
  static fromGeoJSON(e, t) {
    return new se(t, e.coordinates, I.fromGeoJSON(e.crs), !0);
  }
  toGeoJSON() {
    return this.geoJsonFactory(V.POLYGON, this.toArray());
  }
...
class Oe extends Ze {
  ...
  static fromESRI(e, t) {
    return new Oe(t, [e.rings], I.fromESRI(e.spatialReference), !0);
  }
  toESRI() {
    const e = [];
...
class gt extends ke {
  ...
  toESRI() {
    const e = this.outline.toESRI(), t = new St(this.fillColour.rgba), i = new ws();
...
class Ps {
  ...
  async projectGeoJson(e, t, i) {
    let s, o;
    if (t ? s = this.normalizeProj(t) : s = I.parseGeoJsonCrs(e.crs), i ? o = this.normalizeProj(i) : o = Ms, o === s)
      return e;
  ...
  async projectExtent(e, t) {
    const i = (g, w, b) => {
      if (b === 0)
        return [g, w];
      const $ = [(g[0] + w[0]) / 2, (g[1] + w[1]) / 2];
      if (b === 1)
        return [g, $, w];
      if (b > 1) {
        const T = i(g, $, b - 1), C = i($, w, b - 1);
        return T.concat(C.slice(1));
      }
      return [[]];
    }, s = t.toPolygonArray().pop() || [];
    let o = [];
    [0, 1, 2, 3].map((g) => i(s[g], s[g + 1], 3).slice(1)).forEach((g) => o = o.concat(g));
    const a = new se("warpy", [o], t.sr, !0), l = await this.projectGeometry(e, a), n = l.toArray().pop() || [], c = n.map((g) => g[0]), u = n.map((g) => g[1]), p = Math.min.apply(null, c), d = Math.max.apply(null, c), v = Math.min.apply(null, u), f = Math.max.apply(null, u);
  ...
  defaultHandlerFactory(e) {
    ...
    switch (e) {
      ...
      case "ramp_map_resize_updates_scalebar":
        this.$iApi.event.on(
          "map/resized",
          _t(100, () => this.$iApi.geo.map.caption.updateScale()),
          e
        );
        break;
      case "ramp_map_scale_updates_scalebar":
        this.$iApi.event.on(
          "map/scalechanged",
          _t(300, () => this.$iApi.geo.map.caption.updateScale()),
          e
        );
        break;
...
const Rt = z("maptip", () => {
  ...
  __name: "esri-map",
  setup(r) {
    const e = Rt(), t = ve("iApi"), i = N(() => e.maptipPoint), s = N(() => e.maptipInstance), o = N(() => e.content), a = Ae([]), l = h(!1);
    a.push(
      xt(i, () => {
        if (i.value) {
...
const Hs = ["data-cy"], ji = /* @__PURE__ */ O({
    ...
    return (n, c) => {
      ...
      return y(), A("div", {
        ...
        re($i, {
          ...
          default: te(() => [
            P((y(), W(as(r.panel.route.screen), ns({ class: "h-full" }, r.panel.route.props, { panel: r.panel }), null, 16, ["panel"])), [
              [u]
            ])
          ]),
          _: 1
  ...
  function d(_) {
    return _ === "xs" && u.value.length > 0 ? [u.value.slice().pop()] : u.value;
  }
  function v(_) {
    const R = [];
    return _.forEach((ae) => {
  ...
  function C() {
    ...
    for (let Fe = n.value.length - 1; Fe >= 0; Fe--) {
      const et = n.value[Fe];
      let Re = et.width || ae;
      if (s.value ? Re = _ : Re += fe, et.id === "grid" && (Re = Math.max(Math.min(Re, _), li)), (_ >= Re && !s.value || R.length === 0) && (_ -= Re, R.unshift(et)), et.id === "grid" && _ < li)
        break;
    }
    if (r.value && //@ts-expect-error TODO: explain why this is needed or remove
    !R.includes(r.value) && !s.value) {
      let Fe;
      for (let ci = 0; ci < R.length - 1 && _ < (r.value.width || ae) + fe; ci++)
        Fe = R.shift(), _ += Fe.width || ae;
      _ >= (r.value.width || ae) ? R.unshift(r.value) : e.value || (Fe = R.shift(), R.unshift(r.value));
  ...
  function F(_) {
    if (a.value = { ...a.value, [_.id]: _ }, _.id in l.value)
      l.value[_.id].resolveMe(_);
    else {
      const R = new J();
      R.resolveMe(_), l.value = {
        ...l.value,
        [_.id]: R
      };
    }
  ...
  function ce(_) {
    _.teleport ? c.value = [...c.value, _] : (n.value = [...n.value, _], e.value = _);
  }
  function Xe(_) {
    if (_.teleport) {
      const R = c.value.indexOf(_);
      R !== -1 && (c.value = [...c.value.slice(0, R), ...c.value.slice(R + 1)]);
    } else {
      const R = n.value.indexOf(_);
      R !== -1 && (n.value = [...n.value.slice(0, R), ...n.value.slice(R + 1)]);
    }
  }
  function Pt(_, R) {
    const ae = n.value.indexOf(_), fe = R === "right" ? 1 : -1;
  ...
  function Nt(_) {
    a.value[_.id] !== void 0 && delete a.value[_.id], l.value[_.id] !== void 0 && delete l.value[_.id];
    const R = u.value.indexOf(_);
    R !== -1 && (u.value = [...u.value.slice(0, R), ...u.value.slice(R + 1)]), r.value && r.value.id == _.id && (r.value = void 0);
  }
  function Ft(_) {
    l.value = {
      ...l.value,
  ...
  setup(r) {
    ...
    return (c, u) => (y(), W(Ci, {
      ...
      default: te(() => [
        (y(!0), A(We, null, ht(o(S(t).screenSize), (p) => (y(), W(ji, {
          key: `${p.id}`,
          panel: p
        }, null, 8, ["panel"]))), 128))
      ]),
  ...
  for (const [i, s] of e)
    t[i] = s;
  return t;
}, Js = /* @__PURE__ */ Ne(Ys, [["__scopeId", "data-v-197830c4"]]), Zs = ["content", "aria-label"], ei = /* @__PURE__ */ O({
  ...
  setup(r) {
    const e = h(!1), t = h(null), i = Ae([]), s = h(), o = h(), a = h(), l = r;
    i.push(
      xt(e, () => {
        t.value.update();
      })
...
}), Ks = { class: "h-full flex flex-col" }, Qs = { class: "w-full flex mb-6" }, Xs = ["content", "aria-label"], er = /* @__PURE__ */ O({
  __name: "screen",
  props: {
    panel: {
      type: Object,
  ...
  setup(r) {
    const e = Le(), { t } = H(), i = N(() => e.notificationNumber), s = () => e.clearAll();
    return (o, a) => {
      const l = K("panel-screen"), n = M("tippy");
      return y(), W(l, { panel: r.panel }, {
        header: te(() => [
...
const ir = ["content"], sr = { class: "flex items-center text-left" }, rr = { class: "select-text cursor-text" }, or = ["content"], ar = {
  ...
  setup(r) {
    ...
    return (n, c) => {
      ...
      return P((y(), A("li", {
        ...
        r.notification.messageList && s.value ? (y(), A("div", ar, [
          (y(!0), A(We, null, ht(r.notification.messageList, (p, d) => (y(), A("p", {
    ...
    return (l, n) => {
      ...
      return y(), A("div", null, [
        a.value.length > 0 ? P((y(), A("ul", {
          ...
          (y(!0), A(We, null, ht(a.value, (d, v) => (y(), A(We, {
            key: d.message + v
          }, [
            v > 0 ? (y(), A("div", cr)) : U("", !0),
            P(re(nr, {
...
}, fr = { class: "notification-dropdown pointer-events-auto bg-white rounded text-center text-black w-500 h-256 flex flex-col p-0" }, mr = { class: "pb-8 border-b border-gray-600" }, gr = { class: "absolute flex right-3 top-3" }, yr = ["content", "aria-label"], vr = /* @__PURE__ */ O({
      ...
      return y(), W(ei, {
        ...
        header: te(() => [
          m("div", pr, [
            ...
            i.value && i.value > 0 ? (y(), A("span", hr, B(i.value), 1)) : U("", !0)
          ])
        ]),
        default: te((c) => [
          m("div", fr, [
...
}), br = /* @__PURE__ */ Ne(vr, [["__scopeId", "data-v-3623a7d2"]]), wr = { class: "flex hover:text-white" }, Ar = ["aria-label"], Er = { class: "about-ramp-dropdown pointer-events-auto bg-white rounded w-256 h-50" }, xr = ["aria-label", "content"], Sr = { class: "pb-8 border-b border-gray-600 mb-10" }, _r = { class: "absolute right-5 top-5" }, Ir = { class: "select-text" }, Tr = { class: "font-bold cursor-text" }, Lr = { class: "text-sm cursor-text" }, Rr = { class: "text-sm cursor-text" }, $r = /* @__PURE__ */ O({
  ...
  __name: "map-caption",
  setup(r) {
    const e = Ue(), t = de(), { t: i } = H(), s = ve("iApi"), o = N(() => e.scale), a = N(() => e.attribution), l = N(() => e.coords), n = N(() => e.langtoggle), c = N(() => t.config.map), u = h([]), p = Ae([]);
    p.push(
      xt(c, (w) => {
    ...
    const d = () => a.value?.logo?.link && a.value?.logo?.value && !a.value?.logo?.disabled, v = (w) => {
      s.$i18n.locale.value != w && s.setLanguage(w);
    }, f = () => {
      e.toggleScale(), s.geo.map.caption.updateScale();
    }, g = (w = !1) => i(w ? "map.toggleScaleToMetric" : "map.toggleScaleToImperial");
    return (w, b) => {
      ...
      return y(), A("div", Or, [
        ...
        a.value?.text.disabled ? U("", !0) : P((y(), A("span", Nr, [
        ...
        m("div", Fr, [
          l.value?.disabled ? U("", !0) : P((y(), A("div", Dr, [
          ...
          o.value?.disabled ? U("", !0) : P((y(), A("button", {
            key: 1,
            type: "button",
          ...
          n.value?.disabled ? U("", !0) : (y(), W($, {
            ...
            default: te(() => [
              (y(!0), A(We, null, ht(u.value, (F, ce) => (y(), A("a", {
                key: `${F}-${ce}`,
                ...
                F === S(s).$i18n.locale.value ? (y(), A("span", Vr, B(S(i)("map.language.curr")), 1)) : U("", !0)
              ], 10, zr))), 128))
            ]),
            _: 1
          }, 8, ["tooltip", "ariaLabel"]))
  ...
  setup(r) {
    const e = Le(), t = ve("iApi"), { t: i } = H(), s = N(() => e.notificationNumber);
    return (o, a) => {
      const l = M("tippy");
      return P((y(), A("button", {
        type: "button",
        ...
        s.value && s.value > 0 ? (y(), A("span", Wr, B(s.value), 1)) : U("", !0)
      ], 8, qr)), [
        [l]
      ]);
    };
  }
}), Yr = /* @__PURE__ */ Ne(Hr, [["__scopeId", "data-v-a451db5c"]]), Jr = { class: "flex items-center mb-20" }, Zr = { class: "text-xl" }, Kr = /* @__PURE__ */ O({
  __name: "keyboard-instructions",
  setup(r) {
    const e = ve("iApi"), { t } = H(), i = h(!1), s = h(["app", "lists", "map"]), o = h([]), a = h(null), l = h(null);
    Je(() => {
      o.value.push(
    ...
    return (c, u) => {
      ...
      return i.value ? (y(), A("div", {
        ...
        m("div", {
          ...
          (y(!0), A(We, null, ht(s.value, (d) => (y(), A("p", {
  ...
  __name: "shell",
  setup(r) {
    const e = ve("iApi"), t = st(), i = ye(), s = Ye(), { t: o } = H(), a = N(() => i.items.appbar), l = () => {
      e?.event.emit("openKeyboardInstructions");
    }, n = () => s.teleported;
    return (c, u) => (y(), A("div", Qr, [
      m("div", Xr, [
        ...
        a.value ? U("", !0) : (y(), W(Yr, { key: 0 })),
        re(jr, { class: "z-30" })
      ]),
      S(t).started ? (y(), W(qs, { key: 0 })) : (y(), A("div", to, u[1] || (u[1] = [
        m("div", { class: "spinner relative inset-x-1/2 inset-y-9/20" }, null, -1)
      ]))),
      (y(!0), A(We, null, ht(n(), (p) => (y(), W(us, {
...
}), so = /* @__PURE__ */ Ne(io, [["__scopeId", "data-v-7a1e48c2"]]), ro = O({
  name: "App",
  components: { Shell: so },
  setup() {
    const r = ps();
    Je(() => {
      new Vi().observe(r?.proxy?.$refs["app-size"]), _s({
        aria: {
          content: "labelledby"
        },
        theme: "ramp4",
...
const lo = /* @__PURE__ */ Ne(ro, [["render", no]]), Se = "focus-list", je = "focus-item", co = "focus-icon", uo = "focus-container", ct = `[${Se}],[${uo}]`, bt = "truncate-text", wt = "show-truncate", ot = "focused", Yt = `button,input,select,a,textarea,[contenteditable],[${Se}],[${co}],[tabIndex]`, po = {
  mounted(r, e) {
...
class ho {
   ...
   */
  defocusItem(e) {
    e.classList.remove(ot), this.setTabIndex(-1, e), e._tippy && e._tippy.hide(), e.getAttribute(je) === wt && e.querySelector(`[${bt}]`)?._tippy?.hide();
  }
  /**
   ...
   */
  focusItem(e) {
    e.classList.add(ot), this.setAriaActiveDescendant(e), this.setTabIndex(0, e), e.scrollIntoView({ block: "nearest" }), e._tippy && !this.isTapped && e._tippy.show(), e.getAttribute(je) === wt && e.querySelector(`[${bt}]`)?._tippy?.show(), this.isTapped = !1;
  }
  /**
   ...
   */
  onFocus() {
    this.highlightedItem && !this.isClicked && (this.highlightedItem._tippy && this.highlightedItem._tippy.show(), this.highlightedItem.getAttribute(je) === wt && this.highlightedItem.querySelector(`[${bt}]`)?._tippy?.show()), this.isClicked = !1, this.element.hasAttribute("aria-activedescendant") || this.highlightedItem === this.element ? this.highlightedItem !== this.element && this.focusItem(this.highlightedItem) : this.setAriaActiveDescendant(this.highlightedItem), Hi(this.element), this.highlightedItem && this.highlightedItem !== this.element && this.highlightedItem.setAttribute("tabindex", "-1");
  }
  /**
   ...
   */
  onBlur() {
    this.highlightedItem && (this.highlightedItem._tippy && this.highlightedItem._tippy.hide(), this.highlightedItem.getAttribute(je) === wt && this.highlightedItem.querySelector(`[${bt}]`)?._tippy?.hide());
  }
  /**
...
const ti = "focus-container", Yi = "focus-list", go = "focus-icon", Bt = `[${Yi}],[${ti}]`, gi = `button,input,select,a,textarea,[contenteditable],.ag-tab-guard,[${Yi}],[${ti}],[${go}],[tabIndex]`;
let zt = [];
const yo = {
  mounted(r) {
...
class vo {
   ...
   */
  disableTabbing() {
    Array.prototype.filter.call(this.element.querySelectorAll(gi), () => !0).forEach((t) => {
      t.tabIndex = -1;
    });
  }
  /**
  ...
  enableTabbing() {
    let e;
    return Array.prototype.map.call(this.element.querySelectorAll(gi), (t) => {
...
const xo = ["content"], So = {
  ...
  setup(r, { expose: e }) {
    const { t } = H(), i = Ye(), s = Lt(), o = ve("iApi"), a = ui("el"), l = ui("contentEl"), n = h();
    e({ el: a });
    const c = r, u = N(() => o?.fixture.get("appbar") ? s.temporary : []), p = N(() => i.mobileView), d = N(() => i.reorderable), v = (b) => b.scrollHeight > b.clientHeight, f = () => !p.value && !c.panel.teleport, g = (b) => {
    ...
    return Je(() => {
      ...
      const T = K("back"), C = K("panel-options-menu"), F = K("left"), ce = K("right"), Xe = K("pin"), Pt = K("expand"), Nt = K("minimize"), Ft = K("close"), _ = M("truncate"), R = M("focus-item"), ae = M("tippy");
      return P((y(), A("div", {
        ...
        r.header ? (y(), A("header", So, [
          re(T, {
            class: oe(r.panel.teleport ? "display-none" : "block sm:display-none"),
            onClick: $[0] || ($[0] = (fe) => r.panel.close())
          }, null, 8, ["class"]),
          P((y(), A("h2", _o, [
            b.$slots.header ? Me(b.$slots, "header", { key: 0 }) : (y(), A("div", Io, B(S(t)(r.panel.alertName)), 1))
          ])), [
            [_]
          ]),
          b.$slots.controls ? (y(), W(C, { key: 0 }, {
            default: te(() => [
              Me(b.$slots, "controls")
            ]),
            _: 3
          ...
          m("div", {
            ...
            r.panel.teleport ? U("", !0) : (y(), A("div", To, [
              d.value ? (y(), W(F, {
                key: 0,
                onClick: $[1] || ($[1] = (fe) => g("left")),
                active: !r.panel.isLeftMostPanel
              }, null, 8, ["active"])) : U("", !0),
              d.value ? (y(), W(ce, {
                key: 1,
                onClick: $[2] || ($[2] = (fe) => g("right")),
              ...
              r.panel.controls && r.panel.controls.expand ? (y(), W(Pt, {
                key: 2,
                onClick: $[4] || ($[4] = (fe) => r.panel.expand()),
                active: r.panel.expanded
              }, null, 8, ["active"])) : U("", !0)
            ])),
            r.panel.button && u.value?.includes(r.panel.id) ? (y(), W(Nt, {
              key: 1,
        ...
        r.content ? (y(), A("div", {
          ...
          b.$slots.content ? Me(b.$slots, "content", { key: 0 }) : w.value ? (y(), A("div", {
            key: 1,
            innerHTML: w.value.innerHTML
          }, null, 8, Lo)) : U("", !0)
        ], 512)) : U("", !0),
        r.footer ? P((y(), A("div", Ro, [
          Me(b.$slots, "footer")
        ])), [
          [R]
        ]) : U("", !0)
...
}), Co = { class: "relative" }, Oo = ["content", "aria-label"], ko = ["transform"], Mo = /* @__PURE__ */ O({
  __name: "pin",
  props: {
    active: Boolean
  },
...
}), Po = { class: "relative" }, No = ["content", "aria-label"], Fo = /* @__PURE__ */ O({
  __name: "close",
  props: {
    active: Boolean
  },
...
}), Do = { class: "relative" }, Go = ["content", "aria-label"], Uo = /* @__PURE__ */ O({
  __name: "back",
  props: {
    active: Boolean
  },
...
}), Wo = { class: "relative" }, Ho = ["content", "aria-label"], Yo = /* @__PURE__ */ O({
  __name: "minimize",
  props: {
    active: Boolean
  },
...
}), Jo = { class: "relative" }, Zo = ["content", "aria-label"], Ko = /* @__PURE__ */ O({
  __name: "right",
  props: {
    active: Boolean
  },
...
}), Qo = { class: "relative" }, Xo = ["content", "aria-label"], ea = /* @__PURE__ */ O({
  __name: "left",
  props: {
    active: Boolean
  },
  ...
  setup(r) {
    ...
    return (s, o) => {
      ...
      return y(), W(a, {
        ...
        default: te(() => [
          S(t).isFullscreen ? (y(), A("svg", sa, o[0] || (o[0] = [
            m("path", {
              d: "M0 0h24v24H0z",
              fill: "none"
            }, null, -1),
  ...
  tabindex: "-1"
}, ca = ["content", "aria-label"], ua = /* @__PURE__ */ O({
  __name: "button",
  props: {
    onClickFunction: {
      type: Function,
  ...
  class: "relative",
  tabindex: "-1"
}, da = ["aria-label", "content"], ha = /* @__PURE__ */ O({
  __name: "button",
  props: {
    onClickFunction: {
      type: Function,
...
}), fa = /* @__PURE__ */ Ne(ha, [["__scopeId", "data-v-457cd2d4"]]), ma = z("areas-of-interest", () => ({ areas: h([]) })), ga = z("export", () => {
  const r = h({
    title: !0,
    map: !0,
    mapElements: !0,
...
function xa(r, e) {
  ...
  if (t.test(e) && !r.disabledSearchTypes.includes("LAT/LNG")) {
    const o = e.slice(0, -1);
    return new Sa(r, o);
  } else return s.test(e) && !r.disabledSearchTypes.includes("FSA") ? new _a(r, e) : i.test(e) && !r.disabledSearchTypes.includes("NTS") ? new Ia(r, e.substring(0, 6).toUpperCase()) : new Ta(r, e);
}
class kt {
  config;
  query;
...
const vi = "https://geogratis.gc.ca/services/geolocation/@{language}/locate", bi = "https://geogratis.gc.ca/services/geoname/@{language}/geonames.json", wi = "https://geogratis.gc.ca/services/geoname/@{language}/codes/province.json", Ai = "https://geogratis.gc.ca/services/geoname/@{language}/codes/concise.json", La = {
  10: "NL",
  11: "PE",
  12: "NS",
  13: "NB",
...
class Ei {
  ...
  constructor(e, t) {
    ...
    l ? (i = l.geoLocation ? l.geoLocation : vi, s = l.geoNames ? l.geoNames : bi, o = l.geoProvince ? l.geoProvince : wi, a = l.geoTypes ? l.geoTypes : Ai) : (i = vi, s = bi, o = wi, a = Ai), i = i.replace("@{language}", e), s = s.replace("@{language}", e), o = o.replace("@{language}", e), a = a.replace("@{language}", e);
    const n = t?.settings;
    let c, u, p, d, v;
...
class Zi extends Z {
   ...
   */
  constructor(e, t, i) {
    super(e), this._uid = ut.sharedUtils.generateUUID(), this._name = t.name, this._type = t.type ?? "placeholder", this._parent = i, this._children = [], this._loadPromise = new J(), this._hidden = t.hidden ?? !1, this._expanded = t.expanded ?? !0, this._visibility = !0, this._exclusive = t.exclusive ?? !1, this._controls = t.controls?.slice() ?? [
      "visibilityButton",
      "expandButton"
      /* Expand */
...
class Ga {
  ...
  constructor(e, t, i) {
    ...
    const s = Ua(e, this);
    this.$vApp = s.app, this.$element = s.element, this.$i18n = s.i18n, this.$rootEl = s.app.$root?.$el, this.fixture = new Mn(this), this.panel = new Pn(this), this.geo = new On(this), this.ui = {
    ...
    if (t?.configs !== void 0) {
        ...
        f && (clearInterval(u), this.geo.map.createMap(c.map, f).then(() => {
          if (f._tippy.hide(0), a.setMaptipInstance(f._tippy), c.layers && c.layers.length > 0) {
            ...
            c.layers.forEach((w) => {
              ...
              this.geo.map.addLayer(b, g).catch(() => {
              }), b.mapLayer && g++;
            });
          }
        }));
      ...
      if (c.panels) {
        if (c.panels.open && c.panels.open.length > 0) {
          const f = c.panels.open.map((g) => g.id);
          this.panel.isRegistered(f).then(() => {
            c.panels?.open?.forEach((g) => {
              this.panel.open({
                id: g.id,
                screen: g.screen
              }), g.pin && this.panel.pin(g.id);
            });
          });
        }
   ...
   */
  reload(e, t) {
    const i = st(this.$vApp.$pinia), s = Le(this.$vApp.$pinia), o = de(this.$vApp.$pinia), a = ye(this.$vApp.$pinia), l = Ie(this.$vApp.$pinia), n = Wt(this.$vApp.$pinia), c = !!e;
...
function Ua(r, e) {
  ...
  s.directive("focus-container", yo), s.directive("focus-list", po), s.directive("focus-item", fo), s.directive("truncate", Ao), s.component("panel-screen", $o), s.component("pin", Mo), s.component("close", Fo), s.component("back", Uo), s.component("expand", qo), s.component("panel-options-menu", ia), s.component("dropdown-menu", ei), s.component("minimize", Yo), s.component("right", Ko), s.component("left", ea), s.component("fullscreen-nav-button", oa), s.component("geolocator-nav-button", aa), s.component("home-nav-button", na), s.component("mapnav-button", ua), s.component("appbar-button", fa), s.component("transition", $i), s.component("transition-group", Ci), s.config.globalProperties.$iApi = e, s.config.globalProperties.$pinia = t, s.config.idPrefix = `ramp-${r.id || e.geo.shared.generateUUID()}`, s.provide("iApi", e);
  const o = s.mount(r);
...
class Ba extends Z {
  ...
  async createMap(e, t) {
    ...
    const l = {};
    this.esriMap = X(await k.Map(l)), this.pointZoomScale = e.pointZoomScale && e.pointZoomScale > 0 ? e.pointZoomScale : 5e4, this._targetDiv = t, this.createMapView(e.initialBasemapId);
  }
  /**
...
class ja extends Ba {
  ...
  async createMapView(e) {
    ...
    this.esriView = X(
      ...
      n.preventDefault();
    }) : console.error("ESRI Map View is missing its container"), we(
  ...
  addLayer(e, t = void 0) {
    return new Promise((i, s) => {
      ...
      Ie(this.$vApp.$pinia).addLayer(e, t), this.$iApi.event.emit(E.LAYER_REGISTERED, e);
      const a = Date.now();
      let l = 0;
      const n = setInterval(() => {
  ...
  reorder(e, t, i = !1) {
    ...
    if (a === t)
      return;
    if (Ie(this.$vApp.$pinia).reorderLayer(e, t), e.esriLayer && this.esriMap.layers.indexOf(e.esriLayer) > -1) {
      let n = 0;
      if (t > 0) {
  ...
  async geoJsonToEsriJson(e, t) {
    ...
    s || (s = I.parseGeoJsonCrs(e.crs)), a.renderer = await k.RendererFromJson(c.renderer), a.fields = (a.fields || []).concat(
      t.fieldMetadata?.exclusiveFields ? this.extractGeoJsonFields(e).filter(
        (g) => t.fieldMetadata?.fieldInfo?.find((w) => w.name === g.name)
    ...
    for (let g = 0; g < d.length; g++) {
      const w = d[g];
      w.geometry.spatialReference = p, w.geometry.type = a.geometryType, Object.keys(w.attributes).forEach((b) => {
        v.includes(b) ? (Array.isArray(w.attributes[b]) || typeof w.attributes[b] == "object") && w.attributes[b] != null && (w.attributes[b] = JSON.stringify(w.attributes[b])) : delete w.attributes[b];
      });
    }
    return (t.fieldMetadata?.fieldInfo && t.fieldMetadata?.fieldInfo.length > 0 ? t.fieldMetadata.fieldInfo.filter((g) => g.trim && v.includes(g.name)).map((g) => g.name) : []).forEach((g) => {
      for (let w = 0; w < d.length; w++) {
        const b = d[w].attributes;
        typeof b[g] == "string" && (b[g] = b[g].trim());
      }
...
class on extends Z {
   ...
   */
  getLayer(e) {
    return Ie(this.$vApp.$pinia).getLayerByAny(e);
  }
  /**
   ...
   */
  getSublayer(e, t) {
    const i = Ie(this.$vApp.$pinia).getLayerById(e);
   ...
   */
  layerOrderIds() {
    return Ie(this.$vApp.$pinia).mapOrder.slice(0) || [];
  }
  /**
   ...
   */
  allLayers() {
    return Ie(this.$vApp.$pinia).layers || [];
  }
  /**
...
class si extends Z {
   ...
   */
  getLayerTree() {
    return new It(0, "Fake tree", "getLayerTree() was not implemented in layer");
  }
  /**
...
class Ki extends si {
  ...
  constructor(e, t) {
    super(e, t), this.name = e.name || "", this.geomType = L.NONE, this.dataFormat = ee.UNKNOWN, this.layerType = x.UNKNOWN, this.layerFormat = ge.UNKNOWN;
...
class an extends Ke {
  constructor(e, t) {
    super(e, t), this.dataFormat = ee.ESRI_FEATURE, this.layerFormat = ge.GRAPHIC, this.hovertips = !1;
  }
  _graphics = [];
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
...
class nn extends an {
  ...
  async onInitiate() {
    this.esriLayer = X(await k.GraphicsLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
...
class Qe extends ri {
  ...
  constructor(e, t) {
    super(e, t), this.supportsIdentify = !0, this.isFile = !0, this.dataFormat = ee.ESRI_FEATURE, this.layerFormat = ge.FEATURE, this.tooltipField = "", this.layerIdx = 0, e.identifyMode && e.identifyMode !== Q.NONE ? this.identifyMode = e.identifyMode : this.identifyMode = Q.HYBRID;
  }
  async reload() {
  ...
  async onInitiate() {
    ...
    this.esriJson = await this.$iApi.geo.layer.files.geoJsonToEsriJson(this.sourceGeoJson, e), this.esriLayer = X(await k.FeatureLayer(this.makeEsriLayerConfig(this.origRampConfig))), this.esriJson = void 0, this.origRampConfig.caching || delete this.origRampConfig.rawData, delete this.sourceGeoJson, await super.onInitiate();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
  ...
  async getGraphic(e, t) {
    ...
    if (t.getStyle) {
      const s = _e(this.renderer.getGraphicSymbol(i.attributes));
...
class fn extends ri {
  tooltipField;
  constructor(e, t) {
    super(e, t), this.dataFormat = ee.ESRI_FEATURE, this.tooltipField = "", this.supportsIdentify = !0, this.layerType = x.FEATURE, this.layerFormat = ge.FEATURE, e.identifyMode && e.identifyMode !== Q.NONE ? this.identifyMode = e.identifyMode : this.identifyMode = Q.HYBRID;
  }
  async onInitiate() {
    X(this.esriLayer = await k.FeatureLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
...
class mn extends Ke {
  ...
  origState;
  constructor(e, t) {
    super(e, t), this.supportsIdentify = !0, this.supportsSublayers = !0, this.layerType = x.MAPIMAGE, this.layerFormat = ge.MAPIMAGE, this.isDynamic = !1, this.hovertips = !1, this.layerTree.layerIdx = -1, this.identifyMode = Q.GEOMETRIC;
  }
  async onInitiate() {
    this.esriLayer = X(await k.MapImageLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
  ...
  onLoadActions() {
    ...
    const o = [], a = (n, c) => {
      ...
      if (n.sublayers && n.sublayers.length > 0) {
        const d = (p ? p.name : "") || n.title || "", v = new It(u, "", d, !1);
        c.findChildByIdx(u) || c.children.push(v), n.sublayers.reverse().forEach((f) => {
          a(f, v);
        });
      } else {
        this._sublayers[u] || (this._sublayers[u] = new gn(
          {
            id: `${this.id}-${u}`,
            index: u,
        ...
        if (d.name = p?.name || n.title || "", o.push(d), !c.children.map((v) => v.layerIdx).includes(u)) {
          const v = new It(u, d.uid, d.name, !1);
          c.children.push(v);
        }
        d.esriWatches.push(
          we(
...
class gn extends ri {
  tooltipField;
  constructor(e, t, i) {
    if (super(e, t), this.layerType = x.SUBLAYER, this.layerFormat = ge.MAPIMAGE, this.isSublayer = !0, this.layerIdx = e.index, this.parentLayer = i, this.dataFormat = ee.ESRI_FEATURE, this.supportsFeatures = !0, this.tooltipField = "", this.hovertips = !1, this.url = this.parentLayer?.url, this.canReload = !!(this.url || this.origRampConfig.caching), !i.esriLayer)
...
class yn extends Ke {
  constructor(e, t) {
    super(e, t), this.supportsIdentify = !1, this.layerType = x.OSM, this.layerFormat = ge.OSM, this.dataFormat = ee.OSM_TILE, this.supportsFeatures = !1;
  }
  async onInitiate() {
    this.esriLayer = X(await k.OpenStreetMapLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
...
class vn extends Ke {
  constructor(e, t) {
    super(e, t), this.supportsIdentify = !1, this.layerType = x.IMAGERY, this.layerFormat = ge.IMAGERY, this.dataFormat = ee.ESRI_RASTER;
  }
  async onInitiate() {
    this.esriLayer = X(await k.ImageryLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
...
class bn extends Ke {
  constructor(e, t) {
    super(e, t), this.supportsIdentify = !1, this.layerType = x.TILE, this.layerFormat = ge.TILE, this.dataFormat = ee.ESRI_TILE;
  }
  async onInitiate() {
    this.esriLayer = X(await k.TileLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
...
class wn extends Ke {
  ...
  mimeType;
  constructor(e, t) {
    super(e, t), this.supportsIdentify = !0, this.layerType = x.WMS, this.layerFormat = ge.WMS, this.mimeType = e.featureInfoMimeType || "", this.sublayerNames = [], this.dataFormat = ee.OGC_RASTER, this.identifyMode = Q.GEOMETRIC;
  }
  async onInitiate() {
    this.esriLayer = X(await k.WMSLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
  ...
  getFeatureInfo(e, t, i) {
    ...
    let a, l;
    const n = s.getExtent(), c = o.spatialReferences, u = e.join(","), p = s.esriView.toScreen(t.toESRI()), d = Math.floor(p.x), v = Math.floor(p.y), g = {
...
class Qi extends Ki {
  ...
  // ----------- LAYER CONSTRUCTION AND INITIALIZAION -----------
  constructor(e, t) {
    super(e, t), this.dataFormat = ee.ESRI_FEATURE, this.layerFormat = ge.NOLAYER, this.drawState = pe.NOT_VISUAL, this.attribs = new Xi(), this.supportsFeatures = !0, this.mapLayer = !1, this.isFile = !1, this._visibility = e.state?.visibility ?? !0, this.expectedTime.draw = 0;
  }
  async onInitiate() {
    if (this.sourceJson) {
      ...
      this.fields = t.map((a, l) => {
        ...
        return {
          ...
          alias: n,
          type: u,
          length: u === Ce.STRING ? 256 : void 0
        };
      }), this.oidField = "rampOID", this.fields.push({ name: this.oidField, type: Ce.OID }), e.fields.push(this.oidField), e.data.forEach((a, l) => a.push(l + 1)), this.$iApi.geo.attributes.applyFieldMetadata(this, this.origRampConfig.fieldMetadata), this.fieldList = "*";
      const o = {
        batchSize: -1,
...
class oi extends Z {
  ...
  constructor(e, t) {
    super(e), this.aac = new _i(), this.details = t;
  }
  /**
  ...
  getAttribs() {
    return this.loadPromise || (this.aac = new _i(), this.loadPromise = this.loadPromiseGenerator()), this.loadPromise;
  }
  abortAttribLoad() {
...
class $n extends Z {
  ...
  async symbolToSvg(e) {
    ...
    const o = tt(s).size(this.CONTAINER_SIZE, this.CONTAINER_SIZE).viewbox(0, 0, this.CONTAINER_SIZE, this.CONTAINER_SIZE), a = {
      ...
      none: () => "transparent",
      // esriSFSNull
      horizontal: (f, g) => o.pattern(5, 5, (b) => b.line(0, 5 / 2, 5, 5 / 2)).stroke(g),
      vertical: (f, g) => o.pattern(5, 5, (b) => b.line(5 / 2, 0, 5 / 2, 5)).stroke(g),
      "forward-diagonal": (f, g) => o.pattern(5, 5, (b) => {
        b.line(0, 0, 5, 5).stroke(g), b.line(0, 0, 5, 5).move(0, 5).stroke(g), b.line(0, 0, 5, 5).move(5, 0).stroke(g);
      }),
      "backward-diagonal": (f, g) => o.pattern(5, 5, (b) => {
        b.line(5, 0, 0, 5).stroke(g), b.line(5, 0, 0, 5).move(5 / 2, 5 / 2).stroke(g), b.line(5, 0, 0, 5).move(-5 / 2, -5 / 2).stroke(g);
      }),
      cross: (f, g) => o.pattern(5, 5, (b) => {
        b.line(5 / 2, 0, 5 / 2, 5).stroke(g), b.line(0, 5 / 2, 5, 5 / 2).stroke(g);
      }),
      "diagonal-cross": (f, g) => o.pattern(7, 7, (b) => {
        b.line(0, 0, 7, 7).stroke(g), b.line(7, 0, 0, 7).stroke(g);
      })
    }, p = {
      "simple-marker"() {
        const f = v(e.color);
        e.outline = e.outline || c;
        const g = v(e.outline.color), w = d({
          color: g.colour,
          opacity: g.opacity,
      ...
      "picture-fill"() {
        const f = e.imageData ? `data:${e.contentType};base64,${e.imageData}` : e.url, g = e.width * e.xscale, w = e.height * e.yscale;
        e.outline = e.outline || c;
        const b = v(e.outline.color), $ = d({
          color: b.colour,
          opacity: b.opacity,
      ...
      "picture-marker"() {
        const f = e.source, g = f && f.imageData ? `data:${f.contentType};base64,${f.imageData}` : e.url;
        return t.$iApi.geo.shared.convertImagetoDataURL(g).then((b) => t.svgDrawImage(o, b)).then(({ image: b }) => {
...
class On extends Z {
   ...
   */
  constructor(e) {
    super(e), this.geom = ut.geom, this.proj = ut.proj, this.shared = ut.sharedUtils, this.map = new ja(e), this.layer = new on(e), this.attributes = new Sn(e), this.query = new Cn(e), this.symbology = new $n(e), Array.isArray(ft.request.interceptors) || (ft.request.interceptors = []), ft.request.interceptors.push({
      before: (t) => {
...
const kn = /* @__PURE__ */ Object.assign({ "../fixtures/appbar/index.ts": () => import("./index-25oFIG3s.js"), "../fixtures/areas-of-interest/index.ts": () => import("./index-BwcC0oo8.js"), "../fixtures/basemap/index.ts": () => import("./index-BOEZvk4v.js"), "../fixtures/crosshairs/index.ts": () => import("./index-BSh8-jE_.js"), "../fixtures/details/index.ts": () => import("./index-BoFVb327.js"), "../fixtures/export-footnote/index.ts": () => import("./index-B78FCegR.js"), "../fixtures/export-legend/index.ts": () => import("./index-BFBS6MrV.js"), "../fixtures/export-map/index.ts": () => import("./index-CMU5OaUN.js"), "../fixtures/export-northarrow/index.ts": () => import("./index-C3X-DTUD.js"), "../fixtures/export-scalebar/index.ts": () => import("./index-DdfsEf_J.js"), "../fixtures/export-timestamp/index.ts": () => import("./index-Dq4F1eK2.js"), "../fixtures/export-title/index.ts": () => import("./index-kGLxWt5Y.js"), "../fixtures/export/index.ts": () => import("./index-GOXFLB9q.js"), "../fixtures/extentguard/index.ts": () => import("./index-D3vQAUkU.js"), "../fixtures/gazebo/index.ts": () => import("./index-CmBPVun0.js"), "../fixtures/geosearch/index.ts": () => import("./index-DUA9V9Vq.js"), "../fixtures/grid/index.ts": () => import("./index-BAqhXmaP.js"), "../fixtures/help/index.ts": () => import("./index-CThj8Au3.js"), "../fixtures/hilight/index.ts": () => import("./index-BDAWZqYl.js"), "../fixtures/layer-reorder/index.ts": () => import("./index-jUVr9-e-.js"), "../fixtures/legend/index.ts": () => import("./index-C114BF8d.js"), "../fixtures/mapnav/index.ts": () => import("./index-ZZCqj9fh.js"), "../fixtures/metadata/index.ts": () => import("./index-WJ2EQYLV.js"), "../fixtures/northarrow/index.ts": () => import("./index-sLJqiqjA.js"), "../fixtures/overviewmap/index.ts": () => import("./index-CmER5YvS.js"), "../fixtures/panguard/index.ts": () => import("./index-q4U8lDXZ.js"), "../fixtures/scrollguard/index.ts": () => import("./index-B5lb-375.js"), "../fixtures/settings/index.ts": () => import("./index-D9kExkCt.js"), "../fixtures/snowman/index.ts": () => import("./index-Bs35vSLH.js"), "../fixtures/wizard/index.ts": () => import("./index-BwQZlfUc.js") });
class Mn extends Z {
  /**
  ...
  async add(e, t) {
    ...
    if (t) {
      ...
      const s = (await kn[`../fixtures/${e}/index.ts`]()).default;
      i = new s(e, this.$iApi);
    }
  ...
  get(e) {
    ...
    const i = t.map((s) => {
      const o = ye(this.$vApp.$pinia).items[s];
      if (o)
        return o;
    });
...
const Gn = /* @__PURE__ */ Ne(Fn, [["render", Dn], ["__scopeId", "data-v-a3c61802"]]), Un = /* @__PURE__ */ Object.assign({ "../fixtures/areas-of-interest/screen.vue": () => import("./screen-CQxclYEB.js"), "../fixtures/basemap/screen.vue": () => import("./screen-tFscug2N.js"), "../fixtures/export/screen.vue": () => import("./screen-CcUxo1_Y.js"), "../fixtures/geosearch/screen.vue": () => import("./screen-DZTAjGDi.js"), "../fixtures/grid/screen.vue": () => import("./screen-CND28VE9.js"), "../fixtures/help/screen.vue": () => import("./screen-fH-5CwWn.js"), "../fixtures/layer-reorder/screen.vue": () => import("./screen-Bqk9WM3n.js"), "../fixtures/legend/screen.vue": () => import("./screen-DFqKqsZB.js"), "../fixtures/metadata/screen.vue": () => import("./screen-CTsmKTH_.js"), "../fixtures/settings/screen.vue": () => import("./screen-DFlWnkoz.js"), "../fixtures/wizard/screen.vue": () => import("./screen-DfqSmvXb.js") });
class Et extends Z {
  /**
   * ID of this panel.
   *
  ...
  registerScreen(e) {
    ...
    if (Ds(t) || Fs(t))
      ...
      let s;
      typeof t == "string" ? s = Un[`../fixtures/${t}`]() : s = t();
...
function zn(r) {
  ...
  return jn(r.services, e), Vn(r.map, e), qn(r.ui, e), r.plugins && Wn(r.plugins, e), e;
}
function Vn(r, e) {
...
function jt(r) {
  ...
  )), typeof r.stateOnly < "u" && (e.cosmetic = r.stateOnly), r.initialFilteredQuery && (e.initialFilteredQuery = r.initialFilteredQuery), Hn(r, e), (typeof r.toggleSymbology < "u" || r.table) && (e.fixtures = {}, typeof r.toggleSymbology < "u" && (e.fixtures.legend = {
...
var rt = { major: "4", minor: "12", patch: "0-beta", timestamp: "Tue Apr 8 15:40:27 2025 -0400", hash: "57e6df1a28dd6c06421c0c5592bc1ec24e8aa86d" };
console.info(
...
const kl = (r, e, t) => new Ga(r, e, t), ut = new Ns();
export {
  q as $,
  Cr as A,
  gt as B,
