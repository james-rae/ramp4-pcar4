import { defineComponent as G, ref as b, onMounted as re, createElementBlock as a, openBlock as t, createElementVNode as g, normalizeClass as Z, createCommentVNode as N, Fragment as J, renderList as X, normalizeStyle as ge, toDisplayString as z, computed as L, resolveDirective as A, withDirectives as q, withModifiers as he, createVNode as ie, onBeforeMount as ee, watch as U, onBeforeUnmount as te, unref as x, createBlock as Y, inject as se, resolveDynamicComponent as pe, nextTick as ne, createTextVNode as oe, resolveComponent as Me, withCtx as fe } from "vue";
import { _ as ue, e as le, Y as ce, a1 as Ee, G as Q } from "./main-CFlwNxev.js";
...
import "await-to-js";
import "svg.js";
import { T as Ce } from "./toggle-switch-control-B5SG4On7.js";
const De = {
  key: 0,
  class: "relative"
}, Se = {
    ...
    return re(() => {
      ...
      g("div", {
        ...
        s.value.length > 1 ? (t(), a("div", Se, [
          (t(!0), a(J, null, X(s.value.slice(0, 3).reverse(), (h, p) => (t(), a("div", {
  ...
  setup(v, { emit: I }) {
    ...
    return ee(() => {
      ...
      return q((t(), a("div", {
        ...
        (t(!0), a(J, null, X(E.results, (O, l) => (t(), a("div", {
  ...
  setup(v) {
    const { t: I } = W(), s = se("iApi"), m = v, y = (e, u, o, n) => {
  ...
  setup(v) {
    ...
    }, null, 8, Qe)) : (t(), a("div", Xe, z(x(I)("details.layers.results.empty")), 1));
  }
  ...
  setup(v) {
    const I = ce(), s = v, m = se("iApi"), y = b([]), h = le(), { t: p } = W(), D = b(!1), E = b(""), e = b("none"), u = b(), o = () => I.getLayerByUid(s.uid), n = L(() => h.properties), f = L(() => h.defaultTemplates), c = L(() => o()?.supportsFeatures ?? !1), _ = L(() => o()?.mapLayer ?? !1), B = L(() => {
      const l = o();
      ...
      return f.value && f.value[s.data.format] ? f.value[s.data.format] : c.value ? Ke : et;
  ...
  setup(v, { emit: I }) {
    ...
    }, h = se("iApi"), p = le(), D = ce(), E = I, e = v, { t: u } = W(), o = b(!1), n = b(h.fixture.get("details")), f = b(!0), c = b(!1), _ = b(0), B = b(20), S = b([]), H = b([]), r = L(() => p.activeGreedy), w = L(() => p.properties), T = L(() => _.value + B.value), F = () => D.getLayerByUid(e.uid), M = () => e.results.find((i) => i.uid === e.uid), O = L(() => M()?.loaded ?? !1), l = L(() => M()?.requestTime), d = L(
    ...
    return re(() => {
      S.value.push(
        h.event.on(Q.LAYER_REMOVE, (i) => {
          const k = h.panel.get("details");
          e.uid === i.uid && k && k.close();
        })
      ), S.value.push(
        h.event.on(Q.PANEL_CLOSED, (i) => {
          i.id === "details" && Le();
        })
      ), S.value.push(
        h.event.on(Q.PANEL_MINIMIZED, (i) => {
          i.id === "details" && we();
        })
      ), S.value.push(
        h.event.on(Q.MAP_BASEMAPCHANGE, (i) => {
        ...
        o.value ? (t(), a("div", Lt, [
          $().length > 0 ? (t(), a("div", wt, [
            c.value ? q((t(), a("div", {
              ...
              (t(!0), a(J, null, X($().slice(_.value, T.value), (K, me) => q((t(), a("button", {
  ...
  setup(v) {
    const { t: I } = W(), s = se("iApi"), m = le(), y = b([]), h = b([]), p = b([]), D = b(!1), E = b(null), e = b(""), u = L(() => m.activeGreedy), o = L(() => m.payload), n = L(() => m.properties), f = (r) => {
      e.value = r;
        ...
        content: fe(() => [
          g("div", Dt, [
            ...
            g("div", {
              ...
              }, z(p.value.length >= 1 ? x(I)("details.layers.results.empty") : x(I)("details.layers.results.empty.noLayers")), 3)) : (t(), Y(Ct, {
                key: 0,
                uid: e.value,
                results: p.value,
...
}), _s = /* @__PURE__ */ ue(St, [["__scopeId", "data-v-e4b92b97"]]);
export {
  _s as default
};
