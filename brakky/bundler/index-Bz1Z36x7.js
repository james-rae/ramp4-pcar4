...
import "tiny-emitter";
import { G as le, L as Te, F as xe } from "./main-o88lwIG-.js";
...
class ft extends Me {
  async init() {
    Object.entries(Le).forEach((b) => this.$iApi.$i18n.mergeLocaleMessage(...b)), this._parseConfig(this.config), Z(this.$vApp.$pinia).supportedTypes.forEach((b) => {
      const o = `${b.type}-icon`;
      this.$iApi.component(o, Ae(Se(/* @__PURE__ */ Object.assign({ "./icons/circle-icon.vue": () => import("./circle-icon-BHxIG4Hj.js"), "./icons/edit-icon.vue": () => import("./edit-icon-mrPA_232.js"), "./icons/point-icon.vue": () => import("./point-icon-BkyY15_D.js"), "./icons/polygon-icon.vue": () => import("./polygon-icon-AfWLQ_Za.js"), "./icons/polyline-icon.vue": () => import("./polyline-icon-Q9WnXAEQ.js"), "./icons/rectangle-icon.vue": () => import("./rectangle-icon-_0408rbr.js") }), `./icons/${b.type}-icon.vue`, 3)));
    });
