...
import { _ as H, d as L, F as X, G as ee } from "./main-o88lwIG-.js";
...
const G = /* @__PURE__ */ H(ne, [["render", ae]]), se = /* @__PURE__ */ T({
  ...
  setup(h) {
    ...
    const p = [
      {
        type: "point",
        icon: g(_(() => import("./point-icon-BkyY15_D.js")))
      },
      {
        type: "polyline",
        icon: g(_(() => import("./polyline-icon-Q9WnXAEQ.js")))
      },
      {
        type: "polygon",
        icon: g(_(() => import("./polygon-icon-AfWLQ_Za.js")))
      },
      {
        type: "circle",
        icon: g(_(() => import("./circle-icon-BHxIG4Hj.js")))
      },
      {
        type: "rectangle",
        icon: g(_(() => import("./rectangle-icon-_0408rbr.js")))
      }
    ], a = A(() => {
      const s = p.filter((u) => e.supportedTypes.some((x) => x.type === u.type));
      return s.push({
        type: "edit",
        icon: g(_(() => import("./edit-icon-mrPA_232.js")))
      }), s;
    }), n = (s) => {
