import "tiny-emitter";
import { F as C, w as y, m as z, G, P as T, x as W, L as B, y as H, z as R } from "./main-CFlwNxev.js";
...
const Q = "path", Z = 12, ee = "M14.4 6L14 4H5v17h2v-7h5.6l.4 2h7V6z", te = "#ff0000ff", oe = 5, re = 6, ie = {
  ...
  setup(S) {
    ...
    X(() => {
      ...
      $.value = i.tileSchemas, n?.value && (P.value = `<img width='25' src='${n.value}'>`), e.geo.map.esriView?.ready && x(e.geo.map.getExtent()), A.push(e.event.on(G.MAP_EXTENTCHANGE, Y(300, x)));
    }), F(() => {
