...
import { _ as G, u as ae, a as le, b as R, A as pe, k as ce, F as ue, G as de } from "./main-CFlwNxev.js";
import { createPopper as me } from "@popperjs/core";
import fe from "popper-max-size-modifier";
import "tiny-emitter";
...
const J = /* @__PURE__ */ G(he, [["render", ge], ["__scopeId", "data-v-5d32b715"]]), ye = ["content", "aria-label"], $e = /* @__PURE__ */ q({
  ...
  setup(g, { expose: a, emit: l }) {
    ...
    const N = () => {
      ...
      B.value && k.value && (c.value++, me(B.value, k.value, {
  ...
  setup(g) {
    const a = le(), l = R(), i = w(0), d = w(0), p = H(() => l.visible), e = H(() => l.temporary), { t: x } = D(), u = w(!1), c = w({}), b = w(), B = () => {
      ...
      ce(o, b.value) && b.value._tippy.show();
    }, N = () => {
      const o = b.value;
      let m;
      const f = [...o.children];
