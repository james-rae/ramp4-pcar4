...
import { _ as H, d as L, k as X, F as ee, G as te } from "./main-CFlwNxev.js";
...
const G = /* @__PURE__ */ H(ne, [["render", ae]]), se = /* @__PURE__ */ T({
  ...
  setup(h) {
    ...
    const p = [
      {
        type: "point",
        icon: g(_(() => import("./point-icon-CfQLC8zv.js")))
      },
      {
        type: "polyline",
        icon: g(_(() => import("./polyline-icon-NwEarV6q.js")))
      },
      {
        type: "polygon",
        icon: g(_(() => import("./polygon-icon-D-WCWSVC.js")))
      },
      {
        type: "circle",
        icon: g(_(() => import("./circle-icon-vZDdg9Fd.js")))
      },
      {
        type: "rectangle",
        icon: g(_(() => import("./rectangle-icon-DzGxWAXi.js")))
      }
    ], a = A(() => {
      const s = p.filter((u) => e.supportedTypes.some((x) => x.type === u.type));
      return s.push({
        type: "edit",
        icon: g(_(() => import("./edit-icon-Cf6kHT6F.js")))
      }), s;
    }), n = (s) => {
