...
import { _ as H, d as L, F as X, G as ee } from "./main-ClGLFeMT.js";
...
const G = /* @__PURE__ */ H(ne, [["render", ae]]), se = /* @__PURE__ */ T({
  ...
  setup(h) {
    ...
    const p = [
      {
        type: "point",
        icon: g(_(() => import("./point-icon-CGjYr5Ni.js")))
      },
      {
        type: "polyline",
        icon: g(_(() => import("./polyline-icon-CFzIEU-U.js")))
      },
      {
        type: "polygon",
        icon: g(_(() => import("./polygon-icon-KTBAi_Sq.js")))
      },
      {
        type: "circle",
        icon: g(_(() => import("./circle-icon-DmOrNVbm.js")))
      },
      {
        type: "rectangle",
        icon: g(_(() => import("./rectangle-icon-DOQGZPgq.js")))
      }
    ], a = A(() => {
      const s = p.filter((u) => e.supportedTypes.some((x) => x.type === u.type));
      return s.push({
        type: "edit",
        icon: g(_(() => import("./edit-icon-D2S1FFKJ.js")))
      }), s;
    }), n = (s) => {
