...
import "tiny-emitter";
import { G as le, L as Te, F as xe } from "./main-ClGLFeMT.js";
...
class ft extends Me {
  async init() {
    Object.entries(Le).forEach((b) => this.$iApi.$i18n.mergeLocaleMessage(...b)), this._parseConfig(this.config), Z(this.$vApp.$pinia).supportedTypes.forEach((b) => {
      const o = `${b.type}-icon`;
      this.$iApi.component(o, Ae(Se(/* @__PURE__ */ Object.assign({ "./icons/circle-icon.vue": () => import("./circle-icon-DmOrNVbm.js"), "./icons/edit-icon.vue": () => import("./edit-icon-D2S1FFKJ.js"), "./icons/point-icon.vue": () => import("./point-icon-CGjYr5Ni.js"), "./icons/polygon-icon.vue": () => import("./polygon-icon-KTBAi_Sq.js"), "./icons/polyline-icon.vue": () => import("./polyline-icon-CFzIEU-U.js"), "./icons/rectangle-icon.vue": () => import("./rectangle-icon-DOQGZPgq.js") }), `./icons/${b.type}-icon.vue`, 3)));
    });
