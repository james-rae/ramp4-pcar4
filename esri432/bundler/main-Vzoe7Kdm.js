...
import { ref as h, computed as N, markRaw as se, defineComponent as O, inject as ve, reactive as we, watch as xt, onBeforeUnmount as dt, resolveDirective as k, withDirectives as M, openBlock as g, createElementBlock as A, withKeys as os, withModifiers as Kt, onMounted as Je, normalizeClass as oe, normalizeStyle as Ri, createVNode as re, Transition as $i, withCtx as ee, createBlock as W, resolveDynamicComponent as as, mergeProps as ns, TransitionGroup as Ci, Fragment as We, renderList as ht, unref as S, nextTick as $t, renderSlot as Me, createElementVNode as f, vShow as ls, resolveComponent as K, createTextVNode as at, toDisplayString as B, createCommentVNode as U, onUpdated as cs, Teleport as us, getCurrentInstance as ps, useTemplateRef as ui, createApp as Oi, toRaw as Se, h as ds, render as Gt, defineAsyncComponent as hs } from "vue";
...
class Os {
  ...
  graphicGeoJsonToRamp(e, t) {
    ...
    return Object.keys(e.properties.forEach((a) => s[a] = e.properties[a])), new Ae(i, "", s);
  }
  /**
...
const Rt = z("maptip", () => {
  ...
  setup(r) {
    ...
    a.push(
      xt(i, () => {
        if (i.value) {
          const c = t.geo.map.getPixelWidth() / 2, u = 0, p = t.geo.map.mapPointToScreenPoint(i.value), d = p.screenX - c, b = u - p.screenY;
          s.value.setProps({
            // Offset more for touch devices so tooltip is visible above finger
            offset: l.value ? [d, b + 25] : [d, b]
...
const Hs = ["data-cy"], ji = /* @__PURE__ */ O({
    ...
    return (n, c) => {
      ...
      return g(), A("div", {
        ...
        re($i, {
          ...
          default: ee(() => [
            M((g(), W(as(r.panel.route.screen), ns({ class: "h-full" }, r.panel.route.props, { panel: r.panel }), null, 16, ["panel"])), [
              [u]
            ])
          ]),
          _: 1
  ...
  setup(r) {
    ...
    return (c, u) => (g(), W(Ci, {
      ...
      default: ee(() => [
        (g(!0), A(We, null, ht(o(S(t).screenSize), (p) => (g(), W(ji, {
          key: `${p.id}`,
          panel: p
        }, null, 8, ["panel"]))), 128))
      ]),
...
const ir = ["content"], sr = { class: "flex items-center text-left" }, rr = { class: "select-text cursor-text" }, or = ["content"], ar = {
  ...
  setup(r) {
    ...
    return (n, c) => {
      ...
      return M((g(), A("li", {
        ...
        r.notification.messageList && s.value ? (g(), A("div", ar, [
          (g(!0), A(We, null, ht(r.notification.messageList, (p, d) => (g(), A("p", {
    ...
    return (l, n) => {
      ...
      return g(), A("div", null, [
        a.value.length > 0 ? M((g(), A("ul", {
          ...
          (g(!0), A(We, null, ht(a.value, (d, b) => (g(), A(We, {
            key: d.message + b
          }, [
            b > 0 ? (g(), A("div", cr)) : U("", !0),
            M(re(nr, {
      ...
      return g(), W(ei, {
        ...
        header: ee(() => [
          f("div", pr, [
            ...
            i.value && i.value > 0 ? (g(), A("span", hr, B(i.value), 1)) : U("", !0)
          ])
        ]),
        default: ee((c) => [
          f("div", fr, [
  ...
  setup(r) {
    ...
    return (l, n) => {
      const c = K("close"), u = K("dropdown-menu"), p = k("tippy"), d = k("focus-item");
      return M((g(), W(u, {
  ...
  __name: "map-caption",
  setup(r) {
    const e = Ue(), t = de(), { t: i } = H(), s = ve("iApi"), o = N(() => e.scale), a = N(() => e.attribution), l = N(() => e.coords), n = N(() => e.langtoggle), c = N(() => t.config.map), u = h([]), p = we([]);
    p.push(
      xt(c, (w) => {
    ...
    return (w, v) => {
      const $ = K("dropdown-menu"), T = k("truncate"), C = k("tippy");
      return g(), A("div", Or, [
        re(Cr, {
        ...
        a.value?.text.disabled ? U("", !0) : M((g(), A("span", Nr, [
        ...
        f("div", Fr, [
          l.value?.disabled ? U("", !0) : M((g(), A("div", Dr, [
          ...
          o.value?.disabled ? U("", !0) : M((g(), A("button", {
            key: 1,
            type: "button",
          ...
          n.value?.disabled ? U("", !0) : (g(), W($, {
            ...
            default: ee(() => [
              (g(!0), A(We, null, ht(u.value, (F, ce) => (g(), A("a", {
                key: `${F}-${ce}`,
                ...
                F === S(s).$i18n.locale.value ? (g(), A("span", Vr, B(S(i)("map.language.curr")), 1)) : U("", !0)
              ], 10, zr))), 128))
            ]),
            _: 1
          }, 8, ["tooltip", "ariaLabel"]))
  ...
  setup(r) {
    ...
    return (o, a) => {
      ...
      return M((g(), A("button", {
        ...
        s.value && s.value > 0 ? (g(), A("span", Wr, B(s.value), 1)) : U("", !0)
      ], 8, qr)), [
        [l]
      ]);
    };
    ...
    return (c, u) => {
      ...
      return i.value ? (g(), A("div", {
        ...
        f("div", {
          ...
          (g(!0), A(We, null, ht(s.value, (d) => (g(), A("p", {
  ...
  __name: "shell",
  setup(r) {
    const e = ve("iApi"), t = st(), i = ge(), s = Ye(), { t: o } = H(), a = N(() => i.items.appbar), l = () => {
      e?.event.emit("openKeyboardInstructions");
    }, n = () => s.teleported;
    return (c, u) => (g(), A("div", Qr, [
      f("div", Xr, [
      ...
      S(t).started ? (g(), W(qs, { key: 0 })) : (g(), A("div", to, u[1] || (u[1] = [
        f("div", { class: "spinner relative inset-x-1/2 inset-y-9/20" }, null, -1)
      ]))),
      (g(!0), A(We, null, ht(n(), (p) => (g(), W(us, {
...
const lo = /* @__PURE__ */ Ne(ro, [["render", no]]), xe = "focus-list", je = "focus-item", co = "focus-icon", uo = "focus-container", ct = `[${xe}],[${uo}]`, bt = "truncate-text", wt = "show-truncate", ot = "focused", Yt = `button,input,select,a,textarea,[contenteditable],[${xe}],[${co}],[tabIndex]`, po = {
  mounted(r, e) {
...
const xo = ["content"], So = {
  ...
  setup(r, { expose: e }) {
    ...
    return Je(() => {
      ...
      const T = K("back"), C = K("panel-options-menu"), F = K("left"), ce = K("right"), Xe = K("pin"), Pt = K("expand"), Nt = K("minimize"), Ft = K("close"), _ = k("truncate"), R = k("focus-item"), ae = k("tippy");
      return M((g(), A("div", {
        ...
        r.header ? (g(), A("header", So, [
          re(T, {
            class: oe(r.panel.teleport ? "display-none" : "block sm:display-none"),
            onClick: $[0] || ($[0] = (fe) => r.panel.close())
          }, null, 8, ["class"]),
          M((g(), A("h2", _o, [
            v.$slots.header ? Me(v.$slots, "header", { key: 0 }) : (g(), A("div", Io, B(S(t)(r.panel.alertName)), 1))
          ])), [
            [_]
          ]),
          ...
          f("div", {
            ...
            r.panel.teleport ? U("", !0) : (g(), A("div", To, [
              d.value ? (g(), W(F, {
                key: 0,
        ...
        r.content ? (g(), A("div", {
          ...
          v.$slots.content ? Me(v.$slots, "content", { key: 0 }) : w.value ? (g(), A("div", {
            key: 1,
            innerHTML: w.value.innerHTML
          }, null, 8, Lo)) : U("", !0)
        ], 512)) : U("", !0),
        r.footer ? M((g(), A("div", Ro, [
          Me(v.$slots, "footer")
        ])), [
          [R]
        ]) : U("", !0)
  ...
  setup(r) {
    ...
    return (s, o) => {
      ...
      return g(), W(a, {
        ...
        default: ee(() => [
          S(t).isFullscreen ? (g(), A("svg", sa, o[0] || (o[0] = [
            f("path", {
              d: "M0 0h24v24H0z",
              fill: "none"
            }, null, -1),
...
function Ua(r, e) {
  ...
  s.directive("focus-container", go), s.directive("focus-list", po), s.directive("focus-item", fo), s.directive("truncate", Ao), s.component("panel-screen", $o), s.component("pin", Mo), s.component("close", Fo), s.component("back", Uo), s.component("expand", qo), s.component("panel-options-menu", ia), s.component("dropdown-menu", ei), s.component("minimize", Yo), s.component("right", Ko), s.component("left", ea), s.component("fullscreen-nav-button", oa), s.component("geolocator-nav-button", aa), s.component("home-nav-button", na), s.component("mapnav-button", ua), s.component("appbar-button", fa), s.component("transition", $i), s.component("transition-group", Ci), s.config.globalProperties.$iApi = e, s.config.globalProperties.$pinia = t, s.provide("iApi", e);
  const o = s.mount(r);
  ...
  static async create(e) {
    const t = new ii(e), i = e.layers.map((a) => {
      ...
      if (a.layerType === x.MAPIMAGE)
        return P.MapImageLayer({
          url: a.url,
          opacity: a.opacity
        });
      if (a.layerType === x.OSM)
        return P.OpenStreetMapLayer({
          opacity: a.opacity
        });
    ...
    return t.esriBasemap = await P.Basemap({
      baseLayers: o,
      title: e.name || "",
      id: e.id
    }), t;
...
class Ba extends Z {
  ...
  async createMap(e, t) {
    ...
    const l = {};
    this.esriMap = se(await P.Map(l)), this.pointZoomScale = e.pointZoomScale && e.pointZoomScale > 0 ? e.pointZoomScale : 5e4, this._targetDiv = t, this.createMapView(e.initialBasemapId);
  }
  /**
    ...
    if (e ? (e.logo ? e.logo.disabled ? s.logo.disabled = !0 : (s.logo.altText = e.logo.altText || i.altText, s.logo.link = e.logo.link || i.link, s.logo.value = e.logo.value || i.value) : (s.logo.altText = i.altText, s.logo.link = i.link, s.logo.value = i.value), e.text ? e.text.disabled ? s.text.disabled = !0 : s.text.value = e.text.value || t.value : s.text.value = t.value, Ue(this.$vApp.$pinia).setAttribution(s)) : (s.logo.altText = i.altText, s.logo.link = i.link, s.logo.value = i.value, s.text.value = t.value), !e || e.text?.disabled || !e.text) {
      ...
      if (n) {
        const c = n.baseLayers.map((u) => new Promise((p) => {
          let d = 0;
          const b = a / l, m = setInterval(function() {
            u.loaded && !u.loadError ? (clearInterval(m), p(u)) : d > b && (clearInterval(m), p(null)), d++;
          }, l);
        })).toArray();
...
class ja extends Ba {
  ...
  async setBasemap(e) {
    ...
    if (o) {
      ...
      const a = await P.ColorBackground({
...
class tn extends Z {
  ...
  async geoJsonToEsriJson(e, t) {
    ...
    s || (s = I.parseGeoJsonCrs(e.crs)), a.renderer = await P.RendererFromJson(c.renderer), a.fields = (a.fields || []).concat(
    ...
    if (o.name = s.name || "", o.currentVersion = s.currentVersion || -1, o.minScale = s.effectiveMinScale || s.minScale || 0, o.maxScale = s.effectiveMaxScale || s.maxScale || 0, o.extent = s.extent ? G.fromArcServer(s.extent, "layer_extent") : void 0, o.defaultVisibility = s.defaultVisibility ?? !0, o.canModifyLayer = s.canModifyLayer ?? !0, s.type === "Feature Layer" || s.type === "Table") {
      if (o.dataFormat = X.ESRI_FEATURE, o.displayField = s.displayField || "", Array.isArray(s.fields)) {
        const a = await Promise.all(
          s.fields.map((n) => P.FieldFromJson(n))
        );
        o.fields = a.map((n) => ({
          name: n.name,
          alias: n.alias,
...
class si extends Z {
   ...
   */
  getGraphic(e, t) {
    return Promise.resolve(new Ae(new Ve()));
  }
  /**
...
class Ki extends si {
   ...
   */
  getGraphic(e, t) {
    return this.stubError(), Promise.resolve(new Ae(new Ve()));
  }
  getIcon(e) {
    return this.stubError(), Promise.resolve("");
  }
...
class ri extends Ke {
  ...
  async getGraphic(e, t) {
    ...
    const c = new Ae(s, "", t.getAttribs ? i : void 0);
    if (t.getStyle) {
...
class an extends Ke {
  ...
  async addGraphic(e) {
    ...
    const i = t.filter((n) => this._graphics.findIndex((u) => u.id === n.id) === -1 ? (this._graphics.push(n), !0) : (console.error(`Attempting to add graphic with id '${n.id}' that has already been added.`), !1)), s = this.$iApi.geo.map.getSR(), o = i.map((n) => this.$iApi.geo.proj.projectGeometry(s, n.geometry)), a = await Promise.all(o), l = i.map((n, c) => {
      const u = new Ae(a[c], n.id, n.attributes);
...
class nn extends an {
  ...
  async onInitiate() {
    this.esriLayer = se(await P.GraphicsLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
...
class Qe extends ri {
  ...
  async getGraphic(e, t) {
    ...
    if (!t.getGeom && this.attribs.attLoader.isLoaded()) {
      ...
      i = new Ae(new Ve(), "", s.features[s.oidIndex[e]]);
    } else {
      const s = {
        filterOIDs: [e],
...
class fn extends ri {
  ...
  async onInitiate() {
    se(this.esriLayer = await P.FeatureLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
  ...
  onLoadActions() {
    ...
    const a = async () => {
      ...
      if (this.esriLayer && this.origRampConfig.customRenderer?.type) {
        const c = await P.RendererFromJson(this.origRampConfig.customRenderer);
...
class mn extends Ke {
  ...
  async onInitiate() {
    this.esriLayer = se(await P.MapImageLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
  ...
  onLoadActions() {
    ...
    const o = [], a = (n, c) => {
      ...
      if (n.sublayers && n.sublayers.length > 0) {
        const d = (p ? p.name : "") || n.title || "", b = new It(u, "", d, !1);
        ...
        if (d.name = p?.name || n.title || "", o.push(d), !c.children.map((b) => b.layerIdx).includes(u)) {
          const b = new It(u, d.uid, d.name, !1);
          c.children.push(b);
        }
        d.esriWatches.push(
          _e(
    ...
    const l = o.map(async (n) => {
      ...
      if (p && (n.esriSubLayer.renderer = await P.RendererFromJson(u.customRenderer)), await n.loadLayerMetadata(p ? { customRenderer: n.esriSubLayer?.renderer } : {}), t < this.lastCancel)
        return;
...
class gn extends Ke {
  ...
  async onInitiate() {
    this.esriLayer = se(await P.OpenStreetMapLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
...
class vn extends Ke {
  ...
  async onInitiate() {
    this.esriLayer = se(await P.ImageryLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
...
class bn extends Ke {
  ...
  async onInitiate() {
    this.esriLayer = se(await P.TileLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
...
class wn extends Ke {
  ...
  async onInitiate() {
    this.esriLayer = se(await P.WMSLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
  ...
  getFeatureInfo(e, t, i) {
    ...
    }), Object.keys(v).forEach((T) => l[T] = v[T]), ze(o.url.split("?")[0], {
      query: l,
      responseType: y
    });
  }
...
class $n extends Z {
  ...
  async mapServerLegendToRenderer(e, t) {
    ...
    if (typeof i < "u") {
      ...
      const o = await P.RendererFromJson(s);
...
class Cn extends Z {
  ...
  async arcGisServerQueryIds(e) {
    ...
    const i = await P.QueryByIds(e.url, t);
  ...
  async geoJsonQuery(e) {
    ...
    return (await e.layer.esriLayer.queryFeatures(t)).features.map((s, o) => {
      let a;
      return t.returnGeometry ? a = this.$iApi.geo.geom.geomEsriToRamp(s.geometry, `queryResult${o}`) : a = new Ve(), new Ae(a, "", s.attributes);
    });
  }
  /**
...
const kn = /* @__PURE__ */ Object.assign({ "../fixtures/appbar/index.ts": () => import("./index-DQYN_wN2.js"), "../fixtures/areas-of-interest/index.ts": () => import("./index-CzkvSY5n.js"), "../fixtures/basemap/index.ts": () => import("./index-sTTAvW1z.js"), "../fixtures/crosshairs/index.ts": () => import("./index-B6FLLwYS.js"), "../fixtures/details/index.ts": () => import("./index-BQPJNoCj.js"), "../fixtures/export-footnote/index.ts": () => import("./index-CmfCXfKv.js"), "../fixtures/export-legend/index.ts": () => import("./index-DMsd3-DD.js"), "../fixtures/export-map/index.ts": () => import("./index-CoAz9W9A.js"), "../fixtures/export-northarrow/index.ts": () => import("./index-BRG4h39a.js"), "../fixtures/export-scalebar/index.ts": () => import("./index-CADseV0i.js"), "../fixtures/export-timestamp/index.ts": () => import("./index-COAn-i6_.js"), "../fixtures/export-title/index.ts": () => import("./index-Bf_YlAPK.js"), "../fixtures/export/index.ts": () => import("./index-gRAD2FPY.js"), "../fixtures/extentguard/index.ts": () => import("./index-7TOTJWGW.js"), "../fixtures/gazebo/index.ts": () => import("./index-D8J5atA0.js"), "../fixtures/geosearch/index.ts": () => import("./index-oGekcsuA.js"), "../fixtures/grid/index.ts": () => import("./index-CPZ3zdUw.js"), "../fixtures/help/index.ts": () => import("./index-YZkmd22P.js"), "../fixtures/hilight/index.ts": () => import("./index-DClmZxlu.js"), "../fixtures/layer-reorder/index.ts": () => import("./index-BySEd1EE.js"), "../fixtures/legend/index.ts": () => import("./index-B70b-xw2.js"), "../fixtures/mapnav/index.ts": () => import("./index-D83d-TGj.js"), "../fixtures/metadata/index.ts": () => import("./index-PbqIIAzU.js"), "../fixtures/northarrow/index.ts": () => import("./index-Cdwj5n9-.js"), "../fixtures/overviewmap/index.ts": () => import("./index-Cl-sfaUT.js"), "../fixtures/panguard/index.ts": () => import("./index-DoB4wjUQ.js"), "../fixtures/scrollguard/index.ts": () => import("./index-CVgVXs_l.js"), "../fixtures/settings/index.ts": () => import("./index-Iw9u8TTP.js"), "../fixtures/snowman/index.ts": () => import("./index-Bb0oeqvp.js"), "../fixtures/wizard/index.ts": () => import("./index-CQfYIGmy.js") });
class Mn extends Z {
  /**
...
const Gn = /* @__PURE__ */ Ne(Fn, [["render", Dn], ["__scopeId", "data-v-a3c61802"]]), Un = /* @__PURE__ */ Object.assign({ "../fixtures/areas-of-interest/screen.vue": () => import("./screen-DhRFNbHz.js"), "../fixtures/basemap/screen.vue": () => import("./screen-B2sLfQnR.js"), "../fixtures/export/screen.vue": () => import("./screen-Db9BRvUT.js"), "../fixtures/geosearch/screen.vue": () => import("./screen-CwKfUwbz.js"), "../fixtures/grid/screen.vue": () => import("./screen-D4WgrVVt.js"), "../fixtures/help/screen.vue": () => import("./screen-B15sQOxg.js"), "../fixtures/layer-reorder/screen.vue": () => import("./screen-D3vjZWCq.js"), "../fixtures/legend/screen.vue": () => import("./screen-CR6-f6NS.js"), "../fixtures/metadata/screen.vue": () => import("./screen-BEX-WzpG.js"), "../fixtures/settings/screen.vue": () => import("./screen-BOdfGHhJ.js"), "../fixtures/wizard/screen.vue": () => import("./screen-Bhw62ker.js") });
class Et extends Z {
  /**
   * ID of this panel.
   *
...
var rt = { major: "4", minor: "12", patch: "0-beta", timestamp: "Tue Mar 25 10:58:59 2025 -0400", hash: "cdb027e0755da43f7622443112fdcffbefde7118" };
console.info(
