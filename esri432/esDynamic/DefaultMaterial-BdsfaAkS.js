import{H as He,o as B,s as Vt,A as Ht,c as we,r as Wt,g as We,P as Ut,N as Yt}from"./vec32-BSC_c7dB.js";import{eU as Me,gl as ye,gn as X,aI as N,x as s,z as Se,K as qt,d4 as oe,aM as Jt,fp as Zt,aP as kt,cg as Xt,cB as $t}from"./main-CNnokiYz.js";import{l as Ue}from"./ViewingMode-CyR_b1T8.js";import{H as Kt}from"./InterleavedLayout-JXtqIzCP.js";import{n as g,u as $,t as Ye,o as Ce,r as Qt}from"./ShaderOutput-C_OqLoo1.js";import{n as E,a as b,t as re}from"./NormalAttribute.glsl-DaSRz9zk.js";import{a7 as ea,a8 as A,a9 as ta,aa,ab as oa,ac as ra,ad as ie,p as ia,ae as na,af as sa,e as L,B as F,a as V,ag as H,ah as W,u as K,C as O,ai as U,D as la,v as ca,aj as da,K as P,ak as ua,al as qe,y as Je,am as Ze,an as ke,ao as ma,F as Oe,G as ne,ap as Xe,aq as ha,g as se,ar as pa,as as va,at as Ne,au as le,k as $e,o as z,av as m,aw as ze,ax as fa,ay as Ee,az as ce,j as ga,aA as xa,q as Ke,aB as ba,x as Ta,aC as Qe,aD as et,c as de,aE as tt,aF as at,z as ot,r as rt,aG as it,aH as ue,aI as nt,Y as wa,E as st,aJ as Ma,aK as ya,aL as Sa,H as Ca,aM as Oa,aN as Na,aO as za,aP as Ea,I as d,L as D,J as _a,M as Ia,O as _e,aQ as Ga,U as Aa,aR as La,d as Ra,aS as Fa,V as Pa,Z as Da}from"./Geometry-CmKWNNS_.js";import{n as r,t as f}from"./glsl-o28TenZV.js";import{i as _,a as lt,e as Q,n as me}from"./basicInterfaces-Dsf65ICa.js";import{e as T}from"./VertexAttribute-DFC3a3eR.js";import{n as ct,r as ja}from"./vec4f64-CjUMzAyX.js";import{e as Ie,o as Y}from"./mat3f64-Dh9_zhFu.js";import{j as Ba}from"./mat3-DOnW3DjW.js";import{o as dt}from"./mat4f64-BaJwL7tQ.js";import{o as Va,r as Ha}from"./doublePrecisionUtils-BJbYwoii.js";import{a as Ge}from"./BindType-CKbZk6AG.js";import{s as Wa,n as ut}from"./vec2f64-CEUyUoff.js";import{o as he}from"./vec2-BnynUbeJ.js";import{i as pe}from"./ShaderBuilder-DRAW5e-I.js";import{B as Ae,g as Le,f as Ua}from"./renderState-eEtyJpmy.js";import{D as mt,G as Ya,t as qa,_ as Ja,f as Za,O as ht}from"./enums-DBi1-Mm2.js";import{p as ka,w as Xa}from"./Texture-DP5iTU99.js";import{s as I}from"./vec42-D8CJyqHG.js";function $a(e){e.vertex.code.add(r`
...
}`);break;case b.ScreenDerivative:e.vertex.code.add(r`void forwardNormal() {}`);break;default:Me(t.normalType);case b.COUNT:}}let Ka=class extends aa{constructor(){super(...arguments),this.transformNormalViewFromGlobal=Ie()}},vt=class extends ta{constructor(){super(...arguments),this.transformNormalGlobalFromModel=Ie(),this.toMapSpace=ct()}};function Qa({normalTexture:e,metallicRoughnessTexture:t,metallicFactor:a,roughnessFactor:o,emissiveTexture:i,emissiveFactor:n,occlusionTexture:c}){return e==null&&t==null&&i==null&&(n==null||He(n,ye))&&c==null&&(o==null||o===1)&&(a==null||a===1)}const ft=X(1,1,.5),eo=X(0,.6,.2),to=X(0,1,.2);function gt(e){e.vertex.code.add(r`vec4 offsetBackfacingClipPosition(vec4 posClip, vec3 posWorld, vec3 normalWorld, vec3 camPosWorld) {
...
return posClip;
}`)}const xt=Ie();function bt(e,t){const a=t.hasModelTransformation,o=t.instancedDoublePrecision;a&&(e.vertex.uniforms.add(new oa("model",n=>n.modelTransformation??dt)),e.vertex.uniforms.add(new A("normalLocalOriginFromModel",n=>(Ba(xt,n.modelTransformation??dt),xt)))),t.instanced&&o&&(e.attributes.add(T.INSTANCEMODELORIGINHI,"vec3"),e.attributes.add(T.INSTANCEMODELORIGINLO,"vec3"),e.attributes.add(T.INSTANCEMODEL,"mat3"),e.attributes.add(T.INSTANCEMODELNORMAL,"mat3"));const i=e.vertex;o&&(i.include(ra,t),i.uniforms.add(new ie("viewOriginHi",n=>Va(B(ve,n.camera.viewInverseTransposeMatrix[3],n.camera.viewInverseTransposeMatrix[7],n.camera.viewInverseTransposeMatrix[11]),ve)),new ie("viewOriginLo",n=>Ha(B(ve,n.camera.viewInverseTransposeMatrix[3],n.camera.viewInverseTransposeMatrix[7],n.camera.viewInverseTransposeMatrix[11]),ve)))),i.code.add(r`
    ...
    }`)}const ve=N();function Tt(e,t){t.hasSymbolColors?(e.include($a),e.attributes.add(T.SYMBOLCOLOR,"vec4"),e.varyings.add("colorMixMode","mediump float"),e.vertex.code.add(r`int symbolColorMixMode;
vec4 getSymbolColor() {
...
}`)}}function q(e,t){ao(e,t,new L("textureAlphaCutoff",a=>a.textureAlphaCutoff))}function ao(e,t,a){const o=e.fragment,i=t.alphaDiscardMode,n=i===_.Blend;i!==_.Mask&&i!==_.MaskBlend||o.uniforms.add(a),o.code.add(r`
    void discardOrAdjustAlpha(inout vec4 color) {
      ${i===_.Opaque?"color.a = 1.0;":`if (color.a < ${n?r.float(F):"textureAlphaCutoff"}) {
              discard;
             } ${f(i===_.Mask,"else { color.a = 1.0; }")}`}
    }
  `)}function yt(e,t){const{vertex:a,fragment:o}=e,i=t.hasColorTexture&&t.alphaDiscardMode!==_.Opaque,{output:n,normalType:c,hasColorTextureTransform:h}=t;switch(n){case g.Depth:V(a,t),e.include(H,t),e.fragment.include(U,t),e.include(W,t),i&&o.uniforms.add(new O("tex",u=>u.texture)),a.main.add(r`vpos = getVertexInLocalOriginSpace();
...
forwardObjectAndLayerIdColor();`),e.include(q,t),o.main.add(r`
        ...
        ${n===g.ObjectAndLayerIdColor?r`outputObjectAndLayerIdColor();`:r`outputDepth(depth);`}`);break;case g.Normal:{V(a,t),e.include(H,t),e.include(re,t),e.include(pt,t),e.include(W,t),e.include(K,t),i&&o.uniforms.add(new O("tex",v=>v.texture)),c===b.ScreenDerivative&&e.varyings.add("vPositionView","vec3");const u=c===b.Attribute||c===b.Compressed;a.main.add(r`
...
forwardTextureCoordinates();`),e.fragment.include(U,t),e.include(q,t),e.include(la,t),o.main.add(r`
        ...
        ${f(i,r`vec4 texColor = texture(tex, ${h?"colorUV":"vuv0"});
                discardOrAdjustAlpha(texColor);`)}
        calculateOcclusionAndOutputHighlight();`)}}function St(e,t){const a=e.fragment;switch(a.code.add(r`struct ShadingNormalParameters {
vec3 normalView;
vec3 viewDirection;
...
}`);break;default:Me(t.doubleSidedMode);case y.COUNT:}}var y;(function(e){e[e.None=0]="None",e[e.View=1]="View",e[e.WindingOrder=2]="WindingOrder",e[e.COUNT=3]="COUNT"})(y||(y={}));function oo(e,t){const a=e.fragment;t.hasVertexTangents?(e.attributes.add(T.TANGENT,"vec4"),e.varyings.add("vTangent","vec4"),t.doubleSidedMode===y.WindingOrder?a.code.add(r`mat3 computeTangentSpace(vec3 normal) {
...
}`),t.textureCoordinateType!==P.None&&(e.include(ua,t),a.uniforms.add(t.bindType===Ge.Pass?new O("normalTexture",o=>o.textureNormal):new qe("normalTexture",o=>o.textureNormal)),t.hasNormalTextureTransform&&(a.uniforms.add(new Je("scale",o=>o.scale??Wa)),a.uniforms.add(new A("normalTextureTransformMatrix",o=>o.normalTextureTransformMatrix??Y))),a.code.add(r`vec3 computeTextureNormal(mat3 tangentSpace, vec2 uv) {
...
rawNormal.xy = (normalTextureRotation * vec3(rawNormal.x, rawNormal.y, 1.0)).xy;`),a.code.add(r`return tangentSpace * rawNormal;
}`))}const Ct=3e5,Re=5e5,Fe=4;function Ot(){const e=new pe,t=e.fragment;e.include(Ze);const a=(Fe+1)/2,o=1/(2*a*a);return t.include(ke),t.uniforms.add(new O("depthMap",i=>i.depthTexture),new qe("tex",i=>i.colorTexture),new ma("blurSize",i=>i.blurSize),new L("projScale",(i,n)=>{const c=n.camera.distance;return c>5e4?Math.max(0,i.projScale-(c-5e4)):i.projScale})),t.code.add(r`
  ...
  `),e.outputs.add("fragBlur","float"),t.main.add(r`
    ...
    fragBlur = b / w_total;`),e}const ro=Object.freeze(Object.defineProperty({__proto__:null,build:Ot},Symbol.toStringTag,{value:"Module"}));let Nt=class extends Oe{constructor(e,t){super(e,t,new ne(ro,()=>import("./HUDMaterial.glsl-BgQkT2Am.js").then(a=>a.S)))}initializePipeline(){return Ae({colorWrite:Le})}};const io="";let no=class extends Xe{constructor(){super(...arguments),this.projScale=1}},so=class extends no{constructor(){super(...arguments),this.intensity=1}},lo=class extends Xe{};class co extends lo{constructor(){super(...arguments),this.blurSize=ut()}}const zt=16;function Et(){const e=new pe,t=e.fragment;return e.include(Ze),e.include(ha),t.include(ke),t.uniforms.add(new se("radius",a=>fe(a.camera))).code.add(r`vec3 sphere[16] = vec3[16](
...
return fallOffFunction(vv, vn, 0.1);
      ...
      fragOcclusion = A;`),e}function fe(e){return Math.max(10,20*e.computeScreenPixelSizeAtDist(Math.abs(4*e.relativeElevation)))}const _t=ut(),uo=Object.freeze(Object.defineProperty({__proto__:null,build:Et,getRadius:fe},Symbol.toStringTag,{value:"Module"}));let It=class extends Oe{constructor(e,t){super(e,t,new ne(uo,()=>import("./HUDMaterial.glsl-BgQkT2Am.js").then(a=>a.c)))}initializePipeline(){return Ae({colorWrite:Le})}};const ee=2;let te=class extends va{constructor(e){super(e),this.consumes={required:["normals"]},this.produces=Ne.SSAO,this.isEnabled=()=>!1,this._enableTime=oe(0),this._passParameters=new so,this._drawParameters=new co}initialize(){const e=Uint8Array.from(atob(io),a=>a.charCodeAt(0)),t=new ka;t.wrapMode=mt.CLAMP_TO_EDGE,t.pixelFormat=Ya.RGB,t.wrapMode=mt.REPEAT,t.hasMipmap=!0,t.width=32,t.height=32,this._passParameters.noiseTexture=new Xa(this.renderingContext,t,e),this.techniques.precompile(It),this.techniques.precompile(Nt),this.addHandles(Jt(()=>this.isEnabled(),()=>this._enableTime=oe(0)))}destroy(){this._passParameters.noiseTexture=Zt(this._passParameters.noiseTexture)}render(e){const t=this.bindParameters,a=e.find(({name:S})=>S==="normals"),o=a?.getTexture(),i=a?.getTexture(qa),n=this.fboCache,c=t.camera,h=c.fullViewport[2],u=c.fullViewport[3],v=Math.round(h/ee),x=Math.round(u/ee),C=this.techniques.get(It),w=this.techniques.get(Nt);if(!C.compiled||!w.compiled)return this._enableTime=oe(performance.now()),this.requestRender(lt.UPDATE),n.acquire(v,x,Ne.SSAO,le.RED);this._enableTime===0&&(this._enableTime=oe(performance.now()));const p=this.renderingContext,R=this.view.qualitySettings.fadeDuration,M=c.relativeElevation,ae=kt((Re-M)/(Re-Ct),0,1),J=R>0?Math.min(R,performance.now()-this._enableTime)/R:1,Te=J*ae;this._passParameters.normalTexture=o,this._passParameters.depthTexture=i,this._passParameters.projScale=1/c.computeScreenPixelSizeAtDist(1),this._passParameters.intensity=4*mo/fe(c)**6*Te;const Z=n.acquire(h,u,"ssao input",le.RG);p.bindFramebuffer(Z.fbo),p.setViewport(0,0,h,u),p.bindTechnique(C,t,this._passParameters,this._drawParameters),p.screen.draw();const k=n.acquire(v,x,"ssao blur",le.RED);p.bindFramebuffer(k.fbo),this._drawParameters.colorTexture=Z.getTexture(),he(this._drawParameters.blurSize,0,ee/u),p.bindTechnique(w,t,this._passParameters,this._drawParameters),p.setViewport(0,0,v,x),p.screen.draw(),Z.release();const j=n.acquire(v,x,Ne.SSAO,le.RED);return p.bindFramebuffer(j.fbo),p.setViewport(0,0,h,u),p.setClearColor(1,1,1,0),p.clear(Ja.COLOR),this._drawParameters.colorTexture=k.getTexture(),he(this._drawParameters.blurSize,ee/h,0),p.bindTechnique(w,t,this._passParameters,this._drawParameters),p.setViewport(0,0,v,x),p.screen.draw(),p.setViewport4fv(c.fullViewport),k.release(),J<1&&this.requestRender(lt.UPDATE),j}};s([Se()],te.prototype,"consumes",void 0),s([Se()],te.prototype,"produces",void 0),s([Se({constructOnly:!0})],te.prototype,"isEnabled",void 0),te=s([qt("esri.views.3d.webgl-engine.effects.ssao.SSAO")],te);const mo=.5;function ge(e,t){const a=e.fragment;t.receiveAmbientOcclusion?(a.uniforms.add(new $e("ssaoTex",o=>o.ssao?.getTexture())),a.constants.add("blurSizePixelsInverse","float",1/ee),a.code.add(r`float evaluateAmbientOcclusionInverse() {
...
}`))}const At=N(),G=ct();function ho(e){const t=e.fragment.code;t.add(r`vec3 evaluateDiffuseIlluminationHemisphere(vec3 ambientGround, vec3 ambientSky, float NdotNG)
{
...
}`)}function Pe(e,t){const a=e.fragment.code;e.include(ze),t.pbrMode!==m.Normal&&t.pbrMode!==m.Schematic&&t.pbrMode!==m.Simplified&&t.pbrMode!==m.TerrainWithWater||(a.add(r`float normalDistribution(float NdotH, float roughness)
{
...
return c2 * a004 + r.zw;
}`)),t.pbrMode!==m.Normal&&t.pbrMode!==m.Schematic||(e.include(ho),a.add(r`struct PBRShadingInfo
{
float NdotV;
float LdotH;
float NdotNG;
...
return outColor;
}`))}function po(e,t){const a=e.fragment.code;e.include(ze),a.add(r`
...
}`)}function xe(e){e.constants.add("ambientBoostFactor","float",fa)}function be(e){e.uniforms.add(new se("lightingGlobalFactor",t=>t.lighting.globalFactor))}function De(e,t){const a=e.fragment;switch(e.include(ge,t),t.pbrMode!==m.Disabled&&e.include(Pe,t),e.include(Gt,t),e.include(ze),a.code.add(r`
...
return outColor;
}`);break;default:Me(t.pbrMode);case m.COUNT:}}let vo=class extends Ke{constructor(e,t,a){super(e,"mat4",Ge.Draw,(o,i,n,c)=>o.setUniformMatrix4fv(e,t(i,n,c)),a)}};class fo extends Ke{constructor(t,a,o){super(t,"mat4",Ge.Pass,(i,n,c)=>i.setUniformMatrix4fv(t,a(n,c)),o)}}function Lt(e,t){t.receiveShadows&&(e.fragment.uniforms.add(new fo("shadowMapMatrix",(a,o)=>o.shadowMap.getShadowMapMatrices(a.origin),4)),Rt(e))}function je(e,t){t.receiveShadows&&(e.fragment.uniforms.add(new vo("shadowMapMatrix",(a,o)=>o.shadowMap.getShadowMapMatrices(a.origin),4)),Rt(e))}function Rt(e){const t=e.fragment;t.include(wt),t.uniforms.add(new $e("shadowMap",a=>a.shadowMap.depthTexture),new ba("numCascades",a=>a.shadowMap.numCascades),new z("cascadeDistances",a=>a.shadowMap.cascadeDistances)).code.add(r`int chooseCascade(float depth, out mat4 mat) {
...
metallicRoughnessUV = (metallicRoughnessTextureTransformMatrix * vec3(vuv0, 1.0)).xy;
  ...
  `)}function Pt(e){const t=new pe,{vertex:a,fragment:o,varyings:i}=t,{output:n,normalType:c,offsetBackfaces:h,instancedColor:u,spherical:v,receiveShadows:x,snowCover:C,pbrMode:w,textureAlphaPremultiplied:p,instancedDoublePrecision:R,hasVertexColors:M,hasVertexTangents:ae,hasColorTexture:J,hasNormalTexture:Te,hasNormalTextureTransform:Z,hasColorTextureTransform:k}=e;if(V(a,e),t.include(Qe),i.add("vpos","vec3"),t.include(K,e),t.include(bt,e),t.include(et,e),t.include(go,e),!$(n))return t.include(yt,e),t;t.include(xo,e),t.include(bo,e),t.include(To,e),t.include(wo,e),de(a,e),t.include(re,e),t.include(H,e);const j=c===b.Attribute||c===b.Compressed;return j&&h&&t.include(gt),t.include(oo,e),t.include(pt,e),u&&t.attributes.add(T.INSTANCECOLOR,"vec4"),i.add("vPositionLocal","vec3"),t.include(W,e),t.include(tt,e),t.include(Tt,e),t.include(at,e),a.uniforms.add(new ot("externalColor",S=>S.externalColor)),i.add("vcolorExt","vec4"),t.include(rt,e),a.main.add(r`
  ...
  `),t.include(De,e),t.include(ge,e),t.include(q,e),t.include(R?Lt:je,e),t.fragment.include(U,e),t.include(it,e),de(o,e),o.uniforms.add(a.uniforms.get("localOrigin"),new ue("ambient",S=>S.ambient),new ue("diffuse",S=>S.diffuse),new L("opacity",S=>S.opacity),new L("layerOpacity",S=>S.layerOpacity)),J&&o.uniforms.add(new O("tex",S=>S.texture)),t.include(nt,e),t.include(Pe,e),o.include(Ft),t.include(St,e),xe(o),be(o),ce(o),o.main.add(r`
    discardBySlice(vpos);
