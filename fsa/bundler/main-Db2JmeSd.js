...
class Fs {
  ...
  async projectExtent(e, t) {
    ...
    const a = new se("warpy", [o], t.sr, !0), l = await this.projectGeometry(e, a), n = l.toArray().pop() || [], c = n.map((y) => y[0]), u = n.map((y) => y[1]), p = Math.min.apply(null, c), d = Math.max.apply(null, c), g = Math.min.apply(null, u), h = Math.max.apply(null, u);
      ...
      return P((v(), w("li", {
        ...
        m("div", or, [
          m("span", null, [
            ...
            m("span", ar, B(r.notification.message), 1)
          ]),
    ...
    return (o, a) => {
      ...
      return v(), W(ii, {
        ...
        default: te((c) => [
          m("div", yr, [
            m("div", null, [
              m("h4", gr, B(S(t)("notifications.title")), 1),
              m("div", vr, [
                P((v(), w("button", {
                  type: "button",
                  onClick: s,
        ...
        default: te((g) => [
          m("div", Sr, [
            m("div", null, [
              ...
              m("div", Lr, [
                m("div", null, [
                  m("span", Rr, B(s.value), 1),
                  m("span", $r, " [" + B(o.value) + "] ", 1)
                ]),
                m("div", null, [
                  m("span", Cr, B(a.value), 1)
                ]),
      ...
      return v(), w("div", Mr, [
        ...
        m("div", Gr, [
          ...
          n.value?.disabled ? U("", !0) : (v(), W($, {
            ...
            header: te(() => [
              m("span", Vr, B(S(i)("map.language.short")), 1)
            ]),
            default: te(() => [
    ...
    return (c, u) => {
      ...
      return i.value ? (v(), w("div", {
        ...
        m("div", {
          ...
          m("div", Kr, [
            m("h2", Qr, B(S(t)("keyboardInstructions.title")), 1),
            re(p, {
              class: "ml-auto",
...
const Io = ["content"], _o = {
  ...
  setup(r, { expose: e }) {
    ...
    e({ el: a });
    const c = r, u = N(() => o?.fixture.get("appbar") ? s.temporary : []), p = N(() => i.mobileView), d = N(() => i.reorderable), g = (b) => b.scrollHeight > b.clientHeight, h = () => !p.value && !c.panel.teleport, y = (b) => {
...
const Ai = "https://geogratis.gc.ca/services/geolocation/@{language}/locate", wi = "https://geogratis.gc.ca/services/geoname/@{language}/geonames.json", Ei = "https://geogratis.gc.ca/services/geoname/@{language}/codes/province.json", xi = "https://geogratis.gc.ca/services/geoname/@{language}/codes/concise.json", $a = {
  10: "NL",
  11: "PE",
  12: "NS",
  13: "NB",
...
class Si {
  ...
  constructor(e, t) {
    ...
    const n = t?.settings;
    let c, u, p, d, g;
    n ? (c = n.categories ? n.categories : [], u = n.sortOrder ? n.sortOrder : [], p = n.disabledSearchTypes ? n.disabledSearchTypes : [], d = n.maxResults > 0 ? n.maxResults : 100, g = !!n.officialOnly) : (c = [], u = [], p = [], d = 100, g = !1), this.config = {
      language: e,
      geoNameUrl: s,
      geoLocateUrl: i,
      types: Sa(e, a),
...
var ka = /* @__PURE__ */ ((r) => (r.Title = "title", r.Text = "text", r.Image = "image", r.Markdown = "markdown", r.Template = "template", r))(ka || {});
class _i extends Qi {
  _infoType;
...
class Ba {
  ...
  constructor(e, t, i) {
    ...
    const s = za(e, this);
    this.$vApp = s.app, this.$element = s.element, this.$i18n = s.i18n, this.$rootEl = s.app.$root?.$el, this.fixture = new Fn(this), this.panel = new Dn(this), this.geo = new Pn(this), this.dev = new jn(this), this.ui = {
...
class Wa extends Va {
   ...
   */
  constructor(e) {
    super(e, "main"), this.maptip = new ja(e), this.caption = new qa(e), this.mapMouseThrottle = 0;
  }
  async createMap(e, t) {
...
const Ha = { geometryType: "point", renderer: { type: "simple", symbol: { type: "esriSMS", style: "esriSMSCircle", color: [67, 100, 255, 200], size: 7, outline: { color: [0, 0, 0, 255], width: 1 } } } }, Ya = { geometryType: "polyline", renderer: { type: "simple", symbol: { type: "esriSLS", style: "esriSLSSolid", color: [90, 90, 90, 200], width: 2 } } }, Ja = { geometryType: "polygon", renderer: { type: "simple", symbol: { type: "esriSFS", style: "esriSFSSolid", color: [76, 76, 125, 200], outline: { type: "esriSLS", style: "esriSLSSolid", color: [110, 110, 110, 255], width: 1 } } } }, Za = { geometryType: "polygon", renderer: { type: "simple", symbol: { type: "esriSFS", style: "esriSFSSolid", color: [255, 0, 0, 64], outline: { type: "esriSLS", style: "esriSLSSolid", color: [240, 128, 128, 255], width: 1 } } } }, Ka = {
  circlePoint: Ha,
  solidLine: Ya,
  outlinedPoly: Ja,
  boundingBoxPoly: Za
...
class rn extends J {
  ...
  async geoJsonToEsriJson(e, t) {
    ...
    Xa(e);
    const l = e.features[0].geometry.type, n = Qa[l], c = JSON.parse(
      // @ts-expect-error TODO: explain why this is needed or remove
      JSON.stringify(Ka[n])
    );
    if (t) {
...
class nn extends J {
  ...
  ogc;
  constructor(e) {
    super(e), this.files = new rn(e), this.ogc = new an(e);
  }
  /**
...
class Qe extends ai {
  ...
  extractLayerMetadata() {
    ...
    this.attribs.attLoader = new Ln(this.$iApi, i);
  }
  async getGraphic(e, t) {
    let i;
  ...
  onLoadActions() {
    ...
    const o = [], a = (n, c) => {
      ...
      if (n.sublayers && n.sublayers.length > 0) {
        ...
        this._sublayers[u] || (this._sublayers[u] = new vn(
          {
...
class En extends Ke {
  ...
  getFeatureInfo(e, t, i) {
    ...
    let a, l;
    const n = s.getExtent(), c = o.spatialReferences, u = e.join(","), p = s.esriView.toScreen(t.toESRI()), d = Math.floor(p.x), g = Math.floor(p.y), y = {
...
class es extends Xi {
  ...
  async onInitiate() {
    if (this.sourceJson) {
      ...
      this.attribs.attLoader = new Rn(this.$iApi, o), await this.attribs.attLoader.getAttribs(), this.featureCount = e.data.length;
...
class kn extends J {
  ...
  async symbolToSvg(e) {
    ...
    const o = tt(s).size(this.CONTAINER_SIZE, this.CONTAINER_SIZE).viewbox(0, 0, this.CONTAINER_SIZE, this.CONTAINER_SIZE), a = {
      ...
      none: () => "transparent",
      // esriSFSNull
      horizontal: (h, y) => o.pattern(5, 5, (b) => b.line(0, 5 / 2, 5, 5 / 2)).stroke(y),
      vertical: (h, y) => o.pattern(5, 5, (b) => b.line(5 / 2, 0, 5 / 2, 5)).stroke(y),
      "forward-diagonal": (h, y) => o.pattern(5, 5, (b) => {
        b.line(0, 0, 5, 5).stroke(y), b.line(0, 0, 5, 5).move(0, 5).stroke(y), b.line(0, 0, 5, 5).move(5, 0).stroke(y);
      }),
      "backward-diagonal": (h, y) => o.pattern(5, 5, (b) => {
        b.line(5, 0, 0, 5).stroke(y), b.line(5, 0, 0, 5).move(5 / 2, 5 / 2).stroke(y), b.line(5, 0, 0, 5).move(-5 / 2, -5 / 2).stroke(y);
      }),
      cross: (h, y) => o.pattern(5, 5, (b) => {
        b.line(5 / 2, 0, 5 / 2, 5).stroke(y), b.line(0, 5 / 2, 5, 5 / 2).stroke(y);
      }),
      "diagonal-cross": (h, y) => o.pattern(7, 7, (b) => {
...
class Pn extends J {
   ...
   */
  constructor(e) {
    super(e), this.geom = ut.geom, this.proj = ut.proj, this.shared = ut.sharedUtils, this.map = new Wa(e), this.layer = new nn(e), this.attributes = new Tn(e), this.query = new Mn(e), this.symbology = new kn(e), Array.isArray(ft.request.interceptors) || (ft.request.interceptors = []), ft.request.interceptors.push({
      before: (t) => {
...
const Nn = /* @__PURE__ */ Object.assign({ "../fixtures/appbar/index.ts": () => import("./index-BnaGjtjS.js"), "../fixtures/areas-of-interest/index.ts": () => import("./index-DFTWEl79.js"), "../fixtures/basemap/index.ts": () => import("./index-CcfJ2ugA.js"), "../fixtures/crosshairs/index.ts": () => import("./index-GBKKG3va.js"), "../fixtures/details/index.ts": () => import("./index-CNbWdooN.js"), "../fixtures/export-footnote/index.ts": () => import("./index-Dw2Nj3hR.js"), "../fixtures/export-legend/index.ts": () => import("./index-Bu3ewYEx.js"), "../fixtures/export-map/index.ts": () => import("./index-BZb0CoGU.js"), "../fixtures/export-northarrow/index.ts": () => import("./index-BUauWqkW.js"), "../fixtures/export-scalebar/index.ts": () => import("./index-B2WNvHLl.js"), "../fixtures/export-timestamp/index.ts": () => import("./index-qcXgfN8k.js"), "../fixtures/export-title/index.ts": () => import("./index-BkRFjcOD.js"), "../fixtures/export/index.ts": () => import("./index-NvotkFva.js"), "../fixtures/extentguard/index.ts": () => import("./index-CqYB1zCh.js"), "../fixtures/gazebo/index.ts": () => import("./index-CWeroXu8.js"), "../fixtures/geosearch/index.ts": () => import("./index-BVB_nMxE.js"), "../fixtures/grid/index.ts": () => import("./index-DurHB7Uc.js"), "../fixtures/help/index.ts": () => import("./index-CNt2mH7g.js"), "../fixtures/hilight/index.ts": () => import("./index-DDcXmSTI.js"), "../fixtures/layer-reorder/index.ts": () => import("./index-EZYyjN80.js"), "../fixtures/legend/index.ts": () => import("./index-DGvksvgv.js"), "../fixtures/mapnav/index.ts": () => import("./index-DqqyzPZZ.js"), "../fixtures/metadata/index.ts": () => import("./index-De5aNfQR.js"), "../fixtures/northarrow/index.ts": () => import("./index-Br_r-cFH.js"), "../fixtures/overviewmap/index.ts": () => import("./index-BooMA85v.js"), "../fixtures/panguard/index.ts": () => import("./index-BFGgoPqw.js"), "../fixtures/scrollguard/index.ts": () => import("./index-CL1KAJNO.js"), "../fixtures/settings/index.ts": () => import("./index-ALKlgeHj.js"), "../fixtures/snowman/index.ts": () => import("./index-DmcrrsJA.js"), "../fixtures/wizard/index.ts": () => import("./index-D08qUXb3.js") });
class Fn extends J {
  /**
  ...
  async add(e, t) {
    ...
    if (t) {
      ...
      const s = (await Nn[`../fixtures/${e}/index.ts`]()).default;
      i = new s(e, this.$iApi);
    }
...
const zn = /* @__PURE__ */ Ne(Un, [["render", Bn], ["__scopeId", "data-v-a3c61802"]]), Vn = /* @__PURE__ */ Object.assign({ "../fixtures/areas-of-interest/screen.vue": () => import("./screen-A2gyBses.js"), "../fixtures/basemap/screen.vue": () => import("./screen-D-46u1_X.js"), "../fixtures/export/screen.vue": () => import("./screen-BWgAubiR.js"), "../fixtures/geosearch/screen.vue": () => import("./screen-WuxDCMon.js"), "../fixtures/grid/screen.vue": () => import("./screen-wdPIfEcb.js"), "../fixtures/help/screen.vue": () => import("./screen-D8122ZC2.js"), "../fixtures/layer-reorder/screen.vue": () => import("./screen-DGW30Dzz.js"), "../fixtures/legend/screen.vue": () => import("./screen-3u_WlYxS.js"), "../fixtures/metadata/screen.vue": () => import("./screen-DOgcNt2P.js"), "../fixtures/settings/screen.vue": () => import("./screen-BAzCF6Po.js"), "../fixtures/wizard/screen.vue": () => import("./screen-B65HVHJY.js") });
class Et extends J {
  /**
   * ID of this panel.
   *
  ...
  registerScreen(e) {
    ...
    if (Us(t) || Gs(t))
      ...
      let s;
      typeof t == "string" ? s = Vn[`../fixtures/${t}`]() : s = t();
...
function Wn(r) {
  ...
  return Yn(r.services, e), Hn(r.map, e), Jn(r.ui, e), r.plugins && Zn(r.plugins, e), e;
}
function Hn(r, e) {
...
function Wt(r) {
  ...
  )), typeof r.stateOnly < "u" && (e.cosmetic = r.stateOnly), r.initialFilteredQuery && (e.initialFilteredQuery = r.initialFilteredQuery), Kn(r, e), (typeof r.toggleSymbology < "u" || r.table) && (e.fixtures = {}, typeof r.toggleSymbology < "u" && (e.fixtures.legend = {
...
var rt = { major: "4", minor: "12", patch: "0-beta", timestamp: "Wed May 14 11:40:17 2025 -0400", hash: "0efa11552bb5afeb0bfbb81b1c737dfb1ee88cf4" };
console.info(
...
const Fl = (r, e, t) => new Ba(r, e, t), ut = new Ds();
export {
  j as $,
  kr as A,
  yt as B,
