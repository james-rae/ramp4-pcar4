...
import { ref as f, computed as N, markRaw as Q, defineComponent as O, inject as ve, reactive as we, watch as It, onBeforeUnmount as dt, resolveDirective as M, withDirectives as P, openBlock as v, createElementBlock as w, withKeys as cs, withModifiers as Zt, onMounted as Je, normalizeClass as ae, normalizeStyle as Oi, createVNode as re, Transition as ki, withCtx as te, createBlock as W, resolveDynamicComponent as us, mergeProps as ps, TransitionGroup as Mi, Fragment as He, renderList as ht, unref as S, nextTick as Ot, renderSlot as Pe, createElementVNode as y, vShow as ds, resolveComponent as Z, createTextVNode as ot, toDisplayString as U, createCommentVNode as G, onUpdated as hs, Teleport as fs, getCurrentInstance as ms, useTemplateRef as hi, createApp as Pi, toRaw as _e, h as ys, render as Ut, defineAsyncComponent as gs } from "vue";
...
class Ns {
  ...
  graphicGeoJsonToRamp(e, t) {
    ...
    return Object.keys(e.properties.forEach((o) => r[o] = e.properties[o])), new xe(i, "", r);
  }
  /**
...
class Gs {
  ...
  async projectGeoJson(e, t, i) {
    let r, a;
    if (t ? r = this.normalizeProj(t) : r = _.parseGeoJsonCrs(e.crs), i ? a = this.normalizeProj(i) : a = Ds, a === r)
      return e;
  ...
  async projectExtent(e, t) {
    ...
    let a = [];
    [0, 1, 2, 3].map((m) => i(r[m], r[m + 1], 3).slice(1)).forEach((m) => a = a.concat(m));
    const o = new se("warpy", [a], t.sr, !0), l = await this.projectGeometry(e, o), n = l.toArray().pop() || [], c = n.map((m) => m[0]), u = n.map((m) => m[1]), p = Math.min.apply(null, c), d = Math.max.apply(null, c), g = Math.min.apply(null, u), h = Math.max.apply(null, u);
      ...
      case "ramp_layer_remove_checks_grid":
        t = (i) => {
          if (this.$iApi.fixture.get("grid")) {
            const r = Wt(this.$vApp.$pinia), a = r.getGridId(i.id);
            if (a === void 0) return;
...
const Ct = B("maptip", () => {
  ...
  __name: "esri-map",
  setup(s) {
    const e = Ct(), t = ve("iApi"), i = N(() => e.maptipPoint), r = N(() => e.maptipInstance), a = N(() => e.content), o = we([]), l = f(!1);
    o.push(
      It(i, () => {
        if (i.value) {
  ...
  constructor(e) {
    this.resizeObserver = new ResizeObserver((t) => {
      t.length && window.requestAnimationFrame(() => {
        t.forEach((i) => {
          const r = i.target.dataset.breakpoints, a = r ? JSON.parse(r) : e ?? Ks;
...
const Zs = ["data-cy"], Hi = /* @__PURE__ */ O({
  ...
  setup(s) {
    ...
    return (n, c) => {
      ...
      return v(), w("div", {
        class: ae(["shadow-tm bg-white h-full xs:mr-0 sm:mr-12 last:mr-0 pointer-events-auto min-w-0 shrink-0", s.panel.expanded ? "flex-grow max-w-full" : ""]),
  ...
  const s = f(void 0), e = f(void 0), t = f(0), i = f(0), r = f(!1), a = f(!0), o = f({}), l = f({}), n = f([]), c = f([]), u = f([]), p = N(() => i.value);
  function d(I) {
  ...
  function g(I) {
    const R = [];
    return I.forEach((oe) => {
      oe in l.value && R.push(l.value[oe].getPromise());
    }), R;
  }
  function h(I) {
  ...
  function k() {
    ...
    !R.includes(s.value) && !r.value) {
      let De;
      for (let di = 0; di < R.length - 1 && I < (s.value.width || oe) + he; di++)
        De = R.shift(), I += De.width || oe;
      I >= (s.value.width || oe) ? R.unshift(s.value) : e.value || (De = R.shift(), R.unshift(s.value));
  ...
  function V(I) {
    if (o.value = { ...o.value, [I.id]: I }, I.id in l.value)
  ...
  function Nt(I, R) {
    const oe = n.value.indexOf(I), he = R === "right" ? 1 : -1;
    u.value.includes(n.value[oe + he]) && ([n.value[oe], n.value[oe + he]] = [
      n.value[oe + he],
      n.value[oe]
    ]);
  }
  function Ft(I) {
    o.value[I.id] !== void 0 && delete o.value[I.id], l.value[I.id] !== void 0 && delete l.value[I.id];
  ...
  setup(s) {
    ...
    return (c, u) => (v(), W(Mi, {
      ...
      default: te(() => [
        (v(!0), w(He, null, ht(a(S(t).screenSize), (p) => (v(), W(Hi, {
          key: `${p.id}`,
          panel: p
        }, null, 8, ["panel"]))), 128))
      ]),
  ...
  setup(s) {
    ...
    return Je(() => {
      window.addEventListener(
        ...
        o.value && a.value && (t.value = Os(o.value, a.value, {
      ...
      return v(), w("div", {
        ...
        P(y("div", {
          ...
          class: ae(["rv-dropdown shadow-md border border-gray:200 py-8 bg-white rounded z-10", { "text-center": s.centered }]),
          ref_key: "dropdown",
          ref: a
        }, [
          Pe(p.$slots, "default", {
  ...
  setup(s) {
    ...
    return (a, o) => {
      ...
      return v(), W(l, { panel: s.panel }, {
        header: te(() => [
          ot(U(S(t)("notifications.title")), 1)
        ]),
        content: te(() => [
          y("div", tr, [
            y("div", ir, [
...
const or = ["content"], nr = { class: "flex items-center text-left" }, lr = { class: "select-text cursor-text" }, cr = ["content"], ur = {
  key: 0,
  class: "text-left"
}, pr = /* @__PURE__ */ O({
  ...
  setup(s) {
    ...
    return (n, c) => {
      const u = M("tippy");
      return P((v(), w("li", {
        class: ae(["flex-col default-focus-style p-4", s.notification.messageList ? "cursor-pointer" : ""]),
        ...
        y("div", nr, [
          ...
          s.notification.messageList ? (v(), w("div", {
            key: 0,
            class: ae(["dropdown-icon p-4 pointer-events-none", { "transform -rotate-180": r.value }])
          }, c[2] || (c[2] = [
            y("svg", {
              xmlns: "http://www.w3.org/2000/svg",
              height: "24",
          ...
          P((v(), w("button", {
            type: "button",
            onClick: c[0] || (c[0] = Zt((p) => o(s.notification), ["stop"])),
  ...
  setup(s) {
    ...
    const o = N(() => e.notificationStack);
    return (l, n) => {
      const c = M("focus-item"), u = M("focus-list"), p = M("tippy");
      return v(), w("div", null, [
        o.value.length > 0 ? P((v(), w("ul", {
          key: 0,
          ...
          (v(!0), w(He, null, ht(o.value, (d, g) => (v(), w(He, {
            key: d.message + g
          }, [
            g > 0 ? (v(), w("div", hr)) : G("", !0),
            P(re(pr, {
  ...
  setup(s) {
    const { t: e } = Y(), t = ve("iApi"), i = () => {
      t.reload();
    }, r = N(() => `${mt.major}.${mt.minor}.${mt.patch}`), a = N(() => mt.hash.slice(0, 9)), o = N(() => {
            ...
            y("div", null, [
              ...
              y("div", $r, [
                y("div", null, [
                  ...
                  y("span", Or, " [" + U(a.value) + "] ", 1)
                ]),
                y("div", null, [
                  y("span", kr, U(o.value), 1)
                ]),
  ...
  __name: "map-caption",
  setup(s) {
    const e = Be(), t = pe(), { t: i } = Y(), r = ve("iApi"), a = N(() => e.scale), o = N(() => e.attribution), l = N(() => e.coords), n = N(() => e.langtoggle), c = N(() => t.config.map), u = f([]), p = we([]);
    p.push(
      It(c, (A) => {
    ...
    const d = () => o.value?.logo?.link && o.value?.logo?.value && !o.value?.logo?.disabled, g = (A) => {
    ...
    return (A, b) => {
      ...
      return v(), w("div", Nr, [
        ...
        o.value?.text.disabled ? G("", !0) : P((v(), w("span", Ur, [
        ...
        y("div", Br, [
          ...
          a.value?.disabled ? G("", !0) : P((v(), w("button", {
            key: 1,
            type: "button",
            ...
            "aria-label": `
                    ${a.value?.label} - ${m(a.value?.isImperialScale)}
                `,
            content: m(a.value?.isImperialScale)
          }, [
            y("span", {
              class: "border-solid border-2 border-white border-t-0 h-5 mr-4 inline-block",
              style: Oi({ width: a.value?.width })
            }, null, 4),
            y("span", qr, U(a.value?.label), 1)
          ], 8, zr)), [
            [k, {
              delay: [300, 0],
              placement: "top",
          ...
          n.value?.disabled ? G("", !0) : (v(), W($, {
            ...
            default: te(() => [
              (v(!0), w(He, null, ht(u.value, (V, ye) => (v(), w("a", {
                key: `${V}-${ye}`,
                class: ae(["flex-auto items-center text-sm sm:text-base cursor-pointer", { "font-bold": V === S(r).$i18n.locale.value }]),
                href: "javascript:;",
                onClick: (Qe) => g(V)
              }, [
                ot(U(S(i)("map.language." + V)) + " ", 1),
  ...
  setup(s) {
    ...
    return (a, o) => {
      ...
      return P((v(), w("button", {
        type: "button",
        onClick: o[0] || (o[0] = (n) => S(t).panel.get("notifications").open()),
...
}), Xr = /* @__PURE__ */ Fe(Zr, [["__scopeId", "data-v-a451db5c"]]), Qr = { class: "flex items-center mb-20" }, ea = { class: "text-xl" }, ta = /* @__PURE__ */ O({
  __name: "keyboard-instructions",
  setup(s) {
    const e = ve("iApi"), { t } = Y(), i = f(!1), r = f(["app", "lists", "map"]), a = f([]), o = f(null), l = f(null);
    Je(() => {
      a.value.push(
    ...
    return (c, u) => {
      ...
      return i.value ? (v(), w("div", {
        ...
        y("div", {
          ...
          y("div", Qr, [
            y("h2", ea, U(S(t)("keyboardInstructions.title")), 1),
            re(p, {
              class: "ml-auto",
...
}), st = B("instance", () => ({ started: f(!1) })), ia = { class: "h-full relative" }, sa = { class: "inner-shell absolute top-0 left-0 h-full w-full pointer-events-none" }, ra = { class: "absolute top-8 w-full flex justify-center" }, aa = {
  key: 1,
  class: "w-full h-full"
}, oa = /* @__PURE__ */ O({
  __name: "shell",
  setup(s) {
    const e = ve("iApi"), t = st(), i = ge(), r = Ye(), { t: a } = Y(), o = N(() => i.items.appbar), l = () => {
      e?.event.emit("openKeyboardInstructions");
    }, n = () => r.teleported;
    return (c, u) => (v(), w("div", ia, [
      y("div", sa, [
        ...
        y("div", ra, [
          y("button", {
            ...
            onClick: l
          }, U(S(a)("keyboardInstructions.open")), 1)
        ]),
        re(ta),
        ...
        o.value ? G("", !0) : (v(), W(Xr, { key: 0 })),
        re(Yr, { class: "z-30" })
      ]),
      S(t).started ? (v(), W(Js, { key: 0 })) : (v(), w("div", aa, u[1] || (u[1] = [
...
}), na = /* @__PURE__ */ Fe(oa, [["__scopeId", "data-v-7a1e48c2"]]), la = O({
  name: "App",
  components: { Shell: na },
  setup() {
    const s = ms();
...
const da = /* @__PURE__ */ Fe(la, [["render", pa]]), Ie = "focus-list", je = "focus-item", ha = "focus-icon", fa = "focus-container", ct = `[${Ie}],[${fa}]`, At = "truncate-text", wt = "show-truncate", at = "focused", Yt = `button,input,select,a,textarea,[contenteditable],[${Ie}],[${ha}],[tabIndex]`, ma = {
  mounted(s, e) {
    +s.getAttribute("tabindex") <= 0 && s.setAttribute("tabindex", "0"), s.toggleAttribute(Ie, !0), new ya(s, e.value);
  },
  updated(s) {
    Ki(s);
  }
...
function Ki(s) {
  s.querySelectorAll(Yt).forEach((t) => {
    if (t.closest(ct) === s || t.closest(ct) === t && t.parentElement.closest(ct) === s)
      if (t.closest(`[${Ie}],.${at}`).classList.contains(at))
...
class ya {
  ...
  setTabIndex(e, t = this.element) {
    t.querySelectorAll(Yt).forEach((r) => {
      (e === -1 || r.closest(ct) === this.element || r.closest(ct) === r && r.parentElement.closest(ct) === this.element || r.closest(`[${Ie}],.${at}`).classList.contains(at)) && r.setAttribute("tabindex", e.toString());
    });
  }
  /**
   ...
   */
  defocusItem(e) {
    e.classList.remove(at), this.setTabIndex(-1, e), e._tippy && e._tippy.hide(), e.getAttribute(je) === wt && e.querySelector(`[${At}]`)?._tippy?.hide();
  }
  /**
   ...
   */
  focusItem(e) {
    e.classList.add(at), this.setAriaActiveDescendant(e), this.setTabIndex(0, e), e.scrollIntoView({ block: "nearest" }), e._tippy && !this.isTapped && e._tippy.show(), e.getAttribute(je) === wt && e.querySelector(`[${At}]`)?._tippy?.show(), this.isTapped = !1;
  }
  /**
    ...
    if (i.length !== 0)
      switch (e.key) {
        ...
        case " ":
          ...
          break;
        case "Tab":
          const r = this.highlightedItem.querySelectorAll(Yt).length === 0, a = this.element.isEqualNode(e.target);
...
const vi = "focus-item", ga = {
  beforeMount(s, e) {
    s.hasAttribute("id") || s.setAttribute("id", va()), e.value ? s.setAttribute(vi, e.value) : s.toggleAttribute(vi, !0);
  }
};
function va() {
  let s;
...
const ti = "focus-container", Zi = "focus-list", ba = "focus-icon", Vt = `[${Zi}],[${ti}]`, bi = `button,input,select,a,textarea,[contenteditable],.ag-tab-guard,[${Zi}],[${ti}],[${ba}],[tabIndex]`;
let zt = [];
const Aa = {
  mounted(s) {
    [...document.querySelectorAll(".inner-shell")].some((t) => t.contains(s)) && zt.push(new wa(s));
  },
  beforeUnmount(s) {
...
const Ea = "truncate-text", xa = "truncate-trigger", Sa = {
  beforeMount(s, e) {
    !s.classList.contains("truncate") && !e.value?.noTruncateClass && s.classList.add("truncate"), s.toggleAttribute(Ea, !0);
  },
  mounted(s, e) {
    let t;
    e.value && e.value.externalTrigger && (t = s.closest(`[${xa}]`)), $s(s, {
...
const _a = ["content"], Ta = {
  ...
  setup(s, { expose: e }) {
    const { t } = Y(), i = Ye(), r = $t(), a = ve("iApi"), o = hi("el"), l = hi("contentEl"), n = f();
    e({ el: o });
    const c = s, u = N(() => a?.fixture.get("appbar") ? r.temporary : []), p = N(() => i.mobileView), d = N(() => i.reorderable), g = (b) => b.scrollHeight > b.clientHeight, h = () => !p.value && !c.panel.teleport, m = (b) => {
      c.panel.move(b), b === "left" && Ot(() => {
        (o.value?.querySelector(".move-left")).focus();
      });
    }, A = N(() => c.screenId ? c.panel.screens[c.screenId][a?.$i18n.locale.value ?? "en"] : null);
    return Je(() => {
      ...
      const L = Z("back"), k = Z("panel-options-menu"), V = Z("left"), ye = Z("right"), Qe = Z("pin"), Nt = Z("expand"), Ft = Z("minimize"), Dt = Z("close"), I = M("truncate"), R = M("focus-item"), oe = M("tippy");
      return P((v(), w("div", {
        ...
        s.header ? (v(), w("header", Ta, [
          re(L, {
            class: ae(s.panel.teleport ? "display-none" : "block sm:display-none"),
            onClick: $[0] || ($[0] = (he) => s.panel.close())
          }, null, 8, ["class"]),
          P((v(), w("h2", La, [
            b.$slots.header ? Pe(b.$slots, "header", { key: 0 }) : (v(), w("div", Ra, U(S(t)(s.panel.alertName)), 1))
          ])), [
            [I]
          ]),
          ...
          y("div", {
            class: ae(s.panel.teleport ? "flex" : "display-none sm:flex")
          }, [
            s.panel.teleport ? G("", !0) : (v(), w("div", $a, [
              d.value ? (v(), W(V, {
                key: 0,
...
}), Ma = { class: "relative" }, Pa = ["content", "aria-label"], Na = ["transform"], Fa = /* @__PURE__ */ O({
  __name: "pin",
  props: {
    active: Boolean
  },
  setup(s) {
    ...
    return (t, i) => {
      ...
      return v(), w("div", Ma, [
        P((v(), w("button", {
          type: "button",
          class: ae(["text-gray-500 hover:text-black focus:text-black p-8", { "text-gray-700": s.active }]),
...
}), Da = { class: "relative" }, Ga = ["content", "aria-label"], Ua = /* @__PURE__ */ O({
  __name: "close",
  props: {
    active: Boolean
  },
...
}), Ba = { class: "relative" }, Va = ["content", "aria-label"], za = /* @__PURE__ */ O({
  __name: "back",
  props: {
    active: Boolean
  },
...
}), qa = { class: "w-32 h-32" }, ja = ["content", "aria-label"], Wa = {
  key: 0,
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 24 24",
...
}), Ja = { class: "relative" }, Ka = ["content", "aria-label"], Za = /* @__PURE__ */ O({
  __name: "minimize",
  props: {
    active: Boolean
  },
  setup(s) {
    ...
    return (t, i) => {
      ...
      return v(), w("div", Ja, [
        P((v(), w("button", {
          type: "button",
          class: ae(["text-gray-500 hover:text-black focus:text-black p-6", { "text-gray-700": s.active }]),
...
}), Xa = { class: "relative" }, Qa = ["content", "aria-label"], eo = /* @__PURE__ */ O({
  __name: "right",
  props: {
    active: Boolean
  },
...
}), to = { class: "relative" }, io = ["content", "aria-label"], so = /* @__PURE__ */ O({
  __name: "left",
  props: {
    active: Boolean
  },
...
}), ao = /* @__PURE__ */ Fe(ro, [["__scopeId", "data-v-51e22a4a"]]), oo = {
  key: 0,
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 24 24",
  ...
  setup(s) {
    ...
    return (r, a) => {
      ...
      return v(), W(o, {
        ...
        default: te(() => [
          S(t).isFullscreen ? (v(), w("svg", oo, a[0] || (a[0] = [
            y("path", {
              d: "M0 0h24v24H0z",
              fill: "none"
            }, null, -1),
  ...
  tabindex: "-1"
}, ho = ["content", "aria-label"], fo = /* @__PURE__ */ O({
  __name: "button",
  props: {
    onClickFunction: {
      type: Function,
  ...
  class: "relative",
  tabindex: "-1"
}, yo = ["aria-label", "content"], go = /* @__PURE__ */ O({
  __name: "button",
  props: {
    onClickFunction: {
      type: Function,
  ...
  setup(s) {
    ...
    return (r, a) => {
      const o = M("focus-item"), l = M("tippy");
      return v(), w("div", mo, [
        P((v(), w("button", {
          type: "button",
...
}), vo = /* @__PURE__ */ Fe(go, [["__scopeId", "data-v-f0341fec"]]), bo = B("areas-of-interest", () => ({ areas: f([]) })), Ao = B("export", () => {
  const s = f({
    title: !0,
    map: !0,
    mapElements: !0,
...
class So {
  ...
  fsaToProvince(e) {
    ...
    return r === "X" ? i === "X0A" || i === "X0B" || i === "X0C" ? t = 62 : t = 61 : t = Eo[r], this.codeToProvince(t);
  }
}
function Io(s) {
  return new So(s);
...
async function Lo(s, e) {
  ...
  return r.test(e) && !s.disabledSearchTypes.includes("LAT/LNG") ? (i = e.slice(0, -1), t = new xt(s, i), await Co(t)) : o.test(e) && !s.disabledSearchTypes.includes("FSA") ? (i = e.substring(0, 3).toUpperCase(), t = new xt(s, i), await Oo(t)) : a.test(e) && !s.disabledSearchTypes.includes("NTS") ? (i = e.substring(0, 6).toUpperCase(), t = new xt(s, i), await ko(t)) : (i = encodeURIComponent(e.trim()), t = new xt(s, i), await Mo(t)), t;
}
const ii = async (s) => {
  ...
  let i;
  e ? (console.error("GeoName service targeting Name failed"), s.failedServs.push("geoname"), i = []) : i = t.items, s.addResult(Xi(s.config, i));
}, $o = async (s, e, t) => {
  const [i, r] = await Ee(ii(si(s, !1, e, t)));
  let a;
  i ? (console.error("GeoName service targeting Lat Lon failed"), s.failedServs.push("geoname"), a = []) : a = r.items, s.addResult(Xi(s.config, a));
}, Co = async (s) => {
  ...
  const e = s.config;
  if (await Ro(s), e.categories.length === 0 || e.categories.includes("ADDR")) {
    const t = await ri(s), i = e.sortOrder.indexOf("ADDR"), r = i >= 0 ? i : e.sortOrder.length, a = t.filter((o) => o.type?.includes("Street")).map((o) => {
...
}, Po = "~FSA~", wi = "https://geogratis.gc.ca/services/geolocation/@{language}/locate", Ei = "https://geogratis.gc.ca/services/geoname/@{language}/geonames.json", xi = "https://geogratis.gc.ca/services/geoname/@{language}/codes/province.json", Si = "https://geogratis.gc.ca/services/geoname/@{language}/codes/concise.json";
class Ii {
  config;
  constructor(e, t) {
    let i, r, a, o;
    const l = t?.serviceUrls;
    l ? (i = l.geoLocation ? l.geoLocation : wi, r = l.geoNames ? l.geoNames : Ei, a = l.geoProvince ? l.geoProvince : xi, o = l.geoTypes ? l.geoTypes : Si) : (i = wi, r = Ei, a = xi, o = Si), i = i.replace("@{language}", e), r = r.replace("@{language}", e), a = a.replace("@{language}", e), o = o.replace("@{language}", e);
    let n = "";
    const c = t?.fsaBoundaries;
    if (c && c.serviceUrl) {
      const A = c.keyField || "CFSAUID";
      n = `${c.serviceUrl}/query/?where=${A}%3D'${Po}'&outFields=${A}&returnGeometry=true&f=json`;
    }
    const u = t?.settings;
    let p, d, g, h, m;
   ...
   */
  async query(e) {
    const t = await Lo(this.config, e.toUpperCase()), i = this.config.sortOrder.length, r = t.results.filter((n) => n.order < i), a = t.results.filter((n) => n.order >= i);
...
const No = B("geosearch", () => {
  const s = f(new Ii("en", void 0)), e = f({
    type: "",
    province: "",
    extent: void 0
  }), t = f(!1), i = f(""), r = f(""), a = f(""), o = f([]), l = f([]), n = f(!1), c = f([]), u = N(() => s.value.fetchProvinces()), p = N(
    () => new Promise((L) => {
...
var Do = /* @__PURE__ */ ((s) => (s.Title = "title", s.Text = "text", s.Image = "image", s.Markdown = "markdown", s.Template = "template", s))(Do || {});
class Ti extends es {
  _infoType;
  ...
  function n(c) {
    switch (l.value) {
      case ie.UPLOAD:
        ...
        break;
      case ie.FORMAT:
        c === ie.UPLOAD ? (a.value && (t.value = "", a.value = null), i.value = "", l.value = ie.UPLOAD) : c === ie.CONFIGURE && (l.value = ie.CONFIGURE);
        break;
      case ie.CONFIGURE:
        c === ie.UPLOAD ? (t.value = "", i.value = "", a.value = null, r.value = !0, o.value = {
          config: s,
          configOptions: []
        }, l.value = ie.UPLOAD) : c === ie.FORMAT && (o.value = {
          config: s,
          configOptions: []
...
class Wo {
  ...
  constructor(e, t, i) {
    ...
    this.$vApp = r.app, this.$element = r.element, this.$i18n = r.i18n, this.$rootEl = r.app.$root?.$el, this.fixture = new Vn(this), this.panel = new zn(this), this.geo = new Un(this), this.dev = new Jn(this), this.ui = {
      ...
      escapeHtml: () => "",
      isPlainText: () => !0
    }, this.notify = new ar(this), this._isFullscreen = Se.isEnabled && !!this.$vApp.$root && Se.isFullscreen && Se.element === this.$vApp.$root.$el, Se.isEnabled && Se.onchange(() => {
   ...
   */
  initialize(e, t, i) {
    const r = pe(this.$vApp.$pinia), a = Ye(this.$vApp.$pinia), o = Ct(this.$vApp.$pinia);
    if (t?.configs !== void 0) {
   ...
   */
  reloadWorker(e, t) {
    const i = st(this.$vApp.$pinia), r = Re(this.$vApp.$pinia), a = pe(this.$vApp.$pinia), o = ge(this.$vApp.$pinia), l = Te(this.$vApp.$pinia), n = Wt(this.$vApp.$pinia), c = !!e;
...
function Ho(s, e) {
  ...
  t.use(({ store: o }) => {
    const l = mi(o.$state);
    o.$reset = () => o.$patch(mi(l));
  });
  const i = Ys(), r = Pi(da).use(i).use(Ls, {
    directive: "tippy",
    // => v-tippy
    component: "tippy"
    // => <tippy/>
  }).use(t);
  r.directive("focus-container", Aa), r.directive("focus-list", ma), r.directive("focus-item", ga), r.directive("truncate", Sa), r.component("panel-screen", ka), r.component("pin", Fa), r.component("close", Ua), r.component("back", za), r.component("expand", Ya), r.component("panel-options-menu", ao), r.component("dropdown-menu", ei), r.component("minimize", Za), r.component("right", eo), r.component("left", so), r.component("fullscreen-nav-button", lo), r.component("geolocator-nav-button", co), r.component("home-nav-button", uo), r.component("mapnav-button", fo), r.component("appbar-button", vo), r.component("transition", ki), r.component("transition-group", Mi), r.config.globalProperties.$iApi = e, r.config.globalProperties.$pinia = t, r.config.idPrefix = `ramp-${s.id || e.geo.shared.generateUUID()}`, r.provide("iApi", e);
  const a = r.mount(s);
...
class ai {
  ...
  static async create(e) {
    const t = new ai(e), i = e.layers.map((o) => {
...
class Yo extends J {
  ...
  async createMap(e, t) {
    ...
    }, r = e.basemaps.map((n) => ai.create(n)), o = (await Promise.all(r)).filter((n) => (n.createErr && i(n), n.esriBasemap.baseLayers.length > 0));
    o.forEach((n) => {
    ...
    if (e ? (e.logo ? e.logo.disabled ? r.logo.disabled = !0 : (r.logo.altText = e.logo.altText || i.altText, r.logo.link = e.logo.link || i.link, r.logo.value = e.logo.value || i.value) : (r.logo.altText = i.altText, r.logo.link = i.link, r.logo.value = i.value), e.text ? e.text.disabled ? r.text.disabled = !0 : r.text.value = e.text.value || t.value : r.text.value = t.value, Be(this.$vApp.$pinia).setAttribution(r)) : (r.logo.altText = i.altText, r.logo.link = i.link, r.logo.value = i.value, r.text.value = t.value), !e || e.text?.disabled || !e.text) {
      ...
      if (n) {
        ...
        Promise.all(c).then((u) => {
          a = u.filter((d) => d?.copyright).map((d) => d.copyright).join(" | "), r.text.value = a || r.text.value || t.value, Be(this.$vApp.$pinia).setAttribution(r);
        });
      }
    }
  }
...
class Zo extends Yo {
   ...
   */
  constructor(e) {
    super(e, "main"), this.maptip = new Jo(e), this.caption = new Ko(e), this.mapMouseThrottle = 0;
  }
  async createMap(e, t) {
  ...
  addLayer(e, t = void 0) {
    return new Promise((i, r) => {
      ...
      let l = 0;
      const n = setInterval(() => {
        l += 250, l >= e.expectedTime.fail || e.layerState === q.ERROR ? (clearInterval(n), e.lastCancel < o && console.error(`Failed to add layer: ${e.id}.`), r()) : e.initiationState === F.INITIATED && (e.esriLayer || !e.mapLayer) && (clearInterval(n), e.mapLayer ? this.insertToEsriMap(e) : e.onLoad(), i());
      }, 250);
    });
  }
  /**
  ...
  */
  ...
  runIdentify(e) {
    ...
    const a = {
      geometry: i.mapPoint,
      hitTest: r
    }, o = t.filter((c) => c.supportsIdentify).map((c) => (a.tolerance = i.input == "touch" ? c.touchTolerance : c.mouseTolerance, c.runIdentify(a))).flat(), l = Date.now();
    o.forEach((c) => {
      c.requestTime = l;
    });
    const n = {
...
const Xo = { geometryType: "point", renderer: { type: "simple", symbol: { type: "esriSMS", style: "esriSMSCircle", color: [67, 100, 255, 200], size: 7, outline: { color: [0, 0, 0, 255], width: 1 } } } }, Qo = { geometryType: "polyline", renderer: { type: "simple", symbol: { type: "esriSLS", style: "esriSLSSolid", color: [90, 90, 90, 200], width: 2 } } }, en = { geometryType: "polygon", renderer: { type: "simple", symbol: { type: "esriSFS", style: "esriSFSSolid", color: [76, 76, 125, 200], outline: { type: "esriSLS", style: "esriSLSSolid", color: [110, 110, 110, 255], width: 1 } } } }, tn = { geometryType: "polygon", renderer: { type: "simple", symbol: { type: "esriSFS", style: "esriSFSSolid", color: [255, 0, 0, 64], outline: { type: "esriSLS", style: "esriSLSSolid", color: [240, 128, 128, 255], width: 1 } } } }, sn = {
  circlePoint: Xo,
  solidLine: Qo,
  outlinedPoly: en,
  boundingBoxPoly: tn
...
class cn extends J {
  ...
  filterCsvLatLonFields(e, t = ",") {
    const i = yi.dsvFormat(t).parseRows(e), r = i[0], a = {
  ...
  async geoJsonToEsriJson(e, t) {
    ...
    if (t) {
      ...
      t.layerId ? a = t.layerId : a = this.$iApi.geo.shared.generateUUID(), t.colour && (c.renderer.symbol.color = new Ne(t.colour).toArcServer());
    } else
...
class dn extends J {
  ...
  async awaitLayer(e) {
    ...
    const i = new H();
    let r = 0;
    const a = 300, o = setInterval(() => {
      r += a;
      const l = this.getLayer(e);
      if (l)
        clearInterval(o), i.resolveMe(l);
      else if (r > 8e3) {
        clearInterval(o);
        const n = setInterval(() => {
  ...
  async loadLayerMetadata(e) {
    ...
    if (a.name = r.name || "", a.currentVersion = r.currentVersion || -1, a.minScale = r.effectiveMinScale || r.minScale || 0, a.maxScale = r.effectiveMaxScale || r.maxScale || 0, a.extent = r.extent ? D.fromArcServer(r.extent, "layer_extent") : void 0, a.defaultVisibility = r.defaultVisibility ?? !0, a.canModifyLayer = r.canModifyLayer ?? !0, r.type === "Feature Layer" || r.type === "Table") {
...
class ni extends Ze {
  ...
  async loadLayerMetadata(e = {}) {
    ...
    if (!(t < this.lastCancel))
      if (this.geomType = i.geometryType, this.attribs.quickCache = new as(this.geomType), this.scaleSet.minScale = i.minScale, this.scaleSet.maxScale = i.maxScale, this.dataFormat = i.dataFormat, this.extent = this.extent ?? i.extent, this._serverVisibility = i.defaultVisibility, this.origRampConfig.name || (this.name = i.name ?? this.id), this.dataFormat === ee.ESRI_FEATURE) {
        ...
        this.attribs.attLoader = new rs(this.$iApi, a);
      } else
...
class hn extends Ze {
  ...
  async addGraphic(e) {
    ...
    const i = t.filter((n) => this._graphics.findIndex((u) => u.id === n.id) === -1 ? (this._graphics.push(n), !0) : (console.error(`Attempting to add graphic with id '${n.id}' that has already been added.`), !1)), r = this.$iApi.geo.map.getSR(), a = i.map((n) => this.$iApi.geo.proj.projectGeometry(r, n.geometry)), o = await Promise.all(a), l = i.map((n, c) => {
      const u = new xe(o[c], n.id, n.attributes);
...
class Tn extends Ze {
  ...
  getFeatureInfo(e, t, i) {
    ...
    let o, l;
    const n = r.getExtent(), c = a.spatialReferences, u = e.join(","), p = r.esriView.toScreen(t.toESRI()), d = Math.floor(p.x), g = Math.floor(p.y), m = {
    ...
    }), Object.keys(b).forEach((L) => l[L] = b[L]), ze(a.url.split("?")[0], {
      query: l,
      responseType: m
    });
  }
...
class is extends ts {
  ...
  async onInitiate() {
    if (this.sourceJson) {
      ...
      this.attribs.attLoader = new Mn(this.$iApi, a), await this.attribs.attLoader.getAttribs(), this.featureCount = e.data.length;
...
class $n extends is {
  ...
  onLoadActions() {
    const e = super.onLoadActions(), t = Date.now(), r = this.$iApi.geo.shared.parseUrlIndex(this.serviceUrl).index || 0, a = this.$iApi.geo.layer.loadLayerMetadata(this.serviceUrl).then((l) => {
      ...
      this.attribs.attLoader = new rs(this.$iApi, n), this.attribs.quickCache = new as(this.geomType);
...
class On extends J {
  ...
  async loadGraphicsAttributes(e, t) {
    ...
    const r = {
      features: e.sourceGraphics.map((a) => _e(a).attributes).toArray(),
      oidIndex: {}
    };
...
class Fn extends ci {
  ...
  constructor(e, t, i = !1) {
    if (super(e, t, i), this.valField = this.cleanFieldName(e.field, t), e.classBreakInfos.forEach((r, a) => {
      const o = a === 0, l = new $i(this, r.minValue, r.maxValue, o);
...
class Dn extends J {
  ...
  async symbolToSvg(e) {
    ...
    const a = tt(r).size(this.CONTAINER_SIZE, this.CONTAINER_SIZE).viewbox(0, 0, this.CONTAINER_SIZE, this.CONTAINER_SIZE), o = {
      ...
      none: () => "transparent",
      // esriSFSNull
      horizontal: (h, m) => a.pattern(5, 5, (b) => b.line(0, 5 / 2, 5, 5 / 2)).stroke(m),
      vertical: (h, m) => a.pattern(5, 5, (b) => b.line(5 / 2, 0, 5 / 2, 5)).stroke(m),
      "forward-diagonal": (h, m) => a.pattern(5, 5, (b) => {
        b.line(0, 0, 5, 5).stroke(m), b.line(0, 0, 5, 5).move(0, 5).stroke(m), b.line(0, 0, 5, 5).move(5, 0).stroke(m);
      }),
      "backward-diagonal": (h, m) => a.pattern(5, 5, (b) => {
        b.line(5, 0, 0, 5).stroke(m), b.line(5, 0, 0, 5).move(5 / 2, 5 / 2).stroke(m), b.line(5, 0, 0, 5).move(-5 / 2, -5 / 2).stroke(m);
      }),
      cross: (h, m) => a.pattern(5, 5, (b) => {
        b.line(5 / 2, 0, 5 / 2, 5).stroke(m), b.line(0, 5 / 2, 5, 5 / 2).stroke(m);
      }),
      "diagonal-cross": (h, m) => a.pattern(7, 7, (b) => {
      ...
      "simple-fill"() {
        ...
        a.rect(t.CONTENT_SIZE, t.CONTENT_SIZE).center(t.CONTAINER_CENTER, t.CONTAINER_CENTER).fill(A).stroke($);
      },
      text() {
      ...
      "picture-marker"() {
        ...
        return t.$iApi.geo.shared.convertImagetoDataURL(m).then((b) => t.svgDrawImage(a, b)).then(({ image: b }) => {
  ...
  async getMapServerLegend(e) {
    ...
    const t = {
      query: { f: "json" }
    }, i = { layers: [] }, [r, a] = await Ee(ze(`${e}/legend`, t));
...
class Gn extends J {
  ...
  async geoJsonQuery(e) {
    ...
    return (await e.layer.esriLayer.queryFeatures(t)).features.map((r, a) => {
      let o;
      return t.returnGeometry ? o = this.$iApi.geo.geom.geomEsriToRamp(r.geometry, `queryResult${a}`) : o = new qe(), new xe(o, "", r.attributes);
    });
  }
  /**
...
class Un extends J {
   ...
   */
  constructor(e) {
    super(e), this.geom = ut.geom, this.proj = ut.proj, this.shared = ut.sharedUtils, this.map = new Zo(e), this.layer = new dn(e), this.attributes = new On(e), this.query = new Gn(e), this.symbology = new Dn(e), Array.isArray(ft.request.interceptors) || (ft.request.interceptors = []), ft.request.interceptors.push({
      before: (t) => {
...
const Bn = /* @__PURE__ */ Object.assign({ "../fixtures/appbar/index.ts": () => import("./index-R7qBBTX-.js"), "../fixtures/areas-of-interest/index.ts": () => import("./index-Ce5X5yMg.js"), "../fixtures/basemap/index.ts": () => import("./index-C8xfIPpV.js"), "../fixtures/crosshairs/index.ts": () => import("./index-D-Fv-9NS.js"), "../fixtures/details/index.ts": () => import("./index-Bo7rY3pm.js"), "../fixtures/export-footnote/index.ts": () => import("./index-BoJUKDBK.js"), "../fixtures/export-legend/index.ts": () => import("./index-BUeLn_w3.js"), "../fixtures/export-map/index.ts": () => import("./index-CeHDjdXm.js"), "../fixtures/export-northarrow/index.ts": () => import("./index-DUf2soo-.js"), "../fixtures/export-scalebar/index.ts": () => import("./index-VqGhGRih.js"), "../fixtures/export-timestamp/index.ts": () => import("./index-TXBu5iuF.js"), "../fixtures/export-title/index.ts": () => import("./index-vZjuvSTf.js"), "../fixtures/export/index.ts": () => import("./index-BSkDkuzp.js"), "../fixtures/extentguard/index.ts": () => import("./index-Dbql3X_P.js"), "../fixtures/gazebo/index.ts": () => import("./index-Dr8kFv7Y.js"), "../fixtures/geosearch/index.ts": () => import("./index-Cx_vqabK.js"), "../fixtures/grid/index.ts": () => import("./index-ClKZE_-7.js"), "../fixtures/help/index.ts": () => import("./index-Cyo6znAt.js"), "../fixtures/hilight/index.ts": () => import("./index-CAcqLWDL.js"), "../fixtures/layer-reorder/index.ts": () => import("./index-Ddl7wPR5.js"), "../fixtures/legend/index.ts": () => import("./index-BNfKvkSc.js"), "../fixtures/mapnav/index.ts": () => import("./index-DVNQfYox.js"), "../fixtures/metadata/index.ts": () => import("./index-4rG2f_rr.js"), "../fixtures/northarrow/index.ts": () => import("./index-BZxo5rnP.js"), "../fixtures/overviewmap/index.ts": () => import("./index-BmBh0iA_.js"), "../fixtures/panguard/index.ts": () => import("./index-DEI4SLpI.js"), "../fixtures/scrollguard/index.ts": () => import("./index-5aReLf3c.js"), "../fixtures/settings/index.ts": () => import("./index-COjTlAi9.js"), "../fixtures/snowman/index.ts": () => import("./index-BQYAh0cM.js"), "../fixtures/wizard/index.ts": () => import("./index-DVZeMjCw.js") });
class Vn extends J {
  /**
  ...
  get(e) {
    ...
    const i = t.map((r) => {
      const a = ge(this.$vApp.$pinia).items[r];
      if (a)
        return a;
    });
...
class ui extends J {
  ...
  mount(e, { props: t, children: i, element: r, app: a } = {}) {
    let o = r, l = ys(e, t, i);
    return a && a._context && (l.appContext = a._context), o ? Ut(l, o) : (o = document.createElement("div"), Ut(l, o)), { vNode: l, destroy: () => {
      o && Ut(null, o), o = null, l = null;
    }, el: o };
  }
  /**
...
const Hn = /* @__PURE__ */ Fe(jn, [["render", Wn], ["__scopeId", "data-v-a3c61802"]]), Yn = /* @__PURE__ */ Object.assign({ "../fixtures/areas-of-interest/screen.vue": () => import("./screen-BonUPrum.js"), "../fixtures/basemap/screen.vue": () => import("./screen-Bo_YQxgG.js"), "../fixtures/export/screen.vue": () => import("./screen-OGEg9bxs.js"), "../fixtures/geosearch/screen.vue": () => import("./screen-BAM6l4xr.js"), "../fixtures/grid/screen.vue": () => import("./screen-BXGLLylX.js"), "../fixtures/help/screen.vue": () => import("./screen-CahoXy11.js"), "../fixtures/layer-reorder/screen.vue": () => import("./screen-D24XW2nK.js"), "../fixtures/legend/screen.vue": () => import("./screen-DIueNOr6.js"), "../fixtures/metadata/screen.vue": () => import("./screen-CkVNanoG.js"), "../fixtures/settings/screen.vue": () => import("./screen-DWE_QyY9.js"), "../fixtures/wizard/screen.vue": () => import("./screen-CxW6BA8k.js") });
class St extends J {
  /**
   * ID of this panel.
   *
  ...
  return s.controls && s.controls.length > 0 && (e.controls = pt(s.controls, t), s.controls.includes("visibility") && e.controls.push("visibilityButton"), (s.controls.length !== 1 || s.controls[0] !== "visibility") && console.warn(
    ...
    if (i.layerId)
      ...
      typeof i.collapse < "u" && console.warn(
        ...
        a.layerId ? r.children.push(Ci(a)) : r.children.push(Kt(a));
      }), e.children.push(r);
    } else
...
var rt = { major: "4", minor: "12", patch: "0-beta", timestamp: "Fri May 23 13:12:32 2025 -0400", hash: "19f23f49ab4f695620029849903e3c4cf97b6498" };
console.info(
...
const Vl = (s, e, t) => new Wo(s, e, t), ut = new Us();
export {
  H as $,
  Pr as A,
  yt as B,
