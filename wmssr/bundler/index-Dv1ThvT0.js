...
import { _ as H, d as L, F as K, G as X } from "./main-B4zompFA.js";
...
const W = /* @__PURE__ */ H(te, [["render", ne]]), ie = /* @__PURE__ */ O({
  ...
  setup(b) {
    const i = S("iApi"), { t } = N(), o = ee(), p = [
      {
        type: "point",
        icon: f(g(() => import("./point-icon-CFFtR2hX.js")))
      },
      {
        type: "polyline",
        icon: f(g(() => import("./polyline-icon-CuQWSc8d.js")))
      },
      {
        type: "polygon",
        icon: f(g(() => import("./polygon-icon-DFmSNkkb.js")))
      },
      {
        type: "circle",
        icon: f(g(() => import("./circle-icon-CIb-ZvcQ.js")))
      },
      {
        type: "rectangle",
        icon: f(g(() => import("./rectangle-icon-BcgHFv5Y.js")))
      }
    ], a = E(() => {
      const s = p.filter((v) => o.supportedTypes.some((x) => x.type === v.type));
      return s.push({
        type: "edit",
        icon: f(g(() => import("./edit-icon-CbPvVJGu.js")))
      }), s;
    }), n = (s) => {
