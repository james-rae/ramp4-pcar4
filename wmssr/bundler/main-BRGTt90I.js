...
const Hs = ["data-cy"], ji = /* @__PURE__ */ k({
    ...
    return (n, c) => {
      ...
      return v(), w("div", {
        ...
        re($i, {
          ...
          default: te(() => [
            P((v(), W(as(r.panel.route.screen), ns({ class: "h-full" }, r.panel.route.props, { panel: r.panel }), null, 16, ["panel"])), [
              [u]
            ])
          ]),
          _: 1
  ...
  setup(r) {
    ...
    return (c, u) => (v(), W(Ci, {
      ...
      default: te(() => [
        (v(!0), w(We, null, ht(o(S(t).screenSize), (p) => (v(), W(ji, {
          key: `${p.id}`,
          panel: p
        }, null, 8, ["panel"]))), 128))
      ]),
  ...
  setup(r) {
    ...
    return (n, c) => {
      ...
      return P((v(), w("li", {
        ...
        r.notification.messageList && s.value ? (v(), w("div", ar, [
      ...
      return v(), W(ei, {
        ...
        header: te(() => [
          m("div", pr, [
            ...
            i.value && i.value > 0 ? (v(), w("span", hr, B(i.value), 1)) : U("", !0)
          ])
        ]),
        default: te((c) => [
          m("div", fr, [
  ...
  setup(r) {
    ...
    return (A, b) => {
      ...
      return v(), w("div", Or, [
        ...
        a.value?.text.disabled ? U("", !0) : P((v(), w("span", Nr, [
        ...
        m("div", Fr, [
          l.value?.disabled ? U("", !0) : P((v(), w("div", Dr, [
          ...
          n.value?.disabled ? U("", !0) : (v(), W($, {
            ...
            default: te(() => [
              (v(!0), w(We, null, ht(u.value, (F, ce) => (v(), w("a", {
                ...
                F === S(s).$i18n.locale.value ? (v(), w("span", Vr, B(S(i)("map.language.curr")), 1)) : U("", !0)
              ], 10, zr))), 128))
            ]),
            _: 1
          }, 8, ["tooltip", "ariaLabel"]))
  ...
  setup(r) {
    ...
    return (o, a) => {
      ...
      return P((v(), w("button", {
        ...
        s.value && s.value > 0 ? (v(), w("span", Wr, B(s.value), 1)) : U("", !0)
      ], 8, qr)), [
        [l]
      ]);
    };
...
}), st = z("instance", () => ({ started: f(!1) })), Qr = { class: "h-full relative" }, Xr = { class: "inner-shell absolute top-0 left-0 h-full w-full pointer-events-none" }, eo = { class: "absolute top-8 w-full flex justify-center" }, to = {
  key: 1,
  class: "w-full h-full"
}, io = /* @__PURE__ */ k({
  __name: "shell",
  setup(r) {
    ...
    return (c, u) => (v(), w("div", Qr, [
      m("div", Xr, [
        ...
        a.value ? U("", !0) : (v(), W(Yr, { key: 0 })),
        re(jr, { class: "z-30" })
      ]),
      S(t).started ? (v(), W(qs, { key: 0 })) : (v(), w("div", to, u[1] || (u[1] = [
        m("div", { class: "spinner relative inset-x-1/2 inset-y-9/20" }, null, -1)
      ]))),
      (v(!0), w(We, null, ht(n(), (p) => (v(), W(us, {
...
const xo = ["content"], So = {
  ...
  setup(r, { expose: e }) {
    const { t } = Y(), i = Ye(), s = Lt(), o = ve("iApi"), a = ui("el"), l = ui("contentEl"), n = f();
    e({ el: a });
    ...
    return Je(() => {
      ...
      return P((v(), w("div", {
        ...
        r.header ? (v(), w("header", So, [
          re(T, {
            class: oe(r.panel.teleport ? "display-none" : "block sm:display-none"),
            onClick: $[0] || ($[0] = (fe) => r.panel.close())
          }, null, 8, ["class"]),
          P((v(), w("h2", Io, [
            b.$slots.header ? Me(b.$slots, "header", { key: 0 }) : (v(), w("div", _o, B(S(t)(r.panel.alertName)), 1))
          ])), [
            [I]
          ]),
          ...
          m("div", {
            ...
            r.panel.teleport ? U("", !0) : (v(), w("div", To, [
              d.value ? (v(), W(F, {
                key: 0,
  ...
  setup(r) {
    ...
    return (s, o) => {
      ...
      return v(), W(a, {
        ...
        default: te(() => [
          S(t).isFullscreen ? (v(), w("svg", sa, o[0] || (o[0] = [
            m("path", {
              d: "M0 0h24v24H0z",
              fill: "none"
            }, null, -1),
  ...
  setup(r) {
    const e = ve("iApi"), t = r, i = () => e?.event.emit(E.APPBAR_BUTTON_CLICK, t.buttonId);
    return (s, o) => {
...
}), fa = /* @__PURE__ */ Ne(ha, [["__scopeId", "data-v-f0341fec"]]), ma = z("areas-of-interest", () => ({ areas: f([]) })), ya = z("export", () => {
  const r = f({
    title: !0,
    map: !0,
    mapElements: !0,
...
const Ra = z("geosearch", () => {
  const r = f(new Ei("en", void 0)), e = f({
    type: "",
    province: "",
    extent: void 0
...
class ja extends Ba {
   ...
   */
  constructor(e) {
    super(e, "main"), this.maptip = new za(e), this.caption = new Va(e), this.mapMouseThrottle = 0;
  }
  async createMap(e, t) {
...
const Mn = /* @__PURE__ */ Object.assign({ "../fixtures/appbar/index.ts": () => import("./index-Cgx1Y9aP.js"), "../fixtures/areas-of-interest/index.ts": () => import("./index-BCVHIG-b.js"), "../fixtures/basemap/index.ts": () => import("./index-C1CAT257.js"), "../fixtures/crosshairs/index.ts": () => import("./index-BuFwKSmp.js"), "../fixtures/details/index.ts": () => import("./index-BQmJ6QwY.js"), "../fixtures/export-footnote/index.ts": () => import("./index-BYrIOT5m.js"), "../fixtures/export-legend/index.ts": () => import("./index-CgHunpC9.js"), "../fixtures/export-map/index.ts": () => import("./index-CbAEZTCv.js"), "../fixtures/export-northarrow/index.ts": () => import("./index-B2I7dNsW.js"), "../fixtures/export-scalebar/index.ts": () => import("./index-d28s5_ER.js"), "../fixtures/export-timestamp/index.ts": () => import("./index-Dg1owdPL.js"), "../fixtures/export-title/index.ts": () => import("./index-DP0AUrmt.js"), "../fixtures/export/index.ts": () => import("./index-D7PaHgqW.js"), "../fixtures/extentguard/index.ts": () => import("./index-BB3SpTb8.js"), "../fixtures/gazebo/index.ts": () => import("./index-DAwzoFa-.js"), "../fixtures/geosearch/index.ts": () => import("./index-CtoGQW8M.js"), "../fixtures/grid/index.ts": () => import("./index-DV6Khhb3.js"), "../fixtures/help/index.ts": () => import("./index-km2iB5ad.js"), "../fixtures/hilight/index.ts": () => import("./index-D4BnJfGG.js"), "../fixtures/layer-reorder/index.ts": () => import("./index-DNc7gbnH.js"), "../fixtures/legend/index.ts": () => import("./index-Do9Ou8Tn.js"), "../fixtures/mapnav/index.ts": () => import("./index-XRzh2Av7.js"), "../fixtures/metadata/index.ts": () => import("./index-D6C7Giij.js"), "../fixtures/northarrow/index.ts": () => import("./index-CJ8okv1e.js"), "../fixtures/overviewmap/index.ts": () => import("./index-CWW7Youn.js"), "../fixtures/panguard/index.ts": () => import("./index-CFMdDAwt.js"), "../fixtures/scrollguard/index.ts": () => import("./index-DBqV3bCM.js"), "../fixtures/settings/index.ts": () => import("./index-OJ1gCtQF.js"), "../fixtures/snowman/index.ts": () => import("./index-DbzLce3G.js"), "../fixtures/wizard/index.ts": () => import("./index-C4FCGdEs.js") });
class Pn extends J {
  /**
...
const Un = /* @__PURE__ */ Ne(Dn, [["render", Gn], ["__scopeId", "data-v-a3c61802"]]), Bn = /* @__PURE__ */ Object.assign({ "../fixtures/areas-of-interest/screen.vue": () => import("./screen-C7b_Uduz.js"), "../fixtures/basemap/screen.vue": () => import("./screen-BYo4_oSU.js"), "../fixtures/export/screen.vue": () => import("./screen-B1H5KhnG.js"), "../fixtures/geosearch/screen.vue": () => import("./screen-BR5tvbsB.js"), "../fixtures/grid/screen.vue": () => import("./screen-2sP0rzfT.js"), "../fixtures/help/screen.vue": () => import("./screen-CNqwgKon.js"), "../fixtures/layer-reorder/screen.vue": () => import("./screen-gJB-X31d.js"), "../fixtures/legend/screen.vue": () => import("./screen-D66UmHHd.js"), "../fixtures/metadata/screen.vue": () => import("./screen-C3sELd0V.js"), "../fixtures/settings/screen.vue": () => import("./screen-Bf0lfNkO.js"), "../fixtures/wizard/screen.vue": () => import("./screen-DejtBhMW.js") });
class Et extends J {
  /**
   * ID of this panel.
   *
...
var rt = { major: "4", minor: "12", patch: "0-beta", timestamp: "Wed May 21 15:20:33 2025 -0400", hash: "f8f99a0924d4568fdd7fe0c2f3f0c8ff800ac160" };
console.info(
