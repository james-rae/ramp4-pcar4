import{E as m,o as p}from"./VertexArrayObject-BozXCsvq.js";import{x as l,s as u}from"./FramebufferObject-Cfd-GWRN.js";import{r as c}from"./ProgramTemplate-B9283W-k.js";import{e as d,a as $}from"./ProgramTemplate-B9283W-k.js";import"./main-B1Ch7gaA.js";import{t as x}from"./NestedMap-Ddo7BfvO.js";import{w as b}from"./Texture-DwPO3zp1.js";class h{constructor(e){this._rctx=e,this._store=new x}dispose(){this._store.forAll(e=>e.dispose()),this._store.clear()}acquire(e,t,r,i){const s=this._store.get(e,t);if(s!=null)return s.ref(),s;const o=new c(this._rctx,e,t,r,i);return o.ref(),this._store.set(e,t,o),o}get test(){}}function _(n){const{options:e,value:t}=n;return typeof e[t]=="number"}function g(n){let e="";for(const t in n){const r=n[t];if(typeof r=="boolean")r&&(e+=`#define ${t}
