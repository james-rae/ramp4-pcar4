...
import { _ as H, d as L, F as X, G as ee } from "./main-CZNDm8mP.js";
...
const G = /* @__PURE__ */ H(ne, [["render", ae]]), se = /* @__PURE__ */ T({
  ...
  setup(h) {
    ...
    const p = [
      {
        type: "point",
        icon: g(_(() => import("./point-icon-Bp5pgEQF.js")))
      },
      {
        type: "polyline",
        icon: g(_(() => import("./polyline-icon-DIi3AiPh.js")))
      },
      {
        type: "polygon",
        icon: g(_(() => import("./polygon-icon-CkUjIs_B.js")))
      },
      {
        type: "circle",
        icon: g(_(() => import("./circle-icon-D-hkmXhp.js")))
      },
      {
        type: "rectangle",
        icon: g(_(() => import("./rectangle-icon-XHMNttlk.js")))
      }
    ], a = A(() => {
      const s = p.filter((u) => e.supportedTypes.some((x) => x.type === u.type));
      return s.push({
        type: "edit",
        icon: g(_(() => import("./edit-icon-BYDpoSMb.js")))
      }), s;
    }), n = (s) => {
