...
import "tiny-emitter";
import { G as le, L as Te, F as xe } from "./main-CZNDm8mP.js";
...
class ft extends Me {
  async init() {
    Object.entries(Le).forEach((b) => this.$iApi.$i18n.mergeLocaleMessage(...b)), this._parseConfig(this.config), Z(this.$vApp.$pinia).supportedTypes.forEach((b) => {
      const o = `${b.type}-icon`;
      this.$iApi.component(o, Ae(Se(/* @__PURE__ */ Object.assign({ "./icons/circle-icon.vue": () => import("./circle-icon-D-hkmXhp.js"), "./icons/edit-icon.vue": () => import("./edit-icon-BYDpoSMb.js"), "./icons/point-icon.vue": () => import("./point-icon-Bp5pgEQF.js"), "./icons/polygon-icon.vue": () => import("./polygon-icon-CkUjIs_B.js"), "./icons/polyline-icon.vue": () => import("./polyline-icon-DIi3AiPh.js"), "./icons/rectangle-icon.vue": () => import("./rectangle-icon-XHMNttlk.js") }), `./icons/${b.type}-icon.vue`, 3)));
    });
