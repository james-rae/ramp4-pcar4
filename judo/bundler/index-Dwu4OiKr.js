import { createElementBlock as r, openBlock as t, defineComponent as T, inject as S, resolveComponent as N, createVNode as b, unref as v, withCtx as O, createElementVNode as m, useTemplateRef as Q, markRaw as f, defineAsyncComponent as _, computed as A, normalizeClass as M, Fragment as z, renderList as F, createBlock as y, normalizeStyle as j, resolveDynamicComponent as I, ref as $, onMounted as U, nextTick as J, onBeforeUnmount as K, resolveDirective as V, withDirectives as P, createCommentVNode as w } from "vue";
import { _ as H, d as L, k as X, F as ee, G as te } from "./main-DFWvmD-k.js";
import { useI18n as B } from "vue-i18n";
import { throttle as R } from "es-toolkit/function";
import "tiny-emitter";
...
import "await-to-js";
import "svg.js";
import { u as oe } from "./draw-store-DYkFY3w9.js";
...
const G = /* @__PURE__ */ H(ne, [["render", ae]]), se = /* @__PURE__ */ T({
  __name: "zoom-nav",
  setup(h) {
    const { t: i } = B(), o = S("iApi"), e = R(() => o.geo.map.zoomIn(), 400, { edges: ["leading"] }), p = R(() => o.geo.map.zoomOut(), 400, { edges: ["leading"] });
    return (a, n) => {
  ...
  setup(h) {
    const i = S("iApi"), { t: o } = B(), e = oe();
    e.mapNavEl = Q("mapNavEl");
    const p = [
      {
        type: "point",
        icon: f(_(() => import("./point-icon-SDf2E1_z.js")))
      },
      {
        type: "polyline",
        icon: f(_(() => import("./polyline-icon-DqV7UYtS.js")))
      },
      {
        type: "polygon",
        icon: f(_(() => import("./polygon-icon-BldknJjT.js")))
      },
      {
        type: "circle",
        icon: f(_(() => import("./circle-icon-BUbYe6oz.js")))
      },
      {
        type: "rectangle",
        icon: f(_(() => import("./rectangle-icon-DrClPdpn.js")))
      }
    ], a = A(() => {
      const s = p.filter((u) => e.supportedTypes.some((x) => x.type === u.type));
      return s.push({
        type: "edit",
        icon: f(_(() => import("./edit-icon-BQZB5OFj.js")))
      }), s;
    }), n = (s) => {
  ...
  setup(h) {
    const i = $(void 0), o = S("iApi"), e = L(), { t: p } = B(), a = $(), n = A(() => o.getConfig().fixtures.mapnav.items.some((c) => c === "draw")), l = $(o.$rootEl?.clientHeight), s = $(!1), u = $(0), x = () => {
      ...
      X(c, a.value) && a.value._tippy.show();
    };
    U(() => {
      ...
      return t(), r("div", le, [
        P((t(), r("div", {
          ...
          n.value && l.value > u.value ? (t(), r(z, { key: 0 }, [
            b(Z),
            g[0] || (g[0] = m("span", { class: "py-1" }, null, -1))
          ], 64)) : w("", !0),
          b(se, { class: "mapnav-section bg-white-75 hover:bg-white" }),
          g[2] || (g[2] = m("span", { class: "py-1" }, null, -1)),
          m("div", ce, [
...
class nt extends ge {
  async added() {
    ...
    ), a = this.$iApi.event.on(te.COMPONENT, () => {
