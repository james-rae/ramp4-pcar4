import "tiny-emitter";
import { B as I, L as P, D as d, I as O, y as R, J as F, m as G, K as T, F as z, G as v, _ as k } from "./main-DFWvmD-k.js";
import "@arcgis/core/Color";
import "@arcgis/core/config";
import { watch as H } from "@arcgis/core/core/reactiveUtils";
...
import "proj4";
import { debounce as N } from "es-toolkit/function";
import { markRaw as x, defineComponent as D, inject as W, ref as y, computed as l, reactive as E, onMounted as j, onBeforeUnmount as q, resolveDirective as J, createElementBlock as f, openBlock as g, createElementVNode as c, normalizeStyle as S, normalizeClass as K, withDirectives as U, unref as L } from "vue";
import "pinia";
...
const Q = { class: "relative h-full w-full overflow-hidden" }, ee = { class: "absolute h-30 w-30 top-0 right-0" }, te = ["content", "aria-label"], ie = /* @__PURE__ */ D({
  __name: "overviewmap",
  setup(u) {
    const e = d(), { t: i } = X(), a = W("iApi"), t = G(), o = y(), n = l(
      () => t.activeBasemapConfig
    ), _ = l(() => e.mapConfig), M = l(() => e.basemaps), A = l(() => e.startMinimized), r = E(new Y(a)), p = y(!0), b = y(!1), m = E([]);
    j(async () => {
    ...
    return (h, s) => {
      ...
      return g(), f("div", {
        ...
        c("div", {
          ...
          c("div", Q, [
            c("div", {
              class: K(["overviewmap absolute top-0 right-0 h-192 w-192", { "cursor-move": b.value }]),
              onMousemove: $
            }, null, 34)
          ]),
          c("div", ee, [
...
}), ae = /* @__PURE__ */ k(ie, [["__scopeId", "data-v-0d0f3ee0"]]), re = { en: { "overviewmap.expand": "Expand Overview", "overviewmap.minimize": "Minimize Overview" }, fr: { "overviewmap.expand": "Développer l'aperçu", "overviewmap.minimize": "Réduire l'aperçu" } };
class We extends Z {
  added() {
