...
import Ai from "@arcgis/core/geometry/Extent";
import Ts from "@arcgis/core/geometry/Multipoint";
import Ls from "@arcgis/core/geometry/Point";
import ai from "@arcgis/core/geometry/Polygon";
import Vi from "@arcgis/core/geometry/Polyline";
...
import { fromJSON as oi } from "@arcgis/core/symbols/support/jsonUtils";
import "@arcgis/map-components/components/arcgis-sketch";
import "@arcgis/map-components/components/arcgis-swipe";
import { merge as Xt } from "es-toolkit";
import { applyConverter as Ms } from "@terraformer/spatial";
import ge from "proj4";
import { debounce as Ft, throttle as ut } from "es-toolkit/function";
import { createI18n as Ps, useI18n as se } from "vue-i18n";
import ke from "screenfull";
import { cloneDeep as wi } from "es-toolkit/object";
...
import { dsv as Ei, csv2geojson as Bs } from "csv2geojson";
...
class X extends ot {
  ...
  static fromArcServer(e, t) {
    return X.fromESRI(Ai.fromJSON(e), t);
  }
...
class Gt {
   ...
   */
  updateQuery(e) {
    const t = Xt({}, this.queryMap);
    return Xt(t, e), `${this.base}${Object.entries(t).filter(([, s]) => s !== void 0).map(([s, a], o) => `${o === 0 ? "?" : ""}${s}=${a}`).join("&")}`;
  }
}
const Hs = "EPSG:4326";
class Ws {
...
class Qs extends re {
   ...
   */
  addDefaultEvents(e) {
    return (!Array.isArray(e) || e.length === 0) && (e = Object.values(ei)), e.map((t) => this.defaultHandlerFactory(t));
  }
  /**
  ...
  defaultHandlerFactory(e) {
    ...
    switch (e) {
      ...
      case "ramp_layer_remove_checks_grid":
        t = (i) => {
          if (this.$iApi.fixture.get("grid")) {
            const s = Qt(this.$vApp.$pinia), a = s.getGridId(i.id);
            if (a === void 0) return;
      ...
      case "ramp_map_resize_updates_scalebar":
        this.$iApi.event.on(
          "map/resized",
          Ft(() => this.$iApi.geo.map.caption.updateScale(), 100),
          e
        );
        break;
      case "ramp_map_scale_updates_scalebar":
        this.$iApi.event.on(
          "map/scalechanged",
          Ft(() => this.$iApi.geo.map.caption.updateScale(), 300),
          e
        );
        break;
...
const or = ["data-cy"], Zi = /* @__PURE__ */ D({
  ...
  for (const [i, s] of e)
    t[i] = s;
  return t;
}, lr = /* @__PURE__ */ He(nr, [["__scopeId", "data-v-717e4bd7"]]), cr = ["content", "aria-label"], ni = /* @__PURE__ */ D({
    ...
    return (n, c) => {
      ...
      return V((v(), w("li", {
        ...
        g("div", yr, [
          ...
          V((v(), w("button", {
            type: "button",
            onClick: c[0] || (c[0] = ri(() => i("remove"), ["stop"])),
...
const $a = /* @__PURE__ */ He(_a, [["render", Ra]]), Me = "focus-list", Ye = "focus-item", Ca = "focus-icon", Oa = "focus-container", gt = `[${Me}],[${Oa}]`, Rt = "truncate-text", $t = "show-truncate", ht = "focused", ti = `button,input,select,a,textarea,[contenteditable],[${Me}],[${Ca}],[tabindex]`, ka = {
  mounted(r, e) {
...
function ts(r) {
  r.querySelectorAll(ti).forEach((t) => {
...
class Ma {
  ...
  setTabIndex(e, t = this.element) {
    t.querySelectorAll(ti).forEach((s) => {
    ...
    if (i.length !== 0)
      switch (e.key) {
        ...
        case " ":
          ...
          break;
        case "Tab":
          const s = this.highlightedItem.querySelectorAll(ti).length === 0, a = this.element.isEqualNode(e.target);
...
const xi = "focus-item", Pa = {
  beforeMount(r, e) {
    r.hasAttribute("id") || r.setAttribute("id", Na()), e.value ? r.setAttribute(xi, e.value) : r.toggleAttribute(xi, !0);
  }
};
function Na() {
  let r;
...
const li = "focus-container", is = "focus-list", Fa = "focus-icon", Yt = `[${is}],[${li}]`, Si = `button,input,select,a,textarea,[contenteditable],.ag-tab-guard,[${is}],[${li}],[${Fa}],[tabindex]`;
let Jt = [];
const Da = {
  mounted(r) {
...
class Ga {
   ...
   */
  constructor(e) {
    this.element = e, this.element.toggleAttribute(li, !0), this.element.tabIndex = 0, setTimeout(() => this.disableTabbing(), 600);
    const t = this;
  ...
  disableTabbing() {
    if (this.element.contains(document.activeElement))
      return;
    Array.prototype.filter.call(this.element.querySelectorAll(Si), () => !0).forEach((t) => {
      t.tabIndex = -1;
    });
  }
  /**
  ...
  enableTabbing() {
    let e;
    return Array.prototype.map.call(this.element.querySelectorAll(Si), (t) => {
...
const Ua = "truncate-text", Va = "truncate-trigger", za = {
  ...
  updated(r, e) {
    r._tippy && (r._tippy.setContent(Ii(r.textContent)), e.value && e.value.options && r._tippy.setProps(e.value.options));
  },
  unmounted(r) {
...
const Ha = ["content"], Wa = {
  ...
  setup(r, { expose: e }) {
    const { t } = se(), i = rt(), s = Ut(), a = _e("iApi"), o = bi("el"), l = bi("contentEl"), n = f(), c = f(), u = f();
    e({ el: o });
...
const ci = async (r) => {
  ...
  if (await Zo(r), e.categories.length === 0 || e.categories.includes("ADDR")) {
    const t = await pi(r), i = e.sortOrder.indexOf("ADDR"), s = i >= 0 ? i : e.sortOrder.length, a = t.filter((o) => o.type?.includes("Street")).map((o) => {
...
}, rn = "~FSA~", _i = "https://geogratis.gc.ca/services/geolocation/@{language}/locate", Ti = "https://geogratis.gc.ca/services/geoname/@{language}/geonames.json", Li = "https://geogratis.gc.ca/services/geoname/@{language}/codes/province.json", Ri = "https://geogratis.gc.ca/services/geoname/@{language}/codes/concise.json";
class $i {
  config;
  constructor(e, t) {
    let i, s, a, o;
    const l = t?.serviceUrls;
    l ? (i = l.geoLocation ? l.geoLocation : _i, s = l.geoNames ? l.geoNames : Ti, a = l.geoProvince ? l.geoProvince : Li, o = l.geoTypes ? l.geoTypes : Ri) : (i = _i, s = Ti, a = Li, o = Ri), i = i.replace("@{language}", e), s = s.replace("@{language}", e), a = a.replace("@{language}", e), o = o.replace("@{language}", e);
    let n = "";
...
var as = /* @__PURE__ */ ((r) => (r.Visibility = "visibilityButton", r.Expand = "expandButton", r))(as || {}), ii = /* @__PURE__ */ ((r) => (r.Item = "item", r.Placeholder = "placeholder", r.Error = "error", r))(ii || {});
class os extends re {
  _uid;
  _name;
  _type;
...
class Je extends os {
  ...
  load(e) {
    const t = e instanceof hi ? e : this.$iApi.geo.layer.getLayer(this._layerId ?? this._layerUid);
    t && (this.layer = t, this._layerRedrawing = t.mapLayer && t.drawState !== fe.UP_TO_DATE, t.loadPromise().then(() => {
      this._layerInitVis = typeof this._layerInitVis < "u" ? this._visibility : t.visibility, super.load(), this.toggleVisibility(this._layerInitVis, !0, !0), t.visibility || this.setSymbologyVisibility(void 0, !1), this.handlers.push(
        this.$iApi.event.on(
          ...
          (i) => {
            i.layer.uid === this.layer.uid && this._type === ii.Item && this.toggleVisibility(i.visibility, !0, !0);
          }
        )
      ), this.handlers.push(
        this.$iApi.event.on(
...
const nn = W("legend", () => {
  ...
  function a(n) {
    if (n.parent === void 0)
      ...
      if (!(n.item instanceof Oi) && !(n.item instanceof Je)) {
  ...
  function o(n) {
    const c = (u) => (u = u.filter((p) => (p === n && !p.children.length && p.onRemoved(), p !== n)), u.forEach((p) => {
      ...
      (p) => !(p instanceof Oi && !p.children.length && p.content === "")
    ), u);
    e.value = c(e.value);
  }
  function l(n) {
...
class fn {
   ...
   */
  reloadWorker(e, t) {
    const i = pt(this.$vApp.$pinia), s = qe(this.$vApp.$pinia), a = Ae(this.$vApp.$pinia), o = xe(this.$vApp.$pinia), l = Ne(this.$vApp.$pinia), n = Qt(this.$vApp.$pinia), c = !!e;
...
function mn(r, e) {
  ...
  t.use(({ store: o }) => {
    const l = wi(o.$state);
    o.$reset = () => o.$patch(wi(l));
  });
  const i = sr(), s = Ui($a).use(i).use(Ns, {
    directive: "tippy",
    // => v-tippy
    component: "tippy"
    // => <tippy/>
  }).use(t);
  s.directive("focus-container", Da), s.directive("focus-list", ka), s.directive("focus-item", Pa), s.directive("truncate", za), s.component("panel-screen", eo), s.component("pin", ro), s.component("close", no), s.component("back", uo), s.component("expand", yo), s.component("panel-options-menu", To), s.component("dropdown-menu", ni), s.component("minimize", bo), s.component("right", Eo), s.component("left", Io), s.component("fullscreen-nav-button", $o), s.component("geolocator-nav-button", Co), s.component("home-nav-button", Oo), s.component("mapnav-button", Po), s.component("appbar-button", Go), s.component("transition", Di), s.component("transition-group", Gi), s.config.globalProperties.$iApi = e, s.config.globalProperties.$pinia = t, s.config.idPrefix = `ramp-${r.id || it.sharedUtils.generateUUID()}`, s.provide("iApi", e);
  const a = s.mount(r);
...
class di {
  ...
  static async create(e) {
    const t = new di(e), i = e.layers.map((o) => {
      const l = {
        url: o.url,
        opacity: o.opacity
      };
...
class yn extends re {
  ...
  async createMap(e, t) {
    ...
    }, s = e.basemaps.map((n) => di.create(n)), o = (await Promise.all(s)).filter((n) => (n.createErr && i(n), n.esriBasemap.baseLayers.length > 0));
    o.forEach((n) => {
...
class bn extends yn {
  ...
  removeLayer(e) {
    ...
    let t;
    if (e instanceof hi ? t = e : t = this.$iApi.geo.layer.getLayer(e), !t)
...
class $n extends re {
  ...
  extractCsvFields(e, t = ",") {
    return Ei.dsvFormat(t).parseRows(e)[0].map((s) => ({ name: s, type: Ue.STRING }));
  }
  /**
  ...
  filterCsvLatLonFields(e, t = ",") {
    const i = Ei.dsvFormat(t).parseRows(e), s = i[0], a = {
...
class yi extends re {
  ...
  constructor(e, t) {
    super(e), this.aac = new ki(), this.details = t;
  }
  /**
  ...
  getAttribs() {
    return this.loadPromise || (this.aac = new ki(), this.loadPromise = this.loadPromiseGenerator()), this.loadPromise;
  }
  abortAttribLoad() {
...
class ol extends gi {
  ...
  constructor(e, t, i = !1) {
    if (super(e, t, i), this.valField = this.cleanFieldName(e.field, t), e.classBreakInfos.forEach((s, a) => {
      const o = a === 0, l = new Pi(this, s.minValue, s.maxValue, o);
...
const ul = /* @__PURE__ */ Object.assign({ "../fixtures/appbar/index.ts": () => import("./index-jD_x63tQ.js"), "../fixtures/areas-of-interest/index.ts": () => import("./index-yusNNXeZ.js"), "../fixtures/basemap/index.ts": () => import("./index-DzU-Or92.js"), "../fixtures/crosshairs/index.ts": () => import("./index-BZgBCW1y.js"), "../fixtures/details/index.ts": () => import("./index-CWLlSd4N.js"), "../fixtures/draw/index.ts": () => import("./index-C0rRXOgY.js"), "../fixtures/export-footnote/index.ts": () => import("./index-D1oxzYGA.js"), "../fixtures/export-legend/index.ts": () => import("./index-A9UbJeic.js"), "../fixtures/export-map/index.ts": () => import("./index-DrvHFMNI.js"), "../fixtures/export-northarrow/index.ts": () => import("./index-Bvj4vQcy.js"), "../fixtures/export-scalebar/index.ts": () => import("./index-m_l8_Mqz.js"), "../fixtures/export-timestamp/index.ts": () => import("./index-DhVRys3P.js"), "../fixtures/export-title/index.ts": () => import("./index-CUbQp_D8.js"), "../fixtures/export/index.ts": () => import("./index-CMB9YsCG.js"), "../fixtures/extentguard/index.ts": () => import("./index-CALs9BCM.js"), "../fixtures/gazebo/index.ts": () => import("./index-DCygdE5q.js"), "../fixtures/geosearch/index.ts": () => import("./index-BVPbO9ZM.js"), "../fixtures/grid/index.ts": () => import("./index-CXB0WGr1.js"), "../fixtures/help/index.ts": () => import("./index-C5nJdvLN.js"), "../fixtures/hilight/index.ts": () => import("./index-CKgX93LC.js"), "../fixtures/keyboardnav/index.ts": () => import("./index-Cvd5CdCb.js"), "../fixtures/layer-reorder/index.ts": () => import("./index-Ch3cItKH.js"), "../fixtures/legend/index.ts": () => import("./index-C7-Zugvg.js"), "../fixtures/mapnav/index.ts": () => import("./index-Dwu4OiKr.js"), "../fixtures/metadata/index.ts": () => import("./index-C9Bvq4oY.js"), "../fixtures/northarrow/index.ts": () => import("./index-9F_lIlhu.js"), "../fixtures/overviewmap/index.ts": () => import("./index-tlMeXAyW.js"), "../fixtures/panguard/index.ts": () => import("./index-OpMC2UEW.js"), "../fixtures/scrollguard/index.ts": () => import("./index-BfNa083g.js"), "../fixtures/settings/index.ts": () => import("./index-BKo__-ik.js"), "../fixtures/snowman/index.ts": () => import("./index-BNlIE8nX.js"), "../fixtures/swipe/index.ts": () => import("./index-D417vXO3.js"), "../fixtures/wizard/index.ts": () => import("./index-Bw-S8um_.js") });
class pl extends re {
  /**
  ...
  async add(e, t) {
    ...
    if (t) {
      ...
      i = vi.updateBaseToInstance(new t(), e, this.$iApi);
    } else {
...
const yl = /* @__PURE__ */ He(fl, [["render", ml], ["__scopeId", "data-v-a3c61802"]]), gl = /* @__PURE__ */ Object.assign({ "../fixtures/areas-of-interest/screen.vue": () => import("./screen-oFoRjrkO.js"), "../fixtures/basemap/screen.vue": () => import("./screen-j4T-9Y6C.js"), "../fixtures/export/screen.vue": () => import("./screen-Dg8xBBQr.js"), "../fixtures/geosearch/screen.vue": () => import("./screen-DJNUDd2f.js"), "../fixtures/grid/screen.vue": () => import("./screen-ChRLu0ox.js"), "../fixtures/help/screen.vue": () => import("./screen-B0ioMT_i.js"), "../fixtures/layer-reorder/screen.vue": () => import("./screen-BEAzK0RU.js"), "../fixtures/legend/screen.vue": () => import("./screen-DnC4bX7d.js"), "../fixtures/metadata/screen.vue": () => import("./screen-DOyda21S.js"), "../fixtures/settings/screen.vue": () => import("./screen-CSC2nt_p.js"), "../fixtures/wizard/screen.vue": () => import("./screen-BYr47h7f.js") });
class Mt extends re {
  /**
   * ID of this panel.
   *
  ...
  return r.controls && r.controls.length > 0 && (e.controls = vt(r.controls, t), r.controls.includes("visibility") && e.controls.push("visibilityButton"), (r.controls.length !== 1 || r.controls[0] !== "visibility") && console.warn(
    ...
    if (i.layerId)
      ...
      typeof i.collapse < "u" && console.warn(
        ...
        a.layerId ? s.children.push(Ni(a)) : s.children.push(si(a));
      }), e.children.push(s);
    } else
      e.children.push(si(i));
  }), e;
}
function Ni(r) {
  const e = r, t = [
...
var dt = { major: "4", minor: "19", patch: "0-beta", timestamp: "Thu Mar 12 14:15:45 2026 -0400", hash: "c48c87b249cabc92e0417beae0ad55cb609690c1" };
console.info(
