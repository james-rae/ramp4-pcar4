...
import "proj4";
import { debounce as U } from "es-toolkit/function";
...
const se = { class: "rv-geosearch-bar relative h-26 mx-8 mb-8" }, re = ["placeholder", "value", "aria-label"], ne = { class: "absolute inset-y-0 right-8 grid w-10 place-content-center" }, ae = ["aria-label", "content"], ie = /* @__PURE__ */ T({
  __name: "search-bar",
  setup(S) {
    const { t: i } = R(), p = E(), l = X(), _ = y(() => p.searchVal), m = y(
  ...
  __name: "top-filters",
  setup(S) {
    const { t: i } = R(), p = z("iApi"), l = E(), _ = M([]), m = M([]), f = M([]), h = y(() => l.queryParams), v = y(() => p.language), e = (d) => l.setProvince(d), c = (d) => l.setType(d), o = () => {
      e({}), c({});
    }, x = () => {
      ...
      return t(), s("div", le, [
        a("div", ce, [
          L((t(), s("select", {
            ...
            (t(!0), s(P, null, j(_.value, (r) => L((t(), s("option", {
              key: r.code
            }, [
              k(g(r.name), 1)
            ])), [
        ...
        a("div", de, [
          L((t(), s("select", {
            ...
            (t(!0), s(P, null, j(m.value, (r) => (t(), s("option", {
              key: r.code
            }, g(r.name), 1))), 128))
          ], 40, me)), [
            [n]
  ...
  setup(S) {
    const { t: i } = R(), p = z("iApi"), l = E(), _ = y(() => l.resultsVisible), m = U((e) => {
      h(e).then((c) => {
        f({
          extent: c,
          visible: _.value
    ...
    return Z(() => {
      p.event.on(J.MAP_EXTENTCHANGE, m, "geosearch_map_extent");
    }), I(() => {
...
const Ce = /* @__PURE__ */ Y(we, [["render", Se], ["__scopeId", "data-v-0a8d1c36"]]), Te = { class: "flex flex-col h-full" }, Ee = {
...
}, Pe = ["onClick"], je = { class: "rv-result-description px-8" }, ze = { class: "flex-1 text-left truncate font-bold leading-tight" }, Be = ["innerHTML"], Ne = {
  key: 0,
  ...
  setup(S) {
    const { t: i } = R(), p = z("iApi"), l = E(), _ = y(() => l.searchVal.replace(/["!*$+?^{}()|[\]\\]/g, "").trim()), m = y(() => l.searchResults), f = y(() => l.loadingResults), h = y(() => l.failedServices), v = y(() => l.GSservice.config.fsaUrl), e = async (o) => {
    ...
    return (o, x) => {
      const d = W("panel-screen"), b = C("truncate"), n = C("focus-item"), w = C("focus-list");
      return t(), B(d, { panel: S.panel }, {
        header: N(() => [
        ...
        content: N(() => [
          a("div", Te, [
            ...
            m.value.length > 0 ? L((t(), s("ul", Ae, [
              (t(!0), s(P, null, j(m.value, (r, D) => (t(), s("li", {
                class: "relative h-56",
                key: D
              }, [
                L((t(), s("button", {
                  ...
                  a("div", je, [
                    L((t(), s("div", ze, [
                      ...
                      r.location.province ? (t(), s("span", Ne, g(r.location.city ? " " + r.location.city + ", " + r.location.province.abbr : " " + r.location.province.abbr), 1)) : $("", !0),
