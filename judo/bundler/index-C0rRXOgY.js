...
import "tiny-emitter";
import { G as le, L as Te, F as xe } from "./main-DFWvmD-k.js";
...
class ft extends Me {
  async init() {
    Object.entries(Le).forEach((b) => this.$iApi.$i18n.mergeLocaleMessage(...b)), this._parseConfig(this.config), Z(this.$vApp.$pinia).supportedTypes.forEach((b) => {
      const o = `${b.type}-icon`;
      this.$iApi.component(o, Ae(Se(/* @__PURE__ */ Object.assign({ "./icons/circle-icon.vue": () => import("./circle-icon-BUbYe6oz.js"), "./icons/edit-icon.vue": () => import("./edit-icon-BQZB5OFj.js"), "./icons/point-icon.vue": () => import("./point-icon-SDf2E1_z.js"), "./icons/polygon-icon.vue": () => import("./polygon-icon-BldknJjT.js"), "./icons/polyline-icon.vue": () => import("./polyline-icon-DqV7UYtS.js"), "./icons/rectangle-icon.vue": () => import("./rectangle-icon-DrClPdpn.js") }), `./icons/${b.type}-icon.vue`, 3)));
    });
