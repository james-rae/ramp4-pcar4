import { bB as FixtureInstance, i6 as useLegendStore, iD as SectionItem, iE as LayerItem, iF as LegendItem, iG as LayerInstance, iH as LayerType, bG as defineComponent, bH as useI18n, bI as inject, bN as resolveComponent, bP as openBlock, bQ as createBlock, bR as withCtx, bU as unref, fH as createBaseVNode, he as markRaw, hf as useAppbarStore, hg as useMapnavStore } from './main-0587906a.js';
import { _ as _sfc_main$1 } from './screen.vue_vue_type_script_setup_true_lang-868dea3c.js';
  ...
  updateLegend(layer) {
    const updateLayerItem = (sourceLayer, error) => {
      ...
      if (error) {
        ...
        layerItem?.load(
          sourceLayer instanceof LayerInstance ? sourceLayer : void 0
        );
      }
    };
