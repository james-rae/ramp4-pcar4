import "tiny-emitter";
import { x as I, L as O, y as d, z as P, v as R, B as z, l as G, D as F, F as T, G as l, _ as k } from "./main-mxPddRfg.js";
...
import { markRaw as E, defineComponent as N, inject as D, ref as y, computed as v, reactive as x, onMounted as W, onBeforeUnmount as j, resolveDirective as q, openBlock as f, createElementBlock as g, createElementVNode as c, normalizeStyle as S, normalizeClass as U, withDirectives as X, unref as L } from "vue";
import "pinia";
...
const K = { class: "relative h-full w-full overflow-hidden" }, Q = { class: "absolute h-30 w-30 top-0 right-0" }, ee = ["content", "aria-label"], te = /* @__PURE__ */ N({
  __name: "overviewmap",
  setup(u) {
    const e = d(), { t: i } = Y(), a = D("iApi"), t = G(), o = y(), n = v(() => t.activeBasemapConfig), _ = v(() => e.mapConfig), b = v(() => e.basemaps), A = v(() => e.startMinimized);
    let r = x(new Z(a));
    const p = y(!0), M = y(!1), m = x([]);
    W(async () => {
...
}), ie = /* @__PURE__ */ k(te, [["__scopeId", "data-v-cee79589"]]), ae = { en: { "overviewmap.expand": "Expand Overview", "overviewmap.minimize": "Minimize Overview" }, fr: { "overviewmap.expand": "Développer l'aperçu", "overviewmap.minimize": "Réduire l'aperçu" } };
class ke extends J {
  added() {
