import { defineComponent as _, inject as C, resolveDirective as l, openBlock as i, createElementBlock as n, withDirectives as s, normalizeClass as v, unref as h, createElementVNode as o, createCommentVNode as g, toDisplayString as x, withModifiers as b, withKeys as T, vShow as z, computed as I, ref as j, onMounted as A, resolveComponent as B, createBlock as M, withCtx as w, createTextVNode as O, Fragment as S, renderList as V, createVNode as $ } from "vue";
import { E, _ as N, c as D } from "./main-mxPddRfg.js";
...
}), R = /* @__PURE__ */ N(Q, [["__scopeId", "data-v-06be115a"]]), U = { class: "h-600 overflow-y-auto" }, W = { class: "mx-5" }, X = { key: 0 }, ge = /* @__PURE__ */ _({
  __name: "screen",
  props: {
    panel: {
      type: Object
          ...
          o("div", U, [
            o("div", W, [
              r.value.length > 0 ? s((i(), n("ul", X, [
                (i(!0), n(S, null, V(r.value, (f, k) => (i(), n("li", { key: k }, [
                  $(R, {
                    area: f,
                    "show-thumbnail": h(a),
