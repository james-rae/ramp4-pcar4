...
import { ref as h, computed as N, markRaw as se, defineComponent as O, inject as Ae, reactive as be, watch as Et, onBeforeUnmount as ct, resolveDirective as M, withDirectives as P, openBlock as g, createElementBlock as w, withKeys as rs, withModifiers as Zt, onMounted as Ye, normalizeClass as oe, normalizeStyle as Li, createVNode as re, Transition as Ri, withCtx as ee, createBlock as q, resolveDynamicComponent as os, mergeProps as as, TransitionGroup as $i, Fragment as qe, renderList as ut, unref as _, nextTick as Rt, renderSlot as ke, createElementVNode as m, vShow as ns, resolveComponent as K, createTextVNode as st, toDisplayString as U, createCommentVNode as G, onUpdated as ls, Teleport as cs, getCurrentInstance as us, useTemplateRef as ci, createApp as Ci, toRaw as Se, h as ps, render as Dt, defineAsyncComponent as ds } from "vue";
...
import { createI18n as Es, useI18n as W } from "vue-i18n";
...
class Ms {
  ...
  async projectExtent(e, t) {
    ...
    const a = new ie("warpy", [o], t.sr, !0), l = await this.projectGeometry(e, a), n = l.toArray().pop() || [], c = n.map((f) => f[0]), u = n.map((f) => f[1]), p = Math.min.apply(null, c), d = Math.max.apply(null, c), b = Math.min.apply(null, u), y = Math.max.apply(null, u);
    return D.fromParams(t.id + "_projected", p, b, d, y, l.sr);
  }
}
class Ps {
  // useful functions
...
const Tt = B("appbar", () => {
  ...
  function n(p, d) {
    ...
    const b = t.value.findIndex((y) => y === p.id);
  ...
  function c(p) {
    ...
    if (r.value = d, p.mapLayer) {
      const b = t.value.filter((y) => y !== p.id);
      t.value = b;
    }
  }
  function u(p) {
...
const qs = ["data-cy"], Vi = /* @__PURE__ */ O({
  ...
  function R() {
    ...
    for (let Ne = n.value.length - 1; Ne >= 0; Ne--) {
      const Qe = n.value[Ne];
      let Le = Qe.width || ae;
      if (s.value ? Le = S : Le += fe, Qe.id === "grid" && (Le = Math.max(Math.min(Le, S), ni)), (S >= Le && !s.value || C.length === 0) && (S -= Le, C.unshift(Qe)), Qe.id === "grid" && S < ni)
        break;
    }
    ...
    !C.includes(r.value) && !s.value) {
      ...
      const Qe = n.value.indexOf(r.value), Le = n.value.indexOf(Ne), Ft = n.value.slice();
      Le > -1 && (Ft.splice(Qe, 1), Ft.splice(Le, 0, r.value)), n.value = Ft;
    }
    i.value = S, u.value = C;
  }
  function H(S) {
  ...
  setup(r) {
    ...
    return (c, u) => (g(), q($i, {
      ...
      default: ee(() => [
        (g(!0), w(qe, null, ut(o(_(t).screenSize), (p) => (g(), q(Vi, {
          key: `${p.id}`,
          panel: p
        }, null, 8, ["panel"]))), 128))
      ]),
  ...
  for (const [i, s] of e)
    t[i] = s;
  return t;
}, Hs = /* @__PURE__ */ Pe(Ws, [["__scopeId", "data-v-11f38702"]]), Ys = ["content", "aria-label"], Xt = /* @__PURE__ */ O({
  ...
  setup(r) {
    ...
    return Ye(() => {
      ...
      return g(), w("div", {
        ...
        P(m("div", {
          onClick: d[0] || (d[0] = (y) => t.value.update()),
...
}), Js = { class: "h-full flex flex-col" }, Zs = { class: "w-full flex mb-6" }, Ks = ["content", "aria-label"], Qs = /* @__PURE__ */ O({
  __name: "screen",
  props: {
    panel: {
      type: Object,
  ...
  setup(r) {
    const e = Te(), { t } = W(), i = N(() => e.notificationNumber), s = () => e.clearAll();
    return (o, a) => {
      const l = K("panel-screen"), n = M("tippy");
      return g(), q(l, { panel: r.panel }, {
        header: ee(() => [
          st(U(_(t)("notifications.title")), 1)
        ]),
        content: ee(() => [
          m("div", Js, [
            m("div", Zs, [
...
const er = ["content"], tr = { class: "flex items-center text-left" }, ir = { class: "select-text cursor-text" }, sr = ["content"], rr = {
  key: 0,
  class: "text-left"
}, or = /* @__PURE__ */ O({
  ...
  setup(r) {
    ...
    return (n, c) => {
      ...
      return P((g(), w("li", {
        ...
        m("div", tr, [
          m("span", null, [
            st(U(o[r.notification.type]) + " ", 1),
            m("span", ir, U(r.notification.message), 1)
          ]),
        ...
        r.notification.messageList && s.value ? (g(), w("div", rr, [
          (g(!0), w(qe, null, ut(r.notification.messageList, (p, d) => (g(), w("p", {
    ...
    return (l, n) => {
      ...
      return g(), w("div", null, [
        a.value.length > 0 ? P((g(), w("ul", {
          ...
          (g(!0), w(qe, null, ut(a.value, (d, b) => (g(), w(qe, {
            key: d.message + b
          }, [
            b > 0 ? (g(), w("div", nr)) : G("", !0),
            P(re(or, {
          ...
          m("span", null, U(_(t)("notifications.empty")), 1),
          n[2] || (n[2] = m("span", { style: { "flex-grow": "6" } }, null, -1))
        ]))
      ]);
    };
  }
}), cr = { class: "flex items-center hover:text-white" }, ur = ["aria-label"], pr = {
  key: 0,
  class: "number rounded-full w-18 text-white"
}, dr = { class: "notification-dropdown pointer-events-auto bg-white rounded text-center text-black w-500 h-256 flex flex-col p-0" }, hr = { class: "pb-8 border-b border-gray-600" }, fr = { class: "absolute flex right-3 top-3" }, mr = ["content", "aria-label"], yr = /* @__PURE__ */ O({
      ...
      return g(), q(Xt, {
        ...
        header: ee(() => [
          m("div", cr, [
            ...
            i.value && i.value > 0 ? (g(), w("span", pr, U(i.value), 1)) : G("", !0)
          ])
        ]),
        default: ee((c) => [
          m("div", dr, [
            m("div", null, [
              m("h4", hr, U(_(t)("notifications.title")), 1),
              m("div", fr, [
                P((g(), w("button", {
                  type: "button",
                  onClick: s,
...
}), gr = /* @__PURE__ */ Pe(yr, [["__scopeId", "data-v-3623a7d2"]]), vr = { class: "flex hover:text-white" }, br = ["aria-label"], wr = { class: "about-ramp-dropdown pointer-events-auto bg-white rounded w-256 h-50" }, Ar = { class: "pb-8 border-b border-gray-600 mb-10" }, Er = { class: "absolute right-5 top-5" }, xr = { class: "select-text" }, Sr = { class: "font-bold cursor-text" }, _r = { class: "text-sm cursor-text" }, Ir = { class: "text-sm cursor-text" }, Tr = /* @__PURE__ */ O({
  ...
  setup(r) {
    const { t: e } = W(), t = N(() => `${ht.major}.${ht.minor}.${ht.patch}`), i = N(() => ht.hash.slice(0, 9)), s = N(() => {
        ...
        default: ee((u) => [
          m("div", wr, [
            m("div", null, [
              ...
              m("div", xr, [
                m("div", null, [
                  m("span", Sr, U(t.value), 1),
                  m("span", _r, " [" + U(i.value) + "] ", 1)
                ]),
                m("div", null, [
                  m("span", Ir, U(s.value), 1)
                ]),
                a[1] || (a[1] = m("div", { class: "mt-5" }, [
                  m("a", {
...
}), Lr = /* @__PURE__ */ Pe(Tr, [["__scopeId", "data-v-dd0345a4"]]), Rr = { class: "map-caption absolute bottom-0 h-29 sm:h-38 flex justify-end pointer-events-auto cursor-default select-none text-gray-200 bg-black-75 left-0 right-0 py-2 sm:py-6" }, $r = {
  key: 0,
  class: "relative top-2 sm:top-1 ml-4 sm:ml-0 shrink-0"
}, Cr = ["href", "aria-label"], Or = ["src", "alt"], kr = {
  key: 1,
  class: "relative ml-10 top-2 text-sm sm:text-base"
}, Mr = { class: "flex min-w-fit justify-end" }, Pr = {
  key: 0,
  class: "pl-8 px-14 sm:block display-none relative top-2"
}, Nr = ["aria-pressed", "aria-label", "content"], Fr = { class: "relative top-1 text-sm sm:text-base" }, Dr = { class: "text-gray-200 hover:text-white text-sm sm:text-base pb-5" }, Gr = ["onClick"], Ur = {
  key: 0,
  class: "sr-only"
}, Br = /* @__PURE__ */ O({
  __name: "map-caption",
  setup(r) {
    const e = Ge(), t = pe(), { t: i } = W(), s = Ae("iApi"), o = N(() => e.scale), a = N(() => e.attribution), l = N(() => e.coords), n = N(() => e.langtoggle), c = N(() => t.config.map), u = h([]), p = be([]);
    p.push(
      Et(c, (f) => {
    ...
    }, y = (f = !1) => i(f ? "map.toggleScaleToMetric" : "map.toggleScaleToImperial");
    return (f, A) => {
      const v = K("dropdown-menu"), $ = M("truncate"), L = M("tippy");
      return g(), w("div", Rr, [
        re(Lr, {
          class: "sm:block display-none ml-8 mr-4",
          position: "top-end"
        }),
        re(gr, { class: "sm:block display-none" }),
        a.value?.logo.disabled ? G("", !0) : (g(), w("span", $r, [
          m("a", {
        ...
        a.value?.text.disabled ? G("", !0) : P((g(), w("span", kr, [
          st(U(a.value?.text.value), 1)
        ])), [
          [$, {
            options: {
              placement: "top",
        ...
        A[0] || (A[0] = m("span", { class: "flex-grow w-15" }, null, -1)),
        m("div", Mr, [
          l.value?.disabled ? G("", !0) : P((g(), w("div", Pr, [
            st(U(l.value?.formattedString), 1)
          ])), [
            [$, {
              options: {
                hideOnClick: !1,
          ...
          n.value?.disabled ? G("", !0) : (g(), q(v, {
            ...
            header: ee(() => [
              m("span", Dr, U(_(i)("map.language.short")), 1)
            ]),
            default: ee(() => [
              (g(!0), w(qe, null, ut(u.value, (R, H) => (g(), w("a", {
                key: `${R}-${H}`,
                class: oe(["flex-auto items-center text-sm sm:text-base cursor-pointer", { "font-bold": R === _(s).$i18n.locale.value }]),
                href: "javascript:;",
                onClick: (he) => d(R)
              }, [
                st(U(_(i)("map.language." + R)) + " ", 1),
                R === _(s).$i18n.locale.value ? (g(), w("span", Ur, U(_(i)("map.language.curr")), 1)) : G("", !0)
              ], 10, Gr))), 128))
            ]),
            _: 1
          }, 8, ["tooltip", "ariaLabel"]))
  ...
  setup(r) {
    ...
    return (o, a) => {
      ...
      return P((g(), w("button", {
        ...
        s.value && s.value > 0 ? (g(), w("span", Vr, U(s.value), 1)) : G("", !0)
      ], 8, zr)), [
        [l]
      ]);
    };
  }
}), qr = /* @__PURE__ */ Pe(jr, [["__scopeId", "data-v-a451db5c"]]), Wr = { class: "flex items-center mb-20" }, Hr = { class: "text-xl" }, Yr = /* @__PURE__ */ O({
  __name: "keyboard-instructions",
  setup(r) {
    const e = Ae("iApi"), { t } = W(), i = h(!1), s = h(["app", "lists", "map"]), o = h([]), a = h(null), l = h(null);
    Ye(() => {
      o.value.push(
    ...
    return (c, u) => {
      ...
      return i.value ? (g(), w("div", {
        ...
        m("div", {
          ...
          m("div", Wr, [
            m("h2", Hr, U(_(t)("keyboardInstructions.title")), 1),
            re(p, {
              class: "ml-auto",
              onClick: u[0] || (u[0] = (d) => i.value = !1)
            })
          ]),
          (g(!0), w(qe, null, ut(s.value, (d) => (g(), w("p", {
...
}), et = B("instance", () => ({ started: h(!1) })), Jr = { class: "h-full relative" }, Zr = { class: "inner-shell absolute top-0 left-0 h-full w-full pointer-events-none" }, Kr = { class: "absolute top-8 w-full flex justify-center" }, Qr = {
  key: 1,
  class: "w-full h-full"
}, Xr = /* @__PURE__ */ O({
  __name: "shell",
  setup(r) {
    const e = Ae("iApi"), t = et(), i = ge(), s = He(), { t: o } = W(), a = N(() => i.items.appbar), l = () => {
      e?.event.emit("openKeyboardInstructions");
    }, n = () => (
      // @ts-ignore
      s.teleported
    );
    return (c, u) => (g(), w("div", Jr, [
      m("div", Zr, [
        ...
        re(Yr),
        re(Hs, { class: "panel-stack sm:flex absolute inset-0 overflow-hidden sm:p-12 z-10 sm:pl-80 xs:pl-40 sm:pb-48 xs:pb-28 xs:pr-0 sm:pr-40" }),
        a.value ? G("", !0) : (g(), q(qr, { key: 0 })),
        re(Br, { class: "z-30" })
      ]),
      _(t).started ? (g(), q(js, { key: 0 })) : (g(), w("div", Qr, u[1] || (u[1] = [
        m("div", { class: "spinner relative inset-x-1/2 inset-y-9/20" }, null, -1)
      ]))),
      (g(!0), w(qe, null, ut(n(), (p) => (g(), q(cs, {
...
}), eo = /* @__PURE__ */ Pe(Xr, [["__scopeId", "data-v-6c131943"]]), to = O({
  name: "App",
  components: { Shell: eo },
  setup() {
    const r = us();
...
const oo = /* @__PURE__ */ Pe(to, [["render", ro]]), xe = "focus-list", Ve = "focus-item", ao = "focus-icon", no = "focus-container", at = `[${xe}],[${no}]`, vt = "truncate-text", bt = "show-truncate", it = "focused", Ht = `button,input,select,a,textarea,[contenteditable],[${xe}],[${ao}],[tabIndex]`, lo = {
  mounted(r, e) {
    +r.getAttribute("tabindex") <= 0 && r.setAttribute("tabindex", "0"), r.toggleAttribute(xe, !0), new co(r, e.value);
  },
  updated(r) {
    Wi(r);
  }
...
function Wi(r) {
  r.querySelectorAll(Ht).forEach((t) => {
    if (t.closest(at) === r || t.closest(at) === t && t.parentElement.closest(at) === r)
      if (t.closest(`[${xe}],.${it}`).classList.contains(it))
...
class co {
  ...
  setTabIndex(e, t = this.element) {
    t.querySelectorAll(Ht).forEach((s) => {
      (e === -1 || s.closest(at) === this.element || s.closest(at) === s && s.parentElement.closest(at) === this.element || s.closest(`[${xe}],.${it}`).classList.contains(it)) && s.setAttribute("tabindex", e.toString());
    });
  }
  /**
   ...
   */
  defocusItem(e) {
    e.classList.remove(it), this.setTabIndex(-1, e), e._tippy && e._tippy.hide(), e.getAttribute(Ve) === bt && e.querySelector(`[${vt}]`)?._tippy?.hide();
  }
  /**
   ...
   */
  focusItem(e) {
    e.classList.add(it), this.setAriaActiveDescendant(e), this.setTabIndex(0, e), e.scrollIntoView({ block: "nearest" }), e._tippy && !this.isTapped && e._tippy.show(), e.getAttribute(Ve) === bt && e.querySelector(`[${vt}]`)?._tippy?.show(), this.isTapped = !1;
  }
  /**
...
const fi = "focus-item", uo = {
  beforeMount(r, e) {
    r.hasAttribute("id") || r.setAttribute("id", po()), e.value ? r.setAttribute(fi, e.value) : r.toggleAttribute(fi, !0);
  }
};
function po() {
  let r;
...
const ei = "focus-container", Hi = "focus-list", ho = "focus-icon", Ut = `[${Hi}],[${ei}]`, mi = `button,input,select,a,textarea,[contenteditable],.ag-tab-guard,[${Hi}],[${ei}],[${ho}],[tabIndex]`;
let Bt = [];
const fo = {
  mounted(r) {
    [...document.querySelectorAll(".inner-shell")].some((t) => t.contains(r)) && Bt.push(new mo(r));
  },
  beforeUnmount(r) {
...
const yo = "truncate-text", go = "truncate-trigger", vo = {
  beforeMount(r, e) {
    !r.classList.contains("truncate") && !e.value?.noTruncateClass && r.classList.add("truncate"), r.toggleAttribute(yo, !0);
  },
  mounted(r, e) {
    let t;
    e.value && e.value.externalTrigger && (t = r.closest(`[${go}]`)), _s(r, {
...
const wo = ["content"], Ao = {
  ...
  setup(r, { expose: e }) {
    const { t } = W(), i = He(), s = Tt(), o = Ae("iApi"), a = ci("el"), l = ci("contentEl"), n = h();
    e({ el: a });
    const c = r, u = N(() => o?.fixture.get("appbar") ? s.temporary : []), p = N(() => i.mobileView), d = N(() => i.reorderable), b = (v) => v.scrollHeight > v.clientHeight, y = () => !p.value && !c.panel.teleport, f = (v) => {
    ...
    return Ye(() => {
      ...
      const L = K("back"), R = K("panel-options-menu"), H = K("left"), he = K("right"), pt = K("pin"), Mt = K("expand"), Pt = K("minimize"), Nt = K("close"), S = M("truncate"), C = M("focus-item"), ae = M("tippy");
      return P((g(), w("div", {
        ...
        r.header ? (g(), w("header", Ao, [
          re(L, {
            class: oe(r.panel.teleport ? "display-none" : "block sm:display-none"),
            onClick: $[0] || ($[0] = (fe) => r.panel.close())
          }, null, 8, ["class"]),
          P((g(), w("h2", Eo, [
            v.$slots.header ? ke(v.$slots, "header", { key: 0 }) : (g(), w("div", xo, U(_(t)(r.panel.alertName)), 1))
          ])), [
            [S]
          ]),
          v.$slots.controls ? (g(), q(R, { key: 0 }, {
            default: ee(() => [
              ke(v.$slots, "controls")
            ]),
            _: 3
          ...
          m("div", {
            ...
            r.panel.teleport ? G("", !0) : (g(), w("div", So, [
              d.value ? (g(), q(H, {
                key: 0,
        ...
        r.content ? (g(), w("div", {
          ...
          v.$slots.content ? ke(v.$slots, "content", { key: 0 }) : A.value ? (g(), w("div", {
            key: 1,
            innerHTML: A.value.innerHTML
          }, null, 8, _o)) : G("", !0)
        ], 512)) : G("", !0),
        r.footer ? P((g(), w("div", Io, [
          ke(v.$slots, "footer")
        ])), [
          [C]
        ]) : G("", !0)
...
}), Lo = { class: "relative" }, Ro = ["content", "aria-label"], $o = ["transform"], Co = /* @__PURE__ */ O({
  __name: "pin",
  props: {
    active: Boolean
  },
...
}), Oo = { class: "relative" }, ko = ["content", "aria-label"], Mo = /* @__PURE__ */ O({
  __name: "close",
  props: {
    active: Boolean
  },
...
}), Vo = { class: "relative" }, jo = ["content", "aria-label"], qo = /* @__PURE__ */ O({
  __name: "minimize",
  props: {
    active: Boolean
  },
...
}), Xo = /* @__PURE__ */ Pe(Qo, [["__scopeId", "data-v-51e22a4a"]]), ea = {
  key: 0,
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 24 24",
  ...
  setup(r) {
    ...
    return (s, o) => {
      ...
      return g(), q(a, {
        ...
        default: ee(() => [
          _(t).isFullscreen ? (g(), w("svg", ea, o[0] || (o[0] = [
            m("path", {
              d: "M0 0h24v24H0z",
              fill: "none"
            }, null, -1),
  ...
  tabindex: "-1"
}, aa = ["content", "aria-label"], na = /* @__PURE__ */ O({
  __name: "button",
  props: {
    onClickFunction: {
      type: Function,
  ...
  class: "relative",
  tabindex: "-1"
}, ca = ["aria-label", "content"], ua = /* @__PURE__ */ O({
  __name: "button",
  props: {
    onClickFunction: {
      type: Function,
...
}), pa = /* @__PURE__ */ Pe(ua, [["__scopeId", "data-v-457cd2d4"]]), da = B("areas-of-interest", () => ({ areas: h([]) })), ha = B("export", () => {
  const r = h({
    title: !0,
    map: !0,
    mapElements: !0,
...
const gi = "https://geogratis.gc.ca/services/geolocation/@{language}/locate", vi = "https://geogratis.gc.ca/services/geoname/@{language}/geonames.json", bi = "https://geogratis.gc.ca/services/geoname/@{language}/codes/province.json", wi = "https://geogratis.gc.ca/services/geoname/@{language}/codes/concise.json", _a = {
  10: "NL",
  11: "PE",
  12: "NS",
  13: "NB",
...
const Ia = B("geosearch", () => {
  const r = h(new Ai("en", void 0)), e = h({
    ...
    () => new Promise((L) => {
      r.value.fetchProvinces().then((R) => {
        R.sort((H, he) => H.name > he.name ? 1 : -1), L(R);
      });
    })
  ), p = N(
    () => new Promise((L) => {
  ...
  function b(L) {
    ...
    if (!R)
      ...
      const H = setInterval(() => {
        r.value.config.provinces.listFetched && r.value.config.types.typesFetched && (clearInterval(H), r.value.query(`${R}*`).then((he) => {
...
class Na {
  ...
  constructor(e, t, i) {
    ...
    const s = Fa(e, this);
    this.$vApp = s.app, this.$element = s.element, this.$i18n = s.i18n, this.$rootEl = s.app.$root?.$el, this.fixture = new Cn(this), this.panel = new On(this), this.geo = new Rn(this), this.ui = {
      ...
      escapeHtml: () => "",
      isPlainText: () => !0
    }, this.notify = new Xs(this), this._isFullscreen = Ee.isEnabled && !!this.$vApp.$root && Ee.isFullscreen && Ee.element === this.$vApp.$root.$el, Ee.isEnabled && Ee.onchange(() => {
   ...
   */
  initialize(e, t, i) {
    const s = pe(this.$vApp.$pinia), o = He(this.$vApp.$pinia), a = Lt(this.$vApp.$pinia);
    if (t?.configs !== void 0) {
      ...
      s.activeBasemapConfig = c.map.basemaps.find(
        (y) => y.id === c.map.initialBasemapId
      );
      const u = setInterval(() => {
        const y = this.$vApp.$el.querySelector("#esriMap");
        y && (clearInterval(u), this.geo.map.createMap(c.map, y).then(() => {
          if (y._tippy.hide(0), a.setMaptipInstance(y._tippy), c.layers && c.layers.length > 0) {
            let f = 0;
            c.layers.forEach((A) => {
      ...
      if (c.panels) {
        if (c.panels.open && c.panels.open.length > 0) {
          const y = c.panels.open.map((f) => f.id);
          this.panel.isRegistered(y).then(() => {
      ...
      this.ui.getZoomIcon = () => b, this.ui.formatNumber = (y) => this.ui.suppressNumberLocalization ? y.toString() : this.$i18n.n(y, "number"), this.ui.escapeHtml = (y) => {
        const f = {
          "<": "&lt;",
          ">": "&gt;",
          '"': "&quot;",
        ...
        return y.replace(/[<>"']/g, (A) => f[A]);
      }, this.ui.isPlainText = (y) => typeof y == "string" ? !this.containsValidHtml(y) && !this.representsObject(y) : !1;
    }
    i || (i = {});
   ...
   */
  reload(e, t) {
    const i = et(this.$vApp.$pinia), s = Te(this.$vApp.$pinia), o = pe(this.$vApp.$pinia), a = ge(this.$vApp.$pinia), l = _e(this.$vApp.$pinia), n = qt(this.$vApp.$pinia), c = !!e;
...
function Fa(r, e) {
  ...
  const i = Vs(), s = Ci(oo).use(i).use(xs, {
    directive: "tippy",
    // => v-tippy
    component: "tippy"
    // => <tippy/>
  }).use(t);
  s.directive("focus-container", fo), s.directive("focus-list", lo), s.directive("focus-item", uo), s.directive("truncate", vo), s.component("panel-screen", To), s.component("pin", Co), s.component("close", Mo), s.component("back", Fo), s.component("expand", zo), s.component("panel-options-menu", Xo), s.component("dropdown-menu", Xt), s.component("minimize", qo), s.component("right", Yo), s.component("left", Ko), s.component("fullscreen-nav-button", ia), s.component("geolocator-nav-button", sa), s.component("home-nav-button", ra), s.component("mapnav-button", na), s.component("appbar-button", pa), s.component("transition", Ri), s.component("transition-group", $i), s.config.globalProperties.$iApi = e, s.config.globalProperties.$pinia = t, s.provide("iApi", e);
  const o = s.mount(r);
...
class Qa extends Z {
  ...
  async geoJsonToEsriJson(e, t) {
    ...
    const b = a.fields.map((f) => f.name);
    for (let f = 0; f < d.length; f++) {
      const A = d[f];
      A.geometry.spatialReference = p, A.geometry.type = a.geometryType, Object.keys(A.attributes).forEach((v) => {
        b.includes(v) ? (Array.isArray(A.attributes[v]) || typeof A.attributes[v] == "object") && A.attributes[v] != null && (A.attributes[v] = JSON.stringify(A.attributes[v])) : delete A.attributes[v];
      });
    }
  ...
  async loadWfsData(e, t = -1, i = 0, s = 1e3, o = {
    ...
    if (o.features = o.features.concat(d.features), d.features.length < t - i) {
      ...
      return a && o.features.length > 0 && o.features[0].geometry.type === z.POINT && o.features.forEach((b) => {
        const y = b.geometry.coordinates;
        b.properties.rvInternalCoordX = y[0], b.properties.rvInternalCoordY = y[1];
      }), o;
  }
  /**
  ...
  parseCapabilities(e) {
    const t = () => {
      ...
      return l ? (Array.isArray(l) || (l = [l]), l.map((n) => {
        ...
        let p = n.Style;
        const d = [], b = {};
        return p && (Array.isArray(p) || (p = [p]), p.forEach((y) => {
          const f = y.Name;
          if (d.push(f), y.LegendURL) {
            const v = y.LegendURL.OnlineResource["@_xlink:href"];
            b[f] = v.replaceAll("&amp;", "&");
          }
        })), {
...
class Zi extends ii {
  ...
  constructor(e, t) {
    ...
    this.expectedTime.draw = e.expectedDrawTime ?? i.draw, this.expectedTime.load = e.expectedLoadTime ?? i.load, this.expectedTime.fail = e.maxLoadTime || i.fail, this.lastCancel = 0, this.timers = {
      draw: void 0,
      load: void 0
    }, this.origRampConfig = e, this.id = e.id || "", this.uid = this.$iApi.geo.shared.generateUUID(), this.isCosmetic = !1, this.isRemoved = !1, this.isSublayer = !1, this.supportsIdentify = !1, this.mapLayer = !0, this.identifyMode = Q.NONE, this.supportsFeatures = !1, this.hovertips = !1, this.supportsSublayers = !1, this.isFile = !1, this.layerState = V.NEW, this.initiationState = F.NEW, this.drawState = ue.NOT_LOADED, this.loadDefProm = new J(), this.url = this.origRampConfig.url, this.canReload = !!(this.url || this.origRampConfig.caching), this.loadPromDone = !1, this.layerTree = new _t(0, this.uid, this.name, !0);
  }
  updateInitiationState(e) {
  ...
  async terminate() {
    this.updateInitiationState(F.TERMINATING), await Promise.all(this.sublayers.map((e) => e.terminate())), this.loadDefProm = new J(), this.loadPromDone = !1, this.updateLayerState(V.NEW), this.updateDrawState(ue.NOT_LOADED), this.updateInitiationState(F.TERMINATED);
  }
  // ----------- LAYER LOAD -----------
  ...
  onError(e = !0) {
    this.layerState !== V.ERROR && (this.initiationState === F.INITIATING && this.updateInitiationState(F.NEW), this.loadPromDone && (this.loadDefProm = new J()), this.loadDefProm.rejectMe(), this.loadPromDone = !0, this.sublayers.forEach((t) => t.onError(e)), e && this.$iApi.notify.show(
      me.ERROR,
      this.$iApi.$i18n.t("layer.error", {
        id: this.id
      })
...
class Ze extends Zi {
  ...
  // ----------- LAYER CONSTRUCTION AND INITIALIZAION -----------
  constructor(e, t) {
    super(e, t), this._scaleSet = new Di(), this._mouseTolerance = e.mouseTolerance != null ? e.mouseTolerance : 5, this._touchTolerance = e.touchTolerance != null ? e.touchTolerance : 15, this._drawOrder = [], this._serverVisibility = void 0, this.isCosmetic = e.cosmetic || !1, this.extent = e.extent ? D.fromConfig(`${this.id}_extent`, e.extent) : void 0, this.viewDefProm = new J(), this.esriWatches = [];
  }
  noLayerErr() {
    console.error(
  ...
  onLoadActions() {
    ...
    const o = [], a = (n, c) => {
      ...
      if (n.sublayers && n.sublayers.length > 0) {
        ...
        c.findChildByIdx(u) || c.children.push(b), n.sublayers.reverse().forEach((y) => {
          a(y, b);
        });
      } else {
...
class gn extends Ze {
  ...
  getFeatureInfo(e, t, i) {
    ...
    let a, l;
    const n = s.getExtent(), c = o.spatialReferences, u = e.join(","), p = s.esriView.toScreen(t.toESRI()), d = Math.floor(p.x), b = Math.floor(p.y), f = {
    ...
    return $ && Object.keys($).forEach((L) => {
      L.toLowerCase() !== "styles" && (v[L] = $[L]);
    }), Object.keys(v).forEach((L) => l[L] = v[L]), Be(o.url.split("?")[0], {
      query: l,
      responseType: f
    });
  }
...
class Tn extends Z {
  ...
  async symbolToSvg(e) {
    ...
    const o = Xe(s).size(this.CONTAINER_SIZE, this.CONTAINER_SIZE).viewbox(0, 0, this.CONTAINER_SIZE, this.CONTAINER_SIZE), a = {
      ...
      // @ts-ignore
      cross({ size: y }) {
        return o.path("M 0,10 L 20,10 M 10,0 L 10,20").size(y * i);
      },
      // @ts-ignore
      x({ size: y }) {
        return o.path("M 0,0 L 20,20 M 20,0 L 0,20").size(y * i);
      },
      // @ts-ignore
      triangle({ size: y }) {
        return o.path("M 20,20 L 10,0 0,20 Z").size(y * i);
      },
      // @ts-ignore
      diamond({ size: y }) {
        return o.path("M 20,10 L 10,0 0,10 10,20 Z").size(y * i);
      },
      // @ts-ignore
      square({ size: y }) {
        return o.path("M 0,0 20,0 20,20 0,20 Z").size(y * i);
      }
    }, l = {
      [ce.SOLID]: "none",
      // esriSLSSolid
      ...
      none: () => "transparent",
      // esriSFSNull
      horizontal: (y, f) => o.pattern(5, 5, (v) => v.line(0, 5 / 2, 5, 5 / 2)).stroke(f),
      vertical: (y, f) => o.pattern(5, 5, (v) => v.line(5 / 2, 0, 5 / 2, 5)).stroke(f),
      "forward-diagonal": (y, f) => o.pattern(5, 5, (v) => {
        v.line(0, 0, 5, 5).stroke(f), v.line(0, 0, 5, 5).move(0, 5).stroke(f), v.line(0, 0, 5, 5).move(5, 0).stroke(f);
      }),
      "backward-diagonal": (y, f) => o.pattern(5, 5, (v) => {
        v.line(5, 0, 0, 5).stroke(f), v.line(5, 0, 0, 5).move(5 / 2, 5 / 2).stroke(f), v.line(5, 0, 0, 5).move(-5 / 2, -5 / 2).stroke(f);
      }),
      cross: (y, f) => o.pattern(5, 5, (v) => {
        v.line(5 / 2, 0, 5 / 2, 5).stroke(f), v.line(0, 5 / 2, 5, 5 / 2).stroke(f);
      }),
      "diagonal-cross": (y, f) => o.pattern(7, 7, (v) => {
      ...
      "picture-fill"() {
        const y = e.imageData ? `data:${e.contentType};base64,${e.imageData}` : e.url, f = e.width * e.xscale, A = e.height * e.yscale;
        e.outline = e.outline || c;
        const v = b(e.outline.color), $ = d({
          color: v.colour,
          opacity: v.opacity,
        ...
        return t.$iApi.geo.shared.convertImagetoDataURL(y).then((R) => {
          const H = o.pattern(
            f,
            A,
            (he) => (
          ...
          o.rect(t.CONTENT_SIZE, t.CONTENT_SIZE).center(t.CONTAINER_CENTER, t.CONTAINER_CENTER).fill(H).stroke($);
        });
      },
      "picture-marker"() {
        const y = e.source, f = y && y.imageData ? `data:${y.contentType};base64,${y.imageData}` : e.url;
    ...
    try {
      ...
      return console.error(y), this.generateBlankSymbology();
    }
    function d(y) {
...
const $n = /* @__PURE__ */ Object.assign({ "../fixtures/appbar/index.ts": () => import("./index-bfT2gXzU.js"), "../fixtures/areas-of-interest/index.ts": () => import("./index-CSVEmj6K.js"), "../fixtures/basemap/index.ts": () => import("./index-DiqyEe-m.js"), "../fixtures/crosshairs/index.ts": () => import("./index-DDUsf8JL.js"), "../fixtures/details/index.ts": () => import("./index-zvJjVjOw.js"), "../fixtures/export-footnote/index.ts": () => import("./index-CL2zaTjt.js"), "../fixtures/export-legend/index.ts": () => import("./index-B19mCueN.js"), "../fixtures/export-map/index.ts": () => import("./index-ByF__nTR.js"), "../fixtures/export-northarrow/index.ts": () => import("./index-Bflq4RmO.js"), "../fixtures/export-scalebar/index.ts": () => import("./index-D-o0ikJL.js"), "../fixtures/export-timestamp/index.ts": () => import("./index-CMjp0sGB.js"), "../fixtures/export-title/index.ts": () => import("./index-B27uCKfb.js"), "../fixtures/export/index.ts": () => import("./index-CrafxabT.js"), "../fixtures/extentguard/index.ts": () => import("./index-COKi1ble.js"), "../fixtures/gazebo/index.ts": () => import("./index-B0HYDd5T.js"), "../fixtures/geosearch/index.ts": () => import("./index-DeJXlPET.js"), "../fixtures/grid/index.ts": () => import("./index-DDWF7VFL.js"), "../fixtures/help/index.ts": () => import("./index-F_AVS1bh.js"), "../fixtures/hilight/index.ts": () => import("./index-i6iudp62.js"), "../fixtures/layer-reorder/index.ts": () => import("./index-TrbVxiHP.js"), "../fixtures/legend/index.ts": () => import("./index-H3BEyFDR.js"), "../fixtures/mapnav/index.ts": () => import("./index-BvpRyaDP.js"), "../fixtures/metadata/index.ts": () => import("./index-DDrk3PGi.js"), "../fixtures/northarrow/index.ts": () => import("./index-CdwA_Xiq.js"), "../fixtures/overviewmap/index.ts": () => import("./index-lOei6Rci.js"), "../fixtures/panguard/index.ts": () => import("./index-CPPhWcrK.js"), "../fixtures/scrollguard/index.ts": () => import("./index-VE8kmhGC.js"), "../fixtures/settings/index.ts": () => import("./index-vEMupuu3.js"), "../fixtures/snowman/index.ts": () => import("./index-DEVyvM3c.js"), "../fixtures/wizard/index.ts": () => import("./index-C-tBLGda.js") });
class Cn extends Z {
  /**
...
const Nn = /* @__PURE__ */ Pe(Mn, [["render", Pn], ["__scopeId", "data-v-a3c61802"]]), Fn = /* @__PURE__ */ Object.assign({ "../fixtures/areas-of-interest/screen.vue": () => import("./screen-D1dFAib1.js"), "../fixtures/basemap/screen.vue": () => import("./screen-Dnx3c031.js"), "../fixtures/export/screen.vue": () => import("./screen-QvgGqZhY.js"), "../fixtures/geosearch/screen.vue": () => import("./screen-DNid1P4G.js"), "../fixtures/grid/screen.vue": () => import("./screen-WRViCTE0.js"), "../fixtures/help/screen.vue": () => import("./screen-DBvN-3_p.js"), "../fixtures/layer-reorder/screen.vue": () => import("./screen-D3PPaXnH.js"), "../fixtures/legend/screen.vue": () => import("./screen-Cisdq1q9.js"), "../fixtures/metadata/screen.vue": () => import("./screen-D_dZo5M_.js"), "../fixtures/settings/screen.vue": () => import("./screen-DoHghyKu.js"), "../fixtures/wizard/screen.vue": () => import("./screen-DJWXUnWB.js") });
class At extends Z {
  /**
   * ID of this panel.
   *
...
var tt = { major: "4", minor: "11", patch: "0-beta", timestamp: "Mon Dec 30 15:26:36 2024 -0500", hash: "53ad48c45908cf407cd50a420e268ae04bc1e784" };
console.info(
...
const Rl = (r, e, t) => new Na(r, e, t), nt = new Ps();
export {
  j as $,
  Lr as A,
  mt as B,
