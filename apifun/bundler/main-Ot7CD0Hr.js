...
import { ref as h, computed as N, markRaw as se, defineComponent as O, inject as ve, reactive as Ae, watch as xt, onBeforeUnmount as dt, resolveDirective as M, withDirectives as P, openBlock as g, createElementBlock as w, withKeys as os, withModifiers as Kt, onMounted as Je, normalizeClass as oe, normalizeStyle as Ri, createVNode as re, Transition as $i, withCtx as ee, createBlock as W, resolveDynamicComponent as as, mergeProps as ns, TransitionGroup as Ci, Fragment as We, renderList as ht, unref as S, nextTick as $t, renderSlot as Me, createElementVNode as f, vShow as ls, resolveComponent as K, createTextVNode as at, toDisplayString as B, createCommentVNode as U, onUpdated as cs, Teleport as us, getCurrentInstance as ps, useTemplateRef as ui, createApp as Oi, toRaw as Se, h as ds, render as Gt, defineAsyncComponent as hs } from "vue";
...
class ie extends Ze {
  ...
  static fromESRI(e, t) {
    return new ie(t, e.rings, _.fromESRI(e.spatialReference), !0);
  }
  toESRI() {
    return new Qt({
      rings: this.toArray(),
  ...
  static fromGeoJSON(e, t) {
    return new ie(t, e.coordinates, _.fromGeoJSON(e.crs), !0);
  }
  toGeoJSON() {
    return this.geoJsonFactory(V.POLYGON, this.toArray());
  }
...
class Ps {
  ...
  async projectExtent(e, t) {
    ...
    const a = new ie("warpy", [o], t.sr, !0), l = await this.projectGeometry(e, a), n = l.toArray().pop() || [], c = n.map((y) => y[0]), u = n.map((y) => y[1]), p = Math.min.apply(null, c), d = Math.max.apply(null, c), v = Math.min.apply(null, u), m = Math.max.apply(null, u);
    return G.fromParams(t.id + "_projected", p, v, d, m, l.sr);
  }
}
class Ns {
  // useful functions
...
const Lt = z("appbar", () => {
  ...
  function n(p, d) {
    ...
    const v = t.value.findIndex((m) => m === p.id);
  ...
  function c(p) {
    ...
    if (r.value = d, p.mapLayer) {
      const v = t.value.filter((m) => m !== p.id);
      t.value = v;
    }
  }
  function u(p) {
...
const ir = ["content"], sr = { class: "flex items-center text-left" }, rr = { class: "select-text cursor-text" }, or = ["content"], ar = {
      ...
      return P((g(), w("li", {
        ...
        f("div", sr, [
          f("span", null, [
            ...
            f("span", rr, B(r.notification.message), 1)
          ]),
    ...
    return (l, n) => {
      ...
      return g(), w("div", null, [
        a.value.length > 0 ? P((g(), w("ul", {
          ...
          f("span", null, B(S(t)("notifications.empty")), 1),
...
}, fr = { class: "notification-dropdown pointer-events-auto bg-white rounded text-center text-black w-500 h-256 flex flex-col p-0" }, mr = { class: "pb-8 border-b border-gray-600" }, yr = { class: "absolute flex right-3 top-3" }, gr = ["content", "aria-label"], vr = /* @__PURE__ */ O({
    ...
    return (o, a) => {
      ...
      return g(), W(ei, {
        ...
        default: ee((c) => [
          f("div", fr, [
            f("div", null, [
              f("h4", mr, B(S(t)("notifications.title")), 1),
              f("div", yr, [
                P((g(), w("button", {
                  type: "button",
                  onClick: s,
...
}), br = /* @__PURE__ */ Ne(vr, [["__scopeId", "data-v-3623a7d2"]]), Ar = { class: "flex hover:text-white" }, wr = ["aria-label"], Er = { class: "about-ramp-dropdown pointer-events-auto bg-white rounded w-256 h-50" }, xr = ["aria-label", "content"], Sr = { class: "pb-8 border-b border-gray-600 mb-10" }, Ir = { class: "absolute right-5 top-5" }, _r = { class: "select-text" }, Tr = { class: "font-bold cursor-text" }, Lr = { class: "text-sm cursor-text" }, Rr = { class: "text-sm cursor-text" }, $r = /* @__PURE__ */ O({
            ...
            f("div", null, [
              P((g(), w("button", {
                ...
                f("svg", {
                  ...
                  f("path", { d: "M17.65 6.35C16.2 4.9 14.21 4 12 4c-4.42 0-7.99 3.58-7.99 8s3.57 8 7.99 8c3.73 0 6.84-2.55 7.73-6h-2.08c-.82 2.33-3.04 4-5.65 4-3.31 0-6-2.69-6-6s2.69-6 6-6c1.66 0 3.14.69 4.22 1.78L13 11h7V4l-2.35 2.35z" })
                ], -1)
              ]), 8, xr)), [
                [p, {
              ...
              f("div", _r, [
                f("div", null, [
                  ...
                  f("span", Lr, " [" + B(o.value) + "] ", 1)
                ]),
                f("div", null, [
                  f("span", Rr, B(a.value), 1)
                ]),
                n[2] || (n[2] = f("div", { class: "mt-5" }, [
                  f("a", {
  ...
  __name: "map-caption",
  setup(r) {
    const e = Ue(), t = de(), { t: i } = Y(), s = ve("iApi"), o = N(() => e.scale), a = N(() => e.attribution), l = N(() => e.coords), n = N(() => e.langtoggle), c = N(() => t.config.map), u = h([]), p = Ae([]);
    p.push(
      xt(c, (A) => {
    ...
    return (A, b) => {
      ...
      return g(), w("div", Or, [
        ...
        b[0] || (b[0] = f("span", { class: "flex-grow w-15" }, null, -1)),
        f("div", Fr, [
          ...
          n.value?.disabled ? U("", !0) : (g(), W($, {
            ...
            header: ee(() => [
              f("span", Br, B(S(i)("map.language.short")), 1)
            ]),
            default: ee(() => [
    ...
    return (c, u) => {
      ...
      return i.value ? (g(), w("div", {
        ...
        f("div", {
          ...
          f("div", Jr, [
            f("h2", Zr, B(S(t)("keyboardInstructions.title")), 1),
            re(p, {
              class: "ml-auto",
...
const lo = /* @__PURE__ */ Ne(ro, [["render", no]]), xe = "focus-list", je = "focus-item", co = "focus-icon", uo = "focus-container", ct = `[${xe}],[${uo}]`, bt = "truncate-text", At = "show-truncate", ot = "focused", Yt = `button,input,select,a,textarea,[contenteditable],[${xe}],[${co}],[tabIndex]`, po = {
  mounted(r, e) {
    +r.getAttribute("tabindex") <= 0 && r.setAttribute("tabindex", "0"), r.toggleAttribute(xe, !0), new ho(r, e.value);
  },
  updated(r) {
    Hi(r);
  }
...
function Hi(r) {
  r.querySelectorAll(Yt).forEach((t) => {
    if (t.closest(ct) === r || t.closest(ct) === t && t.parentElement.closest(ct) === r)
      if (t.closest(`[${xe}],.${ot}`).classList.contains(ot))
...
class ho {
  ...
  setTabIndex(e, t = this.element) {
    t.querySelectorAll(Yt).forEach((s) => {
      (e === -1 || s.closest(ct) === this.element || s.closest(ct) === s && s.parentElement.closest(ct) === this.element || s.closest(`[${xe}],.${ot}`).classList.contains(ot)) && s.setAttribute("tabindex", e.toString());
    });
  }
  /**
  ...
  onClick(e) {
    ...
    this.highlightedItem = t.closest(`[${je}]`) || t.closest(`[${xe}]`) || this.highlightedItem, t.hasAttribute(`${je}`) && this.element.focus(), this.highlightedItem !== this.element ? this.focusItem(this.highlightedItem) : this.element.removeAttribute("aria-activedescendant");
  }
  /**
...
const xo = ["content"], So = {
  ...
  setup(r, { expose: e }) {
    ...
    e({ el: a });
    const c = r, u = N(() => o?.fixture.get("appbar") ? s.temporary : []), p = N(() => i.mobileView), d = N(() => i.reorderable), v = (b) => b.scrollHeight > b.clientHeight, m = () => !p.value && !c.panel.teleport, y = (b) => {
...
class Ga {
  ...
  constructor(e, t, i) {
    ...
    this.$vApp = s.app, this.$element = s.element, this.$i18n = s.i18n, this.$rootEl = s.app.$root?.$el, this.fixture = new Pn(this), this.panel = new Nn(this), this.geo = new kn(this), this.dev = new zn(this), this.ui = {
      ...
      escapeHtml: () => "",
      isPlainText: () => !0
    }, this.notify = new tr(this), this._isFullscreen = Ee.isEnabled && !!this.$vApp.$root && Ee.isFullscreen && Ee.element === this.$vApp.$root.$el, Ee.isEnabled && Ee.onchange(() => {
  ...
  initialize(e, t, i) {
    ...
    if (t?.configs !== void 0) {
      ...
      this.ui.getZoomIcon = () => v, this.ui.formatNumber = (m) => this.ui.suppressNumberLocalization ? m.toString() : this.$i18n.n(m, "number"), this.ui.escapeHtml = (m) => {
        const y = {
          "<": "&lt;",
          ">": "&gt;",
          '"': "&quot;",
    ...
    if (e ? (e.logo ? e.logo.disabled ? s.logo.disabled = !0 : (s.logo.altText = e.logo.altText || i.altText, s.logo.link = e.logo.link || i.link, s.logo.value = e.logo.value || i.value) : (s.logo.altText = i.altText, s.logo.link = i.link, s.logo.value = i.value), e.text ? e.text.disabled ? s.text.disabled = !0 : s.text.value = e.text.value || t.value : s.text.value = t.value, Ue(this.$vApp.$pinia).setAttribution(s)) : (s.logo.altText = i.altText, s.logo.link = i.link, s.logo.value = i.value, s.text.value = t.value), !e || e.text?.disabled || !e.text) {
      ...
      if (n) {
        const c = n.baseLayers.map((u) => new Promise((p) => {
          let d = 0;
          const v = a / l, m = setInterval(function() {
            u.loaded && !u.loadError ? (clearInterval(m), p(u)) : d > v && (clearInterval(m), p(null)), d++;
          }, l);
        })).toArray();
...
class ja extends Ba {
  ...
  async createMapView(e) {
    ...
    this.esriView = se(
      ...
      n.preventDefault();
    }) : console.error("ESRI Map View is missing its container"), Ie(
...
class tn extends J {
  ...
  async geoJsonToEsriJson(e, t) {
    ...
    s || (s = _.parseGeoJsonCrs(e.crs)), a.renderer = await k.RendererFromJson(c.renderer), a.fields = (a.fields || []).concat(
  ...
  async loadWfsData(e, t = -1, i = 0, s = 1e3, o = {
    ...
    if (o.features = o.features.concat(d.features), d.features.length < t - i) {
      ...
      return a && o.features.length > 0 && o.features[0].geometry.type === V.POINT && o.features.forEach((v) => {
        ...
        v.properties.rvInternalCoordX = m[0], v.properties.rvInternalCoordY = m[1];
      }), o;
  }
  /**
      ...
      return l ? (Array.isArray(l) || (l = [l]), l.map((n) => {
        ...
        return p && (Array.isArray(p) || (p = [p]), p.forEach((m) => {
          ...
          if (d.push(y), m.LegendURL) {
            const b = m.LegendURL.OnlineResource["@_xlink:href"];
            v[y] = b.replaceAll("&amp;", "&");
          }
        })), {
...
class si extends J {
   ...
   */
  getGraphic(e, t) {
    return Promise.resolve(new we(new Ve()));
  }
  /**
...
class Ki extends si {
   ...
   */
  getGraphic(e, t) {
    return this.stubError(), Promise.resolve(new we(new Ve()));
  }
  getIcon(e) {
    return this.stubError(), Promise.resolve("");
  }
...
class Qe extends ri {
  ...
  sourceGeoJson;
  constructor(e, t) {
    super(e, t), this.supportsIdentify = !0, this.isFile = !0, this.dataFormat = X.ESRI_FEATURE, this.layerFormat = ye.FEATURE, this.layerIdx = 0, e.identifyMode && e.identifyMode !== Q.NONE ? this.identifyMode = e.identifyMode : this.identifyMode = Q.HYBRID;
  }
  async reload() {
  ...
  async getGraphic(e, t) {
    ...
    if (!t.getGeom && this.attribs.attLoader.isLoaded()) {
      ...
      i = new we(new Ve(), "", s.features[s.oidIndex[e]]);
    } else {
      const s = {
        filterOIDs: [e],
...
class fn extends ri {
  constructor(e, t) {
    super(e, t), this.dataFormat = X.ESRI_FEATURE, this.supportsIdentify = !0, this.layerType = x.FEATURE, this.layerFormat = ye.FEATURE, e.identifyMode && e.identifyMode !== Q.NONE ? this.identifyMode = e.identifyMode : this.identifyMode = Q.HYBRID;
  }
  async onInitiate() {
  ...
  onLoadActions() {
    ...
    const o = [], a = (n, c) => {
      ...
      if (n.sublayers && n.sublayers.length > 0) {
        ...
        c.findChildByIdx(u) || c.children.push(v), n.sublayers.reverse().forEach((m) => {
          a(m, v);
        });
      } else {
...
class yn extends ri {
  constructor(e, t, i) {
    if (super(e, t), this.layerType = x.SUBLAYER, this.layerFormat = ye.MAPIMAGE, this.isSublayer = !0, this.layerIdx = e.index, this.parentLayer = i, this.dataFormat = X.ESRI_FEATURE, this.supportsFeatures = !0, this.hovertips = !1, this.url = this.parentLayer?.url, this.canReload = !!(this.url || this.origRampConfig.caching), !i.esriLayer)
...
class Qi extends Ki {
  ...
  // ----------- LAYER CONSTRUCTION AND INITIALIZAION -----------
  constructor(e, t) {
    super(e, t), this.dataFormat = X.ESRI_FEATURE, this.layerFormat = ye.NOLAYER, this.drawState = pe.NOT_VISUAL, this.attribs = new Xi(), this.supportsFeatures = !0, this.mapLayer = !1, this.isFile = !1, this._visibility = e.state?.visibility ?? !0, this.expectedTime.draw = 0;
  }
  async onInitiate() {
    if (this.sourceJson) {
...
class Cn extends J {
  ...
  async symbolToSvg(e) {
    ...
    const o = tt(s).size(this.CONTAINER_SIZE, this.CONTAINER_SIZE).viewbox(0, 0, this.CONTAINER_SIZE, this.CONTAINER_SIZE), a = {
      ...
      none: () => "transparent",
      // esriSFSNull
      horizontal: (m, y) => o.pattern(5, 5, (b) => b.line(0, 5 / 2, 5, 5 / 2)).stroke(y),
      vertical: (m, y) => o.pattern(5, 5, (b) => b.line(5 / 2, 0, 5 / 2, 5)).stroke(y),
      "forward-diagonal": (m, y) => o.pattern(5, 5, (b) => {
        b.line(0, 0, 5, 5).stroke(y), b.line(0, 0, 5, 5).move(0, 5).stroke(y), b.line(0, 0, 5, 5).move(5, 0).stroke(y);
      }),
      "backward-diagonal": (m, y) => o.pattern(5, 5, (b) => {
        b.line(5, 0, 0, 5).stroke(y), b.line(5, 0, 0, 5).move(5 / 2, 5 / 2).stroke(y), b.line(5, 0, 0, 5).move(-5 / 2, -5 / 2).stroke(y);
      }),
      cross: (m, y) => o.pattern(5, 5, (b) => {
        b.line(5 / 2, 0, 5 / 2, 5).stroke(y), b.line(0, 5 / 2, 5, 5 / 2).stroke(y);
      }),
      "diagonal-cross": (m, y) => o.pattern(7, 7, (b) => {
      ...
      "picture-fill"() {
        const m = e.imageData ? `data:${e.contentType};base64,${e.imageData}` : e.url, y = e.width * e.xscale, A = e.height * e.yscale;
        e.outline = e.outline || c;
        const b = v(e.outline.color), $ = d({
          color: b.colour,
          opacity: b.opacity,
...
class On extends J {
  ...
  async geoJsonQuery(e) {
    ...
    return (await e.layer.esriLayer.queryFeatures(t)).features.map((s, o) => {
      let a;
      return t.returnGeometry ? a = this.$iApi.geo.geom.geomEsriToRamp(s.geometry, `queryResult${o}`) : a = new Ve(), new we(a, "", s.attributes);
    });
  }
  /**
...
const Mn = /* @__PURE__ */ Object.assign({ "../fixtures/appbar/index.ts": () => import("./index-CtA32v-G.js"), "../fixtures/areas-of-interest/index.ts": () => import("./index-BipVX88u.js"), "../fixtures/basemap/index.ts": () => import("./index-BoNiFFF7.js"), "../fixtures/crosshairs/index.ts": () => import("./index-BsFJuRLx.js"), "../fixtures/details/index.ts": () => import("./index-CvQtq8aY.js"), "../fixtures/export-footnote/index.ts": () => import("./index-qtuPsrIj.js"), "../fixtures/export-legend/index.ts": () => import("./index-DtF_rjRw.js"), "../fixtures/export-map/index.ts": () => import("./index-DWxn3BPl.js"), "../fixtures/export-northarrow/index.ts": () => import("./index-BNvrtLR2.js"), "../fixtures/export-scalebar/index.ts": () => import("./index-CzBma_Oq.js"), "../fixtures/export-timestamp/index.ts": () => import("./index-Bi8j4e_3.js"), "../fixtures/export-title/index.ts": () => import("./index-C0TdpNQk.js"), "../fixtures/export/index.ts": () => import("./index-DXCfrBbq.js"), "../fixtures/extentguard/index.ts": () => import("./index-Bc4H4DE7.js"), "../fixtures/gazebo/index.ts": () => import("./index-Dji070hW.js"), "../fixtures/geosearch/index.ts": () => import("./index-C9Ja-9Sy.js"), "../fixtures/grid/index.ts": () => import("./index-Dr3lIeqD.js"), "../fixtures/help/index.ts": () => import("./index-DrVJIHZt.js"), "../fixtures/hilight/index.ts": () => import("./index-BJdVeTId.js"), "../fixtures/layer-reorder/index.ts": () => import("./index-CD4yAKGu.js"), "../fixtures/legend/index.ts": () => import("./index-B6XzxBtp.js"), "../fixtures/mapnav/index.ts": () => import("./index-hOf5gpIO.js"), "../fixtures/metadata/index.ts": () => import("./index-zc5swaXY.js"), "../fixtures/northarrow/index.ts": () => import("./index-BgWJCgqB.js"), "../fixtures/overviewmap/index.ts": () => import("./index-BTPj1CS6.js"), "../fixtures/panguard/index.ts": () => import("./index-HN9QoIPx.js"), "../fixtures/scrollguard/index.ts": () => import("./index-BNtXYpbo.js"), "../fixtures/settings/index.ts": () => import("./index-tXXrqll_.js"), "../fixtures/snowman/index.ts": () => import("./index-BuHK_Isl.js"), "../fixtures/wizard/index.ts": () => import("./index-CL4AKvA0.js") });
class Pn extends J {
  /**
...
const Un = /* @__PURE__ */ Ne(Dn, [["render", Gn], ["__scopeId", "data-v-a3c61802"]]), Bn = /* @__PURE__ */ Object.assign({ "../fixtures/areas-of-interest/screen.vue": () => import("./screen-BdpC1We6.js"), "../fixtures/basemap/screen.vue": () => import("./screen-B80hUSn8.js"), "../fixtures/export/screen.vue": () => import("./screen-Lga7GbhW.js"), "../fixtures/geosearch/screen.vue": () => import("./screen-BesndAvB.js"), "../fixtures/grid/screen.vue": () => import("./screen-94FBQjxJ.js"), "../fixtures/help/screen.vue": () => import("./screen-JH_LBLYj.js"), "../fixtures/layer-reorder/screen.vue": () => import("./screen-UyVW9jG1.js"), "../fixtures/legend/screen.vue": () => import("./screen-DlYD1EqF.js"), "../fixtures/metadata/screen.vue": () => import("./screen-D3ESjHv4.js"), "../fixtures/settings/screen.vue": () => import("./screen-D4ruqG5R.js"), "../fixtures/wizard/screen.vue": () => import("./screen-CpUxn81w.js") });
class Et extends J {
  /**
   * ID of this panel.
   *
...
var rt = { major: "4", minor: "12", patch: "0-beta", timestamp: "Tue Apr 15 16:12:04 2025 -0400", hash: "539f7d1255557ab56c4a9f941575af4cd886d138" };
console.info(
