undedPlane-acMEfCCF.js","./lineSegment-Bre-Qair.js","./VertexArrayObject-EIH2Bcs4.js","./doublePrecisionUtils-B0owpBza.js","./floatRGBA-BqB6kySc.js","./AlphaCutoff-UcccL64p.js","./renderState-BqKKaxGi.js","./projectVectorToVector-BAuruX4I.js","./projectPointToVector-7JhmrRdF.js","./computeTranslationToOriginAndRotation-Cs8y2zOJ.js","./MeshLocalVertexSpace-C8Wn_wW_.js","./vec3f32-nZdmKIgz.js","./orientedBoundingBox-B6ZEqW-J.js","./quat-CXwkRcdm.js","./spatialReferenceEllipsoidUtils-DIwmgupy.js","./triangle-DviRB9a2.js","./BindType-BmZEZMMh.js"])))=>i.map(i=>d[i]);
import{c1 as si,a$ as go,q as m,u as z,C as ur,aD as li,aA as $,fI as xo,j9 as To,aP as hr,cZ as ci,bY as di,cG as Rt,cq as It,fJ as Je,fL as ut,aE as ui,cS as _o,s as Te,n as hi,cQ as St,g2 as ye,aO as bo,eL as Eo,bQ as So,dq as Ir,fc as Co,ck as rt,eM as it,G as $r,k6 as Ao,aK as wo,aN as Mo,aJ as yo,bP as Oo,k7 as Ro,k8 as Io,cw as $o,c0 as No,cl as Lo}from"./main-B3JhZOBP.js";import{t as Po}from"./requestImageUtils-CY0tl2rc.js";import{s as be,i as ve,a as Qt,O as er,e as Tt,n as Dt,u as Ge}from"./basicInterfaces-CZwQPxTp.js";import{_ as _t}from"./preload-helper-ExcqyqRp.js";import{E as Do,R as Ct,O as de,X as Oe,I as ae,D as ht,G as Ie,t as Fo,_ as zo,f as Bo,c as pe,L as Ze}from"./enums-Dk3osxpS.js";import{b as Go,p as mi,m as ke,a as Vo}from"./Texture-BJCkBhYf.js";import{s as U}from"./Util-C4yWdKVH.js";import{r as ge,o as X,q as Ve,E as mt,H as fi,u as Ho,c as nt,R as Ye,s as Ot,_ as pi,A as mr,g as Nr,P as Uo,N as jo,I as Lr,v as Wo}from"./vec32-DzWiU6o7.js";import{l as tr}from"./ViewingMode-HRfKv6NR.js";import{H as qo}from"./InterleavedLayout-C9oBGHMG.js";import{n as fe,a as Q,t as Ft,S as vi,b as D,u as ft,c as Pr,o as kt,r as ko}from"./NormalAttribute.glsl-Fm-DMXjg.js";import{n as zt}from"./compilerUtils-Dhywe0Oj.js";import{o as s,t as Qe,r as R}from"./interfaces-DDtDqZYj.js";import{e as f}from"./VertexAttribute-BdZWZuT1.js";import{a as I}from"./BindType-BmZEZMMh.js";import{o as _e}from"./AlphaCutoff-UcccL64p.js";import"./boundedPlane-acMEfCCF.js";import{E as gi,U as xe}from"./sphere-7gwFQcxV.js";import{B as Bt,o as Yo,g as Gt,r as Xo,c as Zo,p as Ko,f as Jo}from"./renderState-BqKKaxGi.js";import{j as Qo}from"./mat3-XZDRtl20.js";import{e as bt,o as et}from"./mat3f64-q3fE-ZOt.js";import{i as rr,H as xi,G as Ti}from"./mat4-DmgL3kdu.js";import{e as fr,o as Dr}from"./mat4f64-CSKppSlJ.js";import{I as ea,L as ta}from"./orientedBoundingBox-B6ZEqW-J.js";import{x as _i,c as Fr,y as ra,u as ia,q as oa,i as zr}from"./BufferView-CE0AiH3O.js";import{n as Vt,r as aa}from"./vec4f64-CMoMXWBi.js";import{o as na,r as sa}from"./doublePrecisionUtils-B0owpBza.js";import{s as oe}from"./vec42-CKs01hkn.js";import"./lengthUtils--68mTKxH.js";import{l as la,n as Ht}from"./vec2f64-B7N_6o8F.js";import{o as Le}from"./vec2-DGVIkCvT.js";import"./projectBuffer-cJZKDuOz.js";function Ul(t,e=!1){return t<=si?e?new Array(t).fill(0):new Array(t):new Float32Array(t)}function ca(t){t.vertex.code.add(s`
...
}`)}function bc(t){t.uniforms.add(new k("screenSizePerspective",e=>Vi(e.screenSizePerspective)))}function ja(t){t.uniforms.add(new k("screenSizePerspectiveAlignment",e=>Vi(e.screenSizePerspectiveAlignment||e.screenSizePerspective)))}function Vi(t){return X(Wa,t.parameters.divisor,t.parameters.offset,t.minScaleFactor)}const Wa=$();let te=class extends K{constructor(e,r){super(e,"vec4",I.Pass,(i,o,a)=>i.setUniform4fv(e,r(o,a)))}};function Hi(t,e){const r=t.vertex;e.hasVerticalOffset?(ka(r),e.hasScreenSizePerspective&&(t.include(Ua),ja(r),gt(t.vertex,e)),r.code.add(s`
...
color.a = 1.0;
}`);break;case ve.Mask:i.uniforms.add(r).code.add(s`#define discardOrAdjustAlpha(color) { if (color.a < textureAlphaCutoff) { discard; } else { color.a = 1.0; } }`);break;case ve.MaskBlend:i.uniforms.add(r).code.add(s`#define discardOrAdjustAlpha(color) { if (color.a < textureAlphaCutoff) { discard; } }`)}}function Wi(t,e){const{vertex:r,fragment:i}=t,o=e.hasColorTexture&&e.alphaDiscardMode!==ve.Opaque,{output:a,normalType:n,hasColorTextureTransform:l}=e;switch(a){case D.Depth:je(r,e),t.include(Ue,e),t.include(He,e),t.include(Ne,e),o&&i.uniforms.add(new Z("tex",c=>c.texture)),r.main.add(s`vpos = getVertexInLocalOriginSpace();
...
forwardTextureCoordinates();`),t.include(We,e),i.main.add(s`
          ...
          ${R(o,s`vec4 texColor = texture(tex, ${l?"colorUV":"vuv0"});
                 discardOrAdjustAlpha(texColor);`)}`);break;case D.Shadow:case D.ShadowHighlight:case D.ShadowExcludeHighlight:case D.ViewshedShadow:case D.ObjectAndLayerIdColor:je(r,e),t.include(Ue,e),t.include(Ne,e),t.include(lt,e),t.include(Xa,e),t.include(He,e),t.include(Ya,e),Ri(t),t.varyings.add("depth","float"),o&&i.uniforms.add(new Z("tex",c=>c.texture)),r.main.add(s`vpos = getVertexInLocalOriginSpace();
vpos = subtractOrigin(vpos);
vpos = addVerticalOffset(vpos, localOrigin);
...
forwardObjectAndLayerIdColor();`),t.include(We,e),i.main.add(s`
          ...
          ${a===D.ObjectAndLayerIdColor?s`outputObjectAndLayerIdColor();`:s`outputDepth(depth);`}`);break;case D.Normal:{je(r,e),t.include(Ue,e),t.include(Ft,e),t.include(Si,e),t.include(Ne,e),t.include(lt,e),o&&i.uniforms.add(new Z("tex",u=>u.texture)),n===Q.ScreenDerivative&&t.varyings.add("vPositionView","vec3");const c=n===Q.Attribute||n===Q.Compressed;r.main.add(s`
          ...
          fragColor = vec4(0.5 + 0.5 * normal, 1.0);`);break}case D.Highlight:je(r,e),t.include(Ue,e),t.include(Ne,e),t.include(lt,e),o&&i.uniforms.add(new Z("tex",c=>c.texture)),r.main.add(s`vpos = getVertexInLocalOriginSpace();
vpos = subtractOrigin(vpos);
vpos = addVerticalOffset(vpos, localOrigin);
gl_Position = transformPosition(proj, view, vpos);
