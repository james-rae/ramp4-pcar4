import { TinyEmitter as ts } from "tiny-emitter";
import { defineStore as U, createPinia as is } from "pinia";
import { ref as m, computed as P, markRaw as se, defineComponent as C, inject as we, reactive as ve, watch as Et, onBeforeUnmount as ct, resolveDirective as k, withDirectives as M, openBlock as g, createElementBlock as b, withKeys as ss, withModifiers as Zt, onMounted as He, normalizeClass as oe, normalizeStyle as Ti, createVNode as re, Transition as Li, withCtx as ee, createBlock as j, resolveDynamicComponent as rs, mergeProps as os, TransitionGroup as Ri, Fragment as je, renderList as ut, unref as _, nextTick as Rt, renderSlot as Oe, createElementVNode as y, vShow as as, resolveComponent as K, createTextVNode as st, toDisplayString as G, createCommentVNode as D, onUpdated as ns, Teleport as ls, getCurrentInstance as cs, createApp as $i, toRaw as xe, h as us, render as Dt, defineAsyncComponent as ps } from "vue";
import xt from "@arcgis/core/Color";
import dt from "@arcgis/core/config";
import ci from "@arcgis/core/geometry/Extent";
import ds from "@arcgis/core/geometry/Multipoint";
import hs from "@arcgis/core/geometry/Point";
import Kt from "@arcgis/core/geometry/Polygon";
import Ci from "@arcgis/core/geometry/Polyline";
import fs from "@arcgis/core/geometry/SpatialReference";
import { fromJSON as ms } from "@arcgis/core/geometry/support/jsonUtils";
import ys from "@arcgis/core/Graphic";
import Ue from "@arcgis/core/request";
import gs from "@arcgis/core/symbols/PictureMarkerSymbol";
import vs from "@arcgis/core/symbols/SimpleFillSymbol";
import bs from "@arcgis/core/symbols/SimpleLineSymbol";
import jt from "@arcgis/core/symbols/SimpleMarkerSymbol";
import { fromJSON as Qt } from "@arcgis/core/symbols/support/jsonUtils";
import Oi from "deepmerge";
import { Tools as ws } from "terraformer";
import ae from "proj4";
import { debounce as St, throttle as ft } from "throttle-debounce";
import { createI18n as As, useI18n as q } from "vue-i18n";
import Ae from "screenfull";
import ui from "lodash.clonedeep";
import Es, { setDefaultProps as xs, useTippy as Ss } from "vue-tippy";
import _s from "linkify-html";
import { createPopper as Is, detectOverflow as Ts } from "@popperjs/core";
import $t from "redaxios";
import Ls from "terraformer-arcgis-parser";
import { dsv as pi, csv2geojson as Rs } from "csv2geojson";
import qe from "await-to-js";
import Xe from "svg.js";
import ki from "animejs";
import "tippy.js/animations/scale.css";
var Re = /* @__PURE__ */ ((r) => (r.BLOB = "blob", r.DATE = "date", r.DOUBLE = "double", r.GEOMETRY = "geometry", r.GLOBAL_ID = "global-id", r.GUID = "guid", r.INTEGER = "integer", r.LONG = "long", r.OID = "oid", r.RASTER = "raster", r.SINGLE = "single", r.SMALL_INTEGER = "small-integer", r.STRING = "string", r.XML = "xml", r))(Re || {}), Le = /* @__PURE__ */ ((r) => (r.CIRCLE = "circle", r.CROSS = "cross", r.DIAMOND = "diamond", r.ICON = "icon", r.PATH = "path", r.SQUARE = "square", r.TRIANGLE = "triangle", r.X = "x", r))(Le || {}), le = /* @__PURE__ */ ((r) => (r.DASH = "dash", r.DASHDOT = "dash-dot", r.DASHDOTDOT = "short-dash-dot-dot", r.DOT = "dot", r.LONGDASH = "long-dash", r.LONGDASHDOT = "long-dash-dot", r.LONGDASHDOTDOT = "long-dash-dot-dot", r.NONE = "none", r.NULL = "none", r.SHORTDASH = "short-dash", r.SHORTDASHDOT = "short-dash-dot", r.SHORTDASHDOTDOT = "short-dash-dot-dot", r.SHORTDOT = "short-dot", r.SOLID = "solid", r))(le || {}), Mi = /* @__PURE__ */ ((r) => (r.BEVEL = "bevel", r.MITER = "miter", r.ROUND = "round", r))(Mi || {}), Pi = /* @__PURE__ */ ((r) => (r.ROUND = "round", r.BUTT = "butt", r.SQUARE = "square", r))(Pi || {}), Ni = /* @__PURE__ */ ((r) => (r.BDIAG = "backward-diagonal", r.CROSS = "cross", r.DIAG_CROSS = "diagonal-cross", r.FDIAG = "forward-diagonal", r.HORIZONTAL = "horizontal", r.NONE = "none", r.NULL = "none", r.SOLID = "solid", r.VERTICAL = "vertical", r))(Ni || {}), T = /* @__PURE__ */ ((r) => (r.POINT = "Point", r.MULTIPOINT = "MultiPoint", r.LINESTRING = "LineString", r.MULTILINESTRING = "MultiLineString", r.POLYGON = "Polygon", r.MULTIPOLYGON = "MultiPolygon", r.LINEARRING = "LinearRing", r.EXTENT = "Extent", r.NONE = "None", r.UNKNOWN = "Unknown", r))(T || {}), Ct = /* @__PURE__ */ ((r) => (r.Simple = "simple", r.Unique = "uniqueValue", r.ClassBreaks = "classBreaks", r.Unknown = "unknown", r))(Ct || {}), S = /* @__PURE__ */ ((r) => (r.FEATURE = "esri-feature", r.MAPIMAGE = "esri-map-image", r.TILE = "esri-tile", r.IMAGERY = "esri-imagery", r.GRAPHIC = "esri-graphic", r.WMS = "ogc-wms", r.WFS = "ogc-wfs", r.GEOJSON = "file-geojson", r.GEOJSONZIPPED = "file-zip-geojson", r.CSV = "file-csv", r.SHAPEFILE = "file-shape", r.FLATGEOBUF = "file-fgb", r.FLATGEOBUFZIPPED = "file-zip-fgb", r.OSM = "osm-tile", r.DATACSV = "data-csv", r.DATAJSON = "data-json", r.DATATABLE = "data-esri-table", r.UNKNOWN = "unknown", r.SUBLAYER = "sublayer", r))(S || {}), me = /* @__PURE__ */ ((r) => (r.FEATURE = "feature", r.GRAPHIC = "graphic", r.IMAGERY = "imagery", r.MAPIMAGE = "map-image", r.NOLAYER = "no-layer", r.OSM = "osm-tile", r.TILE = "tile", r.UNKNOWN = "unknown", r.WMS = "wms", r))(me || {}), X = /* @__PURE__ */ ((r) => (r.ESRI_FEATURE = "esriFeature", r.ESRI_RASTER = "esriRaster", r.ESRI_TILE = "esriTile", r.OSM_TILE = "osmTile", r.OGC_RASTER = "ogcRaster", r.UNKNOWN = "unknown", r))(X || {}), B = /* @__PURE__ */ ((r) => (r.POINT = "Point", r.MULTIPOINT = "MultiPoint", r.LINESTRING = "LineString", r.MULTILINESTRING = "MultiLineString", r.POLYGON = "Polygon", r.MULTIPOLYGON = "MultiPolygon", r))(B || {}), Q = /* @__PURE__ */ ((r) => (r.GEOMETRIC = "geometric", r.SYMBOLIC = "symbolic", r.HYBRID = "hybrid", r.NONE = "none", r))(Q || {}), N = /* @__PURE__ */ ((r) => (r.NEW = "new", r.INITIATING = "initiating", r.INITIATED = "initiated", r.TERMINATING = "terminating", r.TERMINATED = "terminated", r))(N || {}), z = /* @__PURE__ */ ((r) => (r.NEW = "new", r.LOADING = "loading", r.LOADED = "loaded", r.ERROR = "error", r))(z || {}), ce = /* @__PURE__ */ ((r) => (r.NOT_LOADED = "not-loaded", r.NOT_VISUAL = "not-visual", r.REFRESH = "refresh", r.UP_TO_DATE = "up-to-date", r))(ce || {}), rt = /* @__PURE__ */ ((r) => (r.ESRI = "esri", r.TEXT = "text", r.IMAGE = "image", r.HTML = "html", r.XML = "xml", r.JSON = "json", r.UNKNOWN = "unknown", r))(rt || {}), ne = /* @__PURE__ */ ((r) => (r.SYMBOL = "symbol", r.GRID = "grid", r.EXTENT = "extent", r.INITIAL = "initial", r.API = "api", r.PERMANENT = "permanent", r))(ne || {}), V = /* @__PURE__ */ ((r) => (r.BoundaryZoom = "boundaryZoom", r.Datatable = "datatable", r.Identify = "identify", r.Metadata = "metadata", r.Opacity = "opacity", r.Refresh = "refresh", r.Reload = "reload", r.Remove = "remove", r.Settings = "settings", r.Symbology = "symbology", r.Visibility = "visibility", r))(V || {});
class be {
  attributes;
  geometry;
  style;
...
class _e extends Ce {
  ...
  constructor(e) {
    ...
    this._width = typeof t > "u" || t < 0 ? 0.75 : t, this._colour = new ke(e.colour), this._miter = e.miter ?? 2, this._cap = e.cap || Pi.ROUND, this._join = e.join || Mi.ROUND;
  }
...
class mt extends Ce {
  ...
  _fillStyle;
  constructor(e) {
    super(), e = e || {}, e.fill || (e.fill = {}), this._fillColour = new ke(e.fill.colour), this._fillStyle = e.fill.style || Ni.SOLID, this._outlineStyle = new _e(e.outline);
  }
  /** Returns the specified colour */
  get fillColour() {
  ...
  toESRI() {
    const e = this.outline.toESRI(), t = new xt(this.fillColour.rgba), i = new vs();
...
class $s {
  ...
  geomEsriToRamp(e, t) {
    switch (e.type) {
      ...
      case "polyline": {
        const i = e;
        return i.paths.length === 1 ? Ge.fromESRI(i, t) : ge.fromESRI(i, t);
      }
      case "polygon":
  ...
  graphicGeoJsonToRamp(e, t) {
    ...
    return Object.keys(e.properties.forEach((a) => s[a] = e.properties[a])), new be(i, "", s);
  }
  /**
  ...
  graphicRampToEsri(e) {
    ...
    return t.geometry = this.geomRampToEsri(e.geometry), Object.keys(e.attributes).forEach((i) => t.attributes[i] = e.attributes[i]), e.style && (t.symbol = this.styleRampToEsri(e.style)), new ys(t);
  }
  styleRampToEsri(e) {
    return e.toESRI();
  }
...
class It {
   ...
   */
  updateQuery(e) {
    const t = Oi.all([{}, this.queryMap, e]);
...
class ks {
  espgWorker;
  constructor() {
    this.espgWorker = this.defaultEpsgLookup, ae.defs(
      "EPSG:3978",
      "+proj=lcc +lat_1=49 +lat_2=77 +lat_0=49 +lon_0=-95 +x_0=0 +y_0=0 +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +units=m +no_defs"
    ), ae.defs(
      "EPSG:3979",
      "+proj=lcc +lat_1=49 +lat_2=77 +lat_0=49 +lon_0=-95 +x_0=0 +y_0=0 +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +units=m +no_defs"
    ), ae.defs("EPSG:54004", "+proj=merc +lon_0=0 +k=1 +x_0=0 +y_0=0 +ellps=WGS84 +datum=WGS84 +units=m +no_defs"), ae.defs("EPSG:102100", ae.defs("EPSG:3857")), ae.defs(
      "EPSG:102187",
    ...
    for (; e <= 60; ) {
      const t = e < 10 ? `0${e}` : e;
      ae.defs(`EPSG:326${t}`, `+proj=utm +zone=${e} +ellps=WGS84 +datum=WGS84 +units=m +no_defs`), e++;
    }
  }
  /**
   ...
   */
  addProjection(e, t) {
    e = typeof e == "number" ? `EPSG:${e}` : e, ae.defs(e, t);
  }
  ...
  async checkProj(e) {
    ...
    const o = async (n) => {
      try {
        ...
        return c === null || c === "" ? !1 : (ae.defs(n, c), !0);
      } catch {
        return !1;
      }
    };
  ...
  async projectGeoJson(e, t, i) {
    let s, o;
    if (t ? s = this.normalizeProj(t) : s = I.parseGeoJsonCrs(e.crs), i ? o = this.normalizeProj(i) : o = Os, o === s)
      return e;
    await this.checkProjBomber([s, o]);
    const a = ae(s, o).forward;
    return ws.applyConverter(e, a);
  }
  /**
  ...
  async projectExtent(e, t) {
    const i = (h, A, w) => {
      if (w === 0)
        return [h, A];
      const W = [(h[0] + A[0]) / 2, (h[1] + A[1]) / 2];
      if (w === 1)
        return [h, W, A];
      if (w > 1) {
        const L = i(h, W, w - 1), R = i(W, A, w - 1);
    ...
    const a = new ie("warpy", [o], t.sr, !0), l = await this.projectGeometry(e, a), n = l.toArray().pop() || [], c = n.map((h) => h[0]), u = n.map((h) => h[1]), p = Math.min.apply(null, c), d = Math.max.apply(null, c), v = Math.min.apply(null, u), f = Math.max.apply(null, u);
    return F.fromParams(t.id + "_projected", p, v, d, f, l.sr);
  }
}
class Ms {
  // useful functions
  ...
  sharedUtils;
  constructor() {
    this.proj = new ks(), this.geom = new $s(), this.sharedUtils = new Cs();
  }
  defaultTileSchemas() {
...
const Tt = U("appbar", () => {
  ...
  const r = m([]), e = m({}), t = m({}), i = m(), s = m(0), o = m(0), a = m(!0), l = m();
  function n(u) {
...
class Gs extends Z {
  ...
  _funCounter;
  constructor(e) {
    super(e), this._eventBus = new ts(), this._eventRegister = [], this._funCounter = 1, this._nameRegister = Object.values(x).filter((t) => typeof t == "string" && t.indexOf("/") > -1);
  }
  /**
...
const Lt = U("maptip", () => {
  ...
  __name: "esri-map",
  setup(r) {
    const e = Lt(), t = we("iApi"), i = P(() => e.maptipPoint), s = P(() => e.maptipInstance), o = P(() => e.content), a = ve([]);
    a.push(
      Et(i, () => {
        if (i.value) {
          let n, c;
          const u = t.geo.map.getPixelWidth() / 2, p = 0, d = t.geo.map.mapPointToScreenPoint(i.value);
          n = d.screenX - u, c = p - d.screenY, s.value.setProps({
            offset: [n, c]
    ...
    this.resizeObserver = "ResizeObserver" in self ? new ResizeObserver(function(t) {
      ...
      t.forEach(function(s) {
        ...
        Object.keys(o).forEach(function(a) {
          const l = o[a];
          s.contentRect.width >= l ? s.target.classList.add(a) : s.target.classList.remove(a);
        });
      });
    }) : void 0;
  }
...
const js = ["data-cy"], zi = /* @__PURE__ */ C({
    ...
    return (n, c) => {
      ...
      return g(), b("div", {
        ...
        re(Li, {
          ...
          default: ee(() => [
            M((g(), j(rs(r.panel.route.screen), os({ class: "h-full" }, r.panel.route.props, { panel: r.panel }), null, 16, ["panel"])), [
              [u]
            ])
          ]),
          _: 1
  ...
  const r = m(void 0), e = m(void 0), t = m(0), i = m(0), s = m(!1), o = m(!0), a = m({}), l = m({}), n = m([]), c = m([]), u = m([]), p = P(() => i.value);
  function d(E) {
  ...
  function v(E) {
    const $ = [];
    return E.forEach((he) => {
      he in l.value && $.push(l.value[he].getPromise());
    }), $;
  }
  function f(E) {
    de(E), R(), e.value = void 0;
  }
  function h(E) {
    pt(E), R();
  }
  ...
  function R() {
    let E = t.value;
    const $ = [], he = 350, Ke = 12, ni = 600;
    for (let Pe = n.value.length - 1; Pe >= 0; Pe--) {
      const Qe = n.value[Pe];
      let Te = Qe.width || he;
      if (s.value ? Te = E : Te += Ke, Qe.id === "grid" && (Te = Math.max(Math.min(Te, E), ni)), (E >= Te && !s.value || $.length === 0) && (E -= Te, $.unshift(Qe)), Qe.id === "grid" && E < ni)
        break;
    }
    if (r.value && //@ts-ignore
    !$.includes(r.value) && !s.value) {
      let Pe;
      for (let li = 0; li < $.length - 1 && E < (r.value.width || he) + Ke; li++)
        Pe = $.shift(), E += Pe.width || he;
      E >= (r.value.width || he) ? $.unshift(r.value) : e.value || (Pe = $.shift(), $.unshift(r.value));
      const Qe = n.value.indexOf(r.value), Te = n.value.indexOf(Pe), Ft = n.value.slice();
      Te > -1 && (Ft.splice(Qe, 1), Ft.splice(Te, 0, r.value)), n.value = Ft;
    }
    i.value = E, u.value = $;
  }
  function H(E) {
    if (a.value = { ...a.value, [E.id]: E }, E.id in l.value)
  ...
  function pt(E) {
    if (E.teleport) {
      const $ = c.value.indexOf(E);
      $ !== -1 && (c.value = [...c.value.slice(0, $), ...c.value.slice($ + 1)]);
    } else {
      const $ = n.value.indexOf(E);
      $ !== -1 && (n.value = [...n.value.slice(0, $), ...n.value.slice($ + 1)]);
    }
  }
  function Mt(E, $) {
    const he = n.value.indexOf(E), Ke = $ === "right" ? 1 : -1;
    u.value.includes(n.value[he + Ke]) && ([n.value[he], n.value[he + Ke]] = [
      n.value[he + Ke],
      n.value[he]
    ]);
  }
  function Pt(E) {
    a.value[E.id] !== void 0 && delete a.value[E.id], l.value[E.id] !== void 0 && delete l.value[E.id];
    const $ = u.value.indexOf(E);
    $ !== -1 && (u.value = [...u.value.slice(0, $), ...u.value.slice($ + 1)]), r.value && r.value.id == E.id && (r.value = void 0);
  }
  function Nt(E) {
    l.value = {
      ...l.value,
  ...
  __name: "panel-stack",
  setup(r) {
    const e = We(), t = we("iApi"), i = m(), s = P(() => e.mobileView);
    He(() => {
      new ResizeObserver((u) => {
        const p = !(t?.$vApp.$root?.$refs["app-size"]).classList.contains("sm");
        s.value !== p && (e.mobileView = p, t?.event.emit(x.RAMP_MOBILEVIEW_CHANGE, p)), e.setStackWidth(u[0].contentRect.width);
      }).observe(i.value?.$el);
    });
    const o = (c) => (
      //@ts-ignore
    ...
    return (c, u) => (g(), j(Ri, {
      ...
      default: ee(() => [
        (g(!0), b(je, null, ut(o(_(t).screenSize), (p) => (g(), j(zi, {
          key: `${p.id}`,
          panel: p
        }, null, 8, ["panel"]))), 128))
      ]),
  ...
  for (const [i, s] of e)
    t[i] = s;
  return t;
}, Ws = /* @__PURE__ */ Me(qs, [["__scopeId", "data-v-11f38702"]]), Hs = ["content", "aria-label"], Xt = /* @__PURE__ */ C({
  ...
  setup(r) {
    const e = m(!1), t = m(null), i = ve([]), s = m(), o = m(), a = m(), l = r;
    i.push(
      Et(e, () => {
        t.value.update();
      })
    ...
    return He(() => {
      window.addEventListener(
        ...
        a.value && o.value && (t.value = Is(a.value, o.value, {
  ...
  const r = m([]), e = m({}), t = P(() => r.value.length >= 99 ? 99 : r.value.length);
  function i(c) {
    r.value = [c, ...r.value];
  }
  function s(c) {
    if (r.value.includes(c)) {
      ...
      c instanceof Vi && n(c), u > -1 && r.value.splice(u, 1);
    }
  }
  function o(c) {
    e.value[c.id] = c;
...
}), Ys = { class: "h-full flex flex-col" }, Js = { class: "w-full flex mb-6" }, Zs = ["content", "aria-label"], Ks = /* @__PURE__ */ C({
  __name: "screen",
  props: {
    panel: {
      type: Object,
  ...
  setup(r) {
    ...
    return (o, a) => {
      const l = K("panel-screen"), n = k("tippy");
      return g(), j(l, { panel: r.panel }, {
        header: ee(() => [
          st(G(_(t)("notifications.title")), 1)
        ]),
        content: ee(() => [
          y("div", Ys, [
            y("div", Js, [
...
class Qs extends Z {
  ...
  addGroup(e, t, i) {
    ...
    const s = new Vi(this.$iApi, e, t, i);
...
const Xs = ["content"], er = { class: "flex items-center text-left" }, tr = { class: "select-text cursor-text" }, ir = ["content"], sr = {
  key: 0,
  class: "text-left"
}, rr = /* @__PURE__ */ C({
  ...
  setup(r) {
    ...
    return (n, c) => {
      ...
      return M((g(), b("li", {
        ...
        y("div", er, [
          y("span", null, [
            st(G(o[r.notification.type]) + " ", 1),
            y("span", tr, G(r.notification.message), 1)
          ]),
          c[4] || (c[4] = y("span", { class: "flex-grow" }, null, -1)),
          r.notification.messageList ? (g(), b("div", {
            key: 0,
        ...
        r.notification.messageList && s.value ? (g(), b("div", sr, [
          (g(!0), b(je, null, ut(r.notification.messageList, (p, d) => (g(), b("p", {
  ...
  setup(r) {
    ...
    const a = P(() => e.notificationStack);
    return (l, n) => {
      const c = k("focus-item"), u = k("focus-list"), p = k("tippy");
      return g(), b("div", null, [
        a.value.length > 0 ? M((g(), b("ul", {
          key: 0,
          content: _(t)("panels.controls.items"),
          ref_key: "el",
          ref: i
        }, [
          (g(!0), b(je, null, ut(a.value, (d, v) => (g(), b(je, {
            key: d.message + v
          }, [
            v > 0 ? (g(), b("div", ar)) : D("", !0),
            M(re(rr, {
          ...
          [u],
          [p, { trigger: "manual", placement: "top-start" }]
        ]) : (g(), b("div", nr, [
          ...
          y("span", null, G(_(t)("notifications.empty")), 1),
          n[2] || (n[2] = y("span", { style: { "flex-grow": "6" } }, null, -1))
        ]))
      ]);
    };
  }
}), lr = { class: "flex items-center hover:text-white" }, cr = ["aria-label"], ur = {
  key: 0,
  class: "number rounded-full w-18 text-white"
}, pr = { class: "notification-dropdown pointer-events-auto bg-white rounded text-center text-black w-500 h-256 flex flex-col p-0" }, dr = { class: "pb-8 border-b border-gray-600" }, hr = { class: "absolute flex right-3 top-3" }, fr = ["content", "aria-label"], mr = /* @__PURE__ */ C({
  __name: "caption-button",
  setup(r) {
    const e = Ie(), { t } = q(), i = P(() => e.notificationNumber), s = () => e.clearAll();
    return (o, a) => {
      const l = K("close"), n = k("tippy");
      return g(), j(Xt, {
        position: "top-start",
        ...
        header: ee(() => [
          y("div", lr, [
            ...
            i.value && i.value > 0 ? (g(), b("span", ur, G(i.value), 1)) : D("", !0)
          ])
        ]),
        default: ee((c) => [
          y("div", pr, [
            y("div", null, [
              y("h4", dr, G(_(t)("notifications.title")), 1),
              y("div", hr, [
                M((g(), b("button", {
                  type: "button",
                  onClick: s,
...
}), yr = /* @__PURE__ */ Me(mr, [["__scopeId", "data-v-3623a7d2"]]), gr = { class: "flex hover:text-white" }, vr = ["aria-label"], br = { class: "about-ramp-dropdown pointer-events-auto bg-white rounded w-256 h-50" }, wr = { class: "pb-8 border-b border-gray-600 mb-10" }, Ar = { class: "absolute right-5 top-5" }, Er = { class: "select-text" }, xr = { class: "font-bold cursor-text" }, Sr = { class: "text-sm cursor-text" }, _r = { class: "text-sm cursor-text" }, Ir = /* @__PURE__ */ C({
  ...
  setup(r) {
    ...
    return (o, a) => {
      const l = K("close"), n = K("dropdown-menu"), c = k("focus-item");
      return M((g(), j(n, {
        ...
        default: ee((u) => [
          y("div", br, [
            y("div", null, [
              ...
              y("div", Er, [
                y("div", null, [
                  y("span", xr, G(t.value), 1),
                  y("span", Sr, " [" + G(i.value) + "] ", 1)
                ]),
                y("div", null, [
                  y("span", _r, G(s.value), 1)
                ]),
                a[1] || (a[1] = y("div", { class: "mt-5" }, [
                  y("a", {
...
}), Tr = /* @__PURE__ */ Me(Ir, [["__scopeId", "data-v-dd0345a4"]]), Lr = { class: "map-caption absolute bottom-0 h-29 sm:h-38 flex justify-end pointer-events-auto cursor-default select-none text-gray-200 bg-black-75 left-0 right-0 py-2 sm:py-6" }, Rr = {
  key: 0,
  class: "relative top-2 sm:top-1 ml-4 sm:ml-0 shrink-0"
}, $r = ["href", "aria-label"], Cr = ["src", "alt"], Or = {
  key: 1,
  class: "relative ml-10 top-2 text-sm sm:text-base"
}, kr = { class: "flex min-w-fit justify-end" }, Mr = {
  key: 0,
  class: "pl-8 px-14 sm:block display-none relative top-2"
}, Pr = ["aria-pressed", "aria-label", "content"], Nr = { class: "relative top-1 text-sm sm:text-base" }, Fr = { class: "text-gray-200 hover:text-white text-sm sm:text-base pb-5" }, Dr = ["onClick"], Gr = {
  key: 0,
  class: "sr-only"
}, Ur = /* @__PURE__ */ C({
  __name: "map-caption",
  setup(r) {
    const e = De(), t = ue(), { t: i } = q(), s = we("iApi"), o = P(() => e.scale), a = P(() => e.attribution), l = P(() => e.coords), n = P(() => e.langtoggle), c = P(() => t.config.map), u = m([]), p = ve([]);
    p.push(
      Et(c, (h) => {
    ...
    return (h, A) => {
      const w = K("dropdown-menu"), W = k("truncate"), L = k("tippy");
      return g(), b("div", Lr, [
        re(Tr, {
          class: "sm:block display-none ml-8 mr-4",
          position: "top-end"
        }),
        re(yr, { class: "sm:block display-none" }),
        a.value?.logo.disabled ? D("", !0) : (g(), b("span", Rr, [
          y("a", {
        ...
        a.value?.text.disabled ? D("", !0) : M((g(), b("span", Or, [
          st(G(a.value?.text.value), 1)
        ])), [
          [W, {
            options: {
              placement: "top",
        ...
        A[0] || (A[0] = y("span", { class: "flex-grow w-15" }, null, -1)),
        y("div", kr, [
          l.value?.disabled ? D("", !0) : M((g(), b("div", Mr, [
            st(G(l.value?.formattedString), 1)
          ])), [
            [W, {
              options: {
                hideOnClick: !1,
          ...
          o.value?.disabled ? D("", !0) : M((g(), b("button", {
            key: 1,
            type: "button",
          ...
          n.value?.disabled ? D("", !0) : (g(), j(w, {
            ...
            header: ee(() => [
              y("span", Fr, G(_(i)("map.language.short")), 1)
            ]),
            default: ee(() => [
              (g(!0), b(je, null, ut(u.value, (R, H) => (g(), b("a", {
                key: `${R}-${H}`,
                class: oe(["flex-auto items-center text-sm sm:text-base cursor-pointer", { "font-bold": R === _(s).$i18n.locale.value }]),
                href: "javascript:;",
                onClick: (de) => d(R)
              }, [
                st(G(_(i)("map.language." + R)) + " ", 1),
                R === _(s).$i18n.locale.value ? (g(), b("span", Gr, G(_(i)("map.language.curr")), 1)) : D("", !0)
              ], 10, Dr))), 128))
            ]),
            _: 1
          }, 8, ["tooltip", "ariaLabel"]))
  ...
  setup(r) {
    ...
    return (o, a) => {
      ...
      return M((g(), b("button", {
        ...
        s.value && s.value > 0 ? (g(), b("span", zr, G(s.value), 1)) : D("", !0)
      ], 8, Br)), [
        [l]
      ]);
    };
  }
}), jr = /* @__PURE__ */ Me(Vr, [["__scopeId", "data-v-a451db5c"]]), qr = { class: "flex items-center mb-20" }, Wr = { class: "text-xl" }, Hr = /* @__PURE__ */ C({
  __name: "keyboard-instructions",
  setup(r) {
    const e = we("iApi"), { t } = q(), i = m(!1), s = m(["app", "lists", "map"]), o = m([]), a = m(null), l = m(null);
    He(() => {
      o.value.push(
    ...
    return (c, u) => {
      ...
      return i.value ? (g(), b("div", {
        ...
        y("div", {
          ...
          y("div", qr, [
            y("h2", Wr, G(_(t)("keyboardInstructions.title")), 1),
            re(p, {
              class: "ml-auto",
              onClick: u[0] || (u[0] = (d) => i.value = !1)
            })
          ]),
          (g(!0), b(je, null, ut(s.value, (d) => (g(), b("p", {
...
}), et = U("instance", () => ({ started: m(!1) })), Yr = { class: "h-full relative" }, Jr = { class: "inner-shell absolute top-0 left-0 h-full w-full pointer-events-none" }, Zr = { class: "absolute top-8 w-full flex justify-center" }, Kr = {
  key: 1,
  class: "w-full h-full"
}, Qr = /* @__PURE__ */ C({
  __name: "shell",
  setup(r) {
    const e = we("iApi"), t = et(), i = ye(), s = We(), { t: o } = q(), a = P(() => i.items.appbar), l = () => {
      e?.event.emit("openKeyboardInstructions");
    }, n = () => (
      // @ts-ignore
      s.teleported
    );
    return (c, u) => (g(), b("div", Yr, [
      y("div", Jr, [
        ...
        re(Hr),
        re(Ws, { class: "panel-stack sm:flex absolute inset-0 overflow-hidden sm:p-12 z-10 sm:pl-80 xs:pl-40 sm:pb-48 xs:pb-28 xs:pr-0 sm:pr-40" }),
        a.value ? D("", !0) : (g(), j(jr, { key: 0 })),
        re(Ur, { class: "z-30" })
      ]),
      _(t).started ? (g(), j(Vs, { key: 0 })) : (g(), b("div", Kr, u[1] || (u[1] = [
        y("div", { class: "spinner relative inset-x-1/2 inset-y-9/20" }, null, -1)
      ]))),
      (g(!0), b(je, null, ut(n(), (p) => (g(), j(ls, {
...
}), Xr = /* @__PURE__ */ Me(Qr, [["__scopeId", "data-v-6c131943"]]), eo = C({
  name: "App",
  components: { Shell: Xr },
  setup() {
    const r = cs();
    He(() => {
      new Bi().observe(r?.proxy?.$refs["app-size"]), xs({
        aria: {
          content: "labelledby"
        },
        theme: "ramp4",
...
const ro = /* @__PURE__ */ Me(eo, [["render", so]]), Ee = "focus-list", ze = "focus-item", oo = "focus-icon", ao = "focus-container", at = `[${Ee}],[${ao}]`, vt = "truncate-text", bt = "show-truncate", it = "focused", Ht = `button,input,select,a,textarea,[contenteditable],[${Ee}],[${oo}],[tabIndex]`, no = {
  mounted(r, e) {
    +r.getAttribute("tabindex") <= 0 && r.setAttribute("tabindex", "0"), r.toggleAttribute(Ee, !0), new lo(r, e.value);
  },
  updated(r) {
    qi(r);
  }
...
function qi(r) {
  r.querySelectorAll(Ht).forEach((t) => {
    if (t.closest(at) === r || t.closest(at) === t && t.parentElement.closest(at) === r)
      if (t.closest(`[${Ee}],.${it}`).classList.contains(it))
...
class lo {
  ...
  setTabIndex(e, t = this.element) {
    t.querySelectorAll(Ht).forEach((s) => {
      (e === -1 || s.closest(at) === this.element || s.closest(at) === s && s.parentElement.closest(at) === this.element || s.closest(`[${Ee}],.${it}`).classList.contains(it)) && s.setAttribute("tabindex", e.toString());
    });
  }
  /**
   ...
   */
  defocusItem(e) {
    e.classList.remove(it), this.setTabIndex(-1, e), e._tippy && e._tippy.hide(), e.getAttribute(ze) === bt && e.querySelector(`[${vt}]`)?._tippy?.hide();
  }
  /**
   ...
   */
  focusItem(e) {
    e.classList.add(it), this.setAriaActiveDescendant(e), this.setTabIndex(0, e), e.scrollIntoView({ block: "nearest" }), e._tippy && !this.isTapped && e._tippy.show(), e.getAttribute(ze) === bt && e.querySelector(`[${vt}]`)?._tippy?.show(), this.isTapped = !1;
  }
  /**
   ...
   */
  onFocus() {
    this.highlightedItem && !this.isClicked && (this.highlightedItem._tippy && this.highlightedItem._tippy.show(), this.highlightedItem.getAttribute(ze) === bt && this.highlightedItem.querySelector(`[${vt}]`)?._tippy?.show()), this.isClicked = !1, this.element.hasAttribute("aria-activedescendant") || this.highlightedItem === this.element ? this.highlightedItem !== this.element && this.focusItem(this.highlightedItem) : this.setAriaActiveDescendant(this.highlightedItem), qi(this.element), this.highlightedItem && this.highlightedItem !== this.element && this.highlightedItem.setAttribute("tabindex", "-1");
  }
  /**
...
const hi = "focus-item", co = {
  beforeMount(r, e) {
    r.hasAttribute("id") || r.setAttribute("id", uo()), e.value ? r.setAttribute(hi, e.value) : r.toggleAttribute(hi, !0);
  }
};
function uo() {
  let r;
...
const ei = "focus-container", Wi = "focus-list", po = "focus-icon", Ut = `[${Wi}],[${ei}]`, fi = `button,input,select,a,textarea,[contenteditable],.ag-tab-guard,[${Wi}],[${ei}],[${po}],[tabIndex]`;
let Bt = [];
const ho = {
  mounted(r) {
    [...document.querySelectorAll(".inner-shell")].some((t) => t.contains(r)) && Bt.push(new fo(r));
  },
  beforeUnmount(r) {
...
const mo = "truncate-text", yo = "truncate-trigger", go = {
  beforeMount(r, e) {
    !r.classList.contains("truncate") && !e.value?.noTruncateClass && r.classList.add("truncate"), r.toggleAttribute(mo, !0);
  },
  mounted(r, e) {
    let t;
    e.value && e.value.externalTrigger && (t = r.closest(`[${yo}]`)), Ss(r, {
...
const bo = ["content"], wo = {
  ...
  setup(r, { expose: e }) {
    const { t } = q(), i = We(), s = Tt(), o = we("iApi"), a = m();
    e({ el: a });
    const l = r, n = P(() => o?.fixture.get("appbar") ? s.temporary : []), c = P(() => i.mobileView), u = P(() => i.reorderable), p = () => !c.value && !l.panel.teleport, d = (f) => {
      l.panel.move(f), f === "left" && Rt(() => {
        (a.value?.querySelector(".move-left")).focus();
      });
    }, v = P(() => l.screenId ? l.panel.screens[l.screenId][o?.$i18n.locale.value ?? "en"] : null);
    return He(() => {
      a.value?.addEventListener("blur", () => {
        a.value._tippy.hide();
      }), a.value?.addEventListener("keyup", (f) => {
        f.key === "Tab" && a.value?.matches(":focus") && a.value._tippy.show();
      });
    }), ct(() => {
      a.value?.removeEventListener("blur", () => {
        a.value._tippy.hide();
      }), a.value?.removeEventListener("keyup", (f) => {
        f.key === "Tab" && a.value?.matches(":focus") && a.value._tippy.show();
      });
    }), (f, h) => {
      const A = K("back"), w = K("panel-options-menu"), W = K("left"), L = K("right"), R = K("pin"), H = K("expand"), de = K("minimize"), pt = K("close"), Mt = k("truncate"), Pt = k("focus-item"), Nt = k("tippy");
      return M((g(), b("div", {
        ...
        r.header ? (g(), b("header", wo, [
          re(A, {
            class: oe(r.panel.teleport ? "display-none" : "block sm:display-none"),
            onClick: h[0] || (h[0] = (E) => r.panel.close())
          }, null, 8, ["class"]),
          M((g(), b("h2", Ao, [
            f.$slots.header ? Oe(f.$slots, "header", { key: 0 }) : (g(), b("div", Eo, G(_(t)(r.panel.alertName)), 1))
          ])), [
            [Mt]
          ]),
          f.$slots.controls ? (g(), j(w, { key: 0 }, {
            default: ee(() => [
              Oe(f.$slots, "controls")
            ]),
            _: 3
          ...
          y("div", {
            ...
            r.panel.teleport ? D("", !0) : (g(), b("div", xo, [
              u.value ? (g(), j(W, {
                key: 0,
              ...
              r.panel.controls && r.panel.controls.expand ? (g(), j(H, {
                key: 2,
                onClick: h[4] || (h[4] = (E) => r.panel.expand()),
                active: r.panel.expanded
              }, null, 8, ["active"])) : D("", !0)
            ])),
            r.panel.button && n.value?.includes(r.panel.id) ? (g(), j(de, {
              key: 1,
        ...
        r.content ? (g(), b("div", So, [
          f.$slots.content ? Oe(f.$slots, "content", { key: 0 }) : v.value ? (g(), b("div", {
            key: 1,
            innerHTML: v.value.innerHTML
          }, null, 8, _o)) : D("", !0)
        ])) : D("", !0),
        r.footer ? M((g(), b("div", Io, [
          Oe(f.$slots, "footer")
        ])), [
          [Pt]
        ]) : D("", !0)
...
}), Lo = { class: "relative" }, Ro = ["content", "aria-label"], $o = ["transform"], Co = /* @__PURE__ */ C({
  __name: "pin",
  props: {
    active: Boolean
  },
...
}), Oo = { class: "relative" }, ko = ["content", "aria-label"], Mo = /* @__PURE__ */ C({
  __name: "close",
  props: {
    active: Boolean
  },
...
}), Po = { class: "relative" }, No = ["content", "aria-label"], Fo = /* @__PURE__ */ C({
  __name: "back",
  props: {
    active: Boolean
  },
...
}), Do = { class: "w-32 h-32" }, Go = ["content"], Uo = {
  key: 0,
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 24 24",
...
}), Vo = { class: "relative" }, jo = ["content", "aria-label"], qo = /* @__PURE__ */ C({
  __name: "minimize",
  props: {
    active: Boolean
  },
...
}), Wo = { class: "relative" }, Ho = ["content", "aria-label"], Yo = /* @__PURE__ */ C({
  __name: "right",
  props: {
    active: Boolean
  },
...
}), Jo = { class: "relative" }, Zo = ["content", "aria-label"], Ko = /* @__PURE__ */ C({
  __name: "left",
  props: {
    active: Boolean
  },
...
}), Xo = /* @__PURE__ */ Me(Qo, [["__scopeId", "data-v-51e22a4a"]]), ea = {
  key: 0,
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 24 24",
  ...
  setup(r) {
    ...
    return (s, o) => {
      ...
      return g(), j(a, {
        ...
        default: ee(() => [
          _(t).isFullscreen ? (g(), b("svg", ea, o[0] || (o[0] = [
            y("path", {
              d: "M0 0h24v24H0z",
              fill: "none"
            }, null, -1),
  ...
  setup(r) {
    ...
    const s = async () => {
      ...
      let n = new Y("geolocation", l, I.latLongSR(), !0);
  ...
  tabindex: "-1"
}, aa = ["content", "aria-label"], na = /* @__PURE__ */ C({
  __name: "button",
  props: {
    onClickFunction: {
      type: Function,
  ...
  class: "relative",
  tabindex: "-1"
}, ca = ["aria-label", "content"], ua = /* @__PURE__ */ C({
  __name: "button",
  props: {
    onClickFunction: {
      type: Function,
  ...
  setup(r) {
    const e = we("iApi"), t = r, i = () => e?.event.emit(x.APPBAR_BUTTON_CLICK, t.id);
    return (s, o) => {
      const a = k("focus-item"), l = k("tippy");
      return g(), b("div", la, [
        M((g(), b("button", {
          type: "button",
...
}), pa = /* @__PURE__ */ Me(ua, [["__scopeId", "data-v-457cd2d4"]]), da = U("areas-of-interest", () => ({ areas: m([]) })), ha = U("export", () => {
  const r = m({
    title: !0,
    map: !0,
    mapElements: !0,
...
class ya {
  ...
  fsaToProvinces(e) {
    const t = {};
    let i = ma[e.substring(0, 1).toUpperCase()];
...
function wa(r, e) {
  ...
  if (t.test(e) && !r.disabledSearchTypes.includes("LAT/LNG")) {
    const o = e.slice(0, -1);
    return new Aa(r, o);
  } else return s.test(e) && !r.disabledSearchTypes.includes("FSA") ? new Ea(r, e) : i.test(e) && !r.disabledSearchTypes.includes("NTS") ? new xa(r, e.substring(0, 6).toUpperCase()) : new Sa(r, e);
}
class Ot {
  config;
  query;
...
const yi = "https://geogratis.gc.ca/services/geolocation/@{language}/locate", gi = "https://geogratis.gc.ca/services/geoname/@{language}/geonames.json", vi = "https://geogratis.gc.ca/services/geoname/@{language}/codes/province.json", bi = "https://geogratis.gc.ca/services/geoname/@{language}/codes/concise.json", _a = {
  10: "NL",
  11: "PE",
  12: "NS",
  13: "NB",
...
class wi {
  ...
  constructor(e, t) {
    ...
    l ? (i = l.geoLocation ? l.geoLocation : yi, s = l.geoNames ? l.geoNames : gi, o = l.geoProvince ? l.geoProvince : vi, a = l.geoTypes ? l.geoTypes : bi) : (i = yi, s = gi, o = vi, a = bi), i = i.replace("@{language}", e), s = s.replace("@{language}", e), o = o.replace("@{language}", e), a = a.replace("@{language}", e);
    const n = t?.settings;
    let c, u, p, d, v;
   ...
   */
  query(e) {
    return wa(this.config, e.toUpperCase()).onComplete.then((t) => {
      let i = [];
...
const Ia = U("geosearch", () => {
  const r = m(new wi("en", void 0)), e = m({
    type: "",
    province: "",
    extent: void 0
  }), t = m(!1), i = m(""), s = m(""), o = m(""), a = m([]), l = m([]), n = m(!1), c = m([]), u = P(
    () => new Promise((L) => {
      r.value.fetchProvinces().then((R) => {
        R.sort((H, de) => H.name > de.name ? 1 : -1), L(R);
      });
    })
  ), p = P(
    () => new Promise((L) => {
      r.value.fetchTypes().then((R) => {
        R.sort((H, de) => H.name > de.name ? 1 : -1), L(R);
      });
    })
  );
  ...
  function v(L) {
    n.value = !0;
    const R = i.value.replace(/["!*$+?^{}()|[\]\\]/g, "").trim();
    if (!R)
      a.value = [], l.value = [], n.value = !1;
    else if (R && R !== o.value || L) {
      const H = setInterval(() => {
        r.value.config.provinces.listFetched && r.value.config.types.typesFetched && (clearInterval(H), r.value.query(`${R}*`).then((de) => {
          c.value = de.failedServs, o.value = R, l.value = de.results;
          const pt = Ai(
            t.value,
            //@ts-ignore
            e.value,
  ...
  function w(L) {
    ...
    L = L.normalize("NFD").replace(/[\u0300-\u036f]/g, "").toLowerCase(), s.value = Array.from(L).map((H) => Object.keys(R).includes(H) ? "[" + H + R[H] + "]" : H.replace(/["$!*+?^{}()|[\]\\]/g, "").replace(/[.\\]/g, "\\$&").trim()).join("");
  }
  function W(L) {
...
}), Ta = U("help", () => ({ location: m("./help/") }));
var Hi = /* @__PURE__ */ ((r) => (r.Visibility = "visibilityButton", r.Expand = "expandButton", r))(Hi || {}), Yt = /* @__PURE__ */ ((r) => (r.Item = "item", r.Placeholder = "placeholder", r.Error = "error", r))(Yt || {});
class Yi extends Z {
  _uid;
  _name;
  _type;
   ...
   */
  constructor(e, t, i) {
    super(e), this._uid = nt.sharedUtils.generateUUID(), this._name = t.name, this._type = t.type ?? "placeholder", this._parent = i, this._children = [], this._loadPromise = new J(), this._hidden = t.hidden ?? !1, this._expanded = t.expanded ?? !0, this._visibility = !0, this._exclusive = t.exclusive ?? !1, this._controls = t.controls?.slice() ?? [
      "visibilityButton",
      "expandButton"
      /* Expand */
...
var La = /* @__PURE__ */ ((r) => (r.Title = "title", r.Text = "text", r.Image = "image", r.Markdown = "markdown", r.Template = "template", r))(La || {});
class Ei extends Yi {
  _infoType;
  ...
  constructor(e, t, i) {
    ...
    }), (t.infoType || t.content) && (this._controls = t.controls?.slice() ?? [Hi.Expand]), super.load();
  }
...
const Ra = U("legend", () => {
  ...
  function o(n) {
    if (n.parent === void 0)
      ...
      if (!(n.item instanceof Ei) && !(n.item instanceof Ne)) {
  ...
  function a(n) {
    const c = (u) => (u = u.filter((p) => (p === n && !p.children.length && p.onRemoved(), p !== n)), u.forEach((p) => {
      ...
      (p) => !(p instanceof Ei && !p.children.length && p.content === "")
    ), u);
    e.value = c(e.value);
  }
  function l(n) {
  ...
  const r = m({
    ...
    tileSchemas: [],
    initialBasemapId: ""
  }), e = m({}), t = m(!0), i = m(1.5), s = m("#FF0000"), o = m(1), a = m("#000000"), l = m(0.25);
  function n(c) {
...
const Pa = U("wizard", () => {
  const r = {
    ...
    layerType: S.UNKNOWN,
    url: ""
  }, e = m(), t = m(""), i = m(""), s = m(!0), o = m(null), a = m({
    config: r,
    configOptions: []
  }), l = m(te.UPLOAD);
  function n(c) {
...
class Na {
  ...
  _isFullscreen;
  constructor(e, t, i) {
    this.event = new Gs(this);
    const s = Fa(e, this);
    this.$vApp = s.app, this.$element = s.element, this.$i18n = s.i18n, this.fixture = new Cn(this), this.panel = new On(this), this.geo = new Rn(this), this.ui = {
      ...
      escapeHtml: () => "",
      isPlainText: () => !0
    }, this.notify = new Qs(this), this._isFullscreen = Ae.isEnabled && !!this.$vApp.$root && Ae.isFullscreen && Ae.element === this.$vApp.$root.$el, Ae.isEnabled && Ae.onchange(() => {
   ...
   */
  initialize(e, t, i) {
    const s = ue(this.$vApp.$pinia), o = We(this.$vApp.$pinia), a = Lt(this.$vApp.$pinia);
    if (t?.configs !== void 0) {
      ...
      const u = setInterval(() => {
        ...
        f && (clearInterval(u), this.geo.map.createMap(c.map, f).then(() => {
          if (f._tippy.hide(0), a.setMaptipInstance(f._tippy), c.layers && c.layers.length > 0) {
            let h = 0;
            c.layers.forEach((A) => {
              const w = this.geo.layer.createLayer(A);
              this.geo.map.addLayer(w, h).catch(() => {
              }), w.mapLayer && h++;
            });
          }
        }));
   ...
   */
  reload(e, t) {
    const i = et(this.$vApp.$pinia), s = Ie(this.$vApp.$pinia), o = ue(this.$vApp.$pinia), a = ye(this.$vApp.$pinia), l = Se(this.$vApp.$pinia), n = qt(this.$vApp.$pinia), c = !!e;
  ...
  useStore(e) {
    if (!([
      ...
      switch (e) {
        ...
        case "details":
          return Ui(this.$vApp.$pinia);
        case "export":
          return ha(this.$vApp.$pinia);
        case "extentguard":
          return fa(this.$vApp.$pinia);
        case "geosearch":
          return Ia(this.$vApp.$pinia);
        case "grid":
  ...
  setLanguage(e) {
    ...
    s[o] !== s[e] && (this.event.emit(x.CONFIG_CHANGE, a), this.reload()), this.event.emit(x.LANG_CHANGE, {
      oldLang: o,
      newLang: e
    });
  }
   ...
   */
  get started() {
    return et(this.$vApp.$pinia).started;
  }
  /**
...
function Fa(r, e) {
  ...
  t.use(({ store: a }) => {
    const l = ui(a.$state);
    a.$reset = () => a.$patch(ui(l));
  });
  const i = zs(), s = $i(ro).use(i).use(Es, {
    directive: "tippy",
    // => v-tippy
    component: "tippy"
    // => <tippy/>
  }).use(t);
  s.directive("focus-container", ho), s.directive("focus-list", no), s.directive("focus-item", co), s.directive("truncate", go), s.component("panel-screen", To), s.component("pin", Co), s.component("close", Mo), s.component("back", Fo), s.component("expand", zo), s.component("panel-options-menu", Xo), s.component("dropdown-menu", Xt), s.component("minimize", qo), s.component("right", Yo), s.component("left", Ko), s.component("fullscreen-nav-button", ia), s.component("geolocator-nav-button", sa), s.component("home-nav-button", ra), s.component("mapnav-button", na), s.component("appbar-button", pa), s.component("transition", Li), s.component("transition-group", Ri), s.config.globalProperties.$iApi = e, s.config.globalProperties.$pinia = t, s.provide("iApi", e);
  const o = s.mount(r);
...
class ti {
  ...
  static async create(e) {
    const t = new ti(e), i = e.layers.map((a) => {
      if (a.layerType === S.TILE)
        return O.TileLayer({
          url: a.url,
          opacity: a.opacity
        });
      if (a.layerType === S.MAPIMAGE)
        return O.MapImageLayer({
          url: a.url,
          opacity: a.opacity
        });
      if (a.layerType === S.OSM)
...
class Da extends Z {
  ...
  async createMap(e, t) {
    ...
    const l = {};
    this.esriMap = se(await O.Map(l)), this.pointZoomScale = e.pointZoomScale && e.pointZoomScale > 0 ? e.pointZoomScale : 5e4, this._targetDiv = t, this.createMapView(e.initialBasemapId);
  }
  /**
  ...
  updateAttribution(e) {
    ...
    if (e ? (e.logo ? e.logo.disabled ? s.logo.disabled = !0 : (s.logo.altText = e.logo.altText || i.altText, s.logo.link = e.logo.link || i.link, s.logo.value = e.logo.value || i.value) : (s.logo.altText = i.altText, s.logo.link = i.link, s.logo.value = i.value), e.text ? e.text.disabled ? s.text.disabled = !0 : s.text.value = e.text.value || t.value : s.text.value = t.value, De(this.$vApp.$pinia).setAttribution(s)) : (s.logo.altText = i.altText, s.logo.link = i.link, s.logo.value = i.value, s.text.value = t.value), !e || e.text?.disabled || !e.text) {
      ...
      const a = 5e3, l = 20, n = this.$iApi.geo.map.esriMap.basemap.baseLayers.map((c) => new Promise((u) => {
        let p = 0;
        const d = a / l, v = setInterval(function() {
          c.loaded && !c.loadError ? (clearInterval(v), u(c)) : p > d && (clearInterval(v), u(null)), p++;
        }, l);
      })).toArray();
...
class Ba extends Da {
   ...
   */
  constructor(e) {
    super(e), this.maptip = new Ga(e), this.caption = new Ua(e), this.mapMouseThrottle = 0;
  }
  async createMap(e, t) {
  ...
  async setBasemap(e) {
    ...
    const t = ue(this.$vApp.$pinia), i = await this.findBasemap(e), o = t.activeBasemapConfig.tileSchemaId !== i.tileSchemaId;
    if (o) {
      const a = this.getExtent().center(), l = this.getScale();
      this._viewPromise = new J(), this.created = !1, this.$iApi.event.emit(x.MAP_REFRESH_START), this.destroyMapView(), this.createMapView(i), await this.viewPromise.then(() => {
      ...
      this.esriView.background = a, this.$iApi.event.emit(x.MAP_BASEMAPCHANGE, {
        basemapId: e,
        schemaChanged: o
      });
    }
  ...
  addLayer(e, t = void 0) {
    return new Promise((i, s) => {
      ...
      Se(this.$vApp.$pinia).addLayer(e, t), this.$iApi.event.emit(x.LAYER_REGISTERED, e);
      const a = Date.now();
      let l = 0;
      const n = setInterval(() => {
        l += 250, l >= e.expectedTime.fail || e.layerState === z.ERROR ? (clearInterval(n), e.lastCancel < a && console.error(`Failed to add layer: ${e.id}.`), s()) : e.initiationState === N.INITIATED && (e.esriLayer || !e.mapLayer) && (clearInterval(n), e.mapLayer ? this.insertToEsriMap(e) : e.onLoad(), i());
      }, 250);
    });
  }
  /**
  ...
  removeLayer(e) {
    ...
    i.removeLayer(t), i.removeLayerConfig(t.id), t.removeEsriLayer(), t.initiationState === N.INITIATED && t.terminate(), t.isRemoved = !0, this.$iApi.event.emit(x.LAYER_REMOVE, t);
  }
  /**
  ...
  */
  ...
  runIdentify(e) {
    ...
    return this.$iApi.event.emit(x.MAP_IDENTIFY, n), n;
  }
  /**
  ...
  async getGraphicAtCoord(e) {
    ...
    if (s.some((n) => {
      ...
      return c ? (!c.isCosmetic && c.layerType !== S.GRAPHIC && (o = c, a = n.graphic), !0) : (l.add(n.layer.id), !1);
    }), o && a)
      return {
        oid: a.getObjectId(),
        layerId: o.id,
...
const za = { geometryType: "point", renderer: { type: "simple", symbol: { type: "esriSMS", style: "esriSMSCircle", color: [67, 100, 255, 200], size: 7, outline: { color: [0, 0, 0, 255], width: 1 } } } }, Va = { geometryType: "polyline", renderer: { type: "simple", symbol: { type: "esriSLS", style: "esriSLSSolid", color: [90, 90, 90, 200], width: 2 } } }, ja = { geometryType: "polygon", renderer: { type: "simple", symbol: { type: "esriSFS", style: "esriSFSSolid", color: [76, 76, 125, 200], outline: { type: "esriSLS", style: "esriSLSSolid", color: [110, 110, 110, 255], width: 1 } } } }, qa = { geometryType: "polygon", renderer: { type: "simple", symbol: { type: "esriSFS", style: "esriSFSSolid", color: [255, 0, 0, 64], outline: { type: "esriSLS", style: "esriSLSSolid", color: [240, 128, 128, 255], width: 1 } } } }, Wa = {
  circlePoint: za,
  solidLine: Va,
  outlinedPoly: ja,
  boundingBoxPoly: qa
...
class Qa extends Z {
  ...
  extractCsvFields(e, t = ",") {
    return pi.dsvFormat(t).parseRows(e)[0].map((s) => ({ name: s, type: Re.STRING }));
  }
  /**
  ...
  filterCsvLatLonFields(e, t = ",") {
    const i = pi.dsvFormat(t).parseRows(e), s = i[0], o = {
  ...
  async geoJsonToEsriJson(e, t) {
    ...
    Ya(e);
    const l = e.features[0].geometry.type, n = Ha[l], c = JSON.parse(
      // @ts-ignore
      JSON.stringify(Wa[n])
    );
    if (t) {
    ...
    s || (s = I.parseGeoJsonCrs(e.crs)), a.renderer = await O.RendererFromJson(c.renderer), a.fields = (a.fields || []).concat(
      t.fieldMetadata?.exclusiveFields ? this.extractGeoJsonFields(e).filter(
        (h) => t.fieldMetadata?.fieldInfo?.find((A) => A.name === h.name)
    ...
    const d = Ls.convert(e, { sr: 8888 });
    a.geometryType = this.$iApi.geo.geom.geoJsonGeomTypeToEsriGeomType(l);
    const v = a.fields.map((h) => h.name);
    for (let h = 0; h < d.length; h++) {
      const A = d[h];
      A.geometry.spatialReference = p, A.geometry.type = a.geometryType, Object.keys(A.attributes).forEach((w) => {
        v.includes(w) ? (Array.isArray(A.attributes[w]) || typeof A.attributes[w] == "object") && A.attributes[w] != null && (A.attributes[w] = JSON.stringify(A.attributes[w])) : delete A.attributes[w];
      });
    }
    return (t.fieldMetadata?.fieldInfo && t.fieldMetadata?.fieldInfo.length > 0 ? t.fieldMetadata.fieldInfo.filter((h) => h.trim && v.includes(h.name)).map((h) => h.name) : []).forEach((h) => {
      for (let A = 0; A < d.length; A++) {
        const w = d[A].attributes;
        typeof w[h] == "string" && (w[h] = w[h].trim());
      }
   ...
   */
  inferType(e) {
    return typeof e == "number" ? Re.DOUBLE : Re.STRING;
  }
  /**
...
class en extends Z {
  ...
  async loadWfsData(e, t = -1, i = 0, s = 1e3, o = {
    ...
    const c = new It(e).updateQuery(l), [u, p] = await qe($t.get(c));
    if (!p)
    ...
    if (o.features = o.features.concat(d.features), d.features.length < t - i) {
      ...
      return a && o.features.length > 0 && o.features[0].geometry.type === B.POINT && o.features.forEach((v) => {
      ...
      return l ? (Array.isArray(l) || (l = [l]), l.map((n) => {
        ...
        return p && (Array.isArray(p) || (p = [p]), p.forEach((f) => {
          ...
          if (d.push(h), f.LegendURL) {
            const w = f.LegendURL.OnlineResource["@_xlink:href"];
            v[h] = w.replaceAll("&amp;", "&");
          }
        })), {
...
class tn extends Z {
  ...
  ogc;
  constructor(e) {
    super(e), this.files = new Qa(e), this.ogc = new en(e);
  }
  /**
  ...
  getLayerControls(e) {
    ...
    return t.supportsFeatures || s.push(V.Datatable), t.extent === void 0 && s.push(V.BoundaryZoom), (t.config?.metadata || (t.isSublayer ? t.parentLayer?.config?.metadata : {}) || {}).url || s.push(V.Metadata), !t.mapLayer && !t.config.controls?.includes(V.Settings) && s.push(V.Settings), s.forEach((a) => {
...
class Ji extends ii {
  ...
  constructor(e, t) {
    super(e, t), this.name = e.name || "", this.geomType = T.NONE, this.dataFormat = X.UNKNOWN, this.layerType = S.UNKNOWN, this.layerFormat = me.UNKNOWN;
    ...
    this.expectedTime.draw = e.expectedDrawTime ?? i.draw, this.expectedTime.load = e.expectedLoadTime ?? i.load, this.expectedTime.fail = e.maxLoadTime || i.fail, this.lastCancel = 0, this.timers = {
      draw: void 0,
      load: void 0
    }, this.origRampConfig = e, this.id = e.id || "", this.uid = this.$iApi.geo.shared.generateUUID(), this.isCosmetic = !1, this.isRemoved = !1, this.isSublayer = !1, this.supportsIdentify = !1, this.mapLayer = !0, this.identifyMode = Q.NONE, this.supportsFeatures = !1, this.hovertips = !1, this.supportsSublayers = !1, this.isFile = !1, this.layerState = z.NEW, this.initiationState = N.NEW, this.drawState = ce.NOT_LOADED, this.loadDefProm = new J(), this.url = this.origRampConfig.url, this.canReload = !!(this.url || this.origRampConfig.caching), this.loadPromDone = !1, this.layerTree = new _t(0, this.uid, this.name, !0);
  }
  updateInitiationState(e) {
  ...
  async terminate() {
    this.updateInitiationState(N.TERMINATING), await Promise.all(this.sublayers.map((e) => e.terminate())), this.loadDefProm = new J(), this.loadPromDone = !1, this.updateLayerState(z.NEW), this.updateDrawState(ce.NOT_LOADED), this.updateInitiationState(N.TERMINATED);
  }
  // ----------- LAYER LOAD -----------
    ...
    try {
      ...
      Promise.all(s).then(() => {
        clearTimeout(i), t ? this.visibility = !1 : (this.stopTimer(
          "load"
          /* LOAD */
        ), e > this.lastCancel && (this.loadPromDone && (this.loadDefProm = new J()), this.loadDefProm.resolveMe(), this.loadPromDone = !0, this.sublayers.forEach((o) => o.onLoad()), this.updateLayerState(z.LOADED)));
      }).catch(() => {
  ...
  onError(e = !0) {
    this.layerState !== z.ERROR && (this.initiationState === N.INITIATING && this.updateInitiationState(N.NEW), this.loadPromDone && (this.loadDefProm = new J()), this.loadDefProm.rejectMe(), this.loadPromDone = !0, this.sublayers.forEach((t) => t.onError(e)), e && this.$iApi.notify.show(
      fe.ERROR,
      this.$iApi.$i18n.t("layer.error", {
        id: this.id
      })
...
class si extends Je {
  ...
  filter;
  constructor(e, t) {
    super(e, t), this.supportsIdentify = !0, this.geomType = T.UNKNOWN, this.serviceUrl = "", this.fieldList = "", this.canModifyLayer = !0, this.filter = new Di(e.permanentFilteredQuery || "", e.initialFilteredQuery || ""), this.hovertips = e.state?.hovertips ?? !0, this.attribs = new Ki();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
  ...
  async loadLayerMetadata(e = {}) {
    ...
    if (!(t < this.lastCancel))
      if (this.geomType = i.geometryType, this.attribs.quickCache = new Xi(this.geomType), this.scaleSet.minScale = i.minScale, this.scaleSet.maxScale = i.maxScale, this.dataFormat = i.dataFormat, this.extent = this.extent ?? i.extent, this._serverVisibility = i.defaultVisibility, this.origRampConfig.name || (this.name = i.name ?? this.id), this.dataFormat === X.ESRI_FEATURE) {
        this.supportsFeatures = !0, this.canModifyLayer = this.layerType === S.SUBLAYER ? i.canModifyLayer : !0, this.fields = i.fields, this.nameField = i.displayField, this.oidField = i.objectIdField, this.sourceSR = i.sourceSR, this.drawOrder.forEach((a) => {
        ...
        this.attribs.attLoader = new Qi(this.$iApi, o);
      } else
...
class sn extends Je {
  constructor(e, t) {
    super(e, t), this.dataFormat = X.ESRI_FEATURE, this.layerFormat = me.GRAPHIC, this.hovertips = !1;
  }
  _graphics = [];
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
  ...
  async addGraphic(e) {
    ...
    const i = t.filter((n) => this._graphics.findIndex((u) => u.id === n.id) === -1 ? (this._graphics.push(n), !0) : (console.error(`Attempting to add graphic with id '${n.id}' that has already been added.`), !1)), s = this.$iApi.geo.map.getSR(), o = i.map((n) => this.$iApi.geo.proj.projectGeometry(s, n.geometry)), a = await Promise.all(o), l = i.map((n, c) => {
      const u = new be(a[c], n.id, n.attributes);
...
class rn extends sn {
  ...
  async onInitiate() {
    this.esriLayer = se(await O.GraphicsLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
...
class Ze extends si {
  ...
  constructor(e, t) {
    super(e, t), this.supportsIdentify = !0, this.isFile = !0, this.dataFormat = X.ESRI_FEATURE, this.layerFormat = me.FEATURE, this.tooltipField = "", this.layerIdx = 0, e.identifyMode && e.identifyMode !== Q.NONE ? this.identifyMode = e.identifyMode : this.identifyMode = Q.HYBRID;
  }
  async reload() {
  ...
  runIdentify(e) {
    ...
    return e.hitTest && (this.identifyMode === Q.HYBRID || this.identifyMode === Q.SYMBOLIC) && (s = o.then(async () => {
      ...
      a.forEach((n) => {
        i.items.push(gt.makeRawItem(rt.ESRI, n.attributes));
      }), l.forEach((n) => {
  ...
  extractLayerMetadata() {
    ...
    this.attribs.attLoader = new En(this.$iApi, i);
  }
  async getGraphic(e, t) {
    let i;
...
class pn extends si {
  tooltipField;
  constructor(e, t) {
    super(e, t), this.dataFormat = X.ESRI_FEATURE, this.tooltipField = "", this.supportsIdentify = !0, this.layerType = S.FEATURE, this.layerFormat = me.FEATURE, e.identifyMode && e.identifyMode !== Q.NONE ? this.identifyMode = e.identifyMode : this.identifyMode = Q.HYBRID;
  }
  async onInitiate() {
    se(this.esriLayer = await O.FeatureLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
  ...
  onLoadActions() {
    ...
    }, l = this.$iApi.geo.layer.loadFeatureCount(this.serviceUrl, this.getSqlFilter(ne.PERMANENT)).then((n) => {
...
class dn extends Je {
  ...
  origState;
  constructor(e, t) {
    super(e, t), this.supportsIdentify = !0, this.supportsSublayers = !0, this.layerType = S.MAPIMAGE, this.layerFormat = me.MAPIMAGE, this.isDynamic = !1, this.hovertips = !1, this.layerTree.layerIdx = -1, this.identifyMode = Q.GEOMETRIC;
  }
  async onInitiate() {
    this.esriLayer = se(await O.MapImageLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
  ...
  onLoadActions() {
    ...
    const o = [], a = (n, c) => {
      ...
      if (n.sublayers && n.sublayers.length > 0) {
        ...
        this._sublayers[u] || (this._sublayers[u] = new hn(
          {
            id: `${this.id}-${u}`,
            index: u,
  ...
  runIdentify(e) {
    ...
    return e.geometry.type === T.POINT && (i = this.$iApi.geo.query.makeClickBuffer(e.geometry, e.tolerance)), t.map((s) => {
      ...
      return s.geomType !== T.POLYGON && i ? a.filterGeometry = i : a.filterGeometry = e.geometry, a.filterSql = s.getCombinedSqlFilter(), a.sourceSR = s.sourceSR, s.queryOIDs(a).then((n) => {
        n.forEach((c) => {
...
class hn extends si {
  tooltipField;
  constructor(e, t, i) {
    if (super(e, t), this.layerType = S.SUBLAYER, this.layerFormat = me.MAPIMAGE, this.isSublayer = !0, this.layerIdx = e.index, this.parentLayer = i, this.dataFormat = X.ESRI_FEATURE, this.supportsFeatures = !0, this.tooltipField = "", this.hovertips = !1, this.url = this.parentLayer?.url, this.canReload = !!(this.url || this.origRampConfig.caching), !i.esriLayer)
...
class fn extends Je {
  constructor(e, t) {
    super(e, t), this.supportsIdentify = !1, this.layerType = S.OSM, this.layerFormat = me.OSM, this.dataFormat = X.OSM_TILE, this.supportsFeatures = !1;
  }
  async onInitiate() {
    this.esriLayer = se(await O.OpenStreetMapLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
...
class mn extends Je {
  constructor(e, t) {
    super(e, t), this.supportsIdentify = !1, this.layerType = S.IMAGERY, this.layerFormat = me.IMAGERY, this.dataFormat = X.ESRI_RASTER;
  }
  async onInitiate() {
    this.esriLayer = se(await O.ImageryLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
...
class yn extends Je {
  constructor(e, t) {
    super(e, t), this.supportsIdentify = !1, this.layerType = S.TILE, this.layerFormat = me.TILE, this.dataFormat = X.ESRI_TILE;
  }
  async onInitiate() {
    this.esriLayer = se(await O.TileLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
...
class gn extends Je {
  ...
  mimeType;
  constructor(e, t) {
    super(e, t), this.supportsIdentify = !0, this.layerType = S.WMS, this.layerFormat = me.WMS, this.mimeType = e.featureInfoMimeType || "", this.sublayerNames = [], this.dataFormat = X.OGC_RASTER, this.identifyMode = Q.GEOMETRIC;
  }
  async onInitiate() {
    this.esriLayer = se(await O.WMSLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
  ...
  runIdentify(e) {
    ...
    return this.getFeatureInfo(this.sublayerNames, e.geometry, this.mimeType).then((s) => {
      if (s) {
        let o = !0, a;
        typeof s != "string" ? a = rt.JSON : s.indexOf("Search returned no results") === -1 && s !== "" ? a = rt.TEXT : (o = !1, a = rt.UNKNOWN), o && i.items.push(gt.makeRawItem(a, s));
      }
      i.loaded = !0, t.resolveMe();
    }).catch(() => {
      i.errored = !0, t.resolveMe();
  ...
  getFeatureInfo(e, t, i) {
    ...
    let a, l;
    const n = s.getExtent(), c = o.spatialReferences, u = e.join(","), p = s.esriView.toScreen(t.toESRI()), d = Math.floor(p.x), v = Math.floor(p.y), h = {
    ...
    const w = {
      ...
      LAYERS: u,
      INFO_FORMAT: i
    }, W = o.customLayerParameters;
    return W && Object.keys(W).forEach((L) => {
      L.toLowerCase() !== "styles" && (w[L] = W[L]);
    }), Object.keys(w).forEach((L) => l[L] = w[L]), Ue(o.url.split("?")[0], {
      query: l,
      responseType: h
    });
  }
...
class Zi extends Ji {
  ...
  // ----------- LAYER CONSTRUCTION AND INITIALIZAION -----------
  constructor(e, t) {
    super(e, t), this.dataFormat = X.ESRI_FEATURE, this.layerFormat = me.NOLAYER, this.drawState = ce.NOT_VISUAL, this.attribs = new Ki(), this.supportsFeatures = !0, this.mapLayer = !1, this.isFile = !1, this._visibility = e.state?.visibility ?? !0, this.expectedTime.draw = 0;
  }
  async onInitiate() {
    if (this.sourceJson) {
      ...
      this.fields = t.map((a, l) => {
        ...
        return {
          ...
          alias: n,
          type: u,
          length: u === Re.STRING ? 256 : void 0
        };
      }), this.oidField = "rampOID", this.fields.push({ name: this.oidField, type: Re.OID }), e.fields.push(this.oidField), e.data.forEach((a, l) => a.push(l + 1)), this.$iApi.geo.attributes.applyFieldMetadata(this, this.origRampConfig.fieldMetadata), this.fieldList = "*";
      const o = {
        batchSize: -1,
...
class wn extends Zi {
  ...
  serviceUrl;
  constructor(e, t) {
    super(e, t), this.layerType = S.DATATABLE, this.serviceUrl = e.url, this.filter = new Di(e.permanentFilteredQuery || "", e.initialFilteredQuery || "");
  }
  async onInitiate() {
  }
  onLoadActions() {
    const e = super.onLoadActions(), t = Date.now(), s = this.$iApi.geo.shared.parseUrlIndex(this.serviceUrl).index || 0, o = this.$iApi.geo.layer.loadLayerMetadata(this.serviceUrl).then((l) => {
      ...
      this.attribs.attLoader = new Qi(this.$iApi, n), this.attribs.quickCache = new Xi(this.geomType);
    }), a = this.$iApi.geo.layer.loadFeatureCount(this.serviceUrl, this.getSqlFilter(ne.PERMANENT)).then((l) => {
  ...
  async getGraphic(e, t) {
    ...
    if (s)
      ...
      const a = {
        ...
        includeGeometry: !1,
        attribs: this.fieldList
      }, l = await this.$iApi.geo.attributes.loadSingleFeature(a);
  ...
  async getFilterOIDs(e = [], t = void 0) {
    ...
    if (!o) {
      ...
      o = this.queryOIDs(a), this.filter.setCache(o, s, !1);
    }
    return o;
  }
  /**
...
class In extends oi {
  ...
  constructor(e, t, i = !1) {
    if (super(e, t, i), this.valField = this.cleanFieldName(e.field, t), e.classBreakInfos.forEach((s, o) => {
      const a = o === 0, l = new _i(this, s.minValue, s.maxValue, a);
...
class Tn extends Z {
  ...
  async generateWMSSymbology(e) {
    const t = Xe(document.createElement("div")).size(this.CONTAINER_SIZE, this.CONTAINER_SIZE).viewbox(0, 0, 0, 0), i = {
      svgcode: "",
      imgHeight: "",
      imgWidth: ""
    };
  ...
  async renderSymbologyImage(e, t = null) {
    t === null && (t = Xe(document.createElement("div")).size(this.CONTAINER_SIZE, this.CONTAINER_SIZE).viewbox(0, 0, 0, 0));
  ...
  async renderSymbologyIcon(e, t = null) {
    if (t === null) {
      ...
      o.setAttribute("style", "opacity:0;position:fixed;left:100%;top:100%;overflow:hidden"), document.body.appendChild(o), t = Xe(o).size(this.CONTAINER_SIZE, this.CONTAINER_SIZE).viewbox(0, 0, this.CONTAINER_SIZE, this.CONTAINER_SIZE);
    }
  ...
  generatePlaceholderSymbology(e, t = "#000") {
    const i = Xe(document.createElement("div")).size(this.CONTAINER_SIZE, this.CONTAINER_SIZE).viewbox(0, 0, this.CONTAINER_SIZE, this.CONTAINER_SIZE);
  ...
  async generateBlankSymbology() {
    return Xe(document.createElement("div")).size(this.CONTAINER_SIZE, this.CONTAINER_SIZE).svg();
  }
  /**
  ...
  async symbolToSvg(e) {
    ...
    const o = Xe(s).size(this.CONTAINER_SIZE, this.CONTAINER_SIZE).viewbox(0, 0, this.CONTAINER_SIZE, this.CONTAINER_SIZE), a = {
      // @ts-ignore
      path({ size: f, path: h }) {
      ...
      none: () => "transparent",
      // esriSFSNull
      horizontal: (f, h) => o.pattern(5, 5, (w) => w.line(0, 5 / 2, 5, 5 / 2)).stroke(h),
      vertical: (f, h) => o.pattern(5, 5, (w) => w.line(5 / 2, 0, 5 / 2, 5)).stroke(h),
      "forward-diagonal": (f, h) => o.pattern(5, 5, (w) => {
        w.line(0, 0, 5, 5).stroke(h), w.line(0, 0, 5, 5).move(0, 5).stroke(h), w.line(0, 0, 5, 5).move(5, 0).stroke(h);
      }),
      "backward-diagonal": (f, h) => o.pattern(5, 5, (w) => {
        w.line(5, 0, 0, 5).stroke(h), w.line(5, 0, 0, 5).move(5 / 2, 5 / 2).stroke(h), w.line(5, 0, 0, 5).move(-5 / 2, -5 / 2).stroke(h);
      }),
      cross: (f, h) => o.pattern(5, 5, (w) => {
        w.line(5 / 2, 0, 5 / 2, 5).stroke(h), w.line(0, 5 / 2, 5, 5 / 2).stroke(h);
      }),
      "diagonal-cross": (f, h) => o.pattern(7, 7, (w) => {
        w.line(0, 0, 7, 7).stroke(h), w.line(7, 0, 0, 7).stroke(h);
      })
    }, p = {
      "simple-marker"() {
        const f = v(e.color);
        e.outline = e.outline || c;
        const h = v(e.outline.color), A = d({
          color: h.colour,
          opacity: h.opacity,
      ...
      "simple-line"() {
        const f = v(e.color), h = d({
          ...
          // @ts-ignore
          dasharray: l[e.style]
        }), A = t.CONTENT_PADDING, w = t.CONTAINER_SIZE - t.CONTENT_PADDING;
        o.line(A, A, w, w).stroke(h);
      },
      ...
      "simple-fill"() {
        ...
        o.rect(t.CONTENT_SIZE, t.CONTENT_SIZE).center(t.CONTAINER_CENTER, t.CONTAINER_CENTER).fill(A).stroke(W);
      },
      text() {
        console.error("no support for feature service legend of text symbols");
      },
      "picture-fill"() {
        const f = e.imageData ? `data:${e.contentType};base64,${e.imageData}` : e.url, h = e.width * e.xscale, A = e.height * e.yscale;
        e.outline = e.outline || c;
        const w = v(e.outline.color), W = d({
          color: w.colour,
          opacity: w.opacity,
        ...
        return t.$iApi.geo.shared.convertImagetoDataURL(f).then((R) => {
          const H = o.pattern(
            h,
            A,
            (de) => (
          ...
          o.rect(t.CONTENT_SIZE, t.CONTENT_SIZE).center(t.CONTAINER_CENTER, t.CONTAINER_CENTER).fill(H).stroke(W);
        });
      },
      "picture-marker"() {
        const f = e.source, h = f && f.imageData ? `data:${f.contentType};base64,${f.imageData}` : e.url;
        return t.$iApi.geo.shared.convertImagetoDataURL(h).then((w) => t.svgDrawImage(o, w)).then(({ image: w }) => {
          w.center(t.CONTAINER_CENTER, t.CONTAINER_CENTER).rotate(e.angle || 0), t.fitInto(w, t.CONTENT_IMAGE_SIZE);
        });
      }
    };
    try {
...
class Ln extends Z {
  ...
  async geoJsonQuery(e) {
    ...
    return (await e.layer.esriLayer.queryFeatures(t)).features.map((s, o) => {
      let a;
      return t.returnGeometry ? a = this.$iApi.geo.geom.geomEsriToRamp(s.geometry, `queryResult${o}`) : a = new Be(), new be(a, "", s.attributes);
    });
  }
  /**
...
class Rn extends Z {
   ...
   */
  constructor(e) {
    super(e), this.geom = nt.geom, this.proj = nt.proj, this.shared = nt.sharedUtils, this.map = new Ba(e), this.layer = new tn(e), this.attributes = new An(e), this.query = new Ln(e), this.symbology = new Tn(e), Array.isArray(dt.request.interceptors) || (dt.request.interceptors = []), dt.request.interceptors.push({
      before: (t) => {
...
const $n = /* @__PURE__ */ Object.assign({ "../fixtures/appbar/index.ts": () => import("./index-GQkwZiTO.js"), "../fixtures/areas-of-interest/index.ts": () => import("./index-C38MDTsr.js"), "../fixtures/basemap/index.ts": () => import("./index-3gj6q93m.js"), "../fixtures/crosshairs/index.ts": () => import("./index-Dkee2qLq.js"), "../fixtures/details/index.ts": () => import("./index-CJvzTXmm.js"), "../fixtures/export-footnote/index.ts": () => import("./index-BjKTkbxC.js"), "../fixtures/export-legend/index.ts": () => import("./index-Dkv-cksC.js"), "../fixtures/export-map/index.ts": () => import("./index-C-XH7Dnn.js"), "../fixtures/export-northarrow/index.ts": () => import("./index-CgsR5ory.js"), "../fixtures/export-scalebar/index.ts": () => import("./index-Vt-Ryx3S.js"), "../fixtures/export-timestamp/index.ts": () => import("./index-D9fhEhRr.js"), "../fixtures/export-title/index.ts": () => import("./index-3i-XP60V.js"), "../fixtures/export/index.ts": () => import("./index-BuFhvdqT.js"), "../fixtures/extentguard/index.ts": () => import("./index--hqiucLH.js"), "../fixtures/gazebo/index.ts": () => import("./index-BhA_jj_c.js"), "../fixtures/geosearch/index.ts": () => import("./index-5E2p6RAC.js"), "../fixtures/grid/index.ts": () => import("./index-B9l39VJk.js"), "../fixtures/help/index.ts": () => import("./index-CVTI_A2p.js"), "../fixtures/hilight/index.ts": () => import("./index-BPOz5w08.js"), "../fixtures/layer-reorder/index.ts": () => import("./index-DSQu58tL.js"), "../fixtures/legend/index.ts": () => import("./index-BqhpT0J4.js"), "../fixtures/mapnav/index.ts": () => import("./index-DLFhWkFh.js"), "../fixtures/metadata/index.ts": () => import("./index-Cqfya7FE.js"), "../fixtures/northarrow/index.ts": () => import("./index-DufsZ_uh.js"), "../fixtures/overviewmap/index.ts": () => import("./index-DBVLTuC5.js"), "../fixtures/panguard/index.ts": () => import("./index-BnR_FzyC.js"), "../fixtures/scrollguard/index.ts": () => import("./index-9JLWfFjM.js"), "../fixtures/settings/index.ts": () => import("./index-DbQQ3h-j.js"), "../fixtures/snowman/index.ts": () => import("./index-UT6cU_Rd.js"), "../fixtures/wizard/index.ts": () => import("./index-le0Av8VK.js") });
class Cn extends Z {
  /**
  ...
  async add(e, t) {
    ...
    if (t) {
      ...
      const s = (await $n[`../fixtures/${e}/index.ts`]()).default;
      i = new s(e, this.$iApi);
    }
    return ye(this.$vApp.$pinia).addFixture(i), this.$iApi.event.emit(x.FIXTURE_ADDED, i), this.$iApi.geo.map.created && i.initialized?.(), i;
  }
  /**
  ...
  remove(e) {
    ...
    return ye(this.$vApp.$pinia).removeFixture(t), this.$iApi.event.emit(x.FIXTURE_REMOVED, t), t;
  }
...
class ai extends Z {
  ...
  mount(e, { props: t, children: i, element: s, app: o } = {}) {
    let a = s, l = us(e, t, i);
    return o && o._context && (l.appContext = o._context), a ? Dt(l, a) : Dt(l, a = document.createElement("div")), { vNode: l, destroy: () => {
...
const Nn = /* @__PURE__ */ Me(Mn, [["render", Pn], ["__scopeId", "data-v-a3c61802"]]), Fn = /* @__PURE__ */ Object.assign({ "../fixtures/areas-of-interest/screen.vue": () => import("./screen-WgoptNGh.js"), "../fixtures/basemap/screen.vue": () => import("./screen-DG26xG8O.js"), "../fixtures/export/screen.vue": () => import("./screen-Ds8lyxZr.js"), "../fixtures/geosearch/screen.vue": () => import("./screen-DZW7pG8h.js"), "../fixtures/grid/screen.vue": () => import("./screen-CHJPwNmh.js"), "../fixtures/help/screen.vue": () => import("./screen-lMb3MmGs.js"), "../fixtures/layer-reorder/screen.vue": () => import("./screen-BHcAr2MD.js"), "../fixtures/legend/screen.vue": () => import("./screen-BtLAc9oy.js"), "../fixtures/metadata/screen.vue": () => import("./screen-BIhthojM.js"), "../fixtures/settings/screen.vue": () => import("./screen-C6YEp4fb.js"), "../fixtures/wizard/screen.vue": () => import("./screen-D4c2UGRx.js") });
class At extends Z {
  /**
   * ID of this panel.
   *
  ...
  registerScreen(e) {
    ...
    if (Ns(t) || Ps(t))
      ...
      let s;
      typeof t == "string" ? s = Fn[`../fixtures/${t}`]() : s = t();
      const o = new Promise((a, l) => {
        s.then((n) => {
          this.loadedScreens.push(e), a(Fs(n) ? n.default : n);
        }), s.catch((n) => l(n));
      });
      i = ps({
...
function Gn(r) {
  ...
  return Bn(r.services, e), Un(r.map, e), zn(r.ui, e), r.plugins && Vn(r.plugins, e), e;
}
function Un(r, e) {
  if (r.layers && r.layers.forEach((t) => {
    e.layers.unshift(es(t));
...
var tt = { major: "4", minor: "10", patch: "0-beta", timestamp: "Mon Dec 16 14:24:21 2024 -0500", hash: "80b6921c8bcc5e64b837059383efdafb4e8730cf" };
console.info(
  `RAMP v${tt.major}.${tt.minor}.${tt.patch} [${tt.hash.slice(0, 9)}] (Built on ${new Date(
...
const Rl = (r, e, t) => new Na(r, e, t), nt = new Ms();
export {
  V as $,
  Tr as A,
  mt as B,
