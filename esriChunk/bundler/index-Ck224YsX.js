...
import { _ as G, u as ae, a as se, b as T, A as le, F as pe, G as ce } from "./main-DCVw7L11.js";
...
const J = /* @__PURE__ */ G(fe, [["render", he], ["__scopeId", "data-v-5d32b715"]]), be = ["content", "aria-label"], ge = /* @__PURE__ */ R({
    ...
    const f = () => {
      ...
      const a = d.$vApp.$el.querySelector(".inner-shell"), h = {
        ...
        fn({ state: m }) {
          ...
          m.styles.popper.height = `${b}px`, I?.value?.offsetHeight && (I.value.style.height = `${b}px`), m.styles.popper.overflowY = "auto", m.styles.popper.overflowX = "hidden";
        }
      };
  ...
  setup(y) {
    ...
    return Q(() => {
      ...
      W(() => {
        const f = g.value;
        let a, h = [...f.children], m = h[h.length - 2].getBoundingClientRect().top;
