...
import "tiny-emitter";
import { F as t, b as l } from "./main-CyvBwAqQ.js";
...
class G extends i {
    ...
    this.$iApi.panel.register(
      {
        "layer-reorder": {
          screens: {
            "layer-reorder-screen": () => a(import("./screen-BHcAr2MD.js"))
          },
          style: {
            width: "350px"
          },
  ...
  removed() {
    this.$iApi.fixture.exists("appbar") && l(this.$vApp.$pinia).removeButton("layer-reorder"), this.$iApi.panel.remove("layer-reorder");
  }
}
export {
  G as default
