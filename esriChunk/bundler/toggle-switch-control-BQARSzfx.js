...
import { _ as S } from "./main-DCVw7L11.js";
const V = { class: "flex flex-row rv-label" }, B = { class: "flex items-center" }, C = ["innerHTML"], E = /* @__PURE__ */ h({
  ...
  emits: ["toggled"],
  setup(s, { emit: m }) {
    const u = m, o = s, l = r(o.config.value), a = r(!!o.config.disabled), g = r(0), c = w([]), n = r(null);
    c.push(
      b(
        O(o, "config"),
        (e, t) => {
    ...
    const f = () => {
      a.value || (l.value = !l.value, u("toggled", l.value));
    }, x = () => {
      if (n.value) {
    ...
    return k(() => {
      ...
      i("div", {
        ...
        (p(), T(j(K), {
          onChange: t[0] || (t[0] = (d) => u("toggled", d)),
          onKeyupCapture: [
            y(v(f, ["stop"]), ["enter"]),
            y(v(f, ["stop"]), ["space"])
          ],
...
}), H = /* @__PURE__ */ S(E, [["__scopeId", "data-v-188debd2"]]);
export {
  H as T
};
