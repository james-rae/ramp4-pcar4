...
import { _ as ie, e as ee, N as ne, L as Te, O as Me, G as J } from "./main-CyvBwAqQ.js";
...
import { T as Ee } from "./toggle-switch-control-CvgqskIc.js";
import "pinia";
import "screenfull";
...
const Ie = {
  ...
  setup(v) {
    ...
    }, m = X("iApi"), $ = ee(), f = ne(), _ = v, { t: u } = V(), r = w(!1), d = w(m.fixture.get("details")), n = w(!0), e = w(!1), o = w(0), E = w(20), O = w([]), D = w([]), p = M(() => $.activeGreedy), I = M(() => $.properties), g = M(() => o.value + E.value), B = () => f.getLayerByUid(_.uid), N = () => _.results.find((l) => l.uid === _.uid), z = M(() => N()?.loaded ?? !1), C = M(() => N()?.requestTime), s = M(
  ...
  setup(v) {
    const { t: b } = V(), i = X("iApi"), c = ee(), m = w([]), $ = w([]), f = w([]), _ = w(!1), u = w(""), r = M(() => c.activeGreedy), d = M(() => c.payload), n = M(() => c.properties), e = (p) => {
      ...
      const B = g[g.length - 1][1], N = p.filter((C) => B.includes(C.layerId)).map(
...
}), ps = /* @__PURE__ */ ie(zt, [["__scopeId", "data-v-2a8a1e06"]]);
export {
  ps as default
};
