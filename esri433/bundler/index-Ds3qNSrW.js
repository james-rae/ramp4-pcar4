...
import { _ as H, d as L, F as K, G as X } from "./main-DzUoCUPB.js";
...
const W = /* @__PURE__ */ H(te, [["render", ne]]), ie = /* @__PURE__ */ O({
  ...
  setup(b) {
    const i = S("iApi"), { t } = N(), o = ee(), p = [
      {
        type: "point",
        icon: f(g(() => import("./point-icon-DfHnKrhe.js")))
      },
      {
        type: "polyline",
        icon: f(g(() => import("./polyline-icon-CW0KcfDo.js")))
      },
      {
        type: "polygon",
        icon: f(g(() => import("./polygon-icon-DfKlo_S9.js")))
      },
      {
        type: "circle",
        icon: f(g(() => import("./circle-icon-B1pLEPEX.js")))
      },
      {
        type: "rectangle",
        icon: f(g(() => import("./rectangle-icon-DdjfaMSS.js")))
      }
    ], a = E(() => {
      const s = p.filter((v) => o.supportedTypes.some((x) => x.type === v.type));
      return s.push({
        type: "edit",
        icon: f(g(() => import("./edit-icon-DUQEwRUP.js")))
      }), s;
    }), n = (s) => {
