...
import "tiny-emitter";
import { G as le, L as Te, F as xe } from "./main-DiHJHtnC.js";
...
class ft extends Me {
  async init() {
    Object.entries(Le).forEach((b) => this.$iApi.$i18n.mergeLocaleMessage(...b)), this._parseConfig(this.config), Z(this.$vApp.$pinia).supportedTypes.forEach((b) => {
      const o = `${b.type}-icon`;
      this.$iApi.component(o, Ae(Se(/* @__PURE__ */ Object.assign({ "./icons/circle-icon.vue": () => import("./circle-icon-zZ5vzClg.js"), "./icons/edit-icon.vue": () => import("./edit-icon-DBNqaH2g.js"), "./icons/point-icon.vue": () => import("./point-icon-DAz4ygNA.js"), "./icons/polygon-icon.vue": () => import("./polygon-icon-DMH2d3bT.js"), "./icons/polyline-icon.vue": () => import("./polyline-icon-DhDLz0hp.js"), "./icons/rectangle-icon.vue": () => import("./rectangle-icon-Sn_wD-WN.js") }), `./icons/${b.type}-icon.vue`, 3)));
    });
