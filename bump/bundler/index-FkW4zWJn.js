...
import { _ as C, d as A, F as j, G } from "./main-Df8iIskC.js";
...
const D = /* @__PURE__ */ C(q, [["render", U]]), W = /* @__PURE__ */ $({
  ...
  setup(_) {
    const i = k("iApi"), { t } = z(), e = Y(), o = [
      {
        type: "point",
        icon: h(f(() => import("./point-icon-5-0bEyyn.js")))
      },
      {
        type: "polyline",
        icon: h(f(() => import("./polyline-icon-CToUYAni.js")))
      },
      {
        type: "polygon",
        icon: h(f(() => import("./polygon-icon-DPox8PIJ.js")))
      },
      {
        type: "circle",
        icon: h(f(() => import("./circle-icon-CMvPTvjC.js")))
      },
      {
        type: "rectangle",
        icon: h(f(() => import("./rectangle-icon-CTLIdbMX.js")))
      }
    ], d = x(() => {
      const a = o.filter((s) => e.supportedTypes.some((c) => c.type === s.type));
      return a.push({
        type: "edit",
        icon: h(f(() => import("./edit-icon-hxwGsaA0.js")))
      }), a;
    }), n = (a) => {
