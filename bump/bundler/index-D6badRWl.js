import "tiny-emitter";
import { F as f, i as n, b as u } from "./main-C3AIznK9.js";
...
class x extends f {
  ...
  toggleGrid(e, i) {
    ...
    !o.isOpen || !o.isVisible ? this.$iApi.panel.open("grid") : t !== e || i === !0 ? o.show({ screen: "grid-screen", props: { key: e } }) : o.close();
  }
  /**
  ...
  _parseConfig(e) {
    ...
    e && e.mergeGrids && e.mergeGrids.forEach((l) => {
      const t = [], { gridId: o, layers: s, fieldMap: c, options: m } = l;
      s.forEach((r) => {
        r.sublayers ? r.sublayers?.forEach((a) => {
          t.push(`${r.layerId}-${a}`), delete i[`${r.layerId}-${a}`];
    ...
    this.$iApi.panel.register(
      {
        grid: {
          screens: {
            "grid-screen": () => b(import("./screen-D4WOu5Jl.js"))
          },
          style: {
            width: "450px"
          },
