import { defineComponent as X, ref as H, onMounted as ye, resolveDirective as q, createElementBlock as a, openBlock as l, withModifiers as k, withDirectives as x, createElementVNode as o, unref as t, normalizeClass as C, withKeys as ce, inject as ue, computed as R, toRaw as S, resolveComponent as ve, createBlock as $, withCtx as ge, createTextVNode as Z, toDisplayString as w, createCommentVNode as u, Fragment as oe, renderList as ie, normalizeStyle as ke, useTemplateRef as xe, watch as we, createStaticVNode as me, resolveDynamicComponent as Ce } from "vue";
import { p as Me, o as y, Z as Se, a as Ie, a1 as I, G as Q, _ as se, Q as Te, n as ze, a3 as G, a4 as b, S as Ee, a5 as F, a6 as ne } from "./main-CIu33szv.js";
import "pinia";
...
const Ae = ["type", "aria-label", "checked", "disabled", "content"], ae = /* @__PURE__ */ X({
...
}), Be = ["aria-label"], $e = ["aria-label"], Ze = ["aria-label"], Ge = ["aria-label"], Re = ["aria-label"], Ue = ["aria-label"], Pe = ["content", "aria-label"], De = /* @__PURE__ */ X({
  ...
  emits: ["focusItem"],
  setup(e, { emit: T }) {
    const { t: i } = re(), c = ue("iApi"), f = H(), A = H(!1), s = Ie(), L = H(s.mobileView), E = T, U = H(0), v = e, Y = () => {
      ...
      if (v.legendItem.layerControlAvailable(I.Metadata) && M("metadata")) {
        ...
        if (g.url) {
          const D = g.url.split("."), V = D[D.length - 1], te = V === "xml" || V === "md" ? V : "html";
      ...
      P.value && S(v.legendItem.layer).reload().then(() => {
        U.value += 1, g.pointerType !== "mouse" && E("focusItem");
      });
    }, P = R(() => v.legendItem.layerControlAvailable(I.Reload) && v.legendItem instanceof y && S(v.legendItem.layer)?.canReload), ee = (g) => {
      A.value = !0, setTimeout(() => {
        A.value && (L.value || g._tippy?.show());
      }, 300);
    }, M = (g) => {
      try {
    ...
    return (g, m) => {
      const j = ve("dropdown-menu"), D = q("tippy");
      return l(), a("div", {
        onClick: m[3] || (m[3] = k(() => {
        }, ["stop"])),
        onMouseover: m[4] || (m[4] = k(() => {
        }, ["stop"])),
        ...
        (l(), $(j, {
          ...
          default: ge(() => [
            ...
            x((l(), a("a", {
              href: "javascript:;",
              class: C(["flex leading-snug items-center text-left w-auto", { disabled: !P.value }]),
              key: +P.value,
              content: P.value ? null : t(i)("legend.layer.controls.reloadDisabled"),
              onMouseover: m[0] || (m[0] = k((V) => ee(V.currentTarget), ["stop"])),
              onMouseout: m[1] || (m[1] = (V) => (
                //@ts-expect-error TODO: explain why this is needed or remove
                (L.value || V.currentTarget?._tippy?.hide(), A.value = !1)
              )),
              onClick: m[2] || (m[2] = (V) => _(V)),
              role: "button",
...
}), Oe = /* @__PURE__ */ se(De, [["__scopeId", "data-v-34fa4433"]]), je = { key: 0 }, Fe = {
  key: 0,
  ...
  setup(e) {
    ...
    }), (c, f) => e.visible ? (l(), a("div", Xe, f[0] || (f[0] = [
      o("svg", {
  ...
  setup(e) {
    const T = Te(), i = Ie(), { t: c } = re(), f = ue("iApi"), A = H(), s = e, L = ze(), E = L.multilineItems, U = (s.legendItem instanceof y && s.legendItem.maxLines) ?? L.maxLines, v = H(i.mobileView), Y = R(() => T.layerConfigs), B = H([]), N = H(!1), O = H(!1), K = xe("legendFocusItem"), J = R(() => s.legendItem instanceof y ? S(s.legendItem.layer)?.layerType : ""), _ = R(() => s.legendItem instanceof y && S(s.legendItem.layer)?.canModifyLayer), P = R(() => {
    ...
    s.legendItem instanceof y && S(s.legendItem.layer)?.sublayers.length > 0), g = (r) => r === G.Expand || r === G.Visibility ? s.legendItem.controlAvailable(r) : s.legendItem.layerControlAvailable(r), m = (r) => He(r), j = () => {
      s.legendItem.children.length === 0 || !g(G.Expand) || (s.legendItem.toggleExpanded(), f.updateAlert(c(`legend.alert.group${s.legendItem.expanded ? "Expanded" : "Collapsed"}`)));
    }, D = () => {
      if (g(I.Symbology)) {
        ...
        o("div", _e, [
          x((l(), a("div", {
            class: C(["flex items-center hover:bg-gray-200 default-focus-style !p-5", [
              ...
              M.value && g(t(G).Expand) || !M.value && e.legendItem instanceof t(y) && g(t(I).Datatable) && W() && e.legendItem.type === t(b).Item ? "cursor-pointer" : "cursor-default",
              t(E) ? "multilined" : "singlelined"
            ]]),
            onMouseover: n[10] || (n[10] = k((d) => Le(d.currentTarget), ["stop"])),
            onMouseout: n[11] || (n[11] = (d) => (
              //@ts-expect-error TODO: explain why this is needed or remove
              (v.value || d.currentTarget?._tippy?.hide(), O.value = !1)
            )),
            onClick: n[12] || (n[12] = () => {
              !M.value && e.legendItem instanceof t(y) && g(t(I).Datatable) && W() && e.legendItem.type === t(b).Item ? V() : M.value && j();
            }),
            content: M.value && g(t(G).Expand) ? t(c)(e.legendItem.expanded ? "legend.group.collapse" : "legend.group.expand") : e.legendItem instanceof t(y) && e.legendItem.type === t(b).Item && g(t(I).Datatable) && W() ? t(c)("legend.layer.data") : "",
            "truncate-trigger": "",
            ...
            e.legendItem.type === t(b).Item && e.legendItem instanceof t(y) && e.legendItem.layer.legend.length > 0 ? (l(), a("div", {
              ...
              x((l(), a("button", {
                type: "button",
                onClick: k(D, ["stop"]),
                class: C([g(t(I).Symbology) ? "cursor-pointer" : "cursor-default"]),
            ...
            e.legendItem.type === t(b).Error && P.value ? (l(), a("div", ut, [
              x((l(), a("button", {
                type: "button",
            ...
            ])) : e.legendItem.type === t(b).Item && g(t(G).Visibility) ? (l(), $(ae, {
              key: 12,
        ...
        e.legendItem instanceof t(y) && e.legendItem.symbologyExpanded ? x((l(), a("div", Mt, [
          B.value.length > 0 ? (l(), a("div", St, [
            ...
            (l(!0), a(oe, null, ie(B.value, (d) => (l(), a("div", {
              ...
              d.imgUrl && e.legendItem.symbologyRenderStyle === "images" || !d.imgUrl && J.value === "ogc-wms" ? (l(), a("div", zt, [
                d.imgUrl ? (l(), a("div", Et, [
                  o("img", {
                    class: "max-w-full",
                    src: d.imgUrl
