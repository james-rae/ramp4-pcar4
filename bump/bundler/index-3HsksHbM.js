import { defineComponent as l, inject as m, resolveComponent as a, openBlock as h, createBlock as c, unref as u, withCtx as v, createElementVNode as i, markRaw as d } from "vue";
import "tiny-emitter";
import { F as f, j as n, G as g, d as x } from "./main-D3k1WGvN.js";
...
const _ = /* @__PURE__ */ l({
  __name: "nav-button",
  setup(p) {
    const e = m("iApi"), { t } = A(), o = () => e.event.emit(g.HELP_TOGGLE);
    return (C, r) => {
    ...
    this.$iApi.component("help-nav-button", _), this.$iApi.panel.register(
      {
        help: {
          screens: {
            "help-screen": () => d(import("./screen-m9FDulfg.js"))
          },
          style: {
            "flex-grow": "1",
            "max-width": "750px"
