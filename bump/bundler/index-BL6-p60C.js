...
import { _ as H, d as L, F as K, G as X } from "./main-CIu33szv.js";
...
const G = /* @__PURE__ */ H(te, [["render", ne]]), ie = /* @__PURE__ */ I({
  ...
  setup(f) {
    const i = S("iApi"), { t } = B(), o = ee(), p = [
      {
        type: "point",
        icon: g(_(() => import("./point-icon-0KCqfOGH.js")))
      },
      {
        type: "polyline",
        icon: g(_(() => import("./polyline-icon-BuxLeCvK.js")))
      },
      {
        type: "polygon",
        icon: g(_(() => import("./polygon-icon-CFnu-bTO.js")))
      },
      {
        type: "circle",
        icon: g(_(() => import("./circle-icon-BBcjentU.js")))
      },
      {
        type: "rectangle",
        icon: g(_(() => import("./rectangle-icon-5-9Ga5iV.js")))
      }
    ], a = M(() => {
      const s = p.filter((u) => o.supportedTypes.some((x) => x.type === u.type));
      return s.push({
        type: "edit",
        icon: g(_(() => import("./edit-icon-D3-47kpF.js")))
      }), s;
    }), n = (s) => {
