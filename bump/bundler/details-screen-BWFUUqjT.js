...
import { _ as ie, e as ee, M as ne, L as Te, N as Me, G as J } from "./main-D3k1WGvN.js";
...
import { T as Ee } from "./toggle-switch-control-QfsdVRpT.js";
import "pinia";
import "screenfull";
...
const Ie = {
  ...
  setup(v) {
    ...
    }, m = X("iApi"), $ = ee(), f = ne(), _ = v, { t: u } = V(), r = w(!1), d = w(m.fixture.get("details")), n = w(!0), e = w(!1), o = w(0), E = w(20), B = w([]), D = w([]), p = M(() => $.activeGreedy), I = M(() => $.properties), h = M(() => o.value + E.value), N = () => f.getLayerByUid(_.uid), O = () => _.results.find((l) => l.uid === _.uid), z = M(() => O()?.loaded ?? !1), C = M(() => O()?.requestTime), s = M(
...
}), Et = /* @__PURE__ */ ie(Mt, [["__scopeId", "data-v-3a47d6ad"]]), It = { class: "relative h-full" }, Ct = { class: "detailsContentSection overflow-y-auto h-full" }, zt = /* @__PURE__ */ F({
  ...
  setup(v) {
    const { t: b } = V(), i = X("iApi"), c = ee(), m = w([]), $ = w([]), f = w([]), _ = w(!1), u = w(""), r = M(() => c.activeGreedy), d = M(() => c.payload), n = M(() => c.properties), e = (p) => {
      ...
      const N = h[h.length - 1][1], O = p.filter((C) => N.includes(C.layerId)).map(
