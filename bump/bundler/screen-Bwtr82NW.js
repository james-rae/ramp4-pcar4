import { defineComponent as x, ref as u, reactive as f, watch as S, onBeforeUnmount as V, openBlock as g, createElementBlock as w, createElementVNode as s, createTextVNode as I, toDisplayString as p, createVNode as b, unref as r, withKeys as T, withModifiers as N, markRaw as E, createBlock as $, resolveDynamicComponent as Y, inject as D, onMounted as G, resolveComponent as P, withCtx as O } from "vue";
import { _ as q, G as h, $ as z } from "./main-DDNyuLKS.js";
import "pinia";
...
import { T as U } from "./toggle-switch-control-K1GKtfdZ.js";
const K = { class: "rv-label" }, F = ["innerHTML"], J = { class: "flex flex-row pl-30" }, Q = /* @__PURE__ */ x({
...
}), W = /* @__PURE__ */ q(Q, [["__scopeId", "data-v-9f0c5af5"]]), X = { class: "rv-label text-sm pt-10" }, ee = { class: "flex flex-row" }, te = ["value", "disabled"], ie = { class: "text-xs pt-10 text-gray-600 mb-20" }, ne = /* @__PURE__ */ x({
  ...
  setup(i) {
    const { t: n } = B(), o = i, t = u(!!o.config.disabled), d = f([]);
    return d.push(
      // watch the config for changes to the opacity value
      S(
        () => o.config,
...
}), se = /* @__PURE__ */ q(ne, [["__scopeId", "data-v-89fc1190"]]), oe = {
  ...
  setup(i) {
    const { t: n } = B(), o = D("iApi"), t = i, d = u(""), a = u(t.layer.uid), c = u(t.layer.visibility), v = u(t.layer.opacity * 100), L = u(t.layer.identify), _ = u(!1), y = f([]), H = f([]);
...
}), Qe = /* @__PURE__ */ q(ve, [["__scopeId", "data-v-72efbdd5"]]);
export {
  Qe as default
};
