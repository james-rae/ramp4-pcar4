...
import { _ as H, d as L, F as X, G as ee } from "./main-DiHJHtnC.js";
...
const G = /* @__PURE__ */ H(ne, [["render", ae]]), se = /* @__PURE__ */ T({
  ...
  setup(h) {
    ...
    const p = [
      {
        type: "point",
        icon: g(_(() => import("./point-icon-DAz4ygNA.js")))
      },
      {
        type: "polyline",
        icon: g(_(() => import("./polyline-icon-DhDLz0hp.js")))
      },
      {
        type: "polygon",
        icon: g(_(() => import("./polygon-icon-DMH2d3bT.js")))
      },
      {
        type: "circle",
        icon: g(_(() => import("./circle-icon-zZ5vzClg.js")))
      },
      {
        type: "rectangle",
        icon: g(_(() => import("./rectangle-icon-Sn_wD-WN.js")))
      }
    ], a = A(() => {
      const s = p.filter((u) => e.supportedTypes.some((x) => x.type === u.type));
      return s.push({
        type: "edit",
        icon: g(_(() => import("./edit-icon-DBNqaH2g.js")))
      }), s;
    }), n = (s) => {
