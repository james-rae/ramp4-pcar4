import { defineComponent as G, ref as x, onMounted as ie, openBlock as t, createElementBlock as a, createElementVNode as _, normalizeClass as R, Fragment as Y, renderList as Q, normalizeStyle as ve, createCommentVNode as H, toDisplayString as D, computed as E, resolveDirective as q, withDirectives as A, withModifiers as pe, createVNode as le, onBeforeMount as W, watch as U, onBeforeUnmount as X, unref as w, createBlock as V, inject as ee, resolveDynamicComponent as we, createTextVNode as ae, resolveComponent as $e, withCtx as ce } from "vue";
import { _ as ne, e as te, N as oe, L as Te, O as Me, G as K } from "./main-C3AIznK9.js";
...
import { T as Ee } from "./toggle-switch-control-dvTI6qML.js";
import "pinia";
import "screenfull";
...
const Ie = {
  ...
  setup(d) {
    ...
    return ie(() => {
      ...
      _("div", {
        class: R(d.result.items.length === 0 ? "opacity-50" : "")
      }, [
        i.value.length > 1 ? (t(), a("div", Ce, [
          (t(!0), a(Y, null, Q(i.value.slice(0, 3).reverse(), ($, y) => (t(), a("div", {
            class: R(["absolute", [y == 0 ? "symbol-0" : y == 1 ? "left-3" : "left-6"]]),
  ...
  setup(d) {
    ...
    return ($, y) => {
      const k = q("tippy");
      return A((t(), a("button", {
        class: R(["flex flex-grow justify-start items-center px-7 py-10 default-focus-style symbologyStackButton truncate", d.selected ? "detailsButtonSelected" : "px-11"]),
        onClick: y[0] || (y[0] = pe(() => {
        }, ["stop"])),
        content: v()
      }, [
  ...
  setup(d, { emit: b }) {
    ...
    return W(() => {
      ...
      return A((t(), a("div", {
        ...
        (t(!0), a(Y, null, Q(m.results, (S, n) => (t(), a("div", {
...
}), Ze = { class: "inline font-bold" }, Ye = ["innerHTML"], Je = /* @__PURE__ */ G({
  __name: "esri-default",
  props: {
    fixtureFields: {
      type: Object,
...
}), Ke = ["innerHTML"], Qe = { key: 1 }, We = /* @__PURE__ */ G({
  __name: "html-default",
  props: {
    identifyData: {
      type: Object,
  ...
  setup(d) {
    ...
    }, null, 8, Ke)) : (t(), a("div", Qe, D(w(b)("details.layers.results.empty")), 1));
  }
  ...
  setup(d) {
    const b = oe(), i = d, c = ee("iApi"), v = x([]), $ = te(), { t: y } = Z(), k = x(!1), m = x(""), l = x("none"), f = x(), o = () => b.getLayerByUid(i.uid), e = E(() => $.properties), r = E(() => $.defaultTemplates), T = E(() => o()?.supportsFeatures ?? !1), j = E(() => o()?.mapLayer ?? !1), C = E(() => {
      const n = o()?.nameField;
      let u = n && i.data.loaded ? i.data.data[n] : c.$i18n.t("details.items.title");
      ...
      const n = o();
      return n && e.value[n.id] && e.value[n.id].template ? e.value[n.id].template : r.value && r.value[i.data.format] ? r.value[i.data.format] : T.value ? Je : We;
      ...
      const u = i.data.data[n.oidField], h = () => {
        const z = { getGeom: !0 };
        n.getGraphic(u, z).then((O) => {
          O.geometry.invalid() ? (console.error(`Could not find graphic for objectid ${u}`), M("error")) : (c.geo.map.zoomMapTo(O.geometry), M("zoomed"), c.updateAlert(c.$i18n.t("details.item.alert.zoom")));
        }).catch(() => {
          M("error");
        });
      };
        ...
        _("div", Xe, [
          T.value ? (t(), a("div", et, [
            ...
            d.data.loaded ? A((t(), a("span", {
              ...
              content: C.value,
              innerHTML: p(C.value),
              onTouchstart: u[0] || (u[0] = (O) => k.value = !0),
              onTouchend: u[1] || (u[1] = (O) => k.value = !1),
  ...
  setup(d) {
    const b = x(), i = () => {
    ...
    }, v = ee("iApi"), $ = te(), y = oe(), k = d, { t: m } = Z(), l = x(!1), f = x(v.fixture.get("details")), o = x(!0), e = x(!1), r = x(0), T = x(20), j = x([]), C = x([]), p = E(() => $.activeGreedy), I = E(() => $.properties), g = E(() => r.value + T.value), B = () => y.getLayerByUid(k.uid), N = () => k.results.find((s) => s.uid === k.uid), F = E(() => N()?.loaded ?? !1), M = E(() => N()?.requestTime), S = E(
      ...
      const s = h();
      if (o.value && F.value && s.length > 0 && O.value)
        if (e.value)
    ...
    return ie(() => {
      j.value.push(
        v.event.on(K.LAYER_REMOVE, (s) => {
          const L = v.panel.get("details");
          k.uid === s.uid && L && L.close();
        })
      ), j.value.push(
        v.event.on(K.PANEL_CLOSED, (s) => {
          s.id === "details" && he();
        })
      ), j.value.push(
        v.event.on(K.PANEL_MINIMIZED, (s) => {
          s.id === "details" && _e();
        })
      ), j.value.push(
        v.event.on(K.MAP_BASEMAPCHANGE, (s) => {
      ...
      return F.value && p.value === 0 ? (t(), a("div", {
        ...
        l.value ? (t(), a("div", kt, [
          h().length > 0 ? (t(), a("div", xt, [
            e.value ? A((t(), a("div", {
              ...
              (t(!0), a(Y, null, Q(h().slice(r.value, g.value), (J, ue) => A((t(), a("button", {
        ...
        key: 1,
        class: R(["flex justify-center py-10 items-center", d.results.length > 1 ? "ml-42" : ""])
      }, [
  ...
  setup(d) {
    const { t: b } = Z(), i = ee("iApi"), c = te(), v = x([]), $ = x([]), y = x([]), k = x(!1), m = x(""), l = E(() => c.activeGreedy), f = E(() => c.payload), o = E(() => c.properties), e = (p) => {
      ...
      const B = g[g.length - 1][1], N = p.filter((M) => B.includes(M.layerId)).map(
        ...
        content: ce(() => [
          _("div", It, [
            ...
            _("div", Ct, [
              k.value ? (t(), a("div", {
                key: 1,
                class: R(["text-center", { "ml-42": y.value.length > 1 }])
              }, D(y.value.length >= 1 ? w(b)("details.layers.results.empty") : w(b)("details.layers.results.empty.noLayers")), 3)) : (t(), V(Et, {
                key: 0,
                uid: m.value,
                results: y.value
              }, null, 8, ["uid", "results"]))
...
}), ms = /* @__PURE__ */ ne(zt, [["__scopeId", "data-v-150a1d19"]]);
export {
  ms as default
};
