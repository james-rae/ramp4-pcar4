import { am as m, au as d, a2 as u, K as w, s as p } from "./main-FTUvxwHX.js";
let r = null, s = !0;
function T(e, a, t) {
...
async function B(e, a) {
  ...
  if (n === "image/gif") {
    const { isAnimatedGIF: o, parseGif: c } = await import("./gif-DFXwiLrx.js");
    if (o(t)) return c(t, a);
  }
  if (i) {
    const { isAnimatedPNG: o, parseApng: c } = await import("./apng-BxTv2jSx.js");
    if (o(t)) return c(t, a);
  }
...
//# sourceMappingURL=imageUtils-Dkq-T3UL.js.map
