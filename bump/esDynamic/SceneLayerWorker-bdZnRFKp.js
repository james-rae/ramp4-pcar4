import { hX as K, bh as D } from "./main-C8BB3UCb.js";
import { y as X } from "./DoubleArray-C9rM3d-4.js";
import { i as Q, a as W } from "./MeshLocalVertexSpace-7YNOvma2.js";
import { n as Z, s as ee } from "./vec3-C1e1jvos.js";
import "./sphere-DrU77s0v.js";
import "./I3SUtil-DDioEAR3.js";
var S, $;
(function(e) {
...
function te() {
  return x || (x = new Promise((e) => import("./i3s-AS69acl1.js").then((t) => t.i).then(({ default: t }) => {
...
async function be(e) {
  ...
  if (i.type === "georeferenced" && i.origin == null) {
    const [{ projectBuffer: c }, { initializeProjection: b }] = await Promise.all([import("./main-C8BB3UCb.js").then((d) => d.qK), import("./main-C8BB3UCb.js").then((d) => d.qL)]);
    await b(f, l), s = new Float64Array(a.length), c(a, f, 0, s, l, 0, s.length / 3);
  } else {
    const c = i.type === "georeferenced" ? Q.fromJSON(i) : W.fromJSON(i), { project: b } = await import("./georeference-DxE-GPL0.js").then((d) => d.g);
...
//# sourceMappingURL=SceneLayerWorker-bdZnRFKp.js.map
