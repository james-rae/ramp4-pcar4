import { hX as K, bh as D } from "./main-FTUvxwHX.js";
import { y as X } from "./DoubleArray-BP506Nkh.js";
import { i as Q, a as W } from "./MeshLocalVertexSpace-9zPrTOdG.js";
import { n as Z, s as ee } from "./vec3-B_xJt3gw.js";
import "./sphere-DBEaSDAh.js";
import "./I3SUtil-hs-gVCWm.js";
var S, $;
(function(e) {
...
function te() {
  return x || (x = new Promise((e) => import("./i3s-DShsXhMe.js").then((t) => t.i).then(({ default: t }) => {
...
async function be(e) {
  ...
  if (i.type === "georeferenced" && i.origin == null) {
    const [{ projectBuffer: c }, { initializeProjection: b }] = await Promise.all([import("./main-FTUvxwHX.js").then((d) => d.qK), import("./main-FTUvxwHX.js").then((d) => d.qL)]);
    await b(f, l), s = new Float64Array(a.length), c(a, f, 0, s, l, 0, s.length / 3);
  } else {
    const c = i.type === "georeferenced" ? Q.fromJSON(i) : W.fromJSON(i), { project: b } = await import("./georeference-DDItYn9W.js").then((d) => d.g);
...
//# sourceMappingURL=SceneLayerWorker-QcsGCAg_.js.map
