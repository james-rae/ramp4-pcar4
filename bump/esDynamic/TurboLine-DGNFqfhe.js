import { af as le, hX as ue } from "./main-FTUvxwHX.js";
...
async function xe() {
  ee = await (le("esri-csp-restrictions") ? await import("./libtess-asm-dOrwq42y.js").then((i) => i.l) : await import("./libtess-BQmtp3G6.js").then((i) => i.l)).default({ locateFile: (i) => ue(`esri/core/libs/libtess/${i}`) });
}
function sr(s, i) {
...
//# sourceMappingURL=TurboLine-DGNFqfhe.js.map
