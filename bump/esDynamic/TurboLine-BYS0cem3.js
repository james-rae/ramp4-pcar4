import { af as le, hX as ue } from "./main-C8BB3UCb.js";
...
async function xe() {
  ee = await (le("esri-csp-restrictions") ? await import("./libtess-asm-CxZ6TNYf.js").then((i) => i.l) : await import("./libtess-BbTuwJaf.js").then((i) => i.l)).default({ locateFile: (i) => ue(`esri/core/libs/libtess/${i}`) });
}
function sr(s, i) {
...
//# sourceMappingURL=TurboLine-BYS0cem3.js.map
