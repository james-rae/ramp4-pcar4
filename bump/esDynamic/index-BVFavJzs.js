import { iO as A, iP as y, bx as M, fB as $, ha as O, fK as D, hb as B } from "./main-C8BB3UCb.js";
import { _ as k } from "./screen.vue_vue_type_script_setup_true_lang-DM1PBn7B.js";
var H = { exports: {} };
(function(S, i) {
  (function(n, a) {
    a();
...
class _ extends M {
   ...
   */
  async make(i, n) {
    const { fabric: a } = await import("./fabric-a284kjJY.js").then((g) => g.f);
...
class I extends _ {
  ...
  async needed() {
    const i = (await import("./index-DK6ROP4P.js")).default, n = (await import("./index-PyY7IblA.js")).default, a = (await import("./index-BqSQvkMF.js")).default, w = (await import("./index-Dk5TutDx.js")).default, p = (await import("./index-C3qc2nZI.js")).default, r = (await import("./index-CIMF81FH.js")).default, b = (await import("./index-BFm7_SZT.js")).default;
...
//# sourceMappingURL=index-BVFavJzs.js.map
