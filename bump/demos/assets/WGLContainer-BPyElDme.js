import{aD as P,aA as W,hV as A,cy as F,aR as N,ih as U,qO as Ee,ii as Q,aS as ft,cb as dt,g_ as $e,gI as me,gK as ne,lv as ue,qP as _t,nh as pe,qQ as vt,o7 as mt,dS as pt,gi as gt,hY as ge,qR as Oe,qS as ht,Q as j,jZ as he,ck as Ae,qT as xt,qU as yt,qV as St,qW as Tt,G as Se,cv as bt,cz as It,cA as Et,qX as B,qY as Ze,bh as Pe,np as Ot,gF as At,qZ as Ce,q_ as Pt,db as De,s as Te,lQ as Ct,gY as Dt,h1 as Re,cf as Rt,q$ as Lt,aL as ee}from"./main-Bwx3RK6o.js";import{e as Mt,b as zt,h as Ke,f as L,n as re,s as le,r as Vt}from"./LabelMetric-By5Nt2Ka.js";import{E as k}from"./BufferObject-DJG0_GYd.js";import{o as Z}from"./VertexArrayObject-i6eTWaE6.js";import{t as ie}from"./VertexElementDescriptor-BOD-G50G.js";import{e as Nt,a as ce}from"./ProgramTemplate-C5guPgLe.js";import{n as wt}from"./vec3f32-nZdmKIgz.js";import{e as qe,n as Ft}from"./Container-DXL2lbi8.js";import{r as J,l as G,n as Le}from"./StyleDefinition-kgEI0GZS.js";import{e as Me}from"./config-MDUrh2eL.js";import{e as Bt}from"./earcut-Lltz9D9k.js";let Ut=class{constructor(e,t){this._rctx=e,this._attributes=[{name:"position",offset:0,type:P.SHORT,count:2}],this.layout={hash:Mt(this._attributes),attributes:this._attributes,stride:4},this._vertexBuffer=k.createVertex(e,W.STATIC_DRAW,new Uint16Array(t)),this._vao=new Z(e,new Map([["a_position",0]]),new Map([["geometry",[new ie("a_position",2,P.SHORT,0,4)]]]),new Map([["geometry",this._vertexBuffer]])),this._count=t.length/2}bind(){this._rctx.bindVAO(this._vao)}unbind(){this._rctx.bindVAO(null)}dispose(){this._vao.dispose()}draw(){this._rctx.bindVAO(this._vao),this._rctx.drawArrays(A.TRIANGLE_STRIP,0,this._count)}},$=class{constructor(){this.name=this.constructor.name||"UnnamedBrush",this.brushEffect=null}prepareState(e,t){}draw(e,t,n){}drawMany(e,t,n){for(const i of t)i.visible&&this.draw(e,i,n)}};const de={nearest:{defines:[],samplingMode:F.NEAREST,mips:!1},bilinear:{defines:[],samplingMode:F.LINEAR,mips:!1},bicubic:{defines:["bicubic"],samplingMode:F.LINEAR,mips:!1},trilinear:{defines:[],samplingMode:F.LINEAR_MIPMAP_LINEAR,mips:!0}},Gt=(u,e,t)=>{if(t.samplingMode==="dynamic"){const{state:n}=u,i=e.resolution/e.pixelRatio/n.resolution,o=Math.round(u.pixelRatio)!==u.pixelRatio,a=i>1.05||i<.95;return n.rotation||a||o||e.isSourceScaled||e.rotation?de.bilinear:de.nearest}return de[t.samplingMode]};let Yt=class extends ${constructor(){super(...arguments),this._desc={vsPath:"raster/bitmap",fsPath:"raster/bitmap",attributes:new Map([["a_pos",0]])}}dispose(){this._quad&&this._quad.dispose()}prepareState({context:e}){e.setBlendingEnabled(!0),e.setColorMask(!0,!0,!0,!0),e.setStencilWriteMask(0),e.setStencilTestEnabled(!0)}draw(e,t){const{context:n,renderingOptions:i,painter:o,requestRender:a,allowDelayedRender:r}=e;if(!t.source||!t.isReady)return;const l=Gt(e,t,i),s=o.materialManager.getProgram(this._desc,l.defines);if(r&&a!=null&&!s.compiled)return void a();e.timeline.begin(this.name),t.blendFunction==="additive"?n.setBlendFunctionSeparate(N.ONE,N.ONE,N.ONE,N.ONE):n.setBlendFunctionSeparate(N.ONE,N.ONE_MINUS_SRC_ALPHA,N.ONE,N.ONE_MINUS_SRC_ALPHA),n.setStencilFunction(U.EQUAL,t.stencilRef,255),this._quad||(this._quad=new Ut(n,[0,0,1,0,0,1,1,1]));const{coordScale:c,computedOpacity:_,transforms:f}=t;t.setSamplingProfile(l),t.bind(e.context,Ee),n.useProgram(s),s.setUniformMatrix3fv("u_dvsMat3",f.displayViewScreenMat3),s.setUniform1i("u_texture",Ee),s.setUniform2fv("u_coordScale",c),s.setUniform1f("u_opacity",_),this._quad.draw(),e.timeline.end(this.name)}};function je(){return new Float32Array(4)}function kt(u){const e=new Float32Array(4);return e[0]=u[0],e[1]=u[1],e[2]=u[2],e[3]=u[3],e}function H(u,e,t,n){const i=new Float32Array(4);return i[0]=u,i[1]=e,i[2]=t,i[3]=n,i}function Ht(u,e){return new Float32Array(u,e,4)}function Xe(){return je()}function Qe(){return H(1,1,1,1)}function Je(){return H(1,0,0,0)}function et(){return H(0,1,0,0)}function tt(){return H(0,0,1,0)}function nt(){return H(0,0,0,1)}const Wt=Xe(),$t=Qe(),Zt=Je(),Kt=et(),qt=tt(),jt=nt();Object.freeze(Object.defineProperty({__proto__:null,ONES:$t,UNIT_W:jt,UNIT_X:Zt,UNIT_Y:Kt,UNIT_Z:qt,ZEROS:Wt,clone:kt,create:je,createView:Ht,fromValues:H,ones:Qe,unitW:nt,unitX:Je,unitY:et,unitZ:tt,zeros:Xe},Symbol.toStringTag,{value:"Module"}));const Xt={background:{"background.frag":`uniform lowp vec4 u_color;
void main() {
