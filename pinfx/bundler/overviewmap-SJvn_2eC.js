import { V as e, p as t, s as n, v as r } from "./main-DRrASmfn.js";
import { t as i } from "./config-RKp-tUX3.js";
...
var C = class extends n {
	_parseConfig(e) {
		...
		t.basemaps = e?.basemaps || {}, t.mapConfig.basemaps = Object.values(t.basemaps), t.startMinimized = e?.startMinimized ?? !0, t.expandFactor = e?.expandFactor ?? 1.5, t.borderColour = e?.borderColour ?? "#FF0000", t.borderWidth = e?.borderWidth ?? 1, t.areaColour = e?.areaColour ?? "#000000", t.areaOpacity = e?.areaOpacity ?? .25;
	}
	get config() {
		return super.config;
	}
	...
	__name: "overviewmap",
	setup(n) {
		let a = r(), { t: l } = S(), C = u("iApi"), D = i(), O = _(), k = o(() => D.activeBasemapConfig), A = o(() => a.mapConfig), j = o(() => a.basemaps), M = o(() => a.startMinimized), N = g(new t(C)), P = _(!0), F = _(!1), I = g([]);
		m(async () => {
	...
	added() {
		...
		let e = this.$vApp.$watch(() => this.config, (e) => this._parseConfig(e)), { destroy: t, el: n } = this.mount(D, { app: this.$element });
		this.$vApp.$el.getElementsByClassName("inner-shell")[0].appendChild(n.childNodes[0]), this.removed = () => {
			e(), t(), r(this.$vApp.$pinia).$reset();
		};
	}
};
//#endregion
