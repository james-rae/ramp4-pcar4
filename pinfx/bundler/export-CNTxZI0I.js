import { G as e, N as t, V as n, s as r } from "./main-DRrASmfn.js";
import i from "./screen-nicAjflp.js";
...
var s = 1200, c = {
	...
	initialized() {}
	async needed() {
		let e = (await import("./export-title-DIRki0oQ.js")).default, t = (await import("./export-map-DWPHmv5r.js")).default, n = (await import("./export-legend-tS5JYJ6c.js")).default, r = (await import("./export-northarrow-B-J7P-87.js")).default, i = (await import("./export-scalebar-C4EvrpTF.js")).default, a = (await import("./export-timestamp-CpIVO3Hk.js")).default, o = (await import("./export-footnote-Cj-ou4ec.js")).default;
	...
	added() {
		...
		let r = this.$iApi.event.on(n.PANEL_OPENED, async (e) => {
		...
		this.removed = () => {
			o(), this.$iApi.fixture.get("export-title")?.remove(), this.$iApi.fixture.get("export-map")?.remove(), this.$iApi.fixture.get("export-legend")?.remove(), this.$iApi.fixture.get("export-northarrow")?.remove(), this.$iApi.fixture.get("export-scalebar")?.remove(), this.$iApi.fixture.get("export-timestamp")?.remove(), this.$iApi.fixture.get("export-footnote")?.remove(), this.$iApi.fixture.exists("appbar") && e(this.$vApp.$pinia).removeButton("export"), t(this.$vApp.$pinia).$reset(), this.$iApi.panel.remove("export");
		};
	}
};
//#endregion
