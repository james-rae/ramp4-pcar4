import { G as e, k as t, s as n, x as r } from "./main-DRrASmfn.js";
...
var m = class extends n {}, h = /* @__PURE__ */ o({
	__name: "nav-button",
	setup(e) {
		let { t } = p(), n = s("iApi"), r = () => {
	...
	async added() {
		t(this.$vApp.$pinia).initService(this.$iApi.language, this.config), this.$iApi.component("geosearch-nav-button", h), this.$iApi.panel.register({
			id: "geosearch",
			config: {
				screens: { "geosearch-component": () => c(import("./screen-CDtpplFQ.js")) },
				button: {
	...
	removed() {
		this.$iApi.fixture.exists("appbar") && e(this.$vApp.$pinia).removeButton("geosearch"), this.$iApi.fixture.exists("mapnav") && r(this.$vApp.$pinia).removeItem("geosearch"), t(this.$vApp.$pinia).$reset(), this.$iApi.panel.remove("geosearch");
	}
};
//#endregion
export { _ as default };
