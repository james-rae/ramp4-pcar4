import { G as e, W as t, s as n } from "./main-DRrASmfn.js";
import { t as r } from "./table-state-manager-DwL9pa-v.js";
import { markRaw as i } from "vue";
//#region src/fixtures/grid/api/grid.ts
var a = class extends n {
	gridStore = t(this.$vApp.$pinia);
	toggleGrid(e, t) {
	...
	async added() {
		this.$iApi.panel.register({ grid: {
			screens: { "grid-screen": () => i(import("./screen-B1OebKXC.js")) },
			style: { width: "450px" },
			controls: { expand: !0 },
			button: {
	...
	removed() {
		this.$iApi.fixture.exists("appbar") && e(this.$vApp.$pinia).removeButton("grid"), t(this.$vApp.$pinia).$reset(), this.$iApi.panel.remove("grid");
	}
};
//#endregion
export { s as default };
