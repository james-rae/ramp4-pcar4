import { Et as e, Tt as t, V as n, h as r, m as i } from "./main-DRrASmfn.js";
...
var M = { class: "flex justify-end mb-20" }, N = ["disabled", "animation"], P = { class: "button-text" }, F = /* @__PURE__ */ a(/* @__PURE__ */ m({
	...
	setup(a) {
		let o = i(), { t: s } = ce(), m = te("iApi"), v = b(), ae = T(), x = b([]), S = c(() => o.layerSource), D = c(() => o.currStep), O = b(null), A = b(), le = b(0), M = b(!1), N = b(), P = E("stepOneStart"), ue = E("stepTwoStart"), de = E("stepThreeStart"), I = b(!1), L = b(!1), R = b(!1), z = b(!1), B = b(!1), V = b(!1), H = b(!0), fe = b(""), U = b(""), W = b([]), G = y([
			{
				value: e.FEATURE,
		...
		g(() => ((D.value === r.FORMAT || D.value === r.CONFIGURE) && (I.value = !0, o.goToStep(r.FORMAT)), !1)), ie(() => {
			x.value.push(m.event.on(n.LAYER_LAYERSTATECHANGE, (e) => {
				e.layer.userAdded && (fe.value = e.layer.name, V.value = e.state !== t.LOADING && e.state !== t.NEW, H.value = V.value && e.state === t.LOADED);
			})), D.value === r.CONFIGURE && (Y.value?.configOptions.includes("colour") && We(), z.value = !Y.value?.configOptions.includes("sublayers") && !!Y.value?.config.name);
		}), re(() => {
		...
		let _e = async (e) => {
			...
			e?.preventDefault(), J.value = S.value.guessFormatFromURL(K.value), o.goToStep(r.FORMAT);
		}, ye = async (t) => {
			t?.preventDefault(), O.value = new AbortController(), M.value = !0, I.value = !1, L.value = !1, z.value = !1, B.value = !0, o.goToStep(r.CONFIGURE), U.value = $() ? pe.find((e) => e.value === J.value)?.label : G.find((e) => e.value === J.value)?.label;
			try {
			...
			m.geo.map.addLayer(i).catch(() => {}), i.userAdded = !0, m.event.emit(n.USER_LAYER_ADDED, i), R.value = !1, o.goToStep(r.UPLOAD);
			...
			if (o.nested = t, W.value = [], le.value += 1, J.value === e.MAPIMAGE) {
