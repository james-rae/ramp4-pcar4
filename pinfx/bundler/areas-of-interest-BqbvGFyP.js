import { G as e, P as t, s as n } from "./main-DRrASmfn.js";
import r from "./screen-CzLR5qiQ.js";
...
var a = {
	...
	_parseConfig(e) {
		...
		n.areas = e.areas, this.handlePanelTeleports(["areas-of-interest"]);
	}
}, s = class extends o {
	added() {
		...
		this.removed = () => {
			n(), this.$iApi.fixture.exists("appbar") && e(this.$vApp.$pinia).removeButton("areas-of-interest"), this.$iApi.panel.remove("areas-of-interest"), t(this.$vApp.$pinia).$reset();
		};
	}
};
//#endregion
