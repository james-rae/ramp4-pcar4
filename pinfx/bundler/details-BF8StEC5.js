import { G as e, H as t, U as n, f as r, s as i } from "./main-DRrASmfn.js";
import { i as a } from "./hilight-defs-Bxj5UF-q.js";
...
var s = "details", c = class extends i {
	...
	_parseConfig(e) {
		...
		let t = this.getLayerFixtureConfigs(), r = [];
		Object.keys(t).forEach((e) => {
			r.push({
				id: e,
				name: t[e].name,
				template: t[e].template,
				fields: t[e].fields,
				priority: t[e].priority ?? 50
			});
		});
	...
	async added() {
		this.$iApi.panel.register({ details: {
			screens: { "details-screen": () => o(import("./details-screen-MsBW6Tvk.js")) },
			style: { width: "425px" },
			button: {
		...
		this.removed = () => {
			n(), this.$iApi.panel.remove("details"), this.$iApi.fixture.exists("appbar") && e(this.$vApp.$pinia).removeButton("details"), t(this.$vApp.$pinia).$reset();
		};
	}
};
//#endregion
