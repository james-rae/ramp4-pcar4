import { G as e, s as t, x as n } from "./main-DRrASmfn.js";
...
var p = /* @__PURE__ */ a({
	...
	added() {
		this.$iApi.component("basemap-nav-button", p), this.$iApi.panel.register({
			id: "basemap",
			config: {
				screens: { "basemap-component": () => s(import("./screen-Dq5-_7lK.js")) },
				button: {
	...
	removed() {
		this.$iApi.fixture.exists("appbar") && e(this.$vApp.$pinia).removeButton("basemap"), this.$iApi.fixture.exists("mapnav") && n(this.$vApp.$pinia).removeItem("basemap"), this.$iApi.panel.remove("basemap");
	}
};
//#endregion
export { h as default };
