import { F as e, I as t, s as n } from "./main-DRrASmfn.js";
...
var x = {
	...
	__name: "keyboardnav",
	setup(t) {
		let n = e(), { activeNamespace: l, namespaces: x, helpVisible: K } = r(n), { t: q } = b(), J = a(() => Object.entries(x.value).map(([e, t]) => ({
			id: e,
			keys: t?.keys ?? []
	...
	keyboardnavStore = e(this.$vApp.$pinia);
	_isInput(e) {
	...
	_handleKeyDown = (e) => {
		...
		if (!(n.shiftKey || a)) {
			if (r.chainState === "awaitNamespace") {
				let e = Object.keys(r.namespaces);
				if (s === "H") {
