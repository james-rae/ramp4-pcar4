import { B as e, R as t, St as n, Tt as r, V as i, W as a, Y as o, bt as s, o as c, xt as l } from "./main-DRrASmfn.js";
import { n as u } from "./config-RKp-tUX3.js";
import { t as d } from "./_plugin-vue_export-helper-O4QQSku4.js";
import { n as ee, t as te } from "./table-state-manager-DwL9pa-v.js";
...
var z = ["onClick"], Te = { class: "md-icon-small flex w-full" }, B = { class: "flex-1 truncate whitespace-nowrap overflow-hidden pr-4" }, Ee = /* @__PURE__ */ v({
	...
	props: ["params"],
	setup(t) {
		let n = e(), { t: r } = I(), i = t, a = w(""), o = w(""), s = w(!!i.params.stateManager.columns[i.params.column.colDef.field].filter.static), c = () => {
			d(), i.params.stateManager.setColumnFilterValue(i.params.column.colDef.field, a.value, "min");
		}, l = () => {
			d(), i.params.stateManager.setColumnFilterValue(i.params.column.colDef.field, o.value, "max");
		}, u = (e) => typeof e != "number" || isNaN(e), d = () => {
			a.value !== "" && u(a.value) && (a.value = ""), o.value !== "" && u(o.value) && (o.value = "");
			let e = i.params.column.colDef.field;
			o.value === "" && a.value === "" ? i.params.api.setColumnFilterModel(e, null) : o.value !== "" && a.value !== "" ? i.params.api.setColumnFilterModel(e, {
				filterType: "number",
				type: "inRange",
				filter: a.value,
				filterTo: o.value
			}) : a.value === "" ? i.params.api.setColumnFilterModel(e, {
				filterType: "number",
				type: "lessThanOrEqual",
				filter: o.value
			}) : i.params.api.setColumnFilterModel(e, {
				filterType: "number",
				type: "greaterThanOrEqual",
				filter: a.value
			}), i.params.api.onFilterChanged();
		};
		return se(() => {
			a.value = i.params.stateManager.getColumnFilterValue(i.params.column.colDef.field, "min"), o.value = i.params.stateManager.getColumnFilterValue(i.params.column.colDef.field, "max"), c(), l();
		}), (e, t) => (C(), h("div", De, [
			N(g("input", {
				class: b(["rv-min rv-input bg-white text-black-75 h-24 py-16 px-8 border-2 rounded", { "cursor-not-allowed": s.value }]),
				style: { width: "45%" },
				type: "number",
				"onUpdate:modelValue": t[0] ||= (e) => a.value = e,
				onInput: t[1] ||= (e) => c(),
				onMousedown: t[2] ||= F(() => {}, ["stop"]),
				onKeypress: t[3] ||= P(F(() => {}, ["prevent"]), ["enter"]),
				onKeyup: t[4] ||= P((e) => {
					O(n).mobileView && e.target.blur();
				}, ["enter"]),
				enterkeyhint: "done",
				placeholder: O(r)("grid.filters.number.min"),
				"aria-label": O(r)("grid.filters.number.min"),
				disabled: s.value
			}, null, 42, Oe), [[A, a.value]]),
			t[10] ||= g("span", { class: "w-12" }, null, -1),
			N(g("input", {
				class: b(["rv-max rv-input bg-white text-black-75 h-24 py-16 px-8 border-2 rounded", { "cursor-not-allowed": s.value }]),
				style: { width: "45%" },
				type: "number",
				"onUpdate:modelValue": t[5] ||= (e) => o.value = e,
				onInput: t[6] ||= (e) => l(),
				onMousedown: t[7] ||= F(() => {}, ["stop"]),
				onKeypress: t[8] ||= P(F(() => {}, ["prevent"]), ["enter"]),
				onKeyup: t[9] ||= P((e) => {
					O(n).mobileView && e.target.blur();
				}, ["enter"]),
				enterkeyhint: "done",
				placeholder: O(r)("grid.filters.number.max"),
				"aria-label": O(r)("grid.filters.number.max"),
				disabled: s.value
			}, null, 42, V), [[A, o.value]])
		]));
	}
	...
	props: ["params"],
	setup(t) {
		let n = e(), { t: r } = I(), i = t, a = w(""), o = w(i.params.stateManager.columns[i.params.column.colDef.field].filter.static), s = () => {
			...
			a.value ? i.params.api.setColumnFilterModel(e, {
				...
				type: "contains",
				filter: a.value
			}) : i.params.api.setColumnFilterModel(e, null), i.params.stateManager.setColumnFilterValue(i.params.column.colDef.field, a.value), i.params.api.onFilterChanged();
		};
		return se(() => {
			a.value = i.params.stateManager.getColumnFilterValue(i.params.column.colDef.field).toString(), s();
		}), (e, i) => (C(), h("div", H, [N(g("input", {
			class: b(["rv-input w-full bg-white text-black-75 h-24 py-16 px-8 border-2 rounded", { "cursor-not-allowed": o.value }]),
			type: "text",
			onInput: i[0] ||= (e) => s(),
			"onUpdate:modelValue": i[1] ||= (e) => a.value = e,
			onMousedown: i[2] ||= F(() => {}, ["stop"]),
			onKeypress: i[3] ||= P(F(() => {}, ["prevent"]), ["enter"]),
			onKeyup: i[4] ||= P((e) => {
				O(n).mobileView && e.target.blur();
			}, ["enter"]),
			enterkeyhint: "done",
			placeholder: O(r)("grid.filters.column.label.text", [t.params.column.colDef.headerName]),
			"aria-label": O(r)("grid.filters.column.label.text", [t.params.column.colDef.headerName]),
			disabled: o.value
		}, null, 42, U), [[A, a.value]])]));
	}
	...
	setup(t) {
		let n = e(), { t: r } = I(), i = t, a = w(""), o = w(""), s = w(i.params.stateManager.columns[i.params.column.colDef.field].filter.static), c = () => {
			u(), i.params.stateManager.setColumnFilterValue(i.params.column.colDef.field, a.value, "min");
		}, l = () => {
			u(), i.params.stateManager.setColumnFilterValue(i.params.column.colDef.field, o.value, "max");
		}, u = () => {
			let e = i.params.column.colDef.field;
			if (o.value === "" && a.value === "") i.params.api.setColumnFilterModel(e, null);
			else {
				let t = {
					filterType: "date",
					type: "inRange"
				};
				a.value !== "" && (t.dateFrom = a.value), o.value !== "" && (t.dateTo = o.value), i.params.api.setColumnFilterModel(e, t);
			}
			i.params.api.onFilterChanged();
		};
		return se(() => {
			...
			N(g("input", {
				class: b(["m-0 w-1/2 rv-input bg-white text-black-75 h-24 py-16 px-8 border-2 rounded", { "cursor-not-allowed": s.value }]),
				type: "date",
				placeholder: O(r)("grid.filters.date.min"),
				"aria-label": O(r)("grid.filters.date.min"),
				"onUpdate:modelValue": t[0] ||= (e) => a.value = e,
				onInput: t[1] ||= (e) => c(),
				onMousedown: t[2] ||= F(() => {}, ["stop"]),
				onKeypress: t[3] ||= P(F(() => {}, ["prevent"]), ["enter"]),
			...
			N(g("input", {
				class: b(["m-0 w-1/2 rv-input bg-white text-black-75 h-24 py-16 px-8 border-2 rounded", { "cursor-not-allowed": s.value }]),
				type: "date",
				placeholder: O(r)("grid.filters.date.max"),
				"aria-label": O(r)("grid.filters.date.max"),
				"onUpdate:modelValue": t[5] ||= (e) => o.value = e,
				onInput: t[6] ||= (e) => l(),
				onMousedown: t[7] ||= F(() => {}, ["stop"]),
				onKeypress: t[8] ||= P(F(() => {}, ["prevent"]), ["enter"]),
	...
	props: ["params"],
	setup(e) {
		let t = e, { t: r } = I(), a = y("iApi"), o = w(), s = async () => {
			let e = t.params.data, r = e.rvUid, o = a.geo.layer.getLayer(r), s = be(t.params.layerCols, o), c = await o.getGraphic(e[s], { getAttribs: !0 });
			a.event.emit(i.DETAILS_TOGGLE, {
				data: c.attributes,
				uid: r,
				format: n.ESRI
			}, !0), t.params.isTeleport && a.scrollToInstance();
		};
		return S(() => {
	...
	props: ["params"],
	setup(t) {
		let n = e(), r = y("iApi"), { t: i } = I(), a = w(), o = w(), s = w(!1), c = t, l = f(() => n.mobileView), u = () => {
			o.value?.textContent && (s.value = !0, a.value?._tippy.show(), navigator.clipboard.writeText(o.value?.textContent), setTimeout(() => {
				s.value = !1;
			}, 2e3));
		}, d = f(() => c.params.type === "number" ? c.params.value == null ? "" : r.ui.formatNumber(c.params.value) : c.params.type === "date" ? c.params.value == null ? "" : new Date(c.params.value).toISOString().slice(0, 10) : c.params.type === "string" ? !c.params.value || /<a[^>]*>[^<]+<\/a>/g.test(c.params.value) ? c.params.value : L(c.params.value, {
			target: "_blank",
			validate: { url: (e) => /^https?:\/\//.test(e) }
		}) : ""), ee = f(() => /<a[^>]*>[^<]+<\/a>/g.test(c.params.value) || /(http(s)?:\/\/.*)/g.test(c.params.value));
		return S(() => {
			c.params.eGridCell.addEventListener("dblclick", () => {
				u();
			}), c.params.eGridCell.addEventListener("keydown", (e) => {
				e.ctrlKey && e.code === "KeyC" && u();
			}), c.params.eGridCell.addEventListener("blur", () => {
				o.value._tippy.hide(), a.value?._tippy.hide();
			}), c.params.eGridCell.addEventListener("focus", () => {
				o.value?._tippy.show(), setTimeout(() => {
					document.activeElement === c.params.eGridCell && a.value?._tippy.show();
			...
			c.params.eGridCell.removeEventListener("dblclick", () => {
				u();
			}), c.params.eGridCell.removeEventListener("keydown", (e) => {
				e.ctrlKey && e.code === "KeyC" && u();
			}), c.params.eGridCell.removeEventListener("blur", () => {
				o.value._tippy.hide(), a.value?._tippy.hide();
			}), c.params.eGridCell.removeEventListener("focus", () => {
				o.value._tippy.show(), a.value?._tippy.show();
			});
		}), (e, t) => {
			let n = E("truncate"), r = E("tippy");
			...
			} }]]), o.value?.textContent ? N((C(), h("div", {
				key: 0,
				ref_key: "copyTooltip",
				ref: a,
				content: O(i)(`grid.label.${s.value ? "copied" : "copy"}`)
			}, null, 8, tt)), [[r, {
	...
	setup(n) {
		...
		let c = [
			...
			l.SINGLE,
			l.INTEGER
		], u = y("iApi"), d = a(), ne = e(), p = f(() => ne.mobileView), v = w(!p.value), T = w(), k = le("gridContainer"), { t: L, locale: be } = I(), xe = () => ie()?.proxy?.$forceUpdate(), R = n, z = w({
			id: "dummy",
			layerIds: [],
			state: new te(),
			fieldMap: {}
		...
		}, Je = f(() => X.value.some((e) => e.layerState === r.LOADED && e.visibility)), Ye = (e) => {
			B.value = e.api;
			let t = z.value.state.title;
			t ||= u.geo.layer.getLayer(R.gridId)?.name || R.gridId, Ne.value = t, Jt(), q.value.length > 0 && Z.value.autoSizeAllColumns(), Ke(), qe(), Z.value.addEventListener("rowDataUpdated", Ke), W.value.push(u.event.on(i.FILTER_CHANGE, ({ uid: e, filterKey: t }) => {
				t !== s.GRID && e && X.value.map((e) => e.uid).includes(e) && Q();
			})), W.value.push(u.event.on(i.LAYER_VISIBILITYCHANGE, ({ layer: e }) => {
				e.uid && X.value.map((e) => e.uid).includes(e.uid) && Q();
			})), W.value.push(u.event.on(i.LAYER_RELOAD_END, (e) => {
				e.loadPromise().then(() => {
					X.value.map((e) => e.uid).includes(e.uid) && Q();
				});
			})), W.value.push(u.event.on(i.LANG_CHANGE, () => {
				Z.value.redrawRows({ force: !0 });
			})), W.value.push(u.event.on(i.MAP_EXTENTCHANGE, de(() => {
				z.value.state.filterByExtent && Q();
			}, 100))), W.value.push(u.event.on(i.LAYER_REMOVE, (e) => {
			...
			let e = new o(), t = We.value.slice().map((e) => e.getPromise());
			We.value.push(e), await Promise.all(t), await Promise.all(X.value.map(async (e) => {
				e && e.visibility ? await e.getFilterOIDs([s.GRID], z.value.state.filterByExtent ? u.geo.map.getExtent() : void 0).then((t) => {
					ze.value[e.uid] = t;
				}) : ze.value[e.uid] = [];
			})), Z.value.onFilterChanged(), e.resolveMe();
			let n = We.value.indexOf(e);
			n === -1 ? console.error("Grid could not find filter blocker in filter queue") : We.value.splice(n, 1);
		}, sn = () => {
			z.value.state.applyToMap = !z.value.state.applyToMap, cn();
		}, cn = () => {
			X.value.filter((e) => e.mapLayer).forEach((e) => {
				if (!z.value.state.applyToMap) e.setSqlFilter(s.GRID, "");
				else {
					let t = ln(e.id);
					e.setSqlFilter(s.GRID, t);
				}
			});
		}, ln = (e) => {
			...
			[
				...
				if (e.special) rn(r, K.value, z.value.state);
					...
					r.cellRenderer = t.template === "" ? nt : u.component(t.template), r.autoHeight = !0, c.indexOf(e.type) > -1 ? (tn(r, z.value.state), r.filter = "agNumberColumnFilter", r.cellRendererParams = { type: "number" }) : e.type === l.DATE ? ($t(r, z.value.state), r.filter = "agDateColumnFilter", r.minWidth = 400, r.cellRendererParams = { type: "date" }) : e.type === l.STRING && (n ? en(r, i.rows, z.value.state) : nn(r, z.value.state), r.filter = "agTextColumnFilter", r.cellRendererParams = { type: "string" }), K.value.push(r);
				}
		...
		return S(() => {
			...
			}, _n(), $.value === "partial" && u.notify.show(t.WARNING, u.$i18n.t("layer.filterwarning")), G.value.push(ue(be, () => {
				Te.value = !1, setTimeout(() => {
					Te.value = !0;
				}, 10);
			})), G.value.push(ue($, (e) => {
				e === "partial" && u.notify.show(t.WARNING, u.$i18n.t("layer.filterwarning"));
			}));
		}), x(() => {
