import { B as e, N as t } from "./main-DRrASmfn.js";
...
var O = ["onClick", "aria-label"], k = { class: "md-icon-small inline" }, A = /* @__PURE__ */ l({
	...
	setup(a) {
		let { t: c } = D(), l = e(), u = t(), f = r(() => l.mobileView ? "top-end" : "left-end"), p = (e) => {
	...
	setup(e) {
		let n = e, { t: o } = D(), l = u("iApi"), d = t(), _ = g(), y = g(void 0), T = g(void 0), O = g([]), k = S("componentEl"), F = r(() => d.componentSelectedState), I = r(() => {
			let e = {};
