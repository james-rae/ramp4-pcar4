import{P as e}from"./typedArrayUtil-DxTGOhzQ.js";import{t}from"./Error-B5zVEp1V.js";import{r as n}from"./tslib.es6-CQRs8sXx.js";import{r,s as i}from"./vec3f64-AstwQ_2i.js";import{t as a}from"./mat4f64-CR6tgU3J.js";import{x as o}from"./mat4-ABfYnpNJ.js";import{j as s,r as c,x as l,y as u}from"./vec3-Dj5TqYmB.js";import{n as d}from"./glsl-C_vcLKq5.js";import{t as f}from"./Uniform-BsjcOff5.js";import{t as p}from"./Float3DrawUniform-HZzWhVa2.js";import{t as m}from"./Texture2DBindUniform-BbPBYJOG.js";import{t as h}from"./NoParameters-D7QDH0Hy.js";import{t as g}from"./HighlightReadBitmap.glsl-APHZ_RIW.js";var _=class{constructor(e){this._bits=[...e]}equals(t){return e(this._bits,t.bits)}get code(){return this._code??=String.fromCharCode(...this._bits),this._code}get bits(){return this._bits}},v=class extends h{constructor(){super(),this._parameterBits=this._parameterBits?.map(()=>0)??[],this._parameterNames??=[]}get key(){return this._key??=new _(this._parameterBits),this._key}decode(e=this.key){let t=this._parameterBits;this._parameterBits=[...e.bits];let n=this._parameterNames.map(e=>`    ${e}: ${this[e]}`).join(`
