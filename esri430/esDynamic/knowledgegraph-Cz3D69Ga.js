import { C as x, a1 as C, bn as J, bo as K, bp as E, bx as I, Z as M, eU as W, eY as Q, eZ as U } from "./main-CNI-dCKS.js";
import { a as G, b as u, r as c, I as j, m as P, G as w, ab as V, P as Z, N as T, U as v, A as H, E as D, X as k, w as X, v as Y, ac as _, ad as F, ae as z } from "./arcadeUtils-BO6x4L4q.js";
import { l as B } from "./portalUtils-CebQagEc.js";
import { p as L, n as O } from "./project-Bkh51gts.js";
import { s as $, m as nn, t as tn, p as en, c as an } from "./GraphQueryStreaming-Bxb9-AXS.js";
let f = null;
async function rn(n) {
...
async function q(n, t) {
  ...
  return await a.load(), f === null && (f = await import("./knowledgeGraphService-OwCHgKDS.js").then((i) => i.k)), await f.fetchKnowledgeGraph(a.url);
}
...
function pn(n) {
  n.mode === "async" && (n.functions.knowledgegraphbyportalitem = function(t, a) {
    ...
    return n.standardFunctionAsync(t, a, async (i, s, e) => {
      ...
      f === null && (f = await import("./knowledgeGraphService-OwCHgKDS.js").then((o) => o.k));
      let p = null;
      const m = Z(e[2], null);
...
//# sourceMappingURL=knowledgegraph-Cz3D69Ga.js.map
