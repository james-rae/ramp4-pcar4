import { ag as m, aJ as d, $ as u, M as w, s as p } from "./main-CNI-dCKS.js";
let r = null, s = !0;
function T(e, a, t) {
...
async function B(e, a) {
  ...
  if (n === "image/gif") {
    const { isAnimatedGIF: o, parseGif: c } = await import("./gif-D2ySvbU8.js");
    if (o(t)) return c(t, a);
  }
  if (i) {
    const { isAnimatedPNG: o, parseApng: c } = await import("./apng-CTYWnp8J.js");
    if (o(t)) return c(t, a);
  }
...
//# sourceMappingURL=imageUtils-DQzKZn5m.js.map
