import { fq as q, bx as v, cy as K } from "./main-CNI-dCKS.js";
import { y as Q } from "./DoubleArray-B6sFKCpx.js";
import { i as W, a as X } from "./MeshLocalVertexSpace-DgvjYkUf.js";
import { f as Z, l as ee } from "./vec3-CKpFdu7j.js";
import "./sphere-C9DMMyp_.js";
import "./I3SUtil-BWTyoKoq.js";
var U, D;
(function(e) {
...
function te() {
  return _ || (_ = new Promise((e) => import("./i3s-fFCRhvri.js").then((t) => t.i).then(({ default: t }) => {
...
async function pe(e) {
  ...
  let s;
  const [{ projectBuffer: I }, { initializeProjection: M }] = await Promise.all([import("./main-CNI-dCKS.js").then((a) => a.r9), import("./main-CNI-dCKS.js").then((a) => a.ra)]);
  await M(c, l);
  const g = [0, 0, 0];
  ...
  if (i.type === "georeferenced" && i.origin == null) {
    ...
    const a = i.type === "georeferenced" ? W.fromJSON(i) : X.fromJSON(i), { project: m } = await import("./projection-CgrcQbfS.js"), d = m({ positions: f, transform: t ? { localMatrix: t } : void 0, vertexSpace: a, inSpatialReference: c, outSpatialReference: l, localMode: u });
...
//# sourceMappingURL=SceneLayerWorker-Df-iPYUc.js.map
