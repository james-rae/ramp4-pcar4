import { O as u, P as f, gt as _t, eH as Dt, e9 as Pt, Q as z, bX as ve, ev as _e, cp as Ae, bW as Et, aM as Ke, cs as De, D as le, aa as be, s as oe, gh as Ut, jc as F, bq as Wt, le as zt, fL as he, nK as ce, nL as Ht, bB as Vt, nM as kt, b8 as Qe, a4 as Bt, dG as Gt, dJ as Yt, aG as S, aH as Se, hi as et, dK as we, a3 as O, R as Xt, nN as qt, mJ as Zt, jT as Jt, ma as Kt, jx as Qt, V as er, bi as tr, cA as Re, aF as rr, nO as tt, m6 as nr, cC as $e, cD as rt, nP as nt, g7 as ot, nQ as st, nR as it, cz as or, jb as sr, en as ir, dI as ar, fa as lr, k8 as cr, S as ur, b5 as pr, nS as hr, eU as fr } from "./main-CNI-dCKS.js";
import { u as Pe, y as mr, h as dr, b as at, N as se, c as lt, d as fe, k as ct, w as gr } from "./MeshTransform-DCjQGLw3.js";
import { c as yr } from "./imageUtils-DQzKZn5m.js";
import { c as xr, l as me } from "./MeshVertexAttributes-Cgwf7mWs.js";
import { a as Me, i as de } from "./MeshLocalVertexSpace-DgvjYkUf.js";
import { a as ie, s as ge, g as ut, u as Ee } from "./meshVertexSpaceUtils-BujMoAru.js";
import { i as vr } from "./earcut-BomAa1Sa.js";
import { a as wr, e as $r, t as pt } from "./DoubleArray-B6sFKCpx.js";
import { t as ht } from "./Indices-DKg39II1.js";
import { E as br, F as Tr, X as Ar } from "./plane-BWAD_id8.js";
import { e as Ue } from "./deduplicate-D5u3RLYm.js";
import { project as Sr, logProjectionError as b, loadProjectErrorMessage as E, projectToPCPF as ft, projectNormalToPCPF as mt, projectTangentToPCPF as dt, projectFromPCPF as gt, projectNormalFromPCPF as yt, projectTangentFromPCPF as xt } from "./projection-CgrcQbfS.js";
import { c as _, M as Fe, X as Rr, N as vt } from "./vertexSpaceConversion-nTt34Vbe.js";
import { e as wt } from "./mat3f64-Dh9_zhFu.js";
import { e as Le } from "./mat4f64-Dn1WEGBx.js";
import { I as Mr } from "./quat-BFnwLVex.js";
import { e as Fr, o as Ir } from "./quatf64-DxbQqBtW.js";
import { a as $t } from "./spatialReferenceEllipsoidUtils-CeQ_idxt.js";
import { u as Cr } from "./computeTranslationToOriginAndRotation-C5tnRbaf.js";
var G;
...
async function qr(e, t, n) {
  const { source: r } = t, { loadGLTFMesh: o } = await et(import("./loadGLTFMesh-CFD62LpA.js"), n), s = await Jr(r, n);
  we(n);
...
let $ = M = class extends lr.LoadableMixin(cr(fr)) {
  ...
  async toBinaryGLTF(e) {
    const [{ toBinaryGLTF: t }] = await Promise.all([import("./gltfexport-BN0XKFEd.js"), this.load(e)]);
  ...
  static async createFromGLTF(e, t, n) {
    ...
    const { loadGLTFMesh: r } = await et(import("./loadGLTFMesh-CFD62LpA.js"), n);
...
//# sourceMappingURL=Mesh-Bgb5d0Db.js.map
