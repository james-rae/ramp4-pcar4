import { jr as A, js as y, bY as M, fU as $, hG as O, g1 as D, hH as j } from "./main-CNI-dCKS.js";
import { _ as k } from "./screen.vue_vue_type_script_setup_true_lang-DDjVLe2a.js";
var H = { exports: {} };
(function(S, i) {
  (function(n, a) {
    a();
...
class _ extends M {
   ...
   */
  async make(i, n) {
    const { fabric: a } = await import("./fabric-cPC1bHQd.js").then((g) => g.f);
...
class I extends _ {
  ...
  async needed() {
    const i = (await import("./index-97w1u8lJ.js")).default, n = (await import("./index-4saKYSKR.js")).default, a = (await import("./index-4MvIR7Yx.js")).default, w = (await import("./index-jU3HPYD2.js")).default, p = (await import("./index-C13rf_3O.js")).default, r = (await import("./index-CYU7SHeX.js")).default, b = (await import("./index-BJQtAuZ7.js")).default;
...
//# sourceMappingURL=index-B8funeoV.js.map
