import { a9 as Et, fq as bt } from "./main-CNI-dCKS.js";
...
async function Mt() {
  gt = await (Et("esri-csp-restrictions") ? await import("./libtess-asm-OCXkU-s4.js").then((i) => i.l) : await import("./libtess-Cq9QGL0W.js").then((i) => i.l)).default({ locateFile: (i) => bt(`esri/core/libs/libtess/${i}`) });
}
function $t(x, i) {
...
//# sourceMappingURL=TurboLine-BxotKhF0.js.map
