...
import { merge as b } from "es-toolkit";
import { applyConverter as re } from "@terraformer/spatial";
import x from "proj4";
import { TinyEmitter as ie } from "tiny-emitter";
import { createPinia as ae, defineStore as S, storeToRefs as oe } from "pinia";
import { Fragment as se, Teleport as ce, Transition as le, TransitionGroup as ue, computed as C, createApp as de, createBlock as w, createCommentVNode as T, createElementBlock as E, createElementVNode as D, createTextVNode as fe, createVNode as pe, defineAsyncComponent as me, defineComponent as O, getCurrentInstance as he, h as ge, inject as _e, markRaw as k, mergeProps as ve, nextTick as ye, normalizeClass as A, normalizeStyle as be, onBeforeUnmount as xe, onMounted as Se, onUpdated as Ce, openBlock as j, reactive as we, ref as M, render as Te, renderList as Ee, renderSlot as De, resolveComponent as N, resolveDirective as P, resolveDynamicComponent as Oe, toDisplayString as F, toRaw as ke, unref as I, useCssVars as Ae, useTemplateRef as je, vShow as Me, watch as Ne, withCtx as L, withDirectives as R, withKeys as Pe, withModifiers as Fe } from "vue";
...
var et = /* @__PURE__ */ function(e) {
	...
	constructor(e) {
		if (e ||= { style: tt.CIRCLE }, super(), this._style = e.style || tt.CIRCLE, e.style === tt.ICON) {
			...
			let t = e;
			this._size = Ct.convToPoints(t.size) || 12, this._colour = new St(t.colour ?? "#ffffff40"), this._outline = new Tt(t.outline), this._path = this._style === tt.PATH && t.path || "", this._height = 0, this._width = 0, this._icon = "";
		}
	...
	constructor(e) {
		...
		this._width = t === void 0 || t < 0 ? .75 : t, this._colour = new St(e.colour), this._miter = e.miter ?? 2, this._cap = e.cap || it.ROUND, this._join = e.join || rt.ROUND;
	}
	get styleType() {
		return this._style;
	}
	...
	_fillStyle;
	constructor(e) {
		super(), e ||= {}, e.fill ||= {}, this._fillColour = new St(e.fill.colour), this._fillStyle = e.fill.style || at.SOLID, this._outlineStyle = new Tt(e.outline);
	}
	get fillColour() {
	...
	geomGeoJsonToRamp(e, t) {
		switch (e.type) {
			...
			case U.LINESTRING: return gt.fromGeoJSON(e, t);
			case U.POLYGON: return yt.fromGeoJSON(e, t);
			case U.MULTIPOINT: return ht.fromGeoJSON(e, t);
			case U.MULTILINESTRING: return _t.fromGeoJSON(e, t);
			case U.MULTIPOLYGON: return bt.fromGeoJSON(e, t);
			default: throw Error(`Encountered unhandled geometry type ${e.type}`);
		}
	}
	geomRampToGeoJson(e) {
	...
	updateQuery(e) {
		let t = b({}, this.queryMap);
		return b(t, e), `${this.base}${Object.entries(t).filter(([, e]) => e !== void 0).map(([e, t], n) => `${n === 0 ? "?" : ""}${e}=${t}`).join("&")}`;
	}
}, Pt = "EPSG:4326", Ft = class {
	espgWorker;
	constructor() {
		this.espgWorker = this.defaultEpsgLookup, x.defs("EPSG:3978", "+proj=lcc +lat_1=49 +lat_2=77 +lat_0=49 +lon_0=-95 +x_0=0 +y_0=0 +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +units=m +no_defs"), x.defs("EPSG:3979", "+proj=lcc +lat_1=49 +lat_2=77 +lat_0=49 +lon_0=-95 +x_0=0 +y_0=0 +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +units=m +no_defs"), x.defs("EPSG:54004", "+proj=merc +lon_0=0 +k=1 +x_0=0 +y_0=0 +ellps=WGS84 +datum=WGS84 +units=m +no_defs"), x.defs("EPSG:102100", x.defs("EPSG:3857")), x.defs("EPSG:102187", "+proj=tmerc +lat_0=0 +lon_0=-114 +k=0.9999 +x_0=0 +y_0=0 +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +units=m +no_defs"), x.defs("EPSG:102190", "+proj=aea +lat_1=50 +lat_2=58.5 +lat_0=45 +lon_0=-126 +x_0=1000000 +y_0=0 +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +units=m +no_defs");
		let e = 1;
		for (; e <= 60;) {
			let t = e < 10 ? `0${e}` : e;
			x.defs(`EPSG:326${t}`, `+proj=utm +zone=${e} +ellps=WGS84 +datum=WGS84 +units=m +no_defs`), e++;
		}
	}
	addProjection(e, t) {
		e = typeof e == "number" ? `EPSG:${e}` : e, x.defs(e, t);
	}
	defaultEpsgLookup(e) {
	...
	async checkProj(e) {
		...
		let r = (e, t) => {
			e !== t && x.defs(t, x.defs(e));
		};
		if (x.defs(t)) return !0;
		if (n && x.defs(n)) return r(n, t), !0;
		let i = async (e) => {
			try {
				let t = await this.epsgLookup(e);
				return t === null || t === "" ? !1 : (x.defs(e, t), !0);
			} catch {
				return !1;
			}
		};
	...
	async projectGeoJson(e, t, n) {
		let r, i;
		if (r = t ? this.normalizeProj(t) : Y.parseGeoJsonCrs(e.crs), i = n ? this.normalizeProj(n) : Pt, i === r) return e;
...
var Vt = class {
	...
	let e = M({}), t = M([]), n = M([]), r = C(() => t.value.map((t) => t.map((t) => e.value[t]).filter((e) => {
	...
	let e = M([]), t = M({}), n = M({}), r = M(), i = M(0), a = M(0), o = M(0), s = M(!0), c = M();
	function l(t) {
	...
	_funCounter;
	constructor(e) {
		super(e), this._eventBus = new ie(), this._eventRegister = [], this._funCounter = 1, this._nameRegister = Object.values($).filter((e) => typeof e == "string" && e.indexOf("/") > -1);
	}
	findHandler(e) {
	...
	addDefaultEvents(e) {
		return (!Array.isArray(e) || e.length === 0) && (e = Object.values(Jt)), e.map((e) => this.defaultHandlerFactory(e));
	}
...
var nn = S("maptip", () => {
	...
	__name: "esri-map",
	setup(e) {
		let t = nn(), n = _e("iApi"), r = C(() => t.maptipPoint), i = C(() => t.maptipInstance), a = C(() => t.content), o = we([]), s = M(!1);
		o.push(Ne(r, () => {
			if (r.value) {
	...
	setup(e) {
		...
		return (n, r) => {
			...
			return j(), E("div", {
				...
				default: L(() => [R((j(), w(Oe(e.panel.route.screen), ve({ class: "h-full" }, e.panel.route.props, { panel: e.panel }), null, 16, ["panel"])), [[i]])]),
				_: 1
			})], 14, sn);
		};
	}
}), ln = S("panel", () => {
	let e = M(void 0), t = M(void 0), n = M(0), r = M(0), i = M(!1), a = M(!0), o = M(!0), s = M({}), c = M({}), l = M([]), u = M([]), d = M([]), f = M(1), p = C(() => r.value);
	function m(e) {
...
}), un = /*#__PURE__*/ y(/* @__PURE__ */ O({
	__name: "panel-stack",
	setup(e) {
		Ae((e) => ({ v3d36ee4c: i.value }));
		let t = ln(), n = _e("iApi"), r = M(), i = C(() => t.opacity), a = C(() => t.mobileView);
		Se(() => {
		...
		return (e, t) => (j(), w(ue, {
			...
			default: L(() => [(j(!0), E(se, null, Ee(o(I(n).screenSize), (e) => (j(), w(cn, {
				key: `${e.id}`,
				panel: e
			}, null, 8, ["panel"]))), 128))]),
			_: 1
...
}), [["__scopeId", "data-v-717e4bd7"]]), dn = ["content", "aria-label"], fn = /* @__PURE__ */ O({
	...
	let e = 0, t = M([]), n = M({}), r = C(() => t.value.length >= 99 ? 99 : t.value.length);
	function i(n) {
		let r = {
			...n,
			id: `notif-${e++}`
...
}), mn = { class: "h-full flex flex-col" }, hn = { class: "w-full flex mb-6" }, gn = ["content", "aria-label"], _n = /* @__PURE__ */ O({
	__name: "screen",
	props: { panel: {
		type: Object,
		required: !0
	...
	setup(e) {
		let t = pn(), { t: n } = z(), r = C(() => t.notificationNumber), i = () => t.clearAll();
		return (t, a) => {
			let o = N("panel-screen"), s = P("tippy");
			return j(), w(o, { panel: e.panel }, {
				header: L(() => [fe(F(I(n)("notifications.title")), 1)]),
				content: L(() => [D("div", mn, [D("div", hn, [R((j(), E("button", {
					type: "button",
					onClick: i,
					...
					D("path", { d: "M13 17h-9a4 4 0 0 0 2 -3v-3a7 7 0 0 1 4 -6a2 2 0 1 1 4 0a7 7 0 0 1 4 6v2" }),
					D("path", { d: "M9 17v1a3 3 0 0 0 4.194 2.753" }),
					D("path", { d: "M22 22l-5 -5" }),
					D("path", { d: "M17 22l5 -5" })
				], -1)]], 10, gn)), [[s, {
					placement: "bottom",
					theme: "ramp4",
					animation: "scale"
				}]])]), pe(An, { class: "overflow-y-auto" })])]),
				_: 1
			}, 8, ["panel"]);
		};
	}
	...
	constructor(e) {
		super(e), this.$iApi.panel.register({
			id: "notifications",
			config: {
				screens: { "notifications-screen": k(_n) },
	...
	setup(e, { emit: t }) {
		...
		return (t, i) => {
			...
			return R((j(), E("li", {
				...
				D("span", null, [fe(F(o[e.notification.type]) + " ", 1), D("span", Cn, F(e.notification.message), 1)]),
				i[4] ||= D("span", { class: "flex-grow" }, null, -1),
				e.notification.messageList ? (j(), E("div", {
					key: 0,
					...
					viewBox: "0 0 24 24",
					width: "24"
				}, [D("path", { d: "M7.41 8.59L12 13.17l4.59-4.58L18 10l-6 6-6-6 1.41-1.41z" })], -1)]], 2)) : T("", !0),
				R((j(), E("button", {
					type: "button",
	...
	setup(e) {
		...
		let c = C(() => t.notificationStack);
		return (e, t) => {
			let a = P("focus-item"), o = P("focus-list"), l = P("tippy");
			return j(), E("div", null, [c.value.length > 0 ? R((j(), E("ul", {
				key: 0,
				content: I(n)("panels.controls.items"),
				ref_key: "el",
				ref: r,
				class: "h-full overflow-y-auto"
			}, [(j(!0), E(se, null, Ee(c.value, (e, t) => (j(), E(se, { key: e.id }, [t > 0 ? (j(), E("div", On)) : T("", !0), R(pe(En, {
				ref_for: !0,
				...
				t[0] ||= D("span", { class: "flex-grow" }, null, -1),
				t[1] ||= D("svg", {
					xmlns: "http://www.w3.org/2000/svg",
					viewBox: "0 0 24 24",
					...
					d: "M0 0h24v24H0z",
					fill: "none"
				}), D("path", { d: "M18 7l-1.41-1.41-6.34 6.34 1.41 1.41L18 7zm4.24-1.41L11.66 16.17 7.48 12l-1.41 1.41L11.66 19l12-12-1.42-1.41zM.41 13.41L6 19l1.41-1.41L1.83 12 .41 13.41z" })], -1),
				D("span", null, F(I(n)("notifications.empty")), 1),
				t[2] ||= D("span", { style: { "flex-grow": "6" } }, null, -1)
			]))]);
		};
	}
}), jn = { class: "flex items-center" }, Mn = ["aria-label"], Nn = {
	key: 0,
	class: "number rounded-full w-18 text-white"
}, Pn = { class: "notification-dropdown pointer-events-auto bg-white rounded text-center text-black w-500 h-256 flex flex-col p-0" }, Fn = { class: "pb-8 border-b border-gray-600" }, In = { class: "absolute flex right-3 top-3" }, Ln = ["content", "aria-label"], Rn = /*#__PURE__*/ y(/* @__PURE__ */ O({
	...
	setup(e) {
		...
		return (e, t) => {
			...
			return j(), w(fn, {
				...
				header: L(() => [D("div", jn, [(j(), E("svg", {
					class: "fill-current w-24 h-24",
					xmlns: "http://www.w3.org/2000/svg",
					viewBox: "0 0 24 24",
					"aria-label": I(n)("notifications.open")
				}, [...t[0] ||= [D("path", { d: "M12 22c1.1 0 2-.9 2-2h-4c0 1.1.89 2 2 2zm6-6v-5c0-3.07-1.64-5.64-4.5-6.32V4c0-.83-.67-1.5-1.5-1.5s-1.5.67-1.5 1.5v.68C7.63 5.36 6 7.92 6 11v5l-2 2v1h16v-1l-2-2z" }, null, -1)]], 8, Mn)), r.value && r.value > 0 ? (j(), E("span", Nn, F(r.value), 1)) : T("", !0)])]),
				default: L((e) => [D("div", Pn, [D("div", null, [D("h4", Fn, F(I(n)("notifications.title")), 1), D("div", In, [R((j(), E("button", {
					type: "button",
					onClick: i,
					...
					animation: "scale",
					appendTo: "parent"
				}]]), pe(a, { onClick: e.close }, null, 8, ["onClick"])])]), pe(An, { class: "overflow-y-auto h-230" })])]),
				_: 1
			}, 8, ["tooltip"]);
		};
	}
}), [["__scopeId", "data-v-28078ee6"]]), zn = { class: "flex" }, Bn = ["aria-label"], Vn = { class: "about-ramp-dropdown pointer-events-auto bg-white rounded w-256 h-50" }, Hn = ["aria-label", "content"], Un = { class: "pb-8 pt-1 border-b border-gray-600 mb-10" }, Wn = { class: "absolute right-5 top-5" }, Gn = { class: "select-text" }, Kn = { class: "font-bold cursor-text" }, qn = { class: "text-sm cursor-text" }, Jn = { class: "font-bold cursor-text" }, Yn = { class: "ml-5 cursor-text" }, Xn = { class: "mt-5" }, Zn = ["href"], Qn = /*#__PURE__*/ y(/* @__PURE__ */ O({
	...
	setup(e) {
		let { t } = z(), n = _e("iApi"), r = () => {
			n.reload();
		}, i = C(() => `${Ms.major}.${Ms.minor}.${Ms.patch}`), a = C(() => Ms.hash.slice(0, 9)), o = C(() => {
			...
			return R((j(), w(l, {
				...
				default: L((e) => [D("div", Vn, [D("div", null, [
					R((j(), E("button", {
						...
						xmlns: "http://www.w3.org/2000/svg",
						viewBox: "0 0 24 24"
					}, [D("path", { d: "M17.65 6.35C16.2 4.9 14.21 4 12 4c-4.42 0-7.99 3.58-7.99 8s3.57 8 7.99 8c3.73 0 6.84-2.55 7.73-6h-2.08c-.82 2.33-3.04 4-5.65 4-3.31 0-6-2.69-6-6s2.69-6 6-6c1.66 0 3.14.69 4.22 1.78L13 11h7V4l-2.35 2.35z" })], -1)]], 8, Hn)), [[u, {
						placement: "bottom-start",
						theme: "ramp4",
						animation: "scale"
					}]]),
					D("h4", Un, F(I(t)("ramp.about")), 1),
					D("div", Wn, [pe(c, { onClick: e.close }, null, 8, ["onClick"])]),
					D("div", Gn, [
						D("div", null, [D("span", Kn, F(i.value), 1), D("span", qn, " [" + F(a.value) + "] ", 1)]),
						D("div", null, [D("span", Jn, F(o.value[0]), 1), D("span", Yn, F(o.value[1]), 1)]),
						s[3] ||= D("div", { class: "mt-5" }, [D("a", {
						...
						}, [D("path", { d: "M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z" })]), fe(" ramp4-pcar4 ")])], -1),
						D("div", Xn, [D("a", {
							class: "text-sm underline text-blue-600",
...
}), [["__scopeId", "data-v-966796d3"]]), $n = "__HELP__", er = S("keyboardnav", () => {
	...
	function d(e, t, n) {
		if (e) {
			...
			if (e === "reset") {
				let e = n ?? b.activeNamespace ?? b.keyChain[1];
				if (!e) {
					h({ suppressHandler: !0 });
					return;
				}
				g(["S", e]), v(void 0), y("awaitAction"), b.activeNamespace = e;
			}
		}
	}
	function f(n, r, i) {
		e.value = n, !i?.suppressHandler && t.value[n]?.activeHandler?.(b, r);
	}
	function p(n, r) {
		e.value && !r?.suppressHandler && t.value[e.value]?.deactiveHandler?.(b, n), e.value = void 0;
	}
	function m(n, r) {
		let i = e.value;
		if (!i) return;
	...
	__name: "map-caption",
	setup(e) {
		let t = Wt(), n = er(), r = v(), { t: i } = z(), a = _e("iApi"), o = C(() => t.scale), s = C(() => t.attribution), c = C(() => t.coords), l = C(() => t.langtoggle), u = C(() => r.config.map), { keyChain: d, lastAction: f, chainState: p, namespaces: m, activeNamespace: h } = oe(n), g = C(() => {
		...
		return (e, t) => {
			...
			return j(), E("div", tr, [
				...
				pe(Rn, { class: "sm:block display-none" }),
				g.value ? (j(), E("span", nr, [D("span", rr, [
					t[0] ||= D("span", { class: "chain-colon" }, ":", -1),
					D("span", ir, F(g.value.keys), 1),
					g.value.cursor ? (j(), E("span", ar, "_")) : T("", !0),
					g.value.options ? (j(), E("span", or, F(g.value.options), 1)) : T("", !0)
				]), g.value.description ? (j(), E("span", sr, "- " + F(g.value.description) + "...", 1)) : T("", !0)])) : s.value?.text.disabled ? T("", !0) : R((j(), E("span", cr, [fe(F(s.value?.text.value), 1)])), [[r, { options: {
					placement: "top",
					hideOnClick: !1,
					theme: "ramp4",
					animation: "scale"
				} }]]),
				t[1] ||= D("span", { class: "flex-grow w-15" }, null, -1),
				D("div", lr, [
					c.value?.disabled ? T("", !0) : R((j(), E("div", ur, [fe(F(c.value?.formattedString), 1)])), [[r, { options: {
						hideOnClick: !1,
						theme: "ramp4",
						animation: "scale"
					} }]]),
					o.value?.disabled ? T("", !0) : R((j(), E("button", {
						key: 1,
						type: "button",
                ...
                `,
					...
					}, null, 4), D("span", fr, F(o.value?.label), 1)], 8, dr)), [[u, {
						delay: [300, 0],
						placement: "top",
						hideOnClick: !1,
						theme: "ramp4",
					...
					l.value?.disabled ? T("", !0) : (j(), w(n, {
						...
						header: L(() => [D("span", pr, F(I(i)("map.language.short")), 1)]),
						default: L(() => [(j(!0), E(se, null, Ee(ee.value, (e, t) => (j(), E("a", {
							key: `${e}-${t}`,
							class: A(["flex-auto items-center text-sm sm:text-base cursor-pointer", { "font-bold": e === I(a).$i18n.locale.value }]),
							href: "javascript:;",
							onClick: (t) => y(e)
						}, [fe(F(I(i)("map.language." + e)) + " ", 1), e === I(a).$i18n.locale.value ? (j(), E("span", hr, F(I(i)("map.language.curr")), 1)) : T("", !0)], 10, mr))), 128))]),
						_: 1
					}, 8, ["tooltip", "ariaLabel"]))
				])
			]);
...
}, yr = /*#__PURE__*/ y(/* @__PURE__ */ O({
	__name: "floating-button",
	setup(e) {
		let t = pn(), n = _e("iApi"), { t: r } = z(), i = C(() => t.notificationNumber);
		return (e, t) => {
			let a = P("tippy");
			return R((j(), E("button", {
				type: "button",
				...
				xmlns: "http://www.w3.org/2000/svg",
				viewBox: "0 0 24 24"
			}, [D("path", { d: "M12 22c1.1 0 2-.9 2-2h-4c0 1.1.89 2 2 2zm6-6v-5c0-3.07-1.64-5.64-4.5-6.32V4c0-.83-.67-1.5-1.5-1.5s-1.5.67-1.5 1.5v.68C7.63 5.36 6 7.92 6 11v5l-2 2v1h16v-1l-2-2z" })], -1), i.value && i.value > 0 ? (j(), E("span", vr, F(i.value), 1)) : T("", !0)], 8, _r)), [[a]]);
		};
	}
}), [["__scopeId", "data-v-a451db5c"]]), br = { class: "flex items-center mb-20" }, xr = { class: "text-xl" }, Sr = /* @__PURE__ */ O({
	...
	setup(e) {
		...
		return (e, t) => {
			...
			return r.value ? (j(), E("div", {
				...
				D("div", br, [D("h2", xr, F(I(n)("keyboardInstructions.title")), 1), pe(a, {
					class: "ml-auto",
					onClick: t[0] ||= (e) => r.value = !1
				})]),
				(j(!0), E(se, null, Ee(i.value, (e) => (j(), E("p", {
...
}), Cr = S("instance", () => ({ started: M(!1) })), wr = { class: "h-full relative" }, Tr = { class: "inner-shell absolute top-0 left-0 h-full w-full pointer-events-none" }, Er = { class: "absolute top-8 w-full flex justify-center" }, Dr = {
	key: 1,
	class: "w-full h-full"
}, Or = O({
	name: "App",
	components: { Shell: /* @__PURE__ */ y(/* @__PURE__ */ O({
		__name: "shell",
		setup(e) {
			let t = _e("iApi"), n = Cr(), r = qt(), i = ln(), { t: a } = z(), o = C(() => r.items.appbar), s = () => {
				t.event.emit("openKeyboardInstructions");
			}, c = () => i.teleported;
			return (e, t) => (j(), E("div", wr, [
				D("div", Tr, [
					t[0] ||= D("div", { class: "sr-only screen-reader-alert" }, null, -1),
					D("div", Er, [D("button", {
						type: "button",
						class: "bg-white hidden-until-focus z-50 shadow-md px-10",
						onClick: s
					}, F(I(a)("keyboardInstructions.open")), 1)]),
					pe(Sr, { class: "keyboard-instructions-modal" }),
					pe(un, { class: "panel-stack sm:flex absolute inset-0 overflow-hidden sm:p-12 z-10 sm:pl-80 xs:pl-40 sm:pb-48 xs:pb-28 xs:pr-0 sm:pr-40" }),
					o.value ? T("", !0) : (j(), w(yr, { key: 0 })),
					pe(gr, { class: "z-30" })
				]),
				I(n).started ? (j(), w(rn, { key: 0 })) : (j(), E("div", Dr, [...t[1] ||= [D("div", { class: "spinner relative inset-x-1/2 inset-y-9/20" }, null, -1)]])),
				(j(!0), E(se, null, Ee(c(), (e) => (j(), w(ce, {
	...
	setup() {
		let e = he();
		Se(() => {
			new on().observe(e?.proxy?.$refs["app-size"]), Ge({
...
function jr(e, t, n, r, i, a) {
	...
	return j(), E("div", {
		...
		lang: e.$i18n.locale
	}, [D("div", Ar, [pe(o)], 512)], 8, kr);
}
var Mr = /*#__PURE__*/ y(Or, [["render", jr]]), Nr = "focus-list", Pr = "focus-item", Fr = "focus-icon", Ir = `[${Nr}],[focus-container]`, Lr = "truncate-text", Rr = "show-truncate", zr = "focused", Br = `button,input,select,a,textarea,[contenteditable],[${Nr}],[${Fr}],[tabindex]`, Vr = {
	mounted(e, t) {
...
var qr = "focus-container", Jr = "focus-container-active", Yr = "focus-list", Xr = "focus-icon", Zr = `[${Yr}],[${qr}]`, Qr = `button,input,select,a,textarea,[contenteditable],.ag-tab-guard,[${Yr}],[${qr}],[${Xr}],[tabindex]`, $r = {
	childList: !0,
	subtree: !0,
	attributes: !0,
	attributeFilter: [
	...
	mounted(e) {
		[...document.querySelectorAll(".inner-shell")].some((t) => t.contains(e)) && ei.push(new ni(e));
	},
	beforeUnmount(e) {
		ei = ei.filter((t) => t.element === e ? (t.removeEventListeners(), !1) : !0);
	}
}, ni = class {
	element;
	isTabbingEnabled;
	...
	focusHandler;
	constructor(e) {
		this.element = e, this.isTabbingEnabled = !1, this.element.toggleAttribute(qr, !0), this.element.toggleAttribute(Jr, !1), this.element.tabIndex = 0, this.initialDisableTimeout = setTimeout(() => this.disableTabbing(), 600), this.keypressHandler = (e) => {
			this.onKeypress(e);
		}, this.clickHandler = () => {
			this.onClick();
	...
	disableTabbing() {
		...
		let t = Array.prototype.filter.call(this.element.querySelectorAll(Qr), () => !0);
	...
	enableTabbing() {
		...
		return this.withPausedObserver(() => {
			Array.prototype.map.call(this.element.querySelectorAll(Qr), (t) => {
				(t.closest(Zr) === this.element || t.closest(Zr) === t && t.parentElement.closest(Zr) === this.element) && t.offsetParent && (t.tabIndex !== 0 && (t.tabIndex = 0), e === void 0 && (e = t));
			});
		}), e;
	}
	setTabbingEnabled(e) {
		this.isTabbingEnabled = e, this.element.toggleAttribute(Jr, e);
	}
	observeMutations() {
		this.mutationObserver?.observe(this.element, $r);
	}
...
}, ri = "truncate-text", ii = "truncate-trigger", ai = {
	beforeMount(e, t) {
		!e.classList.contains("truncate") && !t.value?.noTruncateClass && e.classList.add("truncate"), e.toggleAttribute(ri, !0);
	},
	mounted(e, t) {
		let n;
		t.value && t.value.externalTrigger && (n = e.closest(`[${ii}]`)), Ke(e, {
			content: ci(e.textContent),
			onShow: oi,
			allowHTML: !0,
			placement: "bottom-start",
			maxWidth: 320,
	...
	updated(e, t) {
		e._tippy && (e._tippy.setContent(ci(e.textContent)), t.value && t.value.options && e._tippy.setProps(t.value.options));
	},
	unmounted(e) {
...
var li = ["content"], ui = {
...
}, gi = "focus-container", _i = "focus-container-active", vi = /* @__PURE__ */ O({
	__name: "panel-screen",
	props: {
		header: {
			type: Boolean,
	...
	setup(e, { expose: t }) {
		let { t: n } = z(), r = ln(), i = Ht(), a = _e("iApi"), o = je("el"), s = je("contentEl"), c = M(), l = M(), u = M();
		t({ el: o });
		let d = e, f = C(() => a.fixture.get("appbar") ? i.temporary : []), p = C(() => r.mobileView), m = C(() => r.reorderable), h = C(() => r.pinable), g = `[focus-list], [${gi}]`, ee = (e) => e.scrollHeight > e.clientHeight, _ = (e) => e.querySelector(g), v = () => {
			if (!s.value) return "-1";
			let e = s.value.closest(`[${gi}]`);
			if (e && !e.hasAttribute(_i)) return "-1";
			let t = !!_(s.value);
		...
		}, x = () => !p.value && !d.panel.teleport, ie = (e) => {
			d.panel.move(e), e === "left" && ye(() => {
				(o.value?.querySelector(".move-left")).focus();
			});
		}, ae = C(() => d.screenId ? d.panel.screens[d.screenId][a.$i18n.locale.value ?? "en"] : null);
		return Se(() => {
			o.value?.addEventListener("blur", b), o.value?.addEventListener("keyup", re), s.value && (s.value.addEventListener("focus", ne), c.value = new ResizeObserver(y), c.value.observe(s.value), l.value = new MutationObserver(y), l.value.observe(s.value, {
				childList: !0,
				subtree: !0,
				attributes: !0,
				attributeFilter: ["focus-list", "focus-container"]
			}), u.value = new MutationObserver(y), u.value.observe(s.value, {
				attributes: !0,
				attributeFilter: ["tabindex"]
			}), y());
		}), xe(() => {
			o.value?.removeEventListener("blur", b), o.value?.removeEventListener("keyup", re), s.value?.removeEventListener("focus", ne), c.value?.disconnect(), l.value?.disconnect(), u.value?.disconnect();
		}), (t, r) => {
			let i = N("back"), a = N("panel-options-menu"), c = N("left"), l = N("right"), u = N("pin"), d = N("expand"), p = N("minimize"), g = N("close"), ee = P("truncate"), _ = P("focus-item"), v = P("tippy");
			return R((j(), E("div", {
				...
				e.header ? (j(), E("header", ui, [
					pe(i, {
						class: A(e.panel.teleport ? "display-none" : "block sm:display-none"),
						onClick: r[0] ||= (t) => e.panel.close()
					}, null, 8, ["class"]),
					R((j(), E("h2", di, [t.$slots.header ? De(t.$slots, "header", { key: 0 }) : (j(), E("div", fi, F(I(n)(e.panel.alertName)), 1))])), [[ee]]),
					t.$slots.controls ? (j(), w(a, { key: 0 }, {
						default: L(() => [De(t.$slots, "controls")]),
						_: 3
					})) : T("", !0),
					D("div", { class: A(e.panel.teleport ? "flex" : "display-none sm:flex") }, [
						e.panel.teleport ? T("", !0) : (j(), E("div", pi, [
							m.value ? (j(), w(c, {
								key: 0,
								onClick: r[1] ||= (e) => ie("left"),
								active: !e.panel.isLeftMostPanel
							}, null, 8, ["active"])) : T("", !0),
							m.value ? (j(), w(l, {
								key: 1,
								onClick: r[2] ||= (e) => ie("right"),
							...
							e.panel.controls && e.panel.controls.expand ? (j(), w(d, {
								key: 3,
								onClick: r[4] ||= (t) => e.panel.expand(),
								active: e.panel.expanded
							}, null, 8, ["active"])) : T("", !0)
						])),
						e.panel.button && f.value?.includes(e.panel.id) ? (j(), w(p, {
							key: 1,
							onClick: r[5] ||= (t) => e.panel.minimize()
						})) : T("", !0),
						pe(g, { onClick: r[6] ||= (t) => e.panel.close() })
					], 2)
				])) : T("", !0),
				e.content ? (j(), E("div", {
					key: 1,
					...
					ref: s,
					tabindex: "-1"
				}, [t.$slots.content ? De(t.$slots, "content", { key: 0 }) : ae.value ? (j(), E("div", {
					key: 1,
					innerHTML: ae.value.innerHTML
				}, null, 8, mi)) : T("", !0)], 512)) : T("", !0),
				e.footer ? R((j(), E("div", hi, [De(t.$slots, "footer")])), [[_]]) : T("", !0)
			], 8, li)), [[v, {
				trigger: "manual",
				touch: !1,
				onShow: x,
...
}), yi = { class: "relative" }, bi = ["content", "aria-label"], xi = ["transform"], Si = /* @__PURE__ */ O({
	__name: "pin",
	...
	setup(e) {
		...
		return (n, r) => {
			let i = P("tippy");
			return j(), E("div", yi, [R((j(), E("button", {
				type: "button",
			...
			}, [...r[0] ||= [D("path", { d: "M298.028 214.267L285.793 96H328c13.255 0 24-10.745 24-24V24c0-13.255-10.745-24-24-24H56C42.745 0 32 10.745 32 24v48c0 13.255 10.745 24 24 24h42.207L85.972 214.267C37.465 236.82 0 277.261 0 328c0 13.255 10.745 24 24 24h136v104.007c0 1.242.289 2.467.845 3.578l24 48c2.941 5.882 11.364 5.893 14.311 0l24-48a8.008 8.008 0 0 0 .845-3.578V352h136c13.255 0 24-10.745 24-24-.001-51.183-37.983-91.42-85.973-113.733z" }, null, -1)]], 8, xi))], 10, bi)), [[i, {
				placement: "bottom",
				hideOnClick: !1
			}]])]);
		};
	}
}), Ci = { class: "relative" }, wi = ["content", "aria-label"], Ti = /* @__PURE__ */ O({
	__name: "close",
	props: { active: Boolean },
	setup(e) {
		let { t } = z();
		return (n, r) => {
			let i = P("tippy");
			return j(), E("div", Ci, [R((j(), E("button", {
				type: "button",
				class: A(["text-gray-500 hover:text-black focus:text-black p-8", { "text-gray-700": e.active }]),
				...
				xmlns: "http://www.w3.org/2000/svg",
				viewBox: "0 0 352 512"
			}, [D("path", { d: "M242.72 256l100.07-100.07c12.28-12.28 12.28-32.19 0-44.48l-22.24-22.24c-12.28-12.28-32.19-12.28-44.48 0L176 189.28 75.93 89.21c-12.28-12.28-32.19-12.28-44.48 0L9.21 111.45c-12.28 12.28-12.28 32.19 0 44.48L109.28 256 9.21 356.07c-12.28 12.28-12.28 32.19 0 44.48l22.24 22.24c12.28 12.28 32.2 12.28 44.48 0L176 322.72l100.07 100.07c12.28 12.28 32.2 12.28 44.48 0l22.24-22.24c12.28-12.28 12.28-32.19 0-44.48L242.72 256z" })], -1)]], 10, wi)), [[i, {
				placement: "bottom",
				theme: "ramp4",
				animation: "scale"
			}]])]);
...
}), Ei = { class: "relative" }, Di = ["content", "aria-label"], Oi = /* @__PURE__ */ O({
	__name: "back",
	props: { active: Boolean },
	setup(e) {
		let { t } = z();
		return (n, r) => {
			let i = P("tippy");
			return j(), E("div", Ei, [R((j(), E("button", {
				type: "button",
				class: A(["text-gray-500 hover:text-black focus:text-black p-8", { "text-gray-700": e.active }]),
...
}), ki = { class: "w-32 h-32" }, Ai = ["content", "aria-label"], ji = {
	key: 0,
	xmlns: "http://www.w3.org/2000/svg",
	viewBox: "0 0 24 24",
	...
	setup(e) {
		...
		return (n, r) => {
			let i = P("tippy");
			return j(), E("div", ki, [R((j(), E("button", {
				type: "button",
				...
				D("path", { d: "M8 19h3v3h2v-3h3l-4-4-4 4zm8-15h-3V1h-2v3H8l4 4 4-4zM4 9v2h16V9H4z" }, null, -1),
				D("path", { d: "M4 12h16v2H4z" }, null, -1)
			]])) : (j(), E("svg", ji, [...r[0] ||= [
				D("path", {
					d: "M0 0h24v24H0z",
					fill: "none"
				...
				D("path", { d: "M4 20h16v2H4zM4 2h16v2H4zm9 7h3l-4-4-4 4h3v6H8l4 4 4-4h-3z" }, null, -1)
			]]))], 8, Ai)), [[i, {
				placement: "bottom",
				theme: "ramp4",
				animation: "scale",
...
}), Pi = { class: "relative" }, Fi = ["content", "aria-label"], Ii = /* @__PURE__ */ O({
	__name: "minimize",
	props: { active: Boolean },
	setup(e) {
		let { t } = z();
		return (n, r) => {
			let i = P("tippy");
			return j(), E("div", Pi, [R((j(), E("button", {
				type: "button",
				...
				d: "M0 0h24v24H0V0z",
				fill: "none"
			}), D("path", { d: "M6 19h12v2H6z" })], -1)]], 10, Fi)), [[i, {
				placement: "bottom",
				theme: "ramp4",
				animation: "scale"
			}]])]);
...
var Ri = { class: "relative" }, zi = ["content", "aria-label"], Bi = /* @__PURE__ */ O({
	__name: "right",
	props: { active: Boolean },
	setup(e) {
		let { t } = z(), n = e, r = M(null), { syncTooltipAfterKeyboardMove: i } = Li(r, () => !!n.active);
		return (n, a) => {
			let o = P("tippy");
			return j(), E("div", Ri, [R((j(), E("button", {
				ref_key: "buttonRef",
				ref: r,
				type: "button",
				class: A(["p-8", {
				...
				xmlns: "http://www.w3.org/2000/svg",
				viewBox: "4 4 16 16"
			}, [D("path", { d: "M 8.59 16.34 L 13.17 11.75 L 8.59 7.16 L 10 5.75 L 16 11.75 L 10 17.75 Z" })], -1)]], 10, zi)), [[o, {
				placement: "bottom",
				theme: "ramp4",
				animation: "scale"
			}]])]);
...
}), Vi = { class: "relative" }, Hi = ["content", "aria-label"], Ui = /* @__PURE__ */ O({
	__name: "left",
	props: { active: Boolean },
	setup(e) {
		let t = e, { t: n } = z(), r = M(null), { syncTooltipAfterKeyboardMove: i } = Li(r, () => !!t.active);
		return (t, a) => {
			let o = P("tippy");
			return j(), E("div", Vi, [R((j(), E("button", {
				ref_key: "buttonRef",
				ref: r,
				type: "button",
				...
				xmlns: "http://www.w3.org/2000/svg",
				viewBox: "4 4 16 16"
			}, [D("path", { d: "M 15.41 16.09 L 10.83 11.5 L 15.41 6.91 L 14 5.5 L 8 11.5 L 14 17.5 Z" })], -1)]], 10, Hi)), [[o, {
				placement: "bottom",
				theme: "ramp4",
				animation: "scale"
			}]])]);
	...
	setup(e) {
		...
		return (e, n) => (j(), w(fn, {
			...
			header: L(() => [...n[0] ||= [D("div", { class: "p-6" }, [D("svg", {
				xmlns: "http://www.w3.org/2000/svg",
				viewBox: "0 0 24 24",
				class: "fill-current w-20 h-20"
			}, [D("path", { d: "M12 8c1.1 0 2-.9 2-2s-.9-2-2-2-2 .9-2 2 .9 2 2 2zm0 2c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2zm0 6c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2z" })])], -1)]]),
			default: L(() => [De(e.$slots, "default", {}, void 0, !0)]),
			_: 3
		}, 8, ["tooltip"]));
	}
}), [["__scopeId", "data-v-51e22a4a"]]), Gi = {
	key: 0,
	xmlns: "http://www.w3.org/2000/svg",
	viewBox: "0 0 24 24",
	...
	setup(e) {
		...
		return (e, i) => {
			...
			return j(), w(a, {
				...
				default: L(() => [I(n).isFullscreen ? (j(), E("svg", Gi, [...i[0] ||= [D("path", {
					d: "M0 0h24v24H0z",
					fill: "none"
				}, null, -1), D("path", { d: "M5 16h3v3h2v-5H5v2zm3-8H5v2h5V5H8v3zm6 11h2v-3h3v-2h-5v5zm2-11V5h-2v5h5V8h-3z" }, null, -1)]])) : (j(), E("svg", Ki, [...i[1] ||= [D("path", {
					d: "M0 0h24v24H0z",
					fill: "none"
				}, null, -1), D("path", { d: "M7 14H5v5h5v-2H7v-3zm-2-4h2V7h3V5H5v5zm12 7h-3v2h5v-5h-2v3zM14 5v2h3v3h2V5h-5z" }, null, -1)]]))]),
				_: 1
			}, 8, ["tooltip"]);
		};
	}
		...
		return (e, n) => {
			...
			return j(), w(i, {
				...
				default: L(() => [...n[0] ||= [D("svg", {
					...
					viewBox: "0 0 24 24",
					class: "fill-current w-32 h-20"
				}, [D("path", { d: "M12 8c-2.21 0-4 1.79-4 4s1.79 4 4 4 4-1.79 4-4-1.79-4-4-4zm8.94 3c-.46-4.17-3.77-7.48-7.94-7.94V1h-2v2.06C6.83 3.52 3.52 6.83 3.06 11H1v2h2.06c.46 4.17 3.77 7.48 7.94 7.94V23h2v-2.06c4.17-.46 7.48-3.77 7.94-7.94H23v-2h-2.06zM12 19c-3.87 0-7-3.13-7-7s3.13-7 7-7 7 3.13 7 7-3.13 7-7 7z" })], -1)]]),
				_: 1
			}, 8, ["tooltip"]);
		};
	}
		...
		return (e, n) => {
			...
			return j(), w(i, {
				...
				default: L(() => [...n[0] ||= [D("svg", {
					...
					viewBox: "0 0 24 24",
					class: "fill-current w-32 h-20"
				}, [D("path", { d: "M10 20v-6h4v6h5v-8h3L12 3 2 12h3v8z" }), D("path", {
					d: "M0 0h24v24H0z",
					fill: "none"
				})], -1)]]),
				_: 1
	...
	setup(e) {
		return (t, n) => {
			...
			return j(), E("div", Xi, [R((j(), E("button", {
				type: "button",
			...
			}, [De(t.$slots, "default", {}, void 0, !0)], 10, Zi)), [[r], [i, { placement: "left" }]])]);
		};
	}
}), [["__scopeId", "data-v-bafb7e3d"]]), $i = {
	class: "relative",
	tabindex: "-1"
}, ea = ["aria-label", "content"], ta = /*#__PURE__*/ y(/* @__PURE__ */ O({
	__name: "button",
	props: {
		onClickFunction: {
			type: Function,
	...
	setup(e) {
		...
		return (t, n) => {
			...
			}, [De(t.$slots, "default", {}, void 0, !0)], 8, ea)), [[i], [a, {
				allowHTML: !0,
				placement: "right"
			}]])]);
		};
	}
}), [["__scopeId", "data-v-1cb84ae1"]]), na = S("areas-of-interest", () => ({ areas: M([]) })), ra = S("export", () => {
	let e = M({
		title: !0,
		map: !0,
		mapElements: !0,
	...
	fsaToProvince(e) {
		...
		return t = r === "X" ? n === "X0A" || n === "X0B" || n === "X0C" ? 62 : 61 : aa[r], this.codeToProvince(t);
	}
};
function ca(e) {
	return new sa(e);
	...
	constructor(e, t) {
		Je.get(t).then((t) => {
			t.data.definitions.forEach((t) => {
				la[e][t.code] = t.term.split(`${t.code}-`)[1];
			}), Object.keys(la[e]).forEach((t) => {
				this.allTypes[t] = la[e][t], this.validTypes[t] = la[e][t];
			}), this.typesFetched = !0;
		});
	}
	filterValidTypes(e) {
...
async function pa(e, t) {
	let n, r;
	return /^[-+]?([1-8]?\d(\.\d+)?|90(\.0+)?)(\s*[,|;\s]\s*)[-+]?(180(\.0+)?|((1[0-7]\d)|([1-9]?\d))(\.\d+)?)[*]$/.test(t) && !e.disabledSearchTypes.includes("LAT/LNG") ? (r = t.slice(0, -1), n = new fa(e, r), await Sa(n)) : /^[ABCEGHJKLMNPRSTVXY]\d[A-Z]/.test(t) && !e.disabledSearchTypes.includes("FSA") ? (r = t.substring(0, 3).toUpperCase(), n = new fa(e, r), await Ca(n)) : /^\d{2,3}[A-P]/.test(t) && !e.disabledSearchTypes.includes("NTS") ? (r = t.substring(0, 6).toUpperCase(), n = new fa(e, r), await wa(n)) : (r = encodeURIComponent(t.trim()), n = new fa(e, r), await Ta(n)), e.customSources.length && await va(n, e.customSources), n;
}
var ma = async (e) => {
...
}, _a = (e, t) => t.filter((t) => e.types.validTypes[t.concise.code]).map((t) => ({
	name: t.name,
	flav: "nme",
	bbox: t.bbox,
	...
	let [t, n] = await Ye(ma(ga(e, !0)));
	return t ? (console.error("Geolocation service failed"), e.failedServs.push("geolocation"), []) : n;
}, ba = async (e) => {
	let [t, n] = await Ye(ma(ga(e, !1))), r;
	t ? (console.error("GeoName service targeting Name failed"), e.failedServs.push("geoname"), r = []) : r = n.items, e.addResult(_a(e.config, r));
}, xa = async (e, t, n) => {
	let [r, i] = await Ye(ma(ga(e, !1, t, n))), a;
	r ? (console.error("GeoName service targeting Lat Lon failed"), e.failedServs.push("geoname"), a = []) : a = i.items, e.addResult(_a(e.config, a));
}, Sa = async (e) => {
	...
	await xa(e, n, r), e.addResult(i);
}, Ca = async (e) => {
	let t = e.config, n = await ya(e);
	if (n.length) {
	...
	let t = e.config;
	if (await ba(e), t.categories.length === 0 || t.categories.includes("ADDR")) {
		let n = await ya(e), r = t.sortOrder.indexOf("ADDR"), i = r >= 0 ? r : t.sortOrder.length, a = n.filter((e) => e.type?.includes("Street")).map((e) => {
...
}, Ea = "~FSA~", Da = "https://geogratis.gc.ca/services/geolocation/@{language}/locate", Oa = "https://geogratis.gc.ca/services/geoname/@{language}/geonames.json", ka = "https://geogratis.gc.ca/services/geoname/@{language}/codes/province.json", Aa = "https://geogratis.gc.ca/services/geoname/@{language}/codes/concise.json", ja = class {
	config;
	constructor(e, t) {
		let n, r, i, a, o = t?.serviceUrls;
		o ? (n = o.geoLocation ? o.geoLocation : Da, r = o.geoNames ? o.geoNames : Oa, i = o.geoProvince ? o.geoProvince : ka, a = o.geoTypes ? o.geoTypes : Aa) : (n = Da, r = Oa, i = ka, a = Aa), n = n.replace("@{language}", e), r = r.replace("@{language}", e), i = i.replace("@{language}", e), a = a.replace("@{language}", e);
		let s = "", c = t?.fsaBoundaries;
		if (c && c.serviceUrl) {
			let e = c.keyField || "CFSAUID";
			s = `${c.serviceUrl}/query/?where=${e}%3D'${Ea}'&outFields=${e}&returnGeometry=true&f=json`;
		}
		...
		l ? (u = l.categories ? l.categories : [], d = l.sortOrder ? l.sortOrder : [], f = l.disabledSearchTypes ? l.disabledSearchTypes : [], p = l.maxResults > 0 ? l.maxResults : 100, m = !!l.officialOnly) : (u = [], d = [], f = [], p = 100, m = !1), h = t?.customSources ?? [], h = h.map((e) => ({
			...e,
			onSearch: async (t) => {
				let n = e.data ?? [], r = Na(), i = decodeURIComponent(r.cleanVal(t)).replace("*", "");
	...
	async query(e) {
		let t = await pa(this.config, e.toUpperCase()), n = this.config.sortOrder.length, r = t.results.filter((e) => e.order < n), i = t.results.filter((e) => e.order >= n);
...
var Na = S("geosearch", () => {
	let e = M(new ja("en", void 0)), t = M({
		type: "",
		province: "",
		extent: void 0
	}), n = M(!1), r = M(""), i = M(""), a = M(""), o = M([]), s = M([]), c = M(!1), l = M([]), u = C(() => e.value.fetchProvinces().then((e) => (e.sort((e, t) => e.name.localeCompare(t.name, void 0, { sensitivity: "case" })), e))), d = C(() => new Promise((t) => {
		...
		if (!u) o.value = [], s.value = [], c.value = !1;
			...
			let r = setInterval(() => {
				e.value.config.provinces.listFetched && e.value.config.types.typesFetched && (clearInterval(r), e.value.query(`${u}*`).then((e) => {
					...
					let r = Ma(n.value, t.value, s.value);
					o.value = r || [], c.value = !1;
				}));
			}, 250);
		} else {
			let e = Ma(n.value, t.value, s.value);
			o.value = e || [], c.value = !1;
		}
	}
	function h(e) {
	...
	toggleVisibility(e, t = !0) {
		if (this.visibility !== e) {
			...
			else if (this.visibility) if (this._lastVisible && (!(this._lastVisible instanceof La) || this._lastVisible.layerControlAvailable(J.Visibility))) this._lastVisible.toggleVisibility(!0);
			else {
				let e = this.children.find((e) => !(e instanceof La) || e.layerControlAvailable(J.Visibility));
	...
	checkVisibility(e) {
		this instanceof La && !this.layerControlAvailable(J.Visibility) || (this.exclusive ? e.visibility ? (this.children.forEach((t) => {
			t.uid !== e.uid && t.toggleVisibility(!1, !1);
		}), this._lastVisible = e, this._visibility = !0, this instanceof La && this.layer && this.layer.layerExists && (this.layer.visibility = !0)) : (this._visibility = !1, this instanceof La && this.layer && this.layer.layerExists && (this.layer.visibility = !1), this._lastVisible = e) : this.children.some((e) => e.visibility) ? (this._visibility = !0, this._visibleChildren = this.children.filter((e) => e.visibility), this instanceof La && this.layer && this.layer.layerExists && (this.layer.visibility = !0)) : (this._visibility = !1, this._visibleChildren = [], this instanceof La && this.layer && this.layer.layerExists && (this.layer.visibility = !1)), this.parent && this.parent.checkVisibility(this));
	}
	getConfig() {
		let e = {
			name: this._name,
	...
	load(e) {
		...
		t && (this.layer = t, this._layerRedrawing = t.mapLayer && t.drawState !== lt.UP_TO_DATE, t.loadPromise().then(() => {
			this._layerInitVis = this._layerInitVis === void 0 ? t.visibility : this._visibility, super.load(), this.toggleVisibility(this._layerInitVis, !0, !0), t.visibility || this.setSymbologyVisibility(void 0, !1), this.handlers.push(this.$iApi.event.on($.LAYER_VISIBILITYCHANGE, (e) => {
				e.layer.uid === this.layer.uid && this._type === Fa.Item && this.toggleVisibility(e.visibility, !0, !0);
	...
	_content;
	constructor(e, t, n) {
		super(e, t, n), this._infoType = t.infoType ?? "title", this._content = t.content ?? "", t.infoType === "template" && this.$element.component(`${this._uid}-info-section`, { template: this._content }), (t.infoType || t.content) && (this._controls = t.controls?.slice() ?? [Pa.Expand]), super.load();
	}
	get infoType() {
	...
	function a(e) {
		if (e.parent === void 0) t.value.push(e.item);
			...
			if (!(e.item instanceof za) && !(e.item instanceof La)) {
	...
	function o(e) {
		...
		}), t = t.filter((e) => !(e instanceof za && !e.children.length && e.content === "")), t);
		t.value = n(t.value);
	}
	function s(e) {
	...
	function c(t) {
		switch (s.value) {
			case qa.UPLOAD:
				t === qa.UPLOAD ? n.value = "" : t === qa.FORMAT && (s.value = qa.FORMAT);
				break;
			case qa.FORMAT:
				t === qa.UPLOAD ? (a.value &&= (n.value = "", null), r.value = "", s.value = qa.UPLOAD) : t === qa.CONFIGURE && (s.value = qa.CONFIGURE);
				break;
			case qa.CONFIGURE:
				t === qa.UPLOAD ? (n.value = "", r.value = "", a.value = null, i.value = !0, o.value = {
					config: e,
					configOptions: []
				}, s.value = qa.UPLOAD) : t === qa.FORMAT && (o.value = {
					config: e,
					configOptions: []
				}, i.value = !0, s.value = qa.FORMAT);
				break;
		}
	}
	return {
	...
	constructor(e, t, n) {
		...
		this.$vApp = r.app, this.$element = r.element, this.$i18n = r.i18n, this.$rootEl = r.app.$root?.$el, this.fixture = new us(this), this.panel = new fs(this), this.geo = new ss(this), this.dev = new ys(this), this.ui = {
			...
			escapeHtml: () => "",
			isPlainText: () => !0
		}, this.notify = new yn(this), this._isFullscreen = ze.isEnabled && !!this.$vApp.$root && ze.isFullscreen && ze.element === this.$vApp.$root.$el, ze.isEnabled && ze.onchange(() => {
			this._isFullscreen = ze.isEnabled && !!this.$vApp.$root && ze.isFullscreen && ze.element === this.$vApp.$root.$el;
		}), this.initialize(!0, t, n);
	}
	initialize(e, t, n) {
		let r = v(this.$vApp.$pinia), i = ln(this.$vApp.$pinia), a = nn(this.$vApp.$pinia);
		if (t?.configs !== void 0) {
	...
	reloadWorker(e, t) {
		let n = Cr(this.$vApp.$pinia), r = pn(this.$vApp.$pinia), i = v(this.$vApp.$pinia), a = qt(this.$vApp.$pinia), o = _(this.$vApp.$pinia), s = Ut(this.$vApp.$pinia), c = !!e;
	...
	useStore(e) {
		if (!([
			...
			case "areas-of-interest": return na(this.$vApp.$pinia);
			case "details": return Kt(this.$vApp.$pinia);
			case "export": return ra(this.$vApp.$pinia);
			case "extentguard": return ia(this.$vApp.$pinia);
			case "geosearch": return Na(this.$vApp.$pinia);
			case "grid": return Ut(this.$vApp.$pinia);
			case "help": return ne(this.$vApp.$pinia);
			case "keyboardnav": return er(this.$vApp.$pinia);
			case "legend": return Ba(this.$vApp.$pinia);
			case "mapnav": return Va(this.$vApp.$pinia);
			case "metadata": return Ha(this.$vApp.$pinia);
			case "northarrow": return Ua(this.$vApp.$pinia);
			case "overviewmap": return Wa(this.$vApp.$pinia);
			case "panguard": return Ga(this.$vApp.$pinia);
			case "scrollguard": return Ka(this.$vApp.$pinia);
	...
	setLanguage(e) {
		...
		let t = v(this.$vApp.$pinia), n = pn(this.$vApp.$pinia), r = t.registeredLangs;
...
function Xa(e, t) {
	...
	let r = tn(), i = de(Mr).use(r).use(We, {
		directive: "tippy",
		component: "tippy"
	}).use(n);
	return i.directive("focus-container", ti), i.directive("focus-list", Vr), i.directive("focus-item", Gr), i.directive("truncate", ai), i.component("panel-screen", vi), i.component("pin", Si), i.component("close", Ti), i.component("back", Oi), i.component("expand", Ni), i.component("panel-options-menu", Wi), i.component("dropdown-menu", fn), i.component("minimize", Ii), i.component("right", Bi), i.component("left", Ui), i.component("fullscreen-nav-button", qi), i.component("geolocator-nav-button", Ji), i.component("home-nav-button", Yi), i.component("mapnav-button", Qi), i.component("appbar-button", ta), i.component("transition", le), i.component("transition-group", ue), i.config.globalProperties.$iApi = t, i.config.globalProperties.$pinia = n, i.config.idPrefix = `ramp-${e.id || Is.sharedUtils.generateUUID()}`, i.provide("iApi", t), {
		element: i,
		app: i.mount(e),
		i18n: r.global
	};
...
var Za = class e {
	...
	constructor(e) {
		super(e, "overview"), this.overviewGraphicLayer = this.$iApi.geo.layer.createLayer({
			...
			cosmetic: !0,
			system: !0
		}), this.overviewmapStore = Wa(this.$vApp.$pinia);
	}
	async createMapView(e) {
...
var lo = class extends Q {
	...
	async loadWfsData(e, t = -1, n = 0, r = 1e3, i = {
		...
		let c = new Nt(e).updateQuery(s), [l, u] = await Ye(Je.get(c, { signal: o }));
	...
	constructor(e, t) {
		super(e, t), this.name = e.name || "", this.geomType = B.NONE, this.dataFormat = H.UNKNOWN, this.layerType = V.UNKNOWN, this.layerFormat = ct.UNKNOWN;
		...
		this.expectedTime.draw = e.expectedDrawTime ?? n.draw, this.expectedTime.load = e.expectedLoadTime ?? n.load, this.expectedTime.fail = e.maxLoadTime || n.fail, this.lastCancel = 0, this.timers = {
			draw: void 0,
			load: void 0
		}, this.origRampConfig = e, this.id = e.id || "", this.uid = this.$iApi.geo.shared.generateUUID(), this.isCosmetic = !1, this.isSystem = e.system || !1, this.isRemoved = !1, this.isSublayer = !1, this.supportsIdentify = !1, this.mapLayer = !0, this.identifyMode = W.NONE, this.supportsFeatures = !1, this.maptips = !1, this.supportsSublayers = !1, this.isFile = !1, this.layerState = K.NEW, this.initiationState = G.NEW, this.drawState = lt.NOT_LOADED, this.loadDefProm = new Z(), this.url = this.origRampConfig.url, this.canReload = !!(this.url || this.origRampConfig.caching), this.loadPromDone = !1, this.nameArcadeFormula = "", this.maptipArcadeFormula = "", this.layerTree = new Ot(0, this.uid, this.name, !0);
	}
	updateInitiationState(e) {
	...
	updateDrawState(e) {
		this.drawState = e, e === lt.REFRESH ? this.startTimer("draw") : e === lt.UP_TO_DATE && this.stopTimer("draw"), this.$iApi.event.emit($.LAYER_DRAWSTATECHANGE, {
			state: e,
			layer: this
		});
	}
	async initiate() {
		...
		clearTimeout(n), t > this.lastCancel && (this.drawState !== lt.UP_TO_DATE && this.startTimer("draw"), r ? e(`Init error on layer id: ${this.id} . ${r.message}`) : this.updateInitiationState(G.INITIATED));
	}
	async onInitiate() {
	...
	async terminate() {
		this.updateInitiationState(G.TERMINATING), await Promise.all(this.sublayers.map((e) => e.terminate())), this.loadDefProm = new Z(), this.loadPromDone = !1, this.updateLayerState(K.NEW), this.updateDrawState(lt.NOT_LOADED), this.updateInitiationState(G.TERMINATED);
	}
	onLoad() {
	...
	onError(e = !0) {
		this.layerState !== K.ERROR && (this.initiationState === G.INITIATING && this.updateInitiationState(G.NEW), this.loadPromDone && (this.loadDefProm = new Z()), this.loadDefProm.rejectMe(), this.loadPromDone = !0, this.sublayers.forEach((t) => t.onError(e)), e && this.$iApi.notify.show(vn.ERROR, this.$iApi.$i18n.t("layer.error", { id: this.id })), this.stopTimer("draw"), this.stopTimer("load"), this.updateLayerState(K.ERROR, !e));
	}
	onLoadActions() {
		return [];
	}
	...
	filter;
	constructor(e, t) {
		super(e, t), this.supportsIdentify = !0, this.geomType = B.UNKNOWN, this.serviceUrl = "", this.fieldList = "", this.canModifyLayer = !0, this.filter = new At(e.permanentFilteredQuery || "", e.initialFilteredQuery || ""), e.state?.hovertips !== void 0 && console.warn("hovertips layer configuration property is deprecated. Please adjust to use maptips instead"), this.maptips = e.state?.maptips ?? e.state?.hovertips ?? !0, this.attribs = new Go();
	}
	makeEsriLayerConfig(e) {
	...
	constructor(e, t) {
		super(e, t), this.dataFormat = H.ESRI_FEATURE, this.layerFormat = ct.GRAPHIC, this.maptips = !1;
	}
	_graphics = [];
	makeEsriLayerConfig(e) {
		return super.makeEsriLayerConfig(e);
	...
	sourceGeoJson;
	constructor(e, t) {
		super(e, t), this.supportsIdentify = !0, this.isFile = !0, this.dataFormat = H.ESRI_FEATURE, this.layerFormat = ct.FEATURE, this.layerIdx = 0, e.identifyMode && e.identifyMode !== W.NONE ? this.identifyMode = e.identifyMode : this.identifyMode = W.HYBRID;
	}
	async reload() {
	...
	runIdentify(e) {
		...
		return e.hitTest && (this.identifyMode === W.HYBRID || this.identifyMode === W.SYMBOLIC) && (r = i.then(async () => {
			...
			a.forEach((e) => {
				n.items.push(po.makeRawItem(ut.ESRI, e.attributes));
			}), o.forEach((e) => {
	...
	constructor(e, t) {
		super(e, t), this.dataFormat = H.ESRI_FEATURE, this.supportsIdentify = !0, this.layerType = V.FEATURE, this.layerFormat = ct.FEATURE, e.identifyMode && e.identifyMode !== W.NONE ? this.identifyMode = e.identifyMode : this.identifyMode = W.HYBRID;
	}
	async onInitiate() {
	...
	origState;
	constructor(e, t) {
		super(e, t), this.supportsIdentify = !0, this.supportsSublayers = !0, this.layerType = V.MAPIMAGE, this.layerFormat = ct.MAPIMAGE, this.isDynamic = !1, this.maptips = !1, this.layerTree.layerIdx = -1, this.identifyMode = W.GEOMETRIC;
	}
	actualViz = !1;
	get visibility() {
	...
	set visibility(e) {
		...
		if (e || Ao(this, "1=2"), this.actualViz = e, e && !this.esriLayer.visible) this.esriLayer.visible = !0;
			...
			e = this.$iApi.event.on($.LAYER_DRAWSTATECHANGE, (n) => {
				n.layer.id === this.id && n.state === lt.UP_TO_DATE && (clearTimeout(t), this.$iApi.event.off(e), this.actualViz || (this.esriLayer.visible = !1, Ao(this, "")));
			});
		}
		e && Ao(this, "");
	}
	...
	constructor(e, t, n) {
		if (super(e, t), this.layerType = V.SUBLAYER, this.layerFormat = ct.MAPIMAGE, this.isSublayer = !0, this.layerIdx = e.index, this.parentLayer = n, this.isSystem = n.isSystem, this.dataFormat = H.ESRI_FEATURE, this.supportsFeatures = !0, this.maptips = !1, this.url = this.parentLayer?.url, this.canReload = !0, !n.esriLayer) throw Error("Map Image Layer with no internal esri layer encountered in sublayer creation");
	...
	constructor(e, t) {
		super(e, t), this.supportsIdentify = !1, this.layerType = V.OSM, this.layerFormat = ct.OSM, this.dataFormat = H.OSM_TILE, this.supportsFeatures = !1;
	}
	async onInitiate() {
	...
	constructor(e, t) {
		super(e, t), this.supportsIdentify = !1, this.layerType = V.IMAGERY, this.layerFormat = ct.IMAGERY, this.dataFormat = H.ESRI_RASTER;
	}
	async onInitiate() {
	...
	async checkProj() {
		...
		if (this.layerState === K.LOADED && !t) n(), this.onError(), this.updateDrawState(lt.NOT_LOADED);
		else if (this.layerState === K.ERROR && t) this.reload();
		else if (this.layerState !== K.ERROR && !t) return n(), Promise.reject();
	}
}, Fo = class extends Po {
	constructor(e, t) {
		super(e, t), this.layerType = V.IMAGERYTILE, this.layerFormat = ct.IMAGERYTILE, this.schemaLocked = !1;
	}
	async onInitiate() {
	...
	constructor(e, t) {
		super(e, t), this.layerType = V.TILE, this.layerFormat = ct.TILE;
	}
	async onInitiate() {
	...
	constructor(e, t) {
		super(e, t), this.layerType = V.VECTORTILE, this.layerFormat = ct.VECTORTILE;
	}
	async onInitiate() {
	...
	mimeType;
	constructor(e, t) {
		super(e, t), this.supportsIdentify = !0, this.layerType = V.WMS, this.layerFormat = ct.WMS, this.mimeType = e.featureInfoMimeType || "", this.sublayerNames = [], this.dataFormat = H.OGC_RASTER, this.identifyMode = W.GEOMETRIC;
	}
	async onInitiate() {
	...
	runIdentify(e) {
		...
		return this.getFeatureInfo(this.sublayerNames, e.geometry, this.mimeType).then((e) => {
			if (e) {
				let t = !0, r;
				typeof e == "string" ? e.indexOf("Search returned no results") === -1 && e !== "" ? r = ut.TEXT : (t = !1, r = ut.UNKNOWN) : r = ut.JSON, t && n.items.push(po.makeRawItem(r, e));
			}
			n.loaded = !0, t.resolveMe();
		}).catch(() => {
			n.errored = !0, t.resolveMe();
	...
	_visibility;
	constructor(e, t) {
		super(e, t), this.dataFormat = H.ESRI_FEATURE, this.layerFormat = ct.NOLAYER, this.drawState = lt.NOT_VISUAL, this.attribs = new Go(), this.supportsFeatures = !0, this.mapLayer = !1, this.isFile = !1, this._visibility = e.state?.visibility ?? !0, this.expectedTime.draw = 0;
	}
	async onInitiate() {
		if (this.sourceJson) {
	...
	serviceUrl;
	constructor(e, t) {
		super(e, t), this.layerType = V.DATATABLE, this.serviceUrl = e.url, this.filter = new At(e.permanentFilteredQuery || "", e.initialFilteredQuery || "");
	}
	async onInitiate() {}
	onLoadActions() {
	...
	symbology;
	constructor(e) {
		super(e), this.geom = Is.geom, this.proj = Is.proj, this.shared = Is.sharedUtils, this.map = new no(e), this.layer = new mo(e), this.attributes = new Wo(e), this.query = new os(e), this.symbology = new as(e), Array.isArray(p.request.interceptors) || (p.request.interceptors = []), p.request.interceptors.push({ before: (e) => {
	...
	async getGeolocation(e = !1) {
		let t = (e) => new Promise((t, n) => navigator.geolocation.getCurrentPosition(t, n, e)), n = () => ({
			success: !0,
			coord: new X("geolocation", this.glCoord, Y.latLongSR(), !0)
		}), r;
		if (this.glCoord.length) r = n();
			...
			if (!i || typeof i == "string") {
				let t = i || "internal";
				e || this.$iApi.notify.show(vn.ERROR, this.$iApi.$i18n.t("mapnav.geolocator.error." + t)), r = {
					success: !1,
					error: t
				};
			} else this.glCoord = [i.coords.longitude, i.coords.latitude], r = n();
		}
		return this.$iApi.event.emit($.MAP_GEOLOCATE, r), r;
	}
}, cs = /* #__PURE__ */ Object.assign({
	"../fixtures/appbar/index.ts": () => import("./appbar-zBWLf7aB.js"),
	"../fixtures/areas-of-interest/index.ts": () => import("./areas-of-interest-D0Ba9CLZ.js"),
	"../fixtures/basemap/index.ts": () => import("./basemap-B_XKhmqx.js"),
	"../fixtures/crosshairs/index.ts": () => import("./crosshairs-BO4nItJZ.js"),
	"../fixtures/details/index.ts": () => import("./details-Bqmth057.js"),
	"../fixtures/draw/index.ts": () => import("./draw-afcIkfFZ.js"),
	"../fixtures/export/index.ts": () => import("./export-CvqhNPlw.js"),
	"../fixtures/export-footnote/index.ts": () => import("./export-footnote-Yb3loIt1.js"),
	"../fixtures/export-legend/index.ts": () => import("./export-legend-lUar7mms.js"),
	"../fixtures/export-map/index.ts": () => import("./export-map-Bpi3gqcJ.js"),
	"../fixtures/export-northarrow/index.ts": () => import("./export-northarrow-CB6VjAZf.js"),
	"../fixtures/export-scalebar/index.ts": () => import("./export-scalebar-CxwrCyd_.js"),
	"../fixtures/export-timestamp/index.ts": () => import("./export-timestamp-fvgRHkb2.js"),
	"../fixtures/export-title/index.ts": () => import("./export-title-COueaahn.js"),
	"../fixtures/extentguard/index.ts": () => import("./extentguard-l3WARhhn.js"),
	"../fixtures/gazebo/index.ts": () => import("./gazebo-B-H-TiUD.js"),
	"../fixtures/geosearch/index.ts": () => import("./geosearch-aN99v4VS.js"),
	"../fixtures/grid/index.ts": () => import("./grid-rBqeR63X.js"),
	"../fixtures/help/index.ts": () => import("./help-D_nR05SI.js"),
	"../fixtures/hilight/index.ts": () => import("./hilight-1dBBLK13.js"),
	"../fixtures/keyboardnav/index.ts": () => import("./keyboardnav-CZAq_JKE.js"),
	"../fixtures/layer-reorder/index.ts": () => import("./layer-reorder-CwDeIfGH.js"),
	"../fixtures/legend/index.ts": () => import("./legend-Crvnmeo2.js"),
	"../fixtures/mapnav/index.ts": () => import("./mapnav-BewLDmnD.js"),
	"../fixtures/metadata/index.ts": () => import("./metadata-clpJ3e1T.js"),
	"../fixtures/northarrow/index.ts": () => import("./northarrow-BUptMW-Z.js"),
	"../fixtures/overviewmap/index.ts": () => import("./overviewmap-b8EYRf90.js"),
	"../fixtures/panguard/index.ts": () => import("./panguard-BVfVq_Ko.js"),
	"../fixtures/pindrop/index.ts": () => import("./pindrop-Cx3Ch89v.js"),
	"../fixtures/scrollguard/index.ts": () => import("./scrollguard-DSd5FdrT.js"),
	"../fixtures/settings/index.ts": () => import("./settings-bBTdkrnG.js"),
	"../fixtures/snowman/index.ts": () => import("./snowman-DLDhE2x1.js"),
	"../fixtures/swipe/index.ts": () => import("./swipe-bdaeGIVT.js"),
	"../fixtures/wizard/index.ts": () => import("./wizard-1Z1v3gO-.js")
}), ls = (e) => e === ds || e.prototype instanceof ds, us = class extends Q {
	constructor(e) {
		super(e);
	}
	exists(e) {
	...
	async add(e, t) {
		...
		return qt(this.$vApp.$pinia).addFixture(n), this.$iApi.event.emit($.FIXTURE_ADDED, n), this.$iApi.geo.map.created && n.initialized?.(), n;
	}
	remove(e) {
		let t = this.get(e);
		if (!t) throw Error(`Could not find fixture ${e} for removal`);
		return qt(this.$vApp.$pinia).removeFixture(t), this.$iApi.event.emit($.FIXTURE_REMOVED, t), t;
	}
	flush() {
...
function hs(e, t) {
	...
	return j(), w(n, {
		...
		content: L(() => [...t[0] ||= [D("div", { class: "loader" }, null, -1)]]),
		_: 1
	});
}
var gs = /*#__PURE__*/ y(ms, [["render", hs], ["__scopeId", "data-v-a3c61802"]]), _s = /* #__PURE__ */ Object.assign({
	"../fixtures/areas-of-interest/screen.vue": () => import("./screen-B0T6jFES.js"),
	"../fixtures/basemap/screen.vue": () => import("./screen-xleFbhnm.js"),
	"../fixtures/export/screen.vue": () => import("./screen-DE2ND3iV.js"),
	"../fixtures/geosearch/screen.vue": () => import("./screen-RWOOw6VX.js"),
	"../fixtures/grid/screen.vue": () => import("./screen-IGOwM0vS.js"),
	"../fixtures/help/screen.vue": () => import("./screen-Bqf9r587.js"),
	"../fixtures/layer-reorder/screen.vue": () => import("./screen-jgdhTkCK.js"),
	"../fixtures/legend/screen.vue": () => import("./screen-BK6deKdY.js"),
	"../fixtures/metadata/screen.vue": () => import("./screen-DtNF4C4c.js"),
	"../fixtures/settings/screen.vue": () => import("./screen-DG_aG4bl.js"),
	"../fixtures/wizard/screen.vue": () => import("./screen-jC9VeEA1.js")
}), vs = class extends Q {
	id;
	screens;
	loadedScreens = [];
...
console.info(`RAMP v${{
	...
	minor: "23",
	patch: "0-beta",
	timestamp: "Mon Aug 31 11:48:04 2026 -0400",
	hash: "3e8acbde4f060bd6b1f02b240a87c4569fd8128f"
}.major}.${{
	major: "4",
	minor: "23",
	patch: "0-beta",
...
var Fs = (e, t, n) => new Ya(e, t, n), Is = new It();
//#endregion
export { X as $, Ea as A, ln as B, Ra as C, Ia as D, Pa as E, er as F, Ht as G, Kt as H, $n as I, Nt as J, Vt as K, Qn as L, ia as M, ra as N, Fa as O, na as P, yt as Q, vn as R, Ba as S, La as T, Gt as U, $ as V, Ut as W, wt as X, Z as Y, xt as Z, Ga as _, Ms as a, ut as at, Ha as b, Io as c, K as ct, ho as d, Y as et, po as f, Ka as g, qa as h, Ps as i, B as it, ma as j, Na as k, bo as l, V as lt, Ja as m, Fs as n, q as nt, vs as o, G as ot, eo as p, Q as q, Is as r, et as rt, ds as s, J as st, Ns as t, dt as tt, yo as u, tt as ut, Wa as v, za as w, Va as x, Ua as y, pn as z };
