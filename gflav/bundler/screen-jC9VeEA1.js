import { V as e, ct as t, h as n, lt as r, m as i } from "./main-BroUV1vr.js";
...
var O = { class: "flex justify-end mb-20" }, fe = ["disabled", "animation"], pe = { class: "button-text" }, k = /*#__PURE__*/ a(/* @__PURE__ */ m({
	...
	setup(a) {
		let s = i(), { t: m } = ue(), _ = te("iApi"), b = y(), se = ce(), w = y([]), T = c(() => s.layerSource), D = c(() => s.currStep), O = y(null), fe = y(), pe = y(0), A = y(!1), j = y(), M = C("stepOneStart"), N = C("stepTwoStart"), P = C("stepThreeStart"), F = y(!1), I = y(!1), L = y(!1), R = y(!1), z = y(!1), B = y(!1), V = y(!0), Te = y(""), H = y(""), U = y([]), W = v([
			{
				value: r.FEATURE,
		...
		ie(() => ((D.value === n.FORMAT || D.value === n.CONFIGURE) && (F.value = !0, s.goToStep(n.FORMAT)), !1)), ae(() => {
			w.value.push(_.event.on(e.LAYER_LAYERSTATECHANGE, (e) => {
				e.layer.userAdded && (Te.value = e.layer.name, B.value = e.state !== t.LOADING && e.state !== t.NEW, V.value = B.value && e.state === t.LOADED);
		...
		let ke = async (e) => {
			...
			let t = J.value === r.FEATURE && !(Y.value && Y.value.fields);
			if (!Y.value || t) {
				F.value = !0, Y.value = {
					config: {
						id: "Placeholder",
			...
			let t = Y.value?.config.sublayers, n = t ? e && t.length > 0 : e.trim();
			R.value = !!n;
		}, Re = (e) => {
			Y.value.config.sublayers = e, R.value = !!(e.length > 0 && Y.value?.config.name);
		}, ze = (e) => {
			if (s.nested = e, U.value = [], pe.value += 1, J.value === r.MAPIMAGE) {
