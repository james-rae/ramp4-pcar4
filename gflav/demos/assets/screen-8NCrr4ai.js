import{A as e,F as t,H as n,N as r,Ot as i,R as a,Y as o,Z as s,dt as c,et as l,f as u,it as d,j as f,k as p,o as m,ut as h,vt as g,wt as _,yt as v}from"./store-DqDAc_Fp.js";import{P as y,R as b,U as x,v as S}from"./main-Cn8wi5-8.js";import{t as C}from"./marked.esm-B3aplK7b.js";u();var w=`<?xml version="1.0" encoding="UTF-8"?>
...
`,O={key:0},k={class:`flex justify-center`},A={key:0,class:`flex flex-col justify-center text-center`},j=[`innerHTML`],M=[`innerHTML`],N={key:3,class:`flex flex-col justify-center text-center`},P={class:`text-xl mt-20`},F={key:1,class:`p-5`},I=a({__name:`screen`,props:{panel:{type:Object,required:!0},payload:{type:Object,required:!0}},setup(a){let u=S(),{t:I}=m(),L=n(`iApi`),R=v(),z=a,B=p(()=>u.status),V=p(()=>u.response),H=v(!1),U=g({}),W=g([]),G=g([]);s(()=>{u.status=`loading`,K(),W.push(L.event.on(x.LAYER_REMOVE,e=>{z.payload.layer?.uid===e.uid&&z.panel.close()})),G.push(h(()=>z.payload.layer.uid,(e,t)=>{e!==t&&(u.status=`loading`,K())}))}),o(()=>{W.forEach(e=>L.event.off(e)),G.forEach(e=>e())});let K=async()=>{if(H.value=z.payload.layer!==void 0&&!z.payload.layer.isRemoved,H.value){if(z.payload.type===`xml`){let e=await q(z.payload.url,[]);if(u.status=`success`,e?.firstElementChild){let t=document.createElement(`div`);t.appendChild(X(`${e.firstElementChild.outerHTML}`)),(z.payload.catalogueUrl||z.payload.url)&&t.appendChild(X(`<h5 class="text-xl font-bold mb-3">${I(`metadata.xslt.metadata`)}</h5>`)),z.payload.catalogueUrl&&t.appendChild(X(`<p><a style="color: blue;" href="${z.payload.catalogueUrl}" target="_blank">${I(`metadata.xslt.cataloguePage`)}</a></p>`)),t.appendChild(X(`<p><a style="color: blue;" href="${z.payload.url}" target="_blank">${I(`metadata.xslt.metadataPage`)}</a> (xml)</p>`)),u.response=t.outerHTML}}else if(z.payload.type===`html`){let e=await Y(z.payload.url);u.status=e.status,u.response=e.response}else if(z.payload.type===`md`){let e=await Y(z.payload.url);u.status=e.status,u.response=C(e.response,{async:!1})}}},q=async(e,t)=>{let n;if(n=z.payload.xmlType&&z.payload.xmlType===`DCAT`?L.language===`en`?E:D:L.language===`en`?w:T,n=n.replace(/\{\{([\w.]+)\}\}/g,(e,t)=>I(t)),!U[e]){let t=await Y(e);if(t.status===`error`){let e=t.reason?I(`metadata.notification.rawFallbackWithReason`,{reason:t.reason}):I(`metadata.notification.rawFallback`);L.notify.show(b.WARNING,e)}U[e]=t.response}return J(U[e],n,t)},J=(e,t,n)=>{let r=null;if(window.XSLTProcessor){let i=new window.XSLTProcessor,a=new DOMParser,o=a.parseFromString(e,`text/xml`),s=a.parseFromString(t,`text/xml`);i.importStylesheet(s),n&&n.forEach(e=>i.setParameter(``,e.key,e.value||``)),r=i.transformToFragment(o,document);let c={className:`underline text-blue-700 break-all`,target:`_blank`,validate:{url:e=>/^https?:\/\//.test(e)}},l=r.firstElementChild;l&&(z.payload.treatXmlAsMarkdown?l.innerHTML=C.parse(l.innerHTML,{async:!1}):l.innerHTML=y(l.innerHTML,c))}return r},Y=e=>new Promise(t=>{let n=new XMLHttpRequest;n.open(`GET`,e,!0),n.responseType=`text`,n.onload=()=>{n.status===200?t({status:`success`,response:n.response}):t({status:`error`,response:`Could not load results from remote service.`,reason:(n.statusText?`${n.status} ${n.statusText}`:`HTTP ${n.status}`)||void 0})},n.onerror=()=>{t({status:`error`,response:`Could not load results from remote service.`})},n.send()});function X(e){let t=document.createElement(`div`);return t.innerHTML=e,t}return(n,o)=>{let s=d(`panel-screen`);return l(),f(s,{panel:a.panel,ref_key:`el`,ref:R},{header:c(()=>[t(i(_(I)(`metadata.title`))+`: `+i(a.payload.layerName),1)]),content:c(()=>[H.value?(l(),r(`div`,O,[e(`div`,k,[B.value==`loading`?(l(),r(`div`,A,i(_(I)(`metadata.loading`)),1)):a.payload.type===`xml`&&B.value==`success`?(l(),r(`div`,{key:1,innerHTML:V.value,class:`flex flex-col justify-center max-w-full xml-content`},null,8,j)):(a.payload.type===`html`||a.payload.type===`md`)&&B.value==`success`?(l(),r(`div`,{key:2,innerHTML:V.value,class:`flex flex-col justify-center max-w-full metadata-view`},null,8,M)):(l(),r(`div`,N,[o[0]||=e(`img`,{src:`https://i.imgur.com/fA5EqV6.png`},null,-1),e(`span`,P,i(_(I)(`metadata.error`)),1)]))])])):(l(),r(`div`,F,[e(`span`,null,i(_(I)(`metadata.label.no.layer`)),1)]))]),_:1},8,[`panel`])}}});export{I as default};