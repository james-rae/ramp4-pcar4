import{is as O,l8 as X,it as j,aC as R,iw as _,aD as v,iL as V,iM as D,ip as F,iK as U,iN as B,pI as q,iy as z,hB as n,iB as k,hA as d,hC as f,iG as c,iA as u,iP as G,iz as K}from"./main-BGluhnsS.js";import{k as I}from"./marked.esm-CM0Cz8j8.js";const Y=`<?xml version="1.0" encoding="UTF-8"?>
...
`,Z={key:0},ee={class:"flex justify-center"},te={key:0,class:"flex flex-col justify-center text-center"},ae=["innerHTML"],le=["innerHTML"],se={key:3,class:"flex flex-col justify-center text-center"},oe={class:"text-xl mt-20"},re={key:1,class:"p-5"},ne=O({__name:"screen",props:{panel:{type:Object,required:!0},payload:{type:Object,required:!0}},setup(i){const s=X(),{t:r}=j(),x=D("iApi"),M=R(),a=i,w=_(()=>s.status),y=_(()=>s.response),P=R(!1),p=v({}),C=v([]),T=v([]);V(()=>{s.status="loading",S(),C.push(x.event.on(F.LAYER_REMOVE,e=>{a.payload.layer?.uid===e.uid&&a.panel.close()})),T.push(U(()=>a.payload.layer.uid,(e,t)=>{e!==t&&(s.status="loading",S())}))}),B(()=>{C.forEach(e=>x.event.off(e)),T.forEach(e=>e())});const S=()=>{P.value=a.payload.layer!==void 0&&!a.payload.layer.isRemoved,a.payload.type==="xml"?N(a.payload.url,[]).then(e=>{if(s.status="success",e!==null){const t=document.createElement("div");t.appendChild(g(`${e.firstElementChild.outerHTML}`)),(a.payload.catalogueUrl||a.payload.url)&&t.appendChild(g(`<h5 class="text-xl font-bold mb-3">${r("metadata.xslt.metadata")}</h5>`)),a.payload.catalogueUrl&&t.appendChild(g(`<p><a style="color: blue;" href="${a.payload.catalogueUrl}" target="_blank">${r("metadata.xslt.cataloguePage")}</a></p>`)),t.appendChild(g(`<p><a style="color: blue;" href="${a.payload.url}" target="_blank">${r("metadata.xslt.metadataPage")}</a> (xml)</p>`)),s.response=t.outerHTML}}):a.payload.type==="html"?b(a.payload.url).then(e=>{s.status=e.status,s.response=e.response}):a.payload.type==="md"&&b(a.payload.url).then(e=>{s.status=e.status,s.response=I(e.response)})},N=(e,t)=>{let l;return a.payload.xmlType&&a.payload.xmlType==="DCAT"?l=x.language==="en"?Q:W:l=x.language==="en"?Y:J,l=l.replace(/\{\{([\w.]+)\}\}/g,(o,m)=>r(m)),p[e]?Promise.resolve($(p[e],l,t)):b(e).then(o=>(p[e]=o.response,$(p[e],l,t)))},$=(e,t,l)=>{let o=null;if(window.XSLTProcessor){const m=new window.XSLTProcessor,L=new DOMParser,A=L.parseFromString(e,"text/xml"),E=L.parseFromString(t,"text/xml");m.importStylesheet(E),l&&l.forEach(h=>m.setParameter("",h.key,h.value||"")),o=m.transformToFragment(A,document);const H={className:"underline text-blue-700 break-all",target:"_blank",validate:{url:h=>/^https?:\/\//.test(h)}};a.payload.treatXmlAsMarkdown?o.firstChild.innerHTML=I.parse(o.firstChild.innerHTML):o.firstChild.innerHTML=q(o.firstChild.innerHTML,H)}return o},b=e=>new Promise(t=>{const l=new XMLHttpRequest;l.open("GET",e,!0),l.responseType="text",l.onload=()=>{l.status===200?t({status:"success",response:l.response}):t({status:"error",response:"Could not load results from remote service."})},l.onerror=()=>{t({status:"error",response:"Could not load results from remote service."})},l.send()});function g(e){const t=document.createElement("div");return t.innerHTML=e,t}return(e,t)=>{const l=K("panel-screen");return n(),z(l,{panel:i.panel,ref_key:"el",ref:M},{header:k(()=>[G(c(u(r)("metadata.title"))+": "+c(i.payload.layerName),1)]),content:k(()=>[P.value?(n(),d("div",Z,[f("div",ee,[w.value=="loading"?(n(),d("div",te,c(u(r)("metadata.loading")),1)):i.payload.type==="xml"&&w.value=="success"?(n(),d("div",{key:1,innerHTML:y.value,class:"flex flex-col justify-center max-w-full xml-content"},null,8,ae)):(i.payload.type==="html"||i.payload.type==="md")&&w.value=="success"?(n(),d("div",{key:2,innerHTML:y.value,class:"flex flex-col justify-center max-w-full metadata-view"},null,8,le)):(n(),d("div",se,[t[0]||(t[0]=f("img",{src:"https://i.imgur.com/fA5EqV6.png"},null,-1)),f("span",oe,c(u(r)("metadata.error")),1)]))])])):(n(),d("div",re,[f("span",null,c(u(r)("metadata.label.no.layer")),1)]))]),_:1},8,["panel"])}}});export{ne as default};
