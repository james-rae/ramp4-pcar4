import { createElementBlock as s, openBlock as t, defineComponent as T, inject as S, resolveComponent as N, createVNode as b, unref as v, withCtx as O, createElementVNode as m, useTemplateRef as Q, markRaw as g, defineAsyncComponent as _, computed as A, normalizeClass as M, Fragment as z, renderList as F, createBlock as y, normalizeStyle as j, resolveDynamicComponent as I, ref as $, onMounted as U, nextTick as J, onBeforeUnmount as K, resolveDirective as V, withDirectives as P, createCommentVNode as w } from "vue";
import { _ as H, d as L, F as X, G as ee } from "./main-ClnjO63o.js";
...
const G = /* @__PURE__ */ H(ne, [["render", ae]]), re = /* @__PURE__ */ T({
  __name: "zoom-nav",
  setup(h) {
  ...
  setup(h) {
    ...
    const p = [
      {
        type: "point",
        icon: g(_(() => import("./point-icon-D-0anl4H.js")))
      },
      {
        type: "polyline",
        icon: g(_(() => import("./polyline-icon-CFNxCIg3.js")))
      },
      {
        type: "polygon",
        icon: g(_(() => import("./polygon-icon-CwBTX7dF.js")))
      },
      {
        type: "circle",
        icon: g(_(() => import("./circle-icon-wpSJDRVD.js")))
      },
      {
        type: "rectangle",
        icon: g(_(() => import("./rectangle-icon-CVWjN--A.js")))
      }
    ], a = A(() => {
      const r = p.filter((u) => e.supportedTypes.some((x) => x.type === u.type));
      return r.push({
        type: "edit",
        icon: g(_(() => import("./edit-icon-DLNgEuz_.js")))
      }), r;
    }), n = (r) => {
      e.activeTool === r ? e.setActiveTool(null) : e.setActiveTool(r);
    }, l = () => {
    ...
    return (r, u) => {
      ...
      return t(), s("div", {
        ...
        (t(!0), s(z, null, F(a.value, (d, C) => (t(), y(x, {
          key: d.type,
          onMousedown: l,
...
}), Z = /* @__PURE__ */ H(se, [["__scopeId", "data-v-2036016d"]]), le = { class: "mapnav absolute right-0 bottom-0 pb-36 sm:pb-48 pr-12" }, pe = ["content"], ce = { class: "mapnav-section bg-white-75 hover:bg-white" }, me = {
  key: 1,
  class: "mapnav-section bg-white-75 hover:bg-white"
}, ve = ["content"], ue = { key: 0 }, de = /* @__PURE__ */ T({
  __name: "mapnav",
  setup(h) {
    const i = $(void 0), o = S("iApi"), e = L(), { t: p } = B(), a = $(), n = A(() => o.getConfig().fixtures.mapnav.items.some((c) => c === "draw")), l = $(o.$rootEl?.clientHeight), r = $(!1), u = $(0), x = () => {
    ...
    return (c, f) => {
      ...
      return t(), s("div", le, [
        P((t(), s("div", {
          ...
          n.value && l.value > u.value ? (t(), s(z, { key: 0 }, [
            b(Z),
            f[0] || (f[0] = m("span", { class: "py-1" }, null, -1))
          ], 64)) : w("", !0),
          b(re, { class: "mapnav-section bg-white-75 hover:bg-white" }),
          ...
          m("div", ce, [
            l.value <= u.value ? (t(), y(W, {
              ...
              tooltip: r.value ? c.$t("mapnav.closeMenu") : c.$t("mapnav.openMenu")
            }, {
              default: O(() => [
                (t(), s("svg", {
                  xmlns: "http://www.w3.org/2000/svg",
                  ...
                  class: M(["fill-current w-6 mx-auto transition-all transform", { "rotate-180": r.value }])
                }, f[1] || (f[1] = [
          ...
          l.value > u.value ? (t(), s("div", me, [
            (t(!0), s(z, null, F(E.value, (k, q) => (t(), s(z, {
              key: k.id + "button"
            }, [
        ...
        l.value <= u.value && r.value ? P((t(), s("div", {
          key: 0,
          ...
          (t(!0), s(z, null, F(E.value, (k) => (t(), y(I(k.id + "-nav-button"), {
            key: k.id + "button",
            class: "mapnav-section bg-white-75 hover:bg-white",
            showOutline: ""
          }))), 128))
...
class it extends fe {
  async added() {
    ...
    this.removed = () => {
      ...
      Object.keys(l).forEach((r) => n.removeItem(r)), n.$reset(), i();
    };
  }
}
export {
