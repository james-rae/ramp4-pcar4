...
import "tiny-emitter";
import { G as le, L as Te, F as xe } from "./main-ClnjO63o.js";
...
class ft extends Me {
  async init() {
    Object.entries(Le).forEach((b) => this.$iApi.$i18n.mergeLocaleMessage(...b)), this._parseConfig(this.config), Z(this.$vApp.$pinia).supportedTypes.forEach((b) => {
      const o = `${b.type}-icon`;
      this.$iApi.component(o, Ae(Se(/* @__PURE__ */ Object.assign({ "./icons/circle-icon.vue": () => import("./circle-icon-wpSJDRVD.js"), "./icons/edit-icon.vue": () => import("./edit-icon-DLNgEuz_.js"), "./icons/point-icon.vue": () => import("./point-icon-D-0anl4H.js"), "./icons/polygon-icon.vue": () => import("./polygon-icon-CwBTX7dF.js"), "./icons/polyline-icon.vue": () => import("./polyline-icon-CFNxCIg3.js"), "./icons/rectangle-icon.vue": () => import("./rectangle-icon-CVWjN--A.js") }), `./icons/${b.type}-icon.vue`, 3)));
    });
