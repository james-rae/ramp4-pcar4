import "tiny-emitter";
import { F as C, v as y, l as G, G as T, P as W, w as z, L as B, x as H, y as R } from "./main-ClnjO63o.js";
  ...
  setup(S) {
    ...
    const x = async (i) => {
      ...
      if (h || typeof h > "u" && !I.isWebMercator()) {
        const d = new W("pole", { x: -96, y: 90 }), L = await e.geo.proj.projectGeometry(I, d), v = e.geo.map.mapPointToScreenPoint(L);
        if (v.screenY < 0) {
          c.value = !0;
          const a = {
