...
import { _ as H, d as L, F as X, G as ee } from "./main-_IInrpBM.js";
...
const G = /* @__PURE__ */ H(ne, [["render", ae]]), se = /* @__PURE__ */ T({
  ...
  setup(h) {
    ...
    const p = [
      {
        type: "point",
        icon: g(_(() => import("./point-icon-CiDUyzJG.js")))
      },
      {
        type: "polyline",
        icon: g(_(() => import("./polyline-icon-BgmjQIuA.js")))
      },
      {
        type: "polygon",
        icon: g(_(() => import("./polygon-icon-nolaN5Ng.js")))
      },
      {
        type: "circle",
        icon: g(_(() => import("./circle-icon-CAApQwkZ.js")))
      },
      {
        type: "rectangle",
        icon: g(_(() => import("./rectangle-icon-BqUitWrG.js")))
      }
    ], a = A(() => {
      const s = p.filter((u) => e.supportedTypes.some((x) => x.type === u.type));
      return s.push({
        type: "edit",
        icon: g(_(() => import("./edit-icon-B_AL1TiD.js")))
      }), s;
    }), n = (s) => {
