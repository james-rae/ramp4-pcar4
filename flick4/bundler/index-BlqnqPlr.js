...
import "tiny-emitter";
import { G as le, L as Te, F as xe } from "./main-_IInrpBM.js";
...
class ft extends Me {
  async init() {
    Object.entries(Le).forEach((b) => this.$iApi.$i18n.mergeLocaleMessage(...b)), this._parseConfig(this.config), Z(this.$vApp.$pinia).supportedTypes.forEach((b) => {
      const o = `${b.type}-icon`;
      this.$iApi.component(o, Ae(Se(/* @__PURE__ */ Object.assign({ "./icons/circle-icon.vue": () => import("./circle-icon-CAApQwkZ.js"), "./icons/edit-icon.vue": () => import("./edit-icon-B_AL1TiD.js"), "./icons/point-icon.vue": () => import("./point-icon-CiDUyzJG.js"), "./icons/polygon-icon.vue": () => import("./polygon-icon-nolaN5Ng.js"), "./icons/polyline-icon.vue": () => import("./polyline-icon-BgmjQIuA.js"), "./icons/rectangle-icon.vue": () => import("./rectangle-icon-BqUitWrG.js") }), `./icons/${b.type}-icon.vue`, 3)));
    });
