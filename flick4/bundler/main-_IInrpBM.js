...
class We extends as {
  ...
  clickSymbology(e, t) {
    if (!this.symbolsVisible() && t !== !1 ? (this.setSymbologyVisibility(void 0, !1), this.setSymbologyVisibility(e, !0), this.toggleVisibility(!0)) : this.setSymbologyVisibility(e, t), this.symbolsVisible() || this.toggleVisibility(!1), this.layer?.supportsFeatures) {
      ...
      let r = "";
      i.length === 0 ? r = "1=2" : i.length < this.symbologyStack.length && (r = i.join(" OR ")), this.layer.setSqlFilter(de.SYMBOL, r);
    }
  }
  /**
...
class Gn extends at {
   ...
   */
  set visibility(e) {
    this.layerExists ? (e || (console.log("blocking ON parent" + this.id), this.sublayers.forEach((t) => {
      t.layerExists && t.canModifyLayer && t.setSqlFilter("lolfilter2", "1=2");
    })), console.log("setting viz: " + e), this.esriLayer.visible = e, e && (console.log("blocking OFF parent" + this.id), this.sublayers.forEach((t) => {
      t.layerExists && t.canModifyLayer && t.setSqlFilter("lolfilter2", "");
    }))) : this.noLayerErr();
  }
  async onInitiate() {
...
class Un extends ui {
   ...
   */
  set visibility(e) {
    this.layerExists ? (this.canModifyLayer && !e && (console.log("blocking ON " + this.id), this.setSqlFilter("lolfilter", "1=2")), console.log("setting viz: " + e), this.esriSubLayer.visible = e, this.canModifyLayer && e && (console.log("blocking OFF " + this.id), this.setSqlFilter("lolfilter", ""))) : this.noLayerErr();
  }
  /**
...
const ol = /* @__PURE__ */ Object.assign({ "../fixtures/appbar/index.ts": () => import("./index-DzZjqieG.js"), "../fixtures/areas-of-interest/index.ts": () => import("./index-D_WNEuIk.js"), "../fixtures/basemap/index.ts": () => import("./index-DLUUUjb7.js"), "../fixtures/crosshairs/index.ts": () => import("./index-BWOjd8cj.js"), "../fixtures/details/index.ts": () => import("./index-E-AjbixD.js"), "../fixtures/draw/index.ts": () => import("./index-BlqnqPlr.js"), "../fixtures/export-footnote/index.ts": () => import("./index-BETdIGiI.js"), "../fixtures/export-legend/index.ts": () => import("./index-BVTnPoKX.js"), "../fixtures/export-map/index.ts": () => import("./index-DZCXgLbA.js"), "../fixtures/export-northarrow/index.ts": () => import("./index-DD4aOtF0.js"), "../fixtures/export-scalebar/index.ts": () => import("./index-Bkz83RB_.js"), "../fixtures/export-timestamp/index.ts": () => import("./index-BqpLRzD8.js"), "../fixtures/export-title/index.ts": () => import("./index-DagKFSiI.js"), "../fixtures/export/index.ts": () => import("./index-C7H83hE4.js"), "../fixtures/extentguard/index.ts": () => import("./index-jJBiH7I4.js"), "../fixtures/gazebo/index.ts": () => import("./index-DnLwDc5V.js"), "../fixtures/geosearch/index.ts": () => import("./index-DbQ_XwZt.js"), "../fixtures/grid/index.ts": () => import("./index-DDdQTVXY.js"), "../fixtures/help/index.ts": () => import("./index-BjJKvo8S.js"), "../fixtures/hilight/index.ts": () => import("./index-WlMHc0MC.js"), "../fixtures/keyboardnav/index.ts": () => import("./index-FfOOkVTB.js"), "../fixtures/layer-reorder/index.ts": () => import("./index-C1AkX6Lv.js"), "../fixtures/legend/index.ts": () => import("./index-ueoCoU42.js"), "../fixtures/mapnav/index.ts": () => import("./index-Rn1JEifN.js"), "../fixtures/metadata/index.ts": () => import("./index-CaA6u70V.js"), "../fixtures/northarrow/index.ts": () => import("./index-DSp3DYHf.js"), "../fixtures/overviewmap/index.ts": () => import("./index-CbtWl50T.js"), "../fixtures/panguard/index.ts": () => import("./index-DpexKnXZ.js"), "../fixtures/scrollguard/index.ts": () => import("./index-DJ1fYNGJ.js"), "../fixtures/settings/index.ts": () => import("./index-C-wVzu9I.js"), "../fixtures/snowman/index.ts": () => import("./index-Iqn1byn6.js"), "../fixtures/swipe/index.ts": () => import("./index-CAZed3Kr.js"), "../fixtures/wizard/index.ts": () => import("./index-CAsS2w-v.js") });
class nl extends re {
  /**
...
const dl = /* @__PURE__ */ qe(ul, [["render", pl], ["__scopeId", "data-v-a3c61802"]]), hl = /* @__PURE__ */ Object.assign({ "../fixtures/areas-of-interest/screen.vue": () => import("./screen-dBSRdjGB.js"), "../fixtures/basemap/screen.vue": () => import("./screen-Dkj4F36R.js"), "../fixtures/export/screen.vue": () => import("./screen-DNpjq2Jk.js"), "../fixtures/geosearch/screen.vue": () => import("./screen-CCCHMPda.js"), "../fixtures/grid/screen.vue": () => import("./screen-DLv_jklq.js"), "../fixtures/help/screen.vue": () => import("./screen-BT7CSvZF.js"), "../fixtures/layer-reorder/screen.vue": () => import("./screen-CVOG364B.js"), "../fixtures/legend/screen.vue": () => import("./screen-Crq2RJ8G.js"), "../fixtures/metadata/screen.vue": () => import("./screen-BBHZ2HS2.js"), "../fixtures/settings/screen.vue": () => import("./screen-CxiHtHRp.js"), "../fixtures/wizard/screen.vue": () => import("./screen-D3k3dGMO.js") });
class Ct extends re {
  /**
   * ID of this panel.
   *
...
var pt = { major: "4", minor: "16", patch: "0-beta", timestamp: "Fri Feb 6 13:57:16 2026 -0500", hash: "287d5cdf08eb3dedeaacc60f4d30a23a40a02688" };
console.info(
