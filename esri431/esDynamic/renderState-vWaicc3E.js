import { e as c } from "./basicInterfaces-Dsf65ICa.js";
import { aV as s, aW as d, aX as u, aY as o } from "./main-DZxT3i7S.js";
function _(t, e, i = o.ADD, n = [0, 0, 0, 0]) {
  return { srcRgb: t, srcAlpha: t, dstRgb: e, dstAlpha: e, opRgb: i, opAlpha: i, color: { r: n[0], g: n[1], b: n[2], a: n[3] } };
}
function w(t, e, i, n, h = o.ADD, O = o.ADD, a = [0, 0, 0, 0]) {
  return { srcRgb: t, srcAlpha: e, dstRgb: i, dstAlpha: n, opRgb: h, opAlpha: O, color: { r: a[0], g: a[1], b: a[2], a: a[3] } };
}
const J = _(s.ZERO, s.ONE_MINUS_SRC_ALPHA);
_(s.ONE, s.ZERO);
_(s.ONE, s.ONE);
const Q = _(s.ONE, s.ONE_MINUS_SRC_ALPHA), V = w(s.SRC_ALPHA, s.ONE, s.ONE_MINUS_SRC_ALPHA, s.ONE_MINUS_SRC_ALPHA), A = { face: d.BACK, mode: u.CCW }, B = { face: d.FRONT, mode: u.CCW }, X = (t) => t === c.Back ? A : t === c.Front ? B : null, Y = { zNear: 0, zFar: 1 }, tt = { r: !0, g: !0, b: !0, a: !0 };
function D(t) {
  return z.intern(t);
}
function C(t) {
...
const z = new l(f, (t) => ({ __tag: "Blending", ...t }));
function f(t) {
  return t ? r([t.srcRgb, t.srcAlpha, t.dstRgb, t.dstAlpha, t.opRgb, t.opAlpha, t.color.r, t.color.g, t.color.b, t.color.a]) : null;
}
const F = new l(p, (t) => ({ __tag: "Culling", ...t }));
function p(t) {
  return t ? r([t.face, t.mode]) : null;
}
const H = new l(g, (t) => ({ __tag: "PolygonOffset", ...t }));
function g(t) {
  return t ? r([t.factor, t.units]) : null;
}
const L = new l(v, (t) => ({ __tag: "DepthTest", ...t }));
function v(t) {
  return t ? r([t.func]) : null;
}
const M = new l(I, (t) => ({ __tag: "StencilTest", ...t }));
function I(t) {
  return t ? r([t.function.func, t.function.ref, t.function.mask, t.operation.fail, t.operation.zFail, t.operation.zPass]) : null;
}
const U = new l(S, (t) => ({ __tag: "DepthWrite", ...t }));
function S(t) {
  return t ? r([t.zNear, t.zFar]) : null;
}
const K = new l(W, (t) => ({ __tag: "ColorWrite", ...t }));
function W(t) {
  return t ? r([t.r, t.g, t.b, t.a]) : null;
}
const Z = new l(b, (t) => ({ __tag: "StencilWrite", ...t }));
function b(t) {
  return t ? r([t.mask]) : null;
}
const $ = new l(T, (t) => ({ __tag: "DrawBuffers", ...t }));
function T(t) {
  return t ? r(t.buffers) : null;
}
const j = new l(x, (t) => ({ blending: D(t.blending), culling: C(t.culling), polygonOffset: R(t.polygonOffset), depthTest: y(t.depthTest), stencilTest: N(t.stencilTest), depthWrite: m(t.depthWrite), colorWrite: P(t.colorWrite), stencilWrite: E(t.stencilWrite), drawBuffers: k(t.drawBuffers) }));
function x(t) {
  return t ? r([f(t.blending), p(t.culling), g(t.polygonOffset), v(t.depthTest), I(t.stencilTest), S(t.depthWrite), W(t.colorWrite), b(t.stencilWrite), T(t.drawBuffers)]) : null;
}
class it {
  constructor(e) {
...
//# sourceMappingURL=renderState-vWaicc3E.js.map
