import { m as F, n as T, a as g } from "./TimeOnly-1Agv6Qm9.js";
import { ay as G, az as S, aA as O } from "./main-DZxT3i7S.js";
var c, d;
function D(e) {
  return G.fromJSON(e.toJSON());
}
function N(e) {
...
function B(e) {
  ...
  switch (e.type) {
    ...
    case "polyline":
      return e.extent;
    case "point":
      return new O({ xmin: e.x, ymin: e.y, xmax: e.x, ymax: e.y, spatialReference: e.spatialReference });
    case "extent":
      return e;
  }
  return null;
...
function _(e, n) {
  ...
  const m = typeof n.cycles == "boolean" && n.cycles, f = n.cmp && (y = n.cmp, function(l) {
    return function(i, t) {
      const r = { key: i, value: l[i] }, s = { key: t, value: l[t] };
      return y(r, s);
    };
  });
  var y;
  ...
  return function l(i) {
    ...
    let t, r;
    if (Array.isArray(i)) {
      for (r = "[", t = 0; t < i.length; t++) t && (r += ","), r += l(i[t]) || "null";
      return r + "]";
    }
    if (i === null) return "null";
    if (o.includes(i)) {
      if (m) return JSON.stringify("__cycle__");
      throw new TypeError("Converting circular structure to JSON");
    }
    const s = o.push(i) - 1, p = Object.keys(i).sort(f?.(i));
    for (r = "", t = 0; t < p.length; t++) {
      const a = p[t], u = l(i[a]);
      u && (r && (r += ","), r += JSON.stringify(a) + ":" + u);
    }
    return o.splice(s, 1), "{" + r + "}";
  }(e);
}
function v(e) {
  switch (e.type) {
...
//# sourceMappingURL=shared-BBl_3BOa.js.map
