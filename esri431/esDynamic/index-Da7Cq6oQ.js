import { kN as A, kO as y, F as M, g4 as $, hV as O, gd as D, hW as k } from "./main-DZxT3i7S.js";
import { _ as B } from "./screen.vue_vue_type_script_setup_true_lang-wRBCF0wE.js";
var H = { exports: {} };
(function(S, i) {
  (function(n, a) {
    a();
    ...
    var r = typeof window == "object" && window.window === window ? window : typeof self == "object" && self.self === self ? self : typeof A == "object" && A.global === A ? A : void 0, b = r.navigator && /Macintosh/.test(navigator.userAgent) && /AppleWebKit/.test(navigator.userAgent) && !/Safari/.test(navigator.userAgent), F = r.saveAs || (typeof window != "object" || window !== r ? function() {
    ...
    r.saveAs = F.saveAs = F, S.exports = F;
  });
})(H);
var j = H.exports;
...
class _ extends M {
   ...
   */
  async make(i, n) {
    const { fabric: a } = await import("./fabric-B6qRtwzH.js").then((g) => g.f);
    ...
    const r = w.componentSelectedState, b = this.getSubFixture("export-title"), F = this.getSubFixture("export-map"), t = this.getSubFixture("export-scalebar"), e = this.getSubFixture("export-northarrow"), l = this.getSubFixture("export-legend"), o = this.getSubFixture("export-footnote"), c = this.getSubFixture("export-timestamp");
    let f, u, m, d, x, s, T;
    if (r.title && b && (f = await b.make({
      ...
      width: n,
      textAlign: "center"
    }), this.options.runningHeight += f.height + 40, p.title = f), r.map && F && (u = await F.make({
      top: this.options.runningHeight
      ...
      await this.customRendererFunc(this.fcFabric, p, g), this.fcFabric.renderAll(), this.fcFabric.clone((v) => {
      ...
      v.top = h.TOP, v.left = h.LEFT, this.fcFabricDownload.add(v), g.scale(this.options.scale), this.fcFabric.add(g), this.fcFabric.setDimensions({
        width: n,
...
class I extends _ {
  ...
  async needed() {
    const i = (await import("./index-C_419i0j.js")).default, n = (await import("./index-BcMrOKWp.js")).default, a = (await import("./index-NXDNW8D1.js")).default, w = (await import("./index-CzKpGb2b.js")).default, p = (await import("./index-BRbwpgNI.js")).default, r = (await import("./index-9WGcxc6i.js")).default, b = (await import("./index-DL6aOZK0.js")).default;
...
//# sourceMappingURL=index-Da7Cq6oQ.js.map
