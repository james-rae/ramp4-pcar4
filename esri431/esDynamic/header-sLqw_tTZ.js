import { bs as k, jM as j, bt as _, bu as A, by as E, bz as I, bA as M, bD as h, bJ as g, g5 as e, bI as i, jN as d, bG as l, bH as m, bC as p, bF as c, gd as b, jO as B } from "./main-DZxT3i7S.js";
const R = { class: "relative legend-header flex align-middle" }, D = ["content", "aria-label"], G = ["content", "aria-label"], H = /* @__PURE__ */ k({
  __name: "header",
  setup(L) {
    const w = j(), { t: s } = _(), a = A("iApi"), r = E(() => a.fixture.get("legend")), x = () => {
...
}), O = /* @__PURE__ */ B(H, [["__scopeId", "data-v-e8031c30"]]);
export {
  O as default
};
//# sourceMappingURL=header-sLqw_tTZ.js.map
