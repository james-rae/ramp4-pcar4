import { X as p, gD as c, gE as x, gF as u, gG as a, gH as _, gI as g, gJ as m, gK as w, gL as f, cQ as B, cR as k, cX as S, cU as R, cV as b } from "./main-DZxT3i7S.js";
import { e as v } from "./Container-C7h2dwkX.js";
class y {
  constructor(t, e, i) {
...
function I(s) {
  return A(s) ? s instanceof y ? s.getRenderedRasterPixels()?.renderedRasterPixels : M(s) : s;
}
class D extends v {
  ...
  setTransform(t) {
    const e = x(this.transforms.displayViewScreenMat3), [i, r] = t.toScreenNoRotation([0, 0], [this.x, this.y]), h = this.resolution / this.pixelRatio / t.resolution, l = h * this.width, o = h * this.height, n = Math.PI * this.rotation / 180;
    u(e, e, a(i, r)), u(e, e, a(l / 2, o / 2)), _(e, e, -n), u(e, e, a(-l / 2, -o / 2)), g(e, e, a(l, o)), m(this.transforms.displayViewScreenMat3, t.displayViewMat3, e);
  }
  ...
  async updateTexture({ context: t, painter: e }) {
    ...
    const i = I(this.source);
    try {
      if (this._uploadStatus != null) {
        const { controller: r, resolver: h } = this._uploadStatus, l = { signal: r.signal }, { width: o, height: n } = this, d = this._texture;
        await e.textureUploadManager.enqueueTextureUpdate({ data: i, texture: d, width: o, height: n }, l), h.resolve(), this._uploadStatus = null;
  ...
  _createTexture(t) {
    ...
    return i.internalFormat = e ? k.RGBA8 : S.RGBA, i.wrapMode = R.CLAMP_TO_EDGE, i.isImmutable = e, i.width = this._sourceWidth, i.height = this._sourceHeight, new b(t, i);
  }
}
export {
  D as S,
...
//# sourceMappingURL=Bitmap-6elP6Pc-.js.map
