import { T as p, C as P, cZ as I, c_ as w, U as k, c$ as G, d0 as S, d1 as m, d2 as d, d3 as x, b1 as E, bU as v, cC as M, cB as O } from "./main-DZxT3i7S.js";
...
function j(s) {
  ...
  (s.featureCollection?.layers || []).forEach((o) => {
    ...
    a === "esriGeometryPoint" ? h(n, g, o.featureSet.features) : a === "esriGeometryPolyline" ? h(i, g, o.featureSet.features) : a === "esriGeometryPolygon" && h(f, g, o.featureSet.features);
  }), s.groundOverlays && s.groundOverlays.forEach((o) => {
    c.set(o.id, o);
  }), r.forEach((o) => {
    o.networkLinkIds.forEach((y) => {
      const a = T(y, o.id, s.networkLinks);
      a && t.push(a);
    });
  }), t.forEach((o) => {
    if (o.featureInfos) {
...
async function N(s) {
  const r = v.fromJSON(s.featureSet).features, t = s.layerDefinition, e = M(t.drawingInfo.renderer), n = O.fromJSON(s.popupInfo), i = [];
  for (const f of r) {
...
//# sourceMappingURL=kmlUtils-BLLx81LN.js.map
