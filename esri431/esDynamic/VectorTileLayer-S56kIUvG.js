import { G as Z, s as I, h9 as ee, nt as te, I as x, gV as re, U as w, J as V, cv as F, cE as se, cu as ie, cZ as S, bW as le, l9 as D, l8 as oe, T as g, e$ as W, aw as T, gN as R, nu as z, aA as U, nv as J, nw as G, ld as K, R as ae, nx as Y, fs as E, dy as j, ny as L, D as ne, hg as ue, ex as pe, eB as ce, ey as he, jP as ye, eN as de, ez as fe, eA as me, eO as ge, eP as Ae, eC as Se, B as $, nz as we, nA as xe, nB as B, dE as ve, bQ as h, bR as y, b1 as _e, f9 as be, eD as M, bS as Ie, eM as Ue } from "./main-DZxT3i7S.js";
import { e as Re } from "./jsonContext-iveSquhc.js";
import { l as $e } from "./StyleRepository-BQUCE9Sk.js";
let _ = null;
function Te(e) {
  if (_) return _;
  const t = { lossy: "UklGRiIAAABXRUJQVlA4IBYAAAAwAQCdASoBAAEADsD+JaQAA3AAAAAA", lossless: "UklGRhoAAABXRUJQVlA4TA0AAAAvAAAAEAcQERGIiP4HAA==", alpha: "UklGRkoAAABXRUJQVlA4WAoAAAAQAAAAAAAAAAAAQUxQSAwAAAARBxAR/Q9ERP8DAABWUDggGAAAABQBAJ0BKgEAAQAAAP4AAA3AAP7mtQAAAA==", animation: "UklGRlIAAABXRUJQVlA4WAoAAAASAAAAAAAAAAAAQU5JTQYAAAD/////AABBTk1GJgAAAAAAAAAAAAAAAAAAAGQAAABWUDhMDQAAAC8AAAAQBxAREYiI/gcA" };
  return _ = new Promise((r) => {
    const s = new Image();
    s.onload = () => {
...
class C {
  ...
  async _loadSprites(t) {
    this._isRetina = this.devicePixelRatio > N;
    const { width: r, height: s, data: i, json: o } = await this._getSpriteData(this._spriteSource, t), l = Object.keys(o);
    if (!l || l.length === 0 || !i) return this._spritesData = this.image = null, void (this.width = this.height = 0);
    ...
    let a;
    for (let n = 0; n < i.length; n += 4) a = i[n + 3] / 255, i[n] = i[n] * a, i[n + 1] = i[n + 1] * a, i[n + 2] = i[n + 2] * a;
    this.image = i;
  }
  async _getSpriteData(t, r) {
    ...
    const s = x(this.baseURL), i = s.query ? "?" + re(s.query) : "", o = this._isRetina ? "@2x" : "", l = `${s.path}${o}.${this._spriteImageFormat}${i}`, u = `${s.path}${o}.json${i}`, [a, n] = await Promise.all([w(u, r), w(l, { responseType: "image", ...r })]);
...
let Pe = class {
  ...
  async fetchTileIndex() {
    return this._tileIndexPromise || (this._tileIndexPromise = w(this.url).then((t) => t.data.index)), this._tileIndexPromise;
  }
  async dataKey(t, r) {
  ...
  _getIndexedDataKey(t, r) {
    ...
    let o, l, u = t, a = s.pop();
    if (u === 1) return a;
    for (; s.length; ) if (o = s.pop(), l = (1 & o.col) + ((1 & o.row) << 1), u) {
      if (u[l] === 0) {
        a = null;
        break;
      }
  ...
  async fetchTileIndex(t) {
    return this._tileIndexPromise || (this._tileIndexPromise = w(this._tileIndexUrl, { query: { ...t?.query } }).then((r) => r.data.index)), this._tileIndexPromise;
  }
  dataKey(t, r) {
    const { level: s, row: i, col: o } = t, l = new F(t);
    return this._tilemap.fetchAvailabilityUpsample(s, i, o, l, r).then(() => (l.world = t.world, l)).catch((u) => {
      if (ie(u)) throw u;
      return null;
    });
  }
...
class De {
  ...
  getData(t) {
    (this._promise == null || D(this._abortController?.signal)) && (this._promise = this._makeRequest(this._tileUrl));
    const r = this._abortOptions;
    return r.push(t), oe(t, () => {
      r.every((s) => D(s)) && this._abortController.abort();
    }), this._promise.then((s) => g(s));
  }
  async _makeRequest(t) {
    this._abortController = new AbortController();
    const { data: r } = await w(t, { responseType: "array-buffer", signal: this._abortController.signal });
    return r;
  }
}
const q = /* @__PURE__ */ new Map();
function Ee(e, t, r, s, i) {
  const o = x(e), l = o.query;
  ...
  const u = o.path;
  return je(S(u.replaceAll(/\{z\}/gi, t.toString()).replaceAll(/\{y\}/gi, r.toString()).replaceAll(/\{x\}/gi, s.toString()), { ...o.query }), i);
}
function je(e, t) {
  return le(q, e, () => new De(e)).getData(t).finally(() => q.delete(e));
}
class Le {
  constructor(t, r, s) {
    ...
    const i = x(this.sourceUrl), o = g(s), l = o.tiles;
    if (i) for (let f = 0; f < l.length; f++) {
      const m = x(l[f]);
      m && (W(m.path) || (m.path = T(i.path, m.path)), l[f] = S(m.path, { ...i.query, ...m.query }));
    }
    this.tileServers = l;
    const u = s.capabilities && s.capabilities.split(",").map((f) => f.toLowerCase().trim()), a = s?.exportTilesAllowed === !0, n = u?.includes("tilemap") === !0, p = a && s.hasOwnProperty("maxExportTilesCount") ? s.maxExportTilesCount : 0;
    ...
    n ? (this.type = "vector-tile", this.tilemap = new Oe(new z({ layer: { parsedUrl: i, tileInfo: this.tileInfo }, minLOD: o.minLOD ?? this.tileInfo.lods[0].level, maxLOD: o.maxLOD ?? this.tileInfo.lods[this.tileInfo.lods.length - 1].level }), d)) : d && (this.tilemap = new Pe(d)), this.fullExtent = U.fromJSON(s.fullExtent), this.initialExtent = U.fromJSON(s.initialExtent);
  }
  destroy() {
  ...
  isCompatibleWith(t) {
    ...
    if (!r.spatialReference.equals(s.spatialReference) || !r.origin.equals(s.origin) || Math.round(r.dpi) !== Math.round(s.dpi)) return !1;
    const i = r.lods, o = s.lods, l = Math.min(i.length, o.length);
    for (let u = 0; u < l; u++) {
      const a = i[u], n = o[u];
...
async function A(e, t, r, s, i) {
  ...
  if (V(i), typeof r == "string") {
    const n = K(r);
    u = await w(n, { ...i, responseType: "json", query: { f: "json", ...i?.query } }), u.ssl && (o && (o = o.replace(/^http:/i, "https:")), l && (l = l.replace(/^http:/i, "https:"))), o = n, l = n;
  } else r != null && (u = { data: r }, o = r.jsonUrl || null, l = s);
  const a = u?.data;
  if (H(a)) return e.styleUrl = o || null, Ne(e, a, l, i);
  if (Me(a)) return e.sourceUrl ? Q(e, a, l, !1, t, i) : (e.sourceUrl = o || null, Q(e, a, l, !0, t, i));
...
async function Ne(e, t, r, s) {
  const i = r ? ae(r) : Y();
  e.styleBase = i, e.style = t, t["sprite-format"] && t["sprite-format"].toLowerCase() === "webp" && (e.spriteFormat = "webp");
  const o = [];
  if (t.sources && t.sources.esri) {
    const l = t.sources.esri;
    l.url ? await A(e, "esri", v(i, l.url), void 0, s) : o.push(A(e, "esri", l, i, s));
  }
  for (const l of Object.keys(t.sources)) l !== "esri" && t.sources[l].type === "vector" && (t.sources[l].url ? o.push(A(e, l, v(i, t.sources[l].url), void 0, s)) : t.sources[l].tiles && o.push(A(e, l, t.sources[l], i, s)));
  await Promise.all(o);
}
async function Q(e, t, r, s, i, o) {
  const l = r ? G(r) + "/" : Y(), u = Ce(t), a = new Le(i, S(l, o?.query ?? {}), u);
  ...
  if (s && (e.sourceBase = l, e.source = t, e.validatedSource = u, e.primarySourceName = i), e.sourceNameToSource[i] = a, !X(e) && "defaultStyles" in t && !e.style) {
    if (t.defaultStyles == null) throw new Error();
    return typeof t.defaultStyles == "string" ? A(e, "", v(l, t.defaultStyles, "root.json"), void 0, o) : A(e, "", t.defaultStyles, v(l, "root.json"), o);
  }
}
function Ce(e) {
  if (ke(e)) {
  ...
  if (X(e)) {
    const { bounds: p } = e;
    if (p) {
      const d = E({ x: p[0], y: p[1], spatialReference: g(j) }), f = E({ x: p[2], y: p[3], spatialReference: g(j) });
      s = { xmin: d.x, ymin: d.y, xmax: f.x, ymax: f.y, spatialReference: g(L) };
    }
  }
  s === null && (s = r);
  let i = 78271.51696400007, o = 2958287637957775e-7;
  const l = [], u = e.hasOwnProperty("maxzoom") && e.maxzoom != null ? +e.maxzoom : 22, a = 0, n = 0;
  for (let p = 0; p <= u; p++) l.push({ level: p, scale: o, resolution: i }), i /= 2, o /= 2;
  return { capabilities: "TilesOnly", initialExtent: s, fullExtent: r, minScale: a, maxScale: n, tiles: e.tiles, tileInfo: { rows: 512, cols: 512, dpi: 96, format: "pbf", origin: { x: -20037508342787e-6, y: 20037508342787e-6 }, lods: l, spatialReference: g(L) } };
}
function ke(e) {
...
function qe(e, t) {
  ...
  for (let l = i.lods[0].scale; l >= o.lods[o.lods.length - 1].scale - b; l /= 2) if (Math.abs(l - o.lods[0].scale) < b) return !0;
  return !1;
}
function Qe(e, t) {
  if (e === t) return e;
  ...
  const r = e.size[0], s = e.format, i = e.dpi, o = new ne({ x: e.origin.x, y: e.origin.y }), l = e.spatialReference, u = e.lods[0].scale > t.lods[0].scale ? e.lods[0] : t.lods[0], a = e.lods[e.lods.length - 1].scale <= t.lods[t.lods.length - 1].scale ? e.lods[e.lods.length - 1] : t.lods[t.lods.length - 1], n = u.scale, p = u.resolution, d = a.scale, f = [];
  let m = n, P = p, O = 0;
  for (; m > d; ) f.push(new ue({ level: O, resolution: P, scale: m })), O++, m /= 2, P /= 2;
  return new R({ size: [r, r], dpi: i, format: s || "pbf", origin: o, lods: f, spatialReference: l });
}
let c = class extends pe(ce(he(ye(de(fe(me(ge(Ae(Se(Ue)))))))))) {
  constructor(...e) {
    super(...e), this._spriteSourceMap = /* @__PURE__ */ new Map(), this.currentStyleInfo = null, this.isReference = null, this.operationalLayerType = "VectorTileLayer", this.path = null, this.refreshInterval = 0, this.style = null, this.tilemapCache = null, this.type = "vector-tile", this.url = null;
  }
  ...
  load(e) {
    const t = this.loadFromPortal({ supportedTypes: ["Vector Tile Service"], supportsData: !1 }, e).catch($).then(async () => {
      ...
      (await w(r, { ...e, query: { f: "json", ...this.customParameters, token: this.apiKey } })).data && this.read({ url: r }, Re(this.portalItem, "portal-item"));
    }).catch($).then(() => this._loadStyle(e));
    return this.addResolvingPromise(t), Promise.resolve(this);
  }
  get attributionDataUrl() {
    const e = this.currentStyleInfo, t = e?.serviceUrl && x(e.serviceUrl);
    if (!t) return null;
  ...
  get tileInfo() {
    ...
    if (e.length > 1) for (let r = 0; r < e.length; r++) qe(t, e[r].tileInfo) && (t = Qe(t, e[r].tileInfo));
    return t;
  }
  ...
  async loadSpriteSource(e = 1, t) {
    if (!this._spriteSourceMap.has(e)) {
      const r = B().maxTextureSize, s = this.currentStyleInfo?.spriteUrl ? S(this.currentStyleInfo.spriteUrl, { ...this.customParameters, token: this.apiKey }) : null, i = new C({ type: "url", spriteUrl: s, pixelRatio: e, spriteFormat: this.currentStyleInfo?.spriteFormat }, r);
      await i.load(t), this._spriteSourceMap.set(e, i);
    }
    return this._spriteSourceMap.get(e);
  }
  async setSpriteSource(e, t) {
    if (!e) return null;
    const r = B().maxTextureSize, s = e.spriteUrl, i = s ? S(s, { ...this.customParameters, token: this.apiKey }) : null;
    if (!i && e.type === "url") return null;
    const o = new C(e, r);
    try {
      await o.load(t);
      const l = e.pixelRatio || 1;
      return this._spriteSourceMap.clear(), this._spriteSourceMap.set(l, o), i && this.currentStyleInfo && (this.currentStyleInfo.spriteUrl = i), this.emit("spriteSource-change", { spriteSource: o }), o;
    } catch (l) {
      $(l);
    }
    return null;
  ...
  async loadStyle(e, t) {
    ...
    return this._loadingTask && typeof r == "string" && this.url === r || (this._loadingTask?.abort(), this._loadingTask = ve((s) => (this._spriteSourceMap.clear(), this._getSourceAndStyle(r, { signal: s })), t)), this._loadingTask.promise;
  }
  getStyleLayerId(e) {
  ...
  async _getSourceAndStyle(e, t) {
    ...
    const r = await Be(e, { ...t, query: { ...this.customParameters, token: this.apiKey } });
    r.spriteFormat === "webp" && (await Te("lossy") || (r.spriteFormat = "png")), this._set("currentStyleInfo", { ...r }), typeof e == "string" ? (this.url = e, this.style = null) : (this.url = null, this.style = e), this._set("sourceNameToSource", r.sourceNameToSource), this._set("primarySource", r.sourceNameToSource[r.primarySourceName]), this._set("styleRepository", new $e(r.style)), this.read(r.layerDefinition, { origin: "service" }), this.emit("load-style");
  }
