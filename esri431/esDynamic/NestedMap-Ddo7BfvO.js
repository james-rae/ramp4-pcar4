class u {
  ...
  set(t, e, r) {
    ...
    o ? o.set(e, r) : this._outer.set(t, /* @__PURE__ */ new Map([[e, r]]));
  }
  delete(t, e) {
  ...
  forAll(t) {
    for (const e of this._outer.values()) for (const r of e.values()) t(r);
  }
}
export {
  u as t
};
//# sourceMappingURL=NestedMap-Ddo7BfvO.js.map
