import { ex as f, eB as j, ey as x, gN as b, b1 as h, aA as B, b7 as U, U as c, he as M, s as u, bQ as r, bR as s, bS as T, hf as R, eM as P, fE as k, ez as I, eC as _, D as $, hg as a } from "./main-DZxT3i7S.js";
var v;
const y = new R("0/0/0", 0, 0, 0, void 0);
let g = v = class extends f(j(x(P))) {
  constructor() {
    super(...arguments), this.tileInfo = b.create({ spatialReference: h.WebMercator, size: 256 }), this.type = "base-tile", this.fullExtent = new B(-20037508342787e-6, -2003750834278e-5, 2003750834278e-5, 20037508342787e-6, h.WebMercator), this.spatialReference = h.WebMercator;
  }
  ...
  async fetchImageBitmapTile(e, t, i, l = {}) {
    ...
    const p = this.getTileUrl(e, t, i) ?? "", d = { responseType: "blob", signal: n, query: { ...this.refreshParameters } }, { data: m } = await c(p, d);
    return M(m, e, t, i, n);
  }
  getTileUrl() {
...
let o = class extends f(I(_(z))) {
  ...
  _getMetadata() {
    ...
    return c(`${A}/REST/v1/Imagery/Metadata/${e}`, { responseType: "json", query: { include: "ImageryProviders", uriScheme: "https", key: this.key, suppressStatus: !0, output: "json", culture: this.culture, userRegion: this.region } }).then((t) => {
      const i = t.data;
...
//# sourceMappingURL=BingMapsLayer-CpYnVWFC.js.map
