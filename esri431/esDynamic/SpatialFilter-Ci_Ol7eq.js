import { as as X, az as $, b1 as ee, dz as te, fq as G } from "./main-DZxT3i7S.js";
import { D as ne } from "./arcadeUtils-D2KMJEyx.js";
import { l as u, f as P, d as k, F as L, g as C, T as O, N as ae, s as F, O as re, b as se, u as B, w as Z, v as q } from "./shared-BBl_3BOa.js";
import { a as M, m as ie, n as J } from "./TimeOnly-1Agv6Qm9.js";
import { Z as T, n as g, a as m, r as z } from "./WhereClause-DvtkPbGD.js";
import { union as le, geodesicArea as oe, planarArea as ce, geodesicLength as ue, planarLength as he, relate as de, crosses as pe, touches as _e, within as fe, overlaps as ge, contains as me, intersects as H } from "./geometryEngineAsync-DyUykqWV.js";
var _;
(function(r) {
  r.NeverReach = "NeverReach", r.NotImplemented = "NotImplemented", r.Cancelled = "Cancelled", r.InvalidStatResponse = "InvalidStatResponse", r.InvalidRequest = "InvalidRequest", r.RequestFailed = "RequestFailed", r.MissingFeatures = "MissingFeatures", r.AggregationFieldNotFound = "AggregationFieldNotFound", r.DataElementsNotFound = "DataElementsNotFound";
})(_ || (_ = {}));
const ye = { [_.Cancelled]: "Cancelled", [_.InvalidStatResponse]: "Invalid statistics response from service", [_.InvalidRequest]: "Invalid request", [_.RequestFailed]: "Request failed - {reason}", [_.MissingFeatures]: "Missing features", [_.AggregationFieldNotFound]: "Aggregation field not found", [_.DataElementsNotFound]: "Data elements not found on service", [_.NeverReach]: "Encountered unreachable logic", [_.NotImplemented]: "Not implemented" };
class y extends Error {
  constructor(e, t) {
    super(X(ye[e], t)), this.declaredRootClass = "esri.arcade.featureset.support.featureseterror", Error.captureStackTrace && Error.captureStackTrace(this, y);
  }
}
class v {
  constructor() {
...
class Se {
  ...
  async nextBatchAsArcadeFeatures(e, t) {
    ...
    return n === null ? n : n.map((a) => ne.createFromGraphicLikeObject(a.geometry, a.attributes, this._parent, t));
  }
  nextBatch(e) {
    ...
    return t.returnpromise = new Promise((a, s) => {
      this._parent._getSet(this._progress).then((i) => {
        const l = i._known;
        let c = l.length - 1;
        if (l[l.length - 1] === "GETPAGES" && (c -= 1), this._lastId + e > c && l.length > 0 && l[l.length - 1] === "GETPAGES") return void this._parent._expandPagedSet(i, this._parent._maxQueryRate(), 0, 0, this._progress).then((d) => {
        ...
        if (c >= this._lastId + e || o.length === 0) {
          for (let d = 0; d < e; d++) {
...
function He(r, e, t, n) {
  const a = h(r.parseTree, u.Standardised, r.parameters, e, t);
  return T.create(a, { fieldsIndex: n, timeZone: r.timeZone, currentUser: r.currentUser });
}
function Ye(r, e, t = "AND") {
  return T.create("((" + Y(r, u.Standardised) + ")" + t + "(" + Y(e, u.Standardised) + "))", { fieldsIndex: r.fieldsIndex, timeZone: r.timeZone, currentUser: r.currentUser });
}
function we(r) {
  return r.delimited === !0 ? `"${r.column.split('"').join('""')}"` : r.column;
}
function h(r, e, t, n = null, a = null) {
  ...
  switch (r.type) {
    ...
    case "parameter": {
      ...
      if (Array.isArray(o)) {
        const d = [];
        for (let f = 0; f < o.length; f++) typeof o[f] == "string" ? d.push("'" + o[f].toString().replaceAll("'", "''") + "'") : P(o[f]) || k(o[f]) ? d.push(R(o[f], e)) : L(o[f]) ? d.push(Q(o[f], e)) : C(o[f]) ? d.push(U(o[f], e)) : O(o[f]) ? d.push(K(o[f], e)) : d.push(o[f].toString());
        return d;
      }
      return o.toString();
    }
    ...
    case "binary-expression":
      switch (r.operator) {
        ...
        case "IS":
          if (r.right.type !== "null") throw new g(m.UnsupportedIsRhs);
          return " (" + h(r.left, e, t, n, a) + " IS NULL )";
        case "ISNOT":
          if (r.right.type !== "null") throw new g(m.UnsupportedIsRhs);
          return " (" + h(r.left, e, t, n, a) + " IS NOT NULL )";
        case "IN":
          return s = [], r.right.type === "expression-list" ? (s = h(r.right, e, t, n, a), " (" + h(r.left, e, t, n, a) + " IN (" + s.join(",") + ")) ") : (c = h(r.right, e, t, n, a), Array.isArray(c) ? " (" + h(r.left, e, t, n, a) + " IN (" + c.join(",") + ")) " : " (" + h(r.left, e, t, n, a) + " IN (" + c + ")) ");
        case "NOT IN":
          return s = [], r.right.type === "expression-list" ? (s = h(r.right, e, t, n, a), " (" + h(r.left, e, t, n, a) + " NOT IN (" + s.join(",") + ")) ") : (c = h(r.right, e, t, n, a), Array.isArray(c) ? " (" + h(r.left, e, t, n, a) + " NOT IN (" + c.join(",") + ")) " : " (" + h(r.left, e, t, n, a) + " NOT IN (" + c + ")) ");
        case "BETWEEN":
        ...
        case "||":
          return " (" + h(r.left, e, t, n, a) + " " + (e === u.SqlServer ? "+" : r.operator) + " " + h(r.right, e, t, n, a) + ") ";
      }
      throw new g(m.UnsupportedOperator, { operator: r.operator });
    case "null":
      return "null";
    case "boolean":
    ...
    case "column-reference":
      return n && n.toLowerCase() === r.column.toLowerCase() ? "(" + a + ")" : we(r);
    case "data-type":
      return r.value;
    case "function": {
      const o = h(r.args, e, t, n, a);
      return Te(r.name, o, e);
    }
  }
  throw new g(m.UnsupportedSyntax, { node: r.type });
}
function Te(r, e, t) {
  switch (r.toLowerCase().trim()) {
    ...
    case "log":
    case "abs":
      if (e.length !== 1) throw new g(m.InvalidFunctionParameters, { function: r.toLowerCase().trim() });
      return `${r.toUpperCase().trim()}(${e[0]})`;
    case "ceiling":
    case "ceil":
      if (e.length !== 1) throw new g(m.InvalidFunctionParameters, { function: "ceiling" });
      switch (t) {
        case u.Standardised:
        case u.StandardisedNoInterval:
      }
      return "CEILING(" + e[0] + ")";
    case "mod":
    case "power":
    case "nullif":
      if (e.length !== 2) throw new g(m.InvalidFunctionParameters, { function: r.toLowerCase().trim() });
      return `${r.toUpperCase().trim()}(${e[0]},${e[1]})`;
    case "round":
      if (e.length === 2) return "ROUND(" + e[0] + "," + e[1] + ")";
      if (e.length === 1) return "ROUND(" + e[0] + ")";
      throw new g(m.InvalidFunctionParameters, { function: "round" });
    case "truncate":
      if (e.length < 1 || e.length > 2) throw new g(m.InvalidFunctionParameters, { function: "truncate" });
      return t === u.SqlServer ? "ROUND(" + e[0] + (e.length === 1 ? "0" : "," + e[1]) + ",1)" : "TRUNCATE(" + e[0] + (e.length === 1 ? ")" : "," + e[1] + ")");
    case "char_length":
    case "len":
      if (e.length !== 1) throw new g(m.InvalidFunctionParameters, { function: "char_length" });
      switch (t) {
        case u.SqlServer:
          return "LEN(" + e[0] + ")";
        case u.Oracle:
    ...
    case "coalesce":
    case "concat": {
      if (e.length < 1) throw new g(m.InvalidFunctionParameters, { function: r.toLowerCase() });
    ...
    case "lower":
    case "lcase":
      if (e.length !== 1) throw new g(m.InvalidFunctionParameters, { function: "lower" });
      return "LOWER(" + e[0] + ")";
    case "upper":
    case "ucase":
      if (e.length !== 1) throw new g(m.InvalidFunctionParameters, { function: "upper" });
      return "UPPER(" + e[0] + ")";
    case "substring": {
      let n = "";
      switch (t) {
  ...
  throw new g(m.InvalidFunctionParameters, { function: r });
}
function U(r, e) {
...
function R(r, e) {
  return U(ie.dateTimeToArcadeDate(k(r) ? r : $.fromJSDate(r)), e);
}
function Ie(r, e) {
  switch (e) {
    case u.FILEGDB:
    ...
    case u.PGDB:
    default:
      return r === "date" ? "CURRENT_DATE" : r === "time" ? "CURRENT_TIME" : "CURRENT_TIMESTAMP";
    case u.SqlServer:
      return r === "date" ? "CAST(GETDATE() AS DATE)" : r === "time" ? "CAST(GETDATE() AS TIME)" : "GETDATE()";
    case u.Postgres:
      return r === "date" ? "CURRENT_DATE" : r === "time" ? "LOCALTIME" : "CURRENT_TIMESTAMP";
  }
}
function Fe(r, e, t = {}) {
  ...
  switch (e.type) {
    ...
    case "binary-expression":
      switch (e.operator) {
        ...
        case "IS":
        case "ISNOT":
          if (e.right.type !== "null") throw new g(m.UnsupportedIsRhs);
          return "boolean";
        case "*":
        case "-":
        case "+":
        case "/":
          return N([S(r, e.left, t, n), S(r, e.right, t, n)]);
        case "||":
          return "string";
        default:
          throw new g(m.UnsupportedOperator, { operator: e.operator });
      }
    case "null":
      return "";
    case "boolean":
    ...
    case "time":
      return "time-only";
    case "current-time":
      return e.mode === "time" ? "time-only" : "date";
    case "current-user":
      return "string";
    case "column-reference": {
    ...
    case "function":
      switch (e.name.toLowerCase()) {
        ...
        case "mod":
          return "integer";
        case "round":
          if (a = S(r, e.args, t, n), Array.isArray(a)) {
        ...
        case "floor":
        case "abs":
          return a = S(r, e.args, t, n), Array.isArray(a) && (a = N(a)), a === "integer" || a === "double" ? a : "double";
        case "area":
        case "length":
        case "log":
        case "log10":
        ...
        case "nullif":
        case "coalesce":
          return a = S(r, e.args, t, n), Array.isArray(a) ? a.length > 0 ? a[0] : "" : a;
      }
      return "";
  }
  throw new g(m.UnsupportedSyntax, { node: e.type });
}
const j = { boolean: 1, string: 2, integer: 3, double: 4, date: 5 };
function N(r) {
  if (r) {
    let e = "";
    for (const t of r) t !== "" && (e = e === "" || j[e] < j[t] ? t : e);
    return e;
  }
  return "";
}
...
function Ee(r, e, t) {
  let n = "";
  return n = e.type === "interval-period" ? x(e) : x(e.start) + " TO " + x(e.end), "INTERVAL " + t + " " + r + " " + n;
}
function De(r) {
...
async function Ne(r, e, t) {
  let n = "";
  e && !be(e) && (n = Fe(e, r.fields));
  const a = await A(r, e, t, !0);
  if (a.length === 0) return null;
  const s = W(a);
  return s === null ? s : n === "integer" ? De(s) : s;
}
...
async function ke(r, e, t) {
  const n = await A(r, e, t, !0);
  return n.length === 0 ? null : ve(n);
}
async function Le(r, e) {
  return r.iterator(e).count();
}
async function A(r, e, t, n = !1) {
  const a = r.iterator(t), s = [], i = { ticker: 0 };
  let l = await a.next();
  for (; l !== null; ) {
    if (i.ticker++, t.aborted) throw new y(_.Cancelled);
    i.ticker % 100 == 0 && (i.ticker = 0, await new Promise((o) => {
      setTimeout(o, 0);
    }));
    const c = e?.calculateValue(l);
    c === null ? n === !1 && (s[s.length] = c) : s[s.length] = c instanceof J || c instanceof M ? c.toNumber() : c instanceof z ? c.toMilliseconds() : c, l = await a.next();
  }
  return s;
}
async function Ce(r, e, t = 1e3, n = null) {
  const a = r.iterator(n), s = [], i = {}, l = { ticker: 0 };
  let c = await a.next();
  for (; c !== null; ) {
    if (l.ticker++, n?.aborted) throw new y(_.Cancelled);
    l.ticker % 100 == 0 && (l.ticker = 0, await new Promise((f) => {
      setTimeout(f, 0);
    }));
    const o = e?.calculateValue(c);
    let d = o;
    if (o instanceof J ? d = "!!DATEONLY!!-" + o.toString() : o instanceof z ? d = "!!TSOFFSETONLY!!-" + o.toString() : o instanceof M ? d = "!!TIMEONLY!!-" + o.toString() : o instanceof Date && (d = "!!DATE!!-" + o.toString()), o != null && i[d] === void 0 && (s.push(o), i[d] = 1), s.length >= t && t !== -1) return s;
    c = await a.next();
  }
  return s;
}
class p {
  ...
  getFieldsIndex() {
    return this._fieldsIndex === null && (this._fieldsIndex = te.fromLayer({ timeInfo: this.timeInfo, editFieldsInfo: this.editFieldsInfo, dateFieldsTimeZone: this.dateFieldsTimeZone, datesInUnknownTimezone: this.datesInUnknownTimezone, fields: this.fields })), this._fieldsIndex;
  }
  _maxProcessingRate() {
  ...
  _checkCancelled(e) {
    if (e != null && e.aborted) throw new y(_.Cancelled);
  }
  nativeCapabilities() {
  ...
  async _getAggregatePagesDataSourceDefinition(e, t, n, a, s, i, l) {
    if (this._parent === null) throw new y(_.NeverReach);
  ...
  async databaseType() {
    if (this._databaseType === u.NotEvaluated) {
  ...
  async _getDatabaseTypeImpl() {
    const e = [{ thetype: u.SqlServer, testwhere: "(CAST( '2015-01-01' as DATETIME) = CAST( '2015-01-01' as DATETIME)) AND OBJECTID<0" }, { thetype: u.Oracle, testwhere: "(TO_DATE('2003-11-18','YYYY-MM-DD') = TO_DATE('2003-11-18','YYYY-MM-DD')) AND OBJECTID<0" }, { thetype: u.StandardisedNoInterval, testwhere: "(date '2015-01-01 10:10:10' = date '2015-01-01 10:10:10') AND OBJECTID<0" }];
    for (const t of e)
      if (await this._runDatabaseProbe(t.testwhere) === !0) return t.thetype;
    return u.StandardisedNoInterval;
  }
  ...
  async _getFeature(e, t, n) {
    ...
    throw new y(_.MissingFeatures);
  }
  async _getFeatureBatch(e, t) {
    this._checkCancelled(t);
    const n = new E([], e, !1, null), a = [];
  ...
  _refineKnowns(e, t) {
    ...
    for (let i = 0; i < e._candidates.length && e._candidates[i] !== "GETPAGES"; i++) {
      let l = !1;
      const c = this._candidateIdTransform(e._candidates[i]);
      c !== e._candidates[i] && (l = !0);
      const o = this._isInFeatureSet(c);
      if (o === F.InFeatureSet) l === !0 ? e._known.includes(c) || (e._known.push(c), n += 1) : (e._known.push(e._candidates[i]), n += 1), a === null ? a = { start: i, end: i } : a.end === i - 1 ? a.end = i : (s.push(a), a = { start: i, end: i });
  ...
  _refineIfParentKnown(e, t, n) {
    const a = new E([], [], e._ordered, null);
    return a._candidates = e._candidates.slice(), this._parent._refineSetBlock(a, t, n);
  }
  ...
  async _expandPagedSet(e, t, n, a, s) {
    if (this._parent === null) throw new y(_.NotImplemented);
  ...
  async _manualStat(e, t, n, a) {
    ...
    switch (e.toLowerCase()) {
      case "count":
        return s = await Le(this, a), { calculated: !0, result: s };
      case "distinct":
        return s = await Ce(this, t, n, a), { calculated: !0, result: s };
      case "avg":
      case "mean":
      ...
      case "variance":
        return s = await xe(this, t, a), { calculated: !0, result: s };
      case "sum":
        return s = await ke(this, t, a), { calculated: !0, result: s };
      case "min":
        return s = await Ae(this, t, a), { calculated: !0, result: s };
      case "max":
  ...
  async _stat(e, t, n, a, s, i, l) {
    const c = await this._parent._stat(e, t, n, a, s, i, l);
    return c.calculated === !1 ? s === null && n === "" && a === null ? this._manualStat(e, t, i, l) : { calculated: !1 } : c;
  }
  _unionAllGeomSelf(e) {
  ...
  _unionShapeInBatches(e, t, n, a) {
    t.next().then((s) => {
      try {
        s !== null && s.geometry !== null && e.push(s.geometry), e.length > 30 || s === null && e.length > 1 ? le(e).then((i) => {
          try {
  ...
  sumArea(e, t = !1, n) {
    const a = re(e);
    return this.reduce((s, i) => i.geometry === null ? 0 : t ? oe(i.geometry, a).then((l) => s + l) : ce(i.geometry, a).then((l) => s + l), 0, n);
  }
  sumLength(e, t = !1, n) {
    const a = se(e);
    return this.reduce((s, i) => i.geometry === null ? 0 : t ? ue(i.geometry, a).then((l) => s + l) : he(i.geometry, a).then((l) => s + l), 0, n);
  }
  async distinct(e, t = 1e3, n = null, a) {
    await this.load();
    const s = T.create(e, { fieldsIndex: this.getFieldsIndex(), timeZone: this.dateFieldsTimeZoneDefaultUTC });
    return D(s, n), this.calculateStatistic("distinct", s, t, this._defaultTracker(a));
  }
  async min(e, t = null, n) {
    await this.load();
    const a = T.create(e, { fieldsIndex: this.getFieldsIndex(), timeZone: this.dateFieldsTimeZoneDefaultUTC });
    return D(a, t), this.calculateStatistic("min", a, -1, this._defaultTracker(n));
  }
  async max(e, t = null, n) {
    await this.load();
    const a = T.create(e, { fieldsIndex: this.getFieldsIndex(), timeZone: this.dateFieldsTimeZoneDefaultUTC });
    return D(a, t), this.calculateStatistic("max", a, -1, this._defaultTracker(n));
  }
  async avg(e, t = null, n) {
    await this.load();
    const a = T.create(e, { fieldsIndex: this.getFieldsIndex(), timeZone: this.dateFieldsTimeZoneDefaultUTC });
    return D(a, t), this.calculateStatistic("avg", a, -1, this._defaultTracker(n));
  }
  async sum(e, t = null, n) {
    await this.load();
    const a = T.create(e, { fieldsIndex: this.getFieldsIndex(), timeZone: this.dateFieldsTimeZoneDefaultUTC });
    return D(a, t), this.calculateStatistic("sum", a, -1, this._defaultTracker(n));
  }
  async stdev(e, t = null, n) {
    await this.load();
    const a = T.create(e, { fieldsIndex: this.getFieldsIndex(), timeZone: this.dateFieldsTimeZoneDefaultUTC });
    return D(a, t), this.calculateStatistic("stdev", a, -1, this._defaultTracker(n));
  }
  async variance(e, t = null, n) {
    await this.load();
    const a = T.create(e, { fieldsIndex: this.getFieldsIndex(), timeZone: this.dateFieldsTimeZoneDefaultUTC });
    return D(a, t), this.calculateStatistic("variance", a, -1, this._defaultTracker(n));
  }
  async count(e) {
    return await this.load(), this.calculateStatistic("count", T.create("1", { fieldsIndex: this.getFieldsIndex(), timeZone: this.dateFieldsTimeZoneDefaultUTC }), -1, this._defaultTracker(e));
  }
  _defaultTracker(e) {
    return e ?? { aborted: !1 };
  }
      ...
      e.next().then((l) => {
        try {
          if (l === null) a(n);
            ...
            const c = t(l);
            c == null ? this._forEachImpl(e, t, n, a, s, i) : G(c) ? c.then(() => {
              try {
  ...
  schema() {
    ...
    return { objectIdField: this.objectIdField, globalIdField: this.globalIdField, geometryType: Z[this.geometryType] === void 0 ? "esriGeometryNull" : Z[this.geometryType], fields: e };
  }
...
class b extends p {
  constructor(e) {
    super(e), this.declaredClass = "esri.layers.featureset.sources.Empty", this._maxProcessing = 1e3, this._wset = new E([], [], !1, null), this._parent = e.parentfeatureset, this._databaseType = u.Standardised;
  }
  async _getSet() {
    return this._wset;
  }
...
class I extends p {
  ...
  async _getSet(e) {
    if (this._wset === null) {
      ...
      return this._checkCancelled(e), this._wset = new E(t._candidates.slice(), t._known.slice(), t._ordered, this._clonePageDefinition(t.pagesDefinition)), this._wset;
    }
    return this._wset;
  }
  _isInFeatureSet(e) {
  ...
  async executeSpatialRelationTest(e) {
    ...
    switch (this._relation) {
      case "esriSpatialRelEnvelopeIntersects":
        return H(q(this._relationGeom), q(e.geometry));
      ...
      case "esriSpatialRelRelation":
        return de(this._relationGeom, e.geometry, this._relationString ?? "");
    }
  }
  async _fetchAndRefineFeatures(e, t, n) {
    const a = new E([], e, !1, null), s = Math.min(t, e.length);
    await this._parent?._getFeatures(a, -1, s, n), this._checkCancelled(n);
    const i = [];
    for (let l = 0; l < s; l++) {
      const c = this._parent._featureFromCache(e[l]);
      i.push(await this.executeSpatialRelationTest(c));
    }
  ...
  async _getFilteredSet(e, t, n, a, s) {
    ...
    let l;
    return this._checkCancelled(s), l = t !== null ? new E(i._candidates.slice().concat(i._known.slice()), [], i._ordered, this._clonePageDefinition(i.pagesDefinition)) : new E(i._candidates.slice(), i._known.slice(), i._ordered, this._clonePageDefinition(i.pagesDefinition)), l;
  }
  async _stat(e, t, n, a, s, i, l) {
    if (n !== "") return { calculated: !1 };
    const c = await this._parent._stat(e, t, this._relation !== "esriSpatialRelRelation" ? this._relation : this._relation + ":" + this._relationString, this._relationGeom, s, i, l);
    return c.calculated === !1 ? s === null && n === "" && a === null ? this._manualStat(e, t, i, l) : { calculated: !1 } : c;
  }
  async _canDoAggregates(e, t, n, a, s) {
...
//# sourceMappingURL=SpatialFilter-Ci_Ol7eq.js.map
