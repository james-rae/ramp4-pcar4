import { F as $e, pF as Z, pG as Ie, bs as P, bv as $, bw as le, bD as l, bJ as r, g5 as x, bK as K, bL as Y, g6 as R, kw as pe, gb as M, bF as E, jO as oe, by as T, bA as B, bI as j, bH as ie, k9 as ve, bt as U, nT as ne, g9 as Q, ga as q, bx as X, bB as V, bG as L, bu as ee, pH as he, ms as Te, kr as Se, pI as He, gd as W, bE as ae, bz as Ae, bC as ce, hV as ze, hW as Ce } from "./main-DZxT3i7S.js";
import { H as De } from "./hilight-defs-DzKgjtLG.js";
import { T as Ee } from "./toggle-switch-control-D4Fc8-af.js";
class Me {
  id;
  name;
  template;
...
const Ne = {
...
}), Je = /* @__PURE__ */ oe(Ke, [["__scopeId", "data-v-496d788d"]]), We = ["content"], Ye = { class: "symbologyLayerName truncate" }, Qe = /* @__PURE__ */ P({
  ...
  setup(h, { emit: e }) {
    ...
    }, g = e, p = h, v = $(""), f = $([]), c = $(!1), a = $(!1), m = (b) => s.getLayerByUid(b), S = (b) => {
  ...
  setup(h) {
    const e = ne(), t = h, s = ee("iApi"), i = $([]), u = Z(), { t: d } = U(), g = $(""), p = $("none"), v = $(), f = () => e.getLayerByUid(t.uid), c = T(() => u.properties), a = T(() => u.defaultTemplates), m = T(() => f()?.supportsFeatures ?? !1), S = T(() => f()?.mapLayer ?? !1), F = T(() => {
      const o = f()?.nameField;
  ...
  setup(h) {
    ...
    }, i = ee("iApi"), u = Z(), d = ne(), g = h, { t: p } = U(), v = $(!1), f = $(i.fixture.get("details")), c = $(!0), a = $(!1), m = $(0), S = $(20), F = $([]), C = $([]), y = T(() => u.activeGreedy), H = T(() => u.properties), b = T(() => m.value + S.value), N = () => d.getLayerByUid(g.uid), O = () => g.results.find((n) => n.uid === g.uid), z = T(() => O()?.loaded ?? !1), A = T(() => O()?.requestTime), o = T(
    ...
    return le(() => {
      F.value.push(
        i.event.on(W.LAYER_REMOVE, (n) => {
          const w = i.panel.get("details");
          g.uid === n.uid && w && w.close();
        })
      ), F.value.push(
        i.event.on(W.PANEL_CLOSED, (n) => {
          n.id === "details" && _e();
        })
      ), F.value.push(
        i.event.on(W.PANEL_MINIMIZED, (n) => {
          n.id === "details" && be();
        })
      ), F.value.push(
        i.event.on(W.MAP_BASEMAPCHANGE, (n) => {
        ...
        v.value ? (l(), r("div", Ht, [
          I().length > 0 ? (l(), r("div", At, [
            a.value ? j((l(), r("div", {
              ...
              (l(!0), r(K, null, Y(I().slice(m.value, b.value), (J, de) => j((l(), r("button", {
  ...
  setup(h) {
    const { t: e } = U(), t = ee("iApi"), s = Z(), i = $([]), u = $([]), d = $([]), g = $(!1), p = $(""), v = T(() => s.activeGreedy), f = T(() => s.payload), c = T(() => s.properties), a = (y) => {
      p.value = y;
...
//# sourceMappingURL=index-DuAJQKFJ.js.map
