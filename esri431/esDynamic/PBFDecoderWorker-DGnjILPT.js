import { io as d, b1 as c, ay as p, ip as f, dH as m, iq as y, ir as _, is as g } from "./main-DZxT3i7S.js";
let b = class {
  constructor(t, e, s) {
...
function C(r, t, e, s) {
  if (t?.size && e != null && r) for (const i in r) {
    if (!t.has(i)) continue;
    const n = r[i];
    typeof n == "string" && n.length > e && (s(i), r[i] = "");
  }
}
function G(r, t) {
  return t;
...
function l(r, t, e, s) {
  switch (e) {
    case 0:
      return h(r, t + s, 0);
    case 1:
      return r.originPosition === "lowerLeft" ? h(r, t + s, 1) : M(r, t + s, 1);
  }
}
function u(r, t, e, s) {
  return e === 2 ? h(r, t, 2) : l(r, t, e, s);
}
function A(r, t, e, s) {
  return e === 2 ? h(r, t, 3) : l(r, t, e, s);
}
function v(r, t, e, s) {
  return e === 3 ? h(r, t, 3) : u(r, t, e, s);
}
function h({ translate: r, scale: t }, e, s) {
  return r[s] + e * t[s];
}
function M({ translate: r, scale: t }, e, s) {
  return r[s] - e * t[s];
}
class T {
  constructor(t) {
  ...
  addField(t, e) {
    ...
    const s = t.fields.map((i) => i.name);
    this._attributesConstructor = function() {
      for (const i of s) this[i] = null;
    };
  }
  addFeature(t, e) {
    const s = this._options.maxStringAttributeLength, i = this._options.maxStringAttributeFields;
    C(e.attributes, i, s, (n) => {
      const o = e.attributes[t.objectIdFieldName];
      o != null && this._missingAttributes.push({ objectId: o, attribute: n });
    }), t.features.push(e);
  }
  addQueryGeometry(t, e) {
    const { queryGeometry: s, queryGeometryType: i } = e, n = f(s.clone(), s, !1, !1, this._transform), o = m(n, i, !1, !1);
    let a = null;
    switch (i) {
    ...
    o.type = a, t.queryGeometryType = i, t.queryGeometry = o;
  }
  prepareFeatures(t) {
    switch (this._transform = t.transform ?? null, this._options.applyTransform && t.transform && (this._applyTransform = this._deriveApplyTransform(t)), this._vertexDimension = 2, t.hasZ && this._vertexDimension++, t.hasM && this._vertexDimension++, t.geometryType) {
      case "point":
        this.addCoordinate = (e, s, i) => this.addCoordinatePoint(e, s, i), this.createGeometry = (e) => this.createPointGeometry(e);
        break;
      case "polygon":
        this.addCoordinate = (e, s, i) => this._addCoordinatePolygon(e, s, i), this.createGeometry = (e) => this._createPolygonGeometry(e);
        break;
      case "polyline":
        this.addCoordinate = (e, s, i) => this._addCoordinatePolyline(e, s, i), this.createGeometry = (e) => this._createPolylineGeometry(e);
        break;
      case "multipoint":
        this.addCoordinate = (e, s, i) => this._addCoordinateMultipoint(e, s, i), this.createGeometry = (e) => this._createMultipointGeometry(e);
        break;
      case "mesh":
      case "extent":
        break;
  ...
  addCoordinatePoint(t, e, s) {
    const i = this._transform ? this._applyTransform(this._transform, e, s, 0) : e;
    if (i != null) switch (s) {
      case 0:
        t.x = i;
        break;
  ...
  _addCoordinateMultipoint(t, e, s) {
    s === 0 && t.points.push([]);
    const i = this._transformPathLikeValue(e, s);
...
class R {
  _parseFeatureQuery(t) {
    const e = new T(t.options), s = g(t.buffer, e), i = { ...s, spatialReference: s.spatialReference?.toJSON(), fields: s.fields ? s.fields.map((n) => n.toJSON()) : void 0, missingAttributes: e.missingAttributes };
...
//# sourceMappingURL=PBFDecoderWorker-DGnjILPT.js.map
