import { z as U4 } from "./main-DZxT3i7S.js";
function _4(P2, U2) {
  for (var _2 = 0; _2 < U2.length; _2++) {
    const v2 = U2[_2];
    if (typeof v2 != "string" && !Array.isArray(v2)) {
      for (const d2 in v2) if (d2 !== "default" && !(d2 in P2)) {
        const h2 = Object.getOwnPropertyDescriptor(v2, d2);
        h2 && Object.defineProperty(P2, d2, h2.get ? h2 : { enumerable: !0, get: () => v2[d2] });
      }
    }
  }
  return Object.freeze(Object.defineProperty(P2, Symbol.toStringTag, { value: "Module" }));
}
var w1, y1 = { exports: {} };
function F4() {
  return w1 || (w1 = 1, P2 = y1, U2 = typeof document < "u" && document.currentScript ? document.currentScript.src : void 0, _2 = function(v2 = {}) {
    var d2, h2, R = v2;
    R.ready = new Promise((p, E) => {
      d2 = p, h2 = E;
    });
    var M0 = Object.assign({}, R), P0 = typeof window == "object", Z2 = typeof importScripts == "function";
    typeof process == "object" && typeof process.versions == "object" && process.versions.node;
    var b0, l2 = "";
    function m1(p) {
      return R.locateFile ? R.locateFile(p, l2) : l2 + p;
    }
    (P0 || Z2) && (Z2 ? l2 = self.location.href : typeof document < "u" && document.currentScript && (l2 = document.currentScript.src), U2 && (l2 = U2), l2 = l2.indexOf("blob:") !== 0 ? l2.substr(0, l2.replace(/[?#].*/, "").lastIndexOf("/") + 1) : "", Z2 && (b0 = (p) => {
      var E = new XMLHttpRequest();
      return E.open("GET", p, !1), E.responseType = "arraybuffer", E.send(null), new Uint8Array(E.response);
    }));
    var F2, g1 = R.print || console.log.bind(console), B2 = R.printErr || console.error.bind(console);
    Object.assign(R, M0), M0 = null, R.arguments && R.arguments, R.thisProgram && R.thisProgram, R.quit && R.quit, R.wasmBinary && (F2 = R.wasmBinary);
    var Q2, w2 = { Memory: function(p) {
      this.buffer = new ArrayBuffer(65536 * p.initial);
    }, Module: function(p) {
    }, Instance: function(p, E) {
      this.exports = function(Q) {
        function U(K) {
          return K.set = function(N, t2) {
            this[N] = t2;
          }, K.get = function(N) {
            return this[N];
          }, K;
        ...
        function x(K, N, t2) {
          for (var a2, d, n2 = 0, i = N, w = t2.length, L2 = N + (3 * w >> 2) - (t2[w - 2] == "=") - (t2[w - 1] == "="); n2 < w; n2 += 4) a2 = H[t2.charCodeAt(n2 + 1)], d = H[t2.charCodeAt(n2 + 2)], K[i++] = H[t2.charCodeAt(n2)] << 2 | a2 >> 4, i < L2 && (K[i++] = a2 << 4 | d >> 2), i < L2 && (K[i++] = d << 6 | H[t2.charCodeAt(n2 + 3)]);
        }
        function e2(K) {
        ...
        H[43] = 62, H[47] = 63;
        var p2 = new ArrayBuffer(16), X2 = new Int32Array(p2), i0 = new Float64Array(p2);
        function c2(K) {
          return X2[K];
        }
        function Z0(K, N) {
        ...
        function $1(K) {
          var N = K.a, t2 = N.a, a2 = t2.buffer;
          t2.grow = P4;
          var d = new Int8Array(a2), n2 = new Int16Array(a2), i = new Int32Array(a2), w = new Uint8Array(a2), L2 = new Uint16Array(a2), f0 = new Uint32Array(a2), c = new Float32Array(a2), q = new Float64Array(a2), L = Math.imul, u = Math.fround, X1 = Math.abs, s2 = Math.clz32, S2 = N.b, a0 = N.c, z0 = N.d, J0 = N.e, i4 = N.f, f4 = N.g, a4 = N.h, n4 = N.i, _ = 36704, W = 0, r2 = 0;
          function j(n) {
                ...
                a: {
                  n: {
                    e: {
                          ...
                          o: {
                            b: {
                              if ((n |= 0) >>> 0 <= 244) {
                                ...
                                if (f) {
                                  f = 3456 + (n = (e = t0((0 - (n = 2 << a) | n) & f << a)) << 3) | 0, t = i[n + 3464 >> 2], (0 | f) != (0 | (n = i[t + 8 >> 2])) ? (i[n + 12 >> 2] = f, i[f + 8 >> 2] = n) : (o = i2(e) & o, i[854] = o), i[t + 4 >> 2] = 3 | k, e = (n = e << 3) - k | 0, i[4 + (a = t + k | 0) >> 2] = 1 | e, i[n + t >> 2] = e, A && (f = 3456 + (-8 & A) | 0, b = i[859], (n = 1 << (A >>> 3)) & o ? n = i[f + 8 >> 2] : (i[854] = n | o, n = f), i[f + 8 >> 2] = b, i[n + 12 >> 2] = b, i[b + 12 >> 2] = f, i[b + 8 >> 2] = n), n = t + 8 | 0, i[859] = a, i[856] = e;
                                  break i;
                                }
                                if (!(r = i[855])) break b;
                                for (a = i[3720 + (t0(r) << 2) >> 2], t = (-8 & i[a + 4 >> 2]) - k | 0, f = a; (n = i[f + 16 >> 2]) || (n = i[f + 20 >> 2]); ) t = (e = (f = (-8 & i[n + 4 >> 2]) - k | 0) >>> 0 < t >>> 0) ? f : t, a = e ? n : a, f = n;
                            ...
                            b: {
                                  ...
                                  c: {
                                    A: {
                                      r: {
                                        ...
                                        if ((0 | (a = H2(0))) == -1 || (o = f, (n = (e = i[973]) - 1 | 0) & a && (o = (f - a | 0) + (n + a & 0 - e) | 0), o >>> 0 <= k >>> 0) || (e = i[964]) && e >>> 0 < (b = (n = i[962]) + o | 0) >>> 0 | n >>> 0 >= b >>> 0) break k;
                                        if ((0 | a) != (0 | (n = H2(o)))) break A;
                                        break b;
                                      }
                                      if ((0 | (a = H2(o = b & o - s))) == (i[n >> 2] + i[n + 4 >> 2] | 0)) break c;
                                      n = a;
                                    }
                                    if ((0 | n) == -1) break k;
                                    if (k + 48 >>> 0 <= o >>> 0) {
                                    ...
                                    if ((0 | H2(a = (a = i[974]) + (t - o | 0) & 0 - a)) == -1) break k;
                                    o = a + o | 0, a = n;
                                    break b;
                                  }
                                  if ((0 | a) != -1) break b;
                              ...
                              if ((0 | (a = H2(f))) == -1 | (0 | (n = H2(0))) == -1 | n >>> 0 <= a >>> 0 || (o = n - a | 0) >>> 0 <= k + 40 >>> 0) break n;
                            }
                            n = i[962] + o | 0, i[962] = n, n >>> 0 > f0[963] && (i[963] = n);
                            b: {
                              if (t = i[860]) {
                                for (n = 3864; ; ) {
                      ...
                      f0[858] > a >>> 0 && (i[858] = a), f = a + o | 0, n = 3864;
                      t: {
                        u: {
                          o: {
                            for (; ; ) {
          ...
          function N0(n, f) {
            ...
            _ = s = _ - 144 | 0, Y = i[i[i[f + 4 >> 2] + 8 >> 2] >> 2], T = i[Y >> 2], I = i[T + 16 >> 2], S = i[i[T + 4 >> 2] + 16 >> 2], P = i[f >> 2], g = i[i[P + 4 >> 2] + 16 >> 2], y = i[P + 16 >> 2], z(g, i[n + 72 >> 2], y) > u(0) && (a = c[g + 28 >> 2], b = c[g + 32 >> 2], e = i[n + 72 >> 2], t = c[e + 28 >> 2], k = c[e + 32 >> 2], A = c[y + 28 >> 2], q[s + 40 >> 3] = c[y + 32 >> 2], q[s + 32 >> 3] = A, q[s + 24 >> 3] = k, q[s + 16 >> 3] = t, q[s + 8 >> 3] = b, q[s >> 3] = a, v1(1098, s));
            i: {
              f: {
                a: if ((0 | y) != (0 | I) && (k = (a = c[y + 32 >> 2]) <= (b = c[g + 32 >> 2]) ? a : b, b = c[I + 32 >> 2], !(k > ((t = c[S + 32 >> 2]) <= b ? b : t)))) {
                  n: {
                    if (!(!((t = c[y + 28 >> 2]) < (k = c[I + 28 >> 2])) & (!(a <= b) | t != k))) {
                      if (!(z(S, y, I) > u(0))) break n;
                      break a;
                    }
                    if (z(g, I, y) < u(0)) break a;
                  }
                  ...
                  n: if ((t = c[l + 28 >> 2]) > b | t == b & c[m + 32 >> 2] <= c[l + 32 >> 2]) if (!((A = c[v + 28 >> 2]) > t) & (!(c[l + 32 >> 2] <= c[v + 32 >> 2]) | t != A)) if (a = z(e, m, l), t = z(e, v, l), b = c[m + 28 >> 2], (k = (a = (o = u(a - t) < u(0)) ? u(-a) : a) < u(0) ? u(0) : a) <= (t = (a = o ? t : u(-t)) < u(0) ? u(0) : a)) {
                    ...
                    n: {
                      e: {
                        if (!((b = c[o + 28 >> 2]) == c[g + 28 >> 2] & c[g + 32 >> 2] == c[o + 32 >> 2])) {
                          if (z(g, o, s + 56 | 0) >= u(0)) break e;
                          o = i[n + 72 >> 2], b = c[o + 28 >> 2];
                        }
                        if (b == c[S + 28 >> 2] & c[S + 32 >> 2] == c[o + 32 >> 2] || !(z(S, o, s + 56 | 0) <= u(0))) break n;
                      }
                      if ((0 | (e = i[n + 72 >> 2])) == (0 | S)) {
                        ...
                        o = i[i[i[f + 4 >> 2] + 8 >> 2] >> 2], e = i[o >> 2], Y2(n, o, Y), f2 = 1, M2(n, f, i[i[e + 4 >> 2] + 12 >> 2], e, e, 1);
                        break a;
                      }
                      if ((0 | e) == (0 | g)) {
                        if (!o2(i[T + 4 >> 2]) || !Z(i[P + 12 >> 2], i[i[T + 4 >> 2] + 12 >> 2])) break i;
                        for (o = i[i[i[f >> 2] + 4 >> 2] + 16 >> 2], e = f; e = i[i[i[e + 4 >> 2] + 4 >> 2] >> 2], (0 | o) == i[i[i[e >> 2] + 4 >> 2] + 16 >> 2]; ) ;
                        o = i[i[i[i[i[i[e + 4 >> 2] + 8 >> 2] >> 2] >> 2] + 4 >> 2] + 8 >> 2], i[f >> 2] = i[i[T + 4 >> 2] + 12 >> 2], f2 = 1, M2(n, e, i[Y2(n, f, 0) + 8 >> 2], i[i[P + 4 >> 2] + 8 >> 2], o, 1);
                        break a;
                      }
                      if (z(g, e, s + 56 | 0) >= u(0)) {
          ...
          function e4(n, f, a, e, t, b) {
            ...
            if ((r = i[544]) || (r = j(16), i[544] = r), i[r + 8 >> 2] = b, i[r + 4 >> 2] = 0, i[r + 12 >> 2] = e, i[r >> 2] = t, (r = i[545]) || ((t = j(1900)) ? (i[t + 100 >> 2] = 12, i[t + 96 >> 2] = 13, i[t + 92 >> 2] = 14, i[t + 88 >> 2] = 15, n2[t + 80 >> 1] = 0, i[t + 52 >> 2] = 0, i[t + 56 >> 2] = 100130, i[t + 16 >> 2] = 0, i[t + 20 >> 2] = 0, i[t >> 2] = 0, i[t + 1896 >> 2] = 0, i[t + 1736 >> 2] = 10, i[t + 1732 >> 2] = 11, i[t + 1728 >> 2] = 6, i[t + 1724 >> 2] = 5, i[t + 1720 >> 2] = 4, i[t + 1716 >> 2] = 3, i[t + 104 >> 2] = 16, i[t + 76 >> 2] = 17, i[t + 12 >> 2] = 18, i[t + 24 >> 2] = 0) : t = 0, i[545] = t, T2(t, 100107, 31), T2(i[545], 100100, 32), T2(i[545], 100102, 33), T2(i[545], 100105, 34), T2(i[545], 100103, 35), T2(i[545], 100104, 36), i[i[545] + 56 >> 2] = 100130, t = i[545], c[t + 16 >> 2] = 0, c[t + 24 >> 2] = 1, c[t + 20 >> 2] = 0, r = i[545]), t = 0, b = i[544], i[r >> 2] && m2(r, 0), i[r + 112 >> 2] = 0, i[r >> 2] = 1, d[r + 108 | 0] = 0, i[r + 1896 >> 2] = b, i[r + 8 >> 2] = 0, (0 | a) > 0) for (b = 0; ; ) {
              if (I = i[(b << 2) + f >> 2], o = i[545], i[o >> 2] != 1 && m2(o, 1), i[o >> 2] = 2, i[o + 4 >> 2] = 0, i[o + 112 >> 2] > 0 && (d[o + 108 | 0] = 1), r = 0, (0 | I) > 0) for (; ; ) {
                A = i[545], i[A >> 2] != 2 && m2(A, 2), v = (L(t + r | 0, e) << 2) + n | 0;
                i: {
                  f: {
                    if (w[A + 108 | 0]) {
                      if (!A0(A)) {
                    ...
                    if (P = (m = +(h = (S = (m = +(l = c[v + 4 >> 2])) < -1e37) ? u(-9999999933815813e21) : l)) > 1e37, s = (g = +(y = (M = (g = +(l = c[v >> 2])) < -1e37) ? u(-9999999933815813e21) : l)) > 1e37, ((o = +(l = c[v + 8 >> 2]) < -1e37) | (k = +(l = o ? u(-9999999933815813e21) : l) > 1e37) | S | m > 1e37 || g > 1e37 || M) && ((0 | (o = i[A + 1732 >> 2])) == 11 ? C[i[A + 12 >> 2]](100155) : C[0 | o](100155, i[A + 1896 >> 2])), h = P ? u(9999999933815813e21) : h, y = s ? u(9999999933815813e21) : y, !i[A + 8 >> 2]) {
                      if ((0 | (o = i[A + 112 >> 2])) <= 99) {
                  ...
                  C[0 | k](100902, i[A + 1896 >> 2]);
                }
                if ((0 | I) == (0 | (r = r + 1 | 0))) break;
              }
              if (o = i[545], i[o >> 2] != 2 && m2(o, 2), i[o >> 2] = 1, t = t + I | 0, (0 | (b = b + 1 | 0)) == (0 | a)) break;
            }
            s = i[545], n = j(40), i[n >> 2] = 0, k = c1(t = s + 1740 | 0, 1, n, 4), o = W, n = 0;
            i: {
              f: {
                for (; ; ) {
                  if (n) {
                    if ((0 | (f = i[s + 1732 >> 2])) != 11) {
                      if (n = i[s + 1896 >> 2], i[978] = 0, S2(0 | f, 100902, 0 | n), n = i[978], i[978] = 0, f = -1, n && (e = i[979])) {
                    ...
                    if (n = i[s + 12 >> 2], i[978] = 0, J0(0 | n, 100902), n = i[978], i[978] = 0, f = -1, n && (e = i[979])) {
                      if (!(f = X(i[n >> 2], k, o))) break f;
                      W = e;
                    }
                    if (n = W, (0 | f) == 1) continue;
                  ...
                  if (i[s >> 2] != 1) {
                    if (i[978] = 0, S2(19, 0 | s, 1), n = i[978], i[978] = 0, f = -1, n && (e = i[979])) {
                      if (!(f = X(i[n >> 2], k, o))) break f;
                      W = e;
                    }
                    if (n = W, (0 | f) == 1) continue;
                  ...
                  if (i[s >> 2] = 0, !i[s + 8 >> 2]) {
                    if (!(w[s + 80 | 0] | i[s + 104 >> 2] != 16)) {
                      if (i[978] = 0, a = 0 | a0(20, 0 | s), n = i[978], i[978] = 0, f = -1, n && (e = i[979])) {
                        if (!(f = X(i[n >> 2], k, o))) break f;
                        W = e;
                      }
                      if (n = W, (0 | f) == 1) continue;
                    ...
                    if (i[978] = 0, a = 0 | a0(21, 0 | s), n = i[978], i[978] = 0, f = -1, n && (e = i[979])) {
                      if (!(f = X(i[n >> 2], k, o))) break f;
                      W = e;
                    }
                    if (n = W, (0 | f) == 1) continue;
                    if (!a) {
                      if (i[978] = 0, S2(22, 0 | t, 1), n = i[978], i[978] = 0, n && (e = i[979])) {
                  ...
                  if (i[978] = 0, K0(s), n = i[978], i[978] = 0, f = -1, n && (e = i[979])) {
                    if (!(f = X(i[n >> 2], k, o))) break f;
                    W = e;
                  }
                  if (n = W, (0 | f) != 1) {
                    if (i[978] = 0, a = 0 | a0(24, 0 | s), n = i[978], i[978] = 0, f = -1, n && (e = i[979])) {
                      if (!(f = X(i[n >> 2], k, o))) break f;
                      W = e;
                    }
                    if (n = W, (0 | f) != 1) if (a) {
                      ...
                      a: {
                        n: {
                          if (!w[s + 60 | 0]) {
                            if (w[s + 81 | 0] ? (i[978] = 0, a = 0 | n4(25, 0 | b, 1, 1)) : (i[978] = 0, a = 0 | a0(26, 0 | b)), n = i[978], i[978] = 0, f = -1, n && (e = i[979])) {
                              if (!(f = X(i[n >> 2], k, o))) break f;
                              W = e;
                            }
                            if (n = W, (0 | f) == 1) continue;
                            ...
                            if (i[s + 88 >> 2] != 15 | i[s + 100 >> 2] != 12 | i[s + 96 >> 2] != 13 | i[s + 92 >> 2] != 14 || i[s + 1716 >> 2] != 3 | i[s + 1728 >> 2] != 6 | i[s + 1724 >> 2] != 5 || i[s + 1720 >> 2] != 4) if (w[s + 81 | 0]) {
                              if (i[978] = 0, S2(27, 0 | s, 0 | b), n = i[978], i[978] = 0, f = -1, n && (e = i[979])) {
                                if (!(f = X(i[n >> 2], k, o))) break f;
                                W = e;
                              }
                              if (n = W, (0 | f) == 1) continue;
                            } else {
                              if (i[978] = 0, S2(28, 0 | s, 0 | b), n = i[978], i[978] = 0, f = -1, n && (e = i[979])) {
                                if (!(f = X(i[n >> 2], k, o))) break f;
                                W = e;
                              }
                              if (n = W, (0 | f) == 1) continue;
                            ...
                            if (i[s + 104 >> 2] != 16) {
                              if (i[978] = 0, i1(b), n = i[978], i[978] = 0, f = -1, n && (e = i[979])) {
                                if (!(f = X(i[n >> 2], k, o))) break f;
                                W = e;
                              }
                              if (n = W, (0 | f) == 1) continue;
                              if (n = i[s + 104 >> 2], i[978] = 0, J0(0 | n, 0 | b), n = i[978], i[978] = 0, f = -1, !n || !(e = i[979])) break a;
                              if (f = X(i[n >> 2], k, o)) break n;
                              break f;
                            }
                          }
                          if (i[978] = 0, h0(b), n = i[978], i[978] = 0, f = -1, n && (e = i[979])) {
                            if (!(f = X(i[n >> 2], k, o))) break f;
                            W = e;
                          }
                          if (n = W, (0 | f) == 1) continue;
          ...
          function t4(n, f, a, e, t, b) {
            n |= 0, f = +f, a |= 0, e |= 0, t |= 0, b |= 0;
            var o = 0, k = 0, s = 0, r = 0, A = 0, l = 0, v = 0, h = 0, y = 0, m = 0, g = 0, I = 0, S = 0, M = 0, P = 0, T = 0, O = 0, G = 0, Y = 0, f2 = 0, C2 = 0;
            _ = h = _ - 560 | 0, i[h + 44 >> 2] = 0, c0(+f), o = 0 | c2(1), c2(0), (0 | o) < 0 ? (M = 1, O = 1034, c0(+(f = -f)), o = 0 | c2(1), c2(0)) : 2048 & t ? (M = 1, O = 1037) : (O = (M = 1 & t) ? 1040 : 1035, Y = !M);
            i: if (2146435072 & ~o) {
              P = h + 16 | 0;
              f: {
                a: {
                  n: {
                    if (f = s1(f, h + 44 | 0), (f += f) != 0) {
                ...
                if ((0 | A) <= 0) e = A, o = k, s = m;
                  ...
                  if (r = (0 | e) >= 29 ? 29 : e, !(s >>> 0 > (o = k - 4 | 0) >>> 0)) {
                    for (y = 0; e = i[o >> 2], v = 31 & r, G = y, (63 & r) >>> 0 >= 32 ? (y = e << v, e = 0) : (y = (1 << v) - 1 & e >>> 32 - v, e <<= v), y = y + g | 0, f2 = o, C2 = (v = G + e | 0) - w0(y = a1(v, e >>> 0 > v >>> 0 ? y + 1 | 0 : y, 1e9), r2, 1e9, 0) | 0, i[f2 >> 2] = C2, s >>> 0 <= (o = o - 4 | 0) >>> 0; ) ;
                    y && (i[(s = s - 4 | 0) >> 2] = y);
                  }
                ...
                if (g = 1 + (!!(0 | y) + l | 0) | 0, (0 | (k = -33 & b)) != 70) {
                  if ((P - (o = W2(((o = e >> 31) ^ e) - o | 0, 0, P)) | 0) <= 1) for (; d[0 | (o = o - 1 | 0)] = 48, (P - o | 0) < 2; ) ;
                ...
                V(n, 32, a, g = e + M | 0, t), J(n, O, M), V(n, 48, a, g, 65536 ^ t);
                a: {
                  n: {
                    e: {
                      if ((0 | k) == 70) {
                        for (e = 8 | (b = h + 16 | 0), A = 9 | b, s = k = s >>> 0 > m >>> 0 ? m : s; ; ) {
                          ...
                          if (J(n, o, A - o | 0), !(m >>> 0 >= (s = s + 4 | 0) >>> 0)) break;
                        }
                        if (y && J(n, 1069, 1), (0 | l) <= 0 | s >>> 0 >= r >>> 0) break e;
                        for (; ; ) {
                          if ((o = W2(i[s >> 2], 0, A)) >>> 0 > h + 16 >>> 0) for (; d[0 | (o = o - 1 | 0)] = 48, h + 16 >>> 0 < o >>> 0; ) ;
                          if (J(n, o, (0 | l) >= 9 ? 9 : l), o = l - 9 | 0, r >>> 0 <= (s = s + 4 | 0) >>> 0) break n;
                          if (e = (0 | l) > 9, l = o, !e) break;
                        }
                        break n;
                      }
                      t: if (!((0 | l) < 0)) for (m = s >>> 0 < r >>> 0 ? r : s + 4 | 0, e = 8 | (b = h + 16 | 0), r = 9 | b, k = s; ; ) {
                        (0 | r) == (0 | (o = W2(i[k >> 2], 0, r))) && (d[h + 24 | 0] = 48, o = e);
                        u: if ((0 | k) == (0 | s)) J(n, o, 1), o = o + 1 | 0, A | l && J(n, 1069, 1);
                        else {
                          if (h + 16 >>> 0 >= o >>> 0) break u;
                          for (; d[0 | (o = o - 1 | 0)] = 48, h + 16 >>> 0 < o >>> 0; ) ;
                        }
                        if (J(n, o, (0 | (b = r - o | 0)) < (0 | l) ? b : l), l = l - b | 0, m >>> 0 <= (k = k + 4 | 0) >>> 0) break t;
                        if (!((0 | l) >= 0)) break;
                      }
                      V(n, 48, l + 18 | 0, 18, 0), J(n, S, P - S | 0);
                      break a;
                    }
                    o = l;
                  }
                ...
                V(n, 32, a, g, 8192 ^ t), v = (0 | a) < (0 | g) ? g : a;
                break i;
              }
              ...
              for ((0 | P) == (0 | (o = W2(((o = i[h + 44 >> 2]) ^ (k = o >> 31)) - k | 0, 0, P))) && (d[h + 15 | 0] = 48, o = h + 15 | 0), m = 2 | M, s = 32 & b, k = i[h + 44 >> 2], d[0 | (l = o - 2 | 0)] = b + 15, d[o - 1 | 0] = (0 | k) < 0 ? 45 : 43, o = 8 & t, k = h + 16 | 0; b = k, r = X1(f) < 2147483648 ? ~~f : -2147483648, d[0 | k] = s | w[r + 1600 | 0], !((0 | e) > 0 | o) & (f = 16 * (f - +(0 | r))) == 0 | ((k = b + 1 | 0) - (h + 16 | 0) | 0) != 1 || (d[b + 1 | 0] = 46, k = b + 2 | 0), f != 0; ) ;
              v = -1, (2147483645 - (b = (o = P - l | 0) + m | 0) | 0) < (0 | e) || (r = b, s = k - (b = h + 16 | 0) | 0, V(n, 32, a, k = r + (e = e && (s - 2 | 0) < (0 | e) ? e + 2 | 0 : s) | 0, t), J(n, A, m), V(n, 48, a, k, 65536 ^ t), J(n, b, s), V(n, 48, e - s | 0, 0, 0), J(n, l, o), V(n, 32, a, k, 8192 ^ t), v = (0 | a) < (0 | k) ? k : a);
            } else V(n, 32, a, o = M + 3 | 0, -65537 & t), J(n, O, M), e = 32 & b, J(n, f != f ? e ? 1053 : 1061 : e ? 1057 : 1065, 3), V(n, 32, a, o, 8192 ^ t), v = (0 | a) < (0 | o) ? o : a;
            return _ = h + 560 | 0, 0 | v;
          }
          function V0(n, f, a, e, t, b) {
            var o = 0, k = 0, s = 0, r = 0, A = 0, l = 0, v = 0, h = 0, y = 0, m = 0, g = 0, I = 0, S = 0, M = 0, P = 0, T = 0, O = 0, G = 0, Y = 0, f2 = 0, C2 = 0;
                    ...
                    e: for (; ; ) {
                      ...
                      t: for (; ; ) {
                        ...
                        u: {
                            ...
                            b: {
                              if (k = w[0 | (o = f)]) for (; ; ) {
                                k: {
                                  ...
                                  if (o = 0, A = -1, w[0 | k] == 46) if (w[k + 1 | 0] != 42) i[s + 76 >> 2] = k + 1, A = r1(s + 76 | 0), f = i[s + 76 >> 2], P = 1;
                                  else {
                                  ...
                                  c: {
                                    A: {
                                      r: {
                                                  ...
                                                  l: {
                                                    d: {
                                                      m: {
                                                        ...
                                                        if (f = I, (r = i[s + 64 >> 2]) | (k = i[s + 68 >> 2])) for (C2 = 32 & o; d[0 | (f = f - 1 | 0)] = C2 | w[1600 + (15 & r) | 0], T = !k & r >>> 0 > 15 | !!(0 | k), h = k, k = k >>> 4 | 0, r = (15 & h) << 28 | r >>> 4, T; ) ;
                                        ...
                                        for (o = 0; ; ) {
                                          if (r = i[k >> 2]) {
                                            if ((0 | (r = b1(s + 4 | 0, r))) < 0) break f;
                                            if (!(r >>> 0 > A - o >>> 0) && (k = k + 4 | 0, A >>> 0 > (o = o + r | 0) >>> 0)) continue;
                                          }
                                          break;
                                        }
                                        if (l = 61, (0 | o) < 0) break a;
                                        if (V(n, 32, g, o, v), o) for (l = 0, k = i[s + 64 >> 2]; ; ) {
                                          if (!(r = i[k >> 2]) || (l = (r = b1(A = s + 4 | 0, r)) + l | 0) >>> 0 > o >>> 0) break r;
                                          if (J(n, A, r), k = k + 4 | 0, !(o >>> 0 > l >>> 0)) break;
                                        }
                                        else o = 0;
                                      }
                                      V(n, 32, g, o, 8192 ^ v), o = (0 | o) < (0 | g) ? g : o;
                                      continue t;
                                    }
                                    if ((0 | A) < 0 & P) break n;
                                    if (l = 61, (0 | (o = 0 | C[0 | b](n, q[s + 64 >> 3], g, A, v, o))) >= 0) continue t;
                                    break a;
                                  }
                              ...
                              for (o = 1; ; ) {
                                if (n = i[(o << 2) + t >> 2]) {
                                  if (e1((o << 3) + e | 0, n, a), y = 1, (0 | (o = o + 1 | 0)) != 10) continue;
                                  break i;
                                }
                                break;
                              }
                          ...
                          V(n, 32, o, A, v), J(n, M, m), V(n, 48, o, A, 65536 ^ v), V(n, 48, f, k, 0), J(n, r, k), V(n, 32, o, A, 8192 ^ v), f = i[s + 76 >> 2];
                          continue;
                        }
                        break;
                      }
              ...
              f: if (h) {
                ...
                a: {
                  n: {
                    for (; ; ) {
                      if ((0 | e) != (0 | (a = i[a >> 2]))) {
                        if (f = f1(h, a), i[a + 36 >> 2] = f, (0 | f) != 2147483647) continue;
                        break n;
                      }
                      break;
                    }
                ...
                if (k1(n, u(-3999999973526325e22)), k1(n, u(3999999973526325e22)), f = d0(i[n + 68 >> 2])) for (; ; ) {
                  a: if (a = u1(i[n + 68 >> 2])) for (; ; ) {
                    if (c[a + 28 >> 2] != c[f + 28 >> 2] | c[a + 32 >> 2] != c[f + 32 >> 2]) break a;
                    if (t = i[d0(i[n + 68 >> 2]) + 8 >> 2], e = i[f + 8 >> 2], i[o + 24 >> 2] = 0, i[o + 28 >> 2] = 0, i[o + 16 >> 2] = 0, i[o + 20 >> 2] = 0, i[o + 8 >> 2] = 0, i[o + 12 >> 2] = 0, i[o >> 2] = 1056964608, i[o + 4 >> 2] = 1056964608, a = i[e + 16 >> 2], i[o + 16 >> 2] = i[a + 12 >> 2], i[o + 20 >> 2] = i[i[t + 16 >> 2] + 12 >> 2], c[o + 36 >> 2] = c[a + 16 >> 2], c[o + 40 >> 2] = c[a + 20 >> 2], c[o + 44 >> 2] = c[a + 24 >> 2], i[a + 12 >> 2] = 0, b = a + 12 | 0, (0 | (a = i[n + 1736 >> 2])) == 10 ? C[i[n + 76 >> 2]](o + 36 | 0, o + 16 | 0, o, b) : C[0 | a](o + 36 | 0, o + 16 | 0, o, b, i[n + 1896 >> 2]), i[b >> 2] || (i[b >> 2] = i[o + 16 >> 2]), !Z(e, t)) break i;
                    if (!(a = u1(i[n + 68 >> 2]))) break;
                  }
                  if (n0(n, f), !(f = d0(i[n + 68 >> 2]))) break;
                }
                for (a = i[i[i[n + 64 >> 2] + 4 >> 2] >> 2], i[n + 72 >> 2] = i[i[a >> 2] + 16 >> 2]; i[i[a >> 2] + 24 >> 2] = 0, g2(i[a + 4 >> 2]), B(a), f = i[n + 64 >> 2], a = i[i[f + 4 >> 2] >> 2]; ) ;
                if ((0 | f) != (0 | (a = i[f + 4 >> 2]))) for (; B(a), (0 | f) != (0 | (a = i[a + 4 >> 2])); ) ;
                if (B(f), p0(i[n + 68 >> 2]), P = 1, f = i[n + 8 >> 2], (0 | (n = i[f + 40 >> 2])) != (0 | (a = f + 40 | 0))) for (; ; ) {
            ...
            i: {
              f: {
                a: {
                  ...
                  for (i[v >> 2] = i[t + 4 >> 2], t = a = i[n + 64 >> 2]; t = i[t + 4 >> 2], (e = i[t >> 2]) && !(0 | C[i[a + 16 >> 2]](i[a + 12 >> 2], v, e)); ) ;
                  if (e = i[t >> 2], t = i[i[i[e + 4 >> 2] + 8 >> 2] >> 2], k = i[t >> 2], b = i[e >> 2], z(i[i[b + 4 >> 2] + 16 >> 2], f, i[b + 16 >> 2]) == u(0)) {
                    ...
                    if (t = i[i[i[e + 4 >> 2] + 8 >> 2] >> 2], k = i[t >> 2], b = i[k + 4 >> 2], a = i[b + 8 >> 2], w[t + 15 | 0]) {
                      if (i[k + 24 >> 2] = 0, g2(i[t + 4 >> 2]), B(t), !$(b)) break i;
                      b = i[i[a + 4 >> 2] + 12 >> 2];
                    }
                    if (!Z(i[f + 8 >> 2], b)) break i;
                    s = i[b + 8 >> 2], t = i[i[a + 4 >> 2] + 16 >> 2], o = c[t + 28 >> 2], k = i[a + 16 >> 2], M2(n, e, s, a, f = o < (r = c[k + 28 >> 2]) | o == r & c[t + 32 >> 2] <= c[k + 32 >> 2] ? a : 0, 1);
                    break f;
                  }
                  if (s = w[e + 12 | 0], k = i[k + 4 >> 2], A = i[k + 16 >> 2], o = c[A + 28 >> 2], l = i[i[b + 4 >> 2] + 16 >> 2], a = e, o < (r = c[l + 28 >> 2]) || o == r && (a = e, c[A + 32 >> 2] <= c[l + 32 >> 2]) || (a = t), s | w[a + 15 | 0]) {
                    ...
                    if (w[a + 15 | 0]) {
                      if ($(i[a >> 2])) {
                        i[a >> 2] = t, d[a + 15 | 0] = 0, i[t + 24 >> 2] = a, n0(n, f);
                        break f;
                      }
                      break i;
                    }
                    if (!(a = j(16)) || (i[a >> 2] = t, e = y0(i[n + 64 >> 2], i[e + 4 >> 2], a), i[a + 4 >> 2] = e, !e)) break i;
                ...
                if (w[e + 15 | 0] && (!(f = A2(i[i[i[i[i[e + 4 >> 2] + 8 >> 2] >> 2] >> 2] + 4 >> 2], i[a + 12 >> 2])) || !$(i[e >> 2]) || (i[e >> 2] = f, d[e + 15 | 0] = 0, i[f + 24 >> 2] = e, !(e = i[i[i[e + 4 >> 2] + 4 >> 2] >> 2]))))
                  break i;
                if (f = i[i[i[e + 4 >> 2] + 8 >> 2] >> 2], a = i[f >> 2], f = Y2(n, f, 0), (0 | a) != (0 | (t = i[f + 8 >> 2]))) M2(n, e, t, a, a, 1);
                else {
                  if (t = i[e >> 2], A = i[i[i[e + 4 >> 2] + 8 >> 2] >> 2], k = i[A >> 2], i[i[t + 4 >> 2] + 16 >> 2] != i[i[k + 4 >> 2] + 16 >> 2] && N0(n, e), l = 1, b = i[n + 72 >> 2], o = c[b + 28 >> 2], s = i[t + 16 >> 2], !(o != c[s + 28 >> 2] | c[s + 32 >> 2] != c[b + 32 >> 2])) {
                    ...
                    if (w[e + 15 | 0] && (!(a = A2(i[i[i[i[i[e + 4 >> 2] + 8 >> 2] >> 2] >> 2] + 4 >> 2], i[b + 12 >> 2])) || !$(i[e >> 2]) || (i[e >> 2] = a, d[e + 15 | 0] = 0, i[a + 24 >> 2] = e, !(e = i[i[i[e + 4 >> 2] + 4 >> 2] >> 2]))))
                      break i;
                    b = i[i[i[e + 4 >> 2] + 8 >> 2] >> 2], a = i[b >> 2], Y2(n, b, A), b = i[n + 72 >> 2], o = c[b + 28 >> 2], l = 0;
                  }
                  a: {
          ...
          function K0(n) {
            n |= 0;
            var f = 0, a = 0, e = 0, t = u(0), b = u(0), o = 0, k = 0, s = u(0), r = 0, A = u(0), l = u(0), v = 0, h = 0, y = u(0), m = u(0), g = u(0), I = u(0), S = u(0), M = u(0), P = u(0), T = u(0), O = u(0), G = u(0), Y = u(0), f2 = 0, C2 = 0, m0 = 0, g0 = 0, E0 = 0, C0 = 0, R0 = 0, I0 = 0, S0 = u(0);
            h = i[n + 8 >> 2], f = _ - 80 | 0, I = c[n + 16 >> 2], c[f + 8 >> 2] = I, S = c[n + 20 >> 2], c[f + 12 >> 2] = S, M = c[n + 24 >> 2], c[f + 16 >> 2] = M, r = i[h >> 2];
            i: if (C2 = I == u(0) & S == u(0) & M == u(0)) {
              if (i[f + 76 >> 2] = -42943038, i[f + 68 >> 2] = -42943038, i[f + 72 >> 2] = -42943038, i[f + 64 >> 2] = 2104540610, i[f + 56 >> 2] = 2104540610, i[f + 60 >> 2] = 2104540610, (0 | h) != (0 | r)) {
                for (g = u(19999999867631625e21), O = u(-19999999867631625e21), P = u(-19999999867631625e21), T = u(19999999867631625e21), G = u(-19999999867631625e21), Y = u(19999999867631625e21), A = u(-19999999867631625e21), s = u(19999999867631625e21), y = u(-19999999867631625e21), b = u(19999999867631625e21), l = u(-19999999867631625e21), m = u(19999999867631625e21), a = r; A = (e = (t = c[a + 24 >> 2]) > A) ? t : A, O = e ? t : O, s = (v = t < s) ? t : s, g = v ? t : g, y = (k = (t = c[a + 20 >> 2]) > y) ? t : y, P = k ? t : P, b = (f2 = b > t) ? t : b, T = f2 ? t : T, l = (o = (t = c[a + 16 >> 2]) > l) ? t : l, G = o ? t : G, m0 = o ? a : m0, m = (o = t < m) ? t : m, Y = o ? t : Y, g0 = o ? a : g0, E0 = e ? a : E0, C0 = v ? a : C0, R0 = k ? a : R0, I0 = f2 ? a : I0, (0 | h) != (0 | (a = i[a >> 2])); ) ;
                i[f + 20 >> 2] = g0, c[f + 56 >> 2] = Y, c[f + 68 >> 2] = G, i[f + 32 >> 2] = m0, c[f + 60 >> 2] = T, i[f + 24 >> 2] = I0, c[f + 72 >> 2] = P, i[f + 36 >> 2] = R0, c[f + 64 >> 2] = g, i[f + 28 >> 2] = C0, c[f + 76 >> 2] = O, i[f + 40 >> 2] = E0, s = u(A - s), A = u(l - m), b = u(y - b);
              ...
              if (a = 2, e = (k = b > A) << 2, v = k, o = f + 56 | 0, v = u(c[(k = f + 68 | 0) + e >> 2] - c[o + e >> 2]) < s ? 2 : v, c[(e = v << 2) + o >> 2] >= c[e + k >> 2]) i[f + 8 >> 2] = 0, i[f + 12 >> 2] = 0;
                ...
                if (a = i[(e = v << 2) + (f + 20 | 0) >> 2], e = i[e + (f + 32 | 0) >> 2], G = c[e + 16 >> 2], g = u(c[a + 16 >> 2] - G), c[f + 44 >> 2] = g, Y = c[e + 20 >> 2], l = u(c[a + 20 >> 2] - Y), c[f + 48 >> 2] = l, S0 = c[e + 24 >> 2], m = u(c[a + 24 >> 2] - S0), O = u(-g), (0 | h) != (0 | r)) {
                  for (T = u(-l), P = u(-m), b = u(0), a = r; s = u(c[a + 20 >> 2] - Y), t = u(c[a + 16 >> 2] - G), A = u(u(g * s) + u(t * T)), y = u(c[a + 24 >> 2] - S0), s = u(u(l * y) + u(s * P)), t = u(u(m * t) + u(y * O)), (y = u(u(A * A) + u(u(s * s) + u(t * t)))) > b && (M = A, S = t, I = s, b = y), (0 | h) != (0 | (a = i[a >> 2])); ) ;
          ...
          function b4(n, f) {
            ...
            if (_ = k = _ - 16 | 0, i[84 + (n |= 0) >> 2] = 0, !(a = (0 | (r = i[f + 40 >> 2])) == (0 | (h = f + 40 | 0)))) {
              ...
              if (!a) {
                for (; ; ) {
                  if (!(w[r + 20 | 0] | !w[r + 21 | 0])) {
                    if (o = i[r + 8 >> 2], w[n + 80 | 0]) f = 1, a = 1;
                      ...
                      l0(f = k + 4 | 0, o), I = i[k + 12 >> 2], S = i[k + 8 >> 2], a = i[k + 4 >> 2], l0(f, i[o + 12 >> 2]), M = i[k + 12 >> 2], P = i[k + 8 >> 2], l = i[k + 4 >> 2], l0(f, i[i[o + 8 >> 2] + 4 >> 2]), f = b, (0 | (f = (t = (0 | (f = (e = (0 | (f = (b = (0 | b) > (0 | s)) ? f : s)) < (0 | a)) ? a : f)) < (0 | l)) ? l : f)) >= (0 | (a = i[k + 4 >> 2])) ? (o = t ? P : e ? S : b ? v : g ? A : m ? y : o, a = t ? M : e ? I : b || g || m ? 2 : 1) : (o = i[k + 8 >> 2], f = a, a = i[k + 12 >> 2]);
                    }
                    C[0 | a](n, o, f);
                  }
                ...
                if (o = i[n + 84 >> 2]) {
                  for ((0 | (f = i[n + 1716 >> 2])) == 3 ? C[i[n + 88 >> 2]](4) : C[0 | f](4, i[n + 1896 >> 2]), b = -1; ; ) {
                    for (f = i[o + 8 >> 2]; w[n + 80 | 0] && (0 | (a = !(e = w[i[i[f + 4 >> 2] + 20 >> 2] + 21 | 0]))) != (0 | b) && ((0 | (t = i[n + 1720 >> 2])) == 4 ? C[i[n + 92 >> 2]](!e) : C[0 | t](!e, i[n + 1896 >> 2]), b = a), (0 | (a = i[n + 1724 >> 2])) == 5 ? C[i[n + 96 >> 2]](i[i[f + 16 >> 2] + 12 >> 2]) : C[0 | a](i[i[f + 16 >> 2] + 12 >> 2], i[n + 1896 >> 2]), (0 | (f = i[f + 12 >> 2])) != i[o + 8 >> 2]; ) ;
                    if (!(o = i[o + 16 >> 2])) break;
                  }
                  (0 | (f = i[n + 1728 >> 2])) == 6 ? C[i[n + 100 >> 2]]() : C[0 | f](i[n + 1896 >> 2]), i[n + 84 >> 2] = 0;
                }
              }
            }
            _ = k + 16 | 0;
          ...
          function B(n) {
            ...
            i: if (n |= 0) {
              ...
              f: if (!(1 & f)) {
                if (!(2 & f) || (e = e - (f = i[e >> 2]) | 0) >>> 0 < f0[858]) break i;
                n = n + f | 0;
                a: {
                  n: {
                    if (i[859] != (0 | e)) {
            ...
            i: {
              f: if (!((0 | (y = i[n + 112 >> 2])) < 3)) {
                ...
                if (l) {
                  ...
                  (0 | (f = i[n + 1716 >> 2])) == 3 ? C[i[n + 88 >> 2]](w[n + 81 | 0] ? 2 : (0 | y) < 4 ? 4 : 6) : C[0 | f](w[n + 81 | 0] ? 2 : (0 | y) < 4 ? 4 : 6, i[n + 1896 >> 2]), (0 | (f = i[n + 1724 >> 2])) == 5 ? C[i[n + 96 >> 2]](i[n + 128 >> 2]) : C[0 | f](i[n + 128 >> 2], i[n + 1896 >> 2]);
                  a: if ((0 | l) <= 0) {
                    if ((0 | y) < 2) break a;
                    for (f = Y + 100 | 0; a = n + f | 0, (0 | (s = i[n + 1724 >> 2])) == 5 ? C[i[n + 96 >> 2]](i[a + 12 >> 2]) : C[0 | s](i[a + 12 >> 2], i[n + 1896 >> 2]), a = (0 | f) > 132, f = f - 16 | 0, a; ) ;
                  } else if (!(A >>> 0 >= I >>> 0)) for (; (0 | (f = i[n + 1724 >> 2])) == 5 ? C[i[n + 96 >> 2]](i[A + 12 >> 2]) : C[0 | f](i[A + 12 >> 2], i[n + 1896 >> 2]), I >>> 0 > (A = A + 16 | 0) >>> 0; ) ;
                  (0 | (f = i[n + 1728 >> 2])) == 6 ? C[i[n + 100 >> 2]]() : C[0 | f](i[n + 1896 >> 2]);
                }
              }
              a = 1;
            }
            ...
            i: {
              ...
              f: {
                if (!(!(s < (o = c[b + 28 >> 2])) & (!(c[t + 32 >> 2] <= c[b + 32 >> 2]) | s != o))) {
                  if (z(i[i[v + 4 >> 2] + 16 >> 2], t, b) > u(0)) break f;
                  ...
                  return v0(n, i[i[v + 4 >> 2] + 12 >> 2], l), 1;
                }
                if (!(z(i[i[l + 4 >> 2] + 16 >> 2], b, t) < u(0)) && (e = 1, d[f + 14 | 0] = 1, d[i[i[i[f + 4 >> 2] + 4 >> 2] >> 2] + 14 | 0] = 1, !o2(i[l + 4 >> 2]) || !Z(i[i[v + 4 >> 2] + 12 >> 2], l)))
                  break i;
              }
              return e;
            }
          ...
          function e0(n, f) {
            ...
            i: if (3 & s) {
              ...
              f: if (e >>> 0 >= b >>> 0) {
                ...
                i[t + 4 >> 2] = 1 & s | b | 2, i[4 + (e = t + b | 0) >> 2] = 3 | a, i[o + 4 >> 2] = 1 | i[o + 4 >> 2], q0(e, a);
                ...
                l >>> 0 <= 15 ? (i[t + 4 >> 2] = 1 & s | r | 2, i[4 + (a = t + r | 0) >> 2] = 1 | i[a + 4 >> 2]) : (i[t + 4 >> 2] = 1 & s | b | 2, i[4 + (a = t + b | 0) >> 2] = 3 | l, i[4 + (e = t + r | 0) >> 2] = 1 | i[e + 4 >> 2], q0(a, l));
              } else {
            ...
            return a ? a + 8 | 0 : (a = j(f)) ? (X0(a, n, f >>> 0 > (t = (3 & (t = i[n - 4 >> 2]) ? -4 : -8) + (-8 & t) | 0) >>> 0 ? t : f), B(n), a) : 0;
          }
          function $0(n, f) {
            ...
            for (e = i[i[i[f + 4 >> 2] + 8 >> 2] >> 2]; ; ) {
              i: {
                ...
                f: {
                      ...
                      e: {
                        ...
                        t: if ((0 | f) != i[i[o + 4 >> 2] + 16 >> 2]) {
                          ...
                          if (d[i[f + 20 >> 2] + 21 | 0] = w[a + 12 | 0], w[e + 15 | 0]) {
                            if (i[i[e >> 2] + 24 >> 2] = 0, g2(i[e + 4 >> 2]), B(e), !$(o)) break i;
                            e = i[i[i[a + 4 >> 2] + 8 >> 2] >> 2], o = i[e >> 2], f = a;
                          } else if (w[a + 15 | 0]) {
                            if (i[i[a >> 2] + 24 >> 2] = 0, g2(i[a + 4 >> 2]), B(a), !$(t)) break i;
                  ...
                  if (i[o + 28 >> 2] = i[o + 28 >> 2] + i[t + 28 >> 2], i[a + 28 >> 2] = i[a + 28 >> 2] + i[b + 28 >> 2], i[i[f >> 2] + 24 >> 2] = 0, g2(i[f + 4 >> 2]), B(f), !$(t)) break i;
                  f = i[i[i[e + 4 >> 2] + 4 >> 2] >> 2];
                  continue;
                }
              }
                    ...
                    if (a = i[i[f + 4 >> 2] + 16 >> 2], t = c[a + 28 >> 2], o = i[e + 16 >> 2], !(t < (b = c[o + 28 >> 2])) & (!(c[a + 32 >> 2] <= c[o + 32 >> 2]) | t != b)) {
                      f: if (i[e + 12 >> 2] != (0 | f)) for (; ; ) {
                        if (a = i[i[f + 8 >> 2] + 4 >> 2], o = i[a + 16 >> 2], t = c[o + 28 >> 2], k = i[i[a + 4 >> 2] + 16 >> 2], !(t < (b = c[k + 28 >> 2]) | t == b & c[o + 32 >> 2] <= c[k + 32 >> 2])) {
                          if (!(z(i[i[f + 4 >> 2] + 16 >> 2], i[f + 16 >> 2], o) >= u(0))) break f;
                          a = i[i[f + 8 >> 2] + 4 >> 2];
                        }
                      ...
                      f: if ((0 | (a = i[e + 12 >> 2])) != (0 | f)) for (o = e + 12 | 0; ; ) {
                        if (k = i[i[a + 4 >> 2] + 16 >> 2], t = c[k + 28 >> 2], r = i[a + 16 >> 2], !(t < (b = c[r + 28 >> 2]) | t == b & c[k + 32 >> 2] <= c[r + 32 >> 2])) {
                          if (!(z(i[e + 16 >> 2], i[i[e + 4 >> 2] + 16 >> 2], k) <= u(0))) break f;
                          a = i[o >> 2];
                        }
          ...
          function M2(n, f, a, e, t, b) {
            var o = 0, k = 0, s = 0, r = 0, A = 0;
            i: {
              for (; ; ) {
                if (k = i[a + 4 >> 2], !(o = j(16)) || (i[o >> 2] = k, s = y0(i[n + 64 >> 2], i[f + 4 >> 2], o), i[o + 4 >> 2] = s, !s)) break i;
              ...
              if (a = i[i[i[f + 4 >> 2] + 8 >> 2] >> 2], k = i[i[a >> 2] + 4 >> 2], t = t || i[k + 8 >> 2], i[k + 16 >> 2] == i[t + 16 >> 2]) {
                ...
                if (d[a + 12 | 0] = o, d[f + 14 | 0] = 1, s = i[i[i[a + 4 >> 2] + 8 >> 2] >> 2], e = i[i[s >> 2] + 4 >> 2], i[e + 16 >> 2] == i[k + 16 >> 2]) for (t = a + 4 | 0; ; ) {
                  ...
                  if (d[f + 12 | 0] = s, d[a + 14 | 0] = 1, s0(n, a) && (i[o + 28 >> 2] = i[o + 28 >> 2] + i[k + 28 >> 2], e = i[o + 4 >> 2], i[e + 28 >> 2] = i[e + 28 >> 2] + i[i[k + 4 >> 2] + 28 >> 2], i[i[a >> 2] + 24 >> 2] = 0, g2(i[t >> 2]), B(a), !$(k))) break i;
                  if (t = f + 4 | 0, s = i[i[i[(a = f) + 4 >> 2] + 8 >> 2] >> 2], e = i[i[s >> 2] + 4 >> 2], k = o, i[e + 16 >> 2] != i[o + 16 >> 2]) break;
                }
                else f = a;
              }
              return d[f + 14 | 0] = 1, void (b && $0(n, f));
            }
            k2(n + 1740 | 0, 1), b2();
          }
          function $(n) {
          ...
          function f1(n, f) {
            ...
            if (i[n + 20 >> 2]) {
              ...
              i: {
                if (!((0 | (f = i[a + 12 >> 2])) >= n << 1)) {
                  if (i[a + 12 >> 2] = f << 1, t = i[a + 4 >> 2], f = e0(b = i[a >> 2], f << 3 | 4), i[a >> 2] = f, !f) {
                    i[a >> 2] = b, t = 2147483647;
                    break i;
                  }
                  if (f = e0(i[a + 4 >> 2], 8 + (i[a + 12 >> 2] << 3) | 0), i[a + 4 >> 2] = f, !f) {
            ...
            else if (i[n + 16 >> 2] = e << 1, e = e0(t, e << 3), i[n + 4 >> 2] = e, !e) return i[n + 4 >> 2] = t, 2147483647;
          ...
          function c4(n, f, a) {
            f |= 0, a |= 0, (0 | (a = i[1716 + (n |= 0) >> 2])) == 3 ? C[i[n + 88 >> 2]](5) : C[0 | a](5, i[n + 1896 >> 2]), (0 | (a = i[n + 1724 >> 2])) == 5 ? C[i[n + 96 >> 2]](i[i[f + 16 >> 2] + 12 >> 2]) : C[0 | a](i[i[f + 16 >> 2] + 12 >> 2], i[n + 1896 >> 2]), (0 | (a = i[n + 1724 >> 2])) == 5 ? C[i[n + 96 >> 2]](i[i[i[f + 4 >> 2] + 16 >> 2] + 12 >> 2]) : C[0 | a](i[i[i[f + 4 >> 2] + 16 >> 2] + 12 >> 2], i[n + 1896 >> 2]), a = i[f + 20 >> 2];
            i: if (w[a + 21 | 0]) for (; ; ) {
              if (w[a + 20 | 0] || (d[a + 20 | 0] = 1, f = i[i[f + 12 >> 2] + 4 >> 2], (0 | (a = i[n + 1724 >> 2])) == 5 ? C[i[n + 96 >> 2]](i[i[f + 16 >> 2] + 12 >> 2]) : C[0 | a](i[i[f + 16 >> 2] + 12 >> 2], i[n + 1896 >> 2]), a = i[f + 20 >> 2], !w[a + 21 | 0] | w[a + 20 | 0])) break i;
              if (d[a + 20 | 0] = 1, f = i[f + 8 >> 2], (0 | (a = i[n + 1724 >> 2])) == 5 ? C[i[n + 96 >> 2]](i[i[i[f + 4 >> 2] + 16 >> 2] + 12 >> 2]) : C[0 | a](i[i[i[f + 4 >> 2] + 16 >> 2] + 12 >> 2], i[n + 1896 >> 2]), a = i[f + 20 >> 2], !w[a + 21 | 0]) break;
            }
            (0 | (f = i[n + 1728 >> 2])) == 6 ? C[i[n + 100 >> 2]]() : C[0 | f](i[n + 1896 >> 2]);
          }
          function m2(n, f) {
            ...
            if ((0 | (a = i[(n |= 0) >> 2])) != (0 | f)) for (; ; ) {
              i: if (f >>> 0 > a >>> 0) {
                f: switch (0 | a) {
                  case 0:
                    (0 | (a = i[n + 1732 >> 2])) == 11 ? C[i[n + 12 >> 2]](100151) : C[0 | a](100151, i[n + 1896 >> 2]), i[n >> 2] && m2(n, 0), i[n + 112 >> 2] = 0, a = 1, i[n >> 2] = 1, d[n + 108 | 0] = 0, i[n + 1896 >> 2] = 0, i[n + 8 >> 2] = 0;
                    break i;
                  case 1:
                    break f;
                  default:
                ...
                if ((0 | (a = i[n + 1732 >> 2])) == 11 ? C[i[n + 12 >> 2]](100152) : C[0 | a](100152, i[n + 1896 >> 2]), i[n >> 2] != 1 && m2(n, 1), i[n >> 2] = 2, i[n + 4 >> 2] = 0, a = 2, i[n + 112 >> 2] <= 0) break i;
                d[n + 108 | 0] = 1;
              } else {
                f: switch (a - 1 | 0) {
                  case 1:
                    (0 | (a = i[n + 1732 >> 2])) == 11 ? C[i[n + 12 >> 2]](100154) : C[0 | a](100154, i[n + 1896 >> 2]), i[n >> 2] != 2 && m2(n, 2), a = 1, i[n >> 2] = 1;
                    break i;
                  case 0:
                    break f;
                  default:
                ...
                (0 | (a = i[n + 1732 >> 2])) == 11 ? C[i[n + 12 >> 2]](100153) : C[0 | a](100153, i[n + 1896 >> 2]), (a = i[n + 8 >> 2]) && h0(a), a = 0, i[n + 8 >> 2] = 0, i[n >> 2] = 0, i[n + 4 >> 2] = 0;
              }
              if ((0 | f) == (0 | a)) break;
            }
          }
                ...
                a: {
                  n: {
                    e: {
                      ...
                      if ((0 | a) == 1) break f;
                      a = 31 & (b = t0(a)), (63 & b) >>> 0 >= 32 ? n = f >>> a | 0 : (e = f >>> a | 0, n = ((1 << a) - 1 & f) << 32 - a | n >>> a), r2 = e;
                      break i;
                    }
                    b = e + 1 | 0, o = 63 - e | 0;
                  }
          ...
          function s4(n, f, a) {
            ...
            i: {
              f: {
                f = b + 16 | 0, (e = 0 | z0(i[n + 60 >> 2], 0 | f, 2, b + 12 | 0)) ? (i[806] = e, e = -1) : e = 0;
                a: {
                  if (e) e = f;
                  else for (; ; ) {
                    ...
                    if (k = t - ((r = (k = i[f + 4 >> 2]) >>> 0 < t >>> 0) ? k : 0) | 0, i[(e = (r << 3) + f | 0) >> 2] = k + i[e >> 2], i[(f = (r ? 12 : 4) + f | 0) >> 2] = i[f >> 2] - k, o = o - t | 0, f = e, s = s - r | 0, (t = 0 | z0(i[n + 60 >> 2], 0 | f, 0 | s, b + 12 | 0)) ? (i[806] = t, t = -1) : t = 0, t) break;
                  }
                  if ((0 | o) != -1) break f;
                }
          ...
          function r4(n, f, a) {
            f |= 0, a |= 0, (0 | (a = i[1716 + (n |= 0) >> 2])) == 3 ? C[i[n + 88 >> 2]](6) : C[0 | a](6, i[n + 1896 >> 2]), (0 | (a = i[n + 1724 >> 2])) == 5 ? C[i[n + 96 >> 2]](i[i[f + 16 >> 2] + 12 >> 2]) : C[0 | a](i[i[f + 16 >> 2] + 12 >> 2], i[n + 1896 >> 2]), (0 | (a = i[n + 1724 >> 2])) == 5 ? C[i[n + 96 >> 2]](i[i[i[f + 4 >> 2] + 16 >> 2] + 12 >> 2]) : C[0 | a](i[i[i[f + 4 >> 2] + 16 >> 2] + 12 >> 2], i[n + 1896 >> 2]), a = i[f + 20 >> 2];
            i: if (w[a + 21 | 0]) for (; ; ) {
              if (w[a + 20 | 0]) break i;
              if (d[a + 20 | 0] = 1, f = i[f + 8 >> 2], (0 | (a = i[n + 1724 >> 2])) == 5 ? C[i[n + 96 >> 2]](i[i[i[f + 4 >> 2] + 16 >> 2] + 12 >> 2]) : C[0 | a](i[i[i[f + 4 >> 2] + 16 >> 2] + 12 >> 2], i[n + 1896 >> 2]), a = i[f + 20 >> 2], !w[a + 21 | 0]) break;
            }
          ...
          function z(n, f, a) {
            ...
            i: {
              ...
              s = t, t = 1, (o = c[a + 28 >> 2]) > e || (t = 0, e == o && (t = c[f + 32 >> 2] <= c[a + 32 >> 2])), r = c[n + 32 >> 2], A = c[f + 32 >> 2], l = c[a + 32 >> 2], q[b + 40 >> 3] = o, q[b + 24 >> 3] = e, q[b + 48 >> 3] = l, q[b + 32 >> 3] = A, q[b + 16 >> 3] = r, q[b + 8 >> 3] = k, i[b + 4 >> 2] = t, i[b >> 2] = s, v1(1092, b), o = c[a + 28 >> 2], k = c[n + 28 >> 2], e = c[f + 28 >> 2];
            }
          ...
          function T2(n, f, a) {
            ...
            (0 | (f = i[n + 1732 >> 2])) == 11 ? C[i[n + 12 >> 2]](100900) : C[0 | f](100900, i[n + 1896 >> 2]);
          }
          function Y2(n, f, a) {
            var e = 0, t = 0, b = 0, o = 0;
            e = i[f >> 2];
            i: {
              if ((0 | f) != (0 | a)) for (; ; ) {
                if (d[f + 15 | 0] = 0, o = i[f + 4 >> 2], b = i[i[o + 8 >> 2] >> 2], t = i[b >> 2], i[t + 16 >> 2] != i[e + 16 >> 2]) {
                  if (!w[b + 15 | 0]) return n = w[f + 12 | 0], a = i[e + 20 >> 2], i[a + 8 >> 2] = e, d[a + 21 | 0] = n, i[e + 24 >> 2] = 0, g2(o), B(f), e;
                  if (!(t = A2(i[i[e + 8 >> 2] + 4 >> 2], i[t + 4 >> 2])) || !$(i[b >> 2])) break i;
                  i[b >> 2] = t, d[b + 15 | 0] = 0, i[t + 24 >> 2] = b;
                }
                if (i[e + 8 >> 2] != (0 | t) && (!Z(i[i[t + 4 >> 2] + 12 >> 2], t) || !Z(e, t)))
                  break i;
                if (t = w[f + 12 | 0], e = i[f >> 2], o = i[e + 20 >> 2], i[o + 8 >> 2] = e, d[o + 21 | 0] = t, i[e + 24 >> 2] = 0, g2(i[f + 4 >> 2]), B(f), e = i[b >> 2], (0 | a) == (0 | (f = b))) break;
              }
              return e;
            }
            k2(n + 1740 | 0, 1), b2();
          ...
          function A4(n, f) {
            ...
            if ((0 | (a = i[40 + (f |= 0) >> 2])) != (0 | (e = f + 40 | 0))) for (; ; ) {
              if (w[a + 21 | 0]) {
                for ((0 | (f = i[n + 1716 >> 2])) == 3 ? C[i[n + 88 >> 2]](2) : C[0 | f](2, i[n + 1896 >> 2]), f = i[a + 8 >> 2]; (0 | (t = i[n + 1724 >> 2])) == 5 ? C[i[n + 96 >> 2]](i[i[f + 16 >> 2] + 12 >> 2]) : C[0 | t](i[i[f + 16 >> 2] + 12 >> 2], i[n + 1896 >> 2]), (0 | (f = i[f + 12 >> 2])) != i[a + 8 >> 2]; ) ;
                (0 | (f = i[n + 1728 >> 2])) == 6 ? C[i[n + 100 >> 2]]() : C[0 | f](i[n + 1896 >> 2]);
              }
          ...
          function o1(n, f, a) {
            var e = 0, t = 0, b = 0;
            if (_ = e = _ - 208 | 0, i[e + 204 >> 2] = f, t1(f = e + 160 | 0, 0, 40), i[e + 200 >> 2] = i[e + 204 >> 2], !((0 | V0(0, n, e + 200 | 0, e + 80 | 0, f, a)) < 0)) {
              ...
              i: {
                ...
                V0(1616, n, e + 200 | 0, e + 80 | 0, e + 160 | 0, a);
              }
              b && (C[i[413]](1616, 0, 0), i[416] = 0, i[415] = b, i[411] = 0, i[408] = 0, i[409] = 0), i[404] = i[404] | 32 & t;
            }
            _ = e + 208 | 0;
          }
          function b1(n, f) {
          ...
          function l4(n, f, a) {
            ...
            return a = i[a >> 2], e = i[i[a + 4 >> 2] + 16 >> 2], f = i[f >> 2], (0 | (t = i[i[f + 4 >> 2] + 16 >> 2])) == (0 | (n = i[n + 72 >> 2])) ? (0 | n) == (0 | e) ? (f = i[f + 16 >> 2], b = c[f + 28 >> 2], a = i[a + 16 >> 2], !(b < (o = c[a + 28 >> 2])) & (!(c[f + 32 >> 2] <= c[a + 32 >> 2]) | b != o) ? z(n, a, f) >= u(0) | 0 : z(n, f, a) <= u(0) | 0) : z(e, n, i[a + 16 >> 2]) <= u(0) | 0 : (f = i[f + 16 >> 2], (0 | n) == (0 | e) ? z(t, n, f) >= u(0) | 0 : A1(t, n, f) >= A1(i[i[a + 4 >> 2] + 16 >> 2], n, i[a + 16 >> 2]) | 0);
          }
          function d0(n) {
            var f = 0, a = 0, e = 0, t = 0, b = 0, o = u(0), k = u(0);
            if (!(f = i[n + 12 >> 2])) return n1(i[n >> 2]);
            if (e = i[n + 8 >> 2], t = i[i[(e + (f << 2) | 0) - 4 >> 2] >> 2], a = i[n >> 2], i[a + 8 >> 2] && (b = i[i[a + 4 >> 2] + (i[i[a >> 2] + 4 >> 2] << 3) >> 2], !(!((o = c[b + 28 >> 2]) < (k = c[t + 28 >> 2])) & (!(c[b + 32 >> 2] <= c[t + 32 >> 2]) | o != k)))) return n1(a);
          ...
          function J(n, f, a) {
            ...
            if (!(32 & w[0 | n])) i: {
              ...
              if (e - (t = i[n + 20 >> 2]) >>> 0 < a >>> 0) C[i[n + 36 >> 2]](n, f, a);
              else {
                f: {
                  a: if (!(!a | i[n + 80 >> 2] < 0)) {
                    for (e = a; ; ) {
                    ...
                    if (C[i[n + 36 >> 2]](n, f, e) >>> 0 < e >>> 0) break i;
                    a = a - e | 0, t = i[n + 20 >> 2];
                    break f;
                  }
                  b = f;
                }
                X0(t, b, a), i[n + 20 >> 2] = i[n + 20 >> 2] + a;
              }
            }
          }
          function k1(n, f) {
            var a = 0, e = 0, t = 0;
            (a = j(16)) && (t = r0(i[n + 8 >> 2])) && (e = i[t + 16 >> 2], c[e + 32 >> 2] = f, i[e + 28 >> 2] = 2112929218, e = i[i[t + 4 >> 2] + 16 >> 2], c[e + 32 >> 2] = f, i[e + 28 >> 2] = -34554430, i[n + 72 >> 2] = e, d[a + 15 | 0] = 0, d[a + 12 | 0] = 0, i[a + 8 >> 2] = 0, i[a >> 2] = t, d[a + 13 | 0] = 1, d[a + 14 | 0] = 0, e = a, a = y0(t = i[n + 64 >> 2], t, a), i[e + 4 >> 2] = a, a) || (k2(n + 1740 | 0, 1), b2());
          }
          function h0(n) {
            var f = 0, a = 0, e = 0;
          ...
          function W2(n, f, a) {
            var e = 0, t = 0, b = 0, o = 0;
            if (f) for (; b = a = a - 1 | 0, o = (t = n) - w0(n = a1(n, f, 10), e = r2, 10, 0) | 48, d[0 | b] = o, t = f >>> 0 > 9, f = e, t; ) ;
          ...
          function c1(n, f, a, e) {
            ...
            return t = n, n = e << 1, f = c1(t, f, e0(a, e << 4 | 8), n), W = n, f;
          }
          function s1(n, f) {
            var a = 0, e = 0, t = 0;
            if (c0(+n), e = 0 | c2(1), t = 0 | c2(0), (0 | (a = e >>> 20 & 2047)) != 2047) {
              if (!a) return n == 0 ? a = 0 : (n = s1(18446744073709552e3 * n, f), a = i[f >> 2] + -64 | 0), i[f >> 2] = a, n;
              i[f >> 2] = a - 1022, Z0(0, 0 | t), Z0(1, -2146435073 & e | 1071644672), n = +q1();
            }
            return n;
          }
          function r1(n) {
          ...
          function y0(n, f, a) {
            for (var e = 0; f = i[f + 8 >> 2], (e = i[f >> 2]) && !(0 | C[i[n + 16 >> 2]](i[n + 12 >> 2], e, a)); ) ;
            return (n = j(12)) && (i[n >> 2] = a, a = i[f + 4 >> 2], i[n + 4 >> 2] = a, i[a + 8 >> 2] = n, i[n + 8 >> 2] = f, i[f + 4 >> 2] = n), n;
          }
          function V(n, f, a, e, t) {
            var b = 0;
            if (_ = b = _ - 256 | 0, !(73728 & t | (0 | a) <= (0 | e))) {
              if (t1(b, 255 & f, (a = (e = a - e | 0) >>> 0 < 256) ? e : 256), !a) for (; J(n, b, 256), (e = e - 256 | 0) >>> 0 > 255; ) ;
              J(n, b, e);
            }
            _ = b + 256 | 0;
          }
          ...
          function H2(n) {
            var f = 0, a = 0;
            i: {
              if (!((n = (f = i[440]) + (a = n + 7 & -8) | 0) >>> 0 <= f >>> 0 && a) && (n >>> 0 <= h1() << 16 >>> 0 || 0 | f4(0 | n)))
                break i;
              return i[806] = 48, -1;
            }
            return i[440] = n, f;
          ...
          function y4(n) {
            n |= 0;
            var f = 0;
            _ = f = _ - 16 | 0, i[f >> 2] = n, _ = n = _ - 16 | 0, i[n + 12 >> 2] = f, o1(1078, f, 0), _ = n + 16 | 0, _ = f + 16 | 0;
          }
          function p4(n, f, a) {
          ...
          function v1(n, f) {
            var a = 0;
            _ = a = _ - 16 | 0, i[a + 12 >> 2] = f, o1(n, f, 40), _ = a + 16 | 0;
          }
          function k2(n, f) {
            n |= 0, f |= 0, i[978] || (i[978] = n, i[979] = f), i4();
          }
          function m4(n, f) {
          ...
          F = w, e2();
          var C = U([null, p4, r4, o0, o0, o0, E2, c4, w4, l4, E4, o0, d1, E2, E2, E2, E2, C4, E2, m2, k4, A0, k2, K0, o4, v4, u4, A4, b4, i1, h0, h4, E2, d1, d4, y4, E2, I4, s4, g4, t4]);
          function h1() {
          ...
          function P4(n) {
            ...
            if (f < a && a < 65536) {
              ...
              new Int8Array(e).set(d), d = new Int8Array(e), n2 = new Int16Array(e), i = new Int32Array(e), w = new Uint8Array(e), L2 = new Uint16Array(e), f0 = new Uint32Array(e), c = new Float32Array(e), q = new Float64Array(e), a2 = e, t2.buffer = a2, F = w;
            }
            return f;
          }
          return { j: R4, k: j, l: B, m: C, n: e4, o: m4, p: S4, q: M4 };
        }
        return $1(Q);
      }(E);
    }, instantiate: function(p, E) {
      return { then: function(Q) {
        var U = new w2.Module(p);
        Q({ instance: new w2.Instance(U, E) });
      } };
    }, RuntimeError: Error };
    function E1(p) {
      for (var E = atob(p), Q = new Uint8Array(E.length), U = 0; U < E.length; ++U) Q[U] = E.charCodeAt(U);
      return Q;
    }
    function C1(p) {
      if (N2(p)) return E1(p.slice(H0.length));
    }
    F2 = [], typeof w2 != "object" && W0("no native wasm support detected");
    var z2, J2, U0 = !1;
    function _0() {
      var p = Q2.buffer;
      R.HEAP8 = new Int8Array(p), R.HEAP16 = new Int16Array(p), R.HEAPU8 = z2 = new Uint8Array(p), R.HEAPU16 = new Uint16Array(p), R.HEAP32 = new Int32Array(p), R.HEAPU32 = J2 = new Uint32Array(p), R.HEAPF32 = new Float32Array(p), R.HEAPF64 = new Float64Array(p);
    }
    var F0 = R.INITIAL_MEMORY || 4194304;
    Q2 = R.wasmMemory ? R.wasmMemory : new w2.Memory({ initial: F0 / 65536, maximum: 32768 }), _0(), F0 = Q2.buffer.byteLength;
    var B0 = [], Q0 = [], T0 = [];
    function R1() {
      if (R.preRun) for (typeof R.preRun == "function" && (R.preRun = [R.preRun]); R.preRun.length; ) M1(R.preRun.shift());
      k0(B0);
    }
    function I1() {
      k0(Q0);
    ...
    function S1() {
      if (R.postRun) for (typeof R.postRun == "function" && (R.postRun = [R.postRun]); R.postRun.length; ) U1(R.postRun.shift());
      k0(T0);
    }
    function M1(p) {
      B0.unshift(p);
    ...
    var R2 = 0, x2 = null;
    function _1(p) {
      R2++, R.monitorRunDependencies?.(R2);
    }
    function F1(p) {
      if (R2--, R.monitorRunDependencies?.(R2), R2 == 0 && x2) {
        var E = x2;
        x2 = null, E();
      }
    }
    function W0(p) {
      R.onAbort?.(p), B2(p = "Aborted(" + p + ")"), U0 = !0, p += ". Build with -sASSERTIONS for more info.";
      var E = new w2.RuntimeError(p);
      throw h2(E), E;
    }
    var O2, H0 = "data:application/octet-stream;base64,", N2 = (p) => p.startsWith(H0);
    function x0(p) {
      if (p == O2 && F2) return new Uint8Array(F2);
      var E = C1(p);
      if (E) return E;
      if (b0) return b0(p);
    ...
    function B1(p) {
      return F2 || N2(p) || !P0 && !Z2 || typeof fetch != "function" ? Promise.resolve().then(() => x0(p)) : fetch(p, { credentials: "same-origin" }).then((E) => {
        if (!E.ok) throw "failed to load wasm binary file at '" + p + "'";
        return E.arrayBuffer();
      }).catch(() => x0(p));
    }
    function O0(p, E, Q) {
      return B1(p).then((U) => w2.instantiate(U, E)).then((U) => U).then(Q, (U) => {
        B2(`failed to asynchronously prepare wasm: ${U}`), W0(U);
      });
    }
    function Q1(p, E, Q, U) {
      return p || typeof w2.instantiateStreaming != "function" || N2(E) || typeof fetch != "function" ? O0(E, Q, U) : fetch(E, { credentials: "same-origin" }).then((F) => w2.instantiateStreaming(F, Q).then(U, function(H) {
        return B2(`wasm streaming compile failed: ${H}`), B2("falling back to ArrayBuffer instantiation"), O0(E, Q, U);
      }));
    }
    function T1() {
      var p = { a: Y1 };
      function E(U, F) {
        return u2 = U.exports, j0 = u2.m, P1(u2.j), F1(), u2;
      }
      function Q(U) {
        E(U.instance);
      }
      if (_1(), R.instantiateWasm) try {
        return R.instantiateWasm(p, E);
      } catch (U) {
        B2(`Module.instantiateWasm callback failed with error: ${U}`), h2(U);
      }
      return Q1(F2, O2, p, Q).catch(h2), {};
    }
    N2(O2 = "libtess-asm.wasm") || (O2 = m1(O2));
    var k0 = (p) => {
      for (; p.length > 0; ) p.shift()(R);
    };
    R.noExitRuntime;
    var j0, W1 = () => {
      throw 1 / 0;
    }, H1 = (p, E, Q) => z2.copyWithin(p, E, E + Q), x1 = () => 2147483648, O1 = (p) => {
      var E = (p - Q2.buffer.byteLength + 65535) / 65536;
      try {
        return Q2.grow(E), _0(), 1;
      } catch {
      }
    }, j1 = (p) => {
      var E = z2.length;
      ...
      return !1;
    }, D1 = [null, [], []], D0 = typeof TextDecoder < "u" ? new TextDecoder("utf8") : void 0, G1 = (p, E, Q) => {
      for (var U = E + Q, F = E; p[F] && !(F >= U); ) ++F;
      if (F - E > 16 && p.buffer && D0) return D0.decode(p.subarray(E, F));
      for (var H = ""; E < F; ) {
        var D = p[E++];
        if (128 & D) {
          var x = 63 & p[E++];
          if ((224 & D) != 192) {
            var e2 = 63 & p[E++];
            if ((D = (240 & D) == 224 ? (15 & D) << 12 | x << 6 | e2 : (7 & D) << 18 | x << 12 | e2 << 6 | 63 & p[E++]) < 65536) H += String.fromCharCode(D);
            else {
              var p2 = D - 65536;
              H += String.fromCharCode(55296 | p2 >> 10, 56320 | 1023 & p2);
            }
      ...
      var Q = D1[p];
      E === 0 || E === 10 ? ((p === 1 ? g1 : B2)(G1(Q, 0)), Q.length = 0) : Q.push(E);
    }, V2 = [], K2 = (p) => {
      var E = V2[p];
      return E || (p >= V2.length && (V2.length = p + 1), V2[p] = E = j0.get(p)), E;
    }, Y1 = { f: W1, h: H1, g: j1, d: (p, E, Q, U) => {
      for (var F = 0, H = 0; H < Q; H++) {
        var D = J2[E >> 2], x = J2[E + 4 >> 2];
        E += 8;
        for (var e2 = 0; e2 < x; e2++) L1(p, z2[D + e2]);
        F += x;
      }
      return J2[U >> 2] = F, 0;
    }, c: J1, i: N1, e: z1, b: Z1, a: Q2 }, u2 = T1();
    R._malloc = (p) => (R._malloc = u2.k)(p), R._free = (p) => (R._free = u2.l)(p), R._triangulate = (p, E, Q, U, F, H) => (R._triangulate = u2.n)(p, E, Q, U, F, H);
    var q2, j2 = (p, E) => (j2 = u2.o)(p, E), D2 = () => (D2 = u2.p)(), G2 = (p) => (G2 = u2.q)(p);
    function Z1(p, E, Q) {
      var U = D2();
      try {
        K2(p)(E, Q);
      } catch (F) {
        if (G2(U), F !== F + 0) throw F;
        j2(1, 0);
      }
    }
    function z1(p, E) {
    ...
    function N1(p, E, Q, U) {
      ...
      try {
        ...
        if (G2(F), H !== H + 0) throw H;
        j2(1, 0);
      }
    }
    function G0() {
      function p() {
        q2 || (q2 = !0, R.calledRun = !0, U0 || (I1(), d2(R), R.onRuntimeInitialized && R.onRuntimeInitialized(), S1()));
      }
      R2 > 0 || (R1(), R2 > 0 || (R.setStatus ? (R.setStatus("Running..."), setTimeout(function() {
        setTimeout(function() {
          R.setStatus("");
        }, 1), p();
      }, 1)) : p()));
    ...
    G0();
    let u0 = null, y2 = null, I2 = null, $2 = null;
    const V1 = 2, L0 = 4e3;
    let Y0 = 0;
    const K1 = (p, E, Q) => {
      u0 || (u0 = R._triangulate);
      let U = R.HEAPF32;
      const F = R.HEAP32.BYTES_PER_ELEMENT, H = 2, D = U.BYTES_PER_ELEMENT;
      Q > Y0 && (Y0 = Q, I2 && (R._free(I2), I2 = 0), y2 && (R._free(y2), y2 = 0)), I2 || (I2 = R._malloc(Q * D)), $2 || ($2 = R._malloc(L0 * F));
      const x = Q * V1;
      y2 || (y2 = R._malloc(x * D)), U = R.HEAPF32, U.set(p, I2 / D), R.HEAP32.set(E, $2 / F);
      const e2 = x / H, p2 = u0(I2, $2, Math.min(E.length, L0), H, y2, e2), X2 = p2 * H;
      U = R.HEAPF32;
      const i0 = U.slice(y2 / D, y2 / D + X2), c2 = {};
      return c2.buffer = i0, c2.vertexCount = p2, c2;
    };
    return R.triangulate = K1, v2.ready;
  }, P2.exports = _2), y1.exports;
  var P2, U2, _2;
}
var p1 = F4();
const Q4 = _4({ __proto__: null, default: U4(p1) }, [p1]);
export {
  Q4 as l
};
//# sourceMappingURL=libtess-asm-BKAo6kUx.js.map
