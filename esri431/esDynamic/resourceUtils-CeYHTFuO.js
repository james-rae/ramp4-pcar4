import { Q as L } from "./main-DZxT3i7S.js";
import { u as d } from "./basicInterfaces-Dsf65ICa.js";
class h {
  constructor(r) {
...
async function p(t, r) {
  ...
  if (L("esri-iPhone")) return new Promise((c, m) => {
    const s = () => {
      ...
      URL.revokeObjectURL(n), e.removeEventListener("load", s), e.removeEventListener("error", i);
    };
    e.addEventListener("load", s), e.addEventListener("error", i), e.src = n;
  });
  try {
...
//# sourceMappingURL=resourceUtils-CeYHTFuO.js.map
