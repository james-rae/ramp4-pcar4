import { fp as _, G as f, bm as g, fP as w, J as u, jP as b, eN as V, ez as S, eA as T, eC as D, jQ as $, s as L, B as x, U as c, gV as k, bQ as o, bR as l, eD as y, iZ as M, eG as N, bS as j, eM as I } from "./main-DZxT3i7S.js";
class O {
  constructor(e, t, i, a) {
...
function P(s = null) {
  let e = p.get(s);
  return e || (s != null ? (e = new m((t) => s.immediate.schedule(t)), p.set(s, e)) : (e = new m(), p.set(null, e))), ++e.ref, e;
}
let r = class extends b(V(S(T(D(I))))) {
  constructor(...s) {
  ...
  async queryElevation(s, e) {
    const { ElevationQuery: t } = await import("./ElevationQuery-BArkBm7v.js");
...
//# sourceMappingURL=ElevationLayer-Daluh6Ue.js.map
