import { bQ as t, bR as s, pJ as Z, bS as A, bT as j, eK as V, pK as he, pL as et, eI as ve, eL as tt, eq as R, eD as N, f9 as G, s as M, bO as me, U as Y, nw as Te, at as rt, bN as Fe, G as Ee, fE as Ue, D as Ge, b3 as fe, a1 as H, aA as qe, bU as x, b1 as q, cF as We, a0 as ot, pM as st, db as $e, lZ as it, fo as nt, b2 as at, a8 as L, ex as lt, eB as ut, ez as pt, eA as ct, eC as yt, cw as dt, fg as mt, cf as ft, dy as Ie, c_ as Oe, or as ht, I as vt, S as wt, e as gt, f as St, cu as bt, hN as Tt, cB as Bt, e7 as Nt, cI as Pt, aZ as $t, eM as Rt } from "./main-DZxT3i7S.js";
import { i as At } from "./originUtils-BLsWtgV9.js";
import { a as Q, D as Re, o as Lt, q as It, b as Ze, d as Ae, P as Ot, n as jt, e as Dt, f as Mt, R as Ct, M as je, l as Jt, U as _t, r as kt, g as xt, m as Ft, c as pe, y as ce, C as re, T as oe, j as se, w as ie, S as we, h as Et } from "./Stop-DXkrdKgD.js";
...
let _ = class extends j {
  constructor(r) {
    super(r), this.directionLines = new ve({ color: [0, 122, 194], width: 6 }), this.directionPoints = new V({ color: [255, 255, 255], size: 6, outline: { color: [0, 122, 194], width: 2 } }), this.pointBarriers = new V({ style: "x", size: 10, outline: { color: [255, 0, 0], width: 3 } }), this.polygonBarriers = new tt({ color: [255, 170, 0, 0.6], outline: { width: 7.5, color: [255, 0, 0, 0.6] } }), this.polylineBarriers = new ve({ width: 7.5, color: [255, 85, 0, 0.7] }), this.routeInfo = new ve({ width: 8, color: [20, 89, 127] }), this.stops = new Ve();
  }
};
t([s({ types: he })], _.prototype, "directionLines", void 0), t([s({ types: Z })], _.prototype, "directionPoints", void 0), t([s({ types: Z })], _.prototype, "pointBarriers", void 0), t([s({ types: et })], _.prototype, "polygonBarriers", void 0), t([s({ types: he })], _.prototype, "polylineBarriers", void 0), t([s({ types: he })], _.prototype, "routeInfo", void 0), t([s({ type: Ve })], _.prototype, "stops", void 0), _ = t([A("esri.layers.support.RouteSymbols")], _);
const ze = _;
...
t([s({ type: Number })], W.prototype, "buildTime", void 0), t([s({ type: String })], W.prototype, "name", void 0), t([s({ type: [Ut] })], W.prototype, "networkAttributes", void 0), t([s()], W.prototype, "networkSources", void 0), t([s({ type: String })], W.prototype, "state", void 0), W = t([A("esri.rest.support.NetworkDataset")], W);
const Gt = W;
let $ = class extends j {
  constructor(r) {
  ...
  readAccumulateAttributes(r) {
    return r == null ? null : r.map((o) => Q.fromJSON(o));
  }
  writeAccumulateAttributes(r, o, i) {
    r?.length && (o[i] = r.map((n) => Q.toJSON(n)));
  }
  get capabilities() {
...
function Zt(e, r) {
  ...
  Wt().warnOnce(`The remote Network Analysis service is powered by a network dataset which is not Z-aware.
...
async function Ke(e, r, o) {
  ...
  const i = me({ f: "json", token: r }, o), { data: n } = await Y(e, i), y = n.currentVersion >= 10.4 ? Kt(e, r, o) : zt(e, o), { defaultTravelMode: u, supportedTravelModes: d } = await y;
  return n.defaultTravelMode = u, n.supportedTravelModes = d, qt.fromJSON(n);
}
async function zt(e, r) {
  const o = me({ f: "json" }, r), { data: i } = await Y(e.replace(/\/rest\/.*$/i, "/info"), o);
  if (!i?.owningSystemUrl) return { supportedTravelModes: [], defaultTravelMode: null };
  const { owningSystemUrl: n } = i, y = Te(n) + "/sharing/rest/portals/self", { data: u } = await Y(y, o), d = rt("helperServices.routingUtilities.url", u);
  if (!d) return { supportedTravelModes: [], defaultTravelMode: null };
  const g = Fe(n), h = /\/solve$/i.test(g.path) ? "Route" : /\/solveclosestfacility$/i.test(g.path) ? "ClosestFacility" : "ServiceAreas", a = me({ f: "json", serviceName: h }, r), b = Te(d) + "/GetTravelModes/execute", P = await Y(b, a), T = [];
  let m = null;
...
async function Kt(e, r, o) {
  try {
    const i = me({ f: "json", token: r }, o), n = Te(e) + "/retrieveTravelModes", { data: { supportedTravelModes: y, defaultTravelMode: u } } = await Y(n, i);
...
t([s({ json: { read: { source: "string" } } })], ee.prototype, "text", void 0), t([R(Ot, { name: "stringType" })], ee.prototype, "type", void 0), ee = t([A("esri.rest.support.DirectionsString")], ee);
const He = ee;
let U = class extends j {
  ...
  readArriveTimeOffset(r, o) {
    return jt(o.ETA, o.arriveTimeUTC);
  }
  readGeometry(r, o) {
...
let K = class extends H {
  constructor(r) {
    super(r), this.events = null, this.geometry = null, this.strings = null;
  }
  readGeometry(r, o) {
    const i = Xt(o.compressedGeometry);
    return i != null ? fe.fromJSON(i) : null;
  }
};
t([s({ type: [Yt] })], K.prototype, "events", void 0), t([s({ type: fe })], K.prototype, "geometry", void 0), t([N("geometry", ["compressedGeometry"])], K.prototype, "readGeometry", null), t([s({ type: [He] })], K.prototype, "strings", void 0), K = t([A("esri.rest.support.DirectionsFeature")], K);
const er = K;
function tr(e, r) {
  if (e.length === 0) return new fe({ spatialReference: r });
  const o = [];
  ...
  return new fe({ hasM: n, hasZ: y, paths: [i], spatialReference: r });
}
let O = class extends x {
  ...
  readFeatures(r, o) {
    if (!r) return [];
    const i = o.summary.envelope.spatialReference ?? o.spatialReference, n = i && q.fromJSON(i);
    return r.map((y) => {
  ...
  get strings() {
    return this.features.flatMap(({ strings: r }) => r).filter(We);
  }
};
t([s({ type: qe, json: { read: { source: "summary.envelope" } } })], O.prototype, "extent", void 0), t([s({ nonNullable: !0 })], O.prototype, "features", void 0), t([N("features")], O.prototype, "readFeatures", null), t([s()], O.prototype, "geometryType", void 0), t([s({ readOnly: !0 })], O.prototype, "mergedGeometry", null), t([s()], O.prototype, "routeId", void 0), t([s()], O.prototype, "routeName", void 0), t([s({ value: null, readOnly: !0 })], O.prototype, "strings", null), t([s({ json: { read: { source: "summary.totalDriveTime" } } })], O.prototype, "totalDriveTime", void 0), t([s({ json: { read: { source: "summary.totalLength" } } })], O.prototype, "totalLength", void 0), t([s({ json: { read: { source: "summary.totalTime" } } })], O.prototype, "totalTime", void 0), O = t([A("esri.rest.support.DirectionsFeatureSet")], O);
const rr = O;
...
t([s({ type: x, json: { write: !0 } })], D.prototype, "directionLines", void 0), t([s({ type: x, json: { write: !0 } })], D.prototype, "directionPoints", void 0), t([s({ type: rr, json: { write: !0 } })], D.prototype, "directions", void 0), t([s({ type: H, json: { write: !0 } })], D.prototype, "route", void 0), t([s({ type: String, json: { write: !0 } })], D.prototype, "routeName", void 0), t([s({ type: [H], json: { write: !0 } })], D.prototype, "stops", void 0), t([s({ type: x, json: { write: !0 } })], D.prototype, "traversedEdges", void 0), t([s({ type: x, json: { write: !0 } })], D.prototype, "traversedJunctions", void 0), t([s({ type: x, json: { write: !0 } })], D.prototype, "traversedTurns", void 0), D = t([A("esri.rest.support.RouteResult")], D);
const or = D;
function ge(e) {
  return e ? x.fromJSON(e).features.filter(We) : [];
}
...
t([s({ type: [Qt] })], J.prototype, "messages", void 0), t([s({ type: [H] })], J.prototype, "pointBarriers", void 0), t([N("pointBarriers", ["barriers"])], J.prototype, "readPointBarriers", null), t([s({ type: [H] })], J.prototype, "polylineBarriers", void 0), t([N("polylineBarriers")], J.prototype, "readPolylineBarriers", null), t([s({ type: [H] })], J.prototype, "polygonBarriers", void 0), t([N("polygonBarriers")], J.prototype, "readPolygonBarriers", null), t([s({ type: [or] })], J.prototype, "routeResults", void 0), J = t([A("esri.rest.support.RouteSolveResult")], J);
const sr = J;
function ae(e) {
...
async function ir(e, r, o) {
  ...
  const a = { ...o, query: { ...d.query, ...Dt(r), f: "json" } }, b = g.endsWith("/solve") ? g : `${g}/solve`, { data: P } = await Y(b, a);
  return nr(P);
}
function nr(e) {
  const { barriers: r, directionLines: o, directionPoints: i, directions: n, messages: y, polygonBarriers: u, polylineBarriers: d, routes: g, stops: h, traversedEdges: a, traversedJunctions: b, traversedTurns: P } = e, T = (l) => {
    const B = f.find((I) => I.routeName === l);
    if (B != null) return B;
    const S = { routeId: f.length + 1, routeName: l };
    return f.push(S), S;
  }, m = (l) => {
    const B = f.find((I) => I.routeId === l);
    if (B != null) return B;
  ...
  g?.features.forEach((l, B) => {
    ...
    const S = l.attributes.Name, I = B + 1;
    f.push({ routeId: I, routeName: S, route: l });
  }), n?.forEach((l) => {
    const { routeName: B } = l;
    T(B).directions = l;
  });
  ...
  return h?.features.forEach((l) => {
    ...
    const B = l.attributes.RouteID, S = m(B), { geometryType: I, spatialReference: F } = o;
    S.directionLines ??= { features: [], geometryType: I, spatialReference: F }, S.directionLines.features.push(l);
  }), i?.features.forEach((l) => {
    const B = l.attributes.RouteID, S = m(B), { geometryType: I, spatialReference: F } = i;
    S.directionPoints ??= { features: [], geometryType: I, spatialReference: F }, S.directionPoints.features.push(l);
  }), a?.features.forEach((l) => {
    const B = l.attributes.RouteID, S = m(B), { geometryType: I, spatialReference: F } = a;
    S.traversedEdges ??= { features: [], geometryType: I, spatialReference: F }, S.traversedEdges.features.push(l);
  }), b?.features.forEach((l) => {
    const B = l.attributes.RouteID, S = m(B), { geometryType: I, spatialReference: F } = b;
    S.traversedJunctions ??= { features: [], geometryType: I, spatialReference: F }, S.traversedJunctions.features.push(l);
...
t([s({ type: Boolean, json: { write: !0 } })], k.prototype, "doNotLocateOnRestrictedElements", void 0), t([s({ types: it, json: { read: nt, write: !0 } })], k.prototype, "geometry", void 0), t([R(Mt)], k.prototype, "geometryType", void 0), t([s({ type: String, json: { name: "layerName", write: !0 } })], k.prototype, "name", void 0), t([R(Ct, { name: "spatialRel" })], k.prototype, "spatialRelationship", void 0), t([s({ type: String, json: { write: !0 } })], k.prototype, "type", void 0), t([s({ type: String, json: { write: !0 } })], k.prototype, "where", void 0), k = t([A("esri.rest.support.DataLayer")], k);
const lr = k;
var Be;
...
let p = Ne = class extends $e(j) {
  ...
  writeAccumulateAttributes(e, r, o) {
    e?.length && (r[o] = e.map((i) => Q.toJSON(i)));
  }
  ...
  readRestrictionAttributes(e) {
    return e == null ? null : e.map((r) => je.fromJSON(r));
  }
  writeRestrictionAttributes(e, r, o) {
    e?.length && (r[o] = e.map((i) => je.toJSON(i)));
  }
  readStartTime(e, r) {
    const { startTime: o } = r;
...
function le(e, r, o) {
  e != null && (r[o] = L.isCollection(e) ? { features: e.toArray().map((i) => i.toJSON()) } : e.toJSON());
}
function Se(e) {
...
function gr(e, r, o) {
  ...
  if (y == null) return void Ye().warn("route-layer:missing-travel-mode", "The routing service must have a default travel mode or one must be specified in the route parameter.");
  ...
  const T = o.directionsLanguage ?? r.directionsLanguage, m = o.accumulateAttributes ?? r.accumulateAttributeNames ?? [], f = new Set(n.filter(({ name: c }) => c === u || c === d || c === a || c != null && m.includes(c)).map(({ name: c }) => c)), w = (c) => {
    for (const Le in c) f.has(Le) || delete c[Le];
  };
  ...
  const { routeInfo: l } = e, { findBestSequence: B, preserveFirstStop: S, preserveLastStop: I, startTimeIsUTC: F, timeWindowsAreUTC: Xe } = o;
  l.analysisSettings = new Et({ accumulateAttributes: m, directionsLanguage: T, findBestSequence: B, preserveFirstStop: S, preserveLastStop: I, startTimeIsUTC: F, timeWindowsAreUTC: Xe, travelMode: y }), l.totalDuration = z(l.totalCosts?.[u] ?? 0, b), l.totalDistance = be(l.totalCosts?.[d] ?? 0, P), l.totalLateDuration = z(l.totalViolations?.[u] ?? 0, b), l.totalWaitDuration = z(l.totalWait?.[u] ?? 0, b), l.totalCosts != null && w(l.totalCosts), l.totalViolations != null && w(l.totalViolations), l.totalWait != null && w(l.totalWait);
  for (const c of e.stops) c.serviceCosts != null && (c.serviceDuration = z(c.serviceCosts[u] ?? 0, b), c.serviceDistance = be(c.serviceCosts[d] ?? 0, P), w(c.serviceCosts)), c.cumulativeCosts != null && (c.cumulativeDuration = z(c.cumulativeCosts[u] ?? 0, b), c.cumulativeDistance = be(c.cumulativeCosts[d] ?? 0, P), w(c.cumulativeCosts)), c.violations != null && (c.lateDuration = z(c.violations[u] ?? 0, b), w(c.violations)), c.wait != null && (c.waitDuration = z(c.wait[u] ?? 0, b), w(c.wait));
}
async function Ce(e) {
  const r = q.WGS84;
...
let v = class extends lt(ut(pt(ct(yt(Rt))))) {
  ...
  get fullExtent() {
    const e = new qe({ xmin: -180, ymin: -90, xmax: 180, ymax: 90, spatialReference: q.WGS84 });
  ...
  readRouteInfo(e, r) {
    return this._getNetworkFeatures(r, "RouteInfo", (o) => we.fromGraphic(o)).at(0) ?? null;
  }
  readSpatialReference(e, r) {
    const o = ue(r) ? r.layers : r.featureCollection?.layers;
    if (!o?.length) return q.WGS84;
    const { layerDefinition: i, featureSet: n } = o[0], y = n.features[0], u = y?.geometry?.spatialReference ?? n.spatialReference ?? i.spatialReference ?? i.extent.spatialReference ?? Ie;
    return q.fromJSON(u);
  }
  readStops(e, r) {
  ...
  set url(e) {
    e != null ? this._set("url", ht(e, Ye())) : this._set("url", Oe.routeServiceUrl);
  }
  load(e) {
  ...
  async solve(e, r) {
    const o = e?.stops ?? this.stops, i = e?.pointBarriers ?? Se(this.pointBarriers), n = e?.polylineBarriers ?? Se(this.polylineBarriers), y = e?.polygonBarriers ?? Se(this.polygonBarriers);
    if (o == null) throw new M("routelayer:undefined-stops", "the route layer must have stops defined in the route parameters.");
    if ((vr(o) || wr(o)) && o.features.length < 2 || L.isCollection(o) && o.length < 2) throw new M("routelayer:insufficent-stops", "the route layer must have two or more stops to solve a route.");
    if (L.isCollection(o)) for (const f of o) f.routeName = null;
  ...
  _getNetworkFeatures(e, r, o, i) {
    ...
    if (y == null) return new L();
    const { layerDefinition: u, popupInfo: d, featureSet: g } = y, h = u.drawingInfo.renderer, { features: a } = g, b = g.spatialReference ?? u.spatialReference ?? u.extent.spatialReference ?? Ie, P = h && Tt(h), T = q.fromJSON(b), m = a.map((f) => {
      const w = H.fromJSON(f);
    ...
    return i && m.some(({ symbol: f }) => !f) && i(m), new L(m);
  }
  _getNetworkSymbol(e) {
    switch (e) {
      case "Barriers":
  ...
  _toRouteLayerSolution(e) {
    ...
    const o = new xe(r), i = new _e(e.polygonBarriers?.map((h) => {
  ...
  _writeRouteInfo() {
    return this._writeNetworkFeatures(this.routeInfo != null ? new L([this.routeInfo]) : null, this.defaultSymbols.routeInfo, "esriGeometryPolyline", we.fields, "RouteInfo", "Route Details");
  }
  _writeStops() {
...
} } } } } })], v.prototype, "_type", void 0), t([s({ nonNullable: !0, type: ze })], v.prototype, "defaultSymbols", void 0), t([s({ readOnly: !0 })], v.prototype, "directionLines", void 0), t([N(["web-map", "portal-item"], "directionLines", ["layers", "featureCollection.layers"])], v.prototype, "readDirectionLines", null), t([s({ readOnly: !0 })], v.prototype, "directionPoints", void 0), t([N(["web-map", "portal-item"], "directionPoints", ["layers", "featureCollection.layers"])], v.prototype, "readDirectionPoints", null), t([s({ readOnly: !0, json: { read: !1, origins: { "web-map": { write: { ignoreOrigin: !0 } } } } })], v.prototype, "featureCollectionType", void 0), t([s({ readOnly: !0 })], v.prototype, "fullExtent", null), t([s({ json: { origins: { "web-map": { name: "featureCollection.showLegend" } }, write: !0 } })], v.prototype, "legendEnabled", void 0), t([s({ type: ["show", "hide"] })], v.prototype, "listMode", void 0), t([s({ type: Number, nonNullable: !0, json: { write: !1 } })], v.prototype, "maxScale", void 0), t([N(["web-map", "portal-item"], "maxScale", ["layers", "featureCollection.layers"])], v.prototype, "readMaxScale", null), t([s({ type: Number, nonNullable: !0, json: { write: !1 } })], v.prototype, "minScale", void 0), t([N(["web-map", "portal-item"], "minScale", ["layers", "featureCollection.layers"])], v.prototype, "readMinScale", null), t([s({ type: ["ArcGISFeatureLayer"], value: "ArcGISFeatureLayer" })], v.prototype, "operationalLayerType", void 0), t([s({ nonNullable: !0, type: L.ofType(re) })], v.prototype, "pointBarriers", void 0), t([N(["web-map", "portal-item"], "pointBarriers", ["layers", "featureCollection.layers"])], v.prototype, "readPointBarriers", null), t([s({ nonNullable: !0, type: L.ofType(oe) })], v.prototype, "polygonBarriers", void 0), t([N(["web-map", "portal-item"], "polygonBarriers", ["layers", "featureCollection.layers"])], v.prototype, "readPolygonBarriers", null), t([s({ nonNullable: !0, type: L.ofType(se) })], v.prototype, "polylineBarriers", void 0), t([N(["web-map", "portal-item"], "polylineBarriers", ["layers", "featureCollection.layers"])], v.prototype, "readPolylineBarriers", null), t([s({ readOnly: !0 })], v.prototype, "routeInfo", void 0), t([N(["web-map", "portal-item"], "routeInfo", ["layers", "featureCollection.layers"])], v.prototype, "readRouteInfo", null), t([s({ type: q })], v.prototype, "spatialReference", void 0), t([N(["web-map", "portal-item"], "spatialReference", ["layers", "featureCollection.layers"])], v.prototype, "readSpatialReference", null), t([s({ nonNullable: !0, type: L.ofType(ie) })], v.prototype, "stops", void 0), t([N(["web-map", "portal-item"], "stops", ["layers", "featureCollection.layers"])], v.prototype, "readStops", null), t([s()], v.prototype, "title", null), t([s({ readOnly: !0, json: { read: !1 } })], v.prototype, "type", void 0), t([s()], v.prototype, "url", null), v = t([A(Qe)], v);
const kr = v;
export {
  kr as default
};
//# sourceMappingURL=RouteLayer-DDdN3ioE.js.map
