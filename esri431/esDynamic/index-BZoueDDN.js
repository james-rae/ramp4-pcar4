import { m7 as O, kr as I, m8 as d, hV as x, m9 as P, ku as k, ma as R, kb as G, mb as F, F as T, bs as z, bt as H, bu as N, bv as f, by as v, kf as E, bw as j, gd as m, g8 as D, bx as W, bA as q, bJ as y, g5 as c, g6 as J, bI as U, bG as S, kw as L, bD as g, jO as X } from "./main-DZxT3i7S.js";
class Y extends O {
...
const K = { class: "relative h-full w-full overflow-hidden" }, Q = { class: "absolute h-30 w-30 top-0 right-0" }, ee = ["content", "aria-label"], te = /* @__PURE__ */ z({
  __name: "overviewmap",
  setup(u) {
    const e = d(), { t: a } = H(), i = N("iApi"), t = G(), s = f(), n = v(() => t.activeBasemapConfig), _ = v(() => e.mapConfig), b = v(() => e.basemaps), A = v(() => e.startMinimized);
    let r = E(new Y(i));
    ...
    j(() => {
      i.geo.map.viewPromise.then(async () => {
        ...
        let h = r.updateOverview(i.geo.map.getExtent());
        l.push(
          i.event.on(
            m.MAP_EXTENTCHANGE,
            D(100, (o) => {
    ...
    return (h, o) => {
      ...
      return g(), y("div", {
        ...
        c("div", {
          ...
          c("div", K, [
            c("div", {
              class: J(["overviewmap absolute top-0 right-0 h-192 w-192", { "cursor-move": M.value }]),
              onMousemove: $
            }, null, 34)
          ]),
          c("div", Q, [
...
}), ae = /* @__PURE__ */ X(te, [["__scopeId", "data-v-461fd934"]]), ie = { en: { "overviewmap.expand": "Expand Overview", "overviewmap.minimize": "Minimize Overview" }, fr: { "overviewmap.expand": "Développer l'aperçu", "overviewmap.minimize": "Réduire l'aperçu" } };
class oe extends Z {
  added() {
...
//# sourceMappingURL=index-BZoueDDN.js.map
