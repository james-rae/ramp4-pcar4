import { eu as P, h6 as d, bQ as t, bR as n, hQ as h, kS as w, kT as S, bS as m, jK as j, D as v, gf as q, i5 as z, jJ as D, a8 as R, d5 as E, cz as $, hI as N, d4 as k, jL as A, aA as b, ez as C, eC as L, f9 as T, eM as _ } from "./main-DZxT3i7S.js";
import { c as H } from "./Analysis-C3ehJX_-.js";
...
t([n({ type: ["simple"], readOnly: !0, json: { write: { isRequired: !0 } } })], r.prototype, "type", void 0), t([n({ type: d, nonNullable: !0, json: { type: [h], write: { isRequired: !0 } } })], r.prototype, "color", void 0), t([n({ type: Number, cast: w, nonNullable: !0, range: { min: S(1) }, json: { write: { isRequired: !0 } } })], r.prototype, "lineSize", void 0), t([n({ type: Number, cast: w, nonNullable: !0, json: { write: { isRequired: !0 } } })], r.prototype, "fontSize", void 0), t([n({ type: d, nonNullable: !0, json: { type: [h], write: { isRequired: !0 } } })], r.prototype, "textColor", void 0), t([n({ type: d, nonNullable: !0, json: { type: [h], write: { isRequired: !0 } } })], r.prototype, "textBackgroundColor", void 0), r = t([m("esri.analysis.DimensionSimpleStyle")], r);
const g = r;
var y;
(function(e) {
...
let a = class extends H {
  ...
  get dimensions() {
    return this._get("dimensions") || new f();
  }
  set dimensions(e) {
    this._set("dimensions", k(e, this.dimensions, f));
  }
...
t([n({ type: ["dimension"] })], a.prototype, "type", void 0), t([n({ cast: E, type: f, nonNullable: !0 })], a.prototype, "dimensions", null), t([n({ readOnly: !0 })], a.prototype, "spatialReference", null), t([n({ types: { key: "type", base: null, typeMap: { simple: g } }, nonNullable: !0 })], a.prototype, "style", void 0), t([n({ value: null, readOnly: !0 })], a.prototype, "extent", void 0), t([n({ readOnly: !0 })], a.prototype, "requiredPropertiesForEditing", null), a = t([m("esri.analysis.DimensionAnalysis")], a);
const x = a;
let s = class extends C(L(_)) {
  constructor(e) {
