import { z as Yt } from "./main-DZxT3i7S.js";
var Ze, er = { exports: {} };
function Bt() {
  return Ze || (Ze = 1, me = er, ae = typeof document < "u" ? document.currentScript?.src : void 0, ve = function(rr = {}) {
    var pe, G, s = Object.assign({}, rr), tr = new Promise((e, r) => {
      pe = e, G = r;
    }), nr = !0, ye = Object.assign({}, s), ge = "./this.program", D = "";
    function ar(e) {
      return s.locateFile ? s.locateFile(e, D) : D + e;
    }
    typeof document < "u" && document.currentScript && (D = document.currentScript.src), ae && (D = ae), D = D.startsWith("blob:") ? "" : D.substr(0, D.replace(/[?#].*/, "").lastIndexOf("/") + 1), s.print || console.log.bind(console);
    var V, J, U = s.printErr || console.error.bind(console);
    Object.assign(s, ye), ye = null, s.arguments && s.arguments, s.thisProgram && (ge = s.thisProgram), s.quit && s.quit, s.wasmBinary && (V = s.wasmBinary);
    var P, _, H, Y, g, v, we, _e, be = !1;
    function Ae() {
      var e = J.buffer;
      s.HEAP8 = P = new Int8Array(e), s.HEAP16 = H = new Int16Array(e), s.HEAPU8 = _ = new Uint8Array(e), s.HEAPU16 = Y = new Uint16Array(e), s.HEAP32 = g = new Int32Array(e), s.HEAPU32 = v = new Uint32Array(e), s.HEAPF32 = we = new Float32Array(e), s.HEAPF64 = _e = new Float64Array(e);
    }
    var Te = [], Ce = [], Fe = [];
    function or() {
      if (s.preRun) for (typeof s.preRun == "function" && (s.preRun = [s.preRun]); s.preRun.length; ) sr(s.preRun.shift());
      oe(Te);
    }
    function ir() {
      oe(Ce);
    ...
    function ur() {
      if (s.postRun) for (typeof s.postRun == "function" && (s.postRun = [s.postRun]); s.postRun.length; ) cr(s.postRun.shift());
      oe(Fe);
    }
    function sr(e) {
      Te.unshift(e);
    ...
    function Pe(e) {
      s.onAbort?.(e), U(e = "Aborted(" + e + ")"), be = !0, e += ". Build with -sASSERTIONS for more info.";
      var r = new WebAssembly.RuntimeError(e);
      throw G(r), r;
    }
    var z, hr = "data:application/octet-stream;base64,", We = (e) => e.startsWith(hr);
    function Ee(e) {
      if (e == z && V) return new Uint8Array(V);
      throw "both async and sync fetching of the wasm failed";
    }
    function mr(e) {
      return !V && nr && typeof fetch == "function" ? fetch(e, { credentials: "same-origin" }).then((r) => {
        if (!r.ok) throw `failed to load wasm binary file at '${e}'`;
        return r.arrayBuffer();
      }).catch(() => Ee(e)) : Promise.resolve().then(() => Ee(e));
    }
    function Se(e, r, t) {
      return mr(e).then((n) => WebAssembly.instantiate(n, r)).then(t, (n) => {
        U(`failed to asynchronously prepare wasm: ${n}`), Pe(n);
      });
    }
    function vr(e, r, t, n) {
      return e || typeof WebAssembly.instantiateStreaming != "function" || We(r) || typeof fetch != "function" ? Se(r, t, n) : fetch(r, { credentials: "same-origin" }).then((a) => WebAssembly.instantiateStreaming(a, t).then(n, function(o) {
        return U(`wasm streaming compile failed: ${o}`), U("falling back to ArrayBuffer instantiation"), Se(r, t, n);
      }));
    }
    function pr() {
      return { a: Vt };
    ...
    function yr() {
      var e = pr();
      function r(n, a) {
        return F = n.exports, J = F.M, Ae(), ke = F.P, lr(F.N), dr(), F;
      }
      function t(n) {
        r(n.instance);
      }
      if (fr(), s.instantiateWasm) try {
        return s.instantiateWasm(e, r);
      } catch (n) {
        U(`Module.instantiateWasm callback failed with error: ${n}`), G(n);
      }
      return vr(V, z, e, t).catch(G), {};
    }
    We(z = "lclayout.wasm") || (z = ar(z));
    var oe = (e) => {
    ...
    var $ = 8, Cr = (e, r, t, n) => {
      ...
      e = w(e), ue([], [r], (n) => (n = n[0], s[e] = n.fromWireType(t), []));
    }, se = [], j = [], le = (e) => {
      e > 9 && --j[e + 1] == 0 && (j[e] = void 0, se.push(e));
    }, Pr = () => j.length / 2 - 5 - se.length, Wr = () => {
      j.push(0, 1, void 0, 1, null, 1, !0, 1, !1, 1), s.count_emval_handles = Pr;
      ...
      switch (e) {
        ...
        case !1:
          return 8;
        default: {
          const r = se.pop() || j.length;
          return j[r] = e, j[r + 1] = 1, r;
        }
      }
    } }, Er = { name: "emscripten::val", fromWireType: (e) => {
      var r = b.toValue(e);
      return le(e), r;
    }, toWireType: (e, r) => b.toHandle(r), argPackAdvance: $, readValueFromPointer: X, destructorFunction: null }, je = (e) => E(e, Er), Sr = (e, r, t) => {
      ...
      s.hasOwnProperty(e) ? ((t === void 0 || s[e].overloadTable !== void 0 && s[e].overloadTable[t] !== void 0) && C(`Cannot register public name '${e}' twice`), Sr(s, e, e), s.hasOwnProperty(t) && C(`Cannot register multiple overloads of a function with the same number of arguments (${t})!`), s[e].overloadTable[t] = r) : (s[e] = r, t !== void 0 && (s[e].numArguments = t));
    }, $r = (e, r, t) => {
      switch (r) {
        case 1:
          return t ? function(n) {
      ...
      }, toWireType: (o, l) => l.value, argPackAdvance: $, readValueFromPointer: $r(r, t, n), destructorFunction: null }), Re(r, a);
    }, Q = (e, r) => Object.defineProperty(r, "name", { value: e }), xe = (e) => {
      var r = Xe(e), t = w(r);
      return O(r), t;
    }, Z = (e, r) => {
      var t = k[e];
      return t === void 0 && C(`${r} has unknown type ${xe(e)}`), t;
    }, Mr = (e, r, t) => {
      var n = Z(e, "enum");
      r = w(r);
      ...
      switch (r) {
        case 4:
          return function(t) {
            return this.fromWireType(we[t >> 2]);
          };
        case 8:
          return function(t) {
            return this.fromWireType(_e[t >> 3]);
          };
        default:
          throw new TypeError(`invalid float width (${r}): ${e}`);
      }
    }, jr = (e, r, t) => {
      E(e, { name: r = w(r), fromWireType: (n) => n, toWireType: (n, a) => a, argPackAdvance: $, readValueFromPointer: Dr(r, t), destructorFunction: null });
    };
    function Rr(e) {
      for (var r = 1; r < e.length; ++r) if (e[r] !== null && e[r].destructorFunction === void 0) return !0;
      return !1;
    }
    function xr(e, r, t, n, a, o) {
      var l = r.length;
      l < 2 && C("argTypes array size mismatch! Must at least get return value and 'this' types!");
      var i = r[1] !== null && t !== null, c = Rr(r), f = r[0].name !== "void", h = l - 2, p = new Array(h), m = [], y = [];
    ...
    var ke, He, Ie, kr = (e, r) => {
      ...
      s.hasOwnProperty(e) || De("Replacing nonexistent public symbol"), s[e].overloadTable !== void 0 && t !== void 0 ? s[e].overloadTable[t] = r : (s[e] = r, s[e].argCount = t);
    }, Ir = (e, r, t) => (e = e.replace(/p/g, "i"), (0, s["dynCall_" + e])(r, ...t)), ee = [], Ve = (e) => {
      var r = ee[e];
      return r || (e >= ee.length && (ee.length = e + 1), ee[e] = r = ke.get(e)), r;
    }, Vr = (e, r, t = []) => e.includes("j") ? Ir(e, r, t) : Ve(r)(...t), Ur = (e, r) => (...t) => Vr(e, r, t), N = (e, r) => {
      function t() {
        return e.includes("j") ? Ur(e, r) : Ve(r);
      }
      e = w(e);
      var n = t();
...
` + a.replace(/^Error(:[^\n]*)?\n/, ""));
      ...
      throw r.forEach(a), new He(`${e}: ` + t.map(xe).join([", "]));
    }, zr = (e) => {
      const r = (e = e.trim()).indexOf("(");
      return r !== -1 ? e.substr(0, r) : e;
    }, Nr = (e, r, t, n, a, o, l) => {
      var i = kr(r, t);
      e = w(e), e = zr(e), a = N(n, a), Re(e, function() {
        Br(`Cannot call ${e} due to unbound types`, i);
      }, r - 1), ue([], i, (c) => {
        var f = [c[0], null].concat(c.slice(1));
        return Hr(e, xr(e, f, null, a, o), r - 1), [];
      });
    }, qr = (e, r, t) => {
      switch (r) {
        case 1:
      ...
      }, argPackAdvance: $, readValueFromPointer: qr(r, t, n !== 0), destructorFunction: null });
    }, Jr = (e, r, t) => {
      ...
      return r[t] = 0, t - a;
    }, Xr = (e, r, t) => Ue(e, _, r, t), Ye = (e) => {
      for (var r = 0, t = 0; t < e.length; ++t) {
        var n = e.charCodeAt(t);
        n <= 127 ? r++ : n <= 2047 ? r += 2 : n >= 55296 && n <= 57343 ? (r += 4, ++t) : r += 3;
      }
      return r;
    }, Be = typeof TextDecoder < "u" ? new TextDecoder("utf8") : void 0, Kr = (e, r, t) => {
      for (var n = r + t, a = r; e[a] && !(a >= n); ) ++a;
      if (a - r > 16 && e.buffer && Be) return Be.decode(e.subarray(r, a));
      for (var o = ""; r < a; ) {
        var l = e[r++];
        if (128 & l) {
          var i = 63 & e[r++];
      ...
      E(e, { name: r, fromWireType(n) {
        ...
        l || a instanceof Uint8Array || a instanceof Uint8ClampedArray || a instanceof Int8Array || C("Cannot pass non-string to std::string"), o = t && l ? Ye(a) : a.length;
        var i = he(4 + o + 1), c = i + 4;
        if (v[i >> 2] = o, t && l) Xr(a, c, o + 1);
    ...
    }, ze = typeof TextDecoder < "u" ? new TextDecoder("utf-16le") : void 0, Zr = (e, r) => {
      for (var t = e, n = t >> 1, a = n + r / 2; !(n >= a) && Y[n]; ) ++n;
      if ((t = n << 1) - e > 32 && ze) return ze.decode(_.subarray(e, t));
      ...
      var n, a, o, l;
      t = w(t), r === 2 ? (n = Zr, a = et, l = rt, o = (i) => Y[i >> 1]) : r === 4 && (n = tt, a = nt, l = at, o = (i) => v[i >> 2]), E(e, { name: t, fromWireType: (i) => {
      ...
      Pe("");
    }, Pt = () => Date.now(), Ge = () => 2147483648, Wt = () => Ge();
    Ie = () => performance.now();
    var Et = (e) => {
      var r = (e - J.buffer.byteLength + 65535) / 65536;
      try {
        return J.grow(r), Ae(), 1;
      } catch {
      }
    }, St = (e) => {
      var r = _.length;
      ...
      return !1;
    }, de = {}, $t = () => ge || "./this.program", q = () => {
      if (!q.strings) {
        var e = { USER: "web_user", LOGNAME: "web_user", PATH: "/", PWD: "/", HOME: "/home/web_user", LANG: (typeof navigator == "object" && navigator.languages && navigator.languages[0] || "C").replace("-", "_") + ".UTF-8", _: $t() };
        for (var r in de) de[r] === void 0 ? delete e[r] : e[r] = de[r];
        var t = [];
      ...
      return q().forEach((n, a) => {
        var o = r + t;
        v[e + 4 * a >> 2] = o, Ot(n, o), t += n.length + 1;
      }), 0;
    }, Dt = (e, r) => {
      var t = q();
      v[e >> 2] = t.length;
    ...
    }, re = (e) => e % 4 == 0 && (e % 100 != 0 || e % 400 == 0), jt = (e, r) => {
      for (var t = 0, n = 0; n <= r; t += e[n++]) ;
      return t;
    }, Je = [31, 29, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31], Le = [31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31], Rt = (e, r) => {
      for (var t = new Date(e.getTime()); r > 0; ) {
        var n = re(t.getFullYear()), a = t.getMonth(), o = (n ? Je : Le)[a];
    ...
    function xt(e, r, t) {
      var n = Ye(e) + 1, a = new Array(n);
      return Ue(e, a, 0, a.length), a;
    }
    var kt = (e, r) => {
      P.set(e, r);
    }, Ht = (e, r, t, n) => {
      ...
      function R(u) {
        var d = Rt(new Date(u.tm_year + 1900, 0, 1), u.tm_yday), A = new Date(d.getFullYear(), 0, 4), T = new Date(d.getFullYear() + 1, 0, 4), ne = S(A), Ut = S(T);
        return y(ne, d) <= 0 ? y(Ut, d) <= 0 ? d.getFullYear() + 1 : d.getFullYear() : d.getFullYear() - 1;
      }
      ...
      }, "%j": (u) => m(u.tm_mday + jt(re(u.tm_year + 1900) ? Je : Le, u.tm_mon - 1), 3), "%m": (u) => m(u.tm_mon + 1, 2), "%M": (u) => m(u.tm_min, 2), "%n": () => `
`, "%p": (u) => u.tm_hour >= 0 && u.tm_hour < 12 ? "AM" : "PM", "%S": (u) => m(u.tm_sec, 2), "%t": () => "	", "%u": (u) => u.tm_wday || 7, "%U": (u) => {
      ...
      var M = xt(l = l.replace(/\0\0/g, "%"));
      return M.length > r ? 0 : (kt(M, e), M.length - 1);
    }, It = (e, r, t, n, a) => Ht(e, r, t, n);
    $e = s.InternalError = class extends Error {
      constructor(e) {
        super(e), this.name = "InternalError";
      }
    }, Ar(), Me = s.BindingError = class extends Error {
      constructor(e) {
        super(e), this.name = "BindingError";
      }
    }, Wr(), He = s.UnboundTypeError = Yr(Error, "UnboundTypeError");
    var te, Vt = { a: wr, j: _r, x: br, F: Cr, u: Fr, w: je, v: Or, q: Mr, t: jr, e: Nr, l: Gr, f: Jr, L: Lr, s: Qr, r: ot, k: it, b: ut, K: st, D: ct, I: ft, g: dt, n: mt, c: le, o: gt, h: wt, p: _t, J: bt, m: At, d: Tt, i: Ct, C: Ft, E: Pt, y: Wt, H: Ie, G: St, A: Mt, B: Dt, z: It }, F = yr(), Xe = (e) => (Xe = F.O)(e), he = s._malloc = (e) => (he = s._malloc = F.Q)(e), O = s._free = (e) => (O = s._free = F.R)(e), Ke = (e) => (Ke = F.S)(e);
    function Qe() {
      function e() {
        te || (te = !0, s.calledRun = !0, be || (ir(), pe(s), s.onRuntimeInitialized && s.onRuntimeInitialized(), ur()));
      }
      x > 0 || (or(), x > 0 || (s.setStatus ? (s.setStatus("Running..."), setTimeout(function() {
        setTimeout(function() {
          s.setStatus("");
        }, 1), e();
      }, 1)) : e()));
    ...
    return Qe(), tr;
  }, me.exports = ve), er.exports;
  var me, ae, ve;
}
const zt = Yt(Bt()), qt = Object.freeze(Object.defineProperty({ __proto__: null, default: zt }, Symbol.toStringTag, { value: "Module" }));
export {
  qt as l
};
//# sourceMappingURL=lclayout-BBUCNmnC.js.map
