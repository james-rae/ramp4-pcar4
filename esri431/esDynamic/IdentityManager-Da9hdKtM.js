import { bQ as u, bR as _, l1 as $, bS as B, l2 as de, l3 as ue, l4 as O, l5 as pe, l6 as _e, bT as oe, ds as ne, l7 as ae, I as z, X as q, l8 as C, s as A, l9 as fe, e4 as b, la as R, U as P, gU as j, lb as F, h4 as H, gV as ee, lc as ge, jd as te, c_ as J, ld as me, le as ve, at as N, dT as se, cZ as we, C as E, lf as Se } from "./main-DZxT3i7S.js";
import { s as Ie } from "./substitute-BBJmR2W2.js";
const W = "esri-identity-modal", G = { base: W, info: `${W}__info`, notice: `${W}__notice` }, ye = "ArcGIS Online";
let T = class extends de {
  ...
  loadDependencies() {
    return ue({ button: () => import("./calcite-button-SSzGhU31.js"), dialog: () => import("./calcite-dialog-Cm7KXheq.js"), input: () => import("./calcite-input-Dc6Y-a67.js"), label: () => import("./calcite-label-1f21eAdp.js"), notice: () => import("./calcite-notice-6L3_r-5-.js") });
  }
  get title() {
  ...
  render() {
    ...
    return O("div", { class: this.classes(G.base, pe()) }, O("form", { bind: this, onsubmit: this._submit }, O("calcite-dialog", { bind: this, heading: e, modal: !0, open: d, outsideCloseDisabled: !0, scale: "s", widthScale: "s", onCalciteDialogClose: this._cancel, onCalciteDialogOpen: this._focusUsernameInput }, O("div", { class: G.info }, Ie(r ? o : p, { server: i && /\.arcgis\.com/i.test(i) ? ye : i, resource: `(${n || l})` })), h ? O("calcite-notice", { class: G.notice, icon: "exclamation-mark-triangle", kind: "danger", open: !0 }, O("div", { slot: "message" }, h.details?.httpStatus ? c : a)) : null, r ? null : [O("calcite-label", null, f, O("calcite-input", { afterCreate: (m) => this._usernameInputNode = m, autocomplete: "off", bind: this, name: "username", required: !0, spellcheck: !1, type: "text", value: "" })), O("calcite-label", null, g, O("calcite-input", { afterCreate: (m) => this._passwordInputNode = m, bind: this, name: "password", required: !0, type: "password", value: "" }))], O("calcite-button", { appearance: "outline", bind: this, onclick: this._cancel, slot: "footer-end", type: "button" }, v), O("calcite-button", { loading: !!t, slot: "footer-end", type: "submit" }, t ? w : k))));
  }
  _focusUsernameInput() {
    return _e(() => this._usernameInputNode);
  }
  _cancel() {
...
u([_({ readOnly: !0 })], T.prototype, "container", void 0), u([_(), $("esri/t9n/common")], T.prototype, "commonMessages", void 0), u([_()], T.prototype, "error", void 0), u([_(), $("esri/identity/t9n/identity")], T.prototype, "messages", void 0), u([_()], T.prototype, "oAuthPrompt", void 0), u([_()], T.prototype, "open", void 0), u([_()], T.prototype, "signingIn", void 0), u([_()], T.prototype, "server", void 0), u([_({ readOnly: !0 })], T.prototype, "title", null), u([_()], T.prototype, "resource", void 0), T = u([B("esri.identity.IdentityModal")], T);
const re = T, K = "esriJSAPIOAuth";
class Q {
  constructor(e, s) {
  ...
  _load() {
    let e = {};
    if (this.storage) {
      const s = this.storage.getItem(K);
      if (s) try {
        e = JSON.parse(s);
      } catch (t) {
        console.warn(t);
...
Q.prototype.declaredClass = "esri.identity.OAuthCredential";
var Y;
let U = Y = class extends oe {
  constructor(d) {
...
class le extends ne {
  ...
  toJSON() {
    return ae({ serverInfos: this.serverInfos.map((e) => e.toJSON()), oAuthInfos: this.oAuthInfos.map((e) => e.toJSON()), credentials: this.credentials.map((e) => e.toJSON()) });
  }
  initialize(e) {
    if (!e) return;
    ...
    if (t) {
      const i = [];
      t.forEach((n) => {
        n.appId && i.push(n.declaredClass ? n : new ie(n));
  ...
  generateToken(e, s, t) {
    ...
    return r || (v.withCredentials = !1), P(l, v).then((w) => {
      ...
      const m = e.server;
      return V[m] || (V[m] = {}), s && (V[m][s.username] = s.password), k.validity = g, k;
    });
  }
  isBusy() {
    return !!this._busy;
  ...
  setOAuthResponseHash(e) {
    e && (e.charAt(0) === "#" && (e = e.slice(1)), this._processOAuthPopupParams(j(e)));
  }
  ...
  signIn(e, s, t = {}) {
    ...
    const h = new re({ open: !0, resource: this.getResourceName(e), server: s.server });
    ...
    let p = h.on("cancel", n), o = h.on("submit", (l) => {
      this.generateToken(s, l, { isAdmin: t.isAdmin, signal: t.signal }).then((c) => {
        i();
        const a = new I({ userId: l.username, server: s.server ?? void 0, token: c.token, expires: c.expires != null ? Number(c.expires) : null, ssl: !!c.ssl, isAdmin: t.isAdmin, validity: c.validity });
        r.resolve(a);
      }).catch((c) => {
  ...
  oAuthSignIn(e, s, t, r) {
    ...
    if (h.storage && (t.flowType === "authorization-code" || t.flowType === "auto" && s.currentVersion >= 8.4)) {
      ...
      n = F(a), h.codeVerifier = n, a = crypto.getRandomValues(new Uint8Array(32)), h.stateUID = F(a), h.save() || (h.codeVerifier = n = null);
    ...
    this._getCodeChallenge(n).then((a) => {
      ...
      const g = new re({ oAuthPrompt: !0, server: s.server, open: !0 });
  ...
  enablePostMessageAuth(e = "https://www.arcgis.com/sharing/rest") {
    this._postMessageAuthHandle && this._postMessageAuthHandle.remove(), this._postMessageAuthHandle = H(window, "message", (s) => {
  ...
  _getOAuthLocationParams() {
    ...
    if (s) {
      ...
      if (r) {
        ...
        const n = ee(i), h = window.location.pathname + (n ? `?${n}` : "") + (t.state?.hash || "");
  ...
  _getServerInstanceRoot(e) {
    ...
    return t === -1 && this._isAdminResource(e) && (t = this._agsAdmin.test(e) ? e.replace(this._agsAdmin, "$1").length : e.search(this._adminSvcs)), t !== -1 || ge(s) || (t = s.indexOf("/sharing")), t === -1 && s.endsWith("/") && (t = s.length - 1), t > -1 ? e.slice(0, t) : e;
  }
  _hasSameServerInstance(e, s) {
    return e.endsWith("/") && (e = e.slice(0, -1)), e = e.toLowerCase(), s = this._getServerInstanceRoot(s).toLowerCase(), e = te(e), s = te(s), (e = e.slice(Math.max(0, e.indexOf(":")))) === (s = s.slice(Math.max(0, s.indexOf(":"))));
  }
  _sanitizeUrl(e) {
    const s = (J.request.proxyUrl || "").toLowerCase(), t = s ? e.toLowerCase().indexOf(s + "?") : -1;
    return t !== -1 && (e = e.slice(t + s.length + 1)), e = me(e), z(e).path;
  }
  _isRESTService(e) {
  ...
  _isPortalDomain(e) {
    ...
    return !r && t && (r = this._hasSameServerInstance(this._getServerInstanceRoot(t.restBaseUrl), s.uri)), r || J.portalUrl && (r = b(s, J.portalUrl, !0)), r || (r = this._portals.some((i) => this._hasSameServerInstance(i, s.uri))), r = r || this._agsPortal.test(s.path), r;
  }
  _isIdProvider(e, s) {
    let t = -1, r = -1;
    ...
    if (t > -1 && r > -1 && (t === 0 || t === 4 ? r !== 0 && r !== 4 || (i = !0) : t === 1 ? r !== 1 && r !== 2 || (i = !0) : t === 2 ? r === 2 && (i = !0) : t === 3 && r === 3 && (i = !0)), !i) {
      ...
      h && he(n) && this._isPortalDomain(h) && this._isIdProvider(e, h) && (i = !0);
    }
    return i;
  }
  ...
  _getTokenSvcUrl(e) {
    ...
    if (this._isPortalDomain(e)) {
      let i = "";
      if (this._gwDomains.some((n) => (n.regex.test(e) && (i = n.tokenServiceUrl), !!i)), i || this._portals.some((n) => (this._hasSameServerInstance(n, e) && (i = n + this._gwTokenUrl), !!i)), i || (r = e.toLowerCase().indexOf("/sharing"), r !== -1 && (i = e.slice(0, r) + this._gwTokenUrl)), i || (i = this._getOrigin(e) + this._gwTokenUrl), i) {
  ...
  _processOAuthResponseParams(e, s, t) {
    ...
    if (e.code) {
      ...
      return r.codeVerifier = null, r.stateUID = null, r.save(), this._getOAuthToken(t.server, e.code, s.appId, this._getRedirectURI(s, !0), n).then((h) => {
        const p = new I({ userId: h.username, server: t.server ?? void 0, token: h.access_token, expires: Date.now() + 1e3 * h.expires_in, ssl: h.ssl, oAuthState: e.state, _oAuthCred: r });
        return s.userId = p.userId, r.storage = h.persist ? L : M, r.refreshToken = h.refresh_token, r.token = null, r.expires = h.refresh_token_expires_in ? Date.now() + 1e3 * h.refresh_token_expires_in : null, r.userId = p.userId, r.ssl = p.ssl, r.save(), p;
      });
    }
    const i = new I({ userId: e.username, server: t.server ?? void 0, token: e.access_token, expires: Date.now() + 1e3 * Number(e.expires_in), ssl: e.ssl === "true", oAuthState: e.state, _oAuthCred: r });
    return s.userId = i.userId, r.storage = e.persist ? L : M, r.refreshToken = null, r.token = i.token, r.expires = i.expires, r.userId = i.userId, r.ssl = i.ssl, r.save(), Promise.resolve(i);
  }
  ...
  _checkProtocol(e, s, t, r) {
    ...
    return n.trim().toLowerCase().startsWith("https:") && !this._appOrigin.startsWith("https:") && ve(n) && (i = !!this._protocolFunc && !!this._protocolFunc({ resourceUrl: e, serverInfo: s }), !i) && t(new A("identity-manager:aborted", "Aborted the Sign-In process to avoid sending password over insecure connection.")), i;
  }
  _enqueue(e, s, t, r, i, n) {
    return r || (r = q()), r.resUrl_ = e, r.sinfo_ = s, r.options_ = t, r.admin_ = i, r.refresh_ = n, this._busy ? this._hasSameServerInstance(this._getServerInstanceRoot(e), this._busy.resUrl_) ? (this._oAuthDfd && this._oAuthDfd.oAuthWin_ && this._oAuthDfd.oAuthWin_.focus(), this._soReqs.push(r)) : this._xoReqs.push(r) : this._doSignIn(r), r.promise;
  }
  _doSignIn(e) {
    ...
    const s = (o) => {
      ...
      let w, k;
      if (o) s(new I({ userId: o, server: f.server ?? void 0, token: c ?? void 0, expires: a != null ? Number(a) : null, ssl: !!l }));
        ...
        const m = H(window, "message", (y) => {
          y.source === window.parent && y.data && (y.data.type === "arcgis:auth:credential" ? (m.remove(), y.data.credential.expires < Date.now() ? t(new A("identity-manager:credential-request-failed", "Parent application's token has expired.")) : s(new I(y.data.credential))) : y.data.type === "arcgis:auth:error" && (m.remove(), y.data.error.name === "tokenExpiredError" ? t(new A("identity-manager:credential-request-failed", "Parent application's token has expired.")) : t(A.fromJSON(y.data.error))));
        });
        C(e.options_?.signal, () => {
          m.remove();
        });
        ...
        let m = v._oAuthCred;
        if (!m) {
          const y = new Q(v, L), S = new Q(v, M);
          y.isValid() && S.isValid() ? y.expires > S.expires ? (m = y, S.destroy()) : (m = S, y.destroy()) : m = y.isValid() ? y : S, v._oAuthCred = m;
        }
        if (m.isValid()) {
          w = new I({ userId: m.userId ?? void 0, server: f.server ?? void 0, token: m.token ?? void 0, expires: m.expires, ssl: m.ssl ?? void 0, _oAuthCred: m });
          const y = v.appId !== m.appId && this._doPortalSignIn(e.resUrl_);
          y || m.refreshToken ? (e._pendingDfd = m.refreshToken ? this._getOAuthToken(f.server, m.refreshToken, m.appId).then((S) => (w.expires = Date.now() + 1e3 * S.expires_in, w.token = S.access_token, w)) : Promise.resolve(w), e._pendingDfd.then((S) => y ? this._exchangeToken(S.server, v.appId, S.token).then((D) => (S.token = D, S)).catch(() => S) : S).then((S) => {
            s(S);
          }).catch((S) => {
            const D = S.details?.httpStatus;
            D > 0 && D !== 404 ? (m.destroy(), r()) : t(S);
          })) : s(w);
          ...
          this._oAuthLocationParams = null, e._pendingDfd = this._processOAuthResponseParams(y, v, f).then((S) => {
            s(S);
          }).catch(t);
        } else {
          const y = () => {
          ...
          this._doPortalSignIn(e.resUrl_) ? e._pendingDfd = this._getPlatformSelf(f.server, v.appId).then((S) => {
            b(S.portalUrl, this._appOrigin, !0) ? (w = new I({ userId: S.username, server: f.server ?? void 0, expires: Date.now() + 1e3 * S.expires_in, token: S.token }), s(w)) : y();
          }).catch(y) : y();
        }
      } else if (g) {
      ...
      if (v) {
        ...
        if (w) s(w);
        else if (Z(o, this._legacyFed)) {
          const k = v.toJSON();
          k.server = o.server, k.resources = null, s(new I(k));
        } else
          (e._pendingDfd = this.generateToken(this.findServerInfo(v.server), null, { serverUrl: e.resUrl_, token: v.token, signal: e.options_.signal, ssl: v.ssl })).then((k) => {
            s(new I({ userId: v?.userId, server: o.server ?? void 0, token: k.token, expires: k.expires != null ? Number(k.expires) : null, ssl: !!k.ssl, isAdmin: e.admin_, validity: k.validity }));
          }, t);
      } else
    ...
    p ? p.promise.then((o) => {
      const l = e.sinfo_;
      if (l._restInfoPms) {
        l.adminTokenServiceUrl = l._restInfoPms.adminUrl, l._restInfoPms = null, l.tokenServiceUrl = (N("authInfo.tokenServicesUrl", o) || N("authInfo.tokenServiceUrl", o) || N("tokenServiceUrl", o)) ?? null, l.shortLivedTokenValidity = N("authInfo.shortLivedTokenValidity", o) ?? null, l.currentVersion = o.currentVersion, l.owningTenant = o.owningTenant;
  ...
  _generateOAuthInfo(e) {
    ...
    return h && t ? (this._hasTestedIfAppIsOnPortal = !0, s = P(t + "/sharing/rest", { query: { f: "json" } }).then(() => {
      this._defaultOAuthInfo = new ie({ appId: "arcgisonline", popupCallbackUrl: t + "/home/oauth-callback.html" });
    })) : s = Promise.resolve(), s.then(() => {
      if (this._defaultOAuthInfo) return r = r.replace(/^http:/i, "https:"), P(r + "/sharing/rest/oauth2/validateRedirectUri", { query: { accountId: n, client_id: this._defaultOAuthInfo.appId, redirect_uri: se(this._defaultOAuthInfo.popupCallbackUrl), f: "json" } }).then((p) => {
        if (p.data.valid) {
  ...
  _doOAuthSignIn(e, s, t, r) {
    ...
    const p = t.portalUrl.replace(/^http:/i, "https:") + "/sharing/oauth2/authorize", o = p + "?" + ee(h);
    if (t.popup) {
      ...
      }, 500), this._oAuthOnPopupHandle = H(window, ["arcgis:auth:hash", "arcgis:auth:location:search"], (c) => {
  ...
  _getRedirectURI(e, s) {
    ...
    if (e.popup) return se(e.popupCallbackUrl);
    if (s) {
      const r = z(t);
...
le.prototype.declaredClass = "esri.identity.IdentityManagerBase";
let I = class extends ne.EventedAccessor {
  constructor(d) {
  ...
  refreshToken() {
    const d = E, e = d.findServerInfo(this.server), s = e?.owningSystemUrl, t = !!s && this.scope === "server", r = t && Z(e, d._legacyFed), i = e.webTierAuth, n = i && d.normalizeWebTierAuth, h = V[this.server], p = h?.[this.userId];
  ...
  refreshServerTokens() {
    if (this.scope === "portal") {
      ...
      d.credentials.forEach((e) => {
        ...
        e !== this && e.userId === this.userId && t && e.scope === "server" && (d._hasSameServerInstance(this.server, t) || d._isIdProvider(t, this.server)) && (Z(s, d._legacyFed) ? (e.token = this.token, e.expires = this.expires, e.creationTime = this.creationTime, e.validity = this.validity, e.emitTokenChange()) : e.refreshToken());
      });
    }
  }
  emitTokenChange(d) {
    clearTimeout(this._refreshTimer);
    const e = E, s = this.server ? e.findServerInfo(this.server) : null, t = s?.owningSystemUrl, r = t ? e.findServerInfo(t) : null;
  ...
  destroy() {
    ...
    const d = E, e = d.credentials.indexOf(this);
    e > -1 && d.credentials.splice(e, 1), this.emitTokenChange(), this.emit("destroy");
  }
  toJSON() {
    const d = ae({ userId: this.userId, server: this.server, token: this.token, expires: this.expires, validity: this.validity, ssl: this.ssl, isAdmin: this.isAdmin, creationTime: this.creationTime, scope: this.scope }), e = this.resources;
...
u([_()], I.prototype, "creationTime", void 0), u([_()], I.prototype, "expires", void 0), u([_()], I.prototype, "isAdmin", void 0), u([_()], I.prototype, "oAuthState", void 0), u([_()], I.prototype, "resources", void 0), u([_()], I.prototype, "scope", void 0), u([_()], I.prototype, "server", void 0), u([_()], I.prototype, "ssl", void 0), u([_()], I.prototype, "token", void 0), u([_()], I.prototype, "tokenRefreshBuffer", void 0), u([_()], I.prototype, "userId", void 0), u([_()], I.prototype, "validity", void 0), I = u([B("esri.identity.Credential")], I);
class ce extends le {
}
ce.prototype.declaredClass = "esri.identity.IdentityManager";
const ke = new ce();
Se(ke);
export {
  ke as default
};
//# sourceMappingURL=IdentityManager-Da9hdKtM.js.map
