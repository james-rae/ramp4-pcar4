...
const L = {
  ...
  constructor() {
    super(), this.__registerHost(), this.__attachShadow(), this.calciteDropdownSelect = a(this, "calciteDropdownSelect", 6), this.calciteDropdownBeforeClose = a(this, "calciteDropdownBeforeClose", 6), this.calciteDropdownClose = a(this, "calciteDropdownClose", 6), this.calciteDropdownBeforeOpen = a(this, "calciteDropdownBeforeOpen", 6), this.calciteDropdownOpen = a(this, "calciteDropdownOpen", 6), this.items = [], this.groups = [], this.mutationObserver = m("mutation", () => this.updateItems()), this.resizeObserver = m("resize", (e) => this.resizeObserverCallback(e)), this.openTransitionProp = "opacity", this.guid = `calcite-dropdown-${H()}`, this.focusLastDropdownItem = !1, this.setFilteredPlacements = () => {
      ...
      e.style.maxHeight = t > 0 ? `${t}px` : "", this.reposition(!0);
    }, this.setScrollerAndTransitionEl = (e) => {
      this.resizeObserver.observe(e), this.scrollerEl = e, this.transitionEl = e;
    }, this.setReferenceEl = (e) => {
      this.referenceEl = e, l(this, this.referenceEl, this.floatingEl), this.resizeObserver.observe(e);
    }, this.setFloatingEl = (e) => {
      this.floatingEl = e, l(this, this.referenceEl, this.floatingEl);
      ...
      if (!t) {
        ...
        T(i) ? (this.toggleDropdown(), e.preventDefault()) : (i === "ArrowDown" || i === "ArrowUp") && (this.focusLastDropdownItem = i === "ArrowUp", this.open = !0, this.el.addEventListener("calciteDropdownOpen", this.onOpenEnd));
      }
      ...
      this.focusLastDropdownItem = !1, t && p(t);
    }, this.onOpenEnd = () => {
    ...
    }, this.open = !1, this.closeOnSelectDisabled = !1, this.disabled = !1, this.flipPlacements = void 0, this.maxItems = 0, this.overlayPositioning = "absolute", this.placement = x, this.selectedItems = [], this.type = "click", this.widthScale = void 0, this.scale = "m";
  }
  openHandler() {
    if (u(this), this.disabled) {
      this.open = !1;
      return;
    }
    this.reposition(!0);
  ...
  //--------------------------------------------------------------------------
  connectedCallback() {
    this.mutationObserver?.observe(this.el, { childList: !0, subtree: !0 }), this.setFilteredPlacements(), this.open && (this.openHandler(), u(this)), this.updateItems(), l(this, this.referenceEl, this.floatingEl);
  }
  componentWillLoad() {
    z(this);
  }
  componentDidLoad() {
    A(this), l(this, this.referenceEl, this.floatingEl);
  }
  componentDidRender() {
    P(this);
  }
  disconnectedCallback() {
    this.mutationObserver?.disconnect(), this.resizeObserver?.disconnect(), O(this, this.referenceEl, this.floatingEl);
  }
  render() {
    const { open: e, guid: t } = this;
    return o(y, { key: "377c3d9687bc025f004b4efe58bfa5f0893d86d0" }, o(S, { key: "9e2f48be045fc6db10cc7203a8b998ec2b6abafd", disabled: this.disabled }, o("div", { key: "8607de2d53a4f8c4b29206ee56aa23ad4c2cbe3d", class: "calcite-trigger-container", id: `${t}-menubutton`, onClick: this.toggleDropdown, onKeyDown: this.keyDownHandler, ref: this.setReferenceEl }, o("slot", { key: "07de8df34055ddc39301654a5ca312ddf293e6a9", "aria-controls": `${t}-menu`, "aria-expanded": h(e), "aria-haspopup": "menu", name: L.dropdownTrigger, onSlotchange: this.updateTriggers })), o("div", { key: "c1469efb62eb704b021ce6479ad55deda59582d4", "aria-hidden": h(!e), class: "calcite-dropdown-wrapper", ref: this.setFloatingEl }, o("div", { key: "f875166d486a53cd393f17d9295974aa449d449f", "aria-labelledby": `${t}-menubutton`, class: {
      "calcite-dropdown-content": !0,
      [f.animation]: !0,
      [f.animationActive]: e
    }, id: `${t}-menu`, ref: this.setScrollerAndTransitionEl, role: "menu" }, o("slot", { key: "bc6e61383aaf85b3d6242a86c50da68bc8b31e27", onSlotchange: this.updateGroups })))));
  }
  //--------------------------------------------------------------------------
  //
  //  Public Methods
  ...
  async reposition(e = !1) {
    const { floatingEl: t, referenceEl: i, placement: s, overlayPositioning: n, filteredFlipPlacements: c } = this;
    return k(this, {
      floatingEl: t,
      referenceEl: i,
  ...
  getMaxScrollerHeight() {
    ...
    let i = 0, s = 0, n;
    return this.groups.forEach((c) => {
      e > 0 && i < e && Array.from(c.children).forEach((d, D) => {
        D === 0 && (isNaN(n) && (n = d.offsetTop), s += n), i < e && (s += d.offsetHeight, i += 1);
      });
    }), t.length > e ? s : 0;
  }
...
const J = w, N = g;
export {
  J as CalciteDropdown,
  N as defineCustomElement
};
//# sourceMappingURL=calcite-dropdown-2CNgjKeE.js.map
