import { s as g, T as G, dp as L, e as P, a1 as I, bU as J, fb as M } from "./main-DZxT3i7S.js";
import { a as T, n as F, m as S } from "./TimeOnly-1Agv6Qm9.js";
  ...
  for (const l of o) {
    ...
    if (r.variablesPreProcessed) e[c] = s[c];
      ...
      case "featureSetCollection": {
        const t = s[c];
        e[c] = t == null ? null : n ? X(t, n, r) : null;
        break;
      }
      case "dictionary": {
        const t = s[c];
      ...
      case "date": {
        const t = s[c];
        e[c] = t ? t instanceof S ? t : r?.timeZone ? S.dateJSAndZoneToArcadeDate(t, r?.timeZone) : S.dateJSToArcadeDate(t) : null;
        break;
      }
      case "dateOnly": {
        const t = s[c];
...
function R(e, o, a, n, r) {
  const { spatialReference: s, interceptor: l, lruCache: c, console: t, abortSignal: f, timeZone: u, services: $ = { portal: P.getDefault() } } = a, y = { vars: {}, spatialReference: s, interceptor: l, timeZone: u, lrucache: c, useAsync: r, services: $, console: t, abortSignal: f };
...
const U = { variables: [{ name: "$feature", type: "feature" }, { name: "$layer", type: "featureSet" }, { name: "$datastore", type: "featureSetCollection" }, { name: "$map", type: "featureSetCollection" }, { name: "$userInput", type: "geometry" }, { name: "$graph", type: "knowledgeGraph" }] }, D = { variables: [{ name: "$feature", type: "feature" }, { name: "$aggregatedFeatures", type: "featureSet" }] }, O = /* @__PURE__ */ new Map([["aggregate-field", { variables: [{ name: "$feature", type: "feature" }] }], ["form-constraint", { variables: [{ name: "$feature", type: "feature" }] }], ["feature-z", { variables: [{ name: "$feature", type: "feature" }] }], ["field-calculation", { variables: [{ name: "$feature", type: "feature" }, { name: "$datastore", type: "featureSetCollection" }] }], ["form-calculation", { variables: [{ name: "$feature", type: "feature" }, { name: "$originalFeature", type: "feature" }, { name: "$layer", type: "featureSet" }, { name: "$featureSet", type: "featureSet" }, { name: "$datastore", type: "featureSetCollection" }, { name: "$map", type: "featureSetCollection" }, { name: "$editContext", type: "dictionary", properties: [{ name: "editType", type: "text" }] }] }], ["labeling", { variables: [{ name: "$feature", type: "feature" }] }], ["popup", U], ["popup-element", U], ["feature-reduction-popup", D], ["feature-reduction-popup-element", D], ["visualization", { variables: [{ name: "$feature", type: "feature" }, { name: "$view", type: "dictionary", properties: [{ name: "scale", type: "number" }] }] }]]);
function K(e) {
  const o = O.get(e);
  if (!o) {
    const a = Array.from(O.keys()).map((n) => `'${n}'`).join(", ");
...
async function Q(e, o, a = {}) {
  ...
  const $ = r.extractFieldNames(u), y = n.scriptTouchesGeometry(u), h = t.map((i) => i.name.toLowerCase()).filter((i) => l(u, i)), p = c(u, f);
  await s(u, p, f);
  ...
  return { execute: (i, m = {}) => {
    ...
    return m.rawOutput ? d : v(d, r);
  }, isAsync: p, variablesUsed: h, fieldsUsed: $, geometryUsed: y, syntaxTree: u };
}
export {
  Q as createArcadeExecutor,
  K as createArcadeProfile
};
//# sourceMappingURL=arcade-CgBtnu5_.js.map
