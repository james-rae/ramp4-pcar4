import { bs as T, bt as j, bu as W, by as N, bz as Y, bD as p, bB as x, bC as V, g5 as A, g6 as E, bG as L, gb as C, jO as G, bJ as h, pd as te, bv as I, ga as ne, bw as Q, bx as Z, bA as P, bI as H, jN as ee, kd as oe, pe as U, pf as ae, pg as se, bF as re, g3 as ie, hW as D, g9 as le, ph as pe, bK as _, bL as B, bH as q, pi as F, ms as K, pj as ce, F as ue, gd as de } from "./main-DZxT3i7S.js";
class R {
  id;
  /**
...
const fe = ["innerHTML"], O = /* @__PURE__ */ T({
  ...
  setup(y) {
    const { t: a } = j(), n = W("iApi"), o = y, d = N(() => n?.panel.get(o.panelId)?.button), l = () => {
      o.minimize ? n?.panel.toggleMinimize(o.panelId) : n?.panel.toggle(o.panelId);
    };
    return (e, $) => {
      const u = Y("appbar-button");
      return d.value ? (p(), x(u, {
        ...
        default: V(() => [
          A("div", {
            class: E(["default fill-current w-24 h-24 ml-8 sm:ml-20", { "ml-20": y.overflow }]),
...
}), ve = {}, me = { class: "border-b p-0 self-center w-2/3" };
function he(y, a) {
  return p(), h("span", me);
}
const X = /* @__PURE__ */ G(ve, [["render", he], ["__scopeId", "data-v-5d32b715"]]);
var be = {
  name: "maxSize",
  enabled: !0,
  phase: "main",
  ...
  fn: function(a) {
    var n = a.state, o = a.name, d = a.options, l = te(n, d), e = n.modifiersData.preventOverflow || {
      x: 0,
      y: 0
    }, $ = e.x, u = e.y, c = n.rects.popper, m = c.width, S = c.height, w = n.placement.split("-"), k = w[0], v = k === "left" ? "left" : "right", s = k === "top" ? "top" : "bottom";
    n.modifiersData[o] = {
      width: m - l[v] - $,
      height: S - l[s] - u
    };
...
const ge = ["content", "aria-label"], ye = /* @__PURE__ */ T({
  __name: "more-button",
  props: {
    position: {
      type: String,
  ...
  emits: ["updateParent"],
  setup(y, { expose: a, emit: n }) {
    const { t: o } = j(), d = W("iApi"), l = y, e = n;
    function $() {
      e("updateParent");
    }
    const u = I(!1), c = I(0), m = I(), S = I(), w = I();
    function k() {
      $(), U(() => {
        v(), u.value = !u.value;
      });
    ...
    const v = () => {
      ...
      const s = d.$vApp.$el.querySelector(".inner-shell"), b = {
        ...
        fn({ state: f }) {
          ...
          f.styles.popper.height = `${g}px`, w?.value?.offsetHeight && (w.value.style.height = `${g}px`), f.styles.popper.overflowY = "auto", f.styles.popper.overflowX = "hidden";
        }
      };
      S.value && w.value && (c.value++, ae(S.value, w.value, {
    ...
    return Q(() => {
      window.addEventListener(
        "click",
        (s) => {
          s.target instanceof HTMLElement && !m.value?.contains(s.target) && (u.value = !1);
        },
        { capture: !0 }
      );
    }), Z(() => {
...
}), $e = /* @__PURE__ */ G(ye, [["__scopeId", "data-v-93661050"]]), we = {
  key: 0,
  class: "number absolute top-1 right-2 text-white w-18 rounded-full"
}, _e = /* @__PURE__ */ T({
  __name: "appbar-button",
  setup(y) {
    const a = se(), { t: n } = j(), o = W("iApi"), d = N(() => a.notificationNumber), l = () => {
      o.panel.toggle("notifications");
    };
    return (e, $) => {
      const u = Y("appbar-button", !0);
      return p(), x(u, {
        onClickFunction: l,
        ...
        default: V(() => [
          ...
          d.value && d.value > 0 ? (p(), h("span", we, re(d.value), 1)) : C("", !0)
        ]),
        _: 1
      }, 8, ["tooltip"]);
    };
  }
}), xe = /* @__PURE__ */ G(_e, [["__scopeId", "data-v-787da765"]]), Ie = ["content"], ke = /* @__PURE__ */ T({
  __name: "appbar",
  setup(y) {
    const a = ie(), n = D(), o = I(0), d = I(0), l = N(() => n.visible), e = N(() => n.temporary), { t: $ } = j(), u = I(!1), c = I({}), m = I(), S = () => {
      U(() => {
        F()?.proxy?.$forceUpdate();
      });
    }, w = () => {
      ...
      v.key === "Tab" && m.value?.matches(":focus") && m.value._tippy.show();
    };
    return Q(() => {
      m.value?.addEventListener("blur", w), m.value?.addEventListener("keyup", k);
    }), le(() => {
      const v = F();
      window.addEventListener("resize", () => v?.proxy?.$forceUpdate());
    }), Z(() => {
      const v = F();
      window.removeEventListener("resize", () => v?.proxy?.$forceUpdate()), m.value?.removeEventListener("blur", w), m.value?.removeEventListener("keyup", k);
    }), pe(() => {
      U(() => {
        const v = m.value;
        let s, b = [...v.children], f = b[b.length - 2].getBoundingClientRect().top;
        a.mobileView || (f = v.getBoundingClientRect().bottom - 38);
        let r = v.querySelector("#dropdown");
        ...
        let g = v.querySelector("#more"), t = g.getBoundingClientRect().bottom;
        if (s = void 0, u.value && f && g && r && t !== 0 && (t <= f - 56 || r.childElementCount == 1 && t <= f)) {
          let i = r.childElementCount, z = 0;
          for (; t <= f - 56 || i == 1; ) {
            let M = r.children[z];
            if (M && (M.classList.forEach((J) => {
              J.includes("identifier") && (s = J.slice(11));
        ...
        Object.keys(c.value).forEach((i) => {
          v.querySelector(`.identifier-${i}`) || (delete c.value[i], i.includes("divider") || (o.value = Math.max(0, o.value - 1)), d.value++);
        });
      });
    }), (v, s) => {
      ...
      return H((p(), h("div", {
        ...
        content: L($)("panels.controls.items"),
        ref_key: "el",
        ref: m
      }, [
        (p(!0), h(_, null, B(l.value, (r, g) => (p(), h(_, null, [
          (p(!0), h(_, null, B(r, (t, i) => (p(), h(_, null, [
            typeof t == "string" && c.value[`${t}-${i}`] !== !0 ? (p(), x(O, {
              key: `${t}-${i}-default`,
              panelId: t,
              class: E(["appbar-item h-48", `identifier-${t}-${i}`])
            }, null, 8, ["panelId", "class"])) : c.value[`${t}-${i}`] !== !0 ? (p(), x(K(t.componentId), {
              key: `${t}-${i}-custom`,
              options: t.options,
              class: E(["appbar-item h-48", `identifier-${t}-${i}`]),
              id: t.id
        ...
        (p(!0), h(_, null, B(e.value?.filter((r) => c.value[`${r}-temp`] !== !0), (r) => (p(), x(O, {
          panelId: r,
          minimize: !0,
          key: `${r}-temp`,
        ...
        H(q($e, {
          ...
          default: V(() => [
            (p(!0), h(_, null, B(l.value, (r, g) => (p(), h(_, { key: g }, [
              (p(!0), h(_, null, B(r, (t, i) => (p(), h(_, null, [
                typeof t == "string" && c.value[`${t}-${i}`] ? (p(), x(O, {
                  key: `${t}-${i}-default`,
                  panelId: t,
                  class: E(["text-black hover:bg-gray my-4 h-36", `identifier-${t}-${i}`]),
                  overflow: ""
                }, null, 8, ["panelId", "class"])) : c.value[`${t}-${i}`] ? (p(), x(K(t.componentId), {
                  key: `${t}-${i}-custom`,
                  options: t.options,
                  id: t.id,
                  class: E(["appbar-item h-48", `identifier-${t}-${i}`])
            ...
            (p(!0), h(_, null, B(e.value?.filter((r) => c.value[`${r}-temp`]), (r) => (p(), x(O, {
              panelId: r,
              minimize: !0,
              key: `${r}-temp`,
        ...
        q(xe, { class: "appbar-item bottom-48 h-48 sm:display-none" }),
        q(ce, {
...
class Ee extends ue {
  ...
  _parseConfig(a) {
    ...
    o.forEach((l) => {
      d.push(
        l.map((e) => typeof e == "string" ? e : new R(e))
      );
    }), n.items = d.flat().reduce((l, e) => (l[e instanceof R ? e.id : e] = e, l), {}), n.order = d.map(
      (l) => l.map((e) => e instanceof R ? e.id : e)
    ), this._validateItems();
  }
  /**
...
class ze extends Ee {
  ...
  async added() {
    ...
    l.push(
      ...
      const $ = { ...e.items }, u = [...e.temporary];
      Object.keys($).forEach((c) => e.removeButton(c)), u.forEach((c) => e.removeButton(c)), a(), e.$reset();
    };
  }
}
export {
...
//# sourceMappingURL=index-hwB5tvPv.js.map
