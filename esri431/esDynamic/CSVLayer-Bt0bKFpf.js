import { bQ as i, bR as r, bS as c, fF as v, fv as w, bU as S, aA as b, fp as O, Q as F, eD as I, eX as q, hh as N, fb as _, b1 as J, B as C, I as P, fS as l, s as h } from "./main-DZxT3i7S.js";
import { y as j } from "./clientSideDefaults-ppWQ35EG.js";
let a = class extends v {
  ...
  async queryExtent(e, t = {}) {
    ...
    return { count: s.count, extent: b.fromJSON(s.extent) };
  }
  async querySnapping(e, t = {}) {
    return await this.load(t), this._connection.invoke("querySnapping", e, t);
  }
  async _startWorker(e) {
    this._connection = await O("CSVSourceWorker", { strategy: F("feature-layers-workers") ? "dedicated" : "local", signal: e, registryTarget: this });
...
let o = class extends _ {
  ...
  load(e) {
    const t = e != null ? e.signal : null, s = this.loadFromPortal({ supportedTypes: ["CSV"], supportsData: !1 }, e).catch(C).then(async () => this.initLayerProperties(await this.createGraphicsSource(t)));
...
//# sourceMappingURL=CSVLayer-Bt0bKFpf.js.map
