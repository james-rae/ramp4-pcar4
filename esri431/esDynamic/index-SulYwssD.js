import { bs as c, bu as z, bz as b, bB as u, bC as l, bD as m, g5 as e, kw as v, bE as i, bt as h, bF as p, bG as d, F as _, hV as g } from "./main-DZxT3i7S.js";
const G = /* @__PURE__ */ c({
...
}), S = { class: "flex flex-col items-center" }, C = /* @__PURE__ */ c({
  __name: "p1-screen-2",
  props: {
    panel: {
      type: Object,
...
}), B = { class: "flex flex-row justify-center items-center mt-16" }, j = { class: "mt-16" }, k = /* @__PURE__ */ c({
  __name: "p2-screen-2",
  props: {
  ...
  setup(o) {
    const s = o, { t: n } = h(), t = z("iApi"), r = () => {
      s.panel.show("p-2-screen-3"), t.event.emit("gazebo/beholdMyText", "I am a cat");
    };
    return (f, a) => {
      const w = b("panel-screen");
      return m(), u(w, { panel: o.panel }, {
        header: l(() => a[2] || (a[2] = [
        ...
        content: l(() => [
          ...
          e("div", B, [
            e("button", {
              type: "button",
              onClick: a[0] || (a[0] = (y) => o.panel.show({
                screen: "p-2-screen-1",
          ...
          e("p", j, p(o.greeting), 1)
        ]),
        _: 1
      }, 8, ["panel"]);
    };
  }
}), O = { class: "flex flex-col items-center mt-16" }, D = { class: "ml-32 font-bold" }, T = { class: "ml-32 font-bold" }, E = { class: "ml-32 font-bold" }, N = /* @__PURE__ */ c({
  __name: "p2-screen-3",
  props: {
    panel: { type: Object, required: !0 }
  },
        ...
        config: {
          screens: {
            ...
            "p-2-screen-1": () => new Promise(
              (s) => setTimeout(
                () => import("./p2-screen-1-BK9Rt3uA.js").then((n) => {
                  s(n);
                }),
                2e3
              )
             ...
             */
            "p-2-screen-3": () => new Promise((s) => s(g(N)))
          },
          style: {
            "flex-grow": "1",
            "max-width": "500px"
...
//# sourceMappingURL=index-SulYwssD.js.map
