import { dy as _, dz as R, s as I, dA as D, dB as Q, dC as v, cn as A, dD as E, dE as G, cu as Z, G as P, a5 as M, dF as N, dG as b, dH as z, U, cd as O, dI as B, dJ as H, dK as J } from "./main-DZxT3i7S.js";
import { m as L } from "./FeatureStore-zvkXSx1l.js";
import { V } from "./QueryEngine-DVmSGTfj.js";
import { I as W, N as K, E as Y } from "./geojson-B1MnUu7p.js";
import { l as X, a as ee, u as te } from "./clientSideDefaults-ppWQ35EG.js";
import { j as se, p as T, d as w, f as F, y as $ } from "./sourceUtils-CDUC47ds.js";
const ie = { hasAttachments: !1, capabilities: "query, editing, create, delete, update", useStandardizedQueries: !0, supportsCoordinatesQuantization: !0, supportsReturningQueryGeometry: !0, advancedQueryCapabilities: { supportsQueryAttachments: !1, supportsQueryWithCacheHint: !0, supportsQueryWithDistance: !0, supportsQueryWithResultType: !0, supportsStatistics: !0, supportsPercentileStatistics: !0, supportsReturningGeometryCentroid: !0, supportsDistinct: !0, supportsReturningQueryExtent: !0, supportsReturningGeometryProperties: !1, supportsHavingClause: !0, supportsOrderBy: !0, supportsPagination: !0, supportsSqlExpression: !0, supportsDisjointSpatialRel: !0 } };
class ce {
  constructor() {
  ...
  async load(e, t = {}) {
    ...
    const i = [], [s] = await Promise.all([e.url ? this._fetch(t?.signal) : null, this._checkProjection(e.spatialReference)]), n = W(s, { geometryType: e.geometryType }), l = e.fields || n.fields || [], d = e.hasZ != null ? e.hasZ : n.hasZ, c = n.geometryType;
    ...
    const p = c ? te(c) : void 0, j = o.dateFields.length ? { timeZoneIANA: A } : null, f = { warnings: i, featureErrors: [], layerDefinition: { ...ie, drawingInfo: p ?? void 0, templates: X(h), extent: void 0, geometryType: c, objectIdField: y, fields: l, hasZ: !!d, timeInfo: a, dateFieldsTimeReference: j } };
    this._queryEngine = new V({ fieldsIndex: R.fromLayerJSON({ fields: l, timeInfo: a, dateFieldsTimeReference: j }), geometryType: c, hasM: !1, hasZ: d, objectIdField: y, spatialReference: m, timeInfo: a, featureStore: new L({ geometryType: c, hasM: !1, hasZ: d }) });
  ...
  async refresh(e) {
    this._loadOptions.customParameters = e, this._snapshotTask?.abort(), this._snapshotTask = G(this._snapshotFeatures), this._snapshotTask.promise.then((s) => {
      ...
      this._queryEngine.featureStore.clear(), Z(s) || P.getLogger("esri.layers.GeoJSONLayer").error(new I("geojson-layer:refresh", "An error occurred during refresh", { error: s }));
  ...
  async _fetch(e) {
    const { url: t, customParameters: i } = this._loadOptions, s = (await U(t ?? "", { responseType: "json", query: { ...i }, signal: e })).data;
    return Y(s), s;
  }
    ...
    for (const o of t) {
      ...
      if (h) i.push(h);
        ...
        if (o.geometry != null) {
          ...
          o.geometry = b($(o.geometry, p), p, c);
        }
        a.push(o), i.push(w(o.attributes[d]));
      }
    }
    y.addMany(B([], a, s, l, n, d));
  }
  _applyUpdateEdits({ updateResults: e }, t) {
    ...
    for (const m of t) {
      ...
      const h = H(c.getFeature(u), i, n, s);
      if (o != null) {
        if (i !== O(o)) {
...
//# sourceMappingURL=GeoJSONSourceWorker-9Jh2pKfb.js.map
