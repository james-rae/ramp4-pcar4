import { kc as k, by as m, bD as x, bJ as L, bI as C, jN as T, g5 as b, g6 as q, kd as _, gb as N, ke as K, ka as V, k9 as D, bs as M, bv as O, kf as H, ga as B, kg as E, bx as I, bE as z, bF as A, bB as R, bG as U, jO as W } from "./main-DZxT3i7S.js";
var j = { name: "Toggle", emits: ["input", "update:modelValue", "change"], props: { value: { validator: function(l) {
  ...
  const t = function(o, c, d) {
    const { value: i, modelValue: r, falseValue: a, trueValue: e, disabled: f } = k(o), u = r && r.value !== void 0 ? r : i, h = m(() => u.value === e.value), y = (p) => {
  ...
  }(l, n), g = function(o, c, d) {
    const { trueValue: i, falseValue: r, onLabel: a, offLabel: e } = k(o), f = d.checked, u = d.update;
    return { label: m(() => {
      let h = f.value ? a.value : e.value;
      return h || (h = "&nbsp;"), h;
    }), toggle: () => {
      u(f.value ? r.value : i.value);
    }, on: () => {
      u(i.value);
    }, off: () => {
      u(r.value);
    } };
  }(l, 0, { checked: t.checked, update: t.update }), s = function(o, c, d) {
    const i = k(o), r = i.disabled, a = d.checked, e = m(() => ({ container: "toggle-container", toggle: "toggle", toggleOn: "toggle-on", toggleOff: "toggle-off", toggleOnDisabled: "toggle-on-disabled", toggleOffDisabled: "toggle-off-disabled", handle: "toggle-handle", handleOn: "toggle-handle-on", handleOff: "toggle-handle-off", handleOnDisabled: "toggle-handle-on-disabled", handleOffDisabled: "toggle-handle-off-disabled", label: "toggle-label", ...i.classes.value }));
  ...
  }(l, 0, { checked: t.checked }), v = function(o, c, d) {
    const { disabled: i } = k(o), r = d.check, a = d.uncheck, e = d.checked;
    return { handleSpace: () => {
      i.value || (e.value ? a() : r());
    } };
...
const F = ["tabindex", "aria-checked", "aria-describedby", "aria-labelledby"], G = ["id", "name", "value", "checked", "disabled"], J = ["innerHTML"], P = ["checked"];
j.render = function(l, n, t, g, s, v) {
  return x(), L("div", K({ class: l.classList.container, tabindex: t.disabled ? void 0 : 0, "aria-checked": l.checked, "aria-describedby": t.describedby, "aria-labelledby": t.labelledby, role: "switch" }, t.aria, { onKeypress: n[1] || (n[1] = V(D((...o) => l.handleSpace && l.handleSpace(...o), ["prevent"]), ["space"])) }), [C(b("input", { type: "checkbox", id: t.id, name: t.name, value: t.trueValue, checked: l.checked, disabled: t.disabled }, null, 8, G), [[T, !1]]), b("div", { class: q(l.classList.toggle), onClick: n[0] || (n[0] = (...o) => l.handleClick && l.handleClick(...o)) }, [b("span", { class: q(l.classList.handle) }, null, 2), _(l.$slots, "label", { checked: l.checked, classList: l.classList }, () => [b("span", { class: q(l.classList.label), innerHTML: l.label }, null, 10, J)]), t.required ? (x(), L("input", { key: 0, type: "checkbox", style: { appearance: "none", height: "1px", margin: "0", padding: "0", fontSize: "0", background: "transparent", position: "absolute", width: "100%", bottom: "0", outline: "none" }, checked: l.checked, "aria-hidden": "true", tabindex: "-1", required: "" }, null, 8, P)) : N("v-if", !0)], 2)], 16, F);
}, j.__file = "src/Toggle.vue";
const $ = { class: "flex flex-row rv-label" }, Q = { class: "flex items-center" }, X = ["innerHTML"], Y = /* @__PURE__ */ M({
  ...
  emits: ["toggled"],
  setup(l, { emit: n }) {
    const t = n, g = l, s = O(g.config.value), v = O(!!g.config.disabled), o = O(0), c = H([]), d = O(null);
    c.push(
      B(
        E(g, "config"),
        (a, e) => {
    ...
    const i = () => {
      ...
      if (d.value) {
        const a = d.value.querySelector('input[type="checkbox"]');
...
}), ee = /* @__PURE__ */ W(Y, [["__scopeId", "data-v-188debd2"]]);
export {
  ee as T
};
//# sourceMappingURL=toggle-switch-control-D4Fc8-af.js.map
