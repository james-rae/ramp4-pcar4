import { er as y, es as S, J as $, s as v, et as b } from "./main-DZxT3i7S.js";
import { getSiblingOfSameTypeI as E, contentToBlob as m } from "./resourceUtils-Ckb9sFv1.js";
async function P(s, t, o) {
  const r = await d(s, t, o);
  await I(r, t, o);
}
async function R(s, t, o, r, a) {
  const c = await d(o, r, a);
  await s.update({ data: t }), await I(c, r, a);
}
async function d(s, t, o) {
  ...
  for (const e of t.resources.toUpdate) if (r.delete(e.resource.path), a.has(e.resource.path) || c.has(e.resource.path)) {
    const { resource: n, content: g, finish: w } = e, i = E(n, y());
    s.paths.push(i.path), p.push({ resource: i, content: await m(g), compress: e.compress }), w && u.push(() => w(i));
  } else {
  ...
  if (p.length || h.length) {
    const { addOrUpdateResources: e } = await import("./resourceUtils-Ckb9sFv1.js");
...
//# sourceMappingURL=resourceUtils-BITspl6q.js.map
