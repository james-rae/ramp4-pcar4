import { aB as ht } from "./main-DZxT3i7S.js";
import { H as ee, T as ut, X as ct, q as dt, J as bt, Q as ft, c as gt, P as y, O as te, n as q, i as et, r as J, a as mt, z as ie, Y as Ye, d as Z, b as pe, e as D, u as ce, f as pt, g as _t, N as ve, R as re, S as yt, h as G, j as Ce, Z as vt, k as se, l as Ie, m as Te, o as wt, x as De, U as he, p as _e, s as xt, t as ye, v as He, w as tt, y as it, A as Ae, W as Pt, B as Q, C as K, D as W, _ as Ot, E as kt, F as H, M as Mt, G as B, I as de, K as be, L as Re, V as St, $ as Ue, a0 as jt, a1 as Et, a2 as R, a3 as We, a4 as Tt, a5 as Bt, a6 as Ct, a7 as Dt, a8 as X, a9 as fe, aa as At, ab as Ve, ac as Be, ad as rt, ae as Ge, af as Lt, ag as zt, ah as Oe, ai as Ft, aj as Yt, ak as It, al as Ht, am as Rt, an as oe } from "./Theme-D8IVldck.js";
import { u as Xe } from "./Tooltip-BajnU09M.js";
import { s as Ut } from "./DefaultTheme-BPOOTBna.js";
class Wt {
  constructor() {
  ...
  removeTarget(e) {
    this._observer.unobserve(e), ve(this._targets, (t) => t.target !== e);
  }
}
class we {
  constructor() {
  ...
  addTarget(e, t) {
    if (this._timer === null) {
      ...
      const a = () => {
        const s = Date.now();
        (r === null || s > r + we.delay) && (r = s, y(this._targets, (n) => {
  ...
  removeTarget(e) {
    ve(this._targets, (t) => t.target !== e), this._targets.length === 0 && this._timer !== null && (cancelAnimationFrame(this._timer), this._timer = null);
  }
}
Object.defineProperty(we, "delay", { enumerable: !0, configurable: !0, writable: !0, value: 200 });
let ke = null;
function Vt() {
  return ke === null && (ke = typeof ResizeObserver < "u" ? new Wt() : new we()), ke;
}
class Gt {
  constructor(e, t) {
    Object.defineProperty(this, "_sensor", { enumerable: !0, configurable: !0, writable: !0, value: void 0 }), Object.defineProperty(this, "_element", { enumerable: !0, configurable: !0, writable: !0, value: void 0 }), Object.defineProperty(this, "_listener", { enumerable: !0, configurable: !0, writable: !0, value: void 0 }), Object.defineProperty(this, "_disposed", { enumerable: !0, configurable: !0, writable: !0, value: !1 }), this._sensor = Vt(), this._element = e, this._listener = tt(t), this._sensor.addTarget(e, t);
  }
  isDisposed() {
...
class Xt extends ee {
  ...
  format(e, t, i) {
    ...
    if (it(t)) try {
      ...
      s = a > this.get("negativeBase") ? n.positive : a < this.get("negativeBase") ? n.negative : n.zero, i == null || s.mod || (s = Pt(s), s.decimals.active = a == 0 ? 0 : i), r = s.template.split(Q).join(this.applyFormat(a, s));
    }
    return this.get("forceLTR") === !0 && (r = "‎" + r), r;
  }
  parseFormat(e, t) {
    const i = t.translateEmpty("_thousandSeparator"), r = t.translateEmpty("_decimalSeparator");
    let a = { positive: { thousands: { active: -1, passive: -1, interval: -1, separator: i }, decimals: { active: -1, passive: -1, separator: r }, template: "", source: "", parsed: !1 }, negative: { thousands: { active: -1, passive: -1, interval: -1, separator: i }, decimals: { active: -1, passive: -1, separator: r }, template: "", source: "", parsed: !1 }, zero: { thousands: { active: -1, passive: -1, interval: -1, separator: i }, decimals: { active: -1, passive: -1, separator: r }, template: "", source: "", parsed: !1 } }, s = (e = e.replace("||", K)).split("|");
    return a.positive.source = s[0], s[2] === void 0 ? a.zero = a.positive : a.zero.source = s[2], s[1] === void 0 ? a.negative = a.positive : a.negative.source = s[1], he(a, (n, l) => {
      if (l.parsed) return;
      let d = l.source;
        ...
        if (f.text = f.text.replace(K, "|"), f.type === "value") {
          ...
          if (o) if (o === null || o[0] === "") l.template += f.text;
            ...
            if (h[0] !== "") {
              ...
              let u = h[0].split(",");
              u.length === 1 || (l.thousands.interval = (u.pop() || "").length, l.thousands.interval === 0 && (l.thousands.interval = -1));
            }
  ...
  applyFormat(e, t) {
    ...
    if (s.indexOf("b") !== -1) {
      let c = this.applyPrefix(e, this.get("bytePrefixes"), s.indexOf("!") !== -1);
      e = c[0], r = c[1], a = c[2], t.modSpacing && (a = " " + a);
    } else if (s.indexOf("a") !== -1) {
      let c = this.applyPrefix(e, e < this.get("smallNumberThreshold") ? this.get("smallNumberPrefixes") : this.get("bigNumberPrefixes"), s.indexOf("!") !== -1);
      e = c[0], r = c[1], a = c[2], t.modSpacing && (a = " " + a);
    } else if (s.indexOf("p") !== -1) {
      let c = Math.min(e.toString().length + 2, 21);
      e = parseFloat(e.toPrecision(c)), r = this._root.language.translate("_percentPrefix"), a = this._root.language.translate("_percentSuffix"), r == "" && a == "" && (a = "%");
    } else if (s.indexOf("%") !== -1) {
      let c = Math.min(e.toString().length + 2, 21);
      e *= 100, e = parseFloat(e.toPrecision(c)), a = "%";
    } else if (s.indexOf("‰") !== -1) {
      let c = Math.min(e.toString().length + 3, 21);
      e *= 1e3, e = parseFloat(e.toPrecision(c)), a = "‰";
    }
    if (s.indexOf("e") !== -1) {
      let c;
      c = t.decimals.passive >= 0 ? e.toExponential(t.decimals.passive).split("e") : e.toExponential().split("e"), e = Number(c[0]), a = "e" + c[1], t.modSpacing && (a = " " + a);
    } else if (t.decimals.passive === 0) e = Math.round(e);
    else if (t.decimals.passive > 0) {
      const c = Ot(e);
      if (c > 0) {
        const f = Math.pow(10, t.decimals.passive);
        e = Math.round(parseFloat((e * f).toFixed(c))) / f;
      }
    }
    let n = "", l = kt(e).split("."), d = l[0];
    if (d.length < t.thousands.active && (d = Array(t.thousands.active - d.length + 1).join("0") + d), t.thousands.interval > 0) {
      let c = [], f = d.split("").reverse().join("");
      for (let o = 0, p = d.length; o <= p; o += t.thousands.interval) {
        let h = f.substr(o, t.thousands.interval).split("").reverse().join("");
        h !== "" && c.unshift(h);
      }
      d = c.join(t.thousands.separator);
    }
    n += d, l.length === 1 && l.push("");
    let m = l[1];
    return m.length < t.decimals.active && (m += Array(t.decimals.active - m.length + 1).join("0")), m !== "" && (n += t.decimals.separator + m), n === "" && (n = "0"), e !== 0 && i && s.indexOf("s") === -1 && (n = "-" + n), r && (n = r + n), a && (n += a), n;
  }
  applyPrefix(e, t, i = !1) {
    let r = e, a = "", s = "", n = !1, l = 1;
    for (let d = 0, m = t.length; d < m; d++) t[d].number <= e && (t[d].number === 0 ? r = 0 : (r = e / t[d].number, l = t[d].number), a = t[d].prefix, s = t[d].suffix, n = !0);
    return !n && i && t.length && e != 0 && (r = e / t[0].number, a = t[0].prefix, s = t[0].suffix, n = !0), n && (r = parseFloat(r.toPrecision(Math.min(l.toString().length + Math.floor(r).toString().replace(/[^0-9]*/g, "").length, 21)))), [r, a, s];
  }
  escape(e) {
    return e.replace("||", K);
  }
...
function st(b, e) {
  let t = 0, i = 0, r = 1, a = 0, s = 0, n = 0, l = 0, d = 0;
  ...
  }), a === 24 && (a = 0), { year: t, month: i, day: r, hour: a, minute: s, second: n, millisecond: l, weekday: d };
}
function Ne(b, e) {
  const { year: t, month: i, day: r, hour: a, minute: s, second: n, millisecond: l } = st(b, e);
  return Date.UTC(t, i, r, a, s, n, l);
}
class Nt {
  constructor(e, t) {
  ...
  offsetUTC(e) {
    return (Ne(this._utc, e) - Ne(this._dtf, e)) / 6e4;
  }
  parseDate(e) {
...
class $t extends ee {
  ...
  format(e, t, i = !1) {
    ...
    if (it(t)) try {
      ...
      return l ? new Intl.DateTimeFormat(l, t).format(a) : new Intl.DateTimeFormat(void 0, t).format(a);
    } catch {
      return "Invalid";
    }
    let s = this.parseFormat(t);
    const n = this._root.timezone;
    return !n || this._root.utc || i || (a = n.convertLocal(a)), H(a.getTime()) ? (r = this.applyFormat(a, s, i), this.get("capitalize") && (r = r.replace(/^.{1}/, r.substr(0, 1).toUpperCase())), r) : "Invalid date";
  }
  applyFormat(e, t, i = !1) {
    let r, a, s, n, l, d, m, c, f = t.template, o = e.getTime();
    this._root.utc && !i ? (r = e.getUTCFullYear(), a = e.getUTCMonth(), s = e.getUTCDay(), n = e.getUTCDate(), l = e.getUTCHours(), d = e.getUTCMinutes(), m = e.getUTCSeconds(), c = e.getUTCMilliseconds()) : (r = e.getFullYear(), a = e.getMonth(), s = e.getDay(), n = e.getDate(), l = e.getHours(), d = e.getMinutes(), m = e.getSeconds(), c = e.getMilliseconds());
    for (let p = 0, h = t.parts.length; p < h; p++) {
      let u = "";
      switch (t.parts[p]) {
        case "G":
          u = this._t(r < 0 ? "_era_bc" : "_era_ad");
          break;
        case "yyyy":
          u = Math.abs(r).toString(), r < 0 && (u += this._t("_era_bc"));
          break;
        case "yyy":
        case "yy":
        case "y":
          u = Math.abs(r).toString().substr(-t.parts[p].length), r < 0 && (u += this._t("_era_bc"));
          break;
        case "YYYY":
        case "YYY":
        case "YY":
        case "Y":
          let _ = jt(e, this._root.utc);
          u = t.parts[p] == "YYYY" ? Math.abs(_).toString() : Math.abs(_).toString().substr(-t.parts[p].length), _ < 0 && (u += this._t("_era_bc"));
          break;
        case "u":
        case "F":
        case "g":
        ...
        case "q":
          ...
          break;
        case "MMMMM":
          u = this._t(this._getMonth(a)).substr(0, 1);
          break;
        case "MMMM":
          u = this._t(this._getMonth(a));
          break;
        case "MMM":
          u = this._t(this._getShortMonth(a));
          break;
        case "MM":
          u = B(a + 1, 2, "0");
          break;
        case "M":
          ...
          break;
        case "ww":
          u = B(Ue(e, this._root.utc), 2, "0");
          break;
        case "w":
          u = Ue(e, this._root.utc).toString();
          break;
        case "W":
          u = St(e, this._root.utc).toString();
          break;
        case "dd":
          u = B(n, 2, "0");
          break;
        ...
        case "DD":
        case "DDD":
          u = B(Re(e, this._root.utc).toString(), t.parts[p].length, "0");
          break;
        case "D":
          u = Re(e, this._root.utc).toString();
          break;
        case "t":
          u = this._root.language.translateFunc("_dateOrd").call(this, n);
          break;
        case "E":
          u = (s || 7).toString();
          break;
        case "EE":
          u = B((s || 7).toString(), 2, "0");
          break;
        case "EEE":
        case "eee":
          u = this._t(this._getShortWeekday(s));
          break;
        case "EEEE":
        case "eeee":
          u = this._t(this._getWeekday(s));
          break;
        case "EEEEE":
        case "eeeee":
          u = this._t(this._getShortWeekday(s)).substr(0, 1);
          break;
        case "e":
        case "ee":
          u = (s - (this._root.locale.firstDayOfWeek || 1) + 1).toString(), t.parts[p] == "ee" && (u = B(u, 2, "0"));
          break;
        case "a":
          u = l >= 12 ? this._t("PM") : this._t("AM");
          break;
        case "aa":
          u = l >= 12 ? this._t("P.M.") : this._t("A.M.");
          break;
        case "aaa":
          u = l >= 12 ? this._t("P") : this._t("A");
          break;
        case "h":
          u = be(l).toString();
          break;
        ...
        case "SS":
        case "SSS":
          u = Math.round(c / 1e3 * Math.pow(10, t.parts[p].length)).toString();
          break;
        case "x":
          u = o.toString();
          break;
        ...
        case "nn":
        case "nnn":
          u = B(c, t.parts[p].length, "0");
          break;
        case "z":
          u = de(e, !1, !1, this._root.utc, this._root.timezone ? this._root.timezone.name : void 0).replace(/[+-]+[0-9]+$/, "");
          break;
        case "zz":
          u = de(e, !0, !1, this._root.utc, this._root.timezone ? this._root.timezone.name : void 0);
          break;
        case "zzz":
          u = de(e, !1, !0, this._root.utc, this._root.timezone ? this._root.timezone.name : void 0).replace(/[+-]+[0-9]+$/, "");
          break;
        case "zzzz":
          u = de(e, !0, !0, this._root.utc, this._root.timezone ? this._root.timezone.name : void 0);
          break;
        case "Z":
        case "ZZ":
          let w = this._root.utc ? "UTC" : this._root.timezone;
          w instanceof Nt && (w = w.name);
          const v = w ? Mt(w) : e.getTimezoneOffset();
          let g = Math.abs(v) / 60, x = Math.floor(g), k = 60 * g - 60 * x;
          this._root.utc && (x = 0, k = 0), t.parts[p] == "Z" ? (u = "GMT", u += v > 0 ? "-" : "+", u += B(x, 2) + ":" + B(k, 2)) : (u = v > 0 ? "-" : "+", u += B(x, 2) + B(k, 2));
          break;
        case "i":
          u = e.toISOString();
          break;
  ...
  parse(e, t) {
    ...
    for (let f = 0; f < a.parts.length; f++) {
      switch (d = f + l + 1, a.parts[f]) {
        case "yyyy":
        case "YYYY":
          r += "([0-9]{4})", s.year = d;
          break;
        ...
        case "Y":
          ...
          break;
        case "MMMM":
          r += "(" + this.getStringList(this._months()).join("|") + ")", s.monthLong = d;
          break;
        case "MMM":
          r += "(" + this.getStringList(this._shortMonths()).join("|") + ")", s.monthShort = d;
          break;
        case "MM":
        case "M":
          r += "([0-9]{2}|[0-9]{1})", s.month = d;
          break;
        case "ww":
        case "w":
          r += "([0-9]{2}|[0-9]{1})", s.week = d;
          break;
        case "dd":
        case "d":
          r += "([0-9]{2}|[0-9]{1})", s.day = d;
          break;
        case "DDD":
        case "DD":
        case "D":
          r += "([0-9]{3}|[0-9]{2}|[0-9]{1})", s.yearDay = d;
          break;
        case "dddd":
          r += "(" + this.getStringList(this._weekdays()).join("|") + ")", s.weekdayLong = d;
          break;
        case "ddd":
          r += "(" + this.getStringList(this._shortWeekdays()).join("|") + ")", s.weekdayShort = d;
          break;
        case "aaa":
        case "aa":
        case "a":
          r += "(" + this.getStringList(["AM", "PM", "A.M.", "P.M.", "A", "P"]).join("|") + ")", s.am = d;
          break;
        case "hh":
        case "h":
          r += "([0-9]{2}|[0-9]{1})", s.hour12Base1 = d;
          break;
        case "HH":
        case "H":
          r += "([0-9]{2}|[0-9]{1})", s.hourBase0 = d;
          break;
        case "KK":
        case "K":
          r += "([0-9]{2}|[0-9]{1})", s.hour12Base0 = d;
          break;
        case "kk":
        case "k":
          r += "([0-9]{2}|[0-9]{1})", s.hourBase1 = d;
          break;
        case "mm":
        case "m":
          r += "([0-9]{2}|[0-9]{1})", s.minute = d;
          break;
        case "ss":
        case "s":
          r += "([0-9]{2}|[0-9]{1})", s.second = d;
          break;
        case "SSS":
        case "SS":
        case "S":
          r += "([0-9]{3}|[0-9]{2}|[0-9]{1})", s.millisecond = d, s.millisecondDigits = a.parts[f].length;
          break;
        case "nnn":
        case "nn":
        case "n":
          r += "([0-9]{3}|[0-9]{2}|[0-9]{1})", s.millisecond = d;
          break;
        case "x":
          r += "([0-9]{1,})", s.timestamp = d;
          break;
        case "Z":
          r += "GMT([-+]+[0-9]{2}:[0-9]{2})", s.zone = d;
          break;
        case "ZZ":
          r += "([\\-+]+[0-9]{2}[0-9]{2})", s.zone = d;
          break;
        case "i":
          r += "([0-9]{4})-?([0-9]{2})-?([0-9]{2})T?([0-9]{2}):?([0-9]{2}):?([0-9]{2})\\.?([0-9]{0,3})([zZ]|[+\\-][0-9]{2}:?[0-9]{2}|$)", s.iso = d, l += 7;
          break;
        case "G":
        case "YYYY":
        case "YYY":
    ...
    let m = new RegExp(r), c = e.match(m);
    if (c) {
      if (s.year > -1 && (n.year = parseInt(c[s.year])), s.year3 > -1) {
        let f = parseInt(c[s.year3]);
        f += 1e3, n.year = f;
      }
      if (s.year2 > -1) {
        let f = parseInt(c[s.year2]);
        f += f > 50 ? 1e3 : 2e3, n.year = f;
      }
      if (s.year1 > -1) {
        let f = parseInt(c[s.year1]);
        f = 10 * Math.floor((/* @__PURE__ */ new Date()).getFullYear() / 10) + f, n.year = f;
      }
      if (s.monthLong > -1 && (n.month = this.resolveMonth(c[s.monthLong])), s.monthShort > -1 && (n.month = this.resolveShortMonth(c[s.monthShort])), s.month > -1 && (n.month = parseInt(c[s.month]) - 1), s.week > -1 && s.day === -1 && (n.month = 0, n.day = Et(parseInt(c[s.week]), n.year, 1, this._root.utc)), s.day > -1 && (n.day = parseInt(c[s.day])), s.yearDay > -1 && (n.month = 0, n.day = parseInt(c[s.yearDay])), s.hourBase0 > -1 && (n.hour = parseInt(c[s.hourBase0])), s.hourBase1 > -1 && (n.hour = parseInt(c[s.hourBase1]) - 1), s.hour12Base0 > -1) {
        let f = parseInt(c[s.hour12Base0]);
        f == 11 && (f = 0), s.am > -1 && !this.isAm(c[s.am]) && (f += 12), n.hour = f;
      }
      if (s.hour12Base1 > -1) {
        let f = parseInt(c[s.hour12Base1]);
        f == 12 && (f = 0), s.am > -1 && !this.isAm(c[s.am]) && (f += 12), n.hour = f;
      }
      if (s.minute > -1 && (n.minute = parseInt(c[s.minute])), s.second > -1 && (n.second = parseInt(c[s.second])), s.millisecond > -1) {
        let f = parseInt(c[s.millisecond]);
        s.millisecondDigits == 2 ? f *= 10 : s.millisecondDigits == 1 && (f *= 100), n.millisecond = f;
      }
      if (s.timestamp > -1) {
        n.timestamp = parseInt(c[s.timestamp]);
      ...
      s.zone > -1 && (n.offset = this.resolveTimezoneOffset(new Date(n.year, n.month, n.day), c[s.zone])), s.iso > -1 && (n.year = R(c[s.iso + 0]), n.month = R(c[s.iso + 1]) - 1, n.day = R(c[s.iso + 2]), n.hour = R(c[s.iso + 3]), n.minute = R(c[s.iso + 4]), n.second = R(c[s.iso + 5]), n.millisecond = R(c[s.iso + 6]), c[s.iso + 7] == "Z" || c[s.iso + 7] == "z" ? n.utc = !0 : c[s.iso + 7] != "" && (n.offset = this.resolveTimezoneOffset(new Date(n.year, n.month, n.day), c[s.iso + 7]))), i = n.utc ? new Date(Date.UTC(n.year, n.month, n.day, n.hour, n.minute, n.second, n.millisecond)) : new Date(n.year, n.month, n.day, n.hour, n.minute + n.offset, n.second, n.millisecond);
    } else i = new Date(e);
    return i;
  }
  ...
  getStringList(e) {
    let t = [];
    for (let i = 0; i < e.length; i++) this._root.language ? t.push(We(this._t(e[i]))) : t.push(We(e[i]));
    return t;
  }
}
class qt extends ee {
  ...
  _setDefaults() {
    const e = "_duration_millisecond", t = "_duration_second", i = "_duration_minute", r = "_duration_hour", a = "_duration_day", s = "_duration_week", n = "_duration_month", l = "_duration_year", d = "_second", m = "_minute", c = "_hour", f = "_day", o = "_week", p = "_week", h = "_year";
    this._setDefault("negativeBase", 0), this._setDefault("baseUnit", "second"), this._setDefault("durationFormats", { millisecond: { millisecond: this._t(e), second: this._t(e + d), minute: this._t(e + m), hour: this._t(e + c), day: this._t(e + f), week: this._t(e + o), month: this._t(e + p), year: this._t(e + h) }, second: { second: this._t(t), minute: this._t(t + m), hour: this._t(t + c), day: this._t(t + f), week: this._t(t + o), month: this._t(t + p), year: this._t(t + h) }, minute: { minute: this._t(i), hour: this._t(i + c), day: this._t(i + f), week: this._t(i + o), month: this._t(i + p), year: this._t(i + h) }, hour: { hour: this._t(r), day: this._t(r + f), week: this._t(r + o), month: this._t(r + p), year: this._t(r + h) }, day: { day: this._t(a), week: this._t(a + o), month: this._t(a + p), year: this._t(a + h) }, week: { week: this._t(s), month: this._t(s + p), year: this._t(s + h) }, month: { month: this._t(n), year: this._t(n + h) }, year: { year: this._t(l) } }), super._setDefaults();
  }
  _beforeChanged() {
    super._beforeChanged();
  }
  format(e, t, i) {
    ...
    t !== void 0 && t !== "" || (t = this.get("durationFormat") != null ? this.get("durationFormat") : this.getFormat(R(e), void 0, r)), t = Ae(t);
    let a, s = this.parseFormat(t, r), n = Number(e);
    a = n > this.get("negativeBase") ? s.positive : n < this.get("negativeBase") ? s.negative : s.zero;
    let l = this.applyFormat(n, a);
    return a.color !== "" && (l = "[" + a.color + "]" + l + "[/]"), l;
  }
  parseFormat(e, t) {
    let i = t || this.get("baseUnit"), r = { positive: { color: "", template: "", parts: [], source: "", baseUnit: i, parsed: !1, absolute: !1 }, negative: { color: "", template: "", parts: [], source: "", baseUnit: i, parsed: !1, absolute: !1 }, zero: { color: "", template: "", parts: [], source: "", baseUnit: i, parsed: !1, absolute: !1 } }, a = (e = e.replace("||", K)).split("|");
  ...
  applyFormat(e, t) {
    ...
    for (let s = 0, n = t.parts.length; s < n; s++) {
      let l, d = t.parts[s], m = this._toTimeUnit(d.substr(0, 1)), c = d.length;
      const f = this._getUnitValue(m);
      l = s < n - 1 ? Math.floor(r / f) : Math.round(r / f), a = a.replace(Q, B(l, c, "0")), r -= l * f;
    }
    return i && (a = "-" + a), a;
  }
  toTimeStamp(e, t) {
  ...
  getValueUnit(e, t) {
    ...
    return Tt(this._getUnitValues(), (a, s) => {
      if (a == t || i) {
...
class Jt extends ee {
  ...
  translateAll(e, t) {
    return this.isDefault() ? e : Bt(e, (i) => this.translate(i, t));
  }
  isDefault() {
...
}(), le = 2 * Math.PI, Se = function(b, e, t, i, r, a, s) {
  var n = b.x, l = b.y;
  return { x: i * (n *= e) - r * (l *= t) + a, y: r * n + i * l + s };
}, Kt = function(b, e) {
  var t = e === 1.5707963267948966 ? 0.551915024494 : e === -1.5707963267948966 ? -0.551915024494 : 1.3333333333333333 * Math.tan(e / 4), i = Math.cos(b), r = Math.sin(b), a = Math.cos(b + e), s = Math.sin(b + e);
  return [{ x: i - r * t, y: r + i * t }, { x: a + s * t, y: s - a * t }, { x: a, y: s }];
}, $e = function(b, e, t, i) {
  var r = b * t + e * i;
  return r > 1 && (r = 1), r < -1 && (r = -1), (b * i - e * t < 0 ? -1 : 1) * Math.acos(r);
}, Qt = function(b, e, t, i, r, a, s, n, l, d, m, c) {
  var f = Math.pow(r, 2), o = Math.pow(a, 2), p = Math.pow(m, 2), h = Math.pow(c, 2), u = f * o - f * h - o * p;
  u < 0 && (u = 0), u /= f * h + o * p;
  var _ = (u = Math.sqrt(u) * (s === n ? -1 : 1)) * r / a * c, w = u * -a / r * m, v = d * _ - l * w + (b + t) / 2, g = l * _ + d * w + (e + i) / 2, x = (m - _) / r, k = (c - w) / a, O = (-m - _) / r, M = (-c - w) / a, E = $e(1, 0, x, k), P = $e(x, k, O, M);
  return n === 0 && P > 0 && (P -= le), n === 1 && P < 0 && (P += le), [v, g, E, P];
}, ei = function(b) {
  var e = b.px, t = b.py, i = b.cx, r = b.cy, a = b.rx, s = b.ry, n = b.xAxisRotation, l = n === void 0 ? 0 : n, d = b.largeArcFlag, m = d === void 0 ? 0 : d, c = b.sweepFlag, f = c === void 0 ? 0 : c, o = [];
  if (a === 0 || s === 0) return [];
  var p = Math.sin(l * le / 360), h = Math.cos(l * le / 360), u = h * (e - i) / 2 + p * (t - r) / 2, _ = -p * (e - i) / 2 + h * (t - r) / 2;
  if (u === 0 && _ === 0) return [];
  a = Math.abs(a), s = Math.abs(s);
  var w = Math.pow(u, 2) / Math.pow(a, 2) + Math.pow(_, 2) / Math.pow(s, 2);
  w > 1 && (a *= Math.sqrt(w), s *= Math.sqrt(w));
  var v = Qt(e, t, i, r, a, s, m, f, p, h, u, _), g = Zt(v, 4), x = g[0], k = g[1], O = g[2], M = g[3], E = Math.abs(M) / (le / 4);
  Math.abs(1 - E) < 1e-7 && (E = 1);
  var P = Math.max(Math.ceil(E), 1);
  M /= P;
  for (var z = 0; z < P; z++) o.push(Kt(O, M)), O += M;
  return o.map(function(A) {
    var I = Se(A[0], a, s, h, p, x, k), N = I.x, C = I.y, ue = Se(A[1], a, s, h, p, x, k), S = ue.x, F = ue.y, Y = Se(A[2], a, s, h, p, x, k);
    return { x1: N, y1: C, x2: S, y2: F, x: Y.x, y: Y.y };
  });
};
function ti(b, e, t) {
...
function si(b, e, t) {
  return D(b, Be(e), (i) => {
    const r = rt(i);
    let a = i.touches;
    a ? (a.length == 0 && (a = i.changedTouches), t(Lt(a), r)) : t([i], r);
  });
}
function Je(b) {
...
class xe extends Ht {
  constructor(e) {
    super(), Object.defineProperty(this, "_layer", { enumerable: !0, configurable: !0, writable: !0, value: void 0 }), Object.defineProperty(this, "mask", { enumerable: !0, configurable: !0, writable: !0, value: null }), Object.defineProperty(this, "visible", { enumerable: !0, configurable: !0, writable: !0, value: !0 }), Object.defineProperty(this, "exportable", { enumerable: !0, configurable: !0, writable: !0, value: !0 }), Object.defineProperty(this, "interactive", { enumerable: !0, configurable: !0, writable: !0, value: !1 }), Object.defineProperty(this, "inactive", { enumerable: !0, configurable: !0, writable: !0, value: null }), Object.defineProperty(this, "wheelable", { enumerable: !0, configurable: !0, writable: !0, value: !1 }), Object.defineProperty(this, "cancelTouch", { enumerable: !0, configurable: !0, writable: !0, value: !1 }), Object.defineProperty(this, "isMeasured", { enumerable: !0, configurable: !0, writable: !0, value: !1 }), Object.defineProperty(this, "buttonMode", { enumerable: !0, configurable: !0, writable: !0, value: !1 }), Object.defineProperty(this, "alpha", { enumerable: !0, configurable: !0, writable: !0, value: 1 }), Object.defineProperty(this, "compoundAlpha", { enumerable: !0, configurable: !0, writable: !0, value: 1 }), Object.defineProperty(this, "angle", { enumerable: !0, configurable: !0, writable: !0, value: 0 }), Object.defineProperty(this, "scale", { enumerable: !0, configurable: !0, writable: !0, value: 1 }), Object.defineProperty(this, "x", { enumerable: !0, configurable: !0, writable: !0, value: 0 }), Object.defineProperty(this, "y", { enumerable: !0, configurable: !0, writable: !0, value: 0 }), Object.defineProperty(this, "crisp", { enumerable: !0, configurable: !0, writable: !0, value: !1 }), Object.defineProperty(this, "pivot", { enumerable: !0, configurable: !0, writable: !0, value: new ai() }), Object.defineProperty(this, "filter", { enumerable: !0, configurable: !0, writable: !0, value: void 0 }), Object.defineProperty(this, "cursorOverStyle", { enumerable: !0, configurable: !0, writable: !0, value: void 0 }), Object.defineProperty(this, "_replacedCursorStyle", { enumerable: !0, configurable: !0, writable: !0, value: void 0 }), Object.defineProperty(this, "_localMatrix", { enumerable: !0, configurable: !0, writable: !0, value: new Me() }), Object.defineProperty(this, "_matrix", { enumerable: !0, configurable: !0, writable: !0, value: new Me() }), Object.defineProperty(this, "_uMatrix", { enumerable: !0, configurable: !0, writable: !0, value: new Me() }), Object.defineProperty(this, "_renderer", { enumerable: !0, configurable: !0, writable: !0, value: void 0 }), Object.defineProperty(this, "_parent", { enumerable: !0, configurable: !0, writable: !0, value: void 0 }), Object.defineProperty(this, "_localBounds", { enumerable: !0, configurable: !0, writable: !0, value: void 0 }), Object.defineProperty(this, "_bounds", { enumerable: !0, configurable: !0, writable: !0, value: void 0 }), Object.defineProperty(this, "_colorId", { enumerable: !0, configurable: !0, writable: !0, value: void 0 }), this._renderer = e;
  }
  subStatus(e) {
  ...
  on(e, t, i) {
    return this.interactive ? this._renderer._addEvent(this, e, t, i) : new G(() => {
    });
  }
  _setMatrix() {
  ...
  _transform(e, t) {
    ...
    this.crisp && (r = Ze(r), a = Ze(a)), e.setTransform(i.a * t, i.b * t, i.c * t, i.d * t, r, a);
  }
  ...
  render(e) {
    if (this.visible && (this.exportable !== !1 || !this._renderer._omitTainted)) {
      ...
      }), s.save(), n && this._isInteractiveMask(t) && (n._transformMargin(s, i, a.margin), n._runPath(s), s.clip()), this._transformMargin(s, i, a.margin), this._render(t), s.restore(), y(r, (l) => {
        l && l.context.restore();
      });
    }
  }
...
class ni extends xe {
  ...
  removeChild(e) {
    e._parent = void 0, Ce(this._children, e);
  }
  _render(e) {
    super._render(e);
  ...
  registerChildLayer(e) {
    this._childLayers || (this._childLayers = []), Te(this._childLayers, e), this._parent && this._parent.registerChildLayer(e);
  }
  markDirtyLayer(e = !1) {
...
class di extends T {
  ...
  addBounds(e) {
    ...
    j(e, { x: t, y: i }), j(e, { x: r, y: i }), j(e, { x: t, y: a }), j(e, { x: r, y: a });
  }
}
class bi extends T {
  constructor(e, t, i) {
...
class gi extends T {
  ...
  addBounds(e) {
    let t = Rt(this.cx, this.cy, this.startAngle * oe, this.endAngle * oe, this.radius);
...
class Oi extends xe {
  constructor() {
    super(...arguments), Object.defineProperty(this, "_operations", { enumerable: !0, configurable: !0, writable: !0, value: [] }), Object.defineProperty(this, "blendMode", { enumerable: !0, configurable: !0, writable: !0, value: zt.NORMAL }), Object.defineProperty(this, "_hasShadows", { enumerable: !0, configurable: !0, writable: !0, value: !1 }), Object.defineProperty(this, "_fillAlpha", { enumerable: !0, configurable: !0, writable: !0, value: void 0 }), Object.defineProperty(this, "_strokeAlpha", { enumerable: !0, configurable: !0, writable: !0, value: void 0 });
  }
  clear() {
  ...
  beginFill(e, t = 1) {
    this._fillAlpha = t, e ? e instanceof X ? this._pushOp(new je(e.toCSS(t))) : (this.isMeasured = !0, this._pushOp(new je(e))) : this._pushOp(new je("rgba(0, 0, 0, " + t + ")"));
  }
  endFill() {
    this._pushOp(new li(this._hasShadows));
  }
  endStroke() {
    this._pushOp(new hi());
  }
  ...
  lineStyle(e = 0, t, i = 1, r) {
    this._strokeAlpha = i, t ? t instanceof X ? this._pushOp(new Ee(e, t.toCSS(i), r)) : this._pushOp(new Ee(e, t, r)) : this._pushOp(new Ee(e, "rgba(0, 0, 0, " + i + ")", r));
  }
  setLineDash(e) {
  ...
  drawCircle(e, t, i) {
    this._pushOp(new bi(e, t, i));
  }
  drawEllipse(e, t, i, r) {
    this._pushOp(new fi(e, t, i, r));
  }
  arc(e, t, i, r, a, s = !1) {
    this._pushOp(new gi(e, t, i, r, a, s));
  }
  arcTo(e, t, i, r, a) {
    this._pushOp(new mi(e, t, i, r, a));
  }
  lineTo(e, t) {
    this._pushOp(new pi(e, t));
  }
  moveTo(e, t) {
    this._pushOp(new _i(e, t));
  }
  bezierCurveTo(e, t, i, r, a, s) {
    this._pushOp(new vi(e, t, i, r, a, s));
  }
  quadraticCurveTo(e, t, i, r) {
    this._pushOp(new wi(e, t, i, r));
  }
  closePath() {
    this._pushOp(new yi());
  }
  shadow(e, t = 0, i = 0, r = 0, a) {
    this._hasShadows = !0, this._pushOp(new xi(a ? e.toCSS(a) : e.toCSS(this._fillAlpha || this._strokeAlpha), t, i, r));
  }
  image(e, t, i, r, a) {
    this._pushOp(new Pi(e, t, i, r, a));
  }
  svgPath(e) {
    ...
    for (; (m = l.exec(e)) !== null; ) {
      ...
      switch (c !== "S" && c !== "s" && c !== "C" && c !== "c" && (r = null, a = null), c !== "Q" && c !== "q" && c !== "T" && c !== "t" && (s = null, n = null), c) {
        case "M":
          L(c, o.length, 2), t = +o[0], i = +o[1], this.moveTo(t, i);
        ...
        case "C":
          ...
          for (let h = 0; h < o.length; h += 6) {
            const u = +o[h], _ = +o[h + 1];
            r = +o[h + 2], a = +o[h + 3], t = +o[h + 4], i = +o[h + 5], this.bezierCurveTo(u, _, r, a, t, i);
          }
          break;
        case "c":
          L(c, o.length, 6);
          for (let h = 0; h < o.length; h += 6) {
            const u = +o[h] + t, _ = +o[h + 1] + i;
            r = +o[h + 2] + t, a = +o[h + 3] + i, t += +o[h + 4], i += +o[h + 5], this.bezierCurveTo(u, _, r, a, t, i);
          }
          break;
        case "S":
          L(c, o.length, 4), r !== null && a !== null || (r = t, a = i);
          for (let h = 0; h < o.length; h += 4) {
            const u = 2 * t - r, _ = 2 * i - a;
            r = +o[h], a = +o[h + 1], t = +o[h + 2], i = +o[h + 3], this.bezierCurveTo(u, _, r, a, t, i);
          }
          break;
        case "s":
          L(c, o.length, 4), r !== null && a !== null || (r = t, a = i);
          for (let h = 0; h < o.length; h += 4) {
            const u = 2 * t - r, _ = 2 * i - a;
            r = +o[h] + t, a = +o[h + 1] + i, t += +o[h + 2], i += +o[h + 3], this.bezierCurveTo(u, _, r, a, t, i);
          }
          break;
        case "Q":
          L(c, o.length, 4);
          for (let h = 0; h < o.length; h += 4) s = +o[h], n = +o[h + 1], t = +o[h + 2], i = +o[h + 3], this.quadraticCurveTo(s, n, t, i);
          break;
        case "q":
          L(c, o.length, 4);
          for (let h = 0; h < o.length; h += 4) s = +o[h] + t, n = +o[h + 1] + i, t += +o[h + 2], i += +o[h + 3], this.quadraticCurveTo(s, n, t, i);
          break;
        case "T":
          L(c, o.length, 2), s !== null && n !== null || (s = t, n = i);
          for (let h = 0; h < o.length; h += 2) s = 2 * t - s, n = 2 * i - n, t = +o[h], i = +o[h + 1], this.quadraticCurveTo(s, n, t, i);
          break;
        case "t":
          L(c, o.length, 2), s !== null && n !== null || (s = t, n = i);
          for (let h = 0; h < o.length; h += 2) s = 2 * t - s, n = 2 * i - n, t += +o[h], i += +o[h + 1], this.quadraticCurveTo(s, n, t, i);
        ...
        case "a":
          ...
          for (let h = 0; h < o.length; h += 7) {
            let u = +o[h + 5], _ = +o[h + 6];
            p && (u += t, _ += i);
            const w = ei({ px: t, py: i, rx: +o[h], ry: +o[h + 1], xAxisRotation: +o[h + 2], largeArcFlag: qe(+o[h + 3]), sweepFlag: qe(+o[h + 4]), cx: u, cy: _ });
            y(w, (v) => {
        ...
        case "Z":
        case "z":
          ti(c, o.length, 0), this.closePath();
      }
    }
  }
  _runPath(e) {
  ...
  _render(e) {
    ...
    if (t || i) {
      ...
      t && (r.globalCompositeOperation = this.blendMode, r.beginPath()), i && (a.beginPath(), s = this._getColorId()), y(this._operations, (n) => {
        t && (n.path(r), n.colorize(r, void 0)), i && (n.pathGhost(a), n.colorizeGhost(a, s));
      });
    }
  }
  renderDetached(e) {
...
class nt extends xe {
  ...
  _render(e) {
    if (this._textInfo || this._measure(e), this.textVisible) {
      ...
      i.save(), a.save(), this._prerender(e), y(this._textInfo, (s, n) => {
        y(s.textChunks, (l, d) => {
          if (l.style && (i.save(), a.save(), i.font = l.style, this._isInteractive(e) && (a.font = l.style)), l.fill && (i.save(), i.fillStyle = l.fill.toCSS()), r && i.fillText(l.text, l.offsetX, s.offsetY + l.offsetY), l.textDecoration == "underline" || l.textDecoration == "line-through") {
            let m = 1, c = 1, f = l.height;
            const o = this.style.oversizedBehavior || "";
            if (["truncate", "wrap", "wrap-no-break"].indexOf(o) > -1) {
              const u = this._measureText(l.text, i);
              l.width = u.actualBoundingBoxLeft + u.actualBoundingBoxRight;
            }
            let p, h = l.offsetX;
  ...
  _measure(e) {
    ...
    this._textInfo = [];
    const a = this.style.oversizedBehavior, s = this.style.maxWidth, n = H(s) && a == "truncate", l = H(s) && (a == "wrap" || a == "wrap-no-break");
    ...
    let c, f = !0, o = 0, p = 0, h = 0;
    y(m, (_, w) => {
      let v;
      for (v = _ == "" ? [{ type: "value", text: "" }] : W.chunk(_, !1, this.style.ignoreFormatting); v.length > 0; ) {
        let g = { offsetY: h, ascent: 0, width: 0, height: 0, left: 0, right: 0, textChunks: [] };
        const x = this._measureText(d, t), k = x.actualBoundingBoxAscent + x.actualBoundingBoxDescent;
        let O;
        g.height = k, g.ascent = x.actualBoundingBoxAscent;
        let M, E, P, z = this.style.textDecoration, A = !1, I = !0, N = [];
        De(v, (C, ue) => {
          if (C.type == "format") if (C.text == "[/]") f || (t.restore(), i.restore(), f = !0), M = void 0, c = void 0, E = void 0, z = this.style.textDecoration, P = void 0, O = C.text;
          else {
            f || (t.restore(), i.restore());
            let S = W.getTextStyle(C.text);
            const F = this._getFontStyle(S);
            t.save(), i.save(), t.font = F, c = F, O = C.text, S.textDecoration && (z = S.textDecoration), S.fill && (M = S.fill), S.width && (E = R(S.width)), S.verticalAlign && (P = S.verticalAlign), f = !1;
            const Y = this._measureText(d, t), $ = Y.actualBoundingBoxAscent + Y.actualBoundingBoxDescent;
            $ > g.height && (g.height = $), Y.actualBoundingBoxAscent > g.ascent && (g.ascent = Y.actualBoundingBoxAscent);
          }
          else if (C.type == "value" && !A) {
            const S = this._measureText(C.text, t);
            let F = S.actualBoundingBoxLeft + S.actualBoundingBoxRight;
            if (n) {
              let U = I || this.style.breakWords || !1;
              const V = this.style.ellipsis || "", Fe = this._measureText(V, t), ot = Fe.actualBoundingBoxLeft + Fe.actualBoundingBoxRight;
              if (g.width + F > s) {
                const lt = s - g.width - ot;
                C.text = this._truncateText(t, C.text, lt, U), C.text += V, A = !0;
              }
            } else if (l && g.width + F > s) {
              const U = s - g.width, V = this._truncateText(t, C.text, U, !1, I && this.style.oversizedBehavior != "wrap-no-break");
              if (V == "") return this.textVisible = !0, !1;
              N = v.slice(ue + 1), Oe(V) != Oe(C.text) && (N.unshift({ type: "value", text: C.text.substr(V.length) }), O && N.unshift({ type: "format", text: O })), C.text = Oe(V), v = [], A = !0;
            }
            let Y = 1, $ = 1;
            if (c && E && E > F) {
              const U = F / E;
            ...
            const Pe = S.actualBoundingBoxAscent + S.actualBoundingBoxDescent;
            Pe > g.height && (g.height = Pe), S.actualBoundingBoxAscent > g.ascent && (g.ascent = S.actualBoundingBoxAscent), g.width += F, g.left += S.actualBoundingBoxLeft / Y, g.right += S.actualBoundingBoxRight / $, g.textChunks.push({ style: c, fill: M, text: C.text, width: F, height: Pe, left: S.actualBoundingBoxLeft, right: S.actualBoundingBoxRight, ascent: S.actualBoundingBoxAscent, offsetX: 0, offsetY: 0, textDecoration: z, verticalAlign: P }), I = !1;
          }
          return !0;
        }), this.style.lineHeight instanceof ye ? (g.height *= this.style.lineHeight.value, g.ascent *= this.style.lineHeight.value) : (g.height *= this.style.lineHeight || 1.2, g.ascent *= this.style.lineHeight || 1.2), o < g.left && (o = g.left), p < g.right && (p = g.right), this._textInfo.push(g), h += g.height, v = N || [];
      }
    }), f || (t.restore(), i.restore()), y(this._textInfo, (_, w) => {
      let v = 0;
      y(_.textChunks, (g) => {
        if (g.offsetX = v + g.left - _.left, g.offsetY += _.height - _.height * (this.style.baselineRatio || 0.19), v += g.width, g.verticalAlign) switch (g.verticalAlign) {
          case "super":
    ...
    const u = { left: r ? -p : -o, top: 0, right: r ? o : p, bottom: h };
    if (a !== "none") {
      const _ = this._fitRatio(u);
      if (_ < 1) if (a == "fit") H(this.style.minScale) && _ < this.style.minScale ? (this.textVisible = !1, u.left = 0, u.top = 0, u.right = 0, u.bottom = 0) : (this._originalScale && this._originalScale != 1 || (this._originalScale = this.scale), this.scale = _, this.textVisible = !0);
      else if (a == "hide") this.textVisible = !1, u.left = 0, u.top = 0, u.right = 0, u.bottom = 0;
      else {
        switch (this.style.textAlign) {
          case "right":
          case "end":
            u.left = r ? s : -s, u.right = 0;
            break;
          case "center":
            u.left = -s / 2, u.right = s / 2;
            break;
          default:
            u.left = 0, u.right = r ? -s : s;
        }
...
class ki {
  constructor() {
    Object.defineProperty(this, "fill", { enumerable: !0, configurable: !0, writable: !0, value: void 0 }), Object.defineProperty(this, "fillOpacity", { enumerable: !0, configurable: !0, writable: !0, value: void 0 }), Object.defineProperty(this, "textAlign", { enumerable: !0, configurable: !0, writable: !0, value: void 0 }), Object.defineProperty(this, "fontFamily", { enumerable: !0, configurable: !0, writable: !0, value: void 0 }), Object.defineProperty(this, "fontSize", { enumerable: !0, configurable: !0, writable: !0, value: void 0 }), Object.defineProperty(this, "fontWeight", { enumerable: !0, configurable: !0, writable: !0, value: void 0 }), Object.defineProperty(this, "fontStyle", { enumerable: !0, configurable: !0, writable: !0, value: void 0 }), Object.defineProperty(this, "fontVariant", { enumerable: !0, configurable: !0, writable: !0, value: void 0 }), Object.defineProperty(this, "textDecoration", { enumerable: !0, configurable: !0, writable: !0, value: void 0 }), Object.defineProperty(this, "shadowColor", { enumerable: !0, configurable: !0, writable: !0, value: void 0 }), Object.defineProperty(this, "shadowBlur", { enumerable: !0, configurable: !0, writable: !0, value: void 0 }), Object.defineProperty(this, "shadowOffsetX", { enumerable: !0, configurable: !0, writable: !0, value: void 0 }), Object.defineProperty(this, "shadowOffsetY", { enumerable: !0, configurable: !0, writable: !0, value: void 0 }), Object.defineProperty(this, "shadowOpacity", { enumerable: !0, configurable: !0, writable: !0, value: void 0 }), Object.defineProperty(this, "lineHeight", { enumerable: !0, configurable: !0, writable: !0, value: et(120) }), Object.defineProperty(this, "baselineRatio", { enumerable: !0, configurable: !0, writable: !0, value: 0.19 }), Object.defineProperty(this, "direction", { enumerable: !0, configurable: !0, writable: !0, value: void 0 }), Object.defineProperty(this, "textBaseline", { enumerable: !0, configurable: !0, writable: !0, value: void 0 }), Object.defineProperty(this, "oversizedBehavior", { enumerable: !0, configurable: !0, writable: !0, value: "none" }), Object.defineProperty(this, "breakWords", { enumerable: !0, configurable: !0, writable: !0, value: !1 }), Object.defineProperty(this, "ellipsis", { enumerable: !0, configurable: !0, writable: !0, value: "…" }), Object.defineProperty(this, "maxWidth", { enumerable: !0, configurable: !0, writable: !0, value: void 0 }), Object.defineProperty(this, "maxHeight", { enumerable: !0, configurable: !0, writable: !0, value: void 0 }), Object.defineProperty(this, "minScale", { enumerable: !0, configurable: !0, writable: !0, value: void 0 }), Object.defineProperty(this, "ignoreFormatting", { enumerable: !0, configurable: !0, writable: !0, value: !1 });
  }
}
class Mi extends nt {
  constructor() {
  ...
  _renderCircular(e) {
    if (this.textVisible) {
      ...
      let s = this.radius || 0, n = this.startAngle || 0, l = 0, d = this.orientation, m = d == "auto" ? "auto" : d == "inward";
      const c = this.inside, f = this.style.textAlign || "left", o = this.kerning || 0;
      let p = f == "left" ? 1 : -1;
      const h = !this._textReversed;
      if (m == "auto") {
        let u = 0, _ = 0;
        y(this._textInfo, (w, v) => {
          const g = n + w.width / (s - w.height) / 2 * -p;
          g > u && (u = g);
        }), _ = f == "left" ? (u + l / 2) * oe : f == "right" ? (u - l / 2) * oe : n * oe, _ = Ft(_), m = _ >= 270 || _ <= 90;
      }
      m == 1 && h && (this._textInfo.reverse(), this._textReversed = !0), y(this._textInfo, (u, _) => {
        const w = u.height;
        c || (s += w), (p == -1 && m || p == 1 && !m) && h && u.textChunks.reverse();
        let v = n;
        l = 0, f == "center" && (v += u.width / (s - w) / 2 * -p, l = v - n), v += Math.PI * (m ? 0 : 1), i.save(), t && a.save(), i.rotate(v), t && a.rotate(v);
        let g = 0;
        y(u.textChunks, (x, k) => {
          const O = x.text, M = x.width;
          g = M / 2 / (s - w) * p, i.rotate(g), t && a.rotate(g), x.style && (i.save(), a.save(), i.font = x.style, t && (a.font = x.style)), x.fill && (i.save(), i.fillStyle = x.fill.toCSS()), i.textBaseline = "middle", i.textAlign = "center", t && (a.textBaseline = "middle", a.textAlign = "center"), r && i.fillText(O, 0, (m ? 1 : -1) * (0 - s + w / 2)), t && a.fillText(O, 0, (m ? 1 : -1) * (0 - s + w / 2)), x.fill && i.restore(), x.style && (i.restore(), a.restore()), g = (M / 2 + o) / (s - w) * p, i.rotate(g), t && a.rotate(g);
        }), i.restore(), t && a.restore(), c && (s -= w);
  ...
  _measureCircular(e) {
    const t = e.layer.context, i = this._renderer._ghostLayer.context, r = this.style.direction == "rtl", a = this.style.oversizedBehavior, s = this.style.maxWidth, n = H(s) && a == "truncate", l = this.style.ellipsis || "";
    let d;
    ...
    let c = !0, f = 0, o = 0;
    return y(m, (p, h) => {
      let u, _, w, v = W.chunk(p, !1, this.style.ignoreFormatting), g = { offsetY: o, ascent: 0, width: 0, height: 0, left: 0, right: 0, textChunks: [] };
      y(v, (x, k) => {
        if (x.type == "format") {
          if (x.text == "[/]") c || (t.restore(), i.restore(), c = !0), _ = void 0, u = void 0, w = void 0;
          else {
            let O = W.getTextStyle(x.text);
            const M = this._getFontStyle(O);
            t.save(), i.save(), t.font = M, u = M, O.fill && (_ = O.fill), O.width && (w = R(O.width)), c = !1;
          }
          n && (d = this._measureText(l, t));
        } else if (x.type == "value") {
          let O = x.text.match(/./gu) || [];
          r && (O = Yt(x.text), O.reverse());
          for (let M = 0; M < O.length; M++) {
            const E = O[M], P = this._measureText(E, t);
            let z = P.width;
            u && w && w > z && (z = w);
            ...
            if (A > g.height && (g.height = A), P.actualBoundingBoxAscent > g.ascent && (g.ascent = P.actualBoundingBoxAscent), f += z, n) {
              ...
              if (f + I > s) {
                g.textChunks.length == 1 ? this.textVisible = !1 : (g.width += I, g.left += d.actualBoundingBoxLeft, g.right += d.actualBoundingBoxRight, g.textChunks.push({ style: u, fill: _, text: l, width: I, height: A + d.actualBoundingBoxDescent, left: d.actualBoundingBoxLeft, right: d.actualBoundingBoxRight, ascent: d.actualBoundingBoxAscent, offsetX: 0, offsetY: A, textDecoration: void 0 }));
                break;
              }
            }
            g.width += z, g.left += P.actualBoundingBoxLeft, g.right += P.actualBoundingBoxRight, g.textChunks.push({ style: u, fill: _, text: E, width: z, height: A + P.actualBoundingBoxDescent, left: P.actualBoundingBoxLeft, right: P.actualBoundingBoxRight, ascent: P.actualBoundingBoxAscent, offsetX: 0, offsetY: A, textDecoration: void 0 });
          }
        }
      }), this.style.lineHeight instanceof ye ? g.height *= this.style.lineHeight.value : g.height *= this.style.lineHeight || 1.2, this._textInfo.push(g), o += g.height;
    }), c || (t.restore(), i.restore()), a == "hide" && f > s && (this.textVisible = !1), y(this._textInfo, (p) => {
      y(p.textChunks, (h) => {
...
class Si extends xe {
  ...
  _render(e) {
    if (super._render(e), this.image) {
      if (this.tainted === void 0 && (this.tainted = Je(this.image), e.layer.tainted = !0), this.tainted && this._renderer._omitTainted) return;
      if (e.layer.dirty) {
  ...
  _getMask(e) {
    if (this._imageMask === void 0) {
      ...
      a.imageSmoothingEnabled = !1, a.fillStyle = this._getColorId(), a.fillRect(0, 0, t, i), Je(e) || (a.globalCompositeOperation = "destination-in", a.drawImage(e, 0, 0, t, i)), this._imageMask = r;
    }
...
class Ei extends Ct {
  constructor(e) {
    if (super(), Object.defineProperty(this, "view", { enumerable: !0, configurable: !0, writable: !0, value: document.createElement("div") }), Object.defineProperty(this, "_layerDom", { enumerable: !0, configurable: !0, writable: !0, value: document.createElement("div") }), Object.defineProperty(this, "layers", { enumerable: !0, configurable: !0, writable: !0, value: [] }), Object.defineProperty(this, "_dirtyLayers", { enumerable: !0, configurable: !0, writable: !0, value: [] }), Object.defineProperty(this, "defaultLayer", { enumerable: !0, configurable: !0, writable: !0, value: this.getLayer(0) }), Object.defineProperty(this, "_ghostLayer", { enumerable: !0, configurable: !0, writable: !0, value: new Ti() }), Object.defineProperty(this, "_patternCanvas", { enumerable: !0, configurable: !0, writable: !0, value: document.createElement("canvas") }), Object.defineProperty(this, "_patternContext", { enumerable: !0, configurable: !0, writable: !0, value: this._patternCanvas.getContext("2d") }), Object.defineProperty(this, "_realWidth", { enumerable: !0, configurable: !0, writable: !0, value: 0 }), Object.defineProperty(this, "_realHeight", { enumerable: !0, configurable: !0, writable: !0, value: 0 }), Object.defineProperty(this, "_calculatedWidth", { enumerable: !0, configurable: !0, writable: !0, value: 0 }), Object.defineProperty(this, "_calculatedHeight", { enumerable: !0, configurable: !0, writable: !0, value: 0 }), Object.defineProperty(this, "resolution", { enumerable: !0, configurable: !0, writable: !0, value: void 0 }), Object.defineProperty(this, "interactionsEnabled", { enumerable: !0, configurable: !0, writable: !0, value: !0 }), Object.defineProperty(this, "_listeners", { enumerable: !0, configurable: !0, writable: !0, value: {} }), Object.defineProperty(this, "_events", { enumerable: !0, configurable: !0, writable: !0, value: {} }), Object.defineProperty(this, "_colorId", { enumerable: !0, configurable: !0, writable: !0, value: 0 }), Object.defineProperty(this, "_colorMap", { enumerable: !0, configurable: !0, writable: !0, value: {} }), Object.defineProperty(this, "_forceInteractive", { enumerable: !0, configurable: !0, writable: !0, value: 0 }), Object.defineProperty(this, "_omitTainted", { enumerable: !0, configurable: !0, writable: !0, value: !1 }), Object.defineProperty(this, "_hovering", { enumerable: !0, configurable: !0, writable: !0, value: /* @__PURE__ */ new Set() }), Object.defineProperty(this, "_dragging", { enumerable: !0, configurable: !0, writable: !0, value: [] }), Object.defineProperty(this, "_mousedown", { enumerable: !0, configurable: !0, writable: !0, value: [] }), Object.defineProperty(this, "_lastPointerMoveEvent", { enumerable: !0, configurable: !0, writable: !0, value: void 0 }), Object.defineProperty(this, "tapToActivate", { enumerable: !0, configurable: !0, writable: !0, value: !1 }), Object.defineProperty(this, "tapToActivateTimeout", { enumerable: !0, configurable: !0, writable: !0, value: 3e3 }), Object.defineProperty(this, "_touchActive", { enumerable: !0, configurable: !0, writable: !0, value: !1 }), Object.defineProperty(this, "_touchActiveTimeout", { enumerable: !0, configurable: !0, writable: !0, value: void 0 }), this.resolution = e ?? window.devicePixelRatio, this.view.style.position = "absolute", this.view.setAttribute("aria-hidden", "true"), this.view.appendChild(this._layerDom), this._disposers.push(new G(() => {
      he(this._events, (t, i) => {
        i.disposer.dispose();
      }), y(this.layers, (t) => {
        ne(t.view), t.exportableView && ne(t.exportableView);
      }), ne(this._ghostLayer.view), ne(this._patternCanvas);
    })), this._disposers.push(tt(() => {
      e == null && (this.resolution = window.devicePixelRatio);
    })), pe("touchevents")) {
      const t = (i) => {
        this._dragging.length !== 0 && De(this._dragging, (r) => !r.value.shouldCancelTouch() || (i.preventDefault(), !1)), this._touchActiveTimeout && this._delayTouchDeactivate();
      };
      this._disposers.push(D(window, "touchstart", t, { passive: !1 })), this._disposers.push(D(this.view, "touchstart", t, { passive: !1 })), this._disposers.push(D(this.view, "touchmove", () => {
        this._touchActiveTimeout && this._delayTouchDeactivate();
      }, { passive: !0 })), this._disposers.push(D(window, "click", (i) => {
        this._touchActive = !1;
      }, { passive: !0 })), this._disposers.push(D(this.view, "click", (i) => {
        window.setTimeout(() => {
          this._touchActive = !0, this._delayTouchDeactivate();
        }, 100);
      }, { passive: !0 }));
    }
    pe("wheelevents") && this._disposers.push(D(this.view, "wheel", (t) => {
      let i = !1;
  ...
  createDetachedLayer(e = !1) {
    const t = document.createElement("canvas"), i = t.getContext("2d", { willReadFrequently: e }), r = new Bi(t, i);
  ...
  getLayer(e, t = !0) {
    ...
    const a = this.layers;
    a.push(r), a.sort((l, d) => l.order > d.order ? 1 : l.order < d.order ? -1 : 0);
    const s = a.length;
    let n;
    for (let l = Dt(a, r) + 1; l < s; l++) if (a[l].visible) {
      n = a[l];
      break;
    }
  ...
  paintId(e) {
    const t = ri(++this._colorId), i = X.fromHex(t).toCSS();
  ...
  getEvent(e, t = !0) {
    const i = this.view.getBoundingClientRect(), r = e.clientX || 0, a = e.clientY || 0, s = this._calculatedWidth / this._realWidth, n = this._calculatedHeight / this._realHeight, l = { x: r - i.left, y: a - i.top }, d = { x: (r - (t ? i.left : 0)) * s, y: (a - (t ? i.top : 0)) * n };
    return new ji(e, l, d, this._adjustBoundingBox(i));
  }
  _getHitTarget(e, t, i) {
  ...
  _withEvents(e, t) {
    ...
    if (i !== void 0) {
      ...
      try {
        ...
        i.dispatching = !1, i.cleanup && (i.cleanup = !1, ve(i.callbacks, (r) => !r.disposed), i.callbacks.length === 0 && (i.disposer.dispose(), delete this._events[e]));
      }
    }
  }
  ...
  _dispatchMousedown(e, t) {
    ...
    if (a) {
      ...
      let n = !1;
      ge(a, (l) => {
        const d = { id: s, value: l };
        return this._mousedown.push(d), !n && this._dispatchEvent("pointerdown", l, r) && (n = !0, this._dragging.some((m) => m.value === l && m.id === s) || this._dragging.push(d)), !0;
      });
    }
  }
  _dispatchGlobalMousemove(e, t, i) {
    ...
    r.native = i, a ? (this._hovering.forEach((s) => {
      s.contains(a) || (this._hovering.delete(s), s.cursorOverStyle && fe(document.body, "cursor", s._replacedCursorStyle), this._dispatchEvent("pointerout", s, r));
    }), r.native && ge(a, (s) => (this._hovering.has(s) || (this._hovering.add(s), s.cursorOverStyle && (s._replacedCursorStyle = It(document.body, "cursor"), fe(document.body, "cursor", s.cursorOverStyle)), this._dispatchEvent("pointerover", s, r)), !0))) : (this._hovering.forEach((s) => {
      s.cursorOverStyle && fe(document.body, "cursor", s._replacedCursorStyle), this._dispatchEvent("pointerout", s, r);
  ...
  _dispatchDragEnd(e, t) {
    ...
    if (this._mousedown.length !== 0) {
      ...
      n && this._mousedown.forEach((l) => {
        l.id === s && l.value.contains(n) && this._dispatchEvent(r, l.value, a);
  ...
  _dispatchDoubleClick(e, t) {
    ...
    r && ge(r, (a) => !this._dispatchEvent("dblclick", a, i));
  }
  _dispatchWheel(e, t) {
    const i = this.getEvent(e), r = this._getHitTarget(i.originalPoint, i.bbox, t);
    r && ge(r, (a) => !this._dispatchEvent("wheel", a, i));
  }
  _makeSharedEvent(e, t) {
    if (this._listeners[e] === void 0) {
      const i = t();
      this._listeners[e] = new At(() => {
    ...
    switch (e) {
      ...
      case "pointerout":
        return this._makeSharedEvent("pointermove", () => {
          ...
          return new Ve([this._onPointerEvent("pointerdown", t), this._onPointerEvent("pointermove", t)]);
        });
      ...
      case "wheel":
        return this._makeSharedEvent("wheel", () => D(this.view, Be("wheel"), (t) => {
          this._dispatchWheel(t, rt(t));
        }, { passive: !1 }));
    }
  }
  _addEvent(e, t, i, r) {
    ...
    return a.callbacks.push(s), new G(() => {
      s.disposed = !0, a.dispatching ? a.cleanup = !0 : (Ce(a.callbacks, s), a.callbacks.length === 0 && (a.disposer.dispose(), delete this._events[t]));
    });
  }
  getCanvas(e, t) {
    this.render(e), t || (t = {});
    ...
    i != this.resolution && (n = !0, r = r * i / this.resolution, a = a * i / this.resolution), l.width = r, l.height = a, l.style.position = "fixed", l.style.top = "-10000px", this.view.appendChild(l), s.push(l);
    const d = l.getContext("2d");
    let m = 0, c = 0, f = !1;
    return y(this.layers, (o) => {
      if (o && o.visible && (o.tainted || n)) {
        f = !0, o.exportableView = o.view, o.exportableContext = o.context, o.view = document.createElement("canvas"), o.view.style.position = "fixed", o.view.style.top = "-10000px", this.view.appendChild(o.view), s.push(o.view);
        let p = 0, h = 0;
        o.margin && (p += o.margin.left || 0 + o.margin.right || 0, h += o.margin.top || 0 + o.margin.bottom || 0), o.view.width = r + p, o.view.height = a + h, o.context = o.view.getContext("2d"), o.dirty = !0, o.scale = i;
      }
    }), f && (this._omitTainted = !0, this.render(e), this._omitTainted = !1), y(this.layers, (o) => {
      if (o && o.visible) {
        let p = 0, h = 0;
        o.margin && (p = -(o.margin.left || 0) * this.resolution, h = -(o.margin.top || 0) * this.resolution), d.drawImage(o.view, p, h), o.exportableView && (o.view = o.exportableView, o.exportableView = void 0), o.exportableContext && (o.context = o.exportableContext, o.exportableContext = void 0), m < o.view.clientWidth && (m = o.view.clientWidth), c < o.view.clientHeight && (c = o.view.clientHeight), o.scale = void 0;
      }
    }), l.style.width = m + "px", l.style.height = c + "px", y(s, (o) => {
...
class Le {
  constructor(e, t = {}, i) {
    if (Object.defineProperty(this, "dom", { enumerable: !0, configurable: !0, writable: !0, value: void 0 }), Object.defineProperty(this, "_inner", { enumerable: !0, configurable: !0, writable: !0, value: void 0 }), Object.defineProperty(this, "_settings", { enumerable: !0, configurable: !0, writable: !0, value: void 0 }), Object.defineProperty(this, "_isDirty", { enumerable: !0, configurable: !0, writable: !0, value: !1 }), Object.defineProperty(this, "_isDirtyParents", { enumerable: !0, configurable: !0, writable: !0, value: !1 }), Object.defineProperty(this, "_isDirtyAnimation", { enumerable: !0, configurable: !0, writable: !0, value: !1 }), Object.defineProperty(this, "_dirty", { enumerable: !0, configurable: !0, writable: !0, value: {} }), Object.defineProperty(this, "_dirtyParents", { enumerable: !0, configurable: !0, writable: !0, value: {} }), Object.defineProperty(this, "_dirtyBounds", { enumerable: !0, configurable: !0, writable: !0, value: {} }), Object.defineProperty(this, "_dirtyPositions", { enumerable: !0, configurable: !0, writable: !0, value: {} }), Object.defineProperty(this, "_ticker", { enumerable: !0, configurable: !0, writable: !0, value: null }), Object.defineProperty(this, "_tickers", { enumerable: !0, configurable: !0, writable: !0, value: [] }), Object.defineProperty(this, "_updateTick", { enumerable: !0, configurable: !0, writable: !0, value: !0 }), Object.defineProperty(this, "events", { enumerable: !0, configurable: !0, writable: !0, value: new ct() }), Object.defineProperty(this, "animationTime", { enumerable: !0, configurable: !0, writable: !0, value: null }), Object.defineProperty(this, "_animations", { enumerable: !0, configurable: !0, writable: !0, value: [] }), Object.defineProperty(this, "_renderer", { enumerable: !0, configurable: !0, writable: !0, value: void 0 }), Object.defineProperty(this, "_rootContainer", { enumerable: !0, configurable: !0, writable: !0, value: void 0 }), Object.defineProperty(this, "container", { enumerable: !0, configurable: !0, writable: !0, value: void 0 }), Object.defineProperty(this, "tooltipContainer", { enumerable: !0, configurable: !0, writable: !0, value: void 0 }), Object.defineProperty(this, "_tooltipContainerSettings", { enumerable: !0, configurable: !0, writable: !0, value: void 0 }), Object.defineProperty(this, "_tooltip", { enumerable: !0, configurable: !0, writable: !0, value: void 0 }), Object.defineProperty(this, "language", { enumerable: !0, configurable: !0, writable: !0, value: Jt.new(this, {}) }), Object.defineProperty(this, "locale", { enumerable: !0, configurable: !0, writable: !0, value: at }), Object.defineProperty(this, "utc", { enumerable: !0, configurable: !0, writable: !0, value: !1 }), Object.defineProperty(this, "timezone", { enumerable: !0, configurable: !0, writable: !0, value: void 0 }), Object.defineProperty(this, "fps", { enumerable: !0, configurable: !0, writable: !0, value: void 0 }), Object.defineProperty(this, "numberFormatter", { enumerable: !0, configurable: !0, writable: !0, value: Xt.new(this, {}) }), Object.defineProperty(this, "dateFormatter", { enumerable: !0, configurable: !0, writable: !0, value: $t.new(this, {}) }), Object.defineProperty(this, "durationFormatter", { enumerable: !0, configurable: !0, writable: !0, value: qt.new(this, {}) }), Object.defineProperty(this, "tabindex", { enumerable: !0, configurable: !0, writable: !0, value: 0 }), Object.defineProperty(this, "_tabindexes", { enumerable: !0, configurable: !0, writable: !0, value: [] }), Object.defineProperty(this, "_a11yD", { enumerable: !0, configurable: !0, writable: !0, value: !1 }), Object.defineProperty(this, "_focusElementDirty", { enumerable: !0, configurable: !0, writable: !0, value: !1 }), Object.defineProperty(this, "_focusElementContainer", { enumerable: !0, configurable: !0, writable: !0, value: void 0 }), Object.defineProperty(this, "_focusedSprite", { enumerable: !0, configurable: !0, writable: !0, value: void 0 }), Object.defineProperty(this, "_isShift", { enumerable: !0, configurable: !0, writable: !0, value: void 0 }), Object.defineProperty(this, "_keyboardDragPoint", { enumerable: !0, configurable: !0, writable: !0, value: void 0 }), Object.defineProperty(this, "_tooltipElementContainer", { enumerable: !0, configurable: !0, writable: !0, value: void 0 }), Object.defineProperty(this, "_readerAlertElement", { enumerable: !0, configurable: !0, writable: !0, value: void 0 }), Object.defineProperty(this, "_logo", { enumerable: !0, configurable: !0, writable: !0, value: void 0 }), Object.defineProperty(this, "_tooltipDiv", { enumerable: !0, configurable: !0, writable: !0, value: void 0 }), Object.defineProperty(this, "nonce", { enumerable: !0, configurable: !0, writable: !0, value: void 0 }), Object.defineProperty(this, "interfaceColors", { enumerable: !0, configurable: !0, writable: !0, value: void 0 }), Object.defineProperty(this, "verticalLayout", { enumerable: !0, configurable: !0, writable: !0, value: dt.new(this, {}) }), Object.defineProperty(this, "horizontalLayout", { enumerable: !0, configurable: !0, writable: !0, value: bt.new(this, {}) }), Object.defineProperty(this, "gridLayout", { enumerable: !0, configurable: !0, writable: !0, value: ft.new(this, {}) }), Object.defineProperty(this, "_paused", { enumerable: !0, configurable: !0, writable: !0, value: !1 }), Object.defineProperty(this, "autoResize", { enumerable: !0, configurable: !0, writable: !0, value: !0 }), Object.defineProperty(this, "_fontHash", { enumerable: !0, configurable: !0, writable: !0, value: "" }), Object.defineProperty(this, "_isDisposed", { enumerable: !0, configurable: !0, writable: !0, value: !1 }), Object.defineProperty(this, "_disposers", { enumerable: !0, configurable: !0, writable: !0, value: [] }), Object.defineProperty(this, "_resizeSensorDisposer", { enumerable: !0, configurable: !0, writable: !0, value: void 0 }), Object.defineProperty(this, "_tooltips", { enumerable: !0, configurable: !0, writable: !0, value: [] }), Object.defineProperty(this, "_htmlElementContainer", { enumerable: !0, configurable: !0, writable: !0, value: void 0 }), Object.defineProperty(this, "_htmlEnabledContainers", { enumerable: !0, configurable: !0, writable: !0, value: [] }), !i) throw new Error("You cannot use `new Class()`, instead use `Class.new()`");
    let r, a;
    if (this._settings = t, t.accessible == 0 && (this._a11yD = !0), t.useSafeResolution == null && (t.useSafeResolution = !0), t.useSafeResolution && (r = gt()), this._renderer = new Ei(r), a = e instanceof HTMLElement ? e : document.getElementById(e), y(te.rootElements, (l) => {
      if (l.dom === a) throw new Error("You cannot have multiple Roots on the same DOM node");
    }), this.interfaceColors = me.new(this, {}), a === null) throw new Error("Could not find HTML element with id `" + e + "`");
    this.dom = a;
  ...
  _showBranding() {
    if (!this._logo) {
      const e = this.tooltipContainer.children.push(q.new(this, { interactive: !0, interactiveChildren: !1, position: "absolute", setStateOnChildren: !0, paddingTop: 9, paddingRight: 9, paddingBottom: 9, paddingLeft: 9, scale: 0.6, y: et(100), centerY: J, tooltipText: "Created using amCharts 5", tooltipX: J, cursorOverStyle: "pointer", background: mt.new(this, { fill: ie(4671320), fillOpacity: 0, tooltipY: 5 }) })), t = Xe.new(this, { pointerOrientation: "horizontal", paddingTop: 4, paddingRight: 7, paddingBottom: 4, paddingLeft: 7 });
      ...
      }), e.states.create("hover", {}), e.children.push(Ye.new(this, { stroke: ie(13421772), strokeWidth: 3, svgPath: "M5 25 L13 25h13.6c3.4 0 6 0 10.3-4.3s5.2-12 8.6-12c3.4 0 4.3 8.6 7.7 8.6M83.4 25H79.8c-3.4 0-6 0-10.3-4.3s-5.2-12-8.6-12-4.3 8.6-7.7 8.6" })).states.create("hover", { stroke: ie(3976191) }), e.children.push(Ye.new(this, { stroke: ie(8947848), strokeWidth: 3, svgPath: "M83.4 25h-31C37 25 39.5 4.4 28.4 4.4S18.9 24.2 4.3 25H0" })).states.create("hover", { stroke: ie(4671320) }), this._logo = e, this._handleLogo();
    }
  }
  _getRealSize() {
  ...
  _init() {
    ...
    const t = this._renderer, i = this._getRealSize(), r = this._getCalculatedSize(i), a = Math.floor(r.width), s = Math.floor(r.height), n = Math.floor(i.width), l = Math.floor(i.height), d = q.new(this, { visible: !0, width: a, height: s });
    this._rootContainer = d, this._rootContainer._defaultThemes.push(Ut.new(this));
    const m = d.children.push(q.new(this, { visible: !0, width: J, height: J }));
    this.container = m, t.resize(n, l, a, s), this._inner.appendChild(t.view), this._initResizeSensor();
    ...
    if (this._htmlElementContainer = c, c.className = "am5-html-container", c.style.position = "absolute", c.style.pointerEvents = "none", this._tooltipContainerSettings || (c.style.overflow = "hidden"), this._inner.appendChild(c), this._a11yD !== !0) {
      ...
      o.className = "am5-focus-container", o.style.position = "absolute", o.style.pointerEvents = "none", o.style.top = "0px", o.style.left = "0px", o.style.overflow = "hidden", o.style.width = a + "px", o.style.height = s + "px", o.setAttribute("role", "graphics-document"), Z(o, !1), this._focusElementContainer = o, this._inner.appendChild(this._focusElementContainer);
      const p = document.createElement("div");
      this._tooltipElementContainer = p, p.className = "am5-tooltip-container", this._inner.appendChild(p), pe("keyboardevents") && (this._disposers.push(D(window, "keydown", (h) => {
        const u = ce(h);
        u == "Shift" ? this._isShift = !0 : u == "Tab" && (this._isShift = h.shiftKey);
      })), this._disposers.push(D(window, "keyup", (h) => {
        ce(h) == "Shift" && (this._isShift = !1);
      })), this._disposers.push(D(o, "click", () => {
        const h = this._focusedSprite;
        if (h) {
          const u = t.getEvent(new MouseEvent("click"));
          h.events.dispatch("click", { type: "click", originalEvent: u.event, point: u.point, simulated: !0, target: h });
        }
      })), this._disposers.push(D(o, "keydown", (h) => {
        const u = this._focusedSprite;
        if (u) {
          h.key == "Escape" && (pt(), this._focusedSprite = void 0);
          let _ = 0, w = 0;
          const v = ce(h);
          switch (v) {
            case "Enter":
            case " ":
              if (v == " " && u.get("role") != "checkbox") return;
              h.preventDefault();
              const g = t.getEvent(new MouseEvent("mouse"));
              return void u.events.dispatch("click", { type: "click", originalEvent: g.event, point: g.point, simulated: !0, target: u });
            case "ArrowLeft":
              _ = -6;
              break;
            case "ArrowRight":
          ...
          if (_ != 0 || w != 0) {
            if (h.preventDefault(), !u.isDragging()) {
              this._keyboardDragPoint = { x: 0, y: 0 };
              const k = t.getEvent(new MouseEvent("mousedown", { clientX: 0, clientY: 0 }));
              k.point = { x: 0, y: 0 }, u.events.isEnabled("pointerdown") && u.events.dispatch("pointerdown", { type: "pointerdown", originalEvent: k.event, point: k.point, simulated: !0, target: u });
            }
            const g = this._keyboardDragPoint;
            g.x += _, g.y += w;
            const x = t.getEvent(new MouseEvent("mousemove", { clientX: g.x, clientY: g.y }), !1);
            u.events.isEnabled("globalpointermove") && u.events.dispatch("globalpointermove", { type: "globalpointermove", originalEvent: x.event, point: x.point, simulated: !0, target: u });
          }
        }
      })), this._disposers.push(D(o, "keyup", (h) => {
        if (this._focusedSprite) {
          const u = this._focusedSprite, _ = ce(h);
          switch (_) {
            case "ArrowLeft":
            case "ArrowRight":
            case "ArrowTop":
            case "ArrowDown":
              if (u.isDragging()) {
                ...
                return u.events.isEnabled("globalpointerup") && u.events.dispatch("globalpointerup", { type: "globalpointerup", originalEvent: v.event, point: v.point, simulated: !0, target: u }), void (this._keyboardDragPoint = void 0);
              }
              if (u.get("focusableGroup")) {
                const w = u.get("focusableGroup"), v = this._tabindexes.filter((k) => !(k.get("focusableGroup") != w || k.getPrivate("focusable") === !1 || !k.isVisibleDeep()));
                let g = v.indexOf(u);
                const x = v.length - 1;
                g += _ == "ArrowRight" || _ == "ArrowDown" ? 1 : -1, g < 0 ? g = x : g > x && (g = 0), _t(v[g].getPrivate("focusElement").dom);
              }
          }
        }
      })));
  ...
  _initResizeSensor() {
    this._resizeSensorDisposer && this._resizeSensorDisposer.dispose(), this._resizeSensorDisposer = new Gt(this.dom, () => {
  ...
  _runAnimations(e) {
    let t = 0;
    return ve(this._animations, (i) => {
      const r = i._runAnimation(e);
      return r !== Ge.Stopped && (r !== Ge.Playing || (++t, !0));
  ...
  _runDirties() {
    ...
    }), this._positionHTMLElements(), r.sort((s, n) => yt(i[n.uid], i[s.uid])), r.forEach((s) => {
      s._updateBounds();
    });
  ...
  _runTicker(e, t) {
    this.isDisposed() || (this.animationTime = e, this._renderFrame(e) ? (this._ticker = null, this.animationTime = null) : this._paused || (t ? this._ticker : Ke(this.fps, this._ticker)));
  }
  _runTickerNow(e = 1e4) {
    if (!this.isDisposed()) {
  ...
  eachFrame(e) {
    return this._tickers.push(e), this._startTicker(), new G(() => {
      Ce(this._tickers, e);
    });
  }
  markDirtyGlobal(e) {
  ...
  dispose() {
    this._isDisposed || (this._isDisposed = !0, this._rootContainer.dispose(), this._renderer.dispose(), this.horizontalLayout.dispose(), this.verticalLayout.dispose(), this.interfaceColors.dispose(), y(this._disposers, (e) => {
      e.dispose();
    }), this._inner && vt(this._inner), se(te.rootElements, this));
  }
  isDisposed() {
    return this._isDisposed;
  }
  readerAlert(e) {
    this._a11yD !== !0 && (this._readerAlertElement.innerHTML = Ie(e));
  }
  setThemes(e) {
  ...
  _addTooltip() {
    if (!this.tooltipContainer) {
      const e = this._tooltipContainerSettings, t = this._rootContainer.children.push(q.new(this, { position: "absolute", isMeasured: !1, width: J, height: J, layer: e ? 35 : 30, layerMargin: e || void 0 }));
  ...
  _registerTabindexOrder(e) {
    this._a11yD != 1 && (e.get("focusable") ? Te(this._tabindexes, e) : se(this._tabindexes, e), this._invalidateTabindexes());
  }
  ...
  _decorateFocusElement(e, t) {
    ...
    s != null && i && ["checkbox", "option", "radio", "menuitemcheckbox", "menuitemradio", "treeitem"].indexOf(i) !== -1 ? t.setAttribute("aria-checked", s ? "true" : "false") : t.removeAttribute("aria-checked");
  ...
  _makeFocusElement(e, t) {
    ...
    t.get("role") != "tooltip" && (i.tabIndex = this.tabindex), i.style.position = "absolute", Z(i, !1);
    const r = [];
    t.setPrivate("focusElement", { dom: i, disposers: r }), this._decorateFocusElement(t), r.push(D(i, "focus", (a) => {
      this._handleFocus(a);
    })), r.push(D(i, "blur", (a) => {
      this._handleBlur(a);
  ...
  _positionFocusElement(e) {
    ...
    l.style.top = n + "px", l.style.left = s + "px", l.style.width = i + 2 * a + "px", l.style.height = r + 2 * a + "px";
  }
  _getSpriteByFocusElement(e) {
    let t;
    return De(this._tabindexes, (i, r) => i.getPrivate("focusElement").dom !== e || (t = i, !1)), t;
  }
  _handleFocus(e) {
    if (this._a11yD == 1) return;
  ...
  _makeTooltipElement(e) {
    ...
    return i.style.position = "absolute", i.style.width = "1px", i.style.height = "1px", i.style.overflow = "hidden", i.style.clip = "rect(1px, 1px, 1px, 1px)", Z(i, !1), this._decorateFocusElement(e, i), t.append(i), e.setPrivate("tooltipElement", i), i;
  }
  ...
  _invalidateLabelBounds(e) {
    ...
    }) : e instanceof xt && e.markDirtyBounds();
  }
  _hasLicense() {
  ...
  _makeHTMLElement(e) {
    ...
    return e.setPrivate("htmlElement", i), i.style.position = "absolute", i.style.overflow = "auto", i.style.boxSizing = "border-box", Z(i, e.get("interactive", !1)), e.events.isEnabled("click") && (Z(i, !0), this._disposers.push(D(i, "click", (r) => {
    ...
    }))), this._positionHTMLElement(e), t.append(i), Te(this._htmlEnabledContainers, e), i;
  }
  ...
  _positionHTMLElement(e) {
    ...
    if (t) {
      y(["paddingTop", "paddingRight", "paddingBottom", "paddingLeft", "minWidth", "minHeight", "maxWidth", "maxHeight"], (u) => {
        const _ = e.get(u);
        t.style[u] = _ ? _ + "px" : "";
      });
      const i = e.compositeScale() || 1, r = e.compositeRotation() || 0;
      t.style.transform = "", t.style.transformOrigin = "";
      const a = e.compositeOpacity();
      setTimeout(() => {
        t.style.opacity = a + "";
      }, 10);
      const s = e.isVisibleDeep();
      s && (t.style.display = "block");
      let n = { x: e.x(), y: e.y() };
      e.parent && (n = e.parent.toGlobal(n)), t.style.top = n.y + "px", t.style.left = n.x + "px";
      const l = e.get("width"), d = e.get("height");
      let m = 0, c = 0;
      if (l && (m = e.width()), d && (c = e.height()), !l || !d) {
        t.style.position = "fixed", t.style.width = "", t.style.height = "";
        const u = t.getBoundingClientRect();
        t.style.position = "absolute", l || (m = u.width), d || (c = u.height);
        let _ = m / i, w = c / i, v = e.get("centerX", 0), g = e.get("centerY", 0), x = 0, k = 0, O = 0, M = 0;
        v instanceof ye ? (x = -v.value * _, k = (1 - v.value) * _) : (x = -v, k = _ - v), g instanceof ye ? (O = -g.value * w, M = (1 - g.value) * w) : (O = -g, M = w - g), e._localBounds = { left: x, right: k, top: O, bottom: M };
        let E = e._adjustedLocalBounds, P = e._display.getAdjustedBounds(e._localBounds);
        e._adjustedLocalBounds = P, E.left === P.left && E.right === P.right && E.top === P.top && E.bottom === P.bottom || e.markDirtyBounds();
      }
      m > 0 && (t.style.minWidth = m + "px"), c > 0 && (t.style.minHeight = c + "px"), s && a != 0 || (t.style.display = "none");
      const f = e.get("centerX", 0), o = He(f) ? f.percent + "%" : f + "px", p = e.get("centerY", 0), h = He(p) ? p.percent + "%" : p + "px";
      (f || p) && (t.style.transform = "translate(-" + o + ", -" + h + ")" + t.style.transform), i != 1 && (t.style.transform += "scale(" + i + ")"), r != 0 && (t.style.transform += " rotate(" + r + "deg)"), t.style.transform != "" && (t.style.transformOrigin = o + " " + h);
    }
  }
  _setHTMLContent(e, t) {
...
function Di(b) {
  return b ? ze.has(b.toLowerCase()) ? b.toLowerCase() : Ci(b) || Qe : Qe;
}
async function Yi(b, e = ht()) {
  const t = Le.new(b);
  return t.locale = (await ze.get(Di(e))()).default, t;
}
export {
  Yi as createRoot
};
//# sourceMappingURL=chartUtilsAm5-CHjay-f2.js.map
