import { z as ro, fz as Nr } from "./main-DZxT3i7S.js";
var Se, $e = { exports: {} };
function eo() {
  return Se || (Se = 1, Br = $e, br = typeof document < "u" && document.currentScript ? document.currentScript.src : void 0, Lr = function(Ur = {}) {
    var Hr, cr, l = Ur;
    l.ready = new Promise((r, e) => {
      Hr = r, cr = e;
    });
    var kr, Ir, Vr = Object.assign({}, l), Yr = "./this.program", qr = (r, e) => {
      throw e;
    }, Te = !0, V = "";
    function Ce(r) {
      return l.locateFile ? l.locateFile(r, V) : V + r;
    }
    typeof document < "u" && document.currentScript && (V = document.currentScript.src), br && (V = br), V = V.indexOf("blob:") !== 0 ? V.substr(0, V.replace(/[?#].*/, "").lastIndexOf("/") + 1) : "", kr = (r) => {
    ...
    var or, fr, Xr = l.print || console.log.bind(console), Y = l.printErr || console.error.bind(console);
    Object.assign(l, Vr), Vr = null, l.arguments && l.arguments, l.thisProgram && (Yr = l.thisProgram), l.quit && (qr = l.quit), l.wasmBinary && (or = l.wasmBinary), typeof WebAssembly != "object" && Q("no native wasm support detected");
    var P, C, q, mr, y, w, Gr, Jr, Fr = !1;
    function Zr(r, e) {
      r || Q(e);
    }
    function Kr() {
      var r = fr.buffer;
      l.HEAP8 = P = new Int8Array(r), l.HEAP16 = q = new Int16Array(r), l.HEAPU8 = C = new Uint8Array(r), l.HEAPU16 = mr = new Uint16Array(r), l.HEAP32 = y = new Int32Array(r), l.HEAPU32 = w = new Uint32Array(r), l.HEAPF32 = Gr = new Float32Array(r), l.HEAPF64 = Jr = new Float64Array(r);
    }
    var Qr = [], re = [], ee = [];
    function Me() {
      if (l.preRun) for (typeof l.preRun == "function" && (l.preRun = [l.preRun]); l.preRun.length; ) Oe(l.preRun.shift());
      Ar(Qr);
    }
    function je() {
      l.noFSInit || o.init.initialized || o.init(), o.ignorePermissions = !1, Ar(re);
    }
    function xe() {
      if (l.postRun) for (typeof l.postRun == "function" && (l.postRun = [l.postRun]); l.postRun.length; ) ze(l.postRun.shift());
      Ar(ee);
    }
    function Oe(r) {
      Qr.unshift(r);
    ...
    function Q(r) {
      l.onAbort && l.onAbort(r), Y(r = "Aborted(" + r + ")"), Fr = !0, r += ". Build with -sASSERTIONS for more info.";
      var e = new WebAssembly.RuntimeError(r);
      throw cr(e), e;
    }
    var sr, E, S, We = "data:application/octet-stream;base64,", te = (r) => r.startsWith(We);
    function ne(r) {
      if (r == sr && or) return new Uint8Array(or);
      throw "both async and sync fetching of the wasm failed";
    }
    function Ne(r) {
      return !or && Te && typeof fetch == "function" ? fetch(r, { credentials: "same-origin" }).then((e) => {
        if (!e.ok) throw "failed to load wasm binary file at '" + r + "'";
        return e.arrayBuffer();
      }).catch(() => ne(r)) : Promise.resolve().then(() => ne(r));
    }
    function oe(r, e, t) {
      return Ne(r).then((n) => WebAssembly.instantiate(n, e)).then((n) => n).then(t, (n) => {
        Y(`failed to asynchronously prepare wasm: ${n}`), Q(n);
      });
    }
    function Be(r, e, t, n) {
      return r || typeof WebAssembly.instantiateStreaming != "function" || te(e) || typeof fetch != "function" ? oe(e, t, n) : fetch(e, { credentials: "same-origin" }).then((a) => WebAssembly.instantiateStreaming(a, t).then(n, function(i) {
        return Y(`wasm streaming compile failed: ${i}`), Y("falling back to ArrayBuffer instantiation"), oe(e, t, n);
      }));
    }
    function Le() {
      var r = { a: Un };
      function e(n, a) {
        return A = n.exports, fr = A._, Kr(), K = A.aa, Re(A.$), ir(), A;
      }
      function t(n) {
        e(n.instance);
      }
    ...
    function Ie(r) {
      this.excPtr = r, this.ptr = r - 24, this.set_type = function(e) {
        ...
        if (De(this.get_type())) return w[this.excPtr >> 2];
        var e = this.get_adjusted_ptr();
        return e !== 0 ? e : this.excPtr;
      };
    }
    var Ve = (r, e, t) => {
      throw new Ie(r).init(e, t), r;
    }, Ye = (r) => (y[Fe() >> 2] = r, r), b = { isAbs: (r) => r.charAt(0) === "/", splitPath: (r) => /^(\/?|)([\s\S]*?)((?:\.{1,2}|[^\/]+?|)(\.[^.\/]*|))(?:[\/]*)$/.exec(r).slice(1), normalizeArray: (r, e) => {
    ...
    } }, ie = typeof TextDecoder < "u" ? new TextDecoder("utf8") : void 0, rr = (r, e, t) => {
      for (var n = e + t, a = e; r[a] && !(a >= n); ) ++a;
      if (a - e > 16 && r.buffer && ie) return ie.decode(r.subarray(e, a));
      for (var i = ""; e < a; ) {
        var s = r[e++];
        if (128 & s) {
          var u = 63 & r[e++];
    ...
    function $r(r, e, t) {
      var n = Pr(r) + 1, a = new Array(n), i = Sr(r, a, 0, a.length);
...
`), !r) return null;
    ...
    } }, default_tty_ops: { get_char: (r) => Xe(), put_char(r, e) {
      e === null || e === 10 ? (Xr(rr(r.output, 0)), r.output = []) : e != 0 && r.output.push(e);
    }, fsync(r) {
      r.output && r.output.length > 0 && (Xr(rr(r.output, 0)), r.output = []);
      ...
      if (2 & a || u.buffer !== P.buffer) {
        if ((t > 0 || t + e < u.length) && (u = u.subarray ? u.subarray(t, t + e) : Array.prototype.slice.call(u, t, t + e)), s = !0, !(i = se())) throw new o.ErrnoError(48);
        P.set(u, i);
      } else s = !1, i = u.byteOffset;
      return { ptr: i, allocated: s };
    }, msync: (r, e, t, n, a) => (g.stream_ops.write(r, e, 0, n, t, !1), 0) } }, Ge = (r, e, t, n) => {
      var a = `al ${r}`;
      Ir(r, (i) => {
        Zr(i, `Loading data file "${r}" failed (no arrayBuffer).`), e(new Uint8Array(i)), a && ir();
      }, (i) => {
        if (!t) throw `Loading data file "${r}" failed.`;
        t();
      }), a && hr();
    }, Je = (r, e, t, n, a, i) => o.createDataFile(r, e, t, n, a, i), Ze = l.preloadPlugins || [], Ke = (r, e, t, n) => {
      typeof Browser < "u" && Browser.init();
      var a = !1;
      return Ze.forEach((i) => {
        a || i.canHandle(e) && (i.handle(r, e, t, n), a = !0);
      }), a;
    }, Qe = (r, e, t, n, a, i, s, u, d, c) => {
      var m = e ? L.resolve(b.join2(r, e)) : r;
      function h(p) {
        function _(k) {
          c && c(), u || Je(r, e, k, n, a, d), i && i(), ir();
        }
        Ke(p, m, _, () => {
          s && s(), ir();
        }) || _(p);
      }
      hr(), typeof t == "string" ? Ge(t, (p) => h(p), s) : h(t);
    }, rt = (r) => {
      ...
      var n;
      if (t = t === void 0 ? 438 : t, t = 64 & (e = typeof e == "string" ? rt(e) : e) ? 4095 & t | 32768 : 0, typeof r == "object") n = r;
      else {
        r = b.normalize(r);
        try {
      ...
      if (typeof e == "string") {
        var a = new Uint8Array(Pr(e) + 1), i = Sr(e, a, 0, a.length);
      ...
      var r = new Uint8Array(1024), e = 0, t = () => (e === 0 && (e = ae(r).byteLength), r[--e]);
      ...
      var i = b.join2(typeof r == "string" ? r : o.getPath(r), e), s = Tr(n, a);
      return o.create(i, s);
    }, createDataFile(r, e, t, n, a, i) {
      var s = e;
      r && (r = typeof r == "string" ? r : o.getPath(r), s = e ? b.join2(r, e) : r);
      var u = Tr(n, a), d = o.create(s, u);
      if (t) {
        if (typeof t == "string") {
      ...
      var a = b.join2(typeof r == "string" ? r : o.getPath(r), e), i = Tr(!!t, !!n);
      ...
      if (!kr) throw new Error("Cannot load without read() or XMLHttpRequest.");
      try {
        r.contents = $r(kr(r.url), !0), r.usedBytes = r.contents.length;
      } catch {
        throw new o.ErrnoError(29);
      }
    ...
    var ue, le, de, tr = {}, Z = {}, vr = {}, ce = (r) => {
      throw new ue(r);
    }, fe = (r, e, t) => {
      function n(u) {
        var d = t(u);
        d.length !== r.length && ce("Mismatched type converter count");
      ...
      fe([r], i, (s) => {
        ...
        }, argPackAdvance: X, readValueFromPointer: Mr, destructorFunction: n }];
      });
    }, at = (r, e, t, n, a) => {
    }, it = () => {
    ...
    function lt() {
      Object.assign(me.prototype, { get(r) {
    ...
    var z = new me(), jr = (r) => {
      ...
      for (var r = 0, e = z.reserved; e < z.allocated.length; ++e) z.allocated[e] !== void 0 && ++r;
      return r;
    }, ct = () => {
      z.allocated.push({ value: void 0 }, { value: null }, { value: !0 }, { value: !1 }), z.reserved = z.allocated.length, l.count_emval_handles = dt;
    }, $ = { toValue: (r) => (r || O("Cannot use deleted val. handle = " + r), z.get(r).value), toHandle: (r) => {
      switch (r) {
        case void 0:
          return 1;
        case null:
      ...
      U(r, { name: e = M(e), fromWireType: (t) => {
        var n = $.toValue(t);
        return jr(t), n;
      }, toWireType: (t, n) => $.toHandle(n), argPackAdvance: X, readValueFromPointer: Mr, destructorFunction: null });
    }, mt = (r, e) => {
      switch (e) {
        case 4:
          return function(t) {
            return this.fromWireType(Gr[t >> 2]);
          };
        case 8:
          return function(t) {
            return this.fromWireType(Jr[t >> 3]);
          };
        default:
          throw new TypeError(`invalid float width (${e}): ${r}`);
      }
    }, ht = (r, e, t) => {
      U(r, { name: e = M(e), fromWireType: (n) => n, toWireType: (n, a) => a, argPackAdvance: X, readValueFromPointer: mt(e, t), destructorFunction: null });
    }, pt = 48, vt = 57, yt = (r) => {
      if (r === void 0) return "_unknown";
      var e = (r = r.replace(/[^a-zA-Z0-9_]/g, "$")).charCodeAt(0);
      return e >= pt && e <= vt ? `_${r}` : r;
    };
    function gt(r, e, t, n, a, i) {
      var s = e.length;
    ...
    var K, wt = (r, e, t) => {
      ...
      l.hasOwnProperty(r) ? ((t === void 0 || l[r].overloadTable !== void 0 && l[r].overloadTable[t] !== void 0) && O(`Cannot register public name '${r}' twice`), wt(l, r, r), l.hasOwnProperty(t) && O(`Cannot register multiple overloads of a function with the same number of arguments (${t})!`), l[r].overloadTable[t] = e) : (l[r] = e, t !== void 0 && (l[r].numArguments = t));
    }, Et = (r, e) => {
      for (var t = [], n = 0; n < r; n++) t.push(w[e + 4 * n >> 2]);
      return t;
    }, bt = (r, e, t) => {
      l.hasOwnProperty(r) || ce("Replacing nonexistant public symbol"), l[r].overloadTable !== void 0 && t !== void 0 ? l[r].overloadTable[t] = e : (l[r] = e, l[r].argCount = t);
    }, kt = (r, e, t) => {
      var n = l["dynCall_" + r];
    ...
    }, Ft = (r, e, t) => r.includes("j") ? kt(r, e, t) : R(e).apply(null, t), At = (r, e) => {
      var t = [];
      return function() {
        return t.length = 0, Object.assign(t, arguments), Ft(r, e, t);
      };
    }, lr = (r, e) => {
      function t() {
        return r.includes("j") ? At(r, e) : R(e);
      }
      r = M(r);
      var n = t();
    ...
    function Dt(r, e) {
      return r = yt(r), { [r]: function() {
        return e.apply(this, arguments);
      } }[r];
    }
    var he, Pt = (r, e) => {
      var t = Dt(e, function(n) {
...
` + a.replace(/^Error(:[^\n]*)?\n/, ""));
      ...
      throw e.forEach(a), new he(`${r}: ` + t.map(pe).join([", "]));
    }, $t = (r) => {
      const e = (r = r.trim()).indexOf("(");
      return e !== -1 ? (Zr(r[r.length - 1] == ")", "Parentheses for argument names should match."), r.substr(0, e)) : r;
    }, Tt = (r, e, t, n, a, i, s) => {
      var u = Et(e, t);
      r = M(r), r = $t(r), a = lr(n, a), _t(r, function() {
        St(`Cannot call ${r} due to unbound types`, u);
      }, e - 1), fe([], u, function(d) {
        var c = [d[0], null].concat(d.slice(1));
        return bt(r, gt(r, c, null, a, i), e - 1), [];
      });
    }, Ct = (r, e, t) => {
      switch (e) {
        case 1:
      ...
      }, argPackAdvance: X, readValueFromPointer: Ct(e, t, n !== 0), destructorFunction: null });
    }, jt = (r, e, t) => {
    ...
    var Ot = (r, e, t) => Sr(r, C, e, t), Rt = (r, e) => {
      ...
      U(r, { name: e, fromWireType(n) {
        ...
        s || a instanceof Uint8Array || a instanceof Uint8ClampedArray || a instanceof Int8Array || O("Cannot pass non-string to std::string"), i = t && s ? Pr(a) : a.length;
        var u = Wr(4 + i + 1), d = u + 4;
        if (w[u >> 2] = i, t && s) Ot(a, d, i + 1);
      ...
      }, argPackAdvance: X, readValueFromPointer: xt, destructorFunction(n) {
        H(n);
      } });
    }, ve = typeof TextDecoder < "u" ? new TextDecoder("utf-16le") : void 0, zt = (r, e) => {
      for (var t = r, n = t >> 1, a = n + e / 2; !(n >= a) && mr[n]; ) ++n;
      if ((t = n << 1) - r > 32 && ve) return ve.decode(C.subarray(r, t));
      ...
      var n, a, i, s, u;
      t = M(t), e === 2 ? (n = zt, a = Wt, s = Nt, i = () => mr, u = 1) : e === 4 && (n = Bt, a = Lt, s = Ut, i = () => w, u = 2), U(r, { name: t, fromWireType: (d) => {
      ...
      }, argPackAdvance: X, readValueFromPointer: Mr, destructorFunction(d) {
        H(d);
      } });
    }, It = (r, e, t, n, a, i) => {
      pr[r] = { name: M(e), rawConstructor: lr(t, n), rawDestructor: lr(a, i), fields: [] };
    }, Vt = (r, e, t, n, a, i, s, u, d, c) => {
      ...
      var t = Z[r];
      return t === void 0 && O(e + " has unknown type " + pe(r)), t;
    }, Gt = (r, e, t) => {
      r = $.toValue(r), e = xr(e, "emval::as");
      var n = [], a = $.toHandle(n);
      ...
      var i = [], s = (r = Rr[r])(e = $.toValue(e), t = Or(t), i, a);
      ...
      if (typeof $$$embind_global$$$ == "object" || (typeof Nr == "object" && r(Nr) ? $$$embind_global$$$ = Nr : typeof self == "object" && r(self) && ($$$embind_global$$$ = self), typeof $$$embind_global$$$ == "object")) return $$$embind_global$$$;
      throw Error("unable to get global object.");
    }, Kt = (r) => r === 0 ? $.toHandle(ye()) : (r = Or(r), $.toHandle(ye()[r])), Qt = (r) => {
      var e = Rr.length;
      return Rr.push(r), e;
    }, rn = (r, e) => {
      for (var t = new Array(r), n = 0; n < r; ++n) t[n] = xr(w[e + 4 * n >> 2], "parameter " + n);
      return t;
    }, en = (r, e) => {
      var t = rn(r, e), n = t.shift();
      r--;
      var a = new Array(r);
      return Qt((i, s, u, d) => {
    ...
    }, tn = (r, e) => (r = $.toValue(r), e = $.toValue(e), $.toHandle(r[e])), nn = (r) => {
      r > 4 && (z.get(r).refcount += 1);
    }, on = () => $.toHandle([]), an = (r) => $.toHandle(Or(r)), sn = (r) => {
      var e = $.toValue(r);
      Cr(e), jr(r);
    }, un = (r, e, t) => {
      r = $.toValue(r), e = $.toValue(e), t = $.toValue(t), r[e] = t;
    }, ln = (r, e) => {
      var t = (r = xr(r, "_emval_take_value")).readValueFromPointer(e);
      return $.toHandle(t);
    }, dn = () => {
      Q("");
    }, cn = (r, e, t) => C.copyWithin(r, e, e + t), fn = () => 2147483648, mn = (r) => {
      var e = (r - fr.buffer.byteLength + 65535) / 65536;
      try {
        return fr.grow(e), Kr(), 1;
      } catch {
      }
    }, hn = (r) => {
      var e = C.length;
      ...
      return !1;
    }, zr = {}, pn = () => Yr || "./this.program", dr = () => {
      if (!dr.strings) {
        var r = { USER: "web_user", LOGNAME: "web_user", PATH: "/", PWD: "/", HOME: "/home/web_user", LANG: (typeof navigator == "object" && navigator.languages && navigator.languages[0] || "C").replace("-", "_") + ".UTF-8", _: pn() };
        for (var e in zr) zr[e] === void 0 ? delete r[e] : r[e] = zr[e];
        var t = [];
      ...
      return dr().forEach((n, a) => {
        var i = e + t;
        w[r + 4 * a >> 2] = i, vn(n, i), t += n.length + 1;
      }), 0;
    }, gn = (r, e) => {
      var t = dr();
      w[r >> 2] = t.length;
    ...
    }, wn = 0, _n = () => He || wn > 0, En = (r) => {
      _n() || (l.onExit && l.onExit(r), Fr = !0), qr(r, new Ue(r));
    }, bn = (r, e) => {
      En(r);
    };
    function kn(r) {
    ...
    function An(r, e, t, n) {
      try {
        var a = F.getStreamFromFD(r), i = Fn(a, e, t);
        return w[n >> 2] = i, 0;
      } catch (s) {
    ...
    var Dn = (r, e) => e + 2097152 >>> 0 < 4194305 - !!r ? (r >>> 0) + 4294967296 * e : NaN;
    ...
    function $n(r, e, t, n) {
      try {
        var a = F.getStreamFromFD(r), i = Sn(a, e, t);
        return w[n >> 2] = i, 0;
      } catch (s) {
        if (o === void 0 || s.name !== "ErrnoError") throw s;
        return s.errno;
    ...
    var nr, yr = (r) => r % 4 == 0 && (r % 100 != 0 || r % 400 == 0), Tn = (r, e) => {
      for (var t = 0, n = 0; n <= e; t += r[n++]) ;
      return t;
    }, ge = [31, 29, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31], we = [31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31], Cn = (r, e) => {
      for (var t = new Date(r.getTime()); e > 0; ) {
        var n = yr(t.getFullYear()), a = t.getMonth(), i = (n ? ge : we)[a];
      ...
      function T(f) {
        var v = Cn(new Date(f.tm_year + 1900, 0, 1), f.tm_yday), j = new Date(v.getFullYear(), 0, 4), x = new Date(v.getFullYear() + 1, 0, 4), Er = k(j), Qn = k(x);
        return _(Er, v) <= 0 ? _(Qn, v) <= 0 ? v.getFullYear() + 1 : v.getFullYear() : v.getFullYear() - 1;
      }
      ...
      }, "%j": (f) => p(f.tm_mday + Tn(yr(f.tm_year + 1900) ? ge : we, f.tm_mon - 1), 3), "%m": (f) => p(f.tm_mon + 1, 2), "%M": (f) => p(f.tm_min, 2), "%n": () => `
`, "%p": (f) => f.tm_hour >= 0 && f.tm_hour < 12 ? "AM" : "PM", "%S": (f) => p(f.tm_sec, 2), "%t": () => "	", "%u": (f) => f.tm_wday || 7, "%U": (f) => {
      ...
      var I = $r(s = s.replace(/\0\0/g, "%"), !1);
      return I.length > e ? 0 : (Mn(I, r), I.length - 1);
    }, xn = (r, e, t, n, a) => jn(r, e, t, n), _e = (r, e) => {
      ...
      e.push(96), _e(n.length, e);
      for (var i = 0; i < n.length; ++i) e.push(a[n[i]]);
      t == "v" ? e.push(0) : e.push(1, a[t]);
    }, zn = (r, e) => {
      if (typeof WebAssembly.Function == "function") return new WebAssembly.Function(On(e), r);
      var t = [1];
      Rn(e, t);
      var n = [0, 97, 115, 109, 1, 0, 0, 0, 1];
      _e(t.length, n), n.push.apply(n, t), n.push(2, 7, 1, 1, 101, 1, 102, 0, 0, 7, 5, 1, 1, 102, 0, 0);
    ...
    }, Nn = (r) => (nr || (nr = /* @__PURE__ */ new WeakMap(), Wn(0, K.length)), nr.get(r) || 0), Ee = [], Bn = () => {
    ...
    Object.defineProperties(ke.prototype, { read: { get: function() {
    ...
    } } }), o.FSNode = ke, o.createPreloadedFile = Qe, o.staticInit(), l.FS_createPath = o.createPath, l.FS_createDataFile = o.createDataFile, l.FS_createPreloadedFile = o.createPreloadedFile, l.FS_unlink = o.unlink, l.FS_createLazyFile = o.createLazyFile, l.FS_createDevice = o.createDevice, ue = l.InternalError = class extends Error {
      constructor(r) {
        super(r), this.name = "InternalError";
      }
    }, it(), de = l.BindingError = class extends Error {
      constructor(r) {
        super(r), this.name = "BindingError";
      }
    }, lt(), ct(), he = l.UnboundTypeError = Pt(Error, "UnboundTypeError");
    var Un = { i: Ve, x: et, N: tt, O: nt, V: ot, G: at, R: ut, Q: ft, z: ht, r: Tt, c: Mt, b: jt, y: Rt, p: Ht, W: It, k: Vt, S: Yt, U: qt, I: Xt, Y: Gt, A: Zt, a: jr, Z: Kt, B: en, m: tn, g: nn, C: on, h: an, s: sn, X: un, l: ln, q: dn, P: cn, J: hn, K: yn, L: gn, T: bn, v: kn, M: An, F: Pn, w: $n, n: Hn, j: Yn, o: Xn, t: Gn, E: Zn, u: qn, d: In, D: Kn, e: Jn, f: Vn, H: xn }, A = Le(), H = l._free = (r) => (H = l._free = A.ba)(r), Wr = l._malloc = (r) => (Wr = l._malloc = A.ca)(r), Fe = () => (Fe = A.da)(), Ae = (r) => (Ae = A.ea)(r);
    l.__embind_initialize_bindings = () => (l.__embind_initialize_bindings = A.fa)();
    var _r, W = (r, e) => (W = A.ga)(r, e), N = () => (N = A.ha)(), B = (r) => (B = A.ia)(r), De = (r) => (De = A.ja)(r);
    function Hn(r, e) {
      var t = N();
      try {
        return R(r)(e);
    ...
    function Zn(r, e, t, n, a, i, s, u, d, c) {
      var m = N();
      try {
