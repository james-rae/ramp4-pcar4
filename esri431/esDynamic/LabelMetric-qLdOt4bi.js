import { s as T, cS as f, G as N, ni as U, cQ as Y, cV as L, gG as B, nj as P, b6 as R, aH as h } from "./main-DZxT3i7S.js";
import "./Program-7tJi4ey9.js";
import { t as k } from "./VertexElementDescriptor-BAy1DPb3.js";
let y = class p {
  ...
  clone() {
    return new p(this.instanceId, this.textureKey, this.indexStart, this.indexCount, this.vertexStart, this.vertexCount, this.overlaps);
  }
...
let H = class M {
  ...
  static deserialize(t) {
    const e = t.readInt32(), n = t.readF32(), s = new M(e, n);
    return s.records = S(t, y) ?? [], s;
  }
};
H.byteSizeHint = 2 * Uint32Array.BYTES_PER_ELEMENT + y.byteSizeHint;
const x = () => N.getLogger("esri.views.2d.engine.webgl.Utils");
function q(r) {
  switch (r) {
    case f.UNSIGNED_BYTE:
      return 1;
    case f.UNSIGNED_SHORT_4_4_4_4:
      return 2;
    case f.FLOAT:
      return 4;
    default:
      return void x().error(new T("webgl-utils", `Unable to handle type ${r}`));
  }
}
function V(r) {
  switch (r) {
...
function C(r) {
  ...
  for (const e in r) {
    ...
    let s = 0;
    t.set(e, n.map((i) => {
      const a = new k(i.name, i.count, i.type, s, 0, i.normalized || !1);
      return s += i.count * U(i.type), a;
    })), t.get(e).forEach((i) => i.stride = s);
  }
  return t;
}
const v = (r) => {
  ...
  const t = {};
  return r.forEach((e, n) => t[n] = e?.length ? e[0].stride : 0), t;
}, d = /* @__PURE__ */ new Map(), Q = (r, t) => {
  if (!d.has(r)) {
    const e = C(t), n = { strides: z(e), bufferLayouts: e, attributes: v(t) };
    d.set(r, n);
  }
  return d.get(r);
}, $ = (r) => r.includes("data:image/svg+xml");
function J(r) {
  const t = [];
...
class l {
  constructor(t, e, n, s) {
    this.transformedX = 0, this.transformedY = 0, this.center = B(t, e), this.centerT = P(), this.halfWidth = n / 2, this.halfHeight = s / 2, this.width = n, this.height = s;
  }
  get x() {
  ...
  static deserialize(t) {
    ...
    return new l(e, n, s, i);
  }
}
const w = new Float32Array(1), O = new Uint32Array(w.buffer);
function G(r) {
  return w[0] = r, O[0];
}
function et(r, t) {
...
function m(r) {
  ...
  return n -= 127, n > 15 ? e << 15 | 31744 : n < -25 ? 0 : (n < -14 && (s += 8388608, s /= 2 ** (-14 - n), n = -15), n += 15, s /= 8192, s = D(s, 1023), e << 15 | n << 10 | s);
}
function D(r, t) {
...
function u(r, t, e, n, s, i, a) {
  if (r.primitiveName === t) {
    let o = n?.readWithDefault(s, i, r[e] && a);
    return r.type === "text" && (o = o.toString()), void (r[e] = o);
  }
  if ("type" in r && r.type != null) {
    if (r.effects) for (const o of r.effects) u(o, t, e, n, s, i, a);
    switch (r.type) {
      case "CIMPointSymbol":
      case "CIMLineSymbol":
      case "CIMPolygonSymbol":
        if (r.symbolLayers) for (const o of r.symbolLayers) u(o, t, e, n, s, i, a);
        break;
      case "CIMTextSymbol":
        r.symbol && u(r.symbol, t, e, n, s, i, a);
        break;
      case "CIMHatchFill":
        r.lineSymbol && u(r.lineSymbol, t, e, n, s, i, a);
        break;
      case "CIMPictureMarker":
      case "CIMCharacterMarker":
      case "CIMVectorMarker":
        if (r.markerPlacement && u(r.markerPlacement, t, e, n, s, i, a), r.type === "CIMVectorMarker" && r.markerGraphics) for (const o of r.markerGraphics) u(o, t, e, n, s, i, a), u(o.symbol, t, e, n, s, i, a);
    }
  }
}
const W = 400;
...
function it(r, t, e) {
  switch (t.type) {
    ...
    case h.HALF_FLOAT: {
      if (t.count === 1) return g(r.getUint16(e + t.offset, !0));
      const n = [];
      for (let s = 0; s < t.count; s++) {
        const i = s * Uint16Array.BYTES_PER_ELEMENT;
        n.push(g(r.getUint16(e + t.offset + i, !0)));
      }
      return n;
    }
  }
...
class F {
  constructor(t, e, n, s, i, a, o, c, E = []) {
    this.entityTexel = t, this.anchorX = e, this.anchorY = n, this.directionX = s, this.directionY = i, this.maxScale = a, this.minScale = o, this.referenceBounds = c, this.bounds = E;
  }
  serialize(t) {
  ...
  static deserialize(t) {
    const e = t.readInt32(), n = t.readF32(), s = t.readF32(), i = t.readF32(), a = t.readF32(), o = t.readF32(), c = t.readF32(), E = t.readF32(), _ = t.readF32(), b = t.readF32(), A = S(t, l) ?? [];
    return new F(e, n, s, i, a, o, c, { size: E, offsetX: _, offsetY: b }, A);
  }
}
export {
  J as A,
...
//# sourceMappingURL=LabelMetric-qLdOt4bi.js.map
