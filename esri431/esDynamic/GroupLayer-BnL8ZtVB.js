import { ex as u, eB as c, ez as v, eA as m, hB as f, hC as w, eC as g, d6 as I, hD as _, fv as L, cz as h, f7 as S, hE as O, S as $, B as A, hF as V, hG as d, hH as M, bQ as r, bR as l, f9 as p, eD as C, hI as E, cw as P, f6 as b, bS as x, eM as G, G as T } from "./main-DZxT3i7S.js";
import { a as H } from "./fetchService-BbX6Wqej.js";
import { r as R } from "./saveUtils-GXJ71Xww.js";
const j = Symbol("WebScene");
let s = class extends u(c(v(m(f(w(g(G))))))) {
  constructor(e) {
    super(e), this.allLayers = new I({ getCollections: () => [this.layers], getChildrenFunction: (i) => "layers" in i ? i.layers : null }), this.allTables = _(this), this.fullExtent = void 0, this.operationalLayerType = "GroupLayer", this.spatialReference = void 0, this.type = "group", this._debouncedSaveOperations = L(async (i, t, a) => {
      const { save: o, saveAs: n } = await import("./groupLayerUtils-BZH9j2Nq.js");
      switch (i) {
        case d.SAVE:
          return o(this, t);
        case d.SAVE_AS:
  ...
  initialize() {
    this._enforceVisibility(this.visibilityMode, this.visible), this.addHandles([h(() => {
      let e = this.parent;
      for (; e && "parent" in e && e.parent; ) e = e.parent;
      return e && j in e;
    }, (e) => {
      const i = "prevent-adding-tables";
      this.removeHandles(i), e && (this.tables.removeAll(), this.addHandles(P(() => this.tables, "before-add", (t) => {
    ...
    }, E), h(() => this.visible, this._onVisibilityChange.bind(this), b)]);
  }
  destroy() {
    this.allLayers.destroy(), this.allTables.destroy();
  }
  get sourceIsPortalItem() {
    return this.portalItem && this.originIdOf("portalItem") === S.USER;
  }
  _writeLayers(e, i, t, a) {
    const o = [];
    if (!e) return o;
    e.forEach((n) => {
      const y = O(n, a.webmap ? a.webmap.getLayerJSONFromResourceInfo(n) : null, a);
      y?.layerType && o.push(y);
    }), i.layers = o;
  }
  set portalItem(e) {
  ...
  load(e) {
    const i = this.loadFromPortal({ supportedTypes: ["Feature Service", "Feature Collection", "Group Layer", "Scene Service"], layerModuleTypeMap: H }, e).catch((t) => {
  ...
  layerAdded(e) {
    e.visible && this.visibilityMode === "exclusive" ? this._turnOffOtherLayers(e) : this.visibilityMode === "inherited" && (e.visible = this.visible), this.hasHandles(e.uid) ? console.error(`Layer read to Grouplayer: uid=${e.uid}`) : this.addHandles(h(() => e.visible, (i) => this._onChildVisibilityChange(e, i), b), e.uid);
  }
  layerRemoved(e) {
...
//# sourceMappingURL=GroupLayer-BnL8ZtVB.js.map
