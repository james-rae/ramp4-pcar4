import { dg as E, dh as v, fk as i, dc as t, di as B } from "./main-DZxT3i7S.js";
import { g as I } from "./dom-N58V0tYi.js";
import { u as L, I as S } from "./interactive-B_Y0ed_t.js";
import { s as F, a as P, c as T } from "./loadable-BekOWxtq.js";
import { c as x, d as A } from "./locale-B98iGxBG.js";
import { c as M, s as O, d as $, u as D } from "./t9n-DqBq_VHu.js";
import { d as z, S as o } from "./panel-C3Bu-FR5.js";
import { d as R } from "./action-R6b2qHuP.js";
import { d as H, a as _ } from "./action-menu-BGcrUrL7.js";
import { d as U } from "./icon-BnVuD4FT.js";
import { d as W } from "./loader-BOJ3YuGs.js";
import { d as j } from "./scrim-E0qBQm7D.js";
const q = {
...
}, G = ":host{box-sizing:border-box;background-color:var(--calcite-color-foreground-1);color:var(--calcite-color-text-2);font-size:var(--calcite-font-size--1)}:host *{box-sizing:border-box}:host([disabled]){cursor:default;-webkit-user-select:none;user-select:none;opacity:var(--calcite-opacity-disabled)}:host([disabled]) *,:host([disabled]) ::slotted(*){pointer-events:none}:host{position:relative;display:flex;inline-size:100%;flex:1 1 auto;overflow:hidden}:host([disabled]) ::slotted([calcite-hydrated][disabled]),:host([disabled]) [calcite-hydrated][disabled]{opacity:1}.interaction-container{display:contents}.back-button{border-width:0px;border-style:solid;border-color:var(--calcite-color-border-3);border-inline-end-width:1px}calcite-panel{--calcite-panel-footer-padding:var(--calcite-flow-item-footer-padding);--calcite-panel-header-border-block-end:var(--calcite-flow-item-header-border-block-end)}:host([hidden]){display:none}[hidden]{display:none}", J = G, h = /* @__PURE__ */ E(class extends v {
  constructor() {
    super(), this.__registerHost(), this.__attachShadow(), this.calciteFlowItemBack = i(this, "calciteFlowItemBack", 7), this.calciteFlowItemScroll = i(this, "calciteFlowItemScroll", 6), this.calciteFlowItemClose = i(this, "calciteFlowItemClose", 6), this.calciteFlowItemToggle = i(this, "calciteFlowItemToggle", 6), this.handleInternalPanelScroll = (e) => {
  ...
  async setFocus() {
    await T(this);
    const { backButtonEl: e, containerEl: s } = this;
    if (e)
      return e.setFocus();
    if (s)
      return s.setFocus();
...
const ne = h, ie = b;
export {
  ne as CalciteFlowItem,
  ie as defineCustomElement
};
//# sourceMappingURL=calcite-flow-item-BYxZFtTs.js.map
