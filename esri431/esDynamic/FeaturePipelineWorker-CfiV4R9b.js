import { s1 as et, cv as tt, ls as T, oq as Yt, ds as st, c$ as rt, du as Qs, lx as Hs, b4 as Zs, aA as Js, dG as ve, b1 as L, lN as Qt, dx as M, eQ as ft, nD as yt, lr as J, s2 as Ks, s3 as er, s4 as tr, cJ as sr, s5 as rr, dH as ir, dI as nr, mP as Ht, dz as le, s6 as _e, s7 as ar, dD as or, dJ as Zt, dw as Q, ip as dr, Q as w, qS as ge, pD as Jt, gK as it, cE as Kt, J as K, fS as es, gQ as ur, fO as cr, fN as lr, bQ as H, bR as ye, bS as ts, ew as ss, cz as Ge, s8 as hr, s9 as _r, s as B, jS as gr, ok as pr, G as fr, sa as yr, mt as rs, kP as mt, sb as is, sc as mr, gO as ke, l8 as xe, l9 as br, g1 as wr, U as nt, ik as Ir, mQ as vr, mH as xr, mi as ns, b5 as Sr, gP as as, sd as bt, se as wt, mS as Fr, gN as kr, cq as Cr, dq as Tr, kC as Mr, sf as $r, X as qr } from "./main-DZxT3i7S.js";
import { a as It, d as Er, M as Ce, p as at, e as os, i as ot, s as Or, b as Rr, f as Ar, g as Pr } from "./AttributeStore-BzB5Tu2S.js";
import { r as jr, j as Dr } from "./MeshWriterRegistry-BFs_l7AV.js";
import { o as Lr } from "./optimizedFeatureQueryEngineAdapter-CaBWMkrQ.js";
import { V as ds } from "./QueryEngine-DVmSGTfj.js";
import { $ as vt } from "./ogcFeatureUtils-BFNgArIn.js";
import { t as xt } from "./CircularArray-DaQg3PQl.js";
import { createConnection as zr } from "./createConnection-BNha5Nca.js";
import { i as Ur } from "./UpdateTracking2D-0o9_i8fH.js";
let Wr = class {
  constructor(e) {
  ...
  onEvent(e) {
    et(this._eventLog.onEvent(e));
  }
};
const Te = 1, dt = 2, Me = 4, ut = 8, ct = 16, $e = 32, lt = 64, qe = 128;
function Pe(o) {
  switch (o) {
    case Te:
    case ut:
...
const St = Te | ut | $e, Ft = Me | ct | qe, kt = Te | dt | Me, Ct = $e | lt | qe;
let Gr = class {
  constructor(e, t, s, r, i = 0) {
    this.tileKey = e, this._bufferingEnabled = t, this._sizeHint = i, this._meshes = { self: new It(this.id, this._sizeHint), neighbors: new Array() }, this._currentRecordOverlaps = 0, this._currentEntityOverlaps = 0;
    const n = r ? 1 : 0;
    this._copyBufferedDataIntoSelf = s && this._bufferingEnabled && e.level === n;
  }
  get id() {
  ...
  serialize(e) {
    ...
    return t.message.push({ tileId: this.tileKey.id, ...s.message }), t.transferList.push(...s.transferList), this._meshes.neighbors.forEach((r, i) => {
      const n = r.serialize(), a = 1 << i, d = Pe(a), u = je(a), l = new tt(this.tileKey).getNormalizedNeighbor(d, u, e);
      t.message.push({ tileId: l.id, ...n.message }), t.transferList.push(...n.transferList);
    }), t;
  }
  _addOverlap(e, t, s, r) {
    const i = Math.min(T / 2, s), n = Math.min(T / 2, r), a = 255 ^ ((e < 0 + i ? Ft : e >= T - i ? St : Ft | St) | (t < 0 + n ? Ct : t >= T - n ? kt : Ct | kt));
    ...
    for (let e = 0; e < 8; e++) {
      ...
      if (this._currentRecordOverlaps & t) {
        ...
        if (!this._meshes.neighbors[e]) {
          ...
          this._meshes.neighbors[e] = new It(t, n);
        }
        const s = this._meshes.neighbors[e], r = -Pe(t) * T, i = -je(t) * T;
...
}, Vr = class ls extends V {
  constructor(e, t) {
    super(), this._intervals = [], this._isMaxInclusive = t, this._field = e;
  }
  static async fromIntervalSchema(e, t) {
    const s = await e.storage.createComputedField(t), r = new ls(s, t.isMaxInclusive);
    await Promise.all(t.intervals.map(async (a) => {
      const d = await e.createMeshWriters(a.meshes);
      r.add(a, d);
    }));
  ...
  doMatch(e, t) {
    ...
    for (let r = 0; r < this._intervals.length; r++) {
      const { interval: i, result: n } = this._intervals[r], a = s >= i.min, d = this._isMaxInclusive ? s <= i.max : s < i.max;
      if (a && d) return n;
    }
    return null;
  }
}, Xr = class hs extends V {
  ...
  static async fromMatcherSchema(e, t) {
    ...
    return i.setBackgroundFill(a), await Promise.all(t.map.map(async (d, u) => {
      const l = await e.createMeshWriters(d.symbol);
      d.value === "<Null>" ? i.setNullResult(l) : i.add(d.value, l, u + 1);
    })), i;
  }
  setNullResult(e) {
    this._nullResult = e;
...
async function ue(o, e) {
  switch (e.type) {
    ...
    case "pie-chart":
      return V.from(o, e);
    case "interval":
      return Vr.fromIntervalSchema(o, e);
    case "dictionary":
      return Br.fromDictionaryRenderer(o, e);
    case "label":
      return Xr.fromLabelSchema(o, e);
    case "map":
      return Yr.fromMatcherSchema(o, e);
    case "subtype":
      return Qr.fromSubtypes(o, e);
    case "cluster":
      return Hr.fromClusterSchema(o, e);
    default:
      throw new Error("Impl");
  }
}
let Qr = class gs extends V {
  constructor(e, t) {
  ...
  static async fromSubtypes(e, t) {
    ...
    for (const i in t.renderers) {
      const n = parseInt(i, 10), a = ue(e, t.renderers[i]).then((d) => s.set(n, d));
      r.push(a);
    }
    return await Promise.all(r), new gs(s, t.subtypeField);
  }
  match(e, t) {
    const s = e.readAttribute(this._subtypeField), r = this._subMatchers.get(s);
    return r ? r.match(e, t) : null;
  }
}, Hr = class ps extends V {
  static async fromClusterSchema(e, t) {
    const [s, r] = await Promise.all([ue(e, t.feature), ue(e, t.cluster)]);
    return new ps(s, r);
  }
  constructor(e, t) {
...
}, Zr = class fs extends Nr {
  static async create(e, t) {
    const s = await ue(e, t.symbology), r = t.labels ? await ue(e, t.labels) : null;
    return new fs(s, r);
  }
  constructor(e, t) {
  ...
  write(e, t, s, r, i) {
    ...
    if (n) {
      ...
      if (e.entityRecordCount() >= 1 && this._labels) {
        ...
        if (!a) return;
        for (const d of a) d.setReferences(n), d.write(e, t, s, r, i);
      }
    }
  }
  getSortKey(e, t) {
  ...
  constructor(e) {
    this._outstandingMessages = [], this._queue = new Yt({ concurrency: e.concurrency, process: (t) => e.process(t) });
  }
  async push(e) {
  ...
  static async create(e, t) {
    if (t.statisticType === "count") {
      const r = new jr(1);
      return new Ne(t.name, t.alias, t.type, t.statisticType, r);
    }
    const s = await e.createComputedField({ expression: t.onStatisticExpression?.expression, field: t.onStatisticField });
    return new Ne(t.name, t.alias, t.type, t.statisticType, s);
  }
  ...
  constructor(e, t, s, r) {
    super(e, t), this.spatialReference = s, this.aggregateFields = r, this.events = new st(), this.featureAdapter = Lr;
  }
  get aggregateQueryEngine() {
    return this._aggregateQueryEngine || (this._aggregateQueryEngine = new ds({ featureStore: this, fieldsIndex: this._metadata.fieldsIndex, geometryType: this._metadata.geometryType, objectIdField: this._metadata.objectIdField, spatialReference: this.spatialReference })), this._aggregateQueryEngine;
  }
  removeChunks(e) {
  }
  forEach(e) {
  ...
  static fromReader(e) {
    const t = [], s = e.copy(), r = rt();
    for (; s.next(); )
      s.getBounds(r) && t.push(s.getIndex());
    const i = Hs(9, (n) => (s.setIndex(n), { minX: s.getBoundsXMin(), minY: s.getBoundsYMin(), maxX: s.getBoundsXMax(), maxY: s.getBoundsYMax() }));
    return i.load(t), new ws(i);
  }
  constructor(e) {
    this._index = e;
  }
...
const ti = 64;
function si(o, e, t, s) {
  const r = [o.xmin, o.ymin, o.xmax, o.ymax], i = Zs.fromExtent(Js.fromBounds(r, s)), n = ve(i, s, L.WGS84, { densificationStep: e * ti });
  if (!n) return null;
  const a = Qt(new M(), n, !1, !1), d = a.coords.filter((f, m) => !(m % 2)), u = a.coords.filter((f, m) => m % 2), l = Math.min(...d), c = Math.min(...u), _ = Math.max(...d), p = Math.max(...u), g = Ve(l, c, t, L.WGS84), y = Ve(_, p, t, L.WGS84);
  return g && y ? { bounds: r, geohashBounds: { xLL: g[0], yLL: g[1], xTR: y[0], yTR: y[1] }, level: t } : null;
}
function Ve(o, e, t, s) {
  if (s.isWebMercator) {
    const n = ft(o / yt.radius), a = n - 360 * Math.floor((n + 180) / 360), d = [0, 0];
    return Tt(d, 0, ft(Math.PI / 2 - 2 * Math.atan(Math.exp(-e / yt.radius))), a, t), d;
  }
  const r = ve({ x: o, y: e }, s, L.WGS84);
  if (!r) return null;
  const i = [0, 0];
  return Tt(i, 0, r.y, r.x, t), i;
}
function ri(o, e) {
  let t = -90, s = 90, r = -180, i = 180;
  for (let n = 0; n < e; n++) {
    const a = Math.ceil((n + 1) / 2), d = Math.floor((n + 1) / 2), u = 1 - n % 2, l = 30 - (3 * a + 2 * d), c = 30 - (2 * a + 3 * d), _ = 3 * u + 2 * (1 - u), p = 2 * u + 3 * (1 - u), g = 3 * u + 7 * (1 - u) << c, y = (7 * u + 3 * (1 - u) << l & o.geohashX) >> l, f = (g & o.geohashY) >> c;
    for (let m = _ - 1; m >= 0; m--) {
      const v = (r + i) / 2, x = y & 1 << m ? 1 : 0;
      r = (1 - x) * r + x * v, i = (1 - x) * v + x * i;
    }
    for (let m = p - 1; m >= 0; m--) {
      const v = (t + s) / 2, x = f & 1 << m ? 1 : 0;
      t = (1 - x) * t + x * v, s = (1 - x) * v + x * s;
    }
  }
  return [r, t, i, s];
}
function Tt(o, e, t, s, r) {
  r % 2 && (r += 1);
  let i = 0, n = 0, a = -90, d = 90, u = -180, l = 180;
  for (let c = 0; c < r / 2; c++) {
    for (let _ = 0; _ < 5; _++) {
      const p = (u + l) / 2, g = s > p ? 1 : 0;
      i |= g << 29 - (_ + 5 * c), u = (1 - g) * u + g * p, l = (1 - g) * p + g * l;
    }
    for (let _ = 0; _ < 5; _++) {
      const p = (a + d) / 2, g = t > p ? 1 : 0;
      n |= g << 29 - (_ + 5 * c), a = (1 - g) * a + g * p, d = (1 - g) * p + g * d;
    }
  }
  o[2 * e] = i, o[2 * e + 1] = n;
}
...
let vs = class Xe {
  ...
  clone() {
    return new Xe(this._statistics.map((e) => e.clone()));
  }
};
function ii(o) {
  switch (o.statisticType) {
    case "min":
      return new ni(o);
    case "max":
      return new ai(o);
...
let se = class {
  ...
  insert(e, t) {
    ...
    Er(s) || this._insertValue(s);
  }
}, ni = class xs extends se {
  constructor() {
  ...
  clone() {
    const e = new xs(this.field);
    return e.value = this.value, e;
  }
}, ai = class Ss extends se {
  constructor() {
  ...
  clone() {
    const e = new Ss(this.field);
    return e.value = this.value, e;
  }
}, oi = class Fs extends se {
  constructor() {
  ...
  clone() {
    const e = new Fs(this.field);
    return e.value = this.value, e;
  }
}, di = class ks extends se {
  constructor() {
  ...
  _insertValue(e) {
    this._x = this._x + Math.cos(e * Mt), this._y = this._y + Math.sin(e * Mt), this._count += 1;
  }
  merge(e) {
    this._x += e._x, this._y += e._y, this._count += e._count;
  }
  clone() {
    const e = new Cs(this.field);
    return e._x = this._x, e._y = this._y, e._count = this._count, e;
  }
}, ci = class Ts extends se {
  constructor() {
  ...
  clone() {
    const e = new Ts(this.field);
    return e._frequencies = new Map(this._frequencies), e;
  }
}, $t = class Ye extends Is {
  static create(e, t, s, r) {
    const i = vs.create(e), n = new Array(32);
    for (let a = 0; a < n.length; a++) n[a] = null;
    return new Ye(i, t, s, r, n);
  }
  constructor(e, t, s, r, i) {
  ...
  clone() {
    const e = new Ye(this._statistics.clone(), this.xNode, this.yNode, this.depth, this.children);
  ...
  getGeometry(e, t) {
    const s = this._getLngLatBounds(), [r, i, n, a] = s, d = ve({ rings: [[[r, i], [r, a], [n, a], [n, i], [r, i]]] }, L.WGS84, e), u = Qt(new M(), d, !1, !1);
    return t != null ? J(new M(), u, !1, !1, "esriGeometryPolygon", t, !1, !1) : u;
  }
  getGeometricCentroid(e, t) {
    const s = this._getLngLatBounds(), [r, i, n, a] = s, d = ve({ x: (r + n) / 2, y: (i + a) / 2 }, L.WGS84, e), u = Ks(new M(), d);
    return t != null ? J(new M(), u, !1, !1, "esriGeometryPoint", t, !1, !1) : u;
  }
  getAttributes() {
  ...
  find(e, t, s, r, i, n) {
    if (r >= s) return this;
    const a = 1 - r % 2, d = 3 * a + 2 * (1 - a), u = 2 * a + 3 * (1 - a), l = 30 - i - d, c = 30 - n - u, _ = ((e & 7 * a + 3 * (1 - a) << l) >> l) + ((t & 3 * a + 7 * (1 - a) << c) >> c) * (8 * a + 4 * (1 - a)), p = this.children[_];
    return p == null ? null : p.find(e, t, s, r + 1, i + d, n + u);
  }
  _getLngLatBounds() {
    const e = this.depth, t = Math.ceil(e / 2), s = Math.floor(e / 2), r = 30 - (3 * t + 2 * s), i = 30 - (2 * t + 3 * s), n = this.xNode << r, a = this.yNode << i;
    return ri({ geohashX: n, geohashY: a }, this.depth);
  }
};
class li {
  constructor(e) {
  ...
  insert(e, t, s, r, i, n, a) {
    let d = this._root, u = 0, l = 0, c = 0;
    for (; d !== null; ) {
      if (d.insert(e, t, s, r, i, a), u >= n) return;
      const _ = Math.ceil((u + 1) / 2), p = Math.floor((u + 1) / 2), g = 1 - u % 2, y = 30 - (3 * _ + 2 * p), f = 30 - (2 * _ + 3 * p), m = (r & 7 * g + 3 * (1 - g) << y) >> y, v = (i & 3 * g + 7 * (1 - g) << f) >> f, x = m + v * (8 * g + 4 * (1 - g));
      l = l << 3 * g + 2 * (1 - g) | m, c = c << 2 * g + 3 * (1 - g) | v, d.children[x] == null && (d.children[x] = $t.create(this._fields, l, c, u + 1), this._depth = Math.max(this._depth, u + 1), this._size += 1), u += 1, d = d.children[x];
    }
  }
  putBins(e, t) {
  ...
  getNodes(e) {
    ...
    let i = this._root;
    for (; i !== null; ) {
      const n = i.depth, a = i.xNode, d = i.yNode;
      if (n >= r) {
        t.push(i), i = i.next;
        continue;
      }
      const u = Math.ceil((n + 1) / 2), l = Math.floor((n + 1) / 2), c = 1 - n % 2, _ = 30 - (3 * u + 2 * l), p = 30 - (2 * u + 3 * l), g = ~((1 << _) - 1), y = ~((1 << p) - 1), f = (s.xLL & g) >> _, m = (s.yLL & y) >> p, v = (s.xTR & g) >> _, x = (s.yTR & y) >> p, C = a << 3 * c + 2 * (1 - c), E = d << 2 * c + 3 * (1 - c), F = C + 8 * c + 4 * (1 - c), k = E + 4 * c + 8 * (1 - c), S = Math.max(C, f), $ = Math.max(E, m), P = Math.min(F, v), O = Math.min(k, x);
      let R = null, A = null;
      for (let W = $; W <= O; W++) for (let Ae = S; Ae <= P; Ae++) {
        const Ys = Ae - C + (W - E) * (8 * c + 4 * (1 - c)), ie = i.children[Ys];
        ie && (R || (R = ie, R.next = i.next), A && (A.next = ie), A = ie, ie.next = i.next);
      }
      i = R || i.next;
    }
    return t;
...
let Ms = class {
  ...
  constructor(e) {
    super(e), this._tree = new li(this._options.fields);
  }
  put(e) {
    throw new Error("Geohash tree does not support put");
  }
  putBounded(e, t, s) {
    const { geohashLevel: r, spatialReference: i } = this._options, n = si(t, s, r, i);
    n != null && this._tree.putBins(e, n);
  }
  _insert(e, t, s, r) {
    const { geohashLevel: i, spatialReference: n } = this._options, a = Ve(t, s, i, n);
    a && this._tree.insert(e, t, s, a[0], a[1], i, r);
  }
}, Qe = class me extends Is {
  static createId(e, t) {
    return `${e}.${t}`;
  }
  static create(e, t, s, r) {
    return new me(e, t, vs.create(s), r);
  }
  constructor(e, t, s, r) {
  ...
  get id() {
    return me.createId(this.gridX, this.gridY);
  }
  get containedObjectIds() {
    return this._objectIds;
  }
  ...
  clone() {
    const e = new me(this.gridX, this.gridY, this._statistics.clone(), this._worldUnitsPerCell);
  ...
  getCentroidX(e) {
    return e == null ? this.centroidXWorld : er(e, this.centroidXWorld);
  }
  getCentroidY(e) {
    return e == null ? this.centroidYWorld : tr(e, this.centroidYWorld);
  }
  getGeometry(e, t) {
    const s = this.gridX * this._worldUnitsPerCell, r = this.gridY * this._worldUnitsPerCell, i = new M([4], [s, r, s + this._worldUnitsPerCell, r, s + this._worldUnitsPerCell, r + this._worldUnitsPerCell, s, r + this._worldUnitsPerCell]);
    if (t != null) {
      const n = new M();
      return J(n, i, !1, !1, "esriGeometryPolygon", t);
    }
    return i;
  }
  getCentroid(e) {
    const t = new M([], [this.centroidXWorld, this.centroidYWorld]);
    if (e != null) {
      const s = new M();
      return J(s, t, !1, !1, "esriGeometryPoint", e);
    }
    return t;
  }
  getGeometricCentroid(e, t) {
    const s = this.gridX * this._worldUnitsPerCell + 0.5 * this._worldUnitsPerCell, r = this.gridY * this._worldUnitsPerCell + 0.5 * this._worldUnitsPerCell, i = new M([], [s, r]);
    if (t != null) {
      const n = new M();
      return J(n, i, !1, !1, "esriGeometryPoint", t);
    }
    return i;
  }
  getAttributes() {
...
let gi = class extends Ms {
  constructor(e) {
    super(e), this._cells = /* @__PURE__ */ new Map(), this._pixelsPerMapUnit = He(e.spatialReference, e.scale);
  }
  put(e) {
  ...
  putBounded(e, t, s) {
    const r = [t.xmin, t.ymin, t.xmax, t.ymax], [i, n, a, d] = r, u = Math.floor(i * this._pixelsPerMapUnit / this._options.cellSize), l = Math.floor(n * this._pixelsPerMapUnit / this._options.cellSize), c = Math.ceil(a * this._pixelsPerMapUnit / this._options.cellSize), _ = Math.ceil(d * this._pixelsPerMapUnit / this._options.cellSize);
    for (let p = l; p <= _; p++) for (let g = u; g <= c; g++) {
      const y = `${g}.${p}`, f = this._cells.get(y);
      if (!f) continue;
      const m = e.get(f.id);
      m ? f && !e.has(f.id) && m.merge(f) : e.set(f.id, f.clone());
    }
  }
  _insert(e, t, s, r) {
    const i = t * this._pixelsPerMapUnit, n = s * this._pixelsPerMapUnit, a = Math.floor(i / this._options.cellSize), d = Math.floor(n / this._options.cellSize);
    this._getCellOrCreate(a, d).insert(e, r, t, s);
  }
  _getCellOrCreate(e, t) {
    const s = Qe.createId(e, t);
    let r = this._cells.get(s);
    if (!r) {
      const i = 1 * this._options.cellSize / this._pixelsPerMapUnit;
      r = Qe.create(e, t, this._options.fields, i), this._cells.set(s, r);
    }
    return r;
  }
}, pi = class Ze extends Ce {
  static from(e, t) {
    return new Ze(e.copy(), t);
  }
  constructor(e, t) {
  ...
  setTransformForDisplay(e) {
    ...
    if (t == null) {
      const [c, _] = e.scale, [p, g] = e.translate;
      return this._displayTranslationX = -p / c, this._displayScaleX = 1 / c, this._displayTranslationY = g / _, this._displayScaleY = 1 / -_, void (this._displayTransform = e);
    }
    const [s, r] = t.scale, [i, n] = t.translate, [a, d] = e.scale, [u, l] = e.translate;
    if (this._displayScaleX = s / a, this._displayTranslationX = (i - u) / a, this._displayScaleY = r / d, this._displayTranslationY = (-n + l) / d, !this._isPoint && t) throw new Error("InternalError: Relative transformations not supported for non-point features");
  ...
  copy() {
    const e = new Ze(this._reader.copy(), this._indices);
  ...
  readGeometryForDisplay() {
    ...
    const t = new M();
    return J(t, e, this.hasZ, this.hasM, this.geometryType, this._displayTransform), t.deltaDecode();
  }
  ...
  readLegacyGeometryForDisplay() {
    ...
    return ir(e, this.geometryType, !1, !1);
  }
  readGeometryArea() {
  ...
  getAggregateIndex(e) {
    ...
    if (t !== this._aggregateIndexHash) {
      switch (this._aggregateIndexHash = t, e.type) {
        case "grid":
          this._aggregateIndex = new gi(e);
          break;
        case "geohash":
          this._aggregateIndex = new hi(e);
      }
  ...
  _getSpatialIndex() {
    return this._spatialIndex || (this._spatialIndex = ei.fromReader(this.reader)), this._spatialIndex;
  }
}, q = class G extends Ce {
  static fromFeatures(e, t) {
    const { objectIdField: s, geometryType: r } = t, i = nr([], e, r, !1, !1, s);
    for (let n = 0; n < i.length; n++) i[n].displayId = e[n].displayId;
    return G.fromOptimizedFeatures(i, t);
  }
  static fromFeatureSet(e, t) {
    const s = Ht(e, t.objectIdField);
    return G.fromOptimizedFeatureSet(s, t);
  }
  static fromOptimizedFeatureSet(e, t) {
    const s = G.fromOptimizedFeatures(e.features, t);
    return s._exceededTransferLimit = e.exceededTransferLimit, s._transform = e.transform, s._fieldsIndex = new le(e.fields), s;
  }
  ...
  copy() {
    const e = new G(this._features, this.metadata);
  ...
  readGeometryArea() {
    return _e(this._current) ? ar(this._current.geometry, 2) : 0;
  }
  _readX() {
    return _e(this._current) ? this._current.geometry.coords[0] : 0;
  }
  _readY() {
    return _e(this._current) ? this._current.geometry.coords[1] : 0;
  }
  _readGeometry() {
    return _e(this._current) ? this._current.geometry ?? null : null;
  }
  _readServerCentroid() {
  ...
  _readAttribute(e, t) {
    ...
    if (!s) return;
    const r = this._current.attributes[s.name];
    return r == null ? r : t && this.fields.isDateField(e) ? new Date(r) : r;
  }
  _readAttributes() {
...
let Je = class extends he {
  ...
  get reader() {
    return q.fromOptimizedFeatures(this._features, this.metadata);
  }
  get queryInfo() {
    return {};
  }
  ...
  applyOverrides(e) {
    ...
    for (this.overriddenIds.clear(); n.next(); ) {
      const d = n.readOptimizedFeatureWorldSpace(), u = d.objectId;
      r.push(d), i.add(u), this.overriddenIds.add(u), this.removed.delete(u);
    }
    for (const d of this._features) {
      const u = d.objectId;
      a.has(u) || i.has(u) || (r.push(d), this.overriddenIds.add(u));
    }
    this._features = r;
    for (const d of i.values()) this.removed.delete(d);
    for (const d of s) this.removed.add(d), this.overriddenIds.add(d);
  }
  removeOverrides(e) {
  ...
  *featuresWorldSpace() {
    for (const e of this.featureCache.values()) {
      const t = e.clone();
      t.geometry && dr(t.geometry, t.geometry, !1, !1, this.subscription.tile.transform), yield t;
    }
  }
}, yi = class qs extends bs {
  static async create(e, t, s, r, i) {
    const n = new at({ spatialReference: t }), a = await Promise.all(e.fields.map(async (u) => ys.create(n, u))), d = e.featureFilter ? await os.create({ geometryType: s.metadata.geometryType, hasM: !1, hasZ: !1, timeInfo: s.metadata.timeInfo, fieldsIndex: s.metadata.fieldsIndex, spatialReference: t, filterJSON: e.featureFilter }) : null;
    return e.index.type === "geohash" && await or(t, L.WGS84), new qs(e, d, i, a, t, s, r);
  }
  constructor(e, t, s, r, i, n, a) {
    super(n, a, i, r), this._schema = e, this._featureFilter = t, this._timeZone = s, this._metadata = ot.createFeature({ geometryType: "esriGeometryPolygon", objectIdField: "aggregateId", fieldsIndex: new le(e.fields).toJSON(), globalIdField: null, spatialReference: n.metadata.spatialReference, subtypeField: null, subtypes: null, timeInfo: null, timeReferenceUnknownClient: null, typeIdField: null, types: null });
  }
  createState(e) {
    return new fi(e, this._attributeStore);
  }
  async *applyLocalEdit(e) {
    for (const t of this._sendStates.values())
      t.reset(), yield new _t(t.subscription, q.empty(this._source.metadata), !0, !1, {});
  }
  displayMap(e, t, s) {
    const r = new Map(e.map((n) => [t(n), n])), i = [];
    for (const n of this._sendStates.values()) for (const a of n.featuresWorldSpace()) {
      const { objectId: d, displayId: u } = a, l = r.get(d);
      if (l != null) {
        const c = s(u, l, d);
        i.push(c), r.delete(d);
      }
  ...
  getDisplayFeatures(e) {
    ...
    for (const i of this._sendStates.values()) for (const n of i.featuresWorldSpace()) t.has(n.displayId) && !s.has(n.objectId) && (n.geometry && r.push({ ...Zt(n, this._metadata.geometryType, !1, !1), displayId: n.displayId }), s.add(n.objectId));
  ...
  beforeUpdateChunks() {
    ...
    if (!e.length) return;
    let t = !1;
    for (const s of e) $s(s) && s.lastLocalEditDropped !== this._lastHandledLocalEdit && (this._lastHandledLocalEdit = s.lastLocalEditDropped, t = !0);
    if (t) for (const s of this._sendStates.values()) s.invaldateForLocalEditDropped();
  }
  async *updateChunks() {
  ...
  forEachAggregateWorldSpace(e) {
    ...
    for (const s of this._sendStates.values()) for (const r of s.featuresWorldSpace()) t.has(r.objectId) || (e(r), t.add(r.objectId));
  }
  ...
  async *_update(e, t) {
    ...
    if (e.done) return;
    for (const y of t.chunks()) {
      if (s.has(y.chunkId)) continue;
      s.add(y.chunkId);
      const f = y.queryInfo;
      if ("tileId" in f) {
        const m = new tt(f.tileId);
        if (m.level !== a.level || m.world !== a.key.world) continue;
      }
      y.getAggregateIndex(this._createIndexOptions(e.tile)).putBounded(i, e.tile.extent, e.tile.resolution);
    }
    const d = [], u = r.tile.transform, l = r.tile.key.level;
    for (const y of i.values()) {
      let f = n.get(y.id);
      if (f) f.attributes = y.getAttributes();
      else {
        const m = y.getGeometry(this.spatialReference, u);
        f = new Q(m, y.getAttributes(), null), m || (f.centroid = y.getGeometricCentroid(this.spatialReference, u)), f.objectId = y.id, f.displayId = this._attributeStore.createDisplayIdForObjectId(`${f.objectId}.${l}`), n.set(y.id, f);
      }
      d.push(f);
    }
    this.events.emit("changed"), e.done = !t.updateTracking.updating;
    const c = q.fromOptimizedFeatures(d, this._metadata, u), _ = c.getCursor(), p = e.subscription.tile.createArcadeEvaluationOptions(this._timeZone);
    for (; _.next(); ) this._attributeStore.setAttributeData(_.getDisplayId(), _, p);
    yield new Be(e.subscription, c, [], e.done, {});
  }
}, mi = class {
  constructor(e, t) {
...
let bi = class extends ht {
  ...
  *aggregatesWorldSpace() {
    for (const e of this._clusters.values()) {
      const t = e.inner.getCentroid(null), s = new Q(t, e.inner.getAttributes(), null);
  ...
  updateChunks(e, t) {
    ...
    for (const a of e) {
      const d = a.queryInfo;
      "tileId" in d && new tt(d.tileId).level !== this._level || this._handledChunks.has(a.normalizedChunkId) || (this._handledChunks.add(a.normalizedChunkId), s = !0, a.getAggregateIndex({ ...this._indexOptions, scale: this._scale }).put(this._cells));
    }
    const r = { xMin: 1 / 0, yMin: 1 / 0, xMax: -1 / 0, yMax: -1 / 0 }, i = He(this._indexOptions.spatialReference, this._scale), n = this._indexOptions.cellSize;
    for (const { subscription: a } of t) {
      const d = a.tile.bounds, u = Math.floor(d[0] * i / n), l = Math.floor(d[1] * i / n), c = Math.ceil(d[2] * i / n), _ = Math.ceil(d[3] * i / n);
      r.xMin = Math.min(r.xMin, u), r.yMin = Math.min(r.yMin, l), r.xMax = Math.max(r.xMax, c), r.yMax = Math.max(r.yMax, _);
    }
  ...
  createAggregateFeatures(e, t) {
    ...
    for (const n of this._clusters.values()) {
      ...
      const d = n.inner.getCentroidY(i), u = s.tile.lod, l = u.wrap ? u.worldSize[0] : null, c = n.inner.count === 1 ? n.inner.firstObjectId : n.inner.id, _ = n.displayId;
      if (l != null) if (l === 1) {
        const p = new M([], [a, d]), g = new Q(p, n.inner.getAttributes(), null);
        g.geometry.coords[0] -= T, g.objectId = c, g.displayId = _, r.push(g);
        const y = new M([], [a, d]), f = new Q(y, n.inner.getAttributes(), null);
        f.geometry.coords[0] += T, f.objectId = c, f.displayId = _, r.push(f);
      } else a > T + T / 2 ? a -= l * T : a < -T / 2 && (a += l * T);
      if (a < T + pe && a >= -pe && d < T + pe && d >= -pe) {
        const p = new M([], [a, d]), g = new Q(p, n.inner.getAttributes(), null);
        g.objectId = c, g.displayId = _, r.push(g);
      }
    }
    return q.fromOptimizedFeatures(r, t, s.tile.transform);
  }
  _clusterCells(e) {
    let t = Array.from(this._cells.values());
    t = t.sort((a, d) => d.count - a.count);
    const s = [];
    for (const a of this._clusters.values()) s.push(a.inner.id);
    this._clusters.clear();
    const r = this._clusterRadius * (1 / He(this._indexOptions.spatialReference, this._scale)), i = 1 + this._clusterRadius / this._indexOptions.cellSize, n = /* @__PURE__ */ new Set();
    for (const a of t) {
      if (n.has(a.id) || a.gridX < e.xMin || a.gridX > e.xMax || a.gridY < e.yMin || a.gridY > e.yMax) continue;
      const d = this._store.createDisplayIdForObjectId(a.id), u = new mi(a.clone(), d);
      n.add(a.id), this._clusters.set(a.id, u);
      const l = a.centroidXWorld, c = a.centroidYWorld;
      for (let _ = a.gridY - i; _ <= a.gridY + i; _++) for (let p = a.gridX - i; p <= a.gridX + i; p++) {
        if (_ === a.gridY && p === a.gridX) continue;
        const g = this._cells.get(Qe.createId(p, _));
        if (!g || n.has(g.id)) continue;
        const y = Math.abs(g.centroidXWorld - l), f = Math.abs(g.centroidYWorld - c);
        y < r && f < r && (u.inner.merge(g), n.add(g.id));
      }
    }
  ...
  _updateAggregateStatistics(e, t) {
    ...
    for (const r of t.statistics.values()) {
      ...
      if (a) {
        const { minValue: d, maxValue: u } = a, l = Math.min(a.minValue, i), c = Math.max(a.maxValue, i);
        d === l && u === c || (a.minValue = l, a.maxValue = c, s = !0);
      } else e.set(n.name, { minValue: i, maxValue: i }), s = !0;
    }
    return s;
  }
}, Ii = class Es extends bs {
  static async create(e, t, s, r, i, n) {
    const a = new at({ spatialReference: s }), d = { type: "grid", fields: await Promise.all(t.fields.map(async (u) => ys.create(a, u))), spatialReference: s, featureFilter: t.featureFilter ? await os.create({ geometryType: r.metadata.geometryType, hasM: !1, hasZ: !1, timeInfo: r.metadata.timeInfo, fieldsIndex: r.metadata.fieldsIndex, spatialReference: s, filterJSON: t.featureFilter }) : null, cellSize: t.clusterRadius / 4, timeZone: n };
    return new Es(e, t.clusterRadius, d, t.fields, r, i);
  }
  constructor(e, t, s, r, i, n) {
    super(i, n, s.spatialReference, s.fields), this._connection = e, this._clusterRadius = t, this._indexOptions = s, this._cellsPerScale = /* @__PURE__ */ new Map(), this._metadata = ot.createFeature({ geometryType: "esriGeometryPoint", objectIdField: "aggregateId", fieldsIndex: new le([...r, ...this._source.metadata.fieldsIndex.fields, { name: "aggregateId", alias: "aggregateId", type: "esriFieldTypeOID" }]).toJSON(), globalIdField: null, spatialReference: i.metadata.spatialReference, subtypeField: null, subtypes: null, timeInfo: null, timeReferenceUnknownClient: null, typeIdField: null, types: null });
  }
  get enablePixelBuffering() {
    return !1;
  }
  ...
  displayMap(e, t, s) {
    ...
    for (const a of n.clusters()) {
      const d = r.get(a.inner.id);
      if (d == null) {
        if (a.inner.count === 1) {
          const u = r.get(a.inner.firstObjectId);
          if (u != null) {
            const l = s(a.displayId, u, a.inner.firstObjectId);
            i.push(l), r.delete(a.inner.firstObjectId);
          }
        }
      } else {
        const u = s(a.displayId, d, a.inner.id);
        i.push(u), r.delete(a.inner.id);
      }
    }
    return i;
  }
  getDisplayFeatures(e) {
    ...
    for (const a of n.aggregatesWorldSpace()) if (t.has(a.displayId) && !s.has(a.displayId)) {
      const d = Zt(a, this._metadata.geometryType, !1, !1);
      if (s.add(a.displayId), d.attributes.cluster_count === 1) {
        r.push({ ...d, displayId: a.displayId });
        continue;
      }
      i.push({ ...d, displayId: a.displayId });
    }
  ...
  async *updateChunks() {
    const e = this._source.chunks();
    if (!e.length) return;
    for (const n of e) $s(n) && n.lastLocalEditDropped !== this._lastHandledLocalEdit && (this.invalidate(), this._lastHandledLocalEdit = n.lastLocalEditDropped);
  ...
  _getClusterState(e, t) {
    ...
    return s || (s = new wi(e, t, this._indexOptions, this._clusterRadius, this._attributeStore), this._cellsPerScale.set(t, s)), s;
  }
  async *_update(e, t, s) {
    if (e.done) return;
    ...
    yield new _t(e.subscription, r, !0, e.done, {});
  }
}, vi = class extends ht {
}, xi = class extends ms {
  constructor(e, t, s) {
  ...
  displayMap(e, t, s) {
    ...
    for (const n of this._source.chunks()) {
      ...
      for (; a.next(); ) {
        const d = a.getObjectId(), u = a.getDisplayId(), l = r.get(d);
        if (l != null) {
          const c = s(u, l, d);
          i.push(c), r.delete(d);
        }
  ...
  getDisplayFeatures(e) {
    ...
    for (const i of this._source.chunks()) {
      ...
      for (; n.next(); ) {
        const a = n.getObjectId(), d = n.getDisplayId();
        t.has(d) && !s.has(a) && (r.push({ ...n.readLegacyFeatureWorldSpace(), displayId: d }), s.add(a));
      }
    }
  ...
  async *applyLocalEdit(e) {
    ...
    for (; s.next(); ) {
      const n = s.getObjectId(), a = this._attributeStore.createDisplayIdForObjectId(n);
      s.setDisplayId(a), this._attributeStore.setAttributeData(a, s, this._evalOptions), t.push(a);
    }
    const r = [];
    for (const n of e.removed) {
      const a = this._attributeStore.getDisplayIdForObjectId(n);
      a != null && r.push(a);
    }
    w("esri-2d-update-debug") && console.debug("FeatureUpdateStrategy.applyLocalEdit", { message: e, modifiedDisplayIds: t, removedDisplayIds: r });
    const i = new Je(this._source.metadata, "localEdit");
    i.applyOverrides(e), this.handledChunks.add(i.chunkId), this.handledChunksForAttributeData.add(i.chunkId), this.handledChunksForIdCreation.add(i.chunkId);
    for (const n of this._sendStates.values()) n.handledChunks.add(i.chunkId), yield new Be(n.subscription, null, t, !1, i.queryInfo);
    for (const n of this._sendStates.values()) {
      const a = i.getTileReader(n.subscription.tile);
      yield new Be(n.subscription, a, r, !1, i.queryInfo);
    }
    for (const n of e.removed) this._attributeStore.releaseDisplayIdForObjectId(n);
  }
  async *updateChunks() {
  ...
  *_update(e) {
    ...
    for (const r of this._source.chunks()) {
      ...
      n && (yield new _t(e.subscription, n, !1, r.end, r.queryInfo));
    }
  }
}, Si = class {
  constructor(e, t) {
    this._connection = e, this._source = t, this._version = 1, this._registry = new Dr(), this._proxy = new Or({ fetch: (s, r) => this._connection.layerView.fetch(s, r), fetchDictionary: (s, r) => this._connection.layerView.fetchDictionary(s, r) }), this._attributeStore = new Rr({ isLocal: !1, update: (s) => et(this._connection.container.updateAttributeView(s)) });
  }
  destroy() {
  ...
  getDisplayIds(e) {
    const t = {};
    return this._strategy && this._strategy.displayMap(e, (s) => s, (s, r, i) => {
      t[i] = s;
    }), t;
  }
  getFeatureObjectIdsForAggregate(e) {
  ...
  async update(e, t, s, r, i) {
    const n = e.processor, a = ge(this._schema?.storage, n.storage), d = ge(this._schema?.mesh.properties, n.mesh.properties), u = ge(this._schema?.mesh.factory, n.mesh.factory), l = ge(this._schema?.mesh.strategy, n.mesh.strategy), c = d || u || l;
    if (!(a || c) && !r) return;
    w("esri-2d-update-debug") && console.debug(`Version[${this._version}] SymbolProcessor.update`, { changes: Jt(this._schema, n), schema: n }), this._schema = n;
    const _ = L.fromJSON(this._source.service.outSpatialReference), p = new at({ fields: this._source.metadata.fieldsIndex, spatialReference: _ });
    if (await this._attributeStore.update(n.storage, p, this._source.metadata, _, t), this._strategy?.invalidateAttributeData(), !r && !c) return;
    (l || d) && await this._updateStrategy(n.mesh.strategy, _, i, n.mesh.properties.timeZone), this._updateSortKey(p, "sortKey" in n.mesh.properties ? n.mesh.properties.sortKey : null);
    const g = new Jr(p, this._proxy, s, this._registry);
    return (u || n.mesh.factory.symbology.type === "dictionary") && (this._factory = await Zr.create(g, n.mesh.factory)), this._invalidate(), this._version = t, this._connection.container.updateRenderState(this._version);
  }
  async applyLocalEdit(e) {
  ...
  async updateChunks() {
    this._strategy?.beforeUpdateChunks(), await this._doUpdateChunks(), this._strategy?.afterUpdateChunks();
  }
  ...
  async _doUpdateChunks() {
    ...
    for await (const r of e) {
      let i = s.get(r.id);
      i == null && (i = new Kr({ concurrency: 16, process: (a) => this._process(a) }), s.set(r.id, i));
      const n = i.push(r).catch((a) => it(a));
      t.push(n);
    }
    try {
      await Promise.all(t);
    ...
    w("esri-2d-update-debug") && console.log("SendUpdates"), this._attributeStore.sendUpdates(), w("esri-2d-update-debug") && console.log("SendUpdates.await");
  }
  async _updateStrategy(e, t, s, r) {
    switch (this._strategy?.destroy(), e.type) {
      case "feature":
        this._strategy = new xi(this._source, this._attributeStore, r);
        break;
      case "binning":
        this._strategy = await yi.create(e, t, this._source, this._attributeStore, r);
        break;
      case "cluster":
        this._strategy = await Ii.create(this._connection, e, t, this._source, this._attributeStore, r);
    }
    for (const i of s) this._strategy.onSubscribe(i);
  }
  async _updateSortKey(e, t) {
    if (this._sortInfo = Kt(this._sortInfo?.computed), t != null) {
  ...
  async _process(e) {
    ...
    if (w("esri-2d-update-debug")) {
      const d = t.tile;
      console.debug(`Version[${this._version}] Tile[${d.key.id}, end=${e.end}] Processor._process`);
    }
    await this._fetchResources(e), K(t.signal);
    const s = await this._write(e, t.tile.createArcadeEvaluationOptions(this._schema?.mesh.properties.timeZone)), r = t.tile.tileInfoView.getLODInfoAt(t.tile.key), { message: i, transferList: n } = s.serialize(r), a = { objectIdMap: null, inner: e.createMessage(i, this._version, this._attributeStore.epoch) };
    if (this._schema?.mesh.properties.returnMeshObjectId) {
      a.objectIdMap = {};
      const d = e.reader?.getCursor();
      if (d) for (; d.next(); ) a.objectIdMap[d.getDisplayId()] = d.getObjectId();
    }
    if (K(t.signal), await this._connection.container.onMessage(a, { signal: t.signal, transferList: n }), this._attributeStore.sendUpdates(), w("esri-2d-update-debug")) {
      const d = t.tile;
      console.debug(`Version[${this._version}] Tile[${d.key.id}, end=${e.end}] Processor._process.await`);
    }
  }
  ...
  async _write(e, t) {
    const s = e.subscription.tile, r = e.reader?.getCursor(), i = r?.getSize() ?? 0, n = s.tileInfoView.tileInfo.isWrappable, a = s.tileInfoView.tileInfo.spatialReference.isWGS84, d = new Gr(s.key, this._strategy.enablePixelBuffering, n, a, i);
    if (!r) return d;
    const u = s.createArcadeEvaluationOptions(this._schema.mesh.properties.timeZone);
    for (; r.next(); ) {
      const l = this._getSortKeyValue(r, t);
      d.entityStart(r.getDisplayId(), l), this._factory.write(d, this._proxy, r, u, s.level), d.entityEnd();
    }
    return d;
  }
  ...
  static from(e) {
    ...
    return e.forEach((i) => {
      ...
      n && (s += n.isPoint ? 1 : n.lengths.reduce((a, d) => a + d, 0), r += n.isPoint ? 1 : n.lengths.length, t += 1);
    }), new Os(t, s, r);
  }
  constructor(e, t, s) {
...
const De = 4;
function ki(o, e, t) {
  const s = o.orderByFields ?? t.objectIdField + " ASC", r = o.source, i = { returnCentroid: !(r !== null && typeof r == "object" && "path" in r && cr(r.path)) && t.serviceGeometryType === "esriGeometryPolygon", returnGeometry: !0, timeReferenceUnknownClient: t.timeReferenceUnknownClient ?? void 0, outSpatialReference: L.fromJSON(o.outSpatialReference), orderByFields: o.type === "memory" ? [] : [s], where: e.mutable.dataFilter.definitionExpression ?? "1=1", outFields: e.mutable.availableFields, multipatchOption: t.serviceGeometryType === "esriGeometryMultiPatch" ? "xyFootprint" : null };
  if (e.type === "feature") {
    const { gdbVersion: n, historicMoment: a, timeExtent: d } = e.mutable.dataFilter;
    return { ...i, gdbVersion: n, historicMoment: a ? new Date(a) : null, timeExtent: d ? lr.fromJSON(d) : null, outFields: e.mutable.availableFields };
  }
  return i;
}
let Ci = class Rs {
  static fromSchema(e, t, s) {
    ...
    return new Rs(ki(e, t, s), r, s.subtypeField, t.mutable.dataFilter.customParameters, s.geometryType, e.queryMetadata);
  }
  constructor(e, t, s, r, i, n) {
  ...
  get pageSize() {
    ...
    const e = this._queryMetadata.supportsMaxRecordCountFactor ? De : null, t = (this._queryMetadata.maxRecordCount ?? 8e3) * (e ?? 1);
  ...
  createQuery(e = {}) {
    ...
    return { inner: new es({ ...this._queryParams, ...e }), customParameters: this._customParameters };
  }
  createTileQuery(e, t) {
  ...
  createPagedQuery(e) {
    ...
    return this.createQuery({ start: t * e, num: t, returnExceededLimitFeatures: !0, maxRecordCountFactor: De });
  }
};
const Ti = 2500;
let be = class extends ss {
  constructor(e) {
    super(), this._connection = e, this._enabledEventTypes = /* @__PURE__ */ new Set(), this._updateInfo = { websocket: 0, client: 0 }, this._lastTime = performance.now(), this._queuedCommands = [], this.addHandles([Ge(() => this._strategy?.connectionStatus ?? "disconnected", (t) => {
      this._layerView.setProperty({ propertyName: "pipelineConnectionStatus", value: t });
    }, { initial: !0 }), Ge(() => this._strategy?.errorString || null, (t) => this._layerView.setProperty({ propertyName: "pipelineErrorString", value: t }), { initial: !0 })]);
  }
  destroy() {
...
H([ye()], be.prototype, "_strategy", void 0), be = H([ts("esri.views.2d.layers.features.sources.StreamMessenger")], be);
let gt = class {
  constructor(e) {
...
function $i(o, e, t = !1) {
  const u = o.asUnsafe(), l = u.pos(), c = new Mi();
  let _ = 0, p = 0;
  const g = 1, y = 2, f = 4, m = 3;
  let v = null, x = null, C = null, E = !1;
  const F = [];
  for (; u.next(); ) switch (u.tag()) {
    case 1:
      v = u.getString();
      break;
    case 3:
      ...
      break;
    case 12:
      C = u.processMessage(_r);
      break;
    case 9:
      if (c.exceededTransferLimit = u.getBool(), c.exceededTransferLimit) {
        c.offsets.geometry = t ? new Float64Array(8e3) : new Int32Array(8e3), c.centroid = t ? new Float64Array(16e3) : new Int32Array(16e3);
        for (let S = 0; S < c.centroid.length; S++) c.centroid[S] = Le;
      }
      break;
    case 13: {
      const S = u.processMessage(hr);
      S.index = _++, F.push(S);
      break;
    }
    case 15: {
      const S = u.getLength(), $ = u.pos() + S;
      if (!c.exceededTransferLimit) {
        const O = c.offsets.geometry, R = c.centroid;
        O.push(0), R.push(Le), R.push(Le);
      }
      !E && c.exceededTransferLimit && (E = !0, c.offsets.attributes = t ? new Float64Array(8e3 * _) : new Uint32Array(8e3 * _));
      let P = p * _;
      for (; u.pos() < $ && u.next(); ) switch (u.tag()) {
        case g: {
          E ? c.offsets.attributes[P++] = u.pos() : c.offsets.attributes.push(u.pos());
          const O = u.getLength();
          u.skipLen(O);
          break;
        }
        case y:
          if (e) {
            const O = u.getLength(), R = u.pos() + O;
            for (; u.pos() < R && u.next(); ) switch (u.tag()) {
              case m: {
                u.getUInt32();
                const A = u.getSInt64(), W = u.getSInt64();
                c.centroid[2 * p] = A, c.centroid[2 * p + 1] = W;
                break;
              }
              default:
                u.skip();
            ...
            c.offsets.geometry[p] = u.pos();
            const O = u.getLength();
            c.vertexCount += O, u.skipLen(O);
          }
          break;
        case f: {
          const O = u.getLength(), R = u.pos() + O;
  ...
  const k = v || x;
  if (!k) throw new B("FeatureSet has no objectId or globalId field name");
  return c.fields = new le(F), c.featureCount = p, c.fieldCount = _, c.objectIdFieldIndex = c.fields.get(k)?.index, c.transform = C, c.displayIds = new Uint32Array(c.featureCount), c.groupIds = new Uint16Array(c.featureCount), u.move(l), c;
}
const qi = !0, qt = 268435455, Et = 128, Ot = 128e3, X = { small: { delta: new Int32Array(Et), decoded: new Int32Array(Et) }, large: { delta: new Int32Array(Ot), decoded: new Int32Array(Ot) } };
function Rt(o) {
  return o <= X.small.delta.length ? X.small : (o <= X.large.delta.length || (X.large.delta = new Int32Array(Math.round(1.25 * o)), X.large.decoded = new Int32Array(Math.round(1.25 * o))), X.large);
}
function Ei(o) {
  try {
    const t = new pr(new Uint8Array(o), new DataView(o));
    for (; t.next(); ) {
      if (t.tag() === 2) return Oi(t.getMessage());
      t.skip();
    }
  } catch (e) {
    const t = new B("query:parsing-pbf", "Error while parsing FeatureSet PBF payload", { error: e });
    fr.getLogger("esri.view.2d.layers.features.support.FeatureSetReaderPBF").error(t);
  }
  return null;
}
function Oi(o) {
  for (; o.next(); ) {
    if (o.tag() === 1) return o.getMessage();
    o.skip();
  }
  return null;
}
function Ri(o) {
  const l = o.getLength(), c = o.pos() + l;
  for (; o.pos() < c && o.next(); ) switch (o.tag()) {
    case 1:
      return o.getString();
    case 2:
      return o.getFloat();
...
function Ai(o, e, t, s, r, i) {
  return 0.5 * Math.abs(o * s + t * i + r * e - o * i - t * e - r * s);
}
function ze(o, e, t, s, r) {
  return o ? e * r - s * t === 0 && e * s + t * r > 0 : !1;
}
let Pi = class Ke extends Ce {
  static fromBuffer(e, t, s = !1) {
    const r = t.geometryType, i = Ei(e), n = $i(i, r === "esriGeometryPoint", s);
    return new Ke(i, n, t);
  }
  constructor(e, t, s) {
  ...
  copy() {
    const e = this._reader.clone(), t = new Ke(e, this._header, this.metadata);
  ...
  _readServerCentroid() {
    ...
    return e === qt ? null : new M([], [e, t]);
  }
  _readGeometry(e = !1) {
    if (this._cache.geometry === void 0) {
      let t = null;
      if (this._isPoints) {
        if (this._header.centroid[2 * this._featureIndex] === qt) return null;
  ...
  _readAttribute(e, t) {
    ...
    if (s == null) return;
    const r = this._readAttributeAtIndex(s.index), i = this._header.fields.isDateField(s.name);
  ...
  _readAttributeAtIndex(e) {
    ...
    if (t || (t = new Ar(this.getSize()), this._parseCaches[e] = t), t.has(this._featureIndex)) return t.get(this._featureIndex);
  ...
  _readGeometryDeltaDecoded(e = !1) {
    if (this._cache.unquantGeometry === void 0) {
      ...
      const s = Rt(t.coords.length).decoded, r = t.clone(s), i = r.coords;
      let n = 0;
      for (const a of r.lengths) {
        for (let d = 1; d < a; d++) {
          const u = 2 * (n + d), l = 2 * (n + d - 1);
          i[u] += i[l], i[u + 1] += i[l + 1];
        }
        n += a;
      }
  ...
  _parseGeometry(e) {
    const r = e.asUnsafe(), i = r.getLength(), n = r.pos() + i, a = [], d = [];
    for (; r.pos() < n && r.next(); ) switch (r.tag()) {
      case 2: {
        const u = r.getUInt32(), l = r.pos() + u;
        for (; r.pos() < l; ) d.push(r.getUInt32());
        break;
      }
      case 3: {
        const u = r.getUInt32(), l = r.pos() + u;
        for (a.push(r.getSInt64()), a.push(r.getSInt64()), this.hasZ && r.getSInt64(), this.hasM && r.getSInt64(); r.pos() < l; ) a.push(r.getSInt64()), a.push(r.getSInt64()), this.hasZ && r.getSInt64(), this.hasM && r.getSInt64();
        break;
      }
      default:
        r.skip();
  ...
  _parseGeometryForDisplay(e) {
    const r = e.asUnsafe(), i = r.getLength(), n = r.pos() + i, a = [], d = [];
    let u = 0, l = 0, c = null, _ = 0;
    const p = this.geometryType === "esriGeometryPolygon", g = this.geometryType === "esriGeometryPolyline", y = p || g;
    for (; r.pos() < n && r.next(); ) switch (r.tag()) {
      case 2: {
        const f = r.getUInt32(), m = r.pos() + f;
        for (; r.pos() < m; ) {
          const v = r.getUInt32();
          a.push(v), u += v;
        }
      ...
      case 3: {
        r.getUInt32();
        const f = 2 + (this.hasZ ? 1 : 0) + (this.hasM ? 1 : 0);
        gr(c);
        for (const m of a) if (l + f * m > c.length) for (let v = 0; v < m; v++) r.getSInt32(), r.getSInt32(), this.hasZ && r.getSInt32(), this.hasM && r.getSInt32();
        else if (p && qi) {
          const v = this.getAreaSimplificationThreshold(m, this._header.vertexCount);
          let x = 2, C = 1;
          const E = !1;
          let F = r.getSInt32(), k = r.getSInt32();
          c[l++] = F, c[l++] = k, this.hasZ && r.getSInt32(), this.hasM && r.getSInt32();
          let S = r.getSInt32(), $ = r.getSInt32();
          for (this.hasZ && r.getSInt32(), this.hasM && r.getSInt32(); x < m; ) {
            let P = r.getSInt32(), O = r.getSInt32();
            this.hasZ && r.getSInt32(), this.hasM && r.getSInt32();
            const R = F + S, A = k + $;
            Ai(F, k, R, A, R + P, A + O) >= v ? (_ += -0.5 * (R - F) * (A + k), C > 1 && ze(y, c[l - 2], c[l - 1], S, $) ? (c[l - 2] += S, c[l - 1] += $) : (c[l++] = S, c[l++] = $, C++), F = R, k = A) : (P += S, O += $), S = P, $ = O, x++;
          }
          C < 3 || E ? l -= 2 * C : (_ += -0.5 * (F + S - F) * (k + $ + k), ze(y, c[l - 2], c[l - 1], S, $) ? (c[l - 2] += S, c[l - 1] += $, d.push(C)) : (c[l++] = S, c[l++] = $, d.push(++C)));
        } else {
          let v = 0, x = r.getSInt32(), C = r.getSInt32();
          this.hasZ && r.getSInt32(), this.hasM && r.getSInt32(), c[l++] = x, c[l++] = C, v += 1;
          for (let E = 1; E < m; E++) {
            const F = r.getSInt32(), k = r.getSInt32(), S = x + F, $ = C + k;
            _ += -0.5 * (S - x) * ($ + C), this.hasZ && r.getSInt32(), this.hasM && r.getSInt32(), E > 2 && ze(y, c[l - 2], c[l - 1], F, k) ? (c[l - 2] += F, c[l - 1] += k) : (c[l++] = F, c[l++] = k, v += 1), x = S, C = $;
          }
          d.push(v);
        }
        break;
    ...
    return this._cache.area = _, d.length ? new M(d, c) : c != null ? this._createQuantizedExtrudedGeometry(c[0], c[1]) : null;
  }
}, Ee = class {
  constructor(e, t) {
...
function ji(o, e) {
  switch (o.type) {
    ...
    case "feature-service":
      return o.queryMetadata.supportsFormatPBF && w("featurelayer-pbf") ? new zi(o, e) : new Ui(o, e);
  }
}
async function Di(o) {
  const e = new mr();
  return await e.open(o, {}), e;
}
let Li = class extends Ee {
  constructor(e, t) {
    super(e, t), this._portsOpen = Di(e.source).then((s) => this.client = s);
  }
  destroy() {
  ...
  async executeQuery(e, t) {
    ...
    return q.fromFeatureSet(s, this._metadata);
  }
}, zi = class extends Ee {
  async executeQuery(e, t) {
    const { data: s } = await yr(this.service.source, e, t), r = !e.quantizationParameters;
    return Pi.fromBuffer(s, this._metadata, r);
  }
}, Ui = class extends Ee {
  async executeQuery(e, t) {
    const { source: s, queryMetadata: r } = this.service;
    if (e.quantizationParameters != null && !r.supportsQuantization) {
      const n = e.clone(), a = rs(n.quantizationParameters);
      n.quantizationParameters = null;
      const { data: d } = await mt(s, n, this._metadata.spatialReference, t), u = Ht(d, this._metadata.objectIdField);
      return is(a, u), q.fromOptimizedFeatureSet(u, this._metadata);
    }
    const { data: i } = await mt(s, e, this._metadata.spatialReference, t);
    return this._metadata.geometryType === "esriGeometryPoint" && (i.features = i.features?.filter((n) => {
      ...
      return !0;
    })), q.fromFeatureSet(i, this._metadata);
  }
}, Wi = class extends Ee {
  async executeQuery(e, t) {
    if (e.quantizationParameters && !this.service.queryMetadata.supportsQuantization) {
      const r = e.clone(), i = rs(r.quantizationParameters);
      r.quantizationParameters = null;
      const n = await vt(this.service.source, e, t);
      return is(i, n), q.fromOptimizedFeatureSet(n, this._metadata);
    }
    const s = await vt(this.service.source, e, t);
    return q.fromOptimizedFeatureSet(s, this._metadata);
  }
}, As = class extends gt {
  constructor(e, t, s, r, i) {
    super(s), this._serviceInfo = e, this._queryInfo = t, this._metadata = r, this._connection = i, this._queue = new Yt({ concurrency: 16, process: async (n) => {
      const a = { signal: n.options?.signal, query: n.query.customParameters };
      return this._adapter.executeQuery(n.query.inner, a);
    } }), this._adapter = ji(e, r);
  }
  unsafeSetQueryHistoricMoment(e) {
  ...
  async updateFields(e) {
    ...
    const t = Array.from(this._store.chunks()).map(async (r) => {
      const i = es.fromJSON(r.queryInfo.queryJSON);
      if (i) try {
    ...
    if (s.length) throw new B("featurelayer-query", "Encountered errors when downloading fields", { errors: s });
  }
  async queryByObjectId(e) {
    if (e.length === 0) return q.empty(this._metadata);
  ...
  _addChunk(e) {
    ...
    const s = e.size();
    (s || e.first || e.end) && (w("esri-2d-update-debug") && console.debug(`Chunk[${e.chunkId}] ATileLoadStrategy.addChunk [count=${s}]`), this._chunksById.get(t).push(e), this._store.insert(e));
  }
  _removeChunks(e) {
    const t = this._chunksById.get(e.key.id) ?? [];
    for (const s of t) w("esri-2d-update-debug") && console.debug(`Tile[${e.key.id}] Chunk[${s.chunkId}] ATileLoadStrategy.removeChunk`), this._store.remove(s);
  ...
  constructor(e, t) {
    this.subscription = e, this._tileIdToResult = /* @__PURE__ */ new Map(), this._controller = new AbortController(), this._handles = ke([xe(e.signal, () => this._controller.abort()), xe(t, () => this._controller.abort())]);
  }
  destroy() {
  ...
  async load(e) {
    this._loadStates.has(e.key.id) || this._loadStates.set(e.key.id, new Gi(e, this._options));
    const t = this._loadStates.get(e.key.id);
    let s;
    try {
      for await (const i of this._fetchChunkInfos(t, e.tile, 0)) {
        const { queryJSON: n, reader: a, sourceTile: d, sourceTileDepth: u, tile: l } = i, c = new At(a, n, l, d, u, !1);
        K(t.options), this._addChunk(c);
      }
    } catch (i) {
      s = i;
    }
    const r = new At(q.empty(this._metadata), null, e.tile, null, -1, !0);
  ...
  async *_fetchChunkInfos(e, t, s) {
    let r = e.get(t.id);
    const i = !!r;
    if (r || (r = await this._fetchChunkInfo(e, t, s), e.set(t.id, r)), r.reader.exceededTransferLimit && s < w("featurelayer-query-max-depth")) for (const n of t.createChildTiles()) yield* this._fetchChunkInfos(e, n, s + 1);
    else i || (yield r);
  }
  ...
  constructor(e, t) {
    this.subscription = e, this._pages = /* @__PURE__ */ new Set(), this._controller = new AbortController(), this._done = !1, this._handles = ke([xe(e.signal, () => this._controller.abort()), xe(t, () => this._controller.abort())]);
  }
  destroy() {
    this._controller.abort(), this._handles.remove();
  }
  ...
  async load(e) {
    this._loadStates.has(e.key.id) || this._loadStates.set(e.key.id, new Bi(e, this._options));
    const t = this._loadStates.get(e.key.id);
    let s;
    try {
    ...
    const r = new Pt(q.empty(this._metadata), null, e.tile, -1, !0);
    if (br(t.options) || this._addChunk(r), s) throw s;
  }
  unload(e) {
    super.unload(e), this._loadStates.get(e.key.id)?.destroy(), this._loadStates.delete(e.key.id);
  }
  async _fetchPages(e) {
    ...
    for (; r < 20 && !e.done; ) {
      const a = [];
      for (let u = 0; u < n; u++) a.push(this._fetchChunk(e, i++));
      const d = await Promise.all(a);
      for (const u of d) (u.size() !== 0 || u.first) && (e.add(u.page, !u.reader.exceededTransferLimit), K(e.options), this._addChunk(u));
      r++, n = Math.min(n + 1, 4);
    }
  }
  async _fetchChunk(e, t) {
    ...
    return new Pt(i, r.inner.toJSON(), s, t, !1);
  }
}, h;
...
function b(o) {
  oe === D.length && D.push(D.length + 1);
  const e = oe;
  return oe = D[e], D[e] = o, e;
}
const js = typeof TextDecoder < "u" ? new TextDecoder("utf-8", { ignoreBOM: !0, fatal: !0 }) : { decode: () => {
  throw Error("TextDecoder not available");
} };
typeof TextDecoder < "u" && js.decode();
let ne = null;
function we() {
  return ne !== null && ne.byteLength !== 0 || (ne = new Uint8Array(h.memory.buffer)), ne;
}
function Z(o, e) {
  return o >>>= 0, js.decode(we().subarray(o, o + e));
}
const jt = typeof FinalizationRegistry > "u" ? { register: () => {
}, unregister: () => {
} } : new FinalizationRegistry((o) => {
  h.__wbindgen_export_0.get(o.dtor)(o.a, o.b);
});
function Yi(o, e, t, s) {
  const r = { a: o, b: e, cnt: 1, dtor: t }, i = (...n) => {
    r.cnt++;
    const a = r.a;
    r.a = 0;
    try {
      ...
      --r.cnt == 0 ? (h.__wbindgen_export_0.get(r.dtor)(a, r.b), jt.unregister(r)) : r.a = a;
    }
  };
  return i.original = r, jt.register(i, r, r), i;
}
function Qi(o, e, t) {
  h._dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h7be72b1871260ae2(o, e, b(t));
}
function Hi() {
  h.enableTracing();
}
let j = 0;
const Ie = typeof TextEncoder < "u" ? new TextEncoder("utf-8") : { encode: () => {
  throw Error("TextEncoder not available");
} }, Zi = typeof Ie.encodeInto == "function" ? function(o, e) {
  return Ie.encodeInto(o, e);
} : function(o, e) {
  const t = Ie.encode(o);
...
function ce(o, e, t) {
  if (t === void 0) {
    const a = Ie.encode(o), d = e(a.length, 1) >>> 0;
    return we().subarray(d, d + a.length).set(a), j = a.length, d;
  }
  let s = o.length, r = e(s, 1) >>> 0;
  const i = we();
  let n = 0;
  for (; n < s; n++) {
    const a = o.charCodeAt(n);
    if (a > 127) break;
    i[r + n] = a;
  }
  if (n !== s) {
    n !== 0 && (o = o.slice(n)), r = t(r, s, s = n + 3 * o.length, 1) >>> 0;
    const a = we().subarray(r + n, r + s);
    n += Zi(o, a).written, r = t(r, s, n, 1) >>> 0;
  }
  return j = n, r;
}
let N = null;
function ee() {
  return (N === null || N.buffer.detached === !0 || N.buffer.detached === void 0 && N.buffer !== h.memory.buffer) && (N = new DataView(h.memory.buffer)), N;
}
function z(o, e) {
  try {
    return o.apply(this, e);
  } catch (t) {
    h.__wbindgen_exn_store(b(t));
  }
}
function Ji(o, e, t, s) {
  h.wasm_bindgen__convert__closures__invoke2_mut__h35729c14da098d24(o, e, b(t), b(s));
}
let ae = null;
function Ki() {
  return ae !== null && ae.byteLength !== 0 || (ae = new Uint16Array(h.memory.buffer)), ae;
}
function Dt(o, e) {
  const t = e(2 * o.length, 2) >>> 0;
  return Ki().set(o, t / 2), j = o.length, t;
}
function Ds(o, e, t) {
  const s = ce(o, h.__wbindgen_malloc, h.__wbindgen_realloc), r = j;
  return U(h.readMetadata(s, r, b(e), b(t)));
}
function Lt(o, e) {
  if (!(o instanceof e)) throw new Error(`expected instance of ${e.name}`);
  return o.ptr;
}
function en(o, e, t, s, r) {
  const i = ce(o, h.__wbindgen_malloc, h.__wbindgen_realloc), n = j;
  Lt(s, re);
  var a = s.__destroy_into_raw();
  Lt(r, te);
  var d = r.__destroy_into_raw();
  return U(h.readFile(i, n, b(e), b(t), a, d));
}
function Ue(o) {
  return o == null;
}
...
} } : new FinalizationRegistry((o) => h.__wbg_fieldmetadata_free(o >>> 0, 1));
class Oe {
  static __wrap(e) {
    e >>>= 0;
    const t = Object.create(Oe.prototype);
    return t.__wbg_ptr = e, zt.register(t, t.__wbg_ptr, t), t;
  }
  __destroy_into_raw() {
    const e = this.__wbg_ptr;
    return this.__wbg_ptr = 0, zt.unregister(this), e;
  }
  free() {
    const e = this.__destroy_into_raw();
    h.__wbg_fieldmetadata_free(e, 0);
  }
  get name() {
    let e, t;
    try {
      const i = h.__wbindgen_add_to_stack_pointer(-16);
      h.fieldmetadata_name(i, this.__wbg_ptr);
      var s = ee().getInt32(i + 0, !0), r = ee().getInt32(i + 4, !0);
      return e = s, t = r, Z(s, r);
    } finally {
      h.__wbindgen_add_to_stack_pointer(16), h.__wbindgen_free(e, t, 1);
    }
  }
  get index() {
    return h.fieldmetadata_index(this.__wbg_ptr);
  }
  get type() {
    return ["esriFieldTypeSmallInteger", "esriFieldTypeInteger", "esriFieldTypeBigInteger", "esriFieldTypeSingle", "esriFieldTypeDouble", "esriFieldTypeLong", "esriFieldTypeString", "esriFieldTypeDate", "esriFieldTypeOID", "esriFieldTypeGeometry", "esriFieldTypeBlob", "esriFieldTypeRaster", "esriFieldTypeGUID", "esriFieldTypeGlobalID", "esriFieldTypeXML", "esriFieldTypeDateOnly", "esriFieldTypeTimeOnly", "esriFieldTypeTimestampOffset"][h.fieldmetadata_esri_type(this.__wbg_ptr)];
  }
}
const Ut = typeof FinalizationRegistry > "u" ? { register: () => {
}, unregister: () => {
} } : new FinalizationRegistry((o) => h.__wbg_filemetadata_free(o >>> 0, 1));
class re {
  static __wrap(e) {
    e >>>= 0;
    const t = Object.create(re.prototype);
    return t.__wbg_ptr = e, Ut.register(t, t.__wbg_ptr, t), t;
  }
  __destroy_into_raw() {
    const e = this.__wbg_ptr;
  ...
  free() {
    const e = this.__destroy_into_raw();
    h.__wbg_filemetadata_free(e, 0);
  }
  version() {
    return h.filemetadata_version(this.__wbg_ptr);
  }
  numRows() {
    return h.filemetadata_numRows(this.__wbg_ptr) >>> 0;
  }
  numFields() {
    return h.filemetadata_numFields(this.__wbg_ptr) >>> 0;
  }
  keyValueMetadata(e) {
    try {
      const r = h.__wbindgen_add_to_stack_pointer(-16), i = ce(e, h.__wbindgen_malloc, h.__wbindgen_realloc), n = j;
      h.filemetadata_keyValueMetadata(r, this.__wbg_ptr, i, n);
      var t = ee().getInt32(r + 0, !0), s = ee().getInt32(r + 4, !0);
      let a;
      return t !== 0 && (a = Z(t, s).slice(), h.__wbindgen_free(t, 1 * s, 1)), a;
    } finally {
      h.__wbindgen_add_to_stack_pointer(16);
    }
  }
  getFieldIndex(e) {
    const t = ce(e, h.__wbindgen_malloc, h.__wbindgen_realloc), s = j, r = h.filemetadata_getFieldIndex(this.__wbg_ptr, t, s);
    return r === 16777215 ? void 0 : r;
  }
  getFieldByIndex(e) {
    const t = h.filemetadata_getFieldByIndex(this.__wbg_ptr, e);
    return t === 0 ? void 0 : Oe.__wrap(t);
  }
}
const Wt = typeof FinalizationRegistry > "u" ? { register: () => {
}, unregister: () => {
} } : new FinalizationRegistry((o) => h.__wbg_geometryinfodescriptor_free(o >>> 0, 1));
class te {
  static __wrap(e) {
    e >>>= 0;
  ...
  free() {
    const e = this.__destroy_into_raw();
    h.__wbg_geometryinfodescriptor_free(e, 0);
  }
  get wkbIndex() {
    const e = h.__wbg_get_geometryinfodescriptor_wkbIndex(this.__wbg_ptr);
    return e === 16777215 ? void 0 : e;
  }
  set wkbIndex(e) {
    h.__wbg_set_geometryinfodescriptor_wkbIndex(this.__wbg_ptr, Ue(e) ? 16777215 : e);
  }
  get lngIndex() {
    const e = h.__wbg_get_geometryinfodescriptor_lngIndex(this.__wbg_ptr);
    return e === 16777215 ? void 0 : e;
  }
  set lngIndex(e) {
    h.__wbg_set_geometryinfodescriptor_lngIndex(this.__wbg_ptr, Ue(e) ? 16777215 : e);
  }
  get latIndex() {
    const e = h.__wbg_get_geometryinfodescriptor_latIndex(this.__wbg_ptr);
    return e === 16777215 ? void 0 : e;
  }
  set latIndex(e) {
    h.__wbg_set_geometryinfodescriptor_latIndex(this.__wbg_ptr, Ue(e) ? 16777215 : e);
  }
  static new() {
    const e = h.geometryinfodescriptor_new();
    return te.__wrap(e);
  }
}
const Gt = typeof FinalizationRegistry > "u" ? { register: () => {
}, unregister: () => {
} } : new FinalizationRegistry((o) => h.__wbg_parquetchunk_free(o >>> 0, 1));
class Re {
  static __wrap(e) {
    e >>>= 0;
    const t = Object.create(Re.prototype);
  ...
  free() {
    const e = this.__destroy_into_raw();
    h.__wbg_parquetchunk_free(e, 0);
  }
  size() {
    return h.parquetchunk_size(this.__wbg_ptr) >>> 0;
  }
  hasField(e) {
    return h.parquetchunk_hasField(this.__wbg_ptr, e) !== 0;
  }
  readX(e) {
    return h.parquetchunk_readX(this.__wbg_ptr, e);
  }
  readY(e) {
    return h.parquetchunk_readY(this.__wbg_ptr, e);
  }
  readAttributes(e) {
    return U(h.parquetchunk_readAttributes(this.__wbg_ptr, e));
  }
  readAttribute(e, t) {
    return U(h.parquetchunk_readAttribute(this.__wbg_ptr, e, t));
  }
}
const Nt = typeof FinalizationRegistry > "u" ? { register: () => {
}, unregister: () => {
} } : new FinalizationRegistry((o) => h.__wbg_parquetfile_free(o >>> 0, 1));
let Ls = class zs {
  static __wrap(e) {
    e >>>= 0;
    const t = Object.create(zs.prototype);
    return t.__wbg_ptr = e, Nt.register(t, t.__wbg_ptr, t), t;
  }
  __destroy_into_raw() {
    const e = this.__wbg_ptr;
  ...
  free() {
    const e = this.__destroy_into_raw();
    h.__wbg_parquetfile_free(e, 0);
  }
  metadata() {
    const e = h.parquetfile_metadata(this.__wbg_ptr);
    return re.__wrap(e);
  }
  readChunksWithCallback(e, t) {
    const s = Dt(e, h.__wbindgen_malloc), r = j;
    return U(h.parquetfile_readChunksWithCallback(this.__wbg_ptr, s, r, b(t)));
  }
  updateChunks(e) {
    const t = Dt(e, h.__wbindgen_malloc), s = j;
    return U(h.parquetfile_updateChunks(this.__wbg_ptr, t, s));
  }
};
const Bt = typeof FinalizationRegistry > "u" ? { register: () => {
}, unregister: () => {
} } : new FinalizationRegistry((o) => h.__wbg_rangeproviderjs_free(o >>> 0, 1));
class de {
  static __wrap(e) {
    e >>>= 0;
  ...
  free() {
    const e = this.__destroy_into_raw();
    h.__wbg_rangeproviderjs_free(e, 0);
  }
  static new(e, t) {
    const s = h.rangeproviderjs_new(b(e), b(t));
    return de.__wrap(s);
  }
  static withFetch() {
    const e = h.rangeproviderjs_withFetch();
    return de.__wrap(e);
  }
}
async function tn(o, e) {
  if (typeof Response == "function" && o instanceof Response) {
    if (typeof WebAssembly.instantiateStreaming == "function") try {
      ...
      if (o.headers.get("Content-Type") == "application/wasm") throw s;
...
function Us() {
  const o = { wbg: {} };
  return o.wbg.__wbg_new_abda76e883ba8a5f = function() {
    return b(new Error());
  }, o.wbg.__wbg_stack_658279fe44541cf6 = function(e, t) {
    const s = ce(I(t).stack, h.__wbindgen_malloc, h.__wbindgen_realloc), r = j;
    ee().setInt32(e + 4, r, !0), ee().setInt32(e + 0, s, !0);
  }, o.wbg.__wbg_error_f851667af71bcfc6 = function(e, t) {
    let s, r;
    try {
      s = e, r = t, console.error(Z(e, t));
    } finally {
      h.__wbindgen_free(s, r, 1);
    }
  }, o.wbg.__wbindgen_object_drop_ref = function(e) {
    U(e);
  }, o.wbg.__wbindgen_is_function = function(e) {
    return typeof I(e) == "function";
  }, o.wbg.__wbg_self_3093d5d1f7bcb682 = function() {
    return z(function() {
      return b(self.self);
    }, arguments);
  }, o.wbg.__wbg_window_3bcfc4d31bc012f8 = function() {
    return z(function() {
      return b(window.window);
    }, arguments);
  }, o.wbg.__wbg_globalThis_86b222e13bdf32ed = function() {
    return z(function() {
      return b(globalThis.globalThis);
    }, arguments);
  }, o.wbg.__wbg_global_e5a3fe56f8be9485 = function() {
    return z(function() {
      return b(global.global);
    }, arguments);
  }, o.wbg.__wbindgen_is_undefined = function(e) {
    return I(e) === void 0;
  }, o.wbg.__wbg_newnoargs_76313bd6ff35d0f2 = function(e, t) {
    return b(new Function(Z(e, t)));
  }, o.wbg.__wbindgen_object_clone_ref = function(e) {
    return b(I(e));
  }, o.wbg.__wbindgen_number_new = function(e) {
    return b(e);
  }, o.wbg.__wbg_new_525245e2b9901204 = function() {
    return b(new Object());
  }, o.wbg.__wbindgen_string_new = function(e, t) {
    return b(Z(e, t));
  }, o.wbg.__wbg_call_1084a111329e68ce = function() {
    return z(function(e, t) {
      return b(I(e).call(I(t)));
    }, arguments);
  }, o.wbg.__wbg_call_89af060b4e1523f2 = function() {
    return z(function(e, t, s) {
      return b(I(e).call(I(t), I(s)));
    }, arguments);
  }, o.wbg.__wbg_call_7de908392845a9a5 = function() {
    return z(function(e, t, s, r, i) {
      return b(I(e).call(I(t), I(s), I(r), I(i)));
    }, arguments);
  }, o.wbg.__wbg_valueOf_563b3487b1b116aa = function(e) {
    return I(e).valueOf();
  }, o.wbg.__wbg_set_eacc7d73fefaafdf = function() {
    return z(function(e, t, s) {
      return Reflect.set(I(e), I(t), I(s));
    }, arguments);
  }, o.wbg.__wbg_buffer_b7b08af79b0b0974 = function(e) {
    return b(I(e).buffer);
  }, o.wbg.__wbg_new_b85e72ed1bfd57f9 = function(e, t) {
    try {
      var s = { a: e, b: t }, r = (i, n) => {
        const a = s.a;
        s.a = 0;
      ...
      return b(new Promise(r));
    } finally {
      s.a = s.b = 0;
    }
  }, o.wbg.__wbg_resolve_570458cb99d56a43 = function(e) {
    return b(Promise.resolve(I(e)));
  }, o.wbg.__wbg_then_95e6edc0f89b73b1 = function(e, t) {
    return b(I(e).then(I(t)));
  }, o.wbg.__wbg_then_876bb3c633745cc6 = function(e, t, s) {
    return b(I(e).then(I(t), I(s)));
  }, o.wbg.__wbg_new_ea1883e1e5e86686 = function(e) {
    return b(new Uint8Array(I(e)));
  }, o.wbg.__wbg_length_8339fcf5d8ecd12e = function(e) {
    return I(e).length;
  }, o.wbg.__wbg_set_d1e79e2388520f18 = function(e, t, s) {
    I(e).set(I(t), s >>> 0);
  }, o.wbg.__wbindgen_throw = function(e, t) {
    throw new Error(Z(e, t));
  }, o.wbg.__wbindgen_memory = function() {
    return b(h.memory);
  }, o.wbg.__wbg_queueMicrotask_48421b3cc9052b68 = function(e) {
    return b(I(e).queueMicrotask);
  }, o.wbg.__wbindgen_cb_drop = function(e) {
    const t = U(e).original;
    return t.cnt-- == 1 ? (t.a = 0, !0) : !1;
  }, o.wbg.__wbg_queueMicrotask_12a30234db4045d3 = function(e) {
    queueMicrotask(I(e));
  }, o.wbg.__wbg_parquetchunk_new = function(e) {
    return b(Re.__wrap(e));
  }, o.wbg.__wbindgen_bigint_from_i64 = function(e) {
    return b(e);
  }, o.wbg.__wbg_parquetfile_new = function(e) {
    return b(Ls.__wrap(e));
  }, o.wbg.__wbg_filemetadata_new = function(e) {
    return b(re.__wrap(e));
  }, o.wbg.__wbindgen_closure_wrapper1401 = function(e, t, s) {
    return b(Yi(e, t, 74, Qi));
  }, o;
}
function Ws(o, e) {
  return h = o.exports, Gs.__wbindgen_wasm_module = e, N = null, ae = null, ne = null, h;
}
function sn(o) {
  ...
  const e = Us();
  return o instanceof WebAssembly.Module || (o = new WebAssembly.Module(o)), Ws(new WebAssembly.Instance(o, e), o);
}
async function Gs(o) {
  if (h !== void 0) return h;
  o !== void 0 && Object.getPrototypeOf(o) === Object.prototype ? { module_or_path: o } = o : console.warn("using deprecated parameters for the initialization function; pass a single object instead");
  const e = Us();
  (typeof o == "string" || typeof Request == "function" && o instanceof Request || typeof URL == "function" && o instanceof URL) && (o = fetch(o));
  const { instance: t, module: s } = await tn(await o, e);
  return Ws(t, s);
}
const rn = Object.freeze(Object.defineProperty({ __proto__: null, FieldMetadata: Oe, FileMetadata: re, GeometryInfoDescriptor: te, ParquetChunk: Re, ParquetFile: Ls, RangeProviderJs: de, default: Gs, enableTracing: Hi, initSync: sn, readFile: en, readMetadata: Ds }, Symbol.toStringTag, { value: "Module" }));
let We = null;
async function Ns() {
  return We || (We = nn()), We;
}
async function nn() {
  const o = await Promise.resolve().then(() => rn);
  return await o.default({ module_or_path: wr("esri/libs/parquet/pkg/arcgis_parquet_bg.wasm") }), o.enableTracing(), o;
}
const Bs = (o) => async function(e, t, s) {
  const r = o(), { data: i } = await nt(e, { responseType: "array-buffer", query: r, headers: { range: `bytes=${t}-${s}` } });
  return i;
}, Vs = (o) => async function(e) {
  const t = o(), { data: s } = await nt(e, { responseType: "native", method: "head", query: t }), r = s.headers.get("Content-Length");
  if (r == null) throw new Error("Unable to parse content length");
  return parseInt(r, 10);
};
class Se {
  static async create(e, t) {
    const s = await Ns(), r = await s.readMetadata(e, Bs(t), Vs(t));
    return Se.fromFileMetadata(r);
  }
  static fromFileMetadata(e) {
    const t = [];
    for (let s = 0; s < e.numFields(); s++) {
      const r = e.getFieldByIndex(s);
      t.push({ name: r.name, type: r.type, alias: r.name, index: r.index }), r.free();
    }
    return new Se(e, t);
  }
  constructor(e, t) {
    this._inner = e, this.fields = t;
  }
  destroy() {
    this._inner.free();
  }
  ...
  getFieldIndex(e) {
    return this._inner.getFieldIndex(e);
  }
  tryReadGeoMetadata() {
    const e = this._inner.keyValueMetadata("geo");
    return e == null ? null : JSON.parse(e);
  }
}
class pt {
  static async create(e, t) {
    const s = await Ns(), r = Bs(t.getCustomParameters), i = Vs(t.getCustomParameters), n = await Ds(e, r, i), { geometryInfo: a } = t, d = te.new();
    a.type === "location" ? (d.latIndex = n.getFieldIndex(a.latitudeFieldName), d.lngIndex = n.getFieldIndex(a.longitudeFieldName)) : d.wkbIndex = n.getFieldIndex(a.primaryFieldName);
    const u = await s.readFile(e, r, i, n, d);
    return new pt(u, Se.fromFileMetadata(u.metadata()));
  }
  constructor(e, t) {
    this.inner = e, this.metadata = t;
  }
  destroy() {
...
let Fe = class extends he {
...
}, an = class Xs extends Ce {
  constructor(e, t, s, r, i, n = new Uint32Array(r.size())) {
    super(e), this._fields = t, this._geometryInfo = s, this._inner = r, this._chunkId = i, this._displayIds = n, this._index = -1, this._size = this._inner.size(), this._geometryInfo.type === "geometry" && (this._primaryGeometryIndex = this._fields.get(this._geometryInfo.primaryFieldName)?.index), e.objectIdField != null && (this._objectIdFieldIndex = this._fields.get(e.objectIdField)?.index), this._chunkId > 65535 && console.error("Exceeded max allowed parquet reader size");
  }
  destroy() {
  ...
  getObjectId() {
    return this._objectIdFieldIndex != null ? this._inner.readAttribute(this._index, this._objectIdFieldIndex) : this._index << 16 | this._chunkId;
  }
  getDisplayId() {
  ...
  copy() {
    const e = new Xs(this.metadata, this._fields, this._geometryInfo, this._inner, this._chunkId, this._displayIds);
    return this.copyInto(e), e;
  }
  copyInto(e) {
  ...
  _readGeometry(e) {
    const t = Ir(this._inner.readX(this._index), this._inner.readY(this._index));
    return new M([], t);
  }
  _readX() {
  ...
  _readAttribute(e, t) {
    ...
    if (!s) return;
    const r = this._inner.readAttribute(this._index, s.index);
    if (r == null) return r;
    const i = this.fields.isDateField(s.name);
    return t ? r == null ? r : i ? new Date(r) : r : r;
  }
  _readAttributes() {
    const e = {};
    for (const t of this._fields.fields) this._inner.hasField(t.index) && t.index !== this._primaryGeometryIndex && (e[t.name] = this._readAttribute(t.name, !1));
    return this._objectIdFieldIndex == null && (e.__OBJECTID = this.getObjectId()), e;
  }
};
class on extends gt {
  constructor(e, t, s, r) {
    super(r), this._service = e, this._metadata = t, this._schema = s, this._chunkId = 0, this._files = [], this._availableFields = new Set(s.mutable.availableFields);
    const { geometryInfo: i } = this._service;
    i.type === "location" ? (this._availableFields.add(i.latitudeFieldName), this._availableFields.add(i.longitudeFieldName)) : this._availableFields.add(i.primaryFieldName);
  }
  destroy() {
  ...
  async updateFields(e) {
    await this._promise;
    const t = new Set(e), s = vr(t, this._availableFields);
    this._availableFields = xr(s, this._availableFields), await Promise.all(this._files.map((r) => {
      const i = Array.from(s).map((n) => r.metadata.getFieldIndex(n));
      return r.inner.updateChunks(new Uint16Array(i));
    }));
  }
  async load(e) {
    return this._promise == null && (this._promise = this._download()), this._promise;
  }
  unload(e) {
  }
  async addParquetFile(e) {
  ...
  async _insert(e) {
    const t = await pt.create(e, { geometryInfo: this._service.geometryInfo, outSpatialReference: this._service.outSpatialReference, getCustomParameters: () => this._schema.mutable.dataFilter.customParameters }), { geometryInfo: s } = this._service;
    K(this._options);
    const { fields: r, timeZoneByFieldName: i } = this._service.metadata.fieldsIndex, n = r.map((u) => ({ ...u, index: t.metadata.getFieldIndex(u.name) })), a = le.fromJSON({ fields: n, timeZoneByFieldName: i }), d = new Uint16Array(Array.from(this._availableFields.values()).map((u) => a.get(u)?.index));
    await t.inner.readChunksWithCallback(d, (u) => {
      const l = this._chunkId++, c = new an(this._metadata, a, s, u, l), _ = new Fe(c, null, l, !1);
      this._store.insert(_);
    }), this._files.push(t);
  }
  async _download() {
    try {
      await Promise.all(this._service.source.urls.map((t) => this._insert(t)));
      const e = new Fe(q.empty(this._metadata), null, -1, !0);
...
class dn extends As {
  constructor(e, t, s, r, i, n) {
    super(e, t, s, i, n), this._random = new ns(1e3), this._featureCount = r;
  }
  get about() {
    return { willQueryAllFeatures: !0, willQueryFullResolutionGeometry: !0 };
  }
  ...
  async _downloadPages(e) {
    const t = Math.ceil(e / this._queryInfo.pageSize), s = Array.from({ length: t }, (a, d) => d).sort((a, d) => this._random.getInt() - this._random.getInt()), r = await Promise.all(s.map((a) => this._downloadPage(a))), i = new Fe(q.empty(this._metadata), null, -1, !0);
    this._store.insert(i);
    const n = r.filter((a) => a);
    if (n.length) throw new B("featurelayer-query", "Encountered errors when downloading data", { errors: n });
  }
  async _downloadPage(e) {
    try {
      const t = this._queryInfo.createPagedQuery(e), s = await this._fetch(t, this._options), r = new Fe(s, t.inner.toJSON(), e, !1);
      return K(this._options), this._store.insert(r), null;
    } catch (t) {
      return t;
    }
  }
}
const un = "__esri_stream_id__", Vt = "__esri_timestamp__", Xt = 1e3;
class cn {
  constructor(e, t, s, r, i = 128) {
    this._trackIdToObservations = /* @__PURE__ */ new Map(), this._idCounter = 0, this._lastPurge = performance.now(), this._addOrUpdated = /* @__PURE__ */ new Map(), this._removed = [], this._maxAge = 0, this._timeInfo = s, this._purgeOptions = r, this.store = e, this.objectIdField = t, this.purgeInterval = i, this._useGeneratedIds = this.objectIdField === un;
  }
  removeById(e) {
  ...
  add(e) {
    ...
    const t = e.objectId;
    if (this._addOrUpdated.set(t, e), this._maxAge = Math.max(this._maxAge, e.attributes[this._timeInfo.startTimeField]), !this._timeInfo.trackIdField) return this._trackIdLessObservations == null && (this._trackIdLessObservations = new xt(1e5)), void this._trackIdLessObservations.enqueue(t);
    const s = e.attributes[this._timeInfo.trackIdField];
    if (!this._trackIdToObservations.has(s)) {
      const n = this._purgeOptions?.maxObservations != null ? this._purgeOptions.maxObservations : Xt, a = Sr(n, 0, Xt);
      this._trackIdToObservations.set(s, new xt(a));
    }
  ...
  checkForUpdates() {
    ...
    if (e != null) {
      const n = new Set(t ?? []);
      for (const a of e) n.has(a.objectId) || (a.attributes[Vt] = s, this.store.add(a), i.push(a));
    }
  ...
  _purgeByAgeReceived(e, t) {
    ...
    this.store.forEach((r) => {
      r.attributes[Vt] < s && this._removed.push(r.objectId);
    });
  }
  _purgeTracks() {
...
H([ye()], Y.prototype, "connection", void 0), H([ye()], Y.prototype, "connectionStatus", null), H([ye()], Y.prototype, "errorString", null), Y = H([ts("esri.views.2d.layers.features.sources.StreamConnectionState")], Y);
let ln = class {
  constructor(e, t) {
  ...
  get reader() {
    return q.fromFeatures([...this._objectIdToFeature.values()], this._metadata);
  }
  add(e) {
...
class _n extends gt {
  constructor(e, t, s, r, i) {
    super(s), this._service = e, this._dataFilter = t, this._streamOptions = r, this._metadata = i, this._connectionState = new Y(), this._forceRefresh = !1, this.events = new st();
    const { objectIdField: n, timeInfo: a } = this._metadata, { purgeOptions: d } = t;
    this._stagingStore = new ln(this._metadata, (u) => this.events.emit("features-updated", u)), this._manager = new cn(this._stagingStore, n, a, d), this.connect();
  }
  destroy() {
  ...
  async refresh() {
    ...
    this._manager.checkForUpdates() || !e || this._forceRefresh ? (this._chunk && this._store.remove(this._chunk), this._forceRefresh = !1, this._chunk = new hn(this._stagingStore.reader), this._store.insert(this._chunk), this.events.emit("tick")) : this.events.emit("tick");
  }
  async updateFields(e) {
  ...
  disconnect() {
    this._connection = Kt(this._connection), this._connectionState.connection = null, this._handlesGroup?.remove();
  }
  connect() {
    ...
    this._connection = zr(this._service.source, t, this._streamOptions.outSR, e, n, i, s, r, a), this._handlesGroup = ke([this._connection.on("data-received", (d) => this._onFeature(d)), this._connection.on("message-received", (d) => this._onWebSocketMessage(d))]), this._connectionState.connection = this._connection;
  }
  clear() {
...
class gn {
  constructor(e) {
    this._onChange = e, this._chunks = /* @__PURE__ */ new Map(), this._chunksToRemove = [], this.events = new st(), this.featureAdapter = new Pr();
  }
  destroy() {
    this.clear();
  }
  ...
  *chunks() {
  ...
  insert(e) {
    w("esri-2d-update-debug") && console.debug(`Chunk[${e.chunkId}] SourceChunkStore.insert`), this._localOverridesChunk?.overriddenIds.size && (e.reader.removeIds(this._localOverridesChunk.overriddenIds), e.invalidate()), this._localEditChunk?.overriddenIds.size && this._localEditChunk.removeOverrides(e), this._chunks.set(e.chunkId, e), this.events.emit("changed"), this._onChange();
  }
  remove(e) {
    w("esri-2d-update-debug") && console.debug(`Chunk[${e.chunkId}] SourceChunkStore.remove`), this._chunks.delete(e.chunkId), this._chunksToRemove.push(e);
  }
  ...
  applyLocalOverrides(e, t) {
    this._localOverridesChunk == null && (this._localOverridesChunk = new Je(t, "localOverride")), this._localOverridesChunk.applyOverrides(e);
    for (const s of this._chunks.values()) s.reader.removeIds(this._localOverridesChunk.overriddenIds), s.invalidate();
    this.events.emit("changed");
  }
  applyLocalEdit(e, t) {
    this._localEditChunk == null && (this._localEditChunk = new Je(t, "localEdit")), this._localEditChunk.applyOverrides(e);
...
class pn {
  constructor(e, t, s, r, i) {
    this.service = e, this._aggregateAdapter = t, this._subscriptions = s, this._onChange = r, this._connection = i, this._updateTracking = new Ur({ debugName: "FeatureSource" }), this._didInvalidateData = !1, this._store = new gn(this._onChange), this._metadata = ot.createFeature(e.metadata);
  }
  destroy() {
  ...
  get queryEngine() {
    if (!this._queryEngine) {
      ...
      this._queryEngine = new ds({ featureStore: this._store, fieldsIndex: s.fieldsIndex, geometryType: s.geometryType, objectIdField: s.objectIdField, hasM: !1, hasZ: !1, spatialReference: this.service.outSpatialReference, aggregateAdapter: this._aggregateAdapter, timeInfo: s.timeInfo, definitionExpression: e.definitionExpression, availableFields: t });
    }
  ...
  onResume(e) {
    this._updateTracking.addPromise(as(this._strategy?.load(e)));
  }
  onUnsubscribe(e) {
  ...
  async update(e, t) {
    const s = e.source, r = Jt(this._schema?.mutable, s.mutable);
    if (!r) return !1;
    if (w("esri-2d-update-debug") && console.debug(`Version[${t}] FeatureSource.update`, { changes: r }), this._schema = s, this._queryEngine?.destroy(), this._queryEngine = null, this.service.type === "feature-service" && this.service.queryMetadata.lastEditDate != null && (this._lastEditDate = this.service.queryMetadata.lastEditDate), this._streamMessenger == null && this._schema.type === "stream" && this._initStreamMessenger(), bt(r, "sourceRefreshVersion") && this._strategy?.refresh) return await this._strategy.refresh(), !0;
    if ((s.type === "feature" || s.type === "parquet") && bt(r, "availableFields")) {
    ...
    return !(!wt(r, "dataFilter") && !wt(r, "sourceRefreshVersion")) && (await this._updateStrategy(t), !0);
  }
  async addParquetFile(e) {
    this._strategy.addParquetFile(e);
  }
  _initStreamMessenger() {
    this._streamMessenger == null && (this._streamMessenger = new be(this._connection));
  }
  async _getGetLocalEdit(e) {
    if (e.historicMoment && this._schema.type === "feature" && (this._schema.mutable.dataFilter.historicMoment = e.historicMoment, this._strategy.unsafeSetQueryHistoricMoment(new Date(e.historicMoment))), e.type === "edit-by-feature") {
      const r = [...e.added, ...e.updated].map((i) => Q.fromJSON(i, this.metadata.objectIdField));
      return { reader: q.fromOptimizedFeatures(r, this.metadata), removed: this._resolveIdentifiers(e.removed) };
    }
    const t = this._resolveIdentifiers(e.removed);
    if (!e.updated.length && !e.added.length) return { reader: q.empty(this.metadata), removed: t };
  ...
  async _queryLastEditDateChanged() {
    ...
    const e = this.service.source, t = { ...e.query, f: "json" }, s = (await nt(e.path, { query: t, responseType: "json" })).data.editingInfo.lastEditDate;
  ...
  async _createStrategy() {
    ...
    if (this._schema.type === "stream") {
      const d = new _n(this.service, this._schema.mutable.dataFilter, this._store, { outSR: this.service.outSpatialReference }, this.metadata);
      return this._streamMessenger.strategy = d, d;
    }
    if (this._schema.type === "parquet") {
      const d = this.service;
      return new on(d, this._metadata, this._schema, this._store);
    }
    const i = this.service, n = Ci.fromSchema(i, this._schema, this._metadata), a = await this._supportSnapshotMode(i, n);
    return a ? new dn(i, n, this._store, a.featureCount, this.metadata, this._connection) : r ? new Vi(i, n, this._store, this.metadata, this._connection) : new Ni(i, n, this._store, this.metadata, this._connection);
  }
  async _updateStrategy(e) {
    ...
    this._store.clear(), this._strategy?.destroy(), this._strategy = t, w("esri-2d-update-debug") && console.debug(`Version[${e}] FeatureSource.updateStrategy`, { strategy: t });
    ...
    this._connection.onEvent({ type: "updateStrategyEnd" }), w("esri-2d-update-debug") && console.debug(`Version[${e}] FeatureSource.updateStrategyEnd`, { strategy: t });
  }
  async _supportSnapshotMode(e, t) {
    ...
    const a = (await Fr(i, n.inner, { query: n.customParameters })).data.count, { min: d, max: u } = r.snapshotCountThresholds;
    return a <= d || r.supportsSnapshotMaxThreshold && a < u ? { featureCount: a } : null;
  }
}
class fn {
  constructor(e, t) {
...
class ga {
  ...
  onAttach(e) {
    w("esri-2d-update-debug") && console.debug("Pipeline.onAttach");
    const t = this._connection, s = kr.fromJSON(e.tileInfoJSON);
    this._tileInfoView = new Cr(s), this._source = new pn(e.service, this._aggregateAdapter, this._subscriptions, () => this._requestUpdate(), t), this._processor = new Si(t, this._source), this._handles = ke([Ge(() => this._source.updateTracking.updating, () => {
      this._requestUpdate(), as(this._connection.layerView.setUpdating({ data: this._source.updateTracking.updating, pipeline: !0 }));
    })]);
  }
  onDetach() {
    w("esri-2d-update-debug") && console.debug("Pipeline.onDetach"), this.destroy();
  }
  set remoteClient(e) {
    this._connection = new Wr(e);
  }
  get features() {
    const e = this._source?.queryEngine;
    if (!e) throw new B("no-queryEngine", "No query engine defined");
    return e;
  }
  get aggregates() {
    const e = this._processor?.aggregateQueryEngine;
    if (!e) throw new B("no-queryEngine", "No aggregate query engine defined");
    return e;
  }
  get processor() {
  ...
  async updateSchema(e, t) {
    return w("esri-2d-update-debug") && this._updateSchemaRequest && console.error("InternalError: Schema already updating"), this._updateSchemaRequest = new fe({ schema: e, version: t }), this._requestUpdate(), this._updateSchemaRequest.resolver.promise;
  }
  ...
  async onEdits(e) {
    if (this._updateLocalEditsRequest != null) throw new B("InternalError - Already processing an edit");
    this._updateLocalEditsRequest = new fe(e);
  ...
  async queryHeatmapStatistics(e) {
    const t = Math.round(Tr(e.radius));
    let s = Number.POSITIVE_INFINITY, r = Number.NEGATIVE_INFINITY;
    const i = typeof e.fieldOffset == "string", n = e.fieldOffset ?? 0, a = Array.from(this._subscriptions.values()), d = this._source.chunks(), u = t ** 2, l = 3 / (Math.PI * u), c = 2 * t, _ = Math.ceil(T / c);
    for (const p of a) {
      const g = p.tile, y = new Float64Array(_ * _);
      for (const f of d) {
        const m = f.getTileReader(g);
        if (!m) continue;
        const v = m.getCursor();
        for (; v.next(); ) {
          let x = 1;
          if (e.field != null) {
            const P = v.readAttribute(e.field);
            x = i ? -1 * +P : +P + n;
          }
          const C = v.readXForDisplay() / c, E = v.readYForDisplay() / c, F = Math.floor(C), k = Math.floor(E);
          if (F < 0 || k < 0 || F >= _ || k >= _) continue;
          const S = ((0.5 + F - C) * c) ** 2 + ((0.5 + k - E) * c) ** 2;
          if (S > u) continue;
          const $ = x * (l * (1 - S / u) ** 2);
          y[k + F * _] += $;
        }
      }
      for (let f = 0; f < y.length; f++) s = Math.min(s, y[f]), r = Math.max(r, y[f]);
    }
    return { max: r, min: s };
  }
  async getSampleFeatures(e) {
    const t = this._source.chunks();
    if (t.reduce((d, u) => d + u.size(), 0) <= e.minFeatureCount) {
      if (!this._source.updateTracking.updating) {
        const d = [];
        return this._source.store.forEachUnsafe((u) => d.push(u.readLegacyFeatureWorldSpace())), d;
      }
      return null;
    }
    const s = /* @__PURE__ */ new Set(), r = [], i = t.map((d) => d.reader.getCursor()), n = new ns(), a = 3 * e.sampleSize;
    for (let d = 0; d < a && r.length < e.sampleSize; d++) {
      const u = i[n.getIntRange(0, t.length - 1)];
      if (u.getSize() === 0) continue;
      const l = n.getIntRange(0, u.getSize() - 1);
      u.setIndex(l);
      const c = u.getObjectId();
      s.has(c) || (s.add(c), r.push(u.readLegacyFeatureWorldSpace()));
    }
    return r.length >= e.sampleSize ? r : null;
  }
  _requestUpdate() {
    this._updateRequested || (this._updateRequested = !0, Mr(() => this._scheduleNextUpdate()));
  }
  _scheduleNextUpdate() {
    this._updateRequested && (this._ongoingUpdate || (this._ongoingUpdate = et(this._doUpdate()).finally(() => {
  ...
  _subscribe(e) {
    ...
    w("esri-2d-update-debug") && console.debug(`Tile[${t}] Pipeline.subscribe`);
    const s = new $r(this._tileInfoView, t), r = new fn(s, e.version);
    this._subscriptions.set(t, r), this._source.onSubscribe(r), this._processor.onSubscribe(r);
  }
  _unsubscribe(e) {
    const t = this._subscriptions.get(e);
    t && (w("esri-2d-update-debug") && console.debug(`Tile[${e}] Pipeline.unsubscribe`), t.abort(), this._source.onUnsubscribe(t), this._processor.onUnsubscribe(t), this._subscriptions.delete(t.key.id));
  }
  async _doUpdate() {
    if (w("esri-2d-update-debug") && console.debug("Pipeline._doUpdateStart"), await this._connection.layerView.setUpdating({ data: this._source.updateTracking.updating, pipeline: !0 }), this._updateSubscriptionRequests.length) {
    ...
    if (this._updateLocalEditsRequest = null, t != null) {
      w("esri-2d-update-debug") && console.debug("Pipeline.applyEditOverride", t.inner);
      const r = await this._source.getLocalEdit(t.inner);
      await this._processor.applyLocalEdit(r), this._source.applyLocalEdit(r), w("esri-2d-update-debug") && console.debug("Pipeline.endEditOverride", t.inner);
    }
    ...
    try {
      this._subscriptions.size && (w("esri-2d-update-debug") && console.debug("Pipeline.updateChunksStart"), await this._processor.updateChunks(), w("esri-2d-update-debug") && console.debug("Pipeline.updateChunksEnd"));
    } catch (r) {
      it(r);
    }
    t?.resolver.resolve(), e?.resolver.resolve(), this._updateRequested ? (w("esri-2d-update-debug") && console.debug("Pipeline._doUpdateEnd [updateRequested=true]"), await this._connection.layerView.setUpdating({ data: this._source.updateTracking.updating, pipeline: !0 })) : (w("esri-2d-update-debug") && console.debug("Pipeline._doUpdateEnd [updateRequested=false, After flush]"), await this._connection.layerView.setUpdating({ data: this._source.updateTracking.updating, pipeline: this._updateRequested }));
  }
  async _doUpdateSchema(e, t) {
    w("esri-2d-update-debug") && console.debug(`Version[${t}] Pipeline.updateStart`, { schema: e });
    const s = { tileInfo: this._tileInfoView?.tileInfo }, r = await this._source.update(e, t), i = Array.from(this._subscriptions.values());
    await this._processor.update(e, t, s, r, i), w("esri-2d-update-debug") && console.debug(`Version[${t}] Pipeline.updateEnd`);
  }
  _doUpdateSubscriptions(e) {
    w("esri-2d-update-debug") && console.debug("Pipeline.updateSubscriptions", e);
...
//# sourceMappingURL=FeaturePipelineWorker-CfiV4R9b.js.map
