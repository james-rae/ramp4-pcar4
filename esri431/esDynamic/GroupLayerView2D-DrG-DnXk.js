import { bQ as r, bR as a, d5 as o, bS as d, a8 as V, cz as l, f6 as y, d4 as w } from "./main-DZxT3i7S.js";
import { y as p, j as v } from "./LayerView-BSi2ZKlw.js";
let s = class extends p {
  ...
  _layerViewsChangeHandler(i) {
    this.removeHandles("grouplayerview:visible"), this.addHandles(this.layerViews.map((t) => l(() => t.visible, (n) => this._applyVisibility(() => {
      n !== this.visible && (t.visible = this.visible);
    }, () => this._applyExclusiveVisibility(n ? t : null)), y)).toArray(), "grouplayerview:visible");
...
r([a({ readOnly: !0 })], s.prototype, "creatingLayerViews", null), r([a({ cast: o })], s.prototype, "layerViews", null), r([a({ readOnly: !0 })], s.prototype, "updatingProgress", null), r([a()], s.prototype, "view", void 0), s = r([d("esri.views.layers.GroupLayerView")], s);
const u = s;
...
h = r([d("esri.views.2d.layers.GroupLayerView2D")], h);
const c = h;
export {
  c as default
};
//# sourceMappingURL=GroupLayerView2D-DrG-DnXk.js.map
