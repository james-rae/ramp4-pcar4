import { cd as F, dF as L, lq as W, dx as x, lr as z, ls as S, lt as B, lu as X, b7 as g, dD as N, dG as Q, lv as Y, aS as A, Q as y, hZ as J, lw as K, lx as ee, b8 as te, bf as se, dq as T, ly as re, lz as ie, lA as oe, ev as ae, dz as ne, cz as he, cF as de, gP as ce, lB as le, J as ue, be as pe, lC as me, bd as _e, lD as ye, lE as ge, lF as fe, jS as be, bQ as m, bR as _, bS as we, ew as Ie } from "./main-DZxT3i7S.js";
import { d as O, r as Se, u as j, Z as q, i as ve, W as xe, k as Re } from "./UpdateTracking2D-0o9_i8fH.js";
import { c as Me } from "./WGLContainer-CjZoexai.js";
import { M as Te, p as $e, b as Ge, n as Ce, s as ze, a as je } from "./AttributeStore-BzB5Tu2S.js";
import { n as Pe, I as Ue, y as ke, v as Oe, S as qe, V as Ee, u as Fe, m as Ae, x as P, b as De, c as Ve } from "./FeatureCommandQueue-Bd5Dxlq9.js";
import { a as He } from "./normalizeUtilsSync-BXiwJJN9.js";
async function Ze(r, e, t) {
  const s = [], i = { scaleInfo: Pe(r), scaleExpression: null };
  for (const o of e) switch (o.type) {
    case "marker":
      if (o.animationParams) {
        s.push(...Fe(t.instances.animatedMarker, o, P, i));
        break;
      }
      s.push(...Ae(t.instances.marker, o, P, i));
      break;
    case "fill":
      o.spriteRasterizationParam == null ? s.push(...qe(t.instances.fill, o, i)) : s.push(...Ee(t.instances.complexFill, o, !1, i));
      break;
    case "line":
      o.spriteRasterizationParam ? s.push(...ke(t.instances.texturedLine, o, !1, i)) : s.push(...Oe(t.instances.line, o, !1, i));
      break;
    case "text":
      s.push(...Ue(t.instances.text, o, P, i));
  }
  return s;
}
class $ extends Te {
  ...
  get geometryType() {
    const e = F(this._current.geometry);
  ...
  _readGeometry() {
    if (!this._cachedGeometry) {
      ...
      if (this.geometryType === "esriGeometryPolyline" && (e = W(new x(), e, this.hasZ, this.hasM, this.geometryType, this._tile.transform.scale[0])), this._cachedGeometry = z(new x(), e, this.hasZ, this.hasM, this.geometryType, this._tile.transform), !this._cachedGeometry) return null;
  ...
  _readServerCentroid() {
    switch (this.geometryType) {
      case "esriGeometryPolygon": {
        const e = X(this._current.projectedGeometry), t = new x([], e);
        return z(new x(), t, this.hasZ, this.hasM, this.geometryType, this._tile.transform);
      }
      case "esriGeometryPolyline": {
        const e = this._current.projectedGeometry, t = B(e.paths, this.hasZ), s = new x([], t);
        return z(new x(), s, this.hasZ, this.hasM, this.geometryType, this._tile.transform);
      }
    }
    return null;
  }
...
class U {
  static fromGraphic(e, t, s, i) {
    return new U(e.geometry, t, e.attributes, e.visible, e.uid, e.version, s, i);
  }
  constructor(e, t, s, i, o, a, n, l) {
    this.geometry = e, this.symbol = t, this.attributes = s, this.visible = i, this.objectId = o, this._version = a, this.zOrder = n, this.displayId = l, this.bounds = g(), this.prevBounds = g(), this.size = [0, 0, 0, 0];
  }
  get linearCIM() {
  ...
  get hasAnimations() {
    ...
    return !!e && e.some((t) => "animationParams" in t && !!t.animationParams);
  }
  update(e, t, s) {
    return (this._version !== e.version || this.zOrder !== s || this.symbol !== t) && (this.prevBounds = this.bounds, this.bounds = g(), this.zOrder = s, this.geometry = e.geometry, this.attributes = e.attributes, this.symbol = t, this.visible = e.visible, this._version = e.version, this.symbolResource = null, this.projectedGeometry = null, !0);
  }
  async projectAndNormalize(e) {
    let t = this.geometry;
    if (!t || !t.spatialReference || t.type === "mesh") return;
    t.type === "extent" && (t = O(t)), await N(t.spatialReference, e);
    const s = He(t);
    if (!s) return;
    const i = Q(s, t.spatialReference, e);
    i && Y(i), this.projectedGeometry = A(i) ? O(i) : i;
  }
}
class Le {
  constructor(e, t, s) {
...
class Be {
  constructor(e, t, s, i, o) {
    this._items = /* @__PURE__ */ new Map(), this._boundsDirty = !1, this._outSpatialReference = e, this._cimResourceManager = t, this._hittestDrawHelper = new Se(t), this._tileInfoView = s, this._store = o;
  ...
  async update(e, t, s) {
    ...
    for (const h of e.items) {
      ...
      const b = this._store.createDisplayIdForObjectId(c), w = U.fromGraphic(h, f, d, b);
    ...
    return await Promise.all(l), this._index = null, new Le(i, o, a);
  }
  updateLevel(e) {
    this._resolution !== e && (this._index = null, this._boundsDirty = !0, this._resolution = e);
  }
  hitTest(e, t, s, i, o) {
    const a = y("esri-mobile"), n = a ? re : ie, l = n + (a ? 0 : oe);
    e = J(e, this._tileInfoView.spatialReference);
    ...
    const f = 0.5 * i * (l + j), b = this._searchIndex(e - f, t - f, e + f, t + f);
    if (!b || b.length === 0) return [];
    const w = [], k = g(), R = g();
    for (const I of b) {
      if (!I.visible) continue;
      const { projectedGeometry: C, symbolResource: M } = I;
      this._getSymbolBounds(k, M, C, R, o), R[3] = R[2] = R[1] = R[0] = 0, K(k, h) && w.push(I);
    }
    ...
    for (const I of w) {
      const { projectedGeometry: C, symbolResource: M } = I;
      if (!M) continue;
      const { textInfo: V, symbolInfo: H } = M, Z = H.cimSymbol;
      D.hitTest(u, Z.symbol, C, V, o, i) && G.push(I);
    }
    return G.sort(We), G.map((I) => I.objectId);
  }
  queryItems(e) {
  ...
  _searchForItems(e) {
    const t = this._tileInfoView.spatialReference, s = e.bounds, i = te(t);
    if (i && t.isWrappable) {
      const [o, a] = i.valid, n = Math.abs(s[2] - a) < E, l = Math.abs(s[0] - o) < E;
      if ((!n || !l) && (n || l)) {
        const d = e.resolution;
        let h;
        h = g(n ? [o, s[1], o + d * j, s[3]] : [a - d * j, s[1], a, s[3]]);
  ...
  _getSymbolBounds(e, t, s, i, o) {
    ...
    if (e || (e = g()), se(e, s), !i || i[0] === 0 && i[1] === 0 && i[2] === 0 && i[3] === 0) {
      const { textInfo: l, symbolInfo: d } = t, h = d.cimSymbol;
      i || (i = [0, 0, 0, 0]);
      const c = q.getSymbolInflateSize(i, h.symbol, this._cimResourceManager, o, l);
      i[0] = T(c[0]), i[1] = T(c[1]), i[2] = T(c[2]), i[3] = T(c[3]);
    }
    const a = this._resolution, n = q.safeSize(i);
...
let p = class extends ae(Ie) {
  constructor(r) {
    super(r), this._attached = !1, this._tiles = /* @__PURE__ */ new Map(), this._controller = new AbortController(), this._hashToSymbolInfo = /* @__PURE__ */ new Map(), this._lastCleanup = performance.now(), this._cleanupRequired = !0, this.lastUpdateId = -1, this.renderer = null, this._updateTracking = new ve({ debugName: "GraphicsView2D" }), this.updateRequested = !1, this.defaultPointSymbolEnabled = !0, this._commandQueue = new De({ process: (e) => {
  ...
  _initAttributeStore() {
    this._storage = new $e({ spatialReference: this.view.spatialReference, fields: new ne() }), this._attributeStore = new Ge({ isLocal: !0, update: (e) => {
      y("esri-2d-update-debug") && console.debug(`[Id: ${this.layerId}] GraphicsView2D.AttributeStoreView.updateStart`, { message: e }), this.container.attributeView.requestUpdate(e), this.container.requestRender(), y("esri-2d-update-debug") && console.debug(`[Id: ${this.layerId}] GraphicsView2D.AttributeStoreView.updateEnd`, { message: e });
    } });
    const r = Ve(null, []);
    this._attributeStore.update(r, this._storage, null), this.container.checkHighlight = () => this._attributeStore.hasHighlight;
  }
  initialize() {
    this._initAttributeStore(), this._metadata = Ce.createGraphics(this.view.spatialReference), this._resourceProxy = new ze({ fetch: (e) => Promise.all(e.map((t) => this.view.stage.textureManager.rasterizeItem(t))), fetchDictionary: (e) => {
      throw new Error("InternalError: Graphics do not support Dictionary requests");
    } }), this.addHandles([he(() => this._effectiveRenderer, () => this._pushUpdate()), this.view.graphicsTileStore.on("update", this._onTileUpdate.bind(this)), this.container.on("attach", () => {
      this.addHandles([this.graphics.on("change", () => this._pushUpdate())]), this._graphicStore?.destroy(), this._graphicStore = new Be(this.view.spatialReference, this._cimResourceManager, this.view.featuresTilingScheme, this.view.state.scale, this._attributeStore), this._attached = !0, this.requestUpdate(), this._pushUpdate();
  ...
  get updating() {
    ...
    return y("esri-2d-log-updating") && console.log(`Updating GraphicsView2D: ${r}
  ...
  hitTest(r) {
    ...
    return s.map((a) => o.get(a)).filter(de);
  }
  requestUpdate() {
  ...
  _pushUpdate() {
    ce(this._commandQueue.push({ type: "update" }));
  }
  async _update() {
    try {
      y("esri-2d-update-debug") && console.debug(`[Id: ${this.layerId}] GraphicsView._update start`);
      const r = await this._graphicStore.update(this.graphics, (t) => this._getSymbolForGraphic(t), (t) => this._ensureSymbolResource(t));
      for (const t of r.updated) this.container.restartAnimation(t.objectId);
      if (!r.hasAnyUpdate()) return void this._attributeStore.sendUpdates();
      r.removed.length && (this._cleanupRequired = !0), y("esri-2d-update-debug") && console.debug(`[Id: ${this.layerId}] GraphicsView updateMessage`, r);
      ...
      y("esri-2d-update-debug") && console.debug(`[Id: ${this.layerId}] GraphicsView sendUpdate`, r), this._attributeStore.sendUpdates(), y("esri-2d-update-debug") && console.debug(`[Id: ${this.layerId}] GraphicsView sendUpdate.await`, r);
    } catch {
    }
  ...
  _createTileMessages(r) {
    ...
    for (const t of r.added) {
      ...
      for (const i of s)
        v.getOrCreate(i, e, this._metadata).append(t);
    }
    for (const t of r.updated) {
      ...
      for (const o of i)
        v.getOrCreate(o, e, this._metadata).append(t);
    }
  ...
  async _fetchResources(r) {
    for (const { tile: e, reader: t } of r) {
      y("esri-2d-update-debug") && console.debug(`Id[${this.layerId}] Tile[${e.id}] GraphicsView fetchResources`, r);
      const s = t.getCursor();
  ...
  _write(r) {
    for (const e of r) {
      y("esri-2d-update-debug") && console.debug(`Id[${this.layerId}] Tile[${e.tile.id}] GraphicsView write`, e);
      const t = this._writeMeshes(e);
      let s = this._tiles.get(e.tile.key);
      s || (s = this._createFeatureTile(e.tile.key)), y("esri-2d-update-debug") && console.debug(`Id[${this.layerId}] Tile[${e.tile.id}] GraphicsView onTileData`, e), this.container.onTileData(s, { type: "update", modify: t, remove: e.removed, end: !1, attributeEpoch: this._attributeStore.epoch, objectIdMap: e.objectIdMap }), this.container.requestRender();
    }
  }
  _writeMeshes(r) {
    const e = new je(r.tile.id), t = r.reader.getCursor();
    for (; t.next(); ) {
  ...
  _setFilterState(r) {
    ...
    this._attributeStore.setData(e, 0, 0, t | (r.visible ? le : 0));
  }
  ...
  async _createLinearCIM(r) {
    return await Promise.all(Re.fetchResources(r.symbol, this._cimResourceManager, [])), this.view.stage.cimAnalyzer.analyzeSymbolReference(r, !1);
  }
  async _createMeshWriters(r, e) {
    ue(this._controller.signal);
    const t = this.container.instanceStore, s = this.view.stage.meshWriterRegistry, i = await Ze(r, e, t);
  ...
  _createFeatureTile(r) {
    const e = this.view.featuresTilingScheme.getTileBounds(g(), r), t = this.view.featuresTilingScheme.getTileResolution(r.level), s = new Me(r, t, e[0], e[3]);
  ...
  async _addTile(r) {
    ...
    t.onMessage({ type: "append", append: i, clear: !1, end: !0, attributeEpoch: this._attributeStore.epoch, objectIdMap: s.objectIdMap });
  }
  _removeTile(r) {
  ...
  _getNullSymbol(r) {
    const e = r.geometry;
    return pe(e) ? me : _e(e) || A(e) ? ye : this.defaultPointSymbolEnabled ? ge : null;
  }
...
m([_()], p.prototype, "_effectiveRenderer", null), m([_({ constructOnly: !0 })], p.prototype, "layerId", void 0), m([_({ constructOnly: !0 })], p.prototype, "requestUpdateCallback", void 0), m([_()], p.prototype, "container", void 0), m([_({ constructOnly: !0 })], p.prototype, "graphics", void 0), m([_()], p.prototype, "renderer", void 0), m([_()], p.prototype, "_updateTracking", void 0), m([_()], p.prototype, "updating", null), m([_()], p.prototype, "view", void 0), m([_()], p.prototype, "updateRequested", void 0), m([_()], p.prototype, "defaultPointSymbolEnabled", void 0), p = m([we("esri.views.2d.layers.graphics.GraphicsView2D")], p);
const et = p;
export {
  et as F
};
//# sourceMappingURL=GraphicsView2D-DQwEO3YK.js.map
