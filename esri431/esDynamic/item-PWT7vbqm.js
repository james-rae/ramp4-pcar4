import { bs as Y, bt as ae, bv as V, bw as ce, bA as q, bD as l, bJ as a, bI as w, g5 as o, bG as t, k9 as x, ka as ie, g6 as C, kp as Le, ko as u, nR as ke, bu as ge, g3 as me, by as G, nS as b, nk as M, bz as ye, bH as xe, bC as de, bE as A, bF as p, gd as K, jO as oe, bK as le, bL as ne, kw as we, gb as v, nT as pe, jM as Ce, ga as Me, nU as f, nV as Z, nW as re, bB as U, kn as Se, nX as O, ms as Te, nY as ze, nZ as ee } from "./main-DZxT3i7S.js";
...
const Ee = ["type", "aria-label", "checked", "disabled", "content"], te = /* @__PURE__ */ Y({
    ...
    return (s, d) => {
      ...
      return l(), a("div", {
        ...
        w(o("input", {
          ...
          onClick: d[0] || (d[0] = x((j) => $(), ["stop"])),
          checked: e.checked && m.value,
          onKeypress: d[1] || (d[1] = ie(x(() => {
          }, ["prevent"]), ["enter"])),
          onKeyup: d[2] || (d[2] = ie(x((j) => $(), ["stop"]), ["enter"])),
          class: C([[
...
}), He = ["aria-label"], Be = ["aria-label"], Ae = ["aria-label"], $e = ["aria-label"], Ze = ["aria-label"], Ue = ["aria-label"], Ge = ["content", "aria-label"], Re = /* @__PURE__ */ Y({
  ...
  setup(e) {
    const { t: y } = ae(), i = ge("iApi"), m = V(), I = V(!1), $ = me(), s = V($.mobileView), d = e, T = () => {
      ...
      P.value && (M(d.legendItem.layer).reload(), m.value.open = !1);
    }, P = G(() => d.legendItem.layerControlAvailable(b.Reload) && d.legendItem instanceof u && M(d.legendItem.layer)?.canReload), Q = (z) => {
        ...
        xe(L, {
          ...
          default: de(() => [
            o("a", {
              ...
              A(" " + p(t(y)("legend.layer.controls.metadata")), 1)
            ], 10, He),
            o("a", {
              href: "javascript:;",
              class: C(["flex leading-snug items-center text-left w-auto", {
              ...
              A(" " + p(t(y)("legend.layer.controls.settings")), 1)
            ], 10, Be),
            o("a", {
              href: "javascript:;",
              class: C(["flex leading-snug items-center text-left w-auto", {
              ...
              A(" " + p(t(y)("legend.layer.controls.datatable")), 1)
            ], 10, Ae),
            o("a", {
              href: "javascript:;",
              class: C(["flex leading-snug items-center text-left w-auto", {
              ...
              A(" " + p(t(y)("legend.layer.controls.symbology")), 1)
            ], 10, $e),
            o("a", {
              href: "javascript:;",
              class: C(["flex leading-snug items-center text-left w-auto", {
              ...
              A(" " + p(t(y)("legend.layer.controls.boundaryzoom")), 1)
            ], 10, Ze),
            o("a", {
              href: "javascript:;",
              class: C(["flex leading-snug items-center text-left w-auto", {
              ...
              A(" " + p(t(y)("legend.layer.controls.remove")), 1)
            ], 10, Ue),
            w((l(), a("a", {
              href: "javascript:;",
              class: C(["flex leading-snug items-center text-left w-auto", {
              ...
              content: P.value ? "" : t(y)("legend.layer.controls.reloadDisabled"),
              onMouseover: c[0] || (c[0] = x((E) => Q(E.currentTarget), ["stop"])),
              ...
              A(" " + p(t(y)("legend.layer.controls.reload")), 1)
            ], 42, Ge)), [
              [R, {
                placement: "top-start",
...
}), je = /* @__PURE__ */ oe(Re, [["__scopeId", "data-v-9590866e"]]), De = { key: 0 }, Pe = {
  key: 0,
...
}), Je = /* @__PURE__ */ oe(Ye, [["__scopeId", "data-v-34dfeccd"]]), Qe = { class: "relative" }, Xe = ["content"], _e = {
  key: 0,
...
}, Dt = { class: "flex-1 text-gray-500" }, Pt = {
  key: 1,
  ...
  setup(e) {
    const y = pe(), i = me(), { t: m } = ae(), I = ge("iApi"), $ = V(), s = e, d = Ce(), T = d.multilineItems, j = (s.legendItem instanceof u && s.legendItem.maxLines) ?? d.maxLines, N = V(i.mobileView), J = G(() => y.layerConfigs), H = V([]), F = V(!1), D = V(!1), P = G(() => s.legendItem instanceof u ? M(s.legendItem.layer)?.layerType : ""), Q = G(() => s.legendItem instanceof u && M(s.legendItem.layer)?.canModifyLayer), B = G(() => {
    ...
    return s.legendItem instanceof u && (se(), Me(
      ...
      return e.legendItem.hidden ? v("", !0) : (l(), a("div", {
        ...
        e.legendItem instanceof t(u) && e.legendItem.symbologyExpanded ? w((l(), a("div", pt, [
          H.value.length > 0 ? (l(), a("div", Ct, [
            ...
            (l(!0), a(le, null, ne(H.value, (g) => (l(), a("div", {
              ...
              g.imgUrl && e.legendItem.symbologyRenderStyle === "images" || !g.imgUrl && P.value === "ogc-wms" ? (l(), a("div", St, [
                g.imgUrl ? (l(), a("div", Tt, [
                  o("img", {
                    class: "max-w-full",
                    src: g.imgUrl
                ...
                Q.value && e.legendItem.layer.supportsFeatures && (!g.imgUrl && H.value.length > 1 || g.imgUrl && g.definitionClause) ? (l(), U(te, {
                  key: 2,
                  value: g,
                  legendItem: e.legendItem,
                  checked: g.visibility,
        ...
        e.legendItem.expanded ? (l(), a("div", Pt, [
...
//# sourceMappingURL=item-PWT7vbqm.js.map
