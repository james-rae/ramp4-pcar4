import { gZ as G, eb as H, ab as _ } from "./main-DZxT3i7S.js";
let k = class {
...
let q = class {
  ...
  copyFrom(e, t, s) {
    this.copyFromTypedBuffer(e, t.typedBuffer, s * t.typedBufferStride);
  }
  copyFromTypedBuffer(e, t, s) {
    const r = this.typedBuffer;
    let i = e * this.typedBufferStride;
    for (let f = 0; f < 16; ++f) r[i++] = t[s++];
  }
  get buffer() {
    return this.typedBuffer.buffer;
  }
...
//# sourceMappingURL=BufferView-5VozJqYL.js.map
