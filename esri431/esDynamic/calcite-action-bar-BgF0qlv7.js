import { dc as d, de as T, dg as B, dh as k, fk as G, di as M, fm as P } from "./main-DZxT3i7S.js";
import { c as $, d as q } from "./conditionalSlot-CY4lUuOb.js";
import { g as W, b as y, s as E, f as F } from "./dom-N58V0tYi.js";
import { a as I, s as R, c as U } from "./loadable-BekOWxtq.js";
import { c as _, d as j } from "./locale-B98iGxBG.js";
import { c as C } from "./observers-lnyvGi5X.js";
import { u as J, c as K, s as Q, d as V } from "./t9n-DqBq_VHu.js";
import { S as g, d as X } from "./action-group-BDoAPdz_.js";
import { S as Y, d as Z, a as N } from "./action-menu-BGcrUrL7.js";
import { d as ee } from "./action-R6b2qHuP.js";
import { d as te } from "./icon-BnVuD4FT.js";
import { d as oe } from "./loader-BOJ3YuGs.js";
...
}, ce = ({ layout: s, actionCount: e, actionWidth: t, width: o, actionHeight: c, height: a, groupCount: n }) => Math.max(e - ae({ width: o, actionWidth: t, layout: s, height: a, actionHeight: c, groupCount: n }), 0), x = (s) => Array.from(s.querySelectorAll("calcite-action")).filter((e) => e.closest("calcite-action-menu") ? e.slot === Y.trigger : !0), le = ({ actionGroups: s, expanded: e, overflowCount: t }) => {
  let o = t;
  s.reverse().forEach((c) => {
    let a = 0;
    const n = x(c).reverse();
...
const ue = {
  ...
  componentDidLoad() {
    const { el: e, expanded: t } = this;
    I(this), m({ el: e, expanded: t }), this.overflowActions();
  }
  connectedCallback() {
    const { el: e, expanded: t } = this;
    _(this), K(this), m({ el: e, expanded: t }), this.mutationObserver?.observe(e, { childList: !0, subtree: !0 }), this.overflowActionsDisabled || this.resizeObserver?.observe(e), this.overflowActions(), $(this);
  }
  async componentWillLoad() {
    R(this), await Q(this);
  }
  disconnectedCallback() {
    this.mutationObserver?.disconnect(), this.resizeObserver?.disconnect(), q(this), j(this), V(this);
  }
  // --------------------------------------------------------------------------
  //
  //  Methods
...
//# sourceMappingURL=calcite-action-bar-BgF0qlv7.js.map
