import { d7 as w, d8 as F, d9 as $, da as v } from "./main-DZxT3i7S.js";
class z {
  constructor(t = 9, i) {
    this._compareMinX = y, this._compareMinY = A, this._toBBox = (n) => n, this._maxEntries = Math.max(4, t || 9), this._minEntries = Math.max(2, Math.ceil(0.4 * this._maxEntries)), i && (typeof i == "function" ? this._toBBox = i : this._initFormat(i)), this.clear();
  }
  destroy() {
    this.clear(), u.prune(), Y.prune(), m.prune(), X.prune();
  }
  all(t) {
    j(this._data, t);
  }
  ...
  remove(t) {
    ...
    for (m.clear(), X.clear(); n || m.length > 0; ) {
      ...
      a || n.leaf || !E(n, r) ? s ? (h++, n = s.children[h], a = !1) : n = null : (m.push(n), X.push(h), h = 0, s = n, n = n.children[0]);
    }
    return this;
  }
  toJSON() {
  ...
  _build(t, i, n, s) {
    ...
    D(t, i, n, c, this._compareMinX);
    for (let l = i; l <= n; l += c) {
      const d = Math.min(l + c - 1, n);
      D(t, l, d, o, this._compareMinY);
      for (let p = l; p <= d; p += o) {
        const R = Math.min(p + o - 1, d);
        r.children.push(this._build(t, p, R, s - 1));
      }
    }
  ...
  _split(t, i) {
    ...
    if (!a) return;
    const r = n.children.splice(a, n.children.length - a), o = n.leaf ? new B(r) : new b(r);
    o.height = n.height, x(n, this._toBBox), x(o, this._toBBox), i ? t.data[i - 1].children.push(o) : this._splitRoot(n, o);
  }
  _splitRoot(t, i) {
    this._data = new b([t, i]), this._data.height = t.height + 1, x(this._data, this._toBBox);
  }
  _chooseSplitIndex(t, i, n) {
    let s, h, a;
    s = h = 1 / 0;
    for (let r = i; r <= n - i; r++) {
      const o = f(t, 0, r, this._toBBox), c = f(t, r, n, this._toBBox), l = O(o, c), d = S(o) + S(c);
      l < s ? (s = l, a = r, h = d < h ? d : h) : l === s && d < h && (h = d, a = r);
    }
    return a;
  }
  _chooseSplitAxis(t, i, n) {
    const s = t.leaf ? this._compareMinX : y, h = t.leaf ? this._compareMinY : A;
    this._allDistMargin(t, i, n, s) < this._allDistMargin(t, i, n, h) && t.children.sort(s);
  }
  _allDistMargin(t, i, n, s) {
    t.children.sort(s);
    const h = this._toBBox, a = f(t, 0, i, h), r = f(t, n - i, n, h);
    let o = g(a) + g(r);
    for (let c = i; c < n - i; c++) {
...
function I(e, t, i, n) {
  for (; n.push(t), t.leaf !== !0 && n.length - 1 !== i; ) {
    ...
    for (let r = 0, o = t.children.length; r < o; r++) {
      const c = t.children[r], l = S(c), d = N(e, c) - l;
      d < a ? (a = d, h = l < h ? l : h, s = c) : d === a && l < h && (h = l, s = c);
    }
    t = s || t.children[0];
  }
  return t;
...
function D(e, t, i, n, s) {
  ...
  for (; h.length; ) {
    ...
    $(e, o, r, a, s), h.push(r, o, o, a);
  }
}
const u = new w(), Y = new w(), m = new w(), X = new w({ deallocator: void 0 });
class q {
  constructor() {
...
//# sourceMappingURL=PooledRBush-BfX9FRSa.js.map
