import { bQ as i, bR as r, b4 as T, f9 as b, bS as f, bT as I, b_ as x, e1 as L, jf as N, T as R, eu as M, a8 as $, I as A, U as J, eN as V, ez as j, eA as D, eB as P, eC as U, eO as E, eP as K, cw as z, f6 as C, p as G, B, s as d, G as v, eD as k, eU as q, eM as F } from "./main-DZxT3i7S.js";
import { j as h } from "./persistable-ChKWNQcl.js";
import { R as H, V as S } from "./SceneService-BySgYuKY.js";
import { p as Q, a as Z, y as W, m as X } from "./I3SLayerDefinitions-CzBCdHgd.js";
import { $ as w, Z as Y, w as ee } from "./elevationInfoUtils-CrzkqZgQ.js";
var m;
let n = m = class extends I {
  constructor(e) {
  ...
  writeGeometry(e, t, s, a) {
    if (a.layer?.spatialReference && !a.layer.spatialReference.equals(this.geometry.spatialReference)) {
      if (!x(e.spatialReference, a.layer.spatialReference)) return void (a?.messages && a.messages.push(new L("scenemodification:unsupported", "Scene modifications with incompatible spatial references are not supported", { modification: this, spatialReference: a.layer.spatialReference, context: a })));
      const l = new T();
...
i([r({ type: T }), h()], n.prototype, "geometry", void 0), i([b(["web-scene", "portal-item"], "geometry")], n.prototype, "writeGeometry", null), i([r({ type: ["clip", "mask", "replace"], nonNullable: !0 }), h()], n.prototype, "type", void 0), n = m = i([f("esri.layers.support.SceneModification")], n);
const c = n;
var p;
let y = p = class extends M($.ofType(c)) {
  ...
  static async fromUrl(e, t, s) {
    const a = { url: A(e), origin: "service" }, l = await J(e, { responseType: "json", signal: s?.signal }), O = t.toJSON(), u = [];
...
const _ = y;
let o = class extends H(V(j(D(P(U(E(K(F)))))))) {
  constructor(...e) {
  ...
  initialize() {
    this.addHandles(z(() => this.modifications, "after-changes", () => this.modifications = this.modifications, C));
  }
  normalizeCtorArgs(e, t) {
    return typeof e == "string" ? { url: e, ...t } : e;
  }
  readModifications(e, t, s) {
    this._modificationsSource = { url: G(e, s), context: s };
  }
  set elevationInfo(e) {
  ...
  async _doLoad(e) {
    ...
    if (await this._fetchService(t), this._modificationsSource != null) {
      const s = await _.fromUrl(this._modificationsSource.url, this.spatialReference, e);
