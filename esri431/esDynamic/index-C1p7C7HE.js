import { F as o, ki as a, bs as h, bu as r, bt as c, bz as u, bB as m, bC as v, bG as d, gd as f, bD as g, g5 as s, hV as x, hX as _ } from "./main-DZxT3i7S.js";
import { _ as A } from "./screen.vue_vue_type_script_setup_true_lang-Djv573wv.js";
class $ extends o {
  /**
   * Toggles help panel
   *
...
const b = /* @__PURE__ */ h({
  __name: "nav-button",
  setup(n) {
    const t = r("iApi"), { t: e } = c(), i = () => t.event.emit(f.HELP_TOGGLE);
    return (C, p) => {
      const l = u("mapnav-button");
      return g(), m(l, {
        onClickFunction: i,
        tooltip: d(e)("help.title")
      }, {
        default: v(() => p[0] || (p[0] = [
          s("svg", {
...
//# sourceMappingURL=index-C1p7C7HE.js.map
