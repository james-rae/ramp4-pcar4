import { aH as Ot, n as F, r as k, Y as G, a as lt, k as pt, aI as ie, R as ft, U as mt, P as w, aJ as Xt, aK as S, F as f, aL as Yt, ao as L, b as St, e as se, aM as ae, ab as oe, _ as ne, aq as nt, ap as Et, av as vt, aN as Nt, ax as B, ay as E, aO as q, z as re, ar as le, a8 as he, at as gt, af as Ft, W as ut, i as tt, t as et, u as de, aE as zt, j as Lt, aP as Rt, aQ as ce, o as ge, aC as jt } from "./Theme-D8IVldck.js";
import { s as Vt } from "./ColorSet-DumFpUOh.js";
import { l as Y } from "./DefaultTheme-BPOOTBna.js";
import { R as Bt, D as Ut, _ as Wt, g as rt, U as Ht, V as Zt, k as V, I as ue } from "./Tick-CfnJnNV6.js";
import { o as pe, n as Gt } from "./Button-D7rhuEBb.js";
import { ft as it } from "./main-DZxT3i7S.js";
function $t(P) {
...
function te(P, t) {
  var e = V(!0), i = null, s = Kt, a = null, n = Zt(r);
  function r(o) {
  ...
  return P = typeof P == "function" ? P : P === void 0 ? Jt : V(P), t = typeof t == "function" ? t : t === void 0 ? Qt : V(t), r.x = function(o) {
...
function me(P, t, e) {
  var i = null, s = V(!0), a = null, n = Kt, r = null, o = Zt(l);
  function l(h) {
    var d, g, m, p, u, x = (h = $t(h)).length, b = !1, v = new Array(x), _ = new Array(x);
    for (a == null && (r = n(u = o())), d = 0; d <= x; ++d) {
      if (!(d < x && s(p = h[d], d, h)) === b) if (b = !b) g = d, r.areaStart(), r.lineStart();
      else {
        for (r.lineEnd(), r.lineStart(), m = d - 1; m >= g; --m) r.point(v[m], _[m]);
        r.lineEnd(), r.areaEnd();
      }
      b && (v[d] = +P(p, d, h), _[d] = +t(p, d, h), r.point(i ? +i(p, d, h) : v[d], e ? +e(p, d, h) : _[d]));
    }
    if (u) return r = null, u + "" || null;
  }
  function c() {
    return te().defined(s).curve(n).context(a);
  }
  return P = typeof P == "function" ? P : P === void 0 ? Jt : V(+P), t = typeof t == "function" ? t : V(t === void 0 ? 0 : +t), e = typeof e == "function" ? e : e === void 0 ? Qt : V(+e), l.x = function(h) {
...
class _e extends le {
  setupDefaultRules() {
    ...
    i("RoundedRectangle", ["xy", "scrollbar", "thumb"]).setAll({ cornerRadiusTR: 0, cornerRadiusTL: 0, cornerRadiusBR: 0, cornerRadiusBL: 0, fillOpacity: 0, focusable: !0 }), i("RoundedRectangle", ["xy", "scrollbar", "thumb"]).states.create("hover", { fillOpacity: 0.4 }), i("RoundedRectangle", ["xy", "scrollbar", "chart", "background"]).setAll({ cornerRadiusTL: 0, cornerRadiusBL: 0, cornerRadiusTR: 0, cornerRadiusBR: 0 }), i("RoundedRectangle", ["xy", "scrollbar", "chart", "background", "resize", "button"]).setAll({ cornerRadiusBL: 40, cornerRadiusBR: 40, cornerRadiusTL: 40, cornerRadiusTR: 40 }), i("AxisRendererX", ["xy", "chart", "scrollbar"]).setAll({ strokeOpacity: 0, inside: !0 }), i("AxisRendererY", ["xy", "chart", "scrollbar"]).setAll({ strokeOpacity: 0, inside: !0, minGridDistance: 5 }), i("AxisLabel", ["xy", "scrollbar", "x"]).setAll({ opacity: 0.5, centerY: k, minPosition: 0.01, maxPosition: 0.99, fontSize: "0.8em" }), i("AxisLabel", ["category"]).setAll({ text: "{category}", populateText: !0 }), i("AxisLabel", ["x"]).setAll({ centerY: 0 }), i("AxisLabel", ["x", "inside"]).setAll({ centerY: k }), i("AxisLabel", ["x", "inside", "opposite"]).setAll({ centerY: 0 }), i("AxisLabel", ["x", "opposite"]).setAll({ centerY: k }), i("AxisLabel", ["y"]).setAll({ centerX: k }), i("AxisLabel", ["y", "inside"]).setAll({ centerX: 0 }), i("AxisLabel", ["y", "inside", "opposite"]).setAll({ centerX: k }), i("AxisLabel", ["y", "opposite"]).setAll({ centerX: 0 }), i("AxisLabel", ["minor"]).setAll({ fontSize: "0.6em" }), i("AxisLabel", ["xy", "scrollbar", "y"]).setAll({ visible: !1 }), i("Grid", ["xy", "scrollbar", "y"]).setAll({ visible: !1 }), i("Grid", ["xy", "scrollbar", "x"]).setAll({ opacity: 0.5 }), i("XYCursor").setAll({ behavior: "none", layer: 30, exportable: !1, snapToSeriesBy: "xy", moveThreshold: 1 });
    {
      ...
      o.setAll({ forceInactive: !0, strokeOpacity: 0.8, strokeDasharray: [2, 2], role: "slider", ariaLabel: e.translate("Use left and right arrows to move selection") }), Y(o, "stroke", t, "alternativeBackground");
    }
    {
      const o = i("Grid", ["cursor", "y"]);
      o.setAll({ forceInactive: !0, strokeOpacity: 0.8, strokeDasharray: [2, 2], role: "slider", ariaLabel: e.translate("Use up and down arrows to move selection") }), Y(o, "stroke", t, "alternativeBackground");
    }
    {
    ...
    i("CategoryAxis").setAll({ startLocation: 0, endLocation: 1, fillRule: (o, l) => {
      ...
      c && (f(l) && l % 2 != 0 ? c.setPrivate("visible", !1) : c.setPrivate("visible", !0));
    } });
    ...
    i("CategoryDateAxis").setAll({ markUnitChange: !0, gridIntervals: Ft(s), dateFormats: ut(a), periodChangeDateFormats: ut(n) }), i("DateAxis").setAll({ maxZoomFactor: null, strictMinMax: !0, startLocation: 0, endLocation: 1, markUnitChange: !0, groupData: !1, groupCount: 500, gridIntervals: Ft(s), dateFormats: ut(a), periodChangeDateFormats: ut(n), tooltipDateFormats: r, groupIntervals: [{ timeUnit: "millisecond", count: 1 }, { timeUnit: "millisecond", count: 10 }, { timeUnit: "millisecond", count: 100 }, { timeUnit: "second", count: 1 }, { timeUnit: "second", count: 10 }, { timeUnit: "minute", count: 1 }, { timeUnit: "minute", count: 10 }, { timeUnit: "hour", count: 1 }, { timeUnit: "day", count: 1 }, { timeUnit: "week", count: 1 }, { timeUnit: "month", count: 1 }, { timeUnit: "year", count: 1 }], fillRule: (o) => {
      const l = o.get("axisFill");
      if (l) {
        const c = o.component, h = o.get("value"), d = o.get("endValue"), g = c.intervalDuration(), m = c.getPrivate("baseInterval"), p = c.getPrivate("gridInterval", m);
        let u = c.getPrivate("min", 0);
        if (u = ue(new Date(u), p.timeUnit, p.count, this._root.locale.firstDayOfWeek, this._root.utc, void 0, this._root.timezone).getTime(), h != null && d != null) {
          const x = Math.round(Math.round((h - u) / g)) / 2;
          x == Math.round(x) ? l.setPrivate("visible", !0) : l.setPrivate("visible", !1);
        }
      }
      ...
      if (l) {
        const c = o.get("index");
        let h = !1;
        f(c) && c % 2 != 0 || (h = !0), l.setPrivate("visible", h);
      }
      ...
      if (l) {
        ...
        f(h) && f(d) && (S(h / d / 2, 5) == Math.round(h / d / 2) ? l.setPrivate("visible", !1) : l.setPrivate("visible", !0));
      }
...
class wt extends Bt {
  constructor() {
    super(...arguments), Object.defineProperty(this, "xAxes", { enumerable: !0, configurable: !0, writable: !0, value: new Ot() }), Object.defineProperty(this, "yAxes", { enumerable: !0, configurable: !0, writable: !0, value: new Ot() }), Object.defineProperty(this, "topAxesContainer", { enumerable: !0, configurable: !0, writable: !0, value: this.chartContainer.children.push(F.new(this._root, { width: k, layout: this._root.verticalLayout })) }), Object.defineProperty(this, "yAxesAndPlotContainer", { enumerable: !0, configurable: !0, writable: !0, value: this.chartContainer.children.push(F.new(this._root, { width: k, height: k, layout: this._root.horizontalLayout })) }), Object.defineProperty(this, "bottomAxesContainer", { enumerable: !0, configurable: !0, writable: !0, value: this.chartContainer.children.push(F.new(this._root, { width: k, layout: this._root.verticalLayout })) }), Object.defineProperty(this, "leftAxesContainer", { enumerable: !0, configurable: !0, writable: !0, value: this.yAxesAndPlotContainer.children.push(F.new(this._root, { height: k, layout: this._root.horizontalLayout })) }), Object.defineProperty(this, "plotsContainer", { enumerable: !0, configurable: !0, writable: !0, value: this.yAxesAndPlotContainer.children.push(F.new(this._root, { width: k, height: k, maskContent: !1 })) }), Object.defineProperty(this, "plotContainer", { enumerable: !0, configurable: !0, writable: !0, value: this.plotsContainer.children.push(F.new(this._root, { width: k, height: k })) }), Object.defineProperty(this, "topPlotContainer", { enumerable: !0, configurable: !0, writable: !0, value: this.plotsContainer.children.push(F.new(this._root, { width: k, height: k })) }), Object.defineProperty(this, "gridContainer", { enumerable: !0, configurable: !0, writable: !0, value: this.plotContainer.children.push(F.new(this._root, { width: k, height: k, isMeasured: !1 })) }), Object.defineProperty(this, "topGridContainer", { enumerable: !0, configurable: !0, writable: !0, value: F.new(this._root, { width: k, height: k, isMeasured: !1 }) }), Object.defineProperty(this, "rightAxesContainer", { enumerable: !0, configurable: !0, writable: !0, value: this.yAxesAndPlotContainer.children.push(F.new(this._root, { height: k, layout: this._root.horizontalLayout })) }), Object.defineProperty(this, "axisHeadersContainer", { enumerable: !0, configurable: !0, writable: !0, value: this.plotContainer.children.push(F.new(this._root, {})) }), Object.defineProperty(this, "zoomOutButton", { enumerable: !0, configurable: !0, writable: !0, value: this.topPlotContainer.children.push(pe.new(this._root, { themeTags: ["zoom"], icon: G.new(this._root, { themeTags: ["button", "icon"] }) })) }), Object.defineProperty(this, "_movePoint", { enumerable: !0, configurable: !0, writable: !0, value: { x: 0, y: 0 } }), Object.defineProperty(this, "_wheelDp", { enumerable: !0, configurable: !0, writable: !0, value: void 0 }), Object.defineProperty(this, "_otherCharts", { enumerable: !0, configurable: !0, writable: !0, value: void 0 }), Object.defineProperty(this, "_movePoints", { enumerable: !0, configurable: !0, writable: !0, value: {} }), Object.defineProperty(this, "_downStartX", { enumerable: !0, configurable: !0, writable: !0, value: void 0 }), Object.defineProperty(this, "_downEndX", { enumerable: !0, configurable: !0, writable: !0, value: void 0 }), Object.defineProperty(this, "_downStartY", { enumerable: !0, configurable: !0, writable: !0, value: void 0 }), Object.defineProperty(this, "_downEndY", { enumerable: !0, configurable: !0, writable: !0, value: void 0 });
  }
  _afterNew() {
  ...
  handleWheel(t) {
    ...
    e !== "zoomX" && e !== "zoomXY" || l == 0 || this.xAxes.each((d) => {
      if (d.get("zoomX")) {
        let g = d.get("start"), m = d.get("end"), p = d.fixPosition(n.x / s.width());
        c != null && (p = c);
        let u = d.get("maxDeviation", 0), x = Math.min(1 + u, Math.max(-u, g - r * (m - g) * l * p)), b = Math.max(-u, Math.min(1 + u, m + r * (m - g) * l * (1 - p)));
        1 / (b - x) < d.getPrivate("maxZoomFactor", 1 / 0) / d.get("minZoomCount", 1) && this._handleWheelAnimation(d.zoom(x, b));
      }
    }), i !== "zoomX" && i !== "zoomXY" || o == 0 || this.xAxes.each((d) => {
      if (d.get("zoomX")) {
        let g = d.get("start"), m = d.get("end"), p = d.fixPosition(n.x / s.width());
        c != null && (p = c);
        let u = d.get("maxDeviation", 0), x = Math.min(1 + u, Math.max(-u, g - r * (m - g) * o * p)), b = Math.max(-u, Math.min(1 + u, m + r * (m - g) * o * (1 - p)));
        1 / (b - x) < d.getPrivate("maxZoomFactor", 1 / 0) / d.get("minZoomCount", 1) && this._handleWheelAnimation(d.zoom(x, b));
      }
    }), e !== "zoomY" && e !== "zoomXY" || l == 0 || this.yAxes.each((d) => {
      if (d.get("zoomY")) {
        let g = d.get("start"), m = d.get("end"), p = d.fixPosition(n.y / s.height());
        h != null && (p = h);
        let u = d.get("maxDeviation", 0), x = Math.min(1 + u, Math.max(-u, g - r * (m - g) * l * p)), b = Math.max(-u, Math.min(1 + u, m + r * (m - g) * l * (1 - p)));
        1 / (b - x) < d.getPrivate("maxZoomFactor", 1 / 0) / d.get("minZoomCount", 1) && this._handleWheelAnimation(d.zoom(x, b));
      }
      ...
      if (d.get("panX")) {
        let g = d.get("start"), m = d.get("end"), p = this._getWheelSign(d) * r * (m - g) * l, u = g + p, x = m + p, b = this._fixWheel(u, x);
        u = b[0], x = b[1], this._handleWheelAnimation(d.zoom(u, x));
      }
    }), i !== "panX" && i !== "panXY" || o == 0 || this.xAxes.each((d) => {
      if (d.get("panX")) {
        let g = d.get("start"), m = d.get("end"), p = this._getWheelSign(d) * r * (m - g) * o, u = g + p, x = m + p, b = this._fixWheel(u, x);
        u = b[0], x = b[1], this._handleWheelAnimation(d.zoom(u, x));
      }
  ...
  _handlePlotDown(t) {
    ...
    if ((this.get("pinchZoomX") || this.get("pinchZoomY")) && e.pointerId && ft(i._downPoints).length > 0) {
  ...
  _handlePlotMove(t) {
    ...
    if (this.get("pinchZoomX") || this.get("pinchZoomY")) {
      ...
      if (s && (this._movePoints[s] = t.point, ft(e._downPoints).length > 1)) return void this._handlePinch();
    }
      ...
      if (r && o && l && c) {
        if (l = t.toLocal(l), c = t.toLocal(c), r = t.toLocal(r), o = t.toLocal(o), this.get("pinchZoomX")) {
          ...
          if (h != null && d != null) {
            ...
            let g = h + r.x / a * (d - h), m = h + o.x / a * (d - h), p = h + l.x / a * (d - h), u = h + c.x / a * (d - h), x = Math.max(1e-3, m - g) / Math.max(1e-3, u - p), b = h * x + g - p * x, v = d * x + m - u * x;
            this.xAxes.each((_) => {
              let y = _.fixPosition(b), A = _.fixPosition(v);
              _.zoom(y, A, 0);
            });
          }
        }
        if (this.get("pinchZoomY")) {
          ...
          if (h != null && d != null) {
            ...
            let g = h + (1 - r.y / n) * (d - h), m = h + (1 - o.y / n) * (d - h), p = h + (1 - l.y / n) * (d - h), u = h + (1 - c.y / n) * (d - h), x = Math.max(1e-3, m - g) / Math.max(1e-3, u - p), b = h * x + g - p * x, v = d * x + m - u * x;
            this.yAxes.each((_) => {
              let y = _.fixPosition(b), A = _.fixPosition(v);
              _.zoom(y, A, 0);
            });
    ...
    if (t) {
      ...
      if (t._downPoint && (i = void 0), i && e) {
        ...
        if (w(a, (o) => {
          ...
          let o = n.component;
          o.showDataItemTooltip(n), o.setRaw("tooltipDataItem", n);
          const l = n.get("point");
  ...
  _processSeries(t) {
    ...
    Xt(e.series, t), Xt(i.series, t), t._posXDp = t.addDisposer(e.events.on("positionchanged", () => {
      t._fixPosition();
  ...
  _colorize(t) {
    ...
    if (e && t.get("fill") == null) {
      const s = e.next();
      t._setSoft("stroke", s), t._setSoft("fill", s);
    }
    const i = this.get("patterns");
    if (i && t.get("fillPattern") == null) {
      const s = i.next();
      t._setSoft("fillPattern", s);
    }
  }
  ...
  _handleZoomOut() {
    ...
    if (t && t.parent) {
      let e = !1;
      this.xAxes.each((i) => {
        S(i.get("start", 0), 6) == 0 && S(i.get("end", 1), 6) == 1 || (e = !0);
      }), this.yAxes.each((i) => {
        S(i.get("start", 0), 6) == 0 && S(i.get("end", 1), 6) == 1 || (e = !0);
  ...
  arrangeTooltips() {
    ...
    const r = [];
    let o, l, c = 0, h = 1 / 0, d = this._movePoint, g = this.get("maxTooltipDistance"), m = this.get("maxTooltipDistanceBy", "xy");
    f(g) && this.series.each((u) => {
      if (!u.isHidden()) {
        const x = u.get("tooltip");
        if (x) {
          let b = x.get("pointTo");
          if (b) {
            let v = Math.hypot(d.x - b.x, d.y - b.y);
            m == "x" ? v = Math.abs(d.x - b.x) : m == "y" && (v = Math.abs(d.y - b.y)), v < h && (h = v, o = u, l = b);
          }
        }
      }
    });
    ...
    if (this.series.each((u) => {
      const x = u.get("tooltip");
      if (x && !x.get("forceHidden")) {
        let b = !1, v = x.get("pointTo");
        if (v) {
          if (g >= 0) {
            let _ = x.get("pointTo");
            if (_ && l && u != o) {
              let y = Math.hypot(l.x - _.x, l.y - _.y);
              m == "x" ? y = Math.abs(l.x - _.x) : m == "y" && (y = Math.abs(l.y - _.y)), y > g && (b = !0);
            }
          } else g == -1 && u != o && (b = !0);
          this.inPlot(this._tooltipToLocal(v)) && x.dataItem ? b || (c += v.y) : b = !0, b || u.isHidden() || u.isHiding() ? x.hide(0) : (x.show(), r.push(x), p.push(u));
        }
      }
    }), this.setPrivate("tooltipSeries", p), this.get("arrangeTooltips")) {
      const u = this._root.tooltipContainer, x = r.length;
      if (c / x > i / 2 + a.y) {
        r.sort((v, _) => Yt(_.get("pointTo").y, v.get("pointTo").y));
        let b = n.y;
        if (w(r, (v) => {
          let _ = v.height(), y = v.get("centerY");
          y instanceof et && (_ *= y.value), _ += v.get("marginBottom", 0), v.set("bounds", { left: a.x, top: a.y, right: n.x, bottom: b }), v.setPrivate("customData", { left: a.x, top: a.y, right: n.x, bottom: b }), b = Math.min(b - _, v._fy - _), v.parent == u && u.children.moveValue(v, 0);
        }), b < 0) {
          r.reverse();
          let v = b;
          w(r, (_) => {
            let y = _.get("bounds");
            if (y) {
              let A = y.top - b, O = y.bottom - b;
              A < v && (A = v, O = A + _.height()), _.set("bounds", { left: y.left, top: A, right: y.right, bottom: O }), v = y.bottom - b + _.get("marginBottom", 0);
            }
          });
        }
      } else {
        r.reverse(), r.sort((v, _) => Yt(v.get("pointTo").y, _.get("pointTo").y));
        let b = 0;
        if (w(r, (v) => {
          let _ = v.height(), y = v.get("centerY");
          y instanceof et && (_ *= y.value), _ += v.get("marginBottom", 0), v.set("bounds", { left: a.x, top: b, right: n.x, bottom: Math.max(a.y + s, b + _) }), v.parent == u && u.children.moveValue(v, 0), b = Math.max(b + _, v._fy + _);
        }), b > s) {
          r.reverse();
          let v = s;
          w(r, (_) => {
            let y = _.get("bounds");
            if (y) {
              let A = y.top - (s - b), O = y.bottom - (s - b);
              O > v && (O = v, A = O - _.height()), _.set("bounds", { left: y.left, top: A, right: y.right, bottom: O }), v = O - _.height() - _.get("marginBottom", 0);
            }
          });
        }
      }
...
Object.defineProperty(wt, "className", { enumerable: !0, configurable: !0, writable: !0, value: "XYChart" }), Object.defineProperty(wt, "classNames", { enumerable: !0, configurable: !0, writable: !0, value: Bt.classNames.concat([wt.className]) });
class st extends G {
  _beforeChanged() {
...
class Dt extends F {
  ...
  _afterNew() {
    this._settings.themeTags = L(this._settings.themeTags, ["xy", "cursor"]), super._afterNew(), this.setAll({ width: k, height: k, isMeasured: !0, position: "absolute" }), this.states.create("hidden", { visible: !0, opacity: 0 }), this._drawLines(), this.setPrivateRaw("visible", !1), this._disposers.push(this.setTimeout(() => {
      this.setPrivate("visible", !0);
    }, 500)), this._disposers.push(this.lineX.events.on("positionchanged", () => {
      this._handleXLine();
    })), this._disposers.push(this.lineY.events.on("positionchanged", () => {
      this._handleYLine();
    })), this._disposers.push(this.lineX.events.on("focus", () => this._handleLineFocus())), this._disposers.push(this.lineX.events.on("blur", () => this._handleLineBlur())), this._disposers.push(this.lineY.events.on("focus", () => this._handleLineFocus())), this._disposers.push(this.lineY.events.on("blur", () => this._handleLineBlur())), St("keyboardevents") && this._disposers.push(se(document, "keydown", (t) => {
  ...
  _handleLineMove(t, e) {
    ...
    if (s && s.xAxes.length) {
      ...
      let n = 1;
      if (e && (n = 5), a) {
        let r, o = a.get("renderer").get("inversed", !1);
        t == "ArrowRight" || t == "ArrowDown" ? r = 1 : t == "ArrowLeft" || t == "ArrowUp" ? r = -1 : t == "Tab" && (r = 0), r != null && (o && (r *= -1), this.set(i, a.nextPosition(r * n)));
      }
    }
  }
  _handleLineFocus() {
  ...
  _setChart(t) {
    ...
    this.events.on("boundschanged", () => {
    ...
    }), St("touchevents") && (this._disposers.push(e.events.on("click", (s) => {
      ...
      (this.get("syncWith") || ft(e._downPoints).length != 0 || s.native || !this.isHidden()) && (this._handleMove(s), Math.hypot(this._lastPoint2.x - s.point.x, this._lastPoint2.y - s.point.y) > 1 && (this._handleLineBlur(), this._lastPoint2 = s.point));
    }));
    const i = this.parent;
  ...
  _handleMove(t) {
    if (this.getPrivate("visible")) {
      const e = this.chart;
      if (e && ft(e.plotContainer._downPoints).length > 1) return void this.set("forceHidden", !0);
  ...
  handleMove(t, e, i) {
    ...
    if (n && (this._inPlot(a) || this._downPoint)) {
      ...
      f(h) && (d = h);
      let g = this.get("positionY"), m = l.y;
      f(g) && (m = g), this.setPrivate("positionX", d), this.setPrivate("positionY", m);
      const p = this._getPoint(d, m);
      if (r = p.x, o = p.y, n.xAxes.each((u) => {
        u._handleCursorPosition(d, c), s && u.handleCursorShow();
      }), n.yAxes.each((u) => {
        u._handleCursorPosition(m, c), s && u.handleCursorShow();
      }), !e) {
...
class W extends Ut {
  ...
  _makeFieldNames() {
    const t = this.get("xAxis"), e = this.get("yAxis"), i = t.getPrivate("name"), s = Rt(i), a = e.getPrivate("name"), n = Rt(a), r = t.get("renderer").getPrivate("letter"), o = e.get("renderer").getPrivate("letter"), l = "open", c = "low", h = "high", d = "Show";
  ...
  _fixPosition() {
    ...
    this.set("x", t.x() - vt(t.get("centerX", 0), t.width()) - t.parent.get("paddingLeft", 0)), this.set("y", e.y() - vt(e.get("centerY", 0), e.height()) - e.parent.get("paddingTop", 0)), this.bulletsContainer.set("y", this.y()), this.bulletsContainer.set("x", this.x());
  }
  _prepareChildren() {
    ...
    if (this.isDirty("stacked") && (n ? this._valuesDirty && !this._dataProcessed || this._stack() : this._unstack()), this._valuesDirty && !this._dataProcessed && (this._dataProcessed = !0, n && this._stack(), w(this.dataItems, (r) => {
      ...
      if (l > 0 && i && (i.get("renderer").axisLength() / (o - r) > l ? this._showBullets = !0 : this._showBullets = !1), (this._psi != r || this._pei != o || this.isDirty("vcx") || this.isDirty("vcy") || this.isPrivateDirty("adjustedStartIndex") || this._stackDirty || this._valuesDirty) && !this._selectionProcessed) {
        ...
        else for (let m = r; m < o; m++) this.processYSelectionDataItem(this.dataItems[m], h, d);
        ...
        else for (let m = r; m < o; m++) this.processXSelectionDataItem(this.dataItems[m], c, d);
        if ((i === t || !i) && this.get("valueYShow") !== "valueYWorking") {
          const m = this.getPrivate("selectionMinY");
          m != null && (this.setPrivateRaw("minY", m), e.markDirtyExtremes());
          const p = this.getPrivate("selectionMaxY");
          p != null && (this.setPrivateRaw("maxY", p), e.markDirtyExtremes());
        }
        if ((i === e || !i) && this.get("valueXShow") !== "valueXWorking") {
          const m = this.getPrivate("selectionMinX");
          m != null && (this.setPrivateRaw("minX", m), e.markDirtyExtremes());
          const p = this.getPrivate("selectionMaxX");
          p != null && (this.setPrivateRaw("maxX", p), t.markDirtyExtremes());
        }
  ...
  _positionBullet(t) {
    let e = t.get("sprite");
    if (e) {
      let i = e.dataItem, s = t.get("locationX", i.get("locationX", 0.5)), a = t.get("locationY", i.get("locationY", 0.5)), n = this.get("xAxis"), r = this.get("yAxis"), o = n.getDataItemPositionX(i, this._xField, s, this.get("vcx", 1)), l = r.getDataItemPositionY(i, this._yField, a, this.get("vcy", 1)), c = this.getPoint(o, l), h = i.get("left", c.x), d = i.get("right", c.x), g = i.get("top", c.y), m = i.get("bottom", c.y), p = 0, u = 0, x = d - h, b = m - g;
      if (this._shouldShowBullet(o, l)) {
        e.setPrivate("visible", !t.getPrivate("hidden"));
        let v = t.get("field");
        const _ = this.get("baseAxis"), y = this.get("xAxis"), A = this.get("yAxis");
        if (v != null) {
          let D;
          _ == y ? (v == "value" ? D = this._yField : v == "open" ? D = this._yOpenField : v == "high" ? D = this._yHighField : v == "low" && (D = this._yLowField), D && (l = A.getDataItemPositionY(i, D, 0, this.get("vcy", 1)), c = A.get("renderer").positionToPoint(l), u = c.y, p = h + x * s)) : (v == "value" ? D = this._xField : v == "open" ? D = this._xOpenField : v == "high" ? D = this._xHighField : v == "low" && (D = this._xLowField), D && (o = y.getDataItemPositionX(i, D, 0, this.get("vcx", 1)), c = y.get("renderer").positionToPoint(o), p = c.x, u = m - b * a));
        } else p = h + x * s, u = m - b * a;
        const O = t.get("stacked");
        if (O) {
          const D = this.chart;
          if (_ == y) {
            let T = this._bullets[o + "_" + l];
            if (T) {
              let M = T.bounds(), C = e.localBounds(), N = u;
              u = M.top, O == "down" ? u = M.bottom - C.top : O == "auto" ? D && (N < D.plotContainer.height() / 2 ? u = M.bottom - C.top : u += C.bottom) : u += C.bottom;
            }
            this._bullets[o + "_" + l] = e;
          } else {
            let T = this._bullets[o + "_" + l];
            if (T) {
              let M = T.bounds(), C = e.localBounds(), N = p;
              p = M.right, O == "down" ? p = M.left - C.right : O == "auto" ? D && (N < D.plotContainer.width() / 2 ? p = M.left - C.right : p -= C.left) : p -= C.left;
            }
            this._bullets[o + "_" + l] = e;
          }
        }
        e.isType("Label") && (e.setPrivate("maxWidth", Math.abs(x)), e.setPrivate("maxHeight", Math.abs(b))), e.setAll({ x: p, y: u });
  ...
  showDataItem(t, e) {
    ...
    return it(this, void 0, void 0, function* () {
      ...
      f(e) || (e = this.get("stateAnimationDuration", 0));
  ...
  hideDataItem(t, e) {
    ...
    return it(this, void 0, void 0, function* () {
      ...
      f(e) || (e = a.get("stateAnimationDuration", this.get("stateAnimationDuration", 0)));
      ...
      if (l !== r && l || w(this._valueYFields, (h) => {
        ...
        f(d) && d > g && (g = d), c && (g = 0), t.get(h) != null && s.push(t.animate({ key: h + "Working", to: g, duration: e, easing: n }).waitForStop());
      }), l === o || !l) {
        let h = r.getPrivate("min"), d = r.baseValue();
        f(h) && h > d && (d = h), c && (d = 0), w(this._valueXFields, (g) => {
    ...
    if (e) if (!this.isHidden() && this.get("visible")) {
      if (e._setDataItem(t), t) {
        ...
        if (w(this._valueFields, (p) => {
          ...
          const p = this.chart;
          p && p.inPlot(g) ? (e.label.text.markDirtyText(), e.set("tooltipTarget", this._getTooltipTarget(t)), e.set("pointTo", this._display.toGlobal({ x: g.x, y: g.y }))) : e._setDataItem(void 0);
...
class H extends Wt {
  ...
  zoom(t, e, i, s) {
    if (this.get("zoomable", !0)) if (this._updateFinals(t, e), this.get("start") !== t || this.get("end") != e) {
      ...
      t < -r && (t = -r), e > 1 + r && (e = 1 + r), t > e && ([t, e] = [e, t]), f(i) || (i = this.get("interpolationDuration", 0)), s || (s = "end");
      ...
      f(c) && (o = l / c);
      let d = 1;
      if (f(h) && (d = l / h), s === "start" ? (h > 0 && 1 / (e - t) < d && (e = t + 1 / d), 1 / (e - t) > o && (e = t + 1 / o), e > 1 && e - t < 1 / o && (t = e - 1 / o)) : (h > 0 && 1 / (e - t) < d && (t = e - 1 / d), 1 / (e - t) > o && (t = e - 1 / o), t < 0 && e - t < 1 / o && (e = t + 1 / o)), 1 / (e - t) > o && (e = t + 1 / o), 1 / (e - t) > o && (t = e - 1 / o), h != null && c != null && t == this.get("start") && e == this.get("end")) {
        const g = this.chart;
        g && g._handleAxisSelection(this, !0);
      }
      if ((a && a.playing && a.to == t || this.get("start") == t) && (n && n.playing && n.to == e || this.get("end") == e)) return;
      if (i > 0) {
        let g, m, p = this.get("interpolationEasing");
        if (this.get("start") != t && (g = this.animate({ key: "start", to: t, duration: i, easing: p })), this.get("end") != e && (m = this.animate({ key: "end", to: e, duration: i, easing: p })), this._sAnimation = g, this._eAnimation = m, g) return g;
        if (m) return m;
  ...
  _prepareChildren() {
    ...
    if (t._start = this.get("start"), t._end = this.get("end"), t._inversed = t.get("inversed", !1), t._axisLength = t.axisLength() / (t._end - t._start), t._updateLC(), this.isDirty("tooltip")) {
      ...
      if (e) {
        ...
        e.addTag("axis"), e.addTag(this.className.toLowerCase()), e._applyThemes(), i && (e.set("themeTags", L(e.get("themeTags"), i)), e.label._applyThemes());
      }
    }
  }
  ...
  updateTooltip() {
    ...
    f(e) && (w(this.series, (a) => {
      if (a.get("baseAxis") === this) {
        ...
        t && t.indexOf(a) != -1 ? (a.updateLegendMarker(n), a.updateLegendValue(n), a._settings.tooltipDataItem = n) : (a.showDataItemTooltip(n), a.setRaw("tooltipDataItem", n));
      }
...
class _t extends H {
  ...
  _afterNew() {
    this._settings.themeTags = L(this._settings.themeTags, ["axis"]), this.setPrivateRaw("name", "value"), this.addTag("value"), super._afterNew();
  }
  _prepareChildren() {
    ...
    if ((this.isDirty("min") || this.isDirty("max") || this.isDirty("maxPrecision") || this.isDirty("numberFormat")) && (t = !0, this.ghostLabel.set("text", "")), (this._sizeDirty || this._dirtyExtremes || this._valuesDirty || t || this.isPrivateDirty("width") || this.isPrivateDirty("height") || this.isDirty("extraMin") || this.isDirty("extraMax") || this.isDirty("logarithmic") || this.isDirty("treatZeroAs") || this.isDirty("baseValue") || this.isDirty("strictMinMax") || this.isDirty("strictMinMaxSelection")) && (this._getMinMax(), this._dirtyExtremes = !1), this._handleSizeDirty(), this._dirtySelectionExtremes && !this._isPanning && this.get("autoZoom", !0)) {
      ...
      let i = !1;
      if (e) {
        const s = this.get("renderer").getPrivate("letter");
        s == "Y" ? e.xAxes.each((a) => {
          a.className != "ValueAxis" && (i = !0);
        }) : s == "X" && e.yAxes.each((a) => {
          a.className != "ValueAxis" && (i = !0);
        });
      }
      i && this._getSelectionMinMax(), this._dirtySelectionExtremes = !1;
    }
  ...
  _handleSizeDirty() {
    this._sizeDirty && !this._dseHandled && (this._dirtySelectionExtremes = !0, this._dseHandled = !0);
  }
  _clearDirty() {
  ...
  _prepareAxisItems() {
    ...
    if (f(t) && f(e)) {
      ...
      if (i) {
        ...
        l = r, l <= 0 && (l = 1, s < 1 && (l = f(this._minRealLog) ? this._minRealLog : Math.pow(10, -50))), o = Math.log(n - s) * Math.LOG10E - Math.log(l) * Math.LOG10E, o > 2 && (r = Math.pow(10, Math.log(l) * Math.LOG10E - 50));
      }
      ...
      const m = Math.round(s / g);
      let p = 2;
      S(m / 5, 10) % 1 == 0 && (p = 5), S(m / 10, 10) % 1 == 0 && (p = 10);
      let u = s / p, x = 0, b = 0, v = -1 / 0;
      for (; r < n; ) {
        let _;
        this.dataItems.length < x + 1 ? (_ = new rt(this, void 0, {}), this._dataItems.push(_), this.processDataItem(_)) : _ = this.dataItems[x], this._createAssets(_, []), this._toggleDataItem(_, !0), _.setRaw("value", r);
        const y = _.get("label");
        y && y.set("text", this._formatText(r)), this._prepareDataItem(_);
        let A = r;
        if (i && o > 2 ? A = Math.pow(10, Math.log(l) * Math.LOG10E + x - 50) : A += s, d) {
          let D = r + u;
          for (i && (o > 2 && (u = this._adjustMinMax(r, A, 10).step), D = r + u); D < A - 1e-11 * s; ) {
            let T;
            this.minorDataItems.length < b + 1 ? (T = new rt(this, void 0, {}), this.minorDataItems.push(T), this.processDataItem(T)) : T = this.minorDataItems[b], this._createAssets(T, ["minor"], !0), this._toggleDataItem(T, !0), T.setRaw("value", D);
            const M = T.get("label");
            M && (h ? M.set("text", this._formatText(D)) : M.setPrivate("visible", !1)), this._prepareDataItem(T), D += u, b++;
          }
        }
        if (r = A, v == r) break;
        let O = Math.pow(10, Math.floor(Math.log(Math.abs(s)) * Math.LOG10E));
        if (O < 1 && !i) {
          let D = Math.round(Math.abs(Math.log(Math.abs(O)) * Math.LOG10E)) + 2;
          r = S(r, D);
        }
        x++, v = r;
      }
      for (let _ = x; _ < this.dataItems.length; _++) this._toggleDataItem(this.dataItems[_], !1);
      for (let _ = b; _ < this.minorDataItems.length; _++) this._toggleDataItem(this.minorDataItems[_], !1);
      w(this.series, (_) => {
  ...
  _prepareDataItem(t, e) {
    ...
    f(a) && (r = this.valueToPosition(a), o = r), t.get("isRange") && a == null && (o = n);
  ...
  _handleRangeChange() {
    ...
    this.setPrivateRaw("stepDecimalPlaces", a), t = S(t, a), e = S(e, a), s = this._adjustMinMax(t, e, i, !0);
    let n = s.step;
  ...
  _getSelectionMinMax() {
    ...
    if (f(t) && f(e)) {
      let c = e, h = t;
      if (w(this.series, (_) => {
        if (!_.get("ignoreMinMax")) {
          let y, A;
          const O = _.getPrivate("outOfSelection");
          if (_.get("xAxis") === this) {
            if (!O) {
              let D = _.getPrivate("minX"), T = _.getPrivate("maxX");
              _.startIndex() == 0 && _.endIndex() == _.dataItems.length || (D = void 0, T = void 0), y = _.getPrivate("selectionMinX", D), A = _.getPrivate("selectionMaxX", T);
            }
          } else if (_.get("yAxis") === this && !O) {
            let D = _.getPrivate("minY"), T = _.getPrivate("maxY");
            _.startIndex() == 0 && _.endIndex() == _.dataItems.length || (D = void 0, T = void 0), y = _.getPrivate("selectionMinY", D), A = _.getPrivate("selectionMaxY", T);
          }
          _.isHidden() || _.isShowing() || (f(y) && (c = Math.min(c, y)), f(A) && (h = Math.max(h, A)));
        }
      }), this.axisRanges.each((_) => {
        if (_.get("affectsMinMax")) {
          let y = _.get("value");
          y != null && (c = Math.min(c, y), h = Math.max(h, y)), y = _.get("endValue"), y != null && (c = Math.min(c, y), h = Math.max(h, y));
        }
      }), c > h && ([c, h] = [h, c]), f(i) ? c = l ? i : t : l && f(this._minReal) && (c = this._minReal), f(s) ? h = l ? s : e : l && f(this._maxReal) && (h = this._maxReal), c === h) {
        let _ = c;
        if (c -= this._deltaMinMax, h += this._deltaMinMax, c < t) {
          let A = _ - t;
          A == 0 && (A = this._deltaMinMax), c = _ - A, h = _ + A, l = !0;
        }
        let y = this._adjustMinMax(c, h, r, l);
        c = y.min, h = y.max;
      }
      let d = c, g = h, m = h - c;
      c -= m * a, h += m * n;
      let p = this._adjustMinMax(c, h, r);
      c = p.min, h = p.max, c = nt(c, t, e), h = nt(h, t, e), p = this._adjustMinMax(c, h, r, !0), l || (c = p.min, h = p.max);
      const u = this.get("syncWithAxis");
      if (u && (p = this._syncAxes(c, h, p.step, u.getPrivate("selectionMinFinal", u.getPrivate("minFinal", 0)), u.getPrivate("selectionMaxFinal", u.getPrivate("maxFinal", 1)), u.getPrivate("selectionStepFinal", u.getPrivate("step", 1))), p.min < t && (p.min = t), p.max > e && (p.max = e), c = p.min, h = p.max), l && (f(i) && (c = Math.max(c, i)), f(s) && (h = Math.min(h, s))), o && (c = d - (g - d) * a, h = g + (g - d) * n), l) {
        c = f(i) ? i : d, h = f(s) ? s : g, h - c <= 1e-8 && (c -= this._deltaMinMax, h += this._deltaMinMax);
        let _ = h - c;
        c -= _ * a, h += _ * n;
      }
      this.get("logarithmic") && (c <= 0 && (c = d * (1 - Math.min(a, 0.99))), c < t && (c = t), h > e && (h = e));
      let x = Math.min(20, Math.ceil(Math.log(this.getPrivate("maxZoomFactor", 100) + 1) / Math.LN10) + 2), b = S(this.valueToFinalPosition(c), x), v = S(this.valueToFinalPosition(h), x);
      this.setPrivateRaw("selectionMinFinal", c), this.setPrivateRaw("selectionMaxFinal", h), this.setPrivateRaw("selectionStepFinal", p.step), this.zoom(b, v);
    }
  }
  _getMinMax() {
    ...
    let r = 1 / 0;
    if (w(this.series, (v) => {
      if (!v.get("ignoreMinMax")) {
        let _, y;
        if (v.get("xAxis") === this ? (_ = v.getPrivate("minX"), y = v.getPrivate("maxX")) : v.get("yAxis") === this && (_ = v.getPrivate("minY"), y = v.getPrivate("maxY")), f(_) && f(y)) {
          i = Math.min(i, _), s = Math.max(s, y);
          let A = y - _;
          A <= 0 && (A = Math.abs(y / 100)), A < r && (r = A);
        }
      }
    }), this.axisRanges.each((v) => {
      if (v.get("affectsMinMax")) {
        let _ = v.get("value");
        _ != null && (i = Math.min(i, _), s = Math.max(s, _)), _ = v.get("endValue"), _ != null && (i = Math.min(i, _), s = Math.max(s, _));
      }
    }), this.get("logarithmic")) {
      let v = this.get("treatZeroAs");
      f(v) && i <= 0 && (i = v);
    }
    if (i === 0 && s === 0 && (s = 0.9, i = -0.9), f(t) && (i = t), f(e) && (s = e), i === 1 / 0 || s === -1 / 0) return this.setPrivate("minFinal", void 0), void this.setPrivate("maxFinal", void 0);
    i > s && ([i, s] = [s, i]);
    const o = i, l = s;
    let c = this.adapters.fold("min", i), h = this.adapters.fold("max", s);
    this._minRealLog = i, f(c) && (i = c), f(h) && (s = h), i = this._fixMin(i), s = this._fixMax(s), s - i <= 1 / Math.pow(10, 15) && (s - i != 0 ? this._deltaMinMax = (s - i) / 2 : this._getDelta(s), i -= this._deltaMinMax, s += this._deltaMinMax), i -= (s - i) * a, s += (s - i) * n, this.get("logarithmic") && (i < 0 && o >= 0 && (i = 0), s > 0 && l <= 0 && (s = 0)), this._minReal = i, this._maxReal = s;
    let d = this.get("strictMinMax"), g = this.get("strictMinMaxSelection", !1);
    g && (d = g);
    let m = d;
    f(e) && (m = !0);
    let p = this.get("renderer").gridCount(), u = this._adjustMinMax(i, s, p, m);
    if (i = u.min, s = u.max, u = this._adjustMinMax(i, s, p, !0), i = u.min, s = u.max, d) {
      i = f(t) ? t : this._minReal, s = f(e) ? e : this._maxReal, s - i <= 1e-8 && (i -= this._deltaMinMax, s += this._deltaMinMax);
      let v = s - i;
      i -= v * a, s += v * n;
    }
    c = this.adapters.fold("min", i), h = this.adapters.fold("max", s), f(c) && (i = c), f(h) && (s = h), r == 1 / 0 && (r = s - i);
    let x = Math.round(Math.abs(Math.log(Math.abs(s - i)) * Math.LOG10E)) + 5;
    i = S(i, x), s = S(s, x);
    const b = this.get("syncWithAxis");
    if (b && (u = this._syncAxes(i, s, u.step, b.getPrivate("minFinal", b.getPrivate("min", 0)), b.getPrivate("maxFinal", b.getPrivate("max", 1)), b.getPrivate("step", 1)), i = u.min, s = u.max), this.setPrivateRaw("maxZoomFactor", Math.max(1, Math.ceil((s - i) / r * this.get("maxZoomFactor", 100)))), this._fixZoomFactor(), this.get("logarithmic") && (this._minLogAdjusted = i, i = this._minReal, s = this._maxReal, i <= 0 && (i = o * (1 - Math.min(a, 0.99)))), f(i) && f(s) && (this.getPrivate("minFinal") !== i || this.getPrivate("maxFinal") !== s)) {
      this.setPrivate("minFinal", i), this.setPrivate("maxFinal", s), this._saveMinMax(i, s);
      const v = this.get("interpolationDuration", 0), _ = this.get("interpolationEasing");
      this.animatePrivate({ key: "min", to: i, duration: v, easing: _ }), this.animatePrivate({ key: "max", to: s, duration: v, easing: _ });
    }
  }
  _fixZoomFactor() {
  }
  ...
  _adjustMinMax(t, e, i, s) {
    ...
    if (f(m)) {
      let b = ce(h, m);
      m < Number.MAX_VALUE && h !== b && (h = b, h == 0 && (h = 1));
    }
    let p = 0;
    d < 1 && (p = Math.round(Math.abs(Math.log(Math.abs(d)) * Math.LOG10E)) + 1, h = S(h, p));
    let u, x = Math.floor(t / h);
    return t = S(h * x, p), u = s ? Math.floor(e / h) : Math.ceil(e / h), u === x && u++, (e = S(h * u, p)) < n && (e += h), t > a && (t -= h), h = this.fixSmallStep(h), { min: t, max: e, step: h };
  }
  getTooltipText(t, e) {
    const i = this.get("tooltipNumberFormat", this.get("numberFormat")), s = this.getNumberFormatter(), a = this.get("extraTooltipPrecision", 0), n = this.getPrivate("stepDecimalPlaces", 0) + a, r = S(this.positionToValue(t), n);
  ...
  _syncAxes(t, e, i, s, a, n) {
    if (this.get("syncWithAxis")) {
      ...
      if (f(r) && f(o)) {
        let c = !1, h = 0, d = 0.01 * (e - t), g = t, m = e, p = i;
        for (; c != 1; ) if (c = this._checkSync(g, m, p, r), h++, h > 500 && (c = !0), c) t = g, e = m, i = p;
        else {
          h / 3 == Math.round(h / 3) ? (g = t - d * h, t >= 0 && g < 0 && (g = 0)) : (m = e + d * h, m <= 0 && m > 0 && (m = 0));
          let u = this._adjustMinMax(g, m, l, !0);
          g = u.min, m = u.max, p = u.step;
        }
      }
    }
...
Object.defineProperty(_t, "className", { enumerable: !0, configurable: !0, writable: !0, value: "ValueAxis" }), Object.defineProperty(_t, "classNames", { enumerable: !0, configurable: !0, writable: !0, value: H.classNames.concat([_t.className]) });
class xt extends Et {
  constructor() {
    super(...arguments), Object.defineProperty(this, "_tickPoints", { enumerable: !0, configurable: !0, writable: !0, value: [] });
  }
}
Object.defineProperty(xt, "className", { enumerable: !0, configurable: !0, writable: !0, value: "AxisLabel" }), Object.defineProperty(xt, "classNames", { enumerable: !0, configurable: !0, writable: !0, value: Et.classNames.concat([xt.className]) });
class bt extends Ht {
  constructor() {
    super(...arguments), Object.defineProperty(this, "_tickPoints", { enumerable: !0, configurable: !0, writable: !0, value: [] });
  }
}
Object.defineProperty(bt, "className", { enumerable: !0, configurable: !0, writable: !0, value: "AxisTick" }), Object.defineProperty(bt, "classNames", { enumerable: !0, configurable: !0, writable: !0, value: Ht.classNames.concat([bt.className]) });
class Z extends G {
  constructor() {
    super(...arguments), Object.defineProperty(this, "_axisLength", { enumerable: !0, configurable: !0, writable: !0, value: 100 }), Object.defineProperty(this, "_start", { enumerable: !0, configurable: !0, writable: !0, value: 0 }), Object.defineProperty(this, "_end", { enumerable: !0, configurable: !0, writable: !0, value: 1 }), Object.defineProperty(this, "_inversed", { enumerable: !0, configurable: !0, writable: !0, value: !1 }), Object.defineProperty(this, "_minSize", { enumerable: !0, configurable: !0, writable: !0, value: 0 }), Object.defineProperty(this, "chart", { enumerable: !0, configurable: !0, writable: !0, value: void 0 }), Object.defineProperty(this, "_lc", { enumerable: !0, configurable: !0, writable: !0, value: 1 }), Object.defineProperty(this, "_ls", { enumerable: !0, configurable: !0, writable: !0, value: 0 }), Object.defineProperty(this, "_thumbDownPoint", { enumerable: !0, configurable: !0, writable: !0, value: void 0 }), Object.defineProperty(this, "_downStart", { enumerable: !0, configurable: !0, writable: !0, value: void 0 }), Object.defineProperty(this, "_downEnd", { enumerable: !0, configurable: !0, writable: !0, value: void 0 }), Object.defineProperty(this, "ticks", { enumerable: !0, configurable: !0, writable: !0, value: this.addDisposer(new B(E.new({}), () => bt._new(this._root, { themeTags: L(this.ticks.template.get("themeTags", []), this.get("themeTags", [])) }, [this.ticks.template]))) }), Object.defineProperty(this, "grid", { enumerable: !0, configurable: !0, writable: !0, value: this.addDisposer(new B(E.new({}), () => st._new(this._root, { themeTags: L(this.grid.template.get("themeTags", []), this.get("themeTags", [])) }, [this.grid.template]))) }), Object.defineProperty(this, "axisFills", { enumerable: !0, configurable: !0, writable: !0, value: this.addDisposer(new B(E.new({}), () => G._new(this._root, { themeTags: L(this.axisFills.template.get("themeTags", ["axis", "fill"]), this.get("themeTags", [])) }, [this.axisFills.template]))) }), Object.defineProperty(this, "labels", { enumerable: !0, configurable: !0, writable: !0, value: this.addDisposer(new B(E.new({}), () => xt._new(this._root, { themeTags: L(this.labels.template.get("themeTags", []), this.get("themeTags", [])) }, [this.labels.template]))) }), Object.defineProperty(this, "axis", { enumerable: !0, configurable: !0, writable: !0, value: void 0 }), Object.defineProperty(this, "thumb", { enumerable: !0, configurable: !0, writable: !0, value: void 0 });
  }
  makeTick(t, e) {
    const i = this.ticks.make();
    return i._setDataItem(t), t.setRaw("tick", i), i.set("themeTags", L(i.get("themeTags"), e)), this.axis.labelsContainer.children.push(i), this.ticks.push(i), i;
  }
  makeGrid(t, e) {
    const i = this.grid.make();
    return i._setDataItem(t), t.setRaw("grid", i), i.set("themeTags", L(i.get("themeTags"), e)), this.axis.gridContainer.children.push(i), this.grid.push(i), i;
  }
  makeAxisFill(t, e) {
    const i = this.axisFills.make();
    return i._setDataItem(t), i.set("themeTags", L(i.get("themeTags"), e)), this.axis.gridContainer.children.push(i), t.setRaw("axisFill", i), this.axisFills.push(i), i;
  }
  makeLabel(t, e) {
    const i = this.labels.make();
    return i.set("themeTags", L(i.get("themeTags"), e)), this.axis.labelsContainer.children.moveValue(i, 0), i._setDataItem(t), t.setRaw("label", i), this.labels.push(i), i;
  }
  axisLength() {
    return 0;
  }
  ...
  _handleThumbMove(t) {
    ...
    if (e) {
      const i = this.toLocal(t.point), s = this._downStart, a = this._downEnd, n = this._getPan(i, e) * Math.min(1, a - s) / 2 * this.get("panSensitivity", 1);
...
class At extends Z {
  ...
  _afterNew() {
    this._settings.themeTags = L(this._settings.themeTags, ["renderer", "x"]), super._afterNew(), this.setPrivateRaw("letter", "X");
  ...
  _updatePositions() {
    const t = this.axis, e = t.x() - vt(t.get("centerX", 0), t.width()) - t.parent.get("paddingLeft", 0);
  ...
  updateTick(t, e, i, s) {
    if (t) {
      f(e) || (e = 0);
      let a = 0.5;
      a = f(s) && s > 1 ? t.get("multiLocation", a) : t.get("location", a), f(i) && i != e && (e += (i - e) * a), t.set("x", this.positionToCoordinate(e));
  ...
  updateLabel(t, e, i, s) {
    if (t) {
      let a = 0.5;
      a = f(s) && s > 1 ? t.get("multiLocation", a) : t.get("location", a), f(e) || (e = 0);
      const n = t.get("inside", this.get("inside", !1));
      this.get("opposite") ? n ? (t.set("position", "absolute"), t.set("y", 0)) : (t.set("position", "relative"), t.set("y", k)) : n ? (t.set("y", 0), t.set("position", "absolute")) : (t.set("y", void 0), t.set("position", "relative")), f(i) && i != e && (e += (i - e) * a), t.set("x", this.positionToCoordinate(e)), this.toggleVisibility(t, e, t.get("minPosition", 0), t.get("maxPosition", 1));
    }
  }
  updateGrid(t, e, i) {
    if (t) {
      ...
      f(i) && i != e && (e += (i - e) * s), t.set("x", this.positionToCoordinate(e)), this.toggleVisibility(t, e, 0, 1);
    }
  }
  updateBullet(t, e, i) {
    if (t) {
...
Object.defineProperty(At, "className", { enumerable: !0, configurable: !0, writable: !0, value: "AxisRendererX" }), Object.defineProperty(At, "classNames", { enumerable: !0, configurable: !0, writable: !0, value: Z.classNames.concat([At.className]) });
class kt extends Z {
  constructor() {
  ...
  _afterNew() {
    this._settings.themeTags = L(this._settings.themeTags, ["renderer", "y"]), this._settings.opposite && this._settings.themeTags.push("opposite"), super._afterNew(), this.setPrivateRaw("letter", "Y");
    const t = this.grid.template;
  ...
  _updatePositions() {
    const t = this.axis, e = t.y() - vt(t.get("centerY", 0), t.height());
  ...
  updateLabel(t, e, i, s) {
    if (t) {
      f(e) || (e = 0);
      let a = 0.5;
      a = f(s) && s > 1 ? t.get("multiLocation", a) : t.get("location", a);
      const n = this.get("opposite"), r = t.get("inside", this.get("inside", !1));
      n ? (t.set("x", 0), r ? t.set("position", "absolute") : t.set("position", "relative")) : r ? (t.set("x", 0), t.set("position", "absolute")) : (t.set("x", void 0), t.set("position", "relative")), f(i) && i != e && (e += (i - e) * a), t.set("y", this.positionToCoordinate(e)), this.toggleVisibility(t, e, t.get("minPosition", 0), t.get("maxPosition", 1));
    }
  }
  updateGrid(t, e, i) {
    if (t) {
      f(e) || (e = 0);
      let s = t.get("location", 0.5);
      f(i) && i != e && (e += (i - e) * s), t.set("y", this.positionToCoordinate(e)), this.toggleVisibility(t, e, 0, 1);
    }
  }
  updateTick(t, e, i, s) {
    if (t) {
      f(e) || (e = 0);
      let a = 0.5;
      a = f(s) && s > 1 ? t.get("multiLocation", a) : t.get("location", a), f(i) && i != e && (e += (i - e) * a), t.set("y", this.positionToCoordinate(e));
      let n = t.get("length", 0);
      const r = t.get("inside", this.get("inside", !1));
...
class Tt extends W {
  constructor() {
    super(...arguments), Object.defineProperty(this, "_endIndex", { enumerable: !0, configurable: !0, writable: !0, value: void 0 }), Object.defineProperty(this, "_strokeGenerator", { enumerable: !0, configurable: !0, writable: !0, value: te() }), Object.defineProperty(this, "_fillGenerator", { enumerable: !0, configurable: !0, writable: !0, value: me() }), Object.defineProperty(this, "_legendStroke", { enumerable: !0, configurable: !0, writable: !0, value: void 0 }), Object.defineProperty(this, "_legendFill", { enumerable: !0, configurable: !0, writable: !0, value: void 0 }), Object.defineProperty(this, "strokes", { enumerable: !0, configurable: !0, writable: !0, value: this.addDisposer(new B(E.new({}), () => G._new(this._root, { themeTags: L(this.strokes.template.get("themeTags", []), ["line", "series", "stroke"]) }, [this.strokes.template]))) }), Object.defineProperty(this, "fills", { enumerable: !0, configurable: !0, writable: !0, value: this.addDisposer(new B(E.new({}), () => G._new(this._root, { themeTags: L(this.strokes.template.get("themeTags", []), ["line", "series", "fill"]) }, [this.fills.template]))) }), Object.defineProperty(this, "_fillTemplate", { enumerable: !0, configurable: !0, writable: !0, value: void 0 }), Object.defineProperty(this, "_strokeTemplate", { enumerable: !0, configurable: !0, writable: !0, value: void 0 }), Object.defineProperty(this, "_previousPoint", { enumerable: !0, configurable: !0, writable: !0, value: [0, 0, 0, 0] }), Object.defineProperty(this, "_dindex", { enumerable: !0, configurable: !0, writable: !0, value: 0 }), Object.defineProperty(this, "_sindex", { enumerable: !0, configurable: !0, writable: !0, value: 0 });
  }
  _afterNew() {
  ...
  _updateChildren() {
    ...
    if (this.isDirty("fillPattern")) {
      ...
      const s = this._legendFill;
      s && s.states.lookup("default").set("fillPattern", i);
    }
    ...
    if (t.inited && e.inited) {
      if (this._axesDirty || this._valuesDirty || this._stackDirty || this.isDirty("vcx") || this.isDirty("vcy") || this._sizeDirty || this.isDirty("connect") || this.isDirty("curveFactory")) {
        ...
        for (let c = i - 1; c >= 0; c--) {
          ...
          if (s && g[s] && (n = !0), a && g[a] && (r = !0), w(this._valueFields, (m) => {
            f(h.get(m)) || (d = !1);
          }), d && n && r) {
            i = c;
            break;
  ...
  _clearGraphics() {
    this.strokes.clear(), this.fills.clear(), this.axisRanges.each((t) => {
      t.fills.clear(), t.strokes.clear();
    });
  }
  _startSegment(t) {
    ...
    let h = this.get("xAxis"), d = this.get("yAxis"), g = this.get("baseAxis"), m = this.get("vcx", 1), p = this.get("vcy", 1), u = this._xField, x = this._yField, b = this._xOpenField, v = this._yOpenField;
    const _ = this.get("openValueXField"), y = this.get("openValueYField");
    _ || (b = this._xField), y || (v = this._yField);
    const A = this.get("stacked"), O = h.basePosition(), D = d.basePosition();
    let T;
    ...
    let K = this.get("locationX", 0.5), J = this.get("locationY", 0.5), ht = this.get("openLocationX", K), R = this.get("openLocationY", J);
    const j = this.get("minDistance", 0);
    let I, It = this.fills.template.get("visible");
    this.axisRanges.length > 0 && (It = !0);
    let Ct = !1;
    (A || _ || y) && (Ct = !0);
    const yt = { points: C, segments: M, stacked: A, getOpen: Ct, basePosX: O, basePosY: D, fillVisible: It, xField: u, yField: x, xOpenField: b, yOpenField: v, vcx: m, vcy: p, baseAxis: g, xAxis: h, yAxis: d, locationX: K, locationY: J, openLocationX: ht, openLocationY: R, minDistance: j };
    let dt = this._strokeTemplate, ct = this._fillTemplate;
    for (I = t; I < i; I++) {
      this._dindex = I;
      const z = this._dataItems[I];
      let Q = z.get(u), Pt = z.get(x);
      if (Q == null || Pt == null ? a || (C = [], M.push(C), yt.points = C) : this._getPoints(z, yt), N) {
        let X = z.dataContext[N];
        if (X) {
          if (X instanceof E || (X = E.new(X)), this._strokeTemplate = X, I > t) {
            i = I;
            break;
          }
          dt = X, l.template = X;
      ...
      if (U) {
        let X = z.dataContext[U];
        if (X) {
          if (X instanceof E || (X = E.new(X)), this._fillTemplate = X, I > t) {
            i = I;
            break;
          }
          ct = X, n.template = X;
      ...
      if (!a) {
        let X = this.dataItems[I + 1];
        X && g.shouldGap(z, X, s, T) && (C = [], M.push(C), yt.points = C);
      }
    }
    n.setRaw("userData", [t, I]), l.setRaw("userData", [t, I]), I === e && this._endLine(C, M[0][0]), l && this._drawStroke(l, M), n && this._drawFill(n, M), this.axisRanges.each((z) => {
      const Q = z.container, Pt = z.fills, X = this.makeFill(Pt);
      Q && Q.children.push(X), X.setPrivate("visible", !0), this._drawFill(X, M);
      const ee = z.strokes, ot = this.makeStroke(ee);
      Q && Q.children.push(ot), dt && dt != this.strokes.template && (ot.template = dt), ct && ct != this.fills.template && (X.template = ct), ot.setPrivate("visible", !0), this._drawStroke(ot, M), X.setRaw("userData", [t, I]), ot.setRaw("userData", [t, I]);
    });
  }
  _getPoints(t, e) {
    ...
    if (this._shouldInclude(n)) {
      ...
      if (o.x += this._x, o.y += this._y, t.set("point", o), e.fillVisible) {
        ...
        if (e.baseAxis === e.xAxis ? h = e.basePosY : e.baseAxis === e.yAxis && (c = e.basePosX), e.getOpen) {
          let g = t.get(e.xOpenField), m = t.get(e.yOpenField);
          if (g != null && m != null) {
            let p = t.get("openLocationX", e.openLocationX), u = t.get("openLocationY", e.openLocationY);
            if (e.stacked) {
              let x = t.get("stackToItemX"), b = t.get("stackToItemY");
              x ? (c = e.xAxis.getDataItemPositionX(x, e.xField, p, x.component.get("vcx")), q(c) && (c = e.basePosX)) : c = e.yAxis === e.baseAxis ? e.basePosX : e.xAxis.getDataItemPositionX(t, e.xOpenField, p, e.vcx), b ? (h = e.yAxis.getDataItemPositionY(b, e.yField, u, b.component.get("vcy")), q(h) && (h = e.basePosY)) : h = e.xAxis === e.baseAxis ? e.basePosY : e.yAxis.getDataItemPositionY(t, e.yOpenField, u, e.vcy);
            } else c = e.xAxis.getDataItemPositionX(t, e.xOpenField, p, e.vcx), h = e.yAxis.getDataItemPositionY(t, e.yOpenField, u, e.vcy);
          }
        }
      ...
      if (e.minDistance > 0) {
        const c = l[0], h = l[1], d = l[2], g = l[3], m = this._previousPoint, p = m[0], u = m[1], x = m[2], b = m[3];
        (Math.hypot(c - p, h - u) > e.minDistance || d && g && Math.hypot(d - x, g - b) > e.minDistance) && (i.push(l), this._previousPoint = l);
      } else i.push(l);
    }
  }
  _endLine(t, e) {
  ...
  _processAxisRange(t) {
    super._processAxisRange(t), t.fills = new B(E.new({}), () => G._new(this._root, { themeTags: L(t.fills.template.get("themeTags", []), ["line", "series", "fill"]) }, [this.fills.template, t.fills.template])), t.strokes = new B(E.new({}), () => G._new(this._root, { themeTags: L(t.strokes.template.get("themeTags", []), ["line", "series", "stroke"]) }, [this.strokes.template, t.strokes.template]));
  }
  createLegendMarker(t) {
    const e = this.get("legendDataItem");
    if (e) {
...
class $ extends W {
  ...
  _updateChildren() {
    ...
    this.isDirty("fill") && a.get("fill") == null && a.set("fill", this.get("fill")), this.isDirty("fillPattern") && a.get("fillPattern") == null && a.set("fillPattern", this.get("fillPattern")), this.isDirty("stroke") && a.get("stroke") == null && a.set("stroke", this.get("stroke"));
    let n = 0, r = 0, o = 0;
    w(s.series, (x) => {
      if (x instanceof $) {
        const b = x.get("stacked");
        b && o == 0 && r++, !b && x.get("clustered") && r++;
      }
      x === this && (n = r - 1), o++;
    }), this.get("clustered") || (n = 0, r = 1), r === 0 && (r = 1, n = 0);
    const l = e.get("renderer"), c = i.get("renderer"), h = "cellStartLocation", d = "cellEndLocation", g = l.get(h, 0), m = l.get(d, 1), p = c.get(h, 0), u = c.get(d, 1);
    if (this._aLocationX0 = g + n / r * (m - g), this._aLocationX1 = g + (n + 1) / r * (m - g), this._aLocationY0 = p + n / r * (u - p), this._aLocationY1 = p + (n + 1) / r * (u - p), e.inited && i.inited) {
      if (this._axesDirty || this._valuesDirty || this._stackDirty || this.isDirty("vcx") || this.isDirty("vcy") || this._sizeDirty) {
        const x = this.dataItems.length;
        let b = Math.max(0, this.startIndex() - 2), v = Math.min(this.endIndex() + 2, x - 1);
        for (let y = 0; y < b; y++) this._toggleColumn(this.dataItems[y], !1);
        let _ = this.dataItems[b];
        for (let y = b; y <= v; y++) {
          let A = this.dataItems[y];
          if (A.get("valueX") != null && A.get("valueY") != null) {
            if (_ = A, y > 0 && b > 0) for (let O = y - 1; O >= 0; O--) {
              let D = this.dataItems[O];
        ...
        for (let y = b; y <= v; y++) {
          let A = this.dataItems[y];
          this._updateGraphics(A, _), A.get("valueX") != null && A.get("valueY") != null && (_ = A);
        }
        for (let y = v + 1; y < x; y++) this._toggleColumn(this.dataItems[y], !1);
      }
    } else this._skipped = !0;
  ...
  _updateGraphics(t, e) {
    ...
    if (n != null && r != null) {
      const o = this._xOpenField, l = this._yOpenField, c = this.get("locationX", t.get("locationX", 0.5)), h = this.get("locationY", t.get("locationY", 0.5)), d = this.get("openLocationX", t.get("openLocationX", c)), g = this.get("openLocationY", t.get("openLocationY", h)), m = i.get("width"), p = i.get("height"), u = this.get("stacked"), x = this.get("xAxis"), b = this.get("yAxis"), v = this.get("baseAxis"), _ = x.get("start"), y = x.get("end"), A = b.get("start"), O = b.get("end");
      let D, T, M, C, N = this.get("vcy", 1), U = this.get("vcx", 1), K = !1, J = !1;
      if (b.isType("CategoryAxis") && x.isType("CategoryAxis")) {
        let R = this._aLocationX0 + d - 0.5, j = this._aLocationX1 + c - 0.5;
        if (m instanceof et) {
          let I = (j - R) * (1 - m.value) / 2;
          R += I, j -= I;
        }
        if (D = x.getDataItemPositionX(t, o, R, U), T = x.getDataItemPositionX(t, s, j, U), R = this._aLocationY0 + g - 0.5, j = this._aLocationY1 + h - 0.5, p instanceof et) {
          let I = (j - R) * (1 - p.value) / 2;
          R += I, j -= I;
        }
        M = b.getDataItemPositionY(t, l, R, N), C = b.getDataItemPositionY(t, a, j, N), t.setRaw("point", { x: D + (T - D) / 2, y: M + (C - M) / 2 });
      } else if (x === v) {
        let R = this._aLocationX0 + d - 0.5, j = this._aLocationX1 + c - 0.5;
        if (m instanceof et) {
          let I = (j - R) * (1 - m.value) / 2;
        ...
        if (D = x.getDataItemPositionX(t, o, R, U), T = x.getDataItemPositionX(t, s, j, U), M = b.getDataItemPositionY(t, a, h, N), this._yOpenField !== this._yField) C = b.getDataItemPositionY(t, l, g, N);
        else if (u) {
          let I = t.get("stackToItemY");
          C = I ? b.getDataItemPositionY(I, a, g, I.component.get("vcy")) : b.basePosition();
        } else C = b.basePosition();
        t.setRaw("point", { x: D + (T - D) / 2, y: M }), J = !0;
      } else if (b === v) {
        let R = this._aLocationY0 + g - 0.5, j = this._aLocationY1 + h - 0.5;
        if (p instanceof et) {
          let I = (j - R) * (1 - p.value) / 2;
          R += I, j -= I;
        }
        if (M = b.getDataItemPositionY(t, l, R, N), C = b.getDataItemPositionY(t, a, j, N), T = x.getDataItemPositionX(t, s, c, U), this._xOpenField !== this._xField) D = x.getDataItemPositionX(t, o, d, U);
        else if (u) {
          let I = t.get("stackToItemX");
          D = I ? x.getDataItemPositionX(I, s, d, I.component.get("vcx")) : x.basePosition();
        } else D = x.basePosition();
        K = !0, t.setRaw("point", { x: T, y: M + (C - M) / 2 });
      }
      this._updateSeriesGraphics(t, i, D, T, M, C, K, J), D < _ && T < _ || D > y && T > y || M < A && C <= A || M >= O && C > O || q(D) || q(M) ? this._toggleColumn(t, !1) : this._toggleColumn(t, !0);
      let ht = t.get("rangeGraphics");
      ht && w(ht, (R) => {
        this._updateSeriesGraphics(t, R, D, T, M, C, K, J);
      }), this._applyGraphicsStates(t, e);
    }
  }
  _updateSeriesGraphics(t, e, i, s, a, n, r, o) {
    const l = e.get("width"), c = e.get("height"), h = e.get("maxWidth"), d = e.get("maxHeight"), g = this.getPoint(i, a), m = this.getPoint(s, n), p = t.get("point");
    if (p) {
      const u = this.getPoint(p.x, p.y);
      p.x = u.x + this._x, p.y = u.y + this._y;
    }
    if (i = g.x, s = m.x, a = g.y, n = m.y, f(l)) {
      const u = (s - i - l) / 2;
      i += u, s -= u;
    }
    if (f(h) && h < Math.abs(s - i)) {
      const u = (s - i - h) / 2;
      i += u, s -= u;
    }
    if (f(c)) {
  ...
  _applyGraphicsStates(t, e) {
    ...
    if (s || n || a || r) {
      ...
      let h, d, g;
      c === o && l.isType("ValueAxis") ? (h = t.get(this._yOpenField), d = t.get(this._yField), g = e.get(this._yField)) : c === l && o.isType("ValueAxis") && (h = t.get(this._xOpenField), d = t.get(this._xField), g = e.get(this._xField)), f(h) && f(d) && (d < h ? s && s.apply() : a && a.apply(), f(g) && (d < g ? n && n.apply() : r && r.apply()));
    }
  }
  disposeDataItem(t) {
    super.disposeDataItem(t);
...
class at extends H {
  ...
  _afterNew() {
    this._settings.themeTags = L(this._settings.themeTags, ["axis"]), this.fields.push("category"), this.setPrivateRaw("name", "category"), this.addTag("category"), super._afterNew();
  }
  _prepareChildren() {
    super._prepareChildren();
  ...
  _handleRangeChange() {
    w(this.series, (t) => {
      ...
      if (a instanceof at && n instanceof at) t._markDirtyAxes();
        ...
        let r, o, l = n;
        if (a === s ? (t.get("categoryXField") && (r = "categoryX"), t.get("openCategoryXField") && (o = "openCategoryX")) : n === s && (t.get("categoryYField") && (r = "categoryY"), t.get("openCategoryYField") && (o = "openCategoryY"), l = a), l instanceof _t && (r || o)) {
          let c, h;
          for (let p = 0, u = t.dataItems.length; p < u; p++) {
            let x = t.dataItems[p];
            if (r && x.get(r) === e) {
              c = x;
              break;
          ...
          for (let p = t.dataItems.length - 1; p >= 0; p--) {
            let u = t.dataItems[p];
            if (r && u.get(r) === i) {
              h = u;
              break;
          ...
          let m = !1;
          for (let p = d; p < g; p++) {
            const u = t.dataItems[p];
            if (w(t.__valueXShowFields, (x) => {
              u.get(x) != null && (m = !0);
            }), w(t.__valueYShowFields, (x) => {
              u.get(x) != null && (m = !0);
            }), m) break;
          }
          t.setPrivate("outOfSelection", !m);
        }
        t._markDirtyAxes();
      }
    });
  ...
  _prepareDataItem(t, e, i) {
    ...
    f(r) || (r = this.categoryToIndex(t.get("category")));
    let o, l = this.indexToPosition(r, a), c = t.get("endCategory");
    c ? (o = this.categoryToIndex(c), f(o) || (o = r)) : o = r;
...
class Mt extends $ {
  constructor() {
    super(...arguments), Object.defineProperty(this, "columns", { enumerable: !0, configurable: !0, writable: !0, value: this.addDisposer(new B(E.new({}), () => Gt._new(this._root, { position: "absolute", themeTags: L(this.columns.template.get("themeTags", []), ["series", "column"]) }, [this.columns.template]))) });
  }
  makeColumn(t, e) {
  ...
  _processAxisRange(t) {
    super._processAxisRange(t), t.columns = new B(E.new({}), () => Gt._new(this._root, { position: "absolute", themeTags: L(t.columns.template.get("themeTags", []), ["series", "column"]) }, [this.columns.template, t.columns.template]));
  }
}
...
//# sourceMappingURL=xyChart-Cvb5UsKA.js.map
