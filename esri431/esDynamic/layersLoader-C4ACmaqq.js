import { s as p, v as S, w as T, e as v, d as L } from "./main-DZxT3i7S.js";
import { b as F, a as M, t as $ } from "./fetchService-BbX6Wqej.js";
import { l as y, a as P, o as G, u as m, t as d, c as x, n as D, i as k, e as w } from "./portalLayers-CU5dZsja.js";
import { populateGroupLayer as C } from "./layersCreator-D5uJwHqi.js";
import { e as h } from "./jsonContext-iveSquhc.js";
...
async function O(t) {
  ...
  if (!r) return;
  const e = h(a, "web-map");
  t.read(r, e), await C(t, r, { context: e }), t.resourceReferences = { portalItem: a, paths: e.readResourcePaths ?? [] };
}
...
function f(t, a, r, e, o) {
  ...
  if ("sourceJSON" in l && (l.sourceJSON = o), l.type !== "subtype-group" && l.type !== "catalog" && (l.sublayerTitleMode = "service-name"), s.type === "Feature Collection") {
    const i = { origin: "portal-item", portal: s.portal || v.getDefault() };
    l.read(e, i);
...
async function I(t, a, r) {
  ...
  if (z(e)) {
    ...
    if ((s?.layers || s?.tables) && l > 0) {
      if (e.layerId == null) {
        const i = x(e.type), c = i ? D(s, i)[0] : y(s);
        c && (e.layerId = c.id);
      }
...
//# sourceMappingURL=layersLoader-C4ACmaqq.js.map
