import { ay as x, bQ as o, bR as a, bS as C, eL as P, eI as B, eK as v, fa as F, ex as z, eB as A, ez as k, eA as W, eC as K, b1 as b, a8 as O, fb as H, T as w, dv as I, fc as N, fd as h, fe as M, ff as R, a1 as V, s as q, fg as Q, a5 as U, b_ as X, cG as Y, cH as Z, cI as ee, a0 as te, e1 as L, eD as f, f9 as re, aA as oe, fh as le, fi as D, eM as ie } from "./main-DZxT3i7S.js";
import { n as ae } from "./objectIdUtils-EszJVKSV.js";
function g(t) {
  return t.featureCollectionType === "markup" || t.layers.some((e) => e.layerDefinition.visibilityField != null || !E(e));
}
function E({ layerDefinition: t, featureSet: e }) {
...
let u = class extends le {
  ...
  get fullExtent() {
    ...
    return t ? e == null ? h($(), t).geometry : R(e, t) : null;
  }
  get fullBounds() {
...
let i = class extends z(A(k(W(K(ie))))) {
  ...
  readSublayers(t, e, r) {
    ...
    for (const n of e.layers) {
      const { layerDefinition: y, featureSet: p } = n, c = y.id ?? s++, d = E(n);
      if (d != null) {
        const m = new u({ id: d.id, title: y.name, layerId: c, layer: this, graphics: p.features.map(({ geometry: S, symbol: _, attributes: j, popupInfo: G }) => V.fromJSON({ attributes: j, geometry: S, symbol: _, popupTemplate: G })) });
        l.push(m);
      }
    }
    return new O(l);
  ...
  writeSublayers(t, e, r, l) {
    ...
    if (!this.capabilities.operations.supportsMapNotesEditing) return void (y && l?.messages?.push(new q("map-notes-layer:editing-not-supported", "New map notes cannot be added to this layer")));
    const p = [];
    let c = this.spatialReference.toJSON();
    e: for (const d of t) for (const m of d.graphics) if (m.geometry != null) {
      c = m.geometry.spatialReference.toJSON();
      break e;
    }
    for (const d of J) {
      const m = t.find((S) => d.id === S.id);
      this._writeMapNoteSublayer(p, m, d, s, n, c, l);
    }
  ...
  async beforeSave() {
    ...
    for (const l of this.sublayers) for (const s of l.graphics) if (s.geometry != null) {
      const n = s.geometry;
      t ? U(n.spatialReference, t) || (X(n.spatialReference, t) || Y() || await Z(), s.geometry = ee(n, t)) : t = n.spatialReference, e.push(s);
    }
  ...
  _writeMapNoteSublayer(t, e, r, l, s, n, y) {
    const p = [];
    if (e != null) {
      for (const c of e.graphics) this._writeMapNote(p, c, r.geometryType, y);
...
o([a({ readOnly: !0 })], i.prototype, "capabilities", void 0), o([f(["portal-item", "web-map"], "capabilities", ["layers"])], i.prototype, "readCapabilities", null), o([a({ readOnly: !0 })], i.prototype, "featureCollections", void 0), o([f(["web-map", "portal-item"], "featureCollections", ["layers"])], i.prototype, "readFeatureCollections", null), o([a({ readOnly: !0, json: { origins: { "web-map": { write: { enabled: !0, target: "featureCollection" } } } } })], i.prototype, "featureCollectionJSON", void 0), o([f(["web-map", "portal-item"], "featureCollectionJSON", ["featureCollection"])], i.prototype, "readLegacyfeatureCollectionJSON", null), o([a({ readOnly: !0, json: { read: !0, write: { enabled: !0, ignoreOrigin: !0 } } })], i.prototype, "featureCollectionType", void 0), o([a({ readOnly: !0 })], i.prototype, "fullExtent", null), o([a({ readOnly: !0, json: { origins: { "web-map": { write: { target: "featureCollection.showLegend", overridePolicy() {
  return { enabled: this.featureCollectionJSON != null };
} } } } } })], i.prototype, "legendEnabled", void 0), o([a({ type: ["show", "hide", "hide-children"] })], i.prototype, "listMode", void 0), o([a({ type: Number, nonNullable: !0, json: { write: !1 } })], i.prototype, "minScale", void 0), o([f(["web-map", "portal-item"], "minScale", ["layers"])], i.prototype, "readMinScale", null), o([a({ type: Number, nonNullable: !0, json: { write: !1 } })], i.prototype, "maxScale", void 0), o([f(["web-map", "portal-item"], "maxScale", ["layers"])], i.prototype, "readMaxScale", null), o([a({ readOnly: !0 })], i.prototype, "multipointLayer", null), o([a({ value: "ArcGISFeatureLayer", type: ["ArcGISFeatureLayer"] })], i.prototype, "operationalLayerType", void 0), o([a({ readOnly: !0 })], i.prototype, "pointLayer", null), o([a({ readOnly: !0 })], i.prototype, "polygonLayer", null), o([a({ readOnly: !0 })], i.prototype, "polylineLayer", null), o([a({ type: b })], i.prototype, "spatialReference", void 0), o([f(["web-map", "portal-item"], "spatialReference", ["layers"])], i.prototype, "readSpatialReference", null), o([a({ readOnly: !0, json: { origins: { "web-map": { write: { ignoreOrigin: !0 } } } } })], i.prototype, "sublayers", void 0), o([f("web-map", "sublayers", ["layers"])], i.prototype, "readSublayers", null), o([re("web-map", "sublayers")], i.prototype, "writeSublayers", null), o([a({ readOnly: !0 })], i.prototype, "textLayer", null), o([a()], i.prototype, "title", void 0), o([a({ readOnly: !0, json: { read: !1 } })], i.prototype, "type", void 0), i = o([C("esri.layers.MapNotesLayer")], i);
const pe = i;
export {
  pe as default
};
//# sourceMappingURL=MapNotesLayer-DdwxUp8T.js.map
