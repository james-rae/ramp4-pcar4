import { Y as M, n as N, ao as Y, ap as F, e as x, k as R, ab as S, a8 as j, t as B, aq as u } from "./Theme-D8IVldck.js";
class D extends M {
  _beforeChanged() {
...
class P extends N {
  ...
  _afterNew() {
    this._settings.themeTags = Y(this._settings.themeTags, ["tooltip"]), super._afterNew(), this._setDefaultFn("background", () => D.new(this._root, {})).set("themeTags", ["tooltip", "background"]), this._label = this.children.push(F.new(this._root, {})), this._disposers.push(this._label.events.on("boundschanged", () => {
  ...
  _dispose() {
    super._dispose(), R(this._root._tooltips, this);
  }
  _updateChildren() {
  ...
  _changed() {
    if (super._changed(), (this.isDirty("pointTo") || this.isDirty("pointerOrientation")) && this._updateBackground(), this.isDirty("tooltipTarget") && this.updateBackgroundColor(), this.isDirty("keepTargetHover"))
      if (this.get("keepTargetHover")) {
        ...
        this._keepHoverDp = new S([t.events.on("pointerover", (i) => {
...
//# sourceMappingURL=Tooltip-BajnU09M.js.map
