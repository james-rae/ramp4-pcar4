import { bQ as r, bR as i, bS as y, bT as B, hQ as S, eq as v, T as u, eN as V, ez as N, eA as _, eB as A, eC as L, eO as O, eP as E, ay as g, fg as D, B as G, ho as K, mW as x, s as l, aw as M, U, G as C, hv as k, cB as z, eD as Q, eU as W, eF as Z, f9 as H, hA as J, eM as X } from "./main-DZxT3i7S.js";
import { R as Y, V as T } from "./SceneService-BySgYuKY.js";
import { c as q, d as ee, b as te, a as re } from "./PointCloudUniqueValueRenderer-CIJLK593.js";
import { $ as F, Z as ie, w as oe } from "./elevationInfoUtils-CrzkqZgQ.js";
...
const ae = p, le = { key: "type", base: m, typeMap: { value: ae, bitfield: se, return: ne } };
var $;
...
const de = h, P = { key: "type", base: q, typeMap: { "point-cloud-class-breaks": ee, "point-cloud-rgb": de, "point-cloud-stretch": te, "point-cloud-unique-value": re }, errorContext: "renderer" }, R = J();
let o = class extends Y(V(N(_(A(L(O(E(X)))))))) {
  constructor(...e) {
  ...
  readServiceFields(e, t, n) {
    ...
    }) : Array.isArray(t.attributeStorageInfo) ? t.attributeStorageInfo.map((s) => new g({ name: s.name, type: s.name === "ELEVATION" ? "double" : "integer" })) : null;
  }
  set elevationInfo(e) {
    this._set("elevationInfo", e), this._validateElevationInfo();
  }
  writeRenderer(e, t, n, s) {
    D("layerDefinition.drawingInfo.renderer", e.write({}, s), t);
  }
  load(e) {
    const t = e != null ? e.signal : null, n = this.loadFromPortal({ supportedTypes: ["Scene Service"] }, e).catch(G).then(() => this._fetchService(t));
  ...
  async queryCachedStatistics(e, t) {
    ...
    for (const s of this.attributeStorageInfo) if (s.name === n.name) {
      const a = M(this.parsedUrl?.path ?? "", `./statistics/${s.key}`);
      return U(a, { query: { f: "json", ...this.customParameters, token: this.apiKey }, responseType: "json", signal: t ? t.signal : null }).then((j) => j.data);
    }
    throw new l("pointcloudlayer:no-cached-statistics", "Cached statistics for this attribute are not available");
  }
  async saveAs(e, t) {
    return this._debouncedSaveOperations(T.SAVE_AS, { ...t, getTypeKeywords: () => this._getTypeKeywords(), portalItemLayerType: "point-cloud" }, e);
  }
  async save() {
    const e = { getTypeKeywords: () => this._getTypeKeywords(), portalItemLayerType: "point-cloud" };
    return this._debouncedSaveOperations(T.SAVE, e);
  }
  validateLayer(e) {
  ...
  _validateElevationInfo() {
    ...
    F(C.getLogger(this), ie("Point cloud layers", "absolute-height", e)), F(C.getLogger(this), oe("Point cloud layers", e));
  }
};
r([i({ type: ["PointCloudLayer"] })], o.prototype, "operationalLayerType", void 0), r([i(k)], o.prototype, "popupEnabled", void 0), r([i({ type: z, json: { name: "popupInfo", write: !0 } })], o.prototype, "popupTemplate", void 0), r([i({ readOnly: !0, json: { read: !1 } })], o.prototype, "defaultPopupTemplate", null), r([i({ readOnly: !0, json: { write: !1, read: !1, origins: { "web-document": { write: !1, read: !1 } } } })], o.prototype, "opacity", void 0), r([i({ type: ["show", "hide"] })], o.prototype, "listMode", void 0), r([i({ types: [le], json: { origins: { service: { read: { source: "filters" } } }, name: "layerDefinition.filters", write: !0 } })], o.prototype, "filters", void 0), r([i({ type: [g] })], o.prototype, "fields", void 0), r([i(R.fieldsIndex)], o.prototype, "fieldsIndex", void 0), r([Q("service", "fields", ["fields", "attributeStorageInfo"])], o.prototype, "readServiceFields", null), r([i(R.outFields)], o.prototype, "outFields", void 0), r([i({ readOnly: !0 })], o.prototype, "attributeStorageInfo", void 0), r([i(W)], o.prototype, "elevationInfo", null), r([i({ type: String, json: { origins: { "web-scene": { read: !0, write: !0 }, "portal-item": { read: !0, write: !0 } }, read: !1 } })], o.prototype, "path", void 0), r([i(Z)], o.prototype, "legendEnabled", void 0), r([i({ types: P, json: { origins: { service: { read: { source: "drawingInfo.renderer" } } }, name: "layerDefinition.drawingInfo.renderer", write: { target: { "layerDefinition.drawingInfo.renderer": { types: P }, "layerDefinition.drawingInfo.transparency": { type: Number } } } } })], o.prototype, "renderer", void 0), r([H("renderer")], o.prototype, "writeRenderer", null), r([i({ json: { read: !1 }, readOnly: !0 })], o.prototype, "type", void 0), o = r([y("esri.layers.PointCloudLayer")], o);
const fe = o;
export {
  fe as default
};
//# sourceMappingURL=PointCloudLayer-DGWo2Zmz.js.map
