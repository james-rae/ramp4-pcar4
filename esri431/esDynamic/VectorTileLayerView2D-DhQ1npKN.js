import { cQ as Me, cX as Ve, cU as Re, cV as Pe, U as $e, ok as X, gS as ze, cZ as ne, fp as Fe, gK as He, B as qe, cv as L, cu as Z, et as oe, el as Be, pA as Ae, ea as Ne, b7 as F, lw as Qe, aN as E, aE as D, pB as ae, gE as We, gF as Je, gH as Ke, h_ as Ge, gL as $, pC as Ye, j5 as je, aP as B, ih as k, ig as le, aV as N, gN as Le, a1 as he, bW as Xe, cq as Ze, pD as et, pE as tt, cE as V, a5 as st, G, cr as ce, cs as ue, T as it, D as rt, bQ as ye, bR as nt, bS as ot } from "./main-DZxT3i7S.js";
import { I, E as R } from "./enums-qHpGJ28Q.js";
import { t as A } from "./Rect-DD6XS68q.js";
import { l as at } from "./rasterizingUtils-D7pd0XKj.js";
import { w as lt, d as ht } from "./GeometryUtils-C-fTcTXr.js";
import { E as M } from "./BufferObject-Bb9Pw3sC.js";
import { o as U } from "./VertexArrayObject-DNKO7QGF.js";
import { e as W, t as ct, c as ut } from "./config-nuMERBvb.js";
import { r as Oe } from "./WGLContainer-CjZoexai.js";
import { n as yt, l as O, r as dt, i as ee, a as C } from "./StyleDefinition-D9H4pBJh.js";
import { i as _t } from "./TileContainer-BYi4aQ0i.js";
import { h as ft } from "./PooledRBush-BfX9FRSa.js";
import { e as de, s as _e } from "./SourceLayerData-DEo9tEFZ.js";
import { L as pt, l as fe } from "./StyleRepository-BQUCE9Sk.js";
import { j as gt, y as mt } from "./LayerView-BSi2ZKlw.js";
import { i as bt } from "./RefreshableLayerView-hfJGJOy7.js";
let z = class {
  constructor(e, s) {
  ...
  bind(e, s, t, i = 0) {
    if (!this._textures[t]) {
      const n = new Me();
      n.pixelFormat = Ve.ALPHA, n.wrapMode = Re.CLAMP_TO_EDGE, n.width = this.width, n.height = this.height, this._textures[t] = new Pe(e, n, new Uint8Array(this.width * this.height));
    }
  ...
  getBitmap(e) {
    ...
    return i !== 0 ? new St(this._allBitmaps, t, i) : void 0;
  }
}, wt = class {
  constructor() {
    this._ranges = [];
  ...
  getRange(e, s) {
    ...
    if (this._baseURL) {
      ...
      return $e(n, { responseType: "array-buffer" }).then((o) => {
        t.addRange(s, new Y(new X(new Uint8Array(o.data), new DataView(o.data))));
      }).catch(() => {
        t.addRange(s, new Y());
      });
    }
    return t.addRange(s, new Y()), Promise.resolve();
  }
  getGlyph(e, s) {
    const t = this._getFontStack(e);
    if (!t) return;
  ...
  _getFontStack(e) {
    ...
    return s || (s = this._glyphInfo[e] = new wt()), s;
  }
}, St = class {
  constructor(e, s, t) {
...
let me = class ke {
  ...
  getSpriteItem(e, s = !1) {
    ...
    if (r) return r;
    if (!this._sprites || this._sprites.loadStatus !== "loaded" || (e && e.startsWith(xt) ? ([t, i] = this._rasterizeDash(e), s = !0) : t = this._sprites.getSpriteInfo(e), !t?.width || !t.height || t.width < 0 || t.height < 0)) return null;
  ...
  bind(e, s, t = 0, i = 0) {
    ...
    if (!this._textures[t]) {
      const n = new Me();
      n.wrapMode = Re.CLAMP_TO_EDGE, n.width = this._size[t][0], n.height = this._size[t][1], this._textures[t] = new Pe(e, n, new Uint8Array(this._mosaicsData[t].buffer));
    }
    const r = this._textures[t];
  ...
  _copy(e, s, t, i, r, n) {
    ...
    const o = new Uint32Array(n ? n.buffer : this._sprites.image.buffer), a = this._mosaicsData[t], l = 2, c = n ? s.width : this._sprites.width;
    ke._copyBits(o, c, s.x, s.y, a, i[0], e.x + l, e.y + l, s.width, s.height, r), this._dirties[t] = !0;
  }
  _allocateImage(e, s) {
    e += 2, s += 2;
    ...
    return n.width <= 0 ? (this._dirties[this._currentPage] || (this._mosaicsData[this._currentPage] = null), this._currentPage = this._mosaicsData.length, this._mosaicsData.push(new Uint32Array(this._pageWidth * this._pageHeight)), this._dirties.push(!0), this._size.push([this._pageWidth, this._pageHeight]), this._textures.push(void 0), this._binPack = new z(this._pageWidth - 4, this._pageHeight - 4), this._allocateImage(e, s)) : [n, this._currentPage, [this._pageWidth, this._pageHeight]];
  }
  _rasterizeDash(e) {
    const s = /\[(.*?)\]/, t = e.match(s);
    if (!t) return null;
    const i = t[1].split(",").map(Number), r = e.slice(e.lastIndexOf("-") + 1), [n, o, a] = at(i, r);
  ...
  async start(e) {
    ...
    const s = this._layer.currentStyleInfo.glyphsUrl, t = new ge(s ? ne(s, { ...this._layer.customParameters, token: this._layer.apiKey }) : null);
    this._glyphMosaic = new pe(1024, 1024, t), this._broadcastPromise = Fe("WorkerTileHandler", { client: this, schedule: e.schedule, signal: e.signal }).then((i) => {
  ...
  _requestSprite(e) {
    ...
    const t = e?.signal;
    this._inputSignalEventListener && this._startOptionsInputSignal?.removeEventListener("abort", this._inputSignalEventListener), this._startOptionsInputSignal = null, t && (this._inputSignalEventListener = Tt(s), t.addEventListener("abort", this._inputSignalEventListener, { once: !0 }));
    ...
    this._spriteSourcePromise = this._layer.loadSpriteSource(this.devicePixelRatio, r), this._spriteSourcePromise.then((n) => {
      qe(i), this._spriteMosaic = new me(1024, 1024, 250), this._spriteMosaic.setSpriteSource(n);
    });
  }
  async updateStyle(e) {
    const s = [];
    for (const t of e) t.type === I.SPRITES_CHANGED ? s.push({ type: I.SPRITES_CHANGED, data: { spriteSource: null } }) : s.push(t);
    return await this._broadcastPromise, this._broadcastPromise = Promise.all(this._connection.broadcast("updateStyle", s)), this._broadcastPromise;
  }
  setSpriteSource(e) {
    const s = new me(1024, 1024, 250);
  ...
  async setStyle(e, s, t) {
    ...
    const i = new ge(this._layer.currentStyleInfo.glyphsUrl ? ne(this._layer.currentStyleInfo.glyphsUrl, { ...this._layer.customParameters, token: this._layer.apiKey }) : null);
    return this._glyphMosaic = new pe(1024, 1024, i), this._broadcastPromise = Promise.all(this._connection.broadcast("setStyle", { style: s, sourceDataMaxLOD: this._sourceDataMaxLOD })), this._broadcastPromise;
  }
  ...
  async _getTilePayload(e, s, t) {
    const i = L.pool.acquire(e.id), r = this._layer.sourceNameToSource[s], { level: n, row: o, col: a } = i;
    L.pool.release(i);
    try {
...
const be = 512, vt = 1e-6, Ct = (h, e) => h + 1 / (1 << 2 * e);
let we = class {
  constructor(e, s) {
    this._tiles = /* @__PURE__ */ new Map(), this._tileCache = new Be(40, (t) => t.dispose()), this._viewSize = [0, 0], this._visibleTiles = /* @__PURE__ */ new Map(), this.acquireTile = e.acquireTile, this.releaseTile = e.releaseTile, this.tileInfoView = e.tileInfoView, this._container = s;
  }
  destroy() {
  ...
  update(e) {
    ...
    for (const { row: y, colFrom: d, colTo: u } of i) for (let _ = d; _ <= u; _++) {
      const f = L.getId(n, y, r.normalizeCol(_), r.getWorldForColumn(_)), g = this._getOrAcquireTile(f);
      a.add(f), g.processed() ? this._addToContainer(g) : l.add(new L(f));
    }
    ...
    for (const y of this._tiles.keys()) a.has(y) || this._releaseTile(y);
  ...
  getIntersectingTiles(e, s, t, i, r) {
    ...
    const a = Math.min(n[0], o[0]), l = Math.min(n[1], o[1]), c = Math.max(n[0], o[0]), y = Math.max(n[1], o[1]), d = Ne(a, l, c, y), u = F(), _ = [];
    for (const f of this._visibleTiles.values()) this.tileInfoView.getTileBounds(u, f.key), Qe(d, u) && _.push(f);
  ...
  _findPlaceholdersForMissingTiles(e, s) {
    ...
    const i = t.reduce(Ct, 0);
    Math.abs(1 - i) < vt || this._addPlaceholderParent(e.id, s);
  }
  _addPlaceholderChild(e, s, t, i) {
    s.key.level <= t.level || !s.hasData() || Mt(t, s.key) && (this._addToContainer(s), i.add(s.id), e.push(s.key.level - t.level));
  }
  _addPlaceholderParent(e, s) {
    const t = this._tiles;
    let i = e;
    for (; ; ) {
      if (i = Dt(i), !i || s.has(i)) return;
      const r = t.get(i);
  ...
  _addToContainer(e) {
    ...
    for (const n of r.values()) this._canConnectDirectly(e, n) && t.push(n), s == null && this._canConnectDirectly(n, e) && (s = n);
    if (s != null) {
  ...
  _updateCacheSize(e) {
    ...
    const t = Math.ceil(s[0] / be) + 1, i = Math.ceil(s[1] / be) + 1;
...
function At(h, e, s, t, i, r, n) {
  ...
  for (let a = 0; a < o; a++) {
    ...
    const c = e[t++];
    for (let u = 0; u < c; u++) {
      const _ = e[t++], f = e[t++], g = e[t++], p = e[t++], m = !!e[t++], b = e[t++], S = s[t++], T = s[t++], w = e[t++], x = e[t++];
      l.colliders.push({ xTile: _, yTile: f, dxPixels: g, dyPixels: p, hard: m, partIndex: b, width: w, height: x, minLod: S, maxLod: T });
    }
    const y = h[t++];
...
function Lt(h, e, s) {
  for (const [t, i] of h.symbols) Ot(h, e, s, i, t);
}
function Ot(h, e, s, t, i) {
...
function kt(h, e, s, t) {
  ...
  let r, n, o, a;
  for (const l of i)
    if (h.unique.show && h.unique.parts[l.partIndex].show && (r = l.xScreen - t[0] + l.dxScreen, n = l.yScreen - t[1] + l.dyScreen, o = r + l.width, a = n + l.height, lt(s, e.x, e.y, r, n, o, a))) return !0;
  return !1;
}
let K = class {
  constructor(e, s) {
  ...
  doPrepareForRendering(e, s, t) {
    const i = new Uint32Array(s), r = new Int32Array(i.buffer), n = i[t++], o = M.createVertex(e, D.STATIC_DRAW, new Int32Array(r.buffer, 4 * t, n));
    t += n;
    const a = i[t++], l = M.createIndex(e, D.STATIC_DRAW, new Uint32Array(i.buffer, 4 * t, a));
    t += a;
    const c = this.layer.lineMaterial;
    this.vao = new U(e, c.getAttributeLocations(), c.getLayoutInfo(), /* @__PURE__ */ new Map([["geometry", o]]), l);
  }
};
class Ut extends K {
  constructor(e, s) {
  ...
  doDestroy() {
    this.fillVAO = E(this.fillVAO), this.outlineVAO = E(this.outlineVAO);
  }
  doPrepareForRendering(e, s, t) {
    const i = new Uint32Array(s), r = new Int32Array(i.buffer), n = i[t++], o = M.createVertex(e, D.STATIC_DRAW, new Int32Array(r.buffer, 4 * t, n));
    t += n;
    const a = i[t++], l = M.createIndex(e, D.STATIC_DRAW, new Uint32Array(i.buffer, 4 * t, a));
    t += a;
    const c = i[t++], y = M.createVertex(e, D.STATIC_DRAW, new Int32Array(r.buffer, 4 * t, c));
    t += c;
    const d = i[t++], u = M.createIndex(e, D.STATIC_DRAW, new Uint32Array(i.buffer, 4 * t, d));
    t += d;
    const _ = this.layer, f = _.fillMaterial, g = _.outlineMaterial;
    this.fillVAO = new U(e, f.getAttributeLocations(), f.getLayoutInfo(), /* @__PURE__ */ new Map([["geometry", o]]), l), this.outlineVAO = new U(e, g.getAttributeLocations(), g.getLayoutInfo(), /* @__PURE__ */ new Map([["geometry", y]]), u);
  }
}
let Vt = class extends K {
  constructor(e, s, t) {
    ...
    this.isIconSDF = !!i[o++];
    const a = i[o++], l = i[o++], c = i[o++], y = new L(a, l, c, 0), d = i[o++];
    for (let g = 0; g < d; g++) {
    ...
    const _ = i[o++], f = i[o++];
    this.iconOpacity = new Int32Array(_), this.textOpacity = new Int32Array(f), o = At(i, r, n, o, this.symbols, t, y), this.bufferDataOffset = o;
  }
  get usedMemory() {
    return (this.data?.byteLength ?? 0) + (this.iconVAO?.usedMemory ?? 0) + (this.textVAO?.usedMemory ?? 0) + ae(this.iconOpacity) + ae(this.textOpacity);
  }
  hasData() {
  ...
  doDestroy() {
    this.iconVAO = E(this.iconVAO), this.textVAO = E(this.textVAO);
  }
  updateOpacityInfo() {
    if (!this.opacityChanged) return;
    this.opacityChanged = !1;
    const e = this.iconOpacity, s = this.iconVAO.vertexBuffers.get("opacity");
    e.length > 0 && e.byteLength === s.usedMemory && s.setSubData(e, 0, 0, e.length);
    const t = this.textOpacity, i = this.textVAO.vertexBuffers.get("opacity");
  ...
  doPrepareForRendering(e, s, t) {
    ...
    const d = i[t++], u = M.createIndex(e, D.STATIC_DRAW, new Uint32Array(i.buffer, 4 * t, d));
    t += d;
    const _ = M.createVertex(e, D.STATIC_DRAW, this.iconOpacity.buffer), f = M.createVertex(e, D.STATIC_DRAW, this.textOpacity.buffer), g = this.layer, p = g.iconMaterial, m = g.textMaterial;
    this.iconVAO = new U(e, p.getAttributeLocations(), p.getLayoutInfo(), /* @__PURE__ */ new Map([["geometry", o], ["opacity", _]]), l), this.textVAO = new U(e, m.getAttributeLocations(), m.getLayoutInfo(), /* @__PURE__ */ new Map([["geometry", y], ["opacity", f]]), u);
  }
}, $t = class extends K {
  constructor(e, s) {
  ...
  get isHoldingForFade() {
    return this._hasSymbolBuckets && (!this.allSymbolsFadingOut || performance.now() - this.lastOpacityUpdate < W);
  }
  get wasRequested() {
  ...
  deleteLayerData(e) {
    ...
    for (const t of e) {
      ...
      i && (this._usedMemory -= i.usedMemory, i.type === R.SYMBOL && this.symbols.delete(t) && (s = !0), i.destroy(), this.layerData.delete(t));
    }
    this._memCache?.updateSize(this.key.id, this, this._usedMemory), s && (this.featureIndex?.clear(), this.emit("symbols-changed")), this.requestRender();
  }
  processed() {
  ...
  dispose() {
    this.status !== "unloaded" && (Ue._destroyRenderBuckets(this.layerData), this.layerData.clear(), this.featureIndex = null, this._usedMemory = 0, this.destroy(), this.status = "unloaded");
  }
  release() {
  ...
  changeDataImpl(e) {
    ...
    if (e) {
      ...
      for (const [n, o] of r) this._deleteLayerData(n), o.type === R.SYMBOL && (this.symbols.set(n, o.symbols), s = !0), this._usedMemory += o.usedMemory, this.layerData.set(n, o);
      this._memCache?.updateSize(this.key.id, this, this.usedMemory);
    }
    this._hasSymbolBuckets = !1;
    for (const t of this.layerData.values()) t.type === R.SYMBOL && (this._hasSymbolBuckets = !0);
  ...
  setTransform(e) {
    ...
    We(n), Je(n, n, r), Ke(n, n, Math.PI * e.rotation / 180), Ge(n, n, [t, i, 1]);
  }
  _createTransforms() {
  ...
  _deserializeBucket(e, s) {
    ...
    switch (new Uint32Array(e)[0]) {
      ...
      case R.LINE:
        ...
        break;
      case R.SYMBOL:
        t = new Vt(e, this.styleRepository, this);
        break;
      case R.CIRCLE:
        t = new $t(e, this.styleRepository);
    }
    return s.set(e, t), t;
  }
  _deleteLayerData(e) {
...
function Ft(h, e, s, t, i, r) {
  ...
  for (const u of h.colliders) {
    ...
    d += p ? 0 : 1, u.enabled = p, u.xScreen = u.xTile * i[0] + u.yTile * i[3] + i[6], u.yScreen = u.xTile * i[1] + u.yTile * i[4] + i[7], g === dt.MAP ? (u.xScreen += s * _ - e * f, u.yScreen += e * _ + s * f) : (u.xScreen += _, u.yScreen += f), O.VIEWPORT === (u.partIndex === 0 ? n : o) ? (u.dxScreen = u.dxPixels, u.dyScreen = u.dyPixels) : (u.dxScreen = s * (u.dxPixels + u.width / 2) - e * (u.dyPixels + u.height / 2) - u.width / 2, u.dyScreen = e * (u.dxPixels + u.width / 2) + s * (u.dyPixels + u.height / 2) - u.height / 2);
  }
  h.colliders.length > 0 && d === h.colliders.length && (h.unique.show = !1);
}
class Ht {
  constructor(e, s, t, i, r, n) {
    this._symbols = e, this._styleRepository = i, this._zoom = r, this._currentLayerCursor = 0, this._currentSymbolCursor = 0, this._styleProps = /* @__PURE__ */ new Map(), this._allNeededMatrices = /* @__PURE__ */ new Map(), this._gridIndex = new Ee(s, t, ct), this._si = Math.sin(Math.PI * n / 180), this._co = Math.cos(Math.PI * n / 180);
    for (const o of e) for (const a of o.symbols) this._allNeededMatrices.has(a.tile) || this._allNeededMatrices.set(a.tile, Ye(a.tile.transforms.tileUnitsToPixels));
  }
  work(e) {
    ...
    function t(r) {
      ...
      for (let _ = y; _ <= u; _++) for (let f = c; f <= d; f++) {
        const g = s.cells[_][f];
        for (const p of g) {
          const m = p.xScreen + p.dxScreen, b = p.yScreen + p.dyScreen, S = m + p.width, T = b + p.height;
          if (!(a < m || n > S || l < b || o > T)) return !0;
        }
      }
      return !1;
    }
    ...
    for (; this._currentLayerCursor < this._symbols.length; this._currentLayerCursor++, this._currentSymbolCursor = 0) {
      ...
      for (; this._currentSymbolCursor < r.symbols.length; this._currentSymbolCursor++) {
        ...
        Ft(o, this._si, this._co, n, this._allNeededMatrices.get(o.tile), this._zoom);
        const a = o.unique;
        if (!a.show) continue;
        ...
        if (a.show) for (const u of o.colliders) {
          ...
          const _ = u.xScreen + u.dxScreen, f = u.yScreen + u.dyScreen, g = _ + u.width, p = f + u.height, [m, b, S, T] = this._gridIndex.getCellSpan(_, f, g, p);
          for (let w = b; w <= T; w++) for (let x = m; x <= S; x++)
  ...
  _getProperties(e) {
    ...
    if (s) return s;
    const t = this._zoom, i = this._styleRepository.getStyleLayerByUID(e), r = i.getLayoutValue("symbol-placement", t) !== yt.POINT;
...
let Bt = class {
  ...
  _createOpacityJob() {
    ...
    let t = 0;
    function i(r, n) {
      for (const o of r.symbols.values()) Nt(o, n);
      e(r, n);
      for (const o of r.childrenTiles) i(o, n);
    }
    return { work(r) {
...
function Nt(h, e) {
  for (const s of h) {
    ...
    for (const i of t.parts) {
      ...
      i.startOpacity += r * ((e - i.startTime) / W), i.startOpacity = Math.min(Math.max(i.startOpacity, 0), 1), i.startTime = e, i.targetOpacity = t.show && i.show ? 1 : 0;
    }
  }
}
const Qt = 32, Wt = 8, Jt = 64, Kt = 20;
class Gt {
  constructor(e, s, t) {
    ...
    for (const [o, a] of r) {
      ...
      if (l >= Qt) {
        ...
        do
          c /= 2, l /= 4;
        while (l > Wt && c > Jt);
        const y = new Ee(this.tileCoordRange, this.tileCoordRange, c);
  ...
  querySymbols(e, s, t, i) {
    ...
    for (const o of n) {
      ...
      for (const c of l) {
        ...
        y && kt(y, e, s * (window.devicePixelRatio || 1), t) && r.push({ vtlSymbol: y, styleLayerUID: a, tileKey: y.tile.key });
      }
    }
    return r;
  }
  ...
  _matchSymbols(e, s, t) {
    ...
    for (const [r, n] of t) {
      const o = [];
      for (const y of n) {
        const d = Se(this.tileCoordRange, y.xTile, s.level, s.col, e.key.level, e.key.col), u = Se(this.tileCoordRange, y.yTile, s.level, s.row, e.key.level, e.key.row);
        d >= 0 && d < this.tileCoordRange && u >= 0 && u < this.tileCoordRange && o.push({ symbol: y, xTransformed: d, yTransformed: u });
      }
      const a = [], l = (e.key.level < s.level ? 1 : 1 << e.key.level - s.level) + Kt, c = this._tiles.get(e.id).symbols.get(r);
      if (c) {
        const y = c.flat;
        for (const d of o) {
          let u, _ = !1;
...
const Yt = 0.5, xe = 1e-6;
class jt {
  constructor(e, s) {
    this.styleRepository = e, this._tileToHandle = /* @__PURE__ */ new Map(), this._viewState = { scale: 0, rotation: 0, center: [0, 0], size: [0, 0] }, this._declutterViewState = { scale: 0, rotation: 0, center: [0, 0], size: [0, 0] }, this._offsetFromScreenCenter = [0, 0], this._completed = !1, this._fading = je(!1), this._symbolRepository = new Gt(4096, s, () => new Pt()), this._symbolDeclutterer = new Bt(s, this._symbolRepository, (t, i, r) => this._createCollisionJob(t, i, r), (t, i) => {
      t.allSymbolsFadingOut = !0, t.lastOpacityUpdate = i, Lt(t, i, !0), t.decluttered = !0, t.requestRender();
  ...
  _createCollisionJob(e, s, t) {
    return this.updateDecluttererViewState(), new Ht(e, s, t, this.styleRepository, this._zoom, this._viewState.rotation);
  }
  get fading() {
...
function Ie(h, e) {
  if (h) {
    ...
    if (!s || s.getValue() !== ee.NONE && (h.minzoom === void 0 || h.minzoom < e + J) && (h.maxzoom === void 0 || h.maxzoom >= e - J)) return !0;
  }
  return !1;
}
let Zt = class extends _t {
  ...
  setStyleResources(e, s, t, i) {
    this._spriteMosaic = e, this._glyphMosaic = s, this._styleRepository = t, this.tileInfoView = i, this._computeDisplayInfoView(i), this._symbolFader == null && (this._symbolFader = new jt(this._styleRepository, this.children)), this._symbolFader.styleRepository = t;
  }
  setSpriteMosaic(e) {
  ...
  doRender(e) {
    !this.visible || e.drawPhase !== B.MAP && e.drawPhase !== B.DEBUG || this._spriteMosaic === void 0 || super.doRender(e);
  }
  addChild(e) {
  ...
  _doRender(e) {
    ...
    i.backgroundBucketIds.length > 0 && (e.renderPass = "background", this._renderBackgroundLayers(e, i.backgroundBucketIds, n)), super.renderChildren(e), e.drawPhase === B.MAP && this._fade(n, t);
    ...
    s.setStencilWriteMask(0), s.setColorMask(!0, !0, !0, !0), s.setStencilOp(k.KEEP, k.KEEP, k.REPLACE), s.setStencilTestEnabled(!0), s.setBlendingEnabled(!1), s.setDepthTestEnabled(!0), s.setDepthWriteEnabled(!0), s.setDepthFunction(le.LEQUAL), s.setClearDepth(1), s.clear(s.gl.DEPTH_BUFFER_BIT), e.renderPass = "opaque";
  ...
  _renderStyleLayer(e, s, t) {
    ...
    if (o && o.getValue() === ee.NONE) return;
    let a;
    switch (e.type) {
      case C.BACKGROUND:
        return;
    ...
    if (t = e.type === C.SYMBOL ? t.filter((c) => c.decluttered) : t.filter((c) => c.neededForCoverage), a !== "vtlSymbol" && (t.length === 0 || e.minzoom !== void 0 && e.minzoom >= i + J || e.maxzoom !== void 0 && e.maxzoom < i - J)) return;
    const l = e.uid;
  ...
  _renderBackgroundLayers(e, s, t) {
    ...
    let a = !1;
    for (const b of s)
      if (o.getLayerById(b).type === C.BACKGROUND && Ie(o.getLayerById(b), t)) {
        a = !0;
        break;
      }
    if (!a) return;
    const l = this.tileInfoView, c = l.getTileCoverage(e.state, 0, !0, "smallest"), { spans: y, lodInfo: d } = c, { level: u } = d, _ = F(), f = [];
    ...
    let p, m = 0;
    for (const { row: b, colFrom: S, colTo: T } of y) for (let w = S; w <= T; w++) {
      if (m < g.length) p = g[m], p.key.set(u, b, d.normalizeCol(w), d.getWorldForColumn(w)), l.getTileBounds(_, p.key, !1), p.x = _[0], p.y = _[3], p.resolution = l.getTileResolution(u);
        ...
        const x = new L(u, b, d.normalizeCol(w), d.getWorldForColumn(w)), P = l.getTileBounds(F(), x), H = l.getTileResolution(u);
        p = new Xt(x, H, P[0], P[3], 512, 512, 4096, 4096), g.push(p);
      }
      p.setTransform(n), f.push(p), m++;
    }
    i.setStencilWriteMask(0), i.setColorMask(!0, !0, !0, !0), i.setStencilOp(k.KEEP, k.KEEP, k.REPLACE), i.setStencilFunction(le.EQUAL, 0, 255), i.setStencilTestEnabled(!0);
    for (const b of s) {
      const S = o.getLayerById(b);
      S.type === C.BACKGROUND && Ie(S, t) && (e.styleLayerUID = S.uid, e.styleLayer = S, r.renderObjects(e, f, "vtlBackground"));
    }
    Ae.pool.release(c);
  }
  _computeDisplayInfoView(e) {
    ...
    this._displayInfo = Le.create({ scales: i, size: 512, spatialReference: e.spatialReference, numLODs: t });
  }
};
const es = 8, ts = 512, Te = 4096, ss = (h, e) => {
...
class te {
  constructor(e, s, t, i, r) {
    this.tileKey = e, this._tileLayerData = s, this._styleRepository = t, this._tileHandler = i, this._parentLayer = r, this._index = null, this._tileKeyToPBF = /* @__PURE__ */ new Map();
  }
  static create(e, s, t, i, r) {
    return new te(e, s, t, i, r);
  }
  clear() {
  ...
  async queryAttributes(e, s, t, i, r) {
    ...
    this._index === null && (this._index = new ft(100, is), await this._indexLayers());
    const n = [];
  ...
  _indexLayer(e, s, t, i, r, n) {
    const o = e.sourceLayer, a = e.getFeatureFilter(), l = t, c = t + 1, y = ht(l), d = new X(new Uint8Array(s), new DataView(s));
    for (; d.next(); ) switch (d.tag()) {
      case 3: {
        const u = d.getMessage(), _ = new de(u);
        if (u.release(), _.name !== o) continue;
        const f = _.getData(), g = _.extent / i, p = g * n - y, m = g * r - y, b = p + g + 2 * y, S = m + g + 2 * y, T = g / ts, w = Te / g, x = g * n, P = g * r;
        for (; f.nextTag(2); ) {
          const H = f.getMessage(), q = new _e(H, _);
          if (H.release(), a && !a.filter(q, t)) continue;
          const se = q.values || {}, ie = se._minzoom, re = se._maxzoom;
          if (ie && ie >= 10 * c || re && re <= 10 * l) continue;
          const v = e.getFeatureInflatedBounds(q, l, _.extent, T);
          v == null || v[0] > b || v[1] > S || v[2] < p || v[3] < m || (v[0] = (v[0] - x) * w, v[1] = (v[1] - P) * w, v[2] = (v[2] - x) * w, v[3] = (v[3] - P) * w, this._index.insert(new pt(e, q, v, w, x, P)));
        }
        break;
      }
      default:
  ...
  _addSymbolsAttributes(e, s, t, i) {
    ...
    this._getSymbolAttributes(i.protobuff, s, t, a, l, c).forEach((y) => {
      ...
      e.push({ layerId: r[t].id, layerIndex: t, graphic: new he({ attributes: d, origin: { type: "vector-tile", layerId: r[t].id, layerIndex: t, layer: this._parentLayer } }), tilePoint: u });
    });
  }
  _getSymbolAttributes(e, s, t, i, r, n) {
    ...
    const c = new X(new Uint8Array(e), new DataView(e));
    for (; c.next(); ) switch (c.tag()) {
      case 3: {
        const y = c.getMessage(), d = new de(y);
        if (y.release(), d.name !== a[t].sourceLayer) continue;
        const u = d.getData(), _ = d.extent / i, f = Te / _, g = _ * n, p = _ * r;
        let m = 0;
        for (; u.nextTag(2); ) {
          const b = u.getMessage();
          if (m++ === s[l].featureIndex) {
            const S = new _e(b, d), T = S.values, w = S.getGeometry(), x = w != null ? [f * (w[0][0].x - g), f * (w[0][0].y - p)] : null;
            o.push({ attributes: T, tilePoint: x }), l++;
          }
  ...
  _queryIndex(e, s, t, i, r, n) {
    const o = es * i * (window.devicePixelRatio || 1);
    return this._index?.search({ minX: s - o, minY: t - o, maxX: s + o, maxY: t + o }, (a) => {
      const { layer: l, feature: c } = a;
      l.isIntersectingFeature(s, t, i, c, r, n, a) && e.push({ layerId: l.id, layerIndex: l.uid, tilePoint: null, graphic: new he({ attributes: c.values, origin: { type: "vector-tile", layerId: a.layer.id, layerIndex: a.layer.uid, layer: this._parentLayer } }) });
    }), e;
  }
  async _getTilePayload(e) {
    return Xe(this._tileKeyToPBF, e.id, () => this._tileHandler.fetchTilePBFs(e)).then((s) => s);
  }
}
const is = (h) => ({ minX: h.bounds[0], minY: h.bounds[1], maxX: h.bounds[2], maxY: h.bounds[3] });
class ve extends Ze {
  constructor() {
  ...
  _initializeFullCacheLODs(e) {
    ...
    if (e[0].level === 0) s = e.map((t) => ({ level: t.level, resolution: t.resolution, scale: t.scale }));
      ...
      s = Le.create({ size: t, spatialReference: i }).lods.map((r) => ({ level: r.level, resolution: r.resolution, scale: r.scale }));
    }
    for (let t = 0; t < s.length; t++) this._levelByScale[s[t].scale] = s[t].level;
    this._fullCacheLodInfos = s;
  }
}
const j = 2, Ce = 8, De = 512;
let Q = class extends bt(gt(mt)) {
  constructor() {
  ...
  async hitTest(h, e) {
    ...
    r && (i = r.querySymbols(e, j, t.decluttererOffset, {}));
    const n = this.view.state, o = this._tileManager.getIntersectingTiles(e.x, e.y, j, n, i);
    if ((!o || o.length === 0) && i?.length === 0) return null;
    h = h.clone().normalize();
    const a = [], l = [];
    for (const c of o) a.push(this._queryTile(l, h, j, this.view.state.rotation, c, i?.filter((y) => y.tileKey.id === c.id)));
  ...
  attach() {
    ...
    this._styleRepository = new fe(h), this._tileInfoView = new ve(this.layer.tileInfo, this.layer.fullExtent), this._vectorTileContainer = new Zt(this._tileInfoView), this._tileHandler = new It(this.layer, this._styleRepository, window.devicePixelRatio || 1, this.layer.tileInfo.lods.length - 1), this.container.addChild(this._vectorTileContainer), this._start(), this.addAttachHandles([this.layer.on("paint-change", (e) => {
      if (this._styeChanged = !0, e.isDataDriven) this._styleChanges.push({ type: I.PAINTER_CHANGED, data: e }), this.requestUpdate();
      else {
        const s = this._styleRepository, t = s.getLayerById(e.layer);
        if (!t) return;
        const i = t.type === C.SYMBOL;
      ...
      if (!t) return;
      this._styeChanged = !0;
      const i = et(t.layout, e.layout);
      if (i != null) {
        if (tt(i, "visibility") && rs(i) === 1) return s.setLayoutProperties(e.layer, e.layout), t.type === C.SYMBOL && this._vectorTileContainer?.restartDeclutter(), void this._vectorTileContainer?.requestRender();
        this._styleChanges.push({ type: I.LAYOUT_CHANGED, data: e }), this.requestUpdate();
      }
    }), this.layer.on("style-layer-visibility-change", (e) => {
      const s = this._styleRepository, t = s.getLayerById(e.layer);
      t && (this._styeChanged = !0, s.setStyleLayerVisibility(e.layer, e.visibility), t.type === C.SYMBOL && this._vectorTileContainer?.restartDeclutter(), this._vectorTileContainer?.requestRender());
    }), this.layer.on("style-layer-change", (e) => {
      this._styleChanges.push({ type: I.LAYER_CHANGED, data: e }), this._styeChanged = !0, this.requestUpdate();
    }), this.layer.on("delete-style-layer", (e) => {
      this._styleChanges.push({ type: I.LAYER_REMOVED, data: e }), this._styeChanged = !0, this.requestUpdate();
    }), this.layer.on("load-style", () => this._loadStyle()), this.layer.on("spriteSource-change", (e) => {
      this._spriteSourceChanged = !0, this._styleChanges.push({ type: I.SPRITES_CHANGED, data: e });
  ...
  detach() {
    this._stop(), this.container.removeAllChildren(), this._vectorTileContainer = V(this._vectorTileContainer), this._tileHandler = V(this._tileHandler);
  }
  viewChange() {
    this.requestUpdate();
  }
  ...
  supportsSpatialReference(h) {
    return st(this.layer.tileInfo?.spatialReference, h);
  }
  canResume() {
  ...
  async doRefresh() {
    ...
    const h = this._vectorTileContainer.children, e = [];
    try {
      for (const s of h) {
        const t = this._updatingHandles.addPromise(this._fetchQueue.push(s.key).then((i) => this._parseQueue.push({ key: s.key, data: i })).then((i) => s.setData(i)).finally(() => s.featureIndex = null));
        e.push(t);
      }
      await Promise.all(e);
    } catch (s) {
      G.getLogger(this).error("error refreshing vector-tiles layer-view", s), this._resumeQueues(), this._isTileHandlerReady = !0;
    }
    this._isTileHandlerReady = !0, this.requestUpdate();
  }
  _start() {
    if (this._stop(), this._tileManager = new we({ acquireTile: (s) => this.acquireTile(s), releaseTile: (s) => this.releaseTile(s), tileInfoView: this._tileInfoView }, this._vectorTileContainer), !this.layer.currentStyleInfo) return;
    const h = new AbortController(), e = this._tileHandler.start({ signal: h.signal }).then(() => {
      this._fetchQueue = new ce({ tileInfoView: this._tileInfoView, process: (s, t) => this._getTileData(s, t), concurrency: 15, scheduler: this.scheduler, priority: ue.MAPVIEW_FETCH_QUEUE }), this._parseQueue = new ce({ tileInfoView: this._tileInfoView, process: (s, t) => this._parseTileData(s, t), concurrency: 8, scheduler: this.scheduler, priority: ue.MAPVIEW_VECTOR_TILE_PARSING_QUEUE }), this.requestUpdate(), this._isTileHandlerReady = !0;
    });
  ...
  _stop() {
    ...
    h && h.abort(), this._tileHandlerPromise = null, this._isTileHandlerReady = !1, this._fetchQueue = V(this._fetchQueue), this._parseQueue = V(this._parseQueue), this._tileManager = V(this._tileManager), this._vectorTileContainer.removeAllChildren();
  }
  ...
  async _applyStyleChanges() {
    ...
    try {
      ...
      G.getLogger(this).error("error applying vector-tiles style update", r.message), this._resumeQueues(), this._isTileHandlerReady = !0;
    }
    ...
    if (this._resumeQueues(), t.size > 0) {
      ...
      for (const o of i) {
        const a = this._updatingHandles.addPromise(this._fetchQueue.push(o.key).then((l) => this._parseQueue.push({ key: o.key, data: l, styleLayerUIDs: r })).then((l) => o.setData(l)).finally(() => o.featureIndex = null));
        n.push(a);
      }
      await Promise.all(n);
    }
  ...
  async _loadStyle() {
    const { style: h } = this.layer.currentStyleInfo, e = it(h);
    this._isTileHandlerReady = !1, this._pauseQueues(), this._clearQueues(), this._styleRepository = new fe(e), this._vectorTileContainer.destroy(), this._tileManager.clear(), this._tileHandlerAbortController.abort(), this._tileHandlerAbortController = new AbortController();
    ...
    this._tileInfoView = new ve(this.layer.tileInfo, this.layer.fullExtent), i.setStyleResources(t, this._tileHandler.glyphMosaic, this._styleRepository, this._tileInfoView), this._tileManager = new we({ acquireTile: (r) => this.acquireTile(r), releaseTile: (r) => this.releaseTile(r), tileInfoView: this._tileInfoView }, this._vectorTileContainer), this._resumeQueues(), this._isTileHandlerReady = !0, this.requestUpdate(), this._styeChanged = !1, this._spriteSourceChanged = !1;
  }
  _createVectorTile(h) {
  ...
  async _queryTile(h, e, s, t, i, r) {
    ...
    const n = this._ensureTileIndex(i), o = this._tileInfoView.getTileBounds(F(), i.key, !0), a = Ce * De * ((e.x - o[0]) / (o[2] - o[0])), l = Ce * De * (1 - (e.y - o[1]) / (o[3] - o[1])), c = await n.queryAttributes(a, l, s, t, r);
  ...
  _tileToMapPoint(h, e) {
    ...
    return i.toMap(r, [s, t]), new rt({ x: r[0], y: r[1], spatialReference: i.spatialReference });
  }
  _ensureTileIndex(h) {
    let e = h.featureIndex;
    return e || (e = te.create(h.key, h.layerData, this._styleRepository, this._tileHandler, this.layer), h.featureIndex = e), e;
  }
  _pauseQueues() {
...
ye([nt()], Q.prototype, "_isTileHandlerReady", void 0), Q = ye([ot("esri.views.2d.layers.VectorTileLayerView2D")], Q);
const $s = Q;
export {
  $s as default
};
//# sourceMappingURL=VectorTileLayerView2D-DhQ1npKN.js.map
