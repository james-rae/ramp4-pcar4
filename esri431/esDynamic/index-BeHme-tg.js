import { kx as u, lS as f, gd as d, kb as m, kr as p, lT as L, lU as w, F as A } from "./main-DZxT3i7S.js";
...
class $ extends y {
  ...
  constructor(e, i) {
    super(e, i), this.onOpacity = e.options?.onOpacity ?? 0.75, this.offOpacity = e.options?.offOpacity > 0.02 ? e.options.offOpacity : 0.02, this.$iApi.geo.map.created ? this.hilightSetup() : this.handlers.push(
      this.$iApi.event.on(d.MAP_CREATED, () => {
        this.hilightSetup();
      })
    ), this.handlers.push(
      this.$iApi.event.on(d.MAP_BASEMAPCHANGE, () => {
...
class v extends A {
  ...
  _parseConfig(e) {
    if (e)
      switch (e.mode) {
        case h.NONE:
          this.hilightMode = new c(e, this.$iApi);
          break;
        case h.GLOW:
...
//# sourceMappingURL=index-BeHme-tg.js.map
