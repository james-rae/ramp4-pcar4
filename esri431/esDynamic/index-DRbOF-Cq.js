import { bs as i, bt as l, bu as r, bz as m, bB as c, bC as b, bG as v, bD as u, g5 as a, F as h, hV as d, hW as f, hX as g } from "./main-DZxT3i7S.js";
import { _ as x } from "./screen.vue_vue_type_script_setup_true_lang-IsIrgJvs.js";
const w = /* @__PURE__ */ i({
  __name: "nav-button",
  setup(s) {
...
class B extends h {
  ...
  removed() {
    this.$iApi.fixture.exists("appbar") && f(this.$vApp.$pinia).removeButton("basemap"), this.$iApi.fixture.exists("mapnav") && g(this.$vApp.$pinia).removeItem("basemap"), this.$iApi.panel.remove("basemap");
  }
}
export {
  B as default
};
//# sourceMappingURL=index-DRbOF-Cq.js.map
