import { s as ae, a as Y, j as oe, d as he } from "./LabelMetric-qLdOt4bi.js";
import { b6 as ee, G as T, Q as m, q2 as j, jS as ue, dH as G, ip as H, fo as de, q3 as le, q4 as ce, dx as F, dw as _e, q5 as fe, q6 as ye, cg as pe, av as me, ck as ge, dM as be, au as xe, q7 as Ie, nm as we, s as S, b7 as Se, fS as Te, mA as Fe, bf as Ae, dz as k, b1 as Ee, q8 as Ce, cS as I, pD as ve, q9 as $, k0 as A } from "./main-DZxT3i7S.js";
import { m as E, a as Z, n as J } from "./TimeOnly-1Agv6Qm9.js";
import { a7 as ze, a8 as De, a9 as c, aa as Be, ab as Me, f as x } from "./UpdateTracking2D-0o9_i8fH.js";
import { n as Oe, P as Re, t as Ge } from "./timeSupport-CfffRxwA.js";
const $e = 1.25;
let v = class {
  get length() {
    return this._pos;
  ...
  _ensureSize(e) {
    if (this._pos + e >= this._buffer.length) {
      const t = this._roundToNearest((this._array.byteLength + e * this._buffer.BYTES_PER_ELEMENT) * $e, this._buffer.BYTES_PER_ELEMENT), r = new ArrayBuffer(t), i = new this._ctor(r);
...
let ke = class {
  constructor(e, t, r = 0) {
    ...
    this.layout = { ...t, position: o }, this._indices = new v(Uint32Array, i), this._vertices = new v(Uint32Array, s), this._metrics = new v(Uint32Array, 0), this._metricCountOffset = this._metrics.push(0), this._strideInt = a, this._instanceId = e;
  }
  serialize(e) {
  ...
  recordEnd(e = 0) {
    ...
    return this._recordIndexStart = i, this._recordIndexCount = s, this._recordVertexStart = t, this._recordVertexCount = r, this._entities.incr(this._entityRecordCountOffset), Y.write(this._entities, this._current.instanceId, this._current.textureKey, i, s, t, r, e), !0;
  }
  copyLast(e, t) {
    const r = this._recordVertexStart + this._recordVertexCount;
    this._entities.incr(this._entityRecordCountOffset), Y.write(this._entities, this._current.instanceId, this._current.textureKey, this._recordIndexStart + this._recordIndexCount, this._recordIndexCount, r, this._recordVertexCount, 0);
    ...
    const _ = this._current.writer.layout.position, p = _.packPrecisionFactor ?? 1, g = _.offset / Uint32Array.BYTES_PER_ELEMENT, y = e * p, O = t * p;
    for (let f = r * h; f <= s.length; f += h) s.i1616Add(f + g, y, O);
  }
  copyLastFrom(e, t, r) {
    ...
    for (let l = e._current.indexStart; l !== d.length; l++) {
      const R = d.getValue(l);
      h.push(R - o);
    }
    for (let l = e._current.vertexStart * s; l !== _.length; l++) {
      const R = _.getValue(l);
      u.push(R);
    }
    const p = this._current.writer.layout.position, g = p.packPrecisionFactor ?? 1, y = p.offset / Uint32Array.BYTES_PER_ELEMENT, O = t * g, f = r * g;
    for (let l = a * s; l <= u.length; l += s) u.i1616Add(l + y, O, f);
    this.recordEnd();
  }
...
function X(n, e, t) {
  ...
  try {
    ...
    return T.getLogger("esri.views.2d.support.arcadeOnDemand").warn("Feature arcade evaluation failed:", i), null;
  }
}
function te(n) {
...
let W = class z {
  ...
  clone() {
    return new z(this._buf.slice(), this._mask);
  }
  clear() {
...
const M = m("featurelayer-simplify-thresholds") ?? [0.5, 0.5, 0.5, 0.5], Le = M[0], Ue = M[1], Pe = M[2], Ye = M[3], L = m("featurelayer-simplify-payload-size-factors") ?? [1, 2, 4], He = L[0], Ze = L[1], Je = L[2], Xe = m("featurelayer-simplify-mobile-factor") ?? 2, qe = m("esri-mobile"), K = 4294967295;
function Ke(n, e, t) {
...
class Et {
  ...
  getAreaSimplificationThreshold(e, t) {
    let r = 1;
    const i = qe ? Xe : 1;
    t > 4e6 ? r = Je * i : t > 1e6 ? r = Ze * i : t > 5e5 ? r = He * i : t > 1e5 && (r = i);
    let s = 0;
    return e > 4e3 ? s = Ye * r : e > 2e3 ? s = Pe * r : e > 100 ? s = Ue : e > 15 && (s = Le), s;
  }
  getBounds(e) {
    if (Ke(this._boundsBuffer, 4 * this.getIndex() + 4, 0), this.getBoundsXMin() === K) return !1;
    if (this.getBoundsXMin() === 0) {
      const a = this.readGeometryWorldSpace();
      if (!a) return this.setBoundsXMin(K), !1;
      let o = 1 / 0, h = 1 / 0, u = -1 / 0, d = -1 / 0;
      return a.forEachVertex((_, p) => {
        o = Math.min(o, _), h = Math.min(h, p), u = Math.max(u, _), d = Math.max(d, p);
      }), this.setBoundsXMin(o), this.setBoundsYMin(h), this.setBoundsXMax(u), this.setBoundsYMax(d), j(e, o, h, u, d), !0;
    }
    const t = this.getBoundsXMin(), r = this.getBoundsYMin(), i = this.getBoundsXMax(), s = this.getBoundsYMax();
    return j(e, t, r, i, s), !0;
  }
  getBoundsXMin() {
  ...
  readOptimizedFeatureWorldSpace() {
    const e = this.readGeometryWorldSpace(), t = this.readAttributes(), r = this.readCentroidWorldSpace(), i = new _e(e, t, r);
  ...
  readLegacyGeometryForDisplay() {
    ...
    return G(e, this.geometryType, !1, !1);
  }
  readXForDisplay() {
    return this._readX();
  }
  ...
  readGeometryWorldSpace() {
    ...
    return r != null && H(t, t, this.hasZ, this.hasM, r), t;
  }
  ...
  readCentroidWorldSpace() {
    ...
    return i != null && H(r, r, this.hasZ, this.hasM, i), r;
  }
  setCache(e) {
    let t = this._caches.get(e);
    t == null && (t = new We(this.getSize()), this._caches.set(e, t)), this._activeCache = t;
  }
  setCachedValue(e) {
  ...
  geometry() {
    const e = this.readGeometryWorldSpace(), t = G(e, this.geometryType, this.hasZ, this.hasM), r = de(t);
    if (r) {
  ...
  autocastArcadeDate(e, t) {
    return t && t instanceof Date ? this.isUnknownDateTimeField(e) ? E.unknownDateJSToArcadeDate(t) : E.dateJSAndZoneToArcadeDate(t, this.contextTimeZone ?? le) : t;
  }
  isUnknownDateTimeField(e) {
    return this.metadata.fieldsIndex.getTimeZone(e) === ce;
  }
  field(e) {
    ...
    if (t) switch (t.type) {
      ...
      case "esriFieldTypeTimeOnly":
        return Z.fromReader(this.readAttribute(e, !1));
      case "esriFieldTypeTimestampOffset":
      case "timestamp-offset":
        return E.fromReaderAsTimeStampOffset(this.readAttribute(e, !1));
      case "date":
    ...
    for (const r of this._joined) if (r.setIndex(this.getIndex()), t = r.fields.get(e), t) switch (t.type) {
      ...
      case "time-only":
      case "esriFieldTypeTimeOnly":
        return Z.fromReader(r._readAttribute(e, !1));
      case "esriFieldTypeTimestampOffset":
      case "timestamp-offset":
        return E.fromReaderAsTimeStampOffset(r._readAttribute(e, !1));
      case "date":
      case "esriFieldTypeDate":
  ...
  _computeDisplayCentroid(e) {
    if (this.getInTransform() == null) return Oe(new F(), e, this.hasM, this.hasZ);
    const t = ze.fromOptimized(e, this.geometryType);
    t.yFactor *= -1;
    const r = De(t);
    return r ? (r[1] *= -1, new F([], r)) : null;
  }
  copyInto(e) {
  ...
  _createQuantizedExtrudedQuad(e, t) {
    return new F([5], [e - 1, t, 1, -1, 1, 1, -1, 1, -1, -1]);
  }
  _createQuantizedExtrudedLine(e, t) {
    return new F([2], [e - 1, t + 1, 1, -1]);
  }
  _removeAtIndex(e) {
...
let Qe = class extends B {
...
}, et = class re extends B {
  static async create(e, t) {
    const r = await fe(e, t.spatialReference, t.fields), i = ee(e);
    return new re(r, i);
  }
  constructor(e, t) {
  ...
  read(e, t) {
    return this.referencesScale() || t.$view.timeZone !== "system" ? X(this._compiled, e, t) : this._readCached(e, t);
  }
  readWithDefault(e, t, r) {
    return this.referencesScale() || t.$view.timeZone !== "system" ? q(this._compiled, e, t, r) : this._readWithDefaultCached(e, t, r);
  }
  referencesScale() {
  ...
  _readCached(e, t) {
    ...
    const r = X(this._compiled, e, t);
    return e.setCachedValue(r), r;
  }
  _readWithDefaultCached(e, t, r) {
    if (e.setCache(this._cacheKey), e.hasCachedValue()) return e.getCachedValue();
    const i = q(this._compiled, e, t, r);
...
function tt(n, e) {
  ...
  if (t) {
    if (t.type === "codedValue" || t.type === "coded-value") {
      ...
      const { max: i, min: s } = ye(e), a = +n;
      if (s != null && i != null && s <= a && a <= i) return t.name;
    }
  }
  let r = n;
  return pe(e) ? r = me(r, ge("short-date")) : be(e) && (r = xe(+r)), r || "";
}
let rt = class ie extends B {
  static async create(e, t) {
    const r = Ie(e);
...
const V = () => T.getLogger("esri.views.2d.layers.features.support.whereUtils"), st = { getAttribute: (n, e) => n.readAttribute(e) };
async function se(n, e) {
  try {
    const t = await we(n, e);
    if (!t.isStandardized) {
      const r = new S("mapview - bad input", "Unable to apply filter's definition expression, as expression is not standardized.", t);
      V().error(r);
    }
    return (r) => {
      const i = r.readArcadeFeature();
      try {
        return t.testFeature(i, st);
      } catch {
        return V().warn("mapview-bad-where-clause", "Encountered an error when evaluating where clause", n), !0;
      }
    };
  } catch {
    return V().warn("mapview-bad-where-clause", "Encountered an error when evaluating where clause", n), (r) => !0;
  }
}
const Q = () => T.getLogger("esri.views.2d.layers.features.support.ComputedAttributeStorage"), b = 4294967295;
function C(n, e, t) {
  if (!(n.length > e)) for (; n.length <= e; ) n.push(t);
}
let vt = class {
  ...
  createBitset() {
    ...
    return this._bitsets.push(W.create(this._allocatedSize, c)), e + 1;
  }
  async createComputedField(e, t = !1) {
    if (e.expression) try {
      if (!this.compilationOptions) throw new Error("InternalError: Compilation options not defined");
      return t ? await rt.create(e.expression, this.compilationOptions) : await et.create(e.expression, this.compilationOptions);
    } catch (i) {
      const s = new S("featurelayer", "Failed to compile arcade expression", { error: i, expression: e.expression });
      return Q().error(s), null;
    }
    if (e.normalizationType || e.normalizationField) return new it(e.field, e);
    if (e.field) return new Qe(e.field);
    const r = new S("featurelayer", "Unable to create computed field. No expression or field found", { info: e });
  ...
  setBounds(e, t, r = !1) {
    ...
    if (C(this._bounds, 4 * i + 4, 0), !s || !s.coords.length) return this._bounds[4 * i] = b, this._bounds[4 * i + 1] = b, this._bounds[4 * i + 2] = b, this._bounds[4 * i + 3] = b, !1;
  ...
  getBounds(e, t) {
    ...
    return j(e, r, i, s, a), r !== b;
  }
  _ensureNumeric(e, t) {
    this._numerics[e] || (this._numerics[e] = []), C(this._numerics[e], t, 0);
  }
  _ensureInstanceId(e) {
    C(this._instanceIds, e, 0);
  }
  _ensureString(e, t) {
    this._strings[e] || (this._strings[e] = []), C(this._strings[e], t, null);
  }
}, N = class {
  getObjectId(e) {
...
class U {
  constructor(e) {
    this._geometryBounds = Se(), this._idToVisibility = /* @__PURE__ */ new Map(), this._serviceInfo = e;
  }
  ...
  setKnownIds(e) {
    for (const t of e) this._idToVisibility.set(t, w);
  }
  setTrue(e) {
    const t = [], r = [], i = new Set(e);
    return this._idToVisibility.forEach((s, a) => {
      const o = !!(this._idToVisibility.get(a) & w), h = i.has(a);
      !o && h ? t.push(a) : o && !h && r.push(a), this._idToVisibility.set(a, h ? w | nt : 0);
    }), { show: t, hide: r };
  }
  createQuery() {
    const { geometry: e, spatialRel: t, where: r, timeExtent: i, objectIds: s } = this;
    return Te.fromJSON({ geometry: e, spatialRel: t, where: r, timeExtent: i, objectIds: s });
  }
  async update(e, t) {
    this._hash = JSON.stringify(e);
    const r = await Fe(e, null, t);
  ...
  async _setGeometryFilter(e) {
    ...
    const t = e.geometry, r = e.spatialRel || "esriSpatialRelIntersects", i = await Re(r, t, this._serviceInfo.geometryType, this._serviceInfo.hasZ, this._serviceInfo.hasM);
    Ae(this._geometryBounds, t), this._spatialQueryOperator = i, this.geometry = t, this.spatialRel = r;
  }
  _setTimeFilter(e) {
    if (this.timeExtent = this._timeOperator = null, e?.timeExtent) if (this._serviceInfo.timeInfo) this.timeExtent = e.timeExtent, this._timeOperator = Ge(this._serviceInfo.timeInfo, e.timeExtent, N.Shared);
    else {
      const t = new S("feature-layer-view:time-filter-not-available", "Unable to apply time filter, as layer doesn't have time metadata.", e.timeExtent);
      T.getLogger("esri.views.2d.layers.features.controllers.FeatureFilter").error(t);
    }
  }
  _applyFilter(e) {
  ...
  _resetAllHiddenIds() {
    ...
    return this._idToVisibility.forEach((t, r) => {
      t & w || (this._idToVisibility.set(r, w), e.push(r));
    }), e;
  }
}
class D {
  static minimal(e, t, r = []) {
    return new D({ geometryType: e, fieldsIndex: new k(r).toJSON(), objectIdField: t, subtypes: null, subtypeField: null, types: null, globalIdField: null, spatialReference: null, timeInfo: null, timeReferenceUnknownClient: null, typeIdField: null });
  }
  ...
  get geometryType() {
    return this._options.geometryType === "esriGeometryMultiPatch" ? "esriGeometryPolygon" : this._options.geometryType;
  }
...
let Bt = class ne extends D {
  static createGraphics(e) {
    return new ne({ fieldsIndex: new k().toJSON(), objectIdField: "uid", geometryType: null, spatialReference: e, globalIdField: null, subtypeField: null, subtypes: null, timeInfo: null, typeIdField: null, types: null, timeReferenceUnknownClient: null });
  }
};
...
class ut {
  ...
  createIdForObjectId(e) {
    ...
    return t ? t.increment() : (t = new ht(Be(this._getFreeId(), !1)), t.increment(), this._objectIdToDisplayId.set(e, t)), t.data;
  }
...
const P = () => T.getLogger("esri.views.layers.2d.features.support.AttributeStore"), lt = at(ot, P());
...
class ct {
  ...
  setData(e, t, r) {
    const i = x(e), s = 1 << t;
    this.layout & s ? this.data != null && (this.data[i * this.texelSize + t] = r, this.dirtyStart = Math.min(this.dirtyStart, i), this.dirtyEnd = Math.max(this.dirtyEnd, i)) : P().error("mapview-attributes-store", "Tried to set a value for a texel's readonly component");
  }
  expand(e) {
...
class Mt {
  constructor(e) {
    this._client = e, this._filters = [], this._blocks = new Array(), this._attributeComputeInfo = null, this._abortController = new AbortController(), this._size = Ce, this._idsToHighlight = /* @__PURE__ */ new Map(), this._referencesScale = !1, this._referencesGeometry = !1, this._initialized = !1, this.version = 0, this._idGenerator = new ut(), this._epoch = 1;
  }
  destroy() {
  ...
  _initialize() {
    ...
    const e = I.FLOAT;
    this._blockDescriptors = [{ pixelType: I.UNSIGNED_BYTE, layout: 1 }, { pixelType: I.UNSIGNED_BYTE, layout: 15, textureOnly: !0 }, { pixelType: I.UNSIGNED_BYTE, layout: 15, textureOnly: !0 }, { pixelType: e, layout: 15 }, { pixelType: e, layout: 15 }, { pixelType: e, layout: 15 }, { pixelType: e, layout: 15 }, { pixelType: I.FLOAT, layout: 15 }], this._blocks = this._blockDescriptors.map(() => null);
  }
  get referencesScale() {
  ...
  getDisplayIdForObjectId(e) {
    return this._idGenerator.getDisplayIdForObjectId(e);
  }
  ...
  async update(e, t, r, i, s = 0) {
    const a = ve(this._schema, e);
    if (this.version = s, a && (m("esri-2d-update-debug") && console.debug(`Version[${s}] AttributeStore.update`, { changed: a }), this._schema = e, this._attributeComputeInfo = null, this._initialize(), e != null)) if (r && (this._filters = await Promise.all(e.filters.map((o) => o ? U.create({ geometryType: r.geometryType, hasM: !1, hasZ: !1, timeInfo: r.timeInfo, fieldsIndex: r.fieldsIndex, spatialReference: i ?? r.spatialReference, filterJSON: o }) : null))), e.type !== "subtype") this._attributeComputeInfo = { isSubtype: !1, map: /* @__PURE__ */ new Map() }, await Promise.all(e.bindings.map(async (o) => {
  ...
  setHighlight(e, t) {
    ...
    r.unsetComponentAllTexels(0, (1 << $) - 1);
  ...
  setAttributeData(e, t, r) {
    ...
    s && (h = s.isSubtype ? s.map.get(t.readAttribute(s.subtypeField)) : s.map, h?.size && h.forEach((u, d) => {
      const _ = d * a % o, p = Math.floor(d * a / o), g = this._getBlock(p + A.VV);
      let y = u.field?.read(t, r);
      u.valueRepresentation && (y = dt(y, u.valueRepresentation)), (y === null || isNaN(y) || y === 1 / 0 || y === -1 / 0) && (y = Me), g.setData(i, _, y);
    }));
  }
  get epoch() {
    return this._epoch;
  ...
  _getInitArgs() {
    return this._initialized ? null : (this._initialized = !0, this._getBlock(A.Animation), this._getBlock(A.GPGPU), this._getBlock(A.LocalTimeOrigin), { blockSize: this._size, blockDescriptors: this._blocks.map((e) => e != null ? { textureOnly: e.textureOnly, buffer: e.buffer, pixelType: e.pixelType } : null) });
  }
  _getBlock(e) {
  ...
  _expand() {
    ...
    return P().error(new S("mapview-limitations", "Maximum number of onscreen features exceeded.")), -1;
  }
  isVisible(e) {
    return !!(this._getBlock(0).getData(e, 0) & 1 << $);
  }
  getFilterFlags(e) {
    let t = 0;
...
//# sourceMappingURL=AttributeStore-BzB5Tu2S.js.map
