import { dg as E, dh as H, fk as u, dc as t, di as w } from "./main-DZxT3i7S.js";
import { s as l, b as v, f as z, t as x } from "./dom-N58V0tYi.js";
import { u as F, I as B } from "./interactive-B_Y0ed_t.js";
import { s as P, a as T, c as L } from "./loadable-BekOWxtq.js";
import { c as M } from "./observers-lnyvGi5X.js";
import { d as O, a as D, S as I, H as $ } from "./action-menu-BGcrUrL7.js";
import { c as j, d as N } from "./locale-B98iGxBG.js";
import { c as R, s as U, d as _, u as K } from "./t9n-DqBq_VHu.js";
import { d as W } from "./floating-ui-C4g6VEui.js";
import { d as q } from "./action-R6b2qHuP.js";
import { d as G } from "./icon-BnVuD4FT.js";
import { d as J } from "./loader-BOJ3YuGs.js";
import { d as Q } from "./scrim-E0qBQm7D.js";
const o = {
  ...
  constructor() {
    ...
    }, this.beforeClose = void 0, this.closed = !1, this.disabled = !1, this.closable = !1, this.collapsed = !1, this.collapseDirection = "down", this.collapsible = !1, this.headingLevel = void 0, this.loading = !1, this.heading = void 0, this.description = void 0, this.menuFlipPlacements = void 0, this.menuOpen = !1, this.menuPlacement = W, this.messageOverrides = void 0, this.messages = void 0, this.overlayPositioning = "absolute", this.scale = "m", this.isClosed = !1, this.hasStartActions = !1, this.hasEndActions = !1, this.hasMenuItems = !1, this.hasHeaderContent = !1, this.hasActionBar = !1, this.hasContentBottom = !1, this.hasContentTop = !1, this.hasFab = !1, this.hasFooterActions = !1, this.hasFooterContent = !1, this.hasFooterEndContent = !1, this.hasFooterStartContent = !1, this.defaultMessages = void 0, this.effectiveLocale = "", this.showHeaderContent = !1;
  }
  toggleDialog(e) {
  ...
  async componentWillLoad() {
    P(this), this.isClosed = this.closed, await U(this);
  }
  componentDidLoad() {
    T(this);
  }
  ...
  disconnectedCallback() {
    N(this), _(this), this.resizeObserver?.disconnect();
  }
  effectiveLocaleChange() {
    K(this, this.effectiveLocale);
  }
  // --------------------------------------------------------------------------
  //
  //  Methods
   ...
   */
  async setFocus() {
    await L(this), z(this.containerEl);
  }
  /**
  ...
  // --------------------------------------------------------------------------
  renderHeaderContent() {
    const { heading: e, headingLevel: n, description: a, hasHeaderContent: i } = this, r = e ? t($, { class: o.heading, level: n }, e) : null, c = a ? t("span", { class: o.description }, a) : null;
    return !i && (r || c) ? t("div", { class: o.headerContent, key: "header-content" }, r, c) : null;
  }
  renderActionBar() {
    return t("div", { class: o.actionBarContainer, hidden: !this.hasActionBar }, t("slot", { name: s.actionBar, onSlotchange: this.handleActionBarSlotChange }));
  }
  renderHeaderSlottedContent() {
    return t("div", { class: o.headerContent, hidden: !this.hasHeaderContent, key: "slotted-header-content" }, t("slot", { name: s.headerContent, onSlotchange: this.handleHeaderContentSlotChange }));
  }
  renderHeaderStartActions() {
    const { hasStartActions: e } = this;
    return t("div", { class: { [o.headerActionsStart]: !0, [o.headerActions]: !0 }, hidden: !e, key: "header-actions-start" }, t("slot", { name: s.headerActionsStart, onSlotchange: this.handleHeaderActionsStartSlotChange }));
  }
  renderHeaderActionsEnd() {
    const { hasEndActions: e, messages: n, closable: a, collapsed: i, collapseDirection: r, collapsible: c, hasMenuItems: f } = this, { collapse: d, expand: h, close: g } = n, m = [p.expand, p.collapse];
    r === "up" && m.reverse();
    const b = c ? t("calcite-action", { "aria-expanded": x(!i), "aria-label": d, icon: i ? m[0] : m[1], id: S.collapse, onClick: this.collapse, scale: this.scale, text: d, title: i ? h : d }) : null, C = a ? t("calcite-action", { "aria-label": g, icon: p.close, id: S.close, onClick: this.handleUserClose, scale: this.scale, text: g, title: g }) : null, A = t("slot", { name: s.headerActionsEnd, onSlotchange: this.handleHeaderActionsEndSlotChange }), k = e || b || C || f;
    return t("div", { class: { [o.headerActionsEnd]: !0, [o.headerActions]: !0 }, hidden: !k, key: "header-actions-end" }, A, this.renderMenu(), b, C);
  }
  renderMenu() {
    const { hasMenuItems: e, messages: n, menuOpen: a, menuFlipPlacements: i, menuPlacement: r } = this;
    return t("calcite-action-menu", { flipPlacements: i ?? ["top", "bottom"], hidden: !e, key: "menu", label: n.options, open: a, overlayPositioning: this.overlayPositioning, placement: r }, t("calcite-action", { icon: p.menu, scale: this.scale, slot: I.trigger, text: n.options }), t("slot", { name: s.headerMenuActions, onSlotchange: this.handleHeaderMenuActionsSlotChange }));
  }
  renderHeaderNode() {
    const { hasHeaderContent: e, hasStartActions: n, hasEndActions: a, closable: i, collapsible: r, hasMenuItems: c, hasActionBar: f } = this, d = this.renderHeaderContent(), h = e || !!d || n || a || r || i || c;
    return this.showHeaderContent = h, t("header", { class: o.header, hidden: !(h || f) }, t("div", { class: { [o.headerContainer]: !0, [o.headerContainerBorderEnd]: f }, hidden: !h }, this.renderHeaderStartActions(), this.renderHeaderSlottedContent(), d, this.renderHeaderActionsEnd()), this.renderActionBar(), this.renderContentTop());
  }
  renderFooterNode() {
    const { hasFooterEndContent: e, hasFooterStartContent: n, hasFooterContent: a, hasFooterActions: i } = this, r = n || e || a || i;
    return t("footer", { class: o.footer, hidden: !r }, t("div", { class: o.footerContent, hidden: !a }, t("slot", { name: s.footer, onSlotchange: this.handleFooterSlotChange })), t("div", { class: o.footerStart, hidden: a || !n }, t("slot", { name: s.footerStart, onSlotchange: this.handleFooterStartSlotChange })), t("div", { class: o.footerEnd, hidden: a || !e }, t("slot", { name: s.footerEnd, onSlotchange: this.handleFooterEndSlotChange })), t("div", { class: o.footerActions, hidden: a || !i }, t("slot", { key: "footer-actions-slot", name: s.footerActions, onSlotchange: this.handleFooterActionsSlotChange })));
  }
  renderContent() {
    return t("div", { class: o.contentWrapper, hidden: this.collapsible && this.collapsed, onScroll: this.panelScrollHandler, ref: this.setPanelScrollEl }, t("slot", null), this.renderFab());
  }
  renderContentBottom() {
    return t("div", { class: o.contentBottom, hidden: !this.hasContentBottom }, t("slot", { name: s.contentBottom, onSlotchange: this.contentBottomSlotChangeHandler }));
  }
  renderContentTop() {
    return t("div", { class: o.contentTop, hidden: !this.hasContentTop }, t("slot", { name: s.contentTop, onSlotchange: this.contentTopSlotChangeHandler }));
  }
  renderFab() {
    return t("div", { class: o.fabContainer, hidden: !this.hasFab }, t("slot", { name: s.fab, onSlotchange: this.handleFabSlotChange }));
  }
  render() {
    const { disabled: e, loading: n, isClosed: a } = this, i = t("article", { key: "0f439dffdca536eb6973ac386b0566091249aee3", "aria-busy": x(n), class: o.container, hidden: a, ref: this.setContainerRef }, this.renderHeaderNode(), this.renderContent(), this.renderContentBottom(), this.renderFooterNode(), t("slot", { key: "alerts", name: s.alerts, onSlotchange: this.handleAlertsSlotChange }));
    return t(w, { key: "6e5baec07ecb356871dea038ebc2d5ee2d8ed54f", onKeyDown: this.panelKeyDownHandler }, t(B, { key: "924cda1799b359f1bb3fb119cebfff5a7349b72d", disabled: e }, n ? t("calcite-scrim", { loading: n }) : null, i));
  }
...
//# sourceMappingURL=panel-C3Bu-FR5.js.map
