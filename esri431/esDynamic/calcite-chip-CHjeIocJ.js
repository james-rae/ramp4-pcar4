import { dg as p, dh as m, fk as c, dd as u, dc as i, di as g } from "./main-DZxT3i7S.js";
import { s as b, t as f } from "./dom-N58V0tYi.js";
import { a as v, s as x, c as k } from "./loadable-BekOWxtq.js";
import { u as C, c as y, d as z, s as I } from "./t9n-DqBq_VHu.js";
import { u as S, I as M } from "./interactive-B_Y0ed_t.js";
import { c as w, d as E } from "./locale-B98iGxBG.js";
import { i as L } from "./key-CZySMiwx.js";
import { g as n } from "./component-CWGf1hug.js";
import { d as H } from "./icon-BnVuD4FT.js";
const t = {
  title: "title",
  close: "close",
  ...
  checkedMultiple: "check-square-f"
          ...
          )}.close:active{background-color:var(--calcite-close-background-color-press, var(--calcite-color-transparent-press))}.close calcite-icon{color:inherit}:host([disabled]) ::slotted([calcite-hydrated][disabled]),:host([disabled]) [calcite-hydrated][disabled]{opacity:1}.interaction-container{display:contents}:host([hidden]){display:none}[hidden]{display:none}`, T = B, s = /* @__PURE__ */ p(class extends m {
  constructor() {
    super(), this.__registerHost(), this.__attachShadow(), this.calciteChipClose = c(this, "calciteChipClose", 6), this.calciteChipSelect = c(this, "calciteChipSelect", 6), this.calciteInternalChipKeyEvent = c(this, "calciteInternalChipKeyEvent", 6), this.calciteInternalChipSelect = c(this, "calciteInternalChipSelect", 6), this.calciteInternalSyncSelectedChips = c(this, "calciteInternalSyncSelectedChips", 6), this.handleDefaultSlotChange = () => {
      this.updateHasText();
    }, this.close = () => {
      this.calciteChipClose.emit(), this.selected = !1, this.closed = !0;
    }, this.closeButtonKeyDownHandler = (e) => {
      L(e.key) && (e.preventDefault(), this.close());
    }, this.handleSlotImageChange = (e) => {
      this.hasImage = b(e);
    }, this.handleEmittingEvent = () => {
      this.interactive && this.calciteChipSelect.emit();
    }, this.disabled = !1, this.appearance = "solid", this.kind = "neutral", this.closable = !1, this.icon = void 0, this.iconFlipRtl = !1, this.scale = "m", this.label = void 0, this.value = void 0, this.closed = !1, this.selectionMode = "none", this.selected = !1, this.messageOverrides = void 0, this.messages = void 0, this.interactive = !1, this.parentChipGroup = void 0, this.defaultMessages = void 0, this.effectiveLocale = void 0, this.hasText = !1, this.hasImage = !1;
  }
  watchSelected(e) {
  ...
  componentDidLoad() {
    v(this), this.selectionMode !== "none" && this.interactive && this.selected && this.handleSelectionPropertyChange(this.selected);
  }
  componentDidRender() {
    S(this);
  }
  ...
  async componentWillLoad() {
    x(this), u() && (await I(this), this.updateHasText());
  }
  //--------------------------------------------------------------------------
  //
  //  Event Listeners
  ...
  clickHandler() {
    !this.interactive && this.closable && this.closeButtonEl.focus();
  }
  //--------------------------------------------------------------------------
  //
  //  Public Methods
  ...
  async setFocus() {
    await k(this), !this.disabled && this.interactive ? this.containerEl?.focus() : !this.disabled && this.closable && this.closeButtonEl?.focus();
  }
  updateHasText() {
  ...
  //--------------------------------------------------------------------------
  renderChipImage() {
    return i("div", { class: t.imageContainer }, i("slot", { name: D.image, onSlotchange: this.handleSlotImageChange }));
  }
  renderSelectionIcon() {
    const e = this.selectionMode === "multiple" ? this.selected ? a.checkedMultiple : a.uncheckedMultiple : this.selected ? a.checkedSingle : void 0;
    return i("div", { class: {
      [t.selectIcon]: !0,
      [t.selectIconActive]: this.selectionMode === "multiple" || this.selected
    } }, e ? i("calcite-icon", { icon: e, scale: n(this.scale) }) : null);
  }
  renderCloseButton() {
    return i("button", { "aria-label": this.messages.dismissLabel, class: t.close, onClick: this.close, onKeyDown: this.closeButtonKeyDownHandler, ref: (e) => this.closeButtonEl = e, tabIndex: this.disabled ? -1 : 0 }, i("calcite-icon", { icon: a.close, scale: n(this.scale) }));
  }
  renderIcon() {
    return i("calcite-icon", { class: t.chipIcon, flipRtl: this.iconFlipRtl, icon: this.icon, scale: n(this.scale) });
  }
  render() {
    const { disabled: e } = this, l = e || !e && !this.interactive, h = this.selectionMode === "multiple" && this.interactive ? "checkbox" : this.selectionMode !== "none" && this.interactive ? "radio" : this.interactive ? "button" : void 0;
    return i(g, { key: "7feca8bad37627baabfc4abd25cf135e1e9f196b" }, i(M, { key: "af2360b4b768ae8c643d52f4bdb9f5d282504114", disabled: e }, i("div", { key: "8d905c4ab20d271a211282b95ebcb2d305d76cb7", "aria-checked": this.selectionMode !== "none" && this.interactive ? f(this.selected) : void 0, "aria-label": this.label, class: {
      [t.container]: !0,
...
function o() {
  if (typeof customElements > "u")
    return;
  ["calcite-chip", "calcite-icon"].forEach((e) => {
    switch (e) {
      case "calcite-chip":
...
//# sourceMappingURL=calcite-chip-CHjeIocJ.js.map
