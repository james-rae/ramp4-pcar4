import { bs as A, i2 as H, bt as j, bu as R, bv as O, by as T, kf as C, bw as X, gd as V, ga as B, bx as F, bz as D, bB as q, bC as k, bD as o, bE as G, bF as m, bG as p, bJ as d, g5 as h } from "./main-DZxT3i7S.js";
import { m as U } from "./marked.esm-DgqJBp_S.js";
const z = `<?xml version="1.0" encoding="UTF-8"?>
...
`, Y = { key: 0 }, K = { class: "flex justify-center" }, Q = {
  key: 0,
  ...
  setup(r) {
    const s = H(), { t: l } = j(), u = R("iApi"), M = O(), a = r, f = T(() => s.status), b = T(() => s.response), v = O(!1), x = C({}), y = C([]), S = C([]);
    X(() => {
      _(), y.push(
        u.event.on(V.LAYER_REMOVE, (e) => {
      ...
      y.forEach((e) => u.event.off(e)), S.forEach((e) => e());
    });
    const _ = () => {
    ...
    return (e, t) => {
      ...
      return o(), q(n, {
        ...
        content: k(() => [
          v.value ? (o(), d("div", Y, [
            h("div", K, [
              f.value == "loading" ? (o(), d("div", Q, m(p(l)("metadata.loading")), 1)) : r.payload.type === "xml" && f.value == "success" ? (o(), d("div", {
                key: 1,
                innerHTML: b.value,
                class: "flex flex-col justify-center xml-content"
              }, null, 8, W)) : (r.payload.type === "html" || r.payload.type === "md") && f.value == "success" ? (o(), d("div", {
                key: 2,
                innerHTML: b.value,
...
//# sourceMappingURL=screen.vue_vue_type_style_index_0_lang-Clubw_U7.js.map
