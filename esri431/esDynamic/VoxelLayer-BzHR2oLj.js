import { e0 as _e, ao as Ie, ha as Be, p$ as Re, ij as Te, ap as ot, aq as ie, db as P, i5 as $, jJ as N, bQ as i, bR as s, gf as ce, bS as m, bT as g, eX as st, hQ as j, h6 as k, a8 as c, d4 as de, b5 as le, q0 as ae, T as te, b1 as Oe, q1 as Ae, G as D, a5 as rt, dY as nt, mq as lt, D as ve, fZ as at, iG as pt, d$ as ut, eN as ct, ez as dt, eA as yt, eB as ht, eC as mt, eO as gt, eP as ft, or as vt, B as bt, s as be, aA as Ee, ay as J, dz as St, ho as xt, fN as Ce, jH as ke, eF as wt, eG as Vt, eD as qe, cB as jt, mX as $t, eM as Nt } from "./main-DZxT3i7S.js";
import { R as zt } from "./SceneService-BySgYuKY.js";
import { j as It } from "./persistable-ChKWNQcl.js";
import { b as Se, x as Rt } from "./quat-BFf8_asR.js";
import { e as me } from "./quatf64-C16JxGFv.js";
const f = ot(), De = me(), Pe = me(), Le = me(), Ue = ie(0, 0, 1), Tt = ie(0, 1, 0), At = ie(1, 0, 0);
function W(e) {
  _e(f, e), Ie(f, f);
  const t = Math.atan2(f[1], f[0]), o = Se(me(), Ue, -t);
  Be(f, f, o);
  const r = -1 * Math.atan2(f[2], f[0]);
  return [Re(t) + 270, Re(r) + 90];
}
function ye(e, t) {
  return Se(Pe, Ue, Te(e - 270)), Se(Le, Tt, Te(t - 90)), Rt(De, Pe, Le), _e(f, At), Be(f, f, De), Ie(f, f), [f[0], f[1], f[2]];
}
...
i([s({ type: Boolean, json: { default: !0, write: !0 } })], b.prototype, "enabled", void 0), i([s({ type: String, json: { origins: { service: { read: st } }, write: { enabled: !0, isRequired: !0 } } }), It({ origins: ["web-scene"], type: "resource", prefix: "sections", compress: !0 })], b.prototype, "href", void 0), i([s({ type: j, json: { write: { enabled: !0, isRequired: !0 } } })], b.prototype, "id", void 0), i([s({ type: String, json: { write: !0 } })], b.prototype, "label", void 0), i([s({ type: Number, clonable: !1, readOnly: !0, range: { min: 0, max: 360 } })], b.prototype, "orientation", null), i([s({ type: Number, clonable: !1, readOnly: !0, range: { min: 0, max: 360 } })], b.prototype, "tilt", null), i([s({ type: [Number], json: { write: { enabled: !0, isRequired: !0 } } })], b.prototype, "normal", void 0), i([s({ type: [Number], json: { write: { enabled: !0, isRequired: !0 } } })], b.prototype, "point", void 0), i([s({ type: [j], json: { write: { enabled: !0, isRequired: !0 } } })], b.prototype, "sizeInPixel", void 0), i([s({ type: [he], json: { write: !0 } })], b.prototype, "slices", void 0), i([s({ type: j, json: { default: 0, write: !0 } })], b.prototype, "timeId", void 0), i([s({ type: j, json: { write: { enabled: !0, isRequired: !0 } } })], b.prototype, "variableId", void 0), b = i([m("esri.layers.voxel.VoxelSection")], b);
const xe = b;
...
i([s({ type: Number, range: { min: 0, max: 1 }, json: { default: 0.5, write: !0 } })], X.prototype, "diffuseFactor", void 0), i([s({ type: Number, range: { min: 0, max: 1 }, json: { default: 0.5, write: !0 } })], X.prototype, "specularFactor", void 0), X = i([m("esri.layers.voxel.VoxelSimpleShading")], X);
const Je = X;
...
const qt = V;
let M = class extends P(g) {
  constructor() {
    super(...arguments), this.color = k.fromArray([0, 0, 0, 0]), this.value = 0, this.enabled = !0, this.label = "", this.colorLocked = !1;
  }
};
i([s({ type: k, json: { type: [j], write: { enabled: !0, isRequired: !0 } } })], M.prototype, "color", void 0), i([s({ type: Number, json: { write: { enabled: !0, isRequired: !0 } } })], M.prototype, "value", void 0), i([s({ type: Boolean, json: { default: !0, write: !0 } })], M.prototype, "enabled", void 0), i([s({ type: String, json: { write: !0 } })], M.prototype, "label", void 0), i([s({ type: Boolean, json: { default: !1, write: !0 } })], M.prototype, "colorLocked", void 0), M = i([m("esri.layers.voxel.VoxelIsosurface")], M);
const We = M;
let Y = class extends P(g) {
  constructor() {
    super(...arguments), this.color = null, this.position = 0;
  }
};
i([s({ type: k, json: { type: [j], write: { enabled: !0, isRequired: !0 } } })], Y.prototype, "color", void 0), i([s({ type: Number, json: { write: { enabled: !0, isRequired: !0 } } })], Y.prototype, "position", void 0), Y = i([m("esri.layers.voxel.VoxelColorStop")], Y);
const we = Y;
let H = class extends P(g) {
  constructor() {
    super(...arguments), this.opacity = 1, this.position = 0;
  }
};
i([s({ type: Number, json: { name: "alpha", write: { enabled: !0, isRequired: !0 } } })], H.prototype, "opacity", void 0), i([s({ type: Number, json: { write: { enabled: !0, isRequired: !0 } } })], H.prototype, "position", void 0), H = i([m("esri.layers.voxel.VoxelOpacityStop")], H);
const Ve = H;
let K = class extends P(g) {
  constructor() {
    super(...arguments), this.enabled = !1, this.range = null;
  }
};
i([s({ type: Boolean, json: { default: !1, write: !0 } })], K.prototype, "enabled", void 0), i([s({ type: [Number], json: { write: !0 } })], K.prototype, "range", void 0), K = i([m("esri.layers.voxel.VoxelRangeFilter")], K);
const Dt = K;
var w;
(function(e) {
...
let T = class extends P(g) {
  ...
  getPreviousNext(e, t, o) {
    ...
    let n = e;
    const a = t.length;
    for (; ++n < a && t[n].type !== o && t[n].type !== w.Both; ) ;
    return [r, n];
  }
  get rasterizedTransferFunction() {
    ...
    if (this.opacityStops.length === 0) for (const p of o) t.push({ color: p.color, position: p.position });
      ...
      for (const u of this.opacityStops) {
        ...
        for (const y of o) if (y.type === w.Color && Math.abs(y.position - d) < r) {
          y.color.a = h, y.type = w.Both, v = !0;
          break;
        }
        v || o.push({ color: { r: 0, g: 0, b: 0, a: h }, position: u.position, type: w.Alpha });
      }
      ...
      for (let u = 0; u < p; ++u) {
        ...
        if (d.type !== w.Both) if (d.type === w.Color) {
          const [h, v] = this.getPreviousNext(u, o, w.Alpha);
          if (h !== -1 && v !== p) {
            const y = (d.position - o[h].position) / (o[v].position - o[h].position);
            d.color.a = Math.round(ae(o[h].color.a, o[v].color.a, y));
          } else d.color.a = h !== -1 ? o[h].color.a : o[v].color.a;
        } else {
          const [h, v] = this.getPreviousNext(u, o, w.Color);
          if (h !== -1 && v !== p) {
            const y = (d.position - o[h].position) / (o[v].position - o[h].position), L = o[h].color, oe = o[v].color;
            pe.forEach((F) => {
              d.color[F] = Math.round(ae(L[F], oe[F], y));
            });
          } else h !== -1 ? pe.forEach((y) => {
            d.color[y] = o[h].color[y];
          }) : pe.forEach((y) => {
            d.color[y] = o[v].color[y];
          });
        }
      }
    ...
    for (let p = 0; p < this._colorMapSize; ++p) {
      ...
      for (; u > t[a].position; ) n = a++;
      const d = (u - t[n].position) / (t[a].position - t[n].position), h = t[n].color, v = t[a].color, y = new k();
      pe.forEach((L) => {
        y[L] = Math.round(ae(h[L], v[L], d));
      }), y.a = le(1 - ae(h.a, v.a, d) / 255, 0, 1), e.push(y);
    }
    return e;
  }
  getColorForContinuousDataValue(e, t) {
    ...
    e = le(e, r, n);
    const a = o[Math.round((e - r) / (n - r) * (this._colorMapSize - 1))].clone();
    return t || (a.a = 1), a;
  }
};
...
} } } })], T.prototype, "opacityStops", null), i([s({ type: Dt, json: { write: !0 } })], T.prototype, "rangeFilter", void 0), i([s({ type: [k], clonable: !1, json: { read: !1 } })], T.prototype, "rasterizedTransferFunction", null), T = i([m("esri.layers.voxel.VoxelTransferFunctionStyle")], T);
const Pt = T, pe = ["r", "g", "b"];
...
i([s({ type: k, json: { type: [j], write: { enabled: !0, isRequired: !0 } } })], E.prototype, "color", void 0), i([s({ type: j, json: { write: { enabled: !0, isRequired: !0 } } })], E.prototype, "value", void 0), i([s({ type: Boolean, json: { default: !0, write: !0 } })], E.prototype, "enabled", void 0), i([s({ type: String, json: { write: !0 } })], E.prototype, "label", void 0), E = i([m("esri.layers.voxel.VoxelUniqueValue")], E);
const Ze = E;
var je;
let _ = je = class extends g {
  constructor(e) {
    super(e), this.variableId = 0, this.label = "", this.transferFunction = null, this.uniqueValues = null, this.isosurfaces = null, this.uniqueValues = new (c.ofType(Ze))(), this.isosurfaces = new (c.ofType(We))();
  }
  clone() {
...
i([s({ type: j, json: { write: { enabled: !0, isRequired: !0 } } })], _.prototype, "variableId", void 0), i([s({ type: String, json: { write: !0 } })], _.prototype, "label", void 0), i([s({ type: Pt, json: { write: { enabled: !0, overridePolicy() {
  return { enabled: !this.uniqueValues || this.uniqueValues.length < 1 };
} } } })], _.prototype, "transferFunction", void 0), i([s({ type: c.ofType(Ze), json: { write: { enabled: !0, overridePolicy() {
  return { enabled: !!this.uniqueValues && this.uniqueValues.length > 0 };
} } } })], _.prototype, "uniqueValues", void 0), i([s({ type: c.ofType(We), json: { write: { enabled: !0, overridePolicy() {
  const e = !this.uniqueValues || this.uniqueValues.length < 1, t = !!this.isosurfaces && this.isosurfaces.length > 0;
  return { enabled: e && t };
} } } })], _.prototype, "isosurfaces", void 0), _ = je = i([m("esri.layers.voxel.VoxelVariableStyle")], _);
const Ge = _;
function Me(e) {
  ...
  if (z === 2) {
    const Q = Z % 4 == 0 && (Z % 100 != 0 || Z % 400 == 0);
    if (Q && B > 29 || !Q && B > 28) return { didParse: !1 };
  ...
  let fe = 1, O = 0, U = 0;
  if (y && (fe = y === "-" ? -1 : 1), L) {
    if (O = parseInt(L, 10), Number.isNaN(O) || O < 0) return { didParse: !1 };
    if (O !== 0) {
      const Q = fe * O;
      if (Q < -12 || Q > 14) return { didParse: !1 };
    }
  }
  if (oe && (U = parseInt(oe, 10), Number.isNaN(U) || U < 0 || U > 59)) return { didParse: !1 };
  const Ye = `${Z}`.padStart(4, "0"), He = `${z}`.padStart(2, "0"), Ke = `${B}`.padStart(2, "0"), et = `${se}`.padStart(2, "0"), tt = `${re}`.padStart(2, "0"), it = `${ne}`.padStart(2, "0");
  let G = "Z";
  return O === 0 && U === 0 || (G = fe > 0 ? "+" : "-", G += `${O}`.padStart(2, "0"), G += ":", G += `${U}`.padStart(2, "0")), { didParse: !0, unit: F, reference: /* @__PURE__ */ new Date(`${Ye}-${He}-${Ke}T${et}:${tt}:${it}.000${G}`) };
}
...
let x = class extends g {
  constructor(e) {
    super(e), this.id = 0, this.dimensions = null, this.spatialReference = Oe.WGS84;
  }
  get zDimension() {
  ...
  get voxelSizeInLayerSpaceSigned() {
    ...
    for (let a = 0; a < 3; ++a) n[a] < 2 ? n[a] = 1 : n[a] -= 1;
  ...
  get volumeType() {
    if (this.isValid) {
      ...
      if (t) {
        ...
        t = o.quantity === "time", t && o.unit !== null && (t = Me(o.unit).didParse);
      }
      if (!e && t) return "xyt";
      if (e && t) return "xyzt";
    }
  ...
  get timeStops() {
    ...
    if (o.didParse) {
      if (e.isRegular) {
        ...
        t.push(Ae(o.reference, n, o.unit));
      }
    }
    return t;
  }
  computeVoxelSpaceLocation(e) {
    if (!this.isValid) return [0, 0, 0];
    if (this.volumeType === "xyt") return D.getLogger(this).error("computeVoxelSpacePosition cannot be used with XYT volumes."), [0, 0, 0];
    if (!rt(this.spatialReference, e.spatialReference)) return D.getLogger(this).error("pos argument should have the same spatial reference as the VoxelLayer."), [0, 0, 0];
    ...
    if (!o.isRegular && Array.isArray(o.irregularSpacing?.values) && o.irregularSpacing.values.length > 1) {
      const r = e.z ?? 0, n = o.irregularSpacing.values, a = o.isPositiveUp ? 1 : -1, p = n.reduce((u, d) => Math.abs(a * d - r) < Math.abs(a * u - r) ? d : u);
  ...
  computeLayerSpaceLocation(e) {
    if (!this.isValid) return new ve({ x: 0, y: 0, spatialReference: this.spatialReference });
    const t = at(e);
    if (pt(t, t, this.voxelSizeInLayerSpaceSigned), ut(t, t, this.originInLayerSpace3D), this.volumeType === "xyt") return new ve({ x: t[0], y: t[1], spatialReference: this.spatialReference });
    const o = this.dimensions[this.zDimension];
...
i([s({ type: Number, json: { write: { enabled: !0, isRequired: !0 } } })], x.prototype, "id", void 0), i([s({ type: [Mt], json: { write: { enabled: !0, isRequired: !0 } } })], x.prototype, "dimensions", void 0), i([s({ type: Oe, json: { read: { enabled: !1 } } })], x.prototype, "spatialReference", void 0), i([s({ type: Number, json: { read: !1 } })], x.prototype, "zDimension", null), i([s({ type: [Boolean], json: { read: !1 } })], x.prototype, "isValid", null), i([s({ type: [Number], json: { read: !1 } })], x.prototype, "originInLayerSpace3D", null), i([s({ type: [Number], json: { read: !1 } })], x.prototype, "voxelSizeInLayerSpaceSigned", null), i([s({ type: ["xyz", "xyzt", "xyt"], json: { read: { enabled: !1 } } })], x.prototype, "volumeType", null), i([s({ type: [Number], json: { read: !1 } })], x.prototype, "sizeInVoxels", null), i([s({ type: [Date], json: { read: !1, write: !1 } })], x.prototype, "timeStops", null), x = i([m("esri.layers.voxel.VoxelVolume")], x);
const Qe = x;
var $e;
...
i([s({ type: Boolean, json: { default: !0, write: !0 } })], A.prototype, "enabled", void 0), i([s({ type: String, json: { write: !0 } })], A.prototype, "label", void 0), i([s({ type: Number, json: { read: !1 }, clonable: !1, range: { min: 0, max: 360 } }), ce((e) => $.normalize(N(e), 0, !0))], A.prototype, "orientation", null), i([s({ type: Number, json: { read: !1 }, clonable: !1, range: { min: 0, max: 360 } }), ce((e) => $.normalize(N(e), 0, !0))], A.prototype, "tilt", null), i([s({ type: [Number], json: { write: !0 } })], A.prototype, "normal", void 0), i([s({ type: [Number], json: { write: !0 } })], A.prototype, "point", void 0), A = i([m("esri.layers.voxel.VoxelDynamicSection")], A);
const Ne = A;
var ze;
let q = ze = class extends g {
  constructor(e) {
...
i([s({ type: j, json: { write: { enabled: !0, isRequired: !0 } } })], q.prototype, "volumeId", void 0), i([s({ type: Number, json: { default: 1, write: !0 } })], q.prototype, "verticalExaggeration", void 0), i([s({ type: ["scale-position", "scale-height"], json: { default: "scale-height", write: !0 } })], q.prototype, "exaggerationMode", void 0), i([s({ type: Number, json: { default: 0, write: !0 } })], q.prototype, "verticalOffset", void 0), i([s({ type: c.ofType(he), json: { write: { enabled: !0, overridePolicy() {
  return { enabled: !!this.slices && this.slices.length > 0 };
} } } })], q.prototype, "slices", null), i([s({ type: c.ofType(Ne), json: { write: { enabled: !0, overridePolicy() {
  return { enabled: !!this.dynamicSections && this.dynamicSections.length > 0 };
} } } })], q.prototype, "dynamicSections", null), q = ze = i([m("esri.layers.voxel.VoxelVolumeStyle")], q);
const Xe = q;
let l = class extends zt(ct(dt(yt(ht(mt(gt(ft(Nt)))))))) {
  constructor(e) {
    super(e), this.serviceRoot = "", this.operationalLayerType = "Voxel", this.legendEnabled = !0, this.title = null, this.sections = null, this.currentVariableId = 0, this.volumeStyles = null, this.renderMode = "volume", this.variableStyles = null, this.enableSlices = !0, this.enableSections = !0, this.enableDynamicSections = !0, this.enableIsosurfaces = !0, this.shading = new Je(), this.opacity = 1, this.variables = new c(), this.volumes = new c(), this.index = null, this.minScale = 0, this.maxScale = 0, this.type = "voxel", this.version = { major: Number.NaN, minor: Number.NaN, versionString: "" }, this.fullExtent = null, this.popupEnabled = !1, this.popupTemplate = null, this.test = null, this.timeExtent = null, this.timeOffset = null, this.useViewTime = !0, this.volumeStyles = new (c.ofType(Xe))(), this.variableStyles = new (c.ofType(Ge))(), this.sections = new (c.ofType(xe))();
  }
  normalizeCtorArgs(e) {
    return e?.constantUpscaling && (this.test = { constantUpscaling: !0 }, delete e.constantUpscaling), e;
  }
  set url(e) {
    this._set("url", vt(e, D.getLogger(this)));
  }
  load(e) {
  ...
  read(e, t) {
    super.read(e, t), t?.origin === "service" && this.version.major <= 3 && this.version.minor <= 0 && !this.getAtOrigin("popupTemplate", "service") && this.setAtOrigin("popupTemplate", this.createPopupTemplate(), "service");
  ...
  readFullExtent(e, t, o) {
    if (e != null && typeof e == "object") {
      const r = Ee.fromJSON(e, o);
      if (r.zmin === 0 && r.zmax === 0 && Array.isArray(t.volumes)) {
        const n = Qe.fromJSON(t.volumes[0]);
        if (n.isValid && n.volumeType !== "xyt") {
          const a = n.dimensions[2];
          if (a.isRegular) {
            let p = a.regularSpacing.offset, u = a.regularSpacing.offset + a.regularSpacing.scale * (a.size - 1);
            if (p > u) {
              const d = p;
              p = u, u = d;
            }
  ...
  get fields() {
    const e = [new J({ name: "Voxel.Position", alias: "Voxel Position", domain: null, editable: !1, length: 128, type: "string" }), new J({ name: "Voxel.CurrentVariable", alias: "Current Variable", domain: null, editable: !1, length: 128, type: "string" })];
    for (const o of this.variables) {
      const r = new J({ name: o.name, alias: o.description, domain: null, editable: !1, length: 128, type: o.renderingFormat.continuity === "discrete" ? "string" : "double" });
      e.push(r);
    }
    const t = this.getVolume(null);
    if (t != null) {
      if (t.volumeType === "xyzt" || t.volumeType === "xyt") {
        const o = new J({ name: "Voxel.LocalTime", alias: "Local Time", domain: null, editable: !1, length: 256, type: "date" });
        e.push(o);
        const r = new J({ name: "Voxel.SourceTime", alias: "Source Time", domain: null, editable: !1, length: 256, type: "string" });
        e.push(r);
      }
      if (t.volumeType !== "xyt") {
        const o = new J({ name: "Voxel.Depth", alias: "Depth", domain: null, editable: !1, length: 128, type: "double" });
        e.push(o);
      }
    }
    return e;
  ...
  get fieldsIndex() {
    return this.loaded ? new St(this.fields) : null;
  }
  getField(e) {
  ...
  createPopupTemplate(e) {
    const t = this.fields;
    return xt({ fields: t, title: "{Voxel.Position}" }, e);
  }
  getConfiguration() {
  ...
  getColorForContinuousDataValue(e, t, o) {
    ...
    if (n < 0) return null;
    const a = this.variableStyles.at(n);
    return a?.transferFunction ? a.transferFunction.getColorForContinuousDataValue(t, o) : null;
  }
  getSections() {
    const e = [];
  ...
  getVariableStyles() {
    ...
    for (const t of this.variableStyles) {
      ...
      if (o != null) {
        const r = t.clone();
        r.isosurfaces.length > 4 && (r.isosurfaces = r.isosurfaces.slice(0, 3), D.getLogger(this).error("A maximum of 4 isosurfaces are supported for Voxel Layers."));
        for (const n of r.isosurfaces) if (!n.colorLocked) {
          const a = this.getColorForContinuousDataValue(r.variableId, n.value, !1);
          a === null || a.equals(n.color) || (n.color = a);
        }
        if (o.renderingFormat.continuity === "continuous") (r.transferFunction === null || r.transferFunction.colorStops.length < 2) && D.getLogger(this).error(`VoxelVariableStyle for variable ${o.id} is invalid. At least 2 color stops are required in the transferFunction for continuous Voxel Layer variables.`), r.transferFunction !== null && (Array.isArray(r.transferFunction.stretchRange) && r.transferFunction.stretchRange.length === 2 || (D.getLogger(this).error(`VoxelVariableStyle for variable ${o.id} is invalid. The stretchRange of the transferFunction for continuous Voxel Layer variables must be of the form [minimumDataValue, maximumDataValue].`), r.transferFunction.stretchRange = [0, 1], r.transferFunction.colorStops.removeAll()));
        else if (o.renderingFormat.continuity === "discrete") if (t.uniqueValues.length === 0) D.getLogger(this).error(`VoxelVariableStyle for variable ${o.id} is invalid. Unique values are required for discrete Voxel Layer variables.`);
        else for (const n of t.uniqueValues) n.label !== null && n.label !== void 0 || n.value === null || n.value === void 0 || (n.label = n.value.toString());
        e.push(r);
      } else D.getLogger(this).error(`VoxelVariable ID=${t.variableId} doesn't exist, VoxelVariableStyle for this VoxelVariable will be ignored.`);
    }
    return e;
  }
  getVolumeStyles() {
    ...
    for (const t of this.volumeStyles) {
      ...
      if (o != null) {
        ...
        e.push(r);
      } else D.getLogger(this).error(`VoxelVolume ID=${t.volumeId} doesn't exist, VoxelVolumeStyle for this VoxelVolume will be ignored.`);
    }
    return e;
  }
  _getVariable(e) {
...
i([s({ type: ["Voxel"] })], l.prototype, "operationalLayerType", void 0), i([s(wt)], l.prototype, "legendEnabled", void 0), i([s({ json: { write: !0 } })], l.prototype, "title", void 0), i([s(Vt)], l.prototype, "url", null), i([s({ type: c.ofType(xe), json: { origins: { "web-scene": { name: "layerDefinition.sections", write: !0 } } } })], l.prototype, "sections", void 0), i([s({ type: j, json: { origins: { "web-scene": { name: "layerDefinition.style.currentVariableId", write: { enabled: !0, isRequired: !0, ignoreOrigin: !0 } }, service: { name: "style.currentVariableId" } } } })], l.prototype, "currentVariableId", void 0), i([s({ type: c.ofType(Xe), json: { origins: { "web-scene": { name: "layerDefinition.style.volumeStyles", write: !0 }, service: { name: "style.volumeStyles" } } } })], l.prototype, "volumeStyles", void 0), i([s({ type: ["volume", "surfaces"], json: { origins: { "web-scene": { name: "layerDefinition.style.renderMode", write: !0 }, service: { name: "style.renderMode" } } } })], l.prototype, "renderMode", void 0), i([s({ type: c.ofType(Ge), json: { origins: { "web-scene": { name: "layerDefinition.style.variableStyles", write: !0 }, service: { name: "style.variableStyles" } } } })], l.prototype, "variableStyles", void 0), i([s({ type: Boolean, json: { origins: { "web-scene": { name: "layerDefinition.style.enableSlices", write: !0 }, service: { name: "style.enableSlices" } } } })], l.prototype, "enableSlices", void 0), i([s({ type: Boolean, json: { origins: { "web-scene": { name: "layerDefinition.style.enableSections", write: !0 }, service: { name: "style.enableSections" } } } })], l.prototype, "enableSections", void 0), i([s({ type: Boolean, json: { origins: { "web-scene": { name: "layerDefinition.style.enableDynamicSections", write: !0 }, service: { name: "style.enableDynamicSections" } } } })], l.prototype, "enableDynamicSections", void 0), i([s({ type: Boolean, json: { origins: { "web-scene": { name: "layerDefinition.style.enableIsosurfaces", write: !0 }, service: { name: "style.enableIsosurfaces" } } } })], l.prototype, "enableIsosurfaces", void 0), i([s({ type: Je, json: { origins: { "web-scene": { name: "layerDefinition.style.shading", write: !0 }, service: { name: "style.shading" } } } })], l.prototype, "shading", void 0), i([s({ type: ["show", "hide"] })], l.prototype, "listMode", void 0), i([s({ type: Number, range: { min: 0, max: 1 }, nonNullable: !0, json: { read: !1, write: !1, origins: { "web-scene": { read: !1, write: !1 }, "portal-item": { read: !1, write: !1 } } } })], l.prototype, "opacity", void 0), i([s({ type: c.ofType(qt) })], l.prototype, "variables", void 0), i([s({ type: c.ofType(Qe) })], l.prototype, "volumes", void 0), i([s({ type: _t })], l.prototype, "index", void 0), i([s({ type: Number, json: { name: "layerDefinition.minScale", write: !0, origins: { service: { read: !1, write: !1 } } } })], l.prototype, "minScale", void 0), i([s({ type: Number, json: { name: "layerDefinition.maxScale", write: !0, origins: { service: { read: !1, write: !1 } } } })], l.prototype, "maxScale", void 0), i([s({ json: { read: !1 }, readOnly: !0 })], l.prototype, "type", void 0), i([s({ readOnly: !0, json: { name: "serviceVersion" } })], l.prototype, "version", void 0), i([qe("service", "version")], l.prototype, "readVersion", null), i([s({ type: Ee })], l.prototype, "fullExtent", void 0), i([qe("service", "fullExtent", ["fullExtent"])], l.prototype, "readFullExtent", null), i([s({ readOnly: !0, clonable: !1, json: { read: !1 } })], l.prototype, "fields", null), i([s({ readOnly: !0 })], l.prototype, "fieldsIndex", null), i([s({ type: Boolean, json: { name: "disablePopup", read: { reader: (e, t) => !t.disablePopup }, write: { enabled: !0, ignoreOrigin: !0, writer(e, t, o) {
  t[o] = !e;
} }, origins: { "portal-item": { default: !0 }, "web-scene": { default: !0 } } } })], l.prototype, "popupEnabled", void 0), i([s({ type: jt, json: { name: "popupInfo", write: !0 } })], l.prototype, "popupTemplate", void 0), i([s({ readOnly: !0, json: { read: !1 } })], l.prototype, "defaultPopupTemplate", null), i([s({ type: ke, readOnly: !0, json: { read: !1 } })], l.prototype, "timeInfo", null), i([s({ type: Ce, json: { read: !1 } })], l.prototype, "timeExtent", void 0), i([s({ type: $t, json: { read: !1 } })], l.prototype, "timeOffset", void 0), i([s({ type: Boolean, nonNullable: !0, json: { origins: { "web-scene": { name: "timeAnimation", write: !0 }, service: { read: !1 } } } })], l.prototype, "useViewTime", void 0), l = i([m("esri.layers.VoxelLayer")], l);
const oi = l;
export {
  oi as default
};
//# sourceMappingURL=VoxelLayer-BzHR2oLj.js.map
