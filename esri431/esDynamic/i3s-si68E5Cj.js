import { z as ce } from "./main-DZxT3i7S.js";
var zt, Ht = { exports: {} };
function se() {
  return zt || (zt = 1, ot = Ht, J = typeof document < "u" && document.currentScript ? document.currentScript.src : void 0, at = function(K = {}) {
    var ut, H, i = K !== void 0 ? K : {};
    i.ready = new Promise((t, n) => {
      ut = t, H = n;
    });
    var ct = Object.assign({}, i), st = typeof window == "object", D = typeof importScripts == "function";
    typeof process == "object" && typeof process.versions == "object" && process.versions.node;
    var Q, b = "";
    function Dt(t) {
      return i.locateFile ? i.locateFile(t, b) : b + t;
    }
    (st || D) && (D ? b = self.location.href : typeof document < "u" && document.currentScript && (b = document.currentScript.src), J && (b = J), b = b.indexOf("blob:") !== 0 ? b.substr(0, b.replace(/[?#].*/, "").lastIndexOf("/") + 1) : "", D && (Q = (t) => {
      var n = new XMLHttpRequest();
      return n.open("GET", t, !1), n.responseType = "arraybuffer", n.send(null), new Uint8Array(n.response);
    }));
    var U, V, Vt = i.print || console.log.bind(console), F = i.printErr || console.warn.bind(console);
    Object.assign(i, ct), ct = null, i.arguments && i.arguments, i.thisProgram && i.thisProgram, i.quit && i.quit, i.wasmBinary && (U = i.wasmBinary), i.noExitRuntime, typeof WebAssembly != "object" && B("no native wasm support detected");
    var E, v, R, M, W, p, ft, lt, dt, pt = !1;
    function vt() {
      var t = V.buffer;
      i.HEAP8 = E = new Int8Array(t), i.HEAP16 = R = new Int16Array(t), i.HEAP32 = W = new Int32Array(t), i.HEAPU8 = v = new Uint8Array(t), i.HEAPU16 = M = new Uint16Array(t), i.HEAPU32 = p = new Uint32Array(t), i.HEAPF32 = ft = new Float32Array(t), i.HEAPF64 = lt = new Float64Array(t);
    }
    var ht = [], mt = [], gt = [];
    function Mt() {
      if (i.preRun) for (typeof i.preRun == "function" && (i.preRun = [i.preRun]); i.preRun.length; ) Nt(i.preRun.shift());
      Y(ht);
    }
    function Bt() {
      Y(mt);
    ...
    function qt() {
      if (i.postRun) for (typeof i.postRun == "function" && (i.postRun = [i.postRun]); i.postRun.length; ) $t(i.postRun.shift());
      Y(gt);
    }
    function Nt(t) {
      ht.unshift(t);
    ...
    function B(t) {
      i.onAbort && i.onAbort(t), F(t = "Aborted(" + t + ")"), pt = !0, t += ". Build with -sASSERTIONS for more info.";
      var n = new WebAssembly.RuntimeError(t);
      throw H(n), n;
    }
    var O, Zt = "data:application/octet-stream;base64,";
    function yt(t) {
      return t.startsWith(Zt);
    }
    function _t(t) {
      try {
    ...
    function Jt(t) {
      return U || !st && !D || typeof fetch != "function" ? Promise.resolve().then(() => _t(t)) : fetch(t, { credentials: "same-origin" }).then((n) => {
        if (!n.ok) throw "failed to load wasm binary file at '" + t + "'";
        return n.arrayBuffer();
      }).catch(() => _t(t));
    }
    function wt(t, n, e) {
      return Jt(t).then((r) => WebAssembly.instantiate(r, n)).then((r) => r).then(e, (r) => {
        F("failed to asynchronously prepare wasm: " + r), B(r);
      });
    }
    function Kt(t, n, e, r) {
      return t || typeof WebAssembly.instantiateStreaming != "function" || yt(n) || typeof fetch != "function" ? wt(n, e, r) : fetch(n, { credentials: "same-origin" }).then((o) => WebAssembly.instantiateStreaming(o, e).then(r, function(u) {
        return F("wasm streaming compile failed: " + u), F("falling back to ArrayBuffer instantiation"), wt(n, e, r);
      }));
    }
    function Qt() {
      var t = { env: xt, wasi_snapshot_preview1: xt };
      function n(r, o) {
        var u = r.exports;
        return i.asm = u, V = i.asm.memory, vt(), dt = i.asm.__indirect_function_table, Lt(i.asm.__wasm_call_ctors), Xt(), u;
      }
      function e(r) {
        n(r.instance);
      }
      if (Gt(), i.instantiateWasm) try {
        return i.instantiateWasm(t, n);
      } catch (r) {
        F("Module.instantiateWasm callback failed with error: " + r), H(r);
      }
      return Kt(U, O, t, e).catch(H), {};
    }
    function Y(t) {
      for (; t.length > 0; ) t.shift()(i);
    }
    yt(O = "i3s.wasm") || (O = Dt(O));
    var q = [];
    function tt(t) {
      var n = q[t];
      return n || (t >= q.length && (q.length = t + 1), q[t] = n = dt.get(t)), n;
    }
    function Yt(t, n) {
      tt(t)(n);
    }
    function tn(t) {
      this.excPtr = t, this.ptr = t - 24, this.set_type = function(n) {
        ...
        if (It(this.get_type())) return p[this.excPtr >> 2];
        var n = this.get_adjusted_ptr();
        return n !== 0 ? n : this.excPtr;
      };
    }
    function nn(t, n, e) {
      throw new tn(t).init(n, e), t;
    }
    var N = {};
    function bt(t) {
      for (; t.length; ) {
    ...
    function on(t) {
      ...
      return n >= en && n <= rn ? "_" + t : t;
    }
    function an(t, n) {
      return t = on(t), { [t]: function() {
        return n.apply(this, arguments);
      } }[t];
    }
    function nt(t, n) {
      var e = an(n, function(r) {
...
` + o.replace(/^Error(:[^\n]*)?\n/, ""));
    ...
    function Ct(t, n, e) {
      function r(a) {
        var s = e(a);
        s.length !== t.length && Tt("Mismatched type converter count");
    ...
    function un(t) {
      ...
      Ct([t], o.map((u) => u.getterReturnType).concat(o.map((u) => u.setterArgumentType)), (u) => {
        var c = {};
        return o.forEach((a, s) => {
          var f = a.fieldName, l = u[s], d = a.getter, C = a.getterContext, y = u[s + o.length], _ = a.setter, P = a.setterContext;
          c[f] = { read: (w) => l.fromWireType(d(C, w)), write: (w, it) => {
            var Z = [];
            _(P, w, y.toWireType(Z, it)), bt(Z);
          } };
    ...
    function pn() {
      g.allocated.push({ value: void 0 }, { value: null }, { value: !0 }, { value: !1 }), g.reserved = g.allocated.length, i.count_emval_handles = dn;
    }
    ...
    function hn(t, n) {
      switch (n) {
        case 2:
          return function(e) {
            return this.fromWireType(ft[e >> 2]);
          };
        case 3:
          return function(e) {
            return this.fromWireType(lt[e >> 3]);
          };
        default:
    ...
    function mn(t, n, e) {
      ...
      A(t, { name: n = h(n), fromWireType: function(o) {
        ...
        return u;
      }, argPackAdvance: 8, readValueFromPointer: hn(n, r), destructorFunction: null });
    }
    function gn(t, n, e, r, o, u) {
      var c = n.length;
      ...
      return function() {
        ...
        function it(Z) {
          if (s) bt(_);
            ...
            var ue = x === 1 ? P : C[x - 2];
            n[x].destructorFunction !== null && n[x].destructorFunction(ue);
          }
          if (l) return n[0].fromWireType(Z);
        }
        return it(r.apply(null, y));
      };
    }
    function yn(t, n, e) {
    ...
    function _n(t, n, e) {
      i.hasOwnProperty(t) ? ((e === void 0 || i[t].overloadTable !== void 0 && i[t].overloadTable[e] !== void 0) && m("Cannot register public name '" + t + "' twice"), yn(i, t, t), i.hasOwnProperty(e) && m("Cannot register multiple overloads of a function with the same number of arguments (" + e + ")!"), i[t].overloadTable[e] = n) : (i[t] = n, e !== void 0 && (i[t].numArguments = e));
    }
    function wn(t, n) {
    ...
    function bn(t, n, e) {
      i.hasOwnProperty(t) || Tt("Replacing nonexistant public symbol"), i[t].overloadTable !== void 0 && e !== void 0 ? i[t].overloadTable[e] = n : (i[t] = n, i[t].argCount = e);
    }
    function An(t, n, e) {
      var r = i["dynCall_" + t];
    ...
    function Tn(t, n, e) {
      return t.includes("j") ? An(t, n, e) : tt(n).apply(null, e);
    }
    function Cn(t, n) {
      var e = [];
      return function() {
        return e.length = 0, Object.assign(e, arguments), Tn(t, n, e);
      };
    }
    function z(t, n) {
      function e() {
        return t.includes("j") ? Cn(t, n) : tt(n);
      }
      t = h(t);
      var r = e();
    ...
    function Pn(t, n) {
      ...
      throw n.forEach(o), new kt(t + ": " + e.map(jt).join([", "]));
    }
    function En(t, n, e, r, o, u, c) {
      var a = wn(n, e);
      t = h(t), o = z(r, o), _n(t, function() {
        Pn("Cannot call " + t + " due to unbound types", a);
      }, n - 1), Ct([], a, function(s) {
        var f = [s[0], null].concat(s.slice(1));
        return bn(t, gn(t, f, null, o, u), n - 1), [];
      });
    }
    function Wn(t, n, e) {
      switch (n) {
    ...
    function kn(t, n, e, r, o) {
      ...
      }, argPackAdvance: 8, readValueFromPointer: Wn(n, u, r !== 0), destructorFunction: null });
    }
    function jn(t, n, e) {
    ...
    function Rt(t, n, e) {
      ...
      if (o - n > 16 && t.buffer && Ft) return Ft.decode(t.subarray(n, o));
      for (var u = ""; n < o; ) {
        var c = t[n++];
        if (128 & c) {
          var a = 63 & t[n++];
    ...
    function Un(t, n) {
      ...
      A(t, { name: n, fromWireType: function(r) {
        ...
        c || o instanceof Uint8Array || o instanceof Uint8ClampedArray || o instanceof Int8Array || m("Cannot pass non-string to std::string"), u = e && c ? Sn(o) : o.length;
        var a = rt(4 + u + 1), s = a + 4;
        if (p[a >> 2] = u, e && c) Rn(o, s, u + 1);
    ...
    function In(t, n) {
      ...
      if ((e = r << 1) - t > 32 && St) return St.decode(v.subarray(t, e));
    ...
    function Mn(t, n, e) {
      var r, o, u, c, a;
      e = h(e), n === 2 ? (r = In, o = On, c = zn, u = () => M, a = 1) : n === 4 && (r = Hn, o = Dn, c = Vn, u = () => p, a = 2), A(t, { name: e, fromWireType: function(s) {
        ...
        var l = c(f), d = rt(4 + l + n);
        return p[d >> 2] = l >> a, o(f, d + 4, l + n), s !== null && s.push(T, d), d;
      }, argPackAdvance: 8, readValueFromPointer: L, destructorFunction: function(s) {
        T(s);
      } });
    }
    function Bn(t, n, e, r, o, u) {
      N[t] = { name: h(n), rawConstructor: z(e, r), rawDestructor: z(o, u), fields: [] };
    }
    function qn(t, n, e, r, o, u, c, a, s, f) {
      N[t].fields.push({ fieldName: h(n), getterReturnType: e, getter: z(r, o), getterContext: u, setterArgumentType: c, setter: z(a, s), setterContext: f });
    }
    function Nn(t, n) {
    ...
    function Xn(t) {
      return G.toHandle(Gn(t));
    }
    function Zn(t, n) {
      var e = j[t];
      return e === void 0 && m(n + " has unknown type " + jt(t)), e;
    }
    function Jn(t, n) {
      var e = (t = Zn(t, "_emval_take_value")).readValueFromPointer(n);
      return G.toHandle(e);
    }
    function Kn() {
      B("");
    ...
    function te(t) {
      var n = V.buffer;
      try {
        return V.grow(t - n.byteLength + 65535 >>> 16), vt(), 1;
      } catch {
      }
    }
    function ne(t) {
      ...
      for (var o = 1; o <= 4; o *= 2) {
        var u = n * (1 + 0.2 / o);
        if (u = Math.min(u, t + 100663296), te(Math.min(e, r(Math.max(t, u), 65536)))) return !0;
      }
      return !1;
    }
    function ee(t) {
    ...
    function oe(t, n) {
      var e = ie[t];
      n === 0 || n === 10 ? ((t === 1 ? Vt : F)(Rt(e, 0)), e.length = 0) : e.push(n);
    }
    function ae(t, n, e, r) {
      for (var o = 0, u = 0; u < e; u++) {
        var c = p[n >> 2], a = p[n + 4 >> 2];
        n += 8;
        for (var s = 0; s < a; s++) oe(t, v[c + s]);
        o += a;
      }
      return p[r >> 2] = o, 0;
    }
    At = i.InternalError = nt(Error, "InternalError"), sn(), Et = i.BindingError = nt(Error, "BindingError"), pn(), kt = i.UnboundTypeError = nt(Error, "UnboundTypeError");
    var xt = { __call_sighandler: Yt, __cxa_throw: nn, _embind_finalize_value_object: un, _embind_register_bigint: cn, _embind_register_bool: fn, _embind_register_emval: vn, _embind_register_float: mn, _embind_register_function: En, _embind_register_integer: kn, _embind_register_memory_view: jn, _embind_register_std_string: Un, _embind_register_std_wstring: Mn, _embind_register_value_object: Bn, _embind_register_value_object_field: qn, _embind_register_void: Nn, _emval_decref: Wt, _emval_incref: Ln, _emval_new_cstring: Xn, _emval_take_value: Jn, abort: Kn, emscripten_memcpy_big: Qn, emscripten_resize_heap: ne, fd_close: ee, fd_seek: re, fd_write: ae };
    Qt();
    var rt = function() {
      return (rt = i.asm.malloc).apply(null, arguments);
    }, T = function() {
      return (T = i.asm.free).apply(null, arguments);
    }, Ut = function() {
      return (Ut = i.asm.__getTypeName).apply(null, arguments);
    };
    ...
    var X, It = function() {
      return (It = i.asm.__cxa_is_pointer_type).apply(null, arguments);
    };
    function Ot() {
      function t() {
        X || (X = !0, i.calledRun = !0, pt || (Bt(), ut(i), i.onRuntimeInitialized && i.onRuntimeInitialized(), qt()));
      }
      k > 0 || (Mt(), k > 0 || (i.setStatus ? (i.setStatus("Running..."), setTimeout(function() {
        setTimeout(function() {
          i.setStatus("");
        }, 1), t();
      }, 1)) : t()));
    ...
    return Ot(), K.ready;
  }, ot.exports = at), Ht.exports;
  var ot, J, at;
}
const fe = ce(se()), de = Object.freeze(Object.defineProperty({ __proto__: null, default: fe }, Symbol.toStringTag, { value: "Module" }));
export {
  de as i
};
//# sourceMappingURL=i3s-si68E5Cj.js.map
