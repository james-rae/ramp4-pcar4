import { bQ as r, bR as a, h0 as p, bS as l, cz as c, s as u, gO as m, bm as y, bU as d } from "./main-DZxT3i7S.js";
import { n as _, r as g } from "./FeatureLayerView2D-tU5MmL7l.js";
const f = (e) => {
...
let i = class extends f(g) {
  ...
  initialize() {
    this.addHandles([c(() => this.layer.customParameters, async (e) => {
    ...
    }), c(() => this.layer.purgeOptions, () => this._update()), c(() => this.suspended, this._onSuspendedChange.bind(this))], "constructor"), this._doResume();
  }
  destroy() {
    this._doPause();
  }
  get connectionError() {
    return this.pipelineErrorString ? new u("stream-controller", this.pipelineErrorString) : null;
  }
  on(e, t) {
    if (Array.isArray(e)) return m(e.map((n) => this.on(n, t)));
  ...
  async queryLatestObservations(e, t) {
    if (!(this.layer.timeInfo?.endField || this.layer.timeInfo?.startField || this.layer.timeInfo?.trackIdField)) throw new u("streamlayer-no-timeField", "queryLatestObservation can only be used with services that define a TrackIdField");
...
//# sourceMappingURL=StreamLayerView2D-CMXsrxaq.js.map
