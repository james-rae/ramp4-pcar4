var F = ["input:not([inert])", "select:not([inert])", "textarea:not([inert])", "a[href]:not([inert])", "button:not([inert])", "[tabindex]:not(slot):not([inert])", "audio[controls]:not([inert])", "video[controls]:not([inert])", '[contenteditable]:not([contenteditable="false"]):not([inert])', "details>summary:first-of-type:not([inert])", "details:not([inert])"], p = /* @__PURE__ */ F.join(","), O = typeof Element > "u", d = O ? function() {
} : Element.prototype.matches || Element.prototype.msMatchesSelector || Element.prototype.webkitMatchesSelector, m = !O && Element.prototype.getRootNode ? function(e) {
  var t;
  ...
  if (T(t))
    return [];
  var a = Array.prototype.slice.apply(t.querySelectorAll(p));
  return r && d.call(t, p) && a.unshift(t), a = a.filter(n), a;
}, L = function e(t, r, n) {
  for (var a = [], u = Array.from(t); u.length; ) {
    var i = u.shift();
    if (!T(i, !1))
      if (i.tagName === "SLOT") {
        var o = i.assignedElements(), s = o.length ? o : i.children, l = e(s, !0, n);
        ...
        typeof n.getShadowRoot == "function" && n.getShadowRoot(i), y = !T(c, !1) && (!n.shadowRootFilter || n.shadowRootFilter(i));
        if (c && y) {
  ...
  return t.tabIndex < 0 && (/^(AUDIO|VIDEO|DETAILS)$/.test(t.tagName) || $(t)) && !q(t) ? 0 : t.tabIndex;
}, W = function(t, r) {
  var n = B(t);
  return n < 0 && r && !q(t) ? 0 : n;
}, X = function(t, r) {
  ...
  var r, n = t && m(t), a = (r = n) === null || r === void 0 ? void 0 : r.host, u = !1;
  if (n && n !== t) {
    var i, o, s;
    for (u = !!((i = a) !== null && i !== void 0 && (o = i.ownerDocument) !== null && o !== void 0 && o.contains(a) || t != null && (s = t.ownerDocument) !== null && s !== void 0 && s.contains(t)); !u && a; ) {
      var l, f, c;
      n = m(a), a = (l = n) === null || l === void 0 ? void 0 : l.host, u = !!((f = a) !== null && f !== void 0 && (c = f.ownerDocument) !== null && c !== void 0 && c.contains(a));
    }
  }
  return u;
}, N = function(t) {
  ...
  T(r) || Z(r) || V(r, t) || // For a details element with a summary, the summary element gets the focus
  z(r) || _(r));
}, I = function(t, r) {
  return !(J(r) || B(r) < 0 || !w(t, r));
}, tt = function(t) {
  ...
  return t.forEach(function(a, u) {
    var i = !!a.scopeParent, o = i ? a.scopeParent : a, s = W(o, i), l = i ? e(a.candidates) : o;
    s === 0 ? i ? r.push.apply(r, l) : r.push(o) : n.push({
      documentOrder: u,
      tabIndex: s,
      item: a,
      isScope: i,
  ...
  }), n.sort(X).reduce(function(a, u) {
    return u.isScope ? a.push.apply(a, u.content) : a.push(u.content), a;
  }, []).concat(r);
}, rt = function(t, r) {
  r = r || {};
  var n;
  return r.getShadowRoot ? n = L([t], r.includeContainer, {
    filter: I.bind(null, r),
    flatten: !1,
    getShadowRoot: r.getShadowRoot,
    shadowRootFilter: tt
  }) : n = D(t, r.includeContainer, I.bind(null, r)), et(n);
}, Tt = function(t, r) {
  r = r || {};
  var n;
  return r.getShadowRoot ? n = L([t], r.includeContainer, {
    ...
    flatten: !0,
    getShadowRoot: r.getShadowRoot
  }) : n = D(t, r.includeContainer, w.bind(null, r)), n;
}, wt = function(t, r) {
  if (r = r || {}, !t)
    throw new Error("No node provided");
  return d.call(t, p) === !1 ? !1 : I(r, t);
}, nt = /* @__PURE__ */ F.concat("iframe").join(","), At = function(t, r) {
  if (r = r || {}, !t)
    throw new Error("No node provided");
  return d.call(t, nt) === !1 ? !1 : w(r, t);
};
const at = {
  getShadowRoot: !0
};
...
function it(e, { selector: t, id: r }) {
  ...
  return (r ? "getElementById" in n ? (
    /*
       ...
       */
    n.getElementById(r)
  ) : null : t ? n.querySelector(t) : null) || it(P(n), { selector: t, id: r });
}
function M(e, t) {
  return e ? e.closest(t) || M(P(x(e)), t) : null;
}
function ut(e, t) {
  return j(e, t);
}
...
async function st(e) {
  if (e)
    return ot(e) ? e.setFocus() : e.focus();
}
function lt(e) {
  if (e)
    return rt(e, at)[0] ?? e;
...
function Nt(e, t, r) {
  ...
  return r?.all ? ct(e, n, r) : ft(e, n, r);
}
function G(e, t) {
  return e ? Array.from(e.children || []).filter((r) => r?.matches(t)) : [];
}
function ct(e, t, r) {
  let n = t === g ? G(e, g) : Array.from(e.querySelectorAll(t));
...
function ft(e, t, r) {
  let n = t === g ? G(e, g)[0] || null : e.querySelector(t);
...
function vt(e) {
  return bt(e).filter((t) => t.nodeType === Node.TEXT_NODE).map((t) => t.textContent).join("").trim();
}
function ht(e) {
  return !!vt(e);
}
...
const qt = (e, t, r, n = !0) => {
  ...
  n && (r = r === "previous" && u ? "last" : r === "next" && i ? "first" : r);
  let o;
  return r === "previous" ? o = e[a - 1] || e[n ? e.length - 1 : a] : r === "next" ? o = e[a + 1] || e[n ? 0 : a] : r === "last" ? o = e[e.length - 1] : o = e[0], st(o), o;
};
function Bt(e, t) {
...
async function pt(e, t, r, n, a) {
  const u = window.getComputedStyle(e), i = u.transitionDuration, o = u.transitionProperty, s = i.split(","), f = o.split(",").map((S) => S.trim()).indexOf(t), c = s[f] ?? /* Safari will have a single duration value for the shorthand prop when multiple, separate names/props are defined,
  ...
  return new Promise((S) => {
    const U = window.setTimeout(() => {
      e.removeEventListener(v, C), e.removeEventListener(A, h), e.removeEventListener(E, h), y(), S();
    }, parseFloat(c) * 1e3);
    ...
    function h(b) {
      b.target === e && R(b) === t && (e.removeEventListener(A, h), e.removeEventListener(E, h), a?.(), S());
    }
  });
}
function mt(e) {
...
function R(e) {
  return mt(e) ? e.propertyName : e.animationName;
}
export {
  It as a,
  yt as b,
...
//# sourceMappingURL=dom-N58V0tYi.js.map
