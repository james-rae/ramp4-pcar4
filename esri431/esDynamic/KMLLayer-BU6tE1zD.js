import { ds as k, eu as $, cw as v, f6 as u, cz as h, hJ as f, aA as d, hc as L, a8 as b, bQ as s, bR as i, hK as F, eD as p, bS as g, fF as O, ex as _, ey as j, eB as M, ez as C, eA as I, eC as K, d6 as R, b1 as m, r as N, B as P, f9 as T, eG as z, eM as A } from "./main-DZxT3i7S.js";
import { j as J, S, g as w, d as x } from "./kmlUtils-BLLx81LN.js";
var y;
let a = y = class extends k.EventedMixin($(O)) {
  constructor(...e) {
  ...
  load(e) {
    ...
    const t = e != null ? e.signal : null, r = this._fetchService(this._get("networkLink")?.href ?? "", t).then((l) => {
      const n = J(l.sublayers);
      this.fullExtent = d.fromJSON(n), this.sourceJSON = l;
      const c = L(b.ofType(y), S(y, l));
...
s([i()], a.prototype, "description", void 0), s([i({ type: d })], a.prototype, "fullExtent", void 0), s([i()], a.prototype, "id", void 0), s([i({ readOnly: !0, value: null })], a.prototype, "networkLink", void 0), s([i({ json: { write: { allowNull: !0 } } })], a.prototype, "parent", void 0), s([i({ type: b.ofType(a), json: { write: { allowNull: !0 } } })], a.prototype, "sublayers", void 0), s([i({ value: null, json: { read: { source: "name", reader: (e) => F(e) } } })], a.prototype, "title", void 0), s([i({ value: !0 })], a.prototype, "visible", null), s([p("visible", ["visibility"])], a.prototype, "readVisible", null), s([i()], a.prototype, "sourceJSON", void 0), s([i()], a.prototype, "layer", void 0), a = y = s([g("esri.layers.support.KMLSublayer")], a);
const E = a, V = ["kml", "xml"];
let o = class extends _(j(M(C(I(K(A)))))) {
  constructor(...e) {
    super(...e), this._visibleFolders = [], this.allSublayers = new R({ getCollections: () => [this.sublayers], getChildrenFunction: (t) => t.sublayers }), this.outSpatialReference = m.WGS84, this.path = null, this.legendEnabled = !1, this.operationalLayerType = "KML", this.sublayers = null, this.type = "kml", this.url = null;
  }
  initialize() {
  ...
  get title() {
    ...
    return e && this.originOf("title") !== "defaults" ? e : this.url ? N(this.url, V) || "KML" : e;
  }
  set title(e) {
    this._set("title", e);
  }
  ...
  load(e) {
    ...
    return this.addResolvingPromise(this.loadFromPortal({ supportedTypes: ["KML"], supportsData: !1 }, e).catch(P).then(() => this._fetchService(t))), Promise.resolve(this);
  }
  destroy() {
...
//# sourceMappingURL=KMLLayer-BU6tE1zD.js.map
