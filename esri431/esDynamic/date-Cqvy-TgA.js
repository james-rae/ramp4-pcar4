...
function a(t) {
  const n = new Date(t);
  return b(n, t) ? Number.isNaN(n.getTime()) ? null : n.getTime() - 6e4 * n.getTimezoneOffset() : null;
}
function d(t) {
  const n = g.exec(t);
  ...
  const c = e.ms ?? "0", m = c ? +c.padEnd(3, "0").slice(0, 3) : 0;
  let o;
  if (e.isUTC || !e.offsetSign) o = Date.UTC(u, r, s, i, f, l, m);
  else {
    const N = +e.offsetHours, T = +e.offsetMinutes;
    o = 6e4 * (e.offsetSign === "+" ? -1 : 1) * (60 * N + T) + Date.UTC(u, r, s, i, f, l, m);
  }
...
//# sourceMappingURL=date-Cqvy-TgA.js.map
