import { c as g, J as p, U as b, K as N, M as A } from "./main-DZxT3i7S.js";
class m {
  constructor(r, s, t) {
    this.assetName = r, this.assetMimeType = s, this.parts = t;
  }
  equals(r) {
    return this === r || this.assetName === r.assetName && this.assetMimeType === r.assetMimeType && g(this.parts, r.parts, (s, t) => s.equals(t));
  }
  isOnService(r) {
  ...
  async toBlob(r) {
    ...
    const t = await Promise.all(s.map((a) => a.toBlob(r)));
...
class T {
  ...
  async toBlob(r) {
    const { data: s } = await b(this.partUrl, { responseType: "blob" });
    return p(r), s;
  }
}
function U(e) {
...
function H(e, r) {
  ...
  if (u(s) && u(t)) {
    ...
    const a = (n, o) => n.assetName < o.assetName ? -1 : n.assetName > o.assetName ? 1 : 0, i = [...s].sort(a), y = [...t].sort(a);
    for (let n = 0; n < i.length; ++n) if (!i[n].equals(y[n])) return !1;
    return !0;
  }
  return !1;
}
...
function q(e, r) {
  return e instanceof File ? N(e, r) : A(e.assetMimeType, e.assetName, r);
}
function O(e) {
...
//# sourceMappingURL=External-xJgS1C18.js.map
