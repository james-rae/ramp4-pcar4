import { dc as n, dg as z, dh as I, di as L, l0 as T, fk as y, de as F } from "./main-DZxT3i7S.js";
import { h as x, g as O, y as U, j as K, t as V } from "./dom-N58V0tYi.js";
import { s as W, c as j, i as C, d as R, H as q } from "./form-19t_hy5E.js";
import { u as _, I as $ } from "./interactive-B_Y0ed_t.js";
import { n as G } from "./key-CZySMiwx.js";
import { c as Y, d as Z, g as S } from "./label-Dys24PJn.js";
import { s as J, a as Q, c as X } from "./loadable-BekOWxtq.js";
import { n as d, i as p, p as ee, s as te, a as ie, c as ne, d as ae, B as se } from "./locale-B98iGxBG.js";
import { c as oe } from "./observers-lnyvGi5X.js";
import { u as re, c as le, d as ce, s as ue } from "./t9n-DqBq_VHu.js";
import { g as f } from "./component-CWGf1hug.js";
import { d as M } from "./icon-BnVuD4FT.js";
const de = {
...
const o = {
  ...
  constructor() {
    super(), this.__registerHost(), this.__attachShadow(), this.calciteInternalInputFocus = y(this, "calciteInternalInputFocus", 6), this.calciteInternalInputBlur = y(this, "calciteInternalInputBlur", 6), this.calciteInputInput = y(this, "calciteInputInput", 7), this.calciteInputChange = y(this, "calciteInputChange", 6), this.childElType = "input", this.previousValueOrigin = "initial", this.mutationObserver = oe("mutation", () => this.setDisabledAction()), this.userChangedValue = !1, this.keyDownHandler = (e) => {
      ...
      if (this.setPreviousValue(s ?? this.value), this.previousValueOrigin = i, this.type === "number") {
        ...
        const l = this.previousValue?.length > a.length || this.value?.length > a.length, u = a.charAt(a.length - 1) === ".", m = u && l ? a : te(a), c = a && !m ? p(this.previousValue) ? this.previousValue : "" : m;
        let h = d.localize(c);
        i !== "connected" && !u && (h = ie(h, c, d)), this.displayedValue = u && l ? `${h}${d.decimal}` : h, this.userChangedValue = i === "user" && this.value !== c, this.value = ["-", "."].includes(c) ? "" : c;
      } else
  ...
  //--------------------------------------------------------------------------
  connectedCallback() {
    ne(this), le(this), this.inlineEditableEl = this.el.closest("calcite-inline-editable"), this.inlineEditableEl && (this.editingEnabled = this.inlineEditableEl.editingEnabled || !1), Y(this), j(this), this.mutationObserver?.observe(this.el, { childList: !0 }), this.setDisabledAction(), this.el.addEventListener(C, this.onHiddenFormInputInput);
  }
  disconnectedCallback() {
    Z(this), R(this), ae(this), ce(this), this.mutationObserver?.disconnect(), this.el.removeEventListener(C, this.onHiddenFormInputInput);
  }
  async componentWillLoad() {
    J(this), this.childElType = this.type === "textarea" ? "textarea" : "input", this.maxString = this.max?.toString(), this.minString = this.min?.toString(), this.requestedIcon = x(D, this.icon, this.type), await ue(this), this.setPreviousEmittedValue(this.value), this.setPreviousValue(this.value), this.type === "number" && (this.value === "Infinity" || this.value === "-Infinity" ? (this.displayedValue = this.value, this.previousEmittedValue = this.value) : (this.warnAboutInvalidNumberValue(this.value), this.setValue({
      origin: "connected",
  ...
  async setFocus() {
    await X(this), this.type === "number" ? this.childNumberEl?.focus() : this.childEl?.focus();
  }
  ...
  incrementOrDecrementNumberValue(e, t, i, s) {
    ...
    if (a === "Infinity" || a === "-Infinity")
      return;
    const l = e === "up" ? 1 : -1, u = this.step === "any" ? 1 : Math.abs(this.step || 1), c = new se(a !== "" ? a : "0").add(`${u * l}`), h = () => typeof i == "number" && !isNaN(i) && c.subtract(`${i}`).isNegative, g = () => typeof t == "number" && !isNaN(t) && !c.subtract(`${t}`).isNegative, v = h() ? `${i}` : g() ? `${t}` : c.toString();
    this.setValue({
      committing: !0,
      nativeEvent: s,
      origin: "user",
...
//# sourceMappingURL=input2-BdcYSMjo.js.map
