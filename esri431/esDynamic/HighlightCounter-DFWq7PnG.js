...
class u {
  ...
  deleteGroup(n, e) {
    for (const o of n) {
      ...
      let s = t.get(e);
      if (s == null) return;
      s--, s > 0 ? t.set(e, s) : t.delete(e), t.size === 0 && this._idToCounters.delete(o);
    }
  }
  getHighlightGroups(n) {
    const e = this._idToCounters.get(n);
    if (!e) return r;
    const o = /* @__PURE__ */ new Set();
    for (const [t, s] of e) s > 0 && o.add(t);
    return o;
  }
  ids() {
...
//# sourceMappingURL=HighlightCounter-DFWq7PnG.js.map
