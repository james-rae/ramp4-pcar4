import { s as s$3, cU as U, G as n$2, nn as s$4, cS as p$1, cX as m$1, gJ as t$4, no as n$3, b7 as l, aI as C } from './main-jdFDoOPu.js';
import './Program-DyGm5N0S.js';
import { t as t$3 } from './VertexElementDescriptor-HfVzOf0q.js';
...
See https://js.arcgis.com/4.31/esri/copyright.txt for details.
*/
const u=()=>n$2.getLogger("esri.views.2d.engine.webgl.Utils");function c(t){switch(t){case U.UNSIGNED_BYTE:return 1;case U.UNSIGNED_SHORT_4_4_4_4:return 2;case U.FLOAT:return 4;default:return void u().error(new s$3("webgl-utils",`Unable to handle type ${t}`))}}function d(t){switch(t){case U.UNSIGNED_BYTE:return Uint8Array;case U.UNSIGNED_SHORT_4_4_4_4:return Uint16Array;case U.FLOAT:return Float32Array;default:return void u().error(new s$3("webgl-utils",`Unable to handle type ${t}`))}}function f(e){const t=new Map;for(const r in e){const n=e[r];let o=0;t.set(r,n.map((e=>{const t=new t$3(e.name,e.count,e.type,o,0,e.normalized||!1);return o+=e.count*s$4(e.type),t}))),t.get(r).forEach((e=>e.stride=o));}return t}const g=e=>{const t=new Map;for(const r in e)for(const n of e[r])t.set(n.name,n.location);return t},w=e=>{const t={};return e.forEach(((e,r)=>t[r]=e?.length?e[0].stride:0)),t},h=new Map,b$1=(e,t)=>{if(!h.has(e)){const r=f(t),n={strides:w(r),bufferLayouts:r,attributes:g(t)};h.set(e,n);}return h.get(e)},y$1=e=>e.includes("data:image/svg+xml");function A$1(e){const t=[];for(let r=0;r<e.length;r++)t.push(e.charCodeAt(r));return t}function T(e,t,r){const n=new p$1(t.width,t.height);return n.dataType=t.dataType,t.depth&&(n.depth=t.depth),t.flipped&&(n.flipped=t.flipped),t.hasMipmap&&(n.hasMipmap=t.hasMipmap),n.internalFormat=t.internalFormat,t.isImmutable&&(n.isImmutable=t.isImmutable),t.isOpaque&&(n.isOpaque=t.isOpaque),t.maxAnisotropy&&(n.maxAnisotropy=t.maxAnisotropy),n.pixelFormat=t.pixelFormat,t.preMultiplyAlpha&&(n.preMultiplyAlpha=t.preMultiplyAlpha),t.samplingMode&&(n.samplingMode=t.samplingMode),t.target&&(n.target=t.target),n.uniform=t.uniform,t.unpackAlignment&&(n.unpackAlignment=t.unpackAlignment),t.wrapMode&&(n.wrapMode=t.wrapMode),new m$1(e,n,r)}function j(e){return "url"in e&&"urlHash"in e?{...e,url:""}:e}

/*
All material copyright ESRI, All Rights Reserved, unless otherwise specified.
See https://js.arcgis.com/4.31/esri/copyright.txt for details.
*/
class i{constructor(i,e,s,r){this.transformedX=0,this.transformedY=0,this.center=t$4(i,e),this.centerT=n$3(),this.halfWidth=s/2,this.halfHeight=r/2,this.width=s,this.height=r;}get x(){return this.center[0]}get y(){return this.center[1]}get blX(){return this.center[0]+this.halfWidth}get blY(){return this.center[1]+this.halfHeight}get trX(){return this.center[0]-this.halfWidth}get trY(){return this.center[1]-this.halfHeight}get xmin(){return this.x-this.halfWidth}get xmax(){return this.x+this.halfWidth}get ymin(){return this.y-this.halfHeight}get ymax(){return this.y+this.halfHeight}set x(t){this.center[0]=t;}set y(t){this.center[1]=t;}clone(){return new i(this.x,this.y,this.width,this.height)}serialize(t){return t.writeF32(this.center[0]),t.writeF32(this.center[1]),t.push(this.width),t.push(this.height),t}findCollisionDelta(t,h=4){const i=Math.abs(t.centerT[0]-this.centerT[0]),e=Math.abs(t.centerT[1]-this.centerT[1]),s=(t.halfWidth+this.halfWidth+h)/i,r=(t.halfHeight+this.halfHeight+h)/e,n=Math.min(s,r);return Math.log2(n)}extend(t){const h=Math.min(this.xmin,t.xmin),i=Math.min(this.ymin,t.ymin),e=Math.max(this.xmax,t.xmax)-h,s=Math.max(this.ymax,t.ymax)-i,r=h+e/2,n=i+s/2;this.width=e,this.height=s,this.halfWidth=e/2,this.halfHeight=s/2,this.x=r,this.y=n;}static deserialize(t){const h=t.readF32(),e=t.readF32(),s=t.readInt32(),r=t.readInt32();return new i(h,e,s,r)}}

/*
All material copyright ESRI, All Rights Reserved, unless otherwise specified.
See https://js.arcgis.com/4.31/esri/copyright.txt for details.
*/
const n=new Float32Array(1),t$1=new Uint32Array(n.buffer);function a$1(r){return n[0]=r,t$1[0]}function s$1(n,t){return 65535&n|t<<16}function y(n){const t=a$1(n),r=t>>>31;let u=t>>>23&255,o=8388607&t;return u-=127,u>15?r<<15|31744:u<-25?0:(u<-14&&(o+=8388608,o/=2**(-14-u),u=-15),u+=15,o/=8192,o=A(o,1023),r<<15|u<<10|o)}function A(n,t){const r=Math.floor(n),u=n-r;return r<t&&(u>.5||.5===u&&r%2==1)?r+1:r}function b(n){let t=n>>>15,r=n>>10&31,u=1023&n;return t=t?-1:1,r-=15,u/=1024,r>-15?u+=1:r=-14,t*2**r*u}

/*
All material copyright ESRI, All Rights Reserved, unless otherwise specified.
See https://js.arcgis.com/4.31/esri/copyright.txt for details.
*/
function r$1(r){const t=r.map((({name:e,count:r,type:t})=>`${e}.${r}.${t}`)).join(",");return l(t)}function t(e,r,o,a,c,n,s){if(e.primitiveName===r){let r=a?.readWithDefault(c,n,e[o]&&s);return "text"===e.type&&(r=r.toString()),void(e[o]=r)}if("type"in e&&null!=e.type){if(e.effects)for(const i of e.effects)t(i,r,o,a,c,n,s);switch(e.type){case"CIMPointSymbol":case"CIMLineSymbol":case"CIMPolygonSymbol":if(e.symbolLayers)for(const i of e.symbolLayers)t(i,r,o,a,c,n,s);break;case"CIMTextSymbol":e.symbol&&t(e.symbol,r,o,a,c,n,s);break;case"CIMHatchFill":e.lineSymbol&&t(e.lineSymbol,r,o,a,c,n,s);break;case"CIMPictureMarker":case"CIMCharacterMarker":case"CIMVectorMarker":if(e.markerPlacement&&t(e.markerPlacement,r,o,a,c,n,s),"CIMVectorMarker"===e.type&&e.markerGraphics)for(const i of e.markerGraphics)t(i,r,o,a,c,n,s),t(i.symbol,r,o,a,c,n,s);}}}const o$1=400;function a(e){const r=e.width;return null!=e.effects?o$1:Math.max(1.25*r,8)}
...
See https://js.arcgis.com/4.31/esri/copyright.txt for details.
*/
class r{constructor(e,i,t,r,s,n,o,a,h=[]){this.entityTexel=e,this.anchorX=i,this.anchorY=t,this.directionX=r,this.directionY=s,this.maxScale=n,this.minScale=o,this.referenceBounds=a,this.bounds=h;}serialize(e$1){e$1.push(this.entityTexel),e$1.writeF32(this.anchorX),e$1.writeF32(this.anchorY),e$1.writeF32(this.directionX),e$1.writeF32(this.directionY),e$1.writeF32(this.maxScale),e$1.writeF32(this.minScale),null===this.referenceBounds?(e$1.writeF32(0),e$1.writeF32(0),e$1.writeF32(0)):(e$1.writeF32(this.referenceBounds.size),e$1.writeF32(this.referenceBounds.offsetX),e$1.writeF32(this.referenceBounds.offsetY)),e(e$1,this.bounds);}static deserialize(i$1){const s=i$1.readInt32(),n=i$1.readF32(),o=i$1.readF32(),a=i$1.readF32(),h=i$1.readF32(),d=i$1.readF32(),c=i$1.readF32(),F=i$1.readF32(),f=i$1.readF32(),l=i$1.readF32(),u=n$1(i$1,i)??[];return new r(s,n,o,a,h,d,c,{size:F,offsetX:f,offsetY:l},u)}}

export { A$1 as A, T, t$2 as a, b$1 as b, c, d, r$1 as e, s$1 as f, a as g, s as h, i, j, n$1 as n, o, r, s$2 as s, t, y$1 as y };
