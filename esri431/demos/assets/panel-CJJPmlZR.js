...
import { s as slotChangeHasAssignedElement, b as slotChangeGetAssignedElements, f as focusFirstTabbable, t as toAriaBoolean } from './dom-0izRVpjS.js';
import { u as updateHostInteraction, I as InteractiveContainer } from './interactive-d2sRBXlf.js';
...
import { d as defineCustomElement$2, a as defineCustomElement$5, S as SLOTS$1, H as Heading } from './action-menu-DTr-J8SD.js';
import { c as connectLocalized, d as disconnectLocalized } from './locale-DY1rIkqq.js';
import { c as connectMessages, s as setUpMessages, d as disconnectMessages, u as updateMessages } from './t9n-alBVlrK2.js';
import { d as defaultEndMenuPlacement } from './floating-ui-T-eXgWUi.js';
import { d as defineCustomElement$6 } from './action-BluWi0Sr.js';
import { d as defineCustomElement$4 } from './icon-qylkxRiE.js';
import { d as defineCustomElement$3 } from './loader-DODUm49S.js';
import { d as defineCustomElement$1 } from './scrim-raRPrzYZ.js';
...
const Panel = /*@__PURE__*/ proxyCustomElement(class Panel extends H {
    ...
    renderMenu() {
        ...
        return (h("calcite-action-menu", { flipPlacements: menuFlipPlacements ?? ["top", "bottom"], hidden: !hasMenuItems, key: "menu", label: messages.options, open: menuOpen, overlayPositioning: this.overlayPositioning, placement: menuPlacement }, h("calcite-action", { icon: ICONS.menu, scale: this.scale, slot: SLOTS$1.trigger, text: messages.options }), h("slot", { name: SLOTS.headerMenuActions, onSlotchange: this.handleHeaderMenuActionsSlotChange })));
    }
    renderHeaderNode() {
...
export { SLOTS as S, defineCustomElement as d };
