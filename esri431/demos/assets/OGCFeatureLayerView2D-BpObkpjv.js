import { bT as r, bU as m, bV as a$1 } from './main-jdFDoOPu.js';
...
*/
const o=o=>{let t=class extends o{get availableFields(){return this.layer.fieldsIndex.fields.map((e=>e.name))}};return r([m()],t.prototype,"layer",void 0),r([m({readOnly:!0})],t.prototype,"availableFields",null),t=r([a$1("esri.views.layers.OGCFeatureLayerView")],t),t};

/*
All material copyright ESRI, All Rights Reserved, unless otherwise specified.
See https://js.arcgis.com/4.31/esri/copyright.txt for details.
*/
let t=class extends(o(re)){supportsSpatialReference(r){return this.layer.serviceSupportsSpatialReference(r)}};t=r([a$1("esri.views.2d.layers.OGCFeatureLayerView2D")],t);const a=t;
