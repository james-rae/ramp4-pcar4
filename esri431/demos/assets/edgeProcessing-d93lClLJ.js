import { e as e$1 } from './deduplicate-BedirgWR.js';
import { H } from './InterleavedLayout-RshuL9Ca.js';
import { e } from './VertexAttribute-BxkhPj4z.js';
import { t as t$1 } from './glUtil-DOHFqFFb.js';
import { ap as n$1, d9 as l$1, ee as p$3, ed as o, e2 as s$2, al as P$1, eh as b$1, eg as K, am as _, d_ as c$1, ao as A$2, f_ as s$3, b6 as r$1, e1 as u$2, mm as t$2 } from './main-jdFDoOPu.js';
...
See https://js.arcgis.com/4.31/esri/copyright.txt for details.
*/
const d$2=-1;function p$2(e,t,o$1){const c=e.vertices.position,l=e.vertices.componentIndex,i=y$1.position0,h=y$1.position1,g=y$1.faceNormal0,u=y$1.faceNormal1,{edges:p,normals:v}=w$1(e),V=p.length/4,j=t.allocate(V);let I=0;const N=V,b=o$1?.allocate(N);let D=0,E=0,k=0;x.length=0;for(let s=0;s<V;++s){const e=4*s;c.getVec(p.data[e],i),c.getVec(p.data[e+1],h);const t=x.pushNew();t.index=4*s,t.length=p$3(i,h);}x.sort(((e,t)=>t.length-e.length));const P=new Array,U=new Array;x.forAll((({length:e,index:n})=>{const w=p.data[n],x=p.data[n+1],V=p.data[n+2],N=p.data[n+3],q=N===d$2;if(c.getVec(w,i),c.getVec(x,h),q){const e=3*V;o(g,v.data[e],v.data[e+1],v.data[e+2]),s$2(u,g),y$1.componentIndex=l.get(w),y$1.cosAngle=P$1(g,u);}else {let e=3*V;if(o(g,v.data[e],v.data[e+1],v.data[e+2]),e=3*N,o(u,v.data[e],v.data[e+1],v.data[e+2]),y$1.componentIndex=l.get(w),y$1.cosAngle=P$1(g,u),m$2(y$1,M))return;y$1.cosAngle<-.9999&&s$2(u,g);}E+=e,k++,q||f$2(y$1,L)?(t.write(j,I++,y$1),P.push(e)):A(y$1,F)&&(b&&o$1&&o$1.write(b,D++,y$1),U.push(e));}));const q=new Float32Array(P.reverse()),z=new Float32Array(U.reverse()),B=b&&o$1?{instancesData:b.slice(0,D),lodInfo:{lengths:z}}:void 0;return {regular:{instancesData:j.slice(0,I),lodInfo:{lengths:q}},silhouette:B,averageEdgeLength:E/k}}function f$2(e,t){return e.cosAngle<t}function m$2(e,t){return e.cosAngle>t}function A(t,o){const n=b$1(t.cosAngle);K(N$1,t.position1,t.position0);return n*(P$1(_(I,t.faceNormal0,t.faceNormal1),N$1)>0?-1:1)>o}function w$1(e){const t=e.faces.length/3,o=e.faces,n=e.neighbors,s=e.vertices.position;V.length=j.length=0;for(let a=0;a<t;a++){const e=3*a,t=n[e],r=n[e+1],c=n[e+2],g=o[e],u=o[e+1],p=o[e+2];s.getVec(g,b),s.getVec(u,D),s.getVec(p,E),c$1(D,D,b),c$1(E,E,b),_(b,D,E),A$2(b,b),j.pushArray(b),(t===d$2||g<u)&&(V.push(g),V.push(u),V.push(a),V.push(t)),(r===d$2||u<p)&&(V.push(u),V.push(p),V.push(a),V.push(r)),(c===d$2||p<g)&&(V.push(p),V.push(g),V.push(a),V.push(c));}return {edges:V,normals:j}}class v{constructor(){this.index=0,this.length=0;}}const x=new l$1({allocator:e=>e||new v,deallocator:null}),V=new l$1({deallocator:null}),j=new l$1({deallocator:null}),y$1=new s$1,I=n$1(),N$1=n$1(),b=n$1(),D=n$1(),E=n$1(),F=s$3(4),M=Math.cos(F),k=s$3(35),L=Math.cos(k);
