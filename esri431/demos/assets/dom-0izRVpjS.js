...
async function whenTransitionOrAnimationDone(targetEl, transitionPropOrAnimationName, type, onStart, onEnd) {
    ...
    const allDurations = style.transitionDuration ;
    const allProps = style.transitionProperty ;
    ...
    const startEvent = "transitionstart" ;
    const endEvent = "transitionend" ;
    const cancelEvent = "transitioncancel" ;
...
export { containsCrossShadowBoundary as a, slotChangeGetAssignedElements as b, closestElementCrossShadowBoundary as c, slotChangeHasContent as d, getShadowRootNode as e, focusFirstTabbable as f, getElementDir as g, setRequestedIcon as h, isBefore as i, getSlotted as j, getFirstTabbable as k, focusElement as l, focusElementInGroup as m, tabbableOptions as n, isFocusable as o, tabbable as p, queryElementRoots as q, focusable as r, slotChangeHasAssignedElement as s, toAriaBoolean as t, isTabbable as u, getTabIndex as v, whenTransitionDone as w, isKeyboardTriggeredClick as x, isPrimaryPointerButton as y };
