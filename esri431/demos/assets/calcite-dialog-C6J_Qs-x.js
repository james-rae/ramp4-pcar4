import { di as proxyCustomElement, dj as H, fn as createEvent, de as h, dk as Host } from './main-jdFDoOPu.js';
import { t as toAriaBoolean, f as focusFirstTabbable } from './dom-0izRVpjS.js';
import { d as defineCustomElement$3, a as defineCustomElement$7, c as connectFocusTrap, b as deactivateFocusTrap, u as updateFocusTrapElements, e as activateFocusTrap } from './action-menu-DTr-J8SD.js';
import { s as setUpLoadableComponent, a as setComponentLoaded, c as componentFocusable } from './loadable-DP3Fq8b7.js';
import { c as createObserver } from './observers-BNHNLD6_.js';
import { o as onToggleOpenCloseComponent } from './openCloseComponent-DmKhdbkG.js';
import { c as connectLocalized, d as disconnectLocalized } from './locale-DY1rIkqq.js';
import { s as setUpMessages, c as connectMessages, d as disconnectMessages, u as updateMessages } from './t9n-alBVlrK2.js';
import { c as componentOnReady } from './component-Dp1lfHT8.js';
import { d as defineCustomElement$4, S as SLOTS$1 } from './panel-CJJPmlZR.js';
import { d as defineCustomElement$8 } from './action-BluWi0Sr.js';
import { d as defineCustomElement$6 } from './icon-qylkxRiE.js';
import { d as defineCustomElement$5 } from './loader-DODUm49S.js';
import { d as defineCustomElement$2 } from './scrim-raRPrzYZ.js';
import './preload-helper-dJJaZANz.js';
import './guid-GY1vaRnF.js';
import './key-_Cl12XTf.js';
import './floating-ui-T-eXgWUi.js';
import './debounce-GuTLDsIU.js';
import './FloatingArrow-CZFMbMZD.js';
import './interactive-d2sRBXlf.js';
...
const CalciteDialogStyle0 = dialogCss;
...
const Dialog = /*@__PURE__*/ proxyCustomElement(class Dialog extends H {
    ...
    render() {
        ...
        return (h(Host, { key: 'bf406255eaa6d94c8443af185a74a2b2d58c6d59' }, h("div", { key: 'de2a34b6da4a82c66e9fafdbdd2056e4e11e1315', class: {
            ...
            } }, this.modal ? (h("calcite-scrim", { class: CSS.scrim, onClick: this.handleOutsideClose })) : null, h("div", { key: 'be47093e3a955ce45a71c555700143a4a1c7a166', "aria-description": description, "aria-label": heading, "aria-modal": toAriaBoolean(this.modal), class: CSS.dialog, onKeyDown: this.handleKeyDown, ref: this.setTransitionEl, role: "dialog" }, assistiveText ? (h("div", { "aria-live": "polite", class: CSS.assistiveText, key: "assistive-text" }, assistiveText)) : null, h("slot", { key: '6ed9f10ae7d5ecc1ec9062d6aba559001d5194e6', name: SLOTS.content }, h("calcite-panel", { key: 'cd6ebaa7d7362cbeb70e9ae623f38298d1e831e3', beforeClose: this.beforeClose, class: CSS.panel, closable: !this.closeDisabled, closed: !opened, description: description, heading: heading, headingLevel: this.headingLevel, loading: this.loading, menuOpen: this.menuOpen, messageOverrides: this.messageOverrides, onCalcitePanelClose: this.handleInternalPanelCloseClick, onCalcitePanelScroll: this.handleInternalPanelScroll, onKeyDown: this.handlePanelKeyDown, overlayPositioning: this.overlayPositioning, ref: (el) => (this.panelEl = el), scale: this.scale }, h("slot", { key: '2ce955775c33b09fc849a083d0bcc1c8ce523dd8', name: SLOTS.actionBar, slot: SLOTS$1.actionBar }), h("slot", { key: 'dd44184de251320af6225baa2e59571b881a23cd', name: SLOTS.alerts, slot: SLOTS$1.alerts }), h("slot", { key: 'da343a1a10e015b04b37463c10592e612a576e9b', name: SLOTS.headerActionsStart, slot: SLOTS$1.headerActionsStart }), h("slot", { key: '6680fde2bd7ad6dc5803c78ea7250d11d4920b7c', name: SLOTS.headerActionsEnd, slot: SLOTS$1.headerActionsEnd }), h("slot", { key: 'a17ca64188ffe6000792e67eafc838df575ebbc3', name: SLOTS.headerContent, slot: SLOTS$1.headerContent }), h("slot", { key: '7e048c4a9104053ca0a61ab2514b018efb4fc872', name: SLOTS.headerMenuActions, slot: SLOTS$1.headerMenuActions }), h("slot", { key: '6760c8a6c105a511fcb859cfd222f8c1355a82c4', name: SLOTS.fab, slot: SLOTS$1.fab }), h("slot", { key: 'e0f2e7644281d408d8c21ce5bf16b08af0a59c3b', name: SLOTS.contentTop, slot: SLOTS$1.contentTop }), h("slot", { key: '01889c3b7fc13bc49521c27feb2ab35346552504', name: SLOTS.contentBottom, slot: SLOTS$1.contentBottom }), h("slot", { key: '593bad35110b5d7e7b44d598b397e4b87cc28e28', name: SLOTS.footerStart, slot: SLOTS$1.footerStart }), h("slot", { key: '5e84099e096a6afb678cce9731b189f4011dc067', name: SLOTS.footer, slot: SLOTS$1.footer }), h("slot", { key: '69a805bd0c1f43a6d165939e62db562428f39f11', name: SLOTS.footerEnd, slot: SLOTS$1.footerEnd }), h("slot", { key: 'b49e14ff6d2c63caaa8fd296920618e7673eb71b' })))))));
    }
...
function defineCustomElement$1() {
    ...
    const components = ["calcite-dialog", "calcite-action", "calcite-action-menu", "calcite-icon", "calcite-loader", "calcite-panel", "calcite-popover", "calcite-scrim"];
...
const CalciteDialog = Dialog;
const defineCustomElement = defineCustomElement$1;

export { CalciteDialog, defineCustomElement };
