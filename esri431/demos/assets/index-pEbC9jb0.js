const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./p2-screen-1-CkRLN1hy.js","./main-jdFDoOPu.js","./preload-helper-dJJaZANz.js","./main-CRG1_KF0.css"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from './preload-helper-dJJaZANz.js';
import { bv as defineComponent, bx as inject, bC as resolveComponent, bE as createBlock, bF as withCtx, bG as openBlock, g8 as createBaseVNode, kz as normalizeStyle, bH as createTextVNode, bw as useI18n, bI as toDisplayString, bJ as unref, bq as FixtureInstance, i1 as markRaw } from './main-jdFDoOPu.js';
        ...
        config: {
          screens: {
            ...
            "p-2-screen-1": () => {
              return new Promise(
                (resolve) => setTimeout(
                  () => __vitePreload(() => import('./p2-screen-1-CkRLN1hy.js'),true?__vite__mapDeps([0,1,2,3]):void 0,import.meta.url).then((data) => {
                    resolve(data);
                  }),
                  2e3
                )
