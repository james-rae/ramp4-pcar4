const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./screen-D0uz_t7S.js","./main-jdFDoOPu.js","./preload-helper-dJJaZANz.js","./main-CRG1_KF0.css","./table-state-manager-BxhJ2X4c.js","./screen-BSf4PA1q.css"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from './preload-helper-dJJaZANz.js';
import { bq as FixtureInstance, i4 as useGridStore, i1 as markRaw, i2 as useAppbarStore } from './main-jdFDoOPu.js';
    ...
    this.$iApi.panel.register(
      {
        grid: {
          screens: {
            "grid-screen": () => markRaw(__vitePreload(() => import('./screen-D0uz_t7S.js'),true?__vite__mapDeps([0,1,2,3,4,5]):void 0,import.meta.url))
          },
          style: {
            width: "450px"
          },
