import { di as proxyCustomElement, dj as H, fn as createEvent, df as isBrowser, de as h, dk as Host } from './main-jdFDoOPu.js';
...
import { i as isActivationKey } from './key-_Cl12XTf.js';
import { g as getIconScale } from './component-Dp1lfHT8.js';
import { d as defineCustomElement$2 } from './icon-qylkxRiE.js';
...
const Chip = /*@__PURE__*/ proxyCustomElement(class Chip extends H {
    ...
    renderCloseButton() {
        return (h("button", { "aria-label": this.messages.dismissLabel, class: CSS.close, onClick: this.close, onKeyDown: this.closeButtonKeyDownHandler, ref: (el) => (this.closeButtonEl = el), tabIndex: this.disabled ? -1 : 0 }, h("calcite-icon", { icon: ICONS.close, scale: getIconScale(this.scale) })));
    }
    renderIcon() {
