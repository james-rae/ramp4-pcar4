...
import { watch as _e } from "@arcgis/core/core/reactiveUtils.js";
...
class J extends Ze {
  ...
  rawArray;
  constructor(e, t, i, s) {
    super(e, t.sr || i), s ? this.rawArray = t.slice() : this.rawArray = J.parseXY(t);
  }
  ...
  static fromESRI(e, t) {
    return new J(t, [e.x, e.y], I.fromESRI(e.spatialReference), !0);
  }
  toESRI() {
    return new ms({
      x: this.x,
  ...
  static fromGeoJSON(e, t) {
    return new J(t, e.coordinates, I.fromGeoJSON(e.crs), !0);
  }
  toGeoJSON() {
...
class G extends Ze {
  ...
  rawMax;
  constructor(e, t, i, s) {
    super(e, t.sr || s), this.rawMin = J.parseXY(t), this.rawMax = J.parseXY(i);
  }
...
}), br = /* @__PURE__ */ Ne(vr, [["__scopeId", "data-v-3623a7d2"]]), Ar = { class: "flex hover:text-white" }, wr = ["aria-label"], Er = { class: "about-ramp-dropdown pointer-events-auto bg-white rounded w-256 h-50" }, xr = ["aria-label", "content"], Sr = { class: "pb-8 border-b border-gray-600 mb-10" }, _r = { class: "absolute right-5 top-5" }, Ir = { class: "select-text" }, Tr = { class: "font-bold cursor-text" }, Lr = { class: "text-sm cursor-text" }, Rr = { class: "text-sm cursor-text" }, $r = /* @__PURE__ */ O({
...
const bo = "truncate-text", Ao = "truncate-trigger", wo = {
  ...
  mounted(r, e) {
    let t;
    e.value && e.value.externalTrigger && (t = r.closest(`[${Ao}]`)), Is(r, {
...
const xo = ["content"], So = {
    ...
    return Je(() => {
      ...
      return P((g(), w("div", {
        ...
        r.header ? (g(), w("header", So, [
          ...
          P((g(), w("h2", _o, [
            b.$slots.header ? Me(b.$slots, "header", { key: 0 }) : (g(), w("div", Io, B(S(t)(r.panel.alertName)), 1))
          ])), [
            [_]
          ]),
  ...
  setup(r) {
    ...
    const s = async () => {
      ...
      const n = new J("geolocation", l, I.latLongSR(), !0);
...
class Ga {
  ...
  constructor(e, t, i) {
    ...
    const s = Ua(e, this);
    this.$vApp = s.app, this.$element = s.element, this.$i18n = s.i18n, this.$rootEl = s.app.$root?.$el, this.fixture = new Pn(this), this.panel = new Nn(this), this.geo = new kn(this), this.ui = {
   ...
   */
  reload(e, t) {
    const i = st(this.$vApp.$pinia), s = Le(this.$vApp.$pinia), o = de(this.$vApp.$pinia), a = ge(this.$vApp.$pinia), l = Ie(this.$vApp.$pinia), n = Wt(this.$vApp.$pinia), c = !!e;
...
class ja extends Ba {
  ...
  async createMapView(e) {
    ...
    this.esriView = se(
      ...
      n.preventDefault();
    }) : console.error("ESRI Map View is missing its container"), _e(
  ...
  screenPointToMapPoint(e) {
    return this.esriView ? J.fromESRI(
      this.esriView.toMap({
        x: e.screenX,
        y: e.screenY
      }),
      "mappoint"
    ) : (this.noMapErr(), new J("i_am_error", [0, 0], void 0, !0));
  }
  /**
...
class Qe extends ri {
  ...
  extractLayerMetadata() {
    ...
    this.attribs.attLoader = new In(this.$iApi, i);
  }
  async getGraphic(e, t) {
    let i;
...
class kn extends Z {
   ...
   */
  constructor(e) {
    super(e), this.geom = ut.geom, this.proj = ut.proj, this.shared = ut.sharedUtils, this.map = new ja(e), this.layer = new on(e), this.attributes = new _n(e), this.query = new On(e), this.symbology = new Cn(e), Array.isArray(ft.request.interceptors) || (ft.request.interceptors = []), ft.request.interceptors.push({
      before: (t) => {
...
const Mn = /* @__PURE__ */ Object.assign({ "../fixtures/appbar/index.ts": () => import("./index-DzsT-hy6.js"), "../fixtures/areas-of-interest/index.ts": () => import("./index-D4O7yzs6.js"), "../fixtures/basemap/index.ts": () => import("./index-BG-ypzPY.js"), "../fixtures/crosshairs/index.ts": () => import("./index-CzDk1JiM.js"), "../fixtures/details/index.ts": () => import("./index-CsI4s0eI.js"), "../fixtures/export-footnote/index.ts": () => import("./index-Dy670ycr.js"), "../fixtures/export-legend/index.ts": () => import("./index-713n7FbZ.js"), "../fixtures/export-map/index.ts": () => import("./index-BHYK2M0U.js"), "../fixtures/export-northarrow/index.ts": () => import("./index-nHcSVX1P.js"), "../fixtures/export-scalebar/index.ts": () => import("./index-U4GgmN8z.js"), "../fixtures/export-timestamp/index.ts": () => import("./index-Bbp5KfTV.js"), "../fixtures/export-title/index.ts": () => import("./index-C56tcK3K.js"), "../fixtures/export/index.ts": () => import("./index-BRhMgRZT.js"), "../fixtures/extentguard/index.ts": () => import("./index-MuEmbQXA.js"), "../fixtures/gazebo/index.ts": () => import("./index-DTZQcZtA.js"), "../fixtures/geosearch/index.ts": () => import("./index-CDG1RRvv.js"), "../fixtures/grid/index.ts": () => import("./index-7gYh-DR7.js"), "../fixtures/help/index.ts": () => import("./index-9FtJWE96.js"), "../fixtures/hilight/index.ts": () => import("./index-CTQwalf8.js"), "../fixtures/layer-reorder/index.ts": () => import("./index--azp4Fdv.js"), "../fixtures/legend/index.ts": () => import("./index-DQwGCoeZ.js"), "../fixtures/mapnav/index.ts": () => import("./index-CVR5L2Pf.js"), "../fixtures/metadata/index.ts": () => import("./index-AX5XuVic.js"), "../fixtures/northarrow/index.ts": () => import("./index-C1r4WB9a.js"), "../fixtures/overviewmap/index.ts": () => import("./index-BIaiab1C.js"), "../fixtures/panguard/index.ts": () => import("./index-CiPzlXPc.js"), "../fixtures/scrollguard/index.ts": () => import("./index-o6MUS3mK.js"), "../fixtures/settings/index.ts": () => import("./index-DEcuJ7ht.js"), "../fixtures/snowman/index.ts": () => import("./index-ClfMG3wa.js"), "../fixtures/wizard/index.ts": () => import("./index-C3a4o0Ct.js") });
class Pn extends Z {
  /**
...
const Un = /* @__PURE__ */ Ne(Dn, [["render", Gn], ["__scopeId", "data-v-a3c61802"]]), Bn = /* @__PURE__ */ Object.assign({ "../fixtures/areas-of-interest/screen.vue": () => import("./screen-RSj07pK1.js"), "../fixtures/basemap/screen.vue": () => import("./screen-CjdajmZ2.js"), "../fixtures/export/screen.vue": () => import("./screen-C4deykOl.js"), "../fixtures/geosearch/screen.vue": () => import("./screen-8C2Owu4o.js"), "../fixtures/grid/screen.vue": () => import("./screen-BZTs1XkP.js"), "../fixtures/help/screen.vue": () => import("./screen-ByyrCBVr.js"), "../fixtures/layer-reorder/screen.vue": () => import("./screen-DspEkT_b.js"), "../fixtures/legend/screen.vue": () => import("./screen-Df01ke0K.js"), "../fixtures/metadata/screen.vue": () => import("./screen-jEYndd4i.js"), "../fixtures/settings/screen.vue": () => import("./screen-CkjkKJPP.js"), "../fixtures/wizard/screen.vue": () => import("./screen-6EhW2MOH.js") });
class Et extends Z {
  /**
   * ID of this panel.
   *
...
function Vn(r) {
  ...
  return qn(r.services, e), jn(r.map, e), Wn(r.ui, e), r.plugins && Hn(r.plugins, e), e;
}
function jn(r, e) {
...
function jt(r) {
  ...
  )), typeof r.stateOnly < "u" && (e.cosmetic = r.stateOnly), r.initialFilteredQuery && (e.initialFilteredQuery = r.initialFilteredQuery), Yn(r, e), (typeof r.toggleSymbology < "u" || r.table) && (e.fixtures = {}, typeof r.toggleSymbology < "u" && (e.fixtures.legend = {
...
var rt = { major: "4", minor: "12", patch: "0-beta", timestamp: "Thu Apr 10 14:35:21 2025 -0400", hash: "ac7b629f9797a75c0e5ec5a093049b922dc7dad8" };
console.info(
...
const Ml = (r, e, t) => new Ga(r, e, t), ut = new Ns();
export {
  q as $,
  Cr as A,
  yt as B,
