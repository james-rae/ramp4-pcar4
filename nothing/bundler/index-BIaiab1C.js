import "tiny-emitter";
import { x as I, L as O, y as d, z as P, v as R, B as z, l as G, D as F, F as T, G as l, _ as k } from "./main-REWae4Oc.js";
...
import { markRaw as E, defineComponent as D, inject as W, ref as f, computed as v, reactive as x, onMounted as j, onBeforeUnmount as q, resolveDirective as U, openBlock as y, createElementBlock as g, createElementVNode as c, normalizeStyle as S, normalizeClass as X, withDirectives as Y, unref as L } from "vue";
import "pinia";
...
const Q = { class: "relative h-full w-full overflow-hidden" }, ee = { class: "absolute h-30 w-30 top-0 right-0" }, te = ["content", "aria-label"], ie = /* @__PURE__ */ D({
  __name: "overviewmap",
  setup(u) {
    const e = d(), { t: i } = Z(), a = W("iApi"), t = G(), o = f(), n = v(() => t.activeBasemapConfig), _ = v(() => e.mapConfig), b = v(() => e.basemaps), A = v(() => e.startMinimized), r = x(new J(a)), p = f(!0), M = f(!1), m = x([]);
    j(async () => {
