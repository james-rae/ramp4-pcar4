...
export class LayerInstance extends APIScope {
    ...
    */
    ...
    // TODO[Layer-Refactor]: code that use layerIndex tries to access it on the LayerInstance class. It's cleaner if we put this here since it avoids cast
    layerIdx: number;
    supportsIdentify: boolean;
    supportsFeatures: boolean;
    supportsSublayers: boolean;
    isSublayer: boolean;
    isRemoved: boolean; // used to mark sublayers for removal // TODO[Layer-Refactor]: is this efficient?
    isFile: boolean;
