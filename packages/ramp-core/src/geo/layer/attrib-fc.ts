...
export class AttribFC extends CommonFC {
     ...
     */
    processFieldMetadata(configMetadata: RampLayerFieldMetadataConfig | undefined = undefined): void {
        ...
        if (!configMetadata.fieldInfo) {
            throw new Error('processFieldMetadata called before fieldInfo was set on config metadata');
        }
