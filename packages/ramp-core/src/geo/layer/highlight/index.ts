...
import { CommonFC, CommonLayer, LayerType, Point, RampLayerConfig, TreeNode } from '@/api/internal';
 ...
 */
 export default class HighlightLayer extends CommonLayer {
    ...
    addMarker (point: Point, clearLayer: boolean = false): void {
        ...
        const marker = new EsriGraphic({ geometry: esriPoint, symbol: this.markerSymbol });
