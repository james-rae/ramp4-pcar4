...
import { EsriExtent, EsriMultipoint, EsriPoint, EsriPolygon, EsriPolyline, EsriRequest, EsriSpatialReference } from '../esri';
 ...
 { InfoBundle, QueryFeaturesArcServerParams, QueryFeaturesGeoJsonParams, GetGraphicResult } from '../gapiTypes';

imprt BaseGeometry from '../api/geometry/BaseGeometry';
 Extent from '../api/geometry/Extent';
 Point from '../api/geometry/Point';
 RampMap from '../map/RampMap';
 SpatialReference from '../api/geometry/SpatialReference';
 { GeometryType } from '../api/apiDefs';
