    ...
    <div class="absolute duration-150" :style="crosshairsStyle">
        <svg xmlns="http://www.w3.org/2000/svg" fit="" height="100%" width="100%" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24" focusable="false">
            <g fill="#545353" stroke="#fff" id="crosshairs">
                ...
                <path d="M.045 12.047l6.093.051 4.264.068v-.332l-4.264.067-6.093.064v.039z" id="rect4632-6" stroke-width=".09"></path>
                <path d="M12.047 23.955l.051-6.093.068-4.264h-.332l.067 4.264.064 6.093h.039z" id="rect4632-6-0" stroke-width=".09"></path>
                <path d="M23.955 11.953l-6.093-.051-4.264-.068v.332l4.264-.067 6.093-.064v-.039z" id="rect4632-6-4" stroke-width=".09"></path>
                <path d="M11.953.045l-.051 6.093-.068 4.264h.332l-.067-4.264-.064-6.093h-.039z" id="rect4632-6-9" stroke-width=".09"></path>
            </g>
        </svg>
    </div>
</template>
