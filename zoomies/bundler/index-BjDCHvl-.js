...
import { _ as H, d as L, F as X, G as ee } from "./main-B112iR_H.js";
...
const G = /* @__PURE__ */ H(ne, [["render", ae]]), se = /* @__PURE__ */ T({
  ...
  setup(h) {
    ...
    const p = [
      {
        type: "point",
        icon: g(_(() => import("./point-icon-hCPLlJIr.js")))
      },
      {
        type: "polyline",
        icon: g(_(() => import("./polyline-icon-BYc3Ru9K.js")))
      },
      {
        type: "polygon",
        icon: g(_(() => import("./polygon-icon-DeO5xO7D.js")))
      },
      {
        type: "circle",
        icon: g(_(() => import("./circle-icon-yrzDQODu.js")))
      },
      {
        type: "rectangle",
        icon: g(_(() => import("./rectangle-icon-CuMKNP8d.js")))
      }
    ], a = A(() => {
      const s = p.filter((u) => e.supportedTypes.some((x) => x.type === u.type));
      return s.push({
        type: "edit",
        icon: g(_(() => import("./edit-icon-CZKWxnRO.js")))
      }), s;
    }), n = (s) => {
