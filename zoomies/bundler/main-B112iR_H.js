...
import { ref as f, computed as G, markRaw as ne, defineComponent as D, inject as Ie, reactive as Re, watch as Ot, onBeforeUnmount as vt, resolveDirective as U, withDirectives as V, createElementBlock as A, openBlock as b, withKeys as ms, withModifiers as ei, onMounted as st, normalizeStyle as Pi, normalizeClass as ce, createVNode as fe, Transition as Ni, withCtx as ue, createBlock as ee, resolveDynamicComponent as ys, mergeProps as gs, useCssVars as vs, TransitionGroup as Fi, Fragment as tt, renderList as bt, unref as I, nextTick as It, renderSlot as Ve, createElementVNode as g, vShow as bs, resolveComponent as ae, createTextVNode as ht, toDisplayString as z, createCommentVNode as B, onUpdated as ws, Teleport as As, getCurrentInstance as Es, useTemplateRef as yi, createApp as Di, toRaw as ke, h as xs, render as Bt, defineAsyncComponent as Ss } from "vue";
import kt from "@arcgis/core/Color";
import wt from "@arcgis/core/config";
...
class Ge extends rt {
  ...
  static parseMultiPolygon(e) {
    ...
    if (e instanceof he)
      return [e.toArray()];
    if (e instanceof Te || e instanceof we)
...
class Z extends rt {
  ...
  static fromArcServer(e, t) {
    return Z.fromESRI(gi.fromJSON(e), t);
  }
...
class Hs {
  ...
  async projectExtent(e, t) {
    const i = (y, w, v) => {
      if (v === 0)
        return [y, w];
      const C = [(y[0] + w[0]) / 2, (y[1] + w[1]) / 2];
      if (v === 1)
        return [y, C, w];
      if (v > 1) {
        const q = i(y, C, v - 1), L = i(C, w, v - 1);
...
const Dt = W("maptip", () => {
  ...
  __name: "esri-map",
  setup(r) {
    const e = Dt(), t = Ie("iApi"), i = G(() => e.maptipPoint), s = G(() => e.maptipInstance), a = G(() => e.content), o = Re([]), l = f(!1);
    o.push(
      Ot(i, () => {
        if (i.value) {
...
const rr = ["data-cy"], Ki = /* @__PURE__ */ D({
    ...
    return (n, c) => {
      ...
      return b(), A("div", {
        ...
        fe(Ni, {
          ...
          default: ue(() => [
            V((b(), ee(ys(r.panel.route.screen), gs({ class: "h-full" }, r.panel.route.props, { panel: r.panel }), null, 16, ["panel"])), [
              [u]
            ])
          ]),
          _: 1
  ...
  function O() {
    let E = t.value;
    const R = [], X = 350, Ae = 12, je = 600;
    for (let _e = n.value.length - 1; _e >= 0; _e--) {
      const nt = n.value[_e];
      let Ne = nt.width || X;
      if (s.value ? Ne = E : Ne += Ae, nt.id === "grid" && (Ne = Math.max(Math.min(Ne, E), je)), (E >= Ne && !s.value || R.length === 0) && (E -= Ne, R.unshift(nt)), nt.id === "grid" && E < je)
        break;
    }
    if (r.value && //@ts-expect-error TODO: explain why this is needed or remove
    !R.includes(r.value) && !s.value) {
      let _e;
      for (let mi = 0; mi < R.length - 1 && E < (r.value.width || X) + Ae; mi++)
        _e = R.shift(), E += _e.width || X;
      E >= (r.value.width || X) ? R.unshift(r.value) : e.value || (_e = R.shift(), R.unshift(r.value));
      const nt = n.value.indexOf(r.value), Ne = n.value.indexOf(_e), zt = n.value.slice();
  ...
  function F(E, R) {
    const X = n.value.indexOf(E), Ae = R === "right" ? 1 : -1;
    u.value.includes(n.value[X + Ae]) && ([n.value[X], n.value[X + Ae]] = [
      n.value[X + Ae],
      n.value[X]
    ]);
  }
  ...
  setup(r) {
    ...
    return (u, p) => (b(), ee(Fi, {
      ...
      default: ue(() => [
        (b(!0), A(tt, null, bt(o(I(t).screenSize), (d) => (b(), ee(Ki, {
          key: `${d.id}`,
          panel: d
        }, null, 8, ["panel"]))), 128))
      ]),
  ...
  for (const [i, s] of e)
    t[i] = s;
  return t;
}, or = /* @__PURE__ */ qe(ar, [["__scopeId", "data-v-717e4bd7"]]), nr = ["content", "aria-label"], si = /* @__PURE__ */ D({
...
}), lr = { class: "h-full flex flex-col" }, cr = { class: "w-full flex mb-6" }, ur = ["content", "aria-label"], pr = /* @__PURE__ */ D({
  __name: "screen",
  props: {
    panel: {
      type: Object,
...
const hr = ["content"], fr = { class: "flex items-center text-left" }, mr = { class: "select-text cursor-text" }, yr = ["content", "aria-label"], gr = {
      ...
      return V((b(), A("li", {
        ...
        g("div", fr, [
          g("span", null, [
            ...
            g("span", mr, z(r.notification.message), 1)
          ]),
          c[4] || (c[4] = g("span", { class: "flex-grow" }, null, -1)),
          r.notification.messageList ? (b(), A("div", {
            key: 0,
        ...
        r.notification.messageList && a.value ? (b(), A("div", gr, [
          (b(!0), A(tt, null, bt(r.notification.messageList, (p, d) => (b(), A("p", {
    ...
    return (c, u) => {
      ...
      return b(), A("div", null, [
        n.value.length > 0 ? V((b(), A("ul", {
          ...
          (b(!0), A(tt, null, bt(n.value, (h, y) => (b(), A(tt, {
            key: h.id
          }, [
            y > 0 ? (b(), A("div", wr)) : B("", !0),
            V(fe(vr, {
              ref_for: !0,
              ref: (w) => w ? s.value[h.id] = w : delete s.value[h.id],
              class: ce([h.type]),
              notification: h,
              onRemove: (w) => l(y)
...
}, Ir = { class: "notification-dropdown pointer-events-auto bg-white rounded text-center text-black w-500 h-256 flex flex-col p-0" }, _r = { class: "pb-8 border-b border-gray-600" }, Tr = { class: "absolute flex right-3 top-3" }, Lr = ["content", "aria-label"], Rr = /* @__PURE__ */ D({
      ...
      return b(), ee(si, {
        ...
        header: ue(() => [
          g("div", Er, [
            ...
            i.value && i.value > 0 ? (b(), A("span", Sr, z(i.value), 1)) : B("", !0)
          ])
        ]),
        default: ue((c) => [
          g("div", Ir, [
            g("div", null, [
              g("h4", _r, z(I(t)("notifications.title")), 1),
              g("div", Tr, [
                V((b(), A("button", {
                  type: "button",
                  onClick: s,
            ...
            fe(Xi, { class: "overflow-y-auto h-230" })
          ])
        ]),
        _: 1
      }, 8, ["tooltip"]);
...
}), $r = /* @__PURE__ */ qe(Rr, [["__scopeId", "data-v-3623a7d2"]]), Cr = { class: "flex hover:text-white" }, Or = ["aria-label"], kr = { class: "about-ramp-dropdown pointer-events-auto bg-white rounded w-256 h-50" }, Mr = ["aria-label", "content"], Pr = { class: "pb-8 pt-1 border-b border-gray-600 mb-10" }, Nr = { class: "absolute right-5 top-5" }, Fr = { class: "select-text" }, Dr = { class: "font-bold cursor-text" }, Gr = { class: "text-sm cursor-text" }, Ur = { class: "font-bold cursor-text" }, Vr = { class: "ml-5 cursor-text" }, zr = /* @__PURE__ */ D({
  ...
  setup(r) {
    const { t: e } = se(), t = Ie("iApi"), i = () => {
      t.reload();
    }, s = G(() => `${At.major}.${At.minor}.${At.patch}`), a = G(() => At.hash.slice(0, 9)), o = G(() => {
      const l = new Date(At.timestamp);
      if (isNaN(l.getTime()))
        ...
        default: ue((m) => [
          g("div", kr, [
            g("div", null, [
              ...
              g("div", Fr, [
                g("div", null, [
                  g("span", Dr, z(s.value), 1),
                  g("span", Gr, " [" + z(a.value) + "] ", 1)
                ]),
                g("div", null, [
                  g("span", Ur, z(o.value[0]), 1),
                  g("span", Vr, z(o.value[1]), 1)
                ]),
...
}), Br = /* @__PURE__ */ qe(zr, [["__scopeId", "data-v-e0d1ce9f"]]), qr = "S", jr = "__HELP__", Qi = W("keyboardnav", () => {
  ...
  function p(_, N, F) {
    if (_) {
      ...
      if (_ === "reset") {
        ...
        w([qr, j]), q(void 0), L("awaitAction"), P.activeNamespace = j;
      }
    }
  }
  function d(_, N, F) {
  ...
  "aria-live": "polite"
}, Zr = { class: "chain-content" }, Xr = { class: "chain-keys" }, Qr = {
  key: 0,
  class: "chain-cursor"
}, ea = {
  key: 1,
  ...
  __name: "map-caption",
  setup(r) {
    const e = Je(), t = Qi(), i = be(), { t: s } = se(), a = Ie("iApi"), o = G(() => e.scale), l = G(() => e.attribution), n = G(() => e.coords), c = G(() => e.langtoggle), u = G(() => i.config.map), { keyChain: p, lastAction: d, chainState: m, namespaces: h, activeNamespace: y } = hs(t), w = G(() => {
      ...
      if (m.value === "awaitNamespace") {
        const Y = `H - ${s("keyboardnav.chain.help")}`, E = Object.keys(h.value).map((X) => {
          const Ae = `keyboardnav.ns.${X}`, je = s(Ae);
          return `${X} - ${je === Ae ? X : je}`;
        });
        j = `[${[Y, ...E].join(", ")}]`;
        ...
        E && E.keys?.length && (j = `[${E.keys.map((X) => {
          const Ae = `keyboardnav.key.${Y}.${X.key}`, je = s(Ae), _e = je === Ae ? X.key : je;
          return `${X.key} - ${_e}`;
        }).join(", ")}]`);
      }
      return {
      ...
      return b(), A("div", Hr, [
        ...
        w.value ? (b(), A("span", Kr, [
          g("span", Zr, [
            ...
            g("span", Xr, z(w.value.keys), 1),
            w.value.cursor ? (b(), A("span", Qr, "_")) : B("", !0),
            w.value.options ? (b(), A("span", ea, z(w.value.options), 1)) : B("", !0)
          ]),
          w.value.description ? (b(), A("span", ta, "- " + z(w.value.description) + "...", 1)) : B("", !0)
        ])) : l.value?.text.disabled ? B("", !0) : V((b(), A("span", ia, [
        ...
        g("div", sa, [
          n.value?.disabled ? B("", !0) : V((b(), A("div", ra, [
          ...
          o.value?.disabled ? B("", !0) : V((b(), A("button", {
            key: 1,
            type: "button",
          ...
          c.value?.disabled ? B("", !0) : (b(), ee(N, {
            ...
            header: ue(() => [
              g("span", na, z(I(s)("map.language.short")), 1)
            ]),
            default: ue(() => [
              (b(!0), A(tt, null, bt(v.value, (Y, E) => (b(), A("a", {
                key: `${Y}-${E}`,
                class: ce(["flex-auto items-center text-sm sm:text-base cursor-pointer", { "font-bold": Y === I(a).$i18n.locale.value }]),
                href: "javascript:;",
                onClick: (R) => L(Y)
              }, [
                ht(z(I(s)("map.language." + Y)) + " ", 1),
                Y === I(a).$i18n.locale.value ? (b(), A("span", ca, z(I(s)("map.language.curr")), 1)) : B("", !0)
              ], 10, la))), 128))
            ]),
            _: 1
          }, 8, ["tooltip", "ariaLabel"]))
  ...
  setup(r) {
    ...
    return (a, o) => {
      ...
      return V((b(), A("button", {
        ...
        s.value && s.value > 0 ? (b(), A("span", da, z(s.value), 1)) : B("", !0)
      ], 8, pa)), [
        [l]
      ]);
    };
  }
}), fa = /* @__PURE__ */ qe(ha, [["__scopeId", "data-v-a451db5c"]]), ma = { class: "flex items-center mb-20" }, ya = { class: "text-xl" }, ga = /* @__PURE__ */ D({
    ...
    return (c, u) => {
      ...
      return i.value ? (b(), A("div", {
        ...
        g("div", {
          ...
          g("div", ma, [
            g("h2", ya, z(I(t)("keyboardInstructions.title")), 1),
            fe(p, {
              class: "ml-auto",
              onClick: u[0] || (u[0] = (d) => i.value = !1)
            })
          ]),
          (b(!0), A(tt, null, bt(s.value, (d) => (b(), A("p", {
...
}), ut = W("instance", () => ({ started: f(!1) })), va = { class: "h-full relative" }, ba = { class: "inner-shell absolute top-0 left-0 h-full w-full pointer-events-none" }, wa = { class: "absolute top-8 w-full flex justify-center" }, Aa = {
  key: 1,
  class: "w-full h-full"
}, Ea = /* @__PURE__ */ D({
  __name: "shell",
  setup(r) {
    ...
    return (c, u) => (b(), A("div", va, [
      ...
      I(t).started ? (b(), ee(ir, { key: 0 })) : (b(), A("div", Aa, u[1] || (u[1] = [
        g("div", { class: "spinner relative inset-x-1/2 inset-y-9/20" }, null, -1)
      ]))),
      (b(!0), A(tt, null, bt(n(), (p) => (b(), ee(As, {
...
}), xa = /* @__PURE__ */ qe(Ea, [["__scopeId", "data-v-3d441124"]]), Sa = D({
  name: "App",
  components: { Shell: xa },
  setup() {
    const r = Es();
...
const Ai = "focus-item", ka = {
  beforeMount(r, e) {
    r.hasAttribute("id") || r.setAttribute("id", Ma()), e.value ? r.setAttribute(Ai, e.value) : r.toggleAttribute(Ai, !0);
  }
};
function Ma() {
  let r;
...
const Ba = ["content"], qa = {
  ...
  setup(r, { expose: e }) {
    const { t } = se(), i = it(), s = Ft(), a = Ie("iApi"), o = yi("el"), l = yi("contentEl"), n = f();
    e({ el: o });
    ...
    }, w = G(() => c.screenId ? c.panel.screens[c.screenId][a.$i18n.locale.value ?? "en"] : null);
    return st(() => {
      ...
      return V((b(), A("div", {
        ...
        r.header ? (b(), A("header", qa, [
          fe(q, {
            class: ce(r.panel.teleport ? "display-none" : "block sm:display-none"),
            onClick: C[0] || (C[0] = (R) => r.panel.close())
          }, null, 8, ["class"]),
          V((b(), A("h2", ja, [
            v.$slots.header ? Ve(v.$slots, "header", { key: 0 }) : (b(), A("div", Ha, z(I(t)(r.panel.alertName)), 1))
          ])), [
            [j]
          ]),
          ...
          g("div", {
            ...
            r.panel.teleport ? B("", !0) : (b(), A("div", Wa, [
              d.value ? (b(), ee(M, {
                key: 0,
        ...
        r.content ? (b(), A("div", {
          ...
          v.$slots.content ? Ve(v.$slots, "content", { key: 0 }) : w.value ? (b(), A("div", {
            key: 1,
            innerHTML: w.value.innerHTML
          }, null, 8, Ya)) : B("", !0)
        ], 512)) : B("", !0),
        r.footer ? V((b(), A("div", Ja, [
          Ve(v.$slots, "footer")
        ])), [
          [Y]
        ]) : B("", !0)
...
}), Za = { class: "relative" }, Xa = ["content", "aria-label"], Qa = ["transform"], eo = /* @__PURE__ */ D({
  __name: "pin",
  props: {
    active: Boolean
  },
...
}), to = { class: "relative" }, io = ["content", "aria-label"], so = /* @__PURE__ */ D({
  __name: "close",
  props: {
    active: Boolean
  },
...
}), ro = { class: "relative" }, ao = ["content", "aria-label"], oo = /* @__PURE__ */ D({
  __name: "back",
  props: {
    active: Boolean
  },
...
}), ho = { class: "relative" }, fo = ["content", "aria-label"], mo = /* @__PURE__ */ D({
  __name: "minimize",
  props: {
    active: Boolean
  },
...
}), yo = { class: "relative" }, go = ["content", "aria-label"], vo = /* @__PURE__ */ D({
  __name: "right",
  props: {
    active: Boolean
  },
...
}), bo = { class: "relative" }, wo = ["content", "aria-label"], Ao = /* @__PURE__ */ D({
  __name: "left",
  props: {
    active: Boolean
  },
  ...
  setup(r) {
    ...
    return (s, a) => {
      ...
      return b(), ee(o, {
        ...
        default: ue(() => [
          I(t).isFullscreen ? (b(), A("svg", So, a[0] || (a[0] = [
            g("path", {
              d: "M0 0h24v24H0z",
              fill: "none"
            }, null, -1),
  ...
  tabindex: "-1"
}, $o = ["content", "aria-label"], Co = /* @__PURE__ */ D({
  __name: "button",
  props: {
    onClickFunction: {
      type: Function,
  ...
  class: "relative",
  tabindex: "-1"
}, ko = ["aria-label", "content"], Mo = /* @__PURE__ */ D({
  __name: "button",
  props: {
    onClickFunction: {
      type: Function,
...
}, Qo = "~FSA~", Si = "https://geogratis.gc.ca/services/geolocation/@{language}/locate", Ii = "https://geogratis.gc.ca/services/geoname/@{language}/geonames.json", _i = "https://geogratis.gc.ca/services/geoname/@{language}/codes/province.json", Ti = "https://geogratis.gc.ca/services/geoname/@{language}/codes/concise.json";
class Li {
  config;
  constructor(e, t) {
    let i, s, a, o;
    ...
    if (c && c.serviceUrl) {
      ...
      n = `${c.serviceUrl}/query/?where=${v}%3D'${Qo}'&outFields=${v}&returnGeometry=true&f=json`;
    }
    const u = t?.settings;
    let p, d, m, h, y, w;
    u ? (p = u.categories ? u.categories : [], d = u.sortOrder ? u.sortOrder : [], m = u.disabledSearchTypes ? u.disabledSearchTypes : [], h = u.maxResults > 0 ? u.maxResults : 100, y = !!u.officialOnly) : (p = [], d = [], m = [], h = 100, y = !1), w = t?.customSources ?? [], w = w.map((v) => ({
      ...v,
      onSearch: async (C) => {
        const q = v.data ?? [], M = ss().cleanVal(C).replace("*", "");
...
var rs = /* @__PURE__ */ ((r) => (r.Visibility = "visibilityButton", r.Expand = "expandButton", r))(rs || {}), Xt = /* @__PURE__ */ ((r) => (r.Item = "item", r.Placeholder = "placeholder", r.Error = "error", r))(Xt || {});
class as extends re {
  _uid;
  _name;
  _type;
...
function pn(r, e) {
  ...
  s.directive("focus-container", Na), s.directive("focus-list", Ca), s.directive("focus-item", ka), s.directive("truncate", Ua), s.component("panel-screen", Ka), s.component("pin", eo), s.component("close", so), s.component("back", oo), s.component("expand", po), s.component("panel-options-menu", xo), s.component("dropdown-menu", si), s.component("minimize", mo), s.component("right", vo), s.component("left", Ao), s.component("fullscreen-nav-button", _o), s.component("geolocator-nav-button", To), s.component("home-nav-button", Lo), s.component("mapnav-button", Co), s.component("appbar-button", Po), s.component("transition", Ni), s.component("transition-group", Fi), s.config.globalProperties.$iApi = e, s.config.globalProperties.$pinia = t, s.config.idPrefix = `ramp-${r.id || et.sharedUtils.generateUUID()}`, s.provide("iApi", e);
  const a = s.mount(r);
...
class _n extends re {
  ...
  async geoJsonToEsriJson(e, t) {
    ...
    En(e);
    const l = e.features[0].geometry.type, n = An[l], c = JSON.parse(
      // @ts-expect-error TODO: explain why this is needed or remove
      JSON.stringify(wn[n])
    );
    if (t) {
    ...
    for (let y = 0; y < d.length; y++) {
      const w = d[y];
      w.geometry.spatialReference = p, w.geometry.type = o.geometryType, Object.keys(w.attributes).forEach((v) => {
        m.includes(v) ? (Array.isArray(w.attributes[v]) || typeof w.attributes[v] == "object") && w.attributes[v] != null && (w.attributes[v] = JSON.stringify(w.attributes[v])) : delete w.attributes[v];
      });
    }
...
class Ln extends re {
  ...
  async loadWfsData(e, t = -1, i = 0, s = 1e3, a = {
    ...
    const u = new Nt(e).updateQuery(n), [p, d] = await Se(_t.get(u, { signal: l }));
    if (!d)
...
class os extends ci {
  ...
  constructor(e, t) {
    ...
    this.expectedTime.draw = e.expectedDrawTime ?? i.draw, this.expectedTime.load = e.expectedLoadTime ?? i.load, this.expectedTime.fail = e.maxLoadTime || i.fail, this.lastCancel = 0, this.timers = {
      draw: void 0,
      load: void 0
    }, this.origRampConfig = e, this.id = e.id || "", this.uid = this.$iApi.geo.shared.generateUUID(), this.isCosmetic = !1, this.isSystem = e.system || !1, this.isRemoved = !1, this.isSublayer = !1, this.supportsIdentify = !1, this.mapLayer = !0, this.identifyMode = oe.NONE, this.supportsFeatures = !1, this.maptips = !1, this.supportsSublayers = !1, this.isFile = !1, this.layerState = K.NEW, this.initiationState = H.NEW, this.drawState = ye.NOT_LOADED, this.loadDefProm = new ie(), this.url = this.origRampConfig.url, this.canReload = !!(this.url || this.origRampConfig.caching), this.loadPromDone = !1, this.nameArcadeFormula = "", this.maptipArcadeFormula = "", this.layerTree = new Pt(0, this.uid, this.name, !0);
  }
  updateInitiationState(e) {
  ...
  async terminate() {
    this.updateInitiationState(H.TERMINATING), await Promise.all(this.sublayers.map((e) => e.terminate())), this.loadDefProm = new ie(), this.loadPromDone = !1, this.updateLayerState(K.NEW), this.updateDrawState(ye.NOT_LOADED), this.updateInitiationState(H.TERMINATED);
  }
  // ----------- LAYER LOAD -----------
  ...
  onLoadActions() {
    ...
    const a = [], o = (n, c) => {
      ...
      if (n.sublayers && n.sublayers.length > 0) {
        const d = (p ? p.name : "") || n.title || "", m = new Pt(u, "", d, !1);
        ...
        if (d.name = p?.name || n.title || "", a.push(d), !c.children.map((m) => m.layerIdx).includes(u)) {
          const m = new Pt(u, d.uid, d.name, !1);
          c.children.push(m);
        }
        d.esriWatches.push(
          Le(
...
class ns extends os {
  ...
  async onInitiate() {
    if (this.sourceJson) {
      ...
      this.attribs.attLoader = new Qn(this.$iApi, a), await this.attribs.attLoader.getAttribs(), this.featureCount = e.data.length;
  ...
  async symbolToSvg(e) {
    ...
    const a = lt(s).size(this.CONTAINER_SIZE, this.CONTAINER_SIZE).viewbox(0, 0, this.CONTAINER_SIZE, this.CONTAINER_SIZE), o = {
      ...
      "simple-fill"() {
        ...
        a.rect(t.CONTENT_SIZE, t.CONTENT_SIZE).center(t.CONTAINER_CENTER, t.CONTAINER_CENTER).fill(w).stroke(C);
      },
      text() {
...
class al extends re {
   ...
   */
  constructor(e) {
    super(e), this.geom = et.geom, this.proj = et.proj, this.shared = et.sharedUtils, this.map = new mn(e), this.layer = new Rn(e), this.attributes = new Zn(e), this.query = new rl(e), this.symbology = new sl(e), Array.isArray(wt.request.interceptors) || (wt.request.interceptors = []), wt.request.interceptors.push({
      before: (t) => {
   ...
   */
  set proxy(e) {
    wt.request.proxyUrl = e;
  }
  /**
   * Read the current proxy setting, returns url string, empty string if no proxy
   */
  get proxy() {
    return wt.request.proxyUrl || "";
  }
}
const ol = /* @__PURE__ */ Object.assign({ "../fixtures/appbar/index.ts": () => import("./index-Ccghe9Q5.js"), "../fixtures/areas-of-interest/index.ts": () => import("./index-BpipvFYJ.js"), "../fixtures/basemap/index.ts": () => import("./index-eDghVLp7.js"), "../fixtures/crosshairs/index.ts": () => import("./index-DG7TwrnT.js"), "../fixtures/details/index.ts": () => import("./index-1s-i8uXU.js"), "../fixtures/draw/index.ts": () => import("./index-oyMiis4O.js"), "../fixtures/export-footnote/index.ts": () => import("./index-DU5RwQq3.js"), "../fixtures/export-legend/index.ts": () => import("./index-477euwPo.js"), "../fixtures/export-map/index.ts": () => import("./index-CWS_n3qy.js"), "../fixtures/export-northarrow/index.ts": () => import("./index-Ch9He12i.js"), "../fixtures/export-scalebar/index.ts": () => import("./index-KWpcGPm_.js"), "../fixtures/export-timestamp/index.ts": () => import("./index-CD-9_ar0.js"), "../fixtures/export-title/index.ts": () => import("./index-CzPRV4x2.js"), "../fixtures/export/index.ts": () => import("./index-BVYTYFUY.js"), "../fixtures/extentguard/index.ts": () => import("./index-B5dQ0eCM.js"), "../fixtures/gazebo/index.ts": () => import("./index-DbL_QEp2.js"), "../fixtures/geosearch/index.ts": () => import("./index-CyBTRy-B.js"), "../fixtures/grid/index.ts": () => import("./index-CFb_8D23.js"), "../fixtures/help/index.ts": () => import("./index-BA24PvCu.js"), "../fixtures/hilight/index.ts": () => import("./index-ZRHTX7CN.js"), "../fixtures/keyboardnav/index.ts": () => import("./index-BVHxeXgb.js"), "../fixtures/layer-reorder/index.ts": () => import("./index-DHoDm3r_.js"), "../fixtures/legend/index.ts": () => import("./index-C0PGCACs.js"), "../fixtures/mapnav/index.ts": () => import("./index-BjDCHvl-.js"), "../fixtures/metadata/index.ts": () => import("./index-DtEZJM_g.js"), "../fixtures/northarrow/index.ts": () => import("./index-waJDjoO8.js"), "../fixtures/overviewmap/index.ts": () => import("./index-CFGYKtdR.js"), "../fixtures/panguard/index.ts": () => import("./index-Djh7osf0.js"), "../fixtures/scrollguard/index.ts": () => import("./index-5kwpygdp.js"), "../fixtures/settings/index.ts": () => import("./index-Clsv34vt.js"), "../fixtures/snowman/index.ts": () => import("./index-Bm2EmaLK.js"), "../fixtures/swipe/index.ts": () => import("./index-CeJ6zTCT.js"), "../fixtures/wizard/index.ts": () => import("./index-pUF0Y9m6.js") });
class nl extends re {
  /**
...
const dl = /* @__PURE__ */ qe(ul, [["render", pl], ["__scopeId", "data-v-a3c61802"]]), hl = /* @__PURE__ */ Object.assign({ "../fixtures/areas-of-interest/screen.vue": () => import("./screen-CZZM8X-o.js"), "../fixtures/basemap/screen.vue": () => import("./screen-D2IY82vH.js"), "../fixtures/export/screen.vue": () => import("./screen-C-PmQaLZ.js"), "../fixtures/geosearch/screen.vue": () => import("./screen-CiMp3u5A.js"), "../fixtures/grid/screen.vue": () => import("./screen-DKOkTcw9.js"), "../fixtures/help/screen.vue": () => import("./screen-DSJSQLBp.js"), "../fixtures/layer-reorder/screen.vue": () => import("./screen-DERVNrd_.js"), "../fixtures/legend/screen.vue": () => import("./screen-D-ux_Xim.js"), "../fixtures/metadata/screen.vue": () => import("./screen-ir_pS8uv.js"), "../fixtures/settings/screen.vue": () => import("./screen-CNqjSqfe.js"), "../fixtures/wizard/screen.vue": () => import("./screen-DhMS7eXn.js") });
class Ct extends re {
  /**
   * ID of this panel.
   *
...
function yl(r) {
  ...
  return vl(r.services, e), gl(r.map, e), bl(r.ui, e), r.plugins && wl(r.plugins, e), e;
}
function gl(r, e) {
  ...
  return r.controls && r.controls.length > 0 && (e.controls = gt(r.controls, t), r.controls.includes("visibility") && e.controls.push("visibilityButton"), (r.controls.length !== 1 || r.controls[0] !== "visibility") && console.warn(
    ...
    if (i.layerId)
      ...
      typeof i.collapse < "u" && console.warn(
        ...
        a.layerId ? s.children.push(Mi(a)) : s.children.push(Qt(a));
      }), e.children.push(s);
    } else
...
function Wt(r) {
  ...
  )), typeof r.stateOnly < "u" && (e.cosmetic = r.stateOnly), r.initialFilteredQuery && (e.initialFilteredQuery = r.initialFilteredQuery), Al(r, e), typeof r.toggleSymbology < "u" && console.warn(`toggleSymbology property provided in layer ${r.id} cannot be mapped and will be skipped.`), r.table && (e.fixtures = {
    grid: {}
...
var pt = { major: "4", minor: "16", patch: "0-beta", timestamp: "Fri Feb 20 13:34:24 2026 -0500", hash: "a4bb7b6af5805a6c2c3c1dfb7a5bb99982bfb19d" };
console.info(
