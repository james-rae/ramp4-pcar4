import{n as e}from"./glsl-DdA76VR7.js";import{t}from"./FloatPassUniform-D53U6T8V.js";import{t as n}from"./Texture2DPassUniform-djLn-sp6.js";import{t as r}from"./ShaderBuilder-CVTLfC6v.js";import{t as i}from"./HighlightCellGridScreenSpacePass.glsl-BcGZTNgf.js";import{t as a}from"./IntegerPassUniform-KCqKAT1r.js";import{a as o,s}from"./HighlightDownsample.glsl-BUIbK_ql.js";import{t as c}from"./HighlightReadBitmap.glsl-Dmd7Zcwl.js";import{t as l}from"./Float2DrawUniform-DhaF3aDc.js";function u(){let u=new r;u.include(i);let{fragment:d}=u;return d.uniforms.add(new n(`blurInput`,e=>e.highlightBlurTexture),new l(`blurSize`,e=>e.blurSize),new s(`highlightTexture`,e=>e.highlightTexture),new n(`highlightOptionsTexture`,e=>e.highlightOptionsTexture),new a(`highlightLevel`,e=>e.highlightLevel),new t(`occludedIntensityFactor`,e=>e.occludedFactor)),d.constants.add(`inner`,`float`,1-(9-o)/9),u.include(c),d.main.add(e`vec2 highlightTextureSize = vec2(textureSize(highlightTexture,0));
vec2 uv = sUV;
