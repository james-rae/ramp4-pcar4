import { B as e, C as t, D as n, E as r, S as i, T as a, dt as o, ft as s, w as c, x as l, z as u } from "./main-dpIMyHMK.js";
import { n as d } from "./config-Dy8o8ei4.js";
...
}), [["__scopeId", "data-v-a96b0405"]]), de = { class: "relative" }, fe = ["content"], pe = {
	key: 0,
			...
			return r.legendItem.hidden ? g("", !0) : (T(), _("div", {
				...
				v("div", de, [I((T(), _("div", {
					...
					(r.legendItem.type === N(n).Item || r.legendItem.type === N(n).Placeholder && N(H)) && r.legendItem instanceof N(c) ? (T(), h(oe, {
						...
						legendItem: r.legendItem,
						onFocusItem: o[2] ||= () => e.$emit("focusItem", N(q))
