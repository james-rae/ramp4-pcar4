import { B as e, Q as t, Y as n, ht as r, mt as i, s as a, st as o, v as s } from "./main-dpIMyHMK.js";
import { t as c } from "./config-Dy8o8ei4.js";
...
import { debounce as b } from "throttle-debounce";
...
var x = class extends a {
	...
	setup(a) {
		...
		g(() => {
			F.value = f.config.map.tileSchemas, D?.value && (M.value = `<img width='25' src='${D.value}'>`), w.geo.map.esriView?.ready && L(w.geo.map.getExtent()), P.push(w.event.on(e.MAP_EXTENTCHANGE, b(300, L)));
		}), h(() => {
