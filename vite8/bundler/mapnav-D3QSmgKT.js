import { B as e, b as t, s as n } from "./main-dpIMyHMK.js";
import "./config-Dy8o8ei4.js";
...
import { throttle as M } from "throttle-debounce";
...
var L = /* @__PURE__ */ r(P, [["render", I]]), R = /* @__PURE__ */ m({
	__name: "zoom-nav",
	setup(e) {
		let { t } = N(), n = h("iApi"), r = M(400, !0, () => n.geo.map.zoomIn()), i = M(400, !0, () => n.geo.map.zoomOut());
		return (e, n) => {
	...
	setup(e) {
		...
		let i = [
			{
				type: "point",
				icon: g(p(() => import("./point-icon-BrWaB5bM.js")))
			},
			{
				type: "polyline",
				icon: g(p(() => import("./polyline-icon-CXyMOEWR.js")))
			},
			{
				type: "polygon",
				icon: g(p(() => import("./polygon-icon-DRrimhxI.js")))
			},
			{
				type: "circle",
				icon: g(p(() => import("./circle-icon-C-rFMX5X.js")))
			},
			{
				type: "rectangle",
				icon: g(p(() => import("./rectangle-icon-CBfVQGls.js")))
			}
		], l = s(() => {
			let e = i.filter((e) => r.supportedTypes.some((t) => t.type === e.type));
			return e.push({
				type: "edit",
				icon: g(p(() => import("./edit-icon-bVwx_D28.js")))
			}), e;
		}), d = (e) => {
...
}), [["__scopeId", "data-v-7a8c17a8"]]), q = class extends n {
