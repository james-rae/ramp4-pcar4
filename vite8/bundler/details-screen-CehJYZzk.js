import { B as e, L as t, V as n } from "./main-dpIMyHMK.js";
import { n as r } from "./config-Dy8o8ei4.js";
import { t as i } from "./_plugin-vue_export-helper-B52Kst-M.js";
import "./store-BSbISna5.js";
...
var I = {
	...
	setup(e) {
		...
		return x(() => {
			...
			style: v({ "z-index": 3 - t }),
			key: t
		}, [n.value[t].svgcode ? (S(), u("span", {
			key: 0,
			class: "symbologyIcon w-28 h-28",
			innerHTML: n.value[t].svgcode
		}, null, 8, R)) : n.value[t].imgUrl ? (S(), u("img", {
			key: 1,
			class: "symbologyIcon w-28 h-28",
...
}), [["__scopeId", "data-v-496d788d"]]), J = ["content"], Y = { class: "symbologyLayerName truncate" }, X = /* @__PURE__ */ m({
	...
	setup(e) {
		let { t } = P(), r = h("iApi"), i = n(), a = C([]), o = C([]), p = C([]), m = C(!1), v = C(null), x = C(""), w = s(() => i.activeGreedy), E = s(() => i.payload), D = s(() => i.properties), M = (e) => {
			x.value = e;
		}, N = (e) => p.value.find((t) => t.uid === e), F = (e) => {
			e !== void 0 && (i.activeGreedy = e.length === 0 ? 0 : e[0].requestTime, p.value = e, I(e));
		}, I = (e) => {
			if (x.value) {
				let t = N(x.value);
				t ? t.loading.then(() => {
					t.requestTime === w.value && (t.items.length > 0 ? R(!1) : L(e));
				}) : L(e);
			} else L(e);
		}, L = (e, t) => {
			let n;
			...
			Promise.any(a).then((e) => {
				e.requestTime === w.value && (x.value = e.uid, R(!1));
			}).catch(() => {
				o === w.value && (n.pop(), L(e, n));
			});
		}, R = (e) => {
