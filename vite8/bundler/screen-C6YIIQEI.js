import { $ as e, A as t, B as n, O as r, Z as i, k as a, z as o } from "./main-dpIMyHMK.js";
...
import { debounce as P } from "throttle-debounce";
...
var I = { class: "rv-geosearch-bar relative h-26 mx-8 mb-8" }, L = [
	...
	setup(e) {
		let { t } = F(), i = _("iApi"), a = r(), o = l(() => a.resultsVisible), s = P(300, (e) => {
			u(e).then((e) => {
				c({
					extent: e,
					visible: o.value
