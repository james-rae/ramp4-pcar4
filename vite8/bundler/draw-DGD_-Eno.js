import { B as e, at as t, et as n, it as r, mt as i, nt as a, ot as o, rt as s, s as c, tt as l } from "./main-dpIMyHMK.js";
	...
	async init() {
		Object.entries(D).forEach((e) => this.$iApi.$i18n.mergeLocaleMessage(...e)), this._parseConfig(this.config), u(this.$vApp.$pinia).supportedTypes.forEach((e) => {
			...
			this.$iApi.component(t, m(S(/* @__PURE__ */ Object.assign({
				"./icons/circle-icon.vue": () => import("./circle-icon-C-rFMX5X.js"),
				"./icons/edit-icon.vue": () => import("./edit-icon-bVwx_D28.js"),
				"./icons/point-icon.vue": () => import("./point-icon-BrWaB5bM.js"),
				"./icons/polygon-icon.vue": () => import("./polygon-icon-DRrimhxI.js"),
				"./icons/polyline-icon.vue": () => import("./polyline-icon-CXyMOEWR.js"),
				"./icons/rectangle-icon.vue": () => import("./rectangle-icon-CBfVQGls.js")
