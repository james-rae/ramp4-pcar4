import { n as e, t } from "./config-Dy8o8ei4.js";
...
import { debounce as Re, throttle as ze } from "throttle-debounce";
...
var nt = /* @__PURE__ */ function(e) {
	...
	id;
	constructor(e, t, n) {
		this.geometry = e, t ? this.id = t : this.id = Ns.sharedUtils.generateUUID(), n ? this.attributes = n : this.attributes = {};
	}
	_hover;
	get hover() {
		return this._hover;
	...
	static convToPoints(e) {
		if (e !== void 0) if (typeof e == "string") {
			...
			return t = r === "px" ? parseFloat(e.substring(0, n - 2)) * 1.333333 : r === "pt" ? parseFloat(e.substring(0, n - 2)) : parseFloat(e), t;
		} else return e;
	}
	...
	updateQuery(e) {
		...
		return `${this.base}${Object.entries(t).filter(([, e]) => e !== void 0).map(([e, t], n) => `${n === 0 ? "?" : ""}${e}=${t}`).join("&")}`;
	}
	...
	async projectGeometry(e, t) {
		...
		let n = t.toGeoJSON(), r = await this.projectGeoJson(n, this.normalizeProj(t.sr), this.normalizeProj(e)), i = Ns.geom.geomGeoJsonToRamp(r, t.id);
...
var Ht = class {
	...
	defaultHandlerFactory(e) {
		...
		switch (e) {
			...
			case Q.MAP_EXTENT_UPDATES_MAPTIP:
				...
				}, this.$iApi.event.on(Z.MAP_EXTENTCHANGE, ze(50, !0, () => n()), e);
				break;
			...
			case Q.MAP_KEYDOWN_UPDATES_COORDS:
				this.$iApi.event.on(Z.MAP_KEYDOWN, ze(50, () => {
			...
			case Q.MAP_MOUSE_UPDATES_COORDS:
				this.$iApi.event.on(Z.MAP_MOUSEMOVE, ze(50, (e) => {
			...
			case Q.MAP_MOUSE_UPDATES_MAPTIP:
				...
				}, this.$iApi.event.on(Z.MAP_MOUSEMOVE, ze(50, (e) => n(e)), e);
				break;
			case Q.MAP_MOUSEDOWN_UPDATES_MAPTIP:
				...
				}, this.$iApi.event.on(Z.MAP_MOUSEDOWN, ze(50, (e) => {
					let t = {
						screenX: e.offsetX,
						screenY: e.offsetY,
						button: e.button,
			...
			case Q.MAP_RESIZE_UPDATES_SCALEBAR:
				this.$iApi.event.on(Z.MAP_RESIZED, Re(100, () => this.$iApi.geo.map.caption.updateScale()), e);
				break;
			case Q.MAP_SCALE_UPDATES_SCALEBAR:
				this.$iApi.event.on(Z.MAP_SCALECHANGE, Re(300, () => this.$iApi.geo.map.caption.updateScale()), e);
				break;
	...
	en: {
		...
		"caption.attributionLogoAltText": "ESRI logo",
	...
	fr: {
		...
		"caption.attributionLogoAltText": "Logo ESRI",
...
var nn = v("maptip", () => {
	...
	setup(e) {
		let { t } = I(), n = ye("iApi"), r = () => {
			n.reload();
		}, i = y(() => `${ks.major}.${ks.minor}.${ks.patch}`), a = y(() => ks.hash.slice(0, 9)), o = y(() => {
			let e = new Date(ks.timestamp);
...
var Yr = /* @__PURE__ */ function(e) {
...
}(Yr || {}), Xr = "focus-container", Zr = "focus-list", Qr = "focus-icon", $r = `[${Zr}],[${Xr}]`, ei = `button,input,select,a,textarea,[contenteditable],.ag-tab-guard,[${Zr}],[${Xr}],[${Qr}],[tabindex]`, ti = [], ni = {
	mounted(e) {
	...
	element;
	constructor(e) {
		this.element = e, this.element.toggleAttribute(Xr, !0), this.element.tabIndex = 0, setTimeout(() => this.disableTabbing(), 600);
		let t = this;
	...
	disableTabbing() {
		this.element.contains(document.activeElement) || Array.prototype.filter.call(this.element.querySelectorAll(ei), () => !0).forEach((e) => {
			e.tabIndex = -1;
		});
	}
	enableTabbing() {
		...
		return Array.prototype.map.call(this.element.querySelectorAll(ei), (t) => {
			(t.closest($r) === this.element || t.closest($r) === t && t.parentElement.closest($r) === this.element) && t.offsetParent && (t.tabIndex = 0, e === void 0 && (e = t));
		}), e;
	}
...
var ui = ["content"], di = {
...
}, _i = "[focus-list], [focus-container]", vi = /* @__PURE__ */ T({
	__name: "panel-screen",
	props: {
		header: {
			type: Boolean,
	...
	setup(e, { expose: t }) {
		...
		t({ el: s });
		let f = e, p = y(() => o.fixture.get("appbar") ? a.temporary : []), m = y(() => i.mobileView), h = y(() => i.reorderable), ee = (e) => e.scrollHeight > e.clientHeight, g = (e) => e.querySelector(_i), te = () => {
			if (!c.value) return "-1";
			let e = !!g(c.value);
			return ee(c.value) && !e ? "0" : "-1";
		}, ne = () => {
			if (!c.value) return;
			let e = te();
		...
		}, oe = () => !m.value && !f.panel.teleport, _ = (e) => {
			f.panel.move(e), e === "left" && xe(() => {
				(s.value?.querySelector(".move-left")).focus();
			});
		}, se = y(() => f.screenId ? f.panel.screens[f.screenId][o.$i18n.locale.value ?? "en"] : null);
		return we(() => {
			s.value?.addEventListener("blur", ie), s.value?.addEventListener("keyup", ae), c.value && (c.value.addEventListener("focus", re), l.value = new ResizeObserver(ne), l.value.observe(c.value), u.value = new MutationObserver(ne), u.value.observe(c.value, {
				childList: !0,
				subtree: !0,
				attributes: !0,
				attributeFilter: ["focus-list", "focus-container"]
			}), d.value = new MutationObserver(ne), d.value.observe(c.value, {
				attributes: !0,
				attributeFilter: ["tabindex"]
			}), ne());
		}), Ce(() => {
			s.value?.removeEventListener("blur", ie), s.value?.removeEventListener("keyup", ae), c.value?.removeEventListener("focus", re), l.value?.disconnect(), u.value?.disconnect(), d.value?.disconnect();
		}), (t, r) => {
			...
			return F((O(), S("div", {
				...
				e.content ? (O(), S("div", {
					...
					ref: c,
					tabindex: "-1"
				}, [t.$slots.content ? ke(t.$slots, "content", { key: 0 }) : se.value ? (O(), S("div", {
					key: 1,
					innerHTML: se.value.innerHTML
				}, null, 8, hi)) : x("", !0)], 512)) : x("", !0),
				e.footer ? F((O(), S("div", gi, [ke(t.$slots, "footer")])), [[g]]) : x("", !0)
			], 8, ui)), [[te, {
				trigger: "manual",
				touch: !1,
				onShow: oe,
...
}), yi = { class: "relative" }, bi = ["content", "aria-label"], xi = ["transform"], Si = /* @__PURE__ */ T({
	__name: "pin",
	...
	setup(e) {
		...
		return (n, r) => {
			let i = j("tippy");
			return O(), S("div", yi, [F((O(), S("button", {
				type: "button",
...
}), Ci = { class: "relative" }, wi = ["content", "aria-label"], Ti = /* @__PURE__ */ T({
	__name: "close",
	props: { active: Boolean },
	setup(e) {
		let { t } = I();
		return (n, r) => {
			let i = j("tippy");
			return O(), S("div", Ci, [F((O(), S("button", {
				type: "button",
				class: D(["text-gray-500 hover:text-black focus:text-black p-8", { "text-gray-700": e.active }]),
...
}), Pi = { class: "relative" }, Fi = ["content", "aria-label"], Ii = /* @__PURE__ */ T({
	__name: "minimize",
	props: { active: Boolean },
	setup(e) {
		let { t } = I();
		return (n, r) => {
			let i = j("tippy");
			return O(), S("div", Pi, [F((O(), S("button", {
				type: "button",
				...
				d: "M0 0h24v24H0V0z",
				fill: "none"
			}), C("path", { d: "M6 19h12v2H6z" })], -1)], 10, Fi)), [[i, {
				placement: "bottom",
				theme: "ramp4",
				animation: "scale"
			}]])]);
	...
	setup(e) {
		...
		return (n, r) => {
			...
			return O(), S("div", Li, [F((O(), S("button", {
				...
				xmlns: "http://www.w3.org/2000/svg",
				viewBox: "4 4 16 16"
			}, [C("path", { d: "M 8.59 16.34 L 13.17 11.75 L 8.59 7.16 L 10 5.75 L 16 11.75 L 10 17.75 Z" })], -1)], 10, Ri)), [[i, {
				placement: "bottom",
				theme: "ramp4",
				animation: "scale"
			}]])]);
...
}), Bi = { class: "relative" }, Vi = ["content", "aria-label"], Hi = /* @__PURE__ */ T({
	__name: "left",
	props: { active: Boolean },
	setup(e) {
		let { t } = I();
		return (n, r) => {
			...
			return O(), S("div", Bi, [F((O(), S("button", {
				...
				content: N(t)("panels.controls.moveLeft"),
				"aria-label": N(t)("panels.controls.moveLeft")
			}, r[0] ||= [C("svg", {
				class: "fill-current w-16 h-16",
				xmlns: "http://www.w3.org/2000/svg",
				viewBox: "4 4 16 16"
			}, [C("path", { d: "M 15.41 16.09 L 10.83 11.5 L 15.41 6.91 L 14 5.5 L 8 11.5 L 14 17.5 Z" })], -1)], 10, Vi)), [[i, {
				placement: "bottom",
				theme: "ramp4",
				animation: "scale"
			}]])]);
	...
	setup(e) {
		...
		return (e, i) => {
			...
			return O(), b(a, {
				...
				default: P(() => [N(n).isFullscreen ? (O(), S("svg", Wi, i[0] ||= [C("path", {
					d: "M0 0h24v24H0z",
					fill: "none"
				}, null, -1), C("path", { d: "M5 16h3v3h2v-5H5v2zm3-8H5v2h5V5H8v3zm6 11h2v-3h3v-2h-5v5zm2-11V5h-2v5h5V8h-3z" }, null, -1)])) : (O(), S("svg", Gi, i[1] ||= [C("path", {
					d: "M0 0h24v24H0z",
					fill: "none"
	...
	tabindex: "-1"
}, Xi = ["content", "aria-label"], Zi = /* @__PURE__ */ T({
	__name: "button",
	props: {
		onClickFunction: {
			type: Function,
	...
	setup(e) {
		return (t, n) => {
			...
			}, [ke(t.$slots, "default")], 10, Xi)), [[r], [i, { placement: "left" }]])]);
		};
	}
}), Qi = {
	class: "relative",
	tabindex: "-1"
}, $i = ["aria-label", "content"], ea = /* @__PURE__ */ n(/* @__PURE__ */ T({
	__name: "button",
	props: {
		onClickFunction: {
			type: Function,
	...
	setup(e) {
		...
		return (t, n) => {
			...
			}, [ke(t.$slots, "default", {}, void 0, !0)], 8, $i)), [[i], [a, {
				allowHTML: !0,
				placement: "right"
			}]])]);
		};
	}
}), [["__scopeId", "data-v-1cb84ae1"]]), ta = v("areas-of-interest", () => ({ areas: k([]) })), na = v("export", () => {
	let e = k({
		title: !0,
		map: !0,
		mapElements: !0,
...
var pa = async (e) => {
	...
	constructor(e, t) {
		...
		l ? (u = l.categories ? l.categories : [], d = l.sortOrder ? l.sortOrder : [], f = l.disabledSearchTypes ? l.disabledSearchTypes : [], p = l.maxResults > 0 ? l.maxResults : 100, m = !!l.officialOnly) : (u = [], d = [], f = [], p = 100, m = !1), h = t?.customSources ?? [], h = h.map((e) => ({
			...e,
			onSearch: async (t) => {
				let n = e.data ?? [], r = Ma().cleanVal(t).replace("*", "");
				return n.filter((e) => e.name.toLowerCase().includes(r)).map((t) => ({
					name: t.name,
					type: e.catName,
					bbox: t.bbox,
					flav: "nme",
...
var Ma = v("geosearch", () => {
	...
	_visibleChildren;
	constructor(e, t, n) {
		super(e), this._uid = Ns.sharedUtils.generateUUID(), this._name = t.name, this._type = t.type ?? Pa.Placeholder, this._parent = n, this._children = [], this._loadPromise = new Y(), this._hidden = t.hidden ?? !1, this._expanded = t.expanded ?? !0, this._visibility = !0, this._exclusive = t.exclusive ?? !1, this._controls = t.controls?.slice() ?? [Na.Visibility, Na.Expand], this._disabledControls = t.disabledControls?.slice(), this._visibleChildren = [];
	}
	get uid() {
		return this._uid;
	}
	...
	toggleVisibility(e, t = !0) {
		if (this.visibility !== e) {
			...
			else if (this.visibility) if (this._lastVisible && (!(this._lastVisible instanceof Ia) || this._lastVisible.layerControlAvailable(G.Visibility))) this._lastVisible.toggleVisibility(!0);
			else {
				let e = this.children.find((e) => !(e instanceof Ia) || e.layerControlAvailable(G.Visibility));
	...
	checkVisibilityRules() {
		(this.parent && !this.parent.visibility || this.parent?.exclusive && this.parent.children.some((e) => e.visibility && e !== this && e.type === Pa.Item)) && this.toggleVisibility(!1, !1);
	}
	checkVisibility(e) {
		this instanceof Ia && !this.layerControlAvailable(G.Visibility) || (this.exclusive ? e.visibility ? (this.children.forEach((t) => {
	...
	load() {
		this._type = Pa.Item, this._loadPromise.resolveMe(), this.checkVisibilityRules();
	}
	reload() {
		this._type = Pa.Placeholder, this._loadPromise = new Y();
	}
	error() {
		this._type !== Pa.Error && (this._type = Pa.Error, this._loadPromise.getPromise().catch(() => {}), this._loadPromise.rejectMe(), this.checkVisibilityRules());
	}
}, Ia = class extends Fa {
	_layerId;
	_layerIdx;
	...
	load(e) {
		let t = e instanceof fo ? e : this.$iApi.geo.layer.getLayer(this._layerId ?? this._layerUid);
	...
	_content;
	constructor(e, t, n) {
		super(e, t, n), this._infoType = t.infoType ?? La.Title, this._content = t.content ?? "", t.infoType === La.Template && this.$element.component(`${this._uid}-info-section`, { template: this._content }), (t.infoType || t.content) && (this._controls = t.controls?.slice() ?? [Na.Expand]), super.load();
	}
	get infoType() {
	...
	constructor(e, t, n) {
		...
		let r = qa(e, this);
		this.$vApp = r.app, this.$element = r.element, this.$i18n = r.i18n, this.$rootEl = r.app.$root?.$el, this.fixture = new ss(this), this.panel = new ls(this), this.geo = new as(this), this.dev = new gs(this), this.ui = {
	...
	useStore(n) {
		if (!([
			...
			case "scrollguard": return Wa(this.$vApp.$pinia);
			case "wizard": return Ga(this.$vApp.$pinia);
...
function qa(e, t) {
	...
	return i.directive("focus-container", ni), i.directive("focus-list", Ur), i.directive("focus-item", qr), i.directive("truncate", oi), i.component("panel-screen", vi), i.component("pin", Si), i.component("close", Ti), i.component("back", Oi), i.component("expand", Ni), i.component("panel-options-menu", Ui), i.component("dropdown-menu", fn), i.component("minimize", Ii), i.component("right", zi), i.component("left", Hi), i.component("fullscreen-nav-button", Ki), i.component("geolocator-nav-button", qi), i.component("home-nav-button", Ji), i.component("mapnav-button", Zi), i.component("appbar-button", ea), i.component("transition", fe), i.component("transition-group", pe), i.config.globalProperties.$iApi = t, i.config.globalProperties.$pinia = n, i.config.idPrefix = `ramp-${e.id || Ns.sharedUtils.generateUUID()}`, i.provide("iApi", t), {
		element: i,
		app: i.mount(e),
		i18n: r.global
	};
...
var Ja = class e {
	...
	async createMap(e, t) {
		...
		}, r = e.basemaps.map((e) => Ja.create(e)), i = (await Promise.all(r)).filter((e) => (e.createErr && n(e), e.esriBasemap.baseLayers.length > 0));
		i.forEach((e) => {
	...
	async checkAtCoord(e) {
		...
		let n = this.$iApi.geo.layer.getLayer(t.layerId);
	...
	constructor(e) {
		super(e, "main"), this.maptip = new Xa(e), this.caption = new Qa(e), this.mapMouseThrottle = 0;
	}
	async createMap(e, t) {
	...
	removeLayer(t) {
		...
		let n;
		if (n = t instanceof fo ? t : this.$iApi.geo.layer.getLayer(t), !n) throw Error("Layer could not be found for removal.");
		if (n.isSublayer) {
	...
	createMouseMoveHandler() {
		...
		return ze(this.mapMouseThrottle, (e) => {
	...
	async getGraphicAtCoord(e) {
		...
		if (r.some((e) => {
			...
			return n ? (n.isCosmetic || n.layerType === R.GRAPHIC || e.graphic.isAggregate || (i = n, a = e.graphic), !0) : (o.add(e.layer.id), !1);
		}), i && a) return {
			oid: a.getObjectId(),
			layerId: i.id,
			layerIdx: i.layerIdx
...
var oo = class extends X {
	...
	async geoJsonToEsriJson(e, t) {
		...
		no(e);
		let o = e.features[0].geometry.type, s = to[o], c = JSON.parse(JSON.stringify(eo[s]));
		if (t) {
	...
	fgbToGeoJson(e, t) {
		return import("flatgeobuf").then(({ geojson: n }) => new Promise((r) => {
			let i = !1, a = null, o = n.deserialize(new Uint8Array(e), void 0, (e) => {
				a = e.crs, i = !0;
			}), s = 0, c = setInterval(() => {
				if (o && i) {
					clearInterval(c);
				...
				} else s += 60, s > t && (clearInterval(c), r({}));
			}, 60);
		}));
	}
	inferType(e) {
	...
	ogc;
	constructor(e) {
		super(e), this.files = new oo(e), this.ogc = new co(e);
	}
	createLayer(e) {
		let t;
		switch (e.layerType) {
	...
	async loadLayerMetadata(e) {
		...
		if (i.name = r.name || "", i.currentVersion = r.currentVersion || -1, i.minScale = r.effectiveMinScale || r.minScale || 0, i.maxScale = r.effectiveMaxScale || r.maxScale || 0, i.extent = r.extent ? St.fromArcServer(r.extent, "layer_extent") : void 0, i.defaultVisibility = r.defaultVisibility ?? !0, i.canModifyLayer = r.canModifyLayer ?? !0, r.type === "Feature Layer" || r.type === "Table") {
			if (i.dataFormat = z.ESRI_FEATURE, i.displayField = r.displayField || "", Array.isArray(r.fields)) {
				let t = await Promise.all(r.fields.map((e) => K.FieldFromJson(e)));
				i.fields = t.map((e) => ({
					name: e.name,
					alias: e.alias,
					type: e.type,
	...
	updateDrawState(e) {
		this.drawState = e, e === ut.REFRESH ? this.startTimer(po.DRAW) : e === ut.UP_TO_DATE && this.stopTimer(po.DRAW), this.$iApi.event.emit(Z.LAYER_DRAWSTATECHANGE, {
			state: e,
			layer: this
		});
	}
	async initiate() {
		this.updateInitiationState(H.INITIATING), this.startTimer(po.LOAD);
		let e = (e) => {
		...
		clearTimeout(n), t > this.lastCancel && (this.drawState !== ut.UP_TO_DATE && this.startTimer(po.DRAW), r ? e(`Init error on layer id: ${this.id} . ${r.message}`) : this.updateInitiationState(H.INITIATED));
	}
	async onInitiate() {
	...
	onLoad() {
		...
		try {
			...
			Promise.all(r).then(() => {
				clearTimeout(n), t ? this.visibility = !1 : (this.stopTimer(po.LOAD), e > this.lastCancel && (this.loadPromDone && (this.loadDefProm = new Y()), this.loadDefProm.resolveMe(), this.loadPromDone = !0, this.sublayers.forEach((e) => e.onLoad()), this.updateLayerState(U.LOADED)));
			}).catch(() => {
	...
	async loadLayerMetadata(e = {}) {
		...
		if (!(t < this.lastCancel)) if (this.geomType = n.geometryType, this.attribs.quickCache = new Yo(this.geomType), this.scaleSet.minScale = n.minScale, this.scaleSet.maxScale = n.maxScale, this.dataFormat = n.dataFormat, this.extent = this.extent ?? n.extent, this._serverVisibility = n.defaultVisibility, this.origRampConfig.name || (this.name = n.name ?? this.id), this.dataFormat === z.ESRI_FEATURE) {
			...
			this.attribs.attLoader = new Ko(this.$iApi, r);
	...
	runIdentify(e) {
		...
		return e.hitTest && (this.identifyMode === V.HYBRID || this.identifyMode === V.SYMBOLIC) && (r = i.then(async () => {
			...
			a.forEach((e) => {
				n.items.push(lo.makeRawItem(dt.ESRI, e.attributes));
			}), o.forEach((e) => {
				n.items.push(lo.makeOidItem(e, this));
	...
	extractLayerMetadata() {
		...
		this.attribs.attLoader = new qo(this.$iApi, t);
	}
	async getGraphic(e, t) {
		let n;
	...
	set visibility(e) {
		...
		if (e || Oo(this, "1=2"), this.actualViz = e, e && !this.esriLayer.visible) this.esriLayer.visible = !0;
		else if (!e && this.esriLayer.visible) {
			let e = "", t = setTimeout(() => {
				this.$iApi.event.off(e), this.actualViz || (this.esriLayer.visible = !1, Oo(this, ""));
			}, 1600);
			e = this.$iApi.event.on(Z.LAYER_DRAWSTATECHANGE, (n) => {
				n.layer.id === this.id && n.state === ut.UP_TO_DATE && (clearTimeout(t), this.$iApi.event.off(e), this.actualViz || (this.esriLayer.visible = !1, Oo(this, "")));
			});
		}
		e && Oo(this, "");
	}
	...
	onLoadActions() {
		...
		let i = [], a = (e, t) => {
			...
			if (e.sublayers && e.sublayers.length > 0) {
				...
				this._sublayers[n] || (this._sublayers[n] = new ko({
	...
	runIdentify(e) {
		...
		return e.geometry.type === L.POINT && (n = this.$iApi.geo.query.makeClickBuffer(e.geometry, e.tolerance)), t.map((t) => {
			...
			return t.geomType !== L.POLYGON && n ? i.filterGeometry = n : i.filterGeometry = e.geometry, i.filterSql = t.getCombinedSqlFilter(), i.sourceSR = t.sourceSR, t.queryOIDs(i).then((e) => {
				e.forEach((e) => {
					a.items.push(lo.makeOidItem(e, t));
	...
	runIdentify(e) {
		...
		return this.getFeatureInfo(this.sublayerNames, e.geometry, this.mimeType).then((e) => {
			if (e) {
				let t = !0, r;
				typeof e == "string" ? e.indexOf("Search returned no results") === -1 && e !== "" ? r = dt.TEXT : (t = !1, r = dt.UNKNOWN) : r = dt.JSON, t && n.items.push(lo.makeRawItem(r, e));
			}
			n.loaded = !0, t.resolveMe();
		}).catch(() => {
			n.errored = !0, t.resolveMe();
	...
	_visibility;
	constructor(e, t) {
		super(e, t), this.dataFormat = z.ESRI_FEATURE, this.layerFormat = lt.NOLAYER, this.drawState = ut.NOT_VISUAL, this.attribs = new Uo(), this.supportsFeatures = !0, this.mapLayer = !1, this.isFile = !1, this._visibility = e.state?.visibility ?? !0, this.expectedTime.draw = 0;
	}
	async onInitiate() {
		if (this.sourceJson) {
			...
			this.attribs.attLoader = new Jo(this.$iApi, i), await this.attribs.attLoader.getAttribs(), this.featureCount = e.data.length;
	...
	onLoadActions() {
		let e = super.onLoadActions(), t = Date.now(), n = this.$iApi.geo.shared.parseUrlIndex(this.serviceUrl).index || 0, r = this.$iApi.geo.layer.loadLayerMetadata(this.serviceUrl).then((e) => {
			...
			this.attribs.attLoader = new Ko(this.$iApi, n), this.attribs.quickCache = new Yo(this.geomType);
	...
	constructor(e, t) {
		super(e), this.aac = new Wo(), this.details = t;
	}
	updateFieldList(e) {
	...
	getAttribs() {
		return this.loadPromise ||= (this.aac = new Wo(), this.loadPromiseGenerator()), this.loadPromise;
	}
	abortAttribLoad() {
	...
	constructor(e, t, n = !1) {
		if (super(e, t, n), this.valField = this.cleanFieldName(e.field, t), e.classBreakInfos.forEach((e, t) => {
			let n = t === 0, r = new ns(this, e.minValue, e.maxValue, n);
	...
	makeRenderer(e, t, n = !1) {
		switch (e.type) {
			case this.SIMPLE: return new Qo(e, t);
			case this.CLASS_BREAKS: return new ts(e, t, n);
			case this.UNIQUE_VALUE: return new $o(e, t, n);
	...
	generatePlaceholderSymbology(e, t = "#000") {
		...
		return n.rect(this.CONTENT_IMAGE_SIZE, this.CONTENT_IMAGE_SIZE).center(this.CONTAINER_CENTER, this.CONTAINER_CENTER).fill(t), n.text(e[0].toUpperCase()).size(23).fill("#fff").attr({
			"font-weight": "bold",
			"font-family": "Roboto"
	...
	symbology;
	constructor(e) {
		super(e), this.geom = Ns.geom, this.proj = Ns.proj, this.shared = Ns.sharedUtils, this.map = new $a(e), this.layer = new uo(e), this.attributes = new Ho(e), this.query = new is(e), this.symbology = new rs(e), Array.isArray(o.request.interceptors) || (o.request.interceptors = []), o.request.interceptors.push({ before: (e) => {
	...
	"../fixtures/appbar/index.ts": () => import("./appbar-DJu5Ok9A.js"),
	"../fixtures/areas-of-interest/index.ts": () => import("./areas-of-interest-rLM3yEW4.js"),
	"../fixtures/basemap/index.ts": () => import("./basemap-BEHFoTA9.js"),
	"../fixtures/crosshairs/index.ts": () => import("./crosshairs-DRodskJh.js"),
	"../fixtures/details/index.ts": () => import("./details-CM9IbT0C.js"),
	"../fixtures/draw/index.ts": () => import("./draw-DGD_-Eno.js"),
	"../fixtures/export/index.ts": () => import("./export-JdFCl6G3.js"),
	"../fixtures/export-footnote/index.ts": () => import("./export-footnote-D7pRwYdw.js"),
	"../fixtures/export-legend/index.ts": () => import("./export-legend-BkOVY4VY.js"),
	"../fixtures/export-map/index.ts": () => import("./export-map-fgWlKFTr.js"),
	"../fixtures/export-northarrow/index.ts": () => import("./export-northarrow-BN4fHohe.js"),
	"../fixtures/export-scalebar/index.ts": () => import("./export-scalebar-Dn0UfuNG.js"),
	"../fixtures/export-timestamp/index.ts": () => import("./export-timestamp-BJg6WULH.js"),
	"../fixtures/export-title/index.ts": () => import("./export-title-qJq6C9Qa.js"),
	"../fixtures/extentguard/index.ts": () => import("./extentguard-BocHHu59.js"),
	"../fixtures/gazebo/index.ts": () => import("./gazebo-DjIYUUSM.js"),
	"../fixtures/geosearch/index.ts": () => import("./geosearch-DQ703b0V.js"),
	"../fixtures/grid/index.ts": () => import("./grid-CeQASPF-.js"),
	"../fixtures/help/index.ts": () => import("./help-BVt93g6J.js"),
	"../fixtures/hilight/index.ts": () => import("./hilight-Bcs2BovQ.js"),
	"../fixtures/keyboardnav/index.ts": () => import("./keyboardnav-eF9ngZmi.js"),
	"../fixtures/layer-reorder/index.ts": () => import("./layer-reorder-BfFqSm-j.js"),
	"../fixtures/legend/index.ts": () => import("./legend-CHIs92wo.js"),
	"../fixtures/mapnav/index.ts": () => import("./mapnav-D3QSmgKT.js"),
	"../fixtures/metadata/index.ts": () => import("./metadata-BC73b65N.js"),
	"../fixtures/northarrow/index.ts": () => import("./northarrow-oI7zaiw5.js"),
	"../fixtures/overviewmap/index.ts": () => import("./overviewmap-BBVmozBT.js"),
	"../fixtures/panguard/index.ts": () => import("./panguard-C6zMrfG1.js"),
	"../fixtures/scrollguard/index.ts": () => import("./scrollguard-CHxThO94.js"),
	"../fixtures/settings/index.ts": () => import("./settings-Dm82_RRp.js"),
	"../fixtures/snowman/index.ts": () => import("./snowman-Bt9Dfd00.js"),
	"../fixtures/swipe/index.ts": () => import("./swipe-hN_TkrXU.js"),
	"../fixtures/wizard/index.ts": () => import("./wizard-DMNnxTYC.js")
}), ss = class extends X {
	constructor(e) {
		super(e);
	}
	...
	async add(e, t) {
		...
		if (t) {
			...
			let t = (await os[`../fixtures/${e}/index.ts`]()).default;
			n = new t(e, this.$iApi);
		}
	...
	register(e, t) {
		...
		let r = Object.entries(n).reduce((e, [t, n]) => (e.push(new hs(this.$iApi, t, n)), e), []);
	...
	open(e) {
		let t, n, r;
		if (typeof e == "string" || e instanceof hs ? t = this.get(e) : (t = this.get(e.id), {screen: n, props: r} = e), !t) return t;
	...
	toggle(e, t) {
		let n;
		return n = typeof e == "string" || e instanceof hs ? this.get(e) : this.get(e.id), n && (t = t === void 0 ? !n.isVisible : t, t === n.isVisible ? n : t ? this.open(e) : this.close(n));
	}
	toggleMinimize(e, t) {
		let n;
		return n = typeof e == "string" || e instanceof hs ? this.get(e) : this.get(e.id), n && (t = t === void 0 ? !n.isVisible : t, t === n.isVisible ? n : t ? this.open(n) : this.minimize(n));
	}
	pin(e, t) {
		let n = this.get(e);
...
var ps = /* @__PURE__ */ n(ds, [["render", fs], ["__scopeId", "data-v-a3c61802"]]), ms = /* @__PURE__ */ Object.assign({
	"../fixtures/areas-of-interest/screen.vue": () => import("./screen-55uU0hAv.js"),
	"../fixtures/basemap/screen.vue": () => import("./screen-B74TurDx.js"),
	"../fixtures/export/screen.vue": () => import("./screen-DyWAtzzy.js"),
	"../fixtures/geosearch/screen.vue": () => import("./screen-C6YIIQEI.js"),
	"../fixtures/grid/screen.vue": () => import("./screen-G8BLgjKW.js"),
	"../fixtures/help/screen.vue": () => import("./screen-CDIhtnqn.js"),
	"../fixtures/layer-reorder/screen.vue": () => import("./screen-CdplPqSH.js"),
	"../fixtures/legend/screen.vue": () => import("./screen-ZTqBvAsq.js"),
	"../fixtures/metadata/screen.vue": () => import("./screen-DB1XauWE.js"),
	"../fixtures/settings/screen.vue": () => import("./screen-4aA1N1fJ.js"),
	"../fixtures/wizard/screen.vue": () => import("./screen-DRkGVOaL.js")
}), hs = class extends X {
	id;
	screens;
	loadedScreens = [];
	...
	registerScreen(e) {
		...
		if (zt(t) || Rt(t)) n = t, this.loadedScreens.push(e);
			...
			let r;
			r = typeof t == "string" ? ms[`../fixtures/${t}`]() : t();
...
function vs(e) {
	...
	return Ts(e.services, t), ys(e.map, t), Es(e.ui, t), e.plugins && Ds(e.plugins, t), t;
}
function ys(e, t) {
	if (e.layers && e.layers.forEach((e) => {
		t.layers.unshift(Ss(e));
	...
	})) : t.fixtures.legend = { root: bs(e.legend.root) });
}
function bs(e) {
	let t = {
		name: e.name,
	...
	return e.controls && e.controls.length > 0 && (t.controls = ws(e.controls, n), e.controls.includes("visibility") && t.controls.push("visibilityButton"), (e.controls.length !== 1 || e.controls[0] !== "visibility") && console.warn("Legend entry groups currently support only the visibility control. All other controls are currently not supported."), t.controls.push("expandButton")), e.disabledControls && e.disabledControls.length > 0 && (t.disabledControls = ws(e.disabledControls, n), e.disabledControls.includes("visibility") && t.disabledControls.push("visibilityButton"), (e.disabledControls.length !== 1 || e.disabledControls[0] !== "visibility") && console.warn("Legend entry groups currently support only the visibility control. All other controls are currently not supported.")), e.children.forEach((e) => {
		if (e.layerId) t.children.push(xs(e));
			...
			e.collapse !== void 0 && console.warn(`collapse property in visibilitySet in children list of legend entry group ${t.name} cannot be mapped and will be skipped.`), e.exclusiveVisibility.forEach((e) => {
				e.layerId ? n.children.push(xs(e)) : n.children.push(bs(e));
			}), t.children.push(n);
		} else t.children.push(bs(e));
	}), t;
}
function xs(e) {
	let t = e, n = [
	...
	return e.controls && e.controls.length > 0 && (t.layerControls = ws(e.controls, n), t.layerControls.push("symbology")), e.disabledControls && e.disabledControls.length > 0 && (t.disabledLayerControls = ws(e.disabledControls, n)), e.controlledIds && (console.warn(`controlledIds property defined in legend entry ${e.layerId} cannot be mapped and will be skipped.`), delete t.controlledIds), e.entryIndex && (t.sublayerIndex = e.entryIndex, delete e.entryIndex), e.entryId && console.warn(`entryId property defined in legend entry ${e.layerId} cannot be mapped and will be skipped.`), t;
}
function Ss(e) {
	let t = Cs(e);
...
console.info(`RAMP v${{
	...
	minor: "19",
	patch: "0-beta",
	timestamp: "Fri Mar 13 14:40:44 2026 -0400",
	hash: "8abcf10134b224ae8a18d55ae63dcdc2f1229a37"
}.major}.${{
	major: "4",
	minor: "19",
	patch: "0-beta",
...
var Ms = (e, t, n) => new Ka(e, t, n), Ns = new Lt();
//#endregion
export { q as $, pa as A, Z as B, Ra as C, Pa as D, Fa as E, Zn as F, Ht as G, Kt as H, Xn as I, Y as J, X as K, vn as L, na as M, ta as N, Ma as O, Qn as P, J as Q, pn as R, La as S, Na as T, Wt as U, qt as V, Ut as W, St as X, Tt as Y, bt as Z, Ua as _, ks as a, ne as at, Ba as b, Po as c, W as ct, fo as d, H as dt, c as et, lo as f, G as ft, Wa as g, $ as h, rt as ht, js as i, te as it, ra as j, Ta as k, vo as l, nt as lt, Ga as m, R as mt, Ms as n, f as nt, hs as o, re as ot, Za as p, U as pt, Pt as q, Ns as r, p as rt, cs as s, ft as st, As as t, d as tt, _o as u, dt as ut, Ha as v, Ia as w, za as x, Va as y, ln as z };
