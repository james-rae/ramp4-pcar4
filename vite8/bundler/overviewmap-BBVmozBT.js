import { B as e, _ as t, p as n, s as r } from "./main-dpIMyHMK.js";
import { t as i } from "./config-Dy8o8ei4.js";
...
var C = class extends r {
	...
	setup(r) {
		...
		m(async () => {
			...
			I.push(C.event.on(e.MAP_EXTENTCHANGE, x(100, (e) => {
				t.then(() => {
					N.updateOverview(e);
				});
			}))), I.push(C.event.on(e.MAP_CREATED, () => {
				B();
