import { B as e, K as t, c as n, l as r, mt as i, s as a, u as o } from "./main-dpIMyHMK.js";
import { t as s } from "./config-Dy8o8ei4.js";
...
var f = class extends t {
	...
	deconstructGraphicKey(e) {
		let t = e.split("~");
		return t.length !== 4 && console.warn("Malformed Hilight Graphic key provided:", e), {
			origin: t[1],
			uid: t[2],
			oid: parseInt(t[3])
		};
