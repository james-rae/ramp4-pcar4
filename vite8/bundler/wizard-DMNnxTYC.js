import { K as e, m as t, mt as n, q as r, s as i } from "./main-dpIMyHMK.js";
...
var s = class extends i {
	...
	mapWmsLayerList(e, t) {
		let n = [];
		return e.forEach((e) => {
			e.name === null && e.layers ? n = [...n, ...e.layers] : n.push(e);
		}), t ? n.flatMap((e) => ({
	...
	added() {
		this.$iApi.panel.register({ wizard: {
			screens: { "wizard-screen": () => a(import("./screen-DRkGVOaL.js")) },
			button: {
