import { B as e, J as t, L as n, U as r, ct as i, lt as a, o, pt as s, ut as c, z as l } from "./main-dpIMyHMK.js";
import { n as u } from "./config-Dy8o8ei4.js";
import { t as d } from "./_plugin-vue_export-helper-B52Kst-M.js";
import "./store-BSbISna5.js";
import { n as ee, t as te } from "./table-state-manager-Df0xzYKv.js";
...
import { debounce as de } from "throttle-debounce";
...
var z = ["onClick"], Te = { class: "md-icon-small flex w-full" }, B = { class: "flex-1 truncate whitespace-nowrap overflow-hidden pr-4" }, Ee = /* @__PURE__ */ v({
	...
	setup(e) {
		...
		return se(() => {
			...
			N(g("input", {
				class: b(["m-0 py-1 w-1/2 rv-input bg-white text-black-75 h-24 py-16 px-8 border-2 rounded", { "cursor-not-allowed": o.value }]),
				type: "date",
	...
	setup(o) {
		...
		let c = [
			...
			})), W.value.push(u.event.on(e.MAP_EXTENTCHANGE, de(100, () => {
				z.value.state.filterByExtent && Q();
			}))), W.value.push(u.event.on(e.LAYER_REMOVE, (e) => {
...
}), [["__scopeId", "data-v-7664f6eb"]]), qt = /* @__PURE__ */ d(/* @__PURE__ */ v({
	__name: "screen",
	props: { panel: {
		type: o,
		required: !0
