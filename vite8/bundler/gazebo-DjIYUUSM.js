import { s as e } from "./main-dpIMyHMK.js";
...
var m = /* @__PURE__ */ i({
	...
	setup(e) {
		return (i, a) => {
			...
			return c(), t(o, { panel: e.panel }, {
				header: f(() => a[1] ||= [r(" Gazebo/Panel 1/Screen A ")]),
				controls: f(() => a[2] ||= [
	...
	setup(e) {
		return (i, a) => {
			let o = l("panel-screen");
			return c(), t(o, { panel: e.panel }, {
				header: f(() => a[1] ||= [r(" Gazebo/Panel 1/Screen B ")]),
				content: f(() => [n("div", _, [
					n("button", {
						type: "button",
	...
	setup(e) {
		...
		return (i, a) => {
			...
			return c(), t(s, { panel: e.panel }, {
				header: f(() => a[2] ||= [r(" Gazebo/Panel 2/Screen B ")]),
				content: f(() => [
					r(u(d(o)("gz.hello2")) + " ", 1),
					n("div", y, [n("button", {
						type: "button",
	...
	setup(e) {
		...
		return (a, o) => {
			let s = l("panel-screen");
			return c(), t(s, { panel: e.panel }, {
				header: f(() => o[1] ||= [r(" Gazebo/Panel 2/Screen C ")]),
				content: f(() => [n("div", S, [
					n("button", {
						type: "button",
	...
	added() {
		this.$iApi.event.registerEventName(O), this.$iApi.component("gazebo-appbar-button", m), this.$iApi.panel.register({
			...
			config: {
				screens: {
					"p-2-screen-1": () => new Promise((e) => setTimeout(() => import("./p2-screen-1-Cse-qUFt.js").then((t) => {
						e(t);
					}), 2e3)),
					"p-2-screen-2": o(x),
