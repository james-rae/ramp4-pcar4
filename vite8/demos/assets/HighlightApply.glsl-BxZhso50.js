import{n as e}from"./glsl-DekshC-y.js";import{t}from"./FloatPassUniform-vL0DHm2c.js";import{t as n}from"./Texture2DPassUniform-DU218mDy.js";import{t as r}from"./ShaderBuilder-C_I7fgZQ.js";import{t as i}from"./HighlightCellGridScreenSpacePass.glsl-Be0mlFsp.js";import{t as a}from"./IntegerPassUniform-DB8TpXmO.js";import{a as o,s}from"./HighlightDownsample.glsl-ChVubFb_.js";import{t as c}from"./HighlightReadBitmap.glsl-BP60q1sG.js";import{t as l}from"./Float2DrawUniform-C7VViJPy.js";function u(){let u=new r;u.include(i);let{fragment:d}=u;return d.uniforms.add(new n(`blurInput`,e=>e.highlightBlurTexture),new l(`blurSize`,e=>e.blurSize),new s(`highlightTexture`,e=>e.highlightTexture),new n(`highlightOptionsTexture`,e=>e.highlightOptionsTexture),new a(`highlightLevel`,e=>e.highlightLevel),new t(`occludedIntensityFactor`,e=>e.occludedFactor)),d.constants.add(`inner`,`float`,1-(9-o)/9),u.include(c),d.main.add(e`vec2 highlightTextureSize = vec2(textureSize(highlightTexture,0));
vec2 uv = sUV;
