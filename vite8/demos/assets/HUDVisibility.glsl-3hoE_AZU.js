import{n as e}from"./glsl-DekshC-y.js";import{t}from"./FloatPassUniform-vL0DHm2c.js";import{t as n}from"./Float4BindUniform-D3h3ShYf.js";import{t as r}from"./Texture2DBindUniform-DvgOfr6_.js";import{t as i}from"./FloatBindUniform-VYYY-QBe.js";import{n as a,t as o}from"./ScreenSizePerspective.glsl-B3_XDZ3w.js";import{i as s,n as c,r as l,t as u}from"./View.glsl-CpVtepGZ.js";import{n as d}from"./VerticalOffset.glsl-DrwgTJRP.js";import{t as f}from"./BooleanBindUniform-Kj3GWJLT.js";var p=.5;function m(r,f){r.include(a),r.attributes.add(`position`,`vec3`),r.attributes.add(`normal`,`vec3`),r.attributes.add(`centerOffsetAndDistance`,`vec4`);let p=r.vertex;c(p,f),u(p,f),p.uniforms.add(new n(`viewport`,e=>e.camera.fullViewport),new t(`polygonOffset`,e=>e.shaderPolygonOffset),new i(`aboveGround`,e=>e.camera.aboveGround?1:-1)),f.hasVerticalOffset&&d(p),p.code.add(e`struct ProjectHUDAux {
vec3 posModel;
vec3 posView;
vec3 vnormal;
