...
import { p as Me, o as y, Z as Se, a as Ie, a1 as I, G as Q, _ as se, Q as Te, n as ze, a3 as b, a4 as G, S as Ee, a5 as F, a6 as ne } from "./main-klwSAI5R.js";
import "pinia";
  ...
  setup(e, { emit: T }) {
    const { t: i } = re(), c = ue("iApi"), f = H(), A = H(!1), s = Ie(), L = H(s.mobileView), E = T, U = H(0), v = e, Y = () => {
      ...
      if (v.legendItem.layerControlAvailable(I.Metadata) && M("metadata")) {
        ...
        if (g.url) {
          const P = g.url.split("."), V = P[P.length - 1], te = V === "xml" || V === "md" ? V : "html";
    ...
    }, O = R(() => v.legendItem.layerControlAvailable(I.Reload) && v.legendItem instanceof y && S(v.legendItem.layer)?.canReload), ee = (g) => {
...
}), Oe = /* @__PURE__ */ se(De, [["__scopeId", "data-v-d623c1ee"]]), je = { key: 0 }, Fe = {
  key: 0,
