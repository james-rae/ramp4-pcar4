...
import { Attributes, AttributeSet, BaseGeometry, CompactJson, EsriArcadeVarType, Extent, FieldDefinition, GetGraphicServiceDetails, RampLayerFieldInfoConfig, RampLayerFieldMetadataConfig, TabularAttributeSet, GeometryType, Graphic } from '../api';
...
export declare class AttributeAPI extends APIScope {
     ...
     */
    arcadeGenerator(layer: LayerInstance, formula: string): Promise<__esri.ArcadeExecutor>;
    /**
     ...
     */
    applyFieldMetadata(layer: LayerInstance, fieldMetadata?: RampLayerFieldMetadataConfig | undefined): Promise<void>;
    /**
