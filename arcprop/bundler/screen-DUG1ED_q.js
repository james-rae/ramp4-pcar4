import { defineComponent as X, inject as j, ref as $, computed as R, reactive as v, onMounted as D, watch as O, onBeforeUnmount as V, resolveComponent as F, openBlock as r, createBlock as B, withCtx as k, createTextVNode as q, toDisplayString as c, unref as f, createElementBlock as d, createElementVNode as u } from "vue";
import { r as U, G } from "./main-klwSAI5R.js";
import "pinia";
  ...
  setup(i) {
    ...
    return (t, e) => {
      ...
      return r(), B(a, {
        ...
        header: k(() => [
          q(c(f(o)("metadata.title")) + ": " + c(i.payload.layerName), 1)
        ]),
        content: k(() => [
          C.value ? (r(), d("div", Z, [
            u("div", tt, [
              w.value == "loading" ? (r(), d("div", et, c(f(o)("metadata.loading")), 1)) : i.payload.type === "xml" && w.value == "success" ? (r(), d("div", {
                key: 1,
                innerHTML: y.value,
                ...
                u("span", st, c(f(o)("metadata.error")), 1)
              ]))
            ])
          ])) : (r(), d("div", ot, [
            u("span", null, c(f(o)("metadata.label.no.layer")), 1)
          ]))
        ]),
        _: 1
      }, 8, ["panel"]);
