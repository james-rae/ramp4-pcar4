import { TinyEmitter as us } from "tiny-emitter";
import { defineStore as V, createPinia as ps } from "pinia";
import { ref as f, computed as P, markRaw as ee, defineComponent as O, inject as ge, reactive as we, watch as _t, onBeforeUnmount as ht, resolveDirective as k, withDirectives as M, openBlock as v, createElementBlock as A, withKeys as ds, withModifiers as ei, onMounted as Je, normalizeClass as ie, normalizeStyle as Pi, createVNode as oe, Transition as Ni, withCtx as se, createBlock as W, resolveDynamicComponent as hs, mergeProps as fs, useCssVars as ms, TransitionGroup as Fi, Fragment as He, renderList as ft, unref as I, nextTick as kt, renderSlot as Me, createElementVNode as m, vShow as ys, resolveComponent as Z, createTextVNode as nt, toDisplayString as U, createCommentVNode as B, onUpdated as gs, Teleport as vs, getCurrentInstance as bs, useTemplateRef as yi, createApp as Di, toRaw as Ie, h as ws, render as zt, defineAsyncComponent as As } from "vue";
import Tt from "@arcgis/core/Color";
import mt from "@arcgis/core/config";
import { watch as be } from "@arcgis/core/core/reactiveUtils.js";
import gi from "@arcgis/core/geometry/Extent";
import Es from "@arcgis/core/geometry/Multipoint";
import xs from "@arcgis/core/geometry/Point";
import ti from "@arcgis/core/geometry/Polygon";
import Gi from "@arcgis/core/geometry/Polyline";
import Ss from "@arcgis/core/geometry/SpatialReference";
import { fromJSON as Is } from "@arcgis/core/geometry/support/jsonUtils";
import _s from "@arcgis/core/Graphic";
import ze from "@arcgis/core/request";
import Ts from "@arcgis/core/symbols/PictureMarkerSymbol";
import Ls from "@arcgis/core/symbols/SimpleFillSymbol";
import Rs from "@arcgis/core/symbols/SimpleLineSymbol";
...
class Ee {
  ...
  id;
  constructor(e, t, i) {
    this.geometry = e, t ? this.id = t : this.id = pt.sharedUtils.generateUUID(), i ? this.attributes = i : this.attributes = {};
  }
  _hover;
...
class ae extends Ke {
  ...
  constructor(e, t, i, r) {
    super(e, t.sr || i), r ? this.rawArray = ae.arrayDeepCopy(t) : this.rawArray = ae.parsePolygon(t);
  }
  addLinearRings(e) {
  ...
  static fromESRI(e, t) {
    return new ae(t, e.rings, _.fromESRI(e.spatialReference), !0);
  }
  toESRI() {
    return new ti({
      rings: this.toArray(),
  ...
  static fromGeoJSON(e, t) {
    return new ae(t, e.coordinates, _.fromGeoJSON(e.crs), !0);
  }
  toGeoJSON() {
    return this.geoJsonFactory(z.POLYGON, this.toArray());
  }
...
class Oe extends Ke {
  ...
  get polygonArray() {
    return this.rawArray.map((e, t) => new ae(this.childIdGenerator(t), e, this.sr, !0));
  }
  ...
  static parseMultiPolygon(e) {
    ...
    if (e instanceof ve || e instanceof de)
      return [ae.parsePolygon(e)];
    if (Array.isArray(e)) {
      if (e.length === 0)
        throw new Error("no polygons provided");
      return e.map((t) => ae.parsePolygon(t));
    } else
...
class G extends Ke {
  ...
  toPolygon() {
    return new ae(this.id, this.toPolygonArray(), this.sr, !0);
  }
  ...
  static fromArcServer(e, t) {
    return G.fromESRI(gi.fromJSON(e), t);
  }
...
class Ge extends ke {
  ...
  toESRI() {
    let e;
    return this.styleType === $e.ICON ? Ge.isImageUrl(this.icon) ? (e = new Ts(), e.url = this.icon, e.width = this.width, e.height = this.height, e.xoffset = this.xOffset, e.yoffset = this.yOffset, e.angle = this.angle) : (e = new Yt(), e.color = new Tt(this.colour.rgba), e.size = this.width, e.xoffset = this.xOffset, e.yoffset = this.yOffset, e.angle = this.angle) : (e = new Yt(), e.color = new Tt(this.colour.rgba), e.size = this.size, e.xoffset = this.xOffset, e.yoffset = this.yOffset, e.angle = this.angle, e.path = this.path, e.style = this.styleType, e.outline = this.outline.toESRI()), e;
  }
  static fromESRI(e) {
    const t = {
      xOffset: e.xoffset,
...
class Te extends ke {
  ...
  constructor(e) {
    ...
    this._width = typeof t > "u" || t < 0 ? 0.75 : t, this._colour = new Pe(e.colour), this._miter = e.miter ?? 2, this._cap = e.cap || zi.ROUND, this._join = e.join || Vi.ROUND;
  }
...
class gt extends ke {
  ...
  _fillStyle;
  constructor(e) {
    super(), e = e || {}, e.fill || (e.fill = {}), this._fillColour = new Pe(e.fill.colour), this._fillStyle = e.fill.style || qi.SOLID, this._outlineStyle = new Te(e.outline);
  }
  /** Returns the specified colour */
  get fillColour() {
  ...
  toESRI() {
    const e = this.outline.toESRI(), t = new Tt(this.fillColour.rgba), i = new Ls();
...
class vt {
  ...
  clone() {
    return new vt(this.id, this._defaultExtent, this._fullExtent, this._maximumExtent);
  }
}
class H {
  realPromise;
...
class zs {
  ...
  async projectGeometry(e, t) {
    ...
    const i = t.toGeoJSON(), r = await this.projectGeoJson(i, this.normalizeProj(t.sr), this.normalizeProj(e)), a = pt.geom.geomGeoJsonToRamp(r, t.id);
  ...
  async projectExtent(e, t) {
    ...
    const o = new ae("warpy", [a], t.sr, !0), l = await this.projectGeometry(e, o), n = l.toArray().pop() || [], c = n.map((y) => y[0]), u = n.map((y) => y[1]), p = Math.min.apply(null, c), d = Math.max.apply(null, c), g = Math.min.apply(null, u), h = Math.max.apply(null, u);
...
class qs {
  ...
  sharedUtils;
  constructor() {
    this.proj = new zs(), this.geom = new Us(), this.sharedUtils = new Bs();
  }
  defaultTileSchemas() {
...
const Ct = V("appbar", () => {
  ...
  const s = f([]), e = f([]), t = f([]);
  function i(p) {
    return qt(s.value, (d) => d?.uid === p);
  }
  function r(p) {
    return qt(s.value, (d) => d?.id === p);
  }
  function a(p) {
    return qt(
      s.value,
...
class Js extends J {
  ...
  _funCounter;
  constructor(e) {
    super(e), this._eventBus = new us(), this._eventRegister = [], this._funCounter = 1, this._nameRegister = Object.values(E).filter((t) => typeof t == "string" && t.indexOf("/") > -1);
  }
  /**
  ...
  defaultHandlerFactory(e) {
    ...
    switch (e) {
      ...
      case "ramp_layer_remove_checks_grid":
        t = (i) => {
          if (this.$iApi.fixture.get("grid")) {
            const r = Jt(this.$vApp.$pinia), a = r.getGridId(i.id);
            if (a === void 0) return;
      ...
      case "ramp_map_resize_updates_scalebar":
        this.$iApi.event.on(
          "map/resized",
          Lt(100, () => this.$iApi.geo.map.caption.updateScale()),
          e
        );
        break;
      case "ramp_map_scale_updates_scalebar":
        this.$iApi.event.on(
          "map/scalechanged",
          Lt(300, () => this.$iApi.geo.map.caption.updateScale()),
          e
        );
        break;
      case "ramp_panel_close_updates_appbar":
        t = (i) => {
          const r = Ct(this.$vApp.$pinia);
...
const Ot = V("maptip", () => {
  ...
  __name: "esri-map",
  setup(s) {
    const e = Ot(), t = ge("iApi"), i = P(() => e.maptipPoint), r = P(() => e.maptipInstance), a = P(() => e.content), o = we([]), l = f(!1);
    o.push(
      _t(i, () => {
        if (i.value) {
  ...
  constructor(e) {
    this.resizeObserver = new ResizeObserver((t) => {
      t.length && window.requestAnimationFrame(() => {
        t.forEach((i) => {
          const r = i.target.dataset.breakpoints, a = r ? JSON.parse(r) : e ?? er;
...
const tr = ["data-cy"], Ki = /* @__PURE__ */ O({
    ...
    return (n, c) => {
      ...
      return v(), A("div", {
        ...
        oe(Ni, {
          ...
          default: se(() => [
            M((v(), W(hs(s.panel.route.screen), fs({ class: "h-full" }, s.panel.route.props, { panel: s.panel }), null, 16, ["panel"])), [
              [u]
            ])
          ]),
          _: 1
  ...
  function Q() {
    let S = t.value;
    const R = [], he = 350, et = 12, fi = 600;
    for (let Fe = n.value.length - 1; Fe >= 0; Fe--) {
      const tt = n.value[Fe];
      let Re = tt.width || he;
      if (r.value ? Re = S : Re += et, tt.id === "grid" && (Re = Math.max(Math.min(Re, S), fi)), (S >= Re && !r.value || R.length === 0) && (S -= Re, R.unshift(tt)), tt.id === "grid" && S < fi)
        break;
    }
    if (s.value && //@ts-expect-error TODO: explain why this is needed or remove
    !R.includes(s.value) && !r.value) {
      let Fe;
      for (let mi = 0; mi < R.length - 1 && S < (s.value.width || he) + et; mi++)
  ...
  function Gt(S, R) {
    const he = n.value.indexOf(S), et = R === "right" ? 1 : -1;
    u.value.includes(n.value[he + et]) && ([n.value[he], n.value[he + et]] = [
      n.value[he + et],
      n.value[he]
    ]);
  }
  ...
  setup(s) {
    ...
    const e = Ye(), t = ge("iApi"), i = f(), r = P(() => e.opacity), a = P(() => e.mobileView);
    Je(() => {
    ...
    return (u, p) => (v(), W(Fi, {
      ...
      default: se(() => [
        (v(!0), A(He, null, ft(o(I(t).screenSize), (d) => (v(), W(Ki, {
          key: `${d.id}`,
          panel: d
        }, null, 8, ["panel"]))), 128))
      ]),
  ...
  for (const [i, r] of e)
    t[i] = r;
  return t;
}, sr = /* @__PURE__ */ Ne(ir, [["__scopeId", "data-v-717e4bd7"]]), rr = ["content", "aria-label"], si = /* @__PURE__ */ O({
  ...
  setup(s) {
    ...
    return Je(() => {
      window.addEventListener(
        ...
        (!r.value || !r.value.contains(p.target)) && (e.value = !1);
      }), o.value.addEventListener("focus", c), o.value.addEventListener("blur", u), o.value.addEventListener("mouseover", c), o.value.addEventListener("mouseleave", u), kt(() => {
        const p = {
          name: "overflowScroll",
          enabled: !0,
          phase: "main",
        ...
        o.value && a.value && (t.value = Ns(o.value, a.value, {
  ...
  function r(c) {
    if (s.value.includes(c)) {
      ...
      c instanceof Zi && n(c), u > -1 && s.value.splice(u, 1);
    }
  }
  function a(c) {
    e.value[c.id] = c;
...
}), ar = { class: "h-full flex flex-col" }, or = { class: "w-full flex mb-6" }, nr = ["content", "aria-label"], lr = /* @__PURE__ */ O({
  __name: "screen",
  props: {
    panel: {
      type: Object,
...
class cr extends J {
  ...
  addGroup(e, t, i) {
    ...
    const r = new Zi(this.$iApi, e, t, i);
...
const ur = ["content"], pr = { class: "flex items-center text-left" }, dr = { class: "select-text cursor-text" }, hr = ["content"], fr = {
  key: 0,
  class: "text-left"
}, mr = /* @__PURE__ */ O({
      ...
      return M((v(), A("li", {
        ...
        m("div", pr, [
          m("span", null, [
            ...
            m("span", dr, U(s.notification.message), 1)
          ]),
          ...
          M((v(), A("button", {
            type: "button",
            onClick: c[0] || (c[0] = ei((p) => o(s.notification), ["stop"])),
        ...
        s.notification.messageList && r.value ? (v(), A("div", fr, [
          (v(!0), A(He, null, ft(s.notification.messageList, (p, d) => (v(), A("p", {
    ...
    return (l, n) => {
      ...
      return v(), A("div", null, [
        o.value.length > 0 ? M((v(), A("ul", {
          ...
          (v(!0), A(He, null, ft(o.value, (d, g) => (v(), A(He, {
            key: d.message + g
          }, [
            g > 0 ? (v(), A("div", gr)) : B("", !0),
            M(oe(mr, {
...
}), br = { class: "flex items-center hover:text-white" }, wr = ["aria-label"], Ar = {
  key: 0,
  class: "number rounded-full w-18 text-white"
}, Er = { class: "notification-dropdown pointer-events-auto bg-white rounded text-center text-black w-500 h-256 flex flex-col p-0" }, xr = { class: "pb-8 border-b border-gray-600" }, Sr = { class: "absolute flex right-3 top-3" }, Ir = ["content", "aria-label"], _r = /* @__PURE__ */ O({
      ...
      return v(), W(si, {
        ...
        header: se(() => [
          m("div", br, [
            ...
            i.value && i.value > 0 ? (v(), A("span", Ar, U(i.value), 1)) : B("", !0)
          ])
        ]),
        default: se((c) => [
          m("div", Er, [
            m("div", null, [
              m("h4", xr, U(I(t)("notifications.title")), 1),
              m("div", Sr, [
                M((v(), A("button", {
                  type: "button",
                  onClick: r,
            ...
            oe(Xi, { class: "overflow-y-auto h-230" })
          ])
        ]),
        _: 1
      }, 8, ["tooltip"]);
...
}), Tr = /* @__PURE__ */ Ne(_r, [["__scopeId", "data-v-3623a7d2"]]), Lr = { class: "flex hover:text-white" }, Rr = ["aria-label"], $r = { class: "about-ramp-dropdown pointer-events-auto bg-white rounded w-256 h-50" }, Cr = ["aria-label", "content"], Or = { class: "pb-8 border-b border-gray-600 mb-10" }, kr = { class: "absolute right-5 top-5" }, Mr = { class: "select-text" }, Pr = { class: "font-bold cursor-text" }, Nr = { class: "text-sm cursor-text" }, Fr = { class: "font-bold cursor-text" }, Dr = { class: "ml-5 cursor-text" }, Gr = /* @__PURE__ */ O({
  ...
  setup(s) {
    const { t: e } = Y(), t = ge("iApi"), i = () => {
      t.reload();
    }, r = P(() => `${yt.major}.${yt.minor}.${yt.patch}`), a = P(() => yt.hash.slice(0, 9)), o = P(() => {
      const l = new Date(yt.timestamp);
      if (isNaN(l.getTime()))
        ...
        default: se((g) => [
          m("div", $r, [
            m("div", null, [
              ...
              m("div", Mr, [
                m("div", null, [
                  m("span", Pr, U(r.value), 1),
                  m("span", Nr, " [" + U(a.value) + "] ", 1)
                ]),
                m("div", null, [
                  m("span", Fr, U(o.value[0]), 1),
                  m("span", Dr, U(o.value[1]), 1)
                ]),
...
}), Ur = /* @__PURE__ */ Ne(Gr, [["__scopeId", "data-v-24f3a9dc"]]), Br = { class: "map-caption absolute bottom-0 h-29 sm:h-38 flex justify-end pointer-events-auto cursor-default select-none text-gray-200 bg-black-75 left-0 right-0 py-2 sm:py-6" }, Vr = {
  key: 0,
  class: "relative top-2 sm:top-1 ml-4 sm:ml-0 shrink-0"
}, zr = ["href", "aria-label"], qr = ["src", "alt"], jr = {
  key: 1,
  class: "relative ml-10 top-2 text-sm sm:text-base"
}, Wr = { class: "flex min-w-fit justify-end" }, Hr = {
  key: 0,
  class: "pl-8 px-14 sm:block display-none relative top-2"
}, Yr = ["aria-pressed", "aria-label", "content"], Jr = { class: "relative top-1 text-sm sm:text-base" }, Kr = { class: "text-gray-200 hover:text-white text-sm sm:text-base pb-5" }, Zr = ["onClick"], Xr = {
  key: 0,
  class: "sr-only"
}, Qr = /* @__PURE__ */ O({
  __name: "map-caption",
  setup(s) {
    ...
    return (w, b) => {
      ...
      return v(), A("div", Br, [
        ...
        oe(Tr, { class: "sm:block display-none" }),
        d() ? (v(), A("span", Vr, [
          m("a", {
        ...
        o.value?.text.disabled ? B("", !0) : M((v(), A("span", jr, [
        ...
        m("div", Wr, [
          l.value?.disabled ? B("", !0) : M((v(), A("div", Hr, [
          ...
          a.value?.disabled ? B("", !0) : M((v(), A("button", {
            ...
            m("span", {
              ...
              style: Pi({ width: a.value?.width })
            }, null, 4),
            m("span", Jr, U(a.value?.label), 1)
          ], 8, Yr)), [
            [N, {
              delay: [300, 0],
              placement: "top",
          ...
          n.value?.disabled ? B("", !0) : (v(), W($, {
            ...
            header: se(() => [
              m("span", Kr, U(I(i)("map.language.short")), 1)
            ]),
            default: se(() => [
              (v(!0), A(He, null, ft(u.value, (F, Q) => (v(), A("a", {
                key: `${F}-${Q}`,
                ...
                F === I(r).$i18n.locale.value ? (v(), A("span", Xr, U(I(i)("map.language.curr")), 1)) : B("", !0)
              ], 10, Zr))), 128))
            ]),
            _: 1
          }, 8, ["tooltip", "ariaLabel"]))
  ...
  setup(s) {
    ...
    return (a, o) => {
      ...
      return M((v(), A("button", {
        ...
        r.value && r.value > 0 ? (v(), A("span", ta, U(r.value), 1)) : B("", !0)
      ], 8, ea)), [
        [l]
      ]);
    };
  }
}), sa = /* @__PURE__ */ Ne(ia, [["__scopeId", "data-v-a451db5c"]]), ra = { class: "flex items-center mb-20" }, aa = { class: "text-xl" }, oa = /* @__PURE__ */ O({
    ...
    return (c, u) => {
      ...
      return i.value ? (v(), A("div", {
        ...
        m("div", {
          ...
          m("div", ra, [
            m("h2", aa, U(I(t)("keyboardInstructions.title")), 1),
            oe(p, {
              class: "ml-auto",
              onClick: u[0] || (u[0] = (d) => i.value = !1)
            })
          ]),
          (v(!0), A(He, null, ft(r.value, (d) => (v(), A("p", {
...
}), rt = V("instance", () => ({ started: f(!1) })), na = { class: "h-full relative" }, la = { class: "inner-shell absolute top-0 left-0 h-full w-full pointer-events-none" }, ca = { class: "absolute top-8 w-full flex justify-center" }, ua = {
  key: 1,
  class: "w-full h-full"
}, pa = /* @__PURE__ */ O({
  __name: "shell",
  setup(s) {
    const e = ge("iApi"), t = rt(), i = ye(), r = Ye(), { t: a } = Y(), o = P(() => i.items.appbar), l = () => {
      e.event.emit("openKeyboardInstructions");
    }, n = () => r.teleported;
    return (c, u) => (v(), A("div", na, [
      m("div", la, [
        ...
        oe(oa, { class: "keyboard-instructions-modal" }),
        oe(sr, { class: "panel-stack sm:flex absolute inset-0 overflow-hidden sm:p-12 z-10 sm:pl-80 xs:pl-40 sm:pb-48 xs:pb-28 xs:pr-0 sm:pr-40" }),
        o.value ? B("", !0) : (v(), W(sa, { key: 0 })),
        oe(Qr, { class: "z-30" })
      ]),
      I(t).started ? (v(), W(Qs, { key: 0 })) : (v(), A("div", ua, u[1] || (u[1] = [
        m("div", { class: "spinner relative inset-x-1/2 inset-y-9/20" }, null, -1)
      ]))),
      (v(!0), A(He, null, ft(n(), (p) => (v(), W(vs, {
...
}), da = /* @__PURE__ */ Ne(pa, [["__scopeId", "data-v-3d441124"]]), ha = O({
  name: "App",
  components: { Shell: da },
  setup() {
    const s = bs();
    Je(() => {
      new Ji().observe(s?.proxy?.$refs["app-size"]), ks({
        aria: {
          content: "labelledby"
        },
        theme: "ramp4",
...
const ga = /* @__PURE__ */ Ne(ha, [["render", ya]]), Se = "focus-list", je = "focus-item", va = "focus-icon", ba = "focus-container", ut = `[${Se}],[${ba}]`, At = "truncate-text", Et = "show-truncate", ot = "focused", Zt = `button,input,select,a,textarea,[contenteditable],[${Se}],[${va}],[tabIndex]`, wa = {
  mounted(s, e) {
    +s.getAttribute("tabindex") <= 0 && s.setAttribute("tabindex", "0"), s.toggleAttribute(Se, !0), new Aa(s, e.value);
  },
  updated(s) {
    Qi(s);
  }
...
function Qi(s) {
  s.querySelectorAll(Zt).forEach((t) => {
...
class Aa {
  ...
  setTabIndex(e, t = this.element) {
    t.querySelectorAll(Zt).forEach((r) => {
   ...
   */
  defocusItem(e) {
    e.classList.remove(ot), this.setTabIndex(-1, e), e._tippy && e._tippy.hide(), e.getAttribute(je) === Et && e.querySelector(`[${At}]`)?._tippy?.hide();
  }
  /**
   ...
   */
  focusItem(e) {
    e.classList.add(ot), this.setAriaActiveDescendant(e), this.setTabIndex(0, e), e.scrollIntoView({ block: "nearest" }), e._tippy && !this.isTapped && e._tippy.show(), e.getAttribute(je) === Et && e.querySelector(`[${At}]`)?._tippy?.show(), this.isTapped = !1;
  }
  /**
    ...
    if (i.length !== 0)
      switch (e.key) {
        ...
        case " ":
          ...
          break;
        case "Tab":
          const r = this.highlightedItem.querySelectorAll(Zt).length === 0, a = this.element.isEqualNode(e.target);
   ...
   */
  onFocus() {
    this.highlightedItem && !this.isClicked && (this.highlightedItem._tippy && this.highlightedItem._tippy.show(), this.highlightedItem.getAttribute(je) === Et && this.highlightedItem.querySelector(`[${At}]`)?._tippy?.show()), this.isClicked = !1, this.element.hasAttribute("aria-activedescendant") || this.highlightedItem === this.element ? this.highlightedItem !== this.element && this.focusItem(this.highlightedItem) : this.setAriaActiveDescendant(this.highlightedItem), Qi(this.element), this.highlightedItem && this.highlightedItem !== this.element && this.highlightedItem.setAttribute("tabindex", "-1");
  }
  /**
   ...
   */
  onBlur() {
    this.highlightedItem && (this.highlightedItem._tippy && this.highlightedItem._tippy.hide(), this.highlightedItem.getAttribute(je) === Et && this.highlightedItem.querySelector(`[${At}]`)?._tippy?.hide());
  }
  /**
...
const Ai = "focus-item", Ea = {
  beforeMount(s, e) {
    s.hasAttribute("id") || s.setAttribute("id", xa()), e.value ? s.setAttribute(Ai, e.value) : s.toggleAttribute(Ai, !0);
  }
};
function xa() {
  let s;
...
const ri = "focus-container", es = "focus-list", Sa = "focus-icon", jt = `[${es}],[${ri}]`, Ei = `button,input,select,a,textarea,[contenteditable],.ag-tab-guard,[${es}],[${ri}],[${Sa}],[tabIndex]`;
let Wt = [];
const Ia = {
  mounted(s) {
    [...document.querySelectorAll(".inner-shell")].some((t) => t.contains(s)) && Wt.push(new _a(s));
  },
  beforeUnmount(s) {
    Wt = Wt.filter((e) => e.element === s ? (e.removeEventListeners(), !1) : !0);
  }
};
class _a {
  element;
...
const Ta = "truncate-text", La = "truncate-trigger", Ra = {
  beforeMount(s, e) {
    !s.classList.contains("truncate") && !e.value?.noTruncateClass && s.classList.add("truncate"), s.toggleAttribute(Ta, !0);
  },
  mounted(s, e) {
    let t;
    e.value && e.value.externalTrigger && (t = s.closest(`[${La}]`)), Ms(s, {
      content: xi(s.textContent),
      onShow: $a,
      allowHTML: !0,
      placement: "bottom-start",
      maxWidth: 320,
  ...
  updated(s, e) {
    s._tippy && (s._tippy.setContent(xi(s.textContent)), e.value && e.value.options && s._tippy.setProps(e.value.options));
  },
  unmounted(s) {
...
const Ca = ["content"], Oa = {
  ...
  setup(s, { expose: e }) {
    const { t } = Y(), i = Ye(), r = Ct(), a = ge("iApi"), o = yi("el"), l = yi("contentEl"), n = f();
    e({ el: o });
    ...
    return Je(() => {
      ...
      const T = Z("back"), N = Z("panel-options-menu"), F = Z("left"), Q = Z("right"), Qe = Z("pin"), Ft = Z("expand"), Dt = Z("minimize"), Gt = Z("close"), Ut = k("truncate"), Bt = k("focus-item"), S = k("tippy");
      return M((v(), A("div", {
        ...
        s.header ? (v(), A("header", Oa, [
          ...
          m("div", {
            ...
            s.panel.teleport ? B("", !0) : (v(), A("div", Pa, [
              d.value ? (v(), W(F, {
                key: 0,
              ...
              s.panel.controls && s.panel.controls.expand ? (v(), W(Ft, {
                key: 2,
                onClick: $[4] || ($[4] = (R) => s.panel.expand()),
                active: s.panel.expanded
              }, null, 8, ["active"])) : B("", !0)
            ])),
            s.panel.button && u.value?.includes(s.panel.id) ? (v(), W(Dt, {
              key: 1,
...
}), Ga = { class: "relative" }, Ua = ["content", "aria-label"], Ba = ["transform"], Va = /* @__PURE__ */ O({
  __name: "pin",
  props: {
    active: Boolean
  },
  ...
  setup(s) {
    return (e, t) => {
      ...
      return v(), A("div", go, [
        M((v(), A("button", {
          type: "button",
          class: ie(["w-full h-full default-focus-style", [s.showOutline ? "focus:outline focus:outline-2 focus:outline-blue-400" : "focus:outline-none"]]),
...
}), xo = /* @__PURE__ */ Ne(Eo, [["__scopeId", "data-v-1cb84ae1"]]), So = V("areas-of-interest", () => ({ areas: f([]) })), Io = V("export", () => {
  const s = f({
    title: !0,
    map: !0,
    mapElements: !0,
  ...
  constructor(e, t) {
    wt.get(t).then((i) => {
      i.data.definitions.forEach((r) => {
        xt[e][r.code] = r.term.split(`${r.code}-`)[1];
      }), Object.keys(xt[e]).forEach((r) => {
        this.allTypes[r] = xt[e][r], this.validTypes[r] = xt[e][r];
      }), this.typesFetched = !0;
    });
  }
...
async function ko(s, e) {
  ...
  return r.test(e) && !s.disabledSearchTypes.includes("LAT/LNG") ? (i = e.slice(0, -1), t = new St(s, i), await No(t)) : o.test(e) && !s.disabledSearchTypes.includes("FSA") ? (i = e.substring(0, 3).toUpperCase(), t = new St(s, i), await Fo(t)) : a.test(e) && !s.disabledSearchTypes.includes("NTS") ? (i = e.substring(0, 6).toUpperCase(), t = new St(s, i), await Do(t)) : (i = encodeURIComponent(e.trim()), t = new St(s, i), await Go(t)), t;
}
const ai = async (s) => {
  const [e, t] = await Ae(wt.get(s));
...
}, ts = (s, e) => e.filter((t) => s.types.validTypes[t.concise.code]).map((t) => ({
  name: t.name,
  flav: "nme",
  bbox: t.bbox,
  ...
  const [e, t] = await Ae(ai(oi(s, !0)));
  return e ? (console.error("Geolocation service failed"), s.failedServs.push("geolocation"), []) : t;
}, Mo = async (s) => {
  const [e, t] = await Ae(ai(oi(s, !1)));
  let i;
  e ? (console.error("GeoName service targeting Name failed"), s.failedServs.push("geoname"), i = []) : i = t.items, s.addResult(ts(s.config, i));
}, Po = async (s, e, t) => {
  const [i, r] = await Ae(ai(oi(s, !1, e, t)));
  let a;
  i ? (console.error("GeoName service targeting Lat Lon failed"), s.failedServs.push("geoname"), a = []) : a = r.items, s.addResult(ts(s.config, a));
}, No = async (s) => {
  ...
  if (await Mo(s), e.categories.length === 0 || e.categories.includes("ADDR")) {
    const t = await ni(s), i = e.sortOrder.indexOf("ADDR"), r = i >= 0 ? i : e.sortOrder.length, a = t.filter((o) => o.type?.includes("Street")).map((o) => {
...
}, Uo = "~FSA~", Si = "https://geogratis.gc.ca/services/geolocation/@{language}/locate", Ii = "https://geogratis.gc.ca/services/geoname/@{language}/geonames.json", _i = "https://geogratis.gc.ca/services/geoname/@{language}/codes/province.json", Ti = "https://geogratis.gc.ca/services/geoname/@{language}/codes/concise.json";
class Li {
  config;
  constructor(e, t) {
    let i, r, a, o;
    const l = t?.serviceUrls;
    l ? (i = l.geoLocation ? l.geoLocation : Si, r = l.geoNames ? l.geoNames : Ii, a = l.geoProvince ? l.geoProvince : _i, o = l.geoTypes ? l.geoTypes : Ti) : (i = Si, r = Ii, a = _i, o = Ti), i = i.replace("@{language}", e), r = r.replace("@{language}", e), a = a.replace("@{language}", e), o = o.replace("@{language}", e);
    let n = "";
...
const Bo = V("geosearch", () => {
  const s = f(new Li("en", void 0)), e = f({
    type: "",
    province: "",
    extent: void 0
...
}), Vo = V("help", () => ({ location: f("./help/") }));
var is = /* @__PURE__ */ ((s) => (s.Visibility = "visibilityButton", s.Expand = "expandButton", s))(is || {}), Xt = /* @__PURE__ */ ((s) => (s.Item = "item", s.Placeholder = "placeholder", s.Error = "error", s))(Xt || {});
class ss extends J {
  _uid;
  _name;
  _type;
   ...
   */
  constructor(e, t, i) {
    super(e), this._uid = pt.sharedUtils.generateUUID(), this._name = t.name, this._type = t.type ?? "placeholder", this._parent = i, this._children = [], this._loadPromise = new H(), this._hidden = t.hidden ?? !1, this._expanded = t.expanded ?? !0, this._visibility = !0, this._exclusive = t.exclusive ?? !1, this._controls = t.controls?.slice() ?? [
      "visibilityButton",
      "expandButton"
      /* Expand */
...
class $i extends ss {
  ...
  constructor(e, t, i) {
    ...
    }), (t.infoType || t.content) && (this._controls = t.controls?.slice() ?? [is.Expand]), super.load();
  }
...
const qo = V("legend", () => {
  ...
  function a(n) {
    if (n.parent === void 0)
      ...
      if (!(n.item instanceof $i) && !(n.item instanceof De)) {
...
class Zo {
  ...
  constructor(e, t, i) {
    ...
    const r = Xo(e, this);
    this.$vApp = r.app, this.$element = r.element, this.$i18n = r.i18n, this.$rootEl = r.app.$root?.$el, this.fixture = new Hn(this), this.panel = new Yn(this), this.geo = new jn(this), this.dev = new el(this), this.ui = {
      ...
      escapeHtml: () => "",
      isPlainText: () => !0
    }, this.notify = new cr(this), this._isFullscreen = xe.isEnabled && !!this.$vApp.$root && xe.isFullscreen && xe.element === this.$vApp.$root.$el, xe.isEnabled && xe.onchange(() => {
   ...
   */
  initialize(e, t, i) {
    const r = pe(this.$vApp.$pinia), a = Ye(this.$vApp.$pinia), o = Ot(this.$vApp.$pinia);
    if (t?.configs !== void 0) {
   ...
   */
  reloadWorker(e, t) {
    const i = rt(this.$vApp.$pinia), r = Le(this.$vApp.$pinia), a = pe(this.$vApp.$pinia), o = ye(this.$vApp.$pinia), l = _e(this.$vApp.$pinia), n = Jt(this.$vApp.$pinia), c = !!e;
...
function Xo(s, e) {
  ...
  const i = Xs(), r = Di(ga).use(i).use(Os, {
    directive: "tippy",
    // => v-tippy
    component: "tippy"
    // => <tippy/>
  }).use(t);
  r.directive("focus-container", Ia), r.directive("focus-list", wa), r.directive("focus-item", Ea), r.directive("truncate", Ra), r.component("panel-screen", Da), r.component("pin", Va), r.component("close", ja), r.component("back", Ya), r.component("expand", Qa), r.component("panel-options-menu", uo), r.component("dropdown-menu", si), r.component("minimize", io), r.component("right", ao), r.component("left", lo), r.component("fullscreen-nav-button", fo), r.component("geolocator-nav-button", mo), r.component("home-nav-button", yo), r.component("mapnav-button", bo), r.component("appbar-button", xo), r.component("transition", Ni), r.component("transition-group", Fi), r.config.globalProperties.$iApi = e, r.config.globalProperties.$pinia = t, r.config.idPrefix = `ramp-${s.id || e.geo.shared.generateUUID()}`, r.provide("iApi", e);
  const a = r.mount(s);
...
class Qo extends J {
  ...
  async createMap(e, t) {
    ...
    }, r = e.basemaps.map((n) => li.create(n)), o = (await Promise.all(r)).filter((n) => (n.createErr && i(n), n.esriBasemap.baseLayers.length > 0));
    o.forEach((n) => {
   ...
   */
  getExtentSet() {
    return this._rampExtentSet ? this._rampExtentSet : (this.noMapErr(), vt.fromConfig({
...
class en extends J {
   ...
   */
  constructor(e) {
    super(e), this.maptipStore = Ot(this.$vApp.$pinia);
  }
...
class sn extends Qo {
  ...
  async createMapView(e) {
    ...
    this._rampExtentSet = vt.fromConfig(o), this._rampSR = this._rampExtentSet.sr.clone();
...
class fn extends J {
  ...
  extractCsvFields(e, t = ",") {
    return bi.dsvFormat(t).parseRows(e)[0].map((r) => ({ name: r, type: Ce.STRING }));
  }
  /**
  ...
  filterCsvLatLonFields(e, t = ",") {
    const i = bi.dsvFormat(t).parseRows(e), r = i[0], a = {
...
class yn extends J {
  ...
  async loadWfsData(e, t = -1, i = 0, r = 1e3, a = {
    ...
    const c = new $t(e).updateQuery(l), [u, p] = await Ae(wt.get(c));
    if (!p)
...
class gn extends J {
  ...
  async loadLayerMetadata(e) {
    ...
    const [t, i] = await Ae(ze(e, { query: { f: "json" } }));
    if (!i)
    ...
    if (a.name = r.name || "", a.currentVersion = r.currentVersion || -1, a.minScale = r.effectiveMinScale || r.minScale || 0, a.maxScale = r.effectiveMaxScale || r.maxScale || 0, a.extent = r.extent ? G.fromArcServer(r.extent, "layer_extent") : void 0, a.defaultVisibility = r.defaultVisibility ?? !0, a.canModifyLayer = r.canModifyLayer ?? !0, r.type === "Feature Layer" || r.type === "Table") {
      if (a.dataFormat = te.ESRI_FEATURE, a.displayField = r.displayField || "", Array.isArray(r.fields)) {
        ...
        a.fields = o.map((n) => ({
          ...
          length: n.length,
          role: Be.Show
          // this will get updated when processing fieldMetadata
...
class ci extends J {
   ...
   */
  getLayerTree() {
    return new Rt(0, "Fake tree", "getLayerTree() was not implemented in layer");
  }
  /**
   ...
   */
  getGraphic(e, t) {
    return Promise.resolve(new Ee(new qe()));
  }
  /**
...
class rs extends ci {
   ...
   */
  getGraphic(e, t) {
    return this.stubError(), Promise.resolve(new Ee(new qe()));
  }
  getIcon(e) {
    return this.stubError(), Promise.resolve("");
  }
  ...
  async setNameArcade(e) {
    this.supportsFeatures ? e.trim() === "" ? (this.nameArcadeFormula = "", this.nameArcadeExecutor = void 0) : (this.nameArcadeFormula = e, this.nameArcadeExecutor = await this.$iApi.geo.attributes.arcadeGenerator(this, e)) : console.error("Attempted to set a name arcade function on a layer that doesn't support it.");
  }
  /**
  ...
  async setTooltipArcade(e) {
    this.supportsFeatures ? e.trim() === "" ? (this.tooltipArcadeFormula = "", this.tooltipArcadeExecutor = void 0) : (this.tooltipArcadeFormula = e, this.tooltipArcadeExecutor = await this.$iApi.geo.attributes.arcadeGenerator(this, e)) : console.error("Attempted to set a tooltip arcade function on a layer that doesn't support it.");
  }
  /**
...
class ui extends Ze {
  ...
  filter;
  constructor(e, t) {
    super(e, t), this.supportsIdentify = !0, this.geomType = L.UNKNOWN, this.serviceUrl = "", this.fieldList = "", this.canModifyLayer = !0, this.filter = new Wi(e.permanentFilteredQuery || "", e.initialFilteredQuery || ""), this.hovertips = e.state?.hovertips ?? !0, this.attribs = new os();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
  ...
  async loadLayerMetadata(e = {}) {
    ...
    if (!(t < this.lastCancel))
      if (this.geomType = i.geometryType, this.attribs.quickCache = new ls(this.geomType), this.scaleSet.minScale = i.minScale, this.scaleSet.maxScale = i.maxScale, this.dataFormat = i.dataFormat, this.extent = this.extent ?? i.extent, this._serverVisibility = i.defaultVisibility, this.origRampConfig.name || (this.name = i.name ?? this.id), this.dataFormat === te.ESRI_FEATURE) {
        ...
        this.attribs.attLoader = new ns(this.$iApi, a);
      } else
...
class Xe extends ui {
  ...
  onLoadActions() {
    const e = super.onLoadActions(), t = async () => {
      this.esriLayer && this.origRampConfig.customRenderer?.type && (this.esriLayer.renderer = await C.RendererFromJson(this.config.customRenderer)), this.layerTree.name = this.name, this.extractLayerMetadata(), await this.$iApi.geo.attributes.applyFieldMetadata(this, this.origRampConfig.fieldMetadata), this.attribs.attLoader.updateFieldList(this.fieldList), await this.nameInitializer(
  ...
  runIdentify(e) {
    ...
    return e.hitTest && (this.identifyMode === X.HYBRID || this.identifyMode === X.SYMBOLIC) && (r = a.then(async () => {
      ...
      o.forEach((n) => {
        i.items.push(bt.makeRawItem(lt.ESRI, n.attributes));
      }), l.forEach((n) => {
        i.items.push(bt.makeOidItem(n, this));
  ...
  extractLayerMetadata() {
    ...
    this.fields = t.map((r) => ({
      ...
      length: r.length,
      role: Be.Show
      // NOTE: Arcade and Drop won't exist by this step. Hide is valid, but will get set in applyFieldMetadata()
...
class _n extends ui {
  ...
  runIdentify(e) {
    ...
    return e.hitTest && (this.identifyMode === X.HYBRID || this.identifyMode === X.SYMBOLIC) && (r = a.then(async () => {
      ...
      o.forEach((l) => {
        i.items.push(bt.makeOidItem(l, this));
      }), i.loaded = !0, t.resolveMe();
    }).catch(() => {
      i.errored = !0, t.resolveMe();
    }), [i];
  ...
  onLoadActions() {
    ...
    const a = [], o = (n, c) => {
      ...
      if (n.sublayers && n.sublayers.length > 0) {
        const d = (p ? p.name : "") || n.title || "", g = new Rt(u, "", d, !1);
        ...
        if (d.name = p?.name || n.title || "", a.push(d), !c.children.map((g) => g.layerIdx).includes(u)) {
          const g = new Rt(u, d.uid, d.name, !1);
          c.children.push(g);
        }
        d.esriWatches.push(
          be(
    ...
    const l = a.map(async (n) => {
      ...
      if (d ? (n.visibility = n.isRemoved ? !1 : d.state?.visibility ?? (this.origState.visibility ? n._serverVisibility ?? this.origState.visibility : this.origState.visibility ?? n._serverVisibility) ?? !0, n.opacity = d.state?.opacity ?? this.origState.opacity ?? 1, await this.$iApi.geo.attributes.applyFieldMetadata(n, d.fieldMetadata), n.canModifyLayer || this.$iApi.notify.show(
        fe.WARNING,
        this.$iApi.$i18n.t("layer.filtersdisabled", {
          name: n.name || n.id
        })
      )) : await this.$iApi.geo.attributes.applyFieldMetadata(n), n.supportsFeatures) {
  ...
  runIdentify(e) {
    ...
    return e.geometry.type === L.POINT && (i = this.$iApi.geo.query.makeClickBuffer(e.geometry, e.tolerance)), t.map((r) => {
      ...
      return r.geomType !== L.POLYGON && i ? o.filterGeometry = i : o.filterGeometry = e.geometry, o.filterSql = r.getCombinedSqlFilter(), o.sourceSR = r.sourceSR, r.queryOIDs(o).then((n) => {
        n.forEach((c) => {
          l.items.push(bt.makeOidItem(c, r));
...
class On extends Ze {
  ...
  runIdentify(e) {
    ...
    return this.getFeatureInfo(this.sublayerNames, e.geometry, this.mimeType).then((r) => {
      if (r) {
        let a = !0, o;
        typeof r != "string" ? o = lt.JSON : r.indexOf("Search returned no results") === -1 && r !== "" ? o = lt.TEXT : (a = !1, o = lt.UNKNOWN), a && i.items.push(bt.makeRawItem(o, r));
      }
      i.loaded = !0, t.resolveMe();
    }).catch(() => {
      i.errored = !0, t.resolveMe();
  ...
  getFeatureInfo(e, t, i) {
    ...
    }), Object.keys(b).forEach((T) => l[T] = b[T]), ze(a.url.split("?")[0], {
      query: l,
      responseType: y
    });
  }
...
class kn extends Xe {
  ...
  async onInitiate() {
    const e = Date.now(), t = new $t(this.config.url), { offset: i, limit: r } = t.queryMap, a = await this.$iApi.geo.layer.ogc.loadWfsData(
      this.config.url,
      -1,
      parseInt(i) || 0,
      parseInt(r) || 1e3,
...
class as extends rs {
  ...
  // ----------- LAYER CONSTRUCTION AND INITIALIZAION -----------
  constructor(e, t) {
    super(e, t), this.dataFormat = te.ESRI_FEATURE, this.layerFormat = me.NOLAYER, this.drawState = ue.NOT_VISUAL, this.attribs = new os(), this.supportsFeatures = !0, this.mapLayer = !1, this.isFile = !1, this._visibility = e.state?.visibility ?? !0, this.expectedTime.draw = 0;
  }
  async onInitiate() {
    if (this.sourceJson) {
      ...
      }), this.oidField = "rampOID", this.fields.push({ name: this.oidField, type: Ce.OID, role: Be.Hidden }), e.fields.push(this.oidField), e.data.forEach((c, u) => c.push(u + 1)), await this.$iApi.geo.attributes.applyFieldMetadata(this, this.origRampConfig.fieldMetadata), this.fieldList = "*";
      const a = {
        batchSize: -1,
      ...
      this.attribs.attLoader = new Gn(this.$iApi, a), await this.attribs.attLoader.getAttribs(), this.featureCount = e.data.length;
...
class Pn extends as {
  ...
  serviceUrl;
  constructor(e, t) {
    super(e, t), this.layerType = x.DATATABLE, this.serviceUrl = e.url, this.filter = new Wi(e.permanentFilteredQuery || "", e.initialFilteredQuery || "");
  }
  async onInitiate() {
  }
  onLoadActions() {
    const e = super.onLoadActions(), t = Date.now(), r = this.$iApi.geo.shared.parseUrlIndex(this.serviceUrl).index || 0, a = this.$iApi.geo.layer.loadLayerMetadata(this.serviceUrl).then(async (l) => {
      if (t < this.lastCancel)
        return;
      this.name || (this.name = l.name), this.layerTree.name = this.name, this.oidField = l.objectIdField, this.fields = l.fields, await this.$iApi.geo.attributes.applyFieldMetadata(this, this.origRampConfig.fieldMetadata), this.nameInitializer(this.origRampConfig, l.displayField);
      const n = {
        // version number is only provided on 10.0 SP1 servers and up.
        // servers 10.1 and higher support the query limit flag
      ...
      this.attribs.attLoader = new ns(this.$iApi, n), this.attribs.quickCache = new ls(this.geomType);
...
class Fn extends J {
   ...
   */
  async arcadeGenerator(e, t) {
    const i = {
      variables: [
        {
          name: "$attr",
          type: "dictionary",
          properties: e.fields.filter((r) => r.role !== Be.Arcade).map((r) => {
            const a = this.fieldTypeToArcade(r.type);
            return a ? { name: r.name, type: a } : (console.error(`Encountered field type with no arcade support: ${r.type} [${r.name}]`), a);
          }).filter((r) => !!r)
        }
      ]
    };
    return C.ArcadeExecutor(t, i);
  }
  /**
   ...
   */
  async applyFieldMetadata(e, t = void 0) {
    if (!t || !t.fieldInfo) {
      e.fieldList = "*";
      return;
    }
    const i = t.fieldInfo, r = i.filter((o) => o.role === Be.Arcade && o.arcade && o.arcade.formula).map((o) => {
      const l = {
        name: o.name,
        alias: o.alias,
        type: o.arcade.type,
        // TODO does this type need to be mapped to a field type? see arcadeTypeMapper . Might need to go backwards, to double / string / date
        length: void 0,
        // TODO figure out if undefined means all good or problem for string. if problem, might need to detect string and set a value
        role: Be.Arcade
      };
      return e.fields.push(l), [l, o.arcade.formula];
    }), a = i.filter((o) => o.trim).map((o) => o.name);
    e.fields.forEach((o) => {
      a.includes(o.name) && (o.trim = !0);
    }), t.enforceOrder && i.length > 0 && (e.fields = this.orderFields(e.fields, i), e.fieldList = i.map((o) => o.name).join(",")), t.exclusiveFields ? (i.find((o) => o.name === e.oidField) || i.push({ name: e.oidField }), e.fieldList = i.map((o) => o.name).join(","), e.fields = e.fields.filter((o) => i.find((l) => l.name === o.name))) : e.fieldList = "*", i.forEach((o) => {
      if (o.alias) {
        const l = e.fields.find((n) => n.name === o.name);
        l && (l.alias = o.alias);
      }
    }), await Promise.all(
      r.map(async (o) => {
        o[0].arcade = await this.arcadeGenerator(e, o[1]);
      })
    );
  }
  /**
...
class di {
  ...
  constructor(e, t, i = !1) {
    this.innerRenderer = e, this.symbolUnits = [], this.falseRenderer = i, this.type = Mt.Unknown;
  }
...
class Bn extends di {
  ...
  keyFields;
  constructor(e, t, i = !1) {
    super(e, t, i), this.type = Mt.Unique, this.delim = e.fieldDelimiter || ", ";
...
class Vn extends di {
  ...
  constructor(e, t, i = !1) {
    if (super(e, t, i), this.valField = this.cleanFieldName(e.field, t), e.classBreakInfos.forEach((r, a) => {
      const o = a === 0, l = new ki(this, r.minValue, r.maxValue, o);
...
class zn extends J {
  ...
  async getMapServerLegend(e) {
    ...
    const t = {
      query: { f: "json" }
    }, i = { layers: [] }, [r, a] = await Ae(ze(`${e}/legend`, t));
...
class qn extends J {
  ...
  async geoJsonQuery(e) {
    ...
    return (await e.layer.esriLayer.queryFeatures(t)).features.map((r, a) => {
      let o;
      return t.returnGeometry ? o = this.$iApi.geo.geom.geomEsriToRamp(r.geometry, `queryResult${a}`) : o = new qe(), new Ee(o, "", r.attributes);
    });
  }
  /**
...
class jn extends J {
   ...
   */
  constructor(e) {
    super(e), this.geom = pt.geom, this.proj = pt.proj, this.shared = pt.sharedUtils, this.map = new sn(e), this.layer = new gn(e), this.attributes = new Fn(e), this.query = new qn(e), this.symbology = new zn(e), Array.isArray(mt.request.interceptors) || (mt.request.interceptors = []), mt.request.interceptors.push({
      before: (t) => {
   ...
   */
  set proxy(e) {
    mt.request.proxyUrl = e;
  }
  /**
   * Read the current proxy setting, returns url string, empty string if no proxy
   */
  get proxy() {
    return mt.request.proxyUrl || "";
  }
}
const Wn = /* @__PURE__ */ Object.assign({ "../fixtures/appbar/index.ts": () => import("./index-D7fQ6Lw-.js"), "../fixtures/areas-of-interest/index.ts": () => import("./index-CK8c3tvV.js"), "../fixtures/basemap/index.ts": () => import("./index-aHT3KO0L.js"), "../fixtures/crosshairs/index.ts": () => import("./index-CeQ8-dSw.js"), "../fixtures/details/index.ts": () => import("./index-C7OkttjN.js"), "../fixtures/draw/index.ts": () => import("./index-W1kACPYh.js"), "../fixtures/export-footnote/index.ts": () => import("./index-CnBaNwHd.js"), "../fixtures/export-legend/index.ts": () => import("./index-CsK1iySp.js"), "../fixtures/export-map/index.ts": () => import("./index-Ck5ihQFl.js"), "../fixtures/export-northarrow/index.ts": () => import("./index-p7kY1c61.js"), "../fixtures/export-scalebar/index.ts": () => import("./index-C9Tg2wU2.js"), "../fixtures/export-timestamp/index.ts": () => import("./index-ClkjhqvF.js"), "../fixtures/export-title/index.ts": () => import("./index-BulNVA3f.js"), "../fixtures/export/index.ts": () => import("./index-2unkWdzb.js"), "../fixtures/extentguard/index.ts": () => import("./index-0-2B0p_d.js"), "../fixtures/gazebo/index.ts": () => import("./index-iAsR5da-.js"), "../fixtures/geosearch/index.ts": () => import("./index-BfQu4cCt.js"), "../fixtures/grid/index.ts": () => import("./index-BJXipsYs.js"), "../fixtures/help/index.ts": () => import("./index-DkhQVV3y.js"), "../fixtures/hilight/index.ts": () => import("./index-pRkKQEvR.js"), "../fixtures/layer-reorder/index.ts": () => import("./index-DFeBYolQ.js"), "../fixtures/legend/index.ts": () => import("./index-XnykegU6.js"), "../fixtures/mapnav/index.ts": () => import("./index-CLIdIIq0.js"), "../fixtures/metadata/index.ts": () => import("./index-Dn4CsCfC.js"), "../fixtures/northarrow/index.ts": () => import("./index-D_WrBBLi.js"), "../fixtures/overviewmap/index.ts": () => import("./index-BuqNdPXv.js"), "../fixtures/panguard/index.ts": () => import("./index-DWuelCzE.js"), "../fixtures/scrollguard/index.ts": () => import("./index-B-qW_amx.js"), "../fixtures/settings/index.ts": () => import("./index-Dp2WqoN0.js"), "../fixtures/snowman/index.ts": () => import("./index-DxLkTCfP.js"), "../fixtures/swipe/index.ts": () => import("./index-Bn0dbXoJ.js"), "../fixtures/wizard/index.ts": () => import("./index-Bfeebc5K.js") });
class Hn extends J {
  /**
  ...
  async add(e, t) {
    ...
    if (t) {
      ...
      i = hi.updateBaseToInstance(new t(), e, this.$iApi);
    } else {
      const r = (await Wn[`../fixtures/${e}/index.ts`]()).default;
      i = new r(e, this.$iApi);
    }
...
class hi extends J {
  ...
  mount(e, { props: t, children: i, element: r, app: a } = {}) {
    let o = r, l = ws(e, t, i);
    return a && a._context && (l.appContext = a._context), o ? zt(l, o) : (o = document.createElement("div"), zt(l, o)), { vNode: l, destroy: () => {
      o && zt(null, o), o = null, l = null;
    }, el: o };
  }
  /**
...
class Yn extends J {
  ...
  register(e, t) {
    ...
    const r = Object.entries(i).reduce((a, [o, l]) => (a.push(new It(this.$iApi, o, l)), a), []);
  ...
  open(e) {
    let t, i, r;
    if (typeof e == "string" || e instanceof It ? t = this.get(e) : (t = this.get(e.id), { screen: i, props: r } = e), !t)
      return t;
  ...
  toggle(e, t) {
    let i;
    return typeof e == "string" || e instanceof It ? i = this.get(e) : i = this.get(e.id), i && (t = typeof t < "u" ? t : !i.isVisible, t !== i.isVisible ? t ? this.open(e) : this.close(i) : i);
  }
  /**
  ...
  toggleMinimize(e, t) {
    let i;
    return typeof e == "string" || e instanceof It ? i = this.get(e) : i = this.get(e.id), i && (t = typeof t < "u" ? t : !i.isVisible, t !== i.isVisible ? t ? this.open(i) : this.minimize(i) : i);
  }
  /**
...
const Xn = /* @__PURE__ */ Ne(Kn, [["render", Zn], ["__scopeId", "data-v-a3c61802"]]), Qn = /* @__PURE__ */ Object.assign({ "../fixtures/areas-of-interest/screen.vue": () => import("./screen-DmjGE6X6.js"), "../fixtures/basemap/screen.vue": () => import("./screen-DkP2ekB6.js"), "../fixtures/export/screen.vue": () => import("./screen-CmONdt4r.js"), "../fixtures/geosearch/screen.vue": () => import("./screen-B9lKCCK5.js"), "../fixtures/grid/screen.vue": () => import("./screen-D1Vm-z3I.js"), "../fixtures/help/screen.vue": () => import("./screen-BNZ9wEi3.js"), "../fixtures/layer-reorder/screen.vue": () => import("./screen-DlDiHI3W.js"), "../fixtures/legend/screen.vue": () => import("./screen-BsDk7bcQ.js"), "../fixtures/metadata/screen.vue": () => import("./screen-DUG1ED_q.js"), "../fixtures/settings/screen.vue": () => import("./screen-hCYCX_F-.js"), "../fixtures/wizard/screen.vue": () => import("./screen-Dn9_0G3e.js") });
class It extends J {
  /**
   * ID of this panel.
   *
  ...
  registerScreen(e) {
    ...
    if (Ws(t) || js(t))
      ...
      let r;
      typeof t == "string" ? r = Qn[`../fixtures/${t}`]() : r = t();
      const a = new Promise((o, l) => {
        r.then((n) => {
          this.loadedScreens.push(e), o(Hs(n) ? n.default : n);
        }), r.catch((n) => l(n));
      });
      i = As({
...
function il(s) {
  ...
  return rl(s.services, e), sl(s.map, e), al(s.ui, e), s.plugins && ol(s.plugins, e), e;
}
function sl(s, e) {
  if (s.layers && s.layers.forEach((t) => {
    e.layers.unshift(cs(t));
...
function Qt(s) {
  ...
  return s.controls && s.controls.length > 0 && (e.controls = dt(s.controls, t), s.controls.includes("visibility") && e.controls.push("visibilityButton"), (s.controls.length !== 1 || s.controls[0] !== "visibility") && console.warn(
    "Legend entry groups currently support only the visibility control. All other controls are currently not supported."
  ), e.controls.push("expandButton")), s.disabledControls && s.disabledControls.length > 0 && (e.disabledControls = dt(s.disabledControls, t), s.disabledControls.includes("visibility") && e.disabledControls.push("visibilityButton"), (s.disabledControls.length !== 1 || s.disabledControls[0] !== "visibility") && console.warn(
    "Legend entry groups currently support only the visibility control. All other controls are currently not supported."
    ...
    if (i.layerId)
      ...
      typeof i.collapse < "u" && console.warn(
        ...
        a.layerId ? r.children.push(Mi(a)) : r.children.push(Qt(a));
      }), e.children.push(r);
    } else
...
function Mi(s) {
  ...
  return s.controls && s.controls.length > 0 && (e.layerControls = dt(s.controls, t), e.layerControls.push("symbology")), s.disabledControls && s.disabledControls.length > 0 && (e.disabledLayerControls = dt(s.disabledControls, t)), s.controlledIds && (console.warn(
...
function Ht(s) {
  ...
  return s.controls && s.controls.length > 0 && (e.controls = dt(s.controls, t), e.controls.push("symbology")), s.disabledControls && s.disabledControls.length > 0 && (e.disabledControls = dt(s.disabledControls, t)), s.state && (e.state = {
  ...
  )), typeof s.stateOnly < "u" && (e.cosmetic = s.stateOnly), s.initialFilteredQuery && (e.initialFilteredQuery = s.initialFilteredQuery), nl(s, e), (typeof s.toggleSymbology < "u" || s.table) && (e.fixtures = {}, typeof s.toggleSymbology < "u" && (e.fixtures.legend = {
...
var at = { major: "4", minor: "13", patch: "0-beta", timestamp: "Thu Jul 10 15:55:38 2025 -0400", hash: "2698b855e7cccb5264f115bcde8feca36fded0bc" };
console.info(
...
const Yl = (s, e, t) => new Zo(s, e, t), pt = new qs();
export {
  H as $,
  Ur as A,
  gt as B,
