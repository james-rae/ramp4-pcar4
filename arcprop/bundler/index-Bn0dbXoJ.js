import { defineComponent as $, inject as A, useTemplateRef as B, ref as u, computed as g, onBeforeMount as M, onMounted as R, onBeforeUnmount as T, resolveDirective as P, openBlock as k, createElementBlock as z, createElementVNode as f, normalizeStyle as H, withDirectives as N, unref as O, vModelText as F } from "vue";
import { F as _, a as V, G as h, _ as W } from "./main-klwSAI5R.js";
import "pinia";
import "vue-i18n";
import "screenfull";
  ...
  setup(b) {
    ...
    return T(() => {
      ...
      return k(), z("div", D, [
        f("div", {
          class: "verticalLine",
          style: H({ left: x.value, height: C.value, bottom: S.value })
        }, null, 4),
        N(f("input", {
