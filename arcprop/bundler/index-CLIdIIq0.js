...
import { _ as H, d as L, F as K, G as X } from "./main-klwSAI5R.js";
...
const W = /* @__PURE__ */ H(te, [["render", ne]]), ie = /* @__PURE__ */ O({
  ...
  setup(b) {
    const i = S("iApi"), { t } = N(), o = ee(), p = [
      {
        type: "point",
        icon: f(g(() => import("./point-icon-CH_6-oej.js")))
      },
      {
        type: "polyline",
        icon: f(g(() => import("./polyline-icon-Gdi_K-JQ.js")))
      },
      {
        type: "polygon",
        icon: f(g(() => import("./polygon-icon-Bpv5LaWD.js")))
      },
      {
        type: "circle",
        icon: f(g(() => import("./circle-icon-nHNcT2xC.js")))
      },
      {
        type: "rectangle",
        icon: f(g(() => import("./rectangle-icon-BpPYavKM.js")))
      }
    ], a = E(() => {
      const s = p.filter((v) => o.supportedTypes.some((x) => x.type === v.type));
      return s.push({
        type: "edit",
        icon: f(g(() => import("./edit-icon-C2bafTZ6.js")))
      }), s;
    }), n = (s) => {
