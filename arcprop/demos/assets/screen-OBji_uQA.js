import{dO as X,fs as j,dP as D,e1 as O,a2 as $,dS as R,a3 as v,e6 as V,eb as B,e5 as F,e7 as q,hV as U,dT as z,dW as G,dX as k,d4 as r,e8 as W,d_ as c,d$ as f,d2 as d,d3 as u}from"./main-6quFNups.js";import{m as M}from"./marked.esm-DmSrlTiT.js";import"./preload-helper-ExcqyqRp.js";const Y=`<?xml version="1.0" encoding="UTF-8"?>
...
`,Z={key:0},ee={class:"flex justify-center"},te={key:0,class:"flex flex-col justify-center text-center"},ne=["innerHTML"],ae=["innerHTML"],se={key:3,class:"flex flex-col justify-center text-center"},le={class:"text-xl mt-20"},oe={key:1,class:"p-5"},me=X({__name:"screen",props:{panel:{type:Object,required:!0},payload:{type:Object,required:!0}},setup(i){const s=j(),{t:o}=D(),x=O("iApi"),I=$(),n=i,w=R(()=>s.status),y=R(()=>s.response),C=$(!1),p=v({}),P=v([]),T=v([]);V(()=>{s.status="loading",S(),P.push(x.event.on(B.LAYER_REMOVE,e=>{n.payload.layer?.uid===e.uid&&n.panel.close()})),T.push(F(()=>n.payload.layer.uid,(e,t)=>{e!==t&&(s.status="loading",S())}))}),q(()=>{P.forEach(e=>x.event.off(e)),T.forEach(e=>e())});const S=()=>{C.value=n.payload.layer!==void 0&&!n.payload.layer.isRemoved,n.payload.type==="xml"?N(n.payload.url,[]).then(e=>{if(s.status="success",e!==null){const t=document.createElement("div");t.appendChild(g(`${e.firstElementChild.outerHTML}`)),(n.payload.catalogueUrl||n.payload.url)&&t.appendChild(g(`<h5 class="text-xl font-bold mb-3">${o("metadata.xslt.metadata")}</h5>`)),n.payload.catalogueUrl&&t.appendChild(g(`<p><a style="color: blue;" href="${n.payload.catalogueUrl}" target="_blank">${o("metadata.xslt.cataloguePage")}</a></p>`)),t.appendChild(g(`<p><a style="color: blue;" href="${n.payload.url}" target="_blank">${o("metadata.xslt.metadataPage")}</a> (xml)</p>`)),s.response=t.outerHTML}}):n.payload.type==="html"?b(n.payload.url).then(e=>{s.status=e.status,s.response=e.response}):n.payload.type==="md"&&b(n.payload.url).then(e=>{s.status=e.status,s.response=M(e.response)})},N=(e,t)=>{let a;return n.payload.xmlType&&n.payload.xmlType==="DCAT"?a=x.language==="en"?K:Q:a=x.language==="en"?Y:J,a=a.replace(/\{\{([\w.]+)\}\}/g,(l,m)=>o(m)),p[e]?Promise.resolve(_(p[e],a,t)):b(e).then(l=>(p[e]=l.response,_(p[e],a,t)))},_=(e,t,a)=>{let l=null;if(window.XSLTProcessor){const m=new window.XSLTProcessor,L=new DOMParser,E=L.parseFromString(e,"text/xml"),A=L.parseFromString(t,"text/xml");m.importStylesheet(A),a&&a.forEach(h=>m.setParameter("",h.key,h.value||"")),l=m.transformToFragment(E,document);const H={className:"underline text-blue-700 break-all",target:"_blank",validate:{url:h=>/^https?:\/\//.test(h)}};n.payload.treatXmlAsMarkdown?l.firstChild.innerHTML=M.parse(l.firstChild.innerHTML):l.firstChild.innerHTML=U(l.firstChild.innerHTML,H)}return l},b=e=>new Promise(t=>{const a=new XMLHttpRequest;a.open("GET",e,!0),a.responseType="text",a.onload=()=>{a.status===200?t({status:"success",response:a.response}):t({status:"error",response:"Could not load results from remote service."})},a.onerror=()=>{t({status:"error",response:"Could not load results from remote service."})},a.send()});function g(e){const t=document.createElement("div");return t.innerHTML=e,t}return(e,t)=>{const a=z("panel-screen");return r(),G(a,{panel:i.panel,ref_key:"el",ref:I},{header:k(()=>[W(c(f(o)("metadata.title"))+": "+c(i.payload.layerName),1)]),content:k(()=>[C.value?(r(),d("div",Z,[u("div",ee,[w.value=="loading"?(r(),d("div",te,c(f(o)("metadata.loading")),1)):i.payload.type==="xml"&&w.value=="success"?(r(),d("div",{key:1,innerHTML:y.value,class:"flex flex-col justify-center max-w-full xml-content"},null,8,ne)):(i.payload.type==="html"||i.payload.type==="md")&&w.value=="success"?(r(),d("div",{key:2,innerHTML:y.value,class:"flex flex-col justify-center max-w-full metadata-view"},null,8,ae)):(r(),d("div",se,[t[0]||(t[0]=u("img",{src:"https://i.imgur.com/fA5EqV6.png"},null,-1)),u("span",le,c(f(o)("metadata.error")),1)]))])])):(r(),d("div",oe,[u("span",null,c(f(o)("metadata.label.no.layer")),1)]))]),_:1},8,["panel"])}}});export{me as default};
